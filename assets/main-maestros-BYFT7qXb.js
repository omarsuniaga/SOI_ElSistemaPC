...
import{$ as e,A as t,F as n,J as r,K as i,M as a,Q as o,S as s,X as c,Y as l,Z as u,et as d,i as f,j as p,l as m,o as h,q as g,s as _,tt as v,v as y,y as b}from"./clasesApi-DqKzwFwU.js";import{i as x}from"./supabase-BryBf0UA.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./maestroAuth-BZ2ChDTg.js";import"./vendor-CAKU_njC.js";import{t as O}from"./idb-BJPCiZxS.js";import{a as k,n as A,r as j,t as ee}from"./offlineQueue-CfcIbhXO.js";import{a as M,c as te,d as ne,f as re,i as ie,l as ae,n as oe,o as se,p as ce,r as le,t as ue,u as de}from"./pushService-DsWSFa6I.js";import{r as fe,t as pe}from"./permisoService-BqWyDF0U.js";import{t as N}from"./AppToast-L43yfvBt.js";import{n as me,t as he}from"./ausenciaModal-Cp0Ixu1n.js";import{a as ge,c as _e,i as P,l as ve,n as ye,o as be,r as xe,s as Se,t as F}from"./portalUtils-BqwkK1cV.js";import{t as I}from"./preload-helper-CQ36nxok.js";import{t as L}from"./academicService-lra55_F4.js";import{t as Ce}from"./AppModal-BohrepL3.js";import{a as we,c as Te,i as Ee,o as De,s as Oe,t as ke}from"./groqService-CNWH1ut_.js";import{n as Ae}from"./planificacionAdapter-CAWZkGRn.js";import{r as je,s as Me}from"./alumnosApi-L2o0ngo-.js";import{n as Ne,r as Pe,t as Fe}from"./reportService-C5aMGas5.js";import{n as Ie}from"./CHANGELOG-DfDNCZ8H.js";var Le=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Re(e=``){let t=String(e).toLowerCase();return Le.some(e=>t.includes(e.toLowerCase()))}var ze=console.error;console.error=function(...e){e.length>0&&!Re(e[0])&&ze.apply(console,e)};var Be=console.warn;console.warn=function(...e){e.length>0&&!Re(e[0])&&Be.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Re(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Re(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ve=window.fetch;window.fetch=async function(...e){try{return await Ve.apply(window,e)}catch(e){if(!Re(e.message))throw e;return null}};var He=!1;function Ue(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),He=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function We(e,t={}){if(!He&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var Ge=!1;function Ke(e={}){let{enabled:t=!1,consent:n=!1}=e;Ge=t&&n,console.log(`[Analytics] Initialized, enabled:`,Ge)}var qe={windowMs:6e4,max:100};function Je(e={}){qe={...qe,...e},console.log(`[RateLimit] Initialized: ${qe.max} requests per ${qe.windowMs}ms`)}var Ye=null,Xe=new Set;function Ze(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function Qe(e={}){Ye=Ze(e.length||32),Xe.clear(),Xe.add(Ye),console.log(`[CSRF] Initialized`)}var $e={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function et(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function tt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!et()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),nt(t,n),rt(t,n),it(t,n),at(t,n),ot(t,n)}function nt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];$e.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function rt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];$e.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function it(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);$e.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function at(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];$e.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];$e.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var R={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},st=null,ct=!1;function lt(){R.listeners.forEach(e=>e({...R}))}var ut={subscribe(e){return R.listeners.push(e),()=>{R.listeners=R.listeners.filter(t=>t!==e)}},async init(){ct=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),R.maestro=C(),console.log(`[usePortalAuth.init] Maestro local:`,R.maestro?`found`:`not found`),R.loading=!0,lt(),typeof process<`u`&&{}.VITEST)return R.loading=!1,lt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),R.maestro;if(!st){let{data:{subscription:e}}=x.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),ct&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),R.maestro=null,lt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=C();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await E();e&&(R.maestro=e,lt())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});st=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([E(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===D||t?.__pendingApproval?(R.maestro=null,R.pendingApproval=!0):(R.maestro=t,R.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),R.maestro=null,R.pendingApproval=!1}return R.loading=!1,lt(),console.log(`[usePortalAuth.init] Completado`),R.maestro}finally{ct=!1}},setMaestro(e){R.maestro=e,R.loading=!1,lt()},async logout(){await T(),R.maestro=null,lt()},getMaestro:()=>R.maestro,isAuthenticated:()=>!!R.maestro,isLoading:()=>R.loading,isPendingApproval:()=>R.pendingApproval},dt=ut.logout,ft=`calendario`;function pt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):ft}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:ft},``,`#/${ft}`),h(ft);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var mt=null;function ht(e,t){mt=e}function gt(e){mt&&mt(e)}var _t=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function vt(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function yt(e){let{claseId:t,fecha:n,isValid:r}=vt(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}se(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),Dt(e.notification);let t=e.notification;t?.data?.deep_link?yt(t.data.deep_link):t?.data?.deep_link_url&&yt(t.data.deep_link_url),z.some(t=>t.id===e.notification.id)||(z.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Pt())}});var bt=new i(`maestro-notifications`),xt=30*1e3,St=60*1e3,Ct=120*1e3,wt=new Map;function Tt(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/St)}`}function Et(){let e=Date.now();for(let[t,n]of wt.entries())e>n&&wt.delete(t)}function Dt(e){let t=Tt(e),n=Date.now()+Ct;wt.set(t,n)}function Ot(){return Et(),wt.size}function kt(e){return`notif_cache_${e}`}function At(e){try{let t=z.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(kt(e),JSON.stringify(t))}catch{}}function jt(e){try{let t=localStorage.getItem(kt(e));return t?JSON.parse(t):[]}catch{return[]}}var z=[],Mt=[];function Nt(e){return Mt.push(e),e(z),()=>{Mt=Mt.filter(t=>t!==e)}}function Pt(){Mt.forEach(e=>e([...z]))}async function Ft(){let e=C();if(!e)return[];z.length===0&&(z=jt(e.id),z.length>0&&Pt());try{let{data:t,error:n}=await x.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),z;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=z.filter(e=>String(e.id).startsWith(`local_`));return z=[...r,...i],await It(e.id),At(e.id),Pt(),z}catch(e){return console.error(`[NotifService]`,e),z}}async function It(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],i=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[a,s]=await Promise.all([c(),o(e,n,n)]),l=a.map(e=>e.id),u=Object.fromEntries(a.map(e=>[e.id,e])),d=(await r(l)).filter(e=>e.dia?.toLowerCase()===i);s.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let f=new Set(s.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),p=new Date;for(let e of d){if(!e.hora_fin||f.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(p-i)/6e4;if(a<30)continue;let o=u[e.clase_id],s=`${e.clase_id}_${n}`;if(z.some(e=>e.referencia_id===s&&e.tipo===`sesion_sin_registrar`))continue;let c=e.hora_fin?e.hora_fin.slice(0,5):``,l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=l&&c?` (${l}–${c})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;z.unshift({id:`local_`+s,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${d} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:n})}for(let e of d){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-p)/6e4;if(a<0||a>15)continue;let o=u[e.clase_id],s=`prox_${e.clase_id}_${n}`;if(z.some(e=>e.referencia_id===s))continue;let c=e.hora_inicio?e.hora_inicio.slice(0,5):``,l=Math.round(a);z.unshift({id:`local_`+s,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${c?` a las ${c}`:``} empieza en ${l} ${l===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Lt(e){let t=C(),n=z.find(t=>t.id===e);if(n&&(n.estado=`leida`),Pt(),t&&At(t.id),!String(e).startsWith(`local_`))try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Rt(e){let t=C();if(z=z.filter(t=>t.id!==e),Pt(),t&&At(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await x.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function zt(){let e=C();if(z.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Pt(),e&&At(e.id),e)try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Bt(){return z.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Vt=null;function Ht(){let e=C();e&&(Vt||(Vt=x.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};z.some(e=>e.id===n.id)||(z.unshift(n),At(e.id),Pt(),Ut(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=z.findIndex(e=>e.id===t.new.id);n!==-1&&(z[n]={...z[n],...t.new},At(e.id),Pt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),Vt=null,Jt())}),bt.registerChannel(Vt)))}function Ut(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Wt(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),N.show(`Auto-navegación cancelada`,`info`)})}async function kn(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=C();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let i=new Date,a=i.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),s=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,`0`)}-${String(i.getDate()).padStart(2,`0`)}`;try{let d=await g(n.id,s);if(d&&d.length>0){e.innerHTML=An(d,a,i),Mn(e,s,n.id);return}let f=await c();if(!f||f.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let p=f.map(e=>e.id),m=Object.fromEntries(f.map(e=>[e.id,e])),h=(await r(p)).filter(e=>e.dia?.toLowerCase()===a).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${xe(a)} ${ge(i)}</h2>
      ...
      `;return}let _=new Date(i);_.setDate(_.getDate()-3);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=new Date(i);y.setDate(y.getDate()-1);let b=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,`0`)}-${String(y.getDate()).padStart(2,`0`)}`,x=(await o(n.id,v,b)||[]).filter(e=>{if(!p.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await o(n.id,s,s)).filter(e=>p.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),C=new Set(S.map(e=>e.clase_id)),w=await l(p),T={};for(let e of w||[])e.clase_id&&(T[e.clase_id]=(T[e.clase_id]||0)+1);let E=[...new Set(h.map(e=>e.salon_id).filter(Boolean))],D=E.length>0?await u(E):[],O=Object.fromEntries(D.map(e=>[e.id,e.nombre])),k=i.getHours()*60+i.getMinutes(),A=null,j=null,ee=h.map(e=>{let t=m[e.clase_id],n=C.has(t.id),r=T[t.id]||0,i=Dn(e.hora_inicio,e.hora_fin,k);i===`en-curso`&&(!n&&!A&&(A=t.id),n&&!j&&(j=t.id));let a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`,o=i===`en-curso`?`<span class="pm-badge pm-badge-en-curso"><i class="bi bi-circle-fill pm-pulse-dot me-1"></i>En curso</span>`:i===`proxima`?`<span class="pm-badge pm-badge-proxima"><i class="bi bi-clock me-1"></i>Próximamente</span>`:``;return`
        <div class="pm-clase-card ${[n?`registrada`:`sin-registrar`,i===`en-curso`?`pm-clase-en-curso`:``,i===`proxima`?`pm-clase-proxima`:``,i===`pasada`?`pm-clase-pasada`:``].filter(Boolean).join(` `)}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${P(O[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),M=x.length>0?`
  ...
  `,e.querySelector(`#pm-cal-prev`).addEventListener(`click`,o),e.querySelector(`#pm-cal-next`).addEventListener(`click`,s),e.querySelectorAll(`.pm-cal-day[data-fecha]`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-cal-day[data-fecha]`).forEach(e=>e.setAttribute(`aria-selected`,`false`)),t.setAttribute(`aria-selected`,`true`),a?.(t.dataset.fecha)})});let _=e.querySelector(`.pm-cal-grid`);_&&_.addEventListener(`keydown`,function(e){let t=[..._.querySelectorAll(`.pm-cal-day[data-fecha]`)];if(t.length===0)return;let n=_.querySelector(`[tabindex="0"]`),r=n?t.indexOf(n):-1,i=e=>{e<0||e>=t.length||(t.forEach(e=>e.setAttribute(`tabindex`,`-1`)),t[e].setAttribute(`tabindex`,`0`),t[e].focus())};switch(e.key){case`ArrowLeft`:e.preventDefault(),r>0&&i(r-1);break;case`ArrowRight`:e.preventDefault(),r<t.length-1&&i(r+1);break;case`ArrowUp`:e.preventDefault(),i(Math.max(0,r-7));break;case`ArrowDown`:e.preventDefault(),i(Math.min(t.length-1,r+7));break;case`Home`:e.preventDefault(),i(Math.floor(Math.max(r,0)/7)*7);break;case`End`:e.preventDefault(),i(Math.min(t.length-1,Math.floor(Math.max(r,0)/7)*7+6));break;case`PageUp`:e.preventDefault(),typeof o==`function`&&o();break;case`PageDown`:e.preventDefault(),typeof s==`function`&&s();break;case`Enter`:case` `:e.preventDefault(),n&&n.click();break}})}async function Wn(e){let t=C();if(!t)return;let n=new Date,r=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(n.getDate()).padStart(2,`0`)}`,i=document.getElementById(`pm-action-drawer`);i||(i=document.createElement(`div`),i.id=`pm-action-drawer`,i.className=`pm-drawer-overlay`,document.body.appendChild(i));let a=e===r,o=e<r,s=[],c=[],l=[],u=[];try{let{data:n}=await x.from(`clases_emergentes`).select(`*`).eq(`maestro_id`,t.id).eq(`fecha`,e).order(`hora_inicio`,{ascending:!0,nullsFirst:!1}),{data:r}=await x.from(`sesiones_clase`).select(`*`).eq(`maestro_id`,t.id).eq(`fecha`,e);s=r||[],u=s.filter(e=>e.clase_id&&e.emergente_id);let{data:i}=await x.from(`clases`).select(`id, nombre, instrumento`).or(`maestro_principal_id.eq.${t.id},maestro_suplente_id.eq.${t.id},maestro_id.eq.${t.id}`);c=i||[];let a=c.map(e=>e.id);if(a.length>0){let{data:e}=await x.from(`clase_horarios`).select(`clase_id, hora_inicio, hora_fin, dia`).in(`clase_id`,a);l=e||[]}}catch(e){console.error(`Error fetching drawer data:`,e)}let[d,f,p]=e.split(`-`).map(Number),m=new Date(d,f-1,p),h=m.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),g=c.filter(e=>l.some(t=>t.clase_id===e.id&&t.dia?.toLowerCase()===h)).map(e=>{let t=l.find(t=>t.clase_id===e.id&&t.dia?.toLowerCase()===h),n=s.find(t=>t.clase_id===e.id);return{...e,hora_inicio:t?.hora_inicio,hora_fin:t?.hora_fin,sesion:n}}).sort((e,t)=>(e.hora_inicio||``).localeCompare(t.hora_inicio||``)),_=s.filter(e=>!e.clase_id).sort((e,t)=>(e.hora_inicio||``).localeCompare(t.hora_inicio||``)),v=``;_.length>0?v=_.map(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=e.estado===`registrada`||e.estado===`cerrada`||t;return`
        <div class="pm-drawer-clase-item" style="border-left: 3px solid var(--pm-warning);">
          <div class="pm-drawer-clase-info">
            ...
            <span class="pm-drawer-clase-nombre">${P(e.actividad||`Clase Emergente`)}</span>
      ...
      <div style="margin-top:0.75rem;">
        ...
        ${u.sort((e,t)=>(e.hora_inicio||``).localeCompare(t.hora_inicio||``)).map(e=>{let t=c.find(t=>t.id===e.clase_id);return`
            <div class="pm-drawer-clase-item" style="border-left:3px solid #0891b2; opacity:0.85;">
              <div class="pm-drawer-clase-info">
                <span class="pm-drawer-clase-hora">${(e.hora_inicio||`--:--`).slice(0,5)} - ${(e.hora_fin||`--:--`).slice(0,5)}</span>
                <span class="pm-drawer-clase-nombre">${P(t?.nombre||`Clase`)}</span>
...
`);r&&(n[r]=Xn(i))}),{...Xn(e),por_capas:n}}function Qn(e){if(!e)return``;let t=$n(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(H.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${qn.capas}22; color:${qn.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${qn.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${qn.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(H.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(H.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(H.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(H.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(H.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(H.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function $n(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var er=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function tr(e){if(!e||e.length===0)return er.slice(0,6);let t=e.toLowerCase();return er.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function nr(e){let t=er.find(t=>t.trigger===e);return t?t.expand:null}function rr(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=ir(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var U=null,or=[],sr=null,W=-1,cr=!1,lr=null,ur=!1,dr=0,fr=0;function pr(){if(!U){if(U=document.createElement(`div`),U.id=`pm-autocomplete-popup`,U.className=`pm-autocomplete-popup`,U.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(U)}}function mr(e,t,n={}){if(pr(),or=e||[],sr=t,lr=n.trigger||null,W=-1,cr=!0,br(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),U.style.left=`${i}px`,U.style.top=`${a}px`}U.onmousedown=hr,document.addEventListener(`mousemove`,gr),document.addEventListener(`mouseup`,_r),U.style.display=`block`}function hr(e){e.target.closest(`.pm-ac-option`)||(ur=!0,dr=e.clientX-U.offsetLeft,fr=e.clientY-U.offsetTop,U.style.cursor=`grabbing`,U.style.transition=`none`)}function gr(e){if(!ur)return;let t=e.clientX-dr,n=e.clientY-fr;U.style.left=`${Math.max(0,t)}px`,U.style.top=`${Math.max(0,n)}px`}function _r(){ur&&(ur=!1,U.style.cursor=``)}function vr(){U&&(U.style.display=`none`,ur=!1,document.removeEventListener(`mousemove`,gr),document.removeEventListener(`mouseup`,_r)),or=[],sr=null,W=-1,cr=!1,lr=null}function yr(e){or=e||[],W=-1,br(e)}function br(e){if(!U)return;if(!e||e.length===0){U.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${wr(lr)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===W,o=Tr(lr,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
    ...
    `}),U.innerHTML=t,U.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{xr(parseInt(e.dataset.index,10))})})}function xr(e){if(e>=0&&e<or.length){let t=or[e];sr&&sr(t),vr()}}function Sr(e){if(!(!cr||or.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),W=Math.min(W+1,or.length-1),br(or),Cr();break;case`ArrowUp`:e.preventDefault(),W=Math.max(W-1,0),br(or),Cr();break;case`Enter`:e.preventDefault(),W>=0?xr(W):or.length>0&&xr(0);break;case`Escape`:e.preventDefault(),vr();break;case`Tab`:or.length>0&&W===-1&&(e.preventDefault(),xr(0));break}}function Cr(){if(!U||W<0)return;let e=U.querySelector(`.pm-ac-option[data-index="${W}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function wr(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Tr(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?Er(t.type):`•`}function Er(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Dr(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Or(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function kr(){return cr}function Ar(){return W}var jr={show:mr,hide:vr,updateOptions:yr,handleKeyDown:Sr,getCursorPosition:Or,isOpen:kr,getSelectedIndex:Ar},Mr=`portal-maestros-catalogs`,Nr=1,Pr={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Fr=null;async function G(){return Fr||(Fr=await O(Mr,Nr,{upgrade(e){for(let[t,n]of Object.entries(Pr))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Fr)}async function Ir(e,t){let n=await G(),r=await n.get(e,t);if(!r)return null;let i=Pr[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Lr(e){let t=await(await G()).getAll(e),n=Pr[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Rr(e,t,n){return(await G()).getAllFromIndex(e,t,n)}async function zr(e,t){let n=await G(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Br(e,t){let n=(await G()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Vr(e,t){await(await G()).delete(e,t)}async function Hr(e){await(await G()).clear(e)}async function Ur(e){let t=await G(),n=Pr[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Wr(){let e=await G();for(let t of Object.keys(Pr))await e.clear(t)}async function Gr(e){return(await Lr(e)).length}async function Kr(e,t){let n=await G(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function qr(e){return(await G()).get(`historial`,e)}async function Jr(e,t=5){return(await(await G()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var K={get:Ir,getAll:Lr,getByIndex:Rr,set:zr,setBulk:Br,remove:Vr,clear:Hr,cleanExpired:Ur,clearAll:Wr,getStoreSize:Gr,addToHistorial:Kr,getHistorial:qr,getTopUsed:Jr};async function Yr(e){if(!e)return[];try{let{data:t,error:n}=await x.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function Xr(){let e=await K.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await K.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Zr(){let e=await K.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await K.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Qr(){let e=await K.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await K.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function $r(){let e=await K.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await K.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ei(){let e=await K.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await x.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await x.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await x.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await K.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function ti(e=null){let t=await K.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=x.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await K.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function ni(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Yr(n.claseId));break;case`[`:r=await Xr();break;case`(`:r=await Qr();break;case`{`:r=await $r();break;case`$`:r=await Zr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ei():await ti(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=ri(r,t)),e&&e!==`#`){let t=(await K.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function ri(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=ii(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function ii(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function ai(e,t){await K.addToHistorial(e,t)}var oi=`
...
`,hi=class{constructor(e,t=pi){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){this._mounted||(this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(di)||(this._autoTimer=setTimeout(()=>this.start(),fi)))}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(di,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=mi,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,await yi()}async function _i(e,t,n,r){Ce.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:let e=C();await q.addClass(i,e?e.id:null);break;case`Nivel`:await q.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await q.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await q.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await q.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function yi(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=C(),n=await q.getClasses(t?t.id:null);!n.some(e=>e.id===J.activeClassId)&&n.length>0?J.activeClassId=n[0].id:n.length===0&&(J.activeClassId=null),e.innerHTML=`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>vi(`Clase`,null,()=>yi()),J.activeClassId?bi(J.activeClassId):Ei(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),_i(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>yi())},e.onclick=()=>{J.activeClassId=t,J.activeLevelId=J.activeNodeId=J.activeObjectiveId=null,yi(),bi(t),Ei(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Ei(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ei(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function bi(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await q.getLevelsByClass(e);!n.some(e=>e.id===J.activeLevelId)&&n.length>0?J.activeLevelId=n[0].id:n.length===0&&(J.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>vi(`Nivel`,e,()=>bi(e)),J.activeLevelId?xi(J.activeLevelId):Ei(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),_i(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>bi(e))},t.onclick=()=>{J.activeLevelId=n,J.activeNodeId=J.activeObjectiveId=null,bi(e),xi(n),Ei(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ei(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function xi(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await q.getNodesByLevel(e);!n.some(e=>e.id===J.activeNodeId)&&n.length>0?J.activeNodeId=n[0].id:n.length===0&&(J.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>vi(`Tema`,e,()=>xi(e)),J.activeNodeId?Si(J.activeNodeId):Ei(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),_i(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>xi(e))},t.onclick=()=>{J.activeNodeId=n,J.activeObjectiveId=null,xi(e),Si(n),Ei(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Si(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await q.getObjectivesByNode(e);!n.some(e=>e.id===J.activeObjectiveId)&&n.length>0?J.activeObjectiveId=n[0].id:n.length===0&&(J.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
      ...
      ${(await q.getIndicatorsByObjective(e)).map(e=>`
        <div class="pm-rc-ind-card" style="position:relative;flex-direction:column;gap:0.5rem;">
          <div style="display:flex;align-items:flex-start;gap:0.6rem;width:100%;">
            ...
            <span class="ind-text" style="flex:1;">${P(e.descripcion)}</span>
...
`)}function r(e,t){let n=Xi[e.estado]||Xi.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Zi[e.estado]||``}`:`ssp-alumno-chip`}">${$i(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${$i(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${$i(e.tarea)}</div>`:``;return`
  ...
  `,document.head.appendChild(e)}function ia({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function aa(e,t,n){let{data:r,error:i}=await x.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await x.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function oa(e,t){let{data:n,error:r}=await x.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function sa(e){let{error:t}=await x.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function ca(e,t,n,r,i=null,a=null){try{let{error:o}=await x.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await ee({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}var la=`soi_ruta_tema_pendiente`;function ua(e){sessionStorage.setItem(la,JSON.stringify(e))}function da(){let e=sessionStorage.getItem(la);if(!e)return null;sessionStorage.removeItem(la);try{return JSON.parse(e)}catch{return null}}function fa(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
`),s=[];for(let e of o){let t=Zn(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ta({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Da({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await x.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ba(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ba(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await x.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Oa={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},ka=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function X(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Aa={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function ja(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Aa[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Ma(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${X(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${X(n.join(`, `))}</span>`:``}}function o(e,t){let n=Oa[e.estado]??Oa.EN_PROGRESO,r=e.nota?` · ${X(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${X(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Aa[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${ja(c)}</div>`:``,d=Te(r),f=d.length>0?`
    ...
    `,Na(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(ka.indexOf(i)+1)%ka.length;r[n].estado=ka[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function Na(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function Pa(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await x.from(`progresos`).select(`
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}async function za(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||N!==void 0&&N&&N.error(`Error inesperado: `+(e.message||e)),null}}async function Ba(e,{sesionId:t,fecha:n,maestro:r}){try{let{data:i,error:a}=await x.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(a||!i){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let o=n||i.fecha||new Date().toISOString().split(`T`)[0],s={id:t,nombre:i.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let c=Array.isArray(i.asistencia)?i.asistencia:[],l=c.map(e=>e.alumno_id).filter(Boolean),u=[];if(l.length>0){let{data:e}=await x.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,l);u=e||[]}let d={};u.forEach(e=>{d[e.id]=null}),c.forEach(e=>{e.estado&&u.some(t=>t.id===e.alumno_id)&&(d[e.alumno_id]=e.estado)}),Ha(e,{clase:s,horario:null,alumnos:u,estado:d,justificaciones:{},maestro:r,fechaHoy:o,claseId:null,sesionId:t,hasConflict:!1,serverDSL:i.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:i})}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${P(t.message)}</p>`}}async function Va(e,{claseId:t,fecha:n,sesionId:i}={}){let a=typeof e==`string`?document.getElementById(e):e;if(!a){console.error(`[asistenciaView] Container not found:`,e);return}a.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let o=C();if(!o){a.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(i)return Ba(a,{sesionId:i,fecha:n,maestro:o,containerOrId:e});a.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let s=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,i,d,f]=await Promise.all([c(),r([t]),l([t]),x.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,o.id).eq(`fecha`,s).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]),p=n.find(e=>e.id===t);if(!p){a.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let m=i.find(t=>t.dia?.toLowerCase()===e),h=(d||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),g=f.data?.[0],_=Array.isArray(g?.asistencia)?g.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(g?.tipo===`emergente`&&_.length>0){let e=new Set(_),t=new Set(h.map(e=>e.id)),n=_.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await x.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);h=h.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}h=h.filter(t=>e.has(t.id))}let v=g?.id||null,y=g?.updated_at||null,b=g?.contenido||``,S=p.salon?[p.salon]:[],[C,w]=await Promise.all([v?x.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,v).then(e=>e.data||[]):Promise.resolve([]),S.length>0?u(S):Promise.resolve([])]),T=w.length>0?w[0].nombre:null,E=`pm_asistencia_${t||v}_${s}`,D=localStorage.getItem(`${E}_updated`),O=!1;y&&D&&new Date(y).getTime()>new Date(D).getTime()+5e3&&(O=!0);let k=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await x.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();k=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let A={},j={};h.forEach(e=>{A[e.id]=null});let ee=g?.asistencia||[];if(ee.length===0&&v)try{let{data:e}=await x.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,v);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};ee=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let M={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};ee.forEach(e=>{if(Object.prototype.hasOwnProperty.call(A,e.alumno_id)){let t=M[e.estado]??e.estado;A[e.alumno_id]=t}});let te=[];if(v)try{te=await x.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,v).then(e=>e.data||[]),te.forEach(e=>{Object.prototype.hasOwnProperty.call(A,e.alumno_id)&&(A[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Ha(a,{clase:p,horario:m,alumnos:h,estado:A,justificaciones:j,maestro:o,fechaHoy:s,claseId:t,sesionId:v,hasConflict:O,serverDSL:b,snapshots:C,salonNombre:T,rutaId:k,sesionExistenteData:g})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),a.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${P(e.message)}</p>`}}function Ha(r,i){let{clase:o,horario:s,alumnos:l,estado:u,justificaciones:d,maestro:f,fechaHoy:p,claseId:m,snapshots:h,serverDSL:g,hasConflict:_,salonNombre:v,rutaId:y,sesionExistenteData:b}=i,S=i.sesionId,C=[],w=`pm_asistencia_${m}_${p}`,T=g,E=null,D=ya(),O=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${P(o.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${v?`📍 ${P(v)} · `:``}
            ${s?`${be(s.hora_inicio)} – ${be(s.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${ge(new Date(p+`T12:00:00`))}</span> · 
            ${l.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let k=r.querySelector(`#pm-sync-badge-container`);if(k){let e=Kn();k.appendChild(e.el)}let A=r.querySelector(`#pm-dsl-toolbar-container`),j=r.querySelector(`#pm-dsl-editor-container`),M=si(j,{initialContent:g,onChange:e=>{T=e}});M.setContext({claseId:m});let te=ui(r,{onAceptar:e=>{M.setValue(e)}}),ne=rr(r,{onAccept:e=>{M.setValue(e)}}),re=Ma(j.parentNode,{onConfirm:async e=>{try{let t=l.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:n,errors:i}=await Ta({sesionId:S,claseId:m,maestroId:f.id,fechaHoy:p,progressRecords:e,alumnos:t});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=r.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(e){r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Ra(r.querySelector(`#pm-planificacion-dropdown`)||r,{onAdopt:async({instrumento:e,nivel:t,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await n({instrumento:e,nivel:t,descripcion:r,pilares:i}),{linked:s}=await Da({claseId:m,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;N.success(c)}catch(e){N.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=ar(A,{onInsert:(e,t,n)=>M.insertText(e,t,n),getEditorContent:()=>M.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=A.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Ee(e);te.open({original:e,improved:t})}catch(e){N.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=A.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=O?.getActiveIndicador(),n=await De(e,{presentes:l.filter(e=>u[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){N.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async e=>{await za(async()=>{let t=l.filter(e=>u[e.id]&&u[e.id]!==`A`),n=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},i=l.map(e=>e.nombre_completo||e.nombre||``),a={alumnos:l.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:n(t,i)}}),presentes:t.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:n(t,i)}}),tipoClase:Re(o),instrumento:o.instrumento||``,sesionesRecientes:(h||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:O?.getActiveIndicador()?.nombre||``};r.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let s=await ke(e,a);if(!s?.progreso?.length){r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N!==void 0&&N&&N.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:s.progreso,resumen:s.resumen})},{onError:e=>{r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N!==void 0&&N&&N.error(`Error al analizar con IA: `+e.message)}})}}),oe=null,se=r.querySelector(`#pm-planificacion-card`),ce=r.querySelector(`#pm-planificacion-dropdown`),le=r.querySelector(`#pm-planificacion-nombre`);r.querySelector(`#pm-planificacion-detail`);let ue=r.querySelector(`#pm-plan-list-rutas`),de=r.querySelector(`#pm-plan-list-planificaciones`),fe=r.querySelector(`#pm-planificacion-header`);fe&&fe.addEventListener(`click`,()=>{let e=se.classList.toggle(`open`);ce.style.display=e?`block`:`none`}),r.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>{e.addEventListener(`click`,()=>{r.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;ue.style.display=t===`rutas`?``:`none`,de.style.display=t===`planificaciones`?``:`none`})});function pe(e){oe=e.id,localStorage.setItem(`pm_default_plan_${m}`,e.id),le&&(le.textContent=e.nombre||e.name||`Sin nombre`),de.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.planId===e.id)}),O&&=(O.destroy(),null);let t=r.querySelector(`#pm-route-tree-container`),n=r.querySelector(`#pm-active-tema-badge`);oe&&t&&(t.innerHTML=``,He(m).then(e=>{O=Oi(t,{claseId:m,rutaId:oe,completedTopics:e,onIndicadorSelect:e=>{M.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),n&&(n.textContent=e.nombre,n.style.display=`inline-block`),se.classList.remove(`open`),ce.style.display=`none`}}),C.push(()=>O.destroy())}))}let me=r.querySelector(`#btn-manage-planning`);me&&(me.onclick=e=>{if(e.stopPropagation(),!oe){Ce.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ce.open({title:`Gestionar Estructura: ${le.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(O&&O.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&gi(t,oe)}),se&&(async()=>{try{let e=await q.getClasses(f?f.id:null),t=localStorage.getItem(`pm_default_plan_${m}`),n=(o.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ue&&(ue.innerHTML=r.length?r.map(e=>`
            ...
            </div>`).join(``),de.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&pe(n)})})),se.style.display=``;let i=e.find(e=>e.id===t)||r[0]||await q.resolveSmartPlan(o);i&&pe(i)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let he=r.querySelector(`#btn-proponer-curriculo`);he&&(he.onclick=async()=>{he.disabled=!0,he.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await Pa(m,12);if(e.registros.length===0){N.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await we(e,{instrumento:o?.instrumento||``,nivel:``,nombreClase:o?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:o?.instrumento||``,nivel:``})}catch(e){N.error(`Error al generar propuesta: `+e.message)}finally{he.disabled=!1,he.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let _e=r.querySelector(`#btn-copy-as-plan`);_e&&_e.addEventListener(`click`,async()=>{let e=M.getValue();a(`create`,null,await c(),[],{clase_id:m,maestro_id:f?.id||null,maestro_nombre:f?.nombre_completo||null,contenido:e||``,fecha_inicio:p},async e=>{try{await Ae({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),N.error(`Error al guardar la planificación: `+(e.message||e))}})}),y&&(O=Oi(r.querySelector(`#pm-route-tree-container`),{claseId:m,rutaId:y,onIndicadorSelect:e=>{M.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre});let t=r.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``)}}),C.push(()=>O.destroy()));let ve=da();if(ve&&ve.claseId===m){let e=`[${ve.nombre}] `;M.insertText(e),ae.setContext({indicadorActivo:ve.nombre});let t=r.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``);let n=r.querySelector(`#pm-dsl-editor-container`);if(n){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,n.parentElement.insertBefore(e,n)}}let ye=fa(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&x.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&_a(t).catch(console.warn),u[e]=null,delete d[e],Oe(e),Me();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on delete justif:`,e)}sn(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await x.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await x.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=x.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await x.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{S||await Ie(!0,!1);let r=await ha({sesionId:S,alumnoId:e,claseId:m,fecha:p,motivo:t,creadoPor:f.id},n);if(r.error)throw r.error;o=r.data}o&&(d[e]=o),ye.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{u[e]=t,Oe(e),Me()}});C.push(()=>{try{ye.close()}catch{}});let xe=null,Se=r.querySelector(`#pm-draft-indicator`);if(S){xe=ia({saveFn:async e=>{S&&await aa(S,f.id,e)},debounceMs:3e4}),xe.onSaved(()=>{let e=new Date;Se.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,Se.style.display=``}),M.getValue;let e=j.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),xe&&xe.onInput(M.getValue())}}C.push(()=>xe.destroy()),b?.borrador===!0&&oa(S,f.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(M.setValue(e.contenido_raw),T=e.contenido_raw):sa(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}r.querySelector(`#pm-academic-tools`);let F=r.querySelector(`#btn-guardar-obs`);F&&(y&&(F.style.display=``),F.onclick=async()=>{let e=M.getValue();if(!e||!e.trim()){N.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!S){N.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let t=null,n=await Ue(e),i=O?.getActiveIndicador();if(t=n||i,!t){N.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let a=r.querySelector(`#pm-active-tema-badge`);a&&t.nombre&&(a.textContent=t.nombre,a.style.display=`inline-block`),F.disabled=!0,F.textContent=`Procesando...`;try{let n=l.filter(e=>u[e.id]===`P`),i=await Fi(e,t.id,n,t.nombre);if(i.error)throw Error(i.error);if(i.modo===`natural`&&i.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+i.dslGenerado+`

¿Guardar la evaluación?`)){F.disabled=!1,F.textContent=`Guardar observación`;return}if(i.missing.length>0&&!confirm(`Faltan ${i.missing.length} alumno(s) sin evaluar:\n${i.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){F.disabled=!1,F.textContent=`Guardar observación`;return}if(i.evaluaciones.length>0){let{error:e}=await Ni(S,t.id,i.evaluaciones,f.id,n);if(e)throw e}let a={indicador_id:t.id,evaluaciones:i.evaluaciones};await ca(S,f.id,e,a,i.dslGenerado||null,i.textoMejorado||null);let s=Zn(e);if(s.estados&&s.estados.length>0){let t=l.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Ea({sesionId:S,claseId:m,maestroId:f.id,fechaHoy:p,dslText:e,alumnos:t}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&ze(e,j)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let c=await va(S,m,f.id,i.evaluaciones,o.nombre||`Clase`,n);c.success||console.warn(`[Fase C] Fallo parcial en promoción:`,c.error),O&&await O.refresh(),M.setValue(``),T=``;let d=document.createElement(`div`);if(d.innerHTML=`
        ...
        `,d.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(d),setTimeout(()=>d.remove(),4500),i.evaluaciones.length>0&&m&&t?.nombre){let{saved:e,error:n}=await wa({sesionId:S,claseId:m,maestroId:f.id,fechaHoy:p,contenido:t.nombre,evaluaciones:i.evaluaciones});n&&console.warn(`[asistencia] Error al sincronizar progresos:`,n)}if(S){let{academicService:e}=await I(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:t}=await I(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-B9PcYga0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),n=await e.processSessionClosure(S);n&&n.length>0&&await t(r,n)}F.textContent=`¡Guardado!`,setTimeout(()=>{F.textContent=`Guardar observación`,F.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),N.error(`Error al guardar: `+(e.message||e)),F.disabled=!1,F.textContent=`Guardar observación`}});let L=null,Te=r.querySelector(`#pm-alumnos-list`);function Oe(e=null){let t=Ua(l,u),n=null;if(e){let t=Te.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(Te.innerHTML=t.map(e=>je(e,u[e.id])).join(``),e&&n){let t=Te.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function je(e,t){return`
    ...
    `}Te.onclick=async e=>{let t=e.target.closest(`.pm-asist-btn`),n=e.target.closest(`.pm-asist-nombre`);if(n){let e=n.closest(`.pm-asist-item`).dataset.id,t=l.find(t=>t.id===e);if(y){L&&L.destroy(),L=Yi({alumno:t,rutaId:y,sessionId:S,claseId:m,fecha:p,horaInicio:s?.hora_inicio||null}),L.open(),C.push(()=>{L&&L.destroy()});return}let i=h.filter(t=>t.student_id===e);if(i.length===0)try{let{academicService:t}=await I(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(S,e,p);n?(i=n,h.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${e}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}li(r,{student:t,sessionId:S,teacherId:f.id,snapshots:i});return}if(!t)return;let{id:i,action:a}=t.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),a===`J`){let e=l.find(e=>e.id===i);if(!e)return;if(u[i]===`J`){let t=d[i]||null;!t&&S&&(t=await ga(S,i),t&&(d[i]=t)),ye.open(e,t,null),sn(`Editando justificación de ${e.nombre_completo}.`)}else{u[i]=`J`,Oe(i),Me();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on mark J:`,e)}ye.open(e,null,null),sn(`Justificación marcada para ${e.nombre_completo}.`)}return}u[i]=u[i]===a?null:a,Oe(i),Me();let o=Object.values(u).filter(e=>e===`P`).length,c=Object.values(u).filter(e=>e===`A`).length,g=Object.values(u).filter(e=>e===`J`).length;sn(`Asistencia actualizada. ${o} presentes, ${c} ausentes, ${g} justificados.`);try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on mark:`,e)}};function Me(){let e=l.length,t=Object.values(u).filter(e=>e!==null).length,n=r.querySelector(`#pm-progress-wrap`),i=r.querySelector(`#pm-progress-fill`),a=r.querySelector(`#pm-progress-label`);if(t===0){n.style.display=`none`;return}n.style.display=`flex`,i.style.width=`${t/e*100}%`,a.textContent=`${t}/${e}`}async function Ie(e=!1,t=!1){E&&clearTimeout(E);let n=async()=>{let e=l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),t={...S?{}:{clase_id:m},maestro_id:f.id,fecha:p,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:T||``};if(navigator.onLine)try{if(S){let{error:e}=await x.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,S);if(!e){localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await x.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){S=e.id,console.log(`[asistencia] Nueva sesión creada:`,S),localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await ee({tabla:`sesiones_clase`,operacion:S?`update`:`insert`,payload:{...S?{id:S}:{},...t}}),localStorage.setItem(`${w}_updated`,new Date().toISOString())};e?t?await n():await D.run(n):E=setTimeout(()=>{D.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Le=r.querySelector(`.pm-asist-actions-fixed`);if(Le){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),S&&(e.disabled=!0,e.innerHTML=`⏳...`,await Fe(S),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Le.querySelector(`#btn-guardar`);Le.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),m&&(n.disabled=!0,n.innerHTML=`⏳...`,await Ne(m,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Le.insertBefore(n,t)}r.querySelector(`#btn-guardar`).onclick=async()=>{let n=r.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await D.run(async()=>{try{let i=l.filter(e=>u[e.id]).map(e=>({...m?{clase_id:m}:{},alumno_id:e.id,fecha:p,estado:u[e.id],registrado_por:f.id})),a=i.length>0,s=T&&T.trim().length>0;if(!a&&!s)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Ie(!0,!0),!S){let{data:e}=await x.from(`sesiones_clase`).select(`id`).eq(`clase_id`,m).eq(`maestro_id`,f.id).eq(`fecha`,p).maybeSingle();e&&(S=e.id)}if(a&&m)try{let e=i.map(e=>({...e,...S&&{sesion_clase_id:S}}));await t(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!S){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await ee({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:m,alumno_id:e.alumno_id,fecha:p,estado:e.estado,registrado_por:f.id,...S?{sesion_clase_id:S}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(S&&(a||s)){let t=l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),{error:n}=await x.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:t,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,S).select();if(n){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,n.message);let{error:e}=await x.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:t,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,S).select();e&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,e.message),await x.from(`sesiones_clase`).update({borrador:!1,asistencia:t,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,S))}e(),gt(`hoy`),gt(`calendario`),gt(`metricas`),Ft().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(S){let{academicService:e}=await I(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:t}=await I(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-B9PcYga0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await e.processSessionClosure(S);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await t(r,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let c=Le?.querySelector(`#btn-reporte-dia`);c&&(c.style.display=``);let d=Le?.querySelector(`#btn-resumen-mes`);d&&(d.style.display=``);let h=Object.values(u).filter(e=>e===`P`).length,g=Object.values(u).filter(e=>e===`A`).length;sn(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
    ...
    `}_buildEntry(e){let t=wo[e.tipo]||wo.logro,n=new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`});return`
      <div class="pe-entry" data-testid="pe-entry" data-id="${e.id}">
        ...
        <div class="pe-entry__body">
          ...
          <p class="pe-entry__titulo" data-testid="pe-entry-titulo">${P(e.titulo)}</p>
          ${e.descripcion?`<p class="pe-entry__desc">${P(e.descripcion)}</p>`:``}
...
`).trim():``}var Po={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Fo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await x.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await x.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Po[n.estado_cualitativo]??Po.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          <summary class="pm-prog-card__summary">
            ...
            <div class="pm-prog-card__info">
              <span class="pm-prog-card__name">${P(e)}</span>
                ...
                <div class="pm-prog-entry">
                  ...
                  <div class="pm-prog-entry__body">
                    <div class="pm-prog-entry__header">
                      ...
                      <span class="pm-prog-entry__clase">${P(r)}</span>
                    ...
                    ${e.observaciones?`<p class="pm-prog-entry__obs">${P(e.observaciones)}</p>`:``}
                    ${i?`<p class="pm-prog-entry__tarea">📋 ${P(i)}</p>`:``}
                  </div>
                </div>
              `}).join(``)}
          </div>
              ...
              ${o.map(e=>{let t=j.get(e);if(!t)return``;let n=O[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null,i=l?.filter(t=>t.covered_by_clase_id===e&&t.nota!=null&&t.nota!==0)||[],a=i.length>0?Math.round(i.reduce((e,t)=>e+t.nota,0)/i.length*10)/10:null;return`
                  <div class="pm-zen-clase-card pm-glass">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <p class="pm-zen-clase-inst" style="margin:0;">${P(t.instrumento||``)}</p>
                      ${a===null?`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ae=Do(r.tlf_alumno||r.representante_tlf);if(ae){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,es(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{ua({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function rs(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function is(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await $o(),es(e),is(e)})}function as(e){Zo||(Zo=!0,Ko.on(`node-covered`,()=>{$o().then(()=>{es(e),is(e)})}))}var os=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function ss(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await x.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
