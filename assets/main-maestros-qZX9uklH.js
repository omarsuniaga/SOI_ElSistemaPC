const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-lra55_F4.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CQ36nxok.js","assets/supabase-BryBf0UA.js","assets/AchievementsSummaryModal-B9PcYga0.js","assets/portalUtils-BqwkK1cV.js","assets/pushService-DsWSFa6I.js","assets/maestroAuth-BZ2ChDTg.js","assets/permisoService-BqWyDF0U.js","assets/permisosSupabase-DX8LFO6R.js","assets/sistemaView-B1xcqoLz.js","assets/CHANGELOG-DfDNCZ8H.js","assets/ausenciasPanel-DjiJlYyE.js","assets/ausenciaModal-Cp0Ixu1n.js","assets/AppModal-BohrepL3.js","assets/AppToast-L43yfvBt.js","assets/planningParserService-CyklB8VL.js","assets/groqService-CNWH1ut_.js"])))=>i.map(i=>d[i]);
import{$ as e,A as t,F as n,J as r,K as i,M as a,Q as o,S as s,X as c,Y as l,Z as u,et as d,i as f,j as p,l as m,o as h,q as g,s as _,tt as v,v as y,y as b}from"./clasesApi-DqKzwFwU.js";import{i as x}from"./supabase-BryBf0UA.js";import{a as S,i as C,n as w,o as T,r as E,t as D}from"./maestroAuth-BZ2ChDTg.js";import"./vendor-CAKU_njC.js";import{t as O}from"./idb-BJPCiZxS.js";import{a as k,n as A,r as j,t as ee}from"./offlineQueue-CfcIbhXO.js";import{a as M,c as te,d as N,f as P,i as ne,l as re,n as ie,o as ae,p as oe,r as se,t as ce,u as le}from"./pushService-DsWSFa6I.js";import{r as ue,t as de}from"./permisoService-BqWyDF0U.js";import{t as F}from"./AppToast-L43yfvBt.js";import{n as fe,t as pe}from"./ausenciaModal-Cp0Ixu1n.js";import{a as me,c as he,i as I,l as ge,n as _e,o as ve,r as ye,s as be,t as xe}from"./portalUtils-BqwkK1cV.js";import{t as L}from"./preload-helper-CQ36nxok.js";import{t as R}from"./academicService-lra55_F4.js";import{t as Se}from"./AppModal-BohrepL3.js";import{a as Ce,c as z,i as we,o as Te,s as Ee,t as De}from"./groqService-CNWH1ut_.js";import{n as Oe}from"./planificacionAdapter-CAWZkGRn.js";import{r as ke,s as Ae}from"./alumnosApi-L2o0ngo-.js";import{n as je,r as Me,t as Ne}from"./reportService-C5aMGas5.js";import{n as Pe}from"./CHANGELOG-DfDNCZ8H.js";var Fe=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ie(e=``){let t=String(e).toLowerCase();return Fe.some(e=>t.includes(e.toLowerCase()))}var Le=console.error;console.error=function(...e){e.length>0&&!Ie(e[0])&&Le.apply(console,e)};var Re=console.warn;console.warn=function(...e){e.length>0&&!Ie(e[0])&&Re.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ie(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ie(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var ze=window.fetch;window.fetch=async function(...e){try{return await ze.apply(window,e)}catch(e){if(!Ie(e.message))throw e;return null}};var Be=!1;function Ve(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Be=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function He(e,t={}){if(!Be&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var Ue=!1;function We(e={}){let{enabled:t=!1,consent:n=!1}=e;Ue=t&&n,console.log(`[Analytics] Initialized, enabled:`,Ue)}var Ge={windowMs:6e4,max:100};function Ke(e={}){Ge={...Ge,...e},console.log(`[RateLimit] Initialized: ${Ge.max} requests per ${Ge.windowMs}ms`)}var qe=null,Je=new Set;function Ye(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function Xe(e={}){qe=Ye(e.length||32),Je.clear(),Je.add(qe),console.log(`[CSRF] Initialized`)}var Ze={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function Qe(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function $e(e={}){let{debug:t=!1,onReport:n=null}=e;if(!Qe()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),et(t,n),tt(t,n),nt(t,n),rt(t,n),it(t,n)}function et(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];Ze.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function tt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];Ze.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function nt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);Ze.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function rt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];Ze.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function it(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];Ze.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var B={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},at=null,ot=!1;function st(){B.listeners.forEach(e=>e({...B}))}var ct={subscribe(e){return B.listeners.push(e),()=>{B.listeners=B.listeners.filter(t=>t!==e)}},async init(){ot=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),B.maestro=C(),console.log(`[usePortalAuth.init] Maestro local:`,B.maestro?`found`:`not found`),B.loading=!0,st(),typeof process<`u`&&{}.VITEST)return B.loading=!1,st(),console.log(`[usePortalAuth.init] Completado (Test Env)`),B.maestro;if(!at){let{data:{subscription:e}}=x.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),ot&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),B.maestro=null,st();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=C();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await E();e&&(B.maestro=e,st())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});at=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([E(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===D||t?.__pendingApproval?(B.maestro=null,B.pendingApproval=!0):(B.maestro=t,B.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),B.maestro=null,B.pendingApproval=!1}return B.loading=!1,st(),console.log(`[usePortalAuth.init] Completado`),B.maestro}finally{ot=!1}},setMaestro(e){B.maestro=e,B.loading=!1,st()},async logout(){await T(),B.maestro=null,st()},getMaestro:()=>B.maestro,isAuthenticated:()=>!!B.maestro,isLoading:()=>B.loading,isPendingApproval:()=>B.pendingApproval},lt=ct.logout,ut=`calendario`;function dt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):ut}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:ut},``,`#/${ut}`),h(ut);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var ft=null;function pt(e,t){ft=e}function mt(e){ft&&ft(e)}var ht=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function gt(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function _t(e){let{claseId:t,fecha:n,isValid:r}=gt(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}ae(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),Tt(e.notification);let t=e.notification;t?.data?.deep_link?_t(t.data.deep_link):t?.data?.deep_link_url&&_t(t.data.deep_link_url),V.some(t=>t.id===e.notification.id)||(V.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Mt())}});var vt=new i(`maestro-notifications`),yt=30*1e3,bt=60*1e3,xt=120*1e3,St=new Map;function Ct(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/bt)}`}function wt(){let e=Date.now();for(let[t,n]of St.entries())e>n&&St.delete(t)}function Tt(e){let t=Ct(e),n=Date.now()+xt;St.set(t,n)}function Et(){return wt(),St.size}function Dt(e){return`notif_cache_${e}`}function Ot(e){try{let t=V.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Dt(e),JSON.stringify(t))}catch{}}function kt(e){try{let t=localStorage.getItem(Dt(e));return t?JSON.parse(t):[]}catch{return[]}}var V=[],At=[];function jt(e){return At.push(e),e(V),()=>{At=At.filter(t=>t!==e)}}function Mt(){At.forEach(e=>e([...V]))}async function Nt(){let e=C();if(!e)return[];V.length===0&&(V=kt(e.id),V.length>0&&Mt());try{let{data:t,error:n}=await x.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),V;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=V.filter(e=>String(e.id).startsWith(`local_`));return V=[...r,...i],await Pt(e.id),Ot(e.id),Mt(),V}catch(e){return console.error(`[NotifService]`,e),V}}async function Pt(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],i=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[a,s]=await Promise.all([c(),o(e,n,n)]),l=a.map(e=>e.id),u=Object.fromEntries(a.map(e=>[e.id,e])),d=(await r(l)).filter(e=>e.dia?.toLowerCase()===i);s.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let f=new Set(s.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),p=new Date;for(let e of d){if(!e.hora_fin||f.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(p-i)/6e4;if(a<30)continue;let o=u[e.clase_id],s=`${e.clase_id}_${n}`;if(V.some(e=>e.referencia_id===s&&e.tipo===`sesion_sin_registrar`))continue;let c=e.hora_fin?e.hora_fin.slice(0,5):``,l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=l&&c?` (${l}–${c})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;V.unshift({id:`local_`+s,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${d} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:n})}for(let e of d){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-p)/6e4;if(a<0||a>15)continue;let o=u[e.clase_id],s=`prox_${e.clase_id}_${n}`;if(V.some(e=>e.referencia_id===s))continue;let c=e.hora_inicio?e.hora_inicio.slice(0,5):``,l=Math.round(a);V.unshift({id:`local_`+s,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${c?` a las ${c}`:``} empieza en ${l} ${l===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Ft(e){let t=C(),n=V.find(t=>t.id===e);if(n&&(n.estado=`leida`),Mt(),t&&Ot(t.id),!String(e).startsWith(`local_`))try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function It(e){let t=C();if(V=V.filter(t=>t.id!==e),Mt(),t&&Ot(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await x.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Lt(){let e=C();if(V.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Mt(),e&&Ot(e.id),e)try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Rt(){return V.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var zt=null;function Bt(){let e=C();e&&(zt||(zt=x.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};V.some(e=>e.id===n.id)||(V.unshift(n),Ot(e.id),Mt(),Vt(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=V.findIndex(e=>e.id===t.new.id);n!==-1&&(V[n]={...V[n],...t.new},Ot(e.id),Mt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),zt=null,Kt())}),vt.registerChannel(zt)))}function Vt(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Ht(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),Wt(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Ht(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Ut=!1;function Wt(){if(Ut)return;Ut=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var Gt=null;function Kt(){Gt===null&&(Gt=setInterval(()=>{document.visibilityState!==`hidden`&&Nt()},yt),vt.registerInterval(Gt))}function qt(){Gt!==null&&(clearInterval(Gt),Gt=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Nt(),Kt()):qt()});function Jt(){let e=new Date().toISOString().split(`T`)[0];V=V.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}Jt(),document.visibilityState!==`hidden`&&Kt(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var Yt=null,Xt=null;function Zt(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var Qt={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(Yt=document.createElement(`div`),Yt.innerHTML=`
    ...
    `,document.body.appendChild(Yt),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Lt()}),Xt=jt(e=>{this.renderList(e)}),Nt())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=Et();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tienes notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=tn(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=nn(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${en(e.tipo)}">
            <i class="bi ${$t(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${Zt(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>Ft(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),Qt.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>Ft(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Ft(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await It(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Nt()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=fe(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Nt()},close(){this._trap&&=(this._trap.dispose(),null),Xt&&typeof Xt==`function`&&(Xt(),Xt=null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function $t(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function en(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function tn(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function nn(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}var H=null,rn=null;function an(e,t=`polite`){H||(H=document.createElement(`div`),H.setAttribute(`aria-live`,t),H.setAttribute(`aria-atomic`,`true`),H.classList.add(`pm-visually-hidden`),document.body.appendChild(H)),t===`assertive`?(H.setAttribute(`role`,`alert`),H.setAttribute(`aria-live`,`assertive`)):(H.removeAttribute(`role`),H.setAttribute(`aria-live`,`polite`)),clearTimeout(rn),rn=setTimeout(()=>{H.textContent=``,requestAnimationFrame(()=>{H.textContent=e})},50)}function on(e,t){if(!e||!e.id)return;sn(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function sn(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function cn(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>sn(e))}var U={periodo:4,maestroId:null,clasesData:[],todasSesiones:[],inscripcionesPorClase:{},alertasRiesgo:[]};async function ln(e,t){let n=await c();n.sort((e,t)=>e.nombre.localeCompare(t.nombre));let r=new Date;r.setDate(r.getDate()-e*7);let i=r.toISOString().split(`T`)[0],a=new Date().toISOString().split(`T`)[0],s=await o(t,i,a)||[],l=n.map(e=>e.id);if(l.length===0)return{clases:n,sesiones:s,inscripcionesPorClase:{}};let{data:u}=await x.from(`alumnos_clases`).select(`clase_id, alumno:alumnos(id, nombre_completo)`).in(`clase_id`,l).eq(`activo`,!0),d={};for(let e of u||[])!e.clase_id||!e.alumno||(d[e.clase_id]||(d[e.clase_id]=[]),d[e.clase_id].push(e.alumno));return{clases:n,sesiones:s,inscripcionesPorClase:d}}function un({clases:e,sesiones:t,inscripcionesPorClase:n}){let r=t.filter(e=>e.estado===`registrada`).length,i=t.filter(e=>e.estado===`pendiente`).length,a=t.filter(e=>e.borrador===!0).length,o=0,s=0,c=0,l=0;t.forEach(e=>{(e.asistencia||[]).forEach(e=>{l++,e.estado===`P`?o++:e.estado===`A`?s++:e.estado===`J`&&c++})});let u=l>0?Math.round(o/l*100):0,d=e.map(e=>{let r=t.filter(t=>t.clase_id===e.id),i=r.filter(e=>e.estado===`registrada`).length,a=r.filter(e=>e.estado===`pendiente`).length,o=n[e.id]||[],s=o.length,c=r.filter(e=>e.estado===`registrada`).slice(-8).map(e=>{let t=(e.asistencia||[]).filter(e=>e.estado===`P`).length,n=(e.asistencia||[]).length;return n>0?Math.round(t/n*100):0}),l=0,u=0;r.forEach(e=>{(e.asistencia||[]).forEach(e=>{u++,e.estado===`P`&&l++})});let d=u>0?Math.round(l/u*100):0,f=r.filter(e=>e.contenido_dsl?.trim()).length,p=r.length>0?Math.min(100,Math.round(f/Math.max(i,1)*100)):0,m=[];for(let e of o){let t=r.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,i=t.length>0?Math.round(n/t.length*100):0;i>0&&i<70&&m.push({id:e.id,nombre:e.nombre_completo,pct:i})}return{...e,totalAlumnos:s,sesionesCompletadas:i,sesionesPendientes:a,sessionAttendance:c,avgAttendance:d,progress:p,riskStudents:m,alumnos:o}}),f=[];for(let e of d)for(let t of e.riskStudents)f.push({tipo:`baja_asistencia`,alumnoId:t.id,nombre:t.nombre,clase:e.nombre,valor:t.pct,mensaje:`${t.pct}%`});return{totalClases:e.length,sesionesCompletadas:r,sesionesPendientes:i+a,totalPresentes:o,totalAusentes:s,totalJustificados:c,totalRegistros:l,asistenciaPromedio:u,clasesData:d,alertasRiesgo:f,inscripcionesPorClase:n}}function dn(e){let{totalClases:t,sesionesCompletadas:n,sesionesPendientes:r,totalPresentes:i,totalAusentes:a,totalJustificados:o,totalRegistros:s,asistenciaPromedio:c,clasesData:l,alertasRiesgo:u}=e,d=s>0?Math.round(i/s*100):0,f=s>0?Math.round(a/s*100):0,p=s>0?Math.round(o/s*100):0;return`
  ...
  `}function fn(e){e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);U.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await ln(n,U.maestroId),r=un(t);U.clasesData=r.clasesData,U.todasSesiones=t.sesiones,U.inscripcionesPorClase=t.inscripcionesPorClase,U.alertasRiesgo=r.alertasRiesgo,e.innerHTML=dn(r),fn(e),an(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${I(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=U.clasesData.find(e=>e.id===i)?.alumnos||[],o=U.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
        ...
        <div class="pm-clase-students-list" role="list">
          ...
          `).join(``)}
        </div>`,n.appendChild(c),c.querySelector(`.pm-clase-students-close`).addEventListener(`click`,()=>c.remove());let l=t=>{!c.contains(t.target)&&t.target!==e&&(c.remove(),document.removeEventListener(`click`,l))};setTimeout(()=>document.addEventListener(`click`,l),10),c.querySelectorAll(`.pm-clase-student-row`).forEach(e=>{let t=()=>window.location.hash=`#/alumno?id=${e.dataset.alumno}`;e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})})})}function pn(){if(!U.clasesData.length&&!Object.keys(U.inscripcionesPorClase).length)return null;let e=new Map;for(let[t,n]of Object.entries(U.inscripcionesPorClase)){let r=U.clasesData.find(e=>e.id===t);for(let t of n)e.has(t.id)||e.set(t.id,{...t,clases:[]}),r&&e.get(t.id).clases.push(r.nombre)}return[...e.values()]}async function mn(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}U.maestroId=t.id;try{let n=await ln(U.periodo,t.id),r=un(n);U.clasesData=r.clasesData,U.todasSesiones=n.sesiones,U.inscripcionesPorClase=n.inscripcionesPorClase,U.alertasRiesgo=r.alertasRiesgo,e.innerHTML=dn(r),fn(e),an(`Métricas actualizadas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`
      ...
      </div>`}}var hn=gn();function gn(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}window.addEventListener(`resize`,()=>{let e=gn();e!==hn&&(hn=e,document.body.dataset.pmLayout=e)},{passive:!0});function _n(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function vn(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}function yn(e,t,n,r,i){let a=t?.es_admin?`<a href="/admin" class="pm-admin-link" title="Ir al Panel Admin">
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),F.show(`Auto-navegación cancelada`,`info`)})}async function Dn(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=C();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let i=new Date,a=i.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),s=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,`0`)}-${String(i.getDate()).padStart(2,`0`)}`;try{let d=await g(n.id,s);if(d&&d.length>0){e.innerHTML=On(d,a,i),An(e,s,n.id);return}let f=await c();if(!f||f.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let p=f.map(e=>e.id),m=Object.fromEntries(f.map(e=>[e.id,e])),h=(await r(p)).filter(e=>e.dia?.toLowerCase()===a).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${ye(a)} ${me(i)}</h2>
        <p class="pm-empty">No tienes clases hoy.</p>
      `;return}let _=new Date(i);_.setDate(_.getDate()-3);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=new Date(i);y.setDate(y.getDate()-1);let b=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,`0`)}-${String(y.getDate()).padStart(2,`0`)}`,x=(await o(n.id,v,b)||[]).filter(e=>{if(!p.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await o(n.id,s,s)).filter(e=>p.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),C=new Set(S.map(e=>e.clase_id)),w=await l(p),T={};for(let e of w||[])e.clase_id&&(T[e.clase_id]=(T[e.clase_id]||0)+1);let E=[...new Set(h.map(e=>e.salon_id).filter(Boolean))],D=E.length>0?await u(E):[],O=Object.fromEntries(D.map(e=>[e.id,e.nombre])),k=i.getHours()*60+i.getMinutes(),A=null,j=null,ee=h.map(e=>{let t=m[e.clase_id],n=C.has(t.id),r=T[t.id]||0,i=Tn(e.hora_inicio,e.hora_fin,k);i===`en-curso`&&(!n&&!A&&(A=t.id),n&&!j&&(j=t.id));let a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`,o=i===`en-curso`?`<span class="pm-badge pm-badge-en-curso"><i class="bi bi-circle-fill pm-pulse-dot me-1"></i>En curso</span>`:i===`proxima`?`<span class="pm-badge pm-badge-proxima"><i class="bi bi-clock me-1"></i>Próximamente</span>`:``;return`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await R.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await R.createSnapshotFromPlan(r,s,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})});let te=A||j;te&&(requestAnimationFrame(()=>{e.querySelector(`[data-clase-id="${te}"]`)?.scrollIntoView({behavior:`smooth`,block:`center`})}),A&&setTimeout(()=>{En(A,s,t)},800))}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${I(t.message)}</p>`}}function On(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=kn(e.motivo);return`
  ...
  `}function kn(e){return{suplencia:`pm-eme-motivo-suplencia`,eventual:`pm-eme-motivo-eventual`,reforzamiento:`pm-eme-motivo-reforzamiento`,otro:`pm-eme-motivo-otro`}[e]||`pm-eme-motivo-otro`}function An(e,t,n){e.querySelectorAll(`.pm-emergente-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`pm-card-loading`)||(e.classList.add(`pm-card-loading`),window.router&&window.router.navigate(`clase-emergente?fecha=${t}`),e.classList.remove(`pm-card-loading`))})})}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);if(e.id=`pm-hoy-pendientes-styles`,!document.getElementById(`pm-badge-warning-style`)){let e=document.createElement(`style`);e.id=`pm-badge-warning-style`,e.textContent=`
        .pm-badge-warning {
          background: rgba(245,158,11,0.15);
          color: #d97706;
  ...
  `,document.head.appendChild(e)}var jn=null,Mn=null;function Nn(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;jn=o,Mn=a,Se.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
    ...
    `,onShow:e=>{let t=e.querySelector(`#modal-es_co-docencia`),n=e.querySelector(`#codocencia-fields`),r=e.querySelector(`#modal-alumnos-lista`),a=e.querySelector(`#modal-alumnos-buscar`),o=e.querySelector(`#modal-seleccionar-todos`),s=e.querySelector(`#modal-alumnos-resumen`);t?.addEventListener(`change`,e=>{n.style.display=e.target.checked?`block`:`none`});let c=Array.from(new Map((i||[]).filter(Boolean).map(e=>[e.id,e])).values()).sort((e,t)=>(e.nombre_completo||``).localeCompare(t.nombre_completo||``)),l=new Set,u=()=>{let e=l.size;s.textContent=e>0?`${e} alumno(s) seleccionado(s).`:`Selecciona al menos un alumno para crear el registro.`},d=()=>{let e=(a?.value||``).trim().toLowerCase();return c.filter(t=>e?[t.nombre_completo||``,t.instrumento_principal||``,...t.clase_nombres||[]].join(` `).toLowerCase().includes(e):!0)},f=()=>{let e=d(),t=e.length>0&&e.every(e=>l.has(e.id));o.checked=t,o.indeterminate=!t&&e.some(e=>l.has(e.id))},p=()=>{let t=d();r.innerHTML=t.length?t.map(e=>`
            <label class="pm-emergente-student">
              ...
              <span>${Pn(e.nombre_completo||`Alumno sin nombre`)}</span>
              <span class="pm-emergente-student-tags">
                ${e.instrumento_principal?`<span class="pm-emergente-tag pm-emergente-tag-instrument">${Pn(e.instrumento_principal)}</span>`:``}
                ${(e.clase_nombres||[]).map(e=>`<span class="pm-emergente-tag">${Pn(e)}</span>`).join(``)}
              </span>
            </label>
          `).join(``):`<p class="pm-emergente-hint" style="margin:0;">No hay alumnos que coincidan con los filtros.</p>`,r.querySelectorAll(`.modal-alumno-check`).forEach(t=>{t.addEventListener(`change`,()=>{t.checked?l.add(t.value):l.delete(t.value),e.dataset.selectedAlumnoIds=Array.from(l).join(`,`),f(),u()})}),f(),u()};o?.addEventListener(`change`,()=>{let t=d();o.checked?t.forEach(e=>l.add(e.id)):t.forEach(e=>l.delete(e.id)),e.dataset.selectedAlumnoIds=Array.from(l).join(`,`),p()}),a?.addEventListener(`input`,p),p()},onSave:async e=>{let t=(e.dataset.selectedAlumnoIds||``).split(`,`).map(e=>e.trim()).filter(Boolean),n={fecha:e.querySelector(`#modal-fecha`).value,actividad:e.querySelector(`#modal-clase_id`).value,clase_id:null,hora_inicio:e.querySelector(`#modal-hora_inicio`).value,hora_fin:e.querySelector(`#modal-hora_fin`).value,tema_principal:e.querySelector(`#modal-tema`).value.trim(),contenido:e.querySelector(`#modal-contenido`).value.trim(),motivo:e.querySelector(`#modal-motivo`).value.trim(),es_codocencia:e.querySelector(`#modal-es_co-docencia`).checked,maestro_auxiliar_id:e.querySelector(`#modal-maestro_auxiliar_id`)?.value||null,estado:`pendiente`,maestro_id:Mn,asistencia:t.map(e=>({alumno_id:e,estado:null}))};return!n.fecha||!n.actividad||!n.hora_inicio||!n.hora_fin||!n.tema_principal||!n.motivo?(F.error(`Todos los campos obligatorios deben completarse`),!1):t.length===0?(F.error(`Selecciona al menos un alumno participante`),!1):n.hora_inicio>=n.hora_fin?(F.error(`La hora de inicio debe ser menor que la hora de fin`),!1):(jn&&await jn(n),!0)}})}function Pn(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}var Fn=[`domingo`,`lunes`,`martes`,`miercoles`,`jueves`,`viernes`,`sabado`];async function In(e,t){let n=[],r=0,[i,a,o]=e.fecha.split(`-`).map(Number),s=Fn[new Date(i,a-1,o).getDay()],{data:c,error:l}=await x.from(`clases`).select(`id, nombre`).or(`maestro_principal_id.eq.${t},maestro_suplente_id.eq.${t},maestro_id.eq.${t}`);if(l||!c?.length)return{justificadas:0,errores:[]};let u=c.map(e=>e.id),{data:d,error:f}=await x.from(`clase_horarios`).select(`clase_id, hora_inicio, hora_fin`).in(`clase_id`,u).eq(`dia`,s);if(f||!d?.length)return{justificadas:0,errores:[]};let p=d.map(e=>({...e,nombre:c.find(t=>t.id===e.clase_id)?.nombre||``}));for(let i of p)try{let{data:a}=await x.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,i.clase_id).eq(`activo`,!0),o=(a||[]).map(e=>({alumno_id:e.alumno_id,estado:`justificado`})),s=`Clase suspendida por actividad especial: "${e.actividad||`Actividad especial`}".`+(e.motivo?` Motivo: ${e.motivo}.`:``)+` Todos los alumnos quedan justificados.`,{error:c}=await x.from(`sesiones_clase`).upsert({clase_id:i.clase_id,fecha:e.fecha,maestro_id:t,emergente_id:e.id,hora_inicio:i.hora_inicio,hora_fin:i.hora_fin,estado:`registrada`,borrador:!1,asistencia:o,contenido:s},{onConflict:`clase_id,fecha,maestro_id`});c?n.push(`${i.nombre}: ${c.message}`):r++}catch(e){n.push(`${i.nombre}: ${e.message}`)}return{justificadas:r,errores:n}}var Ln=[`Do`,`Lu`,`Ma`,`Mi`,`Ju`,`Vi`,`Sa`],Rn=7;async function zn(e,{onFechaClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=C();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.getFullYear(),a=r.getMonth();async function o(){try{let s=await Bn(n.id,i,a);Vn(e,i,a,r,s,{onFechaClick:e=>{Hn(e),t?.(e)},onPrev:()=>{a===0?(i--,a=11):a--,o()},onNext:()=>{a===11?(i++,a=0):a++,o()}})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar calendario: ${I(t.message)}</p>`}}await o()}async function Bn(e,t,n){let i=new Date(t,n,1),a=new Date(t,n+1,0),s=i.toISOString().split(`T`)[0],l=a.toISOString().split(`T`)[0],u=(await c()).map(e=>e.id);if(u.length===0)return new Map;let d=await r(u),f=new Set(d.map(e=>e.dia?.toLowerCase())),p=new Map;d.forEach(e=>{let t=e.dia?.toLowerCase(),n=e.hora_fin||`23:59`;(t&&!p.has(t)||n>p.get(t))&&p.set(t,n)});let m=await o(e,s,l),h=m.filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return e.estado===`registrada`||e.estado===`cerrada`||t||e.borrador===!1&&n}),g=new Set(h.map(e=>e.fecha)),_=new Set(m.filter(e=>e.clase_id&&e.emergente_id).map(e=>e.fecha)),v=new Map;m.filter(e=>!e.clase_id).forEach(e=>{v.has(e.fecha)||v.set(e.fecha,[]),v.get(e.fecha).push(e)});let y=new Map,b=new Date;b.setHours(0,0,0,0);for(let e=new Date(i);e<=a;e.setDate(e.getDate()+1)){let t=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,n=xe[e.getDay()],r=f.has(n),i=v.get(t)||[];if(!r&&i.length===0){y.set(t,`sin-clase`);continue}let a=new Date(e),o=Math.floor((b-a)/864e5);if(o===0){let e=m.find(e=>e.fecha===t);if(e&&Array.isArray(e.asistencia)&&e.asistencia.length>0){y.set(t,`registrada`);continue}if(_.has(t)){y.set(t,`cubierta-emergente`);continue}let r=p.get(n);if(r){let e=new Date,[n,i]=r.split(`:`),a=parseInt(n)*60*60*1e3+parseInt(i||0)*60*1e3;if(e.getHours()*60*60*1e3+e.getMinutes()*60*1e3<a){y.set(t,`sin-clase`);continue}}y.set(t,`pendiente`);continue}if(o>0&&_.has(t)){y.set(t,`cubierta-emergente`);continue}if(o>0&&g.has(t)){y.set(t,`registrada`);continue}o<0?y.set(t,`sin-clase`):o<=Rn?y.set(t,`pendiente`):y.set(t,`vencida`)}return y}function Vn(e,t,n,r,i,{onFechaClick:a,onPrev:o,onNext:s}){let c=new Date(t,n,1),l=new Date(t,n+1,0),u=c.getDay(),d=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`,f=l.getDate(),p=`${t}-${String(n+1).padStart(2,`0`)}-01`,m=`${t}-${String(n+1).padStart(2,`0`)}-${String(f).padStart(2,`0`)}`,h=d>=p&&d<=m?d:p,g=Ln.map(e=>`<div class="pm-cal-day-header">${e}</div>`).join(``);for(let e=0;e<u;e++)g+=`<div class="pm-cal-day otro-mes"></div>`;for(let e=1;e<=f;e++){let r=`${t}-${String(n+1).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,a=i.get(r)||`sin-clase`,o=r===d?`today`:``,s=r===h,c=`${e} de ${_e[n]} ${t}`;g+=`
...
`);r&&(n[r]=Jn(i))}),{...Jn(e),por_capas:n}}function Xn(e){if(!e)return``;let t=Zn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(W.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Gn.capas}22; color:${Gn.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Gn.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Gn.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(W.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(W.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(W.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(W.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(W.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(W.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function Zn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var Qn=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function $n(e){if(!e||e.length===0)return Qn.slice(0,6);let t=e.toLowerCase();return Qn.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function er(e){let t=Qn.find(t=>t.trigger===e);return t?t.expand:null}function tr(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function nr(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=nr(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var G=null,ir=[],ar=null,K=-1,or=!1,sr=null,cr=!1,lr=0,ur=0;function dr(){if(!G){if(G=document.createElement(`div`),G.id=`pm-autocomplete-popup`,G.className=`pm-autocomplete-popup`,G.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(G)}}function fr(e,t,n={}){if(dr(),ir=e||[],ar=t,sr=n.trigger||null,K=-1,or=!0,vr(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),G.style.left=`${i}px`,G.style.top=`${a}px`}G.onmousedown=pr,document.addEventListener(`mousemove`,mr),document.addEventListener(`mouseup`,hr),G.style.display=`block`}function pr(e){e.target.closest(`.pm-ac-option`)||(cr=!0,lr=e.clientX-G.offsetLeft,ur=e.clientY-G.offsetTop,G.style.cursor=`grabbing`,G.style.transition=`none`)}function mr(e){if(!cr)return;let t=e.clientX-lr,n=e.clientY-ur;G.style.left=`${Math.max(0,t)}px`,G.style.top=`${Math.max(0,n)}px`}function hr(){cr&&(cr=!1,G.style.cursor=``)}function gr(){G&&(G.style.display=`none`,cr=!1,document.removeEventListener(`mousemove`,mr),document.removeEventListener(`mouseup`,hr)),ir=[],ar=null,K=-1,or=!1,sr=null}function _r(e){ir=e||[],K=-1,vr(e)}function vr(e){if(!G)return;if(!e||e.length===0){G.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${Sr(sr)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===K,o=Cr(sr,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Tr(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Tr(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),G.innerHTML=t,G.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{yr(parseInt(e.dataset.index,10))})})}function yr(e){if(e>=0&&e<ir.length){let t=ir[e];ar&&ar(t),gr()}}function br(e){if(!(!or||ir.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),K=Math.min(K+1,ir.length-1),vr(ir),xr();break;case`ArrowUp`:e.preventDefault(),K=Math.max(K-1,0),vr(ir),xr();break;case`Enter`:e.preventDefault(),K>=0?yr(K):ir.length>0&&yr(0);break;case`Escape`:e.preventDefault(),gr();break;case`Tab`:ir.length>0&&K===-1&&(e.preventDefault(),yr(0));break}}function xr(){if(!G||K<0)return;let e=G.querySelector(`.pm-ac-option[data-index="${K}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Sr(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Cr(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?wr(t.type):`•`}function wr(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Tr(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Er(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Dr(){return or}function Or(){return K}var kr={show:fr,hide:gr,updateOptions:_r,handleKeyDown:br,getCursorPosition:Er,isOpen:Dr,getSelectedIndex:Or},Ar=`portal-maestros-catalogs`,jr=1,Mr={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Nr=null;async function Pr(){return Nr||(Nr=await O(Ar,jr,{upgrade(e){for(let[t,n]of Object.entries(Mr))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Nr)}async function Fr(e,t){let n=await Pr(),r=await n.get(e,t);if(!r)return null;let i=Mr[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Ir(e){let t=await(await Pr()).getAll(e),n=Mr[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Lr(e,t,n){return(await Pr()).getAllFromIndex(e,t,n)}async function Rr(e,t){let n=await Pr(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function zr(e,t){let n=(await Pr()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Br(e,t){await(await Pr()).delete(e,t)}async function Vr(e){await(await Pr()).clear(e)}async function Hr(e){let t=await Pr(),n=Mr[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Ur(){let e=await Pr();for(let t of Object.keys(Mr))await e.clear(t)}async function Wr(e){return(await Ir(e)).length}async function Gr(e,t){let n=await Pr(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Kr(e){return(await Pr()).get(`historial`,e)}async function qr(e,t=5){return(await(await Pr()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var q={get:Fr,getAll:Ir,getByIndex:Lr,set:Rr,setBulk:zr,remove:Br,clear:Vr,cleanExpired:Hr,clearAll:Ur,getStoreSize:Wr,addToHistorial:Gr,getHistorial:Kr,getTopUsed:qr};async function Jr(e){if(!e)return[];try{let{data:t,error:n}=await x.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function Yr(){let e=await q.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Xr(){let e=await q.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Zr(){let e=await q.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function Qr(){let e=await q.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function $r(){let e=await q.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await x.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await x.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await x.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await q.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function ei(e=null){let t=await q.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=x.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await q.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function ti(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Jr(n.claseId));break;case`[`:r=await Yr();break;case`(`:r=await Zr();break;case`{`:r=await Qr();break;case`$`:r=await Xr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await $r():await ei(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=ni(r,t)),e&&e!==`#`){let t=(await q.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function ni(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=ri(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function ri(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function ii(e,t){await q.addToHistorial(e,t)}var ai=`
...
`;function oi(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{si(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function li(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,mi=class{constructor(e,t=fi){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){this._mounted||(this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(ui)||(this._autoTimer=setTimeout(()=>this.start(),di)))}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(ui,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=pi,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,await vi()}async function gi(e,t,n,r){Se.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:let e=C();await J.addClass(i,e?e.id:null);break;case`Nivel`:await J.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await J.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await J.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await J.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function vi(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=C(),n=await J.getClasses(t?t.id:null);!n.some(e=>e.id===Y.activeClassId)&&n.length>0?Y.activeClassId=n[0].id:n.length===0&&(Y.activeClassId=null),e.innerHTML=`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>_i(`Clase`,null,()=>vi()),Y.activeClassId?yi(Y.activeClassId):Ti(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),gi(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>vi())},e.onclick=()=>{Y.activeClassId=t,Y.activeLevelId=Y.activeNodeId=Y.activeObjectiveId=null,vi(),yi(t),Ti(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Ti(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ti(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function yi(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await J.getLevelsByClass(e);!n.some(e=>e.id===Y.activeLevelId)&&n.length>0?Y.activeLevelId=n[0].id:n.length===0&&(Y.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>_i(`Nivel`,e,()=>yi(e)),Y.activeLevelId?bi(Y.activeLevelId):Ti(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),gi(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>yi(e))},t.onclick=()=>{Y.activeLevelId=n,Y.activeNodeId=Y.activeObjectiveId=null,yi(e),bi(n),Ti(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ti(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function bi(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await J.getNodesByLevel(e);!n.some(e=>e.id===Y.activeNodeId)&&n.length>0?Y.activeNodeId=n[0].id:n.length===0&&(Y.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>_i(`Tema`,e,()=>bi(e)),Y.activeNodeId?xi(Y.activeNodeId):Ti(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),gi(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>bi(e))},t.onclick=()=>{Y.activeNodeId=n,Y.activeObjectiveId=null,bi(e),xi(n),Ti(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function xi(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await J.getObjectivesByNode(e);!n.some(e=>e.id===Y.activeObjectiveId)&&n.length>0?Y.activeObjectiveId=n[0].id:n.length===0&&(Y.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>_i(`Objetivo`,e,()=>xi(e)),Y.activeObjectiveId?wi(Y.activeObjectiveId):Ti(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),gi(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>xi(e))},t.onclick=()=>{Y.activeObjectiveId=n,xi(e),wi(n)}})}var Si={0:`Sin eval.`,1:`Inicial`,2:`En desarrollo`,3:`Logrado`,4:`Destacado`,5:`Superado`},Ci={0:`var(--pm-text-muted)`,1:`#ef4444`,2:`#f97316`,3:`#22c55e`,4:`#06b6d4`,5:`#8b5cf6`};async function wi(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
          ...
          <div class="pm-rc-calif-row" style="display:flex;gap:4px;padding-left:1.6rem;" data-indicator-id="${e.id}">
            ${[1,2,3,4,5].map(t=>`
              <button class="pm-rc-calif-btn" data-calif="${t}" style="
                width:28px;height:28px;border-radius:50%;border:2px solid ${Ci[t]};
                background:${e.calificacion===t?Ci[t]:`transparent`};
                color:${e.calificacion===t?`#fff`:Ci[t]};
            ...
            `:``}
            <span style="font-size:0.6rem;color:${Ci[e.calificacion]||`var(--pm-text-muted)`};margin-left:auto;align-self:center;font-weight:600;">
              ${Si[e.calificacion]||Si[0]}
            </span>
          </div>
        </div>
      `).join(``)}
    </div>
  `,t.querySelector(`#btn-add-ind`).onclick=()=>_i(`Indicador`,e,()=>wi(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=n=>{n.stopPropagation();let r=t.dataset.id,i=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;gi(`Indicador`,r,i,()=>wi(e))}}),t.querySelectorAll(`.pm-rc-calif-btn, .pm-rc-calif-clear`).forEach(t=>{t.onclick=async n=>{n.stopPropagation();let r=t.closest(`.pm-rc-calif-row`).dataset.indicatorId,i=parseInt(t.dataset.calif,10);try{await J.updateIndicatorCalificacion(r,i),wi(e)}catch(e){console.error(`Error updating calificacion:`,e)}}})}function Ti(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}function Ei(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Di(e,{claseId:t,rutaId:n,completedTopics:r=[],onIndicadorSelect:i}){let a=[],o=!1,s=null,c=document.createElement(`div`);if(c.className=`pm-route-bar-wrapper`,e.appendChild(c),!document.getElementById(`pm-route-bar-styles`)){let e=document.createElement(`style`);e.id=`pm-route-bar-styles`,e.textContent=`
        ...
        ${(e.plan_temas||[]).map(e=>`
          <div class="pm-tree-node" data-type="node">
            <div class="pm-tree-header">
              <span class="pm-tree-title">${Ei(e.nombre)}</span>
              <span class="pm-tree-badge">${e.tipo}</span>
            </div>
          </div>
          <div class="pm-tree-children">
            ${(e.plan_objetivos||[]).map(e=>{let t=(r||[]).includes(e.nombre);return`
                <div class="pm-tree-obj" data-type="obj" data-id="${e.id}" data-nombre="${Ei(e.nombre)}">
                  <i class="bi ${t?`bi-check-circle-fill text-success`:s?.id===e.id?`bi-circle-fill text-primary`:`bi-circle`}"></i>
                  <span style="${t?`text-decoration: line-through; opacity: 0.6;`:``}">${Ei(e.nombre)}</span>
                </div>
              `}).join(``)}
          </div>
        `).join(``)}
      </div>
    `).join(``)}async function d(){if(n){o=!0,u();try{a=await J.getRouteHierarchy(n)}catch(e){console.error(`[routeTreeBar] Error:`,e)}finally{o=!1,u()}}}function f(){c.removeEventListener(`click`,l),c.remove()}function p(){return s}return d(),{refresh:d,destroy:f,getActiveIndicador:p}}function Oi(e){return!e||typeof e!=`string`||!e.trim()||/[#\[\(\{\$>]/.test(e)?`dsl`:`natural`}function ki(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=Yn(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function Ai(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function ji(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Mi(e,t,n,r,i=null){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let a=n;if(i&&i.length>0){let e=new Set(i.map(e=>e.id)),t=n.length;a=n.filter(t=>e.has(t.alumno_id)),a.length<t&&console.warn(`[evaluationService] saveEvaluaciones: filtrados ${t-a.length} evaluaciones de alumnos ausentes`)}let o=a.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea}));try{let{data:e,error:t}=await x.from(`indicator_attempts`).upsert(o,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});if(t)throw t;return{data:e,error:null}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[evaluationService] Offline, encolando saveEvaluaciones...`);for(let e of o)await ee({tabla:`indicator_attempts`,operacion:`upsert`,payload:e});return{data:null,error:null,_offline:!0}}return{data:null,error:e}}}async function Ni(e,t){let{data:n,error:r}=await x.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await x.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await x.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:ji(a??[],l),indicators:n,totalAlumnos:l}}async function Pi(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Oi(e);try{let t=e;i===`natural`&&(t=await Te(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=Ai(ki(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,textoMejorado:Fi(e,a,n),error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],textoMejorado:``,error:e.message||`Error desconocido`}}}function Fi(e,t,n){let r=new Map(n.map(e=>[e.id,e.nombre_completo])),i=[];e?.trim()&&(i.push(`Texto original: "${e.trim()}"`),i.push(``)),i.push(`Evaluaciones:`);for(let e of t){let t=r.get(e.alumno_id)||`Alumno`,n=e.nota!==null&&e.nota!==void 0?`${e.nota}/5`:`—`,a=e.observacion?.trim()?e.observacion:`—`,o=e.tarea?.trim()?` | Tarea: ${e.tarea}`:``;i.push(`• ${t}: ${a} | Nota: ${n}${o}`)}return i.join(`
`)}function Ii(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function X(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Li(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function Ri(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function zi(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function Bi(e,t){let{data:n,error:r}=await x.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await x.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=zi(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function Vi(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${X(Li(e.nombre_completo))}</div>
      <div>
  ...
  `}function Hi(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${X(Ri(e.created_at))}</span>
  ...
  `}function Ui(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Wi(e){return e.length?`
  ...
  `:``}function Gi(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${Vi(e,n)}
...
`)}function r(e,t){let n=Yi[e.estado]||Yi.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Xi[e.estado]||``}`:`ssp-alumno-chip`}">${Qi(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Qi(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Qi(e.tarea)}</div>`:``;return`
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Qi(i)} · ${Qi(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}function ra({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ia(e,t,n){let{data:r,error:i}=await x.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await x.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function aa(e,t){let{data:n,error:r}=await x.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function oa(e){let{error:t}=await x.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function sa(e,t,n,r,i=null,a=null){try{let{error:o}=await x.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await ee({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}var ca=`soi_ruta_tema_pendiente`;function la(e){sessionStorage.setItem(ca,JSON.stringify(e))}function ua(){let e=sessionStorage.getItem(ca);if(!e)return null;sessionStorage.removeItem(ca);try{return JSON.parse(e)}catch{return null}}function da(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `,document.body.appendChild(i),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let a=null,o=null,s=null,c=null,l=!1,u=null,d=null,f=i.querySelector(`#pm-justif-title`),p=i.querySelector(`#pm-justif-subtitle`),m=i.querySelector(`#pm-justif-btn-text`),h=i.querySelector(`#pm-justif-alumno-nombre`),g=i.querySelector(`#pm-justif-motivo`),_=i.querySelector(`#pm-justif-file`),v=i.querySelector(`.pm-justif-file-placeholder`),y=i.querySelector(`.pm-justif-file-preview`),b=i.querySelector(`#pm-justif-preview-img`),x=i.querySelector(`#pm-justif-remove-file`),S=i.querySelector(`#pm-justif-delete`);function C(e,t=null,n=null){a=e,o=t,s=null,c=null,l=!!t,u=n,l?(f.textContent=`Editar Justificación`,p.textContent=`Modifica el motivo de la inasistencia`,m.textContent=`Actualizar`,S.style.display=`flex`):(f.textContent=`Justificar Inasistencia`,p.textContent=`Registra el motivo de la ausencia`,m.textContent=`Guardar Justificación`,S.style.display=`none`),h.textContent=e.nombre_completo,g.value=t?.motivo||``;let r=t?.evidencia_url||t?.evidencia_base64;r?(c=r,b.src=r,v.style.display=`none`,y.style.display=`block`):(c=null,v.style.display=`flex`,y.style.display=`none`),_.value=``,i.classList.add(`open`),g.focus();let x=i.querySelector(`.pm-justif-modal`);x&&(d&&d.dispose(),d=fe(x,{onClose:()=>w(!0)}))}function w(e=!1){e&&n&&a&&u!==null&&n(a.id,u),i.classList.remove(`open`),a=null,o=null,s=null,c=null,u=null,d&&=(d.dispose(),null)}i.querySelector(`#pm-justif-close`).onclick=()=>w(!0),i.querySelector(`#pm-justif-cancel`).onclick=()=>w(!0),S.onclick=()=>{a&&confirm(`¿Eliminar la justificación de ${a.nombre_completo}?`)&&(r&&r({alumnoId:a.id,justificacionId:o?.id,existingUrl:o?.evidencia_url||o?.evidencia_base64}),w(!1))},i.querySelector(`.pm-justif-backdrop`).onclick=()=>w(!0),_.onchange=e=>{let t=e.target.files[0];t&&(s=t,c=URL.createObjectURL(t),b.src=c,v.style.display=`none`,y.style.display=`block`)},x.onclick=()=>{c&&!(o?.evidencia_url||o?.evidencia_base64)&&URL.revokeObjectURL(c),s=null,c=null,_.value=``,v.style.display=`flex`,y.style.display=`none`},i.querySelector(`#pm-justif-save`).onclick=()=>{let e=g.value.trim();if(!e){g.focus(),g.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{g.style.borderColor=``},2e3);return}t&&a&&t({alumnoId:a.id,motivo:e,evidenciaFile:s,evidenciaPreview:c,justificacionId:o?.id||null,existingUrl:o?.evidencia_url||o?.evidencia_base64||null,isEdit:l})};let T=e=>{e.key===`Escape`&&(w(),document.removeEventListener(`keydown`,T))};return document.addEventListener(`keydown`,T),{open:C,close:w}}var fa=`documentos`;async function pa(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await x.storage.from(fa).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=x.storage.from(fa).getPublicUrl(r);return o.publicUrl}async function ma({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await pa(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await x.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function ha(e,t){if(!e||!t)return null;let{data:n,error:r}=await x.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ga(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await x.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function _a(e,t,n,r,i=`Clase`,a=null){if(!r||r.length===0)return{success:!0};let o=r;if(a&&a.length>0){let e=new Set(a.map(e=>e.id)),t=r.length;o=r.filter(t=>e.has(t.alumno_id)),o.length<t&&console.warn(`[Promotion] promocionarObservacionesAlumnos: filtrados ${t-o.length} evaluaciones de alumnos ausentes`)}let s=o.filter(e=>e.observacion&&e.observacion.trim().length>0);if(s.length===0)return{success:!0};let c=s.map(r=>new p({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON());try{let{data:e,error:t}=await x.from(`observaciones_alumnos`).upsert(c,{onConflict:`sesion_clase_id,alumno_id`});if(t)throw t;return{success:!0,data:e}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[Promotion] Offline, encolando promoción de observaciones...`);for(let e of c)await ee({tabla:`observaciones_alumnos`,operacion:`upsert`,payload:e});return{success:!0,_offline:!0,count:c.length}}return console.error(`[Promotion] Error promoviendo observaciones:`,e),{success:!1,error:e.message}}}function va(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function ya(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function ba(e,t){let n=ya(e);return t.find(e=>ya(e.nombre)===n||ya(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&ya(e.nombre).includes(n)||n.length>=3&&n.includes(ya(e.nombreCorto||e.nombre.split(` `)[0])))??null}function xa(e,t){let n=[],r=[];for(let i of e){if(ya(i)===`todos`){n.push(...t);continue}let e=ba(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Sa(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await x.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function Ca({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=Ee(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await Sa(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function wa({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=xa(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Sa(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function Ta({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=Yn(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:wa({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ea({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await x.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ya(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ya(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await x.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Da={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Oa=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function ka(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Aa={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function ja(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Aa[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Ma(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${ka(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${ka(n.join(`, `))}</span>`:``}}function o(e,t){let n=Da[e.estado]??Da.EN_PROGRESO,r=e.nota?` · ${ka(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${ka(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Aa[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${ka(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${ka(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${ka(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${ka((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${ka(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${ka(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${ja(c)}</div>`:``,d=z(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${ka(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${ka(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,Na(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Oa.indexOf(i)+1)%Oa.length;r[n].estado=Oa[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function Na(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function Pa(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await x.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=Fa[e.tipo]??Fa.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${La(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${La(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${La(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}async function za(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||F!==void 0&&F&&F.error(`Error inesperado: `+(e.message||e)),null}}async function Ba(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await x.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let s=n||a.fecha||new Date().toISOString().split(`T`)[0],c={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let l=Array.isArray(a.asistencia)?a.asistencia:[],u=l.map(e=>e.alumno_id).filter(Boolean),d=[];if(u.length>0){let{data:e}=await x.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,u);d=e||[]}let f={};d.forEach(e=>{f[e.id]=null}),l.forEach(e=>{e.estado&&d.some(t=>t.id===e.alumno_id)&&(f[e.alumno_id]=e.estado)}),Ha(e,{clase:c,horario:null,alumnos:d,estado:f,justificaciones:{},maestro:r,fechaHoy:s,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i})}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(t.message)}</p>`}}async function Va(e,{claseId:t,fecha:n,sesionId:i,router:a}={}){let o=typeof e==`string`?document.getElementById(e):e;if(!o){console.error(`[asistenciaView] Container not found:`,e);return}o.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let s=C();if(!s){o.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(i)return Ba(o,{sesionId:i,fecha:n,maestro:s,containerOrId:e,router:a});o.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let d=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,i,f,p]=await Promise.all([c(),r([t]),l([t]),x.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,s.id).eq(`fecha`,d).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]),m=n.find(e=>e.id===t);if(!m){o.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let h=i.find(t=>t.dia?.toLowerCase()===e),g=(f||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),_=p.data?.[0],v=Array.isArray(_?.asistencia)?_.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(_?.tipo===`emergente`&&v.length>0){let e=new Set(v),t=new Set(g.map(e=>e.id)),n=v.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await x.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);g=g.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}g=g.filter(t=>e.has(t.id))}let y=_?.id||null,b=_?.updated_at||null,S=_?.contenido||``;console.group(`[asistencia] Session restore diagnostic`),console.log(`claseId:`,t,`| fecha:`,d),console.log(`sesionId:`,y,`| borrador:`,_?.borrador,`| estado_db:`,_?.estado),console.log(`sesionExistenteData.asistencia:`,_?.asistencia),console.log(`alumnos count:`,g.length),console.groupEnd();let C=m.salon?[m.salon]:[],[w,T]=await Promise.all([y?x.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,y).then(e=>e.data||[]):Promise.resolve([]),C.length>0?u(C):Promise.resolve([])]),E=T.length>0?T[0].nombre:null,D=`pm_asistencia_${t||y}_${d}`,O=localStorage.getItem(`${D}_updated`),k=!1;b&&O&&new Date(b).getTime()>new Date(O).getTime()+5e3&&(k=!0);let A=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await x.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();A=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let j={},ee={};g.forEach(e=>{j[e.id]=null});let M=_?.asistencia||[];console.log(`[asistencia] Source 1 (JSONB):`,M.length,`registros`,M.slice(0,2));let te={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(M.length===0)try{let e=null;if(y){let{data:t}=await x.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,y);e=t}if((!e||e.length===0)&&t&&d){let{data:n}=await x.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,d);e=n}console.log(`[asistencia] Source 2a (sesion_clase_id):`,e?.length??`no data`),e?.length>0&&(M=e.map(e=>({alumno_id:e.alumno_id,estado:te[e.estado]??e.estado})),console.log(`[asistencia] Restaurado desde source 2a:`,M.length))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}if(console.log(`[asistencia] serverAsistencia final:`,M.length,`| alumnos en estado:`,Object.keys(j).length),M.length>0&&Object.keys(j).length>0){let e=M[0];console.log(`[asistencia] sample alumno_id from serverAsistencia:`,e?.alumno_id,`| exists in estado:`,Object.prototype.hasOwnProperty.call(j,e?.alumno_id))}let N={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};M.forEach(e=>{if(Object.prototype.hasOwnProperty.call(j,e.alumno_id)){let t=N[e.estado]??e.estado;j[e.alumno_id]=t}});let P=[];if(y)try{P=await x.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,y).then(e=>e.data||[]),P.forEach(e=>{Object.prototype.hasOwnProperty.call(j,e.alumno_id)&&(j[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Ha(o,{clase:m,horario:h,alumnos:g,estado:j,justificaciones:ee,maestro:s,fechaHoy:d,claseId:t,sesionId:y,hasConflict:k,serverDSL:S,snapshots:w,salonNombre:E,rutaId:A,sesionExistenteData:_,router:a})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),o.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function Ha(r,i){let{clase:o,horario:s,alumnos:l,estado:u,justificaciones:d,maestro:f,fechaHoy:p,claseId:m,snapshots:h,serverDSL:g,hasConflict:_,salonNombre:v,rutaId:y,sesionExistenteData:b,router:S}=i,C=i.sesionId,w=e=>{if(S?.navigate){S.navigate(e);return}window.location.hash=`#/${e}`},T=[],E=`pm_asistencia_${m}_${p}`,D=g,O=null,k=va(),A=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    `,document.head.appendChild(e)}r.innerHTML=`
    <style>
      .pm-asist-header { 
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${I(o.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${v?`📍 ${I(v)} · `:``}
            ${s?`${ve(s.hora_inicio)} – ${ve(s.hora_fin)} · `:``}
      ...
      <div class="pm-asist-content" style="padding: 0 1rem 160px;">
        <div class="pm-asist-progress-wrap" id="pm-progress-wrap" style="display:none; margin: 1rem 0;">
          ...
          <span class="pm-asist-progress-label" id="pm-progress-label">0/${l.length}</span>
        </div>
    ...
    <!-- Modales... -->
  `;let j=r.querySelector(`#pm-sync-badge-container`);if(j){let e=Wn();j.appendChild(e.el)}let M=r.querySelector(`#pm-dsl-toolbar-container`),te=r.querySelector(`#pm-dsl-editor-container`),N=oi(te,{initialContent:g,onChange:e=>{D=e}});N.setContext({claseId:m});let P=li(r,{onAceptar:e=>{N.setValue(e)}}),ne=tr(r,{onAccept:e=>{N.setValue(e)}}),re=Ma(te.parentNode,{onConfirm:async e=>{try{let t=l.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:n,errors:i}=await wa({sesionId:C,claseId:m,maestroId:f.id,fechaHoy:p,progressRecords:e,alumnos:t});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=r.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(e){r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Ra(r.querySelector(`#pm-planificacion-dropdown`)||r,{onAdopt:async({instrumento:e,nivel:t,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await n({instrumento:e,nivel:t,descripcion:r,pilares:i}),{linked:s}=await Ea({claseId:m,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;F.success(c)}catch(e){F.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=rr(M,{onInsert:(e,t,n)=>N.insertText(e,t,n),getEditorContent:()=>N.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=M.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await we(e);P.open({original:e,improved:t})}catch(e){F.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=M.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=A?.getActiveIndicador(),n=await Te(e,{presentes:l.filter(e=>u[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){F.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async e=>{await za(async()=>{let t=l.filter(e=>u[e.id]&&u[e.id]!==`A`),n=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},i=l.map(e=>e.nombre_completo||e.nombre||``),a={alumnos:l.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:n(t,i)}}),presentes:t.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:n(t,i)}}),tipoClase:Re(o),instrumento:o.instrumento||``,sesionesRecientes:(h||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:A?.getActiveIndicador()?.nombre||``};r.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let s=await De(e,a);if(!s?.progreso?.length){r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:s.progreso,resumen:s.resumen})},{onError:e=>{r.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.error(`Error al analizar con IA: `+e.message)}})}}),oe=null,se=r.querySelector(`#pm-planificacion-card`),ce=r.querySelector(`#pm-planificacion-dropdown`),le=r.querySelector(`#pm-planificacion-nombre`);r.querySelector(`#pm-planificacion-detail`);let ue=r.querySelector(`#pm-plan-list-rutas`),de=r.querySelector(`#pm-plan-list-planificaciones`),fe=r.querySelector(`#pm-planificacion-header`);fe&&fe.addEventListener(`click`,()=>{let e=se.classList.toggle(`open`);ce.style.display=e?`block`:`none`}),r.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>{e.addEventListener(`click`,()=>{r.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;ue.style.display=t===`rutas`?``:`none`,de.style.display=t===`planificaciones`?``:`none`})});function pe(e){oe=e.id,localStorage.setItem(`pm_default_plan_${m}`,e.id),le&&(le.textContent=e.nombre||e.name||`Sin nombre`),de.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.planId===e.id)}),A&&=(A.destroy(),null);let t=r.querySelector(`#pm-route-tree-container`),n=r.querySelector(`#pm-active-tema-badge`);oe&&t&&(t.innerHTML=``,He(m).then(e=>{A=Di(t,{claseId:m,rutaId:oe,completedTopics:e,onIndicadorSelect:e=>{N.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),n&&(n.textContent=e.nombre,n.style.display=`inline-block`),se.classList.remove(`open`),ce.style.display=`none`}}),T.push(()=>A.destroy())}))}let he=r.querySelector(`#btn-manage-planning`);he&&(he.onclick=e=>{if(e.stopPropagation(),!oe){Se.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Se.open({title:`Gestionar Estructura: ${le.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(A&&A.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&hi(t,oe)}),se&&(async()=>{try{let e=await J.getClasses(f?f.id:null),t=localStorage.getItem(`pm_default_plan_${m}`),n=(o.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ue&&(ue.innerHTML=r.length?r.map(e=>`
            ...
            </div>`).join(``),de.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&pe(n)})})),se.style.display=``;let i=e.find(e=>e.id===t)||r[0]||await J.resolveSmartPlan(o);i&&pe(i)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let ge=r.querySelector(`#btn-proponer-curriculo`);ge&&(ge.onclick=async()=>{ge.disabled=!0,ge.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await Pa(m,12);if(e.registros.length===0){F.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Ce(e,{instrumento:o?.instrumento||``,nivel:``,nombreClase:o?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:o?.instrumento||``,nivel:``})}catch(e){F.error(`Error al generar propuesta: `+e.message)}finally{ge.disabled=!1,ge.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let _e=r.querySelector(`#btn-copy-as-plan`);_e&&_e.addEventListener(`click`,async()=>{let e=N.getValue();a(`create`,null,await c(),[],{clase_id:m,maestro_id:f?.id||null,maestro_nombre:f?.nombre_completo||null,contenido:e||``,fecha_inicio:p},async e=>{try{await Oe({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),F.error(`Error al guardar la planificación: `+(e.message||e))}})}),y&&(A=Di(r.querySelector(`#pm-route-tree-container`),{claseId:m,rutaId:y,onIndicadorSelect:e=>{N.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre});let t=r.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``)}}),T.push(()=>A.destroy()));let ye=ua();if(ye&&ye.claseId===m){let e=`[${ye.nombre}] `;N.insertText(e),ae.setContext({indicadorActivo:ye.nombre});let t=r.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``);let n=r.querySelector(`#pm-dsl-editor-container`);if(n){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        Tema cargado desde Ruta: <strong>${ye.nombre.replace(/</g,`&lt;`)}</strong>
        <button onclick="this.parentElement.remove()" style="
          margin-left:auto;background:none;border:none;cursor:pointer;
          font-size:12px;color:#1d4ed8;
        ">✕</button>
      `,n.parentElement.insertBefore(e,n)}}let be=da(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&x.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&ga(t).catch(console.warn),u[e]=null,delete d[e],Ae(e),Fe();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on delete justif:`,e)}an(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await x.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await x.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=x.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await x.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{C||await Ie(!0,!1);let r=await ma({sesionId:C,alumnoId:e,claseId:m,fecha:p,motivo:t,creadoPor:f.id},n);if(r.error)throw r.error;o=r.data}o&&(d[e]=o),be.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{u[e]=t,Ae(e),Fe()}});T.push(()=>{try{be.close()}catch{}});let xe=null,R=r.querySelector(`#pm-draft-indicator`);if(C){xe=ra({saveFn:async e=>{C&&await ia(C,f.id,e)},debounceMs:3e4}),xe.onSaved(()=>{let e=new Date;R.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,R.style.display=``}),N.getValue;let e=te.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),xe&&xe.onInput(N.getValue())}}T.push(()=>xe.destroy()),b?.borrador===!0&&aa(C,f.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(N.setValue(e.contenido_raw),D=e.contenido_raw):oa(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}r.querySelector(`#pm-academic-tools`);let z=r.querySelector(`#btn-guardar-obs`);z&&(y&&(z.style.display=``),z.onclick=async()=>{let e=N.getValue();if(!e||!e.trim()){F.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!C){F.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let t=null,n=await Ue(e),i=A?.getActiveIndicador();if(t=n||i,!t){F.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let a=r.querySelector(`#pm-active-tema-badge`);a&&t.nombre&&(a.textContent=t.nombre,a.style.display=`inline-block`),z.disabled=!0,z.textContent=`Procesando...`;try{let n=l.filter(e=>u[e.id]===`P`),i=await Pi(e,t.id,n,t.nombre);if(i.error)throw Error(i.error);if(i.modo===`natural`&&i.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+i.dslGenerado+`

¿Guardar la evaluación?`)){z.disabled=!1,z.textContent=`Guardar observación`;return}if(i.missing.length>0&&!confirm(`Faltan ${i.missing.length} alumno(s) sin evaluar:\n${i.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){z.disabled=!1,z.textContent=`Guardar observación`;return}if(i.evaluaciones.length>0){let{error:e}=await Mi(C,t.id,i.evaluaciones,f.id,n);if(e)throw e}let a={indicador_id:t.id,evaluaciones:i.evaluaciones};await sa(C,f.id,e,a,i.dslGenerado||null,i.textoMejorado||null);let s=Yn(e);if(s.estados&&s.estados.length>0){let t=l.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Ta({sesionId:C,claseId:m,maestroId:f.id,fechaHoy:p,dslText:e,alumnos:t}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&ze(e,te)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let c=await _a(C,m,f.id,i.evaluaciones,o.nombre||`Clase`,n);c.success||console.warn(`[Fase C] Fallo parcial en promoción:`,c.error),A&&await A.refresh(),N.setValue(``),D=``;let d=document.createElement(`div`);if(d.innerHTML=`
        ...
        `,d.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(d),setTimeout(()=>d.remove(),4500),i.evaluaciones.length>0&&m&&t?.nombre){let{saved:e,error:n}=await Ca({sesionId:C,claseId:m,maestroId:f.id,fechaHoy:p,contenido:t.nombre,evaluaciones:i.evaluaciones});n&&console.warn(`[asistencia] Error al sincronizar progresos:`,n)}if(C){let{academicService:e}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:t}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-B9PcYga0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),n=await e.processSessionClosure(C);n&&n.length>0&&await t(r,n)}z.textContent=`¡Guardado!`,setTimeout(()=>{z.textContent=`Guardar observación`,z.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),F.error(`Error al guardar: `+(e.message||e)),z.disabled=!1,z.textContent=`Guardar observación`}});let Ee=null,ke=r.querySelector(`#pm-alumnos-list`);function Ae(e=null){let t=Ua(l,u),n=null;if(e){let t=ke.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(ke.innerHTML=t.map(e=>Pe(e,u[e.id])).join(``),e&&n){let t=ke.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Pe(e,t){return`
    ...
    `}ke.onclick=async e=>{let t=e.target.closest(`.pm-asist-btn`),n=e.target.closest(`.pm-asist-nombre`);if(n){let e=n.closest(`.pm-asist-item`).dataset.id,t=l.find(t=>t.id===e);if(y){Ee&&Ee.destroy(),Ee=Ji({alumno:t,rutaId:y,sessionId:C,claseId:m,fecha:p,horaInicio:s?.hora_inicio||null}),Ee.open(),T.push(()=>{Ee&&Ee.destroy()});return}let i=h.filter(t=>t.student_id===e);if(i.length===0)try{let{academicService:t}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(C,e,p);n?(i=n,h.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${e}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}ci(r,{student:t,sessionId:C,teacherId:f.id,snapshots:i});return}if(!t)return;let{id:i,action:a}=t.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),a===`J`){let e=l.find(e=>e.id===i);if(!e)return;if(u[i]===`J`){let t=d[i]||null;!t&&C&&(t=await ha(C,i),t&&(d[i]=t)),be.open(e,t,null),an(`Editando justificación de ${e.nombre_completo}.`)}else{u[i]=`J`,Ae(i),Fe();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on mark J:`,e)}be.open(e,null,null),an(`Justificación marcada para ${e.nombre_completo}.`)}return}u[i]=u[i]===a?null:a,Ae(i),Fe();let o=Object.values(u).filter(e=>e===`P`).length,c=Object.values(u).filter(e=>e===`A`).length,g=Object.values(u).filter(e=>e===`J`).length;an(`Asistencia actualizada. ${o} presentes, ${c} ausentes, ${g} justificados.`);try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on mark:`,e)}};function Fe(){let e=l.length,t=Object.values(u).filter(e=>e!==null).length,n=r.querySelector(`#pm-progress-wrap`),i=r.querySelector(`#pm-progress-fill`),a=r.querySelector(`#pm-progress-label`);if(t===0){n.style.display=`none`;return}n.style.display=`flex`,i.style.width=`${t/e*100}%`,a.textContent=`${t}/${e}`}async function Ie(e=!1,t=!1){O&&clearTimeout(O);let n=async()=>{let e=l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),t={...C?{}:{clase_id:m},maestro_id:f.id,fecha:p,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:D||``};if(navigator.onLine)try{if(C){let{error:e}=await x.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,C);if(!e){localStorage.setItem(`${E}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await x.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){C=e.id,console.log(`[asistencia] Nueva sesión creada:`,C),localStorage.setItem(`${E}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await ee({tabla:`sesiones_clase`,operacion:C?`update`:`insert`,payload:{...C?{id:C}:{},...t}}),localStorage.setItem(`${E}_updated`,new Date().toISOString())};e?t?await n():await k.run(n):O=setTimeout(()=>{k.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Le=r.querySelector(`.pm-asist-actions-fixed`);if(Le){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),C&&(e.disabled=!0,e.innerHTML=`⏳...`,await Ne(C),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Le.querySelector(`#btn-guardar`);Le.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),m&&(n.disabled=!0,n.innerHTML=`⏳...`,await je(m,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Le.insertBefore(n,t)}r.querySelector(`#btn-guardar`).onclick=async()=>{let n=r.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await k.run(async()=>{try{let i=l.filter(e=>u[e.id]).map(e=>({...m?{clase_id:m}:{},alumno_id:e.id,fecha:p,estado:u[e.id],registrado_por:f.id})),a=i.length>0,s=D&&D.trim().length>0;if(!a&&!s)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Ie(!0,!0),!C){let{data:e}=await x.from(`sesiones_clase`).select(`id`).eq(`clase_id`,m).eq(`maestro_id`,f.id).eq(`fecha`,p).maybeSingle();e&&(C=e.id)}if(a&&m)try{let e=i.map(e=>({...e,...C&&{sesion_clase_id:C}}));await t(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!C){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await ee({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:m,alumno_id:e.alumno_id,fecha:p,estado:e.estado,registrado_por:f.id,...C?{sesion_clase_id:C}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(C&&(a||s)){let t=l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),{error:n}=await x.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:t,contenido:D||``,updated_at:new Date().toISOString()}).eq(`id`,C).select();if(n){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,n.message);let{error:e}=await x.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:t,contenido:D||``,updated_at:new Date().toISOString()}).eq(`id`,C).select();e&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,e.message),await x.from(`sesiones_clase`).update({borrador:!1,asistencia:t,contenido:D||``,updated_at:new Date().toISOString()}).eq(`id`,C))}e(),mt(`hoy`),mt(`calendario`),mt(`metricas`),Nt().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(C){let{academicService:e}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:t}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-B9PcYga0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await e.processSessionClosure(C);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await t(r,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let c=Le?.querySelector(`#btn-reporte-dia`);c&&(c.style.display=``);let d=Le?.querySelector(`#btn-resumen-mes`);d&&(d.style.display=``);let h=Object.values(u).filter(e=>e===`P`).length,g=Object.values(u).filter(e=>e===`A`).length;an(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
      ...
      `,document.body.appendChild(_);let v=_.querySelector(`#btn-resumen-pedagogico`),y=_.querySelector(`#btn-editar-asistencia`),b=_.querySelector(`#btn-compartir-correo`),S=_.querySelector(`#btn-compartir-whatsapp`),T=_.querySelector(`#btn-volver-hoy`),E=_.querySelector(`#btn-ir-calendario`),O=ta();v&&(v.onclick=()=>{O.open({sesionId:C,claseNombre:o?.nombre||`Clase`,fecha:p,supabase:x})}),y&&(y.onclick=()=>{_.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),b&&(b.onclick=async()=>{let e=l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${o?.nombre||``} - ${p}`),n=Be(e,D,l,o);Ve(`mailto:?subject=${t}&body=`,n,1800)}),S&&(S.onclick=async()=>{Ve(`https://wa.me/?text=`,Be(l.filter(e=>u[e.id]).map(e=>({alumno_id:e.id,estado:u[e.id]})),D,l,o),1600)}),T&&(T.onclick=()=>{_.remove(),w(`hoy`)}),E&&(E.onclick=()=>{_.remove(),w(`calendario`)});let k=_.querySelector(`#btn-reporte-dia-overlay`);k&&(k.onclick=async()=>{let e=k.innerHTML;k.disabled=!0,k.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await Ne(C)}finally{k.disabled=!1,k.innerHTML=e}});let A=_.querySelector(`#btn-resumen-mes-overlay`);A&&(m?A.onclick=async()=>{let e=A.innerHTML;A.disabled=!0,A.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await je(m,e.getFullYear(),e.getMonth()+1)}finally{A.disabled=!1,A.innerHTML=e}}:(A.disabled=!0,A.title=`No disponible para actividades especiales`,A.style.opacity=`0.5`));let j=_.querySelector(`#btn-informe-ped-overlay`);j&&(m?j.onclick=async()=>{let e=j.innerHTML;j.disabled=!0,j.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Me(m,e.getFullYear(),e.getMonth()+1)}finally{j.disabled=!1,j.innerHTML=e}}:(j.disabled=!0,j.title=`No disponible para actividades especiales`,j.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};function Re(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function ze(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function Be(e,t,n,r){if(!r)return`No hay datos de clase disponibles.`;let i=(e||[]).filter(e=>e.estado===`P`).length,a=(e||[]).filter(e=>e.estado===`A`).length,o=(e||[]).filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return s+=`Fecha: ${p||``}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}function Ve(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;F.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}r.querySelector(`#pm-asist-back`).onclick=()=>{We.destroy();try{be.close()}catch{}T.forEach(e=>{try{e()}catch{}}),w(`hoy`)},r.querySelector(`#btn-bulk-p`).onclick=async()=>{l.forEach(e=>{u[e.id]=`P`}),Ae(),Fe();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk P:`,e)}an(`Todos los ${l.length} alumnos marcados como presentes.`)},r.querySelector(`#btn-bulk-a`).onclick=async()=>{l.forEach(e=>{u[e.id]=`A`}),Ae(),Fe();try{await Ie(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk A:`,e)}an(`Todos los ${l.length} alumnos marcados como ausentes.`)},Ae();async function He(e){try{let{data:t}=await x.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Ue(e){if(!e||!oe)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await J.getRouteHierarchy(oe),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let We=new mi(r);We.mount();let Ge=r.querySelector(`#pm-btn-help`);return Ge&&(Ge.onclick=()=>We.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),We.destroy();try{be.close()}catch{}T.forEach(e=>{try{e()}catch{}})}}function Ua(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Wa(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Ga(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await x.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Wa(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await ee({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Ka={async open(){let e=await ie(),t=await ne();Se.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await P()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await N();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await oe()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await re({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},qa={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function Ja(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>qa[e])}var Ya={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Qa(n,t),$a(n,t),oo(n,t),eo(r),to(r,t),no(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),ro(r),io(r),ho(t),lo(t),go(),L(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-BqWyDF0U.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&ao(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Qa(e,t){let n=he(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function $a(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function eo(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function to(e,t){let n=M(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function no(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function io(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ao(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await L(async()=>{let{getPermisos:e}=await import(`./permisoService-BqWyDF0U.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));ao(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function oo(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Xa.map(e=>so(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function so(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function lo(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{Z.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>uo(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,po),document.getElementById(`pm-ver-sistema-btn`)?.addEventListener(`click`,()=>{L(async()=>{let{renderSistemaView:e}=await import(`./sistemaView-B1xcqoLz.js`);return{renderSistemaView:e}},__vite__mapDeps([10,11])).then(({renderSistemaView:e})=>{Se.open({title:`<i class="bi bi-cpu-fill me-2"></i>Sistema SOI — v${Pe}`,size:`xl`,saveText:null,cancelText:`Cerrar`,body:`<div id="pm-sistema-modal-body"></div>`,onOpen:t=>{e(t.querySelector(`#pm-sistema-modal-body`))}})})}),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await N();e.success?(Z.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await oe(),Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>Ka.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>Ya.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await P();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>mo(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>mo(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>mo(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await L(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-DjiJlYyE.js`);return{ausenciasPanel:e}},__vite__mapDeps([12,3,13,7,5,14,1,15]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>pe.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,co(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function uo(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=b(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=fo();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}Z.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await s(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await x.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let c={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(w,JSON.stringify(c)),Z.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{Z.saving=!1,a.disabled=!1,a.innerHTML=o}}function fo(){let e={};return Xa.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function po(){Se.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await T(),window.location.reload(),!0)})}function mo(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),Z.theme=e}function ho(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function go(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var _o=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=_o,document.head.appendChild(e)}async function vo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await J.getClasses(t.id),{data:r}=await x.from(`clases`).select(`id, nombre, instrumento`).or(`maestro_principal_id.eq.${t.id},maestro_suplente_id.eq.${t.id},maestro_id.eq.${t.id}`).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let n=await J.getRouteHierarchy(e,t.id);if(!n||n.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let r=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,i=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}var bo=`alumno_plan_entradas`;async function xo(e){let{data:t,error:n}=await x.from(bo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function So(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await x.from(bo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function Co(e){let{error:t}=await x.from(bo).delete().eq(`id`,e);if(t)throw Error(t.message)}var wo={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},To=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],Eo=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await xo(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
    ...
    `}_buildEntry(e){let t=wo[e.tipo]||wo.logro,n=new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`});return`
      ...
      <div class="pe-form-overlay">
        <div class="pe-form">
          ...
          <select class="pe-select" id="pe-tipo">
            ${To.map(e=>`
              <option value="${e}" ${e===t?`selected`:``}>${wo[e].icon} ${wo[e].label}</option>
            `).join(``)}
          </select>
...
`).trim():``}var Po={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Fo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await x.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await x.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Po[n.estado_cualitativo]??Po.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          ...
          <div class="pm-prog-card__timeline">
            ${t.map(e=>{let t=Po[e.estado_cualitativo]??Po.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=l.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
      ...
      `;return}let{data:a}=await x.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await x.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await x.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id, covered_by_clase_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await x.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await x.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,g=c.filter(e=>e.estado===`J`).length,_=c.filter(e=>e.estado===`T`).length,v=p>0?Math.round(m/p*100):0,b=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],S={};b.forEach(e=>{let t=e.covered_by_clase_id||`sin_clase`;S[t]||(S[t]=[]),S[t].push(e.nota)});let C=Object.values(S).map(e=>e.reduce((e,t)=>e+t,0)/e.length),w=C.length>0?Math.round(C.reduce((e,t)=>e+t,0)/C.length*10)/10:0,T=b.filter(e=>e.nota>=4).length,E=b.length,D=E>0?Math.round(T/E*100):0,O={};c.forEach(e=>{O[e.clase_id]||(O[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(O[e.clase_id][e.estado]=(O[e.clase_id][e.estado]||0)+1,O[e.clase_id].total++)});let k=new Set([...o,...Object.keys(O)]),{data:A}=k.size>0?await x.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...k]):{data:[]},j=new Map((A||[]).map(e=>[e.id,e])),ee=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),M=l?.filter(e=>e.observations?.trim())||[],te=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;te=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&te--}let N=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,P=(r.instrumento_principal||``).toLowerCase(),ne=`var(--pm-primary)`;(P.includes(`violin`)||P.includes(`cuerda`))&&(ne=`#FF3B30`),(P.includes(`piano`)||P.includes(`teclado`))&&(ne=`#FF9500`),P.includes(`guitarra`)&&(ne=`#5856D6`),(P.includes(`canto`)||P.includes(`voz`))&&(ne=`#AF52DE`),e.innerHTML=`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${ee.map(e=>{let t=j.get(e.clase_id),n=No(e.contenido_dsl);return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let re=Do(r.tlf_alumno||r.representante_tlf);if(re){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var Lo={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},Ro={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},zo={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function Bo(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(Lo))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function Vo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await x.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await x.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${Bo(e.name)}</div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${Ro[t?.status||`pending`]};"></span>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Jo=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():C(),Yo=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):c(...e),Xo=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):Wo(...e),Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Zo=!1;async function Qo(t,{onTopicSelected:n}={}){if(Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:n},t.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Jo()){t.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(e(),Q.clases=await Yo(!0),!Q.clases?.length){t.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Q.activeClaseId=Q.clases[0].id,await $o(),es(t),is(t),as(t)}catch(e){console.error(`[rutaGameificadaView]`,e),t.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${e.message}</div>`}}async function $o(){Q.loading=!0,Q.rutaId=await Uo(Q.activeClaseId),Q.rutaId?Q.blocks=await Xo(Q.rutaId,Q.activeClaseId):Q.blocks=[],Q.loading=!1}function es(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!Q.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(Q.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}Q.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),qo(r,{blockId:n.id,blockName:n.nombre,isExpanded:Q.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{Q.expandedBlocks.has(t)?Q.expandedBlocks.delete(t):Q.expandedBlocks.add(t),es(e)}}),Q.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(ts(n,e))})}}),ns(e)}function ts(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=Q.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${rs(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${rs(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${rs(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Q.expandedLevels.has(e.id)?Q.expandedLevels.delete(e.id):Q.expandedLevels.add(e.id),es(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Q.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},es(t)})}),n}function ns(e){let t=e.querySelector(`#ruta-action-panel`);if(!Q.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,es(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{la({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function rs(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function is(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await $o(),es(e),is(e)})}function as(e){Zo||(Zo=!0,Ko.on(`node-covered`,()=>{$o().then(()=>{es(e),is(e)})}))}var os=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function ss(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await x.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${os.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function cs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await R.getStudent(t),r=await R.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await x.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await R.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await R.createAcademicPlan(t,u),await x.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${I(t.message)}</p></div>`}}async function ls(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await x.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await R.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await x.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await R.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},ds={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([R.getRouteDetail(t),n?R.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}};function fs(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ps(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function ms(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var hs=null,gs=[],_s=new Set;async function vs(e){e.innerHTML=js();let t=C();if(!t){e.innerHTML=Ms(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await de(t.id);if(!n.puede_inscribir_clases){e.innerHTML=bs(n),xs(t.id);return}let[r,i]=await Promise.all([m(t.id),Ae().catch(()=>[])]);gs=i.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=Ss(r),Os(r),r.length>0&&await ws(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=Ms(`bi-exclamation-triangle`,`Error al cargar`,fs(t.message))}}function ys(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function bs(e){return`
    <div class="gcv-root">
  ...
  `}function xs(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await ue(e,`clases:enroll`),F.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){F.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function Ss(e){return`
    <div class="gcv-root">
      ...
      ${e.length===0?Ms(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function Cs(e){let t=fs(e.nombre||`Clase sin nombre`),n=ms(e.horarios||[]),r=fs(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function ws(e,t){hs=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await _(e),a=i.map(e=>e.alumno).filter(Boolean);_s=new Set(i.map(e=>e.alumno_id)),n.innerHTML=Ts(r,a,gs.filter(e=>!_s.has(e.id))),ks(e,t)}catch(e){n.innerHTML=Ms(`bi-exclamation-circle`,`Error al cargar alumnos`,fs(e.message))}}}function Ts(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${fs(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>Es(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>Ds(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function Es(e){let t=fs(e.nombre_completo||e.nombre||`Alumno`),n=fs(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${ps(t)}</div>
  ...
  `}var Ns=[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`gestionar-clases`],Ps=new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]);function Fs(e,t,n){[`login`,`logout`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`gestionar-clases`,`register`,`pending-approval`].forEach(t=>e.on(t,(e,r)=>n(t,r))),e.on(`ruta-detalle/:id`,(e,t)=>n(`ruta-detalle`,t)),e.onNotFound(()=>n(`hoy`))}function Is(){let e=document.getElementById(`pm-view-container`);if(!e)return{};e.innerHTML=``;let t={};return Ns.forEach(n=>{let r=document.createElement(`div`);r.id=`pm-view-${n}`,r.className=`pm-view-content`,r.style.display=`none`,e.appendChild(r),t[n]=r}),t}async function Ls(e,t,n,r,i){let{maestroId:a,permisos:o,router:s,showLoginScreen:c,cleanupPushService:l,stopRealtime:u,logoutMaestro:d}=i;switch(e){case`login`:xn(t,{onSuccess:i.onLoginSuccess});break;case`register`:Sn(t,{onSuccess:()=>s.navigate(`pending-approval`)});break;case`pending-approval`:Cn(t,{onBackToLogin:()=>s.navigate(`login`)});break;case`logout`:c(),l(),u(),d().then(()=>window.location.reload());break;case`calendario`:case`clases`:return await zn(t);case`hoy`:return await Dn(t,{onClaseClick:e=>s.navigate(`asistencia?clase=${e}`)});case`asistencia`:return await Va(t,{claseId:r.get(`clase`),fecha:r.get(`fecha`),sesionId:r.get(`sesion`),router:s});case`metricas`:return mn(t);case`perfil`:return Za(t);case`clase-emergente`:return Ga(t,{maestroId:a});case`planificacion`:return await vo(t);case`alumno`:return Io(t,{alumnoId:r.get(`id`)||n.id});case`gamificacion`:await Vo(t);break;case`ruta`:await Qo(t,{onTopicSelected:e=>s.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:ss(t);break;case`ruta-plan-builder`:cs(t,{alumnoId:r.get(`id`)});break;case`ruta-semanal`:ls(t,{alumnoId:r.get(`id`)});break;case`ruta-libreria`:us.render().then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`ruta-detalle`:ds.render(n).then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`gestionar-clases`:if(!o?.puede_inscribir_clases){s.navigate(`hoy`);return}return await vs(t);default:break}return null}var Rs=!1,zs=null;function Bs({isAdmin:e,getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i,onResize:a}){if(Rs)return;Rs=!0,jt(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=Rt();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Nt(),Bt(),e||Vs({getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i}),document.addEventListener(`keydown`,e=>{if(gn()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`){let n={h:`hoy`,c:`calendario`,r:`ruta`,m:`metricas`,p:`perfil`}[e.key.toLowerCase()];n&&(i(n),t.length=0)}t.length>3&&t.splice(0,t.length-2)});let o=null,s=gn();window.addEventListener(`resize`,()=>{clearTimeout(o),o=setTimeout(()=>{let e=gn();e!==s&&(s=e,a())},250)},{passive:!0})}function Vs({getMaestro:e,getPermisosCached:t,onPermisosUpdate:n,onNavigate:r}){let i=e();i?.id&&(zs&&=(x.removeChannel(zs),null),zs=x.channel(`permisos-maestro:${i.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${i.id}`},async e=>{console.log(`[Realtime] Permisos actualizados:`,e.new);try{let e=await de(i.id),r=t(),a=[],o=[];e.puede_inscribir_clases&&!r?.puede_inscribir_clases&&a.push(`Gestionar e Inscribir Clases`),r?.puede_inscribir_clases&&!e.puede_inscribir_clases&&o.push(`Gestionar e Inscribir Clases`),await n(e,{ganados:a,perdidos:o}),a.length>0?F.success(`¡Nuevos permisos activados: ${a.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):o.length>0?F.show(`El administrador removió tu acceso a: ${o.join(`, `)}.`,`warning`):F.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>console.log(`[Realtime] Canal permisos_maestros:`,e)),window.addEventListener(`beforeunload`,()=>x.removeChannel(zs),{once:!0}))}if(v(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;Xe(),Ke({windowMs:6e4,max:100}),We({enabled:!1,consent:!1}),$e({debug:!1}),Ve({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&F.show(t,n)});var Hs=null,Us=null,Ws=!1,$=dt();window.router=$;var Gs={},Ks=null,qs=new Set;function Js(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}async function Ys(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await x.from(t).insert([i]);if(e)throw e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await x.from(t).update(n).eq(`id`,e);if(r)throw r}else if(n===`delete`){let{error:e}=await x.from(t).delete().eq(`id`,i.id);if(e)throw e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await x.from(t).select().limit(1);e?.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico:`,e),e}}var Xs=null;async function Zs(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await A();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function Qs(){clearTimeout(Xs),Xs=setTimeout(async()=>{if(navigator.onLine)try{await k(Ys)}finally{await Zs()}},1e3)}window.addEventListener(`online`,Qs),window.addEventListener(`offline`,Zs);function $s(){qs.clear()}function ec(e){qs.delete(e)}async function tc(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e?.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}vn(a),window.pwaInstaller?.evaluateInsights()}let o=Gs[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Ks==`function`&&(Ks(),Ks=null),Object.values(Gs).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),qs.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{let e=await Ls(a,o,t,i,{maestroId:Hs?.id,permisos:Us,router:$,showLoginScreen:rc,cleanupPushService:ce,stopRealtime:()=>{},logoutMaestro:lt,onLoginSuccess:()=>oc()});e&&(Ks=e),clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),Ps.has(a)&&qs.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}function nc(e,t,n){Hs=t,Us=n||Us,yn(e,t,Js(Us),(e,t)=>$.navigate(e,t),Zs),document.getElementById(`pm-sync-indicator`)?.addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await Qs()});let r=($.currentRoute?.()||`hoy`).split(`?`)[0];vn(r)}function rc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=($.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Gs,Is()),ic(),$.setAuthGuard(()=>ct.isAuthenticated(),t),$.start();return}let r=Gs.login;if(r){_n(),r.style.display=`block`,r.innerHTML=``,Ls(`login`,r,{},new URLSearchParams,{router:$,onLoginSuccess:e=>{e&&e!==`login`?$.navigate(e):oc()}});return}e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`,Object.assign(Gs,Is()),ic(),$.setAuthGuard(()=>ct.isAuthenticated(),t),history.replaceState({route:`login`},``,`#/login`),tc(`login`)}function ic(){Fs($,Ws,tc)}async function ac(){if(Hs)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[i,a,s]=await Promise.all([c(),c().then(e=>r(e.map(e=>e.id))),c().then(()=>o(Hs.id,n,n))]),l=Object.fromEntries(i.map(e=>[e.id,e]));await le(a.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:l[e.clase_id]?.nombre||`Clase`})),s.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}async function oc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`);let t=await ct.init();if(console.log(`[Init] Auth:`,t?`con maestro`:`sin maestro`),ct.isPendingApproval()){console.log(`[Init] Cuenta pendiente de aprobación — mostrando pantalla de espera`),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Gs,Is(!1)),ic(),history.replaceState({route:`pending-approval`},``,`#/pending-approval`),tc(`pending-approval`);return}let n=[`login`,`register`,`pending-approval`],r=(window.router||$).currentRoute().split(`?`)[0],i=n.includes(r);if(!t&&!i){rc();return}if(!t&&i){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Gs,Is()),ic(),$.setAuthGuard(()=>ct.isAuthenticated(),n),$.start();return}if(t.es_admin&&!t.es_maestro){console.log(`[Init] Admin puro detectado → redirigiendo a /admin`),window.location.href=`/admin`;return}let a=null;try{a=await de(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}nc(e,t,a),Object.assign(Gs,Is()),Bs({isAdmin:!1,getMaestro:()=>Hs,getPermisosCached:()=>Us,onPermisosUpdate:async(t,{ganados:r,perdidos:i})=>{let a=($.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`gestionar-clases`&&!t.puede_inscribir_clases||a===`pending-approval`&&r.length>0?`hoy`:a;nc(e,Hs,t),Object.assign(Gs,Is()),ic(),$.setAuthGuard(()=>ct.isAuthenticated(),n),qs.clear(),await tc(o),$.navigate(o)},onNavigate:e=>$.navigate(e),onResize:()=>{nc(e,Hs,Us),Object.assign(Gs,Is());let t=($.currentRoute?.()||`hoy`).split(`?`)[0];vn(t)}}),pt(ec,$s),ic(),$.setAuthGuard(()=>ct.isAuthenticated(),n),$.start();let o=($.currentRoute?.()||``).split(`?`)[0];(!o||o===`login`||o===`logout`)&&$.navigate(`hoy`),d().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=($.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!qs.has(e)).reduce((e,t)=>e.then(()=>{if(Gs[t])return tc(t,{},{silent:!0})}),Promise.resolve()),ac(),window.pwaInstaller?.evaluateInsights()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),Qs()}var sc=(e,t,n,r)=>`
  ...
  </div>`;window.addEventListener(`error`,e=>{if([`useCache`,`WebSocket`,`content.js`].some(t=>(e.message||``).includes(t))){console.warn(`[Ignored Error]`,e.message);return}He(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=sc(`bi-x-circle-fill`,`Ups! Algo salió mal`,`Se ha producido un error inesperado en la aplicación.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">${e.message}</div><div style="color:rgba(255,255,255,0.4);">${e.filename?.split(`/`).pop()}:${e.lineno}</div>`))}),window.addEventListener(`unhandledrejection`,e=>{He(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=sc(`bi-exclamation-triangle-fill`,`Error de Sincronización`,`Hubo un problema al procesar una solicitud de red.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">Promise Rejection</div><div style="color:rgba(255,255,255,0.4);">${String(e.reason)}</div>`))}),oc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});