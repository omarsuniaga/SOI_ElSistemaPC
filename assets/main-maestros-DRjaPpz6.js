...
import{A as e,At as t,C as n,Ct as r,Dt as i,Et as a,F as o,Ft as s,I as c,It as l,J as u,M as d,Mt as f,N as p,Nt as m,Ot as h,Pt as g,S as _,Tt as v,X as y,_t as b,a as x,at as S,bt as C,c as w,ft as T,i as E,j as D,jt as O,kt as ee,m as k,mt as te,o as ne,q as re,s as ie,t as ae,vt as oe,z as se}from"./adminNotificacionesView-WbFl3kqR.js";import{i as A}from"./supabase-BryBf0UA.js";import{a as ce,i as le,n as ue,r as j,t as de}from"./maestroAuth-C_VNWKdh.js";import"./vendor-CAKU_njC.js";import{t as fe}from"./idb-BJPCiZxS.js";import{a as pe,n as me,r as he,t as ge}from"./offlineQueue-CfcIbhXO.js";import{a as _e,c as ve,d as ye,f as be,i as xe,l as M,n as Se,o as Ce,p as we,r as Te,t as Ee,u as De}from"./pushService-BMnXDTUe.js";import{r as Oe,t as ke}from"./permisoService-BqWyDF0U.js";import{t as N}from"./AppToast-L43yfvBt.js";import{n as Ae,t as je}from"./ausenciaModal-Bp4HF47W.js";import{a as Me,c as Ne,i as P,l as Pe,n as Fe,o as Ie,r as Le,s as Re,t as ze}from"./portalUtils-BqwkK1cV.js";import{t as F}from"./preload-helper-CQ36nxok.js";import{t as I}from"./academicService-lra55_F4.js";import{t as Be}from"./AppModal-BohrepL3.js";import{a as Ve,c as He,i as Ue,o as We,s as Ge,t as Ke}from"./groqService-CNWH1ut_.js";import{n as qe,r as Je,t as Ye}from"./reportService-BzF98mXg.js";var Xe=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ze(e=``){let t=String(e).toLowerCase();return Xe.some(e=>t.includes(e.toLowerCase()))}var Qe=console.error;console.error=function(...e){e.length>0&&!Ze(e[0])&&Qe.apply(console,e)};var $e=console.warn;console.warn=function(...e){e.length>0&&!Ze(e[0])&&$e.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ze(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ze(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var et=window.fetch;window.fetch=async function(...e){try{return await et.apply(window,e)}catch(e){if(!Ze(e.message))throw e;return null}};var tt=!1;function nt(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),tt=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function rt(e,t={}){if(!tt&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var it=!1;function at(e={}){let{enabled:t=!1,consent:n=!1}=e;it=t&&n,console.log(`[Analytics] Initialized, enabled:`,it)}var ot={windowMs:6e4,max:100};function st(e={}){ot={...ot,...e},console.log(`[RateLimit] Initialized: ${ot.max} requests per ${ot.windowMs}ms`)}var ct=null,lt=new Set;function ut(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function dt(e={}){ct=ut(e.length||32),lt.clear(),lt.add(ct),console.log(`[CSRF] Initialized`)}var ft={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function pt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function mt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!pt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ht(t,n),gt(t,n),_t(t,n),vt(t,n),yt(t,n)}function ht(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];ft.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function gt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ft.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function _t(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);ft.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function vt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ft.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function yt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ft.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var L={maestro:null,loading:!0,listeners:[]},bt=null,xt=!1;function St(){L.listeners.forEach(e=>e({...L}))}var Ct={subscribe(e){return L.listeners.push(e),()=>{L.listeners=L.listeners.filter(t=>t!==e)}},async init(){xt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),L.maestro=j(),console.log(`[usePortalAuth.init] Maestro local:`,L.maestro?`found`:`not found`),L.loading=!0,St(),typeof process<`u`&&{}.VITEST)return L.loading=!1,St(),console.log(`[usePortalAuth.init] Completado (Test Env)`),L.maestro;if(!bt){let{data:{subscription:e}}=A.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),xt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),L.maestro=null,St();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=j();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await ue();e&&(L.maestro=e,St())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});bt=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([ue(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),L.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),L.maestro=null}return L.loading=!1,St(),console.log(`[usePortalAuth.init] Completado`),L.maestro}finally{xt=!1}},setMaestro(e){L.maestro=e,L.loading=!1,St()},async logout(){await ce(),L.maestro=null,St()},getMaestro:()=>L.maestro,isAuthenticated:()=>!!L.maestro,isLoading:()=>L.loading},wt=Ct.logout,Tt=`calendario`;function Et(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):Tt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:Tt},``,`#/${Tt}`),h(Tt);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var Dt=`pm-modo`;function Ot(e){return e?.es_admin?e?.es_maestro&&localStorage.getItem(`pm-modo`)||`admin`:`maestro`}function kt(e){localStorage.setItem(Dt,e),e===`admin`?window.location.href=`/admin`:window.location.reload()}var At=null;function jt(e,t){At=e}function Mt(e){At&&At(e)}var Nt=null,Pt=!1,Ft={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};function It(e){if(!e)return``;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function Lt(e){return e===`alta`?`<i class="bi bi-exclamation-circle-fill" style="color:#ef4444"></i>`:e===`media`?`<i class="bi bi-exclamation-circle-fill" style="color:#f59e0b"></i>`:`<i class="bi bi-info-circle-fill" style="color:#22c55e"></i>`}function Rt(){if(document.getElementById(`admin-ausencias-insights-styles`))return;let e=document.createElement(`style`);e.id=`admin-ausencias-insights-styles`,e.textContent=`
  ...
  `,requestAnimationFrame(()=>{t.classList.add(`visible`)}),t.querySelector(`#aai-btn-revisar`)?.addEventListener(`click`,()=>{Ht(),window.router&&window.router.navigate(`admin-ausencias`)}),t.querySelector(`#aai-btn-dismiss`)?.addEventListener(`click`,()=>{Ut()})}function Ht(){Nt&&Nt.classList.remove(`visible`)}function Ut(){Ht();let e=Date.now()+1800*1e3;localStorage.setItem(`admin-ausencias-insights-dismiss`,String(e))}function Wt(){let e=localStorage.getItem(`admin-ausencias-insights-dismiss`);return e?Date.now()<Number(e):!1}var Gt={init(){window.adminAusenciasInsights=this,Rt(),Bt(),this.evaluate()},async evaluate(){if(!Pt){Pt=!0;try{if((window.router?.currentRoute?.()??``).split(`?`)[0]===`admin-ausencias`){Ht(),zt((await i())?.length??0);return}if(Wt())return;let e=await i();if(zt(e?.length??0),!e||e.length===0){Ht();return}Vt(e)}catch(e){console.warn(`[adminAusenciasInsights] Error evaluando:`,e),Ht()}finally{Pt=!1}}}},Kt=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function qt(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Jt(e){let{claseId:t,fecha:n,isValid:r}=qt(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}Ce(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),nn(e.notification);let t=e.notification;t?.data?.deep_link?Jt(t.data.deep_link):t?.data?.deep_link_url&&Jt(t.data.deep_link_url),R.some(t=>t.id===e.notification.id)||(R.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),un())}});var Yt=new a(`maestro-notifications`),Xt=30*1e3,Zt=60*1e3,Qt=120*1e3,$t=new Map;function en(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Zt)}`}function tn(){let e=Date.now();for(let[t,n]of $t.entries())e>n&&$t.delete(t)}function nn(e){let t=en(e),n=Date.now()+Qt;$t.set(t,n)}function rn(){return tn(),$t.size}function an(e){return`notif_cache_${e}`}function on(e){try{let t=R.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(an(e),JSON.stringify(t))}catch{}}function sn(e){try{let t=localStorage.getItem(an(e));return t?JSON.parse(t):[]}catch{return[]}}var R=[],cn=[];function ln(e){return cn.push(e),e(R),()=>{cn=cn.filter(t=>t!==e)}}function un(){cn.forEach(e=>e([...R]))}async function dn(){let e=j();if(!e)return[];R.length===0&&(R=sn(e.id),R.length>0&&un());try{let{data:t,error:n}=await A.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),R;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=R.filter(e=>String(e.id).startsWith(`local_`));return R=[...r,...i],await fn(e.id),on(e.id),un(),R}catch(e){return console.error(`[NotifService]`,e),R}}async function fn(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([O(),m(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await ee(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(R.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let d=e.hora_fin?e.hora_fin.slice(0,5):``,f=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=f&&d?` (${f}–${d})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;R.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(R.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=Math.round(a);R.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${d} ${d===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function pn(e){let t=j(),n=R.find(t=>t.id===e);if(n&&(n.estado=`leida`),un(),t&&on(t.id),!String(e).startsWith(`local_`))try{await A.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function mn(e){let t=j();if(R=R.filter(t=>t.id!==e),un(),t&&on(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await A.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function hn(){let e=j();if(R.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),un(),e&&on(e.id),e)try{await A.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function gn(){return R.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var _n=null;function vn(){let e=j();e&&(_n||(_n=A.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};R.some(e=>e.id===n.id)||(R.unshift(n),on(e.id),un(),yn(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=R.findIndex(e=>e.id===t.new.id);n!==-1&&(R[n]={...R[n],...t.new},on(e.id),un())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),_n=null,wn())}),Yt.registerChannel(_n)))}function yn(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=bn(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function tr(e,{onClaseClick:n}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let r=j();if(!r){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let i=new Date,a=i.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),o=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,`0`)}-${String(i.getDate()).padStart(2,`0`)}`;try{let s=await h(r.id,o);if(s&&s.length>0){e.innerHTML=nr(s,a,i),ir(e,o,r.id);return}let c=await O();if(!c||c.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let l=c.map(e=>e.id),u=Object.fromEntries(c.map(e=>[e.id,e])),d=(await ee(l)).filter(e=>e.dia?.toLowerCase()===a).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!d||d.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${Le(a)} ${Me(i)}</h2>
        <p class="pm-empty">No tienes clases hoy.</p>
      `;return}let p=new Date(i);p.setDate(p.getDate()-3);let g=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,_=new Date(i);_.setDate(_.getDate()-1);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=(await m(r.id,g,v)||[]).filter(e=>{if(!l.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),b=(await m(r.id,o,o)).filter(e=>l.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),x=new Set(b.map(e=>e.clase_id)),S=await t(l),C={};for(let e of S||[])e.clase_id&&(C[e.clase_id]=(C[e.clase_id]||0)+1);let w=[...new Set(d.map(e=>e.salon_id).filter(Boolean))],T=w.length>0?await f(w):[],E=Object.fromEntries(T.map(e=>[e.id,e.nombre])),D=d.map(e=>{let t=u[e.clase_id],n=x.has(t.id),r=C[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
        <div class="pm-clase-card ${i}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            <div class="meta-item"><i class="bi bi-clock"></i> ${Ie(e.hora_inicio)} – ${Ie(e.hora_fin)}</div>
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${P(E[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),k=y.length>0?`
      <div class="pm-pendientes-banner">
        ...
        <div class="pm-pendientes-list">
          ${y.map(e=>{let t=u[e.clase_id];if(!t)return``;let n=e.fecha?e.fecha.split(`-`).reverse().slice(0,2).join(`/`):`—`;return`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,n=e.dataset.fecha;try{await I.createSnapshotFromPlan(t,n,r.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${n}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let t=e.dataset.claseId;try{await I.createSnapshotFromPlan(t,o,r.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),n?.(t)})})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${P(t.message)}</p>`}}function nr(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=rr(e.motivo);return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${Le(t)} ${Me(n)}</h2>
  ...
  `,document.head.appendChild(e)}var ar=null,or=null;function sr(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;ar=o,or=a,Be.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
    ...
    `,onShow:e=>{let t=e.querySelector(`#modal-es_co-docencia`),n=e.querySelector(`#codocencia-fields`),r=e.querySelector(`#modal-alumnos-lista`),a=e.querySelector(`#modal-alumnos-buscar`),o=e.querySelector(`#modal-seleccionar-todos`),s=e.querySelector(`#modal-alumnos-resumen`);t?.addEventListener(`change`,e=>{n.style.display=e.target.checked?`block`:`none`});let c=Array.from(new Map((i||[]).filter(Boolean).map(e=>[e.id,e])).values()).sort((e,t)=>(e.nombre_completo||``).localeCompare(t.nombre_completo||``)),l=new Set,u=()=>{let e=l.size;s.textContent=e>0?`${e} alumno(s) seleccionado(s).`:`Selecciona al menos un alumno para crear el registro.`},d=()=>{let e=(a?.value||``).trim().toLowerCase();return c.filter(t=>e?[t.nombre_completo||``,t.instrumento_principal||``,...t.clase_nombres||[]].join(` `).toLowerCase().includes(e):!0)},f=()=>{let e=d(),t=e.length>0&&e.every(e=>l.has(e.id));o.checked=t,o.indeterminate=!t&&e.some(e=>l.has(e.id))},p=()=>{let t=d();r.innerHTML=t.length?t.map(e=>`
          ...
          `).join(``):`<p class="pm-emergente-hint" style="margin:0;">No hay alumnos que coincidan con los filtros.</p>`,r.querySelectorAll(`.modal-alumno-check`).forEach(t=>{t.addEventListener(`change`,()=>{t.checked?l.add(t.value):l.delete(t.value),e.dataset.selectedAlumnoIds=Array.from(l).join(`,`),f(),u()})}),f(),u()};o?.addEventListener(`change`,()=>{let t=d();o.checked?t.forEach(e=>l.add(e.id)):t.forEach(e=>l.delete(e.id)),e.dataset.selectedAlumnoIds=Array.from(l).join(`,`),p()}),a?.addEventListener(`input`,p),p()},onSave:async e=>{let t=(e.dataset.selectedAlumnoIds||``).split(`,`).map(e=>e.trim()).filter(Boolean),n={fecha:e.querySelector(`#modal-fecha`).value,actividad:e.querySelector(`#modal-clase_id`).value,clase_id:null,hora_inicio:e.querySelector(`#modal-hora_inicio`).value,hora_fin:e.querySelector(`#modal-hora_fin`).value,tema_principal:e.querySelector(`#modal-tema`).value.trim(),contenido:e.querySelector(`#modal-contenido`).value.trim(),motivo:e.querySelector(`#modal-motivo`).value.trim(),es_codocencia:e.querySelector(`#modal-es_co-docencia`).checked,maestro_auxiliar_id:e.querySelector(`#modal-maestro_auxiliar_id`)?.value||null,estado:`pendiente`,maestro_id:or,asistencia:t.map(e=>({alumno_id:e,estado:null}))};return!n.fecha||!n.actividad||!n.hora_inicio||!n.hora_fin||!n.tema_principal||!n.motivo?(N.error(`Todos los campos obligatorios deben completarse`),!1):t.length===0?(N.error(`Selecciona al menos un alumno participante`),!1):n.hora_inicio>=n.hora_fin?(N.error(`La hora de inicio debe ser menor que la hora de fin`),!1):(ar&&await ar(n),!0)}})}function cr(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}var lr=[`domingo`,`lunes`,`martes`,`miercoles`,`jueves`,`viernes`,`sabado`];async function ur(e,t){let n=[],r=0,[i,a,o]=e.fecha.split(`-`).map(Number),s=lr[new Date(i,a-1,o).getDay()],{data:c,error:l}=await A.from(`clases`).select(`id, nombre`).or(`maestro_principal_id.eq.${t},maestro_suplente_id.eq.${t},maestro_id.eq.${t}`);if(l||!c?.length)return{justificadas:0,errores:[]};let u=c.map(e=>e.id),{data:d,error:f}=await A.from(`clase_horarios`).select(`clase_id, hora_inicio, hora_fin`).in(`clase_id`,u).eq(`dia`,s);if(f||!d?.length)return{justificadas:0,errores:[]};let p=d.map(e=>({...e,nombre:c.find(t=>t.id===e.clase_id)?.nombre||``}));for(let i of p)try{let{data:a}=await A.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,i.clase_id).eq(`activo`,!0),o=(a||[]).map(e=>({alumno_id:e.alumno_id,estado:`justificado`})),s=`Clase suspendida por actividad especial: "${e.actividad||`Actividad especial`}".`+(e.motivo?` Motivo: ${e.motivo}.`:``)+` Todos los alumnos quedan justificados.`,{error:c}=await A.from(`sesiones_clase`).upsert({clase_id:i.clase_id,fecha:e.fecha,maestro_id:t,emergente_id:e.id,hora_inicio:i.hora_inicio,hora_fin:i.hora_fin,estado:`registrada`,borrador:!1,asistencia:o,contenido:s},{onConflict:`clase_id,fecha,maestro_id`});c?n.push(`${i.nombre}: ${c.message}`):r++}catch(e){n.push(`${i.nombre}: ${e.message}`)}return{justificadas:r,errores:n}}var dr=[`Do`,`Lu`,`Ma`,`Mi`,`Ju`,`Vi`,`Sa`],fr=7;async function pr(e,{onFechaClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=j();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.getFullYear(),a=r.getMonth();async function o(){try{let s=await mr(n.id,i,a);hr(e,i,a,r,s,{onFechaClick:e=>{gr(e),t?.(e)},onPrev:()=>{a===0?(i--,a=11):a--,o()},onNext:()=>{a===11?(i++,a=0):a++,o()}})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar calendario: ${P(t.message)}</p>`}}await o()}async function mr(e,t,n){let r=new Date(t,n,1),i=new Date(t,n+1,0),a=r.toISOString().split(`T`)[0],o=i.toISOString().split(`T`)[0],s=(await O()).map(e=>e.id);if(s.length===0)return new Map;let c=await ee(s),l=new Set(c.map(e=>e.dia?.toLowerCase())),u=new Map;c.forEach(e=>{let t=e.dia?.toLowerCase(),n=e.hora_fin||`23:59`;(t&&!u.has(t)||n>u.get(t))&&u.set(t,n)});let d=await m(e,a,o),f=d.filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return e.estado===`registrada`||e.estado===`cerrada`||t||e.borrador===!1&&n}),p=new Set(f.map(e=>e.fecha)),h=new Set(d.filter(e=>e.clase_id&&e.emergente_id).map(e=>e.fecha)),g=new Map;d.filter(e=>!e.clase_id).forEach(e=>{g.has(e.fecha)||g.set(e.fecha,[]),g.get(e.fecha).push(e)});let _=new Map,v=new Date;v.setHours(0,0,0,0);for(let e=new Date(r);e<=i;e.setDate(e.getDate()+1)){let t=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,n=ze[e.getDay()],r=l.has(n),i=g.get(t)||[];if(!r&&i.length===0){_.set(t,`sin-clase`);continue}let a=new Date(e),o=Math.floor((v-a)/864e5);if(o===0){let e=d.find(e=>e.fecha===t);if(e&&Array.isArray(e.asistencia)&&e.asistencia.length>0){_.set(t,`registrada`);continue}if(h.has(t)){_.set(t,`cubierta-emergente`);continue}let r=u.get(n);if(r){let e=new Date,[n,i]=r.split(`:`),a=parseInt(n)*60*60*1e3+parseInt(i||0)*60*1e3;if(e.getHours()*60*60*1e3+e.getMinutes()*60*1e3<a){_.set(t,`sin-clase`);continue}}_.set(t,`pendiente`);continue}if(o>0&&h.has(t)){_.set(t,`cubierta-emergente`);continue}if(o>0&&p.has(t)){_.set(t,`registrada`);continue}o<0?_.set(t,`sin-clase`):o<=fr?_.set(t,`pendiente`):_.set(t,`vencida`)}return _}function hr(e,t,n,r,i,{onFechaClick:a,onPrev:o,onNext:s}){let c=new Date(t,n,1),l=new Date(t,n+1,0),u=c.getDay(),d=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`,f=l.getDate(),p=`${t}-${String(n+1).padStart(2,`0`)}-01`,m=`${t}-${String(n+1).padStart(2,`0`)}-${String(f).padStart(2,`0`)}`,h=d>=p&&d<=m?d:p,g=dr.map(e=>`<div class="pm-cal-day-header">${e}</div>`).join(``);for(let e=0;e<u;e++)g+=`<div class="pm-cal-day otro-mes"></div>`;for(let e=1;e<=f;e++){let r=`${t}-${String(n+1).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,a=i.get(r)||`sin-clase`,o=r===d?`today`:``,s=r===h,c=`${e} de ${Fe[n]} ${t}`;g+=`
    ...
    <div class="pm-calendar-wrapper">
      ...
      <div class="pm-cal-grid-container">
        <div class="pm-cal-grid" role="grid" aria-label="Calendario ${Fe[n]} ${t}">
          ${g}
        </div>
      </div>
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function Ui(e,t=null,n=[],i=[],a={},o){let s=e===`edit`&&!!t,c=s?t:{...a};!s&&a.contenido&&!c.notas_dsl&&(c.notas_dsl=a.contenido),!s&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let l=new v(c),u=document.getElementById(`pm-planificacion-modal`);if(u&&u.remove(),u=document.createElement(`div`),u.id=`pm-planificacion-modal`,u.className=`pm-plan-modal-overlay`,u.innerHTML=Gi(s,l,n,i),document.body.appendChild(u),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Ki(),document.head.appendChild(e)}let d=()=>{u.classList.remove(`open`),setTimeout(()=>u.remove(),200)};u.querySelector(`.pm-plan-close-x`).onclick=d,u.querySelector(`.pm-plan-cancel-btn`).onclick=d,u.querySelector(`.pm-plan-backdrop`).onclick=d;let f=e=>{e.key===`Escape`&&(d(),document.removeEventListener(`keydown`,f))};document.addEventListener(`keydown`,f);let p=u.querySelector(`#pl-plantilla`);p&&p.addEventListener(`change`,e=>{let t=Hi.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(u.querySelector(`#pl-objetivos`).value=t.objetivos,u.querySelector(`#pl-contenido`).value=t.contenido,u.querySelector(`#pl-recursos`).value=t.recursos,u.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Ji(u))});let m=u.querySelector(`#pl-clase_id`);m&&m.addEventListener(`change`,()=>{let e=u.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Yi(n,m.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),qi(u);let h=u.querySelector(`#dsl-editor-container`);if(h){let e=te({onSelect:async e=>{let n=(await oe()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=r({initialContent:l.notas_dsl||``,onChange:(e,t)=>{let n=u.querySelector(`#dsl-summary`);n&&(n.textContent=Zi(t))},onAlumnoClick:()=>e.openModal()});h.appendChild(t),u._dslEditor=t}let g=u.querySelector(`.pm-plan-save-btn`);g.onclick=async()=>{let e=u.querySelector(`#pl-tema`)?.value.trim(),t=u.querySelector(`#pl-clase_id`)?.value;if(!e){u.querySelector(`#pl-tema`).focus();return}if(!t){u.querySelector(`#pl-clase_id`).focus();return}g.disabled=!0,g.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=u.querySelector(`#pl-recursos`)?.value||``,r=u._dslEditor,i={clase_id:t,maestro_id:u.querySelector(`#pl-maestro_id`)?.value||null,instrumento:u.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:u.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:u.querySelector(`#pl-objetivos`)?.value.trim(),contenido:u.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:u.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:u.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:s&&u.querySelector(`#pl-estado`)?.value||`planificado`};o&&await o(i),d()}catch(e){console.error(`[planificacionModal] Error:`,e),g.disabled=!1,g.textContent=s?`Guardar cambios`:`Guardar`}};let _=u.querySelector(`.pm-plan-body`);if(_){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;_.firstChild;)t.appendChild(_.firstChild);let r=document.createElement(`div`);r.style.cssText=`flex:1;min-width:0`,r.appendChild(t),e.appendChild(r),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),_.appendChild(e);let i=u.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=n.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&Wi(t.instrumento,t.plan_estudio,u)}),l.clase_id)){let e=n.find(e=>e.id===l.clase_id);e?.instrumento&&e?.plan_estudio&&Wi(e.instrumento,e.plan_estudio,u)}}requestAnimationFrame(()=>{u.classList.add(`open`),u.querySelector(`#pl-tema`)?.focus()})}async function Wi(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await T(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
  ...
  `,await ta()}async function $i(e,t,n,r){Be.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:let e=j();await K.addClass(i,e?e.id:null);break;case`Nivel`:await K.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await K.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await K.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await K.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function ta(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=j(),n=await K.getClasses(t?t.id:null);!n.some(e=>e.id===q.activeClassId)&&n.length>0?q.activeClassId=n[0].id:n.length===0&&(q.activeClassId=null),e.innerHTML=`
...
`)}function r(e,t){let n=Aa[e.estado]||Aa.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${ja[e.estado]||``}`:`ssp-alumno-chip`}">${Na(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Na(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Na(e.tarea)}</div>`:``;return`
  ...
  `,document.head.appendChild(e)}function Ra({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function za(e,t,n){let{data:r,error:i}=await A.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await A.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await A.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function Ba(e,t){let{data:n,error:r}=await A.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function Va(e){let{error:t}=await A.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function Ha(e,t,n,r,i=null,a=null){try{let{error:o}=await A.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await A.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await ge({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}var Ua=`soi_ruta_tema_pendiente`;function Wa(e){sessionStorage.setItem(Ua,JSON.stringify(e))}function Ga(){let e=sessionStorage.getItem(Ua);if(!e)return null;sessionStorage.removeItem(Ua);try{return JSON.parse(e)}catch{return null}}function Ka(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
`),s=[];for(let e of o){let t=Cr(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:ao({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function so({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await A.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:eo(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=eo(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await A.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var co={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},lo=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Y(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var uo={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function fo(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=uo[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function po(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n.join(`, `))}</span>`:``}}function o(e,t){let n=co[e.estado]??co.EN_PROGRESO,r=e.nota?` · ${Y(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Y(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=uo[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
  ...
  `,document.head.appendChild(e)}async function ho(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await A.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${P(n.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${p?`📍 ${P(p)} · `:``}
            ${r?`${Ie(r.hora_inicio)} – ${Ie(r.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${Me(new Date(c+`T12:00:00`))}</span> · 
            ${i.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let E=e.querySelector(`#pm-sync-badge-container`);if(E){let e=vr();E.appendChild(e.el)}let D=e.querySelector(`#pm-dsl-toolbar-container`),ee=e.querySelector(`#pm-dsl-editor-container`),k=Ni(ee,{initialContent:d,onChange:e=>{x=e}});k.setContext({claseId:l});let te=Ii(e,{onAceptar:e=>{k.setValue(e)}}),ne=kr(e,{onAccept:e=>{k.setValue(e)}}),ie=po(ee.parentNode,{onConfirm:async t=>{try{let n=i.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:a}=await ao({sesionId:_,claseId:l,maestroId:s.id,fechaHoy:c,progressRecords:t,alumnos:n});a.length&&console.warn(`[Progress] Errores parciales:`,a);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ae=yo(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await S({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await so({claseId:l,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;N.success(s)}catch(e){N.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),oe=jr(D,{onInsert:(e,t,n)=>k.insertText(e,t,n),getEditorContent:()=>k.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=D.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Ue(e);te.open({original:e,improved:t})}catch(e){N.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=D.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=T?.getActiveIndicador(),n=await We(e,{presentes:i.filter(e=>a[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){N.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async t=>{await bo(async()=>{let r=i.filter(e=>a[e.id]&&a[e.id]!==`A`),o=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=i.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:i.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,s)}}),presentes:r.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,s)}}),tipoClase:ke(n),instrumento:n.instrumento||``,sesionesRecientes:(u||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:T?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Ke(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N!==void 0&&N&&N.warning(`La IA no detectó registros de progreso en este texto.`);return}ie.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N!==void 0&&N&&N.error(`Error al analizar con IA: `+t.message)}})}}),se=null,ce=e.querySelector(`#pm-planificacion-card`),le=e.querySelector(`#pm-planificacion-dropdown`),ue=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let j=e.querySelector(`#pm-plan-list-rutas`),de=e.querySelector(`#pm-plan-list-planificaciones`),fe=e.querySelector(`#pm-planificacion-header`);fe&&fe.addEventListener(`click`,()=>{let e=ce.classList.toggle(`open`);le.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;j.style.display=n===`rutas`?``:`none`,de.style.display=n===`planificaciones`?``:`none`})});function pe(t){se=t.id,localStorage.setItem(`pm_default_plan_${l}`,t.id),ue&&(ue.textContent=t.nombre||t.name||`Sin nombre`),de.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),T&&=(T.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);se&&n&&(n.innerHTML=``,Pe(l).then(e=>{T=ca(n,{claseId:l,rutaId:se,completedTopics:e,onIndicadorSelect:e=>{k.insertText(`[${e.nombre}] `),oe.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),ce.classList.remove(`open`),le.style.display=`none`}}),v.push(()=>T.destroy())}))}let me=e.querySelector(`#btn-manage-planning`);me&&(me.onclick=e=>{if(e.stopPropagation(),!se){Be.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Be.open({title:`Gestionar Estructura: ${ue.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(T&&T.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Qi(t,se)}),ce&&(async()=>{try{let e=await K.getClasses(s?s.id:null),t=localStorage.getItem(`pm_default_plan_${l}`),r=(n.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===t)return!0;let n=(e.nombre||``).toLowerCase();return r.some(e=>n.includes(e))});j&&(j.innerHTML=i.length?i.map(e=>`
              ...
              </div>`).join(``):`<div style="padding:0.5rem;font-size:0.8rem;color:var(--pm-text-muted)">No hay planes sugeridos para este instrumento</div>`,j.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=i.find(t=>t.id===e.dataset.planId);t&&pe(t)})})),de&&(de.innerHTML=e.map(e=>`
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${P(e.nombre||e.name)}</span>
            </div>`).join(``),de.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&pe(n)})})),ce.style.display=``;let a=e.find(e=>e.id===t)||i[0]||await K.resolveSmartPlan(n);a&&pe(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let he=e.querySelector(`#btn-proponer-curriculo`);he&&(he.onclick=async()=>{he.disabled=!0,he.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await ho(l,12);if(e.registros.length===0){N.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Ve(e,{instrumento:n?.instrumento||``,nivel:``,nombreClase:n?.nombre||``});ae.open({pilares:t.pilares,resumen:t.resumen,instrumento:n?.instrumento||``,nivel:``})}catch(e){N.error(`Error al generar propuesta: `+e.message)}finally{he.disabled=!1,he.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let _e=e.querySelector(`#btn-copy-as-plan`);_e&&_e.addEventListener(`click`,async()=>{let e=k.getValue();Ui(`create`,null,await O(),[],{clase_id:l,maestro_id:s?.id||null,maestro_nombre:s?.nombre_completo||null,contenido:e||``,fecha_inicio:c},async e=>{try{await y({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),N.error(`Error al guardar la planificación: `+(e.message||e))}})}),m&&(T=ca(e.querySelector(`#pm-route-tree-container`),{claseId:l,rutaId:m,onIndicadorSelect:t=>{k.insertText(`[${t.nombre}] `),oe.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),v.push(()=>T.destroy()));let ve=Ga();if(ve&&ve.claseId===l){let t=`[${ve.nombre}] `;k.insertText(t),oe.setContext({indicadorActivo:ve.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let ye=Ka(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&A.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&Za(t).catch(console.warn),a[e]=null,delete o[e],we(e),Ee(),await De(!0),In(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let u=document.getElementById(`pm-justif-save`);u&&(u.disabled=!0);try{let u=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await A.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await A.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=A.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:o}=await A.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(o)throw o;u=a}else{_||await De(!0,!1);let r=await Ya({sesionId:_,alumnoId:e,claseId:l,fecha:c,motivo:t,creadoPor:s.id},n);if(r.error)throw r.error;u=r.data}u&&(o[e]=u),ye.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{u&&(u.disabled=!1)}},onCancel:(e,t)=>{a[e]=t,we(e),Ee()}});v.push(()=>{try{ye.close()}catch{}});let be=null,xe=e.querySelector(`#pm-draft-indicator`);if(_){be=Ra({saveFn:async e=>{_&&await za(_,s.id,e)},debounceMs:3e4}),be.onSaved(()=>{let e=new Date;xe.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,xe.style.display=``}),k.getValue;let e=ee.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),be&&be.onInput(k.getValue())}}v.push(()=>be.destroy()),h?.borrador===!0&&Ba(_,s.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(k.setValue(e.contenido_raw),x=e.contenido_raw):Va(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let M=e.querySelector(`#btn-guardar-obs`);M&&(m&&(M.style.display=``),M.onclick=async()=>{let t=k.getValue();if(!t||!t.trim()){N.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!_){N.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let r=null,o=await Fe(t),u=T?.getActiveIndicador();if(r=o||u,!r){N.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let d=e.querySelector(`#pm-active-tema-badge`);d&&r.nombre&&(d.textContent=r.nombre,d.style.display=`inline-block`),M.disabled=!0,M.textContent=`Procesando...`;try{let o=i.filter(e=>a[e.id]===`P`),u=await ha(t,r.id,o,r.nombre);if(u.error)throw Error(u.error);if(u.modo===`natural`&&u.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+u.dslGenerado+`

¿Guardar la evaluación?`)){M.disabled=!1,M.textContent=`Guardar observación`;return}if(u.missing.length>0&&!confirm(`Faltan ${u.missing.length} alumno(s) sin evaluar:\n${u.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){M.disabled=!1,M.textContent=`Guardar observación`;return}if(u.evaluaciones.length>0){let{error:e}=await pa(_,r.id,u.evaluaciones,s.id,o);if(e)throw e}let d={indicador_id:r.id,evaluaciones:u.evaluaciones};await Ha(_,s.id,t,d,u.dslGenerado||null,u.textoMejorado||null);let f=Cr(t);if(f.estados&&f.estados.length>0){let e=i.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));oo({sesionId:_,claseId:l,maestroId:s.id,fechaHoy:c,dslText:t,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Ae(e,ee)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let p=await Qa(_,l,s.id,u.evaluaciones,n.nombre||`Clase`,o);p.success||console.warn(`[Fase C] Fallo parcial en promoción:`,p.error),T&&await T.refresh(),k.setValue(``),x=``;let m=document.createElement(`div`);if(m.innerHTML=`
          <div style="display:flex; flex-direction:column; align-items:center; gap:4px;">
            <span>✅ Observación guardada exitosamente (${u.evaluaciones.length} eval.)</span>
            <span style="font-size:0.85em; opacity:0.9;">Tema detectado: <b>${r.nombre}</b></span>
          </div>
        `,m.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(m),setTimeout(()=>m.remove(),4500),u.evaluaciones.length>0&&l&&r?.nombre){let{saved:e,error:t}=await io({sesionId:_,claseId:l,maestroId:s.id,fechaHoy:c,contenido:r.nombre,evaluaciones:u.evaluaciones});t&&console.warn(`[asistencia] Error al sincronizar progresos:`,t)}if(_){let{academicService:t}=await F(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:n}=await F(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BL55LQ8B.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),r=await t.processSessionClosure(_);r&&r.length>0&&await n(e,r)}M.textContent=`¡Guardado!`,setTimeout(()=>{M.textContent=`Guardar observación`,M.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),N.error(`Error al guardar: `+(e.message||e)),M.disabled=!1,M.textContent=`Guardar observación`}});let Se=null,Ce=e.querySelector(`#pm-alumnos-list`);function we(e=null){let t=wo(i,a),n=null;if(e){let t=Ce.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(Ce.innerHTML=t.map(e=>Te(e,a[e.id])).join(``),e&&n){let t=Ce.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Te(e,t){return`
    ...
    `}Ce.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),d=t.target.closest(`.pm-asist-nombre`);if(d){let t=d.closest(`.pm-asist-item`).dataset.id,n=i.find(e=>e.id===t);if(m){Se&&Se.destroy(),Se=ka({alumno:n,rutaId:m,sessionId:_,claseId:l,fecha:c,horaInicio:r?.hora_inicio||null}),Se.open(),v.push(()=>{Se&&Se.destroy()});return}let a=u.filter(e=>e.student_id===t);if(a.length===0)try{let{academicService:e}=await F(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(_,t,c);n?(a=n,u.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}Fi(e,{student:n,sessionId:_,teacherId:s.id,snapshots:a});return}if(!n)return;let{id:f,action:p}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),p===`J`){let e=i.find(e=>e.id===f);if(!e)return;if(a[f]===`J`){let t=o[f]||null;!t&&_&&(t=await Xa(_,f),t&&(o[f]=t)),ye.open(e,t,null),In(`Editando justificación de ${e.nombre_completo}.`)}else a[f]=`J`,we(f),Ee(),await De(!0),ye.open(e,null,null),In(`Justificación marcada para ${e.nombre_completo}.`);return}a[f]=a[f]===p?null:p,we(f),Ee();let h=Object.values(a).filter(e=>e===`P`).length,g=Object.values(a).filter(e=>e===`A`).length,y=Object.values(a).filter(e=>e===`J`).length;In(`Asistencia actualizada. ${h} presentes, ${g} ausentes, ${y} justificados.`),await De(!0)};function Ee(){let t=i.length,n=Object.values(a).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),o=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,o.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function De(e=!1,t=!1){C&&clearTimeout(C);let n=async()=>{let e=i.filter(e=>a[e.id]).map(e=>({alumno_id:e.id,estado:a[e.id]})),t={..._?{}:{clase_id:l},maestro_id:s.id,fecha:c,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:x||``};if(navigator.onLine)try{if(_){let{error:e}=await A.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,_);if(!e){localStorage.setItem(`${b}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await A.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){_=e.id,console.log(`[asistencia] Nueva sesión creada:`,_),localStorage.setItem(`${b}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await ge({tabla:`sesiones_clase`,operacion:_?`update`:`insert`,payload:{..._?{id:_}:{},...t}}),localStorage.setItem(`${b}_updated`,new Date().toISOString())};e?t?await n():await w.run(n):C=setTimeout(()=>{w.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Oe=e.querySelector(`.pm-asist-actions-fixed`);if(Oe){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),_&&(e.disabled=!0,e.innerHTML=`⏳...`,await Ye(_),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Oe.querySelector(`#btn-guardar`);Oe.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),l&&(n.disabled=!0,n.innerHTML=`⏳...`,await qe(l,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Oe.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),r=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await w.run(async()=>{try{let r=i.filter(e=>a[e.id]).map(e=>({...l?{clase_id:l}:{},alumno_id:e.id,fecha:c,estado:a[e.id],registrado_por:s.id})),o=r.length>0,u=x&&x.trim().length>0;if(!o&&!u)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await De(!0,!0),!_){let{data:e}=await A.from(`sesiones_clase`).select(`id`).eq(`clase_id`,l).eq(`maestro_id`,s.id).eq(`fecha`,c).maybeSingle();e&&(_=e.id)}if(o&&l)try{let e=r.map(e=>({...e,..._&&{sesion_clase_id:_}}));await re(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!_){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of r)await ge({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:l,alumno_id:e.alumno_id,fecha:c,estado:e.estado,registrado_por:s.id,..._?{sesion_clase_id:_}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(_&&(o||u)){let e=i.filter(e=>a[e.id]).map(e=>({alumno_id:e.id,estado:a[e.id]})),{error:t}=await A.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:x||``,updated_at:new Date().toISOString()}).eq(`id`,_).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await A.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:x||``,updated_at:new Date().toISOString()}).eq(`id`,_).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await A.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:x||``,updated_at:new Date().toISOString()}).eq(`id`,_))}g(),Mt(`hoy`),Mt(`calendario`),Mt(`metricas`),dn().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(_){let{academicService:n}=await F(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await F(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BL55LQ8B.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await n.processSessionClosure(_);i&&i.length>0?(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let d=Oe?.querySelector(`#btn-reporte-dia`);d&&(d.style.display=``);let f=Oe?.querySelector(`#btn-resumen-mes`);f&&(f.style.display=``);let p=Object.values(a).filter(e=>e===`P`).length,m=Object.values(a).filter(e=>e===`A`).length;In(`Sesión guardada exitosamente. ${p} presentes, ${m} ausentes.`);let h=document.createElement(`div`);h.className=`pm-saved-overlay`,h.innerHTML=`
      ...
      `,document.body.appendChild(h);let v=h.querySelector(`#btn-resumen-pedagogico`),y=h.querySelector(`#btn-editar-asistencia`),b=h.querySelector(`#btn-compartir-correo`),S=h.querySelector(`#btn-compartir-whatsapp`),C=h.querySelector(`#btn-volver-hoy`),w=h.querySelector(`#btn-ir-calendario`),T=Ia();v&&(v.onclick=()=>{T.open({sesionId:_,claseNombre:n?.nombre||`Clase`,fecha:c,supabase:A})}),y&&(y.onclick=()=>{h.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),b&&(b.onclick=async()=>{let e=i.filter(e=>a[e.id]).map(e=>({alumno_id:e.id,estado:a[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${n?.nombre||``} - ${c}`),r=je(e,x,i,n);Ne(`mailto:?subject=${t}&body=`,r,1800)}),S&&(S.onclick=async()=>{Ne(`https://wa.me/?text=`,je(i.filter(e=>a[e.id]).map(e=>({alumno_id:e.id,estado:a[e.id]})),x,i,n),1600)}),C&&(C.onclick=()=>{window.location.hash=`#/hoy`}),w&&(w.onclick=()=>{window.location.hash=`#/calendario`});let E=h.querySelector(`#btn-reporte-dia-overlay`);E&&(E.onclick=async()=>{let e=E.innerHTML;E.disabled=!0,E.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await Ye(_)}finally{E.disabled=!1,E.innerHTML=e}});let D=h.querySelector(`#btn-resumen-mes-overlay`);D&&(l?D.onclick=async()=>{let e=D.innerHTML;D.disabled=!0,D.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await qe(l,e.getFullYear(),e.getMonth()+1)}finally{D.disabled=!1,D.innerHTML=e}}:(D.disabled=!0,D.title=`No disponible para actividades especiales`,D.style.opacity=`0.5`));let O=h.querySelector(`#btn-informe-ped-overlay`);O&&(l?O.onclick=async()=>{let e=O.innerHTML;O.disabled=!0,O.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Je(l,e.getFullYear(),e.getMonth()+1)}finally{O.disabled=!1,O.innerHTML=e}}:(O.disabled=!0,O.title=`No disponible para actividades especiales`,O.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=r,t.style.background=``},3e3)}})};function ke(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Ae(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function je(e,t,n,r){if(!r)return`No hay datos de clase disponibles.`;let i=(e||[]).filter(e=>e.estado===`P`).length,a=(e||[]).filter(e=>e.estado===`A`).length,o=(e||[]).filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return s+=`Fecha: ${c||``}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}function Ne(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;N.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}e.querySelector(`#pm-asist-back`).onclick=()=>{Le.destroy();try{ye.close()}catch{}v.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{i.forEach(e=>{a[e.id]=`P`}),we(),Ee(),await De(!0),In(`Todos los ${i.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{i.forEach(e=>{a[e.id]=`A`}),we(),Ee(),await De(!0),In(`Todos los ${i.length} alumnos marcados como ausentes.`)},we();async function Pe(e){try{let{data:t}=await A.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Fe(e){if(!e||!se)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await K.getRouteHierarchy(se),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Le=new Vi(e);Le.mount();let Re=e.querySelector(`#pm-btn-help`);return Re&&(Re.onclick=()=>Le.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Le.destroy();try{ye.close()}catch{}v.forEach(e=>{try{e()}catch{}})}}function wo(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function To(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await A.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=To(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await ge({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Do={async open(){let e=await Se(),t=await xe();Be.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await be()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await ye();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await we()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await M({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},Oo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function ko(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>Oo[e])}var Ao={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);No(n,t),Po(n,t),Vo(n,t),Fo(r),Io(r,t),Lo(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Ro(r),zo(r),Yo(t),Wo(t),Xo(),F(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-BqWyDF0U.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Bo(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function No(e,t){let n=Ne(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Io(e,t){let n=_e(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${X.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
...
`).trim():``}var ms={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function hs(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await A.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await A.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=ms[n.estado_cualitativo]??ms.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
      ...
      `;return}let{data:a}=await A.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),s=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:c}=await A.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),l=(c||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(l.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:u}=await A.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id, covered_by_clase_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:d}=await A.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:f}=await A.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),p=new Map((f||[]).map(e=>[e.sesion_id,e])),m=l.length,h=l.filter(e=>e.estado===`P`).length,g=l.filter(e=>e.estado===`A`).length,_=l.filter(e=>e.estado===`J`).length,v=l.filter(e=>e.estado===`T`).length,y=m>0?Math.round(h/m*100):0,b=u?.filter(e=>e.nota!=null&&e.nota!==0)||[],x={};b.forEach(e=>{let t=e.covered_by_clase_id||`sin_clase`;x[t]||(x[t]=[]),x[t].push(e.nota)});let S=Object.values(x).map(e=>e.reduce((e,t)=>e+t,0)/e.length),C=S.length>0?Math.round(S.reduce((e,t)=>e+t,0)/S.length*10)/10:0,w=b.filter(e=>e.nota>=4).length,T=b.length,E=T>0?Math.round(w/T*100):0,D={};l.forEach(e=>{D[e.clase_id]||(D[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(D[e.clase_id][e.estado]=(D[e.clase_id][e.estado]||0)+1,D[e.clase_id].total++)});let O=new Set([...s,...Object.keys(D)]),{data:ee}=O.size>0?await A.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...O]):{data:[]},k=new Map((ee||[]).map(e=>[e.id,e])),te=l.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),ne=u?.filter(e=>e.observations?.trim())||[],re=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;re=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&re--}let ie=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,ae=(r.instrumento_principal||``).toLowerCase(),oe=`var(--pm-primary)`;(ae.includes(`violin`)||ae.includes(`cuerda`))&&(oe=`#FF3B30`),(ae.includes(`piano`)||ae.includes(`teclado`))&&(oe=`#FF9500`),ae.includes(`guitarra`)&&(oe=`#5856D6`),(ae.includes(`canto`)||ae.includes(`voz`))&&(oe=`#AF52DE`),e.innerHTML=`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-clases-grid">
              ${s.map(e=>{let t=k.get(e);if(!t)return``;let n=D[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null,i=u?.filter(t=>t.covered_by_clase_id===e&&t.nota!=null&&t.nota!==0)||[],a=i.length>0?Math.round(i.reduce((e,t)=>e+t.nota,0)/i.length*10)/10:null;return`
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${te.map(e=>{let t=k.get(e.clase_id),n=ps(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion" ${l.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${l.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:l.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=k.get(e.clase_id),i=e.estado===`J`?p.get(e.sesion_id):null;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${o(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let se=ss(r.tlf_alumno||r.representante_tlf);if(se){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Os=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():j(),ks=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):O(...e),As=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):ws(...e),Z={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},js=!1;async function Ms(e,{onTopicSelected:t}={}){if(Z={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Os()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(g(),Z.clases=await ks(!0),!Z.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Z.activeClaseId=Z.clases[0].id,await Ns(),Ps(e),Rs(e),zs(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Ns(){Z.loading=!0,Z.rutaId=await Cs(Z.activeClaseId),Z.rutaId?Z.blocks=await As(Z.rutaId,Z.activeClaseId):Z.blocks=[],Z.loading=!1}function Ps(e){e.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Z.selectedIndicator=null,Ps(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Wa({...Z.selectedIndicator,indicatorId:Z.selectedIndicator.id,claseId:Z.activeClaseId}),Z.onTopicSelected&&Z.onTopicSelected(Z.activeClaseId)})}function Ls(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Rs(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Z.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Ns(),Ps(e),Rs(e)})}function zs(e){js||(js=!0,Es.on(`node-covered`,()=>{Ns().then(()=>{Ps(e),Rs(e)})}))}var Bs=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Vs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=j();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await A.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await A.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await I.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await I.createAcademicPlan(t,u),await A.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${P(t.message)}</p></div>`}}async function Us(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await A.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await I.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await A.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
