const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/router-DSDN-AHb.js","assets/rolldown-runtime-DlOssbPu.js","assets/vendor-BUMNmNsE.js","assets/vendor-COf7rB16.css"])))=>i.map(i=>d[i]);
import{r as e}from"./rolldown-runtime-DlOssbPu.js";import{i as t}from"./supabase-KnARm58N.js";import{t as n}from"./preload-helper-lqsI3teB.js";import{n as r,r as i,t as a}from"./InfoTooltip-BOK5LUMZ.js";async function o(){try{let{data:e,error:n}=await t.from(`maestro_desempeño`).select(`
        id,
        maestro_id,
