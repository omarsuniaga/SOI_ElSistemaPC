...
export function getTokenSummary(parsed) {
  ...
  if (parsed.alumnos.length > 0) {
    summary.push(`${parsed.alumnos.length} alumno(s)`)
  }
  if (parsed.contenido.length > 0) {
    summary.push(`${parsed.contenido.length} contenido(s)`)
  }
  if (parsed.sugerencias.length > 0) {
    summary.push(`${parsed.sugerencias.length} sugerencia(s)`)
  }
  if (parsed.tareas.length > 0) {
    summary.push(`${parsed.tareas.length} tarea(s)`)
  }
  if (parsed.medidas.length > 0) {
    summary.push(`${parsed.medidas.length} medida(s)`)
  }
  ...
  if (parsed.objetivos.length > 0) {
    summary.push(`${parsed.objetivos.length} objetivo(s)`)
  }
