const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-DjQqxtAp.js","assets/rolldown-runtime-BKS5pmYO.js","assets/preload-helper-TKOBYGYD.js","assets/supabase-BryBf0UA.js","assets/LevelCompletionModal-DYZBjtVP.js","assets/portalUtils-d8JQ9zxl.js","assets/AchievementsSummaryModal-CMQ6SInk.js","assets/pushService-BhOUdsE9.js","assets/maestroAuth-BZ2ChDTg.js","assets/permisoService-3I2LDTJa.js","assets/permisosSupabase-De-RKHm8.js","assets/sistemaView-CWVjA_tu.js","assets/router-BuOn9Utw.js","assets/vendor-qhSM09z_.js","assets/vendor-COf7rB16.css","assets/CHANGELOG-CNg1HUtO.js","assets/groqService-BOqADv92.js","assets/AppToast-BfOaB9z8.js","assets/ausenciasPanel-DGkLqI84.js","assets/ausenciaModal-Bt-iUVgF.js","assets/AppModal-BRx623gX.js","assets/PlanningRouteTree-BOq-75R2.js","assets/planningService-s-tkfwT4.js","assets/PlanningManagerPanel-C91DQcnR.js","assets/curriculumAdminService-BjoT79y6.js","assets/PlanningHistorialPane-HCR0sPE_.js"])))=>i.map(i=>d[i]);
import{$ as e,C as t,G as n,J as r,K as i,Q as a,S as o,X as s,Y as c,Z as l,et as u,i as d,k as f,l as p,nt as m,o as h,q as g,s as _,tt as v,v as y,w as b,y as x}from"./clasesApi-Bv8DEfIA.js";import{i as S}from"./supabase-BryBf0UA.js";import{a as C,i as w,n as T,o as E,r as D,t as O}from"./maestroAuth-BZ2ChDTg.js";import{n as k,o as A,s as j}from"./CHANGELOG-CNg1HUtO.js";import"./vendor-qhSM09z_.js";import{t as M}from"./idb-mVrqaBz4.js";import{a as N,n as P,r as ee,t as F}from"./offlineQueue-RKO6FQOA.js";import{a as te,c as ne,d as re,f as ie,i as ae,l as oe,n as se,o as ce,p as le,r as ue,t as de,u as fe}from"./pushService-BhOUdsE9.js";import{r as pe,t as me}from"./permisoService-3I2LDTJa.js";import{t as I}from"./AppToast-BfOaB9z8.js";import{n as he,t as ge}from"./ausenciaModal-Bt-iUVgF.js";import{a as _e,c as ve,i as L,l as ye,n as be,o as xe,r as Se,s as Ce,t as we}from"./portalUtils-d8JQ9zxl.js";import{a as Te,c as Ee,i as De,l as Oe,n as ke,o as Ae,s as je,t as Me}from"./groqService-BOqADv92.js";import{t as R}from"./preload-helper-TKOBYGYD.js";import{t as z}from"./academicService-DjQqxtAp.js";import{t as Ne}from"./AppModal-BRx623gX.js";import{n as Pe}from"./planificacionAdapter-D9sq6LTl.js";import{r as Fe,s as Ie}from"./alumnosApi-CG7n3qUK.js";import{n as Le,r as Re,t as ze}from"./reportService-BpyVAolk.js";import{n as Be,r as Ve,t as He}from"./planningService-s-tkfwT4.js";var Ue=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function We(e=``){let t=String(e).toLowerCase();return Ue.some(e=>t.includes(e.toLowerCase()))}var Ge=console.error;console.error=function(...e){e.length>0&&!We(e[0])&&Ge.apply(console,e)};var Ke=console.warn;console.warn=function(...e){e.length>0&&!We(e[0])&&Ke.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{We(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{We(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var qe=window.fetch;window.fetch=async function(...e){try{return await qe.apply(window,e)}catch(e){if(!We(e.message))throw e;return null}};var Je=!1;function Ye(e={}){let{enabled:t=!1,consent:n=!1}=e;Je=t&&n,console.log(`[Analytics] Initialized, enabled:`,Je)}var Xe={windowMs:6e4,max:100};function Ze(e={}){Xe={...Xe,...e},console.log(`[RateLimit] Initialized: ${Xe.max} requests per ${Xe.windowMs}ms`)}var Qe=null,$e=new Set;function et(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function tt(e={}){Qe=et(e.length||32),$e.clear(),$e.add(Qe),console.log(`[CSRF] Initialized`)}var nt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function rt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function it(e={}){let{debug:t=!1,onReport:n=null}=e;if(!rt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),at(t,n),ot(t,n),st(t,n),ct(t,n),lt(t,n)}function at(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];nt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function st(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);nt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ct(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function lt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var B={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},ut=null,dt=!1;function ft(){B.listeners.forEach(e=>e({...B}))}var pt={subscribe(e){return B.listeners.push(e),()=>{B.listeners=B.listeners.filter(t=>t!==e)}},async init(){dt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),B.maestro=w(),console.log(`[usePortalAuth.init] Maestro local:`,B.maestro?`found`:`not found`),B.loading=!0,ft(),typeof process<`u`&&{}.VITEST)return B.loading=!1,ft(),console.log(`[usePortalAuth.init] Completado (Test Env)`),B.maestro;if(!ut){let{data:{subscription:e}}=S.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),dt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),B.maestro=null,ft();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=w();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await D();e&&(B.maestro=e,ft())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});ut=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([D(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===O||t?.__pendingApproval?(B.maestro=null,B.pendingApproval=!0):(B.maestro=t,B.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),B.maestro=null,B.pendingApproval=!1}return B.loading=!1,ft(),console.log(`[usePortalAuth.init] Completado`),B.maestro}finally{dt=!1}},setMaestro(e){B.maestro=e,B.loading=!1,ft()},async logout(){await E(),B.maestro=null,ft()},getMaestro:()=>B.maestro,isAuthenticated:()=>!!B.maestro,isLoading:()=>B.loading,isPendingApproval:()=>B.pendingApproval},mt=pt.logout,ht=`calendario`;function gt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):ht}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:ht},``,`#/${ht}`),h(ht);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var _t=null;function vt(e,t){_t=e}function yt(e){_t&&_t(e)}var bt=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function xt(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function St(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Ct(e){let{claseId:t,fecha:n,isValid:r}=St(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}ce(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),jt(e.notification);let t=e.notification;t?.data?.deep_link?Ct(t.data.deep_link):t?.data?.deep_link_url&&Ct(t.data.deep_link_url),V.some(t=>t.id===e.notification.id)||(V.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Rt())}});var wt=new i(`maestro-notifications`),Tt=30*1e3,Et=60*1e3,Dt=120*1e3,Ot=new Map;function kt(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Et)}`}function At(){let e=Date.now();for(let[t,n]of Ot.entries())e>n&&Ot.delete(t)}function jt(e){let t=kt(e),n=Date.now()+Dt;Ot.set(t,n)}function Mt(){return At(),Ot.size}function Nt(e){return`notif_cache_${e}`}function Pt(e){try{let t=V.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Nt(e),JSON.stringify(t))}catch{}}function Ft(e){try{let t=localStorage.getItem(Nt(e));return t?JSON.parse(t):[]}catch{return[]}}var V=[],It=[];function Lt(e){return It.push(e),e(V),()=>{It=It.filter(t=>t!==e)}}function Rt(){It.forEach(e=>e([...V]))}async function zt(){let e=w();if(!e)return[];V.length===0&&(V=Ft(e.id),V.length>0&&Rt());try{let{data:t,error:n}=await S.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),V;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=V.filter(e=>String(e.id).startsWith(`local_`));return V=[...r,...i],await Bt(e.id),Pt(e.id),Rt(),V}catch(e){return console.error(`[NotifService]`,e),V}}async function Bt(t){try{let n=new Date,i=xt(n),a=n.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[o,c]=await Promise.all([s(),e(t,i,i)]),l=o.map(e=>e.id),u=Object.fromEntries(o.map(e=>[e.id,e])),d=(await r(l)).filter(e=>e.dia?.toLowerCase()===a);c.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let f=new Set(c.filter(e=>e.borrador===!1||e.estado===`registrada`||e.estado===`cerrada`).map(e=>e.clase_id));V=V.filter(e=>String(e.id).startsWith(`local_`)?!f.has(e.clase_id):!0);let p=new Date;for(let e of d){if(!e.hora_fin||f.has(e.clase_id))continue;let[t,n]=e.hora_fin.split(`:`),r=new Date;r.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(p-r)/6e4;if(a<30)continue;let o=u[e.clase_id],s=`${e.clase_id}_${i}`;if(V.some(e=>e.referencia_id===s&&e.tipo===`sesion_sin_registrar`))continue;let c=e.hora_fin?e.hora_fin.slice(0,5):``,l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=l&&c?` (${l}–${c})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;V.unshift({id:`local_`+s,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${d} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:i})}for(let e of d){if(!e.hora_inicio)continue;let[t,n]=e.hora_inicio.split(`:`),r=new Date;r.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(r-p)/6e4;if(a<0||a>15)continue;let o=u[e.clase_id],s=`prox_${e.clase_id}_${i}`;if(V.some(e=>e.referencia_id===s))continue;let c=e.hora_inicio?e.hora_inicio.slice(0,5):``,l=Math.round(a);V.unshift({id:`local_`+s,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${c?` a las ${c}`:``} empieza en ${l} ${l===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:i})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Vt(e){let t=w(),n=V.find(t=>t.id===e);if(n&&(n.estado=`leida`),Rt(),t&&Pt(t.id),!String(e).startsWith(`local_`))try{await S.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Ht(e){let t=w();if(V=V.filter(t=>t.id!==e),Rt(),t&&Pt(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await S.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Ut(){let e=w();if(V.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Rt(),e&&Pt(e.id),e)try{await S.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Wt(){return V.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Gt=null;function Kt(){let e=w();e&&(Gt||(Gt=S.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};V.some(e=>e.id===n.id)||(V.unshift(n),Pt(e.id),Rt(),qt(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=V.findIndex(e=>e.id===t.new.id);n!==-1&&(V[n]={...V[n],...t.new},Pt(e.id),Rt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),Gt=null,Qt())}),wt.registerChannel(Gt)))}function qt(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Jt(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.head.appendChild(e)}var H=null,un=null;function dn(e,t=`polite`){H||(H=document.createElement(`div`),H.setAttribute(`aria-live`,t),H.setAttribute(`aria-atomic`,`true`),H.classList.add(`pm-visually-hidden`),document.body.appendChild(H)),t===`assertive`?(H.setAttribute(`role`,`alert`),H.setAttribute(`aria-live`,`assertive`)):(H.removeAttribute(`role`),H.setAttribute(`aria-live`,`polite`)),clearTimeout(un),un=setTimeout(()=>{H.textContent=``,requestAnimationFrame(()=>{H.textContent=e})},50)}function fn(e,t){if(!e||!e.id)return;pn(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function pn(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function mn(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>pn(e))}async function hn(e,t=null){try{let n=``;t&&t.sesiones&&t.sesiones.length>0&&(n=`
...
`);let r=await ke([{role:`user`,content:`
...
Sé directo, pedagógico y actionable. Responde SOLO JSON válido.`}]);try{return Te(r)}catch(e){return console.error(`[ClaseAnalysis] Parse error:`,e,`| raw:`,r),null}}catch(e){return console.error(`[ClaseAnalysis] Error:`,e),null}}async function gn(e,t,n=4){try{let r=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:i}=await S.from(`sesiones_clase`).select(`id, fecha, contenido, asistencia`).eq(`clase_id`,e).gte(`fecha`,r).lte(`fecha`,t).order(`fecha`,{ascending:!1});if(!i||i.length===0)return{sesiones:[],tracking:[]};let{data:a}=await S.from(`observaciones_alumnos`).select(`id, alumno_id, contenido, created_at`).eq(`clase_id`,e).gte(`created_at`,r+`T00:00:00`),o={};a&&a.forEach(e=>{o[e.alumno_id]||(o[e.alumno_id]=[]),o[e.alumno_id].push(e.contenido)});let{data:s}=await S.from(`alumnos`).select(`id, nombre_completo`),c=Object.fromEntries((s||[]).map(e=>[e.id,e.nombre_completo]));return{sesiones:i.map(e=>{let t=Array.isArray(e.asistencia)?e.asistencia:[],n=t.filter(e=>e.estado===`P`).map(e=>e.alumno_id||e),r=t.filter(e=>e.estado===`A`).map(e=>e.alumno_id||e);return{fecha:e.fecha,contenido:e.contenido||`(sin descripción)`,totalPresentes:n.length,totalAusentes:r.length,asistentes:n.map(e=>c[e]||`Desconocido`),ausentes:r.map(e=>c[e]||`Desconocido`),detalleAlumnos:t.map(e=>({alumnoId:e.alumno_id||e,alumnoNombre:c[e.alumno_id||e]||`Desconocido`,estado:e.estado,tieneObs:o[e.alumno_id||e]?.length>0,obsPreview:o[e.alumno_id||e]?.[0]||null}))}}),alumnoMap:c,obsPorAlumno:o}}catch(e){return console.error(`[ContentTracking] Error:`,e),{sesiones:[],tracking:[],alumnoMap:{},obsPorAlumno:{}}}}async function _n(e,t,n=4){try{console.log(`[getClaseDataForAnalysis] Iniciando con claseId:`,e,`fecha:`,t,`semanas:`,n);let{data:r,error:i}=await S.from(`clases`).select(`id, nombre, instrumento`).eq(`id`,e).maybeSingle();if(console.log(`[getClaseDataForAnalysis] Clase:`,r,`Error:`,i),!r)return console.warn(`[getClaseDataForAnalysis] No se encontró clase con id:`,e),null;let{data:a}=await S.from(`inscripciones`).select(`alumno_id`).eq(`clase_id`,e),o=a?.length||0,s=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:c}=await S.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(1),l=c?.[0],u=Array.isArray(l?.asistencia)?l.asistencia.filter(e=>e.estado===`P`).length:0,d=o-u,{data:f}=await S.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(10),p=(f||[]).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}).length,m=(f||[]).length-p,h=f&&f.length>0?Math.round(p/f.length*100):0,g=new Date(new Date(t).getTime()-672*60*60*1e3).toISOString().split(`T`)[0],{data:_}=await S.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,e).gte(`fecha`,g),v={};_&&_.forEach(e=>{v[e.alumno_id]||(v[e.alumno_id]={total:0,presentes:0}),v[e.alumno_id].total++,e.estado===`P`&&v[e.alumno_id].presentes++});let y=Object.values(v).filter(e=>e.total>=3&&e.presentes/e.total<.7).length;return{id:e,nombre:r.nombre,instrumento:r.instrumento||`Sin especificar`,cumplimiento:h,totalAlumnos:o,alumnosPresentes:u,alumnosAusentes:d,registrosCompletos:p,registrosPendientes:m,alumnosEnRiesgo:y,alumnosEnRiesgoDetalle:y>0?`${y} alumno(s) con <70% asistencia`:null}}catch(e){return console.error(`[ClaseDataForAnalysis] Error:`,e),null}}async function vn(e,t=new Date().toISOString().split(`T`)[0],n=4){let r=document.createElement(`div`);r.className=`clase-analysis-backdrop`,r.innerHTML=`
  ...
  `,document.body.appendChild(r),r.querySelector(`.clase-analysis-close`).addEventListener(`click`,()=>r.remove()),r.addEventListener(`click`,e=>{e.target===r&&r.remove()});try{let[i,a]=await Promise.all([_n(e,t,n),gn(e,t,n)]);if(!i)throw Error(`No se pudo obtener datos de la clase`);let o=await hn(i,a),s=r.querySelector(`.clase-analysis-body`);o?s.innerHTML=`
    ...
    `}}function yn(){if(document.getElementById(`clase-analysis-styles`))return;let e=document.createElement(`style`);e.id=`clase-analysis-styles`,e.textContent=`
  ...
  `}function Cn(e){console.log(`[MetricasView.bindEvents] Iniciando bind, container:`,e),console.log(`[MetricasView.bindEvents] HTML length:`,e?.innerHTML?.length||0),e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);U.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await bn(n,U.maestroId),r=xn(t);U.clasesData=r.clasesData,U.todasSesiones=t.sesiones,U.inscripcionesPorClase=t.inscripcionesPorClase,U.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Sn(r),Cn(e),dn(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${L(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})});let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`,r=U.periodo||4;e.querySelectorAll(`.pm-analisis-btn-metrics`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),t.preventDefault();let i=e.dataset.claseId;vn(i,n,r)})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=U.clasesData.find(e=>e.id===i)?.alumnos||[],o=U.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
      ...
      </div>`}}var En=Dn();function Dn(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}window.addEventListener(`resize`,()=>{let e=Dn();e!==En&&(En=e,document.body.dataset.pmLayout=e)},{passive:!0});function On(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function kn(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}function An(e,t,n,r,i){let a=t?.es_admin?`<a href="/admin" class="pm-admin-link" title="Ir al Panel Admin">
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),I.show(`Auto-navegación cancelada`,`info`)})}async function Rn(t,{onClaseClick:n}={}){t.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=w();if(!i){t.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let o=new Date,l=o.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),u=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,`0`)}-${String(o.getDate()).padStart(2,`0`)}`;try{let d=await g(i.id,u);if(d&&d.length>0){t.innerHTML=zn(d,l,o),Vn(t,u,i.id);return}let f=await s();if(!f||f.length===0){t.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let p=f.map(e=>e.id),m=Object.fromEntries(f.map(e=>[e.id,e])),h=(await r(p)).filter(e=>e.dia?.toLowerCase()===l).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){t.innerHTML=`
        <h2 class="pm-date-header">${Se(l)} ${_e(o)}</h2>
        <p class="pm-empty">No tienes clases hoy.</p>
      `;return}let _=new Date(o);_.setDate(_.getDate()-3);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=new Date(o);y.setDate(y.getDate()-1);let b=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,`0`)}-${String(y.getDate()).padStart(2,`0`)}`,x=(await e(i.id,v,b)||[]).filter(e=>{if(!p.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await e(i.id,u,u)).filter(e=>p.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),C=new Set(S.map(e=>e.clase_id)),w=await c(p),T={};for(let e of w||[])e.clase_id&&(T[e.clase_id]=(T[e.clase_id]||0)+1);let E=[...new Set(h.map(e=>e.salon_id).filter(Boolean))],D=E.length>0?await a(E):[],O=Object.fromEntries(D.map(e=>[e.id,e.nombre])),k=o.getHours()*60+o.getMinutes(),A=null,j=null,M=h.map(e=>{let t=m[e.clase_id],n=C.has(t.id),r=T[t.id]||0,i=In(e.hora_inicio,e.hora_fin,k);i===`en-curso`&&(!n&&!A&&(A=t.id),n&&!j&&(j=t.id));let a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`,o=i===`en-curso`?`<span class="pm-badge pm-badge-en-curso"><i class="bi bi-circle-fill pm-pulse-dot me-1"></i>En curso</span>`:i===`proxima`?`<span class="pm-badge pm-badge-proxima"><i class="bi bi-clock me-1"></i>Próximamente</span>`:``;return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${Se(t)} ${_e(n)}</h2>
  ...
  `}function Bn(e){return{suplencia:`pm-eme-motivo-suplencia`,eventual:`pm-eme-motivo-eventual`,reforzamiento:`pm-eme-motivo-reforzamiento`,otro:`pm-eme-motivo-otro`}[e]||`pm-eme-motivo-otro`}function Vn(e,t,n){e.querySelectorAll(`.pm-emergente-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`pm-card-loading`)||(e.classList.add(`pm-card-loading`),window.router&&window.router.navigate(`clase-emergente?fecha=${t}`),e.classList.remove(`pm-card-loading`))})})}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);if(e.id=`pm-hoy-pendientes-styles`,!document.getElementById(`pm-badge-warning-style`)){let e=document.createElement(`style`);e.id=`pm-badge-warning-style`,e.textContent=`
        .pm-badge-warning {
          background: rgba(245,158,11,0.15);
          color: #d97706;
  ...
  `,document.head.appendChild(e)}var Hn=null,Un=null;function Wn(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;Hn=o,Un=a,Ne.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{nr(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function ir(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,ur=class{constructor(e,t=cr){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(or)||(this._autoTimer=setTimeout(()=>this.start(),sr))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(or,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=lr,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),this._tooltip=n}_bindEvents(){if(!this._tooltip||!this._overlay){console.warn(`[AsistenciaTour] DOM no inyectado correctamente, saltando event binding`);return}this._tooltip.querySelector(`#pm-tour-next`).addEventListener(`click`,()=>this._nextStep()),this._tooltip.querySelector(`#pm-tour-skip`).addEventListener(`click`,()=>this._close()),this._onKeydown=e=>{e.key===`Escape`&&this._close()},document.addEventListener(`keydown`,this._onKeydown),this._onResize=()=>{this._overlay?.style.display!==`none`&&this._showStep(this._step)},window.addEventListener(`resize`,this._onResize,{passive:!0})}_showStep(e){let t=this._steps[e],n=this._container.querySelector(t.target);if(!n){this._nextStep();return}n.scrollIntoView({behavior:`smooth`,block:`center`}),setTimeout(()=>this._positionOnElement(n,t,e),400)}_positionOnElement(e,t,n){if(!this._spotlight||!this._tooltip){console.warn(`[AsistenciaTour] Tour no montado correctamente, abortando posicionamiento`);return}let r=e.getBoundingClientRect();this._spotlight.style.width=`${r.width+20}px`,this._spotlight.style.height=`${r.height+20}px`,this._spotlight.style.top=`${r.top-10}px`,this._spotlight.style.left=`${r.left-10}px`;let i=r.bottom+16;i+200>window.innerHeight&&(i=r.top-200-16);let a=Math.max(16,Math.min(window.innerWidth-280-16,r.left));this._tooltip.style.top=`${i}px`,this._tooltip.style.left=`${a}px`,this._tooltip.querySelector(`#pm-tour-title`).innerHTML=`<span>${t.title}</span>`,this._tooltip.querySelector(`#pm-tour-body`).textContent=t.body,this._tooltip.querySelector(`#pm-tour-progress`).textContent=`${n+1} / ${this._steps.length}`,this._tooltip.querySelector(`#pm-tour-next`).textContent=n===this._steps.length-1?`Finalizar ✓`:`Siguiente →`}_nextStep(){this._step++,this._step<this._steps.length?this._showStep(this._step):this._close()}_close(){this._overlay&&(localStorage.setItem(or,`true`),this._onKeydown&&document.removeEventListener(`keydown`,this._onKeydown),this._onResize&&window.removeEventListener(`resize`,this._onResize),this._tooltip&&(this._tooltip.style.display=`none`),this._spotlight&&(this._spotlight.style.display=`none`),this._overlay.style.opacity=`0`,setTimeout(()=>{this._overlay&&(this._overlay.style.display=`none`)},300))}},W={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g,estados:/!(LOGRADO|EN_PROGRESO|INICIADO)\b/gi},dr={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`,estados:{LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}};function fr(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#([{$>])/)[0].trim()),n.push(e)}return n}function pr(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function mr(e){return{alumnos:fr(e,W.alumnos),contenido:fr(e,W.contenido),sugerencias:fr(e,W.sugerencias),tareas:fr(e,W.tareas),medidas:fr(e,W.medidas),calificacion:pr(e),objetivos:fr(e,W.objetivos),niveles:fr(e,W.niveles),nodos:fr(e,W.nodos),capas:fr(e,W.capas),estados:fr(e,W.estados).map(e=>e.toUpperCase())}}function hr(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],estados:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=mr(i))}),{...mr(e),por_capas:n}}function gr(e){if(!e)return``;let t=_r(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(W.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${dr.capas}22; color:${dr.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${dr.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${dr.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(W.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(W.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(W.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(W.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(W.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(W.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function _r(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function vr(e){return!e||typeof e!=`string`||!e.trim()||/[#[({$>]/.test(e)?`dsl`:`natural`}function yr(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=hr(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function br(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function xr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Sr(e,t,n,r,i=null){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let a=n;if(i&&i.length>0){let e=new Set(i.map(e=>e.id)),t=n.length;a=n.filter(t=>e.has(t.alumno_id)),a.length<t&&console.warn(`[evaluationService] saveEvaluaciones: filtrados ${t-a.length} evaluaciones de alumnos ausentes`)}let o=a.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea}));try{let{data:e,error:t}=await S.from(`indicator_attempts`).upsert(o,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});if(t)throw t;return{data:e,error:null}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[evaluationService] Offline, encolando saveEvaluaciones...`);for(let e of o)await F({tabla:`indicator_attempts`,operacion:`upsert`,payload:e});return{data:null,error:null,_offline:!0}}return{data:null,error:e}}}async function Cr(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await S.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await S.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:xr(a??[],l),indicators:n,totalAlumnos:l}}async function wr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=vr(e);try{let t=e;i===`natural`&&(t=await je(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=br(yr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,textoMejorado:Tr(e,a,n),error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],textoMejorado:``,error:e.message||`Error desconocido`}}}function Tr(e,t,n){let r=new Map(n.map(e=>[e.id,e.nombre_completo])),i=[];e?.trim()&&(i.push(`Texto original: "${e.trim()}"`),i.push(``)),i.push(`Evaluaciones:`);for(let e of t){let t=r.get(e.alumno_id)||`Alumno`,n=e.nota!==null&&e.nota!==void 0?`${e.nota}/5`:`—`,a=e.observacion?.trim()?e.observacion:`—`,o=e.tarea?.trim()?` | Tarea: ${e.tarea}`:``;i.push(`• ${t}: ${a} | Nota: ${n}${o}`)}return i.join(`
`)}function Er(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function G(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Dr(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function Or(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function kr(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function Ar(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await S.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=kr(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function jr(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${G(Dr(e.nombre_completo))}</div>
      <div>
  ...
  `}function Mr(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${G(Or(e.created_at))}</span>
  ...
  `}function Nr(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Pr(e){return e.length?`
  ...
  `:``}function Fr(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${jr(e,n)}
  ...
  `}function Rr({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Er();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){Ce()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=ye(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=w();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await S.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=Ir(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=he(o,{onClose:()=>h()});try{let n=await Ar(e.id,t);s=n.indicatorSummaries,o.innerHTML=Fr(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=Lr(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}var zr={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Br={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Vr={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function Hr(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Ur(e){return(e||``).trim().toLowerCase()}function Wr(e){let t=new Map;for(let n of e){let e=Ur(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Gr(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Vr[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Vr[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=zr[e.estado]||zr.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Br[e.estado]||``}`:`ssp-alumno-chip`}">${Hr(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Hr(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Hr(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${Hr(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Hr(i)} · ${Hr(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}var qr=`soi_ruta_tema_pendiente`;function Jr(e){sessionStorage.setItem(qr,JSON.stringify(e))}function Yr(){let e=sessionStorage.getItem(qr);if(!e)return null;sessionStorage.removeItem(qr);try{return JSON.parse(e)}catch{return null}}var Xr=`documentos`;async function Zr(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await S.storage.from(Xr).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=S.storage.from(Xr).getPublicUrl(r);return o.publicUrl}async function Qr({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await Zr(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await S.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function $r(e,t){if(!e||!t)return null;let{data:n,error:r}=await S.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ei(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await S.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}function ti(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function ni(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function ri(e,t){let n=ni(e);return t.find(e=>ni(e.nombre)===n||ni(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&ni(e.nombre).includes(n)||n.length>=3&&n.includes(ni(e.nombreCorto||e.nombre.split(` `)[0])))??null}function ii(e,t){let n=[],r=[];for(let i of e){if(ni(i)===`todos`){n.push(...t);continue}let e=ri(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function ai(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await S.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function oi({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=Ee(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await ai(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function si({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=ii(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await ai(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function ci({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=hr(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:si({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function li({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await S.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ni(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ni(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await S.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var ui={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},di=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function fi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var pi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function mi(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=pi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function hi(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${fi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${fi(n.join(`, `))}</span>`:``}}function o(e,t){let n=ui[e.estado]??ui.EN_PROGRESO,r=e.nota?` · ${fi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${fi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=pi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${fi(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${fi(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${fi(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${fi((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${fi(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${fi(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${mi(c)}</div>`:``,d=Oe(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${fi(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${fi(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,gi(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(di.indexOf(i)+1)%di.length;r[n].estado=di[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function gi(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function _i(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await S.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=vi[e.tipo]??vi.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${bi(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${bi(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${bi(o)}" placeholder="ej. Básico" />
          </label>
        </div>
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function Ei(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        ...
        <p class="pm-asist-subtitle">
          ${i?`📍 ${L(i)} · `:``}
          ${r?`${xe(r.hora_inicio)} – ${xe(r.hora_fin)} · `:``}
          <span style="color:var(--pm-primary); font-weight:700;">${_e(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `,await Ni()}async function ji(e,t,n,r){Ne.open({title:`Editar ${e}`,body:`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Mi(`Clase`,null,()=>Ni()),q.activeClassId?Pi(q.activeClassId):Bi(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),ji(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Ni())},e.onclick=()=>{q.activeClassId=t,q.activeLevelId=q.activeNodeId=q.activeObjectiveId=null,Ni(),Pi(t),Bi(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Bi(`#pm-rc-objs-wrapper`,`Elegí Tema`),Bi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Pi(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await K.getLevelsByClass(e);!n.some(e=>e.id===q.activeLevelId)&&n.length>0?q.activeLevelId=n[0].id:n.length===0&&(q.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Mi(`Nivel`,e,()=>Pi(e)),q.activeLevelId?Fi(q.activeLevelId):Bi(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),ji(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Pi(e))},t.onclick=()=>{q.activeLevelId=n,q.activeNodeId=q.activeObjectiveId=null,Pi(e),Fi(n),Bi(`#pm-rc-objs-wrapper`,`Elegí Tema`),Bi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Fi(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await K.getNodesByLevel(e);!n.some(e=>e.id===q.activeNodeId)&&n.length>0?q.activeNodeId=n[0].id:n.length===0&&(q.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Mi(`Tema`,e,()=>Fi(e)),q.activeNodeId?Ii(q.activeNodeId):Bi(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),ji(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Fi(e))},t.onclick=()=>{q.activeNodeId=n,q.activeObjectiveId=null,Fi(e),Ii(n),Bi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ii(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await K.getObjectivesByNode(e);!n.some(e=>e.id===q.activeObjectiveId)&&n.length>0?q.activeObjectiveId=n[0].id:n.length===0&&(q.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Mi(`Objetivo`,e,()=>Ii(e)),q.activeObjectiveId?zi(q.activeObjectiveId):Bi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),ji(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ii(e))},t.onclick=()=>{q.activeObjectiveId=n,Ii(e),zi(n)}})}var Li={0:`Sin eval.`,1:`Inicial`,2:`En desarrollo`,3:`Logrado`,4:`Destacado`,5:`Superado`},Ri={0:`var(--pm-text-muted)`,1:`#ef4444`,2:`#f97316`,3:`#22c55e`,4:`#06b6d4`,5:`#8b5cf6`};async function zi(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
          ...
          <div class="pm-rc-calif-row" style="display:flex;gap:4px;padding-left:1.6rem;" data-indicator-id="${e.id}">
            ${[1,2,3,4,5].map(t=>`
              <button class="pm-rc-calif-btn" data-calif="${t}" style="
                width:28px;height:28px;border-radius:50%;border:2px solid ${Ri[t]};
                background:${e.calificacion===t?Ri[t]:`transparent`};
                color:${e.calificacion===t?`#fff`:Ri[t]};
            ...
            `:``}
            <span style="font-size:0.6rem;color:${Ri[e.calificacion]||`var(--pm-text-muted)`};margin-left:auto;align-self:center;font-weight:600;">
              ${Li[e.calificacion]||Li[0]}
            </span>
          </div>
        </div>
      `).join(``)}
    </div>
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Mi(`Indicador`,e,()=>zi(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=n=>{n.stopPropagation();let r=t.dataset.id,i=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;ji(`Indicador`,r,i,()=>zi(e))}}),t.querySelectorAll(`.pm-rc-calif-btn, .pm-rc-calif-clear`).forEach(t=>{t.onclick=async n=>{n.stopPropagation();let r=t.closest(`.pm-rc-calif-row`).dataset.indicatorId,i=parseInt(t.dataset.calif,10);try{await K.updateIndicatorCalificacion(r,i),zi(e)}catch(e){console.error(`Error updating calificacion:`,e)}}})}function Bi(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}function Vi(e,t){let n=null,r=null,i=[],a=e.querySelector(`#pm-planificacion-card`),o=e.querySelector(`#pm-planificacion-dropdown`),c=e.querySelector(`#pm-planificacion-nombre`),l=e.querySelector(`#pm-plan-list-rutas`),u=e.querySelector(`#pm-plan-list-planificaciones`),d=e.querySelector(`#pm-planificacion-header`),f=e.querySelector(`#btn-copy-as-plan`);d&&d.addEventListener(`click`,()=>{let e=a.classList.toggle(`open`);o.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;l.style.display=n===`rutas`?``:`none`,u.style.display=n===`planificaciones`?``:`none`})});function p(s){n=s.id,localStorage.setItem(`pm_default_plan_${t.claseId}`,s.id),c&&(c.textContent=s.nombre||s.name||`Sin nombre`),u.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===s.id)}),h();let l=e.querySelector(`#pm-route-tree-container`),d=e.querySelector(`#pm-active-tema-badge`);n&&l&&(l.innerHTML=``,Hi(t.claseId).then(e=>{r=ki(l,{claseId:t.claseId,rutaId:n,completedTopics:e,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e),d&&(d.textContent=e.nombre,d.style.display=`inline-block`),a.classList.remove(`open`),o.style.display=`none`}}),i.push(()=>r.destroy())}))}let m=e.querySelector(`#btn-manage-planning`);m&&(m.onclick=e=>{if(e.stopPropagation(),!n){Ne.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ne.open({title:`Gestionar Estructura: ${c.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(r&&r.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Ai(t,n)}),a&&(async()=>{try{let e=await K.getClasses(t.maestro?t.maestro.id:null),n=localStorage.getItem(`pm_default_plan_${t.claseId}`),r=(t.clase.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===n)return!0;let t=(e.nombre||``).toLowerCase();return r.some(e=>t.includes(e))});l&&(l.innerHTML=i.length?i.map(e=>`
            ...
            </div>`).join(``),u.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&p(n)})})),a.style.display=``;let o=e.find(e=>e.id===n)||i[0]||await K.resolveSmartPlan(t.clase);o&&p(o)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})(),f&&f.addEventListener(`click`,async()=>{let e=t.getDslContent();b(`create`,null,await s(),[],{clase_id:t.claseId,maestro_id:t.maestro?.id||null,maestro_nombre:t.maestro?.nombre_completo||null,contenido:e||``,fecha_inicio:t.fechaHoy},async e=>{try{await Pe({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),I.error(`Error al guardar la planificación: `+(e.message||e))}})}),t.rutaId&&(r=ki(e.querySelector(`#pm-route-tree-container`),{claseId:t.claseId,rutaId:t.rutaId,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e)}}),i.push(()=>r.destroy()));function h(){r&&=(r.destroy(),null)}function g(){h(),i.forEach(e=>{try{e()}catch{}}),i.length=0}return{destroy:g,getActiveIndicador:()=>r?.getActiveIndicador()||null,refreshTree:async()=>{r&&await r.refresh()},getActivePlanificacionId:()=>n}}async function Hi(e){try{let{data:t}=await S.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[asistencia] Error calculando progreso histórico:`,e),[]}}var J=null,Ui=[],Wi=null,Y=-1,Gi=!1,Ki=null,qi=!1,Ji=0,Yi=0;function Xi(){if(!J){if(J=document.createElement(`div`),J.id=`pm-autocomplete-popup`,J.className=`pm-autocomplete-popup`,J.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(J)}}function Zi(e,t,n={}){if(Xi(),Ui=e||[],Wi=t,Ki=n.trigger||null,Y=-1,Gi=!0,ra(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+6;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),J.style.left=`${i}px`,J.style.top=`${a}px`}J.onmousedown=Qi,document.addEventListener(`mousemove`,$i),document.addEventListener(`mouseup`,ea),J.style.display=`block`}function Qi(e){e.target.closest(`.pm-ac-option`)||(qi=!0,Ji=e.clientX-J.offsetLeft,Yi=e.clientY-J.offsetTop,J.style.cursor=`grabbing`,J.style.transition=`none`)}function $i(e){if(!qi)return;let t=e.clientX-Ji,n=e.clientY-Yi;J.style.left=`${Math.max(0,t)}px`,J.style.top=`${Math.max(0,n)}px`}function ea(){qi&&(qi=!1,J.style.cursor=``)}function ta(){J&&(J.style.display=`none`,qi=!1,document.removeEventListener(`mousemove`,$i),document.removeEventListener(`mouseup`,ea)),Ui=[],Wi=null,Y=-1,Gi=!1,Ki=null}function na(e){Ui=e||[],Y=-1,ra(e)}function ra(e){if(!J)return;if(!e||e.length===0){J.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${sa(Ki)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===Y,o=ca(Ki,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${ua(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${ua(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),J.innerHTML=t,J.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{ia(parseInt(e.dataset.index,10))})})}function ia(e){if(e>=0&&e<Ui.length){let t=Ui[e];Wi&&Wi(t),ta()}}function aa(e){if(!(!Gi||Ui.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),Y=Math.min(Y+1,Ui.length-1),ra(Ui),oa();break;case`ArrowUp`:e.preventDefault(),Y=Math.max(Y-1,0),ra(Ui),oa();break;case`Enter`:e.preventDefault(),Y>=0?ia(Y):Ui.length>0&&ia(0);break;case`Escape`:e.preventDefault(),ta();break;case`Tab`:Ui.length>0&&Y===-1&&(e.preventDefault(),ia(0));break}}function oa(){if(!J||Y<0)return;let e=J.querySelector(`.pm-ac-option[data-index="${Y}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function sa(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function ca(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?la(t.type):`•`}function la(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function ua(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function da(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.bottom}}function fa(){return Gi}function pa(){return Y}var ma={show:Zi,hide:ta,updateOptions:na,handleKeyDown:aa,getCursorPosition:da,isOpen:fa,getSelectedIndex:pa},ha=`portal-maestros-catalogs`,ga=1,_a={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},va=null;async function ya(){return va||(va=await M(ha,ga,{upgrade(e){for(let[t,n]of Object.entries(_a))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),va)}async function ba(e,t){let n=await ya(),r=await n.get(e,t);if(!r)return null;let i=_a[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function xa(e){let t=await(await ya()).getAll(e),n=_a[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Sa(e,t,n){return(await ya()).getAllFromIndex(e,t,n)}async function Ca(e,t){let n=await ya(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function wa(e,t){let n=(await ya()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Ta(e,t){await(await ya()).delete(e,t)}async function Ea(e){await(await ya()).clear(e)}async function Da(e){let t=await ya(),n=_a[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Oa(){let e=await ya();for(let t of Object.keys(_a))await e.clear(t)}async function ka(e){return(await xa(e)).length}async function Aa(e,t){let n=await ya(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function ja(e){return(await ya()).get(`historial`,e)}async function Ma(e,t=5){return(await(await ya()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var X={get:ba,getAll:xa,getByIndex:Sa,set:Ca,setBulk:wa,remove:Ta,clear:Ea,cleanExpired:Da,clearAll:Oa,getStoreSize:ka,addToHistorial:Aa,getHistorial:ja,getTopUsed:Ma};async function Na(e){if(!e)return[];try{let{data:t,error:n}=await S.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function Pa(){let e=await X.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await S.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Fa(){let e=await X.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await S.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Ia(){let e=await X.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await S.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function La(){let e=await X.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await S.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function Ra(){let e=await X.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await S.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await S.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await S.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await X.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function za(e=null){let t=await X.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=S.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await X.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function Ba(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Na(n.claseId));break;case`[`:r=await Pa();break;case`(`:r=await Ia();break;case`{`:r=await La();break;case`$`:r=await Fa();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await Ra():await za(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=Va(r,t)),e&&e!==`#`){let t=(await X.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function Va(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=Ha(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function Ha(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function Ua(e,t){await X.addToHistorial(e,t)}var Wa=`
...
`;function Ga(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
    <div class="pm-dsl-editor-container">
      <div
        ...
        spellcheck="false"
      ></div>
      <div class="pm-dsl-placeholder" id="pm-dsl-placeholder">${Wa}</div>
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=Ya(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}function Za(e,t){let n=e.querySelector(`#pm-dsl-toolbar-container`),r=e.querySelector(`#pm-dsl-editor-container`),i=null,a=Ga(r,{initialContent:t.initialContent||``,onChange:e=>{t.onEditorChange?.(e)}});a.setContext({claseId:t.claseId});function o(e){i=Xa(n,{onInsert:(e,t,n)=>a.insertText(e,t,n),getEditorContent:()=>a.getValue(),onLoading:()=>{},onIaProposal:t=>e.onIaProposal?.(t),onImproveClick:t=>e.onImproveClick?.(t),onStructureClick:t=>e.onStructureClick?.(t),onAnalyzeClick:t=>e.onAnalyzeClick?.(t)})}function s(){i&&i.destroy(),a.destroy()}return{getEditor:()=>a,getToolbar:()=>i,getValue:()=>a.getValue(),setValue:e=>a.setValue(e),setContext:e=>a.setContext(e),initToolbar:o,destroy:s}}function Qa(e,{onMarkAll:t}){if(!t)return{destroy(){}};let n=e.querySelector(`#btn-bulk-p`),r=e.querySelector(`#btn-bulk-a`),i=[];function a(e,t,n){e&&(e.addEventListener(t,n),i.push(()=>e.removeEventListener(t,n)))}return a(n,`click`,e=>{e.preventDefault(),t(`P`)}),a(r,`click`,e=>{e.preventDefault(),t(`A`)}),{destroy(){i.forEach(e=>{try{e()}catch{}}),i.length=0}}}function $a({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function eo(e,t,n){let{data:r,error:i}=await S.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await S.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await S.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function to(e,t){let{data:n,error:r}=await S.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function no(e){let{error:t}=await S.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function ro(e,t,n,r,i=null,a=null){try{let{error:o}=await S.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await S.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await F({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}function io(e,{sesionId:t,maestroId:n,editor:r,sesionExistenteData:i,onDraftRecovered:a}){if(!t)return{destroy(){}};let o=null,s=!1,c=e.querySelector(`#pm-draft-indicator`);o=$a({saveFn:async e=>{!t||s||await eo(t,n,e)},debounceMs:3e4}),o.onSaved(()=>{if(s||!c)return;let e=new Date;c.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,c.style.display=``});let l=e.querySelector(`#pm-dsl-editable`);if(l){let e=l.oninput;l.oninput=function(t){e&&e.call(this,t),o&&!s&&o.onInput(r.getValue())}}return i?.borrador===!0&&to(t,n).then(e=>{if(!s&&e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?a&&a(e.contenido_raw):no(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e)),{destroy(){s=!0,o&&o.destroy()}}}function ao(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `}return g.onclick=async e=>{let g=e.target.closest(`.pm-asist-btn`),v=e.target.closest(`.pm-asist-nombre`);if(v){let e=v.closest(`.pm-asist-item`).dataset.id,n=t.find(t=>t.id===e);if(!n)return;if(r){_&&_.destroy(),u&&u(n);return}let s=o.filter(t=>t.student_id===e);if(s.length===0)try{let{academicService:t}=await R(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(i,e,a);n&&(s=n,h&&h(n))}catch(e){console.error(`Error creando snapshot on-demand:`,e)}d&&d(n,s);return}if(!g)return;let{id:b,action:x}=g.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),x===`J`){let e=t.find(e=>e.id===b);if(!e)return;if(n[b]===`J`){let t=s[b]||null;!t&&i&&c&&(t=await c(i,b)),f&&f(e,t,null),m&&m(`Editando justificación de ${e.nombre_completo}.`)}else l&&l(b,`J`),y(b),p&&await p(!0),f&&f(e,null,null),m&&m(`Justificación marcada para ${e.nombre_completo}.`);return}if(l&&l(b,n[b]===x?null:x),y(b),m){let e=Object.values(n).filter(e=>e===`P`).length,t=Object.values(n).filter(e=>e===`A`).length,r=Object.values(n).filter(e=>e===`J`).length;m(`Asistencia actualizada. ${e} presentes, ${t} ausentes, ${r} justificados.`)}p&&await p(!0)},{render(e){y(e)},destroy(){g.onclick=null,_&&=(_.destroy(),null)}}}async function co(e,n,r,i,a=`Clase`,o=null){if(!i||i.length===0)return{success:!0};let s=i;if(o&&o.length>0){let e=new Set(o.map(e=>e.id)),t=i.length;s=i.filter(t=>e.has(t.alumno_id)),s.length<t&&console.warn(`[Promotion] promocionarObservacionesAlumnos: filtrados ${t-s.length} evaluaciones de alumnos ausentes`)}let c=s.filter(e=>e.observacion&&e.observacion.trim().length>0);if(c.length===0)return{success:!0};let l=c.map(i=>new t({alumno_id:i.alumno_id,maestro_id:r,clase_id:n,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${a}`,descripcion:i.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON());try{let{data:e,error:t}=await S.from(`observaciones_alumnos`).upsert(l,{onConflict:`sesion_clase_id,alumno_id`});if(t)throw t;return{success:!0,data:e}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[Promotion] Offline, encolando promoción de observaciones...`);for(let e of l)await F({tabla:`observaciones_alumnos`,operacion:`upsert`,payload:e});return{success:!0,_offline:!0,count:l.length}}return console.error(`[Promotion] Error promoviendo observaciones:`,e),{success:!1,error:e.message}}}async function lo(e,t){if(!e||!t)throw Error(`classEventId and status are required`);let{data:n,error:r}=await S.from(`class_events`).update({status:t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw Error(`Error updating class event status: ${r.message}`);return n}function uo(e,t){let n=e.querySelector(`#btn-guardar-obs`);return n?(t.rutaId&&(n.style.display=``),n.onclick=async()=>{let r=t.getEditorValue();if(!r||!r.trim()){I.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!t.sesionId){I.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let i=null,a=await po(r,t),o=t.planificationCard?.getActiveIndicador();if(i=a||o,!i){I.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let s=e.querySelector(`#pm-active-tema-badge`);s&&i.nombre&&(s.textContent=i.nombre,s.style.display=`inline-block`),n.disabled=!0,n.textContent=`Procesando...`;try{let a=t.alumnos.filter(e=>t.estado[e.id]===`P`),o=await wr(r,i.id,a,i.nombre);if(o.error)throw Error(o.error);if(o.modo===`natural`&&o.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+o.dslGenerado+`

¿Guardar la evaluación?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:e}=await Sr(t.sesionId,i.id,o.evaluaciones,t.maestro.id,a);if(e)throw e}let s={indicador_id:i.id,evaluaciones:o.evaluaciones};await ro(t.sesionId,t.maestro.id,r,s,o.dslGenerado||null,o.textoMejorado||null);let c=hr(r);if(c.estados&&c.estados.length>0){let e=t.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));ci({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,dslText:r,alumnos:e}).then(({saved:e,errors:n})=>{n.length&&console.warn(`[Progress DSL] Errores:`,n),e.length&&Ci(e,t.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await co(t.sesionId,t.claseId,t.maestro.id,o.evaluaciones,t.claseNombre||`Clase`,a);if(l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),t.planificationCard&&await t.planificationCard.refreshTree(),t.setEditorValue(``),t.onDslContentClear&&t.onDslContentClear(),fo(o.evaluaciones.length,i.nombre),t.activeClassEventId){try{await lo(t.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(t.activeLevel)try{let{academicService:e}=await R(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3]));for(let n of a){let r=await e.checkLevelCompletion(n.id,t.activeLevel);if(r&&r.status===`approved`){let{createLevelCompletionModal:e}=await R(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-DYZBjtVP.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([4,3,5])),r=e({studentId:n.id,levelId:t.activeLevel});t.onAppendModal?.(r.el||r)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&t.claseId&&i?.nombre){let{error:e}=await oi({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,contenido:i.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(t.sesionId){let{academicService:n}=await R(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),r=await n.processSessionClosure(t.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:t}=await R(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CMQ6SInk.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5]));await t(e,r)}}n.textContent=`¡Guardado!`,setTimeout(()=>{n.textContent=`Guardar observación`,n.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),I.error(`Error al guardar: `+(e.message||e)),n.disabled=!1,n.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function fo(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function po(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await K.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function mo(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||I!==void 0&&I&&I.error(`Error inesperado: `+(e.message||e)),null}}async function ho(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await S.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let s=new Date,c=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,`0`)}-${String(s.getDate()).padStart(2,`0`)}`,l=n||a.fecha||c,u={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let d=Array.isArray(a.asistencia)?a.asistencia:[],f=d.map(e=>e.alumno_id).filter(Boolean),p=[];if(f.length>0){let{data:e}=await S.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,f);p=e||[]}let m={},h={};p.forEach(e=>{m[e.id]=null}),d.forEach(e=>{e.estado&&p.some(t=>t.id===e.alumno_id)&&(m[e.alumno_id]=e.estado)});let g=_o(e,{clase:u,horario:null,alumnos:p,estado:m,justificaciones:h,maestro:r,fechaHoy:l,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i});return typeof g==`function`?g:void 0}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${L(t.message)}</p>`}}async function go(e,{claseId:t,fecha:n,sesionId:i,router:o}={}){let l=typeof e==`string`?document.getElementById(e):e;if(!l){console.error(`[asistenciaView] Container not found:`,e);return}l.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let u=w();if(!u){l.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(i)return ho(l,{sesionId:i,fecha:n,maestro:u,router:o});l.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let d=new Date,f=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,`0`)}-${String(d.getDate()).padStart(2,`0`)}`,p=n||f;try{let e=d.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,i,f,m]=await Promise.all([s(),r([t]),c([t]),S.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,u.id).eq(`fecha`,p).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),h=n.find(e=>e.id===t);if(!h){l.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let g=i.find(t=>t.dia?.toLowerCase()===e),_=(f||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),v=m.data||[],y=v[0]||null,b=(()=>{let e=new Map;for(let t of[...v].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),x=Array.isArray(y?.asistencia)?y.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(y?.tipo===`emergente`&&x.length>0){let e=new Set(x),t=new Set(_.map(e=>e.id)),n=x.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await S.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);_=_.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}_=_.filter(t=>e.has(t.id))}let C=y?.id||null,w=y?.updated_at||null,T=y?.contenido||``,E=h.salon?[h.salon]:[],[D,O]=await Promise.all([C?S.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?a(E):Promise.resolve([])]),k=O.length>0?O[0].nombre:null,A=`pm_asistencia_${t||C}_${p}`,j=localStorage.getItem(`${A}_updated`),M=!1;w&&j&&new Date(w).getTime()>new Date(j).getTime()+5e3&&(M=!0);let N=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await S.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();N=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let P={},ee={};_.forEach(e=>{P[e.id]=null});let F=b,te={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(F.length===0)try{let e=null,n=v.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:t}=await S.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);e=t}if((!e||e.length===0)&&t&&p){let{data:n}=await S.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,p);e=n}e?.length>0&&(F=e.map(e=>({alumno_id:e.alumno_id,estado:te[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}F.forEach(e=>{if(Object.prototype.hasOwnProperty.call(P,e.alumno_id)){let t=te[e.estado]??e.estado;P[e.alumno_id]=t}});let ne=[];if(C)try{ne=await S.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),ne.forEach(e=>{Object.prototype.hasOwnProperty.call(P,e.alumno_id)&&(P[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}_o(l,{clase:h,horario:g,alumnos:_,estado:P,justificaciones:ee,maestro:u,fechaHoy:p,claseId:t,sesionId:C,hasConflict:M,serverDSL:T,snapshots:D,salonNombre:k,rutaId:N,sesionExistenteData:y,router:o})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),l.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${L(e.message)}</p>`}}function _o(e,t){let{clase:r,horario:i,alumnos:a,estado:o,justificaciones:s,maestro:c,fechaHoy:l,claseId:d,snapshots:p,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v,router:y}=t,b=t.sesionId,x=e=>{if(y?.navigate){y.navigate(e);return}window.location.hash=`#/${e}`},C=[],w=`pm_asistencia_${d||b}_${l}`,T=m,E=null,D=ti(),O=null,k=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let A=Ei(e.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:g,fechaHoy:l,totalAlumnos:a.length,hasConflict:h,onBack:()=>{ge.destroy();try{ce.close()}catch{}C.forEach(e=>{try{e()}catch{}}),x(`hoy`)}});C.push(()=>A.destroy());let j=e.querySelector(`#pm-sync-badge-container`);if(j){let e=tr();j.appendChild(e.el)}let M=Za(e,{initialContent:m,claseId:d,onEditorChange:e=>{T=e}}),N=M.getEditor(),P=e.querySelector(`#pm-dsl-editor-container`),ee=ir(e,{onAceptar:e=>{N.setValue(e)}}),te=ar(e,{onAccept:e=>{N.setValue(e)}}),ne=hi(P.parentNode,{onConfirm:async t=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await si({sesionId:b,claseId:d,maestroId:c.id,fechaHoy:l,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),I.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),re=xi(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await f({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await li({claseId:d,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;I.success(s)}catch(e){I.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}});M.initToolbar({onImproveClick:async t=>{let n=e.querySelector(`#btn-generar-informe`);n&&(n.disabled=!0);try{let e=await De(t);ee.open({original:t,improved:e})}catch(e){I.error(`Error al generar informe: `+e.message)}finally{n&&(n.disabled=!1)}},onStructureClick:async t=>{let n=e.querySelector(`#btn-ia-magic`);n&&(n.disabled=!0);try{let e=O?.getActiveIndicador(),n=await je(t,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});te.open({original:t,dsl:n})}catch(e){I.error(`Error al estructurar con IA: `+e.message)}finally{n&&(n.disabled=!1)}},onAnalyzeClick:async t=>{await mo(async()=>{let n=a.filter(e=>o[e.id]&&o[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),tipoClase:Si(r),instrumento:r.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:O?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Me(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),I!==void 0&&I&&I.warning(`La IA no detectó registros de progreso en este texto.`);return}ne.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),I!==void 0&&I&&I.error(`Error al analizar con IA: `+t.message)}})}});let ie=M.getToolbar();O=Vi(e,{claseId:d,clase:r,maestro:c,fechaHoy:l,rutaId:_,editor:N,onIndicadorSelect:t=>{N.insertText(`[${t.nombre}] `),ie&&ie.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getDslContent:()=>N.getValue()}),C.push(()=>O.destroy());let ae=e.querySelector(`#btn-proponer-curriculo`);ae&&(ae.onclick=async()=>{ae.disabled=!0,ae.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await _i(d,12);if(e.registros.length===0){I.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Ae(e,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});re.open({pilares:t.pilares,resumen:t.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(e){I.error(`Error al generar propuesta: `+e.message)}finally{ae.disabled=!1,ae.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let oe=Di(e,{editor:N,toolbar:ie}),se=Yr();oe.inject(se,d),C.push(()=>oe.destroy());let ce=oo(e,{sesionId:b,claseId:d,fechaHoy:l,maestroId:c.id,supabase:S,guardarJustificacion:Qr,eliminarJustificacion:ei,onJustifDeleted:e=>{o[e]=null,delete s[e]},onJustifSaved:(e,t)=>{s[e]=t},onJustifCancelled:(e,t)=>{o[e]=t},onRenderLista:e=>ue.render(e),onUpdateProgress:()=>fe(),onAutoSave:e=>pe(e),onAnnounce:e=>dn(e)});C.push(()=>{try{ce.close()}catch{}});let le=io(e,{sesionId:b,maestroId:c.id,editor:N,sesionExistenteData:v,onDraftRecovered:e=>{T=e,N.setValue(e)}});C.push(()=>le.destroy()),e.querySelector(`#pm-academic-tools`),uo(e,{rutaId:_,sesionId:b,claseId:d,maestro:c,fechaHoy:l,alumnos:a,estado:o,planificationCard:O,editorContainer:P,getEditorValue:()=>N.getValue(),setEditorValue:e=>N.setValue(e),onDslContentClear:()=>{T=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:t=>{let n=e.querySelector(`.pm-asist-root`);n&&n.appendChild(t)}});let ue=so(e,{alumnos:a,estado:o,rutaId:_,sesionId:b,fechaHoy:l,snapshots:p,justificaciones:s,obtenerJustificacion:$r,onEstadoChange:(e,t)=>{o[e]=t},onOpenProgressPanel:e=>{de&&de.destroy(),de=Rr({alumno:e,rutaId:_,sessionId:b,claseId:d,fecha:l,horaInicio:i?.hora_inicio||null}),de.open(),C.push(()=>{de&&de.destroy()})},onOpenEvaluationDrawer:(t,n)=>{rr(e,{student:t,sessionId:b,teacherId:c.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{ce.open(e,t,n)},onAutoSave:e=>pe(e),onAnnounce:e=>dn(e),onUpdateSnapshots:e=>{p.push(...e)}});C.push(()=>ue.destroy());let de=null;function fe(){let t=a.length,n=Object.values(o).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function pe(e=!1,t=!1){E&&clearTimeout(E);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...b?{}:{clase_id:d},maestro_id:c.id,fecha:l,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:T||``};if(navigator.onLine)try{if(b){let{error:e}=await S.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,b);if(!e){localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await S.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){b=e.id,console.log(`[asistencia] Nueva sesión creada:`,b),localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await F({tabla:`sesiones_clase`,operacion:b?`update`:`insert`,payload:{...b?{id:b}:{},...t}}),localStorage.setItem(`${w}_updated`,new Date().toISOString())};e?t?await n():await D.run(n):E=setTimeout(()=>{D.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let me=e.querySelector(`.pm-asist-actions-fixed`);if(me){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),b&&(e.disabled=!0,e.innerHTML=`⏳...`,await ze(b),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=me.querySelector(`#btn-guardar`);me.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),d&&(n.disabled=!0,n.innerHTML=`⏳...`,await Le(d,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),me.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),i=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await D.run(async()=>{try{let i=a.filter(e=>o[e.id]).map(e=>({...d?{clase_id:d}:{},alumno_id:e.id,fecha:l,estado:o[e.id],registrado_por:c.id})),s=i.length>0,f=T&&T.trim().length>0;if(!s&&!f)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await pe(!0,!0),!b){let{data:e}=await S.from(`sesiones_clase`).select(`id`).eq(`clase_id`,d).eq(`maestro_id`,c.id).eq(`fecha`,l).maybeSingle();e&&(b=e.id)}if(s&&d)try{let e=i.map(e=>({...e,...b&&{sesion_clase_id:b}}));await n(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!b){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await F({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:d,alumno_id:e.alumno_id,fecha:l,estado:e.estado,registrado_por:c.id,...b?{sesion_clase_id:b}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(b&&(s||f)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:t}=await S.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await S.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await S.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b))}u(),yt(`hoy`),yt(`calendario`),yt(`metricas`),zt().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(b){let{academicService:n}=await R(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await R(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CMQ6SInk.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5])),i=await n.processSessionClosure(b);i&&i.length>0?(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let p=me?.querySelector(`#btn-reporte-dia`);p&&(p.style.display=``);let m=me?.querySelector(`#btn-resumen-mes`);m&&(m.style.display=``);let h=Object.values(o).filter(e=>e===`P`).length,g=Object.values(o).filter(e=>e===`A`).length;dn(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
      ...
      `,document.body.appendChild(_);let v=_.querySelector(`#btn-resumen-pedagogico`),y=_.querySelector(`#btn-editar-asistencia`),C=_.querySelector(`#btn-compartir-correo`),w=_.querySelector(`#btn-compartir-whatsapp`),E=_.querySelector(`#btn-volver-hoy`),D=_.querySelector(`#btn-ir-calendario`);k&&k.destroy(),k=Gr();let O=k;v&&(v.onclick=()=>{O.open({sesionId:b,claseNombre:r?.nombre||`Clase`,fecha:l,supabase:S})}),y&&(y.onclick=()=>{_.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),C&&(C.onclick=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${l}`),n=wi(e,T,a,r,l);Ti(`mailto:?subject=${t}&body=`,n,1800)}),w&&(w.onclick=async()=>{Ti(`https://wa.me/?text=`,wi(a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),T,a,r,l),1600)}),E&&(E.onclick=()=>{_.remove(),x(`hoy`)}),D&&(D.onclick=()=>{_.remove(),x(`calendario`)});let A=_.querySelector(`#btn-reporte-dia-overlay`);A&&(A.onclick=async()=>{let e=A.innerHTML;A.disabled=!0,A.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await ze(b)}finally{A.disabled=!1,A.innerHTML=e}});let j=_.querySelector(`#btn-resumen-mes-overlay`);j&&(d?j.onclick=async()=>{let e=j.innerHTML;j.disabled=!0,j.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Le(d,e.getFullYear(),e.getMonth()+1)}finally{j.disabled=!1,j.innerHTML=e}}:(j.disabled=!0,j.title=`No disponible para actividades especiales`,j.style.opacity=`0.5`));let M=_.querySelector(`#btn-informe-ped-overlay`);M&&(d?M.onclick=async()=>{let e=M.innerHTML;M.disabled=!0,M.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Re(d,e.getFullYear(),e.getMonth()+1)}finally{M.disabled=!1,M.innerHTML=e}}:(M.disabled=!0,M.title=`No disponible para actividades especiales`,M.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=i,t.style.background=``},3e3)}})};let he=Qa(e,{onMarkAll:async e=>{a.forEach(t=>{o[t.id]=e}),ue.render(),fe();try{await pe(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}dn(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)}});C.push(()=>he.destroy()),ue.render();let ge=new ur(e);ge.mount();let _e=e.querySelector(`#pm-btn-help`);return _e&&(_e.onclick=()=>ge.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),ge.destroy();try{ce.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),C.forEach(e=>{try{e()}catch{}})}}function vo(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function yo(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await S.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=vo(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await F({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var bo={async open(){let e=await se(),t=await ae();Ne.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await ie()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await re();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await le()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await oe({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},xo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function So(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>xo[e])}var Co={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Eo(n,t),Do(n,t),Lo(n,t),Oo(r),ko(r,t),Ao(r),jo(r,t),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Po(r),Fo(r),Go(t),Bo(t),Ko(),R(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-3I2LDTJa.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([9,1,10,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Io(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Eo(e,t){let n=ve(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ko(e,t){let n=te(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
        ...
        <div class="card-body py-2 px-3">
          ...
          ${e.respuesta_admin?`
            <div class="border-start border-2 border-primary ps-2 mt-2">
              ...
              <div class="small">${L(e.respuesta_admin)}</div>
            </div>`:``}
        </div>
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await R(async()=>{let{getPermisos:e}=await import(`./permisoService-3I2LDTJa.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([9,1,10,3]));Io(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Lo(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    ...
    </div>`}function Bo(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{Z.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>Vo(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,Uo),document.getElementById(`pm-ver-sistema-btn`)?.addEventListener(`click`,()=>{R(async()=>{let{renderSistemaView:e}=await import(`./sistemaView-CWVjA_tu.js`);return{renderSistemaView:e}},__vite__mapDeps([11,3,12,1,13,14,15,16,17])).then(({renderSistemaView:e})=>{Ne.open({title:`<i class="bi bi-cpu-fill me-2"></i>Sistema SOI — v${k}`,size:`xl`,saveText:null,cancelText:`Cerrar`,body:`<div id="pm-sistema-modal-body"></div>`,onOpen:t=>{e(t.querySelector(`#pm-sistema-modal-body`))}})})}),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await re();e.success?(Z.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await le(),Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>bo.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>Co.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await ie();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>Wo(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>Wo(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>Wo(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await R(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-DGkLqI84.js`);return{ausenciasPanel:e}},__vite__mapDeps([18,3,19,8,5,20,17]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>ge.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,zo(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function Vo(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=x(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=Ho();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}Z.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),s=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await o(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:s}=await S.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(s)throw s;let c={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(T,JSON.stringify(c)),Z.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{Z.saving=!1,a.disabled=!1,a.innerHTML=s}}function Ho(){let e={};return wo.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function Uo(){Ne.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=qo,document.head.appendChild(e)}async function Jo(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i,onSave:a}){let o=new Set,s=document.createElement(`div`);s.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
  ...
  `,s.appendChild(l),e.appendChild(s);try{let e=(await c([n])).map(e=>e.alumno_id);if(e.length===0){document.getElementById(`pm-students-list`).innerHTML=`<p style="color: var(--pm-text-muted); text-align: center;">No hay estudiantes en esta clase</p>`;return}let t=(await Ie()).filter(t=>e.includes(t.id)),r=document.getElementById(`pm-students-list`);r.innerHTML=t.map(e=>`
  ...
  `,a.appendChild(o),e.appendChild(a);try{let e=await Be(t.node_id,i,r,n),a=`
  ...
  `;let a=`pm-planning-active-tab`,o=e.querySelectorAll(`.pm-planning-tab`),c=e.querySelectorAll(`.pm-planning-pane`);function u(e){o.forEach(t=>{let n=t.dataset.tab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),c.forEach(t=>{t.hidden=t.dataset.pane!==e});try{sessionStorage.setItem(a,e)}catch{}C(e)}o.forEach(e=>{e.addEventListener(`click`,()=>u(e.dataset.tab))});let d=e.querySelector(`#pm-planning-clase-select`),f=e.querySelector(`#pm-planning-ruta-select`),p=e.querySelector(`#pm-planning-content`);try{d.innerHTML=`<option value="">Selecciona una clase...</option>`+(await s()).map(e=>`<option value="${e.id}">${e.nombre} (${e.instrumento||`S/I`})</option>`).join(``)}catch(e){console.error(`[planning] Error cargando clases:`,e),I.error(`Error cargando clases`)}d.addEventListener(`change`,async()=>{if(r=d.value,f.value=``,n=null,p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta...</p></div>`,y=null,_=null,v=null,e.querySelector(`.pm-planning-tab.active`)?.dataset.tab===`historial`&&D(),r)try{f.innerHTML=`<option value="">Selecciona una ruta...</option>`+(await l(r)).map(e=>`<option value="${e.route_version_id}">${e.name}${e.instrumento?` (${e.instrumento})`:``}</option>`).join(``)}catch(e){console.error(`[planning] Error cargando rutas:`,e),I.error(`Error cargando rutas`)}}),f.addEventListener(`change`,()=>{n=f.value||null,C(e.querySelector(`.pm-planning-tab.active`)?.dataset.tab||`semaforo`)});let m=e.querySelector(`#pm-planning-route-tree`),h=e.querySelector(`#pm-planning-manager`),g=e.querySelector(`#pm-planning-historial`),_=null,v=null,y=null,b=!1,x=!1,S=!1;function C(e){if(e===`semaforo`)return w();if(e===`ruta`)return T();if(e===`gestionar`)return E();if(e===`historial`)return D()}async function w(){if(!n||!r){p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una clase y ruta para comenzar</p></div>`;return}p.innerHTML=`<div class="pm-planning-empty"><p>Cargando indicadores...</p></div>`;try{i=await Ve(n,t,r),O()}catch(e){console.error(`[planning] Error cargando indicadores:`,e),I.error(`Error cargando indicadores`),p.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar indicadores. Intenta de nuevo.</p></div>`}}async function T(){if(!n){m.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para ver su estructura</p></div>`;return}if(!(_===n||b)){b=!0,m.innerHTML=`<div class="pm-planning-empty"><p>Cargando estructura...</p></div>`;try{let{renderPlanningRouteTree:e}=await R(async()=>{let{renderPlanningRouteTree:e}=await import(`./PlanningRouteTree-BOq-75R2.js`);return{renderPlanningRouteTree:e}},__vite__mapDeps([21,22,3,5]));await e(m,{routeVersionId:n}),_=n}catch(e){console.error(`[planning] Error cargando estructura de ruta:`,e),m.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar la estructura. Intenta de nuevo.</p></div>`}finally{b=!1}}}async function E(){if(!n){h.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para gestionar su contenido</p></div>`;return}if(!(v===n||x)){x=!0,h.innerHTML=`<div class="pm-planning-empty"><p>Preparando tu borrador editable…</p></div>`;try{let{renderPlanningManager:e}=await R(async()=>{let{renderPlanningManager:e}=await import(`./PlanningManagerPanel-C91DQcnR.js`);return{renderPlanningManager:e}},__vite__mapDeps([23,24,3,22,5,20,17]));await e(h,{publishedRouteVersionId:n,maestroId:t,onChanged:()=>{_=null}}),v=n}catch(e){console.error(`[planning] Error cargando gestor:`,e),h.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar el gestor. Intenta de nuevo.</p></div>`}finally{x=!1}}}async function D(){if(!r){g.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una clase para ver el historial</p></div>`;return}let e=`${r}:${n}`;if(!(y===e||S)){S=!0,g.innerHTML=`<div class="pm-planning-empty"><p>Cargando historial...</p></div>`;try{let{renderPlanningHistorialPane:i}=await R(async()=>{let{renderPlanningHistorialPane:e}=await import(`./PlanningHistorialPane-HCR0sPE_.js`);return{renderPlanningHistorialPane:e}},__vite__mapDeps([25,3,24,22,5,20,17]));await i(g,{maestroId:t,claseId:r,publishedRouteVersionId:n,onPromoted:()=>{n&&w()}}),y=e}catch(e){console.error(`[planning] Error cargando historial:`,e),g.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar el historial. Intenta de nuevo.</p></div>`}finally{S=!1}}}try{let e=sessionStorage.getItem(a);e&&e!==`semaforo`&&u(e)}catch{}function O(){if(!i||i.length===0){p.innerHTML=`<div class="pm-planning-empty"><p>No hay indicadores en esta ruta</p></div>`;return}let e={};i.forEach(t=>{let n=t.tipo||`Sin Categoría`;e[n]||(e[n]=[]),e[n].push(t)}),p.innerHTML=`<div class="pm-planning-grid">${Object.entries(e).map(([e,t])=>`
    ...
    `).join(``)}</div>`,p.querySelectorAll(`[data-indicator-id]`).forEach(e=>{let t=e.dataset.indicatorId,n=i.find(e=>e.node_id===t);e.addEventListener(`click`,async()=>{await A(n)})}),p.querySelectorAll(`[data-register-btn]`).forEach(e=>{let t=e.dataset.indicatorId,n=i.find(e=>e.node_id===t);e.addEventListener(`click`,e=>{e.stopPropagation(),j(n)})})}function k(e){let t=e.progreso_porcentaje/100*100,{estado:n,icono:r,color:i}=e.estado;return`
    ...
    `}async function A(i){Yo(e,{indicator:i,claseId:r,maestroId:t,routeVersionId:n})}async function j(a){Jo(e,{indicator:a,claseId:r,maestroId:t,routeVersionId:n,onSave:async()=>{try{i=await Ve(n,t,r),O(),I.success(`✓ Indicadores actualizados`)}catch(e){console.error(`[planning] Error reloading:`,e)}}})}}var Zo=`alumno_plan_entradas`;async function Qo(e){let{data:t,error:n}=await S.from(Zo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function $o(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await S.from(Zo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function es(e){let{error:t}=await S.from(Zo).delete().eq(`id`,e);if(t)throw Error(t.message)}var ts={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},ns=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],rs=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await Qo(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
...
`).trim():``}var ds={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function fs(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await S.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await S.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=ds[n.estado_cualitativo]??ds.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        ...
        <div class="pm-zen-hero" style="--accent-gradient: ${te}">
          ...
          <div class="pm-zen-hero__content">
            ...
            <div class="pm-zen-info">
              ...
              <p style="font-size:0.8rem;opacity:0.8;margin-top:4px;">Nivel ${r.nivel_actual||1} • ${P} años</p>
            </div>
          </div>
        </div>
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${M.map(e=>{let t=j.get(e.clase_id),n=us(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion">
            <summary class="pm-zen-accordion-header">
              ...
              <span class="pm-zen-accordion-meta">${N.length} observación${N.length===1?``:`es`}</span>
              <i class="bi bi-chevron-down pm-accordion-chevron"></i>
            </summary>
            <div class="pm-zen-desenvolvimiento" style="margin-top:0.75rem;">
              ${N.map(e=>{let t=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${y(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ne=is(r.tlf_alumno||r.representante_tlf);if(ne){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Ts=()=>typeof globalThis<`u`&&globalThis.getMaestroLocal?globalThis.getMaestroLocal():w(),Es=(...e)=>typeof globalThis<`u`&&globalThis.getMisClases?globalThis.getMisClases(...e):s(...e),Ds=(...e)=>typeof globalThis<`u`&&globalThis.loadRouteTree?globalThis.loadRouteTree(...e):xs(...e),Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Os=!1;async function ks(e,{onTopicSelected:t}={}){if(Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Ts()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(u(),Q.clases=await Es(!0),!Q.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Q.activeClaseId=Q.clases[0].id,await As(),js(e),Fs(e),Is(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function As(){Q.loading=!0,Q.rutaId=await bs(Q.activeClaseId),Q.rutaId?Q.blocks=await Ds(Q.rutaId,Q.activeClaseId):Q.blocks=[],Q.loading=!1}function js(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!Q.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(Q.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}Q.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),ws(r,{blockId:n.id,blockName:n.nombre,isExpanded:Q.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{Q.expandedBlocks.has(t)?Q.expandedBlocks.delete(t):Q.expandedBlocks.add(t),js(e)}}),Q.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(Ms(n,e))})}}),Ns(e)}function Ms(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Q.expandedLevels.has(e.id)?Q.expandedLevels.delete(e.id):Q.expandedLevels.add(e.id),js(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Q.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},js(t)})}),n}function Ns(e){let t=e.querySelector(`#ruta-action-panel`);if(!Q.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,js(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Jr({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function Ps(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Fs(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await As(),js(e),Fs(e)})}function Is(e){Os||(Os=!0,Cs.on(`node-covered`,()=>{As().then(()=>{js(e),Fs(e)})}))}var Ls=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Rs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=w();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await S.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
    ...
    `}}async function zs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await z.getStudent(t),r=await z.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
      ...
      <div class="card-apple pm-animate-slide-up" style="margin-top: 1.5rem; padding: 1.5rem;">
        <div class="mb-4">
          ...
          <select id="route-selector" class="input-apple">
            ...
            ${r.map(e=>`<option value="${e.id}">${L(e.name)} (${L(e.instrument||`General`)})</option>`).join(``)}
          </select>
        </div>
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{u=await z.getPublishedVersionId(l),d=await z.getRouteDetail(l,u);let e=[];d.forEach(t=>{t.levels.forEach(n=>{e.push({id:n.id,name:n.name,blockName:t.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await z.createAcademicPlan(t,u),await S.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${L(t.message)}</p></div>`}}async function Bs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await S.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await z.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await S.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([z.getRouteDetail(t),n?z.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}};function Us(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ws(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function Gs(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var Ks=null,qs=[],Js=new Set;async function Ys(e){e.innerHTML=cc();let t=w();if(!t){e.innerHTML=lc(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await me(t.id);if(!n.puede_inscribir_clases){e.innerHTML=Zs(n),Qs(t.id);return}let[r,i]=await Promise.all([p(t.id),Ie().catch(()=>[])]);qs=i.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=$s(r),ac(r),r.length>0&&await tc(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=lc(`bi-exclamation-triangle`,`Error al cargar`,Us(t.message))}}function Xs(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function Zs(e){return`
    <div class="gcv-root">
  ...
  `}function Qs(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await pe(e,`clases:enroll`),I.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){I.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function $s(e){return`
    <div class="gcv-root">
  ...
  `}var uc=[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`gestionar-clases`],dc=new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]);function fc(e,t,n){[`login`,`logout`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`gestionar-clases`,`register`,`pending-approval`].forEach(t=>e.on(t,(e,r)=>n(t,r))),e.on(`ruta-detalle/:id`,(e,t)=>n(`ruta-detalle`,t)),e.onNotFound(()=>n(`hoy`))}function pc(){let e=document.getElementById(`pm-view-container`);if(!e)return{};e.innerHTML=``;let t={};return uc.forEach(n=>{let r=document.createElement(`div`);r.id=`pm-view-${n}`,r.className=`pm-view-content`,r.style.display=`none`,e.appendChild(r),t[n]=r}),t}async function mc(e,t,n,r,i){let{maestroId:a,permisos:o,router:s,showLoginScreen:c,cleanupPushService:l,stopRealtime:u,logoutMaestro:d}=i;switch(e){case`login`:Mn(t,{onSuccess:i.onLoginSuccess});break;case`register`:Nn(t,{onSuccess:()=>s.navigate(`pending-approval`)});break;case`pending-approval`:Pn(t,{onBackToLogin:()=>s.navigate(`login`)});break;case`logout`:c(),l(),u(),d().then(()=>window.location.reload());break;case`calendario`:case`clases`:return await Xn(t);case`hoy`:return await Rn(t,{onClaseClick:e=>s.navigate(`asistencia?clase=${e}`)});case`asistencia`:return await go(t,{claseId:r.get(`clase`),fecha:r.get(`fecha`),sesionId:r.get(`sesion`),router:s});case`metricas`:return Tn(t);case`perfil`:return To(t);case`clase-emergente`:return yo(t,{maestroId:a});case`planificacion`:return await Xo(t,{maestroId:a});case`alumno`:return ps(t,{alumnoId:r.get(`id`)||n.id});case`gamificacion`:await vs(t);break;case`ruta`:await ks(t,{onTopicSelected:e=>s.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:Rs(t);break;case`ruta-plan-builder`:zs(t,{alumnoId:r.get(`id`)});break;case`ruta-semanal`:Bs(t,{alumnoId:r.get(`id`)});break;case`ruta-libreria`:Vs.render().then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`ruta-detalle`:Hs.render(n).then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`gestionar-clases`:if(!o?.puede_inscribir_clases){s.navigate(`hoy`);return}return await Ys(t);default:break}return null}var hc=!1,gc=null;function _c({isAdmin:e,getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i,onResize:a}){if(hc)return;hc=!0,Lt(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=Wt();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),zt(),Kt(),e||vc({getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i}),document.addEventListener(`keydown`,e=>{if(Dn()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`){let n={h:`hoy`,c:`calendario`,r:`ruta`,m:`metricas`,p:`perfil`}[e.key.toLowerCase()];n&&(i(n),t.length=0)}t.length>3&&t.splice(0,t.length-2)});let o=null,s=Dn();window.addEventListener(`resize`,()=>{clearTimeout(o),o=setTimeout(()=>{let e=Dn();e!==s&&(s=e,a())},250)},{passive:!0})}function vc({getMaestro:e,getPermisosCached:t,onPermisosUpdate:n,onNavigate:r}){let i=e();i?.id&&(gc&&=(S.removeChannel(gc),null),gc=S.channel(`permisos-maestro:${i.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${i.id}`},async e=>{console.log(`[Realtime] Permisos actualizados:`,e.new);try{let e=await me(i.id),r=t(),a=[],o=[];e.puede_inscribir_clases&&!r?.puede_inscribir_clases&&a.push(`Gestionar e Inscribir Clases`),r?.puede_inscribir_clases&&!e.puede_inscribir_clases&&o.push(`Gestionar e Inscribir Clases`),await n(e,{ganados:a,perdidos:o}),a.length>0?I.success(`¡Nuevos permisos activados: ${a.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):o.length>0?I.show(`El administrador removió tu acceso a: ${o.join(`, `)}.`,`warning`):I.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>console.log(`[Realtime] Canal permisos_maestros:`,e)),window.addEventListener(`beforeunload`,()=>S.removeChannel(gc),{once:!0}))}if(m(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;tt(),Ze({windowMs:6e4,max:100}),Ye({enabled:!1,consent:!1}),it({debug:!1}),A({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&I.show(t,n)});var yc=null,bc=null,xc=!1,$=gt();window.router=$;var Sc={},Cc=null,wc=new Set;function Tc(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}async function Ec(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await S.from(t).insert([i]);if(e)throw e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await S.from(t).update(n).eq(`id`,e);if(r)throw r}else if(n===`delete`){let{error:e}=await S.from(t).delete().eq(`id`,i.id);if(e)throw e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await S.from(t).select().limit(1);e?.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico:`,e),e}}var Dc=null;async function Oc(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await P();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function kc(){clearTimeout(Dc),Dc=setTimeout(async()=>{if(navigator.onLine)try{await N(Ec)}finally{await Oc()}},1e3)}window.addEventListener(`online`,kc),window.addEventListener(`offline`,Oc);function Ac(){wc.clear()}function jc(e){wc.delete(e)}async function Mc(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e?.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}kn(a),window.pwaInstaller?.evaluateInsights()}let o=Sc[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Cc==`function`&&(Cc(),Cc=null),Object.values(Sc).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),wc.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{let e=await mc(a,o,t,i,{maestroId:yc?.id,permisos:bc,router:$,showLoginScreen:Pc,cleanupPushService:de,stopRealtime:()=>{},logoutMaestro:mt,onLoginSuccess:()=>Lc()});e&&(Cc=e),clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),dc.has(a)&&wc.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}function Nc(e,t,n){yc=t,bc=n||bc,An(e,t,Tc(bc),(e,t)=>$.navigate(e,t),Oc),document.getElementById(`pm-sync-indicator`)?.addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await kc()});let r=($.currentRoute?.()||`hoy`).split(`?`)[0];kn(r)}function Pc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=($.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Sc,pc()),Fc(),$.setAuthGuard(()=>pt.isAuthenticated(),t),$.start();return}let r=Sc.login;if(r){On(),r.style.display=`block`,r.innerHTML=``,mc(`login`,r,{},new URLSearchParams,{router:$,onLoginSuccess:e=>{e&&e!==`login`?$.navigate(e):Lc()}});return}e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`,Object.assign(Sc,pc()),Fc(),$.setAuthGuard(()=>pt.isAuthenticated(),t),history.replaceState({route:`login`},``,`#/login`),Mc(`login`)}function Fc(){fc($,xc,Mc)}async function Ic(){if(yc)try{let t=new Date,n=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),i=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`,[a,o,c]=await Promise.all([s(),s().then(e=>r(e.map(e=>e.id))),s().then(()=>e(yc.id,i,i))]),l=Object.fromEntries(a.map(e=>[e.id,e]));await fe(o.filter(e=>e.dia?.toLowerCase()===n).map(e=>({...e,clase_nombre:l[e.clase_id]?.nombre||`Clase`})),c.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}async function Lc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`);let t=await pt.init();if(console.log(`[Init] Auth:`,t?`con maestro`:`sin maestro`),pt.isPendingApproval()){console.log(`[Init] Cuenta pendiente de aprobación — mostrando pantalla de espera`),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Sc,pc(!1)),Fc(),history.replaceState({route:`pending-approval`},``,`#/pending-approval`),Mc(`pending-approval`);return}let n=[`login`,`register`,`pending-approval`],r=(window.router||$).currentRoute().split(`?`)[0],i=n.includes(r);if(!t&&!i){Pc();return}if(!t&&i){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Sc,pc()),Fc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),$.start();return}if(t.es_admin&&!t.es_maestro){console.log(`[Init] Admin puro detectado → redirigiendo a /admin`),window.location.href=`/admin`;return}let a=null;try{a=await me(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}Nc(e,t,a),Object.assign(Sc,pc()),_c({isAdmin:!1,getMaestro:()=>yc,getPermisosCached:()=>bc,onPermisosUpdate:async(t,{ganados:r,perdidos:i})=>{let a=($.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`gestionar-clases`&&!t.puede_inscribir_clases||a===`pending-approval`&&r.length>0?`hoy`:a;Nc(e,yc,t),Object.assign(Sc,pc()),Fc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),wc.clear(),await Mc(o),$.navigate(o)},onNavigate:e=>$.navigate(e),onResize:()=>{Nc(e,yc,bc),Object.assign(Sc,pc());let t=($.currentRoute?.()||`hoy`).split(`?`)[0];kn(t)}}),vt(jc,Ac),Fc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),$.start();let o=($.currentRoute?.()||``).split(`?`)[0];(!o||o===`login`||o===`logout`)&&$.navigate(`hoy`),v().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=($.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!wc.has(e)).reduce((e,t)=>e.then(()=>{if(Sc[t])return Mc(t,{},{silent:!0})}),Promise.resolve()),Ic(),window.pwaInstaller?.evaluateInsights()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),kc()}var Rc=(e,t,n,r)=>`
  ...
  </div>`;window.addEventListener(`error`,e=>{if([`useCache`,`WebSocket`,`content.js`].some(t=>(e.message||``).includes(t))){console.warn(`[Ignored Error]`,e.message);return}j(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=Rc(`bi-x-circle-fill`,`Ups! Algo salió mal`,`Se ha producido un error inesperado en la aplicación.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">${e.message}</div><div style="color:rgba(255,255,255,0.4);">${e.filename?.split(`/`).pop()}:${e.lineno}</div>`))}),window.addEventListener(`unhandledrejection`,e=>{j(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=Rc(`bi-exclamation-triangle-fill`,`Error de Sincronización`,`Hubo un problema al procesar una solicitud de red.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">Promise Rejection</div><div style="color:rgba(255,255,255,0.4);">${String(e.reason)}</div>`))}),Lc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});