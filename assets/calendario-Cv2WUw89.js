import"./modulepreload-polyfill-Ke7zwH0v.js";import{i as e}from"./supabase-KnARm58N.js";import"./vendor-BUMNmNsE.js";/* empty css                        */import{t}from"./horarioBuilderView-Bejcz1A1.js";import{t as n}from"./tareasView-D4p5jk1B.js";async function r(t){let{data:n}=await e.from(`profiles`).select(`rol`).eq(`id`,t).maybeSingle();return[`admin`,`superadmin`,`coordinacion_academica`,`direccion`].includes(n?.rol)}function i(t,n=null){t.style.background=``,t.innerHTML=`
