...
`),Se=null,C=``;function Ce(e=``,t=null){let n=document.createElement(`div`);n.className=`dsl-editor-container`;let r=document.createElement(`div`);r.className=`dsl-editor-wrapper position-relative`;let i=document.createElement(`div`);i.className=`dsl-editor form-control`,i.contentEditable=`true`,i.spellcheck=`false`,i.setAttribute(`data-placeholder`,xe),i.innerHTML=e?ve(e):``;let a=document.createElement(`div`);a.className=`dsl-highlight-layer position-absolute top-0 start-0 w-100 h-100 overflow-hidden pointer-events-none`,a.setAttribute(`aria-hidden`,`true`),r.appendChild(a),r.appendChild(i),n.appendChild(r),we();function o(){return i.innerText||i.textContent||``}function s(){let e=o();e!==C&&(C=e,a.innerHTML=ve(e)+`<br>`)}function c(){a.scrollTop=i.scrollTop,a.scrollLeft=i.scrollLeft}function l(){clearTimeout(Se),Se=setTimeout(()=>{s();let e=_e(o());t&&t(o(),e)},be)}function u(e){e.key===`Tab`&&(e.preventDefault(),document.execCommand(`insertText`,!1,`  `))}function d(){c()}i.addEventListener(`input`,l),i.addEventListener(`keydown`,u),i.addEventListener(`scroll`,d),i.addEventListener(`focus`,()=>{n.classList.add(`focused`)}),i.addEventListener(`blur`,()=>{n.classList.remove(`focused`),s()});function f(e){i.innerHTML=e?ve(e):``,C=o(),a.innerHTML=ve(C)+`<br>`}function p(){return o()}function m(){return _e(o())}function h(){i.focus()}function ee(e){i.focus(),document.execCommand(`insertText`,!1,e)}function te(e,t=``){i.focus();let n=window.getSelection();if(!n.rangeCount)return;let r=n.getRangeAt(0);r.deleteContents();let a=document.createTextNode(e),s=document.createTextNode(t);r.insertNode(a),r.collapse(!1),r.insertNode(s),r.setStartAfter(a),r.setEndAfter(a),n.removeAllRanges(),n.addRange(r),C=o()}return n.component={element:n,editor:i,setContent:f,getContent:p,getParsed:m,focus:h,insertText:ee,insertAtCursor:te},n.setContent=f,n.getContent=p,n.getParsed=m,n.focus=h,n.insertText=ee,n.insertAtCursor=te,e&&(C=e),n}function we(){if(document.getElementById(`dsl-editor-styles`))return;let e=document.createElement(`style`);e.id=`dsl-editor-styles`,e.textContent=`
  ...
  `,document.getElementById(`retryBtn`)?.addEventListener(`click`,()=>sn(e))}function un(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded w-100">
        ...
        <div id="emptyContainer">
          ${N.alumnos.length===0?fn():``}
        </div>
      </div>

    </div>
  `}function dn(e){return e.length?e.map(e=>{let t=e.nombre||`-`,n=e.is_active??!0,r=`border-accent-${n?`success`:`secondary`}`,i=`bg-${n?`success`:`secondary`}`;return`
  ...
  `}function pn(e){P=e,e.querySelector(`#btnAgregarAlumno`)?.addEventListener(`click`,()=>yn()),e.querySelector(`#btnExportarCSV`)?.addEventListener(`click`,()=>wn()),e.querySelector(`#buscar`)?.addEventListener(`input`,hn),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,hn),e.querySelector(`#alumnosTBody`)?.addEventListener(`click`,async e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t&&!e.target.closest(`[data-action]`)){xn(t.dataset.id);return}let n=e.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.id;n.dataset.action===`edit`?bn(r):n.dataset.action===`delete`?Sn(r):n.dataset.action===`whatsapp`&&mn(r)})}function mn(e){let t=N.alumnosOriginales.find(t=>t.id===e);!t||!t.telefono||o.open({title:`Enviar WhatsApp a `+M(t.nombre),size:`md`,saveText:`Enviar WhatsApp`,body:`
      <div class="mb-3">
    ...
    `,onSave:async e=>{let n=e.querySelector(`#modal-whatsapp-msg`).value.trim(),r=Qt(t.telefono,n);r&&window.open(r,`_blank`)}})}function hn(){let e=P.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=P.querySelector(`#filtroEstado`)?.value||`todos`;N.alumnos=N.alumnosOriginales.filter(n=>{let r=!e||(n.nombre||``).toLowerCase().includes(e)||(n.instrumento||``).toLowerCase().includes(e)||(n.telefono||``).toLowerCase().includes(e)||(n.familiar_nombre||``).toLowerCase().includes(e),i=t===`todos`||t===`activo`&&n.is_active||t===`inactivo`&&!n.is_active;return r&&i}),Cn()}function gn(e=``){return ut.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}function _n(e=null){let t=e||{};return`<form class="row g-2">
    <div class="col-12">
      <label class="form-label-compact">Nombre Completo *</label>
      <input type="text" class="form-control input-dense" id="modal-nombre" maxlength="${on.nombreMax}" required placeholder="Juan Pérez" autocomplete="off" value="${M(t.nombre||``)}">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="email" class="form-control input-dense" id="modal-email" maxlength="${on.emailMax}" placeholder="representante@ejemplo.com" autocomplete="off" value="${M(t.email||``)}">
    </div>
    <div class="col-md-6">
      <label class="form-label-compact">Cédula del Alumno</label>
      <input type="text" class="form-control input-dense" id="modal-cedula" maxlength="${on.cedulaMax}" placeholder="12345678" autocomplete="off" value="${M(t.cedula||``)}">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control input-dense" id="modal-instrumento" required maxlength="${on.sectionMax}" placeholder="Violín, Piano..." autocomplete="off" value="${M(t.instrumento||``)}">
    </div>
    <div class="col-12">
      <label class="form-label-compact">Dirección</label>
      <input type="text" class="form-control input-dense" id="modal-direccion" maxlength="${on.direccionMax}" placeholder="Dirección completa" autocomplete="off" value="${M(t.direccion||``)}">
    </div>
        ...
        <div class="row g-2">
          ...
          <div class="col-md-4">
            ...
            <select class="form-select input-dense" id="modal-contacto-emergencia-parentesco">
              ${gn(t.contacto_emergencia_parentesco)}
            </select>
          </div>
        </div>
      </div>
    ...
    <div class="col-12">
  ...
  </form>`}async function vn(e,t=null){let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),a=e.querySelector(`#modal-telefono`).value.trim(),o=e.querySelector(`#modal-cedula`).value.trim(),s=e.querySelector(`#modal-fechaNacimiento`).value,c=e.querySelector(`#modal-genero`).value,l=e.querySelector(`#modal-instrumento`).value.trim(),u=e.querySelector(`#modal-familiar-nombre`).value.trim(),d=e.querySelector(`#modal-familiar-telefono-input`).value.trim()||a,f=e.querySelector(`#modal-familiar-parentesco-input`).value,p=e.querySelector(`#modal-esActivo`).checked;return n?l?a?{nombre:n,email:r||null,telefono:Zt(a)||a,cedula:o||null,fecha_nacimiento:s||null,genero:c||null,instrumento:l,is_active:p,familiar_nombre:u||null,familiar_telefono:Zt(d)||d||null,familiar_parentesco:f||null,contacto_emergencia_nombre:e.querySelector(`#modal-contacto-emergencia-nombre`).value.trim()||null,contacto_emergencia_telefono:Zt(e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim())||e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim()||null,contacto_emergencia_parentesco:e.querySelector(`#modal-contacto-emergencia-parentesco`).value||null,condiciones_medicas:e.querySelector(`#modal-condiciones-medicas`).value.trim()||null,alergias:e.querySelector(`#modal-alergias`).value.trim()||null,medicamentos:e.querySelector(`#modal-medicamentos`).value.trim()||null}:(i.error(`El teléfono es obligatorio para WhatsApp`),null):(i.error(`El instrumento es obligatorio`),null):(i.error(`El nombre es obligatorio`),null)}function yn(){N.editando=null,o.open({title:`Crear Nuevo Alumno`,size:`lg`,body:_n(),saveText:`Guardar`,onSave:async e=>{let t=await vn(e);if(!t)return!1;let n=await at(t);N.alumnosOriginales.push(n),hn(),i.success(`Alumno creado exitosamente`)}})}function bn(e){let t=N.alumnosOriginales.find(t=>t.id===e);if(!t){i.error(`Alumno no encontrado`);return}N.editando=e,o.open({title:`Editar Alumno`,size:`lg`,body:_n(t),saveText:`Guardar cambios`,onSave:async e=>{try{let n=await vn(e,t);if(!n)return!1;await ot(N.editando,n);let r=N.alumnosOriginales.findIndex(e=>e.id===N.editando);r!==-1&&(N.alumnosOriginales[r]={...N.alumnosOriginales[r],...n}),hn(),i.success(`Alumno actualizado correctamente`)}catch(e){return console.error(`[alumnosView] Error al actualizar alumno:`,e),i.error(e.message||`Error al guardar los cambios`),!1}}})}function xn(e){let t=N.alumnosOriginales.find(t=>t.id===e);if(!t){i.error(`Alumno no encontrado`);return}N.viewingId=e,o.open({title:M(t.nombre),hideSave:!0,cancelText:`Cerrar`,size:`lg`,body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${en(t.fecha_nacimiento)?en(t.fecha_nacimiento)+` años`:`-`}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Género</label>
            <p class="form-control-plaintext">${tn(t.genero)}</p>
          </div>
          <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">
              <span class="badge ${nn(t.is_active)}">
                ${rn(t.is_active)}
              </span>
            </p>
          </div>
        ...
        <div class="col-md-6">
          ...
          ${t.telefono?`
            <div class="mb-2">
              ...
              <p class="form-control-plaintext"><a href="${Qt(t.telefono)}" target="_blank" class="text-success text-decoration-none"><i class="bi bi-whatsapp"></i> ${j(t.telefono)}</a></p>
            </div>
          `:``}
        </div>
        <div class="col-md-6">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${dt(t.contacto_emergencia_parentesco)}</p>
          </div>
        </div>
      </div>
      `:``}
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Parentesco</label>
            <p class="form-control-plaintext">${dt(t.familiar_parentesco)}</p>
          </div>
        </div>
      </div>
      `:``}
      ...
      <div class="row mt-2 pt-2 border-top">
        <div class="col-6">
          ...
          <p class="form-control-plaintext small">${$t(t.created_at)}</p>
        </div>
        <div class="col-6">
          <label class="form-label fw-bold">Última actualización</label>
          <p class="form-control-plaintext small">${$t(t.updated_at)}</p>
        </div>
      </div>
      
      <!-- ── Wizard fields: Perfil Musical ───────────────────────────────── -->
      ${t.tiene_conocimientos_musicales!==void 0||t.interes_musical?`
      <div class="row mt-3 pt-2 border-top">
        ...
        <div class="col-md-4">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${t.tiene_conocimientos_musicales?`Sí`:`No`}</p>
          </div>
        </div>
        ${t.tiene_conocimientos_musicales?`
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Instrumento previo</label>
            <p class="form-control-plaintext">${M(t.instrumento_previo||`-`)}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Nivel lectura musical</label>
            <p class="form-control-plaintext">${M(t.nivel_lectura_musical||`-`)}</p>
          </div>
        </div>
        `:``}
        <div class="col-md-4">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${M(t.interes_musical||`-`)}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Instrumento de interés</label>
            <p class="form-control-plaintext">${M(t.instrumento_interes||`-`)}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Requiere iniciación musical</label>
            <p class="form-control-plaintext">${t.iniciacion_musical_requerida?`Sí`:`No`}</p>
          </div>
        </div>
        ${t.iniciacion_musical_requerida?`
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Apto para audición desde</label>
            <p class="form-control-plaintext">${M(t.fecha_elegible_audicion||`-`)}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Fin período iniciación</label>
            <p class="form-control-plaintext">${M(t.fecha_fin_iniciacion||`-`)}</p>
          </div>
        </div>
        `:``}
      </div>
      ...
      <!-- ── Wizard fields: Salud ──────────────────────────────────────────── -->
      ${t.problemas_conducta!==void 0||t.alergias_descripcion||t.tiene_condicion_transmisible?`
      <div class="row mt-3 pt-2 border-top">
        <div class="col-12">
          <h6 class="text-warning"><i class="bi bi-bandaid me-1"></i>Salud y Conducta (Wizard)</h6>
        </div>
        ${t.alergias_descripcion?`
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Descripción alergias</label>
            <p class="form-control-plaintext">${M(t.alergias_descripcion)}</p>
          </div>
        </div>
        `:``}
        ${t.tiene_condicion_transmisible&&t.condicion_transmisible_descripcion?`
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Condición transmisible</label>
            <p class="form-control-plaintext">${M(t.condicion_transmisible_descripcion)}</p>
          </div>
        </div>
        `:``}
        ${t.alergia_medicamento&&t.alergia_medicamento_descripcion?`
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Alergia medicamento</label>
            <p class="form-control-plaintext">${M(t.alergia_medicamento_descripcion)}</p>
          </div>
        </div>
        `:``}
        <div class="col-md-6">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${t.impedimento_social?`Sí`:`No`}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-2">
            <label class="form-label fw-bold">Problemas de conducta</label>
            <p class="form-control-plaintext">${M(t.problemas_conducta||`no`)}</p>
          </div>
        </div>
      </div>
      `:``}
      ...
      ${t.centro_estudios||t.grado_nivel||t.padres_en_vida?`
      <div class="row mt-3 pt-2 border-top">
        <div class="col-12">
        ...
        <div class="col-md-4">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${M(t.centro_estudios||`-`)}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Grado / Nivel</label>
            <p class="form-control-plaintext">${M(t.grado_nivel||`-`)}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Padres en vida</label>
            <p class="form-control-plaintext">${M(t.padres_en_vida||`-`)}</p>
          </div>
        </div>
      </div>
      `:``}
      ...
      ${t.acepta_beca_4500!==void 0||t.acepta_pago_600!==void 0?`
      <div class="row mt-3 pt-2 border-top">
        <div class="col-12">
        ...
        <div class="col-md-4">
          <div class="mb-2">
            ...
            <p class="form-control-plaintext">${t.acepta_beca_4500?`<span class="badge bg-success">Sí</span>`:`<span class="badge bg-secondary">No</span>`}</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Acepta aporte RD$600</label>
            <p class="form-control-plaintext">${t.acepta_pago_600?`<span class="badge bg-success">Sí</span>`:`<span class="badge bg-secondary">No</span>`}</p>
          </div>
        </div>
        ${t.fecha_aceptacion_compromisos?`
        <div class="col-md-4">
          <div class="mb-2">
            <label class="form-label fw-bold">Fecha aceptación</label>
            <p class="form-control-plaintext small">${$t(t.fecha_aceptacion_compromisos)}</p>
          </div>
        </div>
        `:``}
      </div>
    ...
    `,onShow:e=>{e.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>bn(t.id),300)}),e.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>Sn(t.id),300)})}})}function Sn(e){let t=N.alumnosOriginales.find(t=>t.id===e);if(!t){i.error(`Alumno no encontrado`);return}N.deletingId=e,o.open({title:`⚠️ Eliminar Alumno`,size:`md`,saveText:`Eliminar`,body:`<div class="d-flex flex-column align-items-center justify-content-center py-5">
             <div class="spinner-border text-primary mb-3" role="status">
               <span class="visually-hidden">Cargando...</span>
             </div>
             <p class="text-muted mb-0">Analizando estado de inscripciones...</p>
           </div>`,onSave:async()=>{await st(e),N.alumnosOriginales=N.alumnosOriginales.filter(t=>t.id!==e),hn(),o.close(),i.success(`Alumno eliminado correctamente`)}});let n=document.querySelector(`#app-global-modal .app-modal-btn-save`);n&&(n.style.display=`none`),setTimeout(async()=>{try{if(N.deletingId!==e)return;let r=await ct(e),i=document.querySelector(`#app-global-modal .app-modal-body`);if(!i||N.deletingId!==e)return;n&&(n.style.display=``),r.length===0?i.innerHTML=`
        ...
        `)}},300)}function Cn(){let e=P.querySelector(`#alumnosTBody`);if(!e)return;N.alumnos.length===0?e.innerHTML=fn():e.innerHTML=dn(N.alumnos);let t=P.querySelector(`#emptyContainer`);t&&(t.innerHTML=N.alumnos.length===0?fn():``);let n=P.querySelector(`.alumnos-header-premium p.text-muted`);n&&(n.textContent=`${N.alumnos.length} alumnos en total`)}function wn(){if(N.alumnosOriginales.length===0){i.error(`No hay alumnos para exportar`);return}let e=[[`Nombre`,`Email`,`Teléfono`,`Estado`,`Fecha Nac.`,`Sección`],...N.alumnosOriginales.map(e=>[e.nombre||``,e.email||``,e.telefono||``,e.estado||`activo`,e.fecha_nacimiento||``,e.section||``])].map(e=>e.map(e=>`"${String(e).replace(/"/g,`""`)}"`).join(`,`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`alumnos-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),i.success(`CSV exportado exitosamente`)}var F=class{constructor(e={}){this.id=e.id||null,this.nombre=e.nombre||``,this.descripcion=e.descripcion||``,this.nivel=e.nivel||``,this.duracion_anios=e.duracion_anios||null,this.activo=e.activo===void 0?!0:e.activo,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(e=[]){let t=[];return!this.nombre||!this.nombre.trim()?t.push(`El nombre del programa es obligatorio`):this.nombre.length>100&&t.push(`El nombre no puede exceder los 100 caracteres`),this.nivel?e.length>0&&!e.includes(this.nivel)&&t.push(`El nivel seleccionado no es válido`):t.push(`El nivel es obligatorio`),this.descripcion&&this.descripcion.length>500&&t.push(`La descripción no puede exceder los 500 caracteres`),this.duracion_anios!==null&&(isNaN(this.duracion_anios)||this.duracion_anios<0)&&t.push(`La duración debe ser un número positivo`),t}toJSON(){return{nombre:this.nombre.trim(),descripcion:this.descripcion?this.descripcion.trim():``,nivel:this.nivel,duracion_anios:this.duracion_anios,activo:this.activo}}},Tn=[{value:``,label:`Sin nivel específico`},{value:`1`,label:`1° Año`},{value:`2`,label:`2° Año`},{value:`3`,label:`3° Año`},{value:`4`,label:`4° Año`},{value:`5`,label:`5° Año`},{value:`6`,label:`6° Año`},{value:`inicial`,label:`Nivel Inicial`},{value:`intermedio`,label:`Nivel Intermedio`},{value:`avanzado`,label:`Nivel Avanzado`},{value:`preuniversitario`,label:`Pre-Universitario`}];function En(e){let t=Tn.find(t=>t.value===e);return t?t.label:e||`-`}async function Dn(){let{data:e,error:n}=await t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0});if(n)throw console.error(`Error cargando programas:`,n.message),n;return(e||[]).map(e=>new F(e))}async function On(e){let n=new F(e),r=Tn.map(e=>e.value).filter(Boolean),i=n.validate(r);if(i.length>0)throw Error(i.join(`. `));let{data:a,error:o}=await t.from(`programas`).insert([n.toJSON()]).select();if(o)throw console.error(`Error creando programa:`,o.message),o;return new F(a[0])}async function kn(e,n){let r=new F(n),i=Tn.map(e=>e.value).filter(Boolean),a=r.validate(i);if(a.length>0)throw Error(a.join(`. `));let{data:o,error:s}=await t.from(`programas`).update(r.toJSON()).eq(`id`,e).select();if(s)throw console.error(`Error actualizando programa:`,s.message),s;return new F(o[0])}async function An(e){let{error:n}=await t.from(`programas`).delete().eq(`id`,e);if(n)throw console.error(`Error eliminando programa:`,n.message),n}async function jn(e){let{jsPDF:t}=await a(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-CIPNF2Pl.js`).then(e=>e.n);return{jsPDF:e}},__vite__mapDeps([0,1,2,3])),{default:n}=await a(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-BYntMLuC.js`).then(e=>e.n);return{default:e}},__vite__mapDeps([4,1])),r=new t;r.setFontSize(18),r.text(`Programas Académicos`,14,22),r.setFontSize(10),r.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,30),n(r,{head:[[`Nombre`,`Nivel`,`Descripción`,`Estado`,`Creado`]],body:e.map(e=>[e.nombre,En(e.nivel),e.descripcion?e.descripcion.substring(0,50)+(e.descripcion.length>50?`...`:``):`-`,e.activo?`Activo`:`Inactivo`,e.created_at?new Date(e.created_at).toLocaleDateString(`es-ES`):`-`]),startY:35,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),r.save(`programas.pdf`)}var I={programas:[],programasOriginales:[],cargando:!1},Mn={nombreMax:100,descripcionMax:500};function L(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function Nn(e){return e?new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`}):`N/A`}function Pn(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].charAt(0).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function Fn(e=``){return Tn.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}async function In(e){try{I.cargando=!0,Ln(e);let t=await Dn();I.programas=t,I.programasOriginales=[...t],I.cargando=!1,zn(e),Un(e)}catch(t){console.error(`[ProgramasView]`,t),Rn(e,t.message)}}function Ln(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>In(e))}function zn(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded w-100">
        ...
        <div id="emptyContainer">
          ${I.programas.length===0?Vn():``}
        </div>
      </div>
    </div>
  `}function Bn(e){return e.length?e.map(e=>{let t=Pn(e.nombre),n=En(e.nivel),r=L(e.descripcion||`Sin descripción`),i=`border-accent-${e.activo?`success`:`secondary`}`,a=`bg-${e.activo?`success`:`secondary`}`;return`
    ...
    `}).join(``):``}function Vn(){return`
    <div class="text-center py-5 text-muted">
      <i class="bi bi-inbox fs-1 d-block mb-2"></i>
      <p>No hay programas que coincidan con la búsqueda.</p>
    </div>
  `}var Hn=null;function Un(e){Hn=e,e.querySelector(`#btnAgregarPrograma`)?.addEventListener(`click`,()=>Kn()),e.querySelector(`#btnExportarPDF`)?.addEventListener(`click`,async()=>{try{await jn(I.programas),i.success(`PDF generado exitosamente`)}catch{i.error(`Error al generar PDF`)}}),e.querySelector(`#buscar`)?.addEventListener(`input`,Wn),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,Wn),e.querySelector(`#programasTBody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t){let t=e.target.closest(`.list-group-item[data-id]`);t&&Yn(t.dataset.id);return}let{action:n,id:r}=t.dataset;n===`edit`&&qn(r),n===`delete`&&Xn(r)})}function Wn(){let e=Hn.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=Hn.querySelector(`#filtroEstado`)?.value||`todos`;I.programas=I.programasOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||(n.descripcion||``).toLowerCase().includes(e),i=t===`todos`||t===`activo`&&n.activo||t===`inactivo`&&!n.activo;return r&&i}),Gn()}function Gn(){let e=Hn.querySelector(`#programasTBody`);e&&(e.innerHTML=Bn(I.programas));let t=Hn.querySelector(`#emptyContainer`);t&&(t.innerHTML=I.programas.length===0?Vn():``)}function Kn(){Jn({title:`Nuevo Programa`,saveText:`Crear Programa`})}function qn(e){let t=I.programasOriginales.find(t=>t.id===e);if(!t)return i.error(`Programa no encontrado`);Jn({title:`Editar Programa`,saveText:`Guardar Cambios`,programa:t})}function Jn({title:e,saveText:t,programa:n=null}){o.open({title:e,saveText:t,body:`
      <form id="form-programa" class="row g-3">
        <div class="col-12">
          <label class="form-label-compact">Nombre del Programa *</label>
          <input type="text" class="form-control input-dense" id="prog-nombre" required maxlength="${Mn.nombreMax}" value="${L(n?.nombre||``)}">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control input-dense" id="prog-descripcion" rows="3" maxlength="${Mn.descripcionMax}">${L(n?.descripcion||``)}</textarea>
        </div>
        <div class="col-12">
          <div class="form-check">
    ...
    `,onSave:async e=>{let t={nombre:e.querySelector(`#prog-nombre`).value.trim(),nivel:e.querySelector(`#prog-nivel`).value,duracion_anios:e.querySelector(`#prog-duracion`).value?parseFloat(e.querySelector(`#prog-duracion`).value):null,descripcion:e.querySelector(`#prog-descripcion`).value.trim(),activo:e.querySelector(`#prog-activo`).checked},r=new F(t),a=Tn.map(e=>e.value).filter(Boolean),o=r.validate(a);if(o.length>0)return i.error(o[0]),!1;try{if(n){let e=await kn(n.id,t),r=I.programasOriginales.findIndex(e=>e.id===n.id);I.programasOriginales[r]=e,i.success(`Programa actualizado`)}else{let e=await On(t);I.programasOriginales.unshift(e),i.success(`Programa creado`)}return Wn(),!0}catch(e){return i.error(e.message),!1}}})}function Yn(e){let t=I.programasOriginales.find(t=>t.id===e);t&&o.open({title:`Perfil del Programa`,hideSave:!0,cancelText:`Cerrar`,body:`
            ...
            <div class="programa-profile-card">
              <div class="row g-2">
                <div class="col-sm-6">
                  ...
                  <p class="mb-0 programa-profile-value small" style="opacity: 0.85;">${Nn(t.created_at)}</p>
                </div>
                <div class="col-sm-6">
                  <label class="programa-profile-label small text-uppercase fw-bold mb-1 d-block" style="font-size: 0.72rem; letter-spacing: 0.05em;">
                    <i class="bi bi-calendar-event me-1"></i> Modificado
                  </label>
                  <p class="mb-0 programa-profile-value small" style="opacity: 0.85;">${t.updated_at?Nn(t.updated_at):Nn(t.created_at)}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    `,onShow:n=>{n.querySelector(`#view-edit-btn`).addEventListener(`click`,()=>{o.close(),setTimeout(()=>qn(e),300)}),n.querySelector(`#view-delete-btn`).addEventListener(`click`,()=>{o.close(),setTimeout(()=>Xn(e),300)}),n.querySelector(`#copy-id-btn`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(t.id),i.success(`ID copiado al portapapeles`)})}})}function Xn(e){let t=I.programasOriginales.find(t=>t.id===e);t&&o.open({title:`⚠️ Eliminar Programa`,saveText:`Confirmar Eliminación`,body:`
    ...
    `,onSave:async()=>{try{return await An(e),I.programasOriginales=I.programasOriginales.filter(t=>t.id!==e),Wn(),i.success(`Programa eliminado`),!0}catch{return i.error(`Error al eliminar`),!1}}})}function Zn(e){return e?{...e,user_id:e.user_id??null,nombre:e.nombre_completo??``,email:e.correo??``,telefono:e.tlf??``,instrumento:e.especialidad??``,bio:e.resena??``,is_active:e.activo??!0,especialidades:Array.isArray(e.especialidades)?e.especialidades:[]}:null}async function Qn(){let{data:e,error:n}=await t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0});if(n)throw console.error(`Error cargando maestros:`,n.message),Error(`No se pudieron cargar los maestros`);return e.map(Zn)}async function $n(e,n){let r={},i=n.nombre||n.nombre_completo;i!==void 0&&(r.nombre_completo=i.trim());let a=n.email||n.correo;a!==void 0&&(r.correo=a.trim().toLowerCase());let o=n.telefono||n.tlf;o!==void 0&&(r.tlf=o.trim());let s=n.instrumento||n.especialidad;s!==void 0&&(r.especialidad=s.trim());let c=n.bio||n.resena;c!==void 0&&(r.resena=c.trim()),n.is_active!==void 0&&(r.activo=n.is_active),n.activo!==void 0&&(r.activo=n.activo),n.especialidades!==void 0&&(r.especialidades=Array.isArray(n.especialidades)?n.especialidades:[]);let{data:l,error:u}=await t.from(`maestros`).update(r).eq(`id`,e).select();if(u)throw console.error(`Error actualizando maestro:`,u.message),Error(`No se pudo actualizar el maestro`);return Zn(l[0])}async function er(e){let{error:n}=await t.from(`maestros`).update({activo:!1}).eq(`id`,e);if(n)throw console.error(`Error inactivando maestro:`,n.message),Error(`No se pudo desactivar el maestro`)}async function tr(e){let{error:n}=await t.from(`maestros`).update({activo:!0}).eq(`id`,e);if(n)throw console.error(`Error activando maestro:`,n.message),Error(`No se pudo activar el maestro`)}async function nr(e){let{data:n,error:r}=await t.from(`maestros`).select(`id`).eq(`correo`,e.trim().toLowerCase()).maybeSingle();return r&&r.code!==`PGRST116`&&console.error(`Error validando email:`,r.message),!!n}function R(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}function rr(e){return e?`success`:`secondary`}function ir(e){return e?`Activo`:`Inactivo`}function ar(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function z(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}function B(e){if(!e)return``;let t=e.split(`:`);return t.length>=2?`${t[0]}:${t[1]}`:e}function or(e){return{activa:`Activa`,suspendida:`Suspendida`,finalizada:`Finalizada`}[e]||`Activa`}function sr(e){return e&&{violin:`bi-music-note-beamed`,viola:`bi-music-note-beamed`,cello:`bi-music-note-beamed`,bajo:`bi-music-note-beamed`,guitarra:`bi-music-note-beamed`,arpa:`bi-music-note-beamed`,flauta:`bi-wind`,oboe:`bi-wind`,clarinete:`bi-wind`,fagot:`bi-wind`,trompa:`bi-wind`,trompeta:`bi-wind`,trombon:`bi-wind`,tuba:`bi-wind`,piano:`bi-piano`,percusion:`bi-disc`,voz:`bi-mic`,direccion:`bi-person-badge`,solfeo:`bi-journal-text`,teoría:`bi-book`}[e.toLowerCase()]||`bi-music-note`}function cr(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function lr(e){let t=[`#007aff`,`#5856d6`,`#34c759`,`#ff3b30`,`#ff9500`,`#5ac8fa`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}function V(e){if(!e)return 0;let t=e.trim(),n=!1,r=t;t.toLowerCase().includes(`pm`)?(n=!0,r=t.toLowerCase().replace(`pm`,``).trim()):t.toLowerCase().includes(`am`)&&(r=t.toLowerCase().replace(`am`,``).trim());let i=r.split(`:`),a=parseInt(i[0],10)||0,o=parseInt(i[1],10)||0;return n&&a<12?a+=12:!n&&a===12&&(a=0),a*60+o}var ur=class{constructor(e={}){this.id=e.id||null,this.nombre=e.nombre||``,this.maestro_principal_id=e.maestro_principal_id||e.maestro_id||null,this.maestro_suplente_id=e.maestro_suplente_id||e.maestro_auxiliar_id||null,this.tiene_suplente=e.tiene_suplente||!1,this.programa_id=e.programa_id||null,this.instrumento=e.instrumento||``,this.horarios=e.horarios||[],this.capacidad_maxima=e.capacidad_maxima??e.max_alumnos??20,this.estado=e.estado||`activa`,this.descripcion=e.descripcion||e.notas_pedagogicas||``,this.tipo_clase=e.tipo_clase||`grupal`,this.nivel_id=e.nivel_id||null,this.planificacion_id=e.planificacion_id||null,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}get maestro_id(){return this.maestro_principal_id}set maestro_id(e){this.maestro_principal_id=e}get maestro_auxiliar_id(){return this.maestro_suplente_id}set maestro_auxiliar_id(e){this.maestro_suplente_id=e}get max_alumnos(){return this.capacidad_maxima}set max_alumnos(e){this.capacidad_maxima=e}get notas_pedagogicas(){return this.descripcion}set notas_pedagogicas(e){this.descripcion=e}validate(){let e=[];!this.nombre||!this.nombre.trim()?e.push(`El nombre es obligatorio`):this.nombre.trim().length<3?e.push(`El nombre debe tener mínimo 3 caracteres`):this.nombre.trim().length>100&&e.push(`El nombre no puede exceder 100 caracteres`),this.maestro_principal_id||e.push(`El maestro titular es obligatorio`),this.programa_id||e.push(`El programa es obligatorio`),(!this.instrumento||!this.instrumento.trim())&&e.push(`El instrumento es obligatorio`),(!this.horarios||this.horarios.length===0)&&e.push(`Debe agregar al menos un horario`);for(let t of this.horarios)t.dia||e.push(`El día es obligatorio en todos los horarios`),(!t.hora_inicio||!t.hora_fin)&&e.push(`La hora de inicio y fin son obligatorias en todos los horarios`),t.hora_inicio&&t.hora_fin&&V(t.hora_inicio)>=V(t.hora_fin)&&e.push(`La hora de inicio debe ser menor que la hora de fin`);let t={};this.horarios.forEach(e=>{if(!e.dia||!e.hora_inicio||!e.hora_fin)return;let n=e.dia.toLowerCase().trim();t[n]||(t[n]=[]),t[n].push(e)});for(let n in t){let r=t[n].sort((e,t)=>V(e.hora_inicio)-V(t.hora_inicio));for(let t=0;t<r.length-1;t++){let i=r[t],a=r[t+1];if(V(i.hora_fin)>V(a.hora_inicio)){let t=n.charAt(0).toUpperCase()+n.slice(1);e.push(`Existen horarios solapados en la misma clase (${t})`);break}}}return this.capacidad_maxima!==void 0&&this.capacidad_maxima!==null&&(this.capacidad_maxima<1?e.push(`El máximo de alumnos debe ser al menos 1`):this.capacidad_maxima>100&&e.push(`El máximo de alumnos no puede exceder 100`)),this.descripcion&&this.descripcion.length>1e3&&e.push(`Las notas pedagógicas no pueden exceder 1000 caracteres`),e}isCompleto(){return!!(this.nombre&&this.maestro_principal_id&&this.programa_id&&this.instrumento&&this.horarios?.length>0)}toJSON(){return{id:this.id,nombre:this.nombre.trim(),maestro_principal_id:this.maestro_principal_id,maestro_suplente_id:this.maestro_suplente_id||null,programa_id:this.programa_id,instrumento:this.instrumento.trim(),capacidad_maxima:this.capacidad_maxima,estado:this.estado,descripcion:this.descripcion.trim()||null,tipo_clase:this.tipo_clase||`grupal`}}static getEstados(){return[`activa`,`suspendida`,`finalizada`]}static getDiasSemana(){return[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`]}static getEstadoLabel(e){return{activa:`Activa`,suspendida:`Suspendida`,finalizada:`Finalizada`}[e]||e}};async function dr({salonId:e,maestroId:n,dia:r,horaInicio:i,horaFin:a,excludeClaseId:o=null}){if(!r||!i||!a)return null;let s=V(i),c=V(a);if(e){let{data:n,error:i}=await t.from(`clase_horarios`).select(`*, clases(nombre)`).eq(`salon_id`,e).eq(`dia`,r);if(!i&&n)for(let e of n){if(o&&e.clase_id===o)continue;let t=V(e.hora_inicio);if(s<V(e.hora_fin)&&t<c)return{tipo:`salón`,clase_nombre:e.clases?.nombre||`Otra clase`,detalle:`El salón ya está ocupado por "${e.clases?.nombre}"`,horario:`${e.dia} de ${B(e.hora_inicio)} a ${B(e.hora_fin)}`}}}if(n){let{data:e,error:i}=await t.from(`clase_horarios`).select(`*, clases!inner(nombre, maestro_principal_id)`).eq(`clases.maestro_principal_id`,n).eq(`dia`,r);if(!i&&e)for(let t of e){if(o&&t.clase_id===o)continue;let e=V(t.hora_inicio);if(s<V(t.hora_fin)&&e<c)return{tipo:`maestro`,clase_nombre:t.clases?.nombre||`Otra clase`,detalle:`El maestro ya tiene otra clase asignada ("${t.clases?.nombre}")`,horario:`${t.dia} de ${B(t.hora_inicio)} a ${B(t.hora_fin)}`}}}return null}function H(e){return e?new ur({...e,maestro_principal_id:e.maestro_principal_id??e.maestro_id??null,maestro_suplente_id:e.maestro_suplente_id??null,tiene_suplente:!!e.maestro_suplente_id,capacidad_maxima:e.capacidad_maxima??e.max_alumnos??20,descripcion:e.descripcion??e.notas_pedagogicas??``}):null}async function fr(){let{data:e,error:n}=await t.from(`clases`).select(`*`).order(`nombre`,{ascending:!0});if(n)throw console.error(`Error cargando clases:`,n.message),Error(`No se pudieron cargar las clases`);let{data:r}=await t.from(`clase_horarios`).select(`*`).order(`dia`,{ascending:!0});return(e||[]).map(e=>{let t=H(e);return t.horarios=r?.filter(t=>t.clase_id===e.id)||[],t})}async function pr(e){let{data:n,error:r}=await t.from(`clases`).select(`*`).eq(`id`,e).single();if(r)throw console.error(`Error cargando clase:`,r.message),Error(`Clase no encontrada`);let{data:i}=await t.from(`clase_horarios`).select(`*`).eq(`clase_id`,e),a=H(n);return a.horarios=i||[],a}async function mr(e,n=!1){let r=H(e);r.horarios=e.horarios||[];let i=r.validate();if(i.length>0)throw Error(i.join(`. `));if(!n)for(let e of r.horarios){let t=await dr({salonId:e.salon_id,maestroId:r.maestro_principal_id,dia:e.dia,horaInicio:e.hora_inicio,horaFin:e.hora_fin});if(t){let e=Error(`Conflicto de ${t.tipo}: ${t.detalle} el ${t.horario}`);throw e.isConflict=!0,e.conflictData=t,e}}let a=r.toJSON();delete a.id;let{data:o,error:s}=await t.from(`clases`).insert([a]).select();if(s)throw console.error(`Error creando clase:`,s.message),Error(`No se pudo crear la clase`);let c=o[0];if(r.horarios.length>0){let e=r.horarios.map(e=>({clase_id:c.id,dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id||null,maestro_id:c.maestro_principal_id})),{error:n}=await t.from(`clase_horarios`).insert(e);if(n)throw console.error(`Error creando horarios:`,n.message),await t.from(`clases`).delete().eq(`id`,c.id),Error(`No se pudieron crear los horarios de la clase`);return H({...c,horarios:e})}return H(c)}async function hr(e,n,r=!1){let i=await pr(e),a=new ur({...i,...n});n.horarios===void 0?a.horarios=i.horarios:a.horarios=n.horarios;let o=a.validate();if(o.length>0)throw Error(o.join(`. `));if(!r&&n.horarios)for(let t of a.horarios){let n=await dr({salonId:t.salon_id,maestroId:a.maestro_id,dia:t.dia,horaInicio:t.hora_inicio,horaFin:t.hora_fin,excludeClaseId:e});if(n){let e=Error(`Conflicto de ${n.tipo}: ${n.detalle} el ${n.horario}`);throw e.isConflict=!0,e.conflictData=n,e}}let{data:s,error:c}=await t.from(`clases`).update(a.toJSON()).eq(`id`,e).select();if(c)throw console.error(`Error actualizando clase:`,c.message),Error(`No se pudo actualizar la clase`);if(n.horarios){let{error:r}=await t.from(`clase_horarios`).delete().eq(`clase_id`,e);if(r)throw console.error(`Error eliminando horarios anteriores:`,r.message),Error(`No se pudieron actualizar los horarios de la clase`);if(n.horarios.length>0){let r=n.horarios.map(t=>({clase_id:e,dia:t.dia,hora_inicio:t.hora_inicio,hora_fin:t.hora_fin,salon_id:t.salon_id||null,maestro_id:a.maestro_principal_id})),{error:i}=await t.from(`clase_horarios`).insert(r);if(i)throw console.error(`Error insertando nuevos horarios:`,i.message),Error(`No se pudieron guardar los nuevos horarios de la clase: `+i.message)}}return pr(e)}async function gr(e){let{error:n}=await t.from(`clases`).delete().eq(`id`,e);if(n)throw console.error(`Error eliminando clase:`,n.message),Error(`No se pudo eliminar la clase`)}async function _r(e){let{data:n,error:r}=await t.from(`clases`).select(`
      *,
      clase_horarios ( dia, hora_inicio, hora_fin, salon_id ),
      alumnos_clases ( id )
    `).or(`maestro_principal_id.eq.${e},maestro_suplente_id.eq.${e}`).order(`nombre`,{ascending:!0});if(r)throw r;return(n||[]).map(t=>{let n=H(t);return n.horarios=t.clase_horarios||[],n.total_alumnos=(t.alumnos_clases||[]).length,n.es_suplente=t.maestro_principal_id!==e,n})}async function vr(e,n,r=null,i=null){let{data:a,error:o}=await t.from(`alumnos_clases`).insert([{clase_id:e,alumno_id:n,activo:!0,fecha_inscripcion:new Date().toISOString().split(`T`)[0],hora_inicio:r,hora_fin:i}]).select();if(o)throw o.code===`23505`?Error(`El alumno ya está inscrito en esta clase`):o;return a[0]}async function yr(e,n){let{error:r}=await t.from(`alumnos_clases`).delete().eq(`clase_id`,e).eq(`alumno_id`,n);if(r)throw r}async function br(e,n,r,i){let{data:a,error:o}=await t.from(`alumnos_clases`).update({hora_inicio:r,hora_fin:i}).eq(`clase_id`,e).eq(`alumno_id`,n).select();if(o)throw o;return a[0]}async function xr(e){let{data:n,error:r}=await t.from(`alumnos_clases`).select(`*, alumno:alumnos(*)`).eq(`clase_id`,e).eq(`activo`,!0).order(`created_at`,{ascending:!1});if(r)throw r;return n||[]}var U={maestros:[],salones:[],programas:[],alumnos:[],onSuccess:null},Sr={nombreMax:100,notasMax:500};async function Cr(e=null,t={}){U={...U,...t};let n=!!e,r=[],a=[];if(n){i.info(`Cargando datos de la clase...`);let t=await xr(e.id);r=(t||[]).map(e=>e.alumno_id),a=t||[]}let s=n?`Editar Clase: ${e.nombre}`:`Nueva Clase`,c=n?`Guardar Cambios`:`Crear Clase`;o.open({title:s,saveText:c,size:`lg`,body:wr(e,r,a),onShow:t=>{Er(t,e)},onSave:async t=>await Dr(t,e)})}function wr(e,t,n=[]){return`
    <form class="row g-3" id="formClase">
      <div class="col-md-6">
        <label class="form-label-compact">Nombre de la Clase *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required placeholder="Ej: Violín Básico A" value="${z(e?.nombre||``)}" maxlength="${Sr.nombreMax}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Instrumento *</label>
      ...
      <div class="col-12">
        ...
        <textarea class="form-control input-dense" id="modal-notas_pedagogicas" rows="2" placeholder="Observaciones sobre el grupo o metodología..." maxlength="${Sr.notasMax}">${z(e?.descripcion||``)}</textarea>
      </div>
  ...
  `}function Tr(e=[]){let t=U.alumnos||[],n=(e=``,n=``,r=``)=>(t.find(t=>t.id===e),`
    ...
    <div class="text-end mt-1">
    ...
    </div>`}function Er(e,t){let n=e.querySelector(`#modal-tiene_suplente`),r=e.querySelector(`#modal-maestro_suplente_id`);n&&r&&n.addEventListener(`change`,e=>{r.style.display=e.target.checked?`block`:`none`,e.target.checked||(r.value=``)}),e.querySelector(`#btn-add-horario`).addEventListener(`click`,()=>{let t=e.querySelector(`#modal-horarios-container`),n=t.children.length,r=document.createElement(`div`);r.innerHTML=Nr(null,n),t.appendChild(r.firstElementChild)}),e.querySelector(`#modal-horarios-container`).addEventListener(`click`,t=>{let n=t.target.closest(`.btn-remove-horario`);n&&(e.querySelector(`#modal-horarios-container`).children.length>1?n.closest(`.horario-row`).remove():i.warning(`La clase debe tener al menos un horario`))});let a=e.querySelector(`#seccion-alumnos-grupal`),o=e.querySelector(`#seccion-alumnos-rotativa`);e.querySelectorAll(`input[name="modal-tipo_clase"]`).forEach(t=>{t.addEventListener(`change`,()=>{let t=e.querySelector(`input[name="modal-tipo_clase"]:checked`)?.value===`rotativa`;a.style.display=t?`none`:`block`,o.style.display=t?`block`:`none`})});let s=e.querySelector(`#slots-container`),c=e.querySelector(`#slots-count`),l=()=>{let e=s.querySelectorAll(`.slot-row`).length;c.textContent=`${e} turno${e===1?``:`s`} asignado${e===1?``:`s`}`};e.querySelector(`#btn-add-slot`)?.addEventListener(`click`,()=>{let e=U.alumnos||[],t=document.createElement(`div`);t.innerHTML=(Tr([]).split(`id="slots-container"`)[1],``);let n=document.createElement(`div`);n.className=`slot-row d-flex align-items-center gap-2 mb-2 p-2 rounded border bg-body-tertiary`,n.innerHTML=`
      <select class="form-select form-select-sm slot-alumno-select flex-grow-1" style="min-width:0;" required>
        <option value="">Seleccionar alumno…</option>
      ...
      <button type="button" class="btn btn-sm btn-link text-danger p-0 btn-remove-slot" title="Quitar turno">
        <i class="bi bi-x-circle-fill fs-5"></i>
      </button>`,s.appendChild(n),l()}),s?.addEventListener(`click`,e=>{if(e.target.closest(`.btn-remove-slot`)){if(s.querySelectorAll(`.slot-row`).length<=1){i.warning(`Debe haber al menos un turno en una clase rotativa`);return}e.target.closest(`.slot-row`).remove(),l()}});let u=e.querySelector(`#search-modal-alumnos`),d=e.querySelectorAll(`.alumno-check-item`);u?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();d.forEach(e=>{let n=e.dataset.nombre.includes(t)||e.dataset.instrumento.includes(t);e.style.display=n?`block`:`none`})});let f=e.querySelectorAll(`.alumnos-list input[type="checkbox"]`),p=e.querySelector(`#alumnos-selection-count`),m=()=>{let e=Array.from(f).filter(e=>e.checked).length;p&&(p.textContent=`${e} alumnos seleccionados`)};f.forEach(e=>e.addEventListener(`change`,m)),m()}async function Dr(e,t){let n=!!t,r=(()=>{let t=e.querySelector(`#modal-maestro_suplente_id`).value,n=e.querySelector(`#modal-tiene_suplente`).checked;return{nombre:e.querySelector(`#modal-nombre`).value.trim(),programa_id:e.querySelector(`#modal-programa_id`).value,maestro_principal_id:e.querySelector(`#modal-maestro_id`).value,maestro_suplente_id:n?t:null,tiene_suplente:n,instrumento:e.querySelector(`#modal-instrumento`).value.trim(),capacidad_maxima:parseInt(e.querySelector(`#modal-max_alumnos`).value)||20,estado:e.querySelector(`#modal-estado`).value,tipo_clase:e.querySelector(`input[name="modal-tipo_clase"]:checked`)?.value||`grupal`,descripcion:e.querySelector(`#modal-notas_pedagogicas`).value.trim(),horarios:Array.from(e.querySelectorAll(`.horario-row`)).map(e=>({dia:e.querySelector(`[name="horario-dia"]`).value,hora_inicio:e.querySelector(`[name="horario-hora_inicio"]`).value,hora_fin:e.querySelector(`[name="horario-hora_fin"]`).value,salon_id:e.querySelector(`[name="horario-salon_id"]`).value||null}))}})(),a=new ur(r).validate();if(a.length>0)return i.error(a[0]),!1;let o=()=>Array.from(e.querySelectorAll(`#slots-container .slot-row`)).map(e=>({alumno_id:e.querySelector(`.slot-alumno-select`).value,hora_inicio:e.querySelector(`.slot-hora-inicio`).value,hora_fin:e.querySelector(`.slot-hora-fin`).value})).filter(e=>e.alumno_id),s=async t=>{let n=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value),r=(await xr(t)).map(e=>e.alumno_id),i=n.filter(e=>!r.includes(e)),a=r.filter(e=>!n.includes(e));await Promise.all([...i.map(e=>vr(t,e)),...a.map(e=>yr(t,e))])},c=async e=>{let t=o();if(t.length===0)return i.warning(`Agregá al menos un turno`),!1;if(t.find(e=>!e.hora_inicio||!e.hora_fin))return i.error(`Todos los turnos deben tener hora de inicio y fin`),!1;let n=(await xr(e)).map(e=>e.alumno_id),r=t.map(e=>e.alumno_id),a=n.filter(e=>!r.includes(e));return await Promise.all(a.map(t=>yr(e,t))),await Promise.all(t.map(t=>n.includes(t.alumno_id)?br(e,t.alumno_id,t.hora_inicio,t.hora_fin):vr(e,t.alumno_id,t.hora_inicio,t.hora_fin))),!0};try{let a;if(n)if(a=await hr(t.id,r),r.tipo_clase===`rotativa`){if(!await c(a.id))return!1}else await s(a.id);else if(a=await mr(r),r.tipo_clase===`rotativa`){if(!await c(a.id))return!1}else{let t=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value);t.length>0&&await Promise.all(t.map(e=>vr(a.id,e)))}return i.success(n?`Clase actualizada`:`Clase creada`),U.onSuccess&&U.onSuccess(),!0}catch(e){return e.isConflict?i.warning(`Conflicto detected: ${e.message}`):i.error(e.message),!1}}function Or(e=``){return`<option value="">Seleccionar maestro...</option>`+U.maestros.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${z(t.nombre_completo||t.nombre)}</option>`).join(``)}function kr(e=``){return`<option value="">Sin salón (Online/Otro)</option>`+U.salones.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${z(t.nombre)}</option>`).join(``)}function Ar(e=``){return`<option value="">Seleccionar programa...</option>`+U.programas.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${z(t.nombre)}</option>`).join(``)}function jr(e=`activa`){return ur.getEstados().map(t=>`<option value="${t}" ${t===e?`selected`:``}>${ur.getEstadoLabel(t)}</option>`).join(``)}function Mr(){return`<datalist id="instrumentos-list">${[`Violín`,`Viola`,`Cello`,`Piano`,`Flauta`,`Teoría`,`Coro`].map(e=>`<option value="${e}">`).join(``)}</datalist>`}function Nr(e,t){return`
  ...
  `}function Pr(e=[]){return e.length===0?Nr(null,0):e.map((e,t)=>Nr(e,t)).join(``)}function Fr(e=[]){return`
  ...
  `}var Ir=`app-help-panel`,Lr=`app-help-overlay`,Rr=!1;function zr(){if(Rr)return;Rr=!0;let e=document.createElement(`style`);e.id=`app-help-panel-styles`,e.textContent=`
    /* ── Overlay ─────────────────────────────────────────── */
    #app-help-overlay {
      display: none;
      position: fixed;
  ...
  `,document.head.appendChild(e)}function Br(){if(document.getElementById(Ir))return;zr();let e=document.createElement(`div`);e.id=Lr,document.body.appendChild(e);let t=document.createElement(`div`);t.id=Ir,t.setAttribute(`role`,`complementary`),t.setAttribute(`aria-label`,`Ayuda`),t.innerHTML=`
    <div id="ahp-header">
  ...
  `,document.body.appendChild(t),e.addEventListener(`click`,()=>W.close()),t.querySelector(`#ahp-close`).addEventListener(`click`,()=>W.close()),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&W.close()})}var W={open({title:e,intro:t,sections:n=[]}){Br();let r=document.getElementById(Ir),i=document.getElementById(Lr);document.getElementById(`ahp-title`).textContent=e||`Ayuda`,document.getElementById(`ahp-body`).innerHTML=`
    ...
    `,i.style.display=`block`,requestAnimationFrame(()=>{i.classList.add(`hp-visible`),r.classList.add(`hp-visible`)})},close(){let e=document.getElementById(Ir),t=document.getElementById(Lr);!e||!e.classList.contains(`hp-visible`)||(e.classList.remove(`hp-visible`),t.classList.remove(`hp-visible`),setTimeout(()=>{t&&(t.style.display=`none`)},280))}},G={maestros:[],maestrosOriginales:[],editando:null,deletingId:null},Vr={nombreMax:100},K=null,Hr=[`Piano`,`Guitarra`,`Violín`,`Viola`,`Cello`,`Contrabajo`,`Flauta`,`Clarinete`,`Oboe`,`Fagot`,`Saxofón`,`Trompeta`,`Trombón`,`Corno`,`Tuba`,`Percusión`,`Batería`,`Canto`,`Teoría`,`Solfeo`,`Dirección`,`Composición`,`Arreglos`];async function Ur(e){try{Wr(e);let t=await Qn();G.maestros=t,G.maestrosOriginales=[...t],Yr(e),Zr(e)}catch(t){console.error(t),Gr(e,t.message)}}function Wr(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status">
          <span class="visually-hidden">Cargando...</span>
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>Ur(e))}function Kr(e=[],t=`modal-especialidades-input`){return`
    <div class="mb-3">
  ...
  `}function qr(e){let t=e.querySelector(`.especialidades-chips-container`);if(!t)return[];let n=t.querySelectorAll(`.chip-item`);return Array.from(n).map(e=>e.textContent.replace(/×$/,``).trim())}function Jr(e,t){let n=e.querySelector(`#modal-especialidades-input`),r=e.querySelector(`#btnAddEspecialidad`),i=e.querySelector(`.especialidades-chips-container`),a=r=>{let a=r.trim();if(a){if(!qr(e).includes(a)){let e=i.querySelector(`.chips-wrapper`),n=document.createElement(`span`);n.className=`badge bg-primary-subtle text-primary rounded-pill chip-item`,n.innerHTML=`${R(a)}<i class="bi bi-x-lg chip-remove" data-especialidad="${R(a)}" style="cursor:pointer;margin-left:4px;"></i>`,e.appendChild(n),t&&t()}n.value=``}};n?.addEventListener(`keypress`,e=>{e.key===`Enter`&&(e.preventDefault(),a(n.value))}),r?.addEventListener(`click`,()=>a(n.value)),i?.addEventListener(`click`,e=>{e.target.classList.contains(`chip-remove`)&&(e.target.closest(`.chip-item`).remove(),t&&t()),e.target.classList.contains(`suggest-chip`)&&(e.preventDefault(),a(e.target.dataset.especialidad))})}function Yr(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function Xr(e){return e.length?e.map(e=>{let t=e.nombre||e.name||`-`,n=e.is_active??!0,r=`border-accent-${n?`success`:`secondary`}`,i=`bg-${n?`success`:`secondary`}`;return`
      <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${r}" data-id="${e.id}" style="cursor: pointer;">
        <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
          <div class="position-relative flex-shrink-0">
            <div class="avatar-compact bg-primary bg-opacity-10 text-primary border border-primary-subtle d-flex align-items-center justify-content-center rounded-circle" style="width: 48px; height: 48px; font-size: 1.2rem; font-weight: 600;">
    ...
    `}).join(``):`
      ...
      </div>`}function Zr(e){K=e,e.querySelector(`#btnAgregarMaestro`).addEventListener(`click`,()=>ei()),e.querySelector(`#btn-help-maestros`)?.addEventListener(`click`,()=>{W.open({title:`Maestros`,intro:`Gestión del plantel docente. Desde acá podés ver, agregar, editar y desactivar maestros, y acceder al perfil completo de cada uno.`,sections:[{icon:`bi-search`,title:`Buscador y filtros`,description:`Filtrá por nombre, instrumento o estado (activo/inactivo) en tiempo real.`,color:`#6b7280`},{icon:`bi-person-badge`,title:`Tarjeta de maestro`,description:`Nombre, instrumento principal, clases activas y estado. Badge verde = activo, gris = inactivo.`,color:`#3b82f6`},{icon:`bi-eye`,title:`Ver perfil`,description:`Perfil completo: datos personales, clases (titular y suplente), horarios y ocupación.`,color:`#10b981`},{icon:`bi-pencil`,title:`Editar desde el perfil`,description:`Desde el perfil podés editar cualquier clase que dicte directamente, sin salir del modal.`,color:`#f59e0b`},{icon:`bi-person-x`,title:`Desactivar maestro`,description:`Desactivar oculta al maestro de listas operativas pero conserva su historial. No elimina datos.`,color:`#ef4444`}]})}),e.querySelector(`#btnExportarCSV`)?.addEventListener(`click`,()=>oi()),e.querySelector(`#buscar`).addEventListener(`input`,()=>$r()),e.querySelector(`#filtroEstado`).addEventListener(`change`,()=>$r()),e.querySelector(`#maestrosTBody`).addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t&&!e.target.closest(`[data-action]`)){ni(t.dataset.id);return}let n=e.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.id,i=n.dataset.action;i===`edit`?ti(r):i===`delete`?ri(r):i===`whatsapp`&&Qr(r)})}function Qr(e){let t=G.maestrosOriginales.find(t=>t.id===e);if(!t||!t.telefono)return;let n=t.telefono.replace(/\D/g,``);o.open({title:`Enviar WhatsApp a `+R(t.nombre||t.name||``),size:`md`,saveText:`Enviar WhatsApp`,body:`
      <div class="mb-3">
        <label class="form-label-compact">Número de destino</label>
        <p class="form-control-plaintext fw-bold mb-0">
    ...
    `,onSave:async e=>{let t=e.querySelector(`#modal-whatsapp-msg`).value.trim(),r=`https://wa.me/${n}?text=${encodeURIComponent(t)}`;window.open(r,`_blank`)}})}function $r(){let e=K.querySelector(`#buscar`).value.trim().toLowerCase(),t=K.querySelector(`#filtroEstado`).value;G.maestros=G.maestrosOriginales.filter(n=>{let r=(n.nombre||n.name||``).toLowerCase(),i=!e||r.includes(e)||(n.email||``).toLowerCase().includes(e)||(n.instrumento||``).toLowerCase().includes(e)||(n.especialidad||``).toLowerCase().includes(e)||(n.especialidades||[]).some(t=>t.toLowerCase().includes(e)),a=n.is_active??!0;return i&&(t===`todos`||t===`activo`&&a||t===`inactivo`&&!a)}),ii()}function ei(){G.editando=null,o.open({title:`Crear Nuevo Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${Vr.nombreMax}" placeholder="Juan Pérez">
        <small class="text-muted" id="modal-nombreCount">0/${Vr.nombreMax}</small>
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Email *</label>
    ...
    </form>`,onShow:e=>Jr(e),saveText:`Guardar`,onSave:async e=>{let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-password`)?.value,a=e.querySelector(`#modal-telefono`).value.trim(),o=e.querySelector(`#modal-instrumento`).value.trim(),s=e.querySelector(`#modal-bio`).value.trim();if(!n)return q(`El nombre es obligatorio`,`error`),!1;if(!r)return q(`El email es obligatorio`,`error`),!1;if(!ai(r))return q(`El formato del email no es válido`,`error`),!1;if(!i||i.length<6)return q(`La contraseña debe tener al menos 6 caracteres`,`error`),!1;if(!o)return q(`El instrumento es obligatorio`,`error`),!1;if(r&&await nr(r))return q(`El email ya está registrado`,`error`),!1;let c=qr(e);try{let{data:e,error:l}=await t.auth.signUp({email:r,password:i,options:{data:{full_name:n,rol:`maestro`}}});if(l)return q(l.message||`Error al crear usuario`,`error`),!1;if(!e?.user)return q(`No se pudo crear el usuario`,`error`),!1;let u=e.user.id;await t.from(`profiles`).update({estado:`activo`}).eq(`id`,u),await t.from(`maestros`).update({tlf:a||null,especialidad:o||null,resena:s||null,especialidades:c}).eq(`user_id`,u);let d=await Qn();G.maestros=d,G.maestrosOriginales=[...d],$r(),q(`Maestro creado exitosamente. Ya puede iniciar sesión.`,`success`)}catch(e){console.error(`Error creando maestro:`,e),q(`Error al crear el maestro: `+e.message,`error`)}}})}function ti(e){let t=G.maestrosOriginales.find(t=>t.id===e);if(!t){q(`Maestro no encontrado`,`error`);return}G.editando=e,o.open({title:`Editar Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${Vr.nombreMax}" value="${R(t.nombre||t.name||``)}">
        <small class="text-muted" id="modal-nombreCount">${(t.nombre||t.name||``).length}/${Vr.nombreMax}</small>
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Email *</label>
      ...
      ${Kr(t.especialidades||[],`modal-especialidades-input`)}
      <div class="col-12">
        <label class="form-label-compact">Biografía</label>
    ...
    </form>`,onShow:e=>Jr(e),saveText:`Guardar cambios`,onSave:async e=>{let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-telefono`).value.trim(),a=e.querySelector(`#modal-instrumento`).value.trim(),o=e.querySelector(`#modal-especialidad`).value.trim(),s=e.querySelector(`#modal-bio`).value.trim(),c=e.querySelector(`#modal-esActivo`).checked;if(!n)return q(`El nombre es obligatorio`,`error`),!1;if(!r)return q(`El email es obligatorio`,`error`),!1;if(!ai(r))return q(`El formato del email no es válido`,`error`),!1;if(r&&t.email!==r&&await nr(r))return q(`El email ya está registrado`,`error`),!1;let l=qr(e),u={nombre:n,email:r||null,telefono:i||null,instrumento:a||null,especialidad:o||null,bio:s||null,is_active:c,especialidades:l};await $n(G.editando,u);let d=G.maestrosOriginales.findIndex(e=>e.id===G.editando);d!==-1&&(G.maestrosOriginales[d]={...G.maestrosOriginales[d],...u}),$r(),q(`Maestro actualizado correctamente`,`success`)}})}function ni(e){let n=G.maestrosOriginales.find(t=>t.id===e);if(!n){q(`Maestro no encontrado`,`error`);return}let r=n.nombre||n.name||`-`,i=n.is_active??!0;o.open({title:r,hideSave:!0,cancelText:`Cerrar`,body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            <label class="form-label fw-bold">Nombre</label>
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3">
            <label class="form-label fw-bold">Estado</label>
            <p class="form-control-plaintext">
              <span class="badge ${rr(i)}">${ir(i)}</span>
            </p>
          </div>
        </div>
      </div>
    ...
    `,onShow:async n=>{n.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>ti(e),300)}),n.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>ri(e),300)});let r=n.querySelector(`#maestro-clases-container`),i=n.querySelector(`#maestro-clases-badge`);(async()=>{try{let[n,a,s,c,l]=await Promise.all([_r(e),t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),t.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]),u={maestros:a.data||[],salones:s.data||[],programas:c.data||[],alumnos:l.data||[]};if(i.textContent=`${n.length} clase${n.length===1?``:`s`}`,n.length===0){r.innerHTML=`
            ...
            </div>`,r.querySelectorAll(`.btn-editar-clase`).forEach(t=>{t.addEventListener(`click`,t=>{let r=t.currentTarget.dataset.claseId,i=n.find(e=>e.id===r);i&&(o.close(),setTimeout(()=>{Cr(i,{...u,onSuccess:()=>{setTimeout(()=>ni(e),300)}})},300))})}),r.querySelectorAll(`.btn-desvincular-clase`).forEach(t=>{t.addEventListener(`click`,async t=>{let n=t.currentTarget.dataset.claseId,r=t.currentTarget.dataset.claseNombre,i=t.currentTarget.dataset.esSuplente===`true`?`maestro_suplente_id`:`maestro_principal_id`;if(confirm(`¿Quitar a este maestro de "${r}"?`))try{t.currentTarget.disabled=!0,t.currentTarget.innerHTML=`<span class="spinner-border spinner-border-sm"></span>`,await hr(n,{[i]:null},!0),q(`Maestro desvinculado correctamente`,`success`),o.close(),setTimeout(()=>ni(e),300)}catch(e){q(`Error al desvincular: `+e.message,`error`),t.currentTarget.disabled=!1,t.currentTarget.innerHTML=`<i class="bi bi-person-dash" style="font-size:1rem;"></i><span>Quitar</span>`}})})}catch{i.textContent=`Error`,r.innerHTML=`
            <div class="alert alert-danger py-2 mb-0 small">
              <i class="bi bi-exclamation-triangle me-1"></i> Error al cargar las clases.
            </div>`}})()}})}function ri(e){let t=G.maestrosOriginales.find(t=>t.id===e);if(!t){q(`Maestro no encontrado`,`error`);return}G.deletingId=e;let n=t.nombre||t.name||``,r=t.is_active!==!1;o.open({title:r?`⏸️ Desactivar Maestro`:`▶️ Reactivar Maestro`,size:`sm`,saveText:r?`Desactivar`:`Reactivar`,body:r?`<p>¿Desactivar al maestro <strong>${R(n)}</strong>?</p>
         ...
         <p class="text-muted small mb-0">El maestro volverá a aparecer en las listas.</p>`,onSave:async()=>{r?(await er(e),q(`Maestro desactivado correctamente`,`success`)):(await tr(e),q(`Maestro reactivado correctamente`,`success`)),$r()}})}function ii(){let e=K.querySelector(`#maestrosTBody`);if(!e)return;e.innerHTML=Xr(G.maestros);let t=K.querySelector(`.maestros-header-premium p.text-muted`);t&&(t.textContent=`${G.maestros.length} maestros en total`)}function ai(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function oi(){if(G.maestrosOriginales.length===0){q(`No hay maestros para exportar`,`error`);return}let e=[[`Nombre`,`Email`,`Teléfono`,`Instrumento`,`Especialidad`,`Estado`],...G.maestrosOriginales.map(e=>[e.nombre||``,e.email||``,e.telefono||``,e.instrumento||``,e.especialidad||``,e.is_active===!1?`Inactivo`:`Activo`])].map(e=>e.map(e=>`"${String(e).replace(/"/g,`""`)}"`).join(`,`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`maestros-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),q(`CSV exportado exitosamente`,`success`)}function q(e,t=`info`){let n=K.querySelector(`#toastContainer`);if(!n)return;let i=t===`success`?`bg-success`:t===`error`?`bg-danger`:`bg-info`,a=t===`success`?`bi-check-circle`:t===`error`?`bi-exclamation-circle`:`bi-info-circle`,o=t===`success`?`Éxito`:t===`error`?`Error`:`Información`,s=document.createElement(`div`);s.className=`toast`,s.setAttribute(`role`,`alert`),s.setAttribute(`aria-live`,`assertive`),s.setAttribute(`aria-atomic`,`true`),s.innerHTML=`
  ...
  `,n.appendChild(s),new r(s,{autohide:!0,delay:3e3}).show(),s.addEventListener(`hidden.bs.toast`,()=>s.remove())}var si=e({getAlertasActivas:()=>fi,getAlertasRojas:()=>pi,getAlumnosDestacados:()=>xi,getAlumnosEnRiesgoAcademico:()=>Si,getAlumnosEnRiesgoAlto:()=>di,getCorrelacionAsistenciaRendimiento:()=>Ti,getDestacadosYRiesgoAcademico:()=>bi,getEstadisticasPeriodoActivo:()=>yi,getEstadisticasPeriodos:()=>vi,getHistorialEstadoAlumno:()=>Ei,getPatronAsistencia:()=>_i,getRachaAusencias:()=>Ci,getRendimientoMaestro:()=>gi,getRendimientoMaestros:()=>hi,getResumenAlertas:()=>mi,getResumenAlumno:()=>li,getResumenAlumnos:()=>ci,getRiesgoAbandono:()=>ui,getTasaAsistenciaPeriodo:()=>wi,registrarCambioEstadoAlumno:()=>Di});async function ci(){let{data:e,error:n}=await t.from(`vw_resumen_alumno`).select(`*`).order(`nombre_completo`);if(n)throw Error(`No se pudo cargar el resumen de alumnos`);return e}async function li(e){let{data:n,error:r}=await t.from(`vw_resumen_alumno`).select(`*`).eq(`id`,e).single();if(r)throw Error(`No se pudo cargar el resumen del alumno`);return n}async function ui({nivel:e=null}={}){let n=t.from(`vw_riesgo_abandono`).select(`*`).order(`score_riesgo`,{ascending:!1});e&&(n=n.eq(`nivel_riesgo`,e));let{data:r,error:i}=await n;if(i)throw Error(`No se pudo cargar el análisis de riesgo`);return r}async function di(){return ui({nivel:`alto`})}async function fi({color:e=null,alumnoId:n=null}={}){let r=t.from(`vw_alertas_activas`).select(`*`).order(`fecha_referencia`,{ascending:!0});e&&(r=r.eq(`color`,e)),n&&(r=r.eq(`alumno_id`,n));let{data:i,error:a}=await r;if(a)throw Error(`No se pudieron cargar las alertas`);return i}async function pi(){return fi({color:`rojo`})}async function mi(){let{data:e,error:n}=await t.from(`vw_alertas_activas`).select(`color, tipo_alerta`);if(n)throw Error(`No se pudo obtener el resumen de alertas`);return{total:e.length,rojas:e.filter(e=>e.color===`rojo`).length,naranjas:e.filter(e=>e.color===`naranja`).length,amarillas:e.filter(e=>e.color===`amarillo`).length,porTipo:e.reduce((e,t)=>(e[t.tipo_alerta]=(e[t.tipo_alerta]||0)+1,e),{})}}async function hi(){let{data:e,error:n}=await t.from(`vw_rendimiento_maestro`).select(`*`);if(n)throw Error(`No se pudo cargar el rendimiento de maestros`);return e}async function gi(e){let{data:n,error:r}=await t.from(`vw_rendimiento_maestro`).select(`*`).eq(`maestro_id`,e).single();if(r)throw Error(`No se pudo cargar el rendimiento del maestro`);return n}async function _i({instrumento:e=null}={}){let n=t.from(`vw_patron_asistencia`).select(`*`).order(`dia_semana_num`);e&&(n=n.eq(`instrumento_principal`,e));let{data:r,error:i}=await n;if(i)throw Error(`No se pudo cargar el patrón de asistencia`);return r}async function vi(){let{data:e,error:n}=await t.from(`vw_estadisticas_periodo`).select(`*`);if(n)throw Error(`No se pudieron cargar las estadísticas por período`);return e}async function yi(){let{data:e,error:n}=await t.from(`vw_estadisticas_periodo`).select(`*`).eq(`activo`,!0).order(`fecha_inicio`,{ascending:!1}).limit(1);if(n)throw Error(`No se pudieron cargar las estadísticas del período activo: `+n.message);return e&&e.length>0?e[0]:null}async function bi({categoria:e=null}={}){let n=t.from(`vw_destacados_y_riesgo_academico`).select(`*`);e&&(n=n.eq(`categoria`,e));let{data:r,error:i}=await n;if(i)throw Error(`No se pudo cargar el análisis académico`);return r}async function xi(){return bi({categoria:`destacado`})}async function Si(){return bi({categoria:`riesgo_academico`})}async function Ci(e){let{data:n,error:r}=await t.rpc(`fn_racha_ausencias`,{p_alumno_id:e});if(r)throw Error(`No se pudo calcular la racha de ausencias`);return n}async function wi(e,n,r=null){let i={p_alumno_id:e,p_desde:n};r&&(i.p_hasta=r);let{data:a,error:o}=await t.rpc(`fn_tasa_asistencia_periodo`,i);if(o)throw Error(`No se pudo calcular la tasa de asistencia`);return a}async function Ti(){let{data:e,error:n}=await t.rpc(`fn_correlacion_asistencia_rendimiento`);if(n)throw Error(`No se pudo calcular la correlación`);return e}async function Ei(e){let{data:n,error:r}=await t.from(`historial_estado_alumno`).select(`*`).eq(`alumno_id`,e).order(`fecha`,{ascending:!1});if(r)throw Error(`No se pudo cargar el historial`);return n}async function Di(e,n,r,i=null){if(![`activo`,`baja_voluntaria`,`baja_academica`,`suspendido`,`egresado`].includes(n))throw Error(`Estado no válido`);let{data:a,error:o}=await t.from(`historial_estado_alumno`).insert([{alumno_id:e,estado:n,motivo:r?.trim()||null,registrado_por:i||null,fecha:new Date().toISOString().split(`T`)[0]}]).select();if(o)throw Error(`No se pudo registrar el cambio de estado`);return a[0]}async function J(e){let t={"/assets/data/mocks/alumnos.json":()=>a(()=>import(`./alumnos-GmOXYzgJ.js`).then(e=>e.n),__vite__mapDeps([5,1])),"/assets/data/mocks/clases.json":()=>a(()=>import(`./clases-B84PNoYk.js`).then(e=>e.t),__vite__mapDeps([6,1])),"/assets/data/mocks/sesiones.json":()=>a(()=>import(`./sesiones-DT2wzp6f.js`).then(e=>e.t),__vite__mapDeps([7,1])),"/assets/data/mocks/maestro_tareas.json":()=>a(()=>import(`./maestro_tareas-Bq7p5yq4.js`),[]),"/assets/data/mocks/metricas_periodo.json":()=>a(()=>import(`./metricas_periodo-Bf3e52Xl.js`),[]),"/assets/data/mocks/alertas_config.json":()=>a(()=>import(`./alertas_config-GVKTu1lw.js`),[]),"/assets/data/mocks/objetivos_gamificacion.json":()=>a(()=>import(`./objetivos_gamificacion-CxXcyIxX.js`),[]),"/assets/data/mocks/ausencias.json":()=>a(()=>import(`./ausencias-BUiWDAoL.js`),[]),"/assets/data/mocks/planificacion-curricular.json":()=>a(()=>import(`./planificacion-curricular-BSf_6Yxz.js`),[])}[e];if(t){let e=await t();return e.default||e}return console.warn(`loadJsonMock: ruta no mapeada: ${e}`),null}var Oi=e({getAlertasActivas:()=>Li,getAlertasConfig:()=>Fi,getAlumnosDestacados:()=>Hi,getEstadisticasPeriodo:()=>Mi,getEstadisticasPeriodoActivo:()=>Ni,getHistorialEstadoAlumno:()=>zi,getRachaAusencias:()=>Bi,getResumenAlertas:()=>Ri,getResumenAlumno:()=>ji,getResumenAlumnos:()=>Ai,getRiesgoAbandono:()=>Vi,getTasaAsistenciaPeriodo:()=>Pi,updateAlertaConfig:()=>Ii}),ki=`/assets/data/mocks/metricas_periodo.json`;async function Ai(){return(await J(ki)).estadisticas_periodo[0]?.total_alumnos||0}async function ji(e){return null}async function Mi(){return(await J(ki)).configuraciones}async function Ni(){let e=await J(ki),t=e.configuraciones.find(e=>e.activo),n=e.estadisticas_periodo.find(e=>e.periodo_id===t?.id);return t?{...t,...n}:null}async function Pi(e,t,n=null){return 87.5}async function Fi(){return await J(`/assets/data/mocks/alertas_config.json`)}async function Ii(e,t){return console.log(`Mock: updateAlertaConfig`,e,t),{id:e,...t}}async function Li(e={}){return(await J(`/assets/data/mocks/alertas_config.json`)).alertas.filter(e=>e.activo)}async function Ri(){let e=(await J(`/assets/data/mocks/alertas_config.json`)).alertas.filter(e=>e.activo);return{total:e.length,rojas:e.filter(e=>e.color===`rojo`).length,naranjas:e.filter(e=>e.color===`naranja`).length,amarillas:e.filter(e=>e.color===`amarillo`).length}}async function zi(e){return[]}async function Bi(e){return 0}async function Vi({nivel:e=null}={}){let t=[{nombre_completo:`Mateo Fernández`,score_riesgo:88,nivel_riesgo:`alto`},{nombre_completo:`Lucía Benítez`,score_riesgo:65,nivel_riesgo:`medio`},{nombre_completo:`Santiago Morales`,score_riesgo:35,nivel_riesgo:`bajo`}];return e?t.filter(t=>t.nivel_riesgo===e):t}async function Hi(){return[{nombre_completo:`Valeria Russo`,promedio:9.85,programa:`Violín Cátedra`},{nombre_completo:`Thiago Silva`,promedio:9.72,programa:`Violín Inicial`},{nombre_completo:`Delfina Lombardi`,promedio:9.6,programa:`Violín Cátedra`}]}var Y=()=>Oe.isDemoMode?Oi:si,Ui=(...e)=>Y().getEstadisticasPeriodoActivo(...e),Wi=(...e)=>Y().getTasaAsistenciaPeriodo(...e),Gi=(...e)=>Y().getAlertasActivas(...e),Ki=(...e)=>Y().getResumenAlertas(...e),qi=(...e)=>Y().getRiesgoAbandono(...e),Ji=(...e)=>Y().getAlumnosDestacados(...e);function Yi({label:e,value:t,color:n=`primary`,icon:r=`bi-graph-up`}){let i=`bg-${n}`,a=`text-${n}`;return`
  ...
  `}var X={activeTab:localStorage.getItem(`pm_metrics_tab`)||`resumen`,stats:null,alertas:[],riesgo:[],cargando:!1,container:null};async function Xi(e){if(e)try{X.container=e,X.cargando=!0,Zi(e),X.stats=await Ui(),X.resumenAlertas=await Ki(),X.cargando=!1,$i(e),aa(e)}catch(t){console.error(t),Qi(e,t.message)}}function Zi(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function Qi(e,t){e.innerHTML=`<div class="alert alert-danger m-3"><h5>Error analítico</h5><p>${z(t)}</p></div>`}function $i(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function ea(){switch(X.activeTab){case`resumen`:return ta();case`alertas`:return na();case`riesgo`:return ra();case`ia`:return ia();default:return ta()}}function ta(){let e=X.stats||{},t=X.resumenAlertas||{total:0,rojas:0};return`
    <div class="row g-3">
      <div class="col-md-6 col-lg-3">
        ${Yi({label:`Alumnos Activos`,value:e.total_alumnos||0,icon:`bi-people`,color:`primary`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Yi({label:`Promedio Global`,value:(e.promedio_general||0).toFixed(2),icon:`bi-star`,color:`success`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Yi({label:`Alertas Rojas`,value:t.rojas,icon:`bi-exclamation-octagon`,color:`danger`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Yi({label:`Asistencia Hoy`,value:(e.asistencia_hoy_porcentaje||0)+`%`,icon:`bi-check2-circle`,color:`info`})}
      </div>
  ...
  `}function aa(e){e.querySelectorAll(`[data-tab]`).forEach(t=>{t.addEventListener(`click`,()=>{X.activeTab=t.dataset.tab,localStorage.setItem(`pm_metrics_tab`,X.activeTab),$i(e),aa(e),oa()})}),e.querySelector(`#btn-guia-analisis`)?.addEventListener(`click`,()=>{ca()}),oa()}async function oa(){if(X.activeTab===`resumen`){let e=await Ji(),t=X.container.querySelector(`#destacados-placeholder`);t&&(t.className=``,t.innerHTML=`
      ...
      `)}if(X.activeTab===`alertas`){X.container.querySelector(`#btn-goto-notifications`)?.addEventListener(`click`,()=>{a(async()=>{let{router:e}=await import(`./router-CcRIuSbB.js`).then(e=>e.n);return{router:e}},__vite__mapDeps([8,1,9,10])).then(({router:e})=>{e.navigate(`admin-notificaciones`)})});let e=await Gi(),t=X.container.querySelector(`#alertas-list-container`);t&&(t.innerHTML=e.length===0?`<p class="text-center text-muted">No hay alertas activas.</p>`:e.map(e=>`
          <div class="alert-item d-flex align-items-center gap-3 p-3 border-bottom">
            ...
            <div class="flex-grow-1">
              <div class="fw-bold small">${z(e.nombre_alumno)}</div>
              <div class="extra-small text-muted">${z(e.descripcion_alerta)}</div>
            </div>
            <div class="text-end small text-muted">${e.fecha_referencia}</div>
          </div>
        `).join(``))}if(X.activeTab===`riesgo`){let e=await qi(),t=X.container.querySelector(`#riesgo-list-container`);t&&(t.innerHTML=`
        <table class="table table-compact table-hover">
          <thead><tr><th>Alumno</th><th class="text-center">Score</th><th>Nivel</th></tr></thead>
          <tbody class="small">
            ${e.map(e=>`
              <tr>
                <td>${z(e.nombre_completo)}</td>
      ...
      `)}X.activeTab===`ia`&&sa()}function sa(){X.container.querySelector(`#btn-run-ia`)?.addEventListener(`click`,async()=>{let e=X.container.querySelector(`#ia-result-area`);e&&(e.innerHTML=`<div class="text-center"><div class="spinner-border spinner-border-sm text-primary"></div><p class="small mt-2">Analizando datos...</p></div>`,setTimeout(()=>{e.innerHTML=`
      ...
      `,X.container.querySelector(`#btn-copy-report`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(e.querySelector(`p.text-secondary`).innerText),i.show(`Reporte copiado al portapapeles`,`success`)})},1500))})}function ca(){o.open({title:`Guía de Análisis Académico`,body:`
    <style>
      .guia-modal-body {
  ...
  `,size:`lg`,hideSave:!0,cancelText:`Entendido`,onShow:e=>{let t=e.querySelectorAll(`#guia-modal-tabs button`),n=e.querySelectorAll(`.guia-panel`);t.forEach(r=>{r.addEventListener(`click`,()=>{t.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),n.forEach(e=>e.classList.add(`d-none`));let i=e.querySelector(`#pane-${r.dataset.guia}`);i&&i.classList.remove(`d-none`)})})}})}var la=class{constructor(e,t={}){this.container=e,this.data=t.data||[],this.onSelect=t.onSelect||(()=>{}),this.expandedNodes=new Set,this.selectedNodeId=null,this.icons={block:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>`,level:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 17h20M2 12h20M2 7h20"></path></svg>`,node:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="3"></circle></svg>`,indicator:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>`,expander:`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>`},this._injectStyles(),this.render(),this._bindEvents()}setData(e){this.data=e,this.render()}render(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function ua(){let{data:e,error:n}=await t.from(`routes`).select(`*`).order(`name`);if(n)throw console.error(`Error fetching routes:`,n.message),Error(`No se pudieron cargar las rutas`);return e}async function da(e){let{data:n,error:r}=await t.from(`route_versions`).select(`*`).eq(`route_id`,e).order(`version_number`,{ascending:!1});if(r)throw console.error(`Error fetching route versions:`,r.message),Error(`No se pudieron cargar las versiones de la ruta`);return n}async function fa(e){if(!e)return[];try{let{data:n,error:r}=await t.from(`blocks`).select(`*`).eq(`route_version_id`,e).order(`order_index`);if(r)throw r;if(!n.length)return[];let i=n.map(e=>e.id),{data:a,error:o}=await t.from(`levels`).select(`*`).in(`block_id`,i).order(`order_index`);if(o)throw o;let s=a.map(e=>e.id),{data:c,error:l}=await t.from(`nodes`).select(`*`).in(`level_id`,s).order(`order_index`).limit(5e3);if(l)throw l;let u=c.map(e=>e.id),{data:d,error:f}=await t.from(`indicators`).select(`*`).in(`node_id`,u).order(`order_index`).limit(1e4);if(f)throw f;return n.map(e=>({...e,type:`block`,children:a.filter(t=>t.block_id===e.id).map(e=>({...e,type:`level`,children:c.filter(t=>t.level_id===e.id).map(e=>({...e,type:`node`,children:d.filter(t=>t.node_id===e.id).map(e=>({...e,type:`indicator`}))}))}))}))}catch(e){throw console.error(`Error building academic tree:`,e.message),Error(`Error al construir el árbol académico`)}}async function pa(e){let{data:n,error:r}=await t.from(`node_resources`).select(`*`).eq(`node_id`,e).order(`order_index`);if(r)throw r;return n}async function ma(e){let{id:n,...r}=e;if(n){let{data:e,error:i}=await t.from(`node_resources`).update(r).eq(`id`,n).select().single();if(i)throw i;return e}else{let{data:e,error:n}=await t.from(`node_resources`).insert([r]).select().single();if(n)throw n;return e}}async function ha(e){let{error:n}=await t.from(`node_resources`).delete().eq(`id`,e);if(n)throw n;return!0}async function ga(e,n){let{data:r,error:i}=await t.from(`nodes`).update(n).eq(`id`,e).select().single();if(i)throw i;return r}var _a=class{constructor(e,t={}){this.container=e,this.node=null,this.resources=[],this.onUpdate=t.onUpdate||(()=>{}),this._injectStyles(),this.renderEmpty()}async setNode(e){if(!e){this.node=null,this.resources=[],this.renderEmpty();return}this.node=e,this.renderLoading();try{this.resources=await pa(e.id),this.render()}catch(e){console.error(`Error loading resources:`,e),this.renderError(`No se pudieron cargar los recursos del nodo.`)}}renderEmpty(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function va(e){ya(),e.innerHTML=`
  ...
  `;let t=e.querySelector(`#tree-container`),n=e.querySelector(`#detail-container`),r=e.querySelector(`#route-selector`),i=e.querySelector(`#version-selector`),a=new _a(n,{onUpdate:e=>{console.log(`Node updated:`,e)}}),o=new la(t,{onSelect:e=>{a.setNode(e)}});try{(await ua()).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,r.appendChild(t)})}catch(e){console.error(`Error loading routes:`,e)}r.addEventListener(`change`,async()=>{let e=r.value;if(i.innerHTML=`<option value="">Versión...</option>`,i.disabled=!0,t.innerHTML=`<div class="tree-placeholder"><p>Cargando versiones...</p></div>`,!e){t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una ruta para comenzar.</p></div>`;return}try{(await da(e)).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=`V${e.version_number} - ${new Date(e.created_at).toLocaleDateString()}`,i.appendChild(t)}),i.disabled=!1,t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una versión.</p></div>`}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar versiones.</p></div>`}}),i.addEventListener(`change`,async()=>{let e=i.value;if(e){t.innerHTML=`
      <div class="tree-loading">
        <div class="spinner-border spinner-border-sm text-primary"></div>
        <span>Construyendo mapa curricular...</span>
      </div>
    `;try{let t=await fa(e);o.setData(t)}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar el árbol curricular.</p></div>`}}})}function ya(){if(document.getElementById(`academic-admin-layout-styles`))return;let e=document.createElement(`style`);e.id=`academic-admin-layout-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Z={clases:[],clasesOriginales:[],maestros:[],salones:[],programas:[],alumnos:[],cargando:!1,filtroEstado:`todos`,filtroInstrumento:``,vista:`tabla`,container:null,mostrarDiasVacios:!0};async function ba(e){if(e)try{Z.container=e,Z.cargando=!0,xa(e);let[n,r,i,a,o]=await Promise.all([fr(),t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),t.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]);Z.clases=n,Z.clasesOriginales=[...n],Z.maestros=r.data||[],Z.salones=i.data||[],Z.programas=a.data||[],Z.alumnos=o.data||[],Z.cargando=!1,Ca(e),ka(e)}catch(t){console.error(t),Sa(e,t.message)}}function xa(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status"></div>
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>ba(e))}function Ca(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function wa(){return Z.clases.length===0?Ea():`
    <div class="page-glass rounded w-100">
      <div class="list-group list-group-flush w-100" id="clasesListBody">
        ${Z.clases.map(e=>Ta(e)).join(``)}
      </div>
    </div>
  `}function Ta(e){let t=e.nombre||`Sin nombre`,n=Z.maestros.find(t=>t.id===e.maestro_principal_id),r=n?n.nombre_completo||n.nombre:`Sin maestro`,i=cr(t),a=e.estado||`activa`,o=`border-accent-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,s=`bg-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,c=(e.horarios||[]).slice(0,3),l=c.length>0?c.map(e=>`${(e.dia||``).slice(0,2).toUpperCase()} ${(e.hora_inicio||``).slice(0,5)}`).join(` • `):`Sin horarios`;return`
  ...
  `}function Da(){if(Z.clases.length===0)return Ea();let e=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`],t={lunes:`Lunes`,martes:`Martes`,miércoles:`Miércoles`,jueves:`Jueves`,viernes:`Viernes`,sábado:`Sábado`},n={lunes:[],martes:[],miércoles:[],jueves:[],viernes:[],sábado:[]};Z.clases.forEach(e=>{(e.horarios||[]).forEach(t=>{let r=(t.dia||``).toLowerCase().trim();n[r]&&n[r].push({...t,clase:e})})}),Object.keys(n).forEach(e=>{n[e].sort((e,t)=>V(e.hora_inicio)-V(t.hora_inicio))});let r=Z.mostrarDiasVacios?``:`hide-empty-days`;return`
                ...
                ${r.length>0?r.map(e=>{let t=e.clase,n=t.estado||`activa`,r=B(e.hora_inicio),i=B(e.hora_fin),a=Z.salones.find(t=>t.id===e.salon_id),o=a?a.nombre:`Online/Otro`;return`
                    <div class="time-block-card p-2 rounded mb-2 border-start-accent ${`border-accent-${n===`activa`?`success`:n===`suspendida`?`warning`:`secondary`}`}" data-id="${t.id}" style="cursor: pointer;">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <i class="bi ${sr(t.instrumento)} text-muted" style="font-size: 0.85rem;"></i>
                      </div>
  ...
  `}async function Oa(e){if(e){o.open({title:`Cargando...`,hideSave:!0,size:`md`,body:`
    ...
    `});try{let t=await xr(e.id),n=t.length,r=Z.maestros.find(t=>t.id===e.maestro_principal_id),i=r?r.nombre_completo||r.nombre:`Sin maestro`,a=e.tiene_suplente||e.maestro_suplente_id?Z.maestros.find(t=>t.id===e.maestro_suplente_id):null,s=a?a.nombre_completo||a.nombre:null,c=Z.programas.find(t=>t.id===e.programa_id),l=c?c.nombre:`Sin programa`,u=``;u=e.horarios&&e.horarios.length>0?e.horarios.map(e=>{let t=e.dia.charAt(0).toUpperCase()+e.dia.slice(1),n=Z.salones.find(t=>t.id===e.salon_id),r=n?n.nombre:`Online/Otro`;return`
        ...
        <div class="list-group list-group-flush border-top">
          ${t.map(e=>{let t=e.alumno;if(!t)return``;let n=cr(t.nombre_completo||t.nombre||`?`);return`
              <div class="list-group-item d-flex align-items-center gap-3 py-2 px-3 border-bottom-0 bg-transparent">
                <div class="avatar-compact text-white d-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; font-size: 0.85rem; background-color: ${lr(t.id)}; font-weight:600;">
                  ${n}
                </div>
      ...
      <div class="class-profile-container">
        ...
        <div class="class-hero-card d-flex align-items-center gap-3 p-3 rounded mb-4" style="background: linear-gradient(135deg, rgba(13,110,253,0.08) 0%, rgba(88,86,214,0.08) 100%); border: 1px solid rgba(13,110,253,0.15);">
          ...
          <div class="overflow-hidden">
            ...
            <span class="badge rounded-pill bg-${e.estado===`activa`?`success`:e.estado===`suspendida`?`warning`:`secondary`} text-capitalize" style="font-size: 0.75rem;">${or(e.estado)}</span>
          </div>
        </div>
    ...
    `;o.open({title:`Perfil de Clase: ${e.nombre}`,hideSave:!0,size:`md`,body:h,onShow:t=>{let n=t.closest(`.app-modal-dialog`)?.querySelector(`.app-modal-footer`);n&&n.style.setProperty(`display`,`none`,`important`),t.querySelector(`.btn-profile-edit`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>{Cr(e,{maestros:Z.maestros,salones:Z.salones,programas:Z.programas,alumnos:Z.alumnos,onSuccess:()=>ba(Z.container)})},250)}),t.querySelector(`.btn-profile-delete`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>{ja(e.id)},250)}),t.querySelector(`.btn-profile-close`)?.addEventListener(`click`,()=>{o.close()})}})}catch(e){console.error(e),i.error(`Error al cargar la información detallada de la clase`),o.close()}}}function ka(e){e.querySelector(`#btn-help-clases`)?.addEventListener(`click`,()=>{W.open({title:`Clases`,intro:`Gestión completa de clases: creación, horarios, asignación de maestros, inscripción de alumnos y control de capacidad.`,sections:[{icon:`bi-easel2`,title:`Lista de clases`,description:`Todas las clases del sistema. Filtrá por instrumento, nivel y estado. Las activas aparecen primero.`,color:`#3b82f6`},{icon:`bi-clock`,title:`Horarios`,description:`Cada clase puede tener múltiples horarios semanales. El sistema detecta conflictos de salón y de maestro automáticamente.`,color:`#6366f1`},{icon:`bi-people`,title:`Inscripción de alumnos`,description:`"Grupal": todos comparten el horario. "Rotativa (Turnos)": cada alumno tiene su propio horario individual dentro de la clase.`,color:`#10b981`},{icon:`bi-bar-chart`,title:`Capacidad`,description:`Barra de ocupación: inscriptos vs capacidad máxima. Rojo cuando supera el 90%.`,color:`#f59e0b`},{icon:`bi-person-workspace`,title:`Maestro titular y suplente`,description:`Cada clase tiene un maestro principal (obligatorio) y puede tener suplente (opcional). Ambos aparecen en el perfil del maestro.`,color:`#6b7280`}]})}),e.querySelector(`#btnAgregarClase`)?.addEventListener(`click`,()=>{Cr(null,{maestros:Z.maestros,salones:Z.salones,programas:Z.programas,alumnos:Z.alumnos,onSuccess:()=>ba(e)})}),e.querySelector(`#btn-vista-tabla`)?.addEventListener(`click`,()=>{Z.vista=`tabla`,Ca(e),ka(e)}),e.querySelector(`#btn-vista-calendario`)?.addEventListener(`click`,()=>{Z.vista=`calendario`,Ca(e),ka(e)}),e.querySelector(`#buscar`)?.addEventListener(`input`,Aa),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,Aa);let t=e.querySelector(`#view-content`);t?.addEventListener(`change`,t=>{if(t.target&&t.target.id===`toggle-empty-days`){Z.mostrarDiasVacios=t.target.checked;let n=e.querySelector(`.weekly-schedule-grid`);n&&(Z.mostrarDiasVacios?n.classList.remove(`hide-empty-days`):n.classList.add(`hide-empty-days`))}}),t?.addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id], .time-block-card[data-id]`);if(t){let e=t.dataset.id,n=Z.clasesOriginales.find(t=>t.id===e);n&&Oa(n)}})}function Aa(){let e=Z.container.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=Z.container.querySelector(`#filtroEstado`)?.value||`todos`;Z.clases=Z.clasesOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||n.instrumento.toLowerCase().includes(e),i=t===`todos`||n.estado===t;return r&&i});let n=Z.container.querySelector(`#view-content`);n&&(n.innerHTML=Z.vista===`tabla`?wa():Da())}function ja(e){let t=Z.clasesOriginales.find(t=>t.id===e);t&&o.open({title:`⚠️ Eliminar Clase`,saveText:`Eliminar Definitivamente`,body:`<p>¿Estás seguro de eliminar la clase <strong>${z(t.nombre)}</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await gr(e),i.success(`Clase eliminada`),ba(Z.container),!0}catch(e){return i.error(e.message),!1}}})}async function Ma(e){e.innerHTML=`
  ...
  `;try{let{data:n,error:r}=await t.from(`profiles`).select(`
          ...
          <tbody>
            ${n.map(e=>{let t=e.maestros?.length>0?e.maestros[0].especialidad:null;return`
              <tr data-profile-id="${e.id}">
                <td>${Fa(e.nombre_completo||`—`)}</td>
                <td>${Fa(e.email)}</td>
                <td>${Fa(t||`—`)}</td>
                <td>${Ia(e.created_at)}</td>
    ...
    `,i.querySelectorAll(`.btn-aprobar`).forEach(e=>{e.addEventListener(`click`,()=>Na(e.dataset.id,i))}),i.querySelectorAll(`.btn-rechazar`).forEach(e=>{e.addEventListener(`click`,()=>Pa(e.dataset.id,`rechazado`,null,i))})}catch(t){let n=e.querySelector(`#aprobacion-content`);n.innerHTML=`
    ...
    `,console.error(`[AprobacionView] Error:`,t.message)}}function Na(e,t){o.open({title:`Aprobar Usuario`,size:`sm`,saveText:`Aprobar`,body:`
    ...
    `,onSave:async n=>{let r=n.querySelector(`#aprobacion-rol-select`).value;await Pa(e,`activo`,r,t)}})}async function Pa(e,n,r,i){let a=i?.querySelector(`tr[data-profile-id="${e}"]`);if(!(!a&&i)){a?.querySelectorAll(`button`).forEach(e=>e.disabled=!0);try{let o={estado:n};r&&(o.rol=r);let{error:s}=await t.from(`profiles`).update(o).eq(`id`,e);if(s)throw s;if(n===`activo`)try{let{data:n}=await t.from(`maestros`).select(`id`).eq(`user_id`,e).maybeSingle();n?.id&&await t.from(`permisos_maestros`).upsert({maestro_id:n.id,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`registrar_alumnos`,`inscribir_clases`]},{onConflict:`maestro_id`})}catch(e){console.warn(`[AprobacionView] Could not grant default permissions:`,e.message)}a&&(a.style.transition=`opacity 0.3s ease`,a.style.opacity=`0`,setTimeout(()=>a.remove(),300));let c=r===`admin`?`Admin`:`Maestro`;if(window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:n===`activo`?`${c} aprobado correctamente`:`Usuario rechazado`,type:`success`}})),i){let e=i.querySelector(`tbody`);e&&e.querySelectorAll(`tr`).length===0&&(i.innerHTML=`
        ...
        `)}}catch(e){a?.querySelectorAll(`button`).forEach(e=>e.disabled=!1),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al ${n===`activo`?`aprobar`:`rechazar`} usuario: ${e.message}`,type:`error`}})),console.error(`[AprobacionView] Action error:`,e.message)}}}function Fa(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function Ia(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`})}catch{return e}}async function La(){let{data:e,error:n}=await t.from(`ausencias_maestros`).select(`
      id,
      maestro_id,
      tipo_ausencia,
      urgencia,
      ...
      estado,
      created_at
    `).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(n)throw n;if(!e||e.length===0)return[];let r=[...new Set(e.map(e=>e.maestro_id).filter(Boolean))];if(r.length>0){let{data:n,error:i}=await t.from(`profiles`).select(`id, nombre_completo, email`).in(`id`,r);if(!i&&n){let t=new Map(n.map(e=>[e.id,e]));return e.map(e=>{let n=t.get(e.maestro_id);return{...e,maestros:n?{nombre_completo:n.nombre_completo,correo:n.email}:e.maestros||null}})}}return e.map(e=>({...e,maestros:e.maestros||null}))}async function Ra(e,n,r){let{data:i,error:a}=await t.from(`ausencias_maestros`).update({estado:n,decision_notas:r||null,decidido_en:new Date().toISOString()}).eq(`id`,e).select().single();if(a)throw a;return i}function za(e,t=``){return Ra(e,`aprobada`,t)}function Ba(e,t=``){return Ra(e,`rechazada`,t)}function Q(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function Va(e){if(!e)return`—`;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function Ha(e){let t=Va(e.fecha_inicio);return!e.fecha_fin||e.fecha_fin===e.fecha_inicio?t:`${t} → ${Va(e.fecha_fin)}`}function Ua(e){return e.maestros?.nombre_completo||e.maestro_nombre||`Maestro no especificado`}function Wa(e){return e.maestros?.correo||``}var Ga={enfermedad:{label:`Médica`,icon:`bi-heart-pulse-fill`,color:`#ef4444`},personal:{label:`Personal`,icon:`bi-person-fill`,color:`#3b82f6`},capacitacion:{label:`Capacitación`,icon:`bi-mortarboard-fill`,color:`#8b5cf6`},vacaciones:{label:`Vacaciones`,icon:`bi-sun-fill`,color:`#f59e0b`},otro:{label:`Otro`,icon:`bi-three-dots`,color:`#6b7280`}},Ka={baja:{label:`Baja`,color:`#22c55e`,bg:`rgba(34,197,94,0.12)`},media:{label:`Media`,color:`#f59e0b`,bg:`rgba(245,158,11,0.12)`},alta:{label:`Alta`,color:`#ef4444`,bg:`rgba(239,68,68,0.12)`}};function qa(e){if(e.clase_emergente?.fecha){let t=e.clase_emergente.hora?` a las ${e.clase_emergente.hora}`:``;return`<i class="bi bi-calendar-check"></i> Reprogramada para ${e.clase_emergente.fecha}${t}`}return e.maestro_suplente_id||e.suplente_nombre?`<i class="bi bi-person-check"></i> Suplente: ${Q(e.suplente_nombre||e.maestro_suplente_id)}`:`<i class="bi bi-clock"></i> Pendiente de coordinación`}function Ja(){if(document.getElementById(`ausencia-aprobacion-card-styles`))return;let e=document.createElement(`style`);e.id=`ausencia-aprobacion-card-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Ya(e,{onApprove:t=()=>{},onReject:n=()=>{}}={}){Ja();let r=Ga[e.tipo_ausencia]||Ga.otro,i=Ka[e.urgencia]||{label:e.urgencia||`Normal`,color:`#6b7280`,bg:`rgba(107,114,128,0.12)`},a=Array.isArray(e.clases_afectadas)?e.clases_afectadas.length:0,o=Ua(e),s=o.split(` `).map(e=>e[0]).join(``).slice(0,2).toUpperCase(),c=document.createElement(`article`);c.className=`ausencia-approval-card`,c.dataset.ausenciaCard=e.id,c.style.setProperty(`--aac-tipo-color`,r.color);let l=e.created_at?new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):``;c.innerHTML=`
    ...
    <div class="aac-header">
      ...
      <div class="aac-header-info">
        ...
        <p class="aac-teacher-email">${Q(Wa(e))}</p>
    ...
    <div class="aac-body">
      ...
      <div class="aac-coverage">${qa(e)}</div>
  ...
  `,document.head.appendChild(e)}function Qa(e){Za(),e.innerHTML=`
    <div class="aav-root">
  ...
  `}function $a(e,t){let n=t.length,r=t.filter(e=>e.urgencia===`alta`).length,i=t.filter(e=>e.urgencia===`media`).length;e.innerHTML=`
    <div class="aav-stat">
      <div>
  ...
  `}async function to(e){let t=e.querySelector(`#aav-content`),n=e.querySelector(`#aav-stats-row`),r=e.querySelector(`#aav-count-label`),i=e.querySelector(`#aav-refresh-btn`);t&&(t.innerHTML=`
      <div class="aav-loading">
        <div class="aav-spinner"></div>
        <span>Cargando solicitudes...</span>
      </div>
    `);try{let i=await La();if(n&&$a(n,i),r&&(r.textContent=i.length===0?`Sin solicitudes pendientes`:`${i.length} solicitud${i.length>1?`es`:``} pendiente${i.length>1?`s`:``}`),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate(),!i.length){eo(t);return}t.innerHTML=``;let a=document.createElement(`div`);a.className=`aav-list`,t.appendChild(a);let o=[...i].sort((e,t)=>{let n={alta:0,media:1,baja:2},r=n[e.urgencia]??3,i=n[t.urgencia]??3;return r===i?(e.created_at||``).localeCompare(t.created_at||``):r-i});for(let t of o)a.appendChild(Ya(t,{onApprove:async(t,n)=>{await za(t,n),Xa(`Ausencia aprobada`,`success`),await to(e)},onReject:async(t,n)=>{await Ba(t,n),Xa(`Ausencia rechazada`,`success`),await to(e)}}))}catch(e){t&&(t.innerHTML=`
        <div class="aav-error">
          <i class="bi bi-exclamation-triangle"></i>
          Error al cargar solicitudes: ${e.message}
        </div>
      `),Xa(`Error al cargar ausencias: ${e.message}`,`error`)}finally{i&&i.classList.remove(`spinning`)}}async function no(e){Qa(e);let t=e.querySelector(`.aav-root`);await to(t);let n=e.querySelector(`#aav-refresh-btn`);n&&n.addEventListener(`click`,async()=>{n.classList.add(`spinning`),await to(t)})}function ro(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().split(`T`)[0]}function $(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):``}function io(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<2?`ahora mismo`:n<60?`hace ${n} min`:r<24?`hace ${r}h`:i<7?`hace ${i}d`:$(e)}var ao={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};async function oo(){let e=ro(30),{data:n,error:r}=await t.from(`ausencias_maestros`).select(`
    ...
    `).in(`estado`,[`pendiente`,`aprobada`,`rechazada`]).gte(`created_at`,`${e}T00:00:00`).order(`created_at`,{ascending:!1}).limit(50);if(r)throw r;if(!n||n.length===0)return[];let i=[...new Set(n.map(e=>e.maestro_id).filter(Boolean))];if(i.length>0){let{data:e,error:r}=await t.from(`profiles`).select(`id, nombre_completo, email`).in(`id`,i);if(!r&&e){let r=e.map(e=>e.email).filter(Boolean),i=new Map;if(r.length>0){let{data:e}=await t.from(`maestros`).select(`correo, especialidad`).in(`correo`,r);e&&(i=new Map(e.map(e=>[e.correo.toLowerCase(),e.especialidad])))}let a=new Map(e.map(e=>{let t=i.get(e.email?.toLowerCase())||null;return[e.id,{nombre_completo:e.nombre_completo,correo:e.email,instrumento:t}]}));return n.map(e=>{let t=a.get(e.maestro_id);return{...e,maestros:t||e.maestros||null}})}}return n.map(e=>({...e,maestros:e.maestros||null}))}function so(e,t=[]){let n=e.maestros?.nombre_completo||`Maestro`,r=ao[e.tipo_ausencia]||e.tipo_ausencia||`Ausencia`,i=e.estado===`pendiente`,a=e.estado===`aprobada`,o=e.fecha_inicio===e.fecha_fin?$(e.fecha_inicio):`${$(e.fecha_inicio)} → ${$(e.fecha_fin)}`,s=e.maestros?.instrumento,c=i&&s?t.filter(t=>t.instrumento===s&&t.id!==e.maestro_id).slice(0,3):[];return{id:`ausencia:${e.id}`,source:`ausencia`,sourceId:e.id,priority:i?e.urgencia===`alta`?`alta`:e.urgencia===`media`?`media`:`baja`:`info`,actionable:i,estado:e.estado,urgencia:e.urgencia,tipo_ausencia:e.tipo_ausencia,icon:i?`bi-calendar-x-fill`:a?`bi-calendar-check-fill`:`bi-calendar-minus-fill`,iconColor:i?e.urgencia===`alta`?`#ef4444`:e.urgencia===`media`?`#f59e0b`:`#6b7280`:a?`#22c55e`:`#ef4444`,category:`ausencia`,titulo:i?`${n} solicitó ausencia ${r.toLowerCase()}`:a?`Ausencia de ${n} aprobada`:`Ausencia de ${n} rechazada`,subtitulo:o,motivo:e.motivo||``,timestamp:e.created_at,timeAgo:io(e.created_at),actionRoute:i?`admin-ausencias`:null,actionLabel:i?`Revisar`:null,suplentesSugeridos:c,maestroInstrumento:s}}async function co(){let e=ro(7),n=new Date().toISOString().split(`T`)[0],{data:r,error:i}=await t.from(`sesiones_clase`).select(`
      id, fecha, asistencia, borrador, contenido, clase_id,
      clases:clase_id(nombre, maestro_id,
        maestros:maestro_id(nombre_completo)
      )
    `).gte(`fecha`,e).lt(`fecha`,n).order(`fecha`,{ascending:!1}).limit(200);if(i)throw i;return r||[]}function lo(e){let t=e.filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),n={};for(let e of t){let t=e.clases?.maestro_id||`unknown`,r=e.clases?.maestros?.nombre_completo||`Maestro desconocido`;n[t]||(n[t]={nombre:r,count:0,ultima:e.fecha,mid:t}),n[t].count++,e.fecha>n[t].ultima&&(n[t].ultima=e.fecha)}return Object.values(n).map(e=>({id:`compliance:${e.mid}`,source:`sesion`,sourceId:e.mid,priority:e.count>=3?`alta`:e.count>=2?`media`:`baja`,actionable:!1,estado:`info`,icon:`bi-clipboard-x-fill`,iconColor:e.count>=3?`#ef4444`:e.count>=2?`#f59e0b`:`#6b7280`,category:`compliance`,titulo:`${e.nombre} tiene ${e.count} clase${e.count>1?`s`:``} sin asistencia`,subtitulo:`Última: ${$(e.ultima)} · últimos 7 días`,motivo:``,timestamp:new Date(`${e.ultima}T12:00:00`).toISOString(),timeAgo:$(e.ultima),actionRoute:null,actionLabel:null}))}async function uo(){let e=ro(7),{data:n,error:r}=await t.from(`alumnos`).select(`id, nombre_completo, created_at`).gte(`created_at`,`${e}T00:00:00`).order(`created_at`,{ascending:!1}).limit(20);return r?(console.warn(`[adminNotifApi] alumnos fetch warn:`,r.message),[]):n||[]}function fo(e){return e.map(e=>({id:`alumno:${e.id}`,source:`alumno`,sourceId:e.id,priority:`info`,actionable:!1,estado:`info`,icon:`bi-person-plus-fill`,iconColor:`#3b82f6`,category:`alumno`,titulo:`Nuevo alumno registrado: ${e.nombre_completo||`Alumno`}`,subtitulo:`Estado: activo`,motivo:``,timestamp:e.created_at,timeAgo:io(e.created_at),actionRoute:null,actionLabel:null}))}async function po(){let{data:e,error:n}=await t.from(`profiles`).select(`id, email, nombre_completo, created_at`).eq(`rol`,`maestro`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!1}).limit(20);return n?(console.warn(`[adminNotifApi] pending teachers fetch warn:`,n.message),[]):e||[]}function mo(e){return{id:`maestro-pendiente:${e.id}`,source:`maestro`,sourceId:e.id,priority:`alta`,actionable:!0,estado:`pendiente`,icon:`bi-person-badge-fill`,iconColor:`#ef4444`,category:`maestro`,titulo:`Nuevo maestro registrado esperando aprobación: ${e.nombre_completo||`Maestro`}`,subtitulo:`Email: ${e.email}`,motivo:``,timestamp:e.created_at,timeAgo:io(e.created_at),actionRoute:`admin-aprobacion`,actionLabel:`Ver Aprobaciones`}}async function ho(){let{data:e,error:n}=await t.from(`maestros`).select(`id, nombre_completo, correo, especialidad`).eq(`activo`,!0);return n?(console.warn(`[adminNotifApi] active maestros fetch warn:`,n.message),[]):(e||[]).map(e=>({id:e.id,nombre_completo:e.nombre_completo,email:e.correo,instrumento:e.especialidad}))}async function go(){let e=ro(30),{data:n,error:r}=await t.from(`asistencias`).select(`
      alumno_id, estado, fecha,
      alumnos:alumno_id(nombre_completo)
    `).gte(`fecha`,e).order(`fecha`,{ascending:!1});if(r)return console.warn(`[adminNotifApi] early warning fetch warn:`,r.message),[];let i={};for(let e of n||[]){let t=e.alumno_id;t&&(i[t]||(i[t]={nombre:e.alumnos?.nombre_completo||`Estudiante`,asistencias:[]}),i[t].asistencias.push(e.estado))}let a=[];for(let[e,t]of Object.entries(i)){let n=t.asistencias.length;if(n<3)continue;let r=0;for(let e of t.asistencias)if(e===`A`||e===`ausente`)r++;else if(e===`P`||e===`presente`||e===`T`||e===`tarde`)break;if(r>=3){a.push({id:`riesgo-alumno-ausencias:${e}`,source:`riesgo`,sourceId:e,priority:`alta`,actionable:!1,estado:`info`,icon:`bi-exclamation-triangle-fill`,iconColor:`#ef4444`,category:`compliance`,titulo:`Riesgo de Deserción: ${t.nombre}`,subtitulo:`Acumula ${r} inasistencias consecutivas en los últimos 30 días.`,motivo:`Acción recomendada: Contactar de urgencia al tutor legal o revisar ficha médica.`,timestamp:new Date().toISOString(),timeAgo:`ahora mismo`,actionRoute:`alumno?id=${e}`,actionLabel:`Ver Ficha`});continue}let i=t.asistencias.filter(e=>e===`P`||e===`presente`).length,o=i/n;o<.7&&a.push({id:`riesgo-alumno-rate:${e}`,source:`riesgo`,sourceId:e,priority:`media`,actionable:!1,estado:`info`,icon:`bi-graph-down`,iconColor:`#f59e0b`,category:`compliance`,titulo:`Bajo Compliance Académico: ${t.nombre}`,subtitulo:`Asistencia del ${Math.round(o*100)}% en los últimos 30 días (${i} de ${n} clases).`,motivo:`Acción recomendada: Coordinar entrevista de seguimiento y analizar tutoría.`,timestamp:new Date().toISOString(),timeAgo:`ahora mismo`,actionRoute:`alumno?id=${e}`,actionLabel:`Ver Ficha`})}return a}async function _o(){let[e,t,n,r,i,a]=await Promise.allSettled([oo(),co(),uo(),po(),ho(),go()]),o=[];try{o=await ho()}catch(e){console.warn(`[adminNotifApi] fallback active maestros failed:`,e)}let s=e.status===`fulfilled`?e.value.map(e=>so(e,o)):[],c=t.status===`fulfilled`?lo(t.value):[],l=n.status===`fulfilled`?fo(n.value):[],u=r.status===`fulfilled`?r.value.map(mo):[],d=a.status===`fulfilled`?a.value:[],f=[...s,...c,...l,...u,...d],p={alta:0,media:1,baja:2,info:3};return f.sort((e,t)=>{if(e.actionable!==t.actionable)return e.actionable?-1:1;let n=p[e.priority]??4,r=p[t.priority]??4;return n===r?(t.timestamp||``).localeCompare(e.timestamp||``):n-r}),f}async function vo(){let[e,n]=await Promise.allSettled([t.from(`ausencias_maestros`).select(`id`,{count:`exact`,head:!0}).eq(`estado`,`pendiente`),t.from(`profiles`).select(`id`,{count:`exact`,head:!0}).eq(`rol`,`maestro`).eq(`estado`,`pendiente`)]);return(e.status===`fulfilled`&&!e.value.error&&e.value.count||0)+(n.status===`fulfilled`&&!n.value.error&&n.value.count||0)}async function yo(){let{data:e,error:n}=await t.from(`profiles`).select(`id, nombre_completo, email`).eq(`rol`,`maestro`).eq(`estado`,`activo`).order(`nombre_completo`,{ascending:!0});if(n)throw n;return(e||[]).map(e=>({profile_id:e.id,nombre:e.nombre_completo||e.email||`Maestro`,email:e.email}))}async function bo(e,{titulo:n,mensaje:r,deep_link:i=`/notificaciones`}){if(!e?.length)throw Error(`Se requiere al menos un destinatario`);let a=e.map(e=>({profile_id:e,tipo:`aviso_admin`,titulo:n,mensaje:r,deep_link:i,estado:`pendiente`})),{error:o}=await t.from(`notificaciones`).insert(a);if(o)throw o;let s=0;try{s=(await Promise.allSettled(e.map(e=>fetch(`/functions/v1/send-push`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer `,apikey:``},body:JSON.stringify({profile_id:e,title:n,body:r,data:{tipo:`aviso_admin`,deepLink:i}})}).then(e=>e.ok?e.json():Promise.reject(Error(`HTTP ${e.status}`)))))).filter(e=>e.status===`fulfilled`&&e.value?.sent>0).length}catch(e){console.warn(`[adminNotifApi] Web push dispatch failed (in-app notif still sent):`,e.message)}return{sent:a.length,pushed:s}}async function xo({limit:e=50}={}){let{data:n,error:r}=await t.from(`notificaciones`).select(`id, titulo, mensaje, deep_link, estado, created_at, profile_id`).eq(`tipo`,`aviso_admin`).order(`created_at`,{ascending:!1}).limit(e*20);if(r)throw r;if(!n?.length)return[];let i=new Map;for(let e of n){let t=e.created_at?.slice(0,16),n=`${e.titulo}|${t}`;i.has(n)||i.set(n,{titulo:e.titulo,mensaje:e.mensaje,deep_link:e.deep_link,created_at:e.created_at,recipients:[]}),i.get(n).recipients.push(e.profile_id)}return[...i.values()].slice(0,e).map(e=>({...e,recipientCount:e.recipients.length}))}var So=null,Co=null,wo=null;function To(){clearTimeout(wo),wo=setTimeout(async()=>{try{let e=await vo();Co?.(e)}catch(e){console.warn(`[realtimeService] count fetch failed:`,e.message)}},800)}function Eo(e,t){if(!(typeof Notification>`u`)&&Notification.permission===`granted`&&(localStorage.getItem(`current-view`)||``)!==`admin-notificaciones`)try{new Notification(e,{body:t,icon:`/icons/icon-192x192.png`,badge:`/icons/icon-72x72.png`,tag:`admin-notif`,renotify:!0})}catch{}}function Do(e){So||=(Co=e,typeof Notification<`u`&&Notification.permission===`default`&&Notification.requestPermission().catch(()=>{}),t.channel(`admin-notif-realtime`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`ausencias_maestros`},e=>{Eo(`📅 Nueva solicitud de ausencia`,`Un maestro solicitó una ausencia — revisá el Centro de Actividad.`),To()}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`ausencias_maestros`,filter:`estado=eq.pendiente`},()=>To()).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`profiles`,filter:`rol=eq.maestro`},e=>{Eo(`👤 Nuevo maestro pendiente de aprobación`,`${e.new?.nombre_completo||`Un maestro`} se registró y está esperando aprobación.`),To()}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`profiles`,filter:`estado=eq.pendiente`},()=>To()).subscribe(e=>{e===`SUBSCRIBED`&&To()}))}function Oo(){So&&=(t.removeChannel(So),null),Co=null,clearTimeout(wo)}function ko(){Co?.(0)}function Ao(){if(document.getElementById(`anv-styles`))return;let e=document.createElement(`style`);e.id=`anv-styles`,e.textContent=`
    .anv-root {
  ...
  `,document.head.appendChild(e)}var jo=[{key:`all`,label:`Todo`,icon:`bi-grid-fill`},{key:`ausencia`,label:`Ausencias`,icon:`bi-calendar-x-fill`},{key:`compliance`,label:`Alertas`,icon:`bi-exclamation-triangle-fill`},{key:`alumno`,label:`Novedades`,icon:`bi-person-plus-fill`}],Mo={ausencia:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`},compliance:{bg:`rgba(245,158,11,0.1)`,color:`#f59e0b`},alumno:{bg:`rgba(59,130,246,0.1)`,color:`#3b82f6`},maestro:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`}},No={ausencia:`Ausencia`,compliance:`Alerta`,alumno:`Novedad`,maestro:`Seguridad`},Po={aprobada:{label:`Aprobada`,bg:`rgba(34,197,94,0.12)`,color:`#16a34a`,icon:`bi-check-circle-fill`},rechazada:{label:`Rechazada`,bg:`rgba(239,68,68,0.12)`,color:`#dc2626`,icon:`bi-x-circle-fill`},pendiente:{label:`Pendiente`,bg:`rgba(245,158,11,0.12)`,color:`#d97706`,icon:`bi-hourglass-split`}};async function Fo(e){Ao(),`Notification`in window&&Notification.permission===`default`&&Notification.requestPermission();let n=[],r=`all`,i=``,a=null;function s(){e.innerHTML=`
      <div class="anv-root">
    ...
    `,r.querySelectorAll(`[data-action]`).forEach(i=>{i.addEventListener(`click`,async a=>{a.stopPropagation();let o=i.dataset.action;if(o===`goto`){let e=window.router||c;if(e){let[t,n]=(i.dataset.route||``).split(`?`),r=i.dataset.params?JSON.parse(i.dataset.params):{};n&&new URLSearchParams(n).forEach((e,t)=>{r[t]=e}),e.navigate(t,r)}return}if(o===`notify-sub`){let e=i.dataset.subName;i.disabled=!0,i.innerHTML=`<i class="bi bi-check-lg"></i> Propuesto`,i.className=`anv-suplente-btn notified`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Propuesta de suplencia enviada a ${e}`,type:`success`}}));return}if(r.querySelectorAll(`[data-action="approve"],[data-action="reject"],[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!0),o===`approve`){i.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{await za(e.sourceId,``),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Ausencia aprobada con éxito`,type:`success`}})),e.actionable=!1,e.estado=`aprobada`,e.priority=`info`,e.icon=`bi-calendar-check-fill`,e.iconColor=`#22c55e`;let t=p(e,n);t.style.animation=`anv-fadein 0.3s ease`,r.replaceWith(t),u(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),r.querySelectorAll(`[data-action="approve"],[data-action="reject"]`).forEach(e=>e.disabled=!1),i.innerHTML=`<i class="bi bi-check-circle"></i> Aprobar`}}else if(o===`reject`){i.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{await Ba(e.sourceId,``),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Ausencia rechazada con éxito`,type:`success`}})),e.actionable=!1,e.estado=`rechazada`,e.priority=`info`,e.icon=`bi-calendar-minus-fill`,e.iconColor=`#ef4444`;let t=p(e,n);t.style.animation=`anv-fadein 0.3s ease`,r.replaceWith(t),u(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),r.querySelectorAll(`[data-action="approve"],[data-action="reject"]`).forEach(e=>e.disabled=!1),i.innerHTML=`<i class="bi bi-x-circle"></i> Rechazar`}}else if(o===`approve-maestro`){i.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{let{error:i}=await t.from(`profiles`).update({estado:`activo`}).eq(`id`,e.sourceId);if(i)throw i;window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Maestro aprobado con éxito`,type:`success`}})),e.actionable=!1,e.estado=`activo`,e.priority=`info`,e.icon=`bi-person-check-fill`,e.iconColor=`#22c55e`,e.titulo=`Maestro registrado aprobado: ${e.titulo.replace(`Nuevo maestro registrado esperando aprobación: `,``)}`;let a=p(e,n);a.style.animation=`anv-fadein 0.3s ease`,r.replaceWith(a),u()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),r.querySelectorAll(`[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!1),i.innerHTML=`<i class="bi bi-check-circle"></i> Aprobar`}}else if(o===`reject-maestro`){i.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{let{error:i}=await t.from(`profiles`).update({estado:`rechazado`}).eq(`id`,e.sourceId);if(i)throw i;window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Maestro rechazado con éxito`,type:`success`}})),e.actionable=!1,e.estado=`rechazado`,e.priority=`info`,e.icon=`bi-person-dash-fill`,e.iconColor=`#ef4444`,e.titulo=`Maestro registrado rechazado: ${e.titulo.replace(`Nuevo maestro registrado esperando aprobación: `,``)}`;let a=p(e,n);a.style.animation=`anv-fadein 0.3s ease`,r.replaceWith(a),u()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),r.querySelectorAll(`[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!1),i.innerHTML=`<i class="bi bi-x-circle"></i> Rechazar`}}})}),r}function m(){let t=e.querySelector(`#anv-body`),a=e.querySelector(`#anv-showing`);if(!t)return;let o=n;if(r===`critica`?o=n.filter(e=>e.actionable||e.priority===`alta`):r!==`all`&&(o=n.filter(e=>e.category===r)),i.trim().length>0){let e=i.toLowerCase().trim();o=o.filter(t=>(t.titulo||``).toLowerCase().includes(e)||(t.subtitulo||``).toLowerCase().includes(e)||(t.motivo||``).toLowerCase().includes(e)||(t.maestroInstrumento||``).toLowerCase().includes(e))}if(a&&(a.textContent=o.length===0?`Sin eventos encontrados`:`${o.length} evento${o.length>1?`s`:``}`),o.length===0){t.innerHTML=`
      ...
      `);try{n=await _o(),u(),l(),m(),f()}catch(t){console.error(`[adminNotificacionesView] load error:`,t);let r=e.querySelector(`#anv-body`);r&&n.length===0&&(r.innerHTML=`
          <div class="anv-center">
    ...
    `,size:`lg`,hideSave:!0,cancelText:`Entendido`})}async function te(){let e=[];try{e=await yo()}catch{}let t=e.map(e=>`<option value="${e.profile_id}">${e.nombre}</option>`).join(``);o.open({title:`<i class="bi bi-send-fill me-2 text-warning"></i>Enviar notificación a maestros`,body:`
        <div class="mb-3">
      ...
      </div>`).join(``);o.open({title:`<i class="bi bi-clock-history me-2"></i>Historial <span class="badge bg-secondary ms-1">${e.length}</span>`,body:`<div style="max-height:420px;overflow-y:auto;">${n}</div>`,hideSave:!0,cancelText:`Cerrar`})}return s(),await h(),ko(),e.querySelector(`#anv-refresh-btn`)?.addEventListener(`click`,()=>h(!1)),e.querySelector(`#anv-btn-send-notif`)?.addEventListener(`click`,()=>te()),e.querySelector(`#anv-btn-historial`)?.addEventListener(`click`,()=>ne()),function(){a&&=(t.removeChannel(a),null)}}export{ht as $,Yt as A,Ot as B,en as C,Zt as D,j as E,zt as F,Ct as G,kt as H,Ut as I,gt as J,bt as K,It as L,Vt as M,Rt as N,Qt as O,Bt as P,xt as Q,Ht as R,sn as S,$t as T,At as U,Dt as V,Et as W,yt as X,St as Y,wt as Z,vr as _,pe as _t,La as a,at,z as b,me as bt,va as c,nt as ct,Ui as d,De as dt,mt as et,Ki as f,_e as ft,yr as g,se as gt,W as h,fe as ht,no as i,ot as it,Pt as j,Xt as k,Xi as l,lt,Ur as m,ce as mt,Do as n,ft as nt,Ma as o,rt as ot,Wi as p,b as pt,Tt as q,Oo as r,ut as rt,ba as s,it as st,Fo as t,vt as tt,Gi as u,Oe as ut,xr as v,le as vt,M as w,In as x,l as xt,_r as y,he as yt,jt as z};