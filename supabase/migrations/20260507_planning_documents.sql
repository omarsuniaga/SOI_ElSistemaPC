-- Planning documents table for teacher planning doc uploads
...
COMMENT ON TABLE planning_documents IS 'Teacher planning documents (PDFs, images, Word, Excel, etc.) linked to classes.';
