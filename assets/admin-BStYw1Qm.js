const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ausenciaForm-RmovM00P.js","assets/supabase-C4ics26R.js","assets/ausenciaHistorial-CcBO9Hyb.js","assets/jspdf.es.min-DjkFa24L.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CsoeaaUJ.js","assets/typeof-DxaMiMZt.js","assets/configView-BaGCstrr.js","assets/pushService-DQD3mJWH.js","assets/maestroAuth-Cae-9DFh.js","assets/importView-CGGhelb3.js","assets/router-BK3enFMp.js","assets/vendor-BhXhnmkW.js","assets/vendor-COf7rB16.css","assets/reportService-DPq6aYOX.js","assets/groqService-CpEtzfwM.js","assets/AppToast-BOjiJExQ.js"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-tcWNtVWY.js";import{$ as t,A as n,B as r,C as i,E as a,F as o,H as s,J as c,L as l,M as u,N as d,O as f,P as p,R as m,S as ee,T as te,U as ne,V as re,W as ie,Z as h,a as ae,b as oe,c as se,ct as ce,d as le,et as g,f as ue,h as de,i as fe,j as pe,k as me,l as he,m as ge,n as _e,o as ve,p as ye,s as _,t as be,u as xe,v as Se,w as Ce,x as we,z as Te}from"./adminNotificacionesView-CzLmbsW2.js";import{i as v,n as Ee,r as De,t as Oe}from"./supabase-C4ics26R.js";import{n as ke,r as Ae}from"./vendor-BhXhnmkW.js";import{t as y}from"./AppToast-BOjiJExQ.js";import{t as b}from"./preload-helper-CsoeaaUJ.js";import{t as x}from"./AppModal-CLA9fW7x.js";import{n as je}from"./groqService-CpEtzfwM.js";import{f as S}from"./clasesApi-CiNtdXkj.js";import{i as Me}from"./permisosSupabase-CIKt_2Y3.js";import{t as C}from"./router-BK3enFMp.js";var w=`auth-session`;function Ne(e,t=!0){let n={access_token:e.access_token,refresh_token:e.refresh_token,user:e.user,expires_at:e.expires_at,persistent:t};(t?localStorage:sessionStorage).setItem(w,JSON.stringify(n)),t?sessionStorage.removeItem(w):localStorage.removeItem(w)}function Pe(){let e=localStorage.getItem(w),t=sessionStorage.getItem(w),n=e||t;if(!n)return null;try{return JSON.parse(n)}catch{return null}}function Fe(){localStorage.removeItem(w),sessionStorage.removeItem(w)}function Ie(){let e=Pe();return!e||!e.expires_at?!1:Date.now()/1e3<e.expires_at-10}var Le=[];async function Re(e,t,n=!1){console.log(`🔑 authManager.login:`,e,`remember:`,n);let{data:r,error:i}=await Oe(e,t);return console.log(`🔑 login result:`,{data:r,error:i}),i?(console.error(`🔑 login error:`,i),{user:null,session:null,error:i}):(r.session&&Ne(r.session,n),{user:r.user,session:r.session,error:null})}async function ze(e,t,n={}){let{data:r,error:i}=await De(e,t,n);return i?{user:null,session:null,error:i}:{user:r.user,session:r.session,error:null}}async function Be(){let{error:e}=await Ee();return Fe(),Le.forEach(e=>e(null)),{error:e}}function Ve(){return Ie()}function He(){return Pe()?.user||null}var T={user:null,session:null,loading:!0,error:null,listeners:[]};function E(){T.listeners.forEach(e=>e(T))}function Ue(e){return T.listeners.push(e),()=>{T.listeners=T.listeners.filter(t=>t!==e)}}async function We(e,t,n=!1){if(T.loading=!0,T.error=null,E(),e===`demo@soi.com`&&t===`demo123`){let e={id:`demo-user-id`,email:`demo@soi.com`,user_metadata:{full_name:`Usuario Demo`},role:`admin`},t={user:e,access_token:`demo-token`};return localStorage.setItem(`demo_mode`,`true`),h.isDemoMode=!0,Ne(t,n),T.user=e,T.session=t,T.loading=!1,E(),{success:!0,user:e,session:t}}try{let r=await Re(e,t,n),i=r?.error&&(r.error.message||r.error),a=r?.user&&!i;return T.user=a?r.user:null,T.session=a?r.session:null,T.loading=!1,E(),i?{success:!1,error:typeof i==`string`?i:i.message||`Error desconocido`}:{success:a,user:T.user,session:T.session}}catch(e){return T.loading=!1,T.error=e.message,E(),{success:!1,error:e.message}}}async function Ge(e,t,n){T.loading=!0,T.error=null,E();try{let r=await ze(e,t,n);T.user=r.user,T.session=r.session,T.loading=!1,E();let i=!r.error&&!!r.user,a=i&&!r.session;return{...r,success:i,needsConfirmation:a,message:a?`Registro exitoso. Tu cuenta está pendiente de aprobación por un administrador.`:void 0}}catch(e){return T.loading=!1,T.error=e.message,E(),{success:!1,error:e.message}}}function Ke(){Be(),localStorage.removeItem(`demo_mode`),h.isDemoMode=!1,T.user=null,T.session=null,T.error=null,E()}function qe(){return He()}function Je(){return T.user?!0:Ve()}async function Ye(){let{data:{session:e},error:t}=await v.auth.getSession();return t||!e?(Fe(),T.user=null,T.session=null,T.loading=!1,E(),{authenticated:!1}):(Ne(e,Pe()?.persistent??!0),T.session=e,T.user=e.user,T.loading=!1,E(),{authenticated:!0,user:T.user})}Ye();var D={subscribe:Ue,login:We,register:Ge,logout:Ke,getUser:qe,isAuthenticated:Je,notifyListeners:E,refreshAuth:Ye,getState:()=>({...T})},Xe={config:{fontSizeBase:`0.8rem`,fontSizeSmall:`0.7rem`,paddingX:`0.5rem`,paddingY:`0.35rem`,gap:`0.35rem`},styles:`
    /* Compact Tables */
    .table-compact {
      font-size: 0.8rem;
  ...
  `}function et(e){let t=document.getElementById(`loginForm`),n=document.getElementById(`loginEmail`),r=document.getElementById(`loginPassword`),i=document.getElementById(`togglePassword`),a=document.getElementById(`linkRegister`);t?.addEventListener(`submit`,async t=>{t.preventDefault();let i=n.value.trim(),a=r.value;await tt(i,a,document.getElementById(`rememberMe`)?.checked||!1,e)}),i?.addEventListener(`click`,()=>{let e=r.type===`password`?`text`:`password`;r.type=e,i.innerHTML=e===`password`?`<i class="bi bi-eye"></i>`:`<i class="bi bi-eye-slash"></i>`}),a?.addEventListener(`click`,e=>{e.preventDefault(),C.navigate(`register`)})}async function tt(e,t,n,r){if(!e||!t){rt(`Por favor ingresa email y contraseña`,`error`,r);return}Ze.loading=!0,nt(!0);try{let i=await D.login(e,t,n);i.success?(rt(`¡Bienvenido!`,`success`,r),setTimeout(()=>{let e=localStorage.getItem(`intended-route`);localStorage.removeItem(`intended-route`),C.navigate(e||`programas`)},500)):rt(i.error||`Error al iniciar sesión`,`error`,r)}catch(e){console.error(`Login error:`,e),rt(`Error de conexión`,`error`,r)}finally{Ze.loading=!1,nt(!1)}}function nt(e){let t=document.getElementById(`btnLogin`),n=t?.querySelector(`.btn-text`),r=t?.querySelector(`.btn-loading`);t&&(t.disabled=e,e?(n?.classList.add(`d-none`),r?.classList.remove(`d-none`)):(n?.classList.remove(`d-none`),r?.classList.add(`d-none`)))}function rt(e,t,n){let r=document.getElementById(`toastContainer`);if(!r)return;let i=e&&typeof e==`object`?e.message||e.error||JSON.stringify(e):String(e||`Error`),a=`
  ...
  `,o=document.createElement(`div`);o.innerHTML=a;let s=o.firstElementChild;r.appendChild(s),new ke(s,{autohide:!0,delay:3e3}).show(),s.addEventListener(`hidden.bs.toast`,()=>{s.remove()})}var it={loading:!1},at=[{test:e=>e.length>=8,message:`Mínimo 8 caracteres`},{test:e=>/[A-Z]/.test(e),message:`Al menos 1 mayúscula`},{test:e=>/[0-9]/.test(e),message:`Al menos 1 número`},{test:e=>/[!@#$%^&*(),.?":{}|<>]/.test(e),message:`Al menos 1 símbolo`}];function ot(e){Xe.injectStyles(),st(e),lt(e)}function st(e){e.innerHTML=`
    <div class="auth-page">
      <div class="auth-container">
        <div class="auth-card">
          <div class="auth-header">
  ...
  `}function ct(e){return at.map((t,n)=>{let r=t.test(e);return`
      <div class="password-requirement ${r?`valid`:`invalid`}" id="req-${n}">
        <i class="bi ${r?`bi-check-circle-fill`:`bi-circle`}"></i>
        <span>${t.message}</span>
      </div>
    `}).join(``)}function lt(e){let t=document.getElementById(`registerForm`);document.getElementById(`registerName`),document.getElementById(`registerEmail`);let n=document.getElementById(`registerPassword`),r=document.getElementById(`registerConfirmPassword`),i=document.getElementById(`togglePassword`),a=document.getElementById(`linkLogin`);n?.addEventListener(`input`,e=>{let t=e.target.value;ut(t),dt()}),r?.addEventListener(`input`,dt),t?.addEventListener(`submit`,async t=>{t.preventDefault(),await pt(e)}),i?.addEventListener(`click`,()=>{let e=n.type===`password`?`text`:`password`;n.type=e,r.type=e,i.innerHTML=e===`password`?`<i class="bi bi-eye"></i>`:`<i class="bi bi-eye-slash"></i>`}),a?.addEventListener(`click`,e=>{e.preventDefault(),C.navigate(`login`)})}function ut(e){document.getElementById(`passwordRequirements`)&&at.forEach((t,n)=>{let r=document.getElementById(`req-${n}`);if(r){let n=t.test(e);r.className=`password-requirement ${n?`valid`:`invalid`}`,r.innerHTML=`
        <i class="bi ${n?`bi-check-circle-fill`:`bi-circle`}"></i>
        <span>${t.message}</span>
      `}})}function dt(){let e=document.getElementById(`registerPassword`).value,t=document.getElementById(`registerConfirmPassword`).value,n=document.getElementById(`confirmPasswordError`),r=document.getElementById(`registerConfirmPassword`);return t&&e!==t?(n?.classList.remove(`d-none`),r?.classList.add(`is-invalid`),!1):(n?.classList.add(`d-none`),r?.classList.remove(`is-invalid`),!0)}function ft(e){return at.every(t=>t.test(e))}async function pt(e){let t=document.getElementById(`registerName`).value.trim(),n=document.getElementById(`registerEmail`).value.trim(),r=document.getElementById(`registerPassword`).value,i=document.getElementById(`registerConfirmPassword`).value,a=document.getElementById(`acceptTerms`).checked;if(!t||!n||!r||!i){O(`Por favor completa todos los campos`,`error`,e);return}if(!ft(r)){O(`La contraseña no cumple los requisitos`,`error`,e);return}if(r!==i){O(`Las contraseñas no coinciden`,`error`,e);return}if(!a){O(`Debes aceptar los términos y condiciones`,`error`,e);return}it.loading=!0,mt(!0);try{let i=await D.register(n,r,{full_name:t,rol:`maestro`});i.success?i.needsConfirmation?(O(i.message,`info`,e),setTimeout(()=>{C.navigate(`login`)},2e3)):(O(`¡Cuenta creada exitosamente!`,`success`,e),setTimeout(()=>{C.navigate(`programas`)},500)):O(i.error||`Error al registrar`,`error`,e)}catch(t){console.error(`Register error:`,t),O(`Error de conexión`,`error`,e)}finally{it.loading=!1,mt(!1)}}function mt(e){let t=document.getElementById(`btnRegister`),n=t?.querySelector(`.btn-text`),r=t?.querySelector(`.btn-loading`);t&&(t.disabled=e,e?(n?.classList.add(`d-none`),r?.classList.remove(`d-none`)):(n?.classList.remove(`d-none`),r?.classList.add(`d-none`)))}function O(e,t,n){let r=document.getElementById(`toastContainer`);if(!r)return;let i=`
    <div id="${`toast-`+Date.now()}" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  `,a=document.createElement(`div`);a.innerHTML=i;let o=a.firstElementChild;r.appendChild(o),new ke(o,{autohide:!0,delay:3e3}).show(),o.addEventListener(`hidden.bs.toast`,()=>{o.remove()})}function ht(e){return e?e.replace(/[&<>]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`})[e]):``}var gt={loading:!1,error:null};function _t(e){let t=D.getUser();if(!t){e.innerHTML=`
  ...
  `,vt(e)}async function vt(e){let{renderAusenciaForm:t}=await b(async()=>{let{renderAusenciaForm:e}=await import(`./ausenciaForm-RmovM00P.js`);return{renderAusenciaForm:e}},__vite__mapDeps([0,1])),{renderAusenciaHistorial:n}=await b(async()=>{let{renderAusenciaHistorial:e}=await import(`./ausenciaHistorial-CcBO9Hyb.js`);return{renderAusenciaHistorial:e}},__vite__mapDeps([2,1]));document.getElementById(`ausenciaModalBody`).innerHTML=t();let r=e.querySelector(`.card-apple:last-child`);if(r){let e=document.createElement(`div`);e.className=`mt-4`,e.innerHTML=`
      <h6 class="fw-bold mb-3">
        <i class="bi bi-clock-history me-2"></i>Historial de Ausencias
      </h6>
      <div id="ausenciaHistorialContainer"></div>
    `,r.appendChild(e),document.getElementById(`ausenciaHistorialContainer`).innerHTML=n()}e.querySelector(`#btnGuardarDatos`)?.addEventListener(`click`,yt),e.querySelector(`#perfilPasswordForm`)?.addEventListener(`submit`,bt)}async function yt(){let e=document.getElementById(`perfilNombre`).value.trim();if(!e){xt(`El nombre no puede estar vacío`);return}gt.loading=!0;let t=document.getElementById(`btnGuardarDatos`);t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Guardando...`;try{let{error:t}=await v.auth.updateUser({data:{full_name:e}});if(t)throw t;St(`Datos guardados correctamente`)}catch(e){xt(e.message)}finally{gt.loading=!1,t.disabled=!1,t.innerHTML=`<i class="bi bi-check-lg me-1"></i>Guardar cambios`}}async function bt(e){e.preventDefault(),document.getElementById(`passwordActual`).value;let t=document.getElementById(`passwordNueva`).value,n=document.getElementById(`passwordConfirmar`).value;if(document.getElementById(`passwordError`),t.length<8){Ct(`La contraseña debe tener al menos 8 caracteres`);return}if(t!==n){Ct(`Las contraseñas no coinciden`);return}gt.loading=!0;let r=document.getElementById(`btnCambiarPassword`);r.disabled=!0,r.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Cambiando...`;try{let{error:e}=await v.auth.updateUser({password:t});if(e)throw e;document.getElementById(`perfilPasswordForm`).reset(),St(`Contraseña cambiada correctamente`)}catch(e){e.message.includes(`same`)?Ct(`La nueva contraseña debe ser diferente a la actual`):Ct(e.message)}finally{gt.loading=!1,r.disabled=!1,r.innerHTML=`<i class="bi bi-key-fill me-1"></i>Cambiar contraseña`}}function xt(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`danger`}}))}function St(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`success`}}))}function Ct(e){let t=document.getElementById(`passwordError`);t&&(t.textContent=e,t.classList.remove(`d-none`))}function wt(){C.register(`login`,Qe),C.register(`register`,ot),C.register(`perfil`,_t)}wt();function Tt(){C.register(`maestros`,ue)}function Et(){C.register(`programas`,ge)}function Dt(){C.register(`alumnos`,de)}function Ot(e){return e?{...e,nombre:e.nombre??e.name??``,codigo:e.codigo_salon??``,ubicacion:e.ubicacion??e.location??``,condicion:e.condicion_fisica??`buena`,is_active:e.is_active??e.isActive??e.activo??!0,capacidad:parseInt(e.capacidad)||20,piso:e.piso!==void 0&&e.piso!==null?parseInt(e.piso):null,equipamiento:Array.isArray(e.equipamiento)?e.equipamiento.join(`, `):e.equipamiento||``,descripcion:e.descripcion||``}:null}async function kt(){let{data:e,error:t}=await v.from(`salones`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando salones:`,t.message),Error(`No se pudieron cargar los salones`);return e.map(Ot)}async function At(e){let t=(e.nombre||``).trim(),n=(e.codigo_salon||``).trim();if(!t)throw Error(`El nombre es obligatorio`);let{data:r,error:i}=await v.from(`salones`).select(`id, nombre, codigo_salon`).or(`nombre.eq."${t}", codigo_salon.eq."${n}"`).maybeSingle();if(i&&console.error(`Error validando duplicados:`,i),r){if(r.nombre.toLowerCase()===t.toLowerCase())throw Error(`Ya existe un salón con ese nombre`);if(n&&r.codigo_salon?.toLowerCase()===n.toLowerCase())throw Error(`Ya existe un salón con ese código`)}let a={nombre:t,codigo_salon:n||void 0,capacidad:parseInt(e.capacidad)||20,ubicacion:(e.ubicacion||``).trim(),piso:e.piso===void 0?null:parseInt(e.piso),condicion_fisica:e.condicion_fisica||`buena`,equipamiento:typeof e.equipamiento==`string`?e.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(e.equipamiento)?e.equipamiento:[],descripcion:(e.descripcion||``).trim(),is_active:e.is_active===void 0?!0:e.is_active,responsable_id:e.responsable_id||null},{data:o,error:s}=await v.from(`salones`).insert([a]).select();if(s)throw s.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error creando salon:`,s.message),Error(`No se pudo crear el salon`));return o[0]}async function jt(e,t){let n=(t.nombre||``).trim(),r=(t.codigo_salon||``).trim();if(n||r){let{data:t}=await v.from(`salones`).select(`id, nombre, codigo_salon`).neq(`id`,e);if(t){if(n&&t.find(e=>e.nombre.toLowerCase()===n.toLowerCase()))throw Error(`Ya existe otro salón con ese nombre`);if(r&&t.find(e=>e.codigo_salon?.toLowerCase()===r.toLowerCase()))throw Error(`Ya existe otro salón con ese código`)}}let i={...t};n&&(i.nombre=n),r&&(i.codigo_salon=r),i.capacidad&&=parseInt(i.capacidad),i.piso!==void 0&&(i.piso=parseInt(i.piso)),i.equipamiento!==void 0&&(i.equipamiento=typeof i.equipamiento==`string`?i.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(i.equipamiento)?i.equipamiento:[]),i.updated_at=new Date().toISOString();let{data:a,error:o}=await v.from(`salones`).update(i).eq(`id`,e).select();if(o)throw o.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error actualizando salon:`,o.message),Error(`No se pudo actualizar el salon`));return a[0]}async function Mt(e){let{error:t}=await v.from(`salones`).update({is_active:!1,updated_at:new Date().toISOString()}).eq(`id`,e);if(t)throw console.error(`Error eliminando salon:`,t.message),Error(`No se pudo inactivar el salon`)}var k=new class{constructor(){this.salones=[],this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notify(){this.listeners.forEach(e=>e(this))}async fetchSalones(){this.cargando=!0,this.error=null,this.notify();try{this.salones=await kt()}catch(e){this.error=e.message,console.error(e)}finally{this.cargando=!1,this.notify()}}getFiltered(e=``,t=``,n=``){return this.salones.filter(r=>{let i=e.toLowerCase(),a=r.nombre.toLowerCase().includes(i)||r.codigo&&r.codigo.toLowerCase().includes(i)||r.ubicacion.toLowerCase().includes(i),o=t===``||String(r.piso)===String(t),s=n===``||r.condicion===n;return a&&o&&s})}},Nt={editandoId:null};function A(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function Pt(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].substring(0,2).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function Ft(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#salonesTableBody`),n=e.querySelector(`#searchSalon`),r=e.querySelector(`#filterCondicion`),i=e.querySelector(`#filterPiso`),a=e.querySelector(`#salonesCount`),o=()=>{let e=n.value,o=r.value,c=i.value,l=k.getFiltered(e,c,o);if(k.cargando){t.innerHTML=`<div class="text-center py-5 text-muted"><div class="spinner-border text-primary mb-3" role="status"></div><br><small class="text-muted">Cargando salones...</small></div>`;return}if(k.error){t.innerHTML=`<div class="text-center py-5 text-danger"><i class="bi bi-exclamation-triangle fs-3 d-block mb-2"></i> Error: ${A(k.error)}</div>`;return}if(l.length===0){t.innerHTML=`
        ...
        </div>`;return}a.textContent=l.length,t.innerHTML=l.map(e=>{let t=Pt(e.nombre||`S`),n=e.is_active!==!1,r=s(e.condicion),i=`border-accent-${n?`success`:`secondary`}`,a=`bg-${n?`success`:`secondary`}`;return`
        <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${i}" data-id="${e.id}" style="cursor: pointer;">
          <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
            ...
            <div class="d-flex flex-column flex-grow-1 overflow-hidden pe-3">
              <span class="fw-bold text-truncate" style="font-size: 1.05rem;">${A(e.nombre||`-`)}</span>
      ...
      `}).join(``)},s=e=>`<span class="badge badge-compact ${{excelente:`bg-success`,buena:`bg-primary`,regular:`bg-warning`,mala:`bg-danger`}[e]||`bg-secondary`}">${{excelente:`Excelente`,buena:`Buena`,regular:`Regular`,mala:`Mala`}[e]||`-`}</span>`,c=k.subscribe(o),l;n.addEventListener(`input`,()=>{clearTimeout(l),l=setTimeout(o,300)}),r.addEventListener(`change`,o),i.addEventListener(`change`,o),e.querySelector(`#btnCrearSalon`)?.addEventListener(`click`,()=>{It()}),t?.addEventListener(`click`,async e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t){let e=t.dataset.id;Rt(e)}}),k.fetchSalones(),e.cleanup=()=>{c()}}function It(){Nt.editandoId=null,x.open({title:`Crear Nuevo Salón`,body:`<form class="row g-2" id="formSalon">
      <div class="col-12">
    ...
    </form>`,saveText:`Guardar`,onSave:async e=>{let t=e.querySelector(`#modal-nombre`).value.trim(),n=parseInt(e.querySelector(`#modal-capacidad`).value),r=e.querySelector(`#modal-piso`).value,i=e.querySelector(`#modal-condicion`).value,a=e.querySelector(`#modal-esActivo`).value===`true`,o=e.querySelector(`#modal-equipamiento`).value.trim(),s=e.querySelector(`#modal-descripcion`).value.trim();if(!t||!n||!r)return y.error(`Por favor complete los campos obligatorios`),!1;await At({nombre:t,capacidad:n,piso:r,condicion_fisica:i,is_active:a,equipamiento:o,descripcion:s}),k.fetchSalones(),y.success(`Salón creado correctamente`)}})}function Lt(e){let t=k.salones.find(t=>t.id===e);if(!t){y.error(`Salón no encontrado`);return}Nt.editandoId=e,x.open({title:`Editar Salón`,body:`<form class="row g-2" id="formSalon">
      <div class="col-12">
        <label class="form-label-compact">Nombre *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required value="${A(t.nombre||``)}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Capacidad *</label>
      ...
      <div class="col-12">
        <label class="form-label-compact">Equipamiento</label>
        <textarea class="form-control input-dense" id="modal-equipamiento" rows="2">${A(t.equipamiento||``)}</textarea>
      </div>
      <div class="col-12">
        <label class="form-label-compact">Descripción</label>
        <textarea class="form-control input-dense" id="modal-descripcion" rows="2">${A(t.descripcion||``)}</textarea>
      </div>
    </form>`,saveText:`Guardar cambios`,onSave:async t=>{try{let n=t.querySelector(`#modal-nombre`).value.trim(),r=parseInt(t.querySelector(`#modal-capacidad`).value),i=t.querySelector(`#modal-piso`).value,a=t.querySelector(`#modal-condicion`).value,o=t.querySelector(`#modal-esActivo`).value===`true`,s=t.querySelector(`#modal-equipamiento`).value.trim(),c=t.querySelector(`#modal-descripcion`).value.trim();return!n||!r||!i?(y.error(`Por favor complete los campos obligatorios`),!1):(await jt(e,{nombre:n,capacidad:r,piso:i,condicion_fisica:a,is_active:o,equipamiento:s,descripcion:c}),await k.fetchSalones(),y.success(`Salón actualizado correctamente`),!0)}catch(e){return console.error(`Error al actualizar salón:`,e),y.error(e.message||`Error al actualizar el salón`),!1}}})}function Rt(e){let t=k.salones.find(t=>t.id===e);if(!t){showToast(`Salón no encontrado`,`error`);return}let n=t.piso===0||t.piso===`0`?`Planta Baja`:`Piso ${t.piso}`,r={excelente:`Excelente`,buena:`Buena`,regular:`Regular`,mala:`Mala`}[t.condicion]||`-`,i=t.is_active===!1?`Inactivo`:`Activo`,a=t.is_active===!1?`bg-secondary`:`bg-success`;x.open({title:A(t.nombre||`Salón`),hideSave:!0,cancelText:`Cerrar`,onShow:t=>{t.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{x.close(),setTimeout(()=>Lt(e),300)}),t.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{x.close(),setTimeout(()=>zt(e),300)})},body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            <label class="form-label fw-bold">Código</label>
            <p class="form-control-plaintext"><code>${A(t.codigo||`-`)}</code></p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Nombre</label>
            <p class="form-control-plaintext">${A(t.nombre||`-`)}</p>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${A(n)}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${A(t.equipamiento||`Sin equipamiento registrado`)}</p>
          </div>
        </div>
      </div>
      ${t.descripcion?`
      ...
      <div class="row">
        <div class="col-12">
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${A(t.descripcion)}</p>
          </div>
        </div>
      </div>
      `:``}
    ...
    `})}function zt(e){let t=k.salones.find(t=>t.id===e);if(!t){y.error(`Salón no encontrado`);return}x.open({title:`⚠️ Inactivar Salón`,size:`sm`,saveText:`Inactivar`,body:`<p>¿Inactivar el salón <strong>${A(t.nombre)}</strong>?</p>
           <p class="text-muted small mb-0">Esta acción lo ocultará de las asignaciones de clases.</p>`,onSave:async()=>{await Mt(e),k.fetchSalones(),y.success(`Salón inactivado correctamente`)}})}function Bt(){C.register(`salones`,Ft)}function Vt(){C.register(`clases`,ae)}var j={timeline:[],periodos:[],periodoActivo:null,clases:[],resumenGlobal:null,cargando:!1,filtroPeriodo:null,filtroClase:`todas`,container:null};async function Ht(e){if(e)try{j.container=e,j.cargando=!0,Wt(e);let[t,n,r]=await Promise.all([Ce(),i(),we()]);j.periodos=t,j.periodoActivo=n,n?.id?j.filtroPeriodo=n.id:t&&t.length>0?j.filtroPeriodo=t[0].id:j.filtroPeriodo=null,j.clases=r,console.log(`🔍 renderAsistenciasView init:`,{periodosCount:t?.length||0,periodoActivo:n?.nombre,filtroPeriodo:j.filtroPeriodo}),await Ut(),Kt(e),Xt(e)}catch(t){console.error(t),Gt(e,t.message)}}async function Ut(){let{timelineByDate:e,resumenGlobal:t}=await te({periodoId:j.filtroPeriodo});j.timeline=e||[],j.resumenGlobal=t||{totalClases:0,totalPresentes:0,totalAusentes:0,totalJustificados:0,totalRegistros:0,totalSesiones:0}}function Wt(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status"></div>
    </div>
  `}function Gt(e,t){e.innerHTML=`
  ...
  `,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>Ht(e))}function Kt(e){e.innerHTML=`
    <div class="page-container">
      <div class="asistencias-header-premium mb-4">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p class="text-muted small mb-0">${j.resumenGlobal?.totalRegistros||0} registros en total</p>
          </div>
        </div>
      ...
      <div class="stats-panel mb-4">
        <div class="stats-grid">
          <div class="stat-card stat-total">
            ...
            <div class="stat-value">${j.resumenGlobal?.totalRegistros||0}</div>
          </div>
          <div class="stat-card stat-present">
            <div class="stat-label">Presentes</div>
            <div class="stat-value">${j.resumenGlobal?.totalPresentes||0}</div>
          </div>
          <div class="stat-card stat-absent">
            <div class="stat-label">Ausentes</div>
            <div class="stat-value">${j.resumenGlobal?.totalAusentes||0}</div>
          </div>
          <div class="stat-card stat-justified">
            <div class="stat-label">Justificados</div>
            <div class="stat-value">${j.resumenGlobal?.totalJustificados||0}</div>
          </div>
          <div class="stat-card stat-sessions">
            <div class="stat-label">Sesiones</div>
            <div class="stat-value">${j.resumenGlobal?.totalSesiones||0}</div>
          </div>
        </div>
      </div>
      ...
      <div class="asistencias-filter-toolbar mb-4">
        <div class="premium-select-container" style="max-width: 250px;">
          ...
          <select class="form-select premium-filter-select" id="select-periodo">
            ${j.periodos.map(e=>`<option value="${e.id}" ${e.id===j.filtroPeriodo?`selected`:``}>${S(e.nombre)}</option>`).join(``)}
          </select>
        </div>
      </div>
  ...
  `}function qt(){return j.timeline.length===0?`<div class="text-center py-5 text-muted"><i class="bi bi-calendar-x fs-1 d-block mb-2"></i>No hay clases registradas.</div>`:j.timeline.map((e,t)=>{let n=Yt(e.fecha),r=`accordion-fecha-${t}`,i=e.clases.map((e,n)=>{let r=`accordion-clase-${t}-${n}`,i=e.hora_inicio?`${e.hora_inicio.slice(0,5)} - ${e.hora_fin?.slice(0,5)||`??:??`}`:`Sin horario`;return`
          ...
          <h2 class="accordion-header" id="heading-clase-${t}-${n}">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#${r}" aria-expanded="false" aria-controls="${r}">
              <div class="clase-header-info">
                <div class="clase-name">${S(e.clase_nombre)}</div>
                <div class="clase-meta">
                  <span class="horario">${i}</span>
                  <span class="maestro">Prof. ${S(e.maestro_nombre)}</span>
                  ${e.maestro_auxiliar_nombre?`<span class="auxiliar">Aux. ${S(e.maestro_auxiliar_nombre)}</span>`:``}
                </div>
              </div>
    ...
    `}).join(``)}function Jt(e){let t=e.asistencias||[],n=t.filter(e=>e.estado===`presente`),r=t.filter(e=>e.estado===`ausente`),i=t.filter(e=>e.estado===`justificado`),a=(e,t,n)=>t.length===0?``:`
      <div class="mb-3">
        ...
        <div class="listado-alumnos ps-3" style="border-left: 2px solid #dee2e6; padding-left: 1rem;">
          ${t.map((e,n)=>`
            <div class="alumno-item mb-2">
              ...
              <span>${S(e.alumno_nombre||`Sin nombre`)}</span>
            </div>
          `).join(``)}
        </div>
      </div>
        ...
        <div class="observaciones-section border-top pt-3">
          ...
          <div class="alert alert-light border">
            <p class="mb-0 text-secondary">
              ${S(e.observacion_sesion||e.observacion_clase||`Sin observaciones registradas`)}
            </p>
          </div>
        </div>
      `:`
  ...
  `}function Yt(e){return new Date(e+`T12:00:00`).toLocaleDateString(`es-ES`,{weekday:`long`,day:`numeric`,month:`long`})}function Xt(e){e.querySelector(`#select-periodo`)?.addEventListener(`change`,async e=>{j.filtroPeriodo=e.target.value,await Zt()}),e.querySelector(`#accordion-dias`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="view-detail"]`);t&&Qt(t.dataset.id)}),e.querySelector(`#btn-nueva-sesion`)?.addEventListener(`click`,()=>$t())}async function Zt(){let e=j.container;y.info(`Cargando asistencias...`),await Ut();let t=e.querySelector(`.asistencias-header-premium p.text-muted`);t&&(t.textContent=`${j.resumenGlobal?.totalRegistros||0} registros en total`);let n=e.querySelector(`.stats-panel`);n&&(n.innerHTML=`
      <div class="stats-grid">
        <div class="stat-card stat-total">
          <div class="stat-label">Total Registros</div>
          <div class="stat-value">${j.resumenGlobal?.totalRegistros||0}</div>
    ...
    `);let r=e.querySelector(`#accordion-dias`);r&&(r.innerHTML=qt()),Xt(e),y.success(`Asistencias cargadas`)}async function Qt(e){y.info(`Cargando detalle...`);try{let t=await ee(e);x.open({title:`Sesión: ${t.sesion.claseNombre}`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
        <div class="row g-4">
          <div class="col-md-8">
            <label class="text-muted small text-uppercase fw-bold mb-1 d-block">Tema Principal</label>
            <p class="fw-semibold">${S(t.sesion.temaPrincipal||`No especificado`)}</p>
            <label class="text-muted small text-uppercase fw-bold mb-1 d-block">Observaciones Generales</label>
            <p class="text-secondary small">${S(t.sesion.observacionesGenerales||`Sin observaciones.`)}</p>
          </div>
          <div class="col-md-4 bg-body-tertiary p-3 rounded">
            ...
            <div class="d-flex justify-content-between"><span>Maestro:</span> <strong>${S(t.sesion.maestroNombre)}</strong></div>
          </div>
          <div class="col-12">
            ...
            <div class="table-responsive">
              <table class="table table-compact">
                ...
                <tbody>
                  ${t.asistencias.map(e=>`
                    <tr>
                      <td>${S(e.alumnoNombre)}</td>
                      <td class="text-center">
                        <span class="badge bg-${oe[e.estado]?.css||`secondary`}">${oe[e.estado]?.label||e.estado}</span>
                      </td>
                      <td class="small text-muted">${S(e.observacion||e.justificacionTexto||`-`)}</td>
                    </tr>
                  `).join(``)}
                </tbody>
              </table>
  ...
  `}var M={periodoActivo:null,periodos:[],datos:{programas:{},niveles:{},totales:{sesiones:0,presentes:0,ausentes:0,justificados:0}},cargando:!1};async function tn(e){M.cargando=!0,e.innerHTML=nn(),await rn(),M.cargando=!1,on(e)}function nn(){return`
  ...
  `}async function rn(){let[e,t]=await Promise.all([Ce(),i()]);M.periodos=e,M.periodoActivo=t,t&&(M.datos=an(await a({periodoId:t.id})))}function an(e){let t={},n={},r=0,i=0,a=0,o=0;for(let s of e)for(let e of s.sesiones){let s=e.claseNombre?.split(`-`)[0]?.trim()||`General`,c=e.instrumento||`General`;t[s]||(t[s]={total:0,presentes:0,ausentes:0,justificados:0}),t[s].total+=e.totalRegistros||0,t[s].presentes+=e.totalPresentes||0,t[s].ausentes+=e.totalAusentes||0,t[s].justificados+=e.totalJustificados||0,n[c]||(n[c]={total:0,presentes:0,ausentes:0,justificados:0}),n[c].total+=e.totalRegistros||0,n[c].presentes+=e.totalPresentes||0,n[c].ausentes+=e.totalAusentes||0,n[c].justificados+=e.totalJustificados||0,r++,i+=e.totalPresentes||0,a+=e.totalAusentes||0,o+=e.totalJustificados||0}return{programas:t,niveles:n,totales:{sesiones:r,presentes:i,ausentes:a,justificados:o}}}function on(e){let{programas:t,niveles:n,totales:r}=M.datos,i=r.presentes+r.ausentes+r.justificados?Math.round(r.presentes/i*100):0;e.innerHTML=`
    <div class="page-container py-3">
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-3">${en({titulo:`Sesiones`,valor:r.sesiones,colorClass:`primary`,icono:`bi-calendar3`})}</div>
        <div class="col-md-3">${en({titulo:`Tasa Asistencia`,valor:`${i}%`,colorClass:i>=80?`success`:i>=50?`warning`:`danger`,icono:`bi-check-circle`})}</div>
        <div class="col-md-3">${en({titulo:`Ausentes`,valor:r.ausentes,colorClass:`danger`,icono:`bi-x-circle`})}</div>
        <div class="col-md-3">${en({titulo:`Justificados`,valor:r.justificados,colorClass:`warning`,icono:`bi-file-earmark-check`})}</div>
      </div>
  ...
  `}function sn(e,t){if(!Object.keys(e).length)return`<p class="text-muted text-center py-3">Sin datos disponibles</p>`;let n=Object.entries(e).sort((e,t)=>t[1].presentes+t[1].ausentes-(e[1].presentes+e[1].ausentes));return Math.max(...n.map(([,e])=>e.presentes+e.ausentes+e.justificados)),n.slice(0,8).map(([e,t])=>{let n=t.presentes+t.ausentes+t.justificados,r=n?t.presentes/n*100:0,i=n?t.ausentes/n*100:0,a=n?t.justificados/n*100:0;return`
    ...
    `}).join(``)}function cn(){C.register(`asistencias`,Ht),C.register(`asistencias-reportes`,tn)}window.location.href.includes(`supabase`);async function ln(e){let{data:t,error:n}=await v.from(`cobertura_alumno_objetivo`).upsert(e,{onConflict:`alumno_id,objetivo_id`}).select();if(n)throw n;return t}async function un(e){let{data:t,error:n}=await v.from(`cobertura_alumno_objetivo`).select(`
      id, nivel, confirmado, fecha, plan_id, objetivo_id,
      curriculo_objetivos ( id, descripcion, pilar_id,
        curriculo_pilares ( id, nombre )
      )
    `).eq(`alumno_id`,e);if(n)throw n;return t||[]}function dn(){return`/functions/v1/groq-proxy`}async function fn(){let{data:{session:e}}=await v.auth.getSession();return{Authorization:`Bearer ${e?.access_token??``}`,"Content-Type":`application/json`,apikey:``}}async function pn(e,{maxTokens:t,temperature:n,responseFormat:r}={}){let i=await fn(),a={model:h.groq.model,messages:e,...t&&{max_tokens:t},...n!==void 0&&{temperature:n},...r&&{response_format:r}},o=await fetch(`${dn()}/chat`,{method:`POST`,headers:i,body:JSON.stringify(a)}),s=await o.json();if(!o.ok||s.error)throw Error(s.error?.message??`Groq proxy error ${o.status}`);return s.choices[0].message.content.trim()}async function mn(e,t,n){let r=`Eres un asistente pedagógico musical. Dado el contenido de un plan de clase y una lista de objetivos curriculares, identifica cuáles objetivos probablemente se cubrieron.
...
Para las próximas semanas, incorporá al menos una pieza nueva por mes y dedicá 5-10 minutos a ejercicios de lectura rítmica.`,isMock:!0};try{return{success:!0,feedback:await pn([{role:`user`,content:i}],{maxTokens:600,temperature:.8}),isMock:!1}}catch(e){return console.error(`analizarEnfoque error:`,e),{success:!1,feedback:``,error:e.message}}}var _n=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),vn=`
...
.cob-ai-badge { font-size:.7rem; color: var(--bs-warning-text-emphasis); }
</style>`;async function yn({plan:e,claseId:n,instrumento:r,nivel:i,maestroId:a,onConfirm:o,onSkip:s}){let c=document.createElement(`div`);c.innerHTML=`${vn}
    <div class="modal fade" id="cob-modal" tabindex="-1" data-bs-backdrop="static">
    ...
    </div>`,document.body.appendChild(c);let l=c.querySelector(`#cob-modal`),u=new bootstrap.Modal(l),d=[];c.querySelector(`#cob-btn-skip`).addEventListener(`click`,()=>{u.hide(),s?.()}),c.querySelector(`#cob-btn-confirm`).addEventListener(`click`,async()=>{let t=d.filter(e=>e.checked).map(t=>({alumno_id:t.alumno_id,objetivo_id:t.objetivo_id,plan_id:e.id,maestro_id:a,nivel:t.nivel,confirmado:!0,fecha:e.fecha_inicio||new Date().toISOString().slice(0,10)}));try{t.length>0&&await ln(t),y.success(`Cobertura registrada`),u.hide(),o?.()}catch(e){y.error(e.message)}}),l.addEventListener(`hidden.bs.modal`,()=>c.remove()),u.show();try{let a=r&&i?await ne(r,i):null,o=t(e.notas_dsl||e.contenido||``).alumnos||[],s=[];if(o.length>0||n){let{data:e}=await v.from(`alumnos`).select(`id, nombre_completo`);o.length>0&&(s=(e||[]).filter(e=>o.some(t=>e.nombre_completo.toLowerCase().includes(t.toLowerCase()))))}if(s.length===0&&n){let{data:e}=await v.from(`alumnos_clases`).select(`alumnos(id, nombre_completo)`).eq(`clase_id`,n);s=(e||[]).map(e=>e.alumnos).filter(Boolean)}let l=a?a.curriculo_pilares.flatMap(e=>e.curriculo_objetivos.map(t=>({...t,pilar_nombre:e.nombre}))):[],u=[];a&&l.length>0&&(u=(await mn({tema:e.tema,objetivos:e.objetivos,contenido:e.contenido,notas_dsl:e.notas_dsl},o,l.map(e=>({id:e.id,descripcion:e.descripcion})))).coberturas||[]),d=[],s.forEach(e=>{l.forEach(t=>{let n=u.find(n=>n.objetivo_id===t.id&&e.nombre_completo.toLowerCase().includes((n.alumno||``).toLowerCase()));d.push({alumno_id:e.id,alumno_nombre:e.nombre_completo,objetivo_id:t.id,obj_descripcion:t.descripcion,pilar_nombre:t.pilar_nombre,nivel:n?.nivel||`en_proceso`,checked:!!n,ai_suggested:!!n,razon:n?.razon||``})})}),f(),c.querySelector(`#cob-btn-confirm`).disabled=!1}catch(e){document.getElementById(`cob-body`).innerHTML=`
      <div class="alert alert-warning">
        <i class="bi bi-exclamation-triangle me-2"></i>
      ...
      ${Object.entries(t).map(([e,{nombre:t,rows:n}])=>`
        <div class="cob-alumno-block">
          <div class="cob-alumno-name"><i class="bi bi-person me-1"></i>${_n(t)}</div>
          ${n.map(e=>{let t=d.indexOf(e);return`
            <div class="cob-obj-row">
              ...
              <span style="flex:1">
                <span class="text-muted small">${_n(e.pilar_nombre)} /</span> ${_n(e.obj_descripcion)}
        ...
        </div>`).join(``)}`,e.querySelectorAll(`.cob-check`).forEach(t=>{t.addEventListener(`change`,()=>{let n=+t.dataset.idx;d[n].checked=t.checked;let r=e.querySelector(`.cob-nivel-sel[data-idx="${n}"]`);r&&(r.disabled=!t.checked)})}),e.querySelectorAll(`.cob-nivel-sel`).forEach(e=>{e.addEventListener(`change`,()=>{d[+e.dataset.idx].nivel=e.value})})}}var N=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);async function bn(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="card border-0 shadow-sm mb-4">
    ...
    </div>`;let t={alumnos:[],selectedAlumnoId:null,selectedAlumno:null,cobertura:[],curriculo:null,maestroId:null,instrumento:null},{data:{user:n}}=await v.auth.getUser(),{data:r}=await v.from(`maestros`).select(`id, instrumento`).eq(`user_id`,n.id).single();t.maestroId=r?.id,t.instrumento=r?.instrumento;let{data:i}=await v.from(`alumnos_clases`).select(`alumnos(id, nombre_completo), clases(instrumento, plan_estudio, maestro_principal_id)`).eq(`clases.maestro_principal_id`,t.maestroId),a={};(i||[]).forEach(e=>{e.alumnos&&e.clases&&(a[e.alumnos.id]={...e.alumnos,instrumento:e.clases.instrumento,nivel:e.clases.plan_estudio})}),t.alumnos=Object.values(a);let o=e.querySelector(`#ap-alumno-sel`);o.innerHTML=`<option value="">Seleccionar alumno...</option>`+t.alumnos.map(e=>`<option value="${e.id}">${N(e.nombre_completo)}</option>`).join(``),o.addEventListener(`change`,async()=>{let n=o.value;if(!n){e.querySelector(`#ap-brechas-content`).innerHTML=`<p class="text-muted small">Seleccioná un alumno.</p>`,e.querySelector(`#ap-btn-draft`).disabled=!0,t.selectedAlumnoId=null,t.selectedAlumno=null;return}t.selectedAlumnoId=n,t.selectedAlumno=t.alumnos.find(e=>e.id===n),e.querySelector(`#ap-btn-draft`).disabled=!1,await s()});async function s(){let n=e.querySelector(`#ap-brechas-content`);n.innerHTML=`<div class="text-center py-3"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let e=t.selectedAlumno;if(t.curriculo=e.instrumento&&e.nivel?await ne(e.instrumento,e.nivel):null,!t.curriculo){n.innerHTML=`<div class="alert alert-secondary py-2 small">Sin guía curricular definida para <strong>${N(e.instrumento||`este instrumento`)}</strong> — <strong>${N(e.nivel||`este nivel`)}</strong>.</div>`;return}t.cobertura=await un(t.selectedAlumnoId);let r={};t.cobertura.forEach(e=>{let t=e.curriculo_objetivos?.id||e.objetivo_id;t&&(r[t]=e)});let i=t.curriculo.curriculo_pilares.flatMap(e=>e.curriculo_objetivos.map(t=>({...t,pilar_nombre:e.nombre}))),a=i.filter(e=>r[e.id]?.nivel===`logrado`).length,o=i.filter(e=>r[e.id]&&r[e.id].nivel!==`logrado`).length;n.innerHTML=`
        <div class="mb-3">
        ...
        <div class="card border-success border-opacity-25">
          <div class="card-body">
            ...
            <div class="mb-2"><span class="fw-semibold">Tema:</span> ${N(u.tema||``)}</div>
            <div class="mb-2"><span class="fw-semibold">Objetivos:</span> ${N(u.objetivos||``)}</div>
            <div class="mb-2"><span class="fw-semibold">Contenido:</span> ${N(u.contenido||``)}</div>
            ${u.recursos?.length?`<div><span class="fw-semibold">Recursos:</span> ${u.recursos.map(e=>`<span class="badge bg-light text-dark border me-1">${N(e)}</span>`).join(``)}</div>`:``}
          </div>
        </div>`,e.querySelector(`#ap-btn-save-draft`)?.addEventListener(`click`,()=>{document.dispatchEvent(new CustomEvent(`planificacion:nuevoPlan`,{detail:{tema:u.tema,objetivos:u.objetivos,contenido:u.contenido}})),y.success(`Borrador listo — abrí "Nuevo plan" para completar los detalles`)})}catch(e){r.innerHTML=`<div class="alert alert-danger small">${e.message}</div>`}finally{n.disabled=!1,n.innerHTML=`<i class="bi bi-stars me-1"></i>Generar borrador`}}),e.querySelector(`#ap-btn-feedback`).addEventListener(`click`,async()=>{let n=e.querySelector(`#ap-btn-feedback`),r=e.querySelector(`#ap-feedback-content`);n.disabled=!0,n.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Analizando...`,r.innerHTML=``;try{let n=new Date;n.setDate(n.getDate()-56);let{data:i}=await v.from(`planificaciones`).select(`tema, contenido, objetivos, instrumento`).eq(`maestro_id`,t.maestroId).eq(`estado`,`ejecutado`).gte(`created_at`,n.toISOString()),a=t.instrumento||i?.[0]?.instrumento||`Instrumento`,o=null;try{o=a?await ne(a,null):null}catch{}let s=t.selectedAlumnoId&&t.selectedAlumno?`Alumno seleccionado: ${t.selectedAlumno.nombre_completo}. ${t.cobertura.length} objetivos trabajados.`:`No hay alumno seleccionado.`,c=await gn(a,i||[],o,s);if(!c.success)throw Error(c.error||`Sin respuesta de la IA`);r.innerHTML=`
        <div class="card border-warning border-opacity-25">
          <div class="card-body">
            ...
            <div class="text-body" style="line-height:1.7; white-space:pre-line">${N(c.feedback)}</div>
          </div>
        </div>`,e.querySelector(`#ap-btn-regenerate`)?.addEventListener(`click`,()=>{e.querySelector(`#ap-btn-feedback`).click()})}catch(e){r.innerHTML=`<div class="alert alert-danger small">${e.message}</div>`}finally{n.disabled=!1,n.innerHTML=`<i class="bi bi-chat-quote me-1"></i>Analizar mi enfoque`}})}var xn=`
...
.cm-obj-input { flex:1; }
</style>`;function Sn(e){let t=document.getElementById(`curriculo-list-modal`);t&&t.remove();let n=document.createElement(`div`);n.id=`curriculo-list-modal`,n.innerHTML=`${xn}
    <div class="modal fade" id="curriculo-list-modal-dialog" tabindex="-1">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
    ...
    </div>`,document.body.appendChild(n);let r=n.querySelector(`#curriculo-list-modal-dialog`),i=new bootstrap.Modal(r);async function a(){let e=document.getElementById(`cl-body`);try{let t=await s();if(t.length===0){e.innerHTML=`<p class="text-muted text-center py-4">No hay currículos creados aún.</p>`;return}e.innerHTML=`
        ...
        </table>`,e.querySelectorAll(`.cl-toggle`).forEach(e=>{e.addEventListener(`change`,async()=>{await ie(e.dataset.id,e.checked),y.success(e.checked?`Currículo activado`:`Currículo desactivado`)})}),e.querySelectorAll(`.cl-btn-edit`).forEach(e=>{e.addEventListener(`click`,()=>wn(e.dataset.id,a))})}catch(t){e.innerHTML=`<p class="text-danger">${t.message}</p>`}}n.querySelector(`#cl-btn-nuevo`).addEventListener(`click`,()=>{Cn(a)}),r.addEventListener(`hidden.bs.modal`,()=>{n.remove(),e?.()}),i.show(),a()}function Cn(e){let t=document.createElement(`div`);t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);let n=t.querySelector(`#cc-modal`),r=new bootstrap.Modal(n);t.querySelector(`#cc-btn-save`).addEventListener(`click`,async()=>{let n=t.querySelector(`#cc-instrumento`).value.trim(),i=t.querySelector(`#cc-nivel`).value.trim();if(!n||!i){y.error(`Instrumento y nivel son obligatorios`);return}try{await l({instrumento:n,nivel:i,descripcion:t.querySelector(`#cc-desc`).value.trim()}),y.success(`Currículo creado`),r.hide(),e?.()}catch(e){y.error(e.message)}}),n.addEventListener(`hidden.bs.modal`,()=>t.remove()),r.show()}async function wn(e,t){let{data:n,error:i}=await v.from(`curriculos`).select(`id, instrumento, nivel, descripcion, curriculo_pilares(id, nombre, orden, curriculo_objetivos(id, descripcion, orden))`).eq(`id`,e).single();if(i){y.error(i.message);return}let a=document.createElement(`div`);a.innerHTML=`
    <div class="modal fade" id="ce-modal" tabindex="-1">
    ...
    </div>`,document.body.appendChild(a);let s=a.querySelector(`#ce-modal`),c=new bootstrap.Modal(s);function l(){let e=document.getElementById(`ce-body`);e.innerHTML=`
      <div class="mb-3">
      ...
      </div>`,e.querySelectorAll(`.pilar-nombre`).forEach(e=>{e.addEventListener(`blur`,async()=>{await o(e.closest(`[data-pilar-id]`).dataset.pilarId,{nombre:e.value.trim()})})}),e.querySelectorAll(`.pilar-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`).dataset.pilarId;confirm(`¿Eliminar este pilar y todos sus objetivos?`)&&(await re(t),n.curriculo_pilares=n.curriculo_pilares.filter(e=>e.id!==t),l())})}),e.querySelectorAll(`.obj-desc`).forEach(e=>{e.addEventListener(`blur`,async()=>{await p(e.closest(`[data-obj-id]`).dataset.objId,{descripcion:e.value.trim()})})}),e.querySelectorAll(`.obj-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-obj-id]`),i=t.dataset.objId;await r(i);let a=t.closest(`[data-pilar-id]`).dataset.pilarId,o=n.curriculo_pilares.find(e=>e.id===a);o&&(o.curriculo_objetivos=o.curriculo_objetivos.filter(e=>e.id!==i)),l()})}),e.querySelectorAll(`.new-obj-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`),r=t.dataset.pilarId,i=t.querySelector(`.new-obj-input`),a=i.value.trim();if(!a)return;let o=n.curriculo_pilares.find(e=>e.id===r),s=(o?.curriculo_objetivos||[]).length,c=await m(r,a,s);o&&(o.curriculo_objetivos=[...o.curriculo_objetivos||[],c]),i.value=``,l()})}),document.getElementById(`ce-add-pilar`)?.addEventListener(`click`,async()=>{let e=prompt(`Nombre del nuevo pilar:`);if(!e?.trim())return;let t=n.curriculo_pilares.length,r=await Te(n.id,e.trim(),t);n.curriculo_pilares.push({...r,curriculo_objetivos:[]}),l()})}s.addEventListener(`hidden.bs.modal`,()=>{a.remove(),t?.()}),c.show(),l()}var Tn=[{id:`escala`,nombre:`Escala Mayor`,instrumento:`Piano / Guitarra`,descripcion:`Trabajo de escalas diatónicas mayores en posición cerrada.`,contenido:`[Indicador] Ejecuta la escala de Do mayor en dos octavas con digitación correcta
...
{Actividad} Construcción de acordes en el instrumento`}],P={planes:[],planesOriginales:[],cargando:!1,viewMode:`maestro`,activeTab:`planes`,asistenteRendered:!1,seleccionados:new Set,container:null};async function F(e,{viewMode:t=`maestro`}={}){if(e){if(P.container=e,P.viewMode=t,P.seleccionados=new Set,P.asistenteRendered=!1,t===`plantillas`){Mn(e);return}try{P.cargando=!0,En(e);let t=await d();P.planes=t,P.planesOriginales=[...t],P.cargando=!1,On(e),Pn(e)}catch(t){console.error(`[planificacionView]`,t),Dn(e,t.message)}}}function En(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando...</span>
      </div>
    </div>`}function Dn(e,t){e.innerHTML=`
    <div class="page-container">
    ...
    </div>`}function On(e){let t=P.viewMode===`admin`,n=t?`Todas las Planificaciones`:`Mis Planes de Clase`,r=t?`bi-shield-check`:`bi-journal-check`,i=t?`${P.planesOriginales.length} planes pendientes de revisión`:`${P.planesOriginales.length} planes registrados`,a=t?kn():``;e.innerHTML=`
    <div class="page-container">
      <!-- Header -->
      ...
      <div class="planificacion-filter-toolbar mb-4">
        ...
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-estado">
            ...
            ${g.getEstados().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
      </div>
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${P.planes.length===0?jn():``}</div>
      </div>
      </div>
  ...
  `}function kn(){let e=P.planesOriginales,t=e.filter(e=>e.estado===`ejecutado`).length,n=e.filter(e=>e.estado===`revisado`).length,r=e.length;return`
    <div class="stats-panel mb-4">
      <div class="stats-grid">
  ...
  `}function An(e){if(!e||e.length===0)return``;let t=P.viewMode===`admin`;return e.map(e=>{let n=g.getEstadoConfig(e.estado),r=e.estado===`revisado`?`border-accent-success`:e.estado===`ejecutado`?`border-accent-warning`:`border-accent-secondary`;return`
      <tr data-id="${e.id}" class="border-start-accent ${r}">
        ${t?`<td><input type="checkbox" class="plan-check" value="${e.id}" ${P.seleccionados.has(e.id)?`checked`:``}></td>`:``}
        <td>
          <div class="fw-bold">${S(e.clase_nombre||`Sin clase`)}</div>
          <div class="small text-muted text-truncate" style="max-width: 260px">${S(e.tema)}</div>
        </td>
        ${t?`<td class="d-none d-md-table-cell align-middle small text-muted">${S(e.maestro_nombre||`N/A`)}</td>`:``}
    ...
    `}).join(``)}function jn(){let e=P.viewMode===`admin`;return`
          ...
          <div class="col-md-6">
            <div class="page-glass rounded p-4 h-100 d-flex flex-column">
              <div class="d-flex align-items-start gap-3 mb-3">
                ...
                <div>
                  <h5 class="fw-bold mb-0">${S(e.nombre)}</h5>
                  <span class="badge bg-secondary bg-opacity-10 text-secondary border small">${S(e.instrumento)}</span>
                </div>
              </div>
              <p class="text-muted small flex-grow-1">${S(e.descripcion)}</p>
              <details class="mb-3">
                <summary class="small text-primary" style="cursor:pointer">Ver contenido DSL</summary>
                <pre class="mt-2 p-2 bg-body-tertiary rounded small border" style="font-size:.75rem;white-space:pre-wrap">${S(e.contenido)}</pre>
              </details>
  ...
  `,e.querySelectorAll(`button[data-template-id]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Tn.find(t=>t.id===e.dataset.templateId);t&&Nn(t)})})}function Nn(e){x.open({title:`Usar plantilla: ${e.nombre}`,saveText:`Crear Plan`,size:`lg`,body:`
      <form id="form-tpl" class="row g-3">
        <div class="col-md-8">
          <label class="form-label-compact">Tema de la Clase *</label>
          <input type="text" class="form-control input-dense" id="tpl-tema" value="${S(e.nombre)}" required>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control input-dense" id="tpl-objetivos" rows="2">${S(e.descripcion)}</textarea>
        </div>
        <div class="col-12">
          <label class="form-label-compact">Contenido DSL</label>
          <textarea class="form-control input-dense font-monospace" id="tpl-contenido" rows="7">${S(e.contenido)}</textarea>
        </div>
      </form>
    `,onOpen:async e=>{let{data:t}=await v.from(`clases`).select(`id, nombre`).order(`nombre`),n=e.querySelector(`#tpl-clase_id`);n.innerHTML=`<option value="">Seleccionar clase...</option>`+(t||[]).map(e=>`<option value="${e.id}">${S(e.nombre)}</option>`).join(``)},onSave:async e=>{let t={tema:e.querySelector(`#tpl-tema`).value.trim(),clase_id:e.querySelector(`#tpl-clase_id`).value,objetivos:e.querySelector(`#tpl-objetivos`).value.trim(),contenido:e.querySelector(`#tpl-contenido`).value.trim()};try{return await n(t),y.success(`Plan creado desde plantilla`),!0}catch(e){return y.error(e.message),!1}}})}function Pn(e){let t=P.viewMode===`admin`;e.querySelector(`#buscar-plan`)?.addEventListener(`input`,Fn),e.querySelector(`#select-estado`)?.addEventListener(`change`,Fn),e.querySelector(`#btn-help-planificacion`)?.addEventListener(`click`,()=>{ye.open({title:`Planificación`,intro:`Módulo para gestionar los planes de clase. Cada plan documenta qué se trabajará en una clase, en qué fecha, y si fue ejecutado o no.`,sections:[{icon:`bi-journal-text`,title:`Tab Mis planes`,description:`Lista tus planes personales. Filtrá por estado (planificado, ejecutado, cancelado) y creá nuevos desde "Nuevo plan".`,color:`#3b82f6`},{icon:`bi-file-earmark-template`,title:`Tab Plantillas`,description:`Plantillas reutilizables en formato DSL. Sirven como base para crear nuevos planes rápidamente.`,color:`#6366f1`},{icon:`bi-journal-check`,title:`Todas las planes (admin)`,description:`Solo visible para administradores. Muestra los planes de todos los maestros para supervisión.`,color:`#10b981`},{icon:`bi-circle-fill`,title:`Estados del plan`,description:`"Planificado" = no dictado aún. "Ejecutado" = clase dada. "Cancelado" = no se realizó. Mantenerlos actualizados mejora los reportes.`,color:`#f59e0b`}]})}),t||e.querySelector(`#btn-nuevo-plan`)?.addEventListener(`click`,()=>Ln(null)),t&&(e.querySelector(`#check-all`)?.addEventListener(`change`,t=>{let n=t.target.checked;P.seleccionados=n?new Set(P.planes.map(e=>e.id)):new Set,e.querySelectorAll(`.plan-check`).forEach(e=>{e.checked=n}),In()}),e.querySelector(`#btn-aprobar-bulk`)?.addEventListener(`click`,async()=>{let t=[...P.seleccionados];if(t.length)try{await u(t),y.success(`${t.length} plan(es) aprobados`),F(e,{viewMode:P.viewMode})}catch(e){y.error(e.message)}})),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(t=>{t.addEventListener(`click`,()=>{if(P.activeTab=t.dataset.tab,[`planes`,`plantillas`,`asistente`].forEach(t=>{let n=e.querySelector(`#tab-content-${t}`);n&&(n.style.display=P.activeTab===t?`block`:`none`)}),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),P.activeTab===`asistente`&&!P.asistenteRendered){let t=e.querySelector(`#tab-content-asistente`);t&&(bn(t),P.asistenteRendered=!0)}})}),document.addEventListener(`planificacion:nuevoPlan`,e=>{Ln(null)},{once:!0}),t&&e.querySelector(`#btn-curriculo-admin`)?.addEventListener(`click`,()=>{Sn()}),e.querySelector(`#planes-tbody`)?.addEventListener(`change`,e=>{if(!e.target.classList.contains(`plan-check`))return;let t=e.target.value;e.target.checked?P.seleccionados.add(t):P.seleccionados.delete(t),In()}),e.querySelector(`#planes-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&Ln(r),n===`delete`&&Vn(r),n===`approve`&&zn(r),n===`view`&&Rn(r),n===`ejecutar`&&Bn(r)})}function Fn(){let e=P.container.querySelector(`#buscar-plan`)?.value.toLowerCase()||``,t=P.container.querySelector(`#select-estado`)?.value||``;P.planes=P.planesOriginales.filter(n=>{let r=(n.tema||``).toLowerCase().includes(e)||(n.clase_nombre||``).toLowerCase().includes(e),i=!t||n.estado===t;return r&&i});let n=P.container.querySelector(`#planes-tbody`),r=P.container.querySelector(`#empty-container`);n&&(n.innerHTML=An(P.planes)),r&&(r.innerHTML=P.planes.length===0?jn():``)}function In(){let e=P.container?.querySelector(`#btn-aprobar-bulk`);e&&(e.style.display=P.seleccionados.size>0?``:`none`)}async function Ln(e,t={}){let r=e?P.planesOriginales.find(t=>t.id===e):new g(t);x.open({title:e?`Editar Plan de Clase`:`Nuevo Plan de Clase`,saveText:`Guardar Plan`,size:`lg`,body:`
      <form id="form-plan" class="row g-3">
        <div class="col-md-8">
          <label class="form-label-compact">Tema de la Clase *</label>
          <input type="text" class="form-control input-dense" id="plan-tema" value="${S(r.tema)}" required>
        </div>
        <div class="col-md-4">
          <label class="form-label-compact">Clase *</label>
        ...
        <div class="col-12">
          <label class="form-label-compact">Objetivos</label>
          <textarea class="form-control input-dense" id="plan-objetivos" rows="2">${S(r.objetivos)}</textarea>
        </div>
        <div class="col-12">
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control input-dense" id="plan-instrumento" value="${S(r.instrumento||``)}">
        </div>
        <div class="col-md-4">
          <label class="form-label-compact">Método de evaluación</label>
          <input type="text" class="form-control input-dense" id="plan-eval" value="${S(r.evaluacion_metodo||``)}">
        </div>
      </form>
    `,onOpen:async e=>{let{data:t}=await v.from(`clases`).select(`id, nombre`).order(`nombre`),n=e.querySelector(`#plan-clase_id`);n.innerHTML=`<option value="">Seleccionar clase...</option>`+(t||[]).map(e=>`<option value="${e.id}" ${e.id===r.clase_id?`selected`:``}>${S(e.nombre)}</option>`).join(``)},onSave:async t=>{let r={tema:t.querySelector(`#plan-tema`).value.trim(),clase_id:t.querySelector(`#plan-clase_id`).value,objetivos:t.querySelector(`#plan-objetivos`).value.trim(),contenido:t.querySelector(`#plan-contenido`).value.trim(),fecha_inicio:t.querySelector(`#plan-fecha`).value||null,instrumento:t.querySelector(`#plan-instrumento`).value.trim()||null,evaluacion_metodo:t.querySelector(`#plan-eval`).value.trim()||null},i=new g(r).validate();if(i.length>0)return y.error(i[0]),!1;try{return e?(await me(e,r),y.success(`Plan actualizado correctamente`)):(await n(r),y.success(`Plan creado correctamente`)),F(P.container,{viewMode:P.viewMode}),!0}catch(e){return y.error(e.message),!1}}})}function Rn(e){let t=P.planesOriginales.find(t=>t.id===e);if(!t)return;let n=g.getEstadoConfig(t.estado);x.open({title:`Plan: ${t.clase_nombre||`Sin clase`}`,hideSave:!0,size:`lg`,body:`
      <div class="row g-3 mb-3">
        <div class="col-md-8">
          <div class="small text-muted text-uppercase fw-bold mb-1">Tema</div>
          <div class="fw-bold">${S(t.tema)}</div>
        </div>
      ...
      ${t.maestro_nombre?`
        <div class="mb-3">
          ...
          <div>${S(t.maestro_nombre)}</div>
        </div>
      `:``}
      ${t.objetivos?`
        <div class="mb-3">
          <div class="small text-muted text-uppercase fw-bold mb-1">Objetivos</div>
          <div class="text-muted">${S(t.objetivos)}</div>
        </div>
      `:``}
      ${t.contenido?`
        <div class="mb-3">
          <div class="small text-muted text-uppercase fw-bold mb-1">Contenido DSL</div>
          <pre class="p-3 rounded border bg-body-tertiary small" style="white-space:pre-wrap">${S(t.contenido)}</pre>
        </div>
      `:``}
      <div class="row g-2">
        ...
        ${t.instrumento?`<div class="col-auto"><span class="badge bg-light text-dark border"><i class="bi bi-music-note me-1"></i>${S(t.instrumento)}</span></div>`:``}
        ${t.evaluacion_metodo?`<div class="col-auto"><span class="badge bg-light text-dark border"><i class="bi bi-clipboard-check me-1"></i>${S(t.evaluacion_metodo)}</span></div>`:``}
      </div>
    `})}async function zn(e){try{await u([e]),y.success(`Plan aprobado y marcado como revisado`),F(P.container,{viewMode:P.viewMode})}catch(e){y.error(e.message)}}async function Bn(e){let t=P.planesOriginales.find(t=>t.id===e);if(!t)return;let n=t.instrumento,r=null,i=t.clase_id;if(i){let{data:e}=await v.from(`clases`).select(`instrumento, plan_estudio`).eq(`id`,i).single();e&&(n||=e.instrumento,r=e.plan_estudio)}let{data:{user:a}}=await v.auth.getUser(),{data:o}=await v.from(`maestros`).select(`id`).eq(`user_id`,a.id).single(),s=o?.id;yn({plan:t,claseId:i,instrumento:n,nivel:r,maestroId:s,onConfirm:async()=>{try{await me(e,{estado:`ejecutado`}),y.success(`Plan marcado como ejecutado`),F(P.container,{viewMode:P.viewMode})}catch(e){y.error(e.message)}},onSkip:async()=>{try{await me(e,{estado:`ejecutado`}),y.success(`Plan ejecutado (sin cobertura)`),F(P.container,{viewMode:P.viewMode})}catch(e){y.error(e.message)}}})}async function Vn(e){let t=P.planesOriginales.find(t=>t.id===e);t&&x.open({title:`⚠️ Eliminar Plan`,saveText:`Eliminar`,body:`<p>¿Estás seguro de eliminar el plan <strong>"${S(t.tema)}"</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await pe(e),y.success(`Plan eliminado`),F(P.container,{viewMode:P.viewMode}),!0}catch(e){return y.error(e.message),!1}}})}function Hn(){C.register(`planificacion`,e=>F(e,{viewMode:`maestro`})),C.register(`planificacion-plantillas`,e=>F(e,{viewMode:`plantillas`})),C.register(`planificacion-maestros`,e=>F(e,{viewMode:`admin`}))}var I={attendance_min_rate:.7,attendance_window_weeks:4,grade_min_avg:6,grade_window_count:3,indicator_min_pass_rate:.5,indicator_window_weeks:4};async function Un(){let{data:e,error:t}=await v.from(`alumnos`).select(`*`).order(`nombre_completo`,{ascending:!0});if(t)throw console.error(`Error cargando alumnos:`,t.message),Error(`No se pudieron cargar los alumnos`);return e}async function Wn(){let{data:e,error:t}=await v.from(`clases`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando clases:`,t.message),Error(`No se pudieron cargar las clases`);return e}async function Gn(){let{data:e,error:t}=await v.from(`progresos`).select(`*`).order(`fecha_evaluacion`,{ascending:!1});if(t)throw console.error(`Error cargando progresos:`,t.message),Error(`No se pudieron cargar los progresos`);return e}async function Kn(e){if(!e.alumno_id)throw Error(`El alumno es obligatorio`);if(!e.clase_id)throw Error(`La clase es obligatoria`);if(!e.evaluacion_tipo)throw Error(`El tipo de evaluacion es obligatorio`);let t={alumno_id:e.alumno_id,clase_id:e.clase_id,maestro_id:e.maestro_id||null,fecha_evaluacion:e.fecha_evaluacion||null,evaluacion_tipo:e.evaluacion_tipo.trim(),calificacion:e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,estado_cualitativo:(e.estado_cualitativo||`en_progreso`).trim(),observaciones:(e.observaciones||``).trim(),indicadores:e.indicadores||null};if(e.sesion_clase_id&&(t.sesion_clase_id=e.sesion_clase_id),e.asistencia_id&&(t.asistencia_id=e.asistencia_id),e.ejercicio_id&&(t.ejercicio_id=e.ejercicio_id),t.calificacion!==null&&(t.calificacion<0||t.calificacion>5))throw Error(`La calificacion debe estar entre 0 y 5`);let{data:n,error:r}=await v.from(`progresos`).insert([t]).select();if(r)throw r.message.includes(`duplicate key`)||r.code===`23505`?Error(`Ya existe una evaluacion con ese tipo para este alumno en esta clase`):(console.error(`Error creando progreso:`,r.message),Error(`No se pudo crear el progreso`));return n[0]}async function qn(e){let{data:t,error:n}=await v.from(`progresos`).select(`*`).eq(`clase_id`,e).order(`fecha_evaluacion`,{ascending:!1});if(n)throw console.error(`Error cargando progresos de la clase:`,n.message),Error(`No se pudieron cargar los progresos de la clase`);return t}async function Jn(e){let{data:t,error:n}=await v.from(`progresos`).select(`calificacion`).eq(`alumno_id`,e).not(`calificacion`,`is`,null);if(n)throw console.error(`Error calculando promedio:`,n.message),Error(`No se pudo calcular el promedio`);if(!t||t.length===0)return null;let r=t.reduce((e,t)=>e+parseFloat(t.calificacion),0);return parseFloat((r/t.length).toFixed(2))}async function Yn(e,t){let{jsPDF:n}=await b(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-DjkFa24L.js`);return{jsPDF:e}},__vite__mapDeps([3,4,5,6])),{default:r}=await b(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-BzE1EGzy.js`);return{default:e}},[]),i=new n,a=e.name||e.nombre||`Sin nombre`,o=e.section||`Sin sección`,s=Xn(t),c=s!==null&&Zn(s);i.setFontSize(18),i.text(`Boletín Académico`,14,22),i.setFontSize(11),i.text(`Alumno: ${a}`,14,32),i.text(`Sección: ${o}`,14,38),i.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,44);let l=c?`EN RIESGO`:`SATISFACTORIO`,u=c?[185,27,27]:[39,174,96];i.setFillColor(...u),i.rect(14,50,60,10,`F`),i.setTextColor(255,255,255),i.setFontSize(10),i.text(l,18,57),i.setTextColor(0,0,0),i.setFontSize(12),i.text(`Promedio: ${s===null?`N/A`:s.toFixed(2)}`,80,55),i.text(`Evaluaciones: ${t.length}`,80,62),t.length>0&&r(i,{head:[[`Fecha`,`Tipo`,`Calificación`,`Etiqueta`,`Observaciones`]],body:t.map(e=>[e.fecha_evaluacion?Qn(e.fecha_evaluacion):`-`,$n(e.tipo_evaluacion),e.calificacion===null?`-`:e.calificacion.toFixed(2),er(e.calificacion),e.observaciones?e.observaciones.substring(0,40)+(e.observaciones.length>40?`...`:``):`-`]),startY:70,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),i.save(`boletin-${a.replace(/\s+/g,`-`).toLowerCase()}.pdf`)}function Xn(e){if(!e||e.length===0)return null;let t=e.filter(e=>e.calificacion!==null&&e.calificacion!==void 0).map(e=>parseFloat(e.calificacion));return t.length===0?null:t.reduce((e,t)=>e+t,0)/t.length}function Zn(e){return e==null?!1:parseFloat(e)<3}function Qn(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):`-`}function $n(e){return{oral:`Oral`,escrita:`Escrita`,practica:`Práctica`,evaluacion_parcial:`Parcial`,evaluacion_final:`Final`}[e]||e||`-`}function er(e){if(e==null)return`-`;let t=parseFloat(e);return t>=4.5?`Sobresaliente`:t>=4?`Muy Bueno`:t>=3?`Bueno`:t>=2?`En Progreso`:`Necesita Mejorar`}var tr=class e{constructor(e={}){this.id=e.id||null,this.alumno_id=e.alumno_id||``,this.clase_id=e.clase_id||``,this.maestro_id=e.maestro_id||null,this.fecha_evaluacion=e.fecha_evaluacion||``,this.tipo_evaluacion=e.tipo_evaluacion||e.evaluacion_tipo||``,this.calificacion=e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,this.observaciones=e.observaciones||``,this.estado=e.estado||`en_progreso`,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(){let t=[];this.alumno_id||t.push(`El alumno es obligatorio`),this.clase_id||t.push(`La clase es obligatoria`),!this.tipo_evaluacion||!this.tipo_evaluacion.trim()?t.push(`El tipo de evaluación es obligatorio`):e.getTiposEvaluacion().map(e=>e.value).includes(this.tipo_evaluacion)||t.push(`Tipo de evaluación no válido`),this.calificacion!==null&&this.calificacion!==void 0&&(isNaN(this.calificacion)||this.calificacion<0||this.calificacion>5)&&t.push(`La calificación debe estar entre 0.0 y 5.0`),this.observaciones&&this.observaciones.length>500&&t.push(`Las observaciones no pueden exceder 500 caracteres`);let n=e.getEstados().map(e=>e.value);return this.estado&&!n.includes(this.estado)&&t.push(`Estado no válido`),t}static getTiposEvaluacion(){return[{value:`parcial`,label:`Parcial`},{value:`final`,label:`Final`},{value:`continua`,label:`Continua`},{value:`oral`,label:`Oral`},{value:`escrita`,label:`Escrita`},{value:`practica`,label:`Práctica`}]}static getEstados(){return[{value:`en_progreso`,label:`En Progreso`,color:`bg-primary`},{value:`completado`,label:`Completado`,color:`bg-success`},{value:`pendiente`,label:`Pendiente`,color:`bg-secondary`}]}static getEstadoConfig(e){return this.getEstados().find(t=>t.value===e)||{value:e,label:e,color:`bg-secondary`}}toJSON(){return{alumno_id:this.alumno_id,clase_id:this.clase_id,maestro_id:this.maestro_id,fecha_evaluacion:this.fecha_evaluacion||null,tipo_evaluacion:this.tipo_evaluacion.trim(),calificacion:this.calificacion,observaciones:this.observaciones?this.observaciones.trim():null,estado:this.estado}}};function nr(e){if(!e||e.length===0)return{promedio:null,total:0,enRiesgo:!1};let t=e.map(e=>e.calificacion).filter(e=>e!=null&&!isNaN(e));if(t.length===0)return{promedio:null,total:e.length,enRiesgo:!1};let n=t.reduce((e,t)=>e+t,0),r=parseFloat((n/t.length).toFixed(2));return{promedio:r,total:e.length,enRiesgo:r<3}}async function rr(e){let t=await qn(e),n={};return t.forEach(e=>{n[e.alumno_id]||(n[e.alumno_id]=[]),n[e.alumno_id].push(e)}),Object.entries(n).map(([e,t])=>({alumnoId:e,progresos:t,rendimiento:nr(t)}))}var ir={calcularRendimiento:nr,getResumenProgresosClase:rr},L={progresos:[],progresosOriginales:[],alumnos:[],clases:[],cargando:!1,filtroClase:`todas`,container:null};async function ar(e){if(e)try{L.container=e,L.cargando=!0,or(e);let[t,n,r]=await Promise.all([Gn(),Un(),Wn()]);L.progresos=(t||[]).map(e=>new tr(e)),L.progresosOriginales=[...L.progresos],L.alumnos=n||[],L.clases=r||[],L.cargando=!1,cr(e),ur(e)}catch(t){console.error(t),sr(e,t.message)}}function or(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function sr(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
    ...
    </div>`}function cr(e){let t=L.progresosOriginales.length,n=L.progresosOriginales.filter(e=>e.calificacion!=null).map(e=>parseFloat(e.calificacion)),r=n.length>0?(n.reduce((e,t)=>e+t,0)/n.length).toFixed(2):null,i={};L.progresosOriginales.forEach(e=>{i[e.alumno_id]||(i[e.alumno_id]=[]),e.calificacion!=null&&i[e.alumno_id].push(parseFloat(e.calificacion))});let a=0;Object.values(i).forEach(e=>{e.length!==0&&e.reduce((e,t)=>e+t,0)/e.length<3&&a++});let o=Object.keys(i).length,s=new Set(L.progresosOriginales.map(e=>e.clase_id)).size;e.innerHTML=`
    <div class="page-container">
      ...
      <div class="progresos-filter-toolbar mb-4">
        ...
        <div class="premium-select-container select-clase-container">
          ...
          <select class="form-select premium-filter-select" id="select-clase">
            ...
            ${L.clases.map(e=>`<option value="${e.id}" ${e.id===L.filtroClase?`selected`:``}>${S(e.nombre)}</option>`).join(``)}
          </select>
        </div>
      </div>
  ...
  `}function lr(){let e=L.container.querySelector(`#buscar-progreso`)?.value.trim().toLowerCase()||``,t=L.filtroClase,n={};L.progresosOriginales.forEach(r=>{let i=L.alumnos.find(e=>e.id===r.alumno_id),a=L.clases.find(e=>e.id===r.clase_id);t!==`todas`&&r.clase_id!==t||e&&!i?.nombre_completo.toLowerCase().includes(e)&&!a?.nombre.toLowerCase().includes(e)||(n[r.alumno_id]||(n[r.alumno_id]={alumno:i,lista:[]}),n[r.alumno_id].lista.push(r))});let r=Object.values(n);return r.length===0?`<tr><td colspan="5" class="text-center py-5 text-muted">No hay resultados.</td></tr>`:r.map(({alumno:e,lista:t})=>{let n=ir.calcularRendimiento(t);return`
      <tr class="border-start-accent ${n.enRiesgo?`border-accent-danger`:`border-accent-success`}">
        <td>
          <div class="fw-bold">${S(e?.nombre_completo||`Desconocido`)}</div>
          <div class="small text-muted">${t.length>0?S(L.clases.find(e=>e.id===t[0].clase_id)?.nombre):``}</div>
        </td>
    ...
    `}).join(``)}function ur(e){e.querySelector(`#select-clase`)?.addEventListener(`change`,t=>{L.filtroClase=t.target.value,e.querySelector(`#progresos-tbody`).innerHTML=lr()}),e.querySelector(`#buscar-progreso`)?.addEventListener(`input`,()=>{e.querySelector(`#progresos-tbody`).innerHTML=lr()}),e.querySelector(`#progresos-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,alumnoId:r}=t.dataset;n===`pdf`&&dr(r),n===`view-detail`&&fr(r)}),e.querySelector(`#btn-nueva-nota`)?.addEventListener(`click`,()=>pr())}async function dr(e){let t=L.alumnos.find(t=>t.id===e),n=L.progresosOriginales.filter(t=>t.alumno_id===e);y.info(`Generando boletín institucional...`);try{await Yn(t,n),y.success(`Boletín generado exitosamente`)}catch(e){y.error(`Error al generar PDF: `+e.message)}}function fr(e){let t=L.alumnos.find(t=>t.id===e),n=L.progresosOriginales.filter(t=>t.alumno_id===e),r=ir.calcularRendimiento(n);x.open({title:`Detalle Académico: ${t.nombre_completo}`,size:`lg`,hideSave:!0,body:`
      <div class="row g-3 mb-4">
        <div class="col-md-4">
          ...
          <tbody>
            ${n.map(e=>`
              <tr>
                ...
                <td class="small text-muted">${S(e.observaciones||`-`)}</td>
              </tr>
            `).join(``)}
          </tbody>
        </table>
      </div>
    `})}function pr(){x.open({title:`Registrar Nueva Calificación`,saveText:`Guardar Nota`,body:`
      <form id="form-nota" class="row g-3">
        <div class="col-md-12">
          ...
          <select class="form-select input-dense" id="nota-alumno_id" required>
            ...
            ${L.alumnos.map(e=>`<option value="${e.id}">${e.nombre_completo}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-6">
          <label class="form-label-compact">Clase *</label>
          <select class="form-select input-dense" id="nota-clase_id" required>
            <option value="">Seleccionar...</option>
            ${L.clases.map(e=>`<option value="${e.id}">${e.nombre}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-6">
          <label class="form-label-compact">Tipo de Evaluación *</label>
          <select class="form-select input-dense" id="nota-tipo" required>
            ${tr.getTiposEvaluacion().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-4">
    ...
    `,onSave:async e=>{let t={alumno_id:e.querySelector(`#nota-alumno_id`).value,clase_id:e.querySelector(`#nota-clase_id`).value,tipo_evaluacion:e.querySelector(`#nota-tipo`).value,calificacion:parseFloat(e.querySelector(`#nota-valor`).value),fecha_evaluacion:e.querySelector(`#nota-fecha`).value,observaciones:e.querySelector(`#nota-obs`).value.trim()},n=new tr(t).validate();if(n.length>0)return y.error(n[0]),!1;try{return await Kn(t),y.success(`Nota registrada exitosamente`),ar(L.container),!0}catch(e){return y.error(e.message),!1}}})}function mr(){C.register(`progresos`,ar)}function hr(e){return e?Array.isArray(e)?e.map(e=>new f(e)):new f(e):null}async function gr(){let{data:e,error:t}=await v.from(`observaciones_alumnos`).select(`
      *,
      alumno:alumnos(nombre_completo),
      maestro:maestros(nombre_completo)
    `).order(`fecha_observacion`,{ascending:!1});if(t)throw console.error(`Error cargando observaciones:`,t.message),Error(`No se pudieron cargar las observaciones`);return e.map(e=>{let t=new f(e);return t.alumno_nombre=e.alumno?.nombre_completo||`Desconocido`,t.maestro_nombre=e.maestro?.nombre_completo||`N/A`,t})}async function _r(e){let t=new f(e),n=t.validate();if(n.length>0)throw Error(n[0]);let{data:r,error:i}=await v.from(`observaciones_alumnos`).insert([t.toJSON()]).select();if(i)throw i;return hr(r[0])}async function vr(e,t){let{data:n}=await v.from(`observaciones_alumnos`).select(`*`).eq(`id`,e).single(),r=new f({...n,...t}),i=r.validate();if(i.length>0)throw Error(i[0]);let{data:a,error:o}=await v.from(`observaciones_alumnos`).update(r.toJSON()).eq(`id`,e).select();if(o)throw o;return hr(a[0])}async function yr(e){let{error:t}=await v.from(`observaciones_alumnos`).delete().eq(`id`,e);if(t)throw t}async function br(e,t){let{data:n,error:r}=await v.from(`observaciones_alumnos`).update({seguimiento_observacion:t.trim(),seguimiento_fecha:new Date().toISOString().split(`T`)[0],estado:`seguimiento`,requiere_seguimiento:!0}).eq(`id`,e).select();if(r)throw r;return hr(n[0])}async function xr(){let{data:e,error:t}=await v.from(`observaciones_alumnos`).select(`estado, prioridad, tipo`);if(t)throw t;return{total:e.length,abiertas:e.filter(e=>e.estado===`abierta`).length,seguimiento:e.filter(e=>e.estado===`seguimiento`).length,altas:e.filter(e=>e.prioridad===`alta`).length,porTipo:e.reduce((e,t)=>(e[t.tipo]=(e[t.tipo]||0)+1,e),{})}}function R(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}var z={observaciones:[],observacionesOriginales:[],alumnos:[],estadisticas:null,cargando:!1,filtroTipo:``,filtroEstado:`todos`,container:null};async function B(e){if(e)try{z.container=e,z.cargando=!0,Sr(e);let[t,n,r]=await Promise.all([gr(),c().catch(()=>[]),xr().catch(()=>null)]);z.observaciones=t,z.observacionesOriginales=[...t],z.alumnos=n,z.estadisticas=r,z.cargando=!1,wr(e),Dr(e)}catch(t){console.error(t),Cr(e,t.message)}}function Sr(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function Cr(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
          <h5 class="alert-heading mb-1">Tabla no encontrada o sin acceso</h5>
          <p class="mb-2 small">${R(t)}</p>
    ...
    </div>`,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>B(e))}function wr(e){e.innerHTML=`
    <div class="page-container">
      <div class="observaciones-header-premium mb-4">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p class="text-muted small mb-0">${z.observaciones.length} observaciones en total</p>
          </div>
        </div>
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${z.observaciones.length===0?Er():``}</div>
      </div>
    </div>
  `}function Tr(e){return e.map(e=>{let t=f.getTipos().find(t=>t.value===e.tipo),n=f.getPrioridades().find(t=>t.value===e.prioridad),r=f.getEstados().find(t=>t.value===e.estado),i=e.prioridad===`alta`?`border-accent-danger`:e.prioridad===`media`?`border-accent-warning`:`border-accent-secondary`;return`
      <tr data-id="${e.id}" class="border-start-accent ${i}">
        <td>
          <div class="fw-bold text-truncate" style="max-width: 250px;">${R(e.titulo)}</div>
          <div class="small text-muted">${R(e.alumno_nombre)}</div>
        </td>
        <td class="d-none d-md-table-cell align-middle">
    ...
    `}).join(``)}function Er(){return`<div class="text-center py-5 text-muted"><i class="bi bi-chat-left-dots fs-1 d-block mb-2"></i>No se encontraron observaciones.</div>`}function Dr(e){e.querySelector(`#buscar-obs`)?.addEventListener(`input`,Or),e.querySelector(`#select-tipo`)?.addEventListener(`change`,Or),e.querySelector(`#obs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&kr(r),n===`delete`&&jr(r),n===`follow`&&Ar(r)}),e.querySelector(`#btn-nueva-obs`)?.addEventListener(`click`,()=>kr(null))}function Or(){let e=z.container.querySelector(`#buscar-obs`).value.toLowerCase(),t=z.container.querySelector(`#select-tipo`).value;z.observaciones=z.observacionesOriginales.filter(n=>{let r=n.titulo.toLowerCase().includes(e)||n.alumno_nombre.toLowerCase().includes(e),i=!t||n.tipo===t;return r&&i}),z.container.querySelector(`#obs-tbody`).innerHTML=Tr(z.observaciones)}async function kr(e){let t=e?z.observacionesOriginales.find(t=>t.id===e):new f;x.open({title:e?`Editar Observación`:`Nueva Observación`,saveText:`Guardar`,body:`
      <form id="form-obs" class="row g-3">
        <div class="col-12">
          <label class="form-label-compact">Alumno *</label>
          <select class="form-select input-dense" id="obs-alumno_id" required>
            <option value="">Seleccionar alumno...</option>
            ${z.alumnos.map(e=>`<option value="${e.id}" ${e.id===t.alumno_id?`selected`:``}>${R(e.nombre_completo)}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-8">
          <label class="form-label-compact">Título de la Incidencia *</label>
          <input type="text" class="form-control input-dense" id="obs-titulo" value="${R(t.titulo)}" required>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control input-dense" id="obs-descripcion" rows="4" required>${R(t.descripcion)}</textarea>
        </div>
      </form>
    `,onSave:async t=>{let n={alumno_id:t.querySelector(`#obs-alumno_id`).value,titulo:t.querySelector(`#obs-titulo`).value.trim(),prioridad:t.querySelector(`#obs-prioridad`).value,tipo:t.querySelector(`#obs-tipo`).value,fecha_observacion:t.querySelector(`#obs-fecha`).value,descripcion:t.querySelector(`#obs-descripcion`).value.trim()},r=new f(n).validate();if(r.length>0)return y.error(r[0]),!1;try{return e?(await vr(e,n),y.success(`Observación actualizada`)):(await _r(n),y.success(`Observación registrada`)),B(z.container),!0}catch(e){return y.error(e.message),!1}}})}function Ar(e){let t=z.observacionesOriginales.find(t=>t.id===e);x.open({title:`Añadir Seguimiento`,saveText:`Guardar Seguimiento`,body:`
      <p class="small text-muted mb-3">Estás añadiendo una nota de seguimiento a: <strong>${R(t.titulo)}</strong></p>
      <div class="mb-3">
          ...
          <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4">
              <div class="form-check form-switch mt-4">
                <input class="form-check-input" type="checkbox" id="programacionActiva" ${V.programada?`checked`:``}>
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <select class="form-select" id="generarAhoraSelect">
                  <option value="">-- Seleccionar --</option>
                  ${V.reportes.map(e=>`<option value="${e.id}">${e.nombre}</option>`).join(``)}
                </select>
              </div>
              <div class="mb-3">
                <label class="form-label">Período</label>
                <div class="d-flex gap-2">
                  <input type="date" class="form-control form-control-sm" id="genDesde" value="${Gr()}">
                  <input type="date" class="form-control form-control-sm" id="genHasta" value="${Wr()}">
                </div>
              </div>
              <div class="mb-3">
  ...
  `}function Ir(e){let t={diaria:`danger`,semanal:`warning`,mensual:`info`}[e.frecuencia]||`secondary`;return`
  ...
  `}function Lr(e){e.querySelector(`#btnNuevoReporte`)?.addEventListener(`click`,()=>Rr(e)),e.querySelectorAll(`[data-action]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.dataset.id;t.dataset.action===`generar`?zr(n):t.dataset.action===`editar`&&Hr(n,e)})}),e.querySelector(`#btnGenerarAhora`)?.addEventListener(`click`,()=>Ur(e)),e.querySelector(`#btnEnviarEmail`)?.addEventListener(`click`,()=>_enviarEmail(e)),e.querySelector(`#programacionActiva`)?.addEventListener(`change`,e=>{V.programada=e.target.checked,x.open({title:V.programada?`Programación Activada`:`Programación Desactivada`,body:`<div class="alert alert-${V.programada?`success`:`warning`} mb-0">La generación de reportes está ahora ${V.programada?`activa`:`inactiva`}.</div>`,hideSave:!0,cancelText:`Cerrar`})})}function Rr(e){x.open({title:`Nueva Plantilla de Reporte`,size:`md`,saveText:`Crear`,body:`
      <div class="mb-3">
    ...
    `,onSave:()=>{let t=document.getElementById(`newReporteNombre`).value.trim();if(!t)return alert(`El nombre es obligatorio`),!1;V.reportes.unshift({id:`rpt_`+Date.now(),nombre:t,descripcion:document.getElementById(`newReporteDesc`).value,tipo:document.getElementById(`newReporteTipo`).value,frecuencia:document.getElementById(`newReporteFreq`).value,icon:`bi-file-earmark-text`}),Fr(e),x.close()}})}async function zr(e){let t=V.reportes.find(t=>t.id===e);if(t){x.showLoading(`Analizando datos para: ${t.nombre}...`);try{let[e,n,r]=await Promise.all([c(),Wn(),Gn()]),i=``,a=[];if(t.tipo===`riesgo`){let t=(await Promise.all(e.map(async e=>{let t=await Jn(e.id);return{...e,promedio:t}}))).filter(e=>e.promedio!==null&&e.promedio<3);a=t.map(e=>({nombre:e.nombre,valor:e.promedio,unidad:`Promedio`})),i=`
...
`)}
      ...
      `}else if(t.tipo===`asistencia`){let{data:t,error:n}=await v.from(`sesiones_clase`).select(`asistencia`).eq(`borrador`,!1);if(n)throw n;let r={};t.forEach(e=>{(e.asistencia||[]).forEach(e=>{r[e.alumno_id]||(r[e.alumno_id]={total:0,presentes:0}),r[e.alumno_id].total++,e.estado===`presente`&&r[e.alumno_id].presentes++})});let o=e.map(e=>{let t=r[e.id]||{total:0,presentes:0},n=t.total>0?Math.round(t.presentes/t.total*100):100;return{...e,asistenciaPct:n}}).filter(e=>e.asistenciaPct<80);a=o.map(e=>({nombre:e.nombre,valor:e.asistenciaPct+`%`,unidad:`Asistencia`})),i=`
...
`)}
      ...
      `}else if(t.tipo===`global`){let[t,o]=await Promise.all([v.from(`sesiones_clase`).select(`asistencia`).eq(`borrador`,!1),v.from(`maestros`).select(`nombre_completo, especialidad`)]),s=t.data?.length||0,c=r.length>0?(r.reduce((e,t)=>e+(t.calificacion||0),0)/r.length).toFixed(2):`N/A`;i=`
      ...
      `,a=[{nombre:`Promedio Institucional`,valor:c,unidad:`Puntos`},{nombre:`Cobertura de Clases`,valor:s,unidad:`Sesiones`},{nombre:`Población Estudiantil`,valor:e.length,unidad:`Alumnos`}]}else i=`Genera un resumen ejecutivo para un reporte de tipo ${t.tipo} basado en ${e.length} alumnos y ${n.length} clases activas.`;let o=await je([{role:`system`,content:`Eres un experto en gestión educativa y análisis de datos académicos.`},{role:`user`,content:`Actúa como un Coordinador Académico Senior. Basado en los siguientes datos reales del sistema SOI:\n${i}\n\nGenera el reporte en formato Markdown, con secciones claras: # Resumen Ejecutivo, ## Hallazgos Clave, y ## Recomendaciones.`}]);x.close(),x.open({title:`<i class="bi bi-stars text-primary me-2"></i>Análisis de IA: ${t.nombre}`,size:`lg`,saveText:`<i class="bi bi-file-earmark-pdf me-2"></i>Exportar PDF`,body:`
      ...
      `,onSave:async()=>(Vr(t.nombre,o,a),!1)})}catch(e){console.error(e),x.close(),y.error(`Error al generar el análisis: `+e.message)}}}function Br(e){return e.replace(/^### (.*$)/gim,`<h5 class="fw-bold mt-4 mb-2">$1</h5>`).replace(/^## (.*$)/gim,`<h4 class="fw-bold mt-4 mb-2 border-bottom pb-1">$1</h4>`).replace(/^# (.*$)/gim,`<h3 class="fw-bold mb-3 text-primary">$1</h3>`).replace(/^\* (.*$)/gim,`<li class="ms-3 mb-1">$1</li>`).replace(/\*\*(.*)\*\*/gim,`<strong>$1</strong>`).replace(/\n/g,`<br>`)}async function Vr(e,t,n){let{jsPDF:r}=await b(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-DjkFa24L.js`);return{jsPDF:e}},__vite__mapDeps([3,4,5,6])),{default:i}=await b(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-BzE1EGzy.js`);return{default:e}},[]);y.info(`Generando documento PDF...`);let a=new r,o=a.internal.pageSize.width;a.setFillColor(41,128,185),a.rect(0,0,o,40,`F`),a.setTextColor(255,255,255),a.setFontSize(22),a.text(`SOI - Sistema Operativo Institucional`,14,20),a.setFontSize(12),a.text(e.toUpperCase(),14,30),a.text(new Date().toLocaleDateString(),o-40,30),a.setTextColor(0,0,0),a.setFontSize(14),a.setFont(void 0,`bold`),a.text(`Análisis Crítico con IA`,14,55),a.setFontSize(10),a.setFont(void 0,`normal`);let s=t.replace(/[#*]/g,``).split(`
`).filter(e=>e.trim()!==``),c=65;s.forEach(e=>{let t=a.splitTextToSize(e.trim(),o-28);c+t.length*5>280&&(a.addPage(),c=20),a.text(t,14,c),c+=t.length*5+2}),n&&n.length>0&&i(a,{startY:c+10,head:[[`Indicador / Estudiante`,`Valor`,`Unidad`]],body:n.map(e=>[e.nombre,e.valor,e.unidad]),theme:`striped`,headStyles:{fillColor:[41,128,185]},styles:{fontSize:9}});let l=a.internal.getNumberOfPages();for(let e=1;e<=l;e++)a.setPage(e),a.setFontSize(8),a.setTextColor(150),a.text(`Página ${e} de ${l} - Generado por SOI Intelligence`,o/2,290,{align:`center`});a.save(`Reporte_SOI_${e.replace(/\s+/g,`_`)}.pdf`),y.success(`PDF descargado con éxito`)}function Hr(e,t){let n=V.reportes.find(t=>t.id===e);n&&x.open({title:`Editar Reporte`,size:`md`,saveText:`Guardar`,body:`
      <div class="mb-3">
        <label class="form-label">Nombre</label>
    ...
    `,onSave:()=>{let n=V.reportes.findIndex(t=>t.id===e);n!==-1&&(V.reportes[n]={...V.reportes[n],nombre:document.getElementById(`editReporteNombre`).value,descripcion:document.getElementById(`editReporteDesc`).value,tipo:document.getElementById(`editReporteTipo`).value,frecuencia:document.getElementById(`editReporteFreq`).value}),Fr(t),x.close()}})}function Ur(e){let t=e.querySelector(`#generarAhoraSelect`).value;e.querySelector(`#genDesde`).value,e.querySelector(`#genHasta`).value;let n=e.querySelector(`input[name="genFormat"]:checked`).value;if(!t){alert(`Selecciona un reporte`);return}x.showLoading(`Generando reporte...`),setTimeout(()=>{x.close();let e=new Blob([`Reporte generado`],{type:`text/plain`}),r=URL.createObjectURL(e),i=document.createElement(`a`);i.href=r,i.download=`reporte-${t}-${new Date().toISOString().slice(0,10)}.${n}`,i.click(),URL.revokeObjectURL(r)},1500)}function Wr(){return new Date().toISOString().slice(0,10)}function Gr(){let e=new Date;return e.setDate(e.getDate()-7),e.toISOString().slice(0,10)}function Kr(){C.register(`metricas`,_),C.register(`metricas-alertas`,_),C.register(`metricas-riesgo`,_),C.register(`metricas-maestros`,_),C.register(`metricas-destacados`,_),C.register(`metricas-ia-reportes`,Pr)}new class{constructor(){this.cache=new Map,this.cacheExpiry=300*1e3}getCached(e){let t=this.cache.get(e);return t&&Date.now()-t.timestamp<this.cacheExpiry?t.data:null}setCached(e,t){this.cache.set(e,{data:t,timestamp:Date.now()})}async getDashboardData(){let e=this.getCached(`dashboard`);if(e)return e;let t={periodoActivo:await he(),alertas:await xe(),alertasActivas:await se()};return this.setCached(`dashboard`,t),t}async getTasaAsistenciaAlumno(e,t=30){let n=new Date;return n.setDate(n.getDate()-t),le(e,n.toISOString().split(`T`)[0])}calcularPorcentaje(e,t){return e<t.rojo?`rojo`:e<t.naranja?`naranja`:e<t.amarillo?`amarillo`:`verde`}generarAlertas(e,t){let n=[];return e<t.umbral_rojo?n.push({nivel:`rojo`,mensaje:`Asistencia crítica`}):e<t.umbral_naranja?n.push({nivel:`naranja`,mensaje:`Asistencia baja`}):e<t.umbral_amarillo&&n.push({nivel:`amarillo`,mensaje:`Precaución`}),n}clearCache(){this.cache.clear()}};var qr=`system_config`;async function Jr(e){let{data:t,error:n}=await v.from(qr).select(`value`).eq(`key`,e).single();return n?(console.warn(`Config not found:`,e),null):t?.value}async function Yr(e,t){let{error:n}=await v.from(qr).upsert({key:e,value:t,updated_at:new Date().toISOString()},{onConflict:`key`});if(n)throw console.error(`Error saving config:`,n),n;return{key:e,value:t}}async function Xr(){return Jr(`groq_api_key`)}async function Zr(e){return Yr(`groq_api_key`,e)}async function Qr(){return Jr(`openrouter_api_key`)}async function $r(e){return Yr(`openrouter_api_key`,e)}async function ei(){return Jr(`preferred_ai_model`)}async function ti(e){return Yr(`preferred_ai_model`,e)}function ni(){C.register(`configuracion`,async e=>{let{renderConfigView:t}=await b(async()=>{let{renderConfigView:e}=await import(`./configView-BaGCstrr.js`);return{renderConfigView:e}},__vite__mapDeps([7,8,4,1,9]));await t(e)}),C.register(`importar-datos`,async e=>{let{renderImportView:t}=await b(async()=>{let{renderImportView:e}=await import(`./importView-CGGhelb3.js`);return{renderImportView:e}},__vite__mapDeps([10,1]));await t(e)})}function ri(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function ii(e){let t=e.progress_percentage||0,n=t<40?`progress-low`:t<80?`progress-mid`:`progress-high`,r=e.health_status||`not_started`,i=e.last_activity_at?new Date(e.last_activity_at).toLocaleDateString():`Sin actividad`;return`
        <tr>
            <td>
                <div class="d-flex align-items-center gap-2">
    ...
    `}function ai(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function oi(e){let t=e.failure_percentage||0;return`
    ...
    `}function ci(){C.register(`gestion-curricular`,e=>{ve(e)}),C.register(`planificacion-curricular`,e=>{ve(e)}),C.register(`torre-de-control`,async e=>{e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{e.innerHTML=await si()}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar el dashboard: ${t.message}</p></div>`}})}async function li(){try{let{data:e,error:t}=await v.from(`maestro_desempeño`).select(`
        id,
        maestro_id,
        ...
        updated_at
        `).order(`updated_at`,{ascending:!1});if(t)throw console.error(`[getMaestrosComplianceStatus] Error:`,t),t;return e||[]}catch(e){throw console.error(`[getMaestrosComplianceStatus] Exception:`,e),e}}async function ui(e){try{let{data:t,error:n}=await v.from(`registros_pendientes`).select(`
        id,
        created_at,
        notification_state,
        notif_count,
        ...
        `).eq(`maestro_id`,e).eq(`estado`,`pendiente`).in(`tipo`,[`asistencia_pendiente`,`contenido_pendiente`]).order(`created_at`,{ascending:!1});if(n)throw console.error(`[getMaestroPendingRegistros] Error:`,n),n;return t||[]}catch(e){throw console.error(`[getMaestroPendingRegistros] Exception:`,e),e}}var di=class{constructor(e){this.containerId=e,this.container=document.getElementById(e),this.maestros=[],this.filteredMaestros=[],this.currentFilter={categoria:null,estado:null,diasAtrasoMin:0,diasAtrasoMax:999}}async init(){try{this.container.innerHTML=`
...
`,Object.entries(t.byTrend).forEach(([t,n])=>{e+=`${t},${n}\n`}),e}return t}catch(e){throw console.error(`[exportComplianceReport] Error:`,e),e}}async function vi(e=30){try{let t=new Date(Date.now()-e*24*60*60*1e3).toISOString().split(`T`)[0],n=(await fi()).filter(e=>e.fecha>=t),r=pi(n),i=mi(n);return{daysBack:e,total_classes:n.length,total_maestros:Object.keys(i).length,date_trends:r,maestro_trends:i,institution_summary:{avg_ai_usage_institution:n.length>0?(n.reduce((e,t)=>e+(t.uso_ai_fill_percent||0),0)/n.length).toFixed(1):0,asistencia_first_percent:n.length>0?(n.filter(e=>e.orden_asistencia_primero===1).length/n.length*100).toFixed(1):0,observaciones_first_percent:n.length>0?(n.filter(e=>e.orden_observaciones_primero===1).length/n.length*100).toFixed(1):0},generatedAt:new Date().toISOString()}}catch(e){throw console.error(`[getInstitutionTrendReportWithFilling] Error:`,e),e}}var yi=class{constructor(e){this.containerId=e,this.container=document.getElementById(e),this.summary=null,this.critical=null}async init(){try{this.container.innerHTML=`
        <div class="premium-loading">
          <div class="premium-loading-spinner"></div>
      ...
      `}}async loadData(){this.summary=await hi(),this.critical=await gi()}render(){let e=`
    ...
    `}function r(e){let t=e.length,n=e.filter(e=>e.orden_asistencia_primero===1).length,r=e.filter(e=>e.orden_observaciones_primero===1).length,i=e.filter(e=>e.orden_simultaneo===1).length,a=e.length>0?(e.reduce((e,t)=>e+(t.uso_ai_fill_percent||0),0)/e.length).toFixed(1):0;return{asistenciaPrimero:t>0?(n/t*100).toFixed(1):0,observacionesPrimero:t>0?(r/t*100).toFixed(1):0,simultaneo:t>0?(i/t*100).toFixed(1):0,avgAiUsage:a,total:t}}return{async init(){t.innerHTML=`
      ...
      `;try{let e=await fi();if(!e||e.length===0){t.innerHTML=`
      ...
      `}}}function xi(e){let t=document.getElementById(e),n=null;function r(e){return`
    ...
    `}return{async init(){t.innerHTML=`
      ...
      `;try{n=await vi(30),this.render()}catch(e){console.error(`[directorTrendReportView] Error:`,e),t.innerHTML=`
          <div class="premium-error-card">
            <i class="bi bi-exclamation-triangle-fill"></i>
      ...
      `}}}function Si(){C.register(`admin-dashboard`,e=>{try{e.innerHTML=`<div id="admin-dashboard-container"></div>`,new di(`admin-dashboard-container`).init()}catch(t){console.error(`[admin-dashboard] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar cumplimiento: ${t.message}</p></div>`}}),C.register(`admin-dashboard-reportes`,e=>{try{e.innerHTML=`<div id="director-reporting-container"></div>`,new yi(`director-reporting-container`).init()}catch(t){console.error(`[admin-dashboard-reportes] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar reportes: ${t.message}</p></div>`}}),C.register(`admin-dashboard-analitca-llenado`,e=>{try{e.innerHTML=`<div id="analytics-filling-container"></div>`,bi(`analytics-filling-container`).init()}catch(t){console.error(`[admin-dashboard-analitca-llenado] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar analítica: ${t.message}</p></div>`}}),C.register(`admin-dashboard-tendencias`,e=>{try{e.innerHTML=`<div id="trend-report-container"></div>`,xi(`trend-report-container`).init()}catch(t){console.error(`[admin-dashboard-tendencias] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar tendencias: ${t.message}</p></div>`}})}var Ci=[{id:`perm-001`,maestro_id:`maestro_001`,maestro_nombre:`Carlos Méndez`,maestro_email:`carlos.mendez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`planificacion:write`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-15T10:00:00Z`,actualizado_en:`2026-05-01T14:30:00Z`},{id:`perm-002`,maestro_id:`maestro_002`,maestro_nombre:`María López`,maestro_email:`maria.lopez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!1,permisos:[`alumnos:create`,`planificacion:write`],solicitudes:[`clases:enroll`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-02-20T09:00:00Z`,actualizado_en:`2026-04-10T11:00:00Z`},{id:`perm-003`,maestro_id:`maestro_003`,maestro_nombre:`Ana Martínez`,maestro_email:`ana.martinez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[`alumnos:create`],concedido_por:null,concedido_por_nombre:null,creado_en:`2026-03-01T08:00:00Z`,actualizado_en:`2026-03-01T08:00:00Z`},{id:`perm-004`,maestro_id:`maestro_004`,maestro_nombre:`Pedro Ramírez`,maestro_email:`pedro.ramirez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-20T15:00:00Z`,actualizado_en:`2026-05-05T09:00:00Z`},{id:`perm-005`,maestro_id:`maestro_005`,maestro_nombre:`Laura Fernández`,maestro_email:`laura.fernandez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!0,permisos:[`clases:enroll`],solicitudes:[`alumnos:create`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-04-01T12:00:00Z`,actualizado_en:`2026-04-15T16:00:00Z`}],wi=e({actualizarPermiso:()=>ki,obtenerPermisoPorMaestro:()=>Oi,obtenerPermisos:()=>Di}),Ti=(e=300)=>new Promise(t=>setTimeout(t,e)),H=[...Ci];function Ei(e){return e?{id:e.id,maestro_id:e.maestro_id??``,maestro_nombre:e.maestro_nombre??``,maestro_email:e.maestro_email??``,puede_registrar_alumnos:e.puede_registrar_alumnos??!1,puede_inscribir_clases:e.puede_inscribir_clases??!1,permisos:Array.isArray(e.permisos)?e.permisos:[],solicitudes:Array.isArray(e.solicitudes)?e.solicitudes:[],concedido_por:e.concedido_por??null,concedido_por_nombre:e.concedido_por_nombre??null,creado_en:e.creado_en||null,actualizado_en:e.actualizado_en||null}:null}async function Di(){return await Ti(),H.map(Ei)}async function Oi(e){await Ti();let t=H.find(t=>t.maestro_id===e);return t?Ei(t):{id:null,maestro_id:e,maestro_nombre:``,maestro_email:``,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[],concedido_por:null,concedido_por_nombre:null,creado_en:null,actualizado_en:null}}async function ki(e,t){await Ti();let n=H.findIndex(t=>t.maestro_id===e),r=new Date().toISOString();if(n===-1){let n={id:Math.random().toString(36).substr(2,9),maestro_id:e,maestro_nombre:t.maestro_nombre||``,maestro_email:t.maestro_email||``,puede_registrar_alumnos:t.puede_registrar_alumnos??!1,puede_inscribir_clases:t.puede_inscribir_clases??!1,permisos:Array.isArray(t.permisos)?t.permisos:[],solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:[],concedido_por:t.concedido_por||null,concedido_por_nombre:t.concedido_por_nombre||null,creado_en:r,actualizado_en:r};return H.push(n),Ei(n)}return H[n]={...H[n],puede_registrar_alumnos:t.puede_registrar_alumnos??H[n].puede_registrar_alumnos,puede_inscribir_clases:t.puede_inscribir_clases??H[n].puede_inscribir_clases,permisos:Array.isArray(t.permisos)?t.permisos:H[n].permisos,solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:H[n].solicitudes,concedido_por:t.concedido_por??H[n].concedido_por,concedido_por_nombre:t.concedido_por_nombre??H[n].concedido_por_nombre,actualizado_en:r},Ei(H[n])}var Ai=()=>h.isDemoMode?wi:Me,ji=(...e)=>Ai().obtenerPermisos(...e),Mi=(...e)=>Ai().actualizarPermiso(...e),U={permisos:[],cargando:!1,togglingId:null,togglingField:null};function W(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}async function Ni(e){try{U.cargando=!0,Pi(e),U.permisos=await ji(),U.cargando=!1,Ii(e),Bi(e)}catch(t){console.error(t),Fi(e,t.message)}}function Pi(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
  ...
  `,document.getElementById(`retryBtn`)?.addEventListener(`click`,()=>Ni(e))}function Ii(e){let t=D.getUser?D.getUser():null;t?.nombre_completo||t?.email,e.innerHTML=`
    <div class="page-container">
      <!-- Page Header -->
      <div class="page-header">
        <div class="d-flex align-items-center gap-2">
          <span class="page-title"><i class="bi bi-shield-lock me-2 text-primary"></i>Permisos de Maestros</span>
          <span class="badge bg-secondary">${U.permisos.length}</span>
        </div>
      </div>
  ...
  `}function Li(){return U.permisos.map(e=>{let t=U.togglingId===e.maestro_id,n=e.concedido_por_nombre||e.concedido_por||`-`,r=e.actualizado_en?new Date(e.actualizado_en).toLocaleDateString(`es-ES`,{day:`numeric`,month:`short`}):`-`,i=e.solicitudes||[],a=!e.puede_registrar_alumnos&&i.includes(`alumnos:create`),o=!e.puede_inscribir_clases&&i.includes(`clases:enroll`);return`
      <tr data-maestro-id="${W(e.maestro_id)}">
        <td>
          <div class="d-flex align-items-center gap-2">
            <div class="avatar-compact bg-primary text-white">${zi(e.maestro_nombre||e.maestro_id)}</div>
            <span class="text-truncate" style="max-width: 150px;" title="${W(e.maestro_nombre)}">${W(e.maestro_nombre||`Sin nombre`)}</span>
          </div>
        </td>
        <td class="text-truncate" style="max-width: 150px;" title="${W(e.maestro_email)}">${W(e.maestro_email||`-`)}</td>
        <td>
          <div class="form-check form-switch mb-0 d-flex align-items-center gap-2">
            <input class="form-check-input permiso-toggle" type="checkbox"
              data-maestro-id="${W(e.maestro_id)}"
        ...
        <td class="small text-muted">${W(n)}</td>
        <td class="small text-muted">${r}</td>
      </tr>
    `}).join(``)}function Ri(){return`
  ...
  `}function zi(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function Bi(e){let t=e.querySelector(`#permisosTable`);t&&(t.addEventListener(`change`,async t=>{let n=t.target.closest(`.permiso-toggle`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.field,a=n.checked;n.disabled=!0,U.togglingId=r,U.togglingField=i;let o=n.closest(`.form-check`)?.querySelector(`span`);o&&(o.textContent=a?`Sí`:`No`,o.className=`small ${a?`text-success`:`text-muted`}`);try{let t=U.permisos.find(e=>e.maestro_id===r),n={[i]:a};if(t){if(a){let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=t.permisos||[];r.includes(e)||r.push(e);let a=(t.solicitudes||[]).filter(t=>t!==e),o=D.getUser?D.getUser():null,s=o?.nombre_completo||o?.email||`Administrador`;n={...n,permisos:r,solicitudes:a,concedido_por:o?.id||`admin`,concedido_por_nombre:s},t.permisos=r,t.solicitudes=a,t.concedido_por=o?.id||`admin`,t.concedido_por_nombre=s}else{let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=(t.permisos||[]).filter(t=>t!==e);n={...n,permisos:r},t.permisos=r}t.actualizado_en=new Date().toISOString()}await Mi(r,n),t&&(t[i]=a),y.success(`Permiso actualizado: ${i===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let o=e.querySelector(`#permisosTBody`);o&&(o.innerHTML=Li())}catch(e){n.checked=!a,o&&(o.textContent=a?`No`:`Sí`,o.className=`small ${a?`text-muted`:`text-success`}`),y.error(`Error al actualizar permiso: `+e.message)}finally{n.disabled=!1,U.togglingId=null,U.togglingField=null}}),t.addEventListener(`click`,async t=>{let n=t.target.closest(`.aprobar-btn`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.permiso,a=n.dataset.field;n.disabled=!0;let o=n.innerHTML;n.innerHTML=`<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>`;try{let t=U.permisos.find(e=>e.maestro_id===r);if(!t)throw Error(`No se encontró el registro de permisos del maestro`);let n=t.permisos||[];n.includes(i)||n.push(i);let o=(t.solicitudes||[]).filter(e=>e!==i),s=D.getUser?D.getUser():null,c=s?.nombre_completo||s?.email||`Administrador`;await Mi(r,{permisos:n,solicitudes:o,concedido_por:s?.id||`admin`,concedido_por_nombre:c,[a]:!0}),t.permisos=n,t.solicitudes=o,t.concedido_por=s?.id||`admin`,t.concedido_por_nombre=c,t[a]=!0,t.actualizado_en=new Date().toISOString(),y.success(`Solicitud aprobada: ${a===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let l=e.querySelector(`#permisosTBody`);l&&(l.innerHTML=Li())}catch(e){y.error(`Error al aprobar solicitud: `+e.message),n.disabled=!1,n.innerHTML=o}}))}function Vi(){C.register(`permisos`,Ni)}async function Hi(e){if(e){e.innerHTML=Gi();try{let[t,n]=await Promise.all([Ui(),Wi()]);e.innerHTML=Ki(t,n),Yi(e)}catch(t){console.error(`[DashboardPedagogico]`,t),e.innerHTML=`
      <div class="page-container">
        <div class="alert alert-warning">Error al cargar el dashboard: ${t.message}</div>
      </div>`}}}async function Ui(){let[e,t,n,r]=await Promise.all([v.from(`alumnos`).select(`id`,{count:`exact`}).eq(`activo`,!0),v.from(`planificaciones`).select(`id, estado`).gte(`fecha_inicio`,new Date(Date.now()-10080*60*1e3).toISOString().split(`T`)[0]),v.from(`clases`).select(`id`,{count:`exact`}).eq(`estado`,`activa`),v.from(`asistencias`).select(`estado`).gte(`fecha`,new Date(Date.now()-10080*60*1e3).toISOString().split(`T`)[0])]),i=r.data?.length||0,a=r.data?.filter(e=>e.estado===`P`).length||0,o=i>0?Math.round(a/i*100):null,s=t.data?.filter(e=>e.estado===`ejecutado`).length||0,c=t.data?.filter(e=>e.estado===`planificado`).length||0;return{alumnosActivos:e.count||0,clasesActivas:n.count||0,planesEstaSemana:t.data?.length||0,planesEjecutados:s,planesPlanificados:c,tasaAsistencia:o}}async function Wi(){let e=new Date(Date.now()-672*60*60*1e3).toISOString().split(`T`)[0],{data:t}=await v.from(`asistencias`).select(`alumno_id, estado`).gte(`fecha`,e);if(!t?.length)return[];let n={};t.forEach(e=>{n[e.alumno_id]||(n[e.alumno_id]={total:0,presentes:0}),n[e.alumno_id].total++,e.estado===`P`&&n[e.alumno_id].presentes++});let r=Object.entries(n).filter(([,e])=>e.total>=4&&e.presentes/e.total<I.attendance_min_rate).map(([e])=>e);if(!r.length)return[];let{data:i}=await v.from(`alumnos`).select(`id, nombre_completo`).in(`id`,r.slice(0,5));return i||[]}function Gi(){return`
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        <div class="brand-badge bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center" style="width:42px;height:42px;">
    ...
    </div>`}function Ki(e,t){let n=e.tasaAsistencia===null?`secondary`:e.tasaAsistencia>=80?`success`:e.tasaAsistencia>=60?`warning`:`danger`;return`
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        <div class="brand-badge bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center" style="width:42px;height:42px;">
          <i class="bi bi-grid-1x2 fs-4"></i>
      ...
      <div class="row g-3 mb-4">
        ${qi(`bi-people-fill`,`Alumnos activos`,e.alumnosActivos,`primary`,null)}
        ${qi(`bi-easel2`,`Clases activas`,e.clasesActivas,`indigo`,null)}
        ${qi(`bi-journal-text`,`Planes esta semana`,e.planesEstaSemana,`success`,`${e.planesEjecutados} ejecutados · ${e.planesPlanificados} pendientes`)}
        ${qi(`bi-calendar-check`,`Asistencia (7 días)`,e.tasaAsistencia===null?`—`:e.tasaAsistencia+`%`,n,null)}
      </div>
      ...
      <div class="row g-3">
        ${Ji(`bi-journal-text`,`Planificación`,`Planes de clase, plantillas y revisión`,`planificacion`,`primary`)}
        ${Ji(`bi-person-lines-fill`,`Seguimiento`,`Progreso y asistencia por alumno`,`pedagogico-seguimiento`,`success`)}
        ${Ji(`bi-graph-up`,`Evaluaciones`,`Calificaciones y boletines`,`progresos`,`warning`)}
        ${Ji(`bi-file-earmark-bar-graph`,`Reportes`,`Rendimiento por clase y riesgo`,`pedagogico-reportes`,`info`)}
      </div>
    </div>`}function qi(e,t,n,r,i){return`
    <div class="col-6 col-md-3">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body">
    ...
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div class="flex-grow-1">
          ...
          <p class="text-muted small mb-0">${G.alumnos.length} alumnos activos · ${n.length} en riesgo</p>
        </div>
      ...
      <div class="input-group mb-3" style="max-width:360px;">
        ...
        <input type="text" class="form-control border-start-0" id="busqueda-alumno"
               placeholder="Buscar alumno o instrumento..." value="${G.busqueda}">
      </div>
      ...
      <div class="d-flex flex-column gap-2" id="lista-alumnos">
        ${i.map(e=>ea(e)).join(``)||`<div class="text-center text-muted py-5">Sin resultados</div>`}
      </div>
    </div>`,ta()}function ea(e){let t=Qi(e.id),n=G.asistenciaMap[e.id],r=G.progresosMap[e.id],i=G.observacionesMap[e.id]||[],a=n?.rate==null?null:Math.round(n.rate*100),o=a===null?`secondary`:a>=80?`success`:a>=60?`warning`:`danger`,s=r?r.promedio>=7?`success`:r.promedio>=5?`warning`:`danger`:`secondary`;return`
    ...
    </div>`}function ta(){G.container.querySelector(`#btn-help-seguimiento`)?.addEventListener(`click`,()=>{ye.open({title:`Seguimiento de Alumnos`,intro:`Vista unificada del estado académico de cada alumno. Los alumnos con riesgo aparecen primero, destacados con una barra lateral amarilla.`,sections:[{icon:`bi-search`,title:`Buscador`,description:`Filtrá por nombre del alumno o por instrumento en tiempo real.`,color:`#6b7280`},{icon:`bi-exclamation-triangle-fill`,title:`Alerta de riesgo`,description:`Aparece cuando hay alumnos que requieren atención. Muestra el total con algún indicador activo.`,color:`#f59e0b`},{icon:`bi-person-fill`,title:`Fila del alumno`,description:`Nombre, instrumento, % de asistencia (últimas 4 semanas) y promedio de las últimas 3 calificaciones. Barra amarilla izquierda = en riesgo.`,color:`#3b82f6`},{icon:`bi-tags-fill`,title:`Badges de riesgo`,description:`"Asistencia baja" < 70% en 4 semanas. "Nota baja" promedio < 6.0. "Observación" cuando hay observaciones de disciplina activas.`,color:`#ef4444`},{icon:`bi-window-sidebar`,title:`Panel de detalle`,description:`Clic en cualquier alumno → panel con asistencia reciente (20 clases), últimas calificaciones por clase y observaciones activas.`,color:`#10b981`}]})}),G.container.querySelector(`#busqueda-alumno`)?.addEventListener(`input`,e=>{G.busqueda=e.target.value,$i()}),G.container.querySelectorAll(`.alumno-row`).forEach(e=>{e.addEventListener(`click`,()=>ra(e.dataset.id)),e.addEventListener(`mouseenter`,()=>{e.style.boxShadow=`0 4px 15px rgba(0,0,0,0.1)`}),e.addEventListener(`mouseleave`,()=>{e.style.boxShadow=``})})}function na(){return`<div class="page-container d-flex align-items-center justify-content-center" style="min-height:400px;">
    <div class="spinner-border text-primary"></div>
  </div>`}async function ra(e){let t=G.alumnos.find(t=>t.id===e);if(!t)return;let[n,r,i,a]=await Promise.all([v.from(`asistencias`).select(`fecha, estado, clase_id`).eq(`alumno_id`,e).order(`fecha`,{ascending:!1}).limit(20),v.from(`progresos`).select(`*, clase:clases(nombre)`).eq(`alumno_id`,e).order(`fecha_evaluacion`,{ascending:!1}).limit(10),v.from(`observaciones`).select(`*`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1}).limit(5),v.from(`alumnos_clases`).select(`clase:clases(id, nombre, instrumento)`).eq(`alumno_id`,e)]),o=(a.data||[]).map(e=>e.clase).filter(Boolean),s=Qi(e);x.open({title:t.nombre_completo,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
    ...
    <div class="page-container">
      ...
      <h6 class="text-muted text-uppercase mb-2" style="font-size:0.72rem;letter-spacing:0.08em;">
        Alumnos en riesgo — asistencia &lt; ${Math.round(I.attendance_min_rate*100)}% (4 semanas)
      </h6>
      ${t.length?`
      <div class="card border-0 shadow-sm">
        <div class="table-responsive">
    ...
    </div>`}function ca(){C.register(`pedagogico-dashboard`,e=>Hi(e)),C.register(`pedagogico-seguimiento`,e=>Xi(e)),C.register(`pedagogico-reportes`,e=>ia(e))}var la=[{id:`m-001`,nombre:`Carlos Méndez`,especialidad:`Violín`,habilidades:[`violín`,`viola`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],martes:[{inicio:`10:00`,fin:`13:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],jueves:[{inicio:`10:00`,fin:`13:00`}],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-002`,nombre:`María Torres`,especialidad:`Piano`,habilidades:[`piano`,`teclado`,`teoría musical`],disponibilidad:{lunes:[{inicio:`14:00`,fin:`19:00`}],martes:[{inicio:`10:00`,fin:`19:00`}],miércoles:[{inicio:`14:00`,fin:`19:00`}],jueves:[{inicio:`10:00`,fin:`19:00`}],viernes:[],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-003`,nombre:`José Ramírez`,especialidad:`Percusión`,habilidades:[`percusión`,`batería`,`timbales`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`14:00`}],martes:[{inicio:`10:00`,fin:`14:00`}],miércoles:[{inicio:`10:00`,fin:`14:00`}],jueves:[{inicio:`10:00`,fin:`14:00`}],viernes:[{inicio:`10:00`,fin:`14:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}},{id:`m-004`,nombre:`Ana Luisa Herrera`,especialidad:`Cello`,habilidades:[`cello`,`contrabajo`,`música de cámara`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`19:00`}],martes:[],miércoles:[{inicio:`10:00`,fin:`19:00`}],jueves:[],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-005`,nombre:`Roberto Sánchez`,especialidad:`Guitarra`,habilidades:[`guitarra`,`cuatro`,`mandolina`],disponibilidad:{lunes:[{inicio:`15:00`,fin:`19:00`}],martes:[{inicio:`15:00`,fin:`19:00`}],miércoles:[{inicio:`15:00`,fin:`19:00`}],jueves:[{inicio:`15:00`,fin:`19:00`}],viernes:[{inicio:`15:00`,fin:`19:00`}],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-006`,nombre:`Luisa Fernanda Díaz`,especialidad:`Voz`,habilidades:[`voz`,`coro`,`técnica vocal`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`}],martes:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`}],jueves:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],viernes:[{inicio:`10:00`,fin:`13:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}}],ua=[{id:`s-101`,nombre:`Salón Mozart (Grande)`,capacidad:30,piso:1,is_active:!0},{id:`s-102`,nombre:`Salón Beethoven (Mediano)`,capacidad:15,piso:1,is_active:!0},{id:`s-103`,nombre:`Salón Bach (Piano)`,capacidad:10,piso:2,is_active:!0},{id:`s-104`,nombre:`Salón Vivaldi (Violín)`,capacidad:8,piso:2,is_active:!0},{id:`s-105`,nombre:`Salón Chopin (Teclados)`,capacidad:12,piso:2,is_active:!0}],da=[{id:`c-001`,nombre:`Violín Inicial`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:10,total_alumnos:6,horarios:[]},{id:`c-002`,nombre:`Violín Intermedio`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:8,total_alumnos:5,horarios:[]},{id:`c-003`,nombre:`Piano Inicial A`,instrumento:`Piano`,maestro_principal_id:`m-002`,capacidad_maxima:12,total_alumnos:10,horarios:[]},{id:`c-004`,nombre:`Teoría y Solfeo I`,instrumento:`Solfeo`,maestro_principal_id:`m-006`,capacidad_maxima:25,total_alumnos:18,horarios:[]},{id:`c-005`,nombre:`Batería Básica`,instrumento:`Percusión`,maestro_principal_id:`m-003`,capacidad_maxima:6,total_alumnos:4,horarios:[]},{id:`c-006`,nombre:`Guitarra Clásica I`,instrumento:`Guitarra`,maestro_principal_id:`m-005`,capacidad_maxima:15,total_alumnos:11,horarios:[]},{id:`c-007`,nombre:`Cello y Cámara`,instrumento:`Cello`,maestro_principal_id:`m-004`,capacidad_maxima:8,total_alumnos:3,horarios:[]},{id:`c-008`,nombre:`Técnica Vocal A`,instrumento:`Voz`,maestro_principal_id:`m-006`,capacidad_maxima:10,total_alumnos:8,horarios:[]}],fa=[];async function pa(){let{data:e,error:t}=await v.from(`salones`).select(`id, nombre, capacidad, is_active`).eq(`is_active`,!0).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar salones reales: `+t.message);return e}async function ma(){let{data:e,error:t}=await v.from(`clases`).select(`id, nombre, maestro_principal_id, capacidad_maxima, instrumento`).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar clases reales: `+t.message);let{data:n}=await v.from(`clase_horarios`).select(`*`),{data:r}=await v.from(`alumnos_clases`).select(`clase_id`);return(e||[]).map(e=>{let t=(n||[]).filter(t=>t.clase_id===e.id),i=(r||[]).filter(t=>t.clase_id===e.id).length;return{id:e.id,nombre:e.nombre,instrumento:e.instrumento||`General`,maestro_principal_id:e.maestro_principal_id,capacidad_maxima:e.capacidad_maxima||20,total_alumnos:i,horarios:t.map(e=>({dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id}))}})}async function ha(){if(h.isDemoMode)return{maestros:la,salones:ua,clases:da};try{let[e,t,n]=await Promise.all([Se(),pa(),ma()]);return{maestros:e,salones:t,clases:n}}catch(e){throw console.error(`[horarioBuilderApi] Error fetching data:`,e),e}}async function ga(e){if(h.isDemoMode){let t={id:`run-${Date.now()}`,created_at:new Date().toISOString(),estado:e.estado||`borrador`,periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas};return fa.push(t),t}let{data:t,error:n}=await v.from(`schedule_runs`).insert([{periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas,estado:e.estado||`borrador`}]).select().single();if(n)throw console.error(`[horarioBuilderApi] Error saving run:`,n),Error(`No se pudo guardar la corrida de horario: `+n.message);return t}async function _a(){if(h.isDemoMode)return fa;let{data:e,error:t}=await v.from(`schedule_runs`).select(`*`).order(`created_at`,{ascending:!1});if(t)throw console.error(`[horarioBuilderApi] Error fetching runs:`,t),Error(`No se pudieron obtener las corridas de horarios`);return e}var va={lunes:{inicio:`10:00`,fin:`19:00`},martes:{inicio:`10:00`,fin:`19:00`},miércoles:{inicio:`10:00`,fin:`19:00`},jueves:{inicio:`10:00`,fin:`19:00`},viernes:{inicio:`10:00`,fin:`19:00`},sábado:{inicio:`09:00`,fin:`13:00`},domingo:{inicio:`00:00`,fin:`00:00`}},ya=[{id:`S1-2026`,nombre:`Semestre 1 (Ene–Jul 2026)`,inicio:`2026-01-01`,fin:`2026-07-31`},{id:`S2-2026`,nombre:`Semestre 2 (Ago–Dic 2026)`,inicio:`2026-08-01`,fin:`2026-12-31`}],ba=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`}];function K(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function xa(e){let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`}function Sa(e,t,n,r,i=0){return e<r+i&&n-i<t}function Ca(e,t,n){let r=e[t]||[],i=n[t];if(!i||i.inicio===`00:00`&&i.fin===`00:00`)return[];let a=K(i.inicio),o=K(i.fin),s=[];return r.forEach(e=>{let t=K(e.inicio),n=K(e.fin),r=Math.max(t,a),i=Math.min(n,o);r<i&&s.push({start:r,end:i})}),s}function wa({clasesConMaestro:e,maestros:t,salones:n,config:r}){let i={jornada:r?.jornada||va,gapMinimo:r?.gapMinimo===void 0?15:parseInt(r.gapMinimo),duracionBloque:r?.duracionBloque===void 0?60:parseInt(r.duracionBloque)},a=[],o=[],s={};t.forEach(e=>{s[e.id]=[]});let c={};n.forEach(e=>{c[e.id]=[]});let l=e.map(e=>{let n=t.find(t=>t.id===e.maestro_principal_id),r=0;return n&&n.disponibilidad&&Object.keys(n.disponibilidad).forEach(e=>{Ca(n.disponibilidad,e,i.jornada).forEach(e=>{r+=e.end-e.start})}),{...e,duracion:e.duracion||i.duracionBloque,totalAlumnos:e.total_alumnos||0,availableMinutes:r||1}});l.sort((e,t)=>e.availableMinutes===t.availableMinutes?t.totalAlumnos-e.totalAlumnos:e.availableMinutes-t.availableMinutes),l.forEach(e=>{let r=t.find(t=>t.id===e.maestro_principal_id);if(!r){o.push({clase_id:e.id,nombre:e.nombre,razon:`El maestro principal asignado (ID: ${e.maestro_principal_id}) no está registrado.`});return}let l=e.duracion,u=[];if(Object.keys(i.jornada).forEach(t=>{let a=i.jornada[t];if(!a||a.inicio===`00:00`&&a.fin===`00:00`)return;let o=Ca(r.disponibilidad||{},t,i.jornada);if(o.length===0)return;K(a.inicio),K(a.fin);let d=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1);d.length!==0&&o.forEach(e=>{for(let n=e.start;n+l<=e.end;n+=30){let e=n+l;(s[r.id]||[]).some(r=>r.day===t&&Sa(n,e,r.start,r.end,i.gapMinimo))||d.forEach(a=>{(c[a.id]||[]).some(r=>r.day===t&&Sa(n,e,r.start,r.end,i.gapMinimo))||u.push({day:t,start:n,end:e,salon:a,teacher:r})})}})}),u.length===0){let t=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1),i=`Sin disponibilidad compatible con maestro y salones.`;i=t.length===0?`No hay salones activos con capacidad suficiente para ${e.totalAlumnos} alumnos.`:`Conflicto de agenda: el maestro ${r.nombre} o los salones adecuados están ocupados en sus horas disponibles.`,o.push({clase_id:e.id,nombre:e.nombre,razon:i});return}u.forEach(t=>{let n=100,r=t.salon.capacidad-e.totalAlumnos;n-=Math.min(r*2,40);let i=(s[t.teacher.id]||[]).reduce((e,t)=>e+(t.end-t.start),0)/60;n-=Math.min(i*3,20),(s[t.teacher.id]||[]).some(e=>e.day===t.day&&(e.end===t.start||e.start===t.end))&&(n+=15),t.score=n}),u.sort((e,t)=>t.score-e.score);let d=u[0];a.push({clase_id:e.id,clase_nombre:e.nombre,maestro_id:r.id,maestro_nombre:r.nombre,salon_id:d.salon.id,salon_nombre:d.salon.nombre,dia:d.day,hora_inicio:xa(d.start),hora_fin:xa(d.end),color:Ta(r.id)}),s[r.id].push({day:d.day,start:d.start,end:d.end,classId:e.id}),c[d.salon.id].push({day:d.day,start:d.start,end:d.end,classId:e.id})});let u=e.length,d=a.length,f=o.length,p={};n.forEach(e=>{let t=(c[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0),n=0;Object.keys(i.jornada).forEach(e=>{let t=i.jornada[e];t&&(t.inicio!==`00:00`||t.fin!==`00:00`)&&(n+=K(t.fin)-K(t.inicio))}),p[e.id]={nombre:e.nombre,porcentaje:Math.round(t/(n||1)*100)}});let m={};t.forEach(e=>{let t=(s[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0);m[e.id]={nombre:e.nombre,horas:Math.round(t/60*10)/10}});let ee=u>0?d/u*100:100;return{assignments:a,noAsignadas:o,metricas:{totalClases:u,clasesAsignadas:d,clasesNoAsignadas:f,ocupacionSalones:p,cargaMaestros:m,score:Math.max(0,Math.round(ee))}}}function Ta(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function Ea(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function Da(e,t,n=0){let r=Ea(e.hora_inicio),i=Ea(e.hora_fin),a=Ea(t.hora_inicio);return r<Ea(t.hora_fin)+n&&a-n<i}function q(e,{returnAnnotated:t=!1,gapMinutes:n=0}={}){let r=[],i=new Set;for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let o=e[t],s=e[a];o.dia===s.dia&&Da(o,s,n)&&(o.maestro_id&&o.maestro_id===s.maestro_id&&(r.push({type:`teacher`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.maestro_nombre} tiene dos clases al mismo tiempo: "${o.clase_nombre}" y "${s.clase_nombre}"`}),i.add(o.clase_id),i.add(s.clase_id)),o.salon_id&&o.salon_id===s.salon_id&&(r.push({type:`room`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.salon_nombre} está ocupado por "${o.clase_nombre}" y "${s.clase_nombre}" al mismo tiempo`}),i.add(o.clase_id),i.add(s.clase_id)))}return t?{conflicts:r,assignments:e.map(e=>({...e,hasConflict:i.has(e.clase_id)}))}:r}function Oa({conflictDescription:e}){return new Promise(t=>{let n=document.createElement(`div`);n.className=`modal-backdrop fade show`,n.style.zIndex=`1040`;let r=document.createElement(`div`);r.className=`modal fade show d-block`,r.style.zIndex=`1050`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
    ...
    <div class="schedule-block"
      ...
      <div class="sb-header" style="background:${f};padding:3px 6px;display:flex;align-items:center;justify-content:space-between;gap:4px;">
        <span style="font-size:0.65rem;font-weight:700;color:#1e293b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;">${J(r)}</span>
      ...
      <div class="sb-body" style="background:#f8fafc;padding:3px 6px;display:flex;align-items:center;gap:5px;">
        ...
        <span style="font-size:0.58rem;color:#475569;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${J(o)}</span>
      </div>
      ${s?`<div style="background:#f1f5f9;padding:2px 6px;font-size:0.55rem;color:#64748b;border-top:1px solid #e2e8f0;">${J(s)} · ${c}–${l}</div>`:``}
    </div>
  `}var Pa=`<p class="text-muted text-center py-4">No hay asignaciones para mostrar.</p>`;function Fa(e){if(!e||!e.includes(`:`))return`00:00`;let[t]=e.split(`:`);return`${t.padStart(2,`0`)}:00`}function Ia(e,t,n){let r=new Map;for(let t of e){let e=Fa(t.hora_inicio);r.has(e)||r.set(e,new Map);let n=r.get(e),i=(t.dia||``).toLowerCase();n.has(i)||n.set(i,[]),n.get(i).push(t)}let i=[...r.keys()].sort(),a=ba.map(e=>`<th class="sg-col-header" data-day="${e.key}" style="text-align:center;padding:4px 6px;font-size:0.75rem;">${e.label}</th>`).join(``),o=i.map(e=>{let n=r.get(e);return`<tr>
      <td class="sg-hour-label" style="font-size:0.7rem;color:#64748b;padding:4px 8px;white-space:nowrap;vertical-align:top;">${e}</td>
      ${ba.map(r=>{let i=(n.get(r.key)||[]).map(e=>Na(e,{draggable:t})).join(``);return`<td class="sg-cell" data-day="${r.key}" data-hour="${e}" style="vertical-align:top;padding:3px;min-width:100px;">${i}</td>`}).join(``)}
    </tr>`}).join(``);return`
  ...
  `}function La(e,t,n){let r=new Map;for(let n of e){let e=n[t]||`(Sin asignar)`;r.has(e)||r.set(e,[]),r.get(e).push(n)}return`<div class="schedule-grouped-view">${[...r.entries()].map(([e,t])=>{let r=t.map(e=>Na(e,{draggable:n})).join(``);return`
      <div class="sg-group" style="margin-bottom:1rem;">
        <h4 class="sg-group-title" style="font-size:0.85rem;font-weight:700;color:#1e293b;margin-bottom:0.5rem;">${J(e)}</h4>
        <div class="sg-group-blocks" style="display:flex;flex-wrap:wrap;gap:6px;">${r}</div>
      </div>
    `}).join(``)}</div>`}function Ra({assignments:e,activeView:t,draggable:n=!1,periodoId:r}={}){if(!e||e.length===0)return Pa;switch(t){case`teacher`:return La(e,`maestro_nombre`,n);case`room`:return La(e,`salon_nombre`,n);case`student`:return La(e,`clase_nombre`,n);default:return Ia(e,n,r)}}var za=[`grid`,`teacher`,`room`,`student`],Ba={grid:{label:`Grilla`,icon:`bi-grid-3x3`},teacher:{label:`Por Maestro`,icon:`bi-person-lines-fill`},room:{label:`Por Salón`,icon:`bi-door-open`},student:{label:`Por Alumno`,icon:`bi-mortarboard`}};function Va(e=`grid`){return Ba[e]||(e=`grid`),`
    <div class="view-toggle" style="display:flex;gap:0.4rem;flex-wrap:wrap;" role="tablist" aria-label="Modo de visualización">
      ${za.map(t=>{let{label:n,icon:r}=Ba[t],i=t===e;return`
  ...
  `}var Ha={lunes:`Lun`,martes:`Mar`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sábado:`Sáb`};function Ua(e=[],t=!1){if(e.length===0)return``;let n=e.length,r=e.map((e,t)=>{e.type;let n=J(Ha[e.day]??e.day);return`
      <div class="cp-row"
           ...
           ">
        <span style="background:#fecaca;color:#991b1b;border-radius:4px;padding:1px 5px;font-size:0.6rem;font-weight:700;flex-shrink:0;margin-top:1px;">${J(e.type)}</span>
        <span style="font-size:0.72rem;color:#7f1d1d;line-height:1.4;">${n} ${e.hora_inicio} — ${J(e.description)}</span>
      </div>
    `}).join(``);return`
  ...
  `}function Wa(e,t,n){let r=e.querySelector(`.cp-header`),i=e.querySelector(`.cp-body`),a=e.querySelector(`.cp-chevron`);r?.addEventListener(`click`,()=>{let e=i.style.display!==`none`;i.style.display=e?`none`:`block`,a.className=`bi ${e?`bi-chevron-down`:`bi-chevron-up`}`}),e.querySelectorAll(`.cp-row`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{e.style.background=`#fff1f2`}),e.addEventListener(`mouseleave`,()=>{e.style.background=`transparent`}),e.addEventListener(`click`,()=>{let r=parseInt(e.dataset.conflictIndex,10);isNaN(r)||!t[r]||n?.(t[r])})})}var Ga=[`borrador`,`revision`,`publicado`],Ka={borrador:`Borrador`,revision:`Revisión`,publicado:`Publicado`};function qa(e){let t=document.createElement(`li`);t.className=`pw-feedback-item d-flex align-items-start gap-2 mb-1`;let n=document.createElement(`span`);n.className=`badge bg-secondary`,n.textContent=e.tipo;let r=document.createElement(`span`);return r.textContent=e.comentario,t.appendChild(n),t.appendChild(r),t}function Ja(e,{runId:t,estadoActual:n,isAdmin:r,feedback:i=[],onEstadoChange:a,onFeedbackAdd:o}){let s=Ga.indexOf(n);e.innerHTML=`
    <div class="pw-wizard">
      <!-- Stage indicators -->
      <div class="pw-stages d-flex align-items-center gap-2 mb-3">
        ${Ga.map((e,t)=>{let n=`pw-stage`;t===s?n+=` pw-stage--active`:t<s&&(n+=` pw-stage--done`);let r=t<Ga.length-1?`<div class="pw-stage-connector"></div>`:``;return`
      <div class="${n}" data-stage="${e}">
        <span class="pw-stage-dot"></span>
        <span class="pw-stage-label">${Ka[e]}</span>
      </div>
      ${r}
    `}).join(``)}
      </div>
  ...
  `;let c=e.querySelector(`.pw-send-revision-btn`);c&&c.addEventListener(`click`,()=>a?.(`revision`));let l=e.querySelector(`.pw-approve-btn`);l&&l.addEventListener(`click`,()=>a?.(`publicado`));let u=e.querySelector(`.pw-add-feedback-btn`),d=e.querySelector(`.pw-feedback-input`);function f(){let e=d?.value?.trim();e&&(o?.({comentario:e,tipo:`observacion`}),d&&(d.value=``))}u&&u.addEventListener(`click`,f),d&&d.addEventListener(`keydown`,e=>{e.key===`Enter`&&f()});let p=e.querySelector(`.pw-feedback-list`);p&&(p.innerHTML=``,(i||[]).forEach(e=>p.appendChild(qa(e))))}async function Ya(e){let{data:t,error:n}=await v.from(`schedule_run_feedback`).select(`*`).eq(`run_id`,e).order(`created_at`,{ascending:!0});if(n)throw n;return t}async function Xa({runId:e,comentario:t,tipo:n=`observacion`}){let{data:r,error:i}=await v.from(`schedule_run_feedback`).insert([{run_id:e,comentario:t,tipo:n}]).select().single();if(i)throw i;return r}async function Za(){let{data:{user:e}}=await v.auth.getUser();if(!e)return!1;let{data:t,error:n}=await v.from(`maestros`).select(`es_admin`).eq(`user_id`,e.id).single();return n||!t?!1:t.es_admin===!0}async function Qa(e,t){let{data:n,error:r}=await v.from(`schedule_runs`).update({estado:t}).eq(`id`,e).select().single();if(r)throw r;return n}function $a(){return{assignments:[],conflicts:[],activeView:`grid`,activePeriodo:ya[0].id,draggable:!1,conflictPanelExpanded:!1,scheduleRuns:[],loading:!1,error:null,undoStack:[],redoStack:[],estado:`borrador`,runId:null,isAdmin:!1,feedback:[],publishWizardOpen:!1}}var Y=$a(),X=null,eo=null;function to(e){X=e,Y=$a(),no(),uo(),_a().then(e=>{Y.scheduleRuns=e||[]}).catch(e=>console.warn(`[horarioBuilderView] getScheduleRuns failed:`,e)),Za().then(e=>{Y.isAdmin=e}).catch(()=>{})}function no(){let e=ya.map(e=>`<option value="${e.id}" ${e.id===Y.activePeriodo?`selected`:``}>${e.nombre}</option>`).join(``),t=Y.draggable?`bi-unlock-fill`:`bi-lock-fill`,n=Y.draggable?`Bloqueando`:`Editar`;X.innerHTML=`
    <div class="hb-view">
      <!-- Toolbar -->
  ...
  `}function Z(){let e=X.querySelector(`#hb-grid-wrapper`);e&&(e.innerHTML=Ra({assignments:Y.assignments,activeView:Y.activeView,draggable:Y.draggable,periodoId:Y.activePeriodo}))}function Q(){let e=X.querySelector(`#hb-conflict-panel-wrapper`);if(!e)return;let t=e.querySelector(`.cp-body`);t&&(Y.conflictPanelExpanded=t.style.display===`block`),e.innerHTML=Ua(Y.conflicts,Y.conflictPanelExpanded),Wa(e,Y.conflicts,e=>{let t=X.querySelector(`.hb-view`);e.ids.forEach(e=>{let n=t?.querySelector(`[data-clase-id="${e}"]`);n&&(n.scrollIntoView({behavior:`smooth`,block:`nearest`}),n.classList.add(`hb-highlight`),setTimeout(()=>n.classList.remove(`hb-highlight`),1500))})})}function ro(){let e=X.querySelector(`#hb-view-toggle-slot`);e&&(e.innerHTML=Va(Y.activeView))}function io(){let e=X.querySelector(`#hb-publish-wrapper`);if(e){if(!Y.publishWizardOpen||!Y.runId){e.style.display=`none`;return}e.style.display=``,Ja(e,{runId:Y.runId,estadoActual:Y.estado,isAdmin:Y.isAdmin,feedback:Y.feedback,async onEstadoChange(e){try{await Qa(Y.runId,e),Y.estado=e,io()}catch(e){console.error(`[horario-builder] estado update failed:`,e)}},async onFeedbackAdd({comentario:e,tipo:t}){try{let n=await Xa({runId:Y.runId,comentario:e,tipo:t});Y.feedback=[...Y.feedback,n],io()}catch(e){console.error(`[horario-builder] feedback add failed:`,e)}}})}}function ao(e){Y.loading=e;let t=X.querySelector(`#hb-status`);t&&(t.innerHTML=e?`<div class="d-flex align-items-center gap-2 mt-2 text-muted" style="font-size:0.85rem;">
         <div class="spinner-border spinner-border-sm" role="status"></div>
         <span>Generando horario optimizado…</span>
       </div>`:``)}function oo(e,t=`success`){let n=document.createElement(`div`);n.className=`hb-toast`;let r=`bi-check-circle-fill text-success`,i=`#10b981`;t===`danger`?(r=`bi-exclamation-octagon-fill text-danger`,i=`#ef4444`):t===`warning`&&(r=`bi-info-circle-fill text-warning`,i=`#f59e0b`),n.style.borderLeftColor=i,n.innerHTML=`
    <i class="bi ${r}"></i>
    <span style="font-size:0.85rem;font-weight:650;color:var(--hb-text);">${e}</span>
  `,document.body.appendChild(n),setTimeout(()=>{n.style.animation=`fadeIn 0.3s reverse forwards`,setTimeout(()=>n.remove(),300)},3500)}function so(e,t){let[n,r]=e.split(`:`).map(Number),[i,a]=t.split(`:`).map(Number);return i*60+a-(n*60+r)}function co(e,t){let[n,r]=e.split(`:`).map(Number),i=n*60+r+t,a=Math.floor(i/60),o=i%60;return`${String(a).padStart(2,`0`)}:${String(o).padStart(2,`0`)}`}function lo(){let e=X?.querySelector(`#hb-undo-btn`),t=X?.querySelector(`#hb-redo-btn`);e&&(e.disabled=Y.undoStack.length===0),t&&(t.disabled=Y.redoStack.length===0)}function $(){eo&&eo.destroy(),Y.draggable&&(eo=ka(X.querySelector(`#hb-grid-wrapper`),{assignments:Y.assignments,onMove({claseId:e,fromDay:t,fromHour:n,toDay:r,toHour:i}){Y.undoStack.push(JSON.parse(JSON.stringify(Y.assignments))),Y.redoStack=[];let a=Y.assignments.findIndex(t=>t.clase_id===e);if(a===-1)return;let o={...Y.assignments[a]},s=so(o.hora_inicio,o.hora_fin);o.dia=r,o.hora_inicio=i,o.hora_fin=co(i,s),Y.assignments[a]=o;let{conflicts:c,assignments:l}=q(Y.assignments,{returnAnnotated:!0});Y.conflicts=c,Y.assignments=l,Z(),Q(),lo(),$()},async onConflict({assignment:e,targetDay:t,targetHour:n,conflicts:r}){let i=X.querySelector(`#hb-drag-toggle`);[i,X.querySelector(`#hb-undo-btn`),X.querySelector(`#hb-redo-btn`)].forEach(e=>{e&&(e.disabled=!0)});try{if(!await Oa({conflictDescription:r.map(e=>e.description).join(`
`)}))return;Y.undoStack.push(JSON.parse(JSON.stringify(Y.assignments))),Y.redoStack=[];let i=Y.assignments.findIndex(t=>t.clase_id===e.clase_id);if(i===-1)return;let a={...Y.assignments[i]},o=so(a.hora_inicio,a.hora_fin);a.dia=t,a.hora_inicio=n,a.hora_fin=co(n,o),Y.assignments[i]=a;let s=q(Y.assignments,{returnAnnotated:!0});Y.conflicts=s.conflicts,Y.assignments=s.assignments,Z(),Q(),lo(),$()}finally{i&&(i.disabled=!1),lo()}}}))}function uo(){X.addEventListener(`change`,e=>{e.target.id===`hb-periodo-select`&&(Y.activePeriodo=e.target.value,Z())}),X.addEventListener(`click`,async e=>{let t=e.target.closest(`.vt-pill[data-view]`);if(t){let e=t.dataset.view;za.includes(e)&&e!==Y.activeView&&(Y.activeView=e,ro(),Z());return}if(e.target.closest(`#hb-drag-toggle`)){Y.draggable=!Y.draggable;let e=X.querySelector(`#hb-drag-toggle`);e&&(e.innerHTML=Y.draggable?`<i class="bi bi-unlock-fill"></i> Bloqueando`:`<i class="bi bi-lock-fill"></i> Editar`),Z(),$();return}if(e.target.closest(`#hb-undo-btn`)){if(Y.undoStack.length===0)return;Y.redoStack.push(JSON.parse(JSON.stringify(Y.assignments))),Y.assignments=Y.undoStack.pop();let e=q(Y.assignments,{returnAnnotated:!0});Y.conflicts=e.conflicts,Y.assignments=e.assignments,Z(),Q(),lo(),$();return}if(e.target.closest(`#hb-redo-btn`)){if(Y.redoStack.length===0)return;Y.undoStack.push(JSON.parse(JSON.stringify(Y.assignments))),Y.assignments=Y.redoStack.pop();let e=q(Y.assignments,{returnAnnotated:!0});Y.conflicts=e.conflicts,Y.assignments=e.assignments,Z(),Q(),lo(),$();return}if(e.target.closest(`#hb-generate-btn`)){fo();return}if(e.target.closest(`#hb-save-btn`)){po();return}if(e.target.closest(`#hb-publish-btn`)){if(Y.publishWizardOpen=!Y.publishWizardOpen,Y.publishWizardOpen&&Y.runId)try{Y.feedback=await Ya(Y.runId)}catch{Y.feedback=[]}io();return}})}async function fo(){let e=X.querySelector(`#hb-generate-btn`);e&&(e.disabled=!0),ao(!0);try{let e=await ha(),{conflicts:t,assignments:n}=q(wa({clasesConMaestro:(e.clases||[]).map(e=>({id:e.id,nombre:e.nombre,maestro_principal_id:e.maestro_principal_id,total_alumnos:e.total_alumnos||0,duracion:60})),maestros:e.maestros||[],salones:e.salones||[],config:{gapMinimo:15,duracionBloque:60}}).assignments,{returnAnnotated:!0,gapMinutes:15});Y.assignments=n,Y.conflicts=t,Z(),Q(),$();let r=X.querySelector(`#hb-save-btn`);r&&(r.disabled=Y.assignments.length===0),oo(t.length>0?`Horario generado con ${t.length} conflicto(s)`:`Horario optimizado sin conflictos`,t.length>0?`warning`:`success`)}catch(e){console.error(`[horarioBuilderView] handleGenerate error:`,e),oo(`Error al generar: `+e.message,`danger`)}finally{ao(!1),e&&(e.disabled=!1)}}async function po(){let e=X.querySelector(`#hb-save-btn`);e&&(e.disabled=!0,e.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Guardando…`);try{let e=await ga({assignments:Y.assignments,periodo_id:Y.activePeriodo,estado:`borrador`});if(e?.id){Y.runId=e.id,Y.estado=`borrador`;let t=X.querySelector(`#hb-publish-btn`);t&&(t.disabled=!1),oo(`Horario guardado como borrador`,`success`)}else oo(`Guardado incompleto: no se obtuvo ID del registro`,`warning`);Y.error=null}catch(e){console.error(`[horarioBuilderView] handleSave error:`,e),Y.error=e.message,oo(`Error al guardar: `+e.message,`danger`)}finally{e&&(e.disabled=!1,e.innerHTML=`<i class="bi bi-floppy-fill"></i> Guardar`)}}function mo(){C.register(`horario-builder`,to)}function ho(){C.register(`admin-notificaciones`,e=>{try{be(e)}catch(t){console.error(`[admin-notificaciones] Error al renderizar la vista:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar el Centro de Actividad: ${t.message}</p>
        </div>
      `}})}function go(){C.register(`admin-aprobacion`,async e=>{try{await fe(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de aprobaciones:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la aprobación de maestros: ${t.message}</p>
        </div>
      `}}),C.register(`admin-ausencias`,async e=>{try{await _e(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de ausencias:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la gestión de ausencias: ${t.message}</p>
        </div>
      `}})}if(ce(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}window.bootstrap=Ae,window.router=C;var _o=[{id:`programas`,label:`Programas`,icon:`bi-book`,description:`Gestión de programas académicos`,enabled:!0,register:Et},{id:`academic-admin`,label:`Gestión Curricular`,icon:`bi-diagram-3`,description:`Gestión de mapa curricular y recursos`,enabled:!0,register:ci},{id:`admin-dashboard`,label:`Dashboard Administrativo`,icon:`bi-speedometer2`,description:`Panel de control, reportes y analítica de maestros`,enabled:!0,register:Si},{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`,description:`Alertas tempranas de riesgo y sustituciones sugeridas`,enabled:!0,register:ho},{id:`admin-aprobacion`,label:`Aprobación de Maestros`,icon:`bi-person-check`,description:`Aprobación de maestros y gestión de ausencias`,enabled:!0,register:go},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`,description:`Gestión de maestros/docentes`,enabled:!0,register:Tt},{id:`alumnos`,label:`Alumnos`,icon:`bi-people`,description:`Gestión de estudiantes`,enabled:!0,register:Dt},{id:`salones`,label:`Salones`,icon:`bi-door-open`,description:`Gestión de espacios de clase`,enabled:!0,register:Bt},{id:`clases`,label:`Clases`,icon:`bi-easel`,description:`Gestión de clases y horarios`,enabled:!0,register:Vt},{id:`horario-builder`,label:`Constructor de Horarios`,icon:`bi-calendar-range`,description:`Motor de asignación y optimización de horarios`,enabled:!0,register:mo},{id:`asistencias`,label:`Asistencias`,icon:`bi-calendar-check`,description:`Control de asistencia`,enabled:!0,register:cn},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`,description:`Planificación pedagógica`,enabled:!0,register:Hn},{id:`progresos`,label:`Progresos`,icon:`bi-graph-up`,description:`Calificaciones y progreso`,enabled:!0,register:mr},{id:`observaciones`,label:`Observaciones`,icon:`bi-chat-quote`,description:`Anotaciones disciplinarias`,enabled:!0,register:Mr},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`,description:`KPIs, alertas y análisis institucional`,enabled:!0,register:Kr},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`,description:`Permisos y roles de maestros`,enabled:!0,register:Vi},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,description:`Dashboard, seguimiento y reportes pedagógicos`,enabled:!0,register:ca},{id:`config`,label:`Configuración`,icon:`bi-gear`,description:`Configuración del sistema`,enabled:!0,register:ni}];function vo(){let e=localStorage.getItem(`app-theme`),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches,n=e===`dark`||e===null&&t;return document.documentElement.setAttribute(`data-bs-theme`,n?`dark`:`light`),n}function yo(){let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-bs-theme`,e),localStorage.setItem(`app-theme`,e)}var bo=[{id:`academico`,label:`Académico`,icon:`bi-easel`,items:[{id:`programas`,label:`Programas`,icon:`bi-book`},{id:`clases`,label:`Clases`,icon:`bi-easel2`},{id:`salones`,label:`Salones`,icon:`bi-door-open`},{id:`horario-builder`,label:`Constructor Horarios`,icon:`bi-calendar-range`}]},{id:`personas`,label:`Personas`,icon:`bi-people`,items:[{id:`alumnos`,label:`Alumnos`,icon:`bi-people`},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`}]},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,items:[{id:`pedagogico-dashboard`,label:`Dashboard`,icon:`bi-grid-1x2`},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`},{id:`planificacion-maestros`,label:`Todas las Planes`,icon:`bi-journal-check`},{id:`pedagogico-seguimiento`,label:`Seguimiento`,icon:`bi-person-lines-fill`},{id:`pedagogico-reportes`,label:`Reportes`,icon:`bi-file-earmark-bar-graph`}]},{id:`analisis`,label:`Análisis`,icon:`bi-bar-chart-line`,items:[{id:`metricas`,label:`Dashboard`,icon:`bi-bar-chart-line`},{id:`admin-dashboard`,label:`Cumplimiento Maestros`,icon:`bi-clipboard-check`},{id:`admin-dashboard-reportes`,label:`Reportes Director`,icon:`bi-file-earmark-pdf`},{id:`admin-dashboard-analitca-llenado`,label:`Analítica Llenado`,icon:`bi-graph-up`},{id:`admin-dashboard-tendencias`,label:`Tendencias`,icon:`bi-arrow-up-right`}]},{id:`sistema`,label:`Sistema`,icon:`bi-gear`,items:[{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`},{id:`admin-aprobacion`,label:`Aprobaciones`,icon:`bi-person-check`},{id:`admin-ausencias`,label:`Gestión Ausencias`,icon:`bi-calendar-x`},{id:`configuracion`,label:`Configuración`,icon:`bi-sliders`},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`},{id:`importar-datos`,label:`Importar Datos`,icon:`bi-cloud-upload`}]}];function xo(e){for(let t of bo)if(t.items.some(t=>t.id===e))return t.id;return bo[0].id}var So=null;function Co(e,t=!1){So?.abort(),So=new AbortController;let{signal:n}=So;if(document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),document.querySelector(`.mobile-sub-sheet`)?.remove(),!t)return;let r=D.getUser(),i=r?r.email||r.full_name||`Usuario`:``,a=localStorage.getItem(`current-view`)||`programas`,o=xo(a),s=document.documentElement.getAttribute(`data-bs-theme`)===`dark`,c=h.isDemoMode,l=document.createElement(`aside`);l.className=`app-sidebar`,l.innerHTML=`
