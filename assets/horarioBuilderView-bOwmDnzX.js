import{t as e}from"./AppToast-BfaQtGFE.js";import{i as t}from"./supabase-Cgh_dhNB.js";import{t as n}from"./config-CNiOV0RX.js";import{n as r}from"./disponibilidadApi-xm0wbIpZ.js";var i=[{id:`m-001`,nombre:`Carlos Méndez`,especialidad:`Violín`,habilidades:[`violín`,`viola`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],martes:[{inicio:`10:00`,fin:`13:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],jueves:[{inicio:`10:00`,fin:`13:00`}],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-002`,nombre:`María Torres`,especialidad:`Piano`,habilidades:[`piano`,`teclado`,`teoría musical`],disponibilidad:{lunes:[{inicio:`14:00`,fin:`19:00`}],martes:[{inicio:`10:00`,fin:`19:00`}],miércoles:[{inicio:`14:00`,fin:`19:00`}],jueves:[{inicio:`10:00`,fin:`19:00`}],viernes:[],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-003`,nombre:`José Ramírez`,especialidad:`Percusión`,habilidades:[`percusión`,`batería`,`timbales`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`14:00`}],martes:[{inicio:`10:00`,fin:`14:00`}],miércoles:[{inicio:`10:00`,fin:`14:00`}],jueves:[{inicio:`10:00`,fin:`14:00`}],viernes:[{inicio:`10:00`,fin:`14:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}},{id:`m-004`,nombre:`Ana Luisa Herrera`,especialidad:`Cello`,habilidades:[`cello`,`contrabajo`,`música de cámara`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`19:00`}],martes:[],miércoles:[{inicio:`10:00`,fin:`19:00`}],jueves:[],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-005`,nombre:`Roberto Sánchez`,especialidad:`Guitarra`,habilidades:[`guitarra`,`cuatro`,`mandolina`],disponibilidad:{lunes:[{inicio:`15:00`,fin:`19:00`}],martes:[{inicio:`15:00`,fin:`19:00`}],miércoles:[{inicio:`15:00`,fin:`19:00`}],jueves:[{inicio:`15:00`,fin:`19:00`}],viernes:[{inicio:`15:00`,fin:`19:00`}],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-006`,nombre:`Luisa Fernanda Díaz`,especialidad:`Voz`,habilidades:[`voz`,`coro`,`técnica vocal`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`}],martes:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`}],jueves:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],viernes:[{inicio:`10:00`,fin:`13:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}}],a=[{id:`s-101`,nombre:`Salón Mozart (Grande)`,capacidad:30,piso:1,is_active:!0},{id:`s-102`,nombre:`Salón Beethoven (Mediano)`,capacidad:15,piso:1,is_active:!0},{id:`s-103`,nombre:`Salón Bach (Piano)`,capacidad:10,piso:2,is_active:!0},{id:`s-104`,nombre:`Salón Vivaldi (Violín)`,capacidad:8,piso:2,is_active:!0},{id:`s-105`,nombre:`Salón Chopin (Teclados)`,capacidad:12,piso:2,is_active:!0}],o=[{id:`c-001`,nombre:`Violín Inicial`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:10,total_alumnos:6,horarios:[]},{id:`c-002`,nombre:`Violín Intermedio`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:8,total_alumnos:5,horarios:[]},{id:`c-003`,nombre:`Piano Inicial A`,instrumento:`Piano`,maestro_principal_id:`m-002`,capacidad_maxima:12,total_alumnos:10,horarios:[]},{id:`c-004`,nombre:`Teoría y Solfeo I`,instrumento:`Solfeo`,maestro_principal_id:`m-006`,capacidad_maxima:25,total_alumnos:18,horarios:[]},{id:`c-005`,nombre:`Batería Básica`,instrumento:`Percusión`,maestro_principal_id:`m-003`,capacidad_maxima:6,total_alumnos:4,horarios:[]},{id:`c-006`,nombre:`Guitarra Clásica I`,instrumento:`Guitarra`,maestro_principal_id:`m-005`,capacidad_maxima:15,total_alumnos:11,horarios:[]},{id:`c-007`,nombre:`Cello y Cámara`,instrumento:`Cello`,maestro_principal_id:`m-004`,capacidad_maxima:8,total_alumnos:3,horarios:[]},{id:`c-008`,nombre:`Técnica Vocal A`,instrumento:`Voz`,maestro_principal_id:`m-006`,capacidad_maxima:10,total_alumnos:8,horarios:[]}],s=[];async function c(){let{data:e,error:n}=await t.from(`salones`).select(`id, nombre, capacidad, is_active`).eq(`is_active`,!0).order(`nombre`,{ascending:!0});if(n)throw Error(`Error al cargar salones reales: `+n.message);return e}async function l(){let{data:e,error:n}=await t.from(`clases`).select(`id, nombre, maestro_principal_id, capacidad_maxima, instrumento`).order(`nombre`,{ascending:!0});if(n)throw Error(`Error al cargar clases reales: `+n.message);let{data:r}=await t.from(`clase_horarios`).select(`*`),{data:i}=await t.from(`alumnos_clases`).select(`clase_id`);return(e||[]).map(e=>{let t=(r||[]).filter(t=>t.clase_id===e.id),n=(i||[]).filter(t=>t.clase_id===e.id).length;return{id:e.id,nombre:e.nombre,instrumento:e.instrumento||`General`,maestro_principal_id:e.maestro_principal_id,capacidad_maxima:e.capacidad_maxima||20,total_alumnos:n,duracion_minutos:e.duracion_minutos??null,horarios:t.map(e=>({dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id}))}})}async function u(){if(n.isDemoMode)return{maestros:i,salones:a,clases:o};try{let[e,t,n]=await Promise.all([r(),c(),l()]);return{maestros:e,salones:t,clases:n}}catch(e){throw console.error(`[horarioBuilderApi] Error fetching data:`,e),e}}async function d(e){if(n.isDemoMode){let t={id:`run-${Date.now()}`,created_at:new Date().toISOString(),estado:e.estado||`borrador`,periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas};return s.push(t),t}let{data:r,error:i}=await t.from(`schedule_runs`).insert([{periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas,estado:e.estado||`borrador`}]).select().single();if(i)throw console.error(`[horarioBuilderApi] Error saving run:`,i),Error(`No se pudo guardar la corrida de horario: `+i.message);return r}async function f(){if(n.isDemoMode)return s;let{data:e,error:r}=await t.from(`schedule_runs`).select(`*`).order(`created_at`,{ascending:!1});if(r)throw console.error(`[horarioBuilderApi] Error fetching runs:`,r),Error(`No se pudieron obtener las corridas de horarios`);return e}var p={lunes:{inicio:`10:00`,fin:`19:00`},martes:{inicio:`10:00`,fin:`19:00`},miércoles:{inicio:`10:00`,fin:`19:00`},jueves:{inicio:`10:00`,fin:`19:00`},viernes:{inicio:`10:00`,fin:`19:00`},sábado:{inicio:`09:00`,fin:`13:00`},domingo:{inicio:`00:00`,fin:`00:00`}},m=[{id:`S1-2026`,nombre:`Semestre 1 (Ene–Jul 2026)`,inicio:`2026-01-01`,fin:`2026-07-31`},{id:`S2-2026`,nombre:`Semestre 2 (Ago–Dic 2026)`,inicio:`2026-08-01`,fin:`2026-12-31`}],h=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`}];function g(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function _(e,t){let n=g(e)+t,r=Math.floor(n/60),i=n%60;return`${String(r).padStart(2,`0`)}:${String(i).padStart(2,`0`)}`}function v(e,t){return g(t)-g(e)}function y(e){if(!e||!e.includes(`:`))return`00:00`;let[t]=e.split(`:`);return`${t.padStart(2,`0`)}:00`}function b(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function x(e){let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`}function S(e,t,n,r,i=0){return e<r+i&&n-i<t}function C(e,t,n){let r=e[t]||[],i=n[t];if(!i||i.inicio===`00:00`&&i.fin===`00:00`)return[];let a=b(i.inicio),o=b(i.fin),s=[];return r.forEach(e=>{let t=b(e.inicio),n=b(e.fin),r=Math.max(t,a),i=Math.min(n,o);r<i&&s.push({start:r,end:i})}),s}function ee(e,t,n){let r=100,i=e.salon.capacidad-t.totalAlumnos;r-=Math.min(i*2,40);let a=(n[e.teacher.id]||[]).reduce((e,t)=>e+(t.end-t.start),0)/60;return r-=Math.min(a*3,20),(n[e.teacher.id]||[]).some(t=>t.day===e.day&&(t.end===e.start||t.start===e.end))&&(r+=15),r}function te(e,t,n,r,i,a,o={}){let{excludeDays:s=new Set,requireSameSalon:c=null}=o,l=e.duracion,u=[];return Object.keys(t.jornada).forEach(o=>{if(s.has(o))return;let d=t.jornada[o];if(!d||d.inicio===`00:00`&&d.fin===`00:00`)return;let f=C(n.disponibilidad||{},o,t.jornada);if(f.length===0)return;let p=r.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1);c&&(p=p.filter(e=>e.id===c)),p.length!==0&&f.forEach(e=>{for(let r=e.start;r+l<=e.end;r+=30){let e=r+l;(i[n.id]||[]).some(n=>n.day===o&&S(r,e,n.start,n.end,t.gapMinimo))||p.forEach(i=>{(a[i.id]||[]).some(n=>n.day===o&&S(r,e,n.start,n.end,t.gapMinimo))||u.push({day:o,start:r,end:e,salon:i,teacher:n})})}})}),u}function ne({clasesConMaestro:e,maestros:t,salones:n,config:r}){let i={jornada:r?.jornada||p,gapMinimo:r?.gapMinimo===void 0?15:parseInt(r.gapMinimo),duracionBloque:r?.duracionBloque===void 0?60:parseInt(r.duracionBloque)},a=[],o=[],s={};t.forEach(e=>{s[e.id]=[]});let c={};n.forEach(e=>{c[e.id]=[]});let l=new Map,u=e.map(e=>{let n=t.find(t=>t.id===e.maestro_principal_id),r=0;return n&&n.disponibilidad&&Object.keys(n.disponibilidad).forEach(e=>{C(n.disponibilidad,e,i.jornada).forEach(e=>{r+=e.end-e.start})}),{...e,duracion:e.duracion||i.duracionBloque,totalAlumnos:e.total_alumnos||0,availableMinutes:r||1}});u.sort((e,t)=>e.availableMinutes===t.availableMinutes?t.totalAlumnos-e.totalAlumnos:e.availableMinutes-t.availableMinutes),u.forEach(e=>{let r=t.find(t=>t.id===e.maestro_principal_id);if(!r){o.push({clase_id:e.id,nombre:e.nombre,razon:`El maestro principal asignado (ID: ${e.maestro_principal_id}) no está registrado.`});return}let u=e.sesiones_por_semana??1,d=new Set;for(let t=0;t<u;t++){let u=te(e,i,r,n,s,c,{excludeDays:d,requireSameSalon:t>0?l.get(e.id)??null:null});if(u.length===0){if(t===0){let t=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1),i=`Sin disponibilidad compatible con maestro y salones.`;i=t.length===0?`No hay salones activos con capacidad suficiente para ${e.totalAlumnos} alumnos.`:`Conflicto de agenda: el maestro ${r.nombre} o los salones adecuados están ocupados en sus horas disponibles.`,o.push({clase_id:e.id,nombre:e.nombre,razon:i})}break}u.forEach(t=>{t.score=ee(t,e,s)}),u.sort((e,t)=>t.score-e.score);let f=u[0];a.push({clase_id:e.id,clase_nombre:e.nombre,maestro_id:r.id,maestro_nombre:r.nombre,salon_id:f.salon.id,salon_nombre:f.salon.nombre,dia:f.day,hora_inicio:x(f.start),hora_fin:x(f.end),duracion:e.duracion,color:re(r.id)}),s[r.id].push({day:f.day,start:f.start,end:f.end,classId:e.id}),c[f.salon.id].push({day:f.day,start:f.start,end:f.end,classId:e.id}),d.add(f.day),t===0&&l.set(e.id,f.salon.id)}});let d=e.length,f=new Set(a.map(e=>e.clase_id)).size,m=o.length,h={};n.forEach(e=>{let t=(c[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0),n=0;Object.keys(i.jornada).forEach(e=>{let t=i.jornada[e];t&&(t.inicio!==`00:00`||t.fin!==`00:00`)&&(n+=b(t.fin)-b(t.inicio))}),h[e.id]={nombre:e.nombre,porcentaje:Math.round(t/(n||1)*100)}});let g={};t.forEach(e=>{let t=(s[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0);g[e.id]={nombre:e.nombre,horas:Math.round(t/60*10)/10}});let _={};a.forEach(e=>{_[e.clase_id]=(_[e.clase_id]||0)+e.duracion/60});let v=d>0?f/d*100:100;return{assignments:a,noAsignadas:o,metricas:{totalClases:d,clasesAsignadas:f,clasesNoAsignadas:m,ocupacionSalones:h,cargaMaestros:g,score:Math.max(0,Math.round(v)),horasSemanalesPorGrupo:_}}}function re(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function w(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function ie(e,t,n=0){let r=w(e.hora_inicio),i=w(e.hora_fin),a=w(t.hora_inicio);return r<w(t.hora_fin)+n&&a-n<i}function T(e,{returnAnnotated:t=!1,gapMinutes:n=0}={}){let r=[],i=new Set;for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let o=e[t],s=e[a];o.dia===s.dia&&ie(o,s,n)&&(o.maestro_id&&o.maestro_id===s.maestro_id&&(r.push({type:`teacher`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.maestro_nombre} tiene dos clases al mismo tiempo: "${o.clase_nombre}" y "${s.clase_nombre}"`}),i.add(o.clase_id),i.add(s.clase_id)),o.salon_id&&o.salon_id===s.salon_id&&(r.push({type:`room`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.salon_nombre} está ocupado por "${o.clase_nombre}" y "${s.clase_nombre}" al mismo tiempo`}),i.add(o.clase_id),i.add(s.clase_id)))}return t?{conflicts:r,assignments:e.map(e=>({...e,hasConflict:i.has(e.clase_id)}))}:r}function ae({conflictDescription:e}){return new Promise(t=>{let n=document.createElement(`div`);n.className=`modal-backdrop fade show`,n.style.zIndex=`1040`;let r=document.createElement(`div`);r.className=`modal fade show d-block`,r.style.zIndex=`1050`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
  ...
  `}function me(e,t,n){let r=e.querySelector(`.cp-header`),i=e.querySelector(`.cp-body`),a=e.querySelector(`.cp-chevron`);r?.addEventListener(`click`,()=>{let e=i.style.display!==`none`;i.style.display=e?`none`:`block`,a.className=`bi ${e?`bi-chevron-down`:`bi-chevron-up`}`}),e.querySelectorAll(`.cp-row`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{e.style.background=`#fff1f2`}),e.addEventListener(`mouseleave`,()=>{e.style.background=`transparent`}),e.addEventListener(`click`,()=>{let r=parseInt(e.dataset.conflictIndex,10);isNaN(r)||!t[r]||n?.(t[r])})})}var N=[`borrador`,`revision`,`publicado`],he={borrador:`Borrador`,revision:`Revisión`,publicado:`Publicado`};function ge(e){let t=document.createElement(`li`);t.className=`pw-feedback-item d-flex align-items-start gap-2 mb-1`;let n=document.createElement(`span`);n.className=`badge bg-secondary`,n.textContent=e.tipo;let r=document.createElement(`span`);return r.textContent=e.comentario,t.appendChild(n),t.appendChild(r),t}function P(e,{runId:t,estadoActual:n,isAdmin:r,feedback:i=[],onEstadoChange:a,onFeedbackAdd:o}){let s=N.indexOf(n);e.innerHTML=`
    <div class="pw-wizard">
      ...
      <div class="${n}" data-stage="${e}">
        ...
        <span class="pw-stage-label">${he[e]}</span>
      </div>
      ${r}
    `}).join(``)}
      </div>
  ...
  `;let c=e.querySelector(`.pw-send-revision-btn`);c&&c.addEventListener(`click`,()=>a?.(`revision`));let l=e.querySelector(`.pw-approve-btn`);l&&l.addEventListener(`click`,()=>a?.(`publicado`));let u=e.querySelector(`.pw-add-feedback-btn`),d=e.querySelector(`.pw-feedback-input`);function f(){let e=d?.value?.trim();e&&(o?.({comentario:e,tipo:`observacion`}),d&&(d.value=``))}u&&u.addEventListener(`click`,f),d&&d.addEventListener(`keydown`,e=>{e.key===`Enter`&&f()});let p=e.querySelector(`.pw-feedback-list`);p&&(p.innerHTML=``,(i||[]).forEach(e=>p.appendChild(ge(e))))}async function F(e){let{data:n,error:r}=await t.from(`schedule_run_feedback`).select(`*`).eq(`run_id`,e).order(`created_at`,{ascending:!0});if(r)throw r;return n}async function I({runId:e,comentario:n,tipo:r=`observacion`}){let{data:i,error:a}=await t.from(`schedule_run_feedback`).insert([{run_id:e,comentario:n,tipo:r}]).select().single();if(a)throw a;return i}async function L(){let{data:{user:e}}=await t.auth.getUser();if(!e)return!1;let{data:n,error:r}=await t.from(`maestros`).select(`es_admin`).eq(`user_id`,e.id).single();return r||!n?!1:n.es_admin===!0}async function _e(e,n){let{data:r,error:i}=await t.from(`schedule_runs`).update({estado:n}).eq(`id`,e).select().single();if(i)throw i;return r}function ve({classes:e=[],config:t={}}){let n=e.filter(e=>!e.horarios||e.horarios.length===0),r=n.length>0?n.map(e=>`
  ...
  `}function ye(e){let t=e.querySelector(`#cp-start-time`),n=e.querySelector(`#cp-end-time`),r=e.querySelector(`#cp-sesiones`),i=e.querySelector(`#hb-input-duracion`),a=e.querySelector(`#hb-input-gap`);return{startTime:t?t.value:`15:30`,endTime:n?n.value:`18:30`,selectedDays:Array.from(e.querySelectorAll(`[data-day]`)).filter(e=>e.checked).map(e=>e.dataset.day),duracion:i?parseInt(i.value,10):60,gap:a?parseInt(a.value,10):15,sesionesPerSemana:r?parseInt(r.value,10):1}}var be=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];function xe(e,t,n=[]){return Object.fromEntries(be.map(r=>[r,n.includes(r)?{inicio:e,fin:t}:{inicio:`00:00`,fin:`00:00`}]))}var Se=`ABCDEFGHIJKLMNOPQRSTUVWXYZ`.split(``);function Ce(e,t){let n=t.filter(e=>e.is_active),r=n.length>0?Math.max(...n.map(e=>e.capacidad)):1,i=e.total_alumnos||0;if(i<=r)return[{...e,_isSubgroup:!1}];let a=Math.ceil(i/r),o=Math.floor(i/a),s=i%a;return Se.slice(0,a).map((t,n)=>{let r=o+ +(n<s);return{...e,id:`${e.id}_grupo_${t}`,nombre:`${e.nombre} — Grupo ${t}`,total_alumnos:r,_originalClaseId:e.id,_isSubgroup:!0,_groupLabel:t}})}function R(e,t){return e.flatMap(e=>Ce(e,t))}function z(){return{assignments:[],conflicts:[],activeView:`grid`,activePeriodo:m[0].id,periodoId:m[0].id,draggable:!1,conflictPanelExpanded:!1,constraintsExpanded:!1,scheduleRuns:[],loading:!1,error:null,undoStack:[],redoStack:[],estado:`borrador`,runId:null,isAdmin:!1,feedback:[],publishWizardOpen:!1,lastConfig:null,noAsignadas:[],metricas:null,runEstado:`borrador`}}var B=z(),V=null,H=null;function we(e){V=e,B=z(),W(),$(),f().then(e=>{B.scheduleRuns=e||[]}).catch(e=>console.warn(`[horarioBuilderView] getScheduleRuns failed:`,e)),L().then(e=>{B.isAdmin=e}).catch(()=>{})}function Te(){let e={borrador:{color:`#f59e0b`,bg:`rgba(245,158,11,0.12)`,icon:`bi-pencil-fill`,label:`Borrador`},en_revision:{color:`#3b82f6`,bg:`rgba(59,130,246,0.12)`,icon:`bi-eye-fill`,label:`En revisión`},publicado:{color:`#10b981`,bg:`rgba(16,185,129,0.12)`,icon:`bi-check-circle-fill`,label:`Publicado`},archivado:{color:`#6b7280`,bg:`rgba(107,114,128,0.12)`,icon:`bi-archive-fill`,label:`Archivado`}},t=e[B.estado]??e.borrador;return`<span style="display:inline-flex;align-items:center;gap:0.3rem;padding:0.2rem 0.6rem;border-radius:20px;font-size:0.72rem;font-weight:600;background:${t.bg};color:${t.color};">
    <i class="bi ${t.icon}" style="font-size:0.65rem;"></i>${t.label}
  </span>`}function U(){let e=B.assignments.length,t=B.conflicts.length,n=B.assignments.filter(e=>e.locked).length,r=B.undoStack.length;return`
  ...
  `}function W(){let e=m.map(e=>`<option value="${e.id}" ${e.id===B.activePeriodo?`selected`:``}>${e.nombre}</option>`).join(``),t=B.draggable,n=B.assignments.length>0;V.innerHTML=`
    <div class="hb-view">
      ...
      <div class="hb-collapse-panel hb-collapse-panel--constraints">
        <button class="hb-collapse-toggle" id="hb-toggle-constraints" type="button" aria-expanded="${B.constraintsExpanded?`true`:`false`}">
          <span class="d-flex align-items-center gap-2">
            <i class="bi ${B.constraintsExpanded,`bi-sliders`}"></i>
            <strong>Configuración avanzada</strong>
          </span>
          <span class="hb-collapse-toggle__meta">
            ${B.constraintsExpanded?`Ocultar`:`Mostrar`}
            <i class="bi ${B.constraintsExpanded?`bi-chevron-up`:`bi-chevron-down`}"></i>
          </span>
        </button>
        <div class="hb-collapse-panel__body ${B.constraintsExpanded?`is-open`:`is-collapsed`}" id="hb-constraint-panel-shell">
      ...
      <div class="hb-toolbar-main">
        ...
        <div class="hb-toolbar-group hb-toolbar-group--views">
          ...
          <div id="hb-view-toggle-slot">${M(B.activeView)}</div>
        </div>
        <div class="hb-toolbar-divider"></div>
        <div class="hb-toolbar-group">
      ...
      <div class="hb-collapse-panel hb-collapse-panel--conflicts">
        <button class="hb-collapse-toggle" id="hb-toggle-conflicts" type="button" aria-expanded="${B.conflictPanelExpanded?`true`:`false`}" ${B.conflicts.length===0?`disabled`:``}>
          <span class="d-flex align-items-center gap-2">
            <i class="bi bi-exclamation-triangle"></i>
            <strong>Conflictos</strong>
            <span id="hb-conflict-count" class="hb-collapse-count">${B.conflicts.length>0?`(${B.conflicts.length})`:``}</span>
          </span>
          <span class="hb-collapse-toggle__meta">
            ${B.conflictPanelExpanded?`Ocultar`:`Mostrar`}
            <i class="bi ${B.conflictPanelExpanded?`bi-chevron-up`:`bi-chevron-down`}"></i>
          </span>
        </button>
        <div class="hb-collapse-panel__body ${B.conflictPanelExpanded&&B.conflicts.length>0?`is-open`:`is-collapsed`}" id="hb-conflict-panel-shell">
  ...
  `}function De(){if(document.getElementById(`hb-shell-styles`))return;let e=document.createElement(`style`);e.id=`hb-shell-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Oe(){let e=V?.querySelector(`#hb-stats-wrapper`);e&&(e.innerHTML=B.assignments.length>0?U():``)}function ke(){let e=V?.querySelector(`#hb-toggle-constraints`),t=V?.querySelector(`#hb-constraint-panel-shell`);if(e&&t){e.setAttribute(`aria-expanded`,B.constraintsExpanded?`true`:`false`);let n=e.querySelector(`.hb-collapse-toggle__meta`);n&&(n.innerHTML=`${B.constraintsExpanded?`Ocultar`:`Mostrar`} <i class="bi ${B.constraintsExpanded?`bi-chevron-up`:`bi-chevron-down`}"></i>`),t.classList.toggle(`is-open`,B.constraintsExpanded),t.classList.toggle(`is-collapsed`,!B.constraintsExpanded)}let n=V?.querySelector(`#hb-toggle-conflicts`),r=V?.querySelector(`#hb-conflict-panel-shell`);if(n&&r){n.disabled=B.conflicts.length===0,n.setAttribute(`aria-expanded`,B.conflictPanelExpanded?`true`:`false`);let e=n.querySelector(`#hb-conflict-count`);e&&(e.textContent=B.conflicts.length>0?`(${B.conflicts.length})`:``);let t=n.querySelector(`.hb-collapse-toggle__meta`);t&&(t.innerHTML=`${B.conflictPanelExpanded?`Ocultar`:`Mostrar`} <i class="bi ${B.conflictPanelExpanded?`bi-chevron-up`:`bi-chevron-down`}"></i>`),r.classList.toggle(`is-open`,B.conflictPanelExpanded&&B.conflicts.length>0),r.classList.toggle(`is-collapsed`,!(B.conflictPanelExpanded&&B.conflicts.length>0))}}function G(){let e=V.querySelector(`#hb-grid-wrapper`);e&&(Oe(),e.innerHTML=de({assignments:B.assignments,activeView:B.activeView,draggable:B.draggable,periodoId:B.activePeriodo}))}function K(){let e=V.querySelector(`#hb-conflict-panel-wrapper`);if(!e)return;let t=e.querySelector(`.cp-body`);t&&(B.conflictPanelExpanded=t.style.display===`block`),e.innerHTML=pe(B.conflicts,B.conflictPanelExpanded),me(e,B.conflicts,e=>{let t=V.querySelector(`.hb-view`);e.ids.forEach(e=>{let n=t?.querySelector(`[data-clase-id="${e}"]`);n&&(n.scrollIntoView({behavior:`smooth`,block:`nearest`}),n.classList.add(`hb-highlight`),setTimeout(()=>n.classList.remove(`hb-highlight`),1500))})}),ke()}function Ae(){let e=V.querySelector(`#hb-view-toggle-slot`);e&&(e.innerHTML=M(B.activeView))}function q(){let e=V.querySelector(`#hb-publish-wrapper`);if(e){if(!B.publishWizardOpen||!B.runId){e.style.display=`none`;return}e.style.display=``,P(e,{runId:B.runId,estadoActual:B.estado,isAdmin:B.isAdmin,feedback:B.feedback,async onEstadoChange(e){try{await _e(B.runId,e),B.estado=e,q()}catch(e){console.error(`[horario-builder] estado update failed:`,e)}},async onFeedbackAdd({comentario:e,tipo:t}){try{let n=await I({runId:B.runId,comentario:e,tipo:t});B.feedback=[...B.feedback,n],q()}catch(e){console.error(`[horario-builder] feedback add failed:`,e)}}})}}function J(e){B.loading=e;let t=V.querySelector(`#hb-status`);t&&(t.innerHTML=e?`<div class="d-flex align-items-center gap-2 mt-2 text-muted" style="font-size:0.85rem;">
         <div class="spinner-border spinner-border-sm" role="status"></div>
         <span>Generando horario optimizado…</span>
       </div>`:``)}function Y(t,n=`success`){if(n===`danger`){e.error(t);return}if(n===`warning`){e.show(t,`warning`);return}e.success(t)}function X(e){return JSON.parse(JSON.stringify(e))}function Z(){let e=V?.querySelector(`#hb-undo-btn`),t=V?.querySelector(`#hb-redo-btn`);e&&(e.disabled=B.undoStack.length===0),t&&(t.disabled=B.redoStack.length===0)}function Q(){H&&H.destroy(),B.draggable&&(H=oe(V.querySelector(`#hb-grid-wrapper`),{assignments:B.assignments,onMove({claseId:e,fromDay:t,fromHour:n,toDay:r,toHour:i}){B.undoStack.push(X(B.assignments)),B.redoStack=[];let a=B.assignments.findIndex(t=>t.clase_id===e);if(a===-1)return;let o={...B.assignments[a]},s=v(o.hora_inicio,o.hora_fin);o.dia=r,o.hora_inicio=i,o.hora_fin=_(i,s),B.assignments[a]=o;let{conflicts:c,assignments:l}=T(B.assignments,{returnAnnotated:!0});B.conflicts=c,B.assignments=l,G(),K(),Z(),Q()},async onConflict({assignment:e,targetDay:t,targetHour:n,conflicts:r}){let i=V.querySelector(`#hb-drag-toggle`);[i,V.querySelector(`#hb-undo-btn`),V.querySelector(`#hb-redo-btn`)].forEach(e=>{e&&(e.disabled=!0)});try{if(!await ae({conflictDescription:r.map(e=>e.description).join(`
`)}))return;B.undoStack.push(X(B.assignments)),B.redoStack=[];let i=B.assignments.findIndex(t=>t.clase_id===e.clase_id);if(i===-1)return;let a={...B.assignments[i]},o=v(a.hora_inicio,a.hora_fin);a.dia=t,a.hora_inicio=n,a.hora_fin=_(n,o),B.assignments[i]=a;let s=T(B.assignments,{returnAnnotated:!0});B.conflicts=s.conflicts,B.assignments=s.assignments,G(),K(),Z(),Q()}finally{i&&(i.disabled=!1),Z()}}}))}function $(){V.addEventListener(`change`,e=>{e.target.id===`hb-periodo-select`&&(B.activePeriodo=e.target.value,G())}),V.addEventListener(`click`,async e=>{if(e.target.closest(`#hb-toggle-constraints`)){B.constraintsExpanded=!B.constraintsExpanded,W(),$();return}if(e.target.closest(`#hb-toggle-conflicts`)){if(B.conflicts.length===0)return;B.conflictPanelExpanded=!B.conflictPanelExpanded,W(),$();return}let t=e.target.closest(`.vt-pill[data-view]`);if(t){let e=t.dataset.view;A.includes(e)&&e!==B.activeView&&(B.activeView=e,Ae(),G());return}if(e.target.closest(`#hb-drag-toggle`)){B.draggable=!B.draggable;let e=V.querySelector(`#hb-drag-toggle`);e&&(e.innerHTML=B.draggable?`<i class="bi bi-unlock-fill"></i> Bloqueando`:`<i class="bi bi-lock-fill"></i> Editar`),G(),Q();return}if(e.target.closest(`#hb-undo-btn`)){if(B.undoStack.length===0)return;B.redoStack.push(X(B.assignments)),B.assignments=B.undoStack.pop();let e=T(B.assignments,{returnAnnotated:!0});B.conflicts=e.conflicts,B.assignments=e.assignments,G(),K(),Z(),Q();return}if(e.target.closest(`#hb-redo-btn`)){if(B.redoStack.length===0)return;B.undoStack.push(X(B.assignments)),B.assignments=B.redoStack.pop();let e=T(B.assignments,{returnAnnotated:!0});B.conflicts=e.conflicts,B.assignments=e.assignments,G(),K(),Z(),Q();return}if(e.target.closest(`#hb-generate-btn`)){je();return}if(e.target.closest(`#hb-save-btn`)){Me();return}if(e.target.closest(`#hb-publish-btn`)){if(B.publishWizardOpen=!B.publishWizardOpen,B.publishWizardOpen&&B.runId)try{B.feedback=await F(B.runId)}catch{B.feedback=[]}q();return}})}async function je(){let e=V.querySelector(`#hb-generate-btn`);e&&(e.disabled=!0),J(!0);try{let e=await u(),t=V.querySelector(`#hb-constraint-panel-slot`),n=t?ye(t):{startTime:`10:00`,endTime:`19:00`,selectedDays:[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`],duracion:60,gap:15,sesionesPerSemana:1},r=xe(n.startTime,n.endTime,n.selectedDays),i=R((e.clases||[]).map(e=>({id:e.id,nombre:e.nombre,maestro_principal_id:e.maestro_principal_id,total_alumnos:e.total_alumnos||0,duracion:e.duracion_minutos??n.duracion,sesiones_por_semana:n.sesionesPerSemana})),e.salones||[]),a={jornada:r,gapMinimo:n.gap,duracionBloque:n.duracion,sesionesPerSemana:n.sesionesPerSemana};B.lastConfig=a,B.periodoId=B.activePeriodo;let o=ne({clasesConMaestro:i,maestros:e.maestros||[],salones:e.salones||[],config:a});B.noAsignadas=o.noAsignadas??[],B.metricas=o.metricas??{};let{conflicts:s,assignments:c}=T(o.assignments,{returnAnnotated:!0,gapMinutes:n.gap});B.assignments=c,B.conflicts=s,G(),K(),Q();let l=V.querySelector(`#hb-save-btn`);l&&(l.disabled=B.assignments.length===0),Y(s.length>0?`Horario generado con ${s.length} conflicto(s)`:`Horario optimizado sin conflictos`,s.length>0?`warning`:`success`)}catch(e){console.error(`[horarioBuilderView] handleGenerate error:`,e),Y(`Error al generar: `+e.message,`danger`)}finally{J(!1),e&&(e.disabled=!1)}}async function Me(){let e=V.querySelector(`#hb-save-btn`);e&&(e.disabled=!0,e.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Guardando…`);try{let e=B.assignments.map(e=>({...e,clase_id:e._originalClaseId??e.clase_id})),t=await d({periodo:B.periodoId??B.activePeriodo,config:B.lastConfig,resultado:{assignments:e,noAsignadas:B.noAsignadas??[]},metricas:B.metricas??{},estado:B.runEstado??`borrador`});if(t?.id){B.runId=t.id,B.estado=`borrador`;let e=V.querySelector(`#hb-publish-btn`);e&&(e.disabled=!1),Y(`Horario guardado como borrador`,`success`)}else Y(`Guardado incompleto: no se obtuvo ID del registro`,`warning`);B.error=null}catch(e){console.error(`[horarioBuilderView] handleSave error:`,e),B.error=e.message,Y(`Error al guardar: `+e.message,`danger`)}finally{e&&(e.disabled=!1,e.innerHTML=`<i class="bi bi-floppy-fill"></i> Guardar`)}}export{we as t};