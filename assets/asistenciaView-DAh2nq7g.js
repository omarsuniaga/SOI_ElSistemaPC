const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-Em9GML5O.js","assets/AppModal-Du6jXNYA.js","assets/supabase-Cgh_dhNB.js","assets/LevelCompletionModal-Du_KQRU_.js","assets/portalUtils-CkF82Yyk.js","assets/AchievementsSummaryModal-DrGzVr84.js"])))=>i.map(i=>d[i]);
import{i as e,r as t,s as n}from"./AppModal-Du6jXNYA.js";import{c as r,d as i,o as a,p as o,r as s}from"./pwaInstaller-CABasb_l.js";import{a as c,i as l}from"./supabase-Cgh_dhNB.js";import{i as u}from"./maestroAuth-BMzDPnai.js";import{c as d,n as f,r as p,s as m,t as h}from"./main-maestros-C695pwkc.js";import{S as g}from"./planificacion-BdwKIwFz.js";import{t as _}from"./config-CNiOV0RX.js";import{l as v}from"./asistenciasApi-ZGiUeNEl.js";import{t as y}from"./aiEvaluacionService-_0RGpDzq.js";import{_ as b,v as x,x as S}from"./mapaClaseService-DaoOTdhF.js";import{t as C}from"./observacion.model-DmAlB4Ru.js";import{a as w,c as T,l as E,n as ee,s as D,u as O}from"./groqService-BEo2aU8D.js";import{a as k,i as te,r as ne}from"./reportService-C177RavV.js";import{t as A}from"./academicService-Em9GML5O.js";import{t as j}from"./calificacionIndicadorPanel-BK40cdMQ.js";import{a as re,i as M,l as N,o as P,s as ie}from"./portalUtils-CkF82Yyk.js";import{t as ae}from"./a11yUtils-DRYT20ux.js";import{a as F,c as I,d as oe,i as L,l as R,n as z,o as B,r as se,s as ce,t as le}from"./weeklyPlanAdapter-CtmEncUW.js";import{a as ue,i as de,n as fe,o as pe,r as me}from"./evaluationService-DR8xmANz.js";import{n as he,r as V}from"./catalogService-M5LBxZnn.js";function ge(e={}){let{showSyncButton:t=!0}=e,n=document.createElement(`div`);n.className=`pm-sync-badge`,n.style.cssText=`
    display: none;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{_e(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function ye(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,Te=class{constructor(e,t=Ce){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(xe)||(this._autoTimer=setTimeout(()=>this.start(),Se))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(xe,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=we,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `}function ke(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${H(W(e.updated_at||e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Estado: ${G(e.status).label}</span>
  ...
  `}function Ae(e){return e.length?e.map((e,t)=>`
    <div class="pm-route-indicador pm-route-indicador--${H(e.semColor)}"
      ...
      <div class="pm-route-indicador__info">
        ...
        <span class="pm-route-indicador__stats">
          ${e.latestStatus===`not_started`?`Sin evaluar`:`Estado: ${G(e.latestStatus).label}`}
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores cargados para este nivel.</p>`}function je(e,{indicatorSummaries:t,avance:n}){return`
    ${Oe(e,n)}
  ...
  `}function Pe({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a,onProgressSaved:o}){Ee();let s=document.createElement(`aside`);s.className=`pm-student-panel`,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-modal`,`false`),s.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(s);let c=[],l=null;function d(){ie()===`desktop`?s.classList.add(`pm-student-panel--desktop`):s.classList.remove(`pm-student-panel--desktop`)}let f=N(d);d();function p(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){v();return}if(n===`toggle-history`){let e=t.dataset.idx,n=s.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;m(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;m(e,n);return}}async function m(e,t=null){let n=c[e],r=t===null?null:n.history[t],i=r?.status??`not_started`,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-status]`);if(t){a.querySelectorAll(`[data-status]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=t.dataset.status;return}let r=e.target.closest(`[data-action]`)?.dataset.action;if(r===`modal-close`)a.remove();else if(r===`modal-save`){let e=a.querySelector(`#modal-obs`).value,t=a.querySelector(`#modal-evidence`).value;await g(n.id,i,e,t),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function g(t,r,i,a){try{if(!u())throw Error(`No hay sesión de maestro activa.`);await oe(e.id,t,r,i.trim(),a.trim(),n),typeof o==`function`&&await o({alumnoId:e.id,indicatorId:t,status:r}),await _()}catch(e){console.error(`[studentProgressPanel] Error saving:`,e),alert(`Error al guardar: `+(e.message||e))}}s.addEventListener(`click`,p),s.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function _(){s.innerHTML=Me(),s.classList.add(`pm-student-panel--open`),l&&l.dispose(),l=h(s,{onClose:()=>v()});try{let n=await K(e.id,t,r);c=n.indicatorSummaries,s.innerHTML=je(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading:`,e),s.innerHTML=Ne(e?.message??`Error desconocido al cargar datos.`)}}function v(){s.classList.remove(`pm-student-panel--open`),l&&=(l.dispose(),null),setTimeout(()=>{s.classList.contains(`pm-student-panel--open`)||(s.innerHTML=``,c=[])},300)}function y(){l&&=(l.dispose(),null),f(),s.removeEventListener(`click`,p),s.remove()}return{open:_,close:v,destroy:y}}var Fe={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Ie={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Le={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function q(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Re(e){return(e||``).trim().toLowerCase()}function ze(e){let t=new Map;for(let n of e){let e=Re(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Be(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Le[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Le[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=Fe[e.estado]||Fe.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Ie[e.estado]||``}`:`ssp-alumno-chip`}">${q(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${q(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${q(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${q(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${q(i)} · ${q(a)}</div>
          </div>
        </div>
    ...
    `,Ve(),e.querySelector(`#ssp-whatsapp`).onclick=()=>{let e=n(i,a);window.open(`https://wa.me/?text=${encodeURIComponent(e)}`,`_blank`)},e.querySelector(`#ssp-close`).onclick=o,e.querySelector(`.ssp-backdrop`).onclick=o}async function a({sesionId:n,claseNombre:r,fecha:a,supabase:s}){e||(e=document.createElement(`div`),e.className=`ssp-wrapper`,document.body.appendChild(e)),e.style.display=`flex`,e.innerHTML=`
      ...
      <div class="ssp-dialog">
        <div class="ssp-header">
          <span class="ssp-icon">📊</span>
          <div><strong>Resumen Pedagógico</strong><div class="ssp-subtitle">${q(r)}</div></div>
        </div>
...
`),s=[];for(let e of o){let t=ue(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Qe({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function et({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await l.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:J(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=J(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await l.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var tt={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},nt=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Y(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var rt={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function it(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=rt[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function at(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n.join(`, `))}</span>`:``}}function o(e,t){let n=tt[e.estado]??tt.EN_PROGRESO,r=e.nota?` · ${Y(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Y(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=rt[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${it(c)}</div>`:``,d=O(r),f=d.length>0?`
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function jt(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        ...
        <p class="pm-asist-subtitle">
          ...
          <span style="color:var(--pm-primary); font-weight:700;">${re(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `;let d=e.querySelector(`#pm-asist-back`);return d&&u(d,`click`,c),{destroy(){l.forEach(e=>{try{e()}catch{}}),l.length=0}}}function Mt(e,{editor:t,toolbar:n}){let r=!1;return{inject(i,a){if(r||!i||i.claseId!==a)return;let o=`[${i.nombre}] `;t.insertText(o),n.setContext({indicadorActivo:i.nombre});let s=e.querySelector(`#btn-guardar-obs`);s&&(s.style.display=``);let c=e.querySelector(`#pm-dsl-editor-container`);if(c){let e=c.parentElement.querySelector(`.pm-ruta-tema-banner`);e&&e.remove();let t=document.createElement(`div`);t.className=`pm-ruta-tema-banner`,t.style.cssText=`
    ...
    `,document.head.appendChild(e)}function v(){return typeof n.getSessionState==`function`?n.getSessionState():{isRegistered:!1}}async function y(e){return!e||!n.claseId||!n.maestro?.id?{}:(await L(n.claseId,n.maestro.id,e).catch(()=>[])).reduce((e,t)=>(e[String(t.week_number)]=t,e),{})}function b(e){let t=o[String(e.week_number)]||null;return{...e,teacher_strategy:t?.teacher_strategy||e.teacher_strategy,student_activity:t?.student_activity||e.student_activity,homework:t?.homework||e.homework,evidence:t?.evidence||e.evidence,teacher_notes:t?.teacher_notes||``,hasTeacherAdjustment:!!t}}async function x(){try{if(c.style.display=``,r=await R(n.claseId),!r)if(_.isDemoMode)r=await z({group_id:n.claseId,weekly_plan_id:`wplan-violin-n0`,level_id:`pnivel_001`,teacher_id:n.maestro?.id||`maestro_001`});else{u&&(u.textContent=`Sin guía ACM asignada`),f&&(f.innerHTML=`
    ...
    `;let a=()=>i.remove();i.querySelectorAll(`[data-close-modal]`).forEach(e=>{e.onclick=a}),i.onclick=e=>{e.target===i&&a()};let o=i.querySelector(`#pm-weekly-adjustment-form`);o.onsubmit=async i=>{i.preventDefault();let s=new FormData(o);try{await se({group_id:n.claseId,teacher_id:n.maestro?.id,weekly_plan_id:r?.weekly_plan_id,week_number:t.week_number,teacher_strategy:String(s.get(`teacher_strategy`)||``).trim(),student_activity:String(s.get(`student_activity`)||``).trim(),homework:String(s.get(`homework`)||``).trim(),evidence:String(s.get(`evidence`)||``).trim(),teacher_notes:String(s.get(`teacher_notes`)||``).trim()}),e.success(`Ajuste docente guardado sin modificar la guía ACM.`),a(),await x()}catch(t){console.error(`[PlanificationCard] Error guardando ajuste docente:`,t),e.error(t.message||`No se pudo guardar el ajuste docente.`)}},document.body.appendChild(i)}function T(){if(!f||!i)return;let e=r.current_week||1,a=(i.items||[]).find(t=>t.week_number===e),o=a?b(a):null;if(!o){f.innerHTML=`<div style="padding:10px;font-size:0.8rem;color:var(--pm-text-muted);">No hay planificación registrada para la Semana ${e}</div>`;return}let s=t.querySelector(`#pm-active-tema-badge`);s&&(s.textContent=`Semana ${e}: ${o.topic}`,s.style.display=`inline-block`),f.innerHTML=`
      ...
      ${C(e)}
    `,f.querySelector(`.pm-weekly-nav-btn.prev`).onclick=async t=>{t.stopPropagation(),e>1&&(r=await le(r.id,e-1),await x())},f.querySelector(`.pm-weekly-nav-btn.next`).onclick=async t=>{t.stopPropagation(),e<i.items.length&&(r=await le(r.id,e+1),await x())};let c=f.querySelector(`#btn-eval-indicator-weekly`);c&&(c.onclick=e=>{e.stopPropagation(),n.onIndicadorSelect?.({id:o.indicator_id,nombre:o.topic,node_id:o.node_id})});let l=f.querySelector(`#btn-edit-weekly-adjustment`);l&&(l.onclick=e=>{e.stopPropagation(),w(o)})}x();function E(){s.forEach(e=>{try{e()}catch{}}),s.length=0}return{destroy:E,getActiveIndicador:()=>{if(!i||!r)return null;let e=i.items.find(e=>e.week_number===r.current_week);return e?{id:e.indicator_id,nombre:e.topic}:null},refreshTree:async()=>{await x()},getActivePlanificacionId:()=>r?.weekly_plan_id||null}}var X=null,Z=[],Ft=null,Q=-1,It=!1,Lt=null,Rt=!1,zt=0,Bt=0;function Vt(){if(!X){if(X=document.createElement(`div`),X.id=`pm-autocomplete-popup`,X.className=`pm-autocomplete-popup`,X.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
...
¿Guardar la evaluación?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:t}=await me(n.sesionId,a.id,o.evaluaciones,n.maestro.id,e);if(t)throw t}let s={indicador_id:a.id,evaluaciones:o.evaluaciones};await Dn(n.sesionId,n.maestro.id,i,s,o.dslGenerado||null,o.textoMejorado||null);let l=ue(i);if(l.estados&&l.estados.length>0){let e=n.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));$e({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,dslText:i,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Ot(e,n.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await Mn(n.sesionId,n.claseId,n.maestro.id,o.evaluaciones,n.claseNombre||`Clase`,e);if(u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),n.planificationCard&&await n.planificationCard.refreshTree(),n.setEditorValue(``),n.onDslContentClear&&n.onDslContentClear(),In(o.evaluaciones.length,a.nombre),n.activeClassEventId){try{await Nn(n.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(n.activeLevel)try{let{academicService:t}=await c(async()=>{let{academicService:e}=await import(`./academicService-Em9GML5O.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2]));for(let r of e){let e=await t.checkLevelCompletion(r.id,n.activeLevel);if(e&&e.status===`approved`){let{createLevelCompletionModal:e}=await c(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-Du_KQRU_.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([3,2,4])),t=e({studentId:r.id,levelId:n.activeLevel});n.onAppendModal?.(t.el||t)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&n.claseId&&a?.nombre){let{error:e}=await Ze({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,contenido:a.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(n.sesionId){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-Em9GML5O.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),r=await e.processSessionClosure(n.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:e}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DrGzVr84.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4]));await e(t,r)}}r.textContent=`¡Guardado!`,setTimeout(()=>{r.textContent=`Guardar observación`,r.disabled=!1},2e3)}catch(t){console.error(`[asistencia] Error saving observation:`,t),e.error(`Error al guardar: `+(t.message||t)),r.disabled=!1,r.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function In(e,t){let n=document.createElement(`div`);n.innerHTML=`
  ...
  `}async function Qn(t,{onError:n,silent:r=!1}={}){try{return await t()}catch(t){return console.error(`[safeAsync]`,t),n?n(t):r||e!==void 0&&e&&e.error(`Error inesperado: `+(t.message||t)),null}}async function $n(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await l.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){i?.navigate?i.navigate(`fechas`):window.location.hash=`#/fechas`;return}let s=new Date,c=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,`0`)}-${String(s.getDate()).padStart(2,`0`)}`,u=n||a.fecha||c,d={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let f=Array.isArray(a.asistencia)?a.asistencia:[],p=f.map(e=>e.alumno_id).filter(Boolean),m=[];if(p.length>0){let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,p);m=e||[]}let h={},g={};m.forEach(e=>{h[e.id]=null}),f.forEach(e=>{e.estado&&m.some(t=>t.id===e.alumno_id)&&(h[e.alumno_id]=e.estado)});let _=tr(e,{clase:d,horario:null,alumnos:m,estado:h,justificaciones:g,maestro:r,fechaHoy:u,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i});return typeof _==`function`?_:void 0}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${M(t.message)}</p>`}}async function er(e,{claseId:t,fecha:n,sesionId:o,router:c}={}){let d=typeof e==`string`?document.getElementById(e):e;if(!d){console.error(`[asistenciaView] Container not found:`,e);return}d.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let f=u();if(!f){d.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(o)return $n(d,{sesionId:o,fecha:n,maestro:f,router:c});c?.navigate?c.navigate(`fechas`):window.location.hash=`#/fechas`;return}localStorage.setItem(`pm_active_clase_id`,t);let p=new Date,m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,h=n||m;try{let e=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,u,m]=await Promise.all([r(),s([t]),a([t]),l.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,f.id).eq(`fecha`,h).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),g=n.find(e=>e.id===t);if(!g){d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let _=o.find(t=>t.dia?.toLowerCase()===e),v=(u||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),y=m.data||[],b=y[0]||null,x=(()=>{let e=new Map;for(let t of[...y].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),S=Array.isArray(b?.asistencia)?b.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(b?.tipo===`emergente`&&S.length>0){let e=new Set(S),t=new Set(v.map(e=>e.id)),n=S.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);v=v.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}v=v.filter(t=>e.has(t.id))}let C=b?.id||null,w=b?.updated_at||null,T=b?.contenido||``,E=g.salon?[g.salon]:[],[ee,D]=await Promise.all([C?l.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?i(E):Promise.resolve([])]),O=D.length>0?D[0].nombre:null,k=`pm_asistencia_${t||C}_${h}`,te=localStorage.getItem(`${k}_updated`),ne=!1;w&&te&&new Date(w).getTime()>new Date(te).getTime()+5e3&&(ne=!0);let A=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await l.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();A=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let j={},re={};v.forEach(e=>{j[e.id]=null});let M=x,N={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(M.length===0)try{let e=null,n=y.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:t}=await l.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);e=t}if((!e||e.length===0)&&t&&h){let{data:n}=await l.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,h);e=n}e?.length>0&&(M=e.map(e=>({alumno_id:e.alumno_id,estado:N[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}M.forEach(e=>{if(Object.prototype.hasOwnProperty.call(j,e.alumno_id)){let t=N[e.estado]??e.estado;j[e.alumno_id]=t}});let P=[];if(C)try{P=await l.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),P.forEach(e=>{Object.prototype.hasOwnProperty.call(j,e.alumno_id)&&(j[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}tr(d,{clase:g,horario:_,alumnos:v,estado:j,justificaciones:re,maestro:f,fechaHoy:h,claseId:t,sesionId:C,hasConflict:ne,serverDSL:T,snapshots:ee,salonNombre:O,rutaId:A,sesionExistenteData:b,router:c})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${M(e.message)}</p>`}}function tr(t,n){let{clase:r,horario:i,alumnos:a,estado:s,justificaciones:u,maestro:d,fechaHoy:h,claseId:_,snapshots:y,serverDSL:b,hasConflict:x,salonNombre:S,rutaId:C,sesionExistenteData:E,router:O}=n,A=n.sesionId,j=!!n.sesionId&&(E?.borrador===!1||E?.estado===`registrada`||E?.estado===`cerrada`),re=e=>{if(O?.navigate){O.navigate(e);return}window.location.hash=`#/${e}`},M=[],N=`pm_asistencia_${_||A}_${h}`,P=b,ie=null,F=qe(),I=null,oe=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
    ...
    <!-- Modales... -->
  `;let L=jt(t.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:S,fechaHoy:h,totalAlumnos:a.length,hasConflict:x,onBack:()=>{ke.destroy();try{Ee.close()}catch{}M.forEach(e=>{try{e()}catch{}}),re(`hoy`)}});M.push(()=>L.destroy());let R=t.querySelector(`#pm-sync-badge-container`);if(R){let e=ge();R.appendChild(e.el)}let z=mn(t,{initialContent:b,claseId:_,onEditorChange:e=>{P=e,le?.onTextoCambia(e)}}),B=z.getEditor(),se=t.querySelector(`#pm-dsl-editor-container`),ce={codigo:null,origen:null},le=xn(t.querySelector(`.pm-asist-dsl-section`)||t,{onChange:async({codigo:e,origen:t})=>{if(ce={codigo:e,origen:t},A)try{await yn(A,e,t)}catch(e){console.warn(`[asistencia] No se pudo guardar la categoría:`,e.message)}}});b&&le.analizarAhora(b);let ue=ye(t,{onAceptar:e=>{B.setValue(e)}}),de=be(t,{onAccept:e=>{B.setValue(e)}}),fe=at(se.parentNode,{onConfirm:async n=>{try{let e=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Qe({sesionId:A,claseId:_,maestroId:d.id,fechaHoy:h,progressRecords:n,alumnos:e});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=t.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(n){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e.error(`Error al guardar progreso: `+n.message)}},onCancel:()=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),me=dt(t.querySelector(`#pm-planificacion-dropdown`)||t,{onAdopt:async({instrumento:t,nivel:n,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await Et({instrumento:t,nivel:n,descripcion:r,pilares:i}),{linked:s}=await et({claseId:_,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;e.success(c)}catch(t){e.error(`Error al crear el plan: `+t.message)}},onCancel:()=>{}});z.initToolbar({onImproveClick:async n=>{let r=t.querySelector(`#btn-generar-informe`);r&&(r.disabled=!0);try{let e=await w(n);ue.open({original:n,improved:e})}catch(t){e.error(`Error al generar informe: `+t.message)}finally{r&&(r.disabled=!1)}},onStructureClick:async n=>{let r=t.querySelector(`#btn-ia-magic`);r&&(r.disabled=!0);try{let e=I?.getActiveIndicador(),t=await T(n,{presentes:a.filter(e=>s[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});de.open({original:n,dsl:t})}catch(t){e.error(`Error al estructurar con IA: `+t.message)}finally{r&&(r.disabled=!1)}},onAnalyzeClick:async n=>{await Qn(async()=>{let i=a.filter(e=>s[e.id]&&s[e.id]!==`A`),o=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},c=a.map(e=>e.nombre_completo||e.nombre||``),l={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,c)}}),presentes:i.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,c)}}),tipoClase:Dt(r),instrumento:r.instrumento||``,sesionesRecientes:(y||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:I?.getActiveIndicador()?.nombre||``};t.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let u=await ee(n,l);if(!u?.progreso?.length){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.warning(`La IA no detectó registros de progreso en este texto.`);return}fe.open({progreso:u.progreso,resumen:u.resumen})},{onError:n=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.error(`Error al analizar con IA: `+n.message)}})}});let he=z.getToolbar();I=Pt(t,{claseId:_,clase:r,maestro:d,fechaHoy:h,rutaId:C,editor:B,onIndicadorSelect:e=>{B.insertText(`[${e.nombre}] `),he&&he.setContext({indicadorActivo:e.nombre});let n=t.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getSessionState:()=>({isRegistered:j,hasContent:!!(P&&P.trim()),sessionId:A}),getDslContent:()=>B.getValue()}),M.push(()=>I.destroy());let V=t.querySelector(`#btn-proponer-curriculo`);V&&(V.onclick=async()=>{V.disabled=!0,V.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let t=await st(_,12);if(t.registros.length===0){e.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let n=await D(t,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});me.open({pilares:n.pilares,resumen:n.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(t){e.error(`Error al generar propuesta: `+t.message)}finally{V.disabled=!1,V.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let _e=t.querySelector(`#btn-ir-modo-sesion`);_e&&(_e.onclick=()=>{re(`planificacion-mapa-clase?clase=${_}`)});let xe=t.querySelector(`#btn-calificar-indicadores`);xe&&(xe.onclick=()=>{if(!A){e.warning(`Guardá la asistencia de hoy antes de calificar indicadores.`);return}Yn({claseId:_,fecha:h,evaluadoPor:d.id,getPresentes:()=>a.filter(e=>s[e.id]===`P`).map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``}))})});let Se=t.querySelector(`#btn-abrir-bitacora`);Se&&(Se.onclick=()=>{if(!A){e.warning(`Guardá la asistencia de hoy antes de abrir la bitácora de la sesión.`);return}Vn({sesionId:A,claseId:_,maestroId:d.id,onSaved:()=>e.success(`Bitácora guardada`)})});let Ce=Mt(t,{editor:B,toolbar:he}),we=pe();Ce.inject(we,_),M.push(()=>Ce.destroy());let Ee=An(t,{sesionId:A,getSesionId:()=>A,claseId:_,fechaHoy:h,maestroId:d.id,supabase:l,guardarJustificacion:We,eliminarJustificacion:Ke,onJustifDeleted:e=>{s[e]=null,delete u[e]},onJustifSaved:(e,t)=>{u[e]=t},onJustifCancelled:(e,t)=>{s[e]=t},onRenderLista:e=>U.render(e),onUpdateProgress:()=>De(),onAutoSave:e=>G(e),onAnnounce:e=>ae(e)});M.push(()=>{try{Ee.close()}catch{}});let H=On(t,{sesionId:A,maestroId:d.id,editor:B,sesionExistenteData:E,onDraftRecovered:e=>{P=e,B.setValue(e)}});M.push(()=>H.destroy()),t.querySelector(`#pm-academic-tools`),Fn(t,{rutaId:C,sesionId:A,claseId:_,maestro:d,fechaHoy:h,alumnos:a,estado:s,planificationCard:I,editorContainer:se,getEditorValue:()=>B.getValue(),setEditorValue:e=>B.setValue(e),onDslContentClear:()=>{P=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:e=>{let n=t.querySelector(`.pm-asist-root`);n&&n.appendChild(e)}});let U=jn(t,{alumnos:a,estado:s,rutaId:C,canOpenProgressPanel:!!(_||C),sesionId:A,fechaHoy:h,snapshots:y,justificaciones:u,obtenerJustificacion:Ge,eliminarJustificacion:Ke,onJustifDeleted:e=>{delete u[e]},onEstadoChange:(e,t)=>{s[e]=t},onOpenProgressPanel:e=>{W&&W.destroy(),W=Pe({alumno:e,rutaId:C,sessionId:A,claseId:_,fecha:h,horaInicio:i?.hora_inicio||null,onProgressSaved:async()=>{I?.refreshTree&&await I.refreshTree()}}),W.open(),M.push(()=>{W&&W.destroy()})},onOpenEvaluationDrawer:(e,n)=>{ve(t,{student:e,sessionId:A,teacherId:d.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{Ee.open(e,t,n)},onAutoSave:e=>G(e),onAnnounce:e=>ae(e),onUpdateSnapshots:e=>{y.push(...e)}});M.push(()=>U.destroy());let W=null;function De(){let e=a.length,n=Object.values(s).filter(e=>e!==null).length,r=t.querySelector(`#pm-progress-wrap`),i=t.querySelector(`#pm-progress-fill`),o=t.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/e*100}%`,o.textContent=`${n}/${e}`}async function G(e=!1,t=!1){ie&&clearTimeout(ie);let n=async()=>{let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t={...A?{}:{clase_id:_},maestro_id:d.id,fecha:h,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:P||``,...ce.codigo?{node_codigo:ce.codigo,node_origen:ce.origen}:{}};if(e.length===0&&!(P||``).trim()&&A)try{await g(A),A=null,localStorage.removeItem(`${N}_updated`),console.log(`[asistencia] Borrador vaciado y eliminado automáticamente`);return}catch(e){console.warn(`[asistencia] Error al autolimpiar borrador:`,e)}if(navigator.onLine)try{if(A){let{error:e}=await l.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,A);if(!e){localStorage.setItem(`${N}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await l.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){A=e.id,console.log(`[asistencia] Nueva sesión creada:`,A),localStorage.setItem(`${N}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await m({tabla:`sesiones_clase`,operacion:A?`update`:`insert`,payload:{...A?{id:A}:{},...t}}),localStorage.setItem(`${N}_updated`,new Date().toISOString())};e?t?await n():await F.run(n):ie=setTimeout(()=>{F.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let K=t.querySelector(`.pm-asist-actions-fixed`);if(K){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),A&&(e.disabled=!0,e.innerHTML=`⏳...`,await ne(A),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=K.querySelector(`#btn-guardar`);K.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),_&&(n.disabled=!0,n.innerHTML=`⏳...`,await te(_,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),K.insertBefore(n,t)}t.querySelector(`#btn-guardar`).onclick=async()=>{let n=t.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await F.run(async()=>{try{let i=a.filter(e=>s[e.id]).map(e=>({..._?{clase_id:_}:{},alumno_id:e.id,fecha:h,estado:s[e.id],registrado_por:d.id})),u=i.length>0,y=P&&P.trim().length>0;if(!u&&!y)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await G(!0,!0),!A){let{data:e}=await l.from(`sesiones_clase`).select(`id`).eq(`clase_id`,_).eq(`maestro_id`,d.id).eq(`fecha`,h).maybeSingle();e&&(A=e.id)}if(u&&_)try{let e=i.map(e=>({...e,...A&&{sesion_clase_id:A}}));await v(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!A){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await m({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:_,alumno_id:e.alumno_id,fecha:h,estado:e.estado,registrado_por:d.id,...A?{sesion_clase_id:A}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(A&&(u||y)){let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),{error:t}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,A).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,A).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await l.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,A))}o(),p(`hoy`),p(`calendario`),p(`metricas`),f().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e)),j=!0,I?.refreshTree&&await I.refreshTree()}if(A){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-Em9GML5O.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),{createAchievementsSummaryModal:r}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DrGzVr84.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4])),i=await e.processSessionClosure(A);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(t,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let b=K?.querySelector(`#btn-reporte-dia`);b&&(b.style.display=``);let x=K?.querySelector(`#btn-resumen-mes`);x&&(x.style.display=``);let S=Object.values(s).filter(e=>e===`P`).length,C=Object.values(s).filter(e=>e===`A`).length;ae(`Sesión guardada exitosamente. ${S} presentes, ${C} ausentes.`);let w=document.createElement(`div`);w.className=`pm-saved-overlay`,w.innerHTML=`
      ...
      `,document.body.appendChild(w);let T=w.querySelector(`#btn-resumen-pedagogico`),ee=w.querySelector(`#btn-editar-asistencia`),D=w.querySelector(`#btn-compartir-correo`),O=w.querySelector(`#btn-compartir-whatsapp`),M=w.querySelector(`#btn-volver-hoy`),N=w.querySelector(`#btn-ir-calendario`);oe&&oe.destroy(),oe=Be();let ie=oe;T&&(T.onclick=()=>{ie.open({sesionId:A,claseNombre:r?.nombre||`Clase`,fecha:h,supabase:l})}),ee&&(ee.onclick=()=>{w.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),D&&(D.onclick=async()=>{let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${h}`),n=kt(e,P,a,r,h);At(`mailto:?subject=${t}&body=`,n,1800)}),O&&(O.onclick=async()=>{At(`https://wa.me/?text=`,kt(a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),P,a,r,h),1600)}),M&&(M.onclick=()=>{w.remove(),re(`hoy`)}),N&&(N.onclick=()=>{w.remove(),re(`fechas`)});let F=w.querySelector(`#btn-reporte-dia-overlay`);F&&(F.onclick=async()=>{let e=F.innerHTML;F.disabled=!0,F.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await ne(A)}finally{F.disabled=!1,F.innerHTML=e}});let L=t.querySelector(`#btn-descartar-borrador`);L&&L.addEventListener(`click`,async()=>{if(confirm(`¿Deseas descartar este borrador? La fecha se limpiará por completo.`))try{L.disabled=!0,L.innerHTML=`<span class="spinner-border spinner-border-sm" role="status"></span> Descartando...`,E?.id&&await g(E.id),e.show(`Borrador descartado correctamente`,`success`),o(),p(`calendario`),window.location.hash=`#/fechas`}catch(t){e.show(`Error al descartar: `+t.message,`danger`),L.disabled=!1,L.innerHTML=`<i class="bi bi-trash"></i> Descartar`}});let R=w.querySelector(`#btn-resumen-mes-overlay`);R&&(_?R.onclick=async()=>{let e=R.innerHTML;R.disabled=!0,R.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await te(_,e.getFullYear(),e.getMonth()+1)}finally{R.disabled=!1,R.innerHTML=e}}:(R.disabled=!0,R.title=`No disponible para actividades especiales`,R.style.opacity=`0.5`));let z=w.querySelector(`#btn-informe-ped-overlay`);z&&(_?z.onclick=async()=>{let e=z.innerHTML;z.disabled=!0,z.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await k(_,e.getFullYear(),e.getMonth()+1)}finally{z.disabled=!1,z.innerHTML=e}}:(z.disabled=!0,z.title=`No disponible para actividades especiales`,z.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};let Oe=Sn(t,{onMarkAll:async e=>{a.forEach(t=>{s[t.id]=e}),U.render(),De();try{await G(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}ae(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)},onClearAll:async()=>{a.forEach(e=>{s[e.id]=null}),U.render(),De();try{await G(!0)}catch(e){console.warn(`[asistencia] autoSave error on clear all:`,e)}ae(`Se desmarcaron las asistencias de todos los alumnos.`)}});M.push(()=>Oe.destroy()),U.render();let ke=new Te(t);ke.mount();let Ae=t.querySelector(`#pm-btn-help`);return Ae&&(Ae.onclick=()=>ke.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),ke.destroy();try{Ee.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),M.forEach(e=>{try{e()}catch{}})}}export{er as renderAsistenciaView};