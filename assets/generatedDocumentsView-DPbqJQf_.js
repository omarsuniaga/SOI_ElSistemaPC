import{i as e}from"./supabase-BryBf0UA.js";import{a as t,i as n,n as r,r as i}from"./admin-Ds66h2Jr.js";async function a(e){e&&(e.innerHTML=`
    ...
    </div>`,e.querySelector(`#btn-doc-hist-back`)?.addEventListener(`click`,()=>window.router?.navigate(`exportar-datos`)),e.querySelectorAll(`.btn-doc-redownload`).forEach(e=>{e.addEventListener(`click`,r=>{r.stopPropagation();let o=a.find(t=>t.id===e.dataset.id);o&&n(t({title:o.titulo,content:o.contenido_final,metadata:{alumnoNombre:o.alumno_nombre,tipo:o.tipo}}),i({tipo:o.tipo,alumnoNombre:o.alumno_nombre,fecha:o.created_at?.slice(0,10)}))})}),e.querySelectorAll(`.btn-doc-archive`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation(),confirm(`¿Archivar este documento?`)&&(await r(t.dataset.id),await o(e))})})}export{a as renderGeneratedDocumentsView};