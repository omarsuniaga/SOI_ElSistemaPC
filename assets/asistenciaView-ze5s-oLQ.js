const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/routeMock-CZoGj0m0.js","assets/rolldown-runtime-DlOssbPu.js","assets/academicService-D-BIm-fm.js","assets/preload-helper-eAV8hweq.js","assets/supabase-KnARm58N.js","assets/LevelCompletionModal-CVIwlh_r.js","assets/portalUtils-C92TBVO0.js","assets/AchievementsSummaryModal-DeANN_Pq.js"])))=>i.map(i=>d[i]);
import{i as e}from"./supabase-KnARm58N.js";import{i as t}from"./maestroAuth-CgmSmLyS.js";import{a as n,i as r,n as i,r as a,s as o}from"./maestroDataService-9gztUGVK.js";import{t as s}from"./idb-DphCmdhj.js";import{r as c,t as l}from"./offlineQueue-C8tVR5V3.js";import{l as u,n as d}from"./notificationService-DdsQPLVo.js";import{t as f}from"./AppToast-3qbHkRVc.js";import{t as p}from"./focusTrap-_L6o1rch.js";import{t as m}from"./preload-helper-eAV8hweq.js";import{t as h}from"./config-CH1Wq4BH.js";import{b as g,i as _,t as v}from"./observacion.model-BVj71YWy.js";import{c as y,i as b,l as x,m as S,n as C,o as w,r as T,s as E,t as D,u as O}from"./weeklyPlanAdapter-BulGBGlw.js";import{c as k,i as A,l as j,o as ee,s as M,t as N}from"./groqService-mbMO9U99.js";import{i as te,n as ne,r as re}from"./reportService-BWq37bBM.js";import{t as P}from"./academicService-D-BIm-fm.js";import{a as F,i as I,l as L,o as R,s as ie}from"./portalUtils-C92TBVO0.js";import{t as ae}from"./a11yUtils-Bm1YcVfS.js";import{a as oe,i as se,n as z,o as ce,r as le}from"./evaluationService-BzF2szc8.js";function ue(e={}){let{showSyncButton:t=!0}=e,n=document.createElement(`div`);n.className=`pm-sync-badge`,n.style.cssText=`
    display: none;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,ye=class{constructor(e,t=_e){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(he)||(this._autoTimer=setTimeout(()=>this.start(),ge))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(he,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=ve,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,document.head.appendChild(e)}function V(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function be(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function xe(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}var Se={achieved:{color:`green`,icon:`🟢`,label:`Dominado`},in_process:{color:`yellow`,icon:`🟡`,label:`En proceso`},needs_reinforcement:{color:`orange`,icon:`🟠`,label:`Requiere refuerzo`},failed:{color:`red`,icon:`🔴`,label:`No aprobado`},exceeded:{color:`blue`,icon:`🔵`,label:`Sobresaliente`},not_started:{color:`gray`,icon:`⚫`,label:`Sin iniciar`}};function H(e){return Se[e]||Se.not_started}async function U(t,n,r=null){let i=[];if(r){let e=await w(r).catch(()=>null),t=e?.plan?.items||[],n=new Set;i=t.filter(e=>{let t=e.indicator_id||`${e.node_id}:${e.week_number}`;return n.has(t)?!1:(n.add(t),!0)}).map(t=>({id:t.indicator_id||t.node_id||t.id,nombre:t.topic||t.objective||`Indicador`,node:{id:t.node_id||t.id,name:t.topic||`Tema`,level:{id:e?.route?.level_id||null,level_number:t.week_number,name:`Semana ${t.week_number}`}}}))}if(!i.length&&h.isDemoMode){let{getFullHierarchy:e}=await m(async()=>{let{getFullHierarchy:e}=await import(`./routeMock-CZoGj0m0.js`).then(e=>e.t);return{getFullHierarchy:e}},__vite__mapDeps([0,1]));(await e(r||`pclase_001`)).forEach(e=>{e.plan_temas.forEach(t=>{t.plan_objetivos.forEach(n=>{n.plan_indicators.forEach(n=>{i.push({id:n.id,nombre:n.descripcion,node:{id:t.id,name:t.nombre,level:{id:e.id,level_number:e.numero_nivel,name:e.nombre}}})})})})})}else if(!i.length){let{data:t,error:r}=await e.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,n).eq(`activo`,!0).order(`order_index`);if(r)throw r;i=(t??[]).filter(e=>e.nodes!==null).map(e=>({id:e.id,nombre:e.nombre||e.description,node:e.nodes}))}let a=await x(r),o=i.map(e=>{let n=a[`${t}_${e.id}`]||null,r=H(n?.status||`not_started`);return{id:e.id,nombre:e.nombre,node:e.node,latestStatus:n?.status||`not_started`,latestObs:n?.observation||``,latestEvidence:n?.evidence_url||``,semColor:r.color,semIcon:r.icon,history:n?[n]:[]}}),s=o.filter(e=>e.latestStatus===`achieved`||e.latestStatus===`exceeded`).length,c=o.length;return{indicatorSummaries:o,dominados:s,total:c,avance:c>0?Math.round(s/c*100):0,pendingTasks:[]}}function Ce(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${V(be(e.nombre_completo))}</div>
      <div>
  ...
  `}function we(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${V(xe(e.updated_at||e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Estado: ${H(e.status).label}</span>
      ${e.observation?`<span class="pm-eval-timeline__detail">${V(e.observation)}</span>`:``}
  ...
  `}function W(e){return e.length?e.map((e,t)=>`
    <div class="pm-route-indicador pm-route-indicador--${V(e.semColor)}"
      ...
      <div class="pm-route-indicador__info">
        ...
        <span class="pm-route-indicador__stats">
          ${e.latestStatus===`not_started`?`Sin evaluar`:`Estado: ${H(e.latestStatus).label}`}
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores cargados para este nivel.</p>`}function Te(e,{indicatorSummaries:t,avance:n}){return`
    ${Ce(e,n)}
  ...
  `}function Oe({alumno:e,rutaId:n,sessionId:r,claseId:i,fecha:a,horaInicio:o,onProgressSaved:s}){B();let c=document.createElement(`aside`);c.className=`pm-student-panel`,c.setAttribute(`role`,`dialog`),c.setAttribute(`aria-modal`,`false`),c.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(c);let l=[],u=null;function d(){ie()===`desktop`?c.classList.add(`pm-student-panel--desktop`):c.classList.remove(`pm-student-panel--desktop`)}let f=L(d);d();function m(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){v();return}if(n===`toggle-history`){let e=t.dataset.idx,n=c.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;h(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;h(e,n);return}}async function h(e,t=null){let n=l[e],r=t===null?null:n.history[t],i=r?.status??`not_started`,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
      <div class="pm-student-panel__modal-content">
        ...
        <div class="pm-student-panel__modal-body">
          ...
          <div class="pm-student-panel__modal-field">
            ...
            <textarea id="modal-obs" rows="3" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 12px; font-size: 0.9rem; resize: none; outline: none;" placeholder="Comentarios sobre el desempeño...">${r?V(r.observation):``}</textarea>
          </div>
          
          <div class="pm-student-panel__modal-field">
            <label>Enlace de Evidencia (Video/Audio)</label>
            <input type="text" id="modal-evidence" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 10px; font-size: 0.9rem; outline: none;" placeholder="URL de video o audio en drive/supabase..." value="${r?V(r.evidence_url):``}">
          </div>
        </div>
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-status]`);if(t){a.querySelectorAll(`[data-status]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=t.dataset.status;return}let r=e.target.closest(`[data-action]`)?.dataset.action;if(r===`modal-close`)a.remove();else if(r===`modal-save`){let e=a.querySelector(`#modal-obs`).value,t=a.querySelector(`#modal-evidence`).value;await g(n.id,i,e,t),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function g(n,i,a,o){try{if(!t())throw Error(`No hay sesión de maestro activa.`);await S(e.id,n,i,a.trim(),o.trim(),r),typeof s==`function`&&await s({alumnoId:e.id,indicatorId:n,status:i}),await _()}catch(e){console.error(`[studentProgressPanel] Error saving:`,e),alert(`Error al guardar: `+(e.message||e))}}c.addEventListener(`click`,m),c.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function _(){c.innerHTML=Ee(),c.classList.add(`pm-student-panel--open`),u&&u.dispose(),u=p(c,{onClose:()=>v()});try{let t=await U(e.id,n,i);l=t.indicatorSummaries,c.innerHTML=Te(e,t)}catch(e){console.error(`[studentProgressPanel] Error loading:`,e),c.innerHTML=De(e?.message??`Error desconocido al cargar datos.`)}}function v(){c.classList.remove(`pm-student-panel--open`),u&&=(u.dispose(),null),setTimeout(()=>{c.classList.contains(`pm-student-panel--open`)||(c.innerHTML=``,l=[])},300)}function y(){u&&=(u.dispose(),null),f(),c.removeEventListener(`click`,m),c.remove()}return{open:_,close:v,destroy:y}}var ke={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Ae={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},je={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function G(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Me(e){return(e||``).trim().toLowerCase()}function Ne(e){let t=new Map;for(let n of e){let e=Me(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Pe(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=je[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=je[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=ke[e.estado]||ke.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Ae[e.estado]||``}`:`ssp-alumno-chip`}">${G(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${G(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${G(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
  ...
  `,document.head.appendChild(e)}var Ie=`documentos`;async function Le(t,n=`justificaciones`){let r=t.name.split(`.`).pop(),i=`${n}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${r}`}`,{data:a,error:o}=await e.storage.from(Ie).upload(i,t,{cacheControl:`3600`,upsert:!1});if(o)throw o;let{data:s}=e.storage.from(Ie).getPublicUrl(i);return s.publicUrl}async function Re({sesionId:t,alumnoId:n,claseId:r,fecha:i,motivo:a,evidenciaBase64:o,creadoPor:s},c=null){let l=[];if(t||l.push(`sesionId`),n||l.push(`alumnoId`),i||l.push(`fecha`),a||l.push(`motivo`),s||l.push(`creadoPor`),l.length>0)return{error:{message:`Faltan campos requeridos: ${l.join(`, `)}`}};let u=null;if(c)try{u=await Le(c)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let d={sesion_id:t,alumno_id:n,clase_id:r||null,fecha:i,motivo:a,evidencia_url:u||null,evidencia_base64:null,creado_por:s,estado:`pendiente`},{data:f,error:p}=await e.from(`justificaciones`).upsert([d],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:f,error:p}}async function ze(t,n){if(!t||!n)return null;let{data:r,error:i}=await e.from(`justificaciones`).select(`*`).eq(`sesion_id`,t).eq(`alumno_id`,n).single();return i&&i.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,i),null):r||null}async function Be(t){if(!t)return{error:{message:`ID requerido`}};let{error:n}=await e.from(`justificaciones`).delete().eq(`id`,t);return{error:n}}function Ve(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function K(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function He(e,t){let n=K(e);return t.find(e=>K(e.nombre)===n||K(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&K(e.nombre).includes(n)||n.length>=3&&n.includes(K(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Ue(e,t){let n=[],r=[];for(let i of e){if(K(i)===`todos`){n.push(...t);continue}let e=He(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function We(t){if(t.length===0)return{data:[],error:null};let n=new Set,r=t.filter(e=>{let t=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return n.has(t)?!1:(n.add(t),!0)}),{data:i,error:a}=await e.from(`progresos`).upsert(r,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:i,error:a}}async function Ge({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=k(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await We(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function Ke({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Ue(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await We(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function qe({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=oe(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ke({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Je({claseId:t,objetivos:n}){if(!t||!n||n.length===0)return{linked:0};let{data:r,error:i}=await e.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,t).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(i)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,i.message),{linked:0};if(!r||r.length===0)return{linked:0};let a=n.map(e=>({id:e.id,norm:K(e.descripcion),raw:e.descripcion})),o=new Map;for(let e of r){let t=K(e.contenido_dsl);if(!t)continue;let n=a.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=a.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=a.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=o.get(n.id)||[];t.push(e.id),o.set(n.id,t)}}if(o.size===0)return{linked:0};let s=0;for(let[t,n]of o.entries()){let{error:r}=await e.from(`progresos`).update({objetivo_id:t}).in(`id`,n);r?console.warn(`[Progress] linkProgresosToObjetivos update error:`,r.message):s+=n.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${s} records`),{linked:s}}var Ye={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Xe=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function q(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Ze={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Qe(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Ze[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function $e(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${q(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${q(n.join(`, `))}</span>`:``}}function o(e,t){let n=Ye[e.estado]??Ye.EN_PROGRESO,r=e.nota?` · ${q(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${q(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Ze[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Qe(c)}</div>`:``,d=j(r),f=d.length>0?`
    ...
    `,et(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Xe.indexOf(i)+1)%Xe.length;r[n].estado=Xe[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function et(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
  ...
  `,document.head.appendChild(e)}async function tt(t,n=12){let r=new Date;r.setDate(r.getDate()-n*7);let i=r.toISOString().split(`T`)[0],{data:a,error:o}=await e.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
      alumnos ( nombre_completo )
    `).eq(`clase_id`,t).eq(`evaluacion_tipo`,`observacion`).gte(`fecha_evaluacion`,i).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1});if(o)throw Error(`Error al obtener registros de progreso: `+o.message);if(!a||a.length===0)return{totalSesiones:0,fechaDesde:i,registros:[]};let s=new Set(a.map(e=>e.fecha_evaluacion)),c=new Map;for(let e of a){let t=(e.contenido_dsl||``).trim().toLowerCase();if(!t)continue;c.has(t)||c.set(t,{contenido_dsl:e.contenido_dsl.trim(),tipo:e.tipo||`otro`,estados:[],fechas:new Set,alumnos:new Set});let n=c.get(t);n.estados.push(e.estado_cualitativo||`EN_PROGRESO`),n.fechas.add(e.fecha_evaluacion);let r=e.alumnos?.nombre_completo;r&&n.alumnos.add(r)}let l=Array.from(c.values()).map(e=>({contenido_dsl:e.contenido_dsl,tipo:e.tipo,estado:e.estados[0]||`EN_PROGRESO`,frecuencia:e.fechas.size,alumnos:Array.from(e.alumnos)}));return l.sort((e,t)=>t.frecuencia-e.frecuencia),{totalSesiones:s.size,fechaDesde:i,registros:l}}var nt={tecnica:{color:`#0d6efd`,bg:`#0d6efd15`},repertorio:{color:`#198754`,bg:`#19875415`},teoria:{color:`#fd7e14`,bg:`#fd7e1415`},interpretacion:{color:`#6f42c1`,bg:`#6f42c115`},otro:{color:`#6c757d`,bg:`#6c757d15`}},rt={alta:{label:`Foco`,color:`#dc3545`},media:{label:`Secundario`,color:`#fd7e14`},consolidacion:{label:`Consolidar`,color:`#198754`}};function it(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function at(e,{onAdopt:t,onCancel:n}){let r=[],i=``,a=null;function o(e,t,n){let r=rt[e.prioridad]??rt.media;return`
    ...
    `}function s(e,t){let n=nt[e.tipo]??nt.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${it(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${it(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${it(o)}" placeholder="ej. Básico" />
          </label>
        </div>
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function ut(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        ...
        <p class="pm-asist-subtitle">
          ${i?`📍 ${I(i)} · `:``}
          ${r?`${R(r.hora_inicio)} – ${R(r.hora_fin)} · `:``}
          <span style="color:var(--pm-primary); font-weight:700;">${F(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `;let d=e.querySelector(`#pm-asist-back`);return d&&u(d,`click`,c),{destroy(){l.forEach(e=>{try{e()}catch{}}),l.length=0}}}function dt(e,{editor:t,toolbar:n}){let r=!1;return{inject(i,a){if(r||!i||i.claseId!==a)return;let o=`[${i.nombre}] `;t.insertText(o),n.setContext({indicadorActivo:i.nombre});let s=e.querySelector(`#btn-guardar-obs`);s&&(s.style.display=``);let c=e.querySelector(`#pm-dsl-editor-container`);if(c){let e=c.parentElement.querySelector(`.pm-ruta-tema-banner`);e&&e.remove();let t=document.createElement(`div`);t.className=`pm-ruta-tema-banner`,t.style.cssText=`
        ...
        `,t.innerHTML=`
          ...
          ">✕</button>
        `,c.parentElement.insertBefore(t,c)}},destroy(){r=!0}}}var ft={pending:{label:`Pendiente`,icon:`⚪`,className:`pending`},viewed:{label:`Vista`,icon:`🟡`,className:`viewed`},graded:{label:`Calificada`,icon:`🟢`,className:`graded`},current:{label:`En curso`,icon:`🔵`,className:`current`}};function pt(e,t){let n=null,r=null,i={},a={},o=[],s=e.querySelector(`#pm-planificacion-card`),c=e.querySelector(`#pm-planificacion-dropdown`),l=e.querySelector(`#pm-planificacion-nombre`),u=e.querySelector(`#pm-planificacion-header`),d=e.querySelector(`#pm-route-tree-container`);u&&(u.onclick=()=>{let e=s.classList.toggle(`open`);c.style.display=e?`block`:`none`});let p=e.querySelector(`.pm-planificacion-tabs-pill`);p&&(p.style.display=`none`);let m=e.querySelector(`#pm-plan-list-rutas`);m&&(m.style.display=`none`);let g=e.querySelector(`#pm-plan-list-planificaciones`);g&&(g.style.display=`none`);let _=e.querySelector(`#pm-curriculo-proposal-trigger`);if(_&&(_.style.display=`none`),!document.getElementById(`pm-weekly-card-styles`)){let e=document.createElement(`style`);e.id=`pm-weekly-card-styles`,e.textContent=`
      .pm-weekly-nav {
    ...
    `,document.head.appendChild(e)}function v(){return typeof t.getSessionState==`function`?t.getSessionState():{isRegistered:!1}}async function S(e){return!e||!t.claseId||!t.maestro?.id?{}:(await b(t.claseId,t.maestro.id,e).catch(()=>[])).reduce((e,t)=>(e[String(t.week_number)]=t,e),{})}function w(e){let t=a[String(e.week_number)]||null;return{...e,teacher_strategy:t?.teacher_strategy||e.teacher_strategy,student_activity:t?.student_activity||e.student_activity,homework:t?.homework||e.homework,evidence:t?.evidence||e.evidence,teacher_notes:t?.teacher_notes||``,hasTeacherAdjustment:!!t}}async function k(){try{if(s.style.display=``,n=await O(t.claseId),!n)if(h.isDemoMode)n=await C({group_id:t.claseId,weekly_plan_id:`wplan-violin-n0`,level_id:`pnivel_001`,teacher_id:t.maestro?.id||`maestro_001`});else{l&&(l.textContent=`Sin guía ACM asignada`),d&&(d.innerHTML=`
            ...
            `);return}i=await x(t.claseId).catch(()=>({})),r=n.weekly_plan_id&&await E?.(n.weekly_plan_id)||await y(n.level_id,`violín`),a=await S(n?.weekly_plan_id),l&&(l.textContent=r?.instrument?`${r.instrument} · Ruta Activa ACM`:`Ruta Activa ACM`),M()}catch(e){console.error(`[PlanificationCard] Error inicializando:`,e),d&&(d.innerHTML=`<div style="color:#ef4444;font-size:0.8rem;padding:8px;">Error al cargar planificación semanal: ${e.message}</div>`)}}function A(e,t){return Object.keys(i).some(t=>e.indicator_id?t.endsWith(`_${e.indicator_id}`)&&i[t]?.status&&i[t]?.status!==`not_started`:!1)?ft.graded:e.week_number<t||e.week_number===t&&v().isRegistered?ft.viewed:e.week_number===t?ft.current:ft.pending}function j(e){return`
      <div class="pm-weekly-box" style="margin-bottom:0;">
        ...
        <div class="pm-weekly-sequence">
          ${(r?.items||[]).map(t=>{let n=w(t),r=A(t,e);return`
              <div class="pm-weekly-sequence-item ${r.className}">
                <div>
                  <div class="pm-weekly-sequence-title">Semana ${t.week_number} · ${I(t.topic)}</div>
                  <div class="pm-weekly-sequence-meta">${I(n.assessment_method||n.evidence||`Sin evidencia registrada`)}</div>
    ...
    `}function ee(e){let r=document.createElement(`div`);r.style.cssText=`position:fixed;inset:0;background:rgba(15,23,42,.72);backdrop-filter:blur(4px);z-index:2100;display:flex;align-items:center;justify-content:center;padding:16px;`,r.innerHTML=`
      <div style="width:min(720px,100%);max-height:90vh;overflow:auto;background:var(--pm-surface,#0f172a);color:var(--pm-text,#fff);border:1px solid var(--pm-border,rgba(255,255,255,.1));border-radius:18px;">
        <div style="padding:16px 18px;border-bottom:1px solid rgba(255,255,255,.08);display:flex;justify-content:space-between;gap:12px;align-items:start;">
          <div>
            ...
            <div style="font-size:.85rem;color:var(--pm-text-muted,#94a3b8);margin-top:4px;">Semana ${e.week_number}. Esto NO reemplaza la guía ACM; solo guarda la adaptación del maestro para esta clase.</div>
          </div>
        ...
        <form id="pm-weekly-adjustment-form" style="padding:16px 18px;display:grid;gap:14px;">
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Estrategia docente ajustada
            <textarea name="teacher_strategy" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${I(e.teacher_strategy||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Actividad del estudiante
            <textarea name="student_activity" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${I(e.student_activity||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Tarea
            <textarea name="homework" rows="2" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${I(e.homework||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Evidencia esperada ajustada
            <textarea name="evidence" rows="2" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${I(e.evidence||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Notas pedagógicas del maestro
            <textarea name="teacher_notes" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${I(e.teacher_notes||``)}</textarea>
          </label>
    ...
    `;let i=()=>r.remove();r.querySelectorAll(`[data-close-modal]`).forEach(e=>{e.onclick=i}),r.onclick=e=>{e.target===r&&i()};let a=r.querySelector(`#pm-weekly-adjustment-form`);a.onsubmit=async r=>{r.preventDefault();let o=new FormData(a);try{await T({group_id:t.claseId,teacher_id:t.maestro?.id,weekly_plan_id:n?.weekly_plan_id,week_number:e.week_number,teacher_strategy:String(o.get(`teacher_strategy`)||``).trim(),student_activity:String(o.get(`student_activity`)||``).trim(),homework:String(o.get(`homework`)||``).trim(),evidence:String(o.get(`evidence`)||``).trim(),teacher_notes:String(o.get(`teacher_notes`)||``).trim()}),f.success(`Ajuste docente guardado sin modificar la guía ACM.`),i(),await k()}catch(e){console.error(`[PlanificationCard] Error guardando ajuste docente:`,e),f.error(e.message||`No se pudo guardar el ajuste docente.`)}},document.body.appendChild(r)}function M(){if(!d||!r)return;let i=n.current_week||1,a=(r.items||[]).find(e=>e.week_number===i),o=a?w(a):null;if(!o){d.innerHTML=`<div style="padding:10px;font-size:0.8rem;color:var(--pm-text-muted);">No hay planificación registrada para la Semana ${i}</div>`;return}let s=e.querySelector(`#pm-active-tema-badge`);s&&(s.textContent=`Semana ${i}: ${o.topic}`,s.style.display=`inline-block`),d.innerHTML=`
      <div class="pm-weekly-nav">
        <button class="pm-weekly-nav-btn prev" ${i<=1?`disabled`:``}>◀ Anterior</button>
        <span class="pm-weekly-title">Semana ${i} de ${r.items.length}</span>
        <button class="pm-weekly-nav-btn next" ${i>=r.items.length?`disabled`:``}>Siguiente ▶</button>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Tema de la Clase</div>
        <div class="pm-weekly-text">${I(o.topic)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Objetivo Pedagógico</div>
        <div class="pm-weekly-desc">${I(o.objective)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Estrategia Metodológica / Actividades</div>
        <div class="pm-weekly-desc">${I(o.teacher_strategy||`Sin estrategia registrada`)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Evidencia Requerida</div>
        <div class="pm-weekly-desc">📸 ${I(o.evidence||`Sin evidencia registrada`)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Actividad del Estudiante / Tarea</div>
        <div class="pm-weekly-desc">${I(o.student_activity||`Sin actividad registrada`)}</div>
        <div class="pm-weekly-desc" style="margin-top:8px;"><strong>Tarea:</strong> ${I(o.homework||`Sin tarea registrada`)}</div>
        ${o.teacher_notes?`<div class="pm-weekly-desc" style="margin-top:8px;"><strong>Nota docente:</strong> ${I(o.teacher_notes)}</div>`:``}
      ...
      <div class="pm-weekly-box">
        ...
        <div class="pm-weekly-indicator-badge" id="btn-eval-indicator-weekly">
          🎯 ${I((o.topic||``).split(` `)[0]||`Indicador`)} — Evaluar
        </div>
      </div>

      ${j(i)}
    `,d.querySelector(`.pm-weekly-nav-btn.prev`).onclick=async e=>{e.stopPropagation(),i>1&&(n=await D(n.id,i-1),await k())},d.querySelector(`.pm-weekly-nav-btn.next`).onclick=async e=>{e.stopPropagation(),i<r.items.length&&(n=await D(n.id,i+1),await k())};let c=d.querySelector(`#btn-eval-indicator-weekly`);c&&(c.onclick=e=>{e.stopPropagation(),t.onIndicadorSelect?.({id:o.indicator_id,nombre:o.topic,node_id:o.node_id})});let l=d.querySelector(`#btn-edit-weekly-adjustment`);l&&(l.onclick=e=>{e.stopPropagation(),ee(o)})}k();function N(){o.forEach(e=>{try{e()}catch{}}),o.length=0}return{destroy:N,getActiveIndicador:()=>{if(!r||!n)return null;let e=r.items.find(e=>e.week_number===n.current_week);return e?{id:e.indicator_id,nombre:e.topic}:null},refreshTree:async()=>{await k()},getActivePlanificacionId:()=>n?.weekly_plan_id||null}}var J=null,Y=[],mt=null,X=-1,ht=!1,gt=null,Z=!1,_t=0,vt=0;function yt(){if(!J){if(J=document.createElement(`div`),J.id=`pm-autocomplete-popup`,J.className=`pm-autocomplete-popup`,J.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(J)}}function bt(e,t,n={}){if(yt(),Y=e||[],mt=t,gt=n.trigger||null,X=-1,ht=!0,Et(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+6;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),J.style.left=`${i}px`,J.style.top=`${a}px`}J.onmousedown=xt,document.addEventListener(`mousemove`,St),document.addEventListener(`mouseup`,Ct),J.style.display=`block`}function xt(e){e.target.closest(`.pm-ac-option`)||(Z=!0,_t=e.clientX-J.offsetLeft,vt=e.clientY-J.offsetTop,J.style.cursor=`grabbing`,J.style.transition=`none`)}function St(e){if(!Z)return;let t=e.clientX-_t,n=e.clientY-vt;J.style.left=`${Math.max(0,t)}px`,J.style.top=`${Math.max(0,n)}px`}function Ct(){Z&&(Z=!1,J.style.cursor=``)}function wt(){J&&(J.style.display=`none`,Z=!1,document.removeEventListener(`mousemove`,St),document.removeEventListener(`mouseup`,Ct)),Y=[],mt=null,X=-1,ht=!1,gt=null}function Tt(e){Y=e||[],X=-1,Et(e)}function Et(e){if(!J)return;if(!e||e.length===0){J.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${At(gt)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===X,o=jt(gt,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
...
¿Guardar la evaluación?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:e}=await le(t.sesionId,i.id,o.evaluaciones,t.maestro.id,a);if(e)throw e}let s={indicador_id:i.id,evaluaciones:o.evaluaciones};await En(t.sesionId,t.maestro.id,r,s,o.dslGenerado||null,o.textoMejorado||null);let c=oe(r);if(c.estados&&c.estados.length>0){let e=t.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));qe({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,dslText:r,alumnos:e}).then(({saved:e,errors:n})=>{n.length&&console.warn(`[Progress DSL] Errores:`,n),e.length&&st(e,t.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await jn(t.sesionId,t.claseId,t.maestro.id,o.evaluaciones,t.claseNombre||`Clase`,a);if(l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),t.planificationCard&&await t.planificationCard.refreshTree(),t.setEditorValue(``),t.onDslContentClear&&t.onDslContentClear(),Fn(o.evaluaciones.length,i.nombre),t.activeClassEventId){try{await Mn(t.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(t.activeLevel)try{let{academicService:e}=await m(async()=>{let{academicService:e}=await import(`./academicService-D-BIm-fm.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3,4]));for(let n of a){let r=await e.checkLevelCompletion(n.id,t.activeLevel);if(r&&r.status===`approved`){let{createLevelCompletionModal:e}=await m(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-CVIwlh_r.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([5,4,6])),r=e({studentId:n.id,levelId:t.activeLevel});t.onAppendModal?.(r.el||r)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&t.claseId&&i?.nombre){let{error:e}=await Ge({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,contenido:i.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(t.sesionId){let{academicService:n}=await m(async()=>{let{academicService:e}=await import(`./academicService-D-BIm-fm.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3,4])),r=await n.processSessionClosure(t.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:t}=await m(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DeANN_Pq.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([7,6]));await t(e,r)}}n.textContent=`¡Guardado!`,setTimeout(()=>{n.textContent=`Guardar observación`,n.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),f.error(`Error al guardar: `+(e.message||e)),n.disabled=!1,n.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function Fn(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function In(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await Nn.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function Ln(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||f!==void 0&&f&&f.error(`Error inesperado: `+(e.message||e)),null}}async function Rn(t,{sesionId:n,fecha:r,maestro:i,router:a}){try{let{data:o,error:s}=await e.from(`sesiones_clase`).select(`*`).eq(`id`,n).single();if(s||!o){t.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let c=new Date,l=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,`0`)}-${String(c.getDate()).padStart(2,`0`)}`,u=r||o.fecha||l,d={id:n,nombre:o.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,n);let f=Array.isArray(o.asistencia)?o.asistencia:[],p=f.map(e=>e.alumno_id).filter(Boolean),m=[];if(p.length>0){let{data:t}=await e.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,p);m=t||[]}let h={},g={};m.forEach(e=>{h[e.id]=null}),f.forEach(e=>{e.estado&&m.some(t=>t.id===e.alumno_id)&&(h[e.alumno_id]=e.estado)});let _=Bn(t,{clase:d,horario:null,alumnos:m,estado:h,justificaciones:g,maestro:i,fechaHoy:u,claseId:null,sesionId:n,hasConflict:!1,serverDSL:o.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:o,router:a});return typeof _==`function`?_:void 0}catch(e){console.error(`[asistenciaView] Error en sesión emergente:`,e.message,e.stack),t.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}async function zn(o,{claseId:s,fecha:c,sesionId:l,router:u}={}){let d=typeof o==`string`?document.getElementById(o):o;if(!d){console.error(`[asistenciaView] Container not found:`,o);return}d.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let f=t();if(!f){d.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!s){if(l)return Rn(d,{sesionId:l,fecha:c,maestro:f,router:u});d.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,s);let p=new Date,m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,h=c||m;try{let t=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[o,c,l,m]=await Promise.all([r(),i([s]),a([s]),e.from(`sesiones_clase`).select(`*`).eq(`clase_id`,s).eq(`maestro_id`,f.id).eq(`fecha`,h).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),g=o.find(e=>e.id===s);if(!g){d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let _=c.find(e=>e.dia?.toLowerCase()===t),v=(l||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),y=m.data||[],b=y[0]||null,x=(()=>{let e=new Map;for(let t of[...y].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),S=Array.isArray(b?.asistencia)?b.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(b?.tipo===`emergente`&&S.length>0){let t=new Set(S),n=new Set(v.map(e=>e.id)),r=S.filter(e=>!n.has(e));if(r.length>0)try{let{data:t}=await e.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,r);v=v.concat(t||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}v=v.filter(e=>t.has(e.id))}let C=b?.id||null,w=b?.updated_at||null,T=b?.contenido||``,E=g.salon?[g.salon]:[],[D,O]=await Promise.all([C?e.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?n(E):Promise.resolve([])]),k=O.length>0?O[0].nombre:null,A=`pm_asistencia_${s||C}_${h}`,j=localStorage.getItem(`${A}_updated`),ee=!1;w&&j&&new Date(w).getTime()>new Date(j).getTime()+5e3&&(ee=!0);let M=null;try{let t=o?.find(e=>e.id===s)?.instrumento;if(t){let n=t.split(`,`)[0].trim().toLowerCase(),{data:r}=await e.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${n}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();M=r?.route_versions?.[0]?.id||r?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let N={},te={};v.forEach(e=>{N[e.id]=null});let ne=x,re={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(ne.length===0)try{let t=null,n=y.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:r}=await e.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);t=r}if((!t||t.length===0)&&s&&h){let{data:n}=await e.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,s).eq(`fecha`,h);t=n}t?.length>0&&(ne=t.map(e=>({alumno_id:e.alumno_id,estado:re[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}ne.forEach(e=>{if(Object.prototype.hasOwnProperty.call(N,e.alumno_id)){let t=re[e.estado]??e.estado;N[e.alumno_id]=t}});let P=[];if(C)try{P=await e.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),P.forEach(e=>{Object.prototype.hasOwnProperty.call(N,e.alumno_id)&&(N[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Bn(d,{clase:g,horario:_,alumnos:v,estado:N,justificaciones:te,maestro:f,fechaHoy:h,claseId:s,sesionId:C,hasConflict:ee,serverDSL:T,snapshots:D,salonNombre:k,rutaId:M,sesionExistenteData:b,router:u})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function Bn(t,n){let{clase:r,horario:i,alumnos:a,estado:s,justificaciones:c,maestro:p,fechaHoy:h,claseId:v,snapshots:y,serverDSL:b,hasConflict:x,salonNombre:S,rutaId:C,sesionExistenteData:w,router:T}=n,E=n.sesionId,D=!!n.sesionId&&(w?.borrador===!1||w?.estado===`registrada`||w?.estado===`cerrada`),O=e=>{if(T?.navigate){T.navigate(e);return}window.location.hash=`#/${e}`},k=[],j=`pm_asistencia_${v||E}_${h}`,P=b,F=null,I=Ve(),L=null,R=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let ie=ut(t.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:S,fechaHoy:h,totalAlumnos:a.length,hasConflict:x,onBack:()=>{Ee.destroy();try{xe.close()}catch{}k.forEach(e=>{try{e()}catch{}}),O(`hoy`)}});k.push(()=>ie.destroy());let oe=t.querySelector(`#pm-sync-badge-container`);if(oe){let e=ue();oe.appendChild(e.el)}let se=bn(t,{initialContent:b,claseId:v,onEditorChange:e=>{P=e}}),z=se.getEditor(),le=t.querySelector(`#pm-dsl-editor-container`),de=pe(t,{onAceptar:e=>{z.setValue(e)}}),he=me(t,{onAccept:e=>{z.setValue(e)}}),ge=$e(le.parentNode,{onConfirm:async e=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ke({sesionId:E,claseId:v,maestroId:p.id,fechaHoy:h,progressRecords:e,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=t.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(e){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),f.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),_e=at(t.querySelector(`#pm-planificacion-dropdown`)||t,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await _({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await Je({claseId:v,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;f.success(s)}catch(e){f.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}});se.initToolbar({onImproveClick:async e=>{let n=t.querySelector(`#btn-generar-informe`);n&&(n.disabled=!0);try{let t=await A(e);de.open({original:e,improved:t})}catch(e){f.error(`Error al generar informe: `+e.message)}finally{n&&(n.disabled=!1)}},onStructureClick:async e=>{let n=t.querySelector(`#btn-ia-magic`);n&&(n.disabled=!0);try{let t=L?.getActiveIndicador(),n=await M(e,{presentes:a.filter(e=>s[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});he.open({original:e,dsl:n})}catch(e){f.error(`Error al estructurar con IA: `+e.message)}finally{n&&(n.disabled=!1)}},onAnalyzeClick:async e=>{await Ln(async()=>{let n=a.filter(e=>s[e.id]&&s[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},o=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,o)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,o)}}),tipoClase:ot(r),instrumento:r.instrumento||``,sesionesRecientes:(y||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:L?.getActiveIndicador()?.nombre||``};t.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await N(e,c);if(!l?.progreso?.length){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),f!==void 0&&f&&f.warning(`La IA no detectó registros de progreso en este texto.`);return}ge.open({progreso:l.progreso,resumen:l.resumen})},{onError:e=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),f!==void 0&&f&&f.error(`Error al analizar con IA: `+e.message)}})}});let ve=se.getToolbar();L=pt(t,{claseId:v,clase:r,maestro:p,fechaHoy:h,rutaId:C,editor:z,onIndicadorSelect:e=>{z.insertText(`[${e.nombre}] `),ve&&ve.setContext({indicadorActivo:e.nombre});let n=t.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getSessionState:()=>({isRegistered:D,hasContent:!!(P&&P.trim()),sessionId:E}),getDslContent:()=>z.getValue()}),k.push(()=>L.destroy());let B=t.querySelector(`#btn-proponer-curriculo`);B&&(B.onclick=async()=>{B.disabled=!0,B.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await tt(v,12);if(e.registros.length===0){f.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await ee(e,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});_e.open({pilares:t.pilares,resumen:t.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(e){f.error(`Error al generar propuesta: `+e.message)}finally{B.disabled=!1,B.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let V=dt(t,{editor:z,toolbar:ve}),be=ce();V.inject(be,v),k.push(()=>V.destroy());let xe=kn(t,{sesionId:E,claseId:v,fechaHoy:h,maestroId:p.id,supabase:e,guardarJustificacion:Re,eliminarJustificacion:Be,onJustifDeleted:e=>{s[e]=null,delete c[e]},onJustifSaved:(e,t)=>{c[e]=t},onJustifCancelled:(e,t)=>{s[e]=t},onRenderLista:e=>H.render(e),onUpdateProgress:()=>Ce(),onAutoSave:e=>we(e),onAnnounce:e=>ae(e)});k.push(()=>{try{xe.close()}catch{}});let Se=Dn(t,{sesionId:E,maestroId:p.id,editor:z,sesionExistenteData:w,onDraftRecovered:e=>{P=e,z.setValue(e)}});k.push(()=>Se.destroy()),t.querySelector(`#pm-academic-tools`),Pn(t,{rutaId:C,sesionId:E,claseId:v,maestro:p,fechaHoy:h,alumnos:a,estado:s,planificationCard:L,editorContainer:le,getEditorValue:()=>z.getValue(),setEditorValue:e=>z.setValue(e),onDslContentClear:()=>{P=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:e=>{let n=t.querySelector(`.pm-asist-root`);n&&n.appendChild(e)}});let H=An(t,{alumnos:a,estado:s,rutaId:C,canOpenProgressPanel:!!(v||C),sesionId:E,fechaHoy:h,snapshots:y,justificaciones:c,obtenerJustificacion:ze,onEstadoChange:(e,t)=>{s[e]=t},onOpenProgressPanel:e=>{U&&U.destroy(),U=Oe({alumno:e,rutaId:C,sessionId:E,claseId:v,fecha:h,horaInicio:i?.hora_inicio||null,onProgressSaved:async()=>{L?.refreshTree&&await L.refreshTree()}}),U.open(),k.push(()=>{U&&U.destroy()})},onOpenEvaluationDrawer:(e,n)=>{fe(t,{student:e,sessionId:E,teacherId:p.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{xe.open(e,t,n)},onAutoSave:e=>we(e),onAnnounce:e=>ae(e),onUpdateSnapshots:e=>{y.push(...e)}});k.push(()=>H.destroy());let U=null;function Ce(){let e=a.length,n=Object.values(s).filter(e=>e!==null).length,r=t.querySelector(`#pm-progress-wrap`),i=t.querySelector(`#pm-progress-fill`),o=t.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/e*100}%`,o.textContent=`${n}/${e}`}async function we(t=!1,n=!1){F&&clearTimeout(F);let r=async()=>{let t=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),n={...E?{}:{clase_id:v},maestro_id:p.id,fecha:h,estado:`pendiente`,borrador:!0,asistencia:t||[],contenido:P||``};if(navigator.onLine)try{if(E){let{error:t}=await e.from(`sesiones_clase`).update({...n,updated_at:new Date().toISOString()}).eq(`id`,E);if(!t){localStorage.setItem(`${j}_updated`,new Date().toISOString());return}throw t}else{let{data:t,error:r}=await e.from(`sesiones_clase`).insert([n]).select(`id`).single();if(!r&&t){E=t.id,console.log(`[asistencia] Nueva sesión creada:`,E),localStorage.setItem(`${j}_updated`,new Date().toISOString());return}throw r||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await l({tabla:`sesiones_clase`,operacion:E?`update`:`insert`,payload:{...E?{id:E}:{},...n}}),localStorage.setItem(`${j}_updated`,new Date().toISOString())};t?n?await r():await I.run(r):F=setTimeout(()=>{I.run(r).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let W=t.querySelector(`.pm-asist-actions-fixed`);if(W){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),E&&(e.disabled=!0,e.innerHTML=`⏳...`,await ne(E),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=W.querySelector(`#btn-guardar`);W.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),v&&(n.disabled=!0,n.innerHTML=`⏳...`,await re(v,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),W.insertBefore(n,t)}t.querySelector(`#btn-guardar`).onclick=async()=>{let n=t.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await I.run(async()=>{try{let i=a.filter(e=>s[e.id]).map(e=>({...v?{clase_id:v}:{},alumno_id:e.id,fecha:h,estado:s[e.id],registrado_por:p.id})),c=i.length>0,f=P&&P.trim().length>0;if(!c&&!f)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await we(!0,!0),!E){let{data:t}=await e.from(`sesiones_clase`).select(`id`).eq(`clase_id`,v).eq(`maestro_id`,p.id).eq(`fecha`,h).maybeSingle();t&&(E=t.id)}if(c&&v)try{let e=i.map(e=>({...e,...E&&{sesion_clase_id:E}}));await g(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!E){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await l({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:v,alumno_id:e.alumno_id,fecha:h,estado:e.estado,registrado_por:p.id,...E?{sesion_clase_id:E}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(E&&(c||f)){let t=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),{error:n}=await e.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:t,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,E).select();if(n){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,n.message);let{error:r}=await e.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:t,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,E).select();r&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,r.message),await e.from(`sesiones_clase`).update({borrador:!1,asistencia:t,contenido:P||``,updated_at:new Date().toISOString()}).eq(`id`,E))}o(),u(`hoy`),u(`calendario`),u(`metricas`),d().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e)),D=!0,L?.refreshTree&&await L.refreshTree()}if(E){let{academicService:e}=await m(async()=>{let{academicService:e}=await import(`./academicService-D-BIm-fm.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3,4])),{createAchievementsSummaryModal:r}=await m(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DeANN_Pq.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([7,6])),i=await e.processSessionClosure(E);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(t,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let _=W?.querySelector(`#btn-reporte-dia`);_&&(_.style.display=``);let y=W?.querySelector(`#btn-resumen-mes`);y&&(y.style.display=``);let b=Object.values(s).filter(e=>e===`P`).length,x=Object.values(s).filter(e=>e===`A`).length;ae(`Sesión guardada exitosamente. ${b} presentes, ${x} ausentes.`);let S=document.createElement(`div`);S.className=`pm-saved-overlay`,S.innerHTML=`
      ...
      `,document.body.appendChild(S);let C=S.querySelector(`#btn-resumen-pedagogico`),w=S.querySelector(`#btn-editar-asistencia`),T=S.querySelector(`#btn-compartir-correo`),k=S.querySelector(`#btn-compartir-whatsapp`),A=S.querySelector(`#btn-volver-hoy`),j=S.querySelector(`#btn-ir-calendario`);R&&R.destroy(),R=Pe();let ee=R;C&&(C.onclick=()=>{ee.open({sesionId:E,claseNombre:r?.nombre||`Clase`,fecha:h,supabase:e})}),w&&(w.onclick=()=>{S.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),T&&(T.onclick=async()=>{let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${h}`),n=ct(e,P,a,r,h);lt(`mailto:?subject=${t}&body=`,n,1800)}),k&&(k.onclick=async()=>{lt(`https://wa.me/?text=`,ct(a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),P,a,r,h),1600)}),A&&(A.onclick=()=>{S.remove(),O(`hoy`)}),j&&(j.onclick=()=>{S.remove(),O(`fechas`)});let M=S.querySelector(`#btn-reporte-dia-overlay`);M&&(M.onclick=async()=>{let e=M.innerHTML;M.disabled=!0,M.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await ne(E)}finally{M.disabled=!1,M.innerHTML=e}});let N=S.querySelector(`#btn-resumen-mes-overlay`);N&&(v?N.onclick=async()=>{let e=N.innerHTML;N.disabled=!0,N.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await re(v,e.getFullYear(),e.getMonth()+1)}finally{N.disabled=!1,N.innerHTML=e}}:(N.disabled=!0,N.title=`No disponible para actividades especiales`,N.style.opacity=`0.5`));let F=S.querySelector(`#btn-informe-ped-overlay`);F&&(v?F.onclick=async()=>{let e=F.innerHTML;F.disabled=!0,F.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await te(v,e.getFullYear(),e.getMonth()+1)}finally{F.disabled=!1,F.innerHTML=e}}:(F.disabled=!0,F.title=`No disponible para actividades especiales`,F.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};let Te=xn(t,{onMarkAll:async e=>{a.forEach(t=>{s[t.id]=e}),H.render(),Ce();try{await we(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}ae(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)}});k.push(()=>Te.destroy()),H.render();let Ee=new ye(t);Ee.mount();let De=t.querySelector(`#pm-btn-help`);return De&&(De.onclick=()=>Ee.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Ee.destroy();try{xe.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),k.forEach(e=>{try{e()}catch{}})}}export{zn as renderAsistenciaView};