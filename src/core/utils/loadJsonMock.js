...
export async function loadJsonMock(path) {
  const MODULE_MAP = {
    ...
    '/assets/data/mocks/maestro_tareas.json': () =>
      import('../../assets/data/mocks/maestro_tareas.json'),
    '/assets/data/mocks/metricas_periodo.json': () =>
      import('../../assets/data/mocks/metricas_periodo.json'),
    '/assets/data/mocks/alertas_config.json': () =>
      import('../../assets/data/mocks/alertas_config.json'),
    '/assets/data/mocks/objetivos_gamificacion.json': () =>
      import('../../assets/data/mocks/objetivos_gamificacion.json'),
    '/assets/data/mocks/ausencias.json': () => import('../../assets/data/mocks/ausencias.json'),
    '/assets/data/mocks/planificacion-curricular.json': () =>
      import('../../assets/data/mocks/planificacion-curricular.json'),
  }
