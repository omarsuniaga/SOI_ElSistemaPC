...
export const portalCatalog = Object.freeze([
  ...
  definePortal({ portalId: 'ADM', path: '/adm', entry: 'adm.html', shell: 'department-admin', defaultRoute: 'alumnos', hermesDept: 'ADM', owner: 'ADM', lifecycle: 'legacy-static', health: 'unknown', allowedRoles: ['admin'] }),
