...
`,yi=class{constructor(e,t=_i){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(hi)||(this._autoTimer=setTimeout(()=>this.start(),gi))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(hi,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=vi,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Si(`Clase`,null,()=>Ci()),J.activeClassId?wi(J.activeClassId):Ai(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),xi(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Ci())},e.onclick=()=>{J.activeClassId=t,J.activeLevelId=J.activeNodeId=J.activeObjectiveId=null,Ci(),wi(t),Ai(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Ai(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ai(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function wi(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await q.getLevelsByClass(e);!n.some(e=>e.id===J.activeLevelId)&&n.length>0?J.activeLevelId=n[0].id:n.length===0&&(J.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Si(`Nivel`,e,()=>wi(e)),J.activeLevelId?Ti(J.activeLevelId):Ai(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),xi(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>wi(e))},t.onclick=()=>{J.activeLevelId=n,J.activeNodeId=J.activeObjectiveId=null,wi(e),Ti(n),Ai(`#pm-rc-objs-wrapper`,`Elegí Tema`),Ai(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ti(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await q.getNodesByLevel(e);!n.some(e=>e.id===J.activeNodeId)&&n.length>0?J.activeNodeId=n[0].id:n.length===0&&(J.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Si(`Tema`,e,()=>Ti(e)),J.activeNodeId?Ei(J.activeNodeId):Ai(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),xi(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ti(e))},t.onclick=()=>{J.activeNodeId=n,J.activeObjectiveId=null,Ti(e),Ei(n),Ai(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ei(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await q.getObjectivesByNode(e);!n.some(e=>e.id===J.activeObjectiveId)&&n.length>0?J.activeObjectiveId=n[0].id:n.length===0&&(J.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Si(`Objetivo`,e,()=>Ei(e)),J.activeObjectiveId?ki(J.activeObjectiveId):Ai(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),xi(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ei(e))},t.onclick=()=>{J.activeObjectiveId=n,Ei(e),ki(n)}})}var Di={0:`Sin eval.`,1:`Inicial`,2:`En desarrollo`,3:`Logrado`,4:`Destacado`,5:`Superado`},Oi={0:`var(--pm-text-muted)`,1:`#ef4444`,2:`#f97316`,3:`#22c55e`,4:`#06b6d4`,5:`#8b5cf6`};async function ki(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
  ...
  `}function qi(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${Y(Ui(e.created_at))}</span>
...
`),s=[];for(let e of o){let t=tr(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:ka({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function ja({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await S.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:wa(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=wa(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await S.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Ma={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Na=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function X(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Pa={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Fa(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Pa[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Ia(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${X(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${X(n.join(`, `))}</span>`:``}}function o(e,t){let n=Ma[e.estado]??Ma.EN_PROGRESO,r=e.nota?` · ${X(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${X(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Pa[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Fa(c)}</div>`:``,d=Te(r),f=d.length>0?`
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;I.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}e.querySelector(`#pm-asist-back`).onclick=()=>{Ge.destroy();try{ye.close()}catch{}T.forEach(e=>{try{e()}catch{}}),w(`hoy`)},e.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{l[e.id]=`P`}),je(),Ie();try{await Le(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk P:`,e)}dn(`Todos los ${s.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{l[e.id]=`A`}),je(),Ie();try{await Le(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk A:`,e)}dn(`Todos los ${s.length} alumnos marcados como ausentes.`)},je();async function Ue(e){try{let{data:t}=await S.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function We(e){if(!e||!ae)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await q.getRouteHierarchy(ae),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Ge=new yi(e);Ge.mount();let Ke=e.querySelector(`#pm-btn-help`);return Ke&&(Ke.onclick=()=>Ge.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Ge.destroy();try{ye.close()}catch{}T.forEach(e=>{try{e()}catch{}})}}function qa(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Ja(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await S.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Ja(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await M({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Xa={async open(){let e=await ie(),t=await ne();Ce.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);no(n,t),ro(n,t),uo(n,t),io(r),ao(r,t),oo(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),so(r),co(r),yo(t),mo(t),bo(),Se(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-BqWyDF0U.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&lo(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function no(e,t){let n=he(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ao(e,t){let n=N(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
...
`);throw Error(e)}let{error:o}=await S.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let c={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(T,JSON.stringify(c)),Z.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{Z.saving=!1,a.disabled=!1,a.innerHTML=o}}function go(){let e={};return eo.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function _o(){Ce.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await E(),window.location.reload(),!0)})}function vo(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),Z.theme=e}function yo(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=xo,document.head.appendChild(e)}async function So(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i,onSave:a}){let o=new Set,s=document.createElement(`div`);s.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
  ...
  `;let a=`pm-planning-active-tab`,o=e.querySelectorAll(`.pm-planning-tab`),s=e.querySelectorAll(`.pm-planning-pane`);function l(e){o.forEach(t=>{let n=t.dataset.tab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),s.forEach(t=>{t.hidden=t.dataset.pane!==e});try{sessionStorage.setItem(a,e)}catch{}b(e)}o.forEach(e=>{e.addEventListener(`click`,()=>l(e.dataset.tab))});let d=e.querySelector(`#pm-planning-clase-select`),f=e.querySelector(`#pm-planning-ruta-select`),p=e.querySelector(`#pm-planning-content`);try{d.innerHTML=`<option value="">Selecciona una clase...</option>`+(await c()).map(e=>`<option value="${e.id}">${e.nombre} (${e.instrumento||`S/I`})</option>`).join(``)}catch(e){console.error(`[planning] Error cargando clases:`,e),I.error(`Error cargando clases`)}d.addEventListener(`change`,async()=>{if(r=d.value,f.value=``,n=null,p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta...</p></div>`,r)try{f.innerHTML=`<option value="">Selecciona una ruta...</option>`+(await u(r)).map(e=>`<option value="${e.route_version_id}">${e.name}${e.instrumento?` (${e.instrumento})`:``}</option>`).join(``)}catch(e){console.error(`[planning] Error cargando rutas:`,e),I.error(`Error cargando rutas`)}}),f.addEventListener(`change`,()=>{n=f.value||null,b(e.querySelector(`.pm-planning-tab.active`)?.dataset.tab||`semaforo`)});let m=e.querySelector(`#pm-planning-route-tree`),h=e.querySelector(`#pm-planning-manager`),g=null,_=null,v=!1,y=!1;function b(e){if(e===`semaforo`)return x();if(e===`ruta`)return S();if(e===`gestionar`)return C()}async function x(){if(!n||!r){p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una clase y ruta para comenzar</p></div>`;return}p.innerHTML=`<div class="pm-planning-empty"><p>Cargando indicadores...</p></div>`;try{i=await Re(n,t,r),w()}catch(e){console.error(`[planning] Error cargando indicadores:`,e),I.error(`Error cargando indicadores`),p.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar indicadores. Intenta de nuevo.</p></div>`}}async function S(){if(!n){m.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para ver su estructura</p></div>`;return}if(!(g===n||v)){v=!0,m.innerHTML=`<div class="pm-planning-empty"><p>Cargando estructura...</p></div>`;try{let{renderPlanningRouteTree:e}=await Se(async()=>{let{renderPlanningRouteTree:e}=await import(`./PlanningRouteTree-BjTvzBBY.js`);return{renderPlanningRouteTree:e}},__vite__mapDeps([16,17,3,5]));await e(m,{routeVersionId:n}),g=n}catch(e){console.error(`[planning] Error cargando estructura de ruta:`,e),m.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar la estructura. Intenta de nuevo.</p></div>`}finally{v=!1}}}async function C(){if(!n){h.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para gestionar su contenido</p></div>`;return}if(!(_===n||y)){y=!0,h.innerHTML=`<div class="pm-planning-empty"><p>Preparando tu borrador editable…</p></div>`;try{let{renderPlanningManager:e}=await Se(async()=>{let{renderPlanningManager:e}=await import(`./PlanningManagerPanel-C660sgCx.js`);return{renderPlanningManager:e}},__vite__mapDeps([18,3,17,5,14,15]));await e(h,{publishedRouteVersionId:n,maestroId:t,onChanged:()=>{g=null}}),_=n}catch(e){console.error(`[planning] Error cargando gestor:`,e),h.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar el gestor. Intenta de nuevo.</p></div>`}finally{y=!1}}}try{let e=sessionStorage.getItem(a);e&&e!==`semaforo`&&l(e)}catch{}function w(){if(!i||i.length===0){p.innerHTML=`<div class="pm-planning-empty"><p>No hay indicadores en esta ruta</p></div>`;return}let e={};i.forEach(t=>{let n=t.tipo||`Sin Categoría`;e[n]||(e[n]=[]),e[n].push(t)}),p.innerHTML=`<div class="pm-planning-grid">${Object.entries(e).map(([e,t])=>`
    ...
    `}async function E(i){Co(e,{indicator:i,claseId:r,maestroId:t,routeVersionId:n})}async function D(a){So(e,{indicator:a,claseId:r,maestroId:t,routeVersionId:n,onSave:async()=>{try{i=await Re(n,t,r),w(),I.success(`✓ Indicadores actualizados`)}catch(e){console.error(`[planning] Error reloading:`,e)}}})}}var To=`alumno_plan_entradas`;async function Eo(e){let{data:t,error:n}=await S.from(To).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function Do(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await S.from(To).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function Oo(e){let{error:t}=await S.from(To).delete().eq(`id`,e);if(t)throw Error(t.message)}var ko={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},Ao=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],jo=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await Eo(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
    ...
    `}_buildEntry(e){let t=ko[e.tipo]||ko.logro,n=new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`});return`
      ...
      <div class="pe-form-overlay">
        <div class="pe-form">
          ...
          <select class="pe-select" id="pe-tipo">
            ${Ao.map(e=>`
              <option value="${e}" ${e===t?`selected`:``}>${ko[e].icon} ${ko[e].label}</option>
            `).join(``)}
          </select>
...
`).trim():``}var zo={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Bo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await S.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await S.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=zo[n.estado_cualitativo]??zo.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          ...
          <div class="pm-prog-card__timeline">
            ${t.map(e=>{let t=zo[e.estado_cualitativo]??zo.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=l.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${ee.map(e=>{let t=j.get(e.clase_id),n=Ro(e.contenido_dsl);return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ne=Mo(r.tlf_alumno||r.representante_tlf);if(ne){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var Ho={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},Uo={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},Wo={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function Go(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(Ho))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function Ko(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=w();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await S.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await S.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${Go(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${L(e.name)}</span>
                          <span class="pm-node-status">${Wo[n]}</span>
                        </div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${Uo[t?.status||`pending`]};"></span>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var $o=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():w(),es=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):c(...e),ts=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):Yo(...e),Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},ns=!1;async function rs(e,{onTopicSelected:t}={}){if(Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!$o()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(d(),Q.clases=await es(!0),!Q.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Q.activeClaseId=Q.clases[0].id,await is(),as(e),ls(e),us(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function is(){Q.loading=!0,Q.rutaId=await Jo(Q.activeClaseId),Q.rutaId?Q.blocks=await ts(Q.rutaId,Q.activeClaseId):Q.blocks=[],Q.loading=!1}function as(e){e.innerHTML=`
  ...
  `;let r=Q.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${cs(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${cs(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${cs(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Q.expandedLevels.has(e.id)?Q.expandedLevels.delete(e.id):Q.expandedLevels.add(e.id),as(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Q.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},as(t)})}),n}function ss(e){let t=e.querySelector(`#ruta-action-panel`);if(!Q.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,as(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{ma({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function cs(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function ls(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await is(),as(e),ls(e)})}function us(e){ns||(ns=!0,Zo.on(`node-covered`,()=>{is().then(()=>{as(e),ls(e)})}))}var ds=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function fs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=w();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await S.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${ds.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function ps(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await R.getStudent(t),r=await R.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([R.getRouteDetail(t),n?R.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}};function _s(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function vs(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function ys(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var bs=null,xs=[],Ss=new Set;async function Cs(e){e.innerHTML=Is();let t=w();if(!t){e.innerHTML=Ls(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await de(t.id);if(!n.puede_inscribir_clases){e.innerHTML=Ts(n),Es(t.id);return}let[r,i]=await Promise.all([m(t.id),Me().catch(()=>[])]);xs=i.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=Ds(r),Ns(r),r.length>0&&await ks(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=Ls(`bi-exclamation-triangle`,`Error al cargar`,_s(t.message))}}function ws(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function Ts(e){return`
    <div class="gcv-root">
  ...
  `}function Es(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await ue(e,`clases:enroll`),I.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
    ...
    <div class="gcv-root">
      ...
      ${e.length===0?Ls(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function Os(e){let t=_s(e.nombre||`Clase sin nombre`),n=ys(e.horarios||[]),r=_s(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function ks(e,t){bs=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await v(e),a=i.map(e=>e.alumno).filter(Boolean);Ss=new Set(i.map(e=>e.alumno_id)),n.innerHTML=As(r,a,xs.filter(e=>!Ss.has(e.id))),Ps(e,t)}catch(e){n.innerHTML=Ls(`bi-exclamation-circle`,`Error al cargar alumnos`,_s(e.message))}}}function As(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${_s(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>js(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>Ms(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function js(e){let t=_s(e.nombre_completo||e.nombre||`Alumno`),n=_s(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${vs(t)}</div>
  ...
  `}var Rs=[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`gestionar-clases`],zs=new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]);function Bs(e,t,n){[`login`,`logout`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`gestionar-clases`,`register`,`pending-approval`].forEach(t=>e.on(t,(e,r)=>n(t,r))),e.on(`ruta-detalle/:id`,(e,t)=>n(`ruta-detalle`,t)),e.onNotFound(()=>n(`hoy`))}function Vs(){let e=document.getElementById(`pm-view-container`);if(!e)return{};e.innerHTML=``;let t={};return Rs.forEach(n=>{let r=document.createElement(`div`);r.id=`pm-view-${n}`,r.className=`pm-view-content`,r.style.display=`none`,e.appendChild(r),t[n]=r}),t}async function Hs(e,t,n,r,i){let{maestroId:a,permisos:o,router:s,showLoginScreen:c,cleanupPushService:l,stopRealtime:u,logoutMaestro:d}=i;switch(e){case`login`:Dn(t,{onSuccess:i.onLoginSuccess});break;case`register`:On(t,{onSuccess:()=>s.navigate(`pending-approval`)});break;case`pending-approval`:kn(t,{onBackToLogin:()=>s.navigate(`login`)});break;case`logout`:c(),l(),u(),d().then(()=>window.location.reload());break;case`calendario`:case`clases`:return await Gn(t);case`hoy`:return await Nn(t,{onClaseClick:e=>s.navigate(`asistencia?clase=${e}`)});case`asistencia`:return await Ga(t,{claseId:r.get(`clase`),fecha:r.get(`fecha`),sesionId:r.get(`sesion`),router:s});case`metricas`:return bn(t);case`perfil`:return to(t);case`clase-emergente`:return Ya(t,{maestroId:a});case`planificacion`:return await wo(t,{maestroId:a});case`alumno`:return Vo(t,{alumnoId:r.get(`id`)||n.id});case`gamificacion`:await Ko(t);break;case`ruta`:await rs(t,{onTopicSelected:e=>s.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:fs(t);break;case`ruta-plan-builder`:ps(t,{alumnoId:r.get(`id`)});break;case`ruta-semanal`:ms(t,{alumnoId:r.get(`id`)});break;case`ruta-libreria`:hs.render().then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`ruta-detalle`:gs.render(n).then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`gestionar-clases`:if(!o?.puede_inscribir_clases){s.navigate(`hoy`);return}return await Cs(t);default:break}return null}var Us=!1,Ws=null;function Gs({isAdmin:e,getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i,onResize:a}){if(Us)return;Us=!0,It(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=Ut();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Rt(),Gt(),e||Ks({getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i}),document.addEventListener(`keydown`,e=>{if(Sn()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`){let n={h:`hoy`,c:`calendario`,r:`ruta`,m:`metricas`,p:`perfil`}[e.key.toLowerCase()];n&&(i(n),t.length=0)}t.length>3&&t.splice(0,t.length-2)});let o=null,s=Sn();window.addEventListener(`resize`,()=>{clearTimeout(o),o=setTimeout(()=>{let e=Sn();e!==s&&(s=e,a())},250)},{passive:!0})}function Ks({getMaestro:e,getPermisosCached:t,onPermisosUpdate:n,onNavigate:r}){let i=e();i?.id&&(Ws&&=(S.removeChannel(Ws),null),Ws=S.channel(`permisos-maestro:${i.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${i.id}`},async e=>{console.log(`[Realtime] Permisos actualizados:`,e.new);try{let e=await de(i.id),r=t(),a=[],o=[];e.puede_inscribir_clases&&!r?.puede_inscribir_clases&&a.push(`Gestionar e Inscribir Clases`),r?.puede_inscribir_clases&&!e.puede_inscribir_clases&&o.push(`Gestionar e Inscribir Clases`),await n(e,{ganados:a,perdidos:o}),a.length>0?I.success(`¡Nuevos permisos activados: ${a.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):o.length>0?I.show(`El administrador removió tu acceso a: ${o.join(`, `)}.`,`warning`):I.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>console.log(`[Realtime] Canal permisos_maestros:`,e)),window.addEventListener(`beforeunload`,()=>S.removeChannel(Ws),{once:!0}))}if(h(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;tt(),Ze({windowMs:6e4,max:100}),Ye({enabled:!1,consent:!1}),it({debug:!1}),Ke({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&I.show(t,n)});var qs=null,Js=null,Ys=!1,$=gt();window.router=$;var Xs={},Zs=null,Qs=new Set;function $s(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}async function ec(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await S.from(t).insert([i]);if(e)throw e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await S.from(t).update(n).eq(`id`,e);if(r)throw r}else if(n===`delete`){let{error:e}=await S.from(t).delete().eq(`id`,i.id);if(e)throw e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await S.from(t).select().limit(1);e?.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico:`,e),e}}var tc=null;async function nc(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await j();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function rc(){clearTimeout(tc),tc=setTimeout(async()=>{if(navigator.onLine)try{await A(ec)}finally{await nc()}},1e3)}window.addEventListener(`online`,rc),window.addEventListener(`offline`,nc);function ic(){Qs.clear()}function ac(e){Qs.delete(e)}async function oc(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e?.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}wn(a),window.pwaInstaller?.evaluateInsights()}let o=Xs[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Zs==`function`&&(Zs(),Zs=null),Object.values(Xs).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),Qs.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{let e=await Hs(a,o,t,i,{maestroId:qs?.id,permisos:Js,router:$,showLoginScreen:cc,cleanupPushService:ce,stopRealtime:()=>{},logoutMaestro:mt,onLoginSuccess:()=>dc()});e&&(Zs=e),clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),zs.has(a)&&Qs.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}function sc(e,t,n){qs=t,Js=n||Js,Tn(e,t,$s(Js),(e,t)=>$.navigate(e,t),nc),document.getElementById(`pm-sync-indicator`)?.addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await rc()});let r=($.currentRoute?.()||`hoy`).split(`?`)[0];wn(r)}function cc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=($.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Xs,Vs()),lc(),$.setAuthGuard(()=>pt.isAuthenticated(),t),$.start();return}let r=Xs.login;if(r){Cn(),r.style.display=`block`,r.innerHTML=``,Hs(`login`,r,{},new URLSearchParams,{router:$,onLoginSuccess:e=>{e&&e!==`login`?$.navigate(e):dc()}});return}e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`,Object.assign(Xs,Vs()),lc(),$.setAuthGuard(()=>pt.isAuthenticated(),t),history.replaceState({route:`login`},``,`#/login`),oc(`login`)}function lc(){Bs($,Ys,oc)}async function uc(){if(qs)try{let t=new Date,n=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),i=t.toISOString().split(`T`)[0],[a,o,s]=await Promise.all([c(),c().then(e=>r(e.map(e=>e.id))),c().then(()=>e(qs.id,i,i))]),l=Object.fromEntries(a.map(e=>[e.id,e]));await le(o.filter(e=>e.dia?.toLowerCase()===n).map(e=>({...e,clase_nombre:l[e.clase_id]?.nombre||`Clase`})),s.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}async function dc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`);let t=await pt.init();if(console.log(`[Init] Auth:`,t?`con maestro`:`sin maestro`),pt.isPendingApproval()){console.log(`[Init] Cuenta pendiente de aprobación — mostrando pantalla de espera`),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Xs,Vs(!1)),lc(),history.replaceState({route:`pending-approval`},``,`#/pending-approval`),oc(`pending-approval`);return}let n=[`login`,`register`,`pending-approval`],r=(window.router||$).currentRoute().split(`?`)[0],i=n.includes(r);if(!t&&!i){cc();return}if(!t&&i){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Xs,Vs()),lc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),$.start();return}if(t.es_admin&&!t.es_maestro){console.log(`[Init] Admin puro detectado → redirigiendo a /admin`),window.location.href=`/admin`;return}let a=null;try{a=await de(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}sc(e,t,a),Object.assign(Xs,Vs()),Gs({isAdmin:!1,getMaestro:()=>qs,getPermisosCached:()=>Js,onPermisosUpdate:async(t,{ganados:r,perdidos:i})=>{let a=($.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`gestionar-clases`&&!t.puede_inscribir_clases||a===`pending-approval`&&r.length>0?`hoy`:a;sc(e,qs,t),Object.assign(Xs,Vs()),lc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),Qs.clear(),await oc(o),$.navigate(o)},onNavigate:e=>$.navigate(e),onResize:()=>{sc(e,qs,Js),Object.assign(Xs,Vs());let t=($.currentRoute?.()||`hoy`).split(`?`)[0];wn(t)}}),vt(ac,ic),lc(),$.setAuthGuard(()=>pt.isAuthenticated(),n),$.start();let o=($.currentRoute?.()||``).split(`?`)[0];(!o||o===`login`||o===`logout`)&&$.navigate(`hoy`),y().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=($.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!Qs.has(e)).reduce((e,t)=>e.then(()=>{if(Xs[t])return oc(t,{},{silent:!0})}),Promise.resolve()),uc(),window.pwaInstaller?.evaluateInsights()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),rc()}var fc=(e,t,n,r)=>`
  ...
  </div>`;window.addEventListener(`error`,e=>{if([`useCache`,`WebSocket`,`content.js`].some(t=>(e.message||``).includes(t))){console.warn(`[Ignored Error]`,e.message);return}qe(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=fc(`bi-x-circle-fill`,`Ups! Algo salió mal`,`Se ha producido un error inesperado en la aplicación.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">${e.message}</div><div style="color:rgba(255,255,255,0.4);">${e.filename?.split(`/`).pop()}:${e.lineno}</div>`))}),window.addEventListener(`unhandledrejection`,e=>{qe(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=fc(`bi-exclamation-triangle-fill`,`Error de Sincronización`,`Hubo un problema al procesar una solicitud de red.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">Promise Rejection</div><div style="color:rgba(255,255,255,0.4);">${String(e.reason)}</div>`))}),dc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});