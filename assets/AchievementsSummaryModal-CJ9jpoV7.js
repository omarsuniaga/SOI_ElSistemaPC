import{i as e}from"./portalUtils-CkF82Yyk.js";function t(t,n){if(!n||n.length===0)return;let r=document.createElement(`div`);r.className=`pm-modal-overlay pm-animate-fade-in`,r.style.zIndex=`9999`;let i=document.createElement(`div`);return i.className=`pm-modal-content pm-achievements-modal pm-animate-scale-up`,i.innerHTML=`
    <style>
    ...
    <div class="pm-achievement-item">
      ...
      ${t.planningContext?`
        <div class="pm-achievement-context">
          <div class="pm-achievement-context-title">Guía ACM · Semana ${e(String(t.planningContext.currentWeek||`—`))}</div>
          ${t.planningContext.topic?`<div class="pm-achievement-context-line"><strong>Tema:</strong> ${e(t.planningContext.topic)}</div>`:``}
          ${t.planningContext.objective?`<div class="pm-achievement-context-line"><strong>Objetivo:</strong> ${e(t.planningContext.objective)}</div>`:``}
          ${t.planningContext.hasTeacherAdjustment?`<div class="pm-achievement-context-line"><strong>Ajuste docente:</strong> aplicado</div>`:``}
        </div>
      `:``}
