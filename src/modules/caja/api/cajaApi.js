...
export const buscarAlumnos           = api.buscarAlumnos
export const getCuotasByAlumno       = api.getCuotasByAlumno
export const listarAlumnosPorEstado  = api.listarAlumnosPorEstado
