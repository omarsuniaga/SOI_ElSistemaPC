...
export const getStudentAbsencesSummary = (...args) => getApi().getStudentAbsencesSummary(...args)
export const getIncompleteClassSessions = (...args) => getApi().getIncompleteClassSessions(...args)
