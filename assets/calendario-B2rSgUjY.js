import"./modulepreload-polyfill-Dezn_h7o.js";import{i as e}from"./supabase-Dhe7Tlxd.js";import"./vendor-fghBzJSA.js";/* empty css                        */import{t}from"./horarioBuilderView-Dyv-9EHI.js";import{t as n}from"./tareasView-2XihvmzN.js";async function r(t){let{data:n}=await e.from(`profiles`).select(`rol`).eq(`id`,t).maybeSingle();return[`admin`,`superadmin`,`coordinacion_academica`,`direccion`].includes(n?.rol)}function i(t,n=null){t.style.background=``,t.innerHTML=`
