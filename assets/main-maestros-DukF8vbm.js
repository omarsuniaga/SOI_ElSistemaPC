...
import{$ as e,A as t,F as n,J as r,K as i,M as a,Q as o,S as s,X as c,Y as l,Z as u,et as d,i as f,j as p,l as m,nt as h,o as g,q as _,s as v,tt as y,v as b,y as x}from"./clasesApi-BzAby4ck.js";import{i as S}from"./supabase-BryBf0UA.js";import{a as C,i as w,n as T,o as E,r as D,t as O}from"./maestroAuth-BZ2ChDTg.js";import{n as k,o as A,s as j}from"./CHANGELOG-CNg1HUtO.js";import"./vendor-DXfjDOBI.js";import{t as ee}from"./idb-mVrqaBz4.js";import{a as M,n as N,r as te,t as P}from"./offlineQueue-fap7YjOo.js";import{a as ne,c as re,d as ie,f as ae,i as oe,l as se,n as ce,o as le,p as ue,r as de,t as fe,u as pe}from"./pushService-BT00dEG_.js";import{r as me,t as he}from"./permisoService-NHGv-s7-.js";import{t as F}from"./AppToast-BfOaB9z8.js";import{n as ge,t as _e}from"./ausenciaModal-Bl3PeQYM.js";import{a as ve,c as ye,i as I,l as be,n as xe,o as Se,r as L,s as Ce,t as we}from"./portalUtils-d8JQ9zxl.js";import{t as R}from"./preload-helper-B_l5jfgx.js";import{t as z}from"./academicService-CdtkOWMO.js";import{t as Te}from"./AppModal-Cd47jEcw.js";import{c as Ee,i as De,l as Oe,o as ke,s as Ae,t as je}from"./groqService-BHtbKQwk.js";import{n as Me}from"./planificacionAdapter-g73e6IAn.js";import{r as Ne,s as Pe}from"./alumnosApi-B81ys2Xz.js";import{n as Fe,r as Ie,t as Le}from"./reportService-Cq2ljVX8.js";import{n as Re,r as ze,t as Be}from"./planningService-s-tkfwT4.js";var Ve=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function He(e=``){let t=String(e).toLowerCase();return Ve.some(e=>t.includes(e.toLowerCase()))}var Ue=console.error;console.error=function(...e){e.length>0&&!He(e[0])&&Ue.apply(console,e)};var We=console.warn;console.warn=function(...e){e.length>0&&!He(e[0])&&We.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{He(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{He(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ge=window.fetch;window.fetch=async function(...e){try{return await Ge.apply(window,e)}catch(e){if(!He(e.message))throw e;return null}};var Ke=!1;function qe(e={}){let{enabled:t=!1,consent:n=!1}=e;Ke=t&&n,console.log(`[Analytics] Initialized, enabled:`,Ke)}var Je={windowMs:6e4,max:100};function Ye(e={}){Je={...Je,...e},console.log(`[RateLimit] Initialized: ${Je.max} requests per ${Je.windowMs}ms`)}var Xe=null,Ze=new Set;function Qe(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function $e(e={}){Xe=Qe(e.length||32),Ze.clear(),Ze.add(Xe),console.log(`[CSRF] Initialized`)}var et={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function tt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function nt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!tt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),rt(t,n),it(t,n),at(t,n),ot(t,n),st(t,n)}function rt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];et.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function it(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];et.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function at(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);et.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];et.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function st(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];et.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var B={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},ct=null,lt=!1;function ut(){B.listeners.forEach(e=>e({...B}))}var dt={subscribe(e){return B.listeners.push(e),()=>{B.listeners=B.listeners.filter(t=>t!==e)}},async init(){lt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),B.maestro=w(),console.log(`[usePortalAuth.init] Maestro local:`,B.maestro?`found`:`not found`),B.loading=!0,ut(),typeof process<`u`&&{}.VITEST)return B.loading=!1,ut(),console.log(`[usePortalAuth.init] Completado (Test Env)`),B.maestro;if(!ct){let{data:{subscription:e}}=S.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),lt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),B.maestro=null,ut();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=w();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await D();e&&(B.maestro=e,ut())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});ct=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([D(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===O||t?.__pendingApproval?(B.maestro=null,B.pendingApproval=!0):(B.maestro=t,B.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),B.maestro=null,B.pendingApproval=!1}return B.loading=!1,ut(),console.log(`[usePortalAuth.init] Completado`),B.maestro}finally{lt=!1}},setMaestro(e){B.maestro=e,B.loading=!1,ut()},async logout(){await E(),B.maestro=null,ut()},getMaestro:()=>B.maestro,isAuthenticated:()=>!!B.maestro,isLoading:()=>B.loading,isPendingApproval:()=>B.pendingApproval},ft=dt.logout,pt=`calendario`;function mt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):pt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:pt},``,`#/${pt}`),h(pt);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var ht=null;function gt(e,t){ht=e}function _t(e){ht&&ht(e)}var vt=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),F.show(`Auto-navegación cancelada`,`info`)})}async function jn(t,{onClaseClick:n}={}){t.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=w();if(!i){t.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let a=new Date,s=a.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),u=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,`0`)}-${String(a.getDate()).padStart(2,`0`)}`;try{let d=await _(i.id,u);if(d&&d.length>0){t.innerHTML=Mn(d,s,a),Pn(t,u,i.id);return}let f=await c();if(!f||f.length===0){t.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let p=f.map(e=>e.id),m=Object.fromEntries(f.map(e=>[e.id,e])),h=(await r(p)).filter(e=>e.dia?.toLowerCase()===s).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){t.innerHTML=`
    ...
    `,t.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,n=e.dataset.fecha;try{await z.createSnapshotFromPlan(t,n,i.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${n}`)})}),t.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let t=e.dataset.claseId;try{await z.createSnapshotFromPlan(t,u,i.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),n?.(t)})});let N=A||j;N&&(requestAnimationFrame(()=>{t.querySelector(`[data-clase-id="${N}"]`)?.scrollIntoView({behavior:`smooth`,block:`center`})}),A&&setTimeout(()=>{An(A,u,n)},800))}catch(e){t.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${I(e.message)}</p>`}}function Mn(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=Nn(e.motivo);return`
...
`,vi=class{constructor(e,t=gi){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(mi)||(this._autoTimer=setTimeout(()=>this.start(),hi))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(mi,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=_i,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,await Si()}async function bi(e,t,n,r){Te.open({title:`Editar ${e}`,body:`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>xi(`Clase`,null,()=>Si()),Y.activeClassId?Ci(Y.activeClassId):ki(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),bi(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Si())},e.onclick=()=>{Y.activeClassId=t,Y.activeLevelId=Y.activeNodeId=Y.activeObjectiveId=null,Si(),Ci(t),ki(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),ki(`#pm-rc-objs-wrapper`,`Elegí Tema`),ki(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ci(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await J.getLevelsByClass(e);!n.some(e=>e.id===Y.activeLevelId)&&n.length>0?Y.activeLevelId=n[0].id:n.length===0&&(Y.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>xi(`Nivel`,e,()=>Ci(e)),Y.activeLevelId?wi(Y.activeLevelId):ki(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),bi(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ci(e))},t.onclick=()=>{Y.activeLevelId=n,Y.activeNodeId=Y.activeObjectiveId=null,Ci(e),wi(n),ki(`#pm-rc-objs-wrapper`,`Elegí Tema`),ki(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function wi(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await J.getNodesByLevel(e);!n.some(e=>e.id===Y.activeNodeId)&&n.length>0?Y.activeNodeId=n[0].id:n.length===0&&(Y.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>xi(`Tema`,e,()=>wi(e)),Y.activeNodeId?Ti(Y.activeNodeId):ki(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),bi(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>wi(e))},t.onclick=()=>{Y.activeNodeId=n,Y.activeObjectiveId=null,wi(e),Ti(n),ki(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ti(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await J.getObjectivesByNode(e);!n.some(e=>e.id===Y.activeObjectiveId)&&n.length>0?Y.activeObjectiveId=n[0].id:n.length===0&&(Y.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>xi(`Objetivo`,e,()=>Ti(e)),Y.activeObjectiveId?Oi(Y.activeObjectiveId):ki(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),bi(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ti(e))},t.onclick=()=>{Y.activeObjectiveId=n,Ti(e),Oi(n)}})}var Ei={0:`Sin eval.`,1:`Inicial`,2:`En desarrollo`,3:`Logrado`,4:`Destacado`,5:`Superado`},Di={0:`var(--pm-text-muted)`,1:`#ef4444`,2:`#f97316`,3:`#22c55e`,4:`#06b6d4`,5:`#8b5cf6`};async function Oi(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
          ...
          <div class="pm-rc-calif-row" style="display:flex;gap:4px;padding-left:1.6rem;" data-indicator-id="${e.id}">
            ${[1,2,3,4,5].map(t=>`
              <button class="pm-rc-calif-btn" data-calif="${t}" style="
                width:28px;height:28px;border-radius:50%;border:2px solid ${Di[t]};
                background:${e.calificacion===t?Di[t]:`transparent`};
                color:${e.calificacion===t?`#fff`:Di[t]};
            ...
            `:``}
            <span style="font-size:0.6rem;color:${Di[e.calificacion]||`var(--pm-text-muted)`};margin-left:auto;align-self:center;font-weight:600;">
              ${Ei[e.calificacion]||Ei[0]}
            </span>
          </div>
        </div>
      `).join(``)}
    </div>
  `,t.querySelector(`#btn-add-ind`).onclick=()=>xi(`Indicador`,e,()=>Oi(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=n=>{n.stopPropagation();let r=t.dataset.id,i=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;bi(`Indicador`,r,i,()=>Oi(e))}}),t.querySelectorAll(`.pm-rc-calif-btn, .pm-rc-calif-clear`).forEach(t=>{t.onclick=async n=>{n.stopPropagation();let r=t.closest(`.pm-rc-calif-row`).dataset.indicatorId,i=parseInt(t.dataset.calif,10);try{await J.updateIndicatorCalificacion(r,i),Oi(e)}catch(e){console.error(`Error updating calificacion:`,e)}}})}function ki(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}function Ai(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function ji(e,{claseId:t,rutaId:n,completedTopics:r=[],onIndicadorSelect:i}){let a=[],o=!1,s=null,c=document.createElement(`div`);if(c.className=`pm-route-bar-wrapper`,e.appendChild(c),!document.getElementById(`pm-route-bar-styles`)){let e=document.createElement(`style`);e.id=`pm-route-bar-styles`,e.textContent=`
    ...
    `).join(``)}async function d(){if(n){o=!0,u();try{a=await J.getRouteHierarchy(n)}catch(e){console.error(`[routeTreeBar] Error:`,e)}finally{o=!1,u()}}}function f(){c.removeEventListener(`click`,l),c.remove()}function p(){return s}return d(),{refresh:d,destroy:f,getActiveIndicador:p}}function Mi(e){return!e||typeof e!=`string`||!e.trim()||/[#[({$>]/.test(e)?`dsl`:`natural`}function Ni(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=$n(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function Pi(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Fi(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Ii(e,t,n,r,i=null){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let a=n;if(i&&i.length>0){let e=new Set(i.map(e=>e.id)),t=n.length;a=n.filter(t=>e.has(t.alumno_id)),a.length<t&&console.warn(`[evaluationService] saveEvaluaciones: filtrados ${t-a.length} evaluaciones de alumnos ausentes`)}let o=a.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea}));try{let{data:e,error:t}=await S.from(`indicator_attempts`).upsert(o,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});if(t)throw t;return{data:e,error:null}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[evaluationService] Offline, encolando saveEvaluaciones...`);for(let e of o)await P({tabla:`indicator_attempts`,operacion:`upsert`,payload:e});return{data:null,error:null,_offline:!0}}return{data:null,error:e}}}async function Li(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await S.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await S.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Fi(a??[],l),indicators:n,totalAlumnos:l}}async function Ri(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Mi(e);try{let t=e;i===`natural`&&(t=await Ae(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=Pi(Ni(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,textoMejorado:zi(e,a,n),error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],textoMejorado:``,error:e.message||`Error desconocido`}}}function zi(e,t,n){let r=new Map(n.map(e=>[e.id,e.nombre_completo])),i=[];e?.trim()&&(i.push(`Texto original: "${e.trim()}"`),i.push(``)),i.push(`Evaluaciones:`);for(let e of t){let t=r.get(e.alumno_id)||`Alumno`,n=e.nota!==null&&e.nota!==void 0?`${e.nota}/5`:`—`,a=e.observacion?.trim()?e.observacion:`—`,o=e.tarea?.trim()?` | Tarea: ${e.tarea}`:``;i.push(`• ${t}: ${a} | Nota: ${n}${o}`)}return i.join(`
`)}function Bi(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function X(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Vi(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function Hi(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function Ui(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function Wi(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await S.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=Ui(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function Gi(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${X(Vi(e.nombre_completo))}</div>
      <div>
  ...
  `}function Ki(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${X(Hi(e.created_at))}</span>
  ...
  `}function qi(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Ji(e){return e.length?`
  ...
  `:``}function Yi(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${Gi(e,n)}
...
`)}function r(e,t){let n=$i[e.estado]||$i.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${ea[e.estado]||``}`:`ssp-alumno-chip`}">${na(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${na(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${na(e.tarea)}</div>`:``;return`
  ...
  `,document.head.appendChild(e)}function sa({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ca(e,t,n){let{data:r,error:i}=await S.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await S.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await S.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function la(e,t){let{data:n,error:r}=await S.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function ua(e){let{error:t}=await S.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function da(e,t,n,r,i=null,a=null){try{let{error:o}=await S.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await S.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await P({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}var fa=`soi_ruta_tema_pendiente`;function pa(e){sessionStorage.setItem(fa,JSON.stringify(e))}function ma(){let e=sessionStorage.getItem(fa);if(!e)return null;sessionStorage.removeItem(fa);try{return JSON.parse(e)}catch{return null}}function ha(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `,document.body.appendChild(i),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let a=null,o=null,s=null,c=null,l=!1,u=null,d=null,f=i.querySelector(`#pm-justif-title`),p=i.querySelector(`#pm-justif-subtitle`),m=i.querySelector(`#pm-justif-btn-text`),h=i.querySelector(`#pm-justif-alumno-nombre`),g=i.querySelector(`#pm-justif-motivo`),_=i.querySelector(`#pm-justif-file`),v=i.querySelector(`.pm-justif-file-placeholder`),y=i.querySelector(`.pm-justif-file-preview`),b=i.querySelector(`#pm-justif-preview-img`),x=i.querySelector(`#pm-justif-remove-file`),S=i.querySelector(`#pm-justif-delete`);function C(e,t=null,n=null){a=e,o=t,s=null,c=null,l=!!t,u=n,l?(f.textContent=`Editar Justificación`,p.textContent=`Modifica el motivo de la inasistencia`,m.textContent=`Actualizar`,S.style.display=`flex`):(f.textContent=`Justificar Inasistencia`,p.textContent=`Registra el motivo de la ausencia`,m.textContent=`Guardar Justificación`,S.style.display=`none`),h.textContent=e.nombre_completo,g.value=t?.motivo||``;let r=t?.evidencia_url||t?.evidencia_base64;r?(c=r,b.src=r,v.style.display=`none`,y.style.display=`block`):(c=null,v.style.display=`flex`,y.style.display=`none`),_.value=``,i.classList.add(`open`),g.focus();let x=i.querySelector(`.pm-justif-modal`);x&&(d&&d.dispose(),d=ge(x,{onClose:()=>w(!0)}))}function w(e=!1){e&&n&&a&&u!==null&&n(a.id,u),i.classList.remove(`open`),a=null,o=null,s=null,c=null,u=null,d&&=(d.dispose(),null)}i.querySelector(`#pm-justif-close`).onclick=()=>w(!0),i.querySelector(`#pm-justif-cancel`).onclick=()=>w(!0),S.onclick=()=>{a&&confirm(`¿Eliminar la justificación de ${a.nombre_completo}?`)&&(r&&r({alumnoId:a.id,justificacionId:o?.id,existingUrl:o?.evidencia_url||o?.evidencia_base64}),w(!1))},i.querySelector(`.pm-justif-backdrop`).onclick=()=>w(!0),_.onchange=e=>{let t=e.target.files[0];t&&(s=t,c=URL.createObjectURL(t),b.src=c,v.style.display=`none`,y.style.display=`block`)},x.onclick=()=>{c&&!(o?.evidencia_url||o?.evidencia_base64)&&URL.revokeObjectURL(c),s=null,c=null,_.value=``,v.style.display=`flex`,y.style.display=`none`},i.querySelector(`#pm-justif-save`).onclick=()=>{let e=g.value.trim();if(!e){g.focus(),g.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{g.style.borderColor=``},2e3);return}t&&a&&t({alumnoId:a.id,motivo:e,evidenciaFile:s,evidenciaPreview:c,justificacionId:o?.id||null,existingUrl:o?.evidencia_url||o?.evidencia_base64||null,isEdit:l})};let T=e=>{e.key===`Escape`&&(w(),document.removeEventListener(`keydown`,T))};return document.addEventListener(`keydown`,T),{open:C,close:w}}var ga=`documentos`;async function _a(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await S.storage.from(ga).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=S.storage.from(ga).getPublicUrl(r);return o.publicUrl}async function va({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await _a(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await S.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function ya(e,t){if(!e||!t)return null;let{data:n,error:r}=await S.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ba(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await S.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function xa(e,t,n,r,i=`Clase`,a=null){if(!r||r.length===0)return{success:!0};let o=r;if(a&&a.length>0){let e=new Set(a.map(e=>e.id)),t=r.length;o=r.filter(t=>e.has(t.alumno_id)),o.length<t&&console.warn(`[Promotion] promocionarObservacionesAlumnos: filtrados ${t-o.length} evaluaciones de alumnos ausentes`)}let s=o.filter(e=>e.observacion&&e.observacion.trim().length>0);if(s.length===0)return{success:!0};let c=s.map(r=>new p({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON());try{let{data:e,error:t}=await S.from(`observaciones_alumnos`).upsert(c,{onConflict:`sesion_clase_id,alumno_id`});if(t)throw t;return{success:!0,data:e}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[Promotion] Offline, encolando promoción de observaciones...`);for(let e of c)await P({tabla:`observaciones_alumnos`,operacion:`upsert`,payload:e});return{success:!0,_offline:!0,count:c.length}}return console.error(`[Promotion] Error promoviendo observaciones:`,e),{success:!1,error:e.message}}}function Sa(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function Ca(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function wa(e,t){let n=Ca(e);return t.find(e=>Ca(e.nombre)===n||Ca(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&Ca(e.nombre).includes(n)||n.length>=3&&n.includes(Ca(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Ta(e,t){let n=[],r=[];for(let i of e){if(Ca(i)===`todos`){n.push(...t);continue}let e=wa(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Ea(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await S.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function Da({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=Ee(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await Ea(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function Oa({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Ta(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Ea(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function ka({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=$n(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Oa({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Aa({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await S.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Ca(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Ca(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await S.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var ja={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Ma=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Na(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Pa={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Fa(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Pa[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Ia(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Na(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Na(n.join(`, `))}</span>`:``}}function o(e,t){let n=ja[e.estado]??ja.EN_PROGRESO,r=e.nota?` · ${Na(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Na(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Pa[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${Na(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${Na(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${Na(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${Na((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${Na(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${Na(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Fa(c)}</div>`:``,d=Oe(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${Na(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${Na(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,La(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Ma.indexOf(i)+1)%Ma.length;r[n].estado=Ma[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function La(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function Ra(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await S.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=za[e.tipo]??za.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${Va(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${Va(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${Va(o)}" placeholder="ej. Básico" />
          </label>
        </div>
  ...
  `;let j=e.querySelector(`#pm-sync-badge-container`);if(j){let e=Jn();j.appendChild(e.el)}let ee=e.querySelector(`#pm-dsl-toolbar-container`),M=e.querySelector(`#pm-dsl-editor-container`),N=ui(M,{initialContent:g,onChange:e=>{D=e}});N.setContext({claseId:m});let te=pi(e,{onAceptar:e=>{N.setValue(e)}}),ne=ar(e,{onAccept:e=>{N.setValue(e)}}),re=Ia(M.parentNode,{onConfirm:async t=>{try{let n=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Oa({sesionId:C,claseId:m,maestroId:f.id,fechaHoy:p,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=e.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Ha(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await n({instrumento:e,nivel:t,descripcion:r,pilares:i}),{linked:s}=await Aa({claseId:m,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;F.success(c)}catch(e){F.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=sr(ee,{onInsert:(e,t,n)=>N.insertText(e,t,n),getEditorContent:()=>N.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=ee.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await De(e);te.open({original:e,improved:t})}catch(e){F.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=ee.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=A?.getActiveIndicador(),n=await Ae(e,{presentes:s.filter(e=>l[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){F.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async t=>{await Ua(async()=>{let n=s.filter(e=>l[e.id]&&l[e.id]!==`A`),r=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},a=s.map(e=>e.nombre_completo||e.nombre||``),o={alumnos:s.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,a)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,a)}}),tipoClase:Re(i),instrumento:i.instrumento||``,sesionesRecientes:(h||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:A?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let c=await je(t,o);if(!c?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:c.progreso,resumen:c.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.error(`Error al analizar con IA: `+t.message)}})}}),oe=null,se=e.querySelector(`#pm-planificacion-card`),ce=e.querySelector(`#pm-planificacion-dropdown`),le=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let ue=e.querySelector(`#pm-plan-list-rutas`),de=e.querySelector(`#pm-plan-list-planificaciones`),fe=e.querySelector(`#pm-planificacion-header`);fe&&fe.addEventListener(`click`,()=>{let e=se.classList.toggle(`open`);ce.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;ue.style.display=n===`rutas`?``:`none`,de.style.display=n===`planificaciones`?``:`none`})});function pe(t){oe=t.id,localStorage.setItem(`pm_default_plan_${m}`,t.id),le&&(le.textContent=t.nombre||t.name||`Sin nombre`),de.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),A&&=(A.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);oe&&n&&(n.innerHTML=``,He(m).then(e=>{A=ji(n,{claseId:m,rutaId:oe,completedTopics:e,onIndicadorSelect:e=>{N.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),se.classList.remove(`open`),ce.style.display=`none`}}),T.push(()=>A.destroy())}))}let me=e.querySelector(`#btn-manage-planning`);me&&(me.onclick=e=>{if(e.stopPropagation(),!oe){Te.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Te.open({title:`Gestionar Estructura: ${le.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(A&&A.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&yi(t,oe)}),se&&(async()=>{try{let e=await J.getClasses(f?f.id:null),t=localStorage.getItem(`pm_default_plan_${m}`),n=(i.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ue&&(ue.innerHTML=r.length?r.map(e=>`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let ye=ha(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&S.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&ba(t).catch(console.warn),l[e]=null,delete u[e],z(e),Oe();try{await Ne(!0)}catch(e){console.warn(`[asistencia] autoSave error on delete justif:`,e)}ln(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await S.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await S.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=S.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await S.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{C||await Ne(!0,!1);let r=await va({sesionId:C,alumnoId:e,claseId:m,fecha:p,motivo:t,creadoPor:f.id},n);if(r.error)throw r.error;o=r.data}o&&(u[e]=o),ye.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{l[e]=t,z(e),Oe()}});T.push(()=>{try{ye.close()}catch{}});let be=null,xe=e.querySelector(`#pm-draft-indicator`);if(C){be=sa({saveFn:async e=>{C&&await ca(C,f.id,e)},debounceMs:3e4}),be.onSaved(()=>{let e=new Date;xe.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,xe.style.display=``}),N.getValue;let e=M.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),be&&be.onInput(N.getValue())}}T.push(()=>be.destroy()),b?.borrador===!0&&la(C,f.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(N.setValue(e.contenido_raw),D=e.contenido_raw):ua(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let L=e.querySelector(`#btn-guardar-obs`);L&&(y&&(L.style.display=``),L.onclick=async()=>{let t=N.getValue();if(!t||!t.trim()){F.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!C){F.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let n=null,r=await Ue(t),a=A?.getActiveIndicador();if(n=r||a,!n){F.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let o=e.querySelector(`#pm-active-tema-badge`);o&&n.nombre&&(o.textContent=n.nombre,o.style.display=`inline-block`),L.disabled=!0,L.textContent=`Procesando...`;try{let r=s.filter(e=>l[e.id]===`P`),a=await Ri(t,n.id,r,n.nombre);if(a.error)throw Error(a.error);if(a.modo===`natural`&&a.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+a.dslGenerado+`

¿Guardar la evaluación?`)){L.disabled=!1,L.textContent=`Guardar observación`;return}if(a.missing.length>0&&!confirm(`Faltan ${a.missing.length} alumno(s) sin evaluar:\n${a.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){L.disabled=!1,L.textContent=`Guardar observación`;return}if(a.evaluaciones.length>0){let{error:e}=await Ii(C,n.id,a.evaluaciones,f.id,r);if(e)throw e}let o={indicador_id:n.id,evaluaciones:a.evaluaciones};await da(C,f.id,t,o,a.dslGenerado||null,a.textoMejorado||null);let c=$n(t);if(c.estados&&c.estados.length>0){let e=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));ka({sesionId:C,claseId:m,maestroId:f.id,fechaHoy:p,dslText:t,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&ze(e,M)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await xa(C,m,f.id,a.evaluaciones,i.nombre||`Clase`,r);u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),A&&await A.refresh(),N.setValue(``),D=``;let d=document.createElement(`div`);if(d.innerHTML=`
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;F.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}e.querySelector(`#pm-asist-back`).onclick=()=>{We.destroy();try{ye.close()}catch{}T.forEach(e=>{try{e()}catch{}}),w(`hoy`)},e.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{l[e.id]=`P`}),z(),Oe();try{await Ne(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk P:`,e)}ln(`Todos los ${s.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{l[e.id]=`A`}),z(),Oe();try{await Ne(!0)}catch(e){console.warn(`[asistencia] autoSave error on bulk A:`,e)}ln(`Todos los ${s.length} alumnos marcados como ausentes.`)},z();async function He(e){try{let{data:t}=await S.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Ue(e){if(!e||!oe)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await J.getRouteHierarchy(oe),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let We=new vi(e);We.mount();let Ge=e.querySelector(`#pm-btn-help`);return Ge&&(Ge.onclick=()=>We.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),We.destroy();try{ye.close()}catch{}T.forEach(e=>{try{e()}catch{}})}}function qa(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Ja(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await S.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Ja(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await P({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Xa={async open(){let e=await ce(),t=await oe();Te.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);no(n,t),ro(n,t),mo(n,t),io(r),ao(r,t),oo(r),so(r,t),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),uo(r),fo(r),So(t),_o(t),Co(),R(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-NHGv-s7-.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&po(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function no(e,t){let n=ye(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ao(e,t){let n=ne(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function so(e,t){e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section" aria-labelledby="solicitudes-title" id="pm-solicitudes-section">
      ...
      </div>`).join(``)}catch(e){console.error(`[historial sol]`,e),t&&(t.innerHTML=`<p class="text-danger small mb-0">Error al cargar el historial.</p>`)}}function uo(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function po(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await R(async()=>{let{getPermisos:e}=await import(`./permisoService-NHGv-s7-.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));po(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function mo(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${eo.map(e=>ho(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
...
`);throw Error(e)}let{error:o}=await S.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let c={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(T,JSON.stringify(c)),Z.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{Z.saving=!1,a.disabled=!1,a.innerHTML=o}}function yo(){let e={};return eo.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function bo(){Te.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await E(),window.location.reload(),!0)})}function xo(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),Z.theme=e}function So(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function Co(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var wo=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=wo,document.head.appendChild(e)}async function To(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i,onSave:a}){let o=new Set,s=document.createElement(`div`);s.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
...
`).trim():``}var Ho={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Uo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await S.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await S.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Ho[n.estado_cualitativo]??Ho.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let re=Fo(r.tlf_alumno||r.representante_tlf);if(re){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var ns=()=>typeof globalThis<`u`&&globalThis.getMaestroLocal?globalThis.getMaestroLocal():w(),rs=(...e)=>typeof globalThis<`u`&&globalThis.getMisClases?globalThis.getMisClases(...e):c(...e),is=(...e)=>typeof globalThis<`u`&&globalThis.loadRouteTree?globalThis.loadRouteTree(...e):Qo(...e),Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},as=!1;async function os(e,{onTopicSelected:t}={}){if(Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!ns()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(d(),Q.clases=await rs(!0),!Q.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Q.activeClaseId=Q.clases[0].id,await ss(),cs(e),fs(e),ps(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function ss(){Q.loading=!0,Q.rutaId=await Zo(Q.activeClaseId),Q.rutaId?Q.blocks=await is(Q.rutaId,Q.activeClaseId):Q.blocks=[],Q.loading=!1}function cs(e){e.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,cs(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{pa({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function ds(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function fs(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await ss(),cs(e),fs(e)})}function ps(e){as||(as=!0,es.on(`node-covered`,()=>{ss().then(()=>{cs(e),fs(e)})}))}var ms=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function hs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=w();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await S.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
    ...
    `}}async function gs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await z.getStudent(t),r=await z.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
  ...
  `}function ks(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await me(e,`clases:enroll`),F.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){F.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function As(e){return`
    <div class="gcv-root">
