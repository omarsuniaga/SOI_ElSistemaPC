import{i as e}from"./supabase-KnARm58N.js";import{t}from"./academicService-D-BIm-fm.js";import{i as n}from"./portalUtils-C92TBVO0.js";async function r(r,{alumnoId:i}){r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let a=await t.getStudent(i),o=await t.fetchRoutes();r.innerHTML=`
