...
| **[planificacion-dataadapter](file:///C:/Users/omare/OneDrive/Documentos/SOI_Sistema_Operativo_Institucional/09_SOI_WEB_PORTAL/sistema-academico-pwa/openspec/changes/planificacion-dataadapter/tasks.md)** | 🔴 **Pendiente** (0%) | A crear en Fase 3 | `planificacionAdapter.js`<br>`planificacionMock.js`<br>`usePlanificacion.js` | Refactorizar el acceso de datos de planificación para implementar la facade (Supabase / Mock local en IndexedDB). |
| **[curriculo-tres-planos](file:///C:/Users/omare/OneDrive/Documentos/SOI_Sistema_Operativo_Institucional/09_SOI_WEB_PORTAL/sistema-academico-pwa/openspec/changes/curriculo-tres-planos/tasks.md)** | 🟡 **Fase DB** (100%)<br>🔴 **Fase UI** (0%) | `curriculoTresPlanos.schema.test.js` | `supabase/migrations/`<br>`weeklyPlanSupabase.js`<br>`planningParserService.js` | Las migraciones de base de datos (`objetivos` tier, `route_status` enums y la función de progresión) están en disco y pasan sus tests, pero falta la UI de ACM y maestros. |
| **[modulo-planificacion-standardization](file:///C:/Users/omare/OneDrive/Documentos/SOI_Sistema_Operativo_Institucional/09_SOI_WEB_PORTAL/sistema-academico-pwa/openspec/changes/modulo-planificacion-standardization/tasks.md)** | 🔴 **Pendiente** (0%) | Por definir | Múltiples módulos | Estandarización de componentes de planificación y vistas asociadas. |
