import{r as e}from"./rolldown-runtime-DlOssbPu.js";import{i as t}from"./supabase-KnARm58N.js";import"./vendor-BUMNmNsE.js";import{t as n}from"./AppToast-3qbHkRVc.js";import{C as r,E as i,S as a,T as o,_ as s,a as c,b as l,c as u,d,f as ee,g as f,h as te,i as ne,l as re,m as ie,n as ae,p as oe,r as se,t as ce,u as le,v as ue,w as de,x as fe,y as pe}from"./scoreDirectorView-CM1twvug.js";import{t as p}from"./router-CIpEKvFn.js";import{t as m}from"./AppModal-CBzMtyFx.js";import{n as me}from"./groqService-mbMO9U99.js";import{C as he,S as ge,_ as _e,c as ve,l as ye,n as be,o as xe,s as Se,v as Ce}from"./tareasApi-Cqzbd4AN.js";import{t as we}from"./tareasView-D4p5jk1B.js";import{i as Te,n as Ee}from"./instrumentosApi-DuLy-UAM.js";var De={DIR:`Dirección`,ACM:`Académica`,ADM:`Administración`,FIN:`Financiero`,LOG:`Logística`,COM:`Comunicaciones`,TECNICO:`Técnico`,LUT:`Lutería`,OPR:`Operaciones`},Oe={critica:`danger`,alta:`warning`,media:`info`,baja:`secondary`},h={procedimientos:[],processContracts:[],cargando:!1};function g(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}async function ke(e){let t=new AbortController;return await _(e),e.addEventListener(`click`,async t=>{if(t.target.closest(`#btn-refrescar-proc`))return _(e);let n=t.target.closest(`[data-open-case-detail]`);if(n){p.navigate(`hermes-caso`,{processCode:n.dataset.processCode||null,correlationId:n.dataset.correlationId||null});return}let r=t.target.closest(`[data-start-process-code]`);if(r){let t=r.dataset.startProcessCode,n=h.processContracts.find(e=>e.process_code===t),i=window.prompt(`Título del caso para ${t}:`,n?.process_name||t);if(!i?.trim())return;let a=window.prompt(`Descripción breve del caso:`)||``;try{await Ce({process_code:t,title:i.trim(),description:a.trim()||null,source:`manual`,priority:`media`,metadata:{opened_from:`procedimientos_view`}}),alert(`Caso SOI abierto: Hermes generó las tareas departamentales del contrato.`),_(e)}catch(e){alert(`Error: ${e.message}`)}return}if(t.target.closest(`#btn-caso-alumno`)){let t=window.prompt(`Nombre del alumno en riesgo:`);if(!t?.trim())return;let n=window.prompt(`Motivo (ausencias, bajo progreso, morosidad…):`)||``;if(he(`${t}\n${n}`)){alert(ge());return}try{await _e(null,t.trim(),n.trim()),alert(`Caso abierto: se delegaron tareas a Académico, Comunicación, Finanzas y Dirección.`),_(e)}catch(e){alert(`Error: ${e.message}`)}}},{signal:t.signal}),{teardown:()=>t.abort()}}async function _(e){try{h.cargando=!0,je(e);let[t,n]=await Promise.all([Se(),ye()]);h.procedimientos=t,h.processContracts=n}catch(t){e.innerHTML=`<div class="alert alert-danger m-3">Error cargando procedimientos: ${g(t.message)}</div>`;return}finally{h.cargando=!1}je(e)}function Ae(e){return{totalProc:e.length,enCurso:e.filter(e=>e.pct_avance<100&&e.total>e.canceladas).length,bloqueados:e.filter(e=>e.bloqueadas>0).length,observados:e.filter(e=>e.observadas>0).length,criticos:e.filter(e=>e.prioridad_max===`critica`).length}}function je(e){if(h.cargando&&h.procedimientos.length===0){e.innerHTML=`<div class="text-center text-muted py-5"><div class="spinner-border" role="status"></div><p class="mt-2">Cargando procedimientos…</p></div>`;return}let t=h.procedimientos,n=Ae(t),r=(e,t,n,r)=>`
    ...
    <div class="sidebar-footer">
      <div class="sidebar-user">
        ...
        <span class="sidebar-user-name" title="${o}">${o.split(`@`)[0]}</span>
      </div>
  ...
  `,e.querySelector(`#btnSalir`)?.addEventListener(`click`,async()=>{await t.auth.signOut(),window.location.reload()})}async function et(e){let t=`current-view-${e.hermesDept.toLowerCase()}`,n=document.querySelector(`#app`);if(!n){console.error(`El contenedor #app no existe en el HTML`);return}qe();try{o()}catch(e){console.error(`Error registrando auth:`,e)}e.registrars.forEach(e=>{try{e()}catch(e){console.error(`Error registrando módulo:`,e)}}),p.register(Ke,(t,n={})=>we(t,{departamento:e.hermesDept,hideCalendarBtn:!0,...n})),p.register(`hermes-caso`,(e,t={})=>Ie(e,t)),p.register(`cierre-academico`,e=>te(e)),p.register(`hermes-procedimientos`,e=>ke(e)),p.register(`dir-score`,e=>ce(e)),p.register(`hermes-consulta`,e=>Ue(e)),p.initCustomEvents(),await i.refreshAuth(),p.setAuthGuard(()=>i.isAuthenticated(),[`login`,`register`]),p.init=function(){let n=localStorage.getItem(t)||e.defaultRoute;this.navigate(n)};let r=p._navigateTo.bind(p);p._navigateTo=function(e,n={}){r(e,n),localStorage.setItem(t,e)};let a=async()=>{if(!i.isAuthenticated()){Ze(e,!1,t),p.navigate(`login`);return}let r=i.getUser()||i.getState?.().user;if(!r?.id){console.warn(`[portalShell] autenticado pero sin user.id; redirigiendo a login`),Ze(e,!1,t),p.navigate(`login`);return}let a=await Qe(r.id);if(!e.allowedRoles.includes(a)){$e(n,e.brandText);return}Ze(e,!0,t);let o=localStorage.getItem(t);p.navigate(o&&p.routes[o]?o:e.defaultRoute)};try{await a()}catch(t){console.error(`[portalShell] Error en boot:`,t),tt(n,e.brandText,t);return}let s=!1;i.subscribe(async e=>{if(!s){s=!0;try{e.user?await a():(document.querySelector(`.app-sidebar`)?.remove(),n.innerHTML=``,p.navigate(`login`))}catch(e){console.error(`[portalShell] Error en re-gate:`,e)}finally{s=!1}}})}function tt(e,t,n){document.querySelector(`.app-sidebar`)?.remove(),e.innerHTML=`
    <div class="d-flex align-items-center justify-content-center" style="min-height:100vh">
...
- Devolvé SOLO el mensaje mejorado, sin explicaciones ni comillas.`;async function bt(e,t=``){let n=t?`Instrucción adicional: ${t}\n\nMensaje a mejorar:\n${e}`:`Mensaje a mejorar:\n${e}`,r=await me([{role:`system`,content:yt},{role:`user`,content:n}]);return typeof r==`string`?r.trim():r&&typeof r.content==`string`?r.content.trim():String(r||``).trim()}function xt(e){let t=new Date;return t.setDate(t.getDate()+e),t.toISOString().slice(0,10)}new Date(Date.now()-2*864e5).toISOString(),xt(-1),new Date(Date.now()-2*864e5).toISOString(),new Date(Date.now()-2*864e5).toISOString(),new Date(Date.now()-1*864e5).toISOString(),xt(0),new Date(Date.now()-1*864e5).toISOString(),new Date(Date.now()-1*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString();var St=e({actualizarSeguimiento:()=>Dt,cerrarSeguimiento:()=>Ot,crearSeguimiento:()=>Et,eliminarSeguimiento:()=>kt,getSeguimientos:()=>wt,getSeguimientosByAlumno:()=>Tt}),E=`comunicaciones_seguimiento`,Ct=`id, alumno_id, contacto_nombre, contacto_telefono, contacto_email, canal, fecha, resultado, notas, requiere_seguimiento, proxima_accion, proxima_fecha, estado, responsable_id, created_at, updated_at`;async function wt(e={}){let n=t.from(E).select(Ct);e.alumno_id&&(n=n.eq(`alumno_id`,e.alumno_id)),e.estado&&(n=n.eq(`estado`,e.estado)),e.canal&&(n=n.eq(`canal`,e.canal));let{data:r,error:i}=await n.order(`fecha`,{ascending:!1});if(i)throw i;return r||[]}async function Tt(e){return wt({alumno_id:e})}async function Et(e){let n={alumno_id:e.alumno_id||null,contacto_nombre:e.contacto_nombre||null,contacto_telefono:e.contacto_telefono||null,contacto_email:e.contacto_email||null,canal:e.canal||`llamada`,fecha:e.fecha||new Date().toISOString(),resultado:e.resultado||`contactado`,notas:e.notas||null,requiere_seguimiento:!!e.requiere_seguimiento,proxima_accion:e.proxima_accion||null,proxima_fecha:e.proxima_fecha||null,estado:e.estado||`abierto`},{data:r,error:i}=await t.from(E).insert(n).select(Ct).single();if(i)throw i;return r}async function Dt(e,n={}){let{data:r,error:i}=await t.from(E).update(n).eq(`id`,e).select(Ct).single();if(i)throw i;return r}async function Ot(e){return Dt(e,{estado:`cerrado`,requiere_seguimiento:!1})}async function kt(e){let{error:n}=await t.from(E).delete().eq(`id`,e);if(n)throw n;return!0}var D=St,At=D.getSeguimientos;D.getSeguimientosByAlumno;var jt=D.crearSeguimiento,Mt=D.actualizarSeguimiento,Nt=D.cerrarSeguimiento,Pt=D.eliminarSeguimiento,O={llamada:{label:`Llamada`,icon:`bi-telephone`},whatsapp:{label:`WhatsApp`,icon:`bi-whatsapp`},correo:{label:`Correo`,icon:`bi-envelope`},reunion:{label:`Reunión`,icon:`bi-people`},otro:{label:`Otro`,icon:`bi-chat-dots`}},Ft={contactado:{label:`Contactado`,color:`success`},buzon_no_contesto:{label:`Buzón / No contestó`,color:`secondary`},reagendar:{label:`Reagendar`,color:`warning`},sin_interes:{label:`Sin interés`,color:`dark`},resuelto:{label:`Resuelto`,color:`primary`}};function It(e){if(e instanceof Date)return new Date(e);if(typeof e==`string`){let t=e.match(/^(\d{4})-(\d{2})-(\d{2})/);if(t)return new Date(Number(t[1]),Number(t[2])-1,Number(t[3]))}return new Date(e)}function Lt(e){let t=It(e);return t.setHours(0,0,0,0),t}function Rt(e){return e?.proxima_fecha?Lt(e.proxima_fecha):null}function zt(e){return e?.estado===`abierto`}function Bt(e,t=new Date){let n=Rt(e);return n?Math.round((n-Lt(t))/864e5):null}function Vt(e=[],t=new Date){let n={vencidos:[],hoy:[],proximos:[]};for(let r of e){if(!zt(r)||!r?.requiere_seguimiento)continue;let e=Bt(r,t);e!==null&&(e<0?n.vencidos.push(r):e===0?n.hoy.push(r):n.proximos.push(r))}return n}var k={registros:[],filtroCanal:`todos`,filtroEstado:`abierto`},A=null;async function j(e){A?.abort(),A=new AbortController,e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height:300px">
  ...
  `}function Gt(){let e=[...k.registros];return k.filtroEstado!==`todos`&&(e=e.filter(e=>e.estado===k.filtroEstado)),k.filtroCanal!==`todos`&&(e=e.filter(e=>e.canal===k.filtroCanal)),e}function Kt(e){let t=A.signal;e.querySelector(`#segNuevo`)?.addEventListener(`click`,()=>qt(null,()=>j(e)),{signal:t}),e.querySelector(`#segFiltroEstado`)?.addEventListener(`change`,t=>{k.filtroEstado=t.target.value,Ht(e)},{signal:t}),e.querySelector(`#segFiltroCanal`)?.addEventListener(`change`,t=>{k.filtroCanal=t.target.value,Ht(e)},{signal:t});let r=t=>{let n=k.registros.find(e=>e.id===t);n&&qt(n,()=>j(e))};e.querySelectorAll(`.seg-agenda-item, .seg-edit`).forEach(e=>e.addEventListener(`click`,()=>r(e.dataset.id),{signal:t})),e.querySelectorAll(`.seg-cerrar`).forEach(r=>r.addEventListener(`click`,async()=>{try{await Nt(r.dataset.id),n.show(`Seguimiento cerrado`,`success`),j(e)}catch(e){n.show(`Error: ${e.message}`,`error`)}},{signal:t}))}function qt(e,t,r=null){let i=!e,a=e||{alumno_id:r?.alumnoId||null,contacto_nombre:r?.alumno||r?.contactoNombre||``,contacto_telefono:r?.whatsapp||``,contacto_email:r?.email||``,canal:`llamada`,fecha:new Date().toISOString(),resultado:`contactado`,notas:``,requiere_seguimiento:!1,proxima_accion:``,proxima_fecha:``,estado:`abierto`},o=new Date().toISOString().slice(0,10);m.open({title:i?`Registrar interacción`:`Editar seguimiento`,size:`lg`,body:`
  ...
  `,e.querySelector(`#commWaAll`)?.addEventListener(`click`,()=>{t.forEach(e=>window.open(at(e.whatsapp,ot(N.mensaje,e)),`_blank`,`noopener`))},{signal:P.signal})}async function an(e){let t=I().filter(e=>e.email),r=N.asunto.trim(),i=N.mensaje.trim();if(!r){n.show(`Falta el asunto del correo`,`error`);return}if(!i){n.show(`El mensaje está vacío`,`error`);return}let a=e.querySelector(`#commSendMail`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Enviando...`;try{let e=fn(ot(i,t[0])),a=await vt({to:t.map(e=>e.email),subject:r,html:e});n.show(`Correo enviado a ${a.enviados} de ${a.total} destinatarios`,a.fallidos?`warning`:`success`)}catch(e){n.show(`Error: ${e.message}`,`error`)}finally{a.disabled=!1,a.innerHTML=o}}async function on(e,t,r){let i=N.mensaje.trim();if(!i){n.show(`Escribí algo primero para mejorarlo`,`error`);return}let a=t.querySelector(`#commIA`),o=a?.innerHTML;a&&(a.disabled=!0,a.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Mejorando...`);try{N.mensaje=await bt(i,r),L(e,t),n.show(`Mensaje mejorado con IA`,`success`)}catch(e){n.show(`IA no disponible: ${e.message}`,`error`),a&&o&&(a.disabled=!1,a.innerHTML=o)}}function sn(e,t){m.open({title:`Ajustar tono con IA`,body:`
  ...
  </div>`}function un(e,t){let r=!t;m.open({title:r?`Nueva plantilla`:`Editar plantilla`,size:`lg`,body:`
  ...
  `}function W(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Dn(){p.register(`comunicaciones`,e=>Yt(e)),p.register(`com-seguimiento`,e=>j(e)),p.register(`com-calendario`,e=>Sn(e))}var G=(e,t)=>({id:`mock-dep-${e.toLowerCase()}`,codigo:e,nombre:t,descripcion:null,email:null,responsable_nombre:null,responsable_email:null,activo:!0,updated_at:new Date().toISOString()});G(`DIR`,`Dirección`),G(`ACM`,`Académica`),G(`ADM`,`Administración`),G(`FIN`,`Financiero`),G(`COM`,`Comunicaciones`),G(`LOG`,`Logística`),G(`TECNICO`,`Técnico`);var On=e({actualizarDepartamento:()=>Mn,enviarCorreoPrueba:()=>Nn,getDepartamentos:()=>jn}),kn=`departamentos`,An=`id, codigo, nombre, descripcion, email, responsable_nombre, responsable_email, activo, updated_at`;async function jn(){let{data:e,error:n}=await t.from(kn).select(An).order(`codigo`,{ascending:!0});if(n)throw n;return e||[]}async function Mn(e,n={}){let r={};n.nombre!==void 0&&(r.nombre=n.nombre),n.email!==void 0&&(r.email=n.email||null),n.responsable_nombre!==void 0&&(r.responsable_nombre=n.responsable_nombre||null),n.responsable_email!==void 0&&(r.responsable_email=n.responsable_email||null),n.activo!==void 0&&(r.activo=n.activo),r.updated_at=new Date().toISOString();let{data:i,error:a}=await t.from(kn).update(r).eq(`id`,e).select(An).single();if(a)throw a;return i}async function Nn(e,n=``){let{data:r,error:i}=await t.functions.invoke(`send-email`,{body:{to:e,subject:`Correo de prueba — Departamento ${n}`.trim(),html:`<div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;font-size:15px;color:#1f2937">
        <p>Este es un <strong>correo de prueba</strong> del SOI (El Sistema Punta Cana).</p>
        <p>Si lo recibís, la casilla del departamento <strong>${Pn(n)}</strong> está configurada correctamente
  ...
  `}function Un(e,t){let n=K.signal;e.querySelectorAll(`.dep-save`).forEach(r=>r.addEventListener(`click`,()=>Wn(e,t,r),{signal:n})),e.querySelectorAll(`.dep-test`).forEach(t=>t.addEventListener(`click`,()=>Gn(e,t),{signal:n}))}async function Wn(e,t,r){let i=r.closest(`.dep-card`),a=i.querySelector(`.dep-nombre`).value.trim(),o=i.querySelector(`.dep-email`).value.trim(),s=i.querySelector(`.dep-resp-nombre`).value.trim(),c=i.querySelector(`.dep-resp-email`).value.trim(),l=i.querySelector(`.dep-activo`).checked;if(!a){n.show(`El nombre es obligatorio`,`error`);return}if(o&&!zn.test(o)){n.show(`El correo institucional no es válido`,`error`);return}if(c&&!zn.test(c)){n.show(`El correo del responsable no es válido`,`error`);return}let u=r.innerHTML;r.disabled=!0,r.innerHTML=`<span class="spinner-border spinner-border-sm"></span>`;try{let i=await Ln(r.dataset.id,{nombre:a,email:o,activo:l,responsable_nombre:s,responsable_email:c}),u=t.findIndex(e=>e.id===i.id);u>=0&&(t[u]=i),n.show(`${i.codigo} actualizado`,`success`),Vn(e,t)}catch(e){n.show(`Error: ${e.message}`,`error`),r.disabled=!1,r.innerHTML=u}}async function Gn(e,t){let r=t.closest(`.dep-card`).querySelector(`.dep-email`).value.trim();if(!r||!zn.test(r)){n.show(`Cargá un correo válido antes de probar`,`error`);return}let i=t.innerHTML;t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm"></span>`;try{await Rn(r,t.dataset.codigo),n.show(`Correo de prueba enviado a ${r}`,`success`)}catch(e){n.show(`No se pudo enviar: ${e.message}`,`error`)}finally{t.disabled=!1,t.innerHTML=i}}function q(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Kn(){p.register(`departamentos`,e=>Bn(e))}async function qn(){let{data:e,error:n}=await t.from(`campanias_periodo`).select(`*`).order(`created_at`,{ascending:!1});if(n)throw n;return e??[]}async function Jn(e){let{data:n,error:r}=await t.from(`campanias_periodo`).insert(e).select().single();if(r)throw r;return n}async function Yn(e,n){let{data:r,error:i}=await t.from(`campanias_periodo`).update({...n,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(i)throw i;return r}async function Xn(e){return Yn(e,{activo:!1})}async function Zn(e){let{data:n,error:r}=await t.rpc(`fn_preview_campania`,{p_id:e});if(r)throw r;return n}async function Qn(e){let{data:n,error:r}=await t.rpc(`fn_activar_campania`,{p_id:e});if(r)throw r;return n}async function $n(e,n=null){let{data:r,error:i}=await t.rpc(`fn_encolar_campania`,{p_campania_id:e,p_limite:n});if(i)throw i;return r}var J={campanias:[],seleccionada:null,preview:null,cargando:!1},er={inscripcion:`Inscripción`,reinscripcion:`Reinscripción`};async function tr(e){await Y(e)}async function Y(e){try{nr(e),J.campanias=await qn(),X(e)}catch(t){rr(e,t.message)}}function nr(e){e.innerHTML=`
  ...
  `;let n=e.querySelector(`#luteria-list`);async function r(){n.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height:200px">
      ...
      </div>`}}return e.querySelector(`#btn-refresh-luteria`)?.addEventListener(`click`,r,{signal:t.signal}),await r(),{teardown(){t.abort()}}}function yr(){p.register(`luteria-diagnosticos`,e=>vr(e))}var br=[Dn,Kn,r,l,fe,u,re,ue,s,f,ae,pe,ie,ee,a,de,le,oe,d,c,ne,se,cr,mr,yr];export{et as n,br as t};