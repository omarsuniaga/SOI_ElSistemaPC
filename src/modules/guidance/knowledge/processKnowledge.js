...
export const PROCESS_RULES = [
  ...
  },
  {
    ...
    action: 'Si cuenta con justificación de la ausencia, regístrela en el campo de observaciones.',
    priority: 'medium',
    views: ['asistencia'],
    roles: ['maestro', 'maestra_suplente'],
  },
  ...
  // ── Preinscriptions Process ─────────────────────────────────────
  {
    ...
    message: 'Hay nuevas preinscripciones pendientes de validación.',
    action: 'Revise los documentos y valide cada preinscripción antes de asignar grupo.',
    priority: 'critical',
  ...
  // ── Planning Process ────────────────────────────────────────────
  {
    ...
    message: 'Tiene planificaciones en estado borrador que necesitan aprobación.',
    action: 'Envíelas al coordinador para que las revise y apruebe.',
    priority: 'high',
    views: ['planificacion'],
    roles: ['maestro', 'maestra_suplente'],
  },
  ...
  // ── Student Records Process ─────────────────────────────────────
  {
    ...
    action: 'Actualice los datos faltantes: contacto, dirección o información médica.',
    priority: 'medium',
    views: ['estudiantes'],
    roles: ['maestro', 'coordinador'],
  },
  ...
  // ── Evaluations Process ─────────────────────────────────────────
  {
    ...
    message: 'Tiene evaluaciones próximas programadas.',
    action: 'Prepare los materiales y comunique a los alumnos la fecha y contenido.',
    priority: 'medium',
    views: ['evaluaciones'],
    roles: ['maestro', 'maestra_suplente'],
  },
  ...
  },
  {
    ...
    action: 'Actualice la vista o contacte al administrador para sincronizar datos.',
    priority: 'low',
    views: ['metricas'],
    roles: ['maestro', 'coordinador', 'admin'],
  },
