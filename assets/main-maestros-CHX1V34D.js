...
import{$ as e,C as t,G as n,J as r,K as i,Q as a,S as o,X as s,Y as c,Z as l,et as u,i as d,k as f,l as p,nt as m,o as h,q as g,s as _,tt as v,v as y,w as b,y as x}from"./clasesApi-Bv8DEfIA.js";import{i as S}from"./supabase-BryBf0UA.js";import{a as C,i as w,n as T,o as E,r as D,t as O}from"./maestroAuth-BZ2ChDTg.js";import{n as k,o as A,s as j}from"./CHANGELOG-CNg1HUtO.js";import"./vendor-qhSM09z_.js";import{t as M}from"./idb-mVrqaBz4.js";import{a as N,n as ee,r as te,t as P}from"./offlineQueue-RKO6FQOA.js";import{a as ne,c as re,d as ie,f as ae,i as oe,l as se,n as ce,o as le,p as ue,r as de,t as fe,u as pe}from"./pushService-BhOUdsE9.js";import{r as me,t as he}from"./permisoService-3I2LDTJa.js";import{t as F}from"./AppToast-BfOaB9z8.js";import{n as ge,t as _e}from"./ausenciaModal-Bt-iUVgF.js";import{a as ve,c as ye,i as I,l as be,n as xe,o as Se,r as Ce,s as we,t as Te}from"./portalUtils-d8JQ9zxl.js";import{a as Ee,c as De,i as Oe,l as ke,n as Ae,o as je,s as Me,t as Ne}from"./groqService-BOqADv92.js";import{t as L}from"./preload-helper-TKOBYGYD.js";import{t as R}from"./academicService-DjQqxtAp.js";import{t as Pe}from"./AppModal-BRx623gX.js";import{n as Fe}from"./planificacionAdapter-D9sq6LTl.js";import{r as Ie,s as Le}from"./alumnosApi-CG7n3qUK.js";import{n as Re,r as ze,t as Be}from"./reportService-BpyVAolk.js";import{n as Ve,r as He,t as Ue}from"./planningService-s-tkfwT4.js";var We=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ge(e=``){let t=String(e).toLowerCase();return We.some(e=>t.includes(e.toLowerCase()))}var Ke=console.error;console.error=function(...e){e.length>0&&!Ge(e[0])&&Ke.apply(console,e)};var qe=console.warn;console.warn=function(...e){e.length>0&&!Ge(e[0])&&qe.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ge(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ge(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Je=window.fetch;window.fetch=async function(...e){try{return await Je.apply(window,e)}catch(e){if(!Ge(e.message))throw e;return null}};var Ye=!1;function Xe(e={}){let{enabled:t=!1,consent:n=!1}=e;Ye=t&&n,console.log(`[Analytics] Initialized, enabled:`,Ye)}var Ze={windowMs:6e4,max:100};function Qe(e={}){Ze={...Ze,...e},console.log(`[RateLimit] Initialized: ${Ze.max} requests per ${Ze.windowMs}ms`)}var $e=null,et=new Set;function tt(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function nt(e={}){$e=tt(e.length||32),et.clear(),et.add($e),console.log(`[CSRF] Initialized`)}var rt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function it(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function at(e={}){let{debug:t=!1,onReport:n=null}=e;if(!it()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ot(t,n),st(t,n),ct(t,n),lt(t,n),ut(t,n)}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];rt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function st(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];rt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function ct(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);rt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function lt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];rt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function ut(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];rt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var z={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},dt=null,ft=!1;function pt(){z.listeners.forEach(e=>e({...z}))}var mt={subscribe(e){return z.listeners.push(e),()=>{z.listeners=z.listeners.filter(t=>t!==e)}},async init(){ft=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),z.maestro=w(),console.log(`[usePortalAuth.init] Maestro local:`,z.maestro?`found`:`not found`),z.loading=!0,pt(),typeof process<`u`&&{}.VITEST)return z.loading=!1,pt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),z.maestro;if(!dt){let{data:{subscription:e}}=S.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),ft&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),z.maestro=null,pt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=w();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await D();e&&(z.maestro=e,pt())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});dt=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([D(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===O||t?.__pendingApproval?(z.maestro=null,z.pendingApproval=!0):(z.maestro=t,z.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),z.maestro=null,z.pendingApproval=!1}return z.loading=!1,pt(),console.log(`[usePortalAuth.init] Completado`),z.maestro}finally{ft=!1}},setMaestro(e){z.maestro=e,z.loading=!1,pt()},async logout(){await E(),z.maestro=null,pt()},getMaestro:()=>z.maestro,isAuthenticated:()=>!!z.maestro,isLoading:()=>z.loading,isPendingApproval:()=>z.pendingApproval},ht=mt.logout,gt=`calendario`;function _t(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):gt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:gt},``,`#/${gt}`),h(gt);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var vt=null;function yt(e,t){vt=e}function bt(e){vt&&vt(e)}var xt=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function St(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function Ct(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function wt(e){let{claseId:t,fecha:n,isValid:r}=Ct(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}le(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),Mt(e.notification);let t=e.notification;t?.data?.deep_link?wt(t.data.deep_link):t?.data?.deep_link_url&&wt(t.data.deep_link_url),B.some(t=>t.id===e.notification.id)||(B.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),zt())}});var Tt=new i(`maestro-notifications`),Et=30*1e3,Dt=60*1e3,Ot=120*1e3,kt=new Map;function At(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Dt)}`}function jt(){let e=Date.now();for(let[t,n]of kt.entries())e>n&&kt.delete(t)}function Mt(e){let t=At(e),n=Date.now()+Ot;kt.set(t,n)}function Nt(){return jt(),kt.size}function Pt(e){return`notif_cache_${e}`}function Ft(e){try{let t=B.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Pt(e),JSON.stringify(t))}catch{}}function It(e){try{let t=localStorage.getItem(Pt(e));return t?JSON.parse(t):[]}catch{return[]}}var B=[],Lt=[];function Rt(e){return Lt.push(e),e(B),()=>{Lt=Lt.filter(t=>t!==e)}}function zt(){Lt.forEach(e=>e([...B]))}async function Bt(){let e=w();if(!e)return[];B.length===0&&(B=It(e.id),B.length>0&&zt());try{let{data:t,error:n}=await S.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),B;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=B.filter(e=>String(e.id).startsWith(`local_`));return B=[...r,...i],await Vt(e.id),Ft(e.id),zt(),B}catch(e){return console.error(`[NotifService]`,e),B}}async function Vt(t){try{let n=new Date,i=St(n),a=n.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[o,c]=await Promise.all([s(),e(t,i,i)]),l=o.map(e=>e.id),u=Object.fromEntries(o.map(e=>[e.id,e])),d=(await r(l)).filter(e=>e.dia?.toLowerCase()===a);c.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let f=new Set(c.filter(e=>e.borrador===!1||e.estado===`registrada`||e.estado===`cerrada`).map(e=>e.clase_id));B=B.filter(e=>String(e.id).startsWith(`local_`)?!f.has(e.clase_id):!0);let p=new Date;for(let e of d){if(!e.hora_fin||f.has(e.clase_id))continue;let[t,n]=e.hora_fin.split(`:`),r=new Date;r.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(p-r)/6e4;if(a<30)continue;let o=u[e.clase_id],s=`${e.clase_id}_${i}`;if(B.some(e=>e.referencia_id===s&&e.tipo===`sesion_sin_registrar`))continue;let c=e.hora_fin?e.hora_fin.slice(0,5):``,l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=l&&c?` (${l}–${c})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;B.unshift({id:`local_`+s,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${d} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:i})}for(let e of d){if(!e.hora_inicio)continue;let[t,n]=e.hora_inicio.split(`:`),r=new Date;r.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(r-p)/6e4;if(a<0||a>15)continue;let o=u[e.clase_id],s=`prox_${e.clase_id}_${i}`;if(B.some(e=>e.referencia_id===s))continue;let c=e.hora_inicio?e.hora_inicio.slice(0,5):``,l=Math.round(a);B.unshift({id:`local_`+s,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${c?` a las ${c}`:``} empieza en ${l} ${l===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:i})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Ht(e){let t=w(),n=B.find(t=>t.id===e);if(n&&(n.estado=`leida`),zt(),t&&Ft(t.id),!String(e).startsWith(`local_`))try{await S.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Ut(e){let t=w();if(B=B.filter(t=>t.id!==e),zt(),t&&Ft(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await S.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Wt(){let e=w();if(B.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),zt(),e&&Ft(e.id),e)try{await S.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Gt(){return B.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Kt=null;function qt(){let e=w();e&&(Kt||(Kt=S.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};B.some(e=>e.id===n.id)||(B.unshift(n),Ft(e.id),zt(),Jt(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=B.findIndex(e=>e.id===t.new.id);n!==-1&&(B[n]={...B[n],...t.new},Ft(e.id),zt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),Kt=null,$t())}),Tt.registerChannel(Kt)))}function Jt(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Yt(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),Zt(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Yt(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Xt=!1;function Zt(){if(Xt)return;Xt=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var Qt=null;function $t(){Qt===null&&(Qt=setInterval(()=>{document.visibilityState!==`hidden`&&Bt()},Et),Tt.registerInterval(Qt))}function en(){Qt!==null&&(clearInterval(Qt),Qt=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Bt(),$t()):en()});function tn(){let e=St();B=B.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}tn(),document.visibilityState!==`hidden`&&$t(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var nn=null,rn=null;function an(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var on={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(nn=document.createElement(`div`),nn.innerHTML=`
    ...
    `,document.body.appendChild(nn),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Wt()}),rn=Rt(e=>{this.renderList(e)}),Bt())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=Nt();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tienes notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=ln(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=un(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${cn(e.tipo)}">
            <i class="bi ${sn(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${an(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>Ht(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),on.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>Ht(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Ht(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await Ut(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Bt()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=ge(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Bt()},close(){this._trap&&=(this._trap.dispose(),null),rn&&typeof rn==`function`&&(rn(),rn=null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function sn(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function cn(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function ln(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function un(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,`0`)}-${String(i.getDate()).padStart(2,`0`)}`,o=t.fecha||a;switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${o}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}var V=null,dn=null;function fn(e,t=`polite`){V||(V=document.createElement(`div`),V.setAttribute(`aria-live`,t),V.setAttribute(`aria-atomic`,`true`),V.classList.add(`pm-visually-hidden`),document.body.appendChild(V)),t===`assertive`?(V.setAttribute(`role`,`alert`),V.setAttribute(`aria-live`,`assertive`)):(V.removeAttribute(`role`),V.setAttribute(`aria-live`,`polite`)),clearTimeout(dn),dn=setTimeout(()=>{V.textContent=``,requestAnimationFrame(()=>{V.textContent=e})},50)}function pn(e,t){if(!e||!e.id)return;mn(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function mn(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function hn(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>mn(e))}async function gn(e,t=null){try{let n=``;t&&t.sesiones&&t.sesiones.length>0&&(n=`
...
`);let r=await Ae([{role:`user`,content:`
...
Sé directo, pedagógico y actionable. Responde SOLO JSON válido.`}]);try{return Ee(r)}catch(e){return console.error(`[ClaseAnalysis] Parse error:`,e,`| raw:`,r),null}}catch(e){return console.error(`[ClaseAnalysis] Error:`,e),null}}async function _n(e,t,n=4){try{let r=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:i}=await S.from(`sesiones_clase`).select(`id, fecha, contenido, asistencia`).eq(`clase_id`,e).gte(`fecha`,r).lte(`fecha`,t).order(`fecha`,{ascending:!1});if(!i||i.length===0)return{sesiones:[],tracking:[]};let{data:a}=await S.from(`observaciones_alumnos`).select(`id, alumno_id, contenido, created_at`).eq(`clase_id`,e).gte(`created_at`,r+`T00:00:00`),o={};a&&a.forEach(e=>{o[e.alumno_id]||(o[e.alumno_id]=[]),o[e.alumno_id].push(e.contenido)});let{data:s}=await S.from(`alumnos`).select(`id, nombre_completo`),c=Object.fromEntries((s||[]).map(e=>[e.id,e.nombre_completo]));return{sesiones:i.map(e=>{let t=Array.isArray(e.asistencia)?e.asistencia:[],n=t.filter(e=>e.estado===`P`).map(e=>e.alumno_id||e),r=t.filter(e=>e.estado===`A`).map(e=>e.alumno_id||e);return{fecha:e.fecha,contenido:e.contenido||`(sin descripción)`,totalPresentes:n.length,totalAusentes:r.length,asistentes:n.map(e=>c[e]||`Desconocido`),ausentes:r.map(e=>c[e]||`Desconocido`),detalleAlumnos:t.map(e=>({alumnoId:e.alumno_id||e,alumnoNombre:c[e.alumno_id||e]||`Desconocido`,estado:e.estado,tieneObs:o[e.alumno_id||e]?.length>0,obsPreview:o[e.alumno_id||e]?.[0]||null}))}}),alumnoMap:c,obsPorAlumno:o}}catch(e){return console.error(`[ContentTracking] Error:`,e),{sesiones:[],tracking:[],alumnoMap:{},obsPorAlumno:{}}}}async function vn(e,t,n=4){try{console.log(`[getClaseDataForAnalysis] Iniciando con claseId:`,e,`fecha:`,t,`semanas:`,n);let{data:r,error:i}=await S.from(`clases`).select(`id, nombre, instrumento`).eq(`id`,e).maybeSingle();if(console.log(`[getClaseDataForAnalysis] Clase:`,r,`Error:`,i),!r)return console.warn(`[getClaseDataForAnalysis] No se encontró clase con id:`,e),null;let{data:a}=await S.from(`inscripciones`).select(`alumno_id`).eq(`clase_id`,e),o=a?.length||0,s=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:c}=await S.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(1),l=c?.[0],u=Array.isArray(l?.asistencia)?l.asistencia.filter(e=>e.estado===`P`).length:0,d=o-u,{data:f}=await S.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(10),p=(f||[]).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}).length,m=(f||[]).length-p,h=f&&f.length>0?Math.round(p/f.length*100):0,g=new Date(new Date(t).getTime()-672*60*60*1e3).toISOString().split(`T`)[0],{data:_}=await S.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,e).gte(`fecha`,g),v={};_&&_.forEach(e=>{v[e.alumno_id]||(v[e.alumno_id]={total:0,presentes:0}),v[e.alumno_id].total++,e.estado===`P`&&v[e.alumno_id].presentes++});let y=Object.values(v).filter(e=>e.total>=3&&e.presentes/e.total<.7).length;return{id:e,nombre:r.nombre,instrumento:r.instrumento||`Sin especificar`,cumplimiento:h,totalAlumnos:o,alumnosPresentes:u,alumnosAusentes:d,registrosCompletos:p,registrosPendientes:m,alumnosEnRiesgo:y,alumnosEnRiesgoDetalle:y>0?`${y} alumno(s) con <70% asistencia`:null}}catch(e){return console.error(`[ClaseDataForAnalysis] Error:`,e),null}}async function yn(e,t=new Date().toISOString().split(`T`)[0],n=4){let r=document.createElement(`div`);r.className=`clase-analysis-backdrop`,r.innerHTML=`
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),F.show(`Auto-navegación cancelada`,`info`)})}async function zn(t,{onClaseClick:n}={}){t.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=w();if(!i){t.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let o=new Date,l=o.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),u=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,`0`)}-${String(o.getDate()).padStart(2,`0`)}`;try{let d=await g(i.id,u);if(d&&d.length>0){t.innerHTML=Bn(d,l,o),Hn(t,u,i.id);return}let f=await s();if(!f||f.length===0){t.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let p=f.map(e=>e.id),m=Object.fromEntries(f.map(e=>[e.id,e])),h=(await r(p)).filter(e=>e.dia?.toLowerCase()===l).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){t.innerHTML=`
    ...
    `,t.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,n=e.dataset.fecha;try{await R.createSnapshotFromPlan(t,n,i.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${n}`)})}),t.querySelectorAll(`.pm-clase-card`).forEach(e=>{let t=e.querySelector(`.pm-analisis-btn`);t?t.addEventListener(`click`,e=>{e.stopPropagation(),e.preventDefault();let n=t.dataset.claseId;console.log(`[HoyView] Abriendo análisis para clase:`,n),yn(n,u)}):console.warn(`[HoyView] No se encontró botón de análisis en card`),e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let t=e.dataset.claseId;try{await R.createSnapshotFromPlan(t,u,i.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),n?.(t)})});let ee=A||j;ee&&(requestAnimationFrame(()=>{t.querySelector(`[data-clase-id="${ee}"]`)?.scrollIntoView({behavior:`smooth`,block:`center`})}),A&&setTimeout(()=>{Rn(A,u,n)},800))}catch(e){t.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${I(e.message)}</p>`}}function Bn(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=Vn(e.motivo);return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${Ce(t)} ${ve(n)}</h2>
  ...
  `}function Vn(e){return{suplencia:`pm-eme-motivo-suplencia`,eventual:`pm-eme-motivo-eventual`,reforzamiento:`pm-eme-motivo-reforzamiento`,otro:`pm-eme-motivo-otro`}[e]||`pm-eme-motivo-otro`}function Hn(e,t,n){e.querySelectorAll(`.pm-emergente-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`pm-card-loading`)||(e.classList.add(`pm-card-loading`),window.router&&window.router.navigate(`clase-emergente?fecha=${t}`),e.classList.remove(`pm-card-loading`))})})}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);if(e.id=`pm-hoy-pendientes-styles`,!document.getElementById(`pm-badge-warning-style`)){let e=document.createElement(`style`);e.id=`pm-badge-warning-style`,e.textContent=`
        .pm-badge-warning {
          background: rgba(245,158,11,0.15);
          color: #d97706;
  ...
  `,document.head.appendChild(e)}var Un=null,Wn=null;function Gn(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;Un=o,Wn=a,Pe.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{rr(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function ar(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,dr=class{constructor(e,t=lr){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(sr)||(this._autoTimer=setTimeout(()=>this.start(),cr))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(sr,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=ur,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),this._tooltip=n}_bindEvents(){if(!this._tooltip||!this._overlay){console.warn(`[AsistenciaTour] DOM no inyectado correctamente, saltando event binding`);return}this._tooltip.querySelector(`#pm-tour-next`).addEventListener(`click`,()=>this._nextStep()),this._tooltip.querySelector(`#pm-tour-skip`).addEventListener(`click`,()=>this._close()),this._onKeydown=e=>{e.key===`Escape`&&this._close()},document.addEventListener(`keydown`,this._onKeydown),this._onResize=()=>{this._overlay?.style.display!==`none`&&this._showStep(this._step)},window.addEventListener(`resize`,this._onResize,{passive:!0})}_showStep(e){let t=this._steps[e],n=this._container.querySelector(t.target);if(!n){this._nextStep();return}n.scrollIntoView({behavior:`smooth`,block:`center`}),setTimeout(()=>this._positionOnElement(n,t,e),400)}_positionOnElement(e,t,n){if(!this._spotlight||!this._tooltip){console.warn(`[AsistenciaTour] Tour no montado correctamente, abortando posicionamiento`);return}let r=e.getBoundingClientRect();this._spotlight.style.width=`${r.width+20}px`,this._spotlight.style.height=`${r.height+20}px`,this._spotlight.style.top=`${r.top-10}px`,this._spotlight.style.left=`${r.left-10}px`;let i=r.bottom+16;i+200>window.innerHeight&&(i=r.top-200-16);let a=Math.max(16,Math.min(window.innerWidth-280-16,r.left));this._tooltip.style.top=`${i}px`,this._tooltip.style.left=`${a}px`,this._tooltip.querySelector(`#pm-tour-title`).innerHTML=`<span>${t.title}</span>`,this._tooltip.querySelector(`#pm-tour-body`).textContent=t.body,this._tooltip.querySelector(`#pm-tour-progress`).textContent=`${n+1} / ${this._steps.length}`,this._tooltip.querySelector(`#pm-tour-next`).textContent=n===this._steps.length-1?`Finalizar ✓`:`Siguiente →`}_nextStep(){this._step++,this._step<this._steps.length?this._showStep(this._step):this._close()}_close(){this._overlay&&(localStorage.setItem(sr,`true`),this._onKeydown&&document.removeEventListener(`keydown`,this._onKeydown),this._onResize&&window.removeEventListener(`resize`,this._onResize),this._tooltip&&(this._tooltip.style.display=`none`),this._spotlight&&(this._spotlight.style.display=`none`),this._overlay.style.opacity=`0`,setTimeout(()=>{this._overlay&&(this._overlay.style.display=`none`)},300))}},U={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g,estados:/!(LOGRADO|EN_PROGRESO|INICIADO)\b/gi},fr={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`,estados:{LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}};function pr(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#([{$>])/)[0].trim()),n.push(e)}return n}function mr(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function hr(e){return{alumnos:pr(e,U.alumnos),contenido:pr(e,U.contenido),sugerencias:pr(e,U.sugerencias),tareas:pr(e,U.tareas),medidas:pr(e,U.medidas),calificacion:mr(e),objetivos:pr(e,U.objetivos),niveles:pr(e,U.niveles),nodos:pr(e,U.nodos),capas:pr(e,U.capas),estados:pr(e,U.estados).map(e=>e.toUpperCase())}}function gr(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],estados:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=hr(i))}),{...hr(e),por_capas:n}}function _r(e){if(!e)return``;let t=vr(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(U.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${fr.capas}22; color:${fr.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${fr.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${fr.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(U.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(U.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(U.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(U.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(U.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(U.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function vr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function yr(e){return!e||typeof e!=`string`||!e.trim()||/[#[({$>]/.test(e)?`dsl`:`natural`}function br(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=gr(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function xr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Sr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Cr(e,t,n,r,i=null){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let a=n;if(i&&i.length>0){let e=new Set(i.map(e=>e.id)),t=n.length;a=n.filter(t=>e.has(t.alumno_id)),a.length<t&&console.warn(`[evaluationService] saveEvaluaciones: filtrados ${t-a.length} evaluaciones de alumnos ausentes`)}let o=a.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea}));try{let{data:e,error:t}=await S.from(`indicator_attempts`).upsert(o,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});if(t)throw t;return{data:e,error:null}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[evaluationService] Offline, encolando saveEvaluaciones...`);for(let e of o)await P({tabla:`indicator_attempts`,operacion:`upsert`,payload:e});return{data:null,error:null,_offline:!0}}return{data:null,error:e}}}async function wr(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await S.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await S.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Sr(a??[],l),indicators:n,totalAlumnos:l}}async function Tr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=yr(e);try{let t=e;i===`natural`&&(t=await Me(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=xr(br(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,textoMejorado:Er(e,a,n),error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],textoMejorado:``,error:e.message||`Error desconocido`}}}function Er(e,t,n){let r=new Map(n.map(e=>[e.id,e.nombre_completo])),i=[];e?.trim()&&(i.push(`Texto original: "${e.trim()}"`),i.push(``)),i.push(`Evaluaciones:`);for(let e of t){let t=r.get(e.alumno_id)||`Alumno`,n=e.nota!==null&&e.nota!==void 0?`${e.nota}/5`:`—`,a=e.observacion?.trim()?e.observacion:`—`,o=e.tarea?.trim()?` | Tarea: ${e.tarea}`:``;i.push(`• ${t}: ${a} | Nota: ${n}${o}`)}return i.join(`
`)}function Dr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function W(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Or(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function kr(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function Ar(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function jr(e,t){let{data:n,error:r}=await S.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await S.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=Ar(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function Mr(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${W(Or(e.nombre_completo))}</div>
      <div>
        <div class="pm-student-panel__name">${W(e.nombre_completo)}</div>
  ...
  `}function Nr(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${W(kr(e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Nota: ${W(String(e.nota??`-`))}</span>
      ${e.observations?`<span class="pm-eval-timeline__detail">${W(e.observations)}</span>`:``}
      ${e.tarea?`<span class="pm-eval-timeline__detail"><strong>Tarea:</strong> ${W(e.tarea)}</span>`:``}
    </li>
  `).join(``)||`<p class="pm-empty-history">Sin evaluaciones previas</p>`}
    </ul>
  `}function Pr(e){return e.length?e.map((e,t)=>`
    <div class="pm-route-indicador pm-route-indicador--${W(e.semColor)}"
      ...
      <div class="pm-route-indicador__info">
        <span class="pm-route-indicador__name">${W(e.nombre)}</span>
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Fr(e){return e.length?`
      ...
      <ul class="pm-pending-tasks">
        ${e.map(e=>`
          <li class="pm-pending-tasks__item">
            <strong>${W(e.indicadorNombre)}:</strong> ${W(e.tarea)}
          </li>
        `).join(``)}
      </ul>
    </section>
  `:``}function Ir(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${Mr(e,n)}
  ...
  `}function zr({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Dr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){we()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=be(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
      <div class="pm-student-panel__modal-content">
        ...
        <p class="pm-student-panel__modal-indicator-name">${W(n.nombre)}</p>
        ...
        <div class="pm-student-panel__modal-body">
          ...
          <div class="pm-student-panel__modal-field">
            ...
            <textarea id="modal-obs" rows="4" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 12px; font-size: 0.9rem; resize: none; outline: none;" placeholder="Escribe aquí las observaciones...">${r?W(r.observations):``}</textarea>
          </div>
        </div>
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=w();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await S.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=Lr(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=ge(o,{onClose:()=>h()});try{let n=await jr(e.id,t);s=n.indicatorSummaries,o.innerHTML=Ir(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=Rr(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}var Br={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Vr={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Hr={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function Ur(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Wr(e){return(e||``).trim().toLowerCase()}function Gr(e){let t=new Map;for(let n of e){let e=Wr(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Kr(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Hr[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Hr[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=Br[e.estado]||Br.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Vr[e.estado]||``}`:`ssp-alumno-chip`}">${Ur(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Ur(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Ur(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${Ur(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Ur(i)} · ${Ur(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}async function Jr(e,t){if(!e||!t)throw Error(`classEventId and status are required`);let{data:n,error:r}=await S.from(`class_events`).update({status:t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw Error(`Error updating class event status: ${r.message}`);return n}var Yr=`soi_ruta_tema_pendiente`;function Xr(e){sessionStorage.setItem(Yr,JSON.stringify(e))}function Zr(){let e=sessionStorage.getItem(Yr);if(!e)return null;sessionStorage.removeItem(Yr);try{return JSON.parse(e)}catch{return null}}var Qr=`documentos`;async function $r(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await S.storage.from(Qr).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=S.storage.from(Qr).getPublicUrl(r);return o.publicUrl}async function ei({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await $r(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await S.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function ti(e,t){if(!e||!t)return null;let{data:n,error:r}=await S.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ni(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await S.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}function ri(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function ii(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function ai(e,t){let n=ii(e);return t.find(e=>ii(e.nombre)===n||ii(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&ii(e.nombre).includes(n)||n.length>=3&&n.includes(ii(e.nombreCorto||e.nombre.split(` `)[0])))??null}function oi(e,t){let n=[],r=[];for(let i of e){if(ii(i)===`todos`){n.push(...t);continue}let e=ai(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function si(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await S.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function ci({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=De(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await si(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=oi(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await si(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function ui({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=gr(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function di({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await S.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ii(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ii(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await S.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var fi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},pi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function mi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var hi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function gi(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=hi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function _i(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${mi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${mi(n.join(`, `))}</span>`:``}}function o(e,t){let n=fi[e.estado]??fi.EN_PROGRESO,r=e.nota?` · ${mi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${mi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=hi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${mi(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${mi(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${mi(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${mi((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${mi(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${mi(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${gi(c)}</div>`:``,d=ke(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${mi(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${mi(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,vi(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(pi.indexOf(i)+1)%pi.length;r[n].estado=pi[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function vi(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function yi(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await S.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function Oi(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        ...
        <p class="pm-asist-subtitle">
          ${i?`📍 ${I(i)} · `:``}
          ${r?`${Se(r.hora_inicio)} – ${Se(r.hora_fin)} · `:``}
          <span style="color:var(--pm-primary); font-weight:700;">${ve(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `,await Fi()}async function Ni(e,t,n,r){Pe.open({title:`Editar ${e}`,body:`
      ...
      ${(await G.getIndicatorsByObjective(e)).map(e=>`
        <div class="pm-rc-ind-card" style="position:relative;flex-direction:column;gap:0.5rem;">
          <div style="display:flex;align-items:flex-start;gap:0.6rem;width:100%;">
            ...
            <span class="ind-text" style="flex:1;">${I(e.descripcion)}</span>
  ...
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Pi(`Indicador`,e,()=>Vi(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=n=>{n.stopPropagation();let r=t.dataset.id,i=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;Ni(`Indicador`,r,i,()=>Vi(e))}}),t.querySelectorAll(`.pm-rc-calif-btn, .pm-rc-calif-clear`).forEach(t=>{t.onclick=async n=>{n.stopPropagation();let r=t.closest(`.pm-rc-calif-row`).dataset.indicatorId,i=parseInt(t.dataset.calif,10);try{await G.updateIndicatorCalificacion(r,i),Vi(e)}catch(e){console.error(`Error updating calificacion:`,e)}}})}function Hi(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}function Ui(e,t){let n=null,r=null,i=[],a=e.querySelector(`#pm-planificacion-card`),o=e.querySelector(`#pm-planificacion-dropdown`),c=e.querySelector(`#pm-planificacion-nombre`),l=e.querySelector(`#pm-plan-list-rutas`),u=e.querySelector(`#pm-plan-list-planificaciones`),d=e.querySelector(`#pm-planificacion-header`),f=e.querySelector(`#btn-copy-as-plan`);d&&d.addEventListener(`click`,()=>{let e=a.classList.toggle(`open`);o.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;l.style.display=n===`rutas`?``:`none`,u.style.display=n===`planificaciones`?``:`none`})});function p(s){n=s.id,localStorage.setItem(`pm_default_plan_${t.claseId}`,s.id),c&&(c.textContent=s.nombre||s.name||`Sin nombre`),u.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===s.id)}),h();let l=e.querySelector(`#pm-route-tree-container`),d=e.querySelector(`#pm-active-tema-badge`);n&&l&&(l.innerHTML=``,Wi(t.claseId).then(e=>{r=ji(l,{claseId:t.claseId,rutaId:n,completedTopics:e,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e),d&&(d.textContent=e.nombre,d.style.display=`inline-block`),a.classList.remove(`open`),o.style.display=`none`}}),i.push(()=>r.destroy())}))}let m=e.querySelector(`#btn-manage-planning`);m&&(m.onclick=e=>{if(e.stopPropagation(),!n){Pe.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Pe.open({title:`Gestionar Estructura: ${c.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(r&&r.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Mi(t,n)}),a&&(async()=>{try{let e=await G.getClasses(t.maestro?t.maestro.id:null),n=localStorage.getItem(`pm_default_plan_${t.claseId}`),r=(t.clase.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===n)return!0;let t=(e.nombre||``).toLowerCase();return r.some(e=>t.includes(e))});l&&(l.innerHTML=i.length?i.map(e=>`
            ...
            </div>`).join(``),u.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&p(n)})})),a.style.display=``;let o=e.find(e=>e.id===n)||i[0]||await G.resolveSmartPlan(t.clase);o&&p(o)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})(),f&&f.addEventListener(`click`,async()=>{let e=t.getDslContent();b(`create`,null,await s(),[],{clase_id:t.claseId,maestro_id:t.maestro?.id||null,maestro_nombre:t.maestro?.nombre_completo||null,contenido:e||``,fecha_inicio:t.fechaHoy},async e=>{try{await Fe({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),F.error(`Error al guardar la planificación: `+(e.message||e))}})}),t.rutaId&&(r=ji(e.querySelector(`#pm-route-tree-container`),{claseId:t.claseId,rutaId:t.rutaId,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e)}}),i.push(()=>r.destroy()));function h(){r&&=(r.destroy(),null)}function g(){h(),i.forEach(e=>{try{e()}catch{}}),i.length=0}return{destroy:g,getActiveIndicador:()=>r?.getActiveIndicador()||null,refreshTree:async()=>{r&&await r.refresh()},getActivePlanificacionId:()=>n}}async function Wi(e){try{let{data:t}=await S.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[asistencia] Error calculando progreso histórico:`,e),[]}}var q=null,Gi=[],Ki=null,J=-1,qi=!1,Ji=null,Yi=!1,Xi=0,Zi=0;function Qi(){if(!q){if(q=document.createElement(`div`),q.id=`pm-autocomplete-popup`,q.className=`pm-autocomplete-popup`,q.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
...
¿Guardar la evaluación?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:e}=await Cr(t.sesionId,i.id,o.evaluaciones,t.maestro.id,a);if(e)throw e}let s={indicador_id:i.id,evaluaciones:o.evaluaciones};await io(t.sesionId,t.maestro.id,r,s,o.dslGenerado||null,o.textoMejorado||null);let c=gr(r);if(c.estados&&c.estados.length>0){let e=t.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));ui({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,dslText:r,alumnos:e}).then(({saved:e,errors:n})=>{n.length&&console.warn(`[Progress DSL] Errores:`,n),e.length&&Ti(e,t.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await lo(t.sesionId,t.claseId,t.maestro.id,o.evaluaciones,t.claseNombre||`Clase`,a);if(l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),t.planificationCard&&await t.planificationCard.refreshTree(),t.setEditorValue(``),t.onDslContentClear&&t.onDslContentClear(),fo(o.evaluaciones.length,i.nombre),t.activeClassEventId){try{await Jr(t.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(t.activeLevel)try{let{academicService:e}=await L(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3]));for(let n of a){let r=await e.checkLevelCompletion(n.id,t.activeLevel);if(r&&r.status===`approved`){let{createLevelCompletionModal:e}=await L(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-DYZBjtVP.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([4,3,5])),r=e({studentId:n.id,levelId:t.activeLevel});t.onAppendModal?.(r.el||r)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&t.claseId&&i?.nombre){let{error:e}=await ci({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,contenido:i.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(t.sesionId){let{academicService:n}=await L(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),r=await n.processSessionClosure(t.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:t}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CMQ6SInk.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5]));await t(e,r)}}n.textContent=`¡Guardado!`,setTimeout(()=>{n.textContent=`Guardar observación`,n.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),F.error(`Error al guardar: `+(e.message||e)),n.disabled=!1,n.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function fo(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function po(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await G.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function mo(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||F!==void 0&&F&&F.error(`Error inesperado: `+(e.message||e)),null}}async function ho(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await S.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let s=new Date,c=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,`0`)}-${String(s.getDate()).padStart(2,`0`)}`,l=n||a.fecha||c,u={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let d=Array.isArray(a.asistencia)?a.asistencia:[],f=d.map(e=>e.alumno_id).filter(Boolean),p=[];if(f.length>0){let{data:e}=await S.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,f);p=e||[]}let m={};p.forEach(e=>{m[e.id]=null}),d.forEach(e=>{e.estado&&p.some(t=>t.id===e.alumno_id)&&(m[e.alumno_id]=e.estado)}),_o(e,{clase:u,horario:null,alumnos:p,estado:m,justificaciones:{},maestro:r,fechaHoy:l,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i})}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(t.message)}</p>`}}async function go(e,{claseId:t,fecha:n,sesionId:i,router:o}={}){let l=typeof e==`string`?document.getElementById(e):e;if(!l){console.error(`[asistenciaView] Container not found:`,e);return}l.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let u=w();if(!u){l.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(i)return ho(l,{sesionId:i,fecha:n,maestro:u,containerOrId:e,router:o});l.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let d=new Date,f=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,`0`)}-${String(d.getDate()).padStart(2,`0`)}`,p=n||f;try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,i,d,f]=await Promise.all([s(),r([t]),c([t]),S.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,u.id).eq(`fecha`,p).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),m=n.find(e=>e.id===t);if(!m){l.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let h=i.find(t=>t.dia?.toLowerCase()===e),g=(d||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),_=f.data||[],v=_[0]||null,y=(()=>{let e=new Map;for(let t of[..._].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),b=Array.isArray(v?.asistencia)?v.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(v?.tipo===`emergente`&&b.length>0){let e=new Set(b),t=new Set(g.map(e=>e.id)),n=b.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await S.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);g=g.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}g=g.filter(t=>e.has(t.id))}let x=v?.id||null,C=v?.updated_at||null,w=v?.contenido||``,T=m.salon?[m.salon]:[],[E,D]=await Promise.all([x?S.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,x).then(e=>e.data||[]):Promise.resolve([]),T.length>0?a(T):Promise.resolve([])]),O=D.length>0?D[0].nombre:null,k=`pm_asistencia_${t||x}_${p}`,A=localStorage.getItem(`${k}_updated`),j=!1;C&&A&&new Date(C).getTime()>new Date(A).getTime()+5e3&&(j=!0);let M=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await S.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();M=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let N={},ee={};g.forEach(e=>{N[e.id]=null});let te=y,P={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(te.length===0)try{let e=null,n=_.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:t}=await S.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);e=t}if((!e||e.length===0)&&t&&p){let{data:n}=await S.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,p);e=n}e?.length>0&&(te=e.map(e=>({alumno_id:e.alumno_id,estado:P[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let ne={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};te.forEach(e=>{if(Object.prototype.hasOwnProperty.call(N,e.alumno_id)){let t=ne[e.estado]??e.estado;N[e.alumno_id]=t}});let re=[];if(x)try{re=await S.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,x).then(e=>e.data||[]),re.forEach(e=>{Object.prototype.hasOwnProperty.call(N,e.alumno_id)&&(N[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}_o(l,{clase:m,horario:h,alumnos:g,estado:N,justificaciones:ee,maestro:u,fechaHoy:p,claseId:t,sesionId:x,hasConflict:j,serverDSL:w,snapshots:E,salonNombre:O,rutaId:M,sesionExistenteData:v,router:o})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),l.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function _o(e,t){let{clase:r,horario:i,alumnos:a,estado:o,justificaciones:s,maestro:c,fechaHoy:l,claseId:d,snapshots:p,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v,router:y}=t,b=t.sesionId,x=e=>{if(y?.navigate){y.navigate(e);return}window.location.hash=`#/${e}`},C=[],w=`pm_asistencia_${d}_${l}`,T=m,E=null,D=ri(),O=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let k=Oi(e.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:g,fechaHoy:l,totalAlumnos:a.length,hasConflict:h,onBack:()=>{he.destroy();try{se.close()}catch{}C.forEach(e=>{try{e()}catch{}}),x(`hoy`)}});C.push(()=>k.destroy());let A=e.querySelector(`#pm-sync-badge-container`);if(A){let e=nr();A.appendChild(e.el)}let j=Qa(e,{initialContent:m,claseId:d,onEditorChange:e=>{T=e}}),M=j.getEditor(),N=e.querySelector(`#pm-dsl-editor-container`),ee=ar(e,{onAceptar:e=>{M.setValue(e)}}),te=or(e,{onAccept:e=>{M.setValue(e)}}),ne=_i(N.parentNode,{onConfirm:async t=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await li({sesionId:b,claseId:d,maestroId:c.id,fechaHoy:l,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),re=Ci(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await f({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await di({claseId:d,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;F.success(s)}catch(e){F.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}});j.initToolbar({onImproveClick:async t=>{let n=e.querySelector(`#btn-generar-informe`);n&&(n.disabled=!0);try{let e=await Oe(t);ee.open({original:t,improved:e})}catch(e){F.error(`Error al generar informe: `+e.message)}finally{n&&(n.disabled=!1)}},onStructureClick:async t=>{let n=e.querySelector(`#btn-ia-magic`);n&&(n.disabled=!0);try{let e=O?.getActiveIndicador(),n=await Me(t,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});te.open({original:t,dsl:n})}catch(e){F.error(`Error al estructurar con IA: `+e.message)}finally{n&&(n.disabled=!1)}},onAnalyzeClick:async t=>{await mo(async()=>{let n=a.filter(e=>o[e.id]&&o[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),tipoClase:wi(r),instrumento:r.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:O?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Ne(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.warning(`La IA no detectó registros de progreso en este texto.`);return}ne.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.error(`Error al analizar con IA: `+t.message)}})}}),O=Ui(e,{claseId:d,clase:r,maestro:c,fechaHoy:l,rutaId:_,editor:M,toolbar,onIndicadorSelect:t=>{M.insertText(`[${t.nombre}] `),toolbar.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getDslContent:()=>M.getValue()}),C.push(()=>O.destroy());let ie=e.querySelector(`#btn-proponer-curriculo`);ie&&(ie.onclick=async()=>{ie.disabled=!0,ie.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await yi(d,12);if(e.registros.length===0){F.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await je(e,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});re.open({pilares:t.pilares,resumen:t.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(e){F.error(`Error al generar propuesta: `+e.message)}finally{ie.disabled=!1,ie.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let ae=ki(e,{editor:M,toolbar}),oe=Zr();ae.inject(oe,d),C.push(()=>ae.destroy());let se=so(e,{sesionId:b,claseId:d,fechaHoy:l,maestroId:c.id,supabase:S,guardarJustificacion:ei,eliminarJustificacion:ni,onJustifDeleted:e=>{o[e]=null,delete s[e]},onJustifSaved:(e,t)=>{s[e]=t},onJustifCancelled:(e,t)=>{o[e]=t},onRenderLista:e=>le.render(e),onUpdateProgress:()=>de(),onAutoSave:e=>fe(e),onAnnounce:e=>fn(e)});C.push(()=>{try{se.close()}catch{}});let ce=ao(e,{sesionId:b,maestroId:c.id,editor:M,sesionExistenteData:v,onDraftRecovered:e=>{T=e,M.setValue(e)}});C.push(()=>ce.destroy()),e.querySelector(`#pm-academic-tools`),uo(e,{rutaId:_,sesionId:b,claseId:d,maestro:c,fechaHoy:l,alumnos:a,estado:o,planificationCard:O,editorContainer:N,getEditorValue:()=>M.getValue(),setEditorValue:e=>M.setValue(e),onDslContentClear:()=>{T=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:t=>{let n=e.querySelector(`.pm-asist-root`);n&&n.appendChild(t)}});let le=co(e,{alumnos:a,estado:o,rutaId:_,sesionId:b,fechaHoy:l,snapshots:p,justificaciones:s,obtenerJustificacion:ti,onEstadoChange:(e,t)=>{o[e]=t},onOpenProgressPanel:e=>{ue&&ue.destroy(),ue=zr({alumno:e,rutaId:_,sessionId:b,claseId:d,fecha:l,horaInicio:i?.hora_inicio||null}),ue.open(),C.push(()=>{ue&&ue.destroy()})},onOpenEvaluationDrawer:(t,n)=>{ir(e,{student:t,sessionId:b,teacherId:c.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{se.open(e,t,n)},onAutoSave:e=>fe(e),onAnnounce:e=>fn(e),onUpdateSnapshots:e=>{p.push(...e)}});C.push(()=>le.destroy());let ue=null;function de(){let t=a.length,n=Object.values(o).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function fe(e=!1,t=!1){E&&clearTimeout(E);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...b?{}:{clase_id:d},maestro_id:c.id,fecha:l,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:T||``};if(navigator.onLine)try{if(b){let{error:e}=await S.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,b);if(!e){localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await S.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){b=e.id,console.log(`[asistencia] Nueva sesión creada:`,b),localStorage.setItem(`${w}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await P({tabla:`sesiones_clase`,operacion:b?`update`:`insert`,payload:{...b?{id:b}:{},...t}}),localStorage.setItem(`${w}_updated`,new Date().toISOString())};e?t?await n():await D.run(n):E=setTimeout(()=>{D.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let pe=e.querySelector(`.pm-asist-actions-fixed`);if(pe){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),b&&(e.disabled=!0,e.innerHTML=`⏳...`,await Be(b),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=pe.querySelector(`#btn-guardar`);pe.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),d&&(n.disabled=!0,n.innerHTML=`⏳...`,await Re(d,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),pe.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),i=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await D.run(async()=>{try{let i=a.filter(e=>o[e.id]).map(e=>({...d?{clase_id:d}:{},alumno_id:e.id,fecha:l,estado:o[e.id],registrado_por:c.id})),s=i.length>0,f=T&&T.trim().length>0;if(!s&&!f)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await fe(!0,!0),!b){let{data:e}=await S.from(`sesiones_clase`).select(`id`).eq(`clase_id`,d).eq(`maestro_id`,c.id).eq(`fecha`,l).maybeSingle();e&&(b=e.id)}if(s&&d)try{let e=i.map(e=>({...e,...b&&{sesion_clase_id:b}}));await n(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!b){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await P({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:d,alumno_id:e.alumno_id,fecha:l,estado:e.estado,registrado_por:c.id,...b?{sesion_clase_id:b}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(b&&(s||f)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:t}=await S.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await S.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await S.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:T||``,updated_at:new Date().toISOString()}).eq(`id`,b))}u(),bt(`hoy`),bt(`calendario`),bt(`metricas`),Bt().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(b){let{academicService:n}=await L(async()=>{let{academicService:e}=await import(`./academicService-DjQqxtAp.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CMQ6SInk.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5])),i=await n.processSessionClosure(b);i&&i.length>0?(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let p=pe?.querySelector(`#btn-reporte-dia`);p&&(p.style.display=``);let m=pe?.querySelector(`#btn-resumen-mes`);m&&(m.style.display=``);let h=Object.values(o).filter(e=>e===`P`).length,g=Object.values(o).filter(e=>e===`A`).length;fn(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
      ...
      `,document.body.appendChild(_);let v=_.querySelector(`#btn-resumen-pedagogico`),y=_.querySelector(`#btn-editar-asistencia`),C=_.querySelector(`#btn-compartir-correo`),w=_.querySelector(`#btn-compartir-whatsapp`),E=_.querySelector(`#btn-volver-hoy`),D=_.querySelector(`#btn-ir-calendario`),O=Kr();v&&(v.onclick=()=>{O.open({sesionId:b,claseNombre:r?.nombre||`Clase`,fecha:l,supabase:S})}),y&&(y.onclick=()=>{_.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),C&&(C.onclick=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${l}`),n=Ei(e,T,a,r,l);Di(`mailto:?subject=${t}&body=`,n,1800)}),w&&(w.onclick=async()=>{Di(`https://wa.me/?text=`,Ei(a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),T,a,r,l),1600)}),E&&(E.onclick=()=>{_.remove(),x(`hoy`)}),D&&(D.onclick=()=>{_.remove(),x(`calendario`)});let k=_.querySelector(`#btn-reporte-dia-overlay`);k&&(k.onclick=async()=>{let e=k.innerHTML;k.disabled=!0,k.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await Be(b)}finally{k.disabled=!1,k.innerHTML=e}});let A=_.querySelector(`#btn-resumen-mes-overlay`);A&&(d?A.onclick=async()=>{let e=A.innerHTML;A.disabled=!0,A.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Re(d,e.getFullYear(),e.getMonth()+1)}finally{A.disabled=!1,A.innerHTML=e}}:(A.disabled=!0,A.title=`No disponible para actividades especiales`,A.style.opacity=`0.5`));let j=_.querySelector(`#btn-informe-ped-overlay`);j&&(d?j.onclick=async()=>{let e=j.innerHTML;j.disabled=!0,j.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await ze(d,e.getFullYear(),e.getMonth()+1)}finally{j.disabled=!1,j.innerHTML=e}}:(j.disabled=!0,j.title=`No disponible para actividades especiales`,j.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=i,t.style.background=``},3e3)}})};let me=$a(e,{onMarkAll:async e=>{a.forEach(t=>{o[t.id]=e}),le.render(),de();try{await fe(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}fn(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)}});C.push(()=>me.destroy()),le.render();let he=new dr(e);he.mount();let ge=e.querySelector(`#pm-btn-help`);return ge&&(ge.onclick=()=>he.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),he.destroy();try{se.close()}catch{}C.forEach(e=>{try{e()}catch{}})}}function vo(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await S.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=vo(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await P({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var bo={async open(){let e=await ce(),t=await oe();Pe.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Eo(n,t),Do(n,t),Lo(n,t),Oo(r),ko(r,t),Ao(r),jo(r,t),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Po(r),Fo(r),Go(t),Bo(t),Ko(),L(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-3I2LDTJa.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([9,1,10,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Io(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Eo(e,t){let n=ye(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ko(e,t){let n=ne(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
        ...
        <div class="card-body py-2 px-3">
          <div class="d-flex justify-content-between align-items-start gap-2">
            <div class="flex-grow-1 overflow-hidden">
              <div class="fw-semibold small text-truncate">${I(e.titulo)}</div>
              <div class="text-muted" style="font-size:0.72rem;">
                ${I(e.tipo_necesidad)} · ${I(e.fecha_solicitud||`—`)} ·
                <span class="${a[e.prioridad]||`text-secondary`}">${I(e.prioridad)}</span>
              </div>
            </div>
            <span class="badge flex-shrink-0 ${i[e.estado]||`bg-secondary-subtle text-secondary-emphasis`}">${I((e.estado||``).replace(`_`,` `))}</span>
          </div>
          ${e.respuesta_admin?`
            <div class="border-start border-2 border-primary ps-2 mt-2">
              ...
              <div class="small">${I(e.respuesta_admin)}</div>
            </div>`:``}
        </div>
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=qo,document.head.appendChild(e)}async function Jo(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i,onSave:a}){let o=new Set,s=document.createElement(`div`);s.style.cssText=`
  ...
  `,a.appendChild(o),e.appendChild(a);try{let e=await Ve(t.node_id,i,r,n),a=`
...
`).trim():``}var ds={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function fs(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await S.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await S.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=ds[n.estado_cualitativo]??ds.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let re=is(r.tlf_alumno||r.representante_tlf);if(re){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
      ...
      `,e.appendChild(o);let s=o.querySelector(`#pm-wa-view-send`),c=o.querySelector(`#pm-wa-view-mgr`),l=o.querySelector(`#pm-wa-tpl-list`),u=o.querySelector(`#pm-wa-tpl-mgr-list`),d=o.querySelector(`#pm-wa-text`),f=o.querySelector(`#pm-wa-send`);function p(){return ss(n.id)}function m(e){cs(n.id,e)}function h(){let e=d.value.trim();f.href=e?`https://wa.me/${re}?text=${encodeURIComponent(e)}`:`https://wa.me/${re}`}function g(e){l.querySelectorAll(`.pm-wa-tpl`).forEach(e=>e.classList.remove(`active`)),l.querySelector(`[data-id="${e.id}"]`)?.classList.add(`active`),d.value=ls(e.text,a),h()}function _(){let e=p();l.innerHTML=e.length?e.map(e=>`<button class="pm-wa-tpl" data-id="${e.id}">${I(e.label)}</button>`).join(``):`<span style="font-size:0.78rem;color:var(--pm-text-muted);">Sin plantillas — creá una en Gestionar.</span>`,l.querySelectorAll(`.pm-wa-tpl`).forEach(e=>{e.addEventListener(`click`,()=>{let t=p().find(t=>t.id===e.dataset.id);t&&g(t)})});let t=p()[0];t&&g(t)}function v(){let e=p();u.innerHTML=e.length===0?`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin plantillas todavía.</p>`:e.map(e=>`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,js(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Xr({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function Ps(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Fs(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await As(),js(e),Fs(e)})}function Is(e){Os||(Os=!0,Cs.on(`node-covered`,()=>{As().then(()=>{js(e),Fs(e)})}))}var Ls=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Rs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=w();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await S.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
    ...
    `}}async function zs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await R.getStudent(t),r=await R.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
      ...
      <div class="card-apple pm-animate-slide-up" style="margin-top: 1.5rem; padding: 1.5rem;">
        <div class="mb-4">
          ...
          <select id="route-selector" class="input-apple">
            ...
            ${r.map(e=>`<option value="${e.id}">${I(e.name)} (${I(e.instrument||`General`)})</option>`).join(``)}
          </select>
        </div>
  ...
  `}function Qs(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await me(e,`clases:enroll`),F.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){F.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function $s(e){return`
    <div class="gcv-root">
