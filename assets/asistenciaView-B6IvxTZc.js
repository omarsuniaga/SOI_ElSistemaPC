const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/routeMock-DozZOAqm.js","assets/AppToast-BfaQtGFE.js","assets/academicService-gfoJzItj.js","assets/supabase-Cgh_dhNB.js","assets/LevelCompletionModal-Du_KQRU_.js","assets/portalUtils-CkF82Yyk.js","assets/AchievementsSummaryModal-CJ9jpoV7.js"])))=>i.map(i=>d[i]);
import{t as e}from"./AppToast-BfaQtGFE.js";import{a as t,i as n,n as r,r as i,s as a}from"./pwaInstaller-BEgVc-OU.js";import{a as o,i as s}from"./supabase-Cgh_dhNB.js";import{i as c}from"./maestroAuth-DOk-16l6.js";import{c as l,n as u,r as d,s as f,t as p}from"./main-maestros-BkX4faBA.js";import{t as m}from"./idb-hTByFGMt.js";import{t as h}from"./config-CNiOV0RX.js";import{T as g,i as _,l as v,n as y,o as b,r as x}from"./reportService-D6Z7PFfN.js";import{c as S,i as C,l as w,m as T,n as E,o as D,r as O,s as k,t as A,u as j}from"./weeklyPlanAdapter-Ok2y3c8i.js";import{c as M,i as ee,l as N,o as te,s as P,t as F}from"./groqService-Cu889xeB.js";import{t as I}from"./academicService-gfoJzItj.js";import{a as L,i as R,l as z,o as ne,s as re}from"./portalUtils-CkF82Yyk.js";import{t as ie}from"./a11yUtils-DRYT20ux.js";import{a as ae,i as oe,n as B,o as se,r as ce}from"./evaluationService-Dbdmgn-U.js";function le(e={}){let{showSyncButton:t=!0}=e,n=document.createElement(`div`);n.className=`pm-sync-badge`,n.style.cssText=`
    display: none;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
...
`,ve=class{constructor(e,t=ge){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(me)||(this._autoTimer=setTimeout(()=>this.start(),he))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(me,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=_e,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `}function De({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a,onProgressSaved:o}){V();let s=document.createElement(`aside`);s.className=`pm-student-panel`,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-modal`,`false`),s.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(s);let l=[],u=null;function d(){re()===`desktop`?s.classList.add(`pm-student-panel--desktop`):s.classList.remove(`pm-student-panel--desktop`)}let f=z(d);d();function m(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){v();return}if(n===`toggle-history`){let e=t.dataset.idx,n=s.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;h(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;h(e,n);return}}async function h(e,t=null){let n=l[e],r=t===null?null:n.history[t],i=r?.status??`not_started`,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
...
`),s=[];for(let e of o){let t=ae(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ge({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function qe({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await s.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:q(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=q(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await s.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Je={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Ye=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function J(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Xe={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Ze(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Xe[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Qe(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${J(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${J(n.join(`, `))}</span>`:``}}function o(e,t){let n=Je[e.estado]??Je.EN_PROGRESO,r=e.nota?` · ${J(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${J(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Xe[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
  ...
  `,document.head.appendChild(e)}async function et(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await s.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
      alumnos ( nombre_completo )
    `).eq(`clase_id`,e).eq(`evaluacion_tipo`,`observacion`).gte(`fecha_evaluacion`,r).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1});if(a)throw Error(`Error al obtener registros de progreso: `+a.message);if(!i||i.length===0)return{totalSesiones:0,fechaDesde:r,registros:[]};let o=new Set(i.map(e=>e.fecha_evaluacion)),c=new Map;for(let e of i){let t=(e.contenido_dsl||``).trim().toLowerCase();if(!t)continue;c.has(t)||c.set(t,{contenido_dsl:e.contenido_dsl.trim(),tipo:e.tipo||`otro`,estados:[],fechas:new Set,alumnos:new Set});let n=c.get(t);n.estados.push(e.estado_cualitativo||`EN_PROGRESO`),n.fechas.add(e.fecha_evaluacion);let r=e.alumnos?.nombre_completo;r&&n.alumnos.add(r)}let l=Array.from(c.values()).map(e=>({contenido_dsl:e.contenido_dsl,tipo:e.tipo,estado:e.estados[0]||`EN_PROGRESO`,frecuencia:e.fechas.size,alumnos:Array.from(e.alumnos)}));return l.sort((e,t)=>t.frecuencia-e.frecuencia),{totalSesiones:o.size,fechaDesde:r,registros:l}}var tt={tecnica:{color:`#0d6efd`,bg:`#0d6efd15`},repertorio:{color:`#198754`,bg:`#19875415`},teoria:{color:`#fd7e14`,bg:`#fd7e1415`},interpretacion:{color:`#6f42c1`,bg:`#6f42c115`},otro:{color:`#6c757d`,bg:`#6c757d15`}},nt={alta:{label:`Foco`,color:`#dc3545`},media:{label:`Secundario`,color:`#fd7e14`},consolidacion:{label:`Consolidar`,color:`#198754`}};function rt(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function it(e,{onAdopt:t,onCancel:n}){let r=[],i=``,a=null;function o(e,t,n){let r=nt[e.prioridad]??nt.media;return`
...
`;function mn(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `}return v.onclick=async e=>{let r=e.target.closest(`.pm-asist-btn`),v=e.target.closest(`.pm-asist-nombre`);if(v){let e=v.closest(`.pm-asist-item`).dataset.id,n=t.find(t=>t.id===e);if(!n)return;if(i){y&&y.destroy(),f&&f(n);return}let r=c.filter(t=>t.student_id===e);if(r.length===0)try{let{academicService:t}=await o(async()=>{let{academicService:e}=await import(`./academicService-gfoJzItj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3])),n=await t.createSnapshotForStudent(a,e,s);n&&(r=n,_&&_(n))}catch(e){console.error(`Error creando snapshot on-demand:`,e)}p&&p(n,r);return}if(!r)return;let{id:b,action:S}=r.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),S===`J`){let e=t.find(e=>e.id===b);if(!e)return;if(n[b]===`J`){let t=l[b]||null;!t&&a&&u&&(t=await u(a,b)),m&&m(e,t,null),g&&g(`Editando justificación de ${e.nombre_completo}.`)}else d&&d(b,`J`),x(b),h&&await h(!0),m&&m(e,null,null),g&&g(`Justificación marcada para ${e.nombre_completo}.`);return}if(d&&d(b,n[b]===S?null:S),x(b),g){let e=Object.values(n).filter(e=>e===`P`).length,t=Object.values(n).filter(e=>e===`A`).length,r=Object.values(n).filter(e=>e===`J`).length;g(`Asistencia actualizada. ${e} presentes, ${t} ausentes, ${r} justificados.`)}h&&await h(!0)},{render(e){x(e)},destroy(){v.onclick=null,y&&=(y.destroy(),null)}}}async function jn(e,t,n,r,i=`Clase`,a=null){if(!r||r.length===0)return{success:!0};let o=r;if(a&&a.length>0){let e=new Set(a.map(e=>e.id)),t=r.length;o=r.filter(t=>e.has(t.alumno_id)),o.length<t&&console.warn(`[Promotion] promocionarObservacionesAlumnos: filtrados ${t-o.length} evaluaciones de alumnos ausentes`)}let c=o.filter(e=>e.observacion&&e.observacion.trim().length>0);if(c.length===0)return{success:!0};let l=c.map(r=>new b({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON());try{let{data:e,error:t}=await s.from(`observaciones_alumnos`).upsert(l,{onConflict:`sesion_clase_id,alumno_id`});if(t)throw t;return{success:!0,data:e}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[Promotion] Offline, encolando promoción de observaciones...`);for(let e of l)await f({tabla:`observaciones_alumnos`,operacion:`upsert`,payload:e});return{success:!0,_offline:!0,count:l.length}}return console.error(`[Promotion] Error promoviendo observaciones:`,e),{success:!1,error:e.message}}}async function Mn(e,t){if(!e||!t)throw Error(`classEventId and status are required`);let{data:n,error:r}=await s.from(`class_events`).update({status:t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw Error(`Error updating class event status: ${r.message}`);return n}var Nn={async getClasses(e=null){let t=s.from(`plan_clases`).select(`*`).eq(`activo`,!0);e&&(t=t.eq(`maestro_id`,e));let{data:n,error:r}=await t.order(`nombre`);return r?(console.error(`Error loading classes:`,r),[]):n},async resolveSmartPlan(e,t=null){let n=await this.getClasses(t||e.maestro_id);if(!n.length)return null;let r=n.find(t=>t.clase_id===e.id);if(r)return r;let i=(e.nombre||``).toLowerCase(),a=(e.instrumento||``).toLowerCase();return r=n.find(e=>(e.nombre||``).toLowerCase()===i),r||a&&(r=n.find(e=>(e.nombre||``).toLowerCase().includes(a)),r)?r:(r=n.find(e=>{let t=(e.nombre||``).toLowerCase();return i.includes(t)||t.includes(i)}),r||n[0])},async addClass(e,t=null,n=null){let r={nombre:e};t&&(r.maestro_id=t),n&&(r.clase_id=n);let{data:i,error:a}=await s.from(`plan_clases`).insert([r]).select().single();if(a)throw a;return i},async updateClass(e,t){let{error:n}=await s.from(`plan_clases`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteClass(e){let{error:t}=await s.from(`plan_clases`).delete().eq(`id`,e);if(t)throw t},async getLevelsByClass(e){let{data:t,error:n}=await s.from(`plan_niveles`).select(`*`).eq(`clase_id`,e).order(`numero_nivel`,{ascending:!0});return n?(console.error(`Error loading levels:`,n),[]):t},async addLevel({clase_id:e,nombre:t,numero_nivel:n}){let{data:r,error:i}=await s.from(`plan_niveles`).insert([{clase_id:e,nombre:t,numero_nivel:n||1}]).select().single();if(i)throw i;return r},async updateLevel(e,t){let{error:n}=await s.from(`plan_niveles`).update(t).eq(`id`,e);if(n)throw n},async deleteLevel(e){let{error:t}=await s.from(`plan_niveles`).delete().eq(`id`,e);if(t)throw t},async getNodesByLevel(e){let{data:t,error:n}=await s.from(`plan_temas`).select(`*`).eq(`nivel_id`,e).order(`orden_index`);return n?(console.error(`Error loading topics:`,n),[]):t},async addNode({nivel_id:e,nombre:t,tipo:n}){let{data:r,error:i}=await s.from(`plan_temas`).insert([{nivel_id:e,nombre:t,tipo:n||`TECNICA`}]).select().single();if(i)throw i;return r},async updateNode(e,t){let{error:n}=await s.from(`plan_temas`).update(t).eq(`id`,e);if(n)throw n},async deleteNode(e){let{error:t}=await s.from(`plan_temas`).delete().eq(`id`,e);if(t)throw t},async getObjectivesByNode(e){let{data:t,error:n}=await s.from(`plan_objetivos`).select(`*`).eq(`tema_id`,e).order(`orden_index`);return n?(console.error(`Error loading objectives:`,n),[]):t},async addObjective({tema_id:e,nombre:t}){let{data:n,error:r}=await s.from(`plan_objetivos`).insert([{tema_id:e,nombre:t}]).select().single();if(r)throw r;return n},async updateObjective(e,t){let{error:n}=await s.from(`plan_objetivos`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteObjective(e){let{error:t}=await s.from(`plan_objetivos`).delete().eq(`id`,e);if(t)throw t},async getIndicatorsByObjective(e){let{data:t,error:n}=await s.from(`plan_indicadores`).select(`*`).eq(`objetivo_id`,e).order(`orden_index`);return n?(console.error(`Error loading indicators:`,n),[]):t},async addIndicator({objetivo_id:e,descripcion:t,es_requerido:n}){let{data:r,error:i}=await s.from(`plan_indicadores`).insert([{objetivo_id:e,descripcion:t,es_requerido:n??!0}]).select().single();if(i)throw i;return r},async updateIndicator(e,t){let{error:n}=await s.from(`plan_indicadores`).update(t).eq(`id`,e);if(n)throw n},async deleteIndicator(e){let{error:t}=await s.from(`plan_indicadores`).delete().eq(`id`,e);if(t)throw t},async updateIndicatorCalificacion(e,t){let{error:n}=await s.from(`plan_indicadores`).update({calificacion:t}).eq(`id`,e);if(n)throw n},async getRouteHierarchy(e,t=null){let n=e;if(!n){let e=await this.getClasses(t);if(e.length>0)n=e[0].id;else return null}let{data:r,error:i}=await s.from(`plan_niveles`).select(`
      ...
      `).eq(`clase_id`,n).order(`numero_nivel`);return i?(console.error(`Error loading hierarchy:`,i),null):r},async importStructure(e,t){if(!e||!t)throw Error(`Faltan datos para la importación.`);console.log(`[Adapter] Iniciando importación masiva optimizada (4 niveles) para clase: ${e}`);for(let n of t.niveles||[]){let{data:t,error:r}=await s.from(`plan_niveles`).insert([{clase_id:e,nombre:n.nombre,numero_nivel:n.numero_nivel||1,objetivo_general:n.objetivo_general}]).select().single();if(r)throw r;let i=(n.temas||[]).map(e=>({nivel_id:t.id,nombre:e.nombre,tipo:e.tipo||`TECNICA`,es_critico:e.es_critico||!1,_originalRef:e}));if(!i.length)continue;let{data:a,error:o}=await s.from(`plan_temas`).insert(i.map(({_originalRef:e,...t})=>t)).select();if(o)throw o;for(let e=0;e<a.length;e++){let t=a[e],n=i[e]._originalRef.objetivos||[];if(!n.length)continue;let r=n.map(e=>({tema_id:t.id,nombre:e.nombre||e,_originalRef:e})),{data:o,error:c}=await s.from(`plan_objetivos`).insert(r.map(({_originalRef:e,...t})=>t)).select();if(c)throw c;let l=[];if(o.forEach((e,t)=>{let n=r[t]._originalRef;n.indicadores&&n.indicadores.length>0&&n.indicadores.forEach(t=>{l.push({objetivo_id:e.id,descripcion:t.descripcion,es_requerido:t.es_requerido??!0})})}),l.length>0){let{error:e}=await s.from(`plan_indicadores`).insert(l);if(e)throw e}}}return console.log(`[Adapter] Importación masiva (4 niveles) completada con éxito.`),!0}};function Pn(t,n){let r=t.querySelector(`#btn-guardar-obs`);return r?(n.rutaId&&(r.style.display=``),r.onclick=async()=>{let i=n.getEditorValue();if(!i||!i.trim()){e.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!n.sesionId){e.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let a=null,s=await In(i,n),c=n.planificationCard?.getActiveIndicador();if(a=s||c,!a){e.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let l=t.querySelector(`#pm-active-tema-badge`);l&&a.nombre&&(l.textContent=a.nombre,l.style.display=`inline-block`),r.disabled=!0,r.textContent=`Procesando...`;try{let e=n.alumnos.filter(e=>n.estado[e.id]===`P`),s=await B(i,a.id,e,a.nombre);if(s.error)throw Error(s.error);if(s.modo===`natural`&&s.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+s.dslGenerado+`

¿Guardar la evaluación?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(s.missing.length>0&&!confirm(`Faltan ${s.missing.length} alumno(s) sin evaluar:\n${s.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(s.evaluaciones.length>0){let{error:t}=await ce(n.sesionId,a.id,s.evaluaciones,n.maestro.id,e);if(t)throw t}let c={indicador_id:a.id,evaluaciones:s.evaluaciones};await En(n.sesionId,n.maestro.id,i,c,s.dslGenerado||null,s.textoMejorado||null);let l=ae(i);if(l.estados&&l.estados.length>0){let e=n.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Ke({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,dslText:i,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&ot(e,n.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await jn(n.sesionId,n.claseId,n.maestro.id,s.evaluaciones,n.claseNombre||`Clase`,e);if(u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),n.planificationCard&&await n.planificationCard.refreshTree(),n.setEditorValue(``),n.onDslContentClear&&n.onDslContentClear(),Fn(s.evaluaciones.length,a.nombre),n.activeClassEventId){try{await Mn(n.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(n.activeLevel)try{let{academicService:t}=await o(async()=>{let{academicService:e}=await import(`./academicService-gfoJzItj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3]));for(let r of e){let e=await t.checkLevelCompletion(r.id,n.activeLevel);if(e&&e.status===`approved`){let{createLevelCompletionModal:e}=await o(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-Du_KQRU_.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([4,3,5])),t=e({studentId:r.id,levelId:n.activeLevel});n.onAppendModal?.(t.el||t)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(s.evaluaciones.length>0&&n.claseId&&a?.nombre){let{error:e}=await We({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,contenido:a.nombre,evaluaciones:s.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(n.sesionId){let{academicService:e}=await o(async()=>{let{academicService:e}=await import(`./academicService-gfoJzItj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3])),r=await e.processSessionClosure(n.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:e}=await o(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CJ9jpoV7.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5]));await e(t,r)}}r.textContent=`¡Guardado!`,setTimeout(()=>{r.textContent=`Guardar observación`,r.disabled=!1},2e3)}catch(t){console.error(`[asistencia] Error saving observation:`,t),e.error(`Error al guardar: `+(t.message||t)),r.disabled=!1,r.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function Fn(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function In(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await Nn.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function Ln(t,{onError:n,silent:r=!1}={}){try{return await t()}catch(t){return console.error(`[safeAsync]`,t),n?n(t):r||e!==void 0&&e&&e.error(`Error inesperado: `+(t.message||t)),null}}async function Rn(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await s.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let c=new Date,l=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,`0`)}-${String(c.getDate()).padStart(2,`0`)}`,u=n||a.fecha||l,d={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let f=Array.isArray(a.asistencia)?a.asistencia:[],p=f.map(e=>e.alumno_id).filter(Boolean),m=[];if(p.length>0){let{data:e}=await s.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,p);m=e||[]}let h={},g={};m.forEach(e=>{h[e.id]=null}),f.forEach(e=>{e.estado&&m.some(t=>t.id===e.alumno_id)&&(h[e.alumno_id]=e.estado)});let _=Bn(e,{clase:d,horario:null,alumnos:m,estado:h,justificaciones:g,maestro:r,fechaHoy:u,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i});return typeof _==`function`?_:void 0}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${R(t.message)}</p>`}}async function zn(e,{claseId:a,fecha:o,sesionId:l,router:u}={}){let d=typeof e==`string`?document.getElementById(e):e;if(!d){console.error(`[asistenciaView] Container not found:`,e);return}d.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let f=c();if(!f){d.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!a){if(l)return Rn(d,{sesionId:l,fecha:o,maestro:f,router:u});d.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,a);let p=new Date,m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,h=o||m;try{let e=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[o,c,l,m]=await Promise.all([n(),r([a]),i([a]),s.from(`sesiones_clase`).select(`*`).eq(`clase_id`,a).eq(`maestro_id`,f.id).eq(`fecha`,h).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),g=o.find(e=>e.id===a);if(!g){d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let _=c.find(t=>t.dia?.toLowerCase()===e),v=(l||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),y=m.data||[],b=y[0]||null,x=(()=>{let e=new Map;for(let t of[...y].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),S=Array.isArray(b?.asistencia)?b.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(b?.tipo===`emergente`&&S.length>0){let e=new Set(S),t=new Set(v.map(e=>e.id)),n=S.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await s.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);v=v.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}v=v.filter(t=>e.has(t.id))}let C=b?.id||null,w=b?.updated_at||null,T=b?.contenido||``,E=g.salon?[g.salon]:[],[D,O]=await Promise.all([C?s.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?t(E):Promise.resolve([])]),k=O.length>0?O[0].nombre:null,A=`pm_asistencia_${a||C}_${h}`,j=localStorage.getItem(`${A}_updated`),M=!1;w&&j&&new Date(w).getTime()>new Date(j).getTime()+5e3&&(M=!0);let ee=null;try{let e=o?.find(e=>e.id===a)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await s.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();ee=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let N={},te={};v.forEach(e=>{N[e.id]=null});let P=x,F={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(P.length===0)try{let e=null,t=y.map(e=>e.id).filter(Boolean);if(t.length>0){let{data:n}=await s.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,t);e=n}if((!e||e.length===0)&&a&&h){let{data:t}=await s.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,a).eq(`fecha`,h);e=t}e?.length>0&&(P=e.map(e=>({alumno_id:e.alumno_id,estado:F[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}P.forEach(e=>{if(Object.prototype.hasOwnProperty.call(N,e.alumno_id)){let t=F[e.estado]??e.estado;N[e.alumno_id]=t}});let I=[];if(C)try{I=await s.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),I.forEach(e=>{Object.prototype.hasOwnProperty.call(N,e.alumno_id)&&(N[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Bn(d,{clase:g,horario:_,alumnos:v,estado:N,justificaciones:te,maestro:f,fechaHoy:h,claseId:a,sesionId:C,hasConflict:M,serverDSL:T,snapshots:D,salonNombre:k,rutaId:ee,sesionExistenteData:b,router:u})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${R(e.message)}</p>`}}function Bn(t,n){let{clase:r,horario:i,alumnos:c,estado:l,justificaciones:p,maestro:m,fechaHoy:h,claseId:b,snapshots:S,serverDSL:C,hasConflict:w,salonNombre:T,rutaId:E,sesionExistenteData:D,router:O}=n,k=n.sesionId,A=!!n.sesionId&&(D?.borrador===!1||D?.estado===`registrada`||D?.estado===`cerrada`),j=e=>{if(O?.navigate){O.navigate(e);return}window.location.hash=`#/${e}`},M=[],N=`pm_asistencia_${b||k}_${h}`,I=C,L=null,R=Be(),z=null,ne=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let re=lt(t.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:T,fechaHoy:h,totalAlumnos:c.length,hasConflict:w,onBack:()=>{Te.destroy();try{be.close()}catch{}M.forEach(e=>{try{e()}catch{}}),j(`hoy`)}});M.push(()=>re.destroy());let ae=t.querySelector(`#pm-sync-badge-container`);if(ae){let e=le();ae.appendChild(e.el)}let oe=bn(t,{initialContent:C,claseId:b,onEditorChange:e=>{I=e}}),B=oe.getEditor(),ce=t.querySelector(`#pm-dsl-editor-container`),ue=fe(t,{onAceptar:e=>{B.setValue(e)}}),me=pe(t,{onAccept:e=>{B.setValue(e)}}),he=Qe(ce.parentNode,{onConfirm:async n=>{try{let e=c.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ge({sesionId:k,claseId:b,maestroId:m.id,fechaHoy:h,progressRecords:n,alumnos:e});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=t.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(n){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e.error(`Error al guardar progreso: `+n.message)}},onCancel:()=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ge=it(t.querySelector(`#pm-planificacion-dropdown`)||t,{onAdopt:async({instrumento:t,nivel:n,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await v({instrumento:t,nivel:n,descripcion:r,pilares:i}),{linked:s}=await qe({claseId:b,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;e.success(c)}catch(t){e.error(`Error al crear el plan: `+t.message)}},onCancel:()=>{}});oe.initToolbar({onImproveClick:async n=>{let r=t.querySelector(`#btn-generar-informe`);r&&(r.disabled=!0);try{let e=await ee(n);ue.open({original:n,improved:e})}catch(t){e.error(`Error al generar informe: `+t.message)}finally{r&&(r.disabled=!1)}},onStructureClick:async n=>{let r=t.querySelector(`#btn-ia-magic`);r&&(r.disabled=!0);try{let e=z?.getActiveIndicador(),t=await P(n,{presentes:c.filter(e=>l[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});me.open({original:n,dsl:t})}catch(t){e.error(`Error al estructurar con IA: `+t.message)}finally{r&&(r.disabled=!1)}},onAnalyzeClick:async n=>{await Ln(async()=>{let i=c.filter(e=>l[e.id]&&l[e.id]!==`A`),a=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},o=c.map(e=>e.nombre_completo||e.nombre||``),s={alumnos:c.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:a(t,o)}}),presentes:i.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:a(t,o)}}),tipoClase:at(r),instrumento:r.instrumento||``,sesionesRecientes:(S||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:z?.getActiveIndicador()?.nombre||``};t.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let u=await F(n,s);if(!u?.progreso?.length){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.warning(`La IA no detectó registros de progreso en este texto.`);return}he.open({progreso:u.progreso,resumen:u.resumen})},{onError:n=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.error(`Error al analizar con IA: `+n.message)}})}});let _e=oe.getToolbar();z=ft(t,{claseId:b,clase:r,maestro:m,fechaHoy:h,rutaId:E,editor:B,onIndicadorSelect:e=>{B.insertText(`[${e.nombre}] `),_e&&_e.setContext({indicadorActivo:e.nombre});let n=t.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getSessionState:()=>({isRegistered:A,hasContent:!!(I&&I.trim()),sessionId:k}),getDslContent:()=>B.getValue()}),M.push(()=>z.destroy());let V=t.querySelector(`#btn-proponer-curriculo`);V&&(V.onclick=async()=>{V.disabled=!0,V.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let t=await et(b,12);if(t.registros.length===0){e.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let n=await te(t,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});ge.open({pilares:n.pilares,resumen:n.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(t){e.error(`Error al generar propuesta: `+t.message)}finally{V.disabled=!1,V.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let H=ut(t,{editor:B,toolbar:_e}),ye=se();H.inject(ye,b),M.push(()=>H.destroy());let be=kn(t,{sesionId:k,claseId:b,fechaHoy:h,maestroId:m.id,supabase:s,guardarJustificacion:Le,eliminarJustificacion:ze,onJustifDeleted:e=>{l[e]=null,delete p[e]},onJustifSaved:(e,t)=>{p[e]=t},onJustifCancelled:(e,t)=>{l[e]=t},onRenderLista:e=>U.render(e),onUpdateProgress:()=>Se(),onAutoSave:e=>Ce(e),onAnnounce:e=>ie(e)});M.push(()=>{try{be.close()}catch{}});let xe=Dn(t,{sesionId:k,maestroId:m.id,editor:B,sesionExistenteData:D,onDraftRecovered:e=>{I=e,B.setValue(e)}});M.push(()=>xe.destroy()),t.querySelector(`#pm-academic-tools`),Pn(t,{rutaId:E,sesionId:k,claseId:b,maestro:m,fechaHoy:h,alumnos:c,estado:l,planificationCard:z,editorContainer:ce,getEditorValue:()=>B.getValue(),setEditorValue:e=>B.setValue(e),onDslContentClear:()=>{I=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:e=>{let n=t.querySelector(`.pm-asist-root`);n&&n.appendChild(e)}});let U=An(t,{alumnos:c,estado:l,rutaId:E,canOpenProgressPanel:!!(b||E),sesionId:k,fechaHoy:h,snapshots:S,justificaciones:p,obtenerJustificacion:Re,onEstadoChange:(e,t)=>{l[e]=t},onOpenProgressPanel:e=>{W&&W.destroy(),W=De({alumno:e,rutaId:E,sessionId:k,claseId:b,fecha:h,horaInicio:i?.hora_inicio||null,onProgressSaved:async()=>{z?.refreshTree&&await z.refreshTree()}}),W.open(),M.push(()=>{W&&W.destroy()})},onOpenEvaluationDrawer:(e,n)=>{de(t,{student:e,sessionId:k,teacherId:m.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{be.open(e,t,n)},onAutoSave:e=>Ce(e),onAnnounce:e=>ie(e),onUpdateSnapshots:e=>{S.push(...e)}});M.push(()=>U.destroy());let W=null;function Se(){let e=c.length,n=Object.values(l).filter(e=>e!==null).length,r=t.querySelector(`#pm-progress-wrap`),i=t.querySelector(`#pm-progress-fill`),a=t.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/e*100}%`,a.textContent=`${n}/${e}`}async function Ce(e=!1,t=!1){L&&clearTimeout(L);let n=async()=>{let e=c.filter(e=>l[e.id]).map(e=>({alumno_id:e.id,estado:l[e.id]})),t={...k?{}:{clase_id:b},maestro_id:m.id,fecha:h,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:I||``};if(navigator.onLine)try{if(k){let{error:e}=await s.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,k);if(!e){localStorage.setItem(`${N}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await s.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){k=e.id,console.log(`[asistencia] Nueva sesión creada:`,k),localStorage.setItem(`${N}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await f({tabla:`sesiones_clase`,operacion:k?`update`:`insert`,payload:{...k?{id:k}:{},...t}}),localStorage.setItem(`${N}_updated`,new Date().toISOString())};e?t?await n():await R.run(n):L=setTimeout(()=>{R.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let G=t.querySelector(`.pm-asist-actions-fixed`);if(G){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),k&&(e.disabled=!0,e.innerHTML=`⏳...`,await y(k),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=G.querySelector(`#btn-guardar`);G.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),b&&(n.disabled=!0,n.innerHTML=`⏳...`,await x(b,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),G.insertBefore(n,t)}t.querySelector(`#btn-guardar`).onclick=async()=>{let e=t.querySelector(`#btn-guardar`),n=e.textContent;e.textContent=`Guardando...`,e.disabled=!0,await R.run(async()=>{try{let n=c.filter(e=>l[e.id]).map(e=>({...b?{clase_id:b}:{},alumno_id:e.id,fecha:h,estado:l[e.id],registrado_por:m.id})),i=n.length>0,p=I&&I.trim().length>0;if(!i&&!p)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Ce(!0,!0),!k){let{data:e}=await s.from(`sesiones_clase`).select(`id`).eq(`clase_id`,b).eq(`maestro_id`,m.id).eq(`fecha`,h).maybeSingle();e&&(k=e.id)}if(i&&b)try{let e=n.map(e=>({...e,...k&&{sesion_clase_id:k}}));await g(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!k){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of n)await f({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:b,alumno_id:e.alumno_id,fecha:h,estado:e.estado,registrado_por:m.id,...k?{sesion_clase_id:k}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(k&&(i||p)){let e=c.filter(e=>l[e.id]).map(e=>({alumno_id:e.id,estado:l[e.id]})),{error:t}=await s.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,k).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await s.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,k).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await s.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,k))}a(),d(`hoy`),d(`calendario`),d(`metricas`),u().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e)),A=!0,z?.refreshTree&&await z.refreshTree()}if(k){let{academicService:n}=await o(async()=>{let{academicService:e}=await import(`./academicService-gfoJzItj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([2,1,3])),{createAchievementsSummaryModal:r}=await o(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CJ9jpoV7.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5])),i=await n.processSessionClosure(k);i&&i.length>0?(e.textContent=`¡Logros detectados!`,e.style.background=`var(--pm-success)`,await r(t,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);e.textContent=`✓ Guardado`,e.style.background=`var(--apple-success)`;let v=G?.querySelector(`#btn-reporte-dia`);v&&(v.style.display=``);let S=G?.querySelector(`#btn-resumen-mes`);S&&(S.style.display=``);let C=Object.values(l).filter(e=>e===`P`).length,w=Object.values(l).filter(e=>e===`A`).length;ie(`Sesión guardada exitosamente. ${C} presentes, ${w} ausentes.`);let T=document.createElement(`div`);T.className=`pm-saved-overlay`,T.innerHTML=`
