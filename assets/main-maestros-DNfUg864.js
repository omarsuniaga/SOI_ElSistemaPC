...
`);r&&(n[r]=$t(i))}),{...$t(e),por_capas:n}}function tn(e){if(!e)return``;let t=nn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(z.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Xt.capas}22; color:${Xt.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Xt.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Xt.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(z.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(z.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(z.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(z.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(z.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(z.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function nn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var rn=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function an(e){if(!e||e.length===0)return rn.slice(0,6);let t=e.toLowerCase();return rn.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function on(e){let t=rn.find(t=>t.trigger===e);return t?t.expand:null}function sn(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `}),B.innerHTML=t,B.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{Tn(parseInt(e.dataset.index,10))})})}function Tn(e){if(e>=0&&e<un.length){let t=un[e];dn&&dn(t),Sn()}}function En(e){if(!(!fn||un.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),V=Math.min(V+1,un.length-1),wn(un),Dn();break;case`ArrowUp`:e.preventDefault(),V=Math.max(V-1,0),wn(un),Dn();break;case`Enter`:e.preventDefault(),V>=0?Tn(V):un.length>0&&Tn(0);break;case`Escape`:e.preventDefault(),Sn();break;case`Tab`:un.length>0&&V===-1&&(e.preventDefault(),Tn(0));break}}function Dn(){if(!B||V<0)return;let e=B.querySelector(`.pm-ac-option[data-index="${V}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function On(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function kn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?An(t.type):`•`}function An(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function jn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Mn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Nn(){return fn}function Pn(){return V}var Fn={show:vn,hide:Sn,updateOptions:Cn,handleKeyDown:En,getCursorPosition:Mn,isOpen:Nn,getSelectedIndex:Pn},In=`portal-maestros-catalogs`,Ln=1,Rn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},zn=null;async function H(){return zn||(zn=await se(In,Ln,{upgrade(e){for(let[t,n]of Object.entries(Rn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),zn)}async function Bn(e,t){let n=await H(),r=await n.get(e,t);if(!r)return null;let i=Rn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Vn(e){let t=await(await H()).getAll(e),n=Rn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Hn(e,t,n){return(await H()).getAllFromIndex(e,t,n)}async function Un(e,t){let n=await H(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Wn(e,t){let n=(await H()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Gn(e,t){await(await H()).delete(e,t)}async function Kn(e){await(await H()).clear(e)}async function qn(e){let t=await H(),n=Rn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Jn(){let e=await H();for(let t of Object.keys(Rn))await e.clear(t)}async function Yn(e){return(await Vn(e)).length}async function Xn(e,t){let n=await H(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Zn(e){return(await H()).get(`historial`,e)}async function Qn(e,t=5){return(await(await H()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var U={get:Bn,getAll:Vn,getByIndex:Hn,set:Un,setBulk:Wn,remove:Gn,clear:Kn,cleanExpired:qn,clearAll:Jn,getStoreSize:Yn,addToHistorial:Xn,getHistorial:Zn,getTopUsed:Qn};async function $n(e){if(!e)return[];try{let{data:t,error:n}=await j.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function er(){let e=await U.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function tr(){let e=await U.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function nr(){let e=await U.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function rr(){let e=await U.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ir(){let e=await U.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await j.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await j.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await j.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await U.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function ar(e=null){let t=await U.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=j.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await U.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function or(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await $n(n.claseId));break;case`[`:r=await er();break;case`(`:r=await nr();break;case`{`:r=await rr();break;case`$`:r=await tr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ir():await ar(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=sr(r,t)),e&&e!==`#`){let t=(await U.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function sr(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=cr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function cr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function lr(e,t){await U.addToHistorial(e,t)}var ur=`
...
`;function dr(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o={};e.innerHTML=`
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{fr(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function mr(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,yr=class{constructor(e,t=_r){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){this._mounted||(this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(hr)||(this._autoTimer=setTimeout(()=>this.start(),gr)))}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(hr,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=vr,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function xr(e,t=null,r=[],i=[],a={},o){let c=e===`edit`&&!!t,l=c?t:{...a};!c&&a.contenido&&!l.notas_dsl&&(l.notas_dsl=a.contenido),!c&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let u=new h(l),d=document.getElementById(`pm-planificacion-modal`);if(d&&d.remove(),d=document.createElement(`div`),d.id=`pm-planificacion-modal`,d.className=`pm-plan-modal-overlay`,d.innerHTML=Cr(c,u,r,i),document.body.appendChild(d),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=wr(),document.head.appendChild(e)}let f=()=>{d.classList.remove(`open`),setTimeout(()=>d.remove(),200)};d.querySelector(`.pm-plan-close-x`).onclick=f,d.querySelector(`.pm-plan-cancel-btn`).onclick=f,d.querySelector(`.pm-plan-backdrop`).onclick=f;let p=e=>{e.key===`Escape`&&(f(),document.removeEventListener(`keydown`,p))};document.addEventListener(`keydown`,p);let m=d.querySelector(`#pl-plantilla`);m&&m.addEventListener(`change`,e=>{let t=br.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(d.querySelector(`#pl-objetivos`).value=t.objetivos,d.querySelector(`#pl-contenido`).value=t.contenido,d.querySelector(`#pl-recursos`).value=t.recursos,d.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Er(d))});let g=d.querySelector(`#pl-clase_id`);g&&g.addEventListener(`change`,()=>{let e=d.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Dr(r,g.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),Tr(d);let _=d.querySelector(`#dsl-editor-container`);if(_){let e=n({onSelect:async e=>{let n=(await E()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=s({initialContent:u.notas_dsl||``,onChange:(e,t)=>{let n=d.querySelector(`#dsl-summary`);n&&(n.textContent=kr(t))},onAlumnoClick:()=>e.openModal()});_.appendChild(t),d._dslEditor=t}let v=d.querySelector(`.pm-plan-save-btn`);v.onclick=async()=>{let e=d.querySelector(`#pl-tema`)?.value.trim(),t=d.querySelector(`#pl-clase_id`)?.value;if(!e){d.querySelector(`#pl-tema`).focus();return}if(!t){d.querySelector(`#pl-clase_id`).focus();return}v.disabled=!0,v.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=d.querySelector(`#pl-recursos`)?.value||``,r=d._dslEditor,i={clase_id:t,maestro_id:d.querySelector(`#pl-maestro_id`)?.value||null,instrumento:d.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:d.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:d.querySelector(`#pl-objetivos`)?.value.trim(),contenido:d.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:d.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:d.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:c&&d.querySelector(`#pl-estado`)?.value||`planificado`};o&&await o(i),f()}catch(e){console.error(`[planificacionModal] Error:`,e),v.disabled=!1,v.textContent=c?`Guardar cambios`:`Guardar`}};let y=d.querySelector(`.pm-plan-body`);if(y){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;y.firstChild;)t.appendChild(y.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),y.appendChild(e);let i=d.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=r.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&Sr(t.instrumento,t.plan_estudio,d)}),u.clase_id)){let e=r.find(e=>e.id===u.clase_id);e?.instrumento&&e?.plan_estudio&&Sr(e.instrumento,e.plan_estudio,d)}}requestAnimationFrame(()=>{d.classList.add(`open`),d.querySelector(`#pl-tema`)?.focus()})}async function Sr(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await c(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
      ...
      </div>`).join(``)}catch(e){r.innerHTML=`<p class="text-danger small">${e.message}</p>`}}}function Cr(e,t,n,r){let i=n.length?n.map(e=>`<option value="${e.id}" ${t.clase_id===e.id?`selected`:``}>${Or(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin clases disponibles</option>`,a=r.length?`<option value="">Sin asignar</option>`+r.map(e=>`<option value="${e.id}" ${t.maestro_id===e.id?`selected`:``}>${Or(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin maestros disponibles</option>`,o=Array.isArray(t.recursos)?t.recursos.join(`, `):``,s=br.map(e=>`<option value="${e.id}">${e.nombre}</option>`).join(``);return`
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-objetivos" rows="2" maxlength="1000"
              placeholder="¿Qué quieres lograr en esta clase?">${Or(t.objetivos||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-contenido" rows="3" maxlength="2000"
              placeholder="Desarrollo del tema, actividades...">${Or(t.contenido||``)}</textarea>
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-evaluacion" rows="2" maxlength="500"
              placeholder="¿Cómo evaluarás el aprendizaje?">${Or(t.evaluacion_metodo||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-observaciones" rows="2" maxlength="1000"
              placeholder="Notas adicionales...">${Or(t.observaciones||``)}</textarea>
  ...
  `,await Nr()}async function jr(e,t,n,r){Ae.open({title:`Editar ${e}`,body:`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Mr(`Clase`,null,()=>Nr()),G.activeClassId?Pr(G.activeClassId):Rr(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),jr(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Nr())},e.onclick=()=>{G.activeClassId=t,G.activeLevelId=G.activeNodeId=G.activeObjectiveId=null,Nr(),Pr(t),Rr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Rr(`#pm-rc-objs-wrapper`,`Elegí Tema`),Rr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Pr(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await W.getLevelsByClass(e);!n.some(e=>e.id===G.activeLevelId)&&n.length>0?G.activeLevelId=n[0].id:n.length===0&&(G.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Mr(`Nivel`,e,()=>Pr(e)),G.activeLevelId?Fr(G.activeLevelId):Rr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),jr(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Pr(e))},t.onclick=()=>{G.activeLevelId=n,G.activeNodeId=G.activeObjectiveId=null,Pr(e),Fr(n),Rr(`#pm-rc-objs-wrapper`,`Elegí Tema`),Rr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Fr(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await W.getNodesByLevel(e);!n.some(e=>e.id===G.activeNodeId)&&n.length>0?G.activeNodeId=n[0].id:n.length===0&&(G.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Mr(`Tema`,e,()=>Fr(e)),G.activeNodeId?Ir(G.activeNodeId):Rr(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),jr(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Fr(e))},t.onclick=()=>{G.activeNodeId=n,G.activeObjectiveId=null,Fr(e),Ir(n),Rr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ir(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await W.getObjectivesByNode(e);!n.some(e=>e.id===G.activeObjectiveId)&&n.length>0?G.activeObjectiveId=n[0].id:n.length===0&&(G.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Mr(`Objetivo`,e,()=>Ir(e)),G.activeObjectiveId?Lr(G.activeObjectiveId):Rr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),jr(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ir(e))},t.onclick=()=>{G.activeObjectiveId=n,Ir(e),Lr(n)}})}async function Lr(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
  ...
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Mr(`Indicador`,e,()=>Lr(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=()=>{let n=t.dataset.id,r=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;jr(`Indicador`,n,r,()=>Lr(e))}})}function Rr(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}var zr=null;function Br(e,t){zr=e}function Vr(e){zr&&zr(e)}function Hr(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Ur(e,{claseId:t,rutaId:n,completedTopics:r=[],onIndicadorSelect:i}){let a=[],o=!1,s=null,c=document.createElement(`div`);if(c.className=`pm-route-bar-wrapper`,e.appendChild(c),!document.getElementById(`pm-route-bar-styles`)){let e=document.createElement(`style`);e.id=`pm-route-bar-styles`,e.textContent=`
        ...
        ${(e.plan_temas||[]).map(e=>`
          <div class="pm-tree-node" data-type="node">
            <div class="pm-tree-header">
              <span class="pm-tree-title">${Hr(e.nombre)}</span>
              <span class="pm-tree-badge">${e.tipo}</span>
            </div>
          </div>
          <div class="pm-tree-children">
            ${(e.plan_objetivos||[]).map(e=>{let t=(r||[]).includes(e.nombre);return`
                <div class="pm-tree-obj" data-type="obj" data-id="${e.id}" data-nombre="${Hr(e.nombre)}">
                  <i class="bi ${t?`bi-check-circle-fill text-success`:s?.id===e.id?`bi-circle-fill text-primary`:`bi-circle`}"></i>
                  <span style="${t?`text-decoration: line-through; opacity: 0.6;`:``}">${Hr(e.nombre)}</span>
                </div>
              `}).join(``)}
          </div>
        `).join(``)}
      </div>
    `).join(``)}async function d(){if(n){o=!0,u();try{a=await W.getRouteHierarchy(n)}catch(e){console.error(`[routeTreeBar] Error:`,e)}finally{o=!1,u()}}}function f(){c.removeEventListener(`click`,l),c.remove()}function p(){return s}return d(),{refresh:d,destroy:f,getActiveIndicador:p}}function Wr(e){return!e||typeof e!=`string`||!e.trim()||/[#\[\(\{\$>]/.test(e)?`dsl`:`natural`}function Gr(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=en(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function Kr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function qr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Jr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await j.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Yr(e,t){let{data:n,error:r}=await j.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await j.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await j.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:qr(a??[],l),indicators:n,totalAlumnos:l}}async function Xr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Wr(e);try{let t=e;i===`natural`&&(t=await Ne(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=Kr(Gr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Zr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function K(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Qr(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function $r(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function ei(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function ti(e,t){let{data:n,error:r}=await j.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await j.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=ei(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function ni(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${K(Qr(e.nombre_completo))}</div>
      <div>
  ...
  `}function ri(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${K($r(e.created_at))}</span>
  ...
  `}function ii(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function ai(e){return e.length?`
  ...
  `:``}function oi(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${ni(e,n)}
  ...
  `}function li({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Zr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){Oe()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=we(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=M();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await j.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=si(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=Ie(o,{onClose:()=>h()});try{let n=await ti(e.id,t);s=n.indicatorSummaries,o.innerHTML=oi(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=ci(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}var ui={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},di=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`],fi={CONDUCTA:{label:`Conducta`,icon:`🚨`},ATENCION:{label:`Atención y concentración`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`Riesgo pedagógico`,icon:`📉`}};function pi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function mi(){let e=null,t=[],n=null;function r(e,t){let n=!!e.alerta,r=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos.join(`, `):e.scope===`grupo`||e.scope===`all`?`Todos los presentes`:`—`;if(n){let t=fi[e.alertaTipo]??{label:`Alerta`,icon:`⚠️`};return`
      ...
      <div class="ssp-card">
        ...
        <div class="ssp-contenido">${pi(e.contenido_dsl)||`—`}</div>
        ${e.observacion?`<div class="ssp-obs">${pi(e.observacion)}</div>`:``}
        ${e.tarea?`<div class="ssp-tarea">📝 ${pi(e.tarea)}</div>`:``}
      </div>
    `}function i(e,n){let r=(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})(),i=t.filter(e=>e.alerta),a=t.filter(e=>!e.alerta),o=[`📚 Resumen clase ${e} — ${r}`];if(i.length){o.push(``,`⚠️ Alertas:`);for(let e of i){let t=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos[0]:`Alumno`,n=fi[e.alertaTipo]??{label:`Alerta`},r=e.tarea?` — ${e.tarea}`:``;o.push(`• ${t}: ${n.label}${r}`)}}if(a.length){o.push(``,`✅ Logros:`);for(let e of a){let t=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos.join(`, `):`Todos`,n=ui[e.estado]?.label??e.estado;o.push(`• ${t}: ${e.contenido_dsl||`—`} — ${n}`)}}return o.push(``,`🎯 El Sistema PC`),o.join(`
`)}function a(n,a){if(!e)return;let s=t.filter(e=>e.alerta),l=t.filter(e=>!e.alerta),u=t.length>0;e.innerHTML=`
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${pi(n)} · ${pi(a)}</div>
          </div>
        </div>
    ...
    `,hi(),e.querySelectorAll(`.ssp-estado-btn`).forEach(e=>{e.onclick=()=>o(parseInt(e.dataset.idx),n,a)}),e.querySelector(`#ssp-whatsapp`).onclick=()=>{let e=i(n,a);window.open(`https://wa.me/?text=${encodeURIComponent(e)}`,`_blank`)},e.querySelector(`#ssp-close`).onclick=c,e.querySelector(`.ssp-backdrop`).onclick=c}async function o(e,r,i){let o=t[e];if(!o||!n)return;let s=di[(di.indexOf(o.estado)+1)%di.length];t[e]={...o,estado:s},a(r,i);let{error:c}=await n.from(`progresos`).update({estado:s}).eq(`id`,o.id);c&&(console.error(`[SessionSummaryPanel] Error actualizando estado:`,c),t[e]=o,a(r,i))}async function s({sesionId:r,claseNombre:i,fecha:o,supabase:s}){n=s,e||(e=document.createElement(`div`),e.className=`ssp-wrapper`,document.body.appendChild(e)),e.style.display=`flex`,e.innerHTML=`
      <div class="ssp-backdrop"></div>
      <div class="ssp-dialog">
        <div class="ssp-header">
          <span class="ssp-icon">📊</span>
          <div><strong>Resumen Pedagógico</strong><div class="ssp-subtitle">${pi(i)}</div></div>
        </div>
        <div class="ssp-loading">Cargando registros...</div>
      </div>
    `,hi(),e.querySelector(`.ssp-backdrop`).onclick=c;let{data:l,error:u}=await s.from(`progresos`).select(`id, alumno_id, contenido_dsl, estado, observacion, tarea, alerta, alertaTipo, scope, alumnos`).eq(`sesion_clase_id`,r).order(`alerta`,{ascending:!1});u?(console.error(`[SessionSummaryPanel] Error cargando progresos:`,u),t=[]):t=l||[],a(i,o)}function c(){e&&(e.style.display=`none`,e.innerHTML=``),t=[],n=null}return{open:s,close:c}}function hi(){if(document.getElementById(`ssp-styles`))return;let e=document.createElement(`style`);e.id=`ssp-styles`,e.textContent=`
    /* ── Wrapper & backdrop ────────────────────────── */
    .ssp-wrapper {
      position: fixed;
      inset: 0;
  ...
  `,document.head.appendChild(e)}function gi({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function _i(e,t,n){let{data:r,error:i}=await j.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await j.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function vi(e,t){let{data:n,error:r}=await j.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function yi(e){let{error:t}=await j.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function bi(e,t,n,r,i=null){let{error:a}=await j.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var xi=`soi_ruta_tema_pendiente`;function Si(e){sessionStorage.setItem(xi,JSON.stringify(e))}function Ci(){let e=sessionStorage.getItem(xi);if(!e)return null;sessionStorage.removeItem(xi);try{return JSON.parse(e)}catch{return null}}function wi(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `,document.body.appendChild(i),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let a=null,o=null,s=null,c=null,l=!1,u=null,d=null,f=i.querySelector(`#pm-justif-title`),p=i.querySelector(`#pm-justif-subtitle`),m=i.querySelector(`#pm-justif-btn-text`),h=i.querySelector(`#pm-justif-alumno-nombre`),g=i.querySelector(`#pm-justif-motivo`),_=i.querySelector(`#pm-justif-file`),v=i.querySelector(`.pm-justif-file-placeholder`),y=i.querySelector(`.pm-justif-file-preview`),b=i.querySelector(`#pm-justif-preview-img`),x=i.querySelector(`#pm-justif-remove-file`),S=i.querySelector(`#pm-justif-delete`);function C(e,t=null,n=null){a=e,o=t,s=null,c=null,l=!!t,u=n,l?(f.textContent=`Editar Justificación`,p.textContent=`Modifica el motivo de la inasistencia`,m.textContent=`Actualizar`,S.style.display=`flex`):(f.textContent=`Justificar Inasistencia`,p.textContent=`Registra el motivo de la ausencia`,m.textContent=`Guardar Justificación`,S.style.display=`none`),h.textContent=e.nombre_completo,g.value=t?.motivo||``;let r=t?.evidencia_url||t?.evidencia_base64;r?(c=r,b.src=r,v.style.display=`none`,y.style.display=`block`):(c=null,v.style.display=`flex`,y.style.display=`none`),_.value=``,i.classList.add(`open`),g.focus();let x=i.querySelector(`.pm-justif-modal`);x&&(d&&d.dispose(),d=Ie(x,{onClose:()=>w(!0)}))}function w(e=!1){e&&n&&a&&u!==null&&n(a.id,u),i.classList.remove(`open`),a=null,o=null,s=null,c=null,u=null,d&&=(d.dispose(),null)}i.querySelector(`#pm-justif-close`).onclick=()=>w(!0),i.querySelector(`#pm-justif-cancel`).onclick=()=>w(!0),S.onclick=()=>{a&&confirm(`¿Eliminar la justificación de ${a.nombre_completo}?`)&&(r&&r({alumnoId:a.id,justificacionId:o?.id,existingUrl:o?.evidencia_url||o?.evidencia_base64}),w(!1))},i.querySelector(`.pm-justif-backdrop`).onclick=()=>w(!0),_.onchange=e=>{let t=e.target.files[0];t&&(s=t,c=URL.createObjectURL(t),b.src=c,v.style.display=`none`,y.style.display=`block`)},x.onclick=()=>{c&&!(o?.evidencia_url||o?.evidencia_base64)&&URL.revokeObjectURL(c),s=null,c=null,_.value=``,v.style.display=`flex`,y.style.display=`none`},i.querySelector(`#pm-justif-save`).onclick=()=>{let e=g.value.trim();if(!e){g.focus(),g.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{g.style.borderColor=``},2e3);return}t&&a&&t({alumnoId:a.id,motivo:e,evidenciaFile:s,evidenciaPreview:c,justificacionId:o?.id||null,existingUrl:o?.evidencia_url||o?.evidencia_base64||null,isEdit:l})};let T=e=>{e.key===`Escape`&&(w(),document.removeEventListener(`keydown`,T))};return document.addEventListener(`keydown`,T),{open:C,close:w}}var Ti=`documentos`;async function Ei(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await j.storage.from(Ti).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=j.storage.from(Ti).getPublicUrl(r);return o.publicUrl}async function Di({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await Ei(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await j.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function Oi(e,t){if(!e||!t)return null;let{data:n,error:r}=await j.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ki(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await j.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function Ai(e,t,n,r,i=`Clase`){if(!r||r.length===0)return{success:!0};let a=r.filter(e=>e.observacion&&e.observacion.trim().length>0);if(a.length===0)return{success:!0};let s=a.map(r=>new o({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON()),{data:c,error:l}=await j.from(`observaciones_alumnos`).upsert(s,{onConflict:`sesion_clase_id,alumno_id`});return l?(console.error(`[Promotion] Error promoviendo observaciones:`,l),{success:!1,error:l.message}):{success:!0,data:c}}function ji(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function Mi(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function Ni(e,t){let n=Mi(e);return t.find(e=>Mi(e.nombre)===n||Mi(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&Mi(e.nombre).includes(n)||n.length>=3&&n.includes(Mi(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Pi(e,t){let n=[],r=[];for(let i of e){if(Mi(i)===`todos`){n.push(...t);continue}let e=Ni(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Fi(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await j.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function Ii({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Pi(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Fi(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function Li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=en(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ii({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ri({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await j.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Mi(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Mi(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await j.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var zi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Bi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Vi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Hi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Ui(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Hi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Wi(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Vi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Vi(n.join(`, `))}</span>`:``}}function o(e,t){let n=zi[e.estado]??zi.EN_PROGRESO,r=e.nota?` · ${Vi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Vi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Hi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${Vi(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${Vi(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${Vi(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${Vi((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${Vi(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${Vi(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Ui(c)}</div>`:``,d=Pe(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${Vi(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${Vi(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,Gi(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Bi.indexOf(i)+1)%Bi.length;r[n].estado=Bi[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function Gi(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function Ki(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await j.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=qi[e.tipo]??qi.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${Yi(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${Yi(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${Yi(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}function Zi(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Qi(e){let{claseId:t,fecha:n,isValid:r}=Zi(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}de(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),aa(e.notification);let t=e.notification;t?.data?.deep_link?Qi(t.data.deep_link):t?.data?.deep_link_url&&Qi(t.data.deep_link_url),q.some(t=>t.id===e.notification.id)||(q.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),fa())}});var $i=30*1e3,ea=60*1e3,ta=120*1e3,na=new Map;function ra(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/ea)}`}function ia(){let e=Date.now();for(let[t,n]of na.entries())e>n&&na.delete(t)}function aa(e){let t=ra(e),n=Date.now()+ta;na.set(t,n)}function oa(){return ia(),na.size}function sa(e){return`notif_cache_${e}`}function ca(e){try{let t=q.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(sa(e),JSON.stringify(t))}catch{}}function la(e){try{let t=localStorage.getItem(sa(e));return t?JSON.parse(t):[]}catch{return[]}}var q=[],ua=[];function da(e){return ua.push(e),e(q),()=>{ua=ua.filter(t=>t!==e)}}function fa(){ua.forEach(e=>e([...q]))}async function pa(){let e=M();if(!e)return[];q.length===0&&(q=la(e.id),q.length>0&&fa());try{let{data:t,error:n}=await j.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),q;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=q.filter(e=>String(e.id).startsWith(`local_`));return q=[...r,...i],await ma(e.id),ca(e.id),fa(),q}catch(e){return console.error(`[NotifService]`,e),q}}async function ma(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([O(),p(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await te(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(q.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let d=e.hora_fin?e.hora_fin.slice(0,5):``,f=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=f&&d?` (${f}–${d})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;q.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(q.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=Math.round(a);q.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${d} ${d===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function ha(e){let t=M(),n=q.find(t=>t.id===e);if(n&&(n.estado=`leida`),fa(),t&&ca(t.id),!String(e).startsWith(`local_`))try{await j.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function ga(e){let t=M();if(q=q.filter(t=>t.id!==e),fa(),t&&ca(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await j.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function _a(){let e=M();if(q.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),fa(),e&&ca(e.id),e)try{await j.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function va(){return q.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var ya=null;function ba(){let e=M();e&&(ya||=j.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};q.some(e=>e.id===n.id)||(q.unshift(n),ca(e.id),fa(),Sa(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=q.findIndex(e=>e.id===t.new.id);n!==-1&&(q[n]={...q[n],...t.new},ca(e.id),fa())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),e===`CHANNEL_ERROR`&&(console.warn(`[Realtime] Canal cerrado, el polling de fallback sigue activo.`),ya=null)}))}function xa(){ya&&=(j.removeChannel(ya),null)}function Sa(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Ca(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),Ta(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Ca(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var wa=!1;function Ta(){if(wa)return;wa=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `;let D=n.querySelector(`#pm-dsl-toolbar-container`),k=n.querySelector(`#pm-dsl-editor-container`),A=dr(k,{initialContent:m,onChange:e=>{S=e}});A.setContext({claseId:f});let ee=mr(n,{onAceptar:e=>{A.setValue(e)}}),te=sn(n,{onAccept:e=>{A.setValue(e)}}),ne=Wi(k.parentNode,{onConfirm:async e=>{try{let t=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ii({sesionId:y,claseId:f,maestroId:u.id,fechaHoy:d,progressRecords:e,alumnos:t});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=n.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(e){n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),re=Xi(n.querySelector(`#pm-planificacion-dropdown`)||n,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await r({instrumento:e,nivel:t,descripcion:n,pilares:i}),{linked:s}=await Ri({claseId:f,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;P.success(c)}catch(e){P.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ie=ln(D,{onInsert:(e,t,n)=>A.insertText(e,t,n),getEditorContent:()=>A.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=D.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Me(e);ee.open({original:e,improved:t})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=D.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=E?.getActiveIndicador(),n=await Ne(e,{presentes:s.filter(e=>c[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});te.open({original:e,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async e=>{await Aa(async()=>{let t=s.filter(e=>c[e.id]&&c[e.id]!==`A`),r=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},i=s.map(e=>e.nombre_completo||e.nombre||``),o={alumnos:s.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),presentes:t.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),tipoClase:ke(a),instrumento:a.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:E?.getActiveIndicador()?.nombre||``};n.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Fe(e,o);if(!l?.progreso?.length){n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.warning(`La IA no detectó registros de progreso en este texto.`);return}ne.open({progreso:l.progreso,resumen:l.resumen})},{onError:e=>{n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.error(`Error al analizar con IA: `+e.message)}})}}),ae=null,M=n.querySelector(`#pm-planificacion-card`),oe=n.querySelector(`#pm-planificacion-dropdown`),se=n.querySelector(`#pm-planificacion-nombre`);n.querySelector(`#pm-planificacion-detail`);let ce=n.querySelector(`#pm-plan-list-rutas`),le=n.querySelector(`#pm-plan-list-planificaciones`),de=n.querySelector(`#pm-planificacion-header`);de&&de.addEventListener(`click`,()=>{let e=M.classList.toggle(`open`);oe.style.display=e?`block`:`none`}),n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>{e.addEventListener(`click`,()=>{n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;ce.style.display=t===`rutas`?``:`none`,le.style.display=t===`planificaciones`?``:`none`})});function fe(e){ae=e.id,localStorage.setItem(`pm_default_plan_${f}`,e.id),se&&(se.textContent=e.nombre||e.name||`Sin nombre`),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.planId===e.id)}),E&&=(E.destroy(),null);let t=n.querySelector(`#pm-route-tree-container`),r=n.querySelector(`#pm-active-tema-badge`);ae&&t&&(t.innerHTML=``,Ve(f).then(e=>{E=Ur(t,{claseId:f,rutaId:ae,completedTopics:e,onIndicadorSelect:e=>{A.insertText(`[${e.nombre}] `),ie.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),M.classList.remove(`open`),oe.style.display=`none`}}),b.push(()=>E.destroy())}))}let pe=n.querySelector(`#btn-manage-planning`);pe&&(pe.onclick=e=>{if(e.stopPropagation(),!ae){Ae.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ae.open({title:`Gestionar Estructura: ${se.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(E&&E.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Ar(t,ae)}),M&&(async()=>{try{let e=await W.getClasses(),t=localStorage.getItem(`pm_default_plan_${f}`),n=(a.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ce&&(ce.innerHTML=r.length?r.map(e=>`
            ...
            </div>`).join(``),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&fe(n)})})),M.style.display=``;let i=e.find(e=>e.id===t)||r[0]||await W.resolveSmartPlan(a);i&&fe(i)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let me=n.querySelector(`#btn-proponer-curriculo`);me&&(me.onclick=async()=>{me.disabled=!0,me.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await Ki(f,12);if(e.registros.length===0){P.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await je(e,{instrumento:a?.instrumento||``,nivel:``,nombreClase:a?.nombre||``});re.open({pilares:t.pilares,resumen:t.resumen,instrumento:a?.instrumento||``,nivel:``})}catch(e){P.error(`Error al generar propuesta: `+e.message)}finally{me.disabled=!1,me.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let he=n.querySelector(`#btn-copy-as-plan`);he&&he.addEventListener(`click`,async()=>{let t=A.getValue();xr(`create`,null,await O(),[],{clase_id:f,maestro_id:u?.id||null,maestro_nombre:u?.nombre_completo||null,contenido:t||``,fecha_inicio:d},async t=>{try{await e({...t,estado:`planificado`});let n=document.createElement(`div`);n.className=`pm-toast-success`,n.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(n),setTimeout(()=>n.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),_&&(E=Ur(n.querySelector(`#pm-route-tree-container`),{claseId:f,rutaId:_,onIndicadorSelect:e=>{A.insertText(`[${e.nombre}] `),ie.setContext({indicadorActivo:e.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``)}}),b.push(()=>E.destroy())),console.log(`[DEBUG] Reached handoff section`);let ge=Ci();if(ge&&ge.claseId===f){let e=`[${ge.nombre}] `;A.insertText(e),ie.setContext({indicadorActivo:ge.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``);let r=n.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;P.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}n.querySelector(`#pm-asist-back`).onclick=()=>{Ue.destroy();try{_e.close()}catch{}b.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},n.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{c[e.id]=`P`}),Ce(),Te(),await De(!0),Tt(`Todos los ${s.length} alumnos marcados como presentes.`)},n.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{c[e.id]=`A`}),Ce(),Te(),await De(!0),Tt(`Todos los ${s.length} alumnos marcados como ausentes.`)},Ce();async function Ve(e){try{let{data:t}=await j.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function He(e){if(!e||!ae)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await W.getRouteHierarchy(ae),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Ue=new yr(n);Ue.mount();let We=n.querySelector(`#pm-btn-help`);return We&&(We.onclick=()=>Ue.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Ue.destroy();try{_e.close()}catch{}b.forEach(e=>{try{e()}catch{}})}}function Na(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Pa(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Fa(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await j.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Pa(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await ue({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Ia={async open(){let e=await N(),t=await ve();Ae.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Ha(n,t),Ua(n,t),Xa(n,t),Wa(r),Ga(r,t),Ka(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),qa(r),Ja(r),io(t),$a(t),ao(),xe(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Ya(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Ha(e,t){let n=Ce(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ua(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ga(e,t){let n=he(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${J.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ka(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function Ja(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ya(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await xe(async()=>{let{getPermisos:e}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));Ya(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Xa(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Ba.map(e=>Za(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function Za(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function $a(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{J.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>eo(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,no),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await be();e.success?(J.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,J.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await me(),J.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=J.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>Ia.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>za.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await pe();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>ro(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>ro(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>ro(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await xe(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-BPslrDVV.js`);return{ausenciasPanel:e}},__vite__mapDeps([10,3,11,7,5,12,1,13]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>Le.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,Qa(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),J.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),J.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function eo(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=d(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=to();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}J.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await ne(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await j.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let s={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(oe,JSON.stringify(s)),J.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{J.saving=!1,a.disabled=!1,a.innerHTML=o}}function to(){let e={};return Ba.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function no(){Ae.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await re(),window.location.reload(),!0)})}function ro(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),J.theme=e}function io(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function ao(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var oo=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=oo,document.head.appendChild(e)}async function so(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await W.getClasses(),{data:r}=await j.from(`clases`).select(`id, nombre, instrumento`).eq(`maestro_id`,t.id).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let t=await W.getRouteHierarchy(e);if(!t||t.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let n=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,r=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}var lo=`alumno_plan_entradas`;async function uo(e){let{data:t,error:n}=await j.from(lo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function fo(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await j.from(lo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function po(e){let{error:t}=await j.from(lo).delete().eq(`id`,e);if(t)throw Error(t.message)}var mo={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},ho=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],go=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await uo(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
...
`).trim():``}var wo={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function To(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await j.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await j.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=wo[n.estado_cualitativo]??wo.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          ...
          <div class="pm-prog-card__timeline">
            ${t.map(e=>{let t=wo[e.estado_cualitativo]??wo.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=l.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${k.map(e=>{let t=O.get(e.clase_id),n=Co(e.contenido_dsl);return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ie=_o(r.tlf_alumno||r.representante_tlf);if(ie){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var Do={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},Oo={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},ko={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function Ao(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(Do))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function jo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await j.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await j.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${Ao(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${I(e.name)}</span>
                          <span class="pm-node-status">${ko[n]}</span>
                        </div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${Oo[t?.status||`pending`]};"></span>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Ro=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():M(),zo=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):O(...e),Bo=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):Po(...e),Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Vo=!1;async function Ho(e,{onTopicSelected:t}={}){if(Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Ro()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(T(),Y.clases=await zo(!0),!Y.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}Y.activeClaseId=Y.clases[0].id,await Uo(),Wo(e),Jo(e),Yo(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Uo(){Y.loading=!0,Y.rutaId=await No(Y.activeClaseId),Y.rutaId?Y.blocks=await Bo(Y.rutaId,Y.activeClaseId):Y.blocks=[],Y.loading=!1}function Wo(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!Y.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(Y.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}Y.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),Lo(r,{blockId:n.id,blockName:n.nombre,isExpanded:Y.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{Y.expandedBlocks.has(t)?Y.expandedBlocks.delete(t):Y.expandedBlocks.add(t),Wo(e)}}),Y.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(Go(n,e))})}}),Ko(e)}function Go(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=Y.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${qo(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${qo(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${qo(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Y.expandedLevels.has(e.id)?Y.expandedLevels.delete(e.id):Y.expandedLevels.add(e.id),Wo(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Y.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},Wo(t)})}),n}function Ko(e){let t=e.querySelector(`#ruta-action-panel`);if(!Y.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Y.selectedIndicator=null,Wo(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Si({...Y.selectedIndicator,indicatorId:Y.selectedIndicator.id,claseId:Y.activeClaseId}),Y.onTopicSelected&&Y.onTopicSelected(Y.activeClaseId)})}function qo(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Jo(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Y.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Uo(),Wo(e),Jo(e)})}function Yo(e){Vo||(Vo=!0,Io.on(`node-covered`,()=>{Uo().then(()=>{Wo(e),Jo(e)})}))}var Xo=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Zo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await j.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${Xo.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function Qo(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await F.getStudent(t),r=await F.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await F.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},ts={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([F.getRouteDetail(t),n?F.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},X={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function ns(e){let t=M();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}X.maestro=t,X.submitting=!1;let n=await Ke(t.id);if(X.permisos=n,X.checked=!0,!n.puede_registrar_alumnos){rs(e,n,t.id);return}try{let e=await O();X.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),X.clases=[]}is(e),ss(),ls()}function rs(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
        ...
        <div id="pm-register-action-container">
          ...
          `}
            ...
            <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.3); padding: 0.85rem; border-radius: 10px; display: inline-flex; align-items: center; gap: 8px; color: #eab308; font-weight: 600; font-size: 0.85rem; animation: pm-error-fade-in 0.3s ease;">
              <i class="bi bi-clock-history"></i> Solicitud Pendiente de Aprobación
            </div>`)}catch(t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al solicitar: `+t.message,type:`danger`}})),a.disabled=!1,a.innerHTML=e}})}function is(e){e.innerHTML=`
    <div class="pm-settings pm-fade-in registro-alumno-view" role="main" aria-label="Registro de alumnos">
      <header class="pm-settings-header">
          ...
          <div class="pm-settings-form-grid" style="grid-template-columns: 1fr;">
            <div class="pm-settings-field">
              ...
              <select class="input-apple" id="reg-clase">
                ...
                ${X.clases.map(e=>`<option value="${I(e.id)}">${I(e.nombre||`Clase sin nombre`)}</option>`).join(``)}
              </select>
  ...
  `}function ys(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Ge(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
    ...
    <div class="gcv-root">
      ...
      ${e.length===0?As(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function xs(e){let t=us(e.nombre||`Clase sin nombre`),n=fs(e.horarios||[]),r=us(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function Ss(e,t){ps=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await He(e),a=i.map(e=>e.alumno).filter(Boolean);hs=new Set(i.map(e=>e.alumno_id)),n.innerHTML=Cs(r,a,ms.filter(e=>!hs.has(e.id))),Ds(e,t)}catch(e){n.innerHTML=As(`bi-exclamation-circle`,`Error al cargar alumnos`,us(e.message))}}}function Cs(e,t,n){return`
    <div class="gcv-panel-inner">
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>ws(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>Ts(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function ws(e){let t=us(e.nombre_completo||e.nombre||`Alumno`),n=us(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${ds(t)}</div>
  ...
  `}var js=null,Ms=!1,Ns={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};function Ps(e){if(!e)return``;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function Fs(e){return e===`alta`?`<i class="bi bi-exclamation-circle-fill" style="color:#ef4444"></i>`:e===`media`?`<i class="bi bi-exclamation-circle-fill" style="color:#f59e0b"></i>`:`<i class="bi bi-info-circle-fill" style="color:#22c55e"></i>`}function Is(){if(document.getElementById(`admin-ausencias-insights-styles`))return;let e=document.createElement(`style`);e.id=`admin-ausencias-insights-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Ls(e){document.querySelectorAll(`[data-route="admin-ausencias"],[data-route="admin-notificaciones"]`).forEach(t=>{let n=t.querySelector(`.aai-nav-badge`);e>0?(n||(n=document.createElement(`span`),n.className=`aai-nav-badge`,t.appendChild(n)),n.textContent=e>99?`99+`:String(e),n.style.display=`flex`):n&&(n.style.display=`none`)})}function Rs(){return js||(js=document.createElement(`div`),js.id=`admin-ausencias-insights`,js.setAttribute(`role`,`status`),js.setAttribute(`aria-live`,`polite`),document.body.appendChild(js),js)}function zs(e){let t=Rs(),n=e.length,r=e[0],i=n===1&&r?`
    <div class="aai-preview">
      <div class="aai-preview-row">
        ${Fs(r.urgencia)}
        <span>${r.maestros?.nombre_completo??`Maestro`}</span>
        <span class="aai-chip">${Ns[r.tipo_ausencia]??r.tipo_ausencia??`—`}</span>
        <span style="opacity:.7">${Ps(r.fecha_inicio)}${r.fecha_fin&&r.fecha_fin!==r.fecha_inicio?` → `+Ps(r.fecha_fin):``}</span>
      </div>
    </div>
  `:``;t.innerHTML=`
    <div class="aai-row">
  ...
  `,requestAnimationFrame(()=>{t.classList.add(`visible`)}),t.querySelector(`#aai-btn-revisar`)?.addEventListener(`click`,()=>{Bs(),window.router&&window.router.navigate(`admin-ausencias`)}),t.querySelector(`#aai-btn-dismiss`)?.addEventListener(`click`,()=>{Vs()})}function Bs(){js&&js.classList.remove(`visible`)}function Vs(){Bs();let e=Date.now()+1800*1e3;localStorage.setItem(`admin-ausencias-insights-dismiss`,String(e))}function Hs(){let e=localStorage.getItem(`admin-ausencias-insights-dismiss`);return e?Date.now()<Number(e):!1}var Us={init(){window.adminAusenciasInsights=this,Is(),Rs(),this.evaluate()},async evaluate(){if(!Ms){Ms=!0;try{if((window.router?.currentRoute?.()??``).split(`?`)[0]===`admin-ausencias`){Bs(),Ls((await D())?.length??0);return}if(Hs())return;let e=await D();if(Ls(e?.length??0),!e||e.length===0){Bs();return}zs(e)}catch(e){console.warn(`[adminAusenciasInsights] Error evaluando:`,e),Bs()}finally{Ms=!1}}}},Ws=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var Gs=null;function Ks(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var qs={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(Gs=document.createElement(`div`),Gs.innerHTML=`
    ...
    `,document.body.appendChild(Gs),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{_a()}),da(e=>{this.renderList(e)}),pa())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=oa();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tenés notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=Xs(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=Zs(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${Ys(e.tipo)}">
            <i class="bi ${Js(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${Ks(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>ha(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),qs.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>ha(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>ha(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await ga(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),pa()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=Ie(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),pa()},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function Js(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function Ys(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function Xs(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function Zs(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
    ...
    <div class="pm-main-area">
      ...
      <header class="pm-header" id="pm-header">
        <div class="pm-header-left" id="pm-header-left">
          <span class="pm-header-greeting">${Qs?`Panel Admin`:`Portal Maestros`}</span>
          <span class="pm-header-title" style="font-size:clamp(1rem,3.5vw,1.5rem);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:52vw;">
            ${Qs?t?.nombre_completo??`Administrador`:`Prof. `+(t?.nombre_completo??``)}
