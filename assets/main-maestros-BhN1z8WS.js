...
import{$ as e,A as t,D as n,G as r,H as i,J as a,K as o,O as s,W as c,Y as l,Z as u,_ as d,a as f,at as p,et as m,f as h,g,h as _,i as v,it as y,m as b,n as x,nt as S,o as C,ot as ee,q as w,r as T,rt as te,s as ne,st as E,t as re,tt as ie,y as ae}from"./adminNotificacionesView-B512DX6K.js";import{i as D}from"./supabase-C4ics26R.js";import{a as O,i as oe,n as se,r as k,t as ce}from"./maestroAuth-Cae-9DFh.js";import{t as le}from"./idb-DOPm7uLh.js";import{i as ue,n as de,t as fe}from"./offlineQueue-Cjwl3aiF.js";import{a as pe,c as me,d as he,f as ge,i as _e,l as ve,n as A,r as ye,s as be,t as xe,u as Se}from"./pushService-DQD3mJWH.js";import"./vendor-BWfrAznO.js";import{t as j}from"./AppToast-BOjiJExQ.js";import{t as M}from"./preload-helper-CsoeaaUJ.js";import{t as N}from"./academicService-DX1WEsMf.js";import{a as Ce,c as we,i as P,l as Te,n as Ee,o as De,r as Oe,s as ke,t as Ae}from"./portalUtils-CisZ9vg-.js";import{t as je}from"./AppModal-CLA9fW7x.js";import{n as Me,r as Ne}from"./groqService-CAJ0uOvc.js";import{n as Pe,t as Fe}from"./ausenciaModal-BAKZ-Gr2.js";import{a as Ie,c as Le,s as Re,u as ze}from"./clasesApi-rTtQZLyp.js";import{r as Be,t as Ve}from"./permisoService-D0NSQfHK.js";var He=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ue(e=``){let t=String(e).toLowerCase();return He.some(e=>t.includes(e.toLowerCase()))}var We=console.error;console.error=function(...e){e.length>0&&!Ue(e[0])&&We.apply(console,e)};var Ge=console.warn;console.warn=function(...e){e.length>0&&!Ue(e[0])&&Ge.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ue(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ue(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ke=window.fetch;window.fetch=async function(...e){try{return await Ke.apply(window,e)}catch(e){if(!Ue(e.message))throw e;return null}};var qe=!1;function Je(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),qe=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function Ye(e,t={}){if(!qe&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var Xe=!1;function Ze(e={}){let{enabled:t=!1,consent:n=!1}=e;Xe=t&&n,console.log(`[Analytics] Initialized, enabled:`,Xe)}var Qe={windowMs:6e4,max:100};function $e(e={}){Qe={...Qe,...e},console.log(`[RateLimit] Initialized: ${Qe.max} requests per ${Qe.windowMs}ms`)}var et=null,tt=new Set;function nt(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function rt(e={}){et=nt(e.length||32),tt.clear(),tt.add(et),console.log(`[CSRF] Initialized`)}var it={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function at(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function ot(e={}){let{debug:t=!1,onReport:n=null}=e;if(!at()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),st(t,n),ct(t,n),lt(t,n),ut(t,n),dt(t,n)}function st(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];it.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function ct(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];it.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function lt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);it.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ut(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];it.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function dt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];it.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var F={maestro:null,loading:!0,listeners:[]},ft=null;function pt(){F.listeners.forEach(e=>e({...F}))}var mt={subscribe(e){return F.listeners.push(e),()=>{F.listeners=F.listeners.filter(t=>t!==e)}},async init(){if(console.log(`[usePortalAuth.init] Iniciando...`),F.maestro=k(),console.log(`[usePortalAuth.init] Maestro local:`,F.maestro?`found`:`not found`),F.loading=!0,pt(),typeof process<`u`&&{}.VITEST)return F.loading=!1,pt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),F.maestro;if(!ft){let{data:{subscription:e}}=D.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),F.maestro=null,pt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=k();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);let e=await se();e&&(F.maestro=e,pt())}}});ft=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([se(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),F.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),F.maestro=null}return F.loading=!1,pt(),console.log(`[usePortalAuth.init] Completado`),F.maestro},setMaestro(e){F.maestro=e,F.loading=!1,pt()},async logout(){await O(),F.maestro=null,pt()},getMaestro:()=>F.maestro,isAuthenticated:()=>!!F.maestro,isLoading:()=>F.loading},ht=mt.logout,gt=`calendario`;function _t(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):gt}function s(e,t=[`login`]){r=e,i=t,a=!0}function c(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.pushState({route:e},``,t),m(e)}function l(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),m(e)}function u(t,n){e.set(t,n)}function d(e){t=e}let f=null;function p(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function m(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}let s=a||t;if(!s)return;let c=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||f){f&&=(f.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),c();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),p(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await c()});f=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{f=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>p(e))})}catch{f=null,c()}}function h(){window.addEventListener(`popstate`,e=>{e.state?.route?m(e.state.route):m(o())});let e=o();e!==gt&&history.replaceState({route:e},``,`#/${e}`),m(e)}return{currentRoute:o,setAuthGuard:s,navigate:c,replace:l,on:u,onNotFound:d,start:h,_dispatch:m}}var I=null,vt=null;function yt(e,t=`polite`){I||(I=document.createElement(`div`),I.setAttribute(`aria-live`,t),I.setAttribute(`aria-atomic`,`true`),I.classList.add(`pm-visually-hidden`),document.body.appendChild(I)),t===`assertive`?(I.setAttribute(`role`,`alert`),I.setAttribute(`aria-live`,`assertive`)):(I.removeAttribute(`role`),I.setAttribute(`aria-live`,`polite`)),clearTimeout(vt),vt=setTimeout(()=>{I.textContent=``,requestAnimationFrame(()=>{I.textContent=e})},50)}function bt(e,t){if(!e||!e.id)return;xt(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function xt(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function St(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>xt(e))}function Ct(e,{onSuccess:t}){e.innerHTML=`
    <div class="pm-login">
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function Et(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=k();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let o=await S();if(!o||o.length===0){e.innerHTML=`<p class="pm-empty">No tenés clases asignadas.</p>`;return}let s=o.map(e=>e.id),c=Object.fromEntries(o.map(e=>[e.id,e])),l=(await m(s)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!l||l.length===0){e.innerHTML=`
          ...
          ${h.map(e=>{let t=c[e.clase_id];if(!t)return``;let n=e.fecha?e.fecha.split(`-`).reverse().slice(0,2).join(`/`):`—`;return`
              <button class="pm-pendiente-item" data-clase-id="${t.id}" data-fecha="${e.fecha}">
                <div class="pm-pendiente-info">
                  <span class="pm-pendiente-nombre">${P(t.nombre)}</span>
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await N.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await N.createSnapshotFromPlan(r,a,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${P(t.message)}</p>`}}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);e.id=`pm-hoy-pendientes-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Dt=null,Ot=null;function kt(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],maestroId:i=null,onSave:a=null}=e;Dt=a,Ot=i,je.open({title:`⚡ Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
          ...
          <div class="pm-emergente-grid">
            ...
            <div class="pm-emergente-field">
              ...
              <select class="pm-emergente-select" id="modal-clase_id" required>
                ...
                ${r.map(e=>`<option value="${e.id}" ${e.id===n?`selected`:``}>${At(e.nombre)}</option>`).join(``)}
              </select>
            </div>
            <div class="pm-emergente-field">
  ...
  `,e.querySelector(`#pm-cal-prev`).addEventListener(`click`,o),e.querySelector(`#pm-cal-next`).addEventListener(`click`,s),e.querySelectorAll(`.pm-cal-day[data-fecha]`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-cal-day[data-fecha]`).forEach(e=>e.setAttribute(`aria-selected`,`false`)),t.setAttribute(`aria-selected`,`true`),a?.(t.dataset.fecha)})});let _=e.querySelector(`.pm-cal-grid`);_&&_.addEventListener(`keydown`,function(e){let t=[..._.querySelectorAll(`.pm-cal-day[data-fecha]`)];if(t.length===0)return;let n=_.querySelector(`[tabindex="0"]`),r=n?t.indexOf(n):-1,i=e=>{e<0||e>=t.length||(t.forEach(e=>e.setAttribute(`tabindex`,`-1`)),t[e].setAttribute(`tabindex`,`0`),t[e].focus())};switch(e.key){case`ArrowLeft`:e.preventDefault(),r>0&&i(r-1);break;case`ArrowRight`:e.preventDefault(),r<t.length-1&&i(r+1);break;case`ArrowUp`:e.preventDefault(),i(Math.max(0,r-7));break;case`ArrowDown`:e.preventDefault(),i(Math.min(t.length-1,r+7));break;case`Home`:e.preventDefault(),i(Math.floor(Math.max(r,0)/7)*7);break;case`End`:e.preventDefault(),i(Math.min(t.length-1,Math.floor(Math.max(r,0)/7)*7+6));break;case`PageUp`:e.preventDefault(),typeof o==`function`&&o();break;case`PageDown`:e.preventDefault(),typeof s==`function`&&s();break;case`Enter`:case` `:e.preventDefault(),n&&n.click();break}})}async function It(e){let t=k();if(!t)return;let n=new Date,r=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(n.getDate()).padStart(2,`0`)}`,i=document.getElementById(`pm-action-drawer`);i||(i=document.createElement(`div`),i.id=`pm-action-drawer`,i.className=`pm-drawer-overlay`,document.body.appendChild(i));let a=e===r,o=e<r,s=[],c=[],l=[];try{let{data:n}=await D.from(`sesiones_clase`).select(`*`).eq(`maestro_id`,t.id).eq(`fecha`,e);s=n||[];let{data:r}=await D.from(`clases`).select(`id, nombre, instrumento`).or(`maestro_principal_id.eq.${t.id},maestro_suplente_id.eq.${t.id},maestro_id.eq.${t.id}`);c=r||[];let i=c.map(e=>e.id);if(i.length>0){let{data:e}=await D.from(`clase_horarios`).select(`clase_id, hora_inicio, hora_fin, dia`).in(`clase_id`,i);l=e||[]}}catch(e){console.error(`Error fetching drawer data:`,e)}let[u,d,f]=e.split(`-`).map(Number),p=new Date(u,d-1,f),m=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),h=c.filter(e=>l.some(t=>t.clase_id===e.id&&t.dia?.toLowerCase()===m)).map(e=>{let t=l.find(t=>t.clase_id===e.id&&t.dia?.toLowerCase()===m),n=s.find(t=>t.clase_id===e.id);return{...e,hora_inicio:t?.hora_inicio,hora_fin:t?.hora_fin,sesion:n}}).sort((e,t)=>(e.hora_inicio||``).localeCompare(t.hora_inicio||``)),g=``;if(h.length>0&&(g=h.map(e=>{let t=e.sesion&&(()=>{let t=Array.isArray(e.sesion.asistencia)&&e.sesion.asistencia.length>0,n=typeof e.sesion.contenido==`string`&&e.sesion.contenido.trim().length>0;return e.sesion.estado===`registrada`||e.sesion.estado===`cerrada`||t||e.sesion.borrador===!1&&n})(),n=e.sesion&&!t&&(e.sesion.estado===`pendiente`||e.sesion.borrador===!0);return`
        <div class="pm-drawer-clase-item">
          <div class="pm-drawer-clase-info">
            ...
            <span class="pm-drawer-clase-nombre">${P(e.nombre)}</span>
            <span class="pm-drawer-clase-instrumento">${P(e.instrumento||``)}</span>
          </div>
    ...
    <div class="pm-dashboard" role="main" aria-label="Panel de métricas">
      ...
      <section class="pm-dashboard-section" aria-label="Alumnos en riesgo">
        ...
        <div class="pm-risk-list" role="list">
          ${u.slice(0,5).map(e=>`
            <div class="pm-risk-item" role="listitem" tabindex="0" data-alumno="${e.alumnoId}" aria-label="Ver perfil de ${P(e.nombre)}">
              <div class="pm-risk-avatar" aria-hidden="true">${(e.nombre||`A`)[0].toUpperCase()}</div>
              <div class="pm-risk-info">
                <span class="pm-risk-name">${P(e.nombre)}</span>
                <span class="pm-risk-class">${P(e.clase)}</span>
              </div>
      ...
      <section class="pm-dashboard-section" aria-label="Resumen por clase">
        ...
        <div class="pm-classes-list" id="pm-clases-grid">
          ${l.map(e=>{let t=e.avgAttendance,n=t<70?`danger`:t<85?`warning`:`success`,r=t<70?`linear-gradient(135deg,#ff3b30,#ff6b6b)`:t<85?`linear-gradient(135deg,#ff9500,#ffcc00)`:`linear-gradient(135deg,#30d158,#34c759)`,i=e.sessionAttendance.length>0?e.sessionAttendance.map((e,t,n)=>{let r=Math.max(8,e),i=e<70?`#ff3b30`:e<85?`#ff9500`:`#30d158`;return`<div class="pm-spark-bar ${t===n.length-1?`pm-spark-last`:``}" style="height:${r}%;background:${i};" title="${e}%"></div>`}).join(``):`<span class="pm-spark-empty">—</span>`;return`
            <div class="pm-class-card2" data-clase-id="${e.id}" role="article" aria-label="Clase ${P(e.nombre)}">
              ...
              <div class="pm-class-card2__body">
                <div class="pm-class-card2__top">
                  <div class="pm-class-card2__info">
                    <span class="pm-class-card2__name">${P(e.nombre)}</span>
                    ${e.instrumento?`<span class="pm-class-card2__inst"><i class="bi bi-music-note-beamed"></i> ${P(e.instrumento)}</span>`:``}
                  </div>
  ...
  `}function Vt(e){e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);L.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await Rt(n,L.maestroId),r=zt(t);L.clasesData=r.clasesData,L.todasSesiones=t.sesiones,L.inscripcionesPorClase=t.inscripcionesPorClase,L.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Bt(r),Vt(e),yt(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${P(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=L.clasesData.find(e=>e.id===i)?.alumnos||[],o=L.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
        ...
        <div class="pm-clase-students-list" role="list">
          ${s.map(e=>`
            <div class="pm-clase-student-row" role="listitem" tabindex="0" data-alumno="${e.id}">
              <div class="pm-student-info">
                <span class="pm-student-nombre">${P(e.nombre_completo)}</span>
          ...
          `).join(``)}
        </div>`,n.appendChild(c),c.querySelector(`.pm-clase-students-close`).addEventListener(`click`,()=>c.remove());let l=t=>{!c.contains(t.target)&&t.target!==e&&(c.remove(),document.removeEventListener(`click`,l))};setTimeout(()=>document.addEventListener(`click`,l),10),c.querySelectorAll(`.pm-clase-student-row`).forEach(e=>{let t=()=>window.location.hash=`#/alumno?id=${e.dataset.alumno}`;e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})})})}function Ht(){if(!L.clasesData.length&&!Object.keys(L.inscripcionesPorClase).length)return null;let e=new Map;for(let[t,n]of Object.entries(L.inscripcionesPorClase)){let r=L.clasesData.find(e=>e.id===t);for(let t of n)e.has(t.id)||e.set(t.id,{...t,clases:[]}),r&&e.get(t.id).clases.push(r.nombre)}return[...e.values()]}async function Ut(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=k();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}L.maestroId=t.id;try{let n=await Rt(L.periodo,t.id),r=zt(n);L.clasesData=r.clasesData,L.todasSesiones=n.sesiones,L.inscripcionesPorClase=n.inscripcionesPorClase,L.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Bt(r),Vt(e),yt(`Métricas actualizadas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`
...
`);r&&(n[r]=qt(i))}),{...qt(e),por_capas:n}}function Yt(e){if(!e)return``;let t=Xt(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(R.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Wt.capas}22; color:${Wt.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Wt.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Wt.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(R.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(R.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(R.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(R.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(R.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(R.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function Xt(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var Zt=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function Qt(e){if(!e||e.length===0)return Zt.slice(0,6);let t=e.toLowerCase();return Zt.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function $t(e){let t=Zt.find(t=>t.trigger===e);return t?t.expand:null}function en(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function tn(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{p.style.display===`block`?h():m()};let g=tn(e);return e.querySelector(`#btn-help`).onclick=()=>{g.open()},{setContext(e={}){e.presentes!==void 0&&(c.presentes=e.presentes),e.indicadorActivo!==void 0&&(c.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(c.indicadoresDisponibles=e.indicadoresDisponibles)}}}var z=null,B=[],rn=null,V=-1,an=!1,on=null,sn=!1,cn=0,ln=0;function un(){if(!z){if(z=document.createElement(`div`),z.id=`pm-autocomplete-popup`,z.className=`pm-autocomplete-popup`,z.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(z)}}function dn(e,t,n={}){if(un(),B=e||[],rn=t,on=n.trigger||null,V=-1,an=!0,_n(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),z.style.left=`${i}px`,z.style.top=`${a}px`}z.onmousedown=fn,document.addEventListener(`mousemove`,pn),document.addEventListener(`mouseup`,mn),z.style.display=`block`}function fn(e){e.target.closest(`.pm-ac-option`)||(sn=!0,cn=e.clientX-z.offsetLeft,ln=e.clientY-z.offsetTop,z.style.cursor=`grabbing`,z.style.transition=`none`)}function pn(e){if(!sn)return;let t=e.clientX-cn,n=e.clientY-ln;z.style.left=`${Math.max(0,t)}px`,z.style.top=`${Math.max(0,n)}px`}function mn(){sn&&(sn=!1,z.style.cursor=``)}function hn(){z&&(z.style.display=`none`,sn=!1,document.removeEventListener(`mousemove`,pn),document.removeEventListener(`mouseup`,mn)),B=[],rn=null,V=-1,an=!1,on=null}function gn(e){B=e||[],V=-1,_n(e)}function _n(e){if(!z)return;if(!e||e.length===0){z.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${xn(on)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===V,o=Sn(on,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${wn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${wn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),z.innerHTML=t,z.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{vn(parseInt(e.dataset.index,10))})})}function vn(e){if(e>=0&&e<B.length){let t=B[e];rn&&rn(t),hn()}}function yn(e){if(!(!an||B.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),V=Math.min(V+1,B.length-1),_n(B),bn();break;case`ArrowUp`:e.preventDefault(),V=Math.max(V-1,0),_n(B),bn();break;case`Enter`:e.preventDefault(),V>=0?vn(V):B.length>0&&vn(0);break;case`Escape`:e.preventDefault(),hn();break;case`Tab`:B.length>0&&V===-1&&(e.preventDefault(),vn(0));break}}function bn(){if(!z||V<0)return;let e=z.querySelector(`.pm-ac-option[data-index="${V}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function xn(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Sn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?Cn(t.type):`•`}function Cn(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function wn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Tn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function En(){return an}function Dn(){return V}var On={show:dn,hide:hn,updateOptions:gn,handleKeyDown:yn,getCursorPosition:Tn,isOpen:En,getSelectedIndex:Dn},kn=`portal-maestros-catalogs`,An=1,jn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Mn=null;async function H(){return Mn||(Mn=await le(kn,An,{upgrade(e){for(let[t,n]of Object.entries(jn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Mn)}async function Nn(e,t){let n=await H(),r=await n.get(e,t);if(!r)return null;let i=jn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Pn(e){let t=await(await H()).getAll(e),n=jn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Fn(e,t,n){return(await H()).getAllFromIndex(e,t,n)}async function In(e,t){let n=await H(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Ln(e,t){let n=(await H()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Rn(e,t){await(await H()).delete(e,t)}async function zn(e){await(await H()).clear(e)}async function Bn(e){let t=await H(),n=jn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Vn(){let e=await H();for(let t of Object.keys(jn))await e.clear(t)}async function Hn(e){return(await Pn(e)).length}async function Un(e,t){let n=await H(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Wn(e){return(await H()).get(`historial`,e)}async function Gn(e,t=5){return(await(await H()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var U={get:Nn,getAll:Pn,getByIndex:Fn,set:In,setBulk:Ln,remove:Rn,clear:zn,cleanExpired:Bn,clearAll:Vn,getStoreSize:Hn,addToHistorial:Un,getHistorial:Wn,getTopUsed:Gn};async function Kn(e){if(!e)return[];try{let{data:t,error:n}=await D.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function qn(){let e=await U.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await D.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Jn(){let e=await U.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await D.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Yn(){let e=await U.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await D.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function Xn(){let e=await U.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await D.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function Zn(){let e=await U.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await D.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await D.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await D.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await U.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function Qn(e=null){let t=await U.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=D.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await U.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function $n(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Kn(n.claseId));break;case`[`:r=await qn();break;case`(`:r=await Yn();break;case`{`:r=await Xn();break;case`$`:r=await Jn();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await Zn():await Qn(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=er(r,t)),e&&e!==`#`){let t=(await U.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function er(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=tr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function tr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function nr(e,t){await U.addToHistorial(e,t)}var rr=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function mr(t,n=null,r=[],i=[],a={},s){let l=t===`edit`&&!!n,d=l?n:{...a};!l&&a.contenido&&!d.notas_dsl&&(d.notas_dsl=a.contenido),!l&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let f=new e(d),p=document.getElementById(`pm-planificacion-modal`);if(p&&p.remove(),p=document.createElement(`div`),p.id=`pm-planificacion-modal`,p.className=`pm-plan-modal-overlay`,p.innerHTML=gr(l,f,r,i),document.body.appendChild(p),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=_r(),document.head.appendChild(e)}let m=()=>{p.classList.remove(`open`),setTimeout(()=>p.remove(),200)};p.querySelector(`.pm-plan-close-x`).onclick=m,p.querySelector(`.pm-plan-cancel-btn`).onclick=m,p.querySelector(`.pm-plan-backdrop`).onclick=m;let h=e=>{e.key===`Escape`&&(m(),document.removeEventListener(`keydown`,h))};document.addEventListener(`keydown`,h);let g=p.querySelector(`#pl-plantilla`);g&&g.addEventListener(`change`,e=>{let t=pr.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(p.querySelector(`#pl-objetivos`).value=t.objetivos,p.querySelector(`#pl-contenido`).value=t.contenido,p.querySelector(`#pl-recursos`).value=t.recursos,p.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,yr(p))});let _=p.querySelector(`#pl-clase_id`);_&&_.addEventListener(`change`,()=>{let e=p.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${br(r,_.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),vr(p);let v=p.querySelector(`#dsl-editor-container`);if(v){let e=c({onSelect:async e=>{let n=(await o()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=u({initialContent:f.notas_dsl||``,onChange:(e,t)=>{let n=p.querySelector(`#dsl-summary`);n&&(n.textContent=Sr(t))},onAlumnoClick:()=>e.openModal()});v.appendChild(t),p._dslEditor=t}let y=p.querySelector(`.pm-plan-save-btn`);y.onclick=async()=>{let e=p.querySelector(`#pl-tema`)?.value.trim(),t=p.querySelector(`#pl-clase_id`)?.value;if(!e){p.querySelector(`#pl-tema`).focus();return}if(!t){p.querySelector(`#pl-clase_id`).focus();return}y.disabled=!0,y.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=p.querySelector(`#pl-recursos`)?.value||``,r=p._dslEditor,i={clase_id:t,maestro_id:p.querySelector(`#pl-maestro_id`)?.value||null,instrumento:p.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:p.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:p.querySelector(`#pl-objetivos`)?.value.trim(),contenido:p.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:p.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:p.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:l&&p.querySelector(`#pl-estado`)?.value||`planificado`};s&&await s(i),m()}catch(e){console.error(`[planificacionModal] Error:`,e),y.disabled=!1,y.textContent=l?`Guardar cambios`:`Guardar`}};let b=p.querySelector(`.pm-plan-body`);if(b){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;b.firstChild;)t.appendChild(b.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
  ...
  `,await Er()}async function wr(e,t,n,r){je.open({title:`Editar ${e}`,body:`
    ...
    <div class="pm-rc-list">
      ${t.map(e=>`
        <div class="pm-rc-item ${G.activeClassId===e.id?`active`:``}" data-id="${e.id}">
          <span class="pm-rc-item-text">${P(e.nombre)}</span>
    ...
    <div class="pm-rc-list">
      ${(await W.getIndicatorsByObjective(e)).map(e=>`
        <div class="pm-rc-ind-card" style="position:relative;">
          ...
          <span class="ind-text">${P(e.descripcion)}</span>
...
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=Jt(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function zr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Br(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Vr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await D.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Hr(e,t){let{data:n,error:r}=await D.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await D.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await D.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Br(a??[],l),indicators:n,totalAlumnos:l}}async function Ur(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Lr(e);try{let t=e;i===`natural`&&(t=await Ne(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=zr(Rr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Wr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `}function ni({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Wr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){ke()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=Te(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=k();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await D.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=ei(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=Pe(o,{onClose:()=>h()});try{let n=await Jr(e.id,t);s=n.indicatorSummaries,o.innerHTML=$r(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=ti(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}function ri({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ii(e,t,n){let{data:r,error:i}=await D.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await D.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await D.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function ai(e,t){let{data:n,error:r}=await D.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function oi(e){let{error:t}=await D.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function si(e,t,n,r,i=null){let{error:a}=await D.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await D.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var ci=`soi_ruta_tema_pendiente`;function li(e){sessionStorage.setItem(ci,JSON.stringify(e))}function ui(){let e=sessionStorage.getItem(ci);if(!e)return null;sessionStorage.removeItem(ci);try{return JSON.parse(e)}catch{return null}}function di(e,{onSave:t,onCancel:n}){let r=document.getElementById(`pm-justif-modal`);if(!r&&(r=document.createElement(`div`),r.id=`pm-justif-modal`,r.className=`pm-justif-modal-overlay`,r.innerHTML=`
    ...
    `,document.body.appendChild(r),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let i=null,a=null,o=null,s=null,c=!1,l=null,u=null,d=r.querySelector(`#pm-justif-title`),f=r.querySelector(`#pm-justif-subtitle`),p=r.querySelector(`#pm-justif-btn-text`),m=r.querySelector(`#pm-justif-alumno-nombre`),h=r.querySelector(`#pm-justif-motivo`),g=r.querySelector(`#pm-justif-file`),_=r.querySelector(`.pm-justif-file-placeholder`),v=r.querySelector(`.pm-justif-file-preview`),y=r.querySelector(`#pm-justif-preview-img`),b=r.querySelector(`#pm-justif-remove-file`);function x(e,t=null,n=null){i=e,a=t,o=null,s=null,c=!!t,l=n,c?(d.textContent=`Editar Justificación`,f.textContent=`Modifica el motivo de la inasistencia`,p.textContent=`Actualizar`):(d.textContent=`Justificar Inasistencia`,f.textContent=`Registra el motivo de la ausencia`,p.textContent=`Guardar Justificación`),m.textContent=e.nombre_completo,h.value=t?.motivo||``;let b=t?.evidencia_url||t?.evidencia_base64;b?(s=b,y.src=b,_.style.display=`none`,v.style.display=`block`):(s=null,_.style.display=`flex`,v.style.display=`none`),g.value=``,r.classList.add(`open`),h.focus();let x=r.querySelector(`.pm-justif-modal`);x&&(u&&u.dispose(),u=Pe(x,{onClose:()=>S(!0)}))}function S(e=!1){e&&n&&i&&l!==null&&n(i.id,l),r.classList.remove(`open`),i=null,a=null,o=null,s=null,l=null,u&&=(u.dispose(),null)}r.querySelector(`#pm-justif-close`).onclick=()=>S(!0),r.querySelector(`#pm-justif-cancel`).onclick=()=>S(!0),r.querySelector(`.pm-justif-backdrop`).onclick=()=>S(!0),g.onchange=e=>{let t=e.target.files[0];t&&(o=t,s=URL.createObjectURL(t),y.src=s,_.style.display=`none`,v.style.display=`block`)},b.onclick=()=>{s&&!(a?.evidencia_url||a?.evidencia_base64)&&URL.revokeObjectURL(s),o=null,s=null,g.value=``,_.style.display=`flex`,v.style.display=`none`},r.querySelector(`#pm-justif-save`).onclick=()=>{let e=h.value.trim();if(!e){h.focus(),h.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{h.style.borderColor=``},2e3);return}t&&i&&t({alumnoId:i.id,motivo:e,evidenciaFile:o,evidenciaPreview:s,justificacionId:a?.id||null,existingUrl:a?.evidencia_url||a?.evidencia_base64||null,isEdit:c})};let C=e=>{e.key===`Escape`&&(S(),document.removeEventListener(`keydown`,C))};return document.addEventListener(`keydown`,C),{open:x,close:S}}var fi=`documentos`;async function pi(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await D.storage.from(fi).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=D.storage.from(fi).getPublicUrl(r);return o.publicUrl}async function mi({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await pi(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await D.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function hi(e,t){if(!e||!t)return null;let{data:n,error:r}=await D.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function gi(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await D.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function _i(e,t,n,r,i=`Clase`){if(!r||r.length===0)return{success:!0};let a=r.filter(e=>e.observacion&&e.observacion.trim().length>0);if(a.length===0)return{success:!0};let o=a.map(r=>new s({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON()),{data:c,error:l}=await D.from(`observaciones_alumnos`).upsert(o,{onConflict:`sesion_clase_id,alumno_id`});return l?(console.error(`[Promotion] Error promoviendo observaciones:`,l),{success:!1,error:l.message}):{success:!0,data:c}}function vi(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}async function yi(e,{claseId:t,fecha:n}={}){let r=typeof e==`string`?document.getElementById(e):e;if(!r){console.error(`[asistenciaView] Container not found:`,e);return}r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=k();if(!i){r.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){r.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let a=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,s,c]=await Promise.all([S(),m([t]),ie([t]),D.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,i.id).eq(`fecha`,a).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let l=n.find(e=>e.id===t);if(!l){console.log(`[DEBUG] Clase not found in misClases`),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let u=o.find(t=>t.dia?.toLowerCase()===e),d=(s||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),f=c.data?.[0],p=f?.id||null,h=f?.updated_at||null,g=f?.contenido||``,_=l.salon?[l.salon]:[],[v,y]=await Promise.all([p?D.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,p).then(e=>e.data||[]):Promise.resolve([]),_.length>0?te(_):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let b=y.length>0?y[0].nombre:null,x=`pm_asistencia_${t}_${a}`,C=localStorage.getItem(`${x}_updated`),ee=!1;h&&C&&new Date(h).getTime()>new Date(C).getTime()+5e3&&(ee=!0);let w=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await D.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();w=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let T={},ne={};d.forEach(e=>{T[e.id]=null});let E=f?.asistencia||[];if(E.length===0&&p)try{let{data:e}=await D.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,p);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};E=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let re={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};E.forEach(e=>{if(T.hasOwnProperty(e.alumno_id)){let t=re[e.estado]??e.estado;T[e.alumno_id]=t}});let ae=[];if(p)try{ae=await D.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,p).then(e=>e.data||[]),ae.forEach(e=>{T.hasOwnProperty(e.alumno_id)&&(T[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}bi(r,{clase:l,horario:u,alumnos:d,estado:T,justificaciones:ne,maestro:i,fechaHoy:a,claseId:t,sesionId:p,hasConflict:ee,serverDSL:g,snapshots:v,salonNombre:b,rutaId:w,sesionExistenteData:f})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${P(e.message)}</p>`}}function bi(e,r){let{clase:i,horario:a,alumnos:o,estado:s,justificaciones:c,maestro:l,fechaHoy:u,claseId:d,snapshots:f,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v}=r,y=r.sesionId,b=[],x=`pm_asistencia_${d}_${u}`,C=m,ee=null,w=vi(),T=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${P(i.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${g?`📍 ${P(g)} · `:``}
            ${a?`${De(a.hora_inicio)} – ${De(a.hora_fin)} · `:``}
    ...
    <!-- Modales... -->
  `;let te=e.querySelector(`#pm-dsl-toolbar-container`),ne=e.querySelector(`#pm-dsl-editor-container`),E=ir(ne,{initialContent:m,onChange:e=>{C=e}});E.setContext({claseId:d});let re=sr(e,{onAceptar:e=>{E.setValue(e)}}),ie=en(e,{onAccept:e=>{E.setValue(e)}}),ae=nn(te,{onInsert:(e,t,n)=>E.insertText(e,t,n),getEditorContent:()=>E.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=te.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Me(e);re.open({original:e,improved:t})}catch(e){j.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=te.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=T?.getActiveIndicador(),n=await Ne(e,{presentes:o.filter(e=>s[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ie.open({original:e,dsl:n})}catch(e){j.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}}}),O=null,oe=e.querySelector(`#pm-planificacion-card`),se=e.querySelector(`#pm-planificacion-dropdown`),k=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let ce=e.querySelector(`#pm-plan-list-rutas`),le=e.querySelector(`#pm-plan-list-planificaciones`),ue=e.querySelector(`#pm-planificacion-header`);ue&&ue.addEventListener(`click`,()=>{let e=oe.classList.toggle(`open`);se.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;ce.style.display=n===`rutas`?``:`none`,le.style.display=n===`planificaciones`?``:`none`})});function de(t){O=t.id,localStorage.setItem(`pm_default_plan_${d}`,t.id),k&&(k.textContent=t.nombre||t.name||`Sin nombre`),le.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),T&&=(T.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);O&&n&&(n.innerHTML=``,Ee(d).then(e=>{T=Ir(n,{claseId:d,rutaId:O,completedTopics:e,onIndicadorSelect:e=>{E.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),oe.classList.remove(`open`),se.style.display=`none`}}),b.push(()=>T.destroy())}))}let pe=e.querySelector(`#btn-manage-planning`);pe&&(pe.onclick=e=>{if(e.stopPropagation(),!O){je.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}je.open({title:`Gestionar Estructura: ${k.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(T&&T.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Cr(t,O)}),oe&&(async()=>{try{let e=await W.getClasses(),t=localStorage.getItem(`pm_default_plan_${d}`),n=(i.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ce&&(ce.innerHTML=r.length?r.map(e=>`
              <div class="pm-plan-item ${e.id===t?`active`:``}" data-plan-id="${e.id}">
                <span class="pm-plan-item-icon">📍</span>
                <span class="pm-plan-item-name">${P(e.nombre||`Ruta sin nombre`)}</span>
            ...
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${P(e.nombre||e.name)}</span>
            </div>`).join(``),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&de(n)})})),oe.style.display=``;let a=e.find(e=>e.id===t)||r[0]||await W.resolveSmartPlan(i);a&&de(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let me=e.querySelector(`#btn-copy-as-plan`);me&&me.addEventListener(`click`,async()=>{let e=E.getValue();mr(`create`,null,await S(),[],{clase_id:d,maestro_id:l?.id||null,maestro_nombre:l?.nombre_completo||null,contenido:e||``,fecha_inicio:u},async e=>{try{await t({...e,estado:`planificado`});let n=document.createElement(`div`);n.className=`pm-toast-success`,n.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(n),setTimeout(()=>n.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),j.error(`Error al guardar la planificación: `+(e.message||e))}})}),_&&(T=Ir(e.querySelector(`#pm-route-tree-container`),{claseId:d,rutaId:_,onIndicadorSelect:t=>{E.insertText(`[${t.nombre}] `),ae.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),b.push(()=>T.destroy())),console.log(`[DEBUG] Reached handoff section`);let he=ui();if(he&&he.claseId===d){let t=`[${he.nombre}] `;E.insertText(t),ae.setContext({indicadorActivo:he.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let ge=di(document.body,{onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await D.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await D.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=D.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await D.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{y||await we(!0,!1);let r=await mi({sesionId:y,alumnoId:e,claseId:d,fecha:u,motivo:t,creadoPor:l.id},n);if(r.error)throw r.error;o=r.data}o&&(c[e]=o),ge.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{s[e]=t,xe(e),N()}});b.push(()=>{try{ge.close()}catch{}});let _e=null,ve=e.querySelector(`#pm-draft-indicator`);if(y){_e=ri({saveFn:async e=>{y&&await ii(y,l.id,e)},debounceMs:3e4}),_e.onSaved(()=>{let e=new Date;ve.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,ve.style.display=``}),E.getValue;let e=ne.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),_e&&_e.onInput(E.getValue())}}b.push(()=>_e.destroy()),v?.borrador===!0&&ai(y,l.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(E.setValue(e.contenido_raw),C=e.contenido_raw):oi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let A=e.querySelector(`#btn-guardar-obs`);A&&(_&&(A.style.display=``),A.onclick=async()=>{let t=E.getValue();if(!t||!t.trim()){j.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!y){j.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let n=null,r=await Oe(t),a=T?.getActiveIndicador();if(n=r||a,!n){j.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let c=e.querySelector(`#pm-active-tema-badge`);c&&n.nombre&&(c.textContent=n.nombre,c.style.display=`inline-block`),A.disabled=!0,A.textContent=`Procesando...`;try{let e=o.filter(e=>s[e.id]===`P`),r=await Ur(t,n.id,e,n.nombre);if(r.error)throw Error(r.error);if(r.modo===`natural`&&r.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+r.dslGenerado+`

¿Guardar la evaluación?`)){A.disabled=!1,A.textContent=`Guardar observación`;return}if(r.missing.length>0&&!confirm(`Faltan ${r.missing.length} alumno(s) sin evaluar:\n${r.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){A.disabled=!1,A.textContent=`Guardar observación`;return}if(r.evaluaciones.length>0){let{error:e}=await Vr(y,n.id,r.evaluaciones,l.id);if(e)throw e}let a={indicador_id:n.id,evaluaciones:r.evaluaciones};await si(y,l.id,t,a,r.dslGenerado||null);let c=await _i(y,d,l.id,r.evaluaciones,i.nombre||`Clase`);c.success||console.warn(`[Fase C] Fallo parcial en promoción:`,c.error),T&&await T.refresh(),E.setValue(``),C=``;let u=document.createElement(`div`);u.innerHTML=`
        ...
        `,u.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(u),setTimeout(()=>u.remove(),4500),A.textContent=`¡Guardado!`,setTimeout(()=>{A.textContent=`Guardar observación`,A.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),j.error(`Error al guardar: `+(e.message||e)),A.disabled=!1,A.textContent=`Guardar observación`}});let ye=null,be=e.querySelector(`#pm-alumnos-list`);function xe(e=null){let t=xi(o,s),n=null;if(e){let t=be.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(be.innerHTML=t.map(e=>Se(e,s[e.id])).join(``),e&&n){let t=be.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Se(e,t){return`
      <div class="pm-asist-item ${t?`estado-${t.toLowerCase()}`:``}" data-id="${e.id}">
        ...
        <div class="pm-asist-info">
          <span class="pm-asist-nombre">${P(e.nombre_completo)}</span>
          <span class="pm-asist-instrumento">${P(e.instrumento_principal||`—`)}</span>
        </div>
    ...
    `}be.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),r=t.target.closest(`.pm-asist-nombre`);if(r){let t=r.closest(`.pm-asist-item`).dataset.id,n=o.find(e=>e.id===t);if(_){ye&&ye.destroy(),ye=ni({alumno:n,rutaId:_,sessionId:y,claseId:d,fecha:u,horaInicio:a?.hora_inicio||null}),ye.open(),b.push(()=>{ye&&ye.destroy()});return}let i=f.filter(e=>e.student_id===t);if(i.length===0)try{let{academicService:e}=await M(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(y,t,u);n?(i=n,f.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}or(e,{student:n,sessionId:y,teacherId:l.id,snapshots:i});return}if(!n)return;let{id:i,action:p}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),p===`J`){let e=o.find(e=>e.id===i);if(!e)return;if(s[i]===`J`){if(y){let e=await hi(y,i);if(e?.id){if(e.evidencia_url){let t=e.evidencia_url.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);t&&D.storage.from(`documentos`).remove([t[1]]).catch(()=>{})}gi(e.id).catch(console.warn)}}s[i]=null,delete c[i],xe(i),N(),await we(!0),yt(`Justificación eliminada para ${e.nombre_completo}.`)}else{s[i]=`J`,xe(i),N(),await we(!0);let t=c[i]||null;!t&&y&&(t=await hi(y,i),t&&(c[i]=t)),ge.open(e,t,null),yt(`Justificación marcada para ${e.nombre_completo}.`)}return}s[i]=s[i]===p?null:p,xe(i),N();let m=Object.values(s).filter(e=>e===`P`).length,h=Object.values(s).filter(e=>e===`A`).length,g=Object.values(s).filter(e=>e===`J`).length;yt(`Asistencia actualizada. ${m} presentes, ${h} ausentes, ${g} justificados.`),await we(!0)};function N(){let t=o.length,n=Object.values(s).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),a=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,a.textContent=`${n}/${t}`}async function we(e=!1,t=!1){ee&&clearTimeout(ee);let n=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t={clase_id:d,maestro_id:l.id,fecha:u,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:C||``};if(navigator.onLine)try{if(y){let{error:e}=await D.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,y);if(!e){localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await D.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){y=e.id,console.log(`[asistencia] Nueva sesión creada:`,y),localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await fe({tabla:`sesiones_clase`,operacion:y?`update`:`insert`,payload:{...y?{id:y}:{},...t}}),localStorage.setItem(`${x}_updated`,new Date().toISOString())};e?t?await n():await w.run(n):ee=setTimeout(()=>{w.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),r=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await w.run(async()=>{try{let r=o.filter(e=>s[e.id]).map(e=>({clase_id:d,alumno_id:e.id,fecha:u,estado:s[e.id],registrado_por:l.id})),a=r.length>0,c=C&&C.trim().length>0;if(!a&&!c)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await we(!0,!0),!y){let{data:e}=await D.from(`sesiones_clase`).select(`id`).eq(`clase_id`,d).eq(`maestro_id`,l.id).eq(`fecha`,u).maybeSingle();e&&(y=e.id)}if(a)try{let e=r.map(e=>({...e,...y&&{sesion_clase_id:y}}));await n(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){throw console.error(`[asistencia] Error registrando asistencias en bulk:`,e),Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(y&&(a||c)){let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),{error:t}=await D.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await D.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await D.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y))}p(),Pr(`hoy`),Pr(`calendario`),Pr(`metricas`)}if(y){let{academicService:n}=await M(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await M(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BQVYinl0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await n.processSessionClosure(y);i&&i.length>0&&(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i))}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let f=Object.values(s).filter(e=>e===`P`).length,m=Object.values(s).filter(e=>e===`A`).length;yt(`Sesión guardada exitosamente. ${f} presentes, ${m} ausentes.`);let h=document.createElement(`div`);if(h.className=`pm-saved-overlay`,h.innerHTML=`
      ...
      `,e.querySelector(`.pm-asist-root`).appendChild(h),!document.getElementById(`pm-saved-styles`)){let e=document.createElement(`style`);e.id=`pm-saved-styles`,e.textContent=`
        ...
        `,document.head.appendChild(e)}let g=h.querySelector(`#btn-editar-asistencia`),_=h.querySelector(`#btn-compartir-correo`),v=h.querySelector(`#btn-compartir-whatsapp`),b=h.querySelector(`#btn-volver-hoy`),x=h.querySelector(`#btn-ir-calendario`);g&&(g.onclick=()=>{h.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),_&&(_.onclick=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${i.nombre} - ${u}`),n=encodeURIComponent(Te(e,C,o,i));window.open(`mailto:?subject=${t}&body=${n}`,`_blank`)}),v&&(v.onclick=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(Te(e,C,o,i));window.open(`https://wa.me/?text=${t}`,`_blank`)}),b&&(b.onclick=()=>{window.location.hash=`#/hoy`}),x&&(x.onclick=()=>{window.location.hash=`#/calendario`})}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=r,t.style.background=``},3e3)}})};function Te(e,t,n,r){let i=e.filter(e=>e.estado===`P`).length,a=e.filter(e=>e.estado===`A`).length,o=e.filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre}\n`;return s+=`Fecha: ${u}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,e.forEach(e=>{let t=n.find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}e.querySelector(`#pm-asist-back`).onclick=()=>{ke.destroy();try{ge.close()}catch{}b.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{o.forEach(e=>{s[e.id]=`P`}),xe(),N(),await we(!0),yt(`Todos los ${o.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{o.forEach(e=>{s[e.id]=`A`}),xe(),N(),await we(!0),yt(`Todos los ${o.length} alumnos marcados como ausentes.`)},xe();async function Ee(e){try{let{data:t}=await D.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Oe(e){if(!e||!O)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await W.getRouteHierarchy(O),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let ke=new fr(e);ke.mount();let Ae=e.querySelector(`#pm-btn-help`);return Ae&&(Ae.onclick=()=>ke.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),ke.destroy();try{ge.close()}catch{}b.forEach(e=>{try{e()}catch{}})}}function xi(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Si(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await D.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Si(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await fe({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var wi={async open(){let e=await xe(),t=await ye();je.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Ai(n,t),ji(n,t),Ri(n,t),Mi(r),Ni(r,t),Pi(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Fi(r),Ii(r),Ki(t),Vi(t),qi(),M(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-D0NSQfHK.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Li(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Ai(e,t){let n=we(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-profile-hero" aria-label="Información del perfil">
      <div class="pm-profile-hero__content">
        <div class="pm-settings-avatar">
          ${t.avatar_url?`<img src="${P(t.avatar_url)}" alt="Avatar" class="pm-settings-avatar__img">`:`<div class="pm-settings-avatar__placeholder" aria-hidden="true">${P(n)}</div>`}
        ...
        <div class="pm-profile-hero__info">
          <h2 class="pm-profile-hero__name">${P(t.nombre_completo)}</h2>
          <p class="pm-profile-hero__email">${P(t.email)}</p>
          ${t.especialidad?`
            <span class="chip-apple active" aria-label="Especialidad: ${P(t.especialidad)}">
              <i class="bi bi-mortarboard" aria-hidden="true"></i> ${P(t.especialidad)}
            </span>`:``}
        </div>
      </div>
    ...
    <section class="card-apple pm-settings-section" aria-labelledby="datos-title">
      ...
      <div class="pm-settings-form-grid">
        <div class="pm-settings-field">
          ...
          <input type="text" class="input-apple" id="perfilNombre" value="${P(t.nombre_completo)}" placeholder="Tu nombre">
        </div>
        <div class="pm-settings-field">
          <label for="perfilTelefono" class="apple-caption">Teléfono</label>
          <input type="tel" class="input-apple" id="perfilTelefono" value="${P(t.tlf||t.telefono||``)}" placeholder="809-000-0000" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
        </div>
        <div class="pm-settings-field">
          <label for="perfilEspecialidad" class="apple-caption">Especialidad</label>
          <input type="text" class="input-apple" id="perfilEspecialidad" value="${P(t.especialidad||``)}" placeholder="Ej. Violín">
        </div>
      </div>
    ...
    </section>`)}function Ni(e,t){let n=_e(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
            ...
            <div class="pm-route-nivel expanded">
              <div class="pm-nivel-toggle" data-level="${e.id}">
                ...
                <div class="pm-nivel-info">
                  <span class="pm-nivel-name">${P(e.nombre)}</span>
                  <span class="pm-nivel-obj">${P(e.objetivo_general||`Objetivo no especificado`)}</span>
                </div>
                ...
                ${(e.plan_temas||[]).map(e=>`
                  <div class="pm-nodo-card ${e.es_critico?`critical`:``}">
                    ...
                    <div class="pm-nodo-info">
                      <span class="pm-nodo-name">${P(e.nombre)}</span>
        ...
        <div id="tab-visualizador" class="pm-tab-pane active">
          ...
          <div class="pm-planif-selector">
            ...
            <select id="pm-planif-clase-select" class="pm-input">
              ...
              ${n?.map(e=>`<option value="${e.id}">${P(e.nombre||e.name||`Sin nombre`)}</option>`).join(``)||``}
            </select>
          </div>
    ...
    <div class="pm-import-preview">
      <div style="margin-bottom:1.5rem; padding:1rem; background:var(--pm-surface-2); border-radius:12px;">
        ...
        <select id="preview-class-selector" class="pm-input" onchange="document.getElementById('new-class-name-wrapper').style.display = (this.value === 'NEW' ? 'block' : 'none')">
          ...
          ${t.map(e=>`<option value="${e.id}">Añadir a: ${P(e.nombre||e.name)}</option>`).join(``)}
        </select>
        ...
        ${n.map((e,t)=>`
          <div style="margin-bottom:1rem; border:1px solid var(--pm-border); border-radius:8px;">
            <div style="background:var(--pm-surface-2); padding:0.5rem; display:flex; gap:0.5rem;">
              <input type="text" class="preview-nivel-input pm-input" value="${P(e.nombre)}" data-n-idx="${t}" />
            </div>
            <div style="padding:0.5rem;">
              ${(e.temas||[]).map((e,n)=>`
                <div style="margin-bottom:0.5rem; padding-left:0.5rem; border-left:2px solid var(--pm-primary);">
                  <input type="text" class="preview-tema-input pm-input" value="${P(e.nombre)}" data-n-idx="${t}" data-t-idx="${n}" style="font-size:0.8rem;" />
                  ${(e.objetivos||[]).map((e,r)=>`
                    <input type="text" class="preview-obj-input pm-input" value="${P(e.nombre)}" data-n-idx="${t}" data-t-idx="${n}" data-o-idx="${r}" style="font-size:0.75rem; margin-top:2px;" />
                  `).join(``)}
                </div>
              `).join(``)}
            </div>
...
`).trim():``}async function ia(e,t){let n=e.querySelector(`#pm-alumno-progreso-root`);if(n)try{let{data:e,error:r}=await D.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1});if(r)throw r;if(!e||e.length===0){n.innerHTML=`<p class="pm-empty">Sin evaluaciones registradas.</p>`;return}let i=[...new Set(e.map(e=>e.indicator_id))],{data:a}=await D.from(`indicators`).select(`id, nombre, node_id`).in(`id`,i),o=[...new Set((a||[]).map(e=>e.node_id).filter(Boolean))],{data:s}=await D.from(`nodes`).select(`id, name`).in(`id`,o),c=new Map((s||[]).map(e=>[e.id,e.name])),l=new Map((a||[]).map(e=>[e.id,e])),u=new Map;for(let t of e){if(u.has(t.indicator_id))continue;let e=l.get(t.indicator_id);u.set(t.indicator_id,{id:t.indicator_id,nombre:e?.nombre||``,nodeName:c.get(e?.node_id)||``,latest:t,history:[]})}for(let t of e)if(u.has(t.indicator_id)){let e=u.get(t.indicator_id);(e.history.length===0||e.history[0].id!==t.id)&&e.history.push(t)}let d=Array.from(u.values()).filter(e=>e.latest.nota!=null&&e.latest.nota!==0||e.latest.observations&&e.latest.observations.trim()!==``),f=d.filter(e=>e.latest.nota>=4).length,p=d.length,m=p>0?Math.round(f/p*100):0;function h(e){return e==null?`⚫`:e>=4?`🟢`:e>=2?`🟡`:`🔴`}function g(e){return e==null?`pm-route-indicador--gray`:e>=4?`pm-route-indicador--green`:e>=2?`pm-route-indicador--yellow`:`pm-route-indicador--red`}n.innerHTML=`
              ...
              <div class="pm-eval-indicador ${g(e.latest.nota)}" data-ind-id="${e.id}">
                <div class="pm-eval-indicador-header">
                  ...
                  <div class="pm-eval-info">
                    <span class="pm-eval-nombre">${P(e.nombre||`Indicador`)}</span>
                    ${e.nodeName?`<span class="pm-eval-node">${P(e.nodeName)}</span>`:``}
                  </div>
                ...
                <div class="pm-eval-timeline" style="display:none;">
                  ${e.history.map(e=>`
                    <div class="pm-eval-entry">
                      ...
                      ${e.observations?`<p class="pm-eval-entry-obs">${P(e.observations)}</p>`:``}
                      ${e.tarea?`<p class="pm-eval-entry-tarea">📋 ${P(e.tarea)}</p>`:``}
                    </div>
                  `).join(``)}
                </div>
              </div>
    ...
    `,n.querySelectorAll(`.pm-eval-indicador`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.querySelector(`.pm-eval-timeline`),n=e.querySelector(`.pm-eval-toggle`),r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.classList.toggle(`bi-chevron-down`,r),n.classList.toggle(`bi-chevron-up`,!r)})})}catch(t){let n=e.querySelector(`#pm-alumno-progreso-root`);n&&(n.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger);">Error al cargar evaluaciones: ${P(t.message)}</p>`)}}async function aa(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=k();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){e.innerHTML=`<p class="pm-empty">No se especificó el alumno.</p>`;return}try{let{data:r,error:i}=await D.from(`alumnos`).select(`id, nombre_completo, instrumento_principal, tlf_alumno, fecha_nacimiento, created_at, nivel_actual, representante_nombre, representante_tlf, correo_representante, direccion`).eq(`id`,t).single();if(i||!r){console.error(`[AlumnoPerfil] Error al obtener alumno:`,i),e.innerHTML=`
      ...
      `;return}let{data:a}=await D.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await D.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await D.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await D.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await D.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,_=c.filter(e=>e.estado===`J`).length,v=c.filter(e=>e.estado===`T`).length,y=p>0?Math.round(m/p*100):0,b=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],x=b.length>0?Math.round(b.reduce((e,t)=>e+t.nota,0)/b.length*10)/10:0,S=b.filter(e=>e.nota>=4).length,C=b.length,ee=C>0?Math.round(S/C*100):0,w={};c.forEach(e=>{w[e.clase_id]||(w[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(w[e.clase_id][e.estado]=(w[e.clase_id][e.estado]||0)+1,w[e.clase_id].total++)});let T=new Set([...o,...Object.keys(w)]),{data:te}=T.size>0?await D.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...T]):{data:[]},ne=new Map((te||[]).map(e=>[e.id,e])),E=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),re=l?.filter(e=>e.observations?.trim())||[],ie=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;ie=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&ie--}let ae=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,O=(r.instrumento_principal||``).toLowerCase(),oe=`var(--pm-primary)`;(O.includes(`violin`)||O.includes(`cuerda`))&&(oe=`#FF3B30`),(O.includes(`piano`)||O.includes(`teclado`))&&(oe=`#FF9500`),O.includes(`guitarra`)&&(oe=`#5856D6`),(O.includes(`canto`)||O.includes(`voz`))&&(oe=`#AF52DE`),e.innerHTML=`
      <div class="pm-alumno-zen pm-animate-fade-in">
        <!-- Hero Section -->
        <div class="pm-zen-hero" style="--accent-gradient: ${oe}">
          ...
          <div class="pm-zen-hero__content">
            ...
            <div class="pm-zen-info">
              <h1 class="pm-zen-name">${P(r.nombre_completo)}</h1>
              <p class="pm-zen-instrument">${P(r.instrumento_principal||`Estudiante`)}</p>
              <p style="font-size:0.8rem;opacity:0.8;margin-top:4px;">Nivel ${r.nivel_actual||1} • ${ie} años</p>
            </div>
          </div>
        </div>
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-mosaic" style="grid-template-columns: repeat(2, 1fr);">
            <div class="pm-zen-card pm-zen-card--large pm-glass" style="grid-column: span 2;">
              ...
              ${C>0?`
              <div class="pm-student-panel__progress-bar" style="height:6px;border-radius:3px;background:var(--pm-border);">
                <div style="width:${ee}%;background:${x>=4?`var(--pm-success)`:x>=2?`var(--pm-warning)`:`var(--pm-danger)`};height:100%;border-radius:3px;"></div>
              </div>
              <p style="font-size:0.72rem;color:var(--pm-text-muted);margin-top:0.4rem;">
                ${S} de ${C} indicadores aprobados · ${ee}%
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-clases-grid">
              ${o.map(e=>{let t=ne.get(e);if(!t)return``;let n=w[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null;return`
                  <div class="pm-zen-clase-card pm-glass">
                    <div class="pm-zen-clase-header">
                      <strong>${P(t.nombre)}</strong>
                      ${t.nivel?`<span class="pm-zen-clase-nivel">Nivel ${t.nivel}</span>`:``}
                    </div>
                    <p class="pm-zen-clase-inst">${P(t.instrumento||``)}</p>
              ...
              ${b.slice(0,8).map(e=>{let t=new Date(e.created_at),n=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
                  <div class="pm-zen-eval-item">
                    ...
                    <div class="pm-zen-eval-content">
                      ...
                      ${e.tarea?`<p class="pm-zen-eval-tarea">${P(e.tarea)}</p>`:``}
                      ${e.observations?`<p class="pm-zen-eval-obs">${P(e.observations.substring(0,80))}${e.observations.length>80?`...`:``}</p>`:``}
                    </div>
                  </div>
                `}).join(``)}
            </div>
          ...
          <details class="pm-zen-section pm-zen-accordion">
            <summary class="pm-zen-accordion-header">
              ...
              <span class="pm-zen-accordion-meta">${re.length} observación${re.length===1?``:`es`}</span>
              <i class="bi bi-chevron-down pm-accordion-chevron"></i>
            </summary>
            <div class="pm-zen-desenvolvimiento" style="margin-top:0.75rem;">
              ${re.map(e=>{let t=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
                  <div class="pm-zen-desenv-item">
                    ...
                    <div class="pm-zen-desenv-content">
                      ...
                      <p class="pm-zen-desenv-obs">${P(e.observations)}</p>
                      ${e.tarea?`<p class="pm-zen-desenv-tarea">📋 ${P(e.tarea)}</p>`:``}
                    </div>
                  </div>
                `}).join(``)}
            </div>
          ...
          <details class="pm-zen-section pm-zen-accordion" ${c.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${c.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:c.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=ne.get(e.clase_id),i=e.estado===`J`?f.get(e.sesion_id):null;return`
                      <div class="pm-zen-asistencia-item">
                        ...
                        <div class="pm-zen-asistencia-content">
                          ...
                          <span class="pm-zen-asistencia-clase">${P(r?.nombre||`Clase`)}</span>
                          ${i?`
                            <div class="pm-zen-justif-box">
                              ...
                              <p class="pm-zen-justif-motivo">${P(i.motivo)}</p>
                          ...
                          ${e.observaciones?`<span class="pm-zen-asistencia-obs">${P(e.observaciones)}</span>`:``}
                        </div>
                      </div>
                    `}).join(``)}
            </div>
              ...
              ${u.map(e=>{let t=new Date(e.fecha_inicio).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`}),n=e.fecha_fin?new Date(e.fecha_fin).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`}):t,r={pendiente:`var(--pm-warning)`,aprobada:`var(--pm-success)`,rechazada:`var(--pm-danger)`};return`
                  <div class="pm-zen-ausencia-item">
                    ...
                    <div class="pm-zen-ausencia-content">
                      ...
                      ${e.motivo?`<p class="pm-zen-ausencia-motivo">${P(e.motivo.substring(0,60))}${e.motivo.length>60?`...`:``}</p>`:``}
                    </div>
                  </div>
                `}).join(``)}
            </div>
            ...
            <div class="pm-zen-details-grid">
              ...
              <div class="pm-zen-detail">
                ...
                <div>
                  ...
                  <strong>${P(r.representante_nombre)}</strong>
                </div>
              </div>`:``}
              ...
              <div class="pm-zen-detail">
                ...
                <div>
                  ...
                  <strong>${P(r.correo_representante)}</strong>
                </div>
              </div>`:``}
              ${r.direccion?`
              <div class="pm-zen-detail">
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let se=Zi(r.tlf_alumno||r.representante_tlf);if(se){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
        ...
        <div class="pm-wa-dialog">
          ...
          <div id="pm-wa-view-send">
            <div class="pm-wa-header">
              ...
              <span>Mensaje para <strong>${P(i)}</strong></span>
      ...
      `,e.appendChild(o);let s=o.querySelector(`#pm-wa-view-send`),c=o.querySelector(`#pm-wa-view-mgr`),l=o.querySelector(`#pm-wa-tpl-list`),u=o.querySelector(`#pm-wa-tpl-mgr-list`),d=o.querySelector(`#pm-wa-text`),f=o.querySelector(`#pm-wa-send`);function p(){return ea(n.id)}function m(e){ta(n.id,e)}function h(){let e=d.value.trim();f.href=e?`https://wa.me/${se}?text=${encodeURIComponent(e)}`:`https://wa.me/${se}`}function g(e){l.querySelectorAll(`.pm-wa-tpl`).forEach(e=>e.classList.remove(`active`)),l.querySelector(`[data-id="${e.id}"]`)?.classList.add(`active`),d.value=na(e.text,a),h()}function _(){let e=p();l.innerHTML=e.length?e.map(e=>`<button class="pm-wa-tpl" data-id="${e.id}">${P(e.label)}</button>`).join(``):`<span style="font-size:0.78rem;color:var(--pm-text-muted);">Sin plantillas — creá una en Gestionar.</span>`,l.querySelectorAll(`.pm-wa-tpl`).forEach(e=>{e.addEventListener(`click`,()=>{let t=p().find(t=>t.id===e.dataset.id);t&&g(t)})});let t=p()[0];t&&g(t)}function v(){let e=p();u.innerHTML=e.length===0?`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin plantillas todavía.</p>`:e.map(e=>`
            <div class="pm-wa-mgr-item" data-id="${e.id}">
              <div class="pm-wa-mgr-item-header">
                <input class="pm-wa-mgr-label" value="${P(e.label)}" placeholder="Nombre de la plantilla" />
                <button class="pm-wa-mgr-del" data-id="${e.id}" title="Eliminar">🗑</button>
              </div>
              <textarea class="pm-wa-mgr-text" rows="3">${P(e.text)}</textarea>
    ...
    `}}var oa={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},sa={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},ca={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function la(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(oa))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function ua(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=k();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await D.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await D.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
      <div class="pm-progress-root">
        <div class="pm-progress-header">
          ...
          <select id="pm-student-select" class="pm-input">
            ...
            ${[...new Map(r?.map(e=>[e.alumnos.id,e.alumnos])||[]).values()].map(e=>`<option value="${e.id}">${P(e.nombre)} ${P(e.apellido)}</option>`).join(``)}
          </select>
        </div>
    ...
    `,e.querySelector(`#pm-student-select`).addEventListener(`change`,async t=>{let n=t.target.value;if(!n){e.querySelector(`#pm-progress-content`).innerHTML=``;return}await da(e,n)})}catch(t){e.innerHTML=`<p class="pm-empty">Error: ${P(t.message)}</p>`}}async function da(e,t){let n=e.querySelector(`#pm-progress-content`);n.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:e}=await D.from(`alumnos`).select(`nombre, apellido`).eq(`id`,t).single(),{data:r}=await D.from(`academic_plans`).select(`id, route_version_id, status`).eq(`student_id`,t).in(`status`,[`in_process`,`active`]).order(`created_at`,{ascending:!1}).limit(1).maybeSingle();if(!r){n.innerHTML=`
      ...
      `;return}let{data:i}=await D.from(`levels`).select(`*`).eq(`route_version_id`,r.route_version_id).order(`level_number`,{ascending:!0}),{data:a}=await D.from(`student_level_progress`).select(`*`).eq(`student_id`,t),{data:o}=await D.from(`nodes`).select(`*, indicators(*)`).in(`level_id`,(i||[]).map(e=>e.id)).order(`order_index`,{ascending:!0}),{data:s}=await D.from(`student_node_progress`).select(`*, indicator_attempts(*)`).eq(`student_id`,t),c=(a||[]).filter(e=>e.status===`approved`).length,l=i?.length||0,u=l>0?Math.round(c/l*100):0;n.innerHTML=`
      <div class="pm-student-summary">
        <div class="pm-summary-row">
          <span class="pm-summary-label">Alumno</span>
          <span class="pm-summary-value">${P(e.nombre)} ${P(e.apellido)}</span>
        </div>
        <div class="pm-summary-row">
            ...
            <div class="pm-level-circle" data-level-id="${e.id}">
              ...
              <div class="pm-level-content">
                <div class="pm-level-title" style="cursor:pointer;" onclick="this.closest('.pm-level-circle').classList.toggle('expanded')">
                  ...
                  Nivel ${e.level_number}: ${P(e.name)}
                </div>
                <div class="pm-level-obj">${P(e.main_objective||``)}</div>
                  ...
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        ...
                        <div class="pm-node-info">
                          <span class="pm-node-name">${P(e.name)}</span>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  ...
                                  <span class="pm-indicator-desc">${P(e.description)}</span>
    ...
    `}catch(e){n.innerHTML=`<p class="pm-empty">Error: ${P(e.message)}</p>`}}async function fa(e){let t=(await S())?.find(t=>t.id===e)?.instrumento;if(!t)return null;let n=t.split(`,`)[0].trim().toLowerCase(),{data:r,error:i}=await D.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${n}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();return i?(console.warn(`[rutaService] resolveRutaIdForClase error:`,i.message),null):r?.route_versions?.[0]?.id||r?.route_versions?.id||null}async function pa(e,t){let{data:n,error:r}=await D.from(`blocks`).select(`id, nombre:name, order_index`).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(r)throw Error(`[rutaService] blocks: `+r.message);if(!n||n.length===0)return[];let i=n.map(e=>e.id),{data:a,error:o}=await D.from(`levels`).select(`id, block_id, nombre:name, order_index`).in(`block_id`,i).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(o)throw Error(`[rutaService] levels: `+o.message);let s=(a??[]).map(e=>e.id);if(s.length===0)return n.map(e=>({...e,levels:[]}));let{data:c,error:l}=await D.from(`nodes`).select(`id, level_id, nombre:name, order_index`).in(`level_id`,s).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(l)throw Error(`[rutaService] nodes: `+l.message);let u=(c??[]).map(e=>e.id),{data:d,error:f}=u.length>0?await D.from(`indicators`).select(`id, node_id, nombre:description, order_index`).in(`node_id`,u).eq(`activo`,!0).order(`order_index`,{ascending:!0}):{data:[],error:null};if(f)throw Error(`[rutaService] indicators: `+f.message);let p=await Promise.all((c??[]).map(e=>Hr(e.id,t).then(t=>({nodeId:e.id,semaphore:t.semaphore})).catch(()=>({nodeId:e.id,semaphore:`gray`})))),m=new Map(p.map(e=>[e.nodeId,e.semaphore])),h=new Map;for(let e of d??[])h.has(e.node_id)||h.set(e.node_id,[]),h.get(e.node_id).push({...e,semaphore:m.get(e.node_id)??`gray`});let g=new Map;for(let e of c??[])g.has(e.level_id)||g.set(e.level_id,[]),g.get(e.level_id).push({...e,semaphore:m.get(e.id)??`gray`,indicators:h.get(e.id)??[]});let _=new Map;for(let[e]of i.map(e=>[e]))_.set(e,[]);let v=new Map;for(let e of a??[])v.has(e.block_id)||v.set(e.block_id,[]),v.get(e.block_id).push(e);for(let[e,t]of v){let n=t.map((e,t,n)=>{let r=g.get(e.id)??[],i=r.flatMap(e=>h.get(e.id)??[]),a=i.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length,o=i.length>0?Math.round(a/i.length*100):0,s=r.map(e=>e.semaphore),c=s.every(e=>e===`green`)&&s.length>0?`green`:s.every(e=>e===`gray`)||s.length===0?`gray`:`yellow`,l=!1;if(t>0){let e=n[t-1],r=(g.get(e.id)??[]).flatMap(e=>h.get(e.id)??[]),i=r.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length;l=r.length>0&&i/r.length<.8}return{...e,semaphore:c,locked:l,percentage:o,nodes:r}});_.set(e,n)}return n.map(e=>({...e,levels:_.get(e.id)??[]}))}var ma=new Map,ha={on(e,t){ma.has(e)||ma.set(e,[]),ma.get(e).push(t)},off(e,t){if(!ma.has(e))return;let n=ma.get(e),r=n.indexOf(t);r>-1&&n.splice(r,1)},emit(e,t){ma.has(e)&&ma.get(e).forEach(n=>{try{n(t)}catch(t){console.error(`[rutaEventEmitter] Error in listener for ${e}:`,t)}})},clearAllListeners(){ma.clear()}};function ga(e,t){let{blockId:n,blockName:r,isExpanded:i,childCount:a,onToggle:o}=t;e.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var _a=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():k(),va=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):S(...e),ya=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):pa(...e),J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},ba=!1;async function xa(e,{onTopicSelected:t}={}){if(J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!_a()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(p(),J.clases=await va(!0),!J.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}J.activeClaseId=J.clases[0].id,await Sa(),Ca(e),Da(e),Oa(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Sa(){J.loading=!0,J.rutaId=await fa(J.activeClaseId),J.rutaId?J.blocks=await ya(J.rutaId,J.activeClaseId):J.blocks=[],J.loading=!1}function Ca(e){e.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{J.selectedIndicator=null,Ca(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{li({...J.selectedIndicator,indicatorId:J.selectedIndicator.id,claseId:J.activeClaseId}),J.onTopicSelected&&J.onTopicSelected(J.activeClaseId)})}function Ea(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Da(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{J.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Sa(),Ca(e),Da(e)})}function Oa(e){ba||(ba=!0,ha.on(`node-covered`,()=>{Sa().then(()=>{Ca(e),Da(e)})}))}var ka=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Aa(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=k();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await D.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
      ...
      `;return}let{data:r}=await D.from(`instrumentos`).select(`id, nombre`).order(`nombre`),{data:i}=await D.from(`maestros`).select(`id, nombre, email`).neq(`id`,t.id).order(`nombre`);e.innerHTML=`
      <div class="pm-crear-clase">
        ...
        <div class="pm-form-section">
          ...
          <div class="pm-form-group">
            ...
            <select id="nueva-clase-instrumento" class="pm-input">
              ...
              ${(r||[]).map(e=>`<option value="${e.id}">${P(e.nombre)}</option>`).join(``)}
            </select>
          </div>
        ...
        <div class="pm-form-section">
          ...
          <div class="pm-form-group">
            ...
            <input type="text" class="pm-input" value="${P(t.nombre_completo||t.nombre||`Tú`)}" disabled>
          ...
          <div class="pm-form-group">
            ...
            <select id="nueva-clase-maestro-aux" class="pm-input">
              ...
              ${(i||[]).map(e=>`<option value="${e.id}">${P(e.nombre||e.email)}</option>`).join(``)}
            </select>
          </div>
        </div>
      ...
      <div class="card-apple pm-animate-slide-up" style="margin-top: 1.5rem; padding: 1.5rem;">
        <div class="mb-4">
          ...
          <select id="route-selector" class="input-apple">
            ...
            ${r.map(e=>`<option value="${e.id}">${P(e.name)} (${e.instrument_id||`General`})</option>`).join(``)}
          </select>
        </div>
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await D.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await N.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `}catch(e){console.error(`Error loading route detail:`,e),o.innerHTML=`<option value="" disabled>Error al cargar niveles</option>`}}),o.addEventListener(`change`,()=>{s.disabled=!1;let e=o.value,t=null;d.forEach(n=>{let r=n.levels.find(t=>t.id===e);r&&(t={...r,blockName:n.name})}),t&&(c.innerHTML=`
          <div style="text-align: left;">
            ...
            <h4 style="margin: 0; font-size: 1rem;">${P(t.blockName)} - ${P(t.name)}</h4>
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await N.createAcademicPlan(t,u),await D.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${P(t.message)}</p></div>`}}async function Ma(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await D.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await N.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await D.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
        <h2 class="apple-display-md">Planificación Semanal</h2>
        <p class="apple-caption">${P(n.route_versions.routes.name)} - v${n.route_versions.version_number}</p>
      </div>
        ...
        `:a.map(e=>`
          <div class="card-apple mb-3 pm-animate-slide-up" style="padding: 1rem;">
            ...
            <div class="mt-2" style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
              ${(e.planned_nodes||[]).map(e=>`<span class="badge-apple" style="background: var(--pm-bg-alt); font-size: 0.7rem;">${P(e.title)}</span>`).join(``)}
            </div>
          </div>
        `).join(``)}
      </div>
        ...
        <div class="pm-modal-content">
          ...
          <div class="mb-3">
            ...
            <div id="nodes-checklist" style="max-height: 200px; overflow-y: auto; background: var(--pm-bg-alt); padding: 0.5rem; border-radius: 8px;">
              ${i.map(e=>`
                <div class="mb-2">
                  <small style="font-weight: 700; color: var(--pm-text-muted); text-transform: uppercase; font-size: 0.65rem;">${P(e.name)}</small>
                  ${e.levels.map(e=>`
                    ${e.nodes.map(e=>`
                      <div class="form-check" style="padding-left: 1.5rem; margin-top: 0.25rem;">
                        <input class="form-check-input node-checkbox" type="checkbox" value="${e.id}" data-title="${P(e.title)}" id="node-${e.id}">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await N.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([N.getRouteDetail(t),n?N.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
          ...
          ${e.levels.map(e=>`
            <div class="pm-level-card card-apple" style="margin-bottom: 1rem; border-left: 4px solid var(--apple-secondary);">
              ...
              <div class="pm-nodes-grid" style="display: flex; flex-direction: column; gap: 0.75rem;">
                ${e.nodes.map(e=>{let t=o.get(e.id)?.status||`pending`,n=N.getStatusToken(t);return`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},Y={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function Fa(e){let t=k();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}Y.maestro=t,Y.submitting=!1;let n=await Ve(t.id);if(Y.permisos=n,Y.checked=!0,!n.puede_registrar_alumnos){Ia(e,n,t.id);return}try{let e=await S();Y.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),Y.clases=[]}La(e),Ba(),Ha()}function Ia(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
          ...
          <div class="pm-settings-form-grid" style="grid-template-columns: 1fr;">
            <div class="pm-settings-field">
              ...
              <select class="input-apple" id="reg-clase">
                ...
                ${Y.clases.map(e=>`<option value="${P(e.id)}">${P(e.nombre||`Clase sin nombre`)}</option>`).join(``)}
              </select>
  ...
  `}function Qa(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Be(e,`clases:enroll`),j.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){j.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function $a(e){return`
    <div class="gcv-root">
  ...
  `,ys();let i=document.getElementById(`pm-theme-toggle-container`);i&&i.appendChild(wo.createToggleButton());let a=document.getElementById(`pm-footer-nav`);a&&a.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let o=document.getElementById(`pm-sidebar`);o&&o.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)});let s=document.getElementById(`pm-header`),c=document.getElementById(`pm-header-search-input`),l=document.getElementById(`pm-search-toggle-btn`),u=document.getElementById(`pm-search-back-btn`),d=()=>{s?.classList.add(`search-active`),setTimeout(()=>{c?.focus()},50)},f=()=>{s?.classList.remove(`search-active`),c&&(c.value=``),document.getElementById(`pm-header-search-dropdown`)?.remove()};l?.addEventListener(`click`,e=>{e.stopPropagation(),d()}),u?.addEventListener(`click`,e=>{e.stopPropagation(),f()});let p=null,m=null,h=()=>{p?.remove(),p=null},g=e=>{if(h(),!e.length)return;let t=document.createElement(`div`);t.id=`pm-header-search-dropdown`,t.setAttribute(`role`,`listbox`),t.innerHTML=e.map(e=>`
    ...
    </div>`)}),window.addEventListener(`unhandledrejection`,e=>{Ye(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`
    <div style="padding:40px; color:#fff; font-family:'Outfit',sans-serif; background:radial-gradient(circle at top right, #1e293b, #0f172a); z-index:9999; position:fixed; top:0; left:0; right:0; bottom:0; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center;">
      <div style="background:rgba(255,255,255,0.05); backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,0.1); border-radius:24px; padding:40px; max-width:600px; width:90%; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
        <div style="width:80px; height:80px; background:rgba(239,68,68,0.1); color:#ef4444; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:40px; margin:0 auto 24px;">
          <i class="bi bi-exclamation-triangle-fill"></i>
