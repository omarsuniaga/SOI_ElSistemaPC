const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-C6WUHrjo.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CsoeaaUJ.js","assets/typeof-C7CwdyHk.js","assets/jspdf.plugin.autotable-BYntMLuC.js","assets/alumnos-GmOXYzgJ.js","assets/clases-C94TYo1J.js","assets/sesiones-Dk3BCHe7.js","assets/cumplimientoMaestrosWidget-DuFFjVW0.js","assets/supabase-DJmkTfk1.js","assets/cumplimientoMaestrosWidget-BlUYKlE2.css","assets/analyticsFillingBehaviorWidget-BCYa3k4D.js","assets/analyticsFillingBehaviorWidget-uKNaEzXM.css"])))=>i.map(i=>d[i]);
...
`),Ce=null,C=``;function we(e=``,t=null){let n=document.createElement(`div`);n.className=`dsl-editor-container`;let r=document.createElement(`div`);r.className=`dsl-editor-wrapper position-relative`;let i=document.createElement(`div`);i.className=`dsl-editor form-control`,i.contentEditable=`true`,i.spellcheck=`false`,i.setAttribute(`data-placeholder`,Se),i.innerHTML=e?ye(e):``;let a=document.createElement(`div`);a.className=`dsl-highlight-layer position-absolute top-0 start-0 w-100 h-100 overflow-hidden pointer-events-none`,a.setAttribute(`aria-hidden`,`true`),r.appendChild(a),r.appendChild(i),n.appendChild(r),Te();function o(){return i.innerText||i.textContent||``}function s(){let e=o();e!==C&&(C=e,a.innerHTML=ye(e)+`<br>`)}function c(){a.scrollTop=i.scrollTop,a.scrollLeft=i.scrollLeft}function l(){clearTimeout(Ce),Ce=setTimeout(()=>{s();let e=ve(o());t&&t(o(),e)},xe)}function u(e){e.key===`Tab`&&(e.preventDefault(),document.execCommand(`insertText`,!1,`  `))}function d(){c()}i.addEventListener(`input`,l),i.addEventListener(`keydown`,u),i.addEventListener(`scroll`,d),i.addEventListener(`focus`,()=>{n.classList.add(`focused`)}),i.addEventListener(`blur`,()=>{n.classList.remove(`focused`),s()});function f(e){i.innerHTML=e?ye(e):``,C=o(),a.innerHTML=ye(C)+`<br>`}function p(){return o()}function m(){return ve(o())}function h(){i.focus()}function ee(e){i.focus(),document.execCommand(`insertText`,!1,e)}function te(e,t=``){i.focus();let n=window.getSelection();if(!n.rangeCount)return;let r=n.getRangeAt(0);r.deleteContents();let a=document.createTextNode(e),s=document.createTextNode(t);r.insertNode(a),r.collapse(!1),r.insertNode(s),r.setStartAfter(a),r.setEndAfter(a),n.removeAllRanges(),n.addRange(r),C=o()}return n.component={element:n,editor:i,setContent:f,getContent:p,getParsed:m,focus:h,insertText:ee,insertAtCursor:te},n.setContent=f,n.getContent=p,n.getParsed=m,n.focus=h,n.insertText=ee,n.insertAtCursor=te,e&&(C=e),n}function Te(){if(document.getElementById(`dsl-editor-styles`))return;let e=document.createElement(`style`);e.id=`dsl-editor-styles`,e.textContent=`
  ...
  </form>`}async function wn(e,t=null){let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),a=e.querySelector(`#modal-telefono`).value.trim(),o=e.querySelector(`#modal-cedula`).value.trim(),s=e.querySelector(`#modal-fechaNacimiento`).value,c=e.querySelector(`#modal-genero`).value,l=e.querySelector(`#modal-instrumento`).value.trim(),u=e.querySelector(`#modal-familiar-nombre`).value.trim(),d=e.querySelector(`#modal-familiar-telefono-input`).value.trim()||a,f=e.querySelector(`#modal-familiar-parentesco-input`).value,p=e.querySelector(`#modal-esActivo`).checked;return n?l?a?{nombre:n,email:r||null,telefono:en(a)||a,cedula:o||null,fecha_nacimiento:s||null,genero:c||null,instrumento:l,is_active:p,familiar_nombre:u||null,familiar_telefono:en(d)||d||null,familiar_parentesco:f||null,contacto_emergencia_nombre:e.querySelector(`#modal-contacto-emergencia-nombre`).value.trim()||null,contacto_emergencia_telefono:en(e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim())||e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim()||null,contacto_emergencia_parentesco:e.querySelector(`#modal-contacto-emergencia-parentesco`).value||null,condiciones_medicas:e.querySelector(`#modal-condiciones-medicas`).value.trim()||null,alergias:e.querySelector(`#modal-alergias`).value.trim()||null,medicamentos:e.querySelector(`#modal-medicamentos`).value.trim()||null}:(i.error(`El teléfono es obligatorio para WhatsApp`),null):(i.error(`El instrumento es obligatorio`),null):(i.error(`El nombre es obligatorio`),null)}function Tn(){M.editando=null,o.open({title:`Crear Nuevo Alumno`,size:`lg`,body:Cn(),saveText:`Guardar`,onSave:async e=>{let t=await wn(e);if(!t)return!1;let n=await ot(t);M.alumnosOriginales.push(n),P(),i.success(`Alumno creado exitosamente`)}})}function En(e){let t=M.alumnosOriginales.find(t=>t.id===e);if(!t){i.error(`Alumno no encontrado`);return}M.deletingId=e,o.open({title:`⚠️ Eliminar Alumno`,size:`md`,saveText:`Eliminar`,body:`<div class="d-flex flex-column align-items-center justify-content-center py-5">
             <div class="spinner-border text-primary mb-3" role="status">
               <span class="visually-hidden">Cargando...</span>
             </div>
...
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`alumnos-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),i.success(`CSV exportado exitosamente`)}var F=class{constructor(e={}){this.id=e.id||null,this.nombre=e.nombre||``,this.descripcion=e.descripcion||``,this.nivel=e.nivel||``,this.duracion_anios=e.duracion_anios||null,this.activo=e.activo===void 0?!0:e.activo,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(e=[]){let t=[];return!this.nombre||!this.nombre.trim()?t.push(`El nombre del programa es obligatorio`):this.nombre.length>100&&t.push(`El nombre no puede exceder los 100 caracteres`),this.nivel?e.length>0&&!e.includes(this.nivel)&&t.push(`El nivel seleccionado no es válido`):t.push(`El nivel es obligatorio`),this.descripcion&&this.descripcion.length>500&&t.push(`La descripción no puede exceder los 500 caracteres`),this.duracion_anios!==null&&(isNaN(this.duracion_anios)||this.duracion_anios<0)&&t.push(`La duración debe ser un número positivo`),t}toJSON(){return{nombre:this.nombre.trim(),descripcion:this.descripcion?this.descripcion.trim():``,nivel:this.nivel,duracion_anios:this.duracion_anios,activo:this.activo}}},kn=[{value:``,label:`Sin nivel específico`},{value:`1`,label:`1° Año`},{value:`2`,label:`2° Año`},{value:`3`,label:`3° Año`},{value:`4`,label:`4° Año`},{value:`5`,label:`5° Año`},{value:`6`,label:`6° Año`},{value:`inicial`,label:`Nivel Inicial`},{value:`intermedio`,label:`Nivel Intermedio`},{value:`avanzado`,label:`Nivel Avanzado`},{value:`preuniversitario`,label:`Pre-Universitario`}];function An(e){let t=kn.find(t=>t.value===e);return t?t.label:e||`-`}async function jn(){let{data:e,error:n}=await t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0});if(n)throw console.error(`Error cargando programas:`,n.message),n;return(e||[]).map(e=>new F(e))}async function Mn(e){let n=new F(e),r=kn.map(e=>e.value).filter(Boolean),i=n.validate(r);if(i.length>0)throw Error(i.join(`. `));let{data:a,error:o}=await t.from(`programas`).insert([n.toJSON()]).select();if(o)throw console.error(`Error creando programa:`,o.message),o;return new F(a[0])}async function Nn(e,n){let r=new F(n),i=kn.map(e=>e.value).filter(Boolean),a=r.validate(i);if(a.length>0)throw Error(a.join(`. `));let{data:o,error:s}=await t.from(`programas`).update(r.toJSON()).eq(`id`,e).select();if(s)throw console.error(`Error actualizando programa:`,s.message),s;return new F(o[0])}async function Pn(e){let{error:n}=await t.from(`programas`).delete().eq(`id`,e);if(n)throw console.error(`Error eliminando programa:`,n.message),n}async function Fn(e){let{jsPDF:t}=await a(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-C6WUHrjo.js`).then(e=>e.n);return{jsPDF:e}},__vite__mapDeps([0,1,2,3])),{default:n}=await a(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-BYntMLuC.js`).then(e=>e.n);return{default:e}},__vite__mapDeps([4,1])),r=new t;r.setFontSize(18),r.text(`Programas Académicos`,14,22),r.setFontSize(10),r.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,30),n(r,{head:[[`Nombre`,`Nivel`,`Descripción`,`Estado`,`Creado`]],body:e.map(e=>[e.nombre,An(e.nivel),e.descripcion?e.descripcion.substring(0,50)+(e.descripcion.length>50?`...`:``):`-`,e.activo?`Activo`:`Inactivo`,e.created_at?new Date(e.created_at).toLocaleDateString(`es-ES`):`-`]),startY:35,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),r.save(`programas.pdf`)}var I={programas:[],programasOriginales:[],cargando:!1},In={nombreMax:100,descripcionMax:500};function L(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function Ln(e){return e?new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`}):`N/A`}function Rn(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].charAt(0).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function zn(e=``){return kn.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}async function Bn(e){try{I.cargando=!0,Vn(e);let t=await jn();I.programas=t,I.programasOriginales=[...t],I.cargando=!1,Un(e),Kn(e)}catch(t){console.error(`[ProgramasView]`,t),Hn(e,t.message)}}function Vn(e){e.innerHTML=`
  ...
  `}var R=null;function Kn(e){R=e,e.querySelector(`#btnAgregarPrograma`)?.addEventListener(`click`,()=>Yn()),e.querySelector(`#btnExportarPDF`)?.addEventListener(`click`,async()=>{try{await Fn(I.programas),i.success(`PDF generado exitosamente`)}catch{i.error(`Error al generar PDF`)}}),e.querySelector(`#buscar`)?.addEventListener(`input`,qn),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,qn),e.querySelector(`#programasTBody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t){let t=e.target.closest(`.list-group-item[data-id]`);t&&Qn(t.dataset.id);return}let{action:n,id:r}=t.dataset;n===`edit`&&Xn(r),n===`delete`&&$n(r)})}function qn(){let e=R.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=R.querySelector(`#filtroEstado`)?.value||`todos`;I.programas=I.programasOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||(n.descripcion||``).toLowerCase().includes(e),i=t===`todos`||t===`activo`&&n.activo||t===`inactivo`&&!n.activo;return r&&i}),Jn()}function Jn(){let e=R.querySelector(`#programasTBody`);e&&(e.innerHTML=Wn(I.programas));let t=R.querySelector(`#emptyContainer`);t&&(t.innerHTML=I.programas.length===0?Gn():``)}function Yn(){Zn({title:`Nuevo Programa`,saveText:`Crear Programa`})}function Xn(e){let t=I.programasOriginales.find(t=>t.id===e);if(!t)return i.error(`Programa no encontrado`);Zn({title:`Editar Programa`,saveText:`Guardar Cambios`,programa:t})}function Zn({title:e,saveText:t,programa:n=null}){o.open({title:e,saveText:t,body:`
    ...
    `,onSave:async e=>{let t={nombre:e.querySelector(`#prog-nombre`).value.trim(),nivel:e.querySelector(`#prog-nivel`).value,duracion_anios:e.querySelector(`#prog-duracion`).value?parseFloat(e.querySelector(`#prog-duracion`).value):null,descripcion:e.querySelector(`#prog-descripcion`).value.trim(),activo:e.querySelector(`#prog-activo`).checked},r=new F(t),a=kn.map(e=>e.value).filter(Boolean),o=r.validate(a);if(o.length>0)return i.error(o[0]),!1;try{if(n){let e=await Nn(n.id,t),r=I.programasOriginales.findIndex(e=>e.id===n.id);I.programasOriginales[r]=e,i.success(`Programa actualizado`)}else{let e=await Mn(t);I.programasOriginales.unshift(e),i.success(`Programa creado`)}return qn(),!0}catch(e){return i.error(e.message),!1}}})}function Qn(e){let t=I.programasOriginales.find(t=>t.id===e);t&&o.open({title:`Perfil del Programa`,hideSave:!0,cancelText:`Cerrar`,body:`
    ...
    `,onShow:n=>{n.querySelector(`#view-edit-btn`).addEventListener(`click`,()=>{o.close(),setTimeout(()=>Xn(e),300)}),n.querySelector(`#view-delete-btn`).addEventListener(`click`,()=>{o.close(),setTimeout(()=>$n(e),300)}),n.querySelector(`#copy-id-btn`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(t.id),i.success(`ID copiado al portapapeles`)})}})}function $n(e){let t=I.programasOriginales.find(t=>t.id===e);t&&o.open({title:`⚠️ Eliminar Programa`,saveText:`Confirmar Eliminación`,body:`
    ...
    `,onSave:async()=>{try{return await Pn(e),I.programasOriginales=I.programasOriginales.filter(t=>t.id!==e),qn(),i.success(`Programa eliminado`),!0}catch{return i.error(`Error al eliminar`),!1}}})}function er(e){return e?{...e,user_id:e.user_id??null,nombre:e.nombre_completo??``,email:e.correo??``,telefono:e.tlf??``,instrumento:e.especialidad??``,bio:e.resena??``,is_active:e.activo??!0,especialidades:Array.isArray(e.especialidades)?e.especialidades:[]}:null}async function tr(){let{data:e,error:n}=await t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0});if(n)throw console.error(`Error cargando maestros:`,n.message),Error(`No se pudieron cargar los maestros`);return e.map(er)}async function nr(e,n){let r={},i=n.nombre||n.nombre_completo;i!==void 0&&(r.nombre_completo=i.trim());let a=n.email||n.correo;a!==void 0&&(r.correo=a.trim().toLowerCase());let o=n.telefono||n.tlf;o!==void 0&&(r.tlf=o.trim());let s=n.instrumento||n.especialidad;s!==void 0&&(r.especialidad=s.trim());let c=n.bio||n.resena;c!==void 0&&(r.resena=c.trim()),n.is_active!==void 0&&(r.activo=n.is_active),n.activo!==void 0&&(r.activo=n.activo),n.especialidades!==void 0&&(r.especialidades=Array.isArray(n.especialidades)?n.especialidades:[]);let{data:l,error:u}=await t.from(`maestros`).update(r).eq(`id`,e).select();if(u)throw console.error(`Error actualizando maestro:`,u.message),Error(`No se pudo actualizar el maestro`);return er(l[0])}async function rr(e){let{error:n}=await t.from(`maestros`).update({activo:!1}).eq(`id`,e);if(n)throw console.error(`Error inactivando maestro:`,n.message),Error(`No se pudo desactivar el maestro`)}async function ir(e){let{error:n}=await t.from(`maestros`).update({activo:!0}).eq(`id`,e);if(n)throw console.error(`Error activando maestro:`,n.message),Error(`No se pudo activar el maestro`)}async function ar(e){let{data:n,error:r}=await t.from(`maestros`).select(`id`).eq(`correo`,e.trim().toLowerCase()).maybeSingle();return r&&r.code!==`PGRST116`&&console.error(`Error validando email:`,r.message),!!n}function z(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}function or(e){return e?`success`:`secondary`}function sr(e){return e?`Activo`:`Inactivo`}function cr(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function B(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}function V(e){if(!e)return``;let t=e.split(`:`);return t.length>=2?`${t[0]}:${t[1]}`:e}function lr(e){return{activa:`Activa`,suspendida:`Suspendida`,finalizada:`Finalizada`}[e]||`Activa`}function ur(e){return e&&{violin:`bi-music-note-beamed`,viola:`bi-music-note-beamed`,cello:`bi-music-note-beamed`,bajo:`bi-music-note-beamed`,guitarra:`bi-music-note-beamed`,arpa:`bi-music-note-beamed`,flauta:`bi-wind`,oboe:`bi-wind`,clarinete:`bi-wind`,fagot:`bi-wind`,trompa:`bi-wind`,trompeta:`bi-wind`,trombon:`bi-wind`,tuba:`bi-wind`,piano:`bi-piano`,percusion:`bi-disc`,voz:`bi-mic`,direccion:`bi-person-badge`,solfeo:`bi-journal-text`,teoría:`bi-book`}[e.toLowerCase()]||`bi-music-note`}function dr(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function fr(e){let t=[`#007aff`,`#5856d6`,`#34c759`,`#ff3b30`,`#ff9500`,`#5ac8fa`];if(!e)return t[0];let n=0;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return t[Math.abs(n)%t.length]}function H(e){if(!e)return 0;let t=e.trim(),n=!1,r=t;t.toLowerCase().includes(`pm`)?(n=!0,r=t.toLowerCase().replace(`pm`,``).trim()):t.toLowerCase().includes(`am`)&&(r=t.toLowerCase().replace(`am`,``).trim());let i=r.split(`:`),a=parseInt(i[0],10)||0,o=parseInt(i[1],10)||0;return n&&a<12?a+=12:!n&&a===12&&(a=0),a*60+o}var pr=class{constructor(e={}){this.id=e.id||null,this.nombre=e.nombre||``,this.maestro_principal_id=e.maestro_principal_id||e.maestro_id||null,this.maestro_suplente_id=e.maestro_suplente_id||e.maestro_auxiliar_id||null,this.tiene_suplente=e.tiene_suplente||!1,this.programa_id=e.programa_id||null,this.instrumento=e.instrumento||``,this.horarios=e.horarios||[],this.capacidad_maxima=e.capacidad_maxima??e.max_alumnos??20,this.estado=e.estado||`activa`,this.descripcion=e.descripcion||e.notas_pedagogicas||``,this.tipo_clase=e.tipo_clase||`grupal`,this.nivel_id=e.nivel_id||null,this.planificacion_id=e.planificacion_id||null,this.ruta_id=e.ruta_id||null,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}get maestro_id(){return this.maestro_principal_id}set maestro_id(e){this.maestro_principal_id=e}get maestro_auxiliar_id(){return this.maestro_suplente_id}set maestro_auxiliar_id(e){this.maestro_suplente_id=e}get max_alumnos(){return this.capacidad_maxima}set max_alumnos(e){this.capacidad_maxima=e}get notas_pedagogicas(){return this.descripcion}set notas_pedagogicas(e){this.descripcion=e}validate(){let e=[];!this.nombre||!this.nombre.trim()?e.push(`El nombre es obligatorio`):this.nombre.trim().length<3?e.push(`El nombre debe tener mínimo 3 caracteres`):this.nombre.trim().length>100&&e.push(`El nombre no puede exceder 100 caracteres`),this.maestro_principal_id||e.push(`El maestro titular es obligatorio`),this.programa_id||e.push(`El programa es obligatorio`),(!this.instrumento||!this.instrumento.trim())&&e.push(`El instrumento es obligatorio`),(!this.horarios||this.horarios.length===0)&&e.push(`Debe agregar al menos un horario`);for(let t of this.horarios)t.dia||e.push(`El día es obligatorio en todos los horarios`),(!t.hora_inicio||!t.hora_fin)&&e.push(`La hora de inicio y fin son obligatorias en todos los horarios`),t.hora_inicio&&t.hora_fin&&H(t.hora_inicio)>=H(t.hora_fin)&&e.push(`La hora de inicio debe ser menor que la hora de fin`);let t={};this.horarios.forEach(e=>{if(!e.dia||!e.hora_inicio||!e.hora_fin)return;let n=e.dia.toLowerCase().trim();t[n]||(t[n]=[]),t[n].push(e)});for(let n in t){let r=t[n].sort((e,t)=>H(e.hora_inicio)-H(t.hora_inicio));for(let t=0;t<r.length-1;t++){let i=r[t],a=r[t+1];if(H(i.hora_fin)>H(a.hora_inicio)){let t=n.charAt(0).toUpperCase()+n.slice(1);e.push(`Existen horarios solapados en la misma clase (${t})`);break}}}return this.capacidad_maxima!==void 0&&this.capacidad_maxima!==null&&(this.capacidad_maxima<1?e.push(`El máximo de alumnos debe ser al menos 1`):this.capacidad_maxima>100&&e.push(`El máximo de alumnos no puede exceder 100`)),this.descripcion&&this.descripcion.length>1e3&&e.push(`Las notas pedagógicas no pueden exceder 1000 caracteres`),e}isCompleto(){return!!(this.nombre&&this.maestro_principal_id&&this.programa_id&&this.instrumento&&this.horarios?.length>0)}toJSON(){return{id:this.id,nombre:this.nombre.trim(),maestro_principal_id:this.maestro_principal_id,maestro_suplente_id:this.maestro_suplente_id||null,programa_id:this.programa_id,instrumento:this.instrumento.trim(),capacidad_maxima:this.capacidad_maxima,estado:this.estado,descripcion:this.descripcion.trim()||null,tipo_clase:this.tipo_clase||`grupal`,ruta_id:this.ruta_id||null}}static getEstados(){return[`activa`,`suspendida`,`finalizada`]}static getDiasSemana(){return[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`]}static getEstadoLabel(e){return{activa:`Activa`,suspendida:`Suspendida`,finalizada:`Finalizada`}[e]||e}};async function mr({salonId:e,maestroId:n,dia:r,horaInicio:i,horaFin:a,excludeClaseId:o=null}){if(!r||!i||!a)return null;let s=H(i),c=H(a);if(e){let{data:n,error:i}=await t.from(`clase_horarios`).select(`*, clases(nombre)`).eq(`salon_id`,e).eq(`dia`,r);if(!i&&n)for(let e of n){if(o&&e.clase_id===o)continue;let t=H(e.hora_inicio);if(s<H(e.hora_fin)&&t<c)return{tipo:`salón`,clase_nombre:e.clases?.nombre||`Otra clase`,detalle:`El salón ya está ocupado por "${e.clases?.nombre}"`,horario:`${e.dia} de ${V(e.hora_inicio)} a ${V(e.hora_fin)}`}}}if(n){let{data:e,error:i}=await t.from(`clase_horarios`).select(`*, clases!inner(nombre, maestro_principal_id)`).eq(`clases.maestro_principal_id`,n).eq(`dia`,r);if(!i&&e)for(let t of e){if(o&&t.clase_id===o)continue;let e=H(t.hora_inicio);if(s<H(t.hora_fin)&&e<c)return{tipo:`maestro`,clase_nombre:t.clases?.nombre||`Otra clase`,detalle:`El maestro ya tiene otra clase asignada ("${t.clases?.nombre}")`,horario:`${t.dia} de ${V(t.hora_inicio)} a ${V(t.hora_fin)}`}}}return null}function U(e){return e?new pr({...e,maestro_principal_id:e.maestro_principal_id??e.maestro_id??null,maestro_suplente_id:e.maestro_suplente_id??null,tiene_suplente:!!e.maestro_suplente_id,capacidad_maxima:e.capacidad_maxima??e.max_alumnos??20,descripcion:e.descripcion??e.notas_pedagogicas??``}):null}async function hr(){let{data:e,error:n}=await t.from(`clases`).select(`*`).order(`nombre`,{ascending:!0});if(n)throw console.error(`Error cargando clases:`,n.message),Error(`No se pudieron cargar las clases`);let{data:r}=await t.from(`clase_horarios`).select(`*`).order(`dia`,{ascending:!0});return(e||[]).map(e=>{let t=U(e);return t.horarios=r?.filter(t=>t.clase_id===e.id)||[],t})}async function gr(e){let{data:n,error:r}=await t.from(`clases`).select(`*`).eq(`id`,e).single();if(r)throw console.error(`Error cargando clase:`,r.message),Error(`Clase no encontrada`);let{data:i}=await t.from(`clase_horarios`).select(`*`).eq(`clase_id`,e),a=U(n);return a.horarios=i||[],a}async function _r(e,n=!1){let r=U(e);r.horarios=e.horarios||[];let i=r.validate();if(i.length>0)throw Error(i.join(`. `));if(!n)for(let e of r.horarios){let t=await mr({salonId:e.salon_id,maestroId:r.maestro_principal_id,dia:e.dia,horaInicio:e.hora_inicio,horaFin:e.hora_fin});if(t){let e=Error(`Conflicto de ${t.tipo}: ${t.detalle} el ${t.horario}`);throw e.isConflict=!0,e.conflictData=t,e}}let a=r.toJSON();delete a.id;let{data:o,error:s}=await t.from(`clases`).insert([a]).select();if(s)throw console.error(`Error creando clase:`,s.message),Error(`No se pudo crear la clase`);let c=o[0];if(r.horarios.length>0){let e=r.horarios.map(e=>({clase_id:c.id,dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id||null,maestro_id:c.maestro_principal_id})),{error:n}=await t.from(`clase_horarios`).insert(e);if(n)throw console.error(`Error creando horarios:`,n.message),await t.from(`clases`).delete().eq(`id`,c.id),Error(`No se pudieron crear los horarios de la clase`);return U({...c,horarios:e})}return U(c)}async function vr(e,n,r=!1){let i=await gr(e),a=new pr({...i,...n});n.horarios===void 0?a.horarios=i.horarios:a.horarios=n.horarios;let o=a.validate();if(o.length>0)throw Error(o.join(`. `));if(!r&&n.horarios)for(let t of a.horarios){let n=await mr({salonId:t.salon_id,maestroId:a.maestro_id,dia:t.dia,horaInicio:t.hora_inicio,horaFin:t.hora_fin,excludeClaseId:e});if(n){let e=Error(`Conflicto de ${n.tipo}: ${n.detalle} el ${n.horario}`);throw e.isConflict=!0,e.conflictData=n,e}}let{data:s,error:c}=await t.from(`clases`).update(a.toJSON()).eq(`id`,e).select();if(c)throw console.error(`Error actualizando clase:`,c.message),Error(`No se pudo actualizar la clase`);if(n.horarios){let{error:r}=await t.from(`clase_horarios`).delete().eq(`clase_id`,e);if(r)throw console.error(`Error eliminando horarios anteriores:`,r.message),Error(`No se pudieron actualizar los horarios de la clase`);if(n.horarios.length>0){let r=n.horarios.map(t=>({clase_id:e,dia:t.dia,hora_inicio:t.hora_inicio,hora_fin:t.hora_fin,salon_id:t.salon_id||null,maestro_id:a.maestro_principal_id})),{error:i}=await t.from(`clase_horarios`).insert(r);if(i)throw console.error(`Error insertando nuevos horarios:`,i.message),Error(`No se pudieron guardar los nuevos horarios de la clase: `+i.message)}}return gr(e)}async function yr(e){let{error:n}=await t.from(`clases`).delete().eq(`id`,e);if(n)throw console.error(`Error eliminando clase:`,n.message),Error(`No se pudo eliminar la clase`)}async function br(e){let{data:n,error:r}=await t.from(`clases`).select(`
      *,
      clase_horarios ( dia, hora_inicio, hora_fin, salon_id ),
      alumnos_clases ( id )
    `).or(`maestro_principal_id.eq.${e},maestro_suplente_id.eq.${e}`).order(`nombre`,{ascending:!0});if(r)throw r;return(n||[]).map(t=>{let n=U(t);return n.horarios=t.clase_horarios||[],n.total_alumnos=(t.alumnos_clases||[]).length,n.es_suplente=t.maestro_principal_id!==e,n})}async function xr(e,n,r=null,i=null){let{data:a,error:o}=await t.from(`alumnos_clases`).insert([{clase_id:e,alumno_id:n,activo:!0,fecha_inscripcion:new Date().toISOString().split(`T`)[0],hora_inicio:r,hora_fin:i}]).select();if(o)throw o.code===`23505`?Error(`El alumno ya está inscrito en esta clase`):o;return a[0]}async function Sr(e,n){let{error:r}=await t.from(`alumnos_clases`).delete().eq(`clase_id`,e).eq(`alumno_id`,n);if(r)throw r}async function Cr(e,n,r,i){let{data:a,error:o}=await t.from(`alumnos_clases`).update({hora_inicio:r,hora_fin:i}).eq(`clase_id`,e).eq(`alumno_id`,n).select();if(o)throw o;return a[0]}async function wr(e){let{data:n,error:r}=await t.from(`alumnos_clases`).select(`*, alumno:alumnos(*)`).eq(`clase_id`,e).eq(`activo`,!0).order(`created_at`,{ascending:!1});if(r)throw r;return n||[]}var Tr=class{constructor(e={}){this.id=e.id,this.instrumento=e.instrumento,this.nivel=e.nivel,this.nombre=e.nombre,this.tipo=e.tipo,this.estado=e.estado,this.descripcion=e.descripcion,this.ruta_base_id=e.ruta_base_id,this.duracion_semanas=e.duracion_semanas||40,this.creada_por=e.creada_por,this.aprobada_por=e.aprobada_por,this.fecha_aprobacion=e.fecha_aprobacion,this.objetivos=e.objetivos||[],this.created_at=e.created_at,this.updated_at=e.updated_at}validate(){let e=[];return this.instrumento?.trim()||e.push(`Instrumento es requerido`),this.nivel?.trim()||e.push(`Nivel es requerido`),this.nombre?.trim()||e.push(`Nombre es requerido`),this.nombre?.length>200&&e.push(`Nombre máximo 200 caracteres`),[`soi-estandar`,`maestro-variante`].includes(this.tipo)||e.push(`Tipo debe ser soi-estandar o maestro-variante`),[`activa`,`pendiente`,`aprobada`,`rechazada`].includes(this.estado)||e.push(`Estado inválido`),this.tipo===`maestro-variante`&&!this.ruta_base_id&&e.push(`Variante debe referenciar ruta base`),(this.duracion_semanas<1||this.duracion_semanas>52)&&e.push(`Duración debe estar entre 1 y 52 semanas`),(!Array.isArray(this.objetivos)||this.objetivos.length===0)&&e.push(`Debe haber al menos 1 objetivo`),this.objetivos.forEach((t,n)=>{t.descripcion?.trim()||e.push(`Objetivo ${n+1}: descripción requerida`),t.semana_inicio<1&&e.push(`Objetivo ${n+1}: semana_inicio >= 1`),t.semana_fin>this.duracion_semanas&&e.push(`Objetivo ${n+1}: semana_fin <= ${this.duracion_semanas}`),t.semana_fin<t.semana_inicio&&e.push(`Objetivo ${n+1}: semana_fin >= semana_inicio`)}),e}isVariante(){return this.tipo===`maestro-variante`}isActiva(){return this.estado===`activa`}isPendiente(){return this.estado===`pendiente`}toJSON(){return{id:this.id,instrumento:this.instrumento,nivel:this.nivel,nombre:this.nombre,tipo:this.tipo,estado:this.estado,descripcion:this.descripcion,ruta_base_id:this.ruta_base_id,duracion_semanas:this.duracion_semanas,creada_por:this.creada_por,aprobada_por:this.aprobada_por,fecha_aprobacion:this.fecha_aprobacion,objetivos:this.objetivos,created_at:this.created_at,updated_at:this.updated_at}}static getEstados(){return[{value:`activa`,label:`Activa`,color:`bg-success`},{value:`pendiente`,label:`Pendiente de aprobación`,color:`bg-warning`},{value:`aprobada`,label:`Aprobada`,color:`bg-info`},{value:`rechazada`,label:`Rechazada`,color:`bg-danger`}]}};async function Er(e){let n=new Tr(e).validate();if(n.length>0)throw Error(`Validación fallida: ${n.join(`, `)}`);let{data:r,error:i}=await t.from(`rutas_contenido`).insert({instrumento:e.instrumento,nivel:e.nivel,nombre:e.nombre,tipo:e.tipo,estado:e.estado,descripcion:e.descripcion,ruta_base_id:e.ruta_base_id,duracion_semanas:e.duracion_semanas,creada_por:e.creada_por}).select().single();if(i)throw i;let a=e.objetivos.map((e,t)=>({ruta_id:r.id,descripcion:e.descripcion,semana_inicio:e.semana_inicio,semana_fin:e.semana_fin,orden:e.orden||t+1,objetivo_id:e.objetivo_id||null})),{data:o,error:s}=await t.from(`ruta_contenido_objetivos`).insert(a).select();if(s)throw s;return{...r,objetivos:o}}async function Dr(e){let{data:n,error:r}=await t.from(`rutas_contenido`).select(`*`).eq(`id`,e).single();if(r)throw r;let{data:i,error:a}=await t.from(`ruta_contenido_objetivos`).select(`*`).eq(`ruta_id`,e).order(`orden`,{ascending:!0});if(a)throw a;return{...n,objetivos:i}}async function Or(e={}){let n=t.from(`rutas_contenido`).select(`*`);e.instrumento&&(n=n.eq(`instrumento`,e.instrumento)),e.nivel&&(n=n.eq(`nivel`,e.nivel)),e.estado&&(n=n.eq(`estado`,e.estado)),e.tipo&&(n=n.eq(`tipo`,e.tipo));let{data:r,error:i}=await n.order(`created_at`,{ascending:!1});if(i)throw i;return r||[]}async function kr(){let{data:e,error:n}=await t.from(`rutas_contenido`).select(`*, rutas_contenido!ruta_base_id(nombre)`).eq(`tipo`,`maestro-variante`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(n)throw n;return e||[]}async function Ar(e,n,r=null){let{data:i}=await t.auth.getUser(),{data:a,error:o}=await t.from(`rutas_contenido`).update({estado:n?`aprobada`:`rechazada`,aprobada_por:i?.user?.id,fecha_aprobacion:new Date().toISOString(),descripcion:n?void 0:r,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(o)throw o;return a}async function jr(e,n,r,i){let a=await Dr(e),{data:o}=await t.auth.getUser();return await Er({instrumento:a.instrumento,nivel:a.nivel,nombre:n,tipo:`maestro-variante`,estado:`pendiente`,descripcion:r,ruta_base_id:e,duracion_semanas:a.duracion_semanas,creada_por:o?.user?.id,objetivos:i})}var Mr=`
...
.ruta-info { font-size: 0.85rem; color: #666; margin-top: 4px; }
</style>`;function Nr(e,t,n){let r=document.getElementById(`ruta-selector-modal`);r&&r.remove();let a=document.createElement(`div`);a.id=`ruta-selector-modal`,a.innerHTML=`${Mr}
    <div class="modal fade" id="ruta-selector-dialog" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
    ...
    </div>`,document.body.appendChild(a);let o=document.getElementById(`ruta-selector-dialog`),s=new bootstrap.Modal(o);async function c(){let r=document.getElementById(`ruta-selector-body`);try{let i=await Or({instrumento:e,nivel:t,estado:`activa`});if(i.length===0){r.innerHTML=`<p class="text-muted text-center">No hay rutas disponibles para este instrumento/nivel.</p>`;return}let a=null,c=i.find(e=>e.tipo===`soi-estandar`);c&&(a=c.id),r.innerHTML=`
        ...
        `).join(``)}</div>
      `,document.querySelectorAll(`.ruta-option`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.ruta-option`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),a=e.dataset.rutaId})});let l=o.querySelector(`.btn-close`);l.onclick=()=>{s.hide(),a&&n(a)}}catch(e){r.innerHTML=`<div class="alert alert-danger">${e.message}</div>`,i.error(`Error cargando rutas`)}}o.addEventListener(`shown.bs.modal`,c),s.show()}var W={maestros:[],salones:[],programas:[],alumnos:[],onSuccess:null},Pr={nombreMax:100,notasMax:500};async function Fr(e=null,t={}){W={...W,...t};let n=!!e,r=[],a=[];if(n){i.info(`Cargando datos de la clase...`);let t=await wr(e.id);r=(t||[]).map(e=>e.alumno_id),a=t||[]}let s=n?`Editar Clase: ${e.nombre}`:`Nueva Clase`,c=n?`Guardar Cambios`:`Crear Clase`;o.open({title:s,saveText:c,size:`lg`,body:Ir(e,r,a),onShow:t=>{Rr(t,e)},onSave:async t=>await zr(t,e)})}function Ir(e,t,n=[]){return`
    <form class="row g-3" id="formClase">
      <div class="col-md-6">
        <label class="form-label-compact">Nombre de la Clase *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required placeholder="Ej: Violín Básico A" value="${B(e?.nombre||``)}" maxlength="${Pr.nombreMax}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Instrumento *</label>
        <input type="text" class="form-control input-dense" id="modal-instrumento" list="instrumentos-list" required placeholder="Seleccionar..." value="${B(e?.instrumento||``)}">
        ${Wr()}
      </div>
      <div class="col-md-6">
      ...
      <div class="col-12">
        ...
        <textarea class="form-control input-dense" id="modal-notas_pedagogicas" rows="2" placeholder="Observaciones sobre el grupo o metodología..." maxlength="${Pr.notasMax}">${B(e?.descripcion||``)}</textarea>
      </div>
  ...
  `}function Lr(e=[]){let t=W.alumnos||[],n=(e=``,n=``,r=``)=>(t.find(t=>t.id===e),`
        ...
        <select class="form-select form-select-sm slot-alumno-select flex-grow-1" style="min-width:0;" required>
          ...
          ${t.map(t=>`
            <option value="${t.id}" ${t.id===e?`selected`:``}>
              ${B(t.nombre_completo)}${t.instrumento_principal?` — ${B(t.instrumento_principal)}`:``}
            </option>`).join(``)}
        </select>
    ...
    <div class="text-end mt-1">
      ...
      <button type="button" class="btn btn-sm btn-link text-danger p-0 btn-remove-slot" title="Quitar turno">
        <i class="bi bi-x-circle-fill fs-5"></i>
      </button>`,c.appendChild(n),u()}),c?.addEventListener(`click`,e=>{if(e.target.closest(`.btn-remove-slot`)){if(c.querySelectorAll(`.slot-row`).length<=1){i.warning(`Debe haber al menos un turno en una clase rotativa`);return}e.target.closest(`.slot-row`).remove(),u()}});let d=e.querySelector(`#search-modal-alumnos`),f=e.querySelectorAll(`.alumno-check-item`);d?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();f.forEach(e=>{let n=e.dataset.nombre.includes(t)||e.dataset.instrumento.includes(t);e.style.display=n?`block`:`none`})});let p=e.querySelectorAll(`.alumnos-list input[type="checkbox"]`),m=e.querySelector(`#alumnos-selection-count`),h=()=>{let e=Array.from(p).filter(e=>e.checked).length;m&&(m.textContent=`${e} alumnos seleccionados`)};p.forEach(e=>e.addEventListener(`change`,h)),h()}async function zr(e,t){let n=!!t,r=(()=>{let t=e.querySelector(`#modal-maestro_suplente_id`).value,n=e.querySelector(`#modal-tiene_suplente`).checked;return{nombre:e.querySelector(`#modal-nombre`).value.trim(),programa_id:e.querySelector(`#modal-programa_id`).value,maestro_principal_id:e.querySelector(`#modal-maestro_id`).value,maestro_suplente_id:n?t:null,tiene_suplente:n,instrumento:e.querySelector(`#modal-instrumento`).value.trim(),capacidad_maxima:parseInt(e.querySelector(`#modal-max_alumnos`).value)||20,estado:e.querySelector(`#modal-estado`).value,tipo_clase:e.querySelector(`input[name="modal-tipo_clase"]:checked`)?.value||`grupal`,descripcion:e.querySelector(`#modal-notas_pedagogicas`).value.trim(),ruta_id:e.querySelector(`#modal-ruta_id`)?.value||null,horarios:Array.from(e.querySelectorAll(`.horario-row`)).map(e=>({dia:e.querySelector(`[name="horario-dia"]`).value,hora_inicio:e.querySelector(`[name="horario-hora_inicio"]`).value,hora_fin:e.querySelector(`[name="horario-hora_fin"]`).value,salon_id:e.querySelector(`[name="horario-salon_id"]`).value||null}))}})(),a=new pr(r).validate();if(a.length>0)return i.error(a[0]),!1;let o=()=>Array.from(e.querySelectorAll(`#slots-container .slot-row`)).map(e=>({alumno_id:e.querySelector(`.slot-alumno-select`).value,hora_inicio:e.querySelector(`.slot-hora-inicio`).value,hora_fin:e.querySelector(`.slot-hora-fin`).value})).filter(e=>e.alumno_id),s=async t=>{let n=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value),r=(await wr(t)).map(e=>e.alumno_id),i=n.filter(e=>!r.includes(e)),a=r.filter(e=>!n.includes(e));await Promise.all([...i.map(e=>xr(t,e)),...a.map(e=>Sr(t,e))])},c=async e=>{let t=o();if(t.length===0)return i.warning(`Agregá al menos un turno`),!1;if(t.find(e=>!e.hora_inicio||!e.hora_fin))return i.error(`Todos los turnos deben tener hora de inicio y fin`),!1;let n=(await wr(e)).map(e=>e.alumno_id),r=t.map(e=>e.alumno_id),a=n.filter(e=>!r.includes(e));return await Promise.all(a.map(t=>Sr(e,t))),await Promise.all(t.map(t=>n.includes(t.alumno_id)?Cr(e,t.alumno_id,t.hora_inicio,t.hora_fin):xr(e,t.alumno_id,t.hora_inicio,t.hora_fin))),!0};try{let a;if(n)if(a=await vr(t.id,r),r.tipo_clase===`rotativa`){if(!await c(a.id))return!1}else await s(a.id);else if(a=await _r(r),r.tipo_clase===`rotativa`){if(!await c(a.id))return!1}else{let t=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value);t.length>0&&await Promise.all(t.map(e=>xr(a.id,e)))}return i.success(n?`Clase actualizada`:`Clase creada`),W.onSuccess&&W.onSuccess(),!0}catch(e){return e.isConflict?i.warning(`Conflicto detected: ${e.message}`):i.error(e.message),!1}}function Br(e=``){return`<option value="">Seleccionar maestro...</option>`+W.maestros.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${B(t.nombre_completo||t.nombre)}</option>`).join(``)}function Vr(e=``){return`<option value="">Sin salón (Online/Otro)</option>`+W.salones.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${B(t.nombre)}</option>`).join(``)}function Hr(e=``){return`<option value="">Seleccionar programa...</option>`+W.programas.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${B(t.nombre)}</option>`).join(``)}function Ur(e=`activa`){return pr.getEstados().map(t=>`<option value="${t}" ${t===e?`selected`:``}>${pr.getEstadoLabel(t)}</option>`).join(``)}function Wr(){return`<datalist id="instrumentos-list">${[`Violín`,`Viola`,`Cello`,`Piano`,`Flauta`,`Teoría`,`Coro`].map(e=>`<option value="${e}">`).join(``)}</datalist>`}function Gr(e,t){return`
  ...
  `}function Kr(e=[]){return e.length===0?Gr(null,0):e.map((e,t)=>Gr(e,t)).join(``)}function qr(e=[]){return`
        ...
        ${(W.alumnos||[]).map(t=>`
          <div class="form-check alumno-check-item" data-nombre="${t.nombre_completo.toLowerCase()}" data-instrumento="${(t.instrumento_principal||``).toLowerCase()}">
            ...
            <label class="form-check-label small w-100 cursor-pointer" for="chk-a-${t.id}">
              ${B(t.nombre_completo)} <span class="text-muted">(${B(t.instrumento_principal||`N/A`)})</span>
            </label>
          </div>
        `).join(``)}
      </div>
  ...
  `}var Jr=`app-help-panel`,Yr=`app-help-overlay`,Xr=!1;function Zr(){if(Xr)return;Xr=!0;let e=document.createElement(`style`);e.id=`app-help-panel-styles`,e.textContent=`
    /* ── Overlay ─────────────────────────────────────────── */
    #app-help-overlay {
      display: none;
      position: fixed;
  ...
  `,document.head.appendChild(e)}function Qr(){if(document.getElementById(Jr))return;Zr();let e=document.createElement(`div`);e.id=Yr,document.body.appendChild(e);let t=document.createElement(`div`);t.id=Jr,t.setAttribute(`role`,`complementary`),t.setAttribute(`aria-label`,`Ayuda`),t.innerHTML=`
    <div id="ahp-header">
    ...
    <div id="ahp-body"></div>
  `,document.body.appendChild(t),e.addEventListener(`click`,()=>G.close()),t.querySelector(`#ahp-close`).addEventListener(`click`,()=>G.close()),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&G.close()})}var G={open({title:e,intro:t,sections:n=[]}){Qr();let r=document.getElementById(Jr),i=document.getElementById(Yr);document.getElementById(`ahp-title`).textContent=e||`Ayuda`,document.getElementById(`ahp-body`).innerHTML=`
    ...
    `,i.style.display=`block`,requestAnimationFrame(()=>{i.classList.add(`hp-visible`),r.classList.add(`hp-visible`)})},close(){let e=document.getElementById(Jr),t=document.getElementById(Yr);!e||!e.classList.contains(`hp-visible`)||(e.classList.remove(`hp-visible`),t.classList.remove(`hp-visible`),setTimeout(()=>{t&&(t.style.display=`none`)},280))}},K={maestros:[],maestrosOriginales:[],editando:null,deletingId:null},$r={nombreMax:100},q=null,ei=[`Piano`,`Guitarra`,`Violín`,`Viola`,`Cello`,`Contrabajo`,`Flauta`,`Clarinete`,`Oboe`,`Fagot`,`Saxofón`,`Trompeta`,`Trombón`,`Corno`,`Tuba`,`Percusión`,`Batería`,`Canto`,`Teoría`,`Solfeo`,`Dirección`,`Composición`,`Arreglos`];async function ti(e){try{ni(e);let t=await tr();K.maestros=t,K.maestrosOriginales=[...t],si(e),li(e)}catch(t){console.error(t),ri(e,t.message)}}function ni(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status">
          <span class="visually-hidden">Cargando...</span>
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>ti(e))}function ii(e=[],t=`modal-especialidades-input`){return`
    <div class="mb-3">
      ...
      <div class="especialidades-chips-container" id="modal-especialidades-container">
        <div class="chips-wrapper d-flex flex-wrap gap-1 mb-2">
          ${e.map(e=>`
            <span class="badge bg-primary-subtle text-primary rounded-pill chip-item">
              ${z(e)}
              <i class="bi bi-x-lg chip-remove" data-especialidad="${z(e)}" style="cursor:pointer;margin-left:4px;"></i>
            </span>
          `).join(``)}
        </div>
        <div class="d-flex gap-2">
        ...
        <div class="mt-2">
          ...
          <div class="d-flex flex-wrap gap-1 mt-1">
            ${ei.slice(0,8).map(e=>`
              <button type="button" class="btn btn-link btn-sm p-0 suggest-chip" data-especialidad="${z(e)}">${z(e)}</button>
            `).join(`, `)}
          </div>
        </div>
      </div>
    </div>
  `}function ai(e){let t=e.querySelector(`.especialidades-chips-container`);if(!t)return[];let n=t.querySelectorAll(`.chip-item`);return Array.from(n).map(e=>e.textContent.replace(/×$/,``).trim())}function oi(e,t){let n=e.querySelector(`#modal-especialidades-input`),r=e.querySelector(`#btnAddEspecialidad`),i=e.querySelector(`.especialidades-chips-container`),a=r=>{let a=r.trim();if(a){if(!ai(e).includes(a)){let e=i.querySelector(`.chips-wrapper`),n=document.createElement(`span`);n.className=`badge bg-primary-subtle text-primary rounded-pill chip-item`,n.innerHTML=`${z(a)}<i class="bi bi-x-lg chip-remove" data-especialidad="${z(a)}" style="cursor:pointer;margin-left:4px;"></i>`,e.appendChild(n),t&&t()}n.value=``}};n?.addEventListener(`keypress`,e=>{e.key===`Enter`&&(e.preventDefault(),a(n.value))}),r?.addEventListener(`click`,()=>a(n.value)),i?.addEventListener(`click`,e=>{e.target.classList.contains(`chip-remove`)&&(e.target.closest(`.chip-item`).remove(),t&&t()),e.target.classList.contains(`suggest-chip`)&&(e.preventDefault(),a(e.target.dataset.especialidad))})}function si(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function ci(e){return e.length?e.map(e=>{let t=e.nombre||e.name||`-`,n=e.is_active??!0,r=`border-accent-${n?`success`:`secondary`}`,i=`bg-${n?`success`:`secondary`}`;return`
      <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${r}" data-id="${e.id}" style="cursor: pointer;">
        <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
          <div class="position-relative flex-shrink-0">
            <div class="avatar-compact bg-primary bg-opacity-10 text-primary border border-primary-subtle d-flex align-items-center justify-content-center rounded-circle" style="width: 48px; height: 48px; font-size: 1.2rem; font-weight: 600;">
          ...
          <div class="d-flex flex-column flex-grow-1 overflow-hidden pe-3">
            ...
            <small class="text-muted text-truncate">
              ${z(e.instrumento||`Sin instrumento especificado`)}
            </small>
          </div>
        </div>
        <div class="d-flex align-items-center gap-2 flex-shrink-0">
          ${e.telefono?`
            <button class="btn btn-sm btn-success bg-gradient text-white rounded-pill px-3 shadow-sm d-flex align-items-center gap-2" data-action="whatsapp" data-id="${e.id}" title="Enviar WhatsApp" style="min-height: 32px;" ${n?``:`disabled`}>
              <i class="bi bi-whatsapp"></i> <span class="d-none d-sm-inline fw-medium">${z(e.telefono)}</span>
            </button>
    ...
    `}).join(``):`
      ...
      </div>`}function li(e){q=e,e.querySelector(`#btnAgregarMaestro`).addEventListener(`click`,()=>fi()),e.querySelector(`#btn-help-maestros`)?.addEventListener(`click`,()=>{G.open({title:`Maestros`,intro:`Gestión del plantel docente. Desde acá podés ver, agregar, editar y desactivar maestros, y acceder al perfil completo de cada uno.`,sections:[{icon:`bi-search`,title:`Buscador y filtros`,description:`Filtrá por nombre, instrumento o estado (activo/inactivo) en tiempo real.`,color:`#6b7280`},{icon:`bi-person-badge`,title:`Tarjeta de maestro`,description:`Nombre, instrumento principal, clases activas y estado. Badge verde = activo, gris = inactivo.`,color:`#3b82f6`},{icon:`bi-eye`,title:`Ver perfil`,description:`Perfil completo: datos personales, clases (titular y suplente), horarios y ocupación.`,color:`#10b981`},{icon:`bi-pencil`,title:`Editar desde el perfil`,description:`Desde el perfil podés editar cualquier clase que dicte directamente, sin salir del modal.`,color:`#f59e0b`},{icon:`bi-person-x`,title:`Desactivar maestro`,description:`Desactivar oculta al maestro de listas operativas pero conserva su historial. No elimina datos.`,color:`#ef4444`}]})}),e.querySelector(`#btnExportarCSV`)?.addEventListener(`click`,()=>vi()),e.querySelector(`#buscar`).addEventListener(`input`,()=>di()),e.querySelector(`#filtroEstado`).addEventListener(`change`,()=>di()),e.querySelector(`#maestrosTBody`).addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t&&!e.target.closest(`[data-action]`)){mi(t.dataset.id);return}let n=e.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.id,i=n.dataset.action;i===`edit`?pi(r):i===`delete`?hi(r):i===`whatsapp`&&ui(r)})}function ui(e){let t=K.maestrosOriginales.find(t=>t.id===e);if(!t||!t.telefono)return;let n=t.telefono.replace(/\D/g,``);o.open({title:`Enviar WhatsApp a `+z(t.nombre||t.name||``),size:`md`,saveText:`Enviar WhatsApp`,body:`
      <div class="mb-3">
        <label class="form-label-compact">Número de destino</label>
        <p class="form-control-plaintext fw-bold mb-0">
    ...
    `,onSave:async e=>{let t=e.querySelector(`#modal-whatsapp-msg`).value.trim(),r=`https://wa.me/${n}?text=${encodeURIComponent(t)}`;window.open(r,`_blank`)}})}function di(){let e=q.querySelector(`#buscar`).value.trim().toLowerCase(),t=q.querySelector(`#filtroEstado`).value;K.maestros=K.maestrosOriginales.filter(n=>{let r=(n.nombre||n.name||``).toLowerCase(),i=!e||r.includes(e)||(n.email||``).toLowerCase().includes(e)||(n.instrumento||``).toLowerCase().includes(e)||(n.especialidad||``).toLowerCase().includes(e)||(n.especialidades||[]).some(t=>t.toLowerCase().includes(e)),a=n.is_active??!0;return i&&(t===`todos`||t===`activo`&&a||t===`inactivo`&&!a)}),gi()}function fi(){K.editando=null,o.open({title:`Crear Nuevo Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${$r.nombreMax}" placeholder="Juan Pérez">
        <small class="text-muted" id="modal-nombreCount">0/${$r.nombreMax}</small>
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Email *</label>
    ...
    </form>`,onShow:e=>oi(e),saveText:`Guardar`,onSave:async e=>{let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-password`)?.value,a=e.querySelector(`#modal-telefono`).value.trim(),o=e.querySelector(`#modal-instrumento`).value.trim(),s=e.querySelector(`#modal-bio`).value.trim();if(!n)return J(`El nombre es obligatorio`,`error`),!1;if(!r)return J(`El email es obligatorio`,`error`),!1;if(!_i(r))return J(`El formato del email no es válido`,`error`),!1;if(!i||i.length<6)return J(`La contraseña debe tener al menos 6 caracteres`,`error`),!1;if(!o)return J(`El instrumento es obligatorio`,`error`),!1;if(r&&await ar(r))return J(`El email ya está registrado`,`error`),!1;let c=ai(e);try{let{data:e,error:l}=await t.auth.signUp({email:r,password:i,options:{data:{full_name:n,rol:`maestro`}}});if(l)return J(l.message||`Error al crear usuario`,`error`),!1;if(!e?.user)return J(`No se pudo crear el usuario`,`error`),!1;let u=e.user.id;await t.from(`profiles`).update({estado:`activo`}).eq(`id`,u),await t.from(`maestros`).update({tlf:a||null,especialidad:o||null,resena:s||null,especialidades:c}).eq(`user_id`,u);let d=await tr();K.maestros=d,K.maestrosOriginales=[...d],di(),J(`Maestro creado exitosamente. Ya puede iniciar sesión.`,`success`)}catch(e){console.error(`Error creando maestro:`,e),J(`Error al crear el maestro: `+e.message,`error`)}}})}function pi(e){let t=K.maestrosOriginales.find(t=>t.id===e);if(!t){J(`Maestro no encontrado`,`error`);return}K.editando=e,o.open({title:`Editar Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${$r.nombreMax}" value="${z(t.nombre||t.name||``)}">
        <small class="text-muted" id="modal-nombreCount">${(t.nombre||t.name||``).length}/${$r.nombreMax}</small>
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Email *</label>
        <input type="email" class="form-control input-dense" id="modal-email" required value="${z(t.email||``)}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Teléfono</label>
        <input type="text" class="form-control input-dense" id="modal-telefono" value="${z(t.telefono||``)}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Instrumento *</label>
        <input type="text" class="form-control input-dense" id="modal-instrumento" required value="${z(t.instrumento||``)}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Especialidad</label>
        <input type="text" class="form-control input-dense" id="modal-especialidad" value="${z(t.especialidad||``)}">
      </div>
      ${ii(t.especialidades||[],`modal-especialidades-input`)}
      <div class="col-12">
        <label class="form-label-compact">Biografía</label>
        <textarea class="form-control input-dense" id="modal-bio" rows="2">${z(t.bio||``)}</textarea>
      </div>
      <div class="col-12">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="modal-esActivo" ${t.is_active===!1?``:`checked`}>
    ...
    </form>`,onShow:e=>oi(e),saveText:`Guardar cambios`,onSave:async e=>{let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-telefono`).value.trim(),a=e.querySelector(`#modal-instrumento`).value.trim(),o=e.querySelector(`#modal-especialidad`).value.trim(),s=e.querySelector(`#modal-bio`).value.trim(),c=e.querySelector(`#modal-esActivo`).checked;if(!n)return J(`El nombre es obligatorio`,`error`),!1;if(!r)return J(`El email es obligatorio`,`error`),!1;if(!_i(r))return J(`El formato del email no es válido`,`error`),!1;if(r&&t.email!==r&&await ar(r))return J(`El email ya está registrado`,`error`),!1;let l=ai(e),u={nombre:n,email:r||null,telefono:i||null,instrumento:a||null,especialidad:o||null,bio:s||null,is_active:c,especialidades:l};await nr(K.editando,u);let d=K.maestrosOriginales.findIndex(e=>e.id===K.editando);d!==-1&&(K.maestrosOriginales[d]={...K.maestrosOriginales[d],...u}),di(),J(`Maestro actualizado correctamente`,`success`)}})}function mi(e){let n=K.maestrosOriginales.find(t=>t.id===e);if(!n){J(`Maestro no encontrado`,`error`);return}let r=n.nombre||n.name||`-`,i=n.is_active??!0;o.open({title:r,hideSave:!0,cancelText:`Cerrar`,body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            <label class="form-label fw-bold">Nombre</label>
            <p class="form-control-plaintext">${z(r)}</p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Email</label>
            <p class="form-control-plaintext">${n.email?`<a href="mailto:${z(n.email)}">${z(n.email)}</a>`:`-`}</p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Teléfono</label>
            <p class="form-control-plaintext">${z(n.telefono||`-`)}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
            <label class="form-label fw-bold">Instrumento</label>
            <p class="form-control-plaintext">${z(n.instrumento||`-`)}</p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Especialidad</label>
            <p class="form-control-plaintext">${z(n.especialidad||`-`)}</p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Especialidades</label>
            <p class="form-control-plaintext">
              ${(n.especialidades||[]).length?n.especialidades.map(e=>`<span class="badge bg-primary-subtle text-primary me-1">${z(e)}</span>`).join(``):`Sin especialidades`}
            </p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Estado</label>
            <p class="form-control-plaintext">
              <span class="badge ${or(i)}">${sr(i)}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mb-4">
        ...
        <p class="form-control-plaintext">${z(n.bio||`Sin biografía`)}</p>
      </div>
      <hr>
      <div class="mb-2">
    ...
    `,onShow:async n=>{n.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>pi(e),300)}),n.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>hi(e),300)});let r=n.querySelector(`#maestro-clases-container`),i=n.querySelector(`#maestro-clases-badge`);(async()=>{try{let[n,a,s,c,l]=await Promise.all([br(e),t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),t.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]),u={maestros:a.data||[],salones:s.data||[],programas:c.data||[],alumnos:l.data||[]};if(i.textContent=`${n.length} clase${n.length===1?``:`s`}`,n.length===0){r.innerHTML=`
                    ...
                    <div class="d-flex align-items-stretch">
                      ...
                      <div class="flex-grow-1 px-3 py-2 overflow-hidden">
                        <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                          <span class="fw-semibold text-truncate" style="font-size:0.87rem;" title="${z(e.nombre)}">${z(e.nombre)}</span>
                        ...
                        <div class="d-flex align-items-center gap-2 flex-wrap mb-1" style="font-size:0.75rem;color:var(--bs-secondary-color);">
                          ${e.instrumento?`<span>${z(e.instrumento)}</span><span style="opacity:0.3;">·</span>`:``}
            ...
            </div>`,r.querySelectorAll(`.btn-editar-clase`).forEach(t=>{t.addEventListener(`click`,t=>{let r=t.currentTarget.dataset.claseId,i=n.find(e=>e.id===r);i&&(o.close(),setTimeout(()=>{Fr(i,{...u,onSuccess:()=>{setTimeout(()=>mi(e),300)}})},300))})}),r.querySelectorAll(`.btn-desvincular-clase`).forEach(t=>{t.addEventListener(`click`,async t=>{let n=t.currentTarget.dataset.claseId,r=t.currentTarget.dataset.claseNombre,i=t.currentTarget.dataset.esSuplente===`true`?`maestro_suplente_id`:`maestro_principal_id`;if(confirm(`¿Quitar a este maestro de "${r}"?`))try{t.currentTarget.disabled=!0,t.currentTarget.innerHTML=`<span class="spinner-border spinner-border-sm"></span>`,await vr(n,{[i]:null},!0),J(`Maestro desvinculado correctamente`,`success`),o.close(),setTimeout(()=>mi(e),300)}catch(e){J(`Error al desvincular: `+e.message,`error`),t.currentTarget.disabled=!1,t.currentTarget.innerHTML=`<i class="bi bi-person-dash" style="font-size:1rem;"></i><span>Quitar</span>`}})})}catch{i.textContent=`Error`,r.innerHTML=`
            <div class="alert alert-danger py-2 mb-0 small">
              <i class="bi bi-exclamation-triangle me-1"></i> Error al cargar las clases.
            </div>`}})()}})}function hi(e){let t=K.maestrosOriginales.find(t=>t.id===e);if(!t){J(`Maestro no encontrado`,`error`);return}K.deletingId=e;let n=t.nombre||t.name||``,r=t.is_active!==!1;o.open({title:r?`⏸️ Desactivar Maestro`:`▶️ Reactivar Maestro`,size:`sm`,saveText:r?`Desactivar`:`Reactivar`,body:r?`<p>¿Desactivar al maestro <strong>${z(n)}</strong>?</p>
         <p class="text-muted small mb-0">El maestro no aparecerá en las listas, pero sus datos se conservarán.</p>`:`<p>¿Reactivar al maestro <strong>${z(n)}</strong>?</p>
         <p class="text-muted small mb-0">El maestro volverá a aparecer en las listas.</p>`,onSave:async()=>{r?(await rr(e),J(`Maestro desactivado correctamente`,`success`)):(await ir(e),J(`Maestro reactivado correctamente`,`success`)),di()}})}function gi(){let e=q.querySelector(`#maestrosTBody`);if(!e)return;e.innerHTML=ci(K.maestros);let t=q.querySelector(`.maestros-header-premium p.text-muted`);t&&(t.textContent=`${K.maestros.length} maestros en total`)}function _i(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function vi(){if(K.maestrosOriginales.length===0){J(`No hay maestros para exportar`,`error`);return}let e=[[`Nombre`,`Email`,`Teléfono`,`Instrumento`,`Especialidad`,`Estado`],...K.maestrosOriginales.map(e=>[e.nombre||``,e.email||``,e.telefono||``,e.instrumento||``,e.especialidad||``,e.is_active===!1?`Inactivo`:`Activo`])].map(e=>e.map(e=>`"${String(e).replace(/"/g,`""`)}"`).join(`,`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`maestros-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),J(`CSV exportado exitosamente`,`success`)}function J(e,t=`info`){let n=q.querySelector(`#toastContainer`);if(!n)return;let i=t===`success`?`bg-success`:t===`error`?`bg-danger`:`bg-info`,a=t===`success`?`bi-check-circle`:t===`error`?`bi-exclamation-circle`:`bi-info-circle`,o=t===`success`?`Éxito`:t===`error`?`Error`:`Información`,s=document.createElement(`div`);s.className=`toast`,s.setAttribute(`role`,`alert`),s.setAttribute(`aria-live`,`assertive`),s.setAttribute(`aria-atomic`,`true`),s.innerHTML=`
    ...
    <div class="card border-0 shadow-sm h-100 pm-metric-card">
      <div class="card-body p-3">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <div class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">${B(e)}</div>
            <div class="h3 mb-0 fw-extrabold ${a}">${t}</div>
          </div>
        </div>
      </div>
    </div>
  `}function ka(e){let t=null,n=`ALL`,r=null,a=null;async function o(){t&&(t.innerHTML=`
      <div class="row g-3">
    ...
    `,s(),await c(),l())}function s(){let e=t.querySelector(`#live-net-status`);e&&(e.innerHTML=navigator.onLine?`<span class="badge bg-success rounded-pill px-2.5 py-1 d-inline-flex align-items-center gap-1 shadow-sm small"><span class="spinner-grow spinner-grow-sm text-white obs-net-spinner obs-spinner-slow"></span> ONLINE</span>`:`<span class="badge bg-warning text-dark rounded-pill px-2.5 py-1 d-inline-flex align-items-center gap-1 shadow-sm small obs-pulse-offline"><span class="spinner-grow spinner-grow-sm text-dark obs-net-spinner"></span> OFFLINE</span>`)}async function c(){let e=t.querySelector(`#logs-body`);if(!e)return;let r=await wa(),i=n===`ALL`?r:r.filter(e=>e.level===n);if(i.length===0){e.innerHTML=`<div class="text-center text-muted py-5">[Consola vacía. No hay logs registrados con severidad "${n}"]</div>`;return}e.innerHTML=i.map(e=>{let t=`obs-log-level-info`;e.level===`WARNING`&&(t=`obs-log-level-warning`),e.level===`ERROR`&&(t=`obs-log-level-error`);let n=`
        <div class="obs-log-item">
          ...
          <span class="obs-log-module">${B(e.module)}</span>:
          <span>${B(e.message)}</span>
          <span class="obs-log-net">${e.network}</span>
      `;return e.stack&&(n+=`<pre class="obs-log-stack">${B(e.stack)}</pre>`),n+=`</div>`,n}).join(``)}function l(){t.querySelectorAll(`[data-log-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{t.querySelectorAll(`[data-log-filter]`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),n=e.dataset.logFilter,c()})}),t.querySelector(`#btn-clear-logs`)?.addEventListener(`click`,()=>{localStorage.setItem(`soi_system_logs`,JSON.stringify([])),i.show(`Consola de logs de sistema limpiada con éxito`,`success`),c()}),t.querySelector(`#btn-mock-rls`)?.addEventListener(`click`,async()=>{await Ea({level:`ERROR`,module:`SupabaseClient`,message:`Security policy violation for select on public.ausencias_auditoria table (RLS error).`,stack:`Error: Row Level Security block
  at executeSelect (supabaseClient.js:84:18)
  at getAuditLogs (observabilidadSupabase.js:46:12)`}),i.show(`Log de error de RLS inyectado`,`danger`),c()}),t.querySelector(`#btn-mock-timeout`)?.addEventListener(`click`,async()=>{await Ea({level:`WARNING`,module:`HTTPClient`,message:`Request timed out for endpoint /rpc/get_institutional_radar. Falling back to offline fallback state.`,stack:`TimeoutException: Request took longer than 5000ms`}),i.show(`Log de timeout de red inyectado`,`warning`),c()}),t.querySelector(`#btn-mock-vitals`)?.addEventListener(`click`,async()=>{await Ea({level:`INFO`,module:`PWA`,message:`Core Web Vitals: FID: 11ms (Excelente), LCP: 980ms (Excelente), CLS: 0.012 (Excelente).`}),i.show(`Log de Core Web Vitals inyectado`,`success`),c()})}return{async init(){if(t=document.getElementById(e),!t){console.error(`[systemLogsWidget] Contenedor #${e} no encontrado en el DOM`);return}await o(),r=()=>{s(),i.show(`Conectividad restablecida. Sistema Online.`,`success`)},a=()=>{s(),i.show(`Conexión perdida. Trabajando en modo Offline.`,`warning`)},window.addEventListener(`online`,r),window.addEventListener(`offline`,a)},destroy(){r&&window.removeEventListener(`online`,r),a&&window.removeEventListener(`offline`,a)}}}function Aa(e){let t=null,n=``,r=`ALL`;async function i(){t&&(t.innerHTML=`
      <div class="row g-3 mb-4 align-items-end">
        <div class="col-12 col-md-5">
          <label class="form-label small fw-semibold text-secondary">Buscar por Actor / Notas / ID</label>
          <div class="input-group">
            <span class="input-group-text"><i class="bi bi-search"></i></span>
            <input type="text" class="form-control shadow-sm" id="input-audit-search" placeholder="Correo, UUID, notas..." value="${B(n)}">
          </div>
        </div>
    ...
    `,await a(),l())}async function a(){let e=t.querySelector(`#audit-trail-tbody`),i=t.querySelector(`#audit-pagination-info`);if(!e)return;let a=await Ta()||[];if(n.trim()!==``){let e=n.toLowerCase();a=a.filter(t=>t.actor_id&&t.actor_id.toLowerCase().includes(e)||t.usuario_id&&t.usuario_id.toLowerCase().includes(e)||t.notas&&t.notas.toLowerCase().includes(e)||t.id&&t.id.toLowerCase().includes(e))}r!==`ALL`&&(a=a.filter(e=>e.accion===r));let o=a.slice(0,50);if(o.length===0){e.innerHTML=`<tr><td colspan="5" class="text-center text-muted py-5"><i class="bi bi-info-circle me-1"></i> No se encontraron registros de auditoría.</td></tr>`,i&&(i.textContent=`Mostrando 0 registros`);return}e.innerHTML=o.map(e=>{let t=`bg-secondary`;e.accion===`APROBACION_FINAL`&&(t=`bg-success bg-opacity-10 text-success border border-success-subtle`),e.accion===`CREACION`&&(t=`bg-primary bg-opacity-10 text-primary border border-primary-subtle`),e.accion===`RECHAZO`&&(t=`bg-danger bg-opacity-10 text-danger border border-danger-subtle`);let n=e.creado_a?new Date(e.creado_a).toLocaleString(`es-ES`):`Fecha no disponible`,r=e.usuario_id||e.actor_id||`Sistema`;return`
        <tr>
          ...
          <td class="text-secondary">${B(e.notas||`Sin comentarios adicionales`)}</td>
      ...
      `}).join(``),i&&(i.textContent=`Mostrando ${o.length} de ${a.length} registros (límite de 50 registros por página)`),t.querySelectorAll(`.btn-audit-detail`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.auditId,n=o.find(e=>e.id===t);n&&s(n)})})}function s(e){let t=e.detalles?Object.keys(e.detalles).map(t=>`
          <div class="col-6 mb-2">
            ...
            <span class="small fw-semibold text-secondary">${B(String(e.detalles[t]))}</span>
          </div>
        `).join(``):``,n=`
      <div class="p-3">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="mt-1 p-3 bg-light bg-opacity-25 rounded border text-secondary small lh-base italic">"${B(e.notas||`Sin notas registradas en esta transacción`)}"</div>
        </div>
        ${t?`
  ...
  `,Ia()}function Ia(){let e=X.container.querySelector(`#offline-network-badge-container`);e&&(e.innerHTML=navigator.onLine?`<span class="badge bg-success rounded-pill px-3 py-2 d-inline-flex align-items-center gap-1 shadow-sm"><span class="spinner-grow spinner-grow-sm text-white obs-spinner-slow" role="status"></span><i class="bi bi-cloud-check me-1"></i> Online</span>`:`<span class="badge bg-warning text-dark rounded-pill px-3 py-2 d-inline-flex align-items-center gap-1 shadow-sm"><span class="spinner-grow spinner-grow-sm text-dark animate-pulse" role="status"></span><i class="bi bi-cloud-slash me-1"></i> Offline - Logs encolados</span>`)}function La(){switch(X.activeTab){case`resumen`:return Ra();case`operaciones`:return za();case`logs`:return Ba();case`auditoria`:return Va();case`ia`:return Ha();default:return Ra()}}function Ra(){let e=X.stats||{},t=X.resumenAlertas||{total:0,rojas:0};return`
    <div class="row g-3">
      <div class="col-md-6 col-lg-3">
        ${Oa({label:`Alumnos Activos`,value:e.total_alumnos||0,icon:`bi-people`,color:`primary`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Oa({label:`Promedio Global`,value:(e.promedio_general||0).toFixed(2),icon:`bi-star`,color:`success`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Oa({label:`Alertas Rojas`,value:t.rojas,icon:`bi-exclamation-octagon`,color:`danger`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${Oa({label:`Asistencia Hoy`,value:(e.asistencia_hoy_porcentaje||0)+`%`,icon:`bi-check2-circle`,color:`info`})}
      </div>
  ...
  `}function Ua(e){e.querySelectorAll(`[data-tab]`).forEach(t=>{t.addEventListener(`click`,()=>{ja(),X.activeTab=t.dataset.tab,localStorage.setItem(`pm_metrics_tab`,X.activeTab),Fa(e),Ua(e),Wa()})}),e.querySelector(`#btn-guia-analisis`)?.addEventListener(`click`,()=>{qa()}),X._onlineListener=Ia,X._offlineListener=Ia,window.addEventListener(`online`,X._onlineListener),window.addEventListener(`offline`,X._offlineListener),Wa()}async function Wa(){if(X.activeTab===`resumen`){let e=await oa(),t=X.container.querySelector(`#destacados-placeholder`);t&&(t.className=``,t.innerHTML=`
        <table class="table table-compact table-hover mb-0">
          <tbody class="small">
            ${e.slice(0,5).map(e=>`
              <tr>
                <td><i class="bi bi-award text-warning me-2"></i><strong>${B(e.nombre_completo)}</strong></td>
                <td><span class="badge bg-success bg-opacity-10 text-success border border-success-subtle">${e.promedio}</span></td>
                <td class="text-muted">${B(e.programa)}</td>
              </tr>
            `).join(``)}
          </tbody>
        </table>
      `)}if(X.activeTab===`operaciones`){try{let{CumplimientoMaestrosWidget:e}=await a(async()=>{let{CumplimientoMaestrosWidget:e}=await import(`./cumplimientoMaestrosWidget-DuFFjVW0.js`).then(e=>e.n);return{CumplimientoMaestrosWidget:e}},__vite__mapDeps([8,1,2,9,10])),t=new e(`cumplimiento-maestros-container`);await t.init(),X.activeWidgetInstances.push(t)}catch(e){console.error(`Error al cargar el widget de CumplimientoMaestrosWidget:`,e);let t=X.container.querySelector(`#cumplimiento-maestros-container`);t&&(t.innerHTML=`<div class="alert alert-warning small"><i class="bi bi-exclamation-circle me-1"></i> No se pudo instanciar el Cumplimiento de Maestros.</div>`)}try{let{analyticsFillingBehaviorWidget:e}=await a(async()=>{let{analyticsFillingBehaviorWidget:e}=await import(`./analyticsFillingBehaviorWidget-BCYa3k4D.js`).then(e=>e.n);return{analyticsFillingBehaviorWidget:e}},__vite__mapDeps([11,1,9,12])),t=e(`comportamiento-llenado-container`);await t.init(),X.activeWidgetInstances.push(t)}catch(e){console.error(`Error al cargar el widget de Comportamiento de Llenado:`,e);let t=X.container.querySelector(`#comportamiento-llenado-container`);t&&(t.innerHTML=`<div class="alert alert-warning small"><i class="bi bi-exclamation-circle me-1"></i> No se pudo instanciar la Analítica de Llenado.</div>`)}}if(X.activeTab===`logs`){let e=ka(`system-logs-container`);X.activeWidgetInstances.push(e),await e.init()}if(X.activeTab===`auditoria`){let e=Aa(`audit-trail-container`);X.activeWidgetInstances.push(e),await e.init()}X.activeTab===`ia`&&Ga()}function Ga(){X.container.querySelector(`#btn-run-ia`)?.addEventListener(`click`,async()=>{let e=X.container.querySelector(`#ia-result-area`);if(e){e.innerHTML=`<div class="text-center"><div class="spinner-border spinner-border-sm text-primary"></div><p class="small mt-2">Compilando datos y analizando con IA...</p></div>`;try{let t=await Da(`global`);if(!t){e.innerHTML=`<div class="alert alert-warning small"><i class="bi bi-exclamation-circle me-1"></i> No hay datos disponibles para analizar.</div>`;return}let n=Ka(t);e.innerHTML=`
        <div class="page-glass p-3 border-primary border-start border-4">
          <p class="small mb-2"><strong>Análisis Institucional:</strong></p>
          <p class="extra-small text-secondary">${B(n)}</p>
          <button class="btn btn-xs btn-outline-primary mt-2" id="btn-copy-report">Copiar Reporte</button>
        </div>
      `,X.container.querySelector(`#btn-copy-report`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(n),i.show(`Reporte copiado al portapapeles`,`success`)})}catch(t){console.error(`Error en análisis IA:`,t),e.innerHTML=`<div class="alert alert-danger small"><i class="bi bi-exclamation-triangle me-1"></i> Error al compilar análisis: ${B(t.message)}</div>`}}})}function Ka(e){let t=[];if(e.radarData&&e.radarData.length>0){let n=(e.radarData.reduce((e,t)=>e+(t.value||0),0)/e.radarData.length).toFixed(1);t.push(`Indicadores promedio: ${n}%.`)}if(e.nodeDifficulty&&e.nodeDifficulty.length>0){let n=e.nodeDifficulty.filter(e=>e.difficulty>.7).length;n>0&&t.push(`Se detectaron ${n} nodos de alto riesgo que requieren intervención.`)}return e.complianceData&&t.push(`Estado de cumplimiento docente compilado en el período actual.`),t.length>0?t.join(` `):`Análisis completado. Consulta el Generador de Reportes para análisis más detallados.`}function qa(){o.open({title:`Guía de Análisis Académico y Observabilidad`,body:`
  ...
  `,size:`lg`,hideSave:!0,cancelText:`Entendido`,onShow:e=>{let t=e.querySelectorAll(`#guia-modal-tabs button`),n=e.querySelectorAll(`.guia-panel`);t.forEach(r=>{r.addEventListener(`click`,()=>{t.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),n.forEach(e=>e.classList.add(`d-none`));let i=e.querySelector(`#pane-${r.dataset.guia}`);i&&i.classList.remove(`d-none`)})})}})}var Ja=class{constructor(e,t={}){this.container=e,this.data=t.data||[],this.onSelect=t.onSelect||(()=>{}),this.expandedNodes=new Set,this.selectedNodeId=null,this.icons={block:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>`,level:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 17h20M2 12h20M2 7h20"></path></svg>`,node:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="3"></circle></svg>`,indicator:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>`,expander:`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>`},this._injectStyles(),this.render(),this._bindEvents()}setData(e){this.data=e,this.render()}render(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function Ya(){let{data:e,error:n}=await t.from(`routes`).select(`*`).order(`name`);if(n)throw console.error(`Error fetching routes:`,n.message),Error(`No se pudieron cargar las rutas`);return e}async function Xa(e){let{data:n,error:r}=await t.from(`route_versions`).select(`*`).eq(`route_id`,e).order(`version_number`,{ascending:!1});if(r)throw console.error(`Error fetching route versions:`,r.message),Error(`No se pudieron cargar las versiones de la ruta`);return n}async function Za(e){if(!e)return[];try{let{data:n,error:r}=await t.from(`blocks`).select(`*`).eq(`route_version_id`,e).order(`order_index`);if(r)throw r;if(!n.length)return[];let i=n.map(e=>e.id),{data:a,error:o}=await t.from(`levels`).select(`*`).in(`block_id`,i).order(`order_index`);if(o)throw o;let s=a.map(e=>e.id),{data:c,error:l}=await t.from(`nodes`).select(`*`).in(`level_id`,s).order(`order_index`).limit(5e3);if(l)throw l;let u=c.map(e=>e.id),{data:d,error:f}=await t.from(`indicators`).select(`*`).in(`node_id`,u).order(`order_index`).limit(1e4);if(f)throw f;return n.map(e=>({...e,type:`block`,children:a.filter(t=>t.block_id===e.id).map(e=>({...e,type:`level`,children:c.filter(t=>t.level_id===e.id).map(e=>({...e,type:`node`,children:d.filter(t=>t.node_id===e.id).map(e=>({...e,type:`indicator`}))}))}))}))}catch(e){throw console.error(`Error building academic tree:`,e.message),Error(`Error al construir el árbol académico`)}}async function Qa(e){let{data:n,error:r}=await t.from(`node_resources`).select(`*`).eq(`node_id`,e).order(`order_index`);if(r)throw r;return n}async function $a(e){let{id:n,...r}=e;if(n){let{data:e,error:i}=await t.from(`node_resources`).update(r).eq(`id`,n).select().single();if(i)throw i;return e}else{let{data:e,error:n}=await t.from(`node_resources`).insert([r]).select().single();if(n)throw n;return e}}async function eo(e){let{error:n}=await t.from(`node_resources`).delete().eq(`id`,e);if(n)throw n;return!0}async function to(e,n){let{data:r,error:i}=await t.from(`nodes`).update(n).eq(`id`,e).select().single();if(i)throw i;return r}var no=class{constructor(e,t={}){this.container=e,this.node=null,this.resources=[],this.onUpdate=t.onUpdate||(()=>{}),this._injectStyles(),this.renderEmpty()}async setNode(e){if(!e){this.node=null,this.resources=[],this.renderEmpty();return}this.node=e,this.renderLoading();try{this.resources=await Qa(e.id),this.render()}catch(e){console.error(`Error loading resources:`,e),this.renderError(`No se pudieron cargar los recursos del nodo.`)}}renderEmpty(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function ro(e){io(),e.innerHTML=`
  ...
  `;let t=e.querySelector(`#tree-container`),n=e.querySelector(`#detail-container`),r=e.querySelector(`#route-selector`),i=e.querySelector(`#version-selector`),a=new no(n,{onUpdate:e=>{console.log(`Node updated:`,e)}}),o=new Ja(t,{onSelect:e=>{a.setNode(e)}});try{(await Ya()).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,r.appendChild(t)})}catch(e){console.error(`Error loading routes:`,e)}r.addEventListener(`change`,async()=>{let e=r.value;if(i.innerHTML=`<option value="">Versión...</option>`,i.disabled=!0,t.innerHTML=`<div class="tree-placeholder"><p>Cargando versiones...</p></div>`,!e){t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una ruta para comenzar.</p></div>`;return}try{(await Xa(e)).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=`V${e.version_number} - ${new Date(e.created_at).toLocaleDateString()}`,i.appendChild(t)}),i.disabled=!1,t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una versión.</p></div>`}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar versiones.</p></div>`}}),i.addEventListener(`change`,async()=>{let e=i.value;if(e){t.innerHTML=`
      <div class="tree-loading">
        <div class="spinner-border spinner-border-sm text-primary"></div>
        <span>Construyendo mapa curricular...</span>
      </div>
    `;try{let t=await Za(e);o.setData(t)}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar el árbol curricular.</p></div>`}}})}function io(){if(document.getElementById(`academic-admin-layout-styles`))return;let e=document.createElement(`style`);e.id=`academic-admin-layout-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Z={clases:[],clasesOriginales:[],maestros:[],salones:[],programas:[],alumnos:[],cargando:!1,filtroEstado:`todos`,filtroInstrumento:``,vista:`tabla`,container:null,mostrarDiasVacios:!0};async function ao(e){if(e)try{Z.container=e,Z.cargando=!0,oo(e);let[n,r,i,a,o]=await Promise.all([hr(),t.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),t.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),t.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]);Z.clases=n,Z.clasesOriginales=[...n],Z.maestros=r.data||[],Z.salones=i.data||[],Z.programas=a.data||[],Z.alumnos=o.data||[],Z.cargando=!1,co(e),ho(e)}catch(t){console.error(t),so(e,t.message)}}function oo(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status"></div>
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>ao(e))}function co(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function lo(){return Z.clases.length===0?fo():`
    <div class="page-glass rounded w-100">
      <div class="list-group list-group-flush w-100" id="clasesListBody">
        ${Z.clases.map(e=>uo(e)).join(``)}
      </div>
    </div>
  `}function uo(e){let t=e.nombre||`Sin nombre`,n=Z.maestros.find(t=>t.id===e.maestro_principal_id),r=n?n.nombre_completo||n.nombre:`Sin maestro`,i=dr(t),a=e.estado||`activa`,o=`border-accent-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,s=`bg-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,c=(e.horarios||[]).slice(0,3),l=c.length>0?c.map(e=>`${(e.dia||``).slice(0,2).toUpperCase()} ${(e.hora_inicio||``).slice(0,5)}`).join(` • `):`Sin horarios`;return`
    <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${o}" data-id="${e.id}" style="cursor: pointer;">
      <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
        ...
        <div class="d-flex flex-column flex-grow-1 overflow-hidden pe-3">
          ...
          <small class="text-muted text-truncate">${B(r)} • ${B(e.instrumento||`-`)}</small>
          <small class="text-muted extra-small mt-1" style="font-size: 0.85rem;"><i class="bi bi-clock me-1"></i>${B(l)}</small>
        </div>
      </div>
      <div class="flex-shrink-0 text-muted ms-2 pe-1">
        <i class="bi bi-chevron-right" style="font-size: 1.1rem; transition: transform 0.2s ease;"></i>
  ...
  `}function po(){if(Z.clases.length===0)return fo();let e=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`],t={lunes:`Lunes`,martes:`Martes`,miércoles:`Miércoles`,jueves:`Jueves`,viernes:`Viernes`,sábado:`Sábado`},n={lunes:[],martes:[],miércoles:[],jueves:[],viernes:[],sábado:[]};Z.clases.forEach(e=>{(e.horarios||[]).forEach(t=>{let r=(t.dia||``).toLowerCase().trim();n[r]&&n[r].push({...t,clase:e})})}),Object.keys(n).forEach(e=>{n[e].sort((e,t)=>H(e.hora_inicio)-H(t.hora_inicio))});let r=Z.mostrarDiasVacios?``:`hide-empty-days`;return`
        ...
        ${e.map(e=>{let r=n[e],i=t[e];return`
            <div class="schedule-day-column ${r.length===0?`is-empty`:``}" data-day="${e}">
              ...
              <div class="schedule-blocks-container">
                ${r.length>0?r.map(e=>{let t=e.clase,n=t.estado||`activa`,r=V(e.hora_inicio),i=V(e.hora_fin),a=Z.salones.find(t=>t.id===e.salon_id),o=a?a.nombre:`Online/Otro`;return`
                    <div class="time-block-card p-2 rounded mb-2 border-start-accent ${`border-accent-${n===`activa`?`success`:n===`suspendida`?`warning`:`secondary`}`}" data-id="${t.id}" style="cursor: pointer;">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <i class="bi ${ur(t.instrumento)} text-muted" style="font-size: 0.85rem;"></i>
                      </div>
                      <div class="fw-semibold text-truncate small class-name" style="font-size: 0.9rem;">${B(t.nombre)}</div>
                      <div class="d-flex justify-content-between align-items-center mt-1 extra-small text-muted">
                        <span class="text-truncate" style="max-width: 60%;"><i class="bi bi-person me-0.5"></i>${B(Z.maestros.find(e=>e.id===t.maestro_principal_id)?.nombre_completo||`Sin maestro`)}</span>
                        <span class="badge bg-body-secondary text-body-secondary-custom px-1.5 py-0.5 rounded" style="font-size: 0.7rem;"><i class="bi bi-geo-alt me-0.5"></i>${B(o)}</span>
                      </div>
                    </div>
                  `}).join(``):`
  ...
  `}async function mo(e){if(e){o.open({title:`Cargando...`,hideSave:!0,size:`md`,body:`
    ...
    `});try{let t=await wr(e.id),n=t.length,r=Z.maestros.find(t=>t.id===e.maestro_principal_id),i=r?r.nombre_completo||r.nombre:`Sin maestro`,a=e.tiene_suplente||e.maestro_suplente_id?Z.maestros.find(t=>t.id===e.maestro_suplente_id):null,s=a?a.nombre_completo||a.nombre:null,c=Z.programas.find(t=>t.id===e.programa_id),l=c?c.nombre:`Sin programa`,u=``;u=e.horarios&&e.horarios.length>0?e.horarios.map(e=>{let t=e.dia.charAt(0).toUpperCase()+e.dia.slice(1),n=Z.salones.find(t=>t.id===e.salon_id),r=n?n.nombre:`Online/Otro`;return`
      ...
      <div class="class-profile-container">
        ...
        <div class="class-hero-card d-flex align-items-center gap-3 p-3 rounded mb-4" style="background: linear-gradient(135deg, rgba(13,110,253,0.08) 0%, rgba(88,86,214,0.08) 100%); border: 1px solid rgba(13,110,253,0.15);">
          ...
          <div class="overflow-hidden">
            <h4 class="mb-1 fw-bold text-truncate" style="letter-spacing: -0.02em; font-size: 1.2rem; color: var(--bs-body-color);">${B(e.nombre)}</h4>
            <span class="badge rounded-pill bg-${e.estado===`activa`?`success`:e.estado===`suspendida`?`warning`:`secondary`} text-capitalize" style="font-size: 0.75rem;">${lr(e.estado)}</span>
          </div>
        </div>
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            <div class="detail-item-glass p-3 rounded h-100 border">
              ...
              <span class="fw-semibold text-body-color-custom" style="font-size: 0.95rem;">${B(i)}</span>
              ${s?`<small class="text-muted d-block extra-small mt-1"><i class="bi bi-person me-0.5"></i>Suplente: ${B(s)}</small>`:``}
            </div>
          </div>
          <div class="col-md-6">
            <div class="detail-item-glass p-3 rounded h-100 border">
              <small class="text-muted d-block mb-1"><i class="bi bi-music-note me-1"></i>Instrumento</small>
              <span class="fw-semibold text-body-color-custom" style="font-size: 0.95rem;">${B(e.instrumento||`Sin asignar`)}</span>
            </div>
          </div>
          <div class="col-md-6">
            <div class="detail-item-glass p-3 rounded h-100 border">
              <small class="text-muted d-block mb-1"><i class="bi bi-collection me-1"></i>Programa</small>
              <span class="fw-semibold text-body-color-custom" style="font-size: 0.95rem;">${B(l)}</span>
            </div>
          </div>
          <div class="col-md-6">
            <div class="detail-item-glass p-3 rounded h-100 border">
        ...
        <div class="description-card p-3 rounded mb-4 border bg-body-tertiary">
          ...
          <p class="mb-0 text-muted small" style="white-space: pre-line; line-height: 1.5;">${B(e.descripcion||`Sin notas pedagógicas registradas.`)}</p>
        </div>
    ...
    `;o.open({title:`Perfil de Clase: ${e.nombre}`,hideSave:!0,size:`md`,body:h,onShow:t=>{let n=t.closest(`.app-modal-dialog`)?.querySelector(`.app-modal-footer`);n&&n.style.setProperty(`display`,`none`,`important`),t.querySelector(`.btn-profile-edit`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>{Fr(e,{maestros:Z.maestros,salones:Z.salones,programas:Z.programas,alumnos:Z.alumnos,onSuccess:()=>ao(Z.container)})},250)}),t.querySelector(`.btn-profile-delete`)?.addEventListener(`click`,()=>{o.close(),setTimeout(()=>{_o(e.id)},250)}),t.querySelector(`.btn-profile-close`)?.addEventListener(`click`,()=>{o.close()})}})}catch(e){console.error(e),i.error(`Error al cargar la información detallada de la clase`),o.close()}}}function ho(e){e.querySelector(`#btn-help-clases`)?.addEventListener(`click`,()=>{G.open({title:`Clases`,intro:`Gestión completa de clases: creación, horarios, asignación de maestros, inscripción de alumnos y control de capacidad.`,sections:[{icon:`bi-easel2`,title:`Lista de clases`,description:`Todas las clases del sistema. Filtrá por instrumento, nivel y estado. Las activas aparecen primero.`,color:`#3b82f6`},{icon:`bi-clock`,title:`Horarios`,description:`Cada clase puede tener múltiples horarios semanales. El sistema detecta conflictos de salón y de maestro automáticamente.`,color:`#6366f1`},{icon:`bi-people`,title:`Inscripción de alumnos`,description:`"Grupal": todos comparten el horario. "Rotativa (Turnos)": cada alumno tiene su propio horario individual dentro de la clase.`,color:`#10b981`},{icon:`bi-bar-chart`,title:`Capacidad`,description:`Barra de ocupación: inscriptos vs capacidad máxima. Rojo cuando supera el 90%.`,color:`#f59e0b`},{icon:`bi-person-workspace`,title:`Maestro titular y suplente`,description:`Cada clase tiene un maestro principal (obligatorio) y puede tener suplente (opcional). Ambos aparecen en el perfil del maestro.`,color:`#6b7280`}]})}),e.querySelector(`#btnAgregarClase`)?.addEventListener(`click`,()=>{Fr(null,{maestros:Z.maestros,salones:Z.salones,programas:Z.programas,alumnos:Z.alumnos,onSuccess:()=>ao(e)})}),e.querySelector(`#btn-vista-tabla`)?.addEventListener(`click`,()=>{Z.vista=`tabla`,co(e),ho(e)}),e.querySelector(`#btn-vista-calendario`)?.addEventListener(`click`,()=>{Z.vista=`calendario`,co(e),ho(e)}),e.querySelector(`#buscar`)?.addEventListener(`input`,go),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,go);let t=e.querySelector(`#view-content`);t?.addEventListener(`change`,t=>{if(t.target&&t.target.id===`toggle-empty-days`){Z.mostrarDiasVacios=t.target.checked;let n=e.querySelector(`.weekly-schedule-grid`);n&&(Z.mostrarDiasVacios?n.classList.remove(`hide-empty-days`):n.classList.add(`hide-empty-days`))}}),t?.addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id], .time-block-card[data-id]`);if(t){let e=t.dataset.id,n=Z.clasesOriginales.find(t=>t.id===e);n&&mo(n)}})}function go(){let e=Z.container.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=Z.container.querySelector(`#filtroEstado`)?.value||`todos`;Z.clases=Z.clasesOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||n.instrumento.toLowerCase().includes(e),i=t===`todos`||n.estado===t;return r&&i});let n=Z.container.querySelector(`#view-content`);n&&(n.innerHTML=Z.vista===`tabla`?lo():po())}function _o(e){let t=Z.clasesOriginales.find(t=>t.id===e);t&&o.open({title:`⚠️ Eliminar Clase`,saveText:`Eliminar Definitivamente`,body:`<p>¿Estás seguro de eliminar la clase <strong>${B(t.nombre)}</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await yr(e),i.success(`Clase eliminada`),ao(Z.container),!0}catch(e){return i.error(e.message),!1}}})}async function vo(e){e.innerHTML=`
  ...
  `;try{let{data:n,error:r}=await t.from(`profiles`).select(`id, email, nombre_completo, created_at`).eq(`rol`,`maestro`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(r)throw r;console.log(`Estamos aqui:`,n);let i=e.querySelector(`#aprobacion-content`);if(!n||n.length===0){i.innerHTML=`
          ...
          <tbody>
            ${n.map(e=>`
              <tr data-profile-id="${e.id}">
                <td>${xo(e.nombre_completo||`—`)}</td>
                <td>${xo(e.email)}</td>
                <td>${xo(e.instrumento||`—`)}</td>
                <td>${So(e.created_at)}</td>
    ...
    `,i.querySelectorAll(`.btn-aprobar`).forEach(e=>{e.addEventListener(`click`,()=>yo(e.dataset.id,i))}),i.querySelectorAll(`.btn-rechazar`).forEach(e=>{e.addEventListener(`click`,()=>bo(e.dataset.id,`rechazado`,null,i))})}catch(t){let n=e.querySelector(`#aprobacion-content`);n.innerHTML=`
    ...
    `,n.querySelector(`#btn-retry-aprobacion`)?.addEventListener(`click`,()=>vo(e)),console.error(`[AprobacionView] Error:`,t.message)}}function yo(e,t){o.open({title:`Aprobar Usuario`,size:`sm`,saveText:`Aprobar`,body:`
    ...
    `,onSave:async n=>{let r=n.querySelector(`#aprobacion-rol-select`).value;await bo(e,`activo`,r,t)}})}async function bo(e,n,r,i){let a=i?.querySelector(`tr[data-profile-id="${e}"]`);if(!(!a&&i)){a?.querySelectorAll(`button`).forEach(e=>e.disabled=!0);try{if(n===`activo`){let n=!1,{data:i,error:a}=await t.rpc(`approve_maestro_profile`,{p_profile_id:e,p_new_rol:r||`maestro`,p_new_estado:`activo`});if(!a&&i?.success&&(n=!0),!n){console.warn(`[AprobacionView] RPC falló, usando operaciones directas:`,a?.message||i?.error);let{error:n,count:o}=await t.from(`profiles`).update({rol:r||`maestro`,estado:`activo`}).eq(`id`,e).select();if(n)throw Error(`No se pudo actualizar el perfil: ${n.message}`);let{data:s}=await t.from(`profiles`).select(`estado, rol`).eq(`id`,e).maybeSingle();if(s?.estado!==`activo`)throw Error(`No se pudo activar el perfil. Por favor cerrá sesión e iniciá sesión nuevamente como admin, luego intentá aprobar de nuevo.`)}if(r===`maestro`||!r){let{data:n}=await t.from(`profiles`).select(`id, email, nombre_completo`).eq(`id`,e).maybeSingle();if(n){let{data:e}=await t.from(`maestros`).select(`id, user_id`).or(`user_id.eq.${n.id},correo.eq.${n.email}`).maybeSingle();e?e.user_id||await t.from(`maestros`).update({user_id:n.id}).eq(`id`,e.id):await t.from(`maestros`).insert({user_id:n.id,nombre_completo:n.nombre_completo,correo:n.email,instrumento:``,activo:!0})}}}else{let{error:r}=await t.from(`profiles`).update({estado:n}).eq(`id`,e);if(r)throw r}a&&(a.style.transition=`opacity 0.3s ease`,a.style.opacity=`0`,setTimeout(()=>a.remove(),300));let o=r===`admin`?`Admin`:`Maestro`;if(window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:n===`activo`?`${o} aprobado correctamente`:`Usuario rechazado`,type:`success`}})),i){let e=i.querySelector(`tbody`);e&&e.querySelectorAll(`tr`).length===0&&(i.innerHTML=`
        ...
        `)}}catch(e){a?.querySelectorAll(`button`).forEach(e=>e.disabled=!1),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al ${n===`activo`?`aprobar`:`rechazar`} usuario: ${e.message}`,type:`error`}})),console.error(`[AprobacionView] Action error:`,e.message)}}}function xo(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function So(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`})}catch{return e}}async function Co(){let{data:e,error:n}=await t.from(`ausencias_maestros`).select(`
      id,
      maestro_id,
      tipo_ausencia,
      urgencia,
  ...
  `}async function Vo(e){let t=e.querySelector(`#aav-content`),n=e.querySelector(`#aav-stats-row`),r=e.querySelector(`#aav-count-label`),i=e.querySelector(`#aav-refresh-btn`);t&&(t.innerHTML=`
    ...
    `);try{let i=await Co();if(n&&zo(n,i),r&&(r.textContent=i.length===0?`Sin solicitudes pendientes`:`${i.length} solicitud${i.length>1?`es`:``} pendiente${i.length>1?`s`:``}`),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate(),!i.length){Bo(t);return}t.innerHTML=``;let a=document.createElement(`div`);a.className=`aav-list`,t.appendChild(a);let o=[...i].sort((e,t)=>{let n={alta:0,media:1,baja:2},r=n[e.urgencia]??3,i=n[t.urgencia]??3;return r===i?(e.created_at||``).localeCompare(t.created_at||``):r-i});for(let t of o)a.appendChild(Fo(t,{onApprove:async(t,n)=>{await To(t,n),Io(`Ausencia aprobada`,`success`),await Vo(e)},onReject:async(t,n)=>{await Eo(t,n),Io(`Ausencia rechazada`,`success`),await Vo(e)}}))}catch(e){t&&(t.innerHTML=`
        <div class="aav-error">
          <i class="bi bi-exclamation-triangle"></i>
  ...
  `,document.head.appendChild(e)}var _s=[{key:`all`,label:`Todo`,icon:`bi-grid-fill`},{key:`ausencia`,label:`Ausencias`,icon:`bi-calendar-x-fill`},{key:`compliance`,label:`Alertas`,icon:`bi-exclamation-triangle-fill`},{key:`alumno`,label:`Novedades`,icon:`bi-person-plus-fill`}],vs={ausencia:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`},compliance:{bg:`rgba(245,158,11,0.1)`,color:`#f59e0b`},alumno:{bg:`rgba(59,130,246,0.1)`,color:`#3b82f6`},maestro:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`}},ys={ausencia:`Ausencia`,compliance:`Alerta`,alumno:`Novedad`,maestro:`Seguridad`},bs={aprobada:{label:`Aprobada`,bg:`rgba(34,197,94,0.12)`,color:`#16a34a`,icon:`bi-check-circle-fill`},rechazada:{label:`Rechazada`,bg:`rgba(239,68,68,0.12)`,color:`#dc2626`,icon:`bi-x-circle-fill`},pendiente:{label:`Pendiente`,bg:`rgba(245,158,11,0.12)`,color:`#d97706`,icon:`bi-hourglass-split`}};async function xs(e){gs(),`Notification`in window&&Notification.permission===`default`&&Notification.requestPermission();let n=[],r=`all`,i=``,a=null;function s(){e.innerHTML=`
    ...
    `,size:`lg`,hideSave:!0,cancelText:`Entendido`})}async function te(){let e=[];try{e=await is()}catch{}let t=e.map(e=>`<option value="${e.profile_id}">${e.nombre}</option>`).join(``);o.open({title:`<i class="bi bi-send-fill me-2 text-warning"></i>Enviar notificación a maestros`,body:`
      ...
      </div>`).join(``);o.open({title:`<i class="bi bi-clock-history me-2"></i>Historial <span class="badge bg-secondary ms-1">${e.length}</span>`,body:`<div style="max-height:420px;overflow-y:auto;">${n}</div>`,hideSave:!0,cancelText:`Cerrar`})}return s(),await h(),hs(),e.querySelector(`#anv-refresh-btn`)?.addEventListener(`click`,()=>h(!1)),e.querySelector(`#anv-btn-send-notif`)?.addEventListener(`click`,()=>te()),e.querySelector(`#anv-btn-historial`)?.addEventListener(`click`,()=>ne()),function(){a&&=(t.removeChannel(a),null)}}export{jt as $,dn as A,se as At,Qt as B,Sr as C,ke as Ct,B as D,he as Dt,br as E,b as Et,sn as F,l as Ft,Ht as G,It as H,tn as I,Rt as J,Vt as K,en as L,un as M,le as Mt,cn as N,ge as Nt,Bn as O,ce as Ot,ln as P,me as Pt,kt as Q,nn as R,jr as S,ut as St,wr as T,ve as Tt,Ut as U,Kt as V,Bt as W,Nt as X,Wt as Y,At as Z,Ar as _,st as _t,Co as a,bt as at,Dr as b,at as bt,ro as c,St as ct,ia as d,xt as dt,Mt as et,na as f,ht as ft,G as g,dt as gt,ti as h,ft as ht,Ho as i,Ct as it,j,pe as jt,mn as k,fe as kt,Ma as l,yt as lt,ra as m,vt as mt,ps as n,Et as nt,vo as o,Tt as ot,aa as p,mt as pt,Gt as q,ms as r,Ot as rt,ao as s,gt as st,xs as t,Dt as tt,Da as u,wt as ut,Er as v,ot as vt,xr as w,Oe as wt,kr as x,rt as xt,Or as y,it as yt,$t as z};