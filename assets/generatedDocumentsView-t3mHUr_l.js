import{i as e}from"./supabase-Cgh_dhNB.js";import{g as t,h as n,m as r,p as i}from"./scoreDirectorView-Bog5bn1s.js";async function a(e){e&&(e.innerHTML=`
    ...
    </div>`,e.querySelector(`#btn-doc-hist-back`)?.addEventListener(`click`,()=>window.router?.navigate(`exportar-datos`)),e.querySelectorAll(`.btn-doc-redownload`).forEach(e=>{e.addEventListener(`click`,i=>{i.stopPropagation();let o=a.find(t=>t.id===e.dataset.id);o&&n(t({title:o.titulo,content:o.contenido_final,metadata:{alumnoNombre:o.alumno_nombre,tipo:o.tipo}}),r({tipo:o.tipo,alumnoNombre:o.alumno_nombre,fecha:o.created_at?.slice(0,10)}))})}),e.querySelectorAll(`.btn-doc-archive`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation(),confirm(`¿Archivar este documento?`)&&(await i(t.dataset.id),await o(e))})})}export{a as renderGeneratedDocumentsView};