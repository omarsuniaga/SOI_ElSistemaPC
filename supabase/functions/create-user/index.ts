...
// Debe coincidir con el CHECK constraint profiles_rol_check en la base y con
// system_config.available_roles (que alimenta el selector del front). Si se
// agrega un rol nuevo, actualizar los tres lugares.
const VALID_ROLES = [
  'superadmin', 'admin', 'direccion', 'coordinacion_academica', 'maestro',
  'monitor', 'finanzas', 'operaciones', 'representante', 'alumno', 'jurado', 'user',
] as const
