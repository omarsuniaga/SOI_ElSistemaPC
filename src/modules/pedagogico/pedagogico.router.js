...
import { renderCockpitDirectorView } from './views/cockpitDirectorView.js'
import { renderPerfilAlumnoView } from './views/perfilAlumnoView.js'

export function registerRoutesPedagogico() {
  router.register('pedagogico-cockpit', (c) => renderCockpitDirectorView(c))
  router.register('pedagogico-perfil', (c, p) => renderPerfilAlumnoView(c, p))
  ...
  router.register('pedagogico-seguimiento-institucional', (c) =>
    renderSeguimientoInstitucionalView(c),
  )
