import{t as e}from"./router-Dfb4XAS3.js";import{n as t,t as n}from"./adminMaestroApi-CDRHdQAv.js";function r(e){return e?String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]):``}var i=class{constructor(e,t){this.containerId=e,this.maestroId=t,this.container=document.getElementById(e)}async init(){try{this.container.innerHTML=`<div class="premium-loading"><div class="premium-loading-spinner"></div><div>Cargando detalle...</div></div>`;let[e,r]=await Promise.all([t(this.maestroId),n(this.maestroId)]);this.render(e,r)}catch(e){console.error(`[MaestroDetalleView] Error:`,e),this.container.innerHTML=`
