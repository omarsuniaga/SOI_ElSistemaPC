...
| Documento | Ubicación |
|---|---|
| **Production Baseline** | [01_PRODUCTION_BASELINE.md](01_PRODUCTION_BASELINE.md) |
| **Security Definer Audit** | [02_SECURITY_DEFINER_AUDIT.md](02_SECURITY_DEFINER_AUDIT.md) |
| **Mutation Integrity** | [03_MUTATION_INTEGRITY.md](03_MUTATION_INTEGRITY.md) |
| **Portal Maestros Check** | [04_PORTAL_MAESTROS_RELEASE_CHECK.md](04_PORTAL_MAESTROS_RELEASE_CHECK.md) |
| **SOP de Restauración** | [RESTORE_SOP.md](../../docs/runbooks/RESTORE_SOP.md) |
| **Contrato de Herencia** | [SOI_V2_INHERITANCE_CONTRACT.md](SOI_V2_INHERITANCE_CONTRACT.md) |
| **Informe de Cierre** | [SOI_V1_CLOSURE_REPORT.md](SOI_V1_CLOSURE_REPORT.md) |
...
Cualquier modificación futura debe partir de este baseline canónico y acatar el [Contrato de Herencia](SOI_V2_INHERITANCE_CONTRACT.md).
