import{r as e}from"./rolldown-runtime-DlOssbPu.js";import{i as t}from"./supabase-KnARm58N.js";import"./vendor-BUMNmNsE.js";import{t as n}from"./AppToast-Bli1nFQQ.js";import{n as r}from"./groqService-DqCFHp7y.js";import{C as i,S as a,T as o,_ as s,a as c,b as l,c as u,d,f as ee,g as f,h as te,i as ne,l as re,m as ie,n as ae,p as oe,r as se,t as ce,u as le,v as ue,w as de,x as fe,y as pe}from"./scoreDirectorView-M48HE1AW.js";import{t as p}from"./router-DSDN-AHb.js";import{t as m}from"./AppModal-Fjeb_yOo.js";import{_ as me,c as he,l as ge,n as _e,o as ve,s as ye,v as be}from"./tareasApi-fy4qrUAO.js";import{t as xe}from"./tareasView-Cn-Ng65P.js";import{i as Se,n as Ce}from"./instrumentosApi-DRPXdxEI.js";var we={DIR:`Dirección`,ACM:`Académica`,ADM:`Administración`,FIN:`Financiero`,LOG:`Logística`,COM:`Comunicaciones`,TECNICO:`Técnico`,LUT:`Lutería`,OPR:`Operaciones`},Te={critica:`danger`,alta:`warning`,media:`info`,baja:`secondary`},h={procedimientos:[],processContracts:[],cargando:!1};function g(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}async function Ee(e){let t=new AbortController;return await _(e),e.addEventListener(`click`,async t=>{if(t.target.closest(`#btn-refrescar-proc`))return _(e);let n=t.target.closest(`[data-open-case-detail]`);if(n){p.navigate(`hermes-caso`,{processCode:n.dataset.processCode||null,correlationId:n.dataset.correlationId||null});return}let r=t.target.closest(`[data-start-process-code]`);if(r){let t=r.dataset.startProcessCode,n=h.processContracts.find(e=>e.process_code===t),i=window.prompt(`Título del caso para ${t}:`,n?.process_name||t);if(!i?.trim())return;let a=window.prompt(`Descripción breve del caso:`)||``;try{await be({process_code:t,title:i.trim(),description:a.trim()||null,source:`manual`,priority:`media`,metadata:{opened_from:`procedimientos_view`}}),alert(`Caso SOI abierto: Hermes generó las tareas departamentales del contrato.`),_(e)}catch(e){alert(`Error: ${e.message}`)}return}if(t.target.closest(`#btn-caso-alumno`)){let t=window.prompt(`Nombre del alumno en riesgo:`);if(!t?.trim())return;let n=window.prompt(`Motivo (ausencias, bajo progreso, morosidad…):`)||``;try{await me(null,t.trim(),n.trim()),alert(`Caso abierto: se delegaron tareas a Académico, Comunicación, Finanzas y Dirección.`),_(e)}catch(e){alert(`Error: ${e.message}`)}}},{signal:t.signal}),{teardown:()=>t.abort()}}async function _(e){try{h.cargando=!0,Oe(e);let[t,n]=await Promise.all([ye(),ge()]);h.procedimientos=t,h.processContracts=n}catch(t){e.innerHTML=`<div class="alert alert-danger m-3">Error cargando procedimientos: ${g(t.message)}</div>`;return}finally{h.cargando=!1}Oe(e)}function De(e){return{totalProc:e.length,enCurso:e.filter(e=>e.pct_avance<100&&e.total>e.canceladas).length,bloqueados:e.filter(e=>e.bloqueadas>0).length,observados:e.filter(e=>e.observadas>0).length,criticos:e.filter(e=>e.prioridad_max===`critica`).length}}function Oe(e){if(h.cargando&&h.procedimientos.length===0){e.innerHTML=`<div class="text-center text-muted py-5"><div class="spinner-border" role="status"></div><p class="mt-2">Cargando procedimientos…</p></div>`;return}let t=h.procedimientos,n=De(t),r=(e,t,n,r)=>`
    <div class="col">
    ...
    </div>`,i=t.length===0?`<div class="text-center text-muted py-5"><i class="bi bi-inbox fs-1"></i><p class="mt-2">No hay procedimientos activos.</p></div>`:t.map(ke).join(``),a=h.processContracts.length===0?`<div class="text-muted small">No hay contratos SOI activos registrados.</div>`:h.processContracts.map(Ae).join(``);e.innerHTML=`
    ...
    </div>`}function Ae(e){let t=(e.responsible_departments||[]).map(e=>`<span class="badge bg-light text-dark border me-1">${g(we[e]||e)}</span>`).join(``),n={manual:`Manual`,semi_auto:`Semi-auto`,automated:`Automatizado`,deprecated:`Deprecado`}[e.automation_status]||e.automation_status;return`
    <div class="col">
      <div class="border rounded-3 p-3 h-100 bg-body">
        ...
        <div class="mt-2 small text-muted">
          Dueño: ${g(we[e.department_owner]||e.department_owner)}
        </div>
    ...
    </div>`}var je={DIR:`Dirección`,ACM:`Académica`,ADM:`Administración`,FIN:`Financiero`,LOG:`Logística`,COM:`Comunicaciones`,TECNICO:`Técnico`,LUT:`Lutería`,OPR:`Operaciones`};function v(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function Me(e){return{pendiente:`secondary`,en_progreso:`info`,completada:`success`,bloqueada:`danger`,cancelada:`dark`,observada:`warning`}[e]||`secondary`}var y={detail:null,cargando:!1};async function Ne(e,t={}){let n=new AbortController;try{y.cargando=!0,Pe(e),y.detail=await he({correlationId:t.correlationId||null,processCode:t.processCode||null}),y.cargando=!1,Fe(e,t)}catch(t){return y.cargando=!1,e.innerHTML=`<div class="alert alert-danger m-3">No pude cargar el caso: ${v(t.message)}</div>`,{teardown:()=>n.abort()}}return e.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-open-case-tasks]`);if(t){p.navigate(`hermes-tareas`,{processCode:t.dataset.processCode,correlationId:t.dataset.correlationId});return}if(e.target.closest(`#btn-back-procedimientos`)){p.navigate(`hermes-procedimientos`);return}let n=e.target.closest(`#btn-cerrar-caso`);if(!n)return;let r=n.dataset.caseId;if(!r)return;let i=window.prompt(`Resumen de cierre (opcional):`);if(i!==null)try{n.disabled=!0,n.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Cerrando...`,await _e({caseId:r,closureSummary:i?.trim()||null,actor:o().getUsuario?.()||{}}),p.navigate(`hermes-procedimientos`)}catch(e){alert(`Error al cerrar el caso: ${e.message}`),n.disabled=!1,n.innerHTML=`<i class="bi bi-check2-all"></i> Cerrar caso`}},{signal:n.signal}),{teardown:()=>n.abort()}}function Pe(e){e.innerHTML=`
    ...
    </div>`}function Fe(e,t){let n=y.detail||{},r=n.contract||null,i=n.tasks||[],a=n.metrics||{total:0,completadas:0,bloqueadas:0,observadas:0,evidencias:0},o=r?.process_code||t.processCode||i[0]?.process_code||`—`,s=r?.process_name||i[0]?.titulo||`Caso Hermes`,c=r?.department_owner||i[0]?.departamento||`—`,l=(r?.responsible_departments||[...new Set(i.map(e=>e.departamento))]).map(e=>`<span class="badge bg-light text-dark border me-1">${v(je[e]||e)}</span>`).join(``),u=(r?.required_evidence||[]).map(e=>`<li class="mb-1">${v(e.label||e.type||e)}</li>`).join(``),d=(r?.closure_criteria||[]).map(e=>`<li class="mb-1">${v(e)}</li>`).join(``),ee=i.length===0?`<div class="text-muted small">No se encontraron tareas para este caso.</div>`:i.map(Ie).join(``),f=a.total>0&&a.total===a.completadas&&a.bloqueadas===0;e.innerHTML=`
    <div class="p-3 p-md-4">
          ...
          <section class="card border-0 shadow-sm mb-3">
            <div class="card-body">
              ...
              <div class="row g-3 small">
                <div class="col-md-6"><div class="text-muted">Dueño</div><div class="fw-semibold">${v(je[c]||c)}</div></div>
    ...
    </div>`}function Ie(e){let t=Array.isArray(e.checklist)&&e.checklist.length>0?Math.round(e.checklist.filter(e=>e.completado).length/e.checklist.length*100):0,n=Me(e.estado);return`
    <div class="border rounded-3 p-3 bg-body">
      <div class="d-flex justify-content-between align-items-start gap-2">
        <div>
          <div class="fw-semibold">${v(e.titulo)}</div>
          <div class="small text-muted">${v(je[e.departamento]||e.departamento)} · ${v(e.process_code||`sin process_code`)}</div>
        </div>
    ...
    </div>`}var Le={DIR:`Dirección`,ACM:`Académica`,ADM:`Administración`,FIN:`Financiero`,LOG:`Logística`,COM:`Comunicaciones`,TECNICO:`Técnico`,LUT:`Lutería`},Re=[`¿Cómo va la operación en general?`,`¿Qué departamentos tienen tareas pendientes?`,`¿Qué casos requieren atención inmediata?`,`¿Cómo va la reinscripción?`],x={snapshot:null,procedimientos:[],historial:[]};function S(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function ze(e){return String(e??``).normalize(`NFD`).replace(/[̀-ͯ]/g,``).toLowerCase()}async function Be(e){let t=new AbortController;try{[x.snapshot,x.procedimientos]=await Promise.all([ve(),ye()])}catch(n){return e.innerHTML=`<div class="alert alert-danger m-3">No pude consultar el estado: ${S(n.message)}</div>`,{teardown:()=>t.abort()}}He(e);let n=()=>{let t=e.querySelector(`#hermes-q`),n=t.value.trim();if(!n)return;x.historial.push({rol:`user`,texto:n}),x.historial.push({rol:`hermes`,html:Ve(n)}),t.value=``,He(e);let r=e.querySelector(`#hermes-log`);r&&(r.scrollTop=r.scrollHeight)};return e.addEventListener(`click`,t=>{t.target.closest(`#hermes-send`)&&n();let r=t.target.closest(`.hermes-sug`);r&&(e.querySelector(`#hermes-q`).value=r.dataset.q,n())},{signal:t.signal}),e.addEventListener(`keydown`,e=>{e.target.id===`hermes-q`&&e.key===`Enter`&&(e.preventDefault(),n())},{signal:t.signal}),{teardown:()=>t.abort()}}function Ve(e){let t=ze(e),n=x.snapshot;if(/(atencion|inmediat|urgent|bloque|critic|riesgo|priorid)/.test(t)){let e=n.atencion_inmediata||[];return e.length===0?`<p>✅ No hay tareas bloqueadas ni críticas abiertas. Nada requiere atención inmediata.</p>`:`<p><strong>${e.length}</strong> tarea(s) requieren atención inmediata:</p><ul class="mb-0">`+e.map(e=>`<li><span class="badge bg-${e.estado===`bloqueada`?`danger`:`warning text-dark`} me-1">${S(e.estado)}</span>
        <strong>${S(Le[e.departamento]||e.departamento)}</strong> — ${S(e.titulo)}</li>`).join(``)+`</ul>`}if(/(pendient|departament|quien|quienes|cargad|saturad)/.test(t)){let e=(n.por_departamento||[]).filter(e=>e.abiertas>0);return e.length===0?`<p>No hay tareas abiertas en ningún departamento.</p>`:`<p>Tareas abiertas por departamento:</p><ul class="mb-0">`+e.map(e=>`<li><strong>${S(Le[e.departamento]||e.departamento)}</strong>: ${e.abiertas} abiertas
        (${e.pendientes} pendientes${e.bloqueadas>0?`, <span class="text-danger">${e.bloqueadas} bloqueadas</span>`:``})</li>`).join(``)+`</ul>`}let r=t.split(/\s+/).filter(e=>e.length>=4&&![`como`,`va`,`van`,`esta`,`estan`,`sobre`,`para`,`proceso`,`procedimiento`,`caso`].includes(e));if(/(como va|como van|proceso|procedimiento|caso|estado de)/.test(t)&&r.length>0){let e=x.procedimientos.filter(e=>{let t=ze(e.titulo_muestra);return r.some(e=>t.includes(e))});if(e.length>0)return`<p>Encontré ${e.length} procedimiento(s) relacionados:</p><ul class="mb-0">`+e.slice(0,8).map(e=>`<li><strong>${e.pct_avance}%</strong> — ${S(e.titulo_muestra)}
    ...
    </ul>`}function He(e){let t=x.historial.length===0?`<div class="text-muted text-center py-4">
    ...
    <div class="p-3 p-md-4" style="max-width:900px;margin:0 auto">
      ...
      <div class="mb-2 d-flex flex-wrap gap-2">
        ${Re.map(e=>`<button class="btn btn-sm btn-outline-secondary hermes-sug" data-q="${S(e)}">${S(e)}</button>`).join(``)}
      </div>
    ...
    </div>`}window.router=p;var Ue=`hermes-tareas`;function We(){let e=localStorage.getItem(`app-theme`),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches,n=e===`dark`||e===null&&t;document.documentElement.setAttribute(`data-bs-theme`,n?`dark`:`light`)}function Ge(){let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-bs-theme`,e),localStorage.setItem(`app-theme`,e)}var Ke=null;function qe(e,t){for(let n of e)if(n.items.some(e=>e.id===t))return n.id;return e[0]?.id}function Je(e,n,r){if(Ke?.abort(),Ke=new AbortController,document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),!n)return;let i=o.getUser(),a=i?i.email||i.full_name||`Usuario`:``,s=localStorage.getItem(r)||e.defaultRoute,c=qe(e.navGroups,s),l=document.documentElement.getAttribute(`data-bs-theme`)===`dark`,u=document.createElement(`aside`);u.className=`app-sidebar`,u.innerHTML=`
  ...
  `,document.body.prepend(u);let{signal:d}=Ke;u.querySelectorAll(`.nav-group-header`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`.nav-group`),n=t.classList.contains(`expanded`);u.querySelectorAll(`.nav-group`).forEach(e=>e.classList.remove(`expanded`)),n||t.classList.add(`expanded`)},{signal:d})}),u.querySelectorAll(`.nav-item-btn`).forEach(e=>{e.addEventListener(`click`,()=>p.navigate(e.dataset.route),{signal:d})}),u.querySelector(`#sidebarBtnTheme`).addEventListener(`click`,()=>{Ge();let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`;u.querySelector(`#sidebarBtnTheme i`).className=e?`bi bi-sun-fill`:`bi bi-moon-fill`},{signal:d}),u.querySelector(`#sidebarBtnLogout`).addEventListener(`click`,async()=>{await t.auth.signOut(),window.location.reload()},{signal:d})}async function Ye(e){let{data:n}=await t.from(`profiles`).select(`rol`).eq(`id`,e).maybeSingle();return n?.rol||null}function Xe(e,n){document.querySelector(`.app-sidebar`)?.remove(),e.innerHTML=`
  ...
  `,e.querySelector(`#btnSalir`)?.addEventListener(`click`,async()=>{await t.auth.signOut(),window.location.reload()})}async function Ze(e){let t=`current-view-${e.hermesDept.toLowerCase()}`,n=document.querySelector(`#app`);if(!n){console.error(`El contenedor #app no existe en el HTML`);return}We();try{de()}catch(e){console.error(`Error registrando auth:`,e)}e.registrars.forEach(e=>{try{e()}catch(e){console.error(`Error registrando módulo:`,e)}}),p.register(Ue,(t,n={})=>xe(t,{departamento:e.hermesDept,hideCalendarBtn:!0,...n})),p.register(`hermes-caso`,(e,t={})=>Ne(e,t)),p.register(`hermes-procedimientos`,e=>Ee(e)),p.register(`dir-score`,e=>ce(e)),p.register(`hermes-consulta`,e=>Be(e)),p.initCustomEvents(),await o.refreshAuth(),p.setAuthGuard(()=>o.isAuthenticated(),[`login`,`register`]),p.init=function(){let n=localStorage.getItem(t)||e.defaultRoute;this.navigate(n)};let r=p._navigateTo.bind(p);p._navigateTo=function(e,n={}){r(e,n),localStorage.setItem(t,e)};let i=async()=>{if(!o.isAuthenticated()){Je(e,!1,t),p.navigate(`login`);return}let r=o.getUser()||o.getState?.().user;if(!r?.id){console.warn(`[portalShell] autenticado pero sin user.id; redirigiendo a login`),Je(e,!1,t),p.navigate(`login`);return}let i=await Ye(r.id);if(!e.allowedRoles.includes(i)){Xe(n,e.brandText);return}Je(e,!0,t);let a=localStorage.getItem(t);p.navigate(a&&p.routes[a]?a:e.defaultRoute)};try{await i()}catch(t){console.error(`[portalShell] Error en boot:`,t),Qe(n,e.brandText,t);return}let a=!1;o.subscribe(async e=>{if(!a){a=!0;try{e.user?await i():(document.querySelector(`.app-sidebar`)?.remove(),n.innerHTML=``,p.navigate(`login`))}catch(e){console.error(`[portalShell] Error en re-gate:`,e)}finally{a=!1}}})}function Qe(e,t,n){document.querySelector(`.app-sidebar`)?.remove(),e.innerHTML=`
    <div class="d-flex align-items-center justify-content-center" style="min-height:100vh">
  ...
  `}var $e={violin:`Violín`,volín:`Violín`,violín:`Violín`,viola:`Viola`,cello:`Cello`,violoncello:`Cello`,violonchelo:`Cello`,chelo:`Cello`,contrabajo:`Contrabajo`,flauta:`Flauta`,oboe:`Oboe`,clarinete:`Clarinete`,fagot:`Fagot`,saxofon:`Saxofón`,saxofón:`Saxofón`,corno:`Corno`,trompeta:`Trompeta`,trombón:`Trombón`,trombon:`Trombón`,tuba:`Tuba`,percusión:`Percusión`,percusion:`Percusión`,coro:`Coro`,piano:`Piano`},et={cuerdas:{label:`Cuerdas`,icon:`bi-music-note-beamed`,instrumentos:[`Violín`,`Viola`,`Cello`,`Contrabajo`]},maderas:{label:`Maderas`,icon:`bi-wind`,instrumentos:[`Flauta`,`Oboe`,`Clarinete`,`Fagot`,`Saxofón`]},metales:{label:`Metales`,icon:`bi-trumpet`,instrumentos:[`Corno`,`Trompeta`,`Trombón`,`Tuba`]},percusion:{label:`Percusión`,icon:`bi-bullseye`,instrumentos:[`Percusión`]},coro:{label:`Coro`,icon:`bi-people`,instrumentos:[`Coro`]},otros:{label:`Otros`,icon:`bi-three-dots`,instrumentos:[`Piano`]}};function C(e){return e?$e[String(e).trim().toLowerCase()]||it(String(e).trim()):null}function tt(e){let t=C(e);if(!t)return`otros`;for(let[e,n]of Object.entries(et))if(n.instrumentos.includes(t))return e;return`otros`}function w(e){if(!e)return null;let t=String(e).replace(/\D/g,``);return t.length===0||(t.length===10&&(t=`1`+t),t.length<11)?null:t}function nt(e,t=``){let n=w(e);return n?`https://wa.me/${n}${t?`?text=${encodeURIComponent(t)}`:``}`:null}function rt(e,t={}){if(!e)return``;let n=et[tt(t.instrumento)];return e.replace(/\{nombre_alumno\}/g,t.alumno||``).replace(/\{representante\}/g,t.contactoNombre||``).replace(/\{instrumento\}/g,C(t.instrumento)||``).replace(/\{seccion\}/g,n?.label||``)}function it(e){return e&&e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()}[[`Ana Lucía Pérez`,`Violín`,`María Pérez`,`8095551001`,`maria.perez@example.com`],[`Carlos Ramírez`,`Violin`,`José Ramírez`,`8295551002`,`jose.ramirez@example.com`],[`Daniela Gómez`,`Viola`,`Rosa Gómez`,`8495551003`,`rosa.gomez@example.com`],[`Esteban Núñez`,`Cello`,`Pedro Núñez`,`8095551004`,`pedro.nunez@example.com`],[`Fabiola Díaz`,`Contrabajo`,`Luisa Díaz`,`8095551005`,null],[`Gabriel Soto`,`Flauta`,`Carmen Soto`,`8295551006`,`carmen.soto@example.com`],[`Helena Cruz`,`Clarinete`,`Marta Cruz`,`8495551007`,`marta.cruz@example.com`],[`Iván Mejía`,`Trompeta`,`Raúl Mejía`,`8095551008`,`raul.mejia@example.com`],[`Julia Vargas`,`Trombón`,`Sofía Vargas`,null,`sofia.vargas@example.com`],[`Kevin Reyes`,`Percusión`,`Ana Reyes`,`8295551010`,`ana.reyes@example.com`]].map((e,t)=>{let[n,r,i,a,o]=e;return{alumnoId:`mock-al-${String(t+1).padStart(3,`0`)}`,alumno:n,instrumento:C(r),familia:tt(r),contactoNombre:i,whatsapp:a,email:o}}),new Date().toISOString(),new Date().toISOString();var at=e({eliminarPlantilla:()=>lt,enviarCorreo:()=>ut,getContactos:()=>ot,getPlantillas:()=>st,guardarPlantilla:()=>ct});async function ot(){let{data:e,error:n}=await t.from(`alumnos`).select(`id, nombre_completo, instrumento_principal, activo, representante_nombre, representante_tlf, madre_nombre, madre_tlf_whatsapp, padre_nombre, padre_tlf_whatsapp, familiar_nombre, familiar_telefono, correo_representante`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0});if(n)throw n;return(e||[]).map(e=>{let t=e.madre_tlf_whatsapp||e.padre_tlf_whatsapp||e.representante_tlf||e.familiar_telefono||null,n=e.representante_nombre||e.madre_nombre||e.padre_nombre||e.familiar_nombre||`Representante`;return{alumnoId:e.id,alumno:e.nombre_completo,instrumento:C(e.instrumento_principal),familia:tt(e.instrumento_principal),contactoNombre:n,whatsapp:t,email:e.correo_representante||null}})}async function st(){let{data:e,error:n}=await t.from(`document_templates`).select(`id, nombre, tipo, descripcion, contenido, variables, estado, version, updated_at`).order(`nombre`,{ascending:!0});if(n)throw n;return e||[]}async function ct(e){let n={nombre:e.nombre,tipo:e.tipo||`mensaje`,descripcion:e.descripcion||null,contenido:e.contenido||``,variables:e.variables||[],estado:e.estado||`activa`,updated_at:new Date().toISOString()};if(e.id){let{data:r,error:i}=await t.from(`document_templates`).update(n).eq(`id`,e.id).select().single();if(i)throw i;return r}let{data:r,error:i}=await t.from(`document_templates`).insert(n).select().single();if(i)throw i;return r}async function lt(e){let{error:n}=await t.from(`document_templates`).delete().eq(`id`,e);if(n)throw n;return!0}async function ut(e){let{data:n,error:r}=await t.functions.invoke(`send-email`,{body:e});if(r){let e=r.message;try{let t=await r.context?.json?.();t?.error&&(e=t.error)}catch{}throw Error(e)}if(n&&n.ok===!1&&n.enviados===0)throw Error(n.batches?.[0]?.error||`No se pudo enviar el correo`);return n}var T=at,dt=T.getContactos,ft=T.getPlantillas,pt=T.guardarPlantilla,mt=T.eliminarPlantilla,ht=T.enviarCorreo,gt=`Eres el asistente de redacción del Departamento de Comunicaciones de
...
- Devolvé SOLO el mensaje mejorado, sin explicaciones ni comillas.`;async function _t(e,t=``){let n=t?`Instrucción adicional: ${t}\n\nMensaje a mejorar:\n${e}`:`Mensaje a mejorar:\n${e}`,i=await r([{role:`system`,content:gt},{role:`user`,content:n}]);return typeof i==`string`?i.trim():i&&typeof i.content==`string`?i.content.trim():String(i||``).trim()}function vt(e){let t=new Date;return t.setDate(t.getDate()+e),t.toISOString().slice(0,10)}new Date(Date.now()-2*864e5).toISOString(),vt(-1),new Date(Date.now()-2*864e5).toISOString(),new Date(Date.now()-2*864e5).toISOString(),new Date(Date.now()-1*864e5).toISOString(),vt(0),new Date(Date.now()-1*864e5).toISOString(),new Date(Date.now()-1*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString(),new Date(Date.now()-5*864e5).toISOString();var yt=e({actualizarSeguimiento:()=>wt,cerrarSeguimiento:()=>Tt,crearSeguimiento:()=>Ct,eliminarSeguimiento:()=>Et,getSeguimientos:()=>xt,getSeguimientosByAlumno:()=>St}),E=`comunicaciones_seguimiento`,bt=`id, alumno_id, contacto_nombre, contacto_telefono, contacto_email, canal, fecha, resultado, notas, requiere_seguimiento, proxima_accion, proxima_fecha, estado, responsable_id, created_at, updated_at`;async function xt(e={}){let n=t.from(E).select(bt);e.alumno_id&&(n=n.eq(`alumno_id`,e.alumno_id)),e.estado&&(n=n.eq(`estado`,e.estado)),e.canal&&(n=n.eq(`canal`,e.canal));let{data:r,error:i}=await n.order(`fecha`,{ascending:!1});if(i)throw i;return r||[]}async function St(e){return xt({alumno_id:e})}async function Ct(e){let n={alumno_id:e.alumno_id||null,contacto_nombre:e.contacto_nombre||null,contacto_telefono:e.contacto_telefono||null,contacto_email:e.contacto_email||null,canal:e.canal||`llamada`,fecha:e.fecha||new Date().toISOString(),resultado:e.resultado||`contactado`,notas:e.notas||null,requiere_seguimiento:!!e.requiere_seguimiento,proxima_accion:e.proxima_accion||null,proxima_fecha:e.proxima_fecha||null,estado:e.estado||`abierto`},{data:r,error:i}=await t.from(E).insert(n).select(bt).single();if(i)throw i;return r}async function wt(e,n={}){let{data:r,error:i}=await t.from(E).update(n).eq(`id`,e).select(bt).single();if(i)throw i;return r}async function Tt(e){return wt(e,{estado:`cerrado`,requiere_seguimiento:!1})}async function Et(e){let{error:n}=await t.from(E).delete().eq(`id`,e);if(n)throw n;return!0}var D=yt,Dt=D.getSeguimientos;D.getSeguimientosByAlumno;var Ot=D.crearSeguimiento,kt=D.actualizarSeguimiento,At=D.cerrarSeguimiento,jt=D.eliminarSeguimiento,O={llamada:{label:`Llamada`,icon:`bi-telephone`},whatsapp:{label:`WhatsApp`,icon:`bi-whatsapp`},correo:{label:`Correo`,icon:`bi-envelope`},reunion:{label:`Reunión`,icon:`bi-people`},otro:{label:`Otro`,icon:`bi-chat-dots`}},Mt={contactado:{label:`Contactado`,color:`success`},buzon_no_contesto:{label:`Buzón / No contestó`,color:`secondary`},reagendar:{label:`Reagendar`,color:`warning`},sin_interes:{label:`Sin interés`,color:`dark`},resuelto:{label:`Resuelto`,color:`primary`}};function Nt(e){if(e instanceof Date)return new Date(e);if(typeof e==`string`){let t=e.match(/^(\d{4})-(\d{2})-(\d{2})/);if(t)return new Date(Number(t[1]),Number(t[2])-1,Number(t[3]))}return new Date(e)}function Pt(e){let t=Nt(e);return t.setHours(0,0,0,0),t}function Ft(e){return e?.proxima_fecha?Pt(e.proxima_fecha):null}function It(e){return e?.estado===`abierto`}function Lt(e,t=new Date){let n=Ft(e);return n?Math.round((n-Pt(t))/864e5):null}function Rt(e=[],t=new Date){let n={vencidos:[],hoy:[],proximos:[]};for(let r of e){if(!It(r)||!r?.requiere_seguimiento)continue;let e=Lt(r,t);e!==null&&(e<0?n.vencidos.push(r):e===0?n.hoy.push(r):n.proximos.push(r))}return n}var k={registros:[],filtroCanal:`todos`,filtroEstado:`abierto`},A=null;async function j(e){A?.abort(),A=new AbortController,e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height:300px">
  ...
  `}function Ht(){let e=[...k.registros];return k.filtroEstado!==`todos`&&(e=e.filter(e=>e.estado===k.filtroEstado)),k.filtroCanal!==`todos`&&(e=e.filter(e=>e.canal===k.filtroCanal)),e}function Ut(e){let t=A.signal;e.querySelector(`#segNuevo`)?.addEventListener(`click`,()=>Wt(null,()=>j(e)),{signal:t}),e.querySelector(`#segFiltroEstado`)?.addEventListener(`change`,t=>{k.filtroEstado=t.target.value,zt(e)},{signal:t}),e.querySelector(`#segFiltroCanal`)?.addEventListener(`change`,t=>{k.filtroCanal=t.target.value,zt(e)},{signal:t});let r=t=>{let n=k.registros.find(e=>e.id===t);n&&Wt(n,()=>j(e))};e.querySelectorAll(`.seg-agenda-item, .seg-edit`).forEach(e=>e.addEventListener(`click`,()=>r(e.dataset.id),{signal:t})),e.querySelectorAll(`.seg-cerrar`).forEach(r=>r.addEventListener(`click`,async()=>{try{await At(r.dataset.id),n.show(`Seguimiento cerrado`,`success`),j(e)}catch(e){n.show(`Error: ${e.message}`,`error`)}},{signal:t}))}function Wt(e,t,r=null){let i=!e,a=e||{alumno_id:r?.alumnoId||null,contacto_nombre:r?.alumno||r?.contactoNombre||``,contacto_telefono:r?.whatsapp||``,contacto_email:r?.email||``,canal:`llamada`,fecha:new Date().toISOString(),resultado:`contactado`,notas:``,requiere_seguimiento:!1,proxima_accion:``,proxima_fecha:``,estado:`abierto`},o=new Date().toISOString().slice(0,10);m.open({title:i?`Registrar interacción`:`Editar seguimiento`,size:`lg`,body:`
      ...
      <div class="row g-2 mb-2">
        ...
        <div class="col-md-4"><label class="form-label small fw-semibold">Resultado</label>
          <select class="form-select form-select-sm" id="segResultado">
            ${Object.entries(Mt).map(([e,t])=>`<option value="${e}" ${a.resultado===e?`selected`:``}>${t.label}</option>`).join(``)}
          </select></div>
    ...
    `,saveText:i?`Registrar`:`Guardar`,deleteText:`Eliminar`,onDelete:i?null:async()=>{try{await jt(a.id),n.show(`Registro eliminado`,`success`),t?.()}catch(e){return n.show(`Error: ${e.message}`,`error`),!1}},onShow:e=>{e.querySelector(`#segReq`)?.addEventListener(`change`,t=>{e.querySelector(`#segProxWrap`).classList.toggle(`d-none`,!t.target.checked)})},onSave:async e=>{let r=e.querySelector(`#segNombre`).value.trim();if(!r)return n.show(`El contacto es obligatorio`,`error`),!1;let s=e.querySelector(`#segReq`).checked,c={alumno_id:a.alumno_id||null,contacto_nombre:r,contacto_telefono:e.querySelector(`#segTel`).value.trim()||null,contacto_email:a.contacto_email||null,canal:e.querySelector(`#segCanal`).value,resultado:e.querySelector(`#segResultado`).value,fecha:new Date(e.querySelector(`#segFecha`).value||o).toISOString(),notas:e.querySelector(`#segNotas`).value.trim()||null,requiere_seguimiento:s,proxima_accion:s&&e.querySelector(`#segProxAccion`).value.trim()||null,proxima_fecha:s&&e.querySelector(`#segProxFecha`).value||null};try{i?await Ot(c):await kt(a.id,c),n.show(`Seguimiento guardado`,`success`),t?.()}catch(e){return n.show(`Error: ${e.message}`,`error`),!1}}})}function M(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var Gt=[`{nombre_alumno}`,`{representante}`,`{instrumento}`,`{seccion}`],N={contactos:[],plantillas:[],tab:`directorio`,filtroFamilia:`todas`,busqueda:``,seleccion:new Set,canal:`whatsapp`,asunto:``,mensaje:``},P=null;async function Kt(e){P?.abort(),P=new AbortController,e.innerHTML=qt();try{let[t,n]=await Promise.all([dt(),ft()]);N.contactos=t,N.plantillas=n,F(e)}catch(t){console.error(`[Comunicaciones] Error:`,t),e.innerHTML=`<div class="container mt-5"><div class="alert alert-danger">
  ...
  `;let o=P.signal;t.querySelectorAll(`.comm-canal`).forEach(n=>n.addEventListener(`click`,()=>{N.canal=n.dataset.canal,L(e,t)},{signal:o}));let s=t.querySelector(`#commMsg`);s?.addEventListener(`input`,e=>{N.mensaje=e.target.value},{signal:o}),t.querySelector(`#commAsunto`)?.addEventListener(`input`,e=>{N.asunto=e.target.value},{signal:o}),t.querySelector(`#commTpl`)?.addEventListener(`change`,n=>{let r=N.plantillas.find(e=>e.id===n.target.value);r&&(N.mensaje=r.contenido||``,L(e,t))},{signal:o}),t.querySelectorAll(`.comm-var`).forEach(e=>e.addEventListener(`click`,()=>{cn(s,e.dataset.var),N.mensaje=s.value},{signal:o})),t.querySelector(`#commIA`)?.addEventListener(`click`,()=>nn(e,t,``),{signal:o}),t.querySelector(`#commIAOpts`)?.addEventListener(`click`,()=>rn(e,t),{signal:o}),$t(e,t)}function $t(e,t){let n=t.querySelector(`#commActionZone`);if(!n)return;let r=I();if(N.canal===`whatsapp`)n.innerHTML=`
    ...
    `,t.querySelector(`#commSendMail`)?.addEventListener(`click`,()=>tn(t),{signal:P.signal})}}function en(e){let t=I().filter(e=>w(e.whatsapp)),n=e.querySelector(`#commWaLinks`);if(t.length===0){n.innerHTML=`<div class="alert alert-warning small mb-0">Ningún destinatario tiene un WhatsApp válido.</div>`;return}n.innerHTML=`
    <div class="d-grid gap-1 comm-wa-list">
      ${t.map(e=>`<a href="${nt(e.whatsapp,rt(N.mensaje,e))}" target="_blank" rel="noopener" class="btn btn-outline-success btn-sm text-start">
  ...
  `,e.querySelector(`#commWaAll`)?.addEventListener(`click`,()=>{t.forEach(e=>window.open(nt(e.whatsapp,rt(N.mensaje,e)),`_blank`,`noopener`))},{signal:P.signal})}async function tn(e){let t=I().filter(e=>e.email),r=N.asunto.trim(),i=N.mensaje.trim();if(!r){n.show(`Falta el asunto del correo`,`error`);return}if(!i){n.show(`El mensaje está vacío`,`error`);return}let a=e.querySelector(`#commSendMail`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Enviando...`;try{let e=ln(rt(i,t[0])),a=await ht({to:t.map(e=>e.email),subject:r,html:e});n.show(`Correo enviado a ${a.enviados} de ${a.total} destinatarios`,a.fallidos?`warning`:`success`)}catch(e){n.show(`Error: ${e.message}`,`error`)}finally{a.disabled=!1,a.innerHTML=o}}async function nn(e,t,r){let i=N.mensaje.trim();if(!i){n.show(`Escribí algo primero para mejorarlo`,`error`);return}let a=t.querySelector(`#commIA`),o=a?.innerHTML;a&&(a.disabled=!0,a.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Mejorando...`);try{N.mensaje=await _t(i,r),L(e,t),n.show(`Mensaje mejorado con IA`,`success`)}catch(e){n.show(`IA no disponible: ${e.message}`,`error`),a&&o&&(a.disabled=!1,a.innerHTML=o)}}function rn(e,t){m.open({title:`Ajustar tono con IA`,body:`
      ...
      </div>`,hideSave:!0,cancelText:`Cerrar`}),setTimeout(()=>{document.querySelectorAll(`.comm-tono`).forEach(n=>n.addEventListener(`click`,()=>{m.close(),nn(e,t,n.dataset.tono)},{once:!0}))},50)}function an(e,t){t.innerHTML=`
  ...
  </div>`}function sn(e,t){let r=!t;m.open({title:r?`Nueva plantilla`:`Editar plantilla`,size:`lg`,body:`
  ...
  `;let n=e.querySelector(`#luteria-list`);async function r(){n.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height:200px">
      <div class="spinner-border text-warning" role="status"><span class="visually-hidden">Cargando...</span></div>
    </div>`;try{let[e,t]=await Promise.all([Se({estado:`danado`}),Se({estado:`en_reparacion`})]),i=[...e,...t].sort((e,t)=>e.nombre.localeCompare(t.nombre));if(i.length===0){n.innerHTML=`
          ...
          </div>`;return}n.innerHTML=``;let a=document.createDocumentFragment();i.forEach(e=>{let t=mr(e,async(e,t)=>{await Ce(e,t),await r()});a.appendChild(t)}),n.appendChild(a)}catch(e){n.innerHTML=`<div class="alert alert-danger">
        <i class="bi bi-exclamation-triangle me-2"></i>Error al cargar instrumentos: ${e.message}
      </div>`}}return e.querySelector(`#btn-refresh-luteria`)?.addEventListener(`click`,r,{signal:t.signal}),await r(),{teardown(){t.abort()}}}function gr(){p.register(`luteria-diagnosticos`,e=>hr(e))}var _r=[wn,Un,a,pe,l,u,re,s,f,te,ae,ue,ie,ee,fe,i,le,oe,d,c,ne,se,ar,dr,gr];export{Ze as n,_r as t};