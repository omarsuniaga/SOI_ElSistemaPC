const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushService-DDP27NH7.js","assets/AppToast-DNGTRY9B.js","assets/supabase-Dhe7Tlxd.js","assets/maestroAuth-CdApllXF.js","assets/main-maestros-D_YZrb46.js","assets/pwaInstaller-Cs9gG4Do.js","assets/vendor-fghBzJSA.js","assets/vendor-COf7rB16.css","assets/idb-CdbSE3_O.js","assets/lifecycleManager-BgmPzZBE.js","assets/preload-helper-CZgWQFsJ.js","assets/main-maestros-j-hYLO3G.css","assets/sistemaView-CGc-cxFz.js","assets/router-DweyPy3s.js","assets/groqService-CYFe0boH.js","assets/CHANGELOG-DPV2OdzA.js","assets/ausenciasPanel-C-DVy3j6.js","assets/ausenciaModal-BGyz7Tee.js","assets/AppModal-B_r6aHTM.js","assets/portalUtils-CkF82Yyk.js"])))=>i.map(i=>d[i]);
import{t as e}from"./main-maestros-D_YZrb46.js";import{i as t}from"./supabase-Dhe7Tlxd.js";import{i as n,n as r,o as i}from"./maestroAuth-CdApllXF.js";import{a,c as o,d as s,f as c,i as l,l as u,n as d,p as f,r as p}from"./pushService-DDP27NH7.js";import{t as m}from"./preload-helper-CZgWQFsJ.js";import{t as h}from"./AppModal-B_r6aHTM.js";import{n as g}from"./phoneUtils-Cpl-jyW9.js";import{t as _}from"./sanitize-9bDGu3i_.js";import{i as v}from"./disponibilidadApi-nw2KBBXV.js";import{n as y}from"./CHANGELOG-DPV2OdzA.js";import{c as b,i as x}from"./portalUtils-CkF82Yyk.js";import{t as S}from"./ausenciaModal-BGyz7Tee.js";var C={async open(){let e=await d(),t=await l();h.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let r=document.getElementById(`col-izquierda`),i=document.getElementById(`col-derecha`);O(r,t),k(r,t),B(r,t),A(i),j(i,t),M(i),N(i,t),i.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),L(i),R(i),J(t),U(t),Y(),m(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./main-maestros-D_YZrb46.js`).then(e=>e.a);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([4,1,5,2,3,6,7,8,0,9,10,11])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&z(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function O(e,t){let n=b(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
