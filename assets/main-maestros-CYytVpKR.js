...
import{$ as e,A as t,D as n,G as r,H as i,J as a,K as o,O as s,W as c,Y as l,Z as u,_ as d,a as f,at as p,et as m,f as h,g,h as _,i as v,it as y,m as b,n as x,nt as S,o as C,ot as w,q as T,r as E,rt as D,s as ee,st as te,t as O,tt as ne,y as re}from"./adminNotificacionesView-B512DX6K.js";import{i as k}from"./supabase-C4ics26R.js";import{a as A,i as j,n as ie,r as M,t as ae}from"./maestroAuth-Cae-9DFh.js";import{t as oe}from"./idb-DOPm7uLh.js";import{i as se,n as ce,t as le}from"./offlineQueue-Cjwl3aiF.js";import{a as ue,c as de,d as fe,f as pe,i as me,l as he,n as N,r as ge,s as _e,t as ve,u as ye}from"./pushService-DQD3mJWH.js";import"./vendor-BWfrAznO.js";import{t as P}from"./AppToast-BOjiJExQ.js";import{t as be}from"./preload-helper-CsoeaaUJ.js";import{t as F}from"./academicService-DX1WEsMf.js";import{a as xe,c as Se,i as I,l as Ce,n as we,o as Te,r as Ee,s as De,t as Oe}from"./portalUtils-CisZ9vg-.js";import{t as ke}from"./AppModal-CLA9fW7x.js";import{n as Ae,r as je}from"./groqService-CAJ0uOvc.js";import{n as Me,t as Ne}from"./ausenciaModal-BAKZ-Gr2.js";import{a as Pe,c as Fe,s as Ie,u as Le}from"./clasesApi-rTtQZLyp.js";import{r as Re,t as ze}from"./permisoService-D0NSQfHK.js";var Be=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ve(e=``){let t=String(e).toLowerCase();return Be.some(e=>t.includes(e.toLowerCase()))}var He=console.error;console.error=function(...e){e.length>0&&!Ve(e[0])&&He.apply(console,e)};var Ue=console.warn;console.warn=function(...e){e.length>0&&!Ve(e[0])&&Ue.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ve(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ve(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var We=window.fetch;window.fetch=async function(...e){try{return await We.apply(window,e)}catch(e){if(!Ve(e.message))throw e;return null}};var Ge=!1;function Ke(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Ge=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function qe(e,t={}){if(!Ge&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var Je=!1;function Ye(e={}){let{enabled:t=!1,consent:n=!1}=e;Je=t&&n,console.log(`[Analytics] Initialized, enabled:`,Je)}var Xe={windowMs:6e4,max:100};function Ze(e={}){Xe={...Xe,...e},console.log(`[RateLimit] Initialized: ${Xe.max} requests per ${Xe.windowMs}ms`)}var Qe=null,$e=new Set;function et(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function tt(e={}){Qe=et(e.length||32),$e.clear(),$e.add(Qe),console.log(`[CSRF] Initialized`)}var nt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function rt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function it(e={}){let{debug:t=!1,onReport:n=null}=e;if(!rt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),at(t,n),ot(t,n),st(t,n),ct(t,n),lt(t,n)}function at(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];nt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function st(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);nt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ct(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function lt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var L={maestro:null,loading:!0,listeners:[]},ut=null;function dt(){L.listeners.forEach(e=>e({...L}))}var ft={subscribe(e){return L.listeners.push(e),()=>{L.listeners=L.listeners.filter(t=>t!==e)}},async init(){if(console.log(`[usePortalAuth.init] Iniciando...`),L.maestro=M(),console.log(`[usePortalAuth.init] Maestro local:`,L.maestro?`found`:`not found`),L.loading=!0,dt(),typeof process<`u`&&{}.VITEST)return L.loading=!1,dt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),L.maestro;if(!ut){let{data:{subscription:e}}=k.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),L.maestro=null,dt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=M();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);let e=await ie();e&&(L.maestro=e,dt())}}});ut=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([ie(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),L.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),L.maestro=null}return L.loading=!1,dt(),console.log(`[usePortalAuth.init] Completado`),L.maestro},setMaestro(e){L.maestro=e,L.loading=!1,dt()},async logout(){await A(),L.maestro=null,dt()},getMaestro:()=>L.maestro,isAuthenticated:()=>!!L.maestro,isLoading:()=>L.loading},pt=ft.logout,mt=`calendario`;function ht(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):mt}function s(e,t=[`login`]){r=e,i=t,a=!0}function c(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.pushState({route:e},``,t),m(e)}function l(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),m(e)}function u(t,n){e.set(t,n)}function d(e){t=e}let f=null;function p(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function m(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}let s=a||t;if(!s)return;let c=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||f){f&&=(f.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),c();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),p(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await c()});f=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{f=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>p(e))})}catch{f=null,c()}}function h(){window.addEventListener(`popstate`,e=>{e.state?.route?m(e.state.route):m(o())});let e=o();e!==mt&&history.replaceState({route:e},``,`#/${e}`),m(e)}return{currentRoute:o,setAuthGuard:s,navigate:c,replace:l,on:u,onNotFound:d,start:h,_dispatch:m}}var R=null,gt=null;function _t(e,t=`polite`){R||(R=document.createElement(`div`),R.setAttribute(`aria-live`,t),R.setAttribute(`aria-atomic`,`true`),R.classList.add(`pm-visually-hidden`),document.body.appendChild(R)),t===`assertive`?(R.setAttribute(`role`,`alert`),R.setAttribute(`aria-live`,`assertive`)):(R.removeAttribute(`role`),R.setAttribute(`aria-live`,`polite`)),clearTimeout(gt),gt=setTimeout(()=>{R.textContent=``,requestAnimationFrame(()=>{R.textContent=e})},50)}function vt(e,t){if(!e||!e.id)return;yt(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function yt(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function bt(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>yt(e))}function xt(e,{onSuccess:t}){e.innerHTML=`
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function wt(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=M();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let o=await S();if(!o||o.length===0){e.innerHTML=`<p class="pm-empty">No tenés clases asignadas.</p>`;return}let s=o.map(e=>e.id),c=Object.fromEntries(o.map(e=>[e.id,e])),l=(await m(s)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!l||l.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${Ee(i)} ${xe(r)}</h2>
        <p class="pm-empty">No tenés clases hoy.</p>
      `;return}let u=new Date(r);u.setDate(u.getDate()-3);let d=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,`0`)}-${String(u.getDate()).padStart(2,`0`)}`,f=new Date(r);f.setDate(f.getDate()-1);let p=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,`0`)}-${String(f.getDate()).padStart(2,`0`)}`,h=(await y(n.id,d,p)||[]).filter(e=>{if(!s.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),g=(await y(n.id,a,a)).filter(e=>s.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),_=new Set(g.map(e=>e.clase_id)),v=await ne(s),b={};for(let e of v||[])e.clase_id&&(b[e.clase_id]=(b[e.clase_id]||0)+1);let x=[...new Set(l.map(e=>e.salon_id).filter(Boolean))],C=x.length>0?await D(x):[],w=Object.fromEntries(C.map(e=>[e.id,e.nombre])),T=l.map(e=>{let t=c[e.clase_id],n=_.has(t.id),r=b[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
  ...
  `,document.head.appendChild(e)}var Tt=null,Et=null;function Dt(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],maestroId:i=null,onSave:a=null}=e;Tt=a,Et=i,ke.open({title:`⚡ Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
          ...
          <div class="pm-emergente-grid">
            ...
            <div class="pm-emergente-field">
              ...
              <select class="pm-emergente-select" id="modal-clase_id" required>
                ...
                ${r.map(e=>`<option value="${e.id}" ${e.id===n?`selected`:``}>${Ot(e.nombre)}</option>`).join(``)}
              </select>
            </div>
            <div class="pm-emergente-field">
  ...
  `}function zt(e){e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);z.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await It(n,z.maestroId),r=Lt(t);z.clasesData=r.clasesData,z.todasSesiones=t.sesiones,z.inscripcionesPorClase=t.inscripcionesPorClase,z.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Rt(r),zt(e),_t(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${I(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=z.clasesData.find(e=>e.id===i)?.alumnos||[],o=z.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
      ...
      </div>`}}var B={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g},Ht={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`};function Ut(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#\[\(\{\$>])/)[0].trim()),n.push(e)}return n}function Wt(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function Gt(e){return{alumnos:Ut(e,B.alumnos),contenido:Ut(e,B.contenido),sugerencias:Ut(e,B.sugerencias),tareas:Ut(e,B.tareas),medidas:Ut(e,B.medidas),calificacion:Wt(e),objetivos:Ut(e,B.objetivos),niveles:Ut(e,B.niveles),nodos:Ut(e,B.nodos),capas:Ut(e,B.capas)}}function Kt(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=Gt(i))}),{...Gt(e),por_capas:n}}function qt(e){if(!e)return``;let t=Jt(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(B.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Ht.capas}22; color:${Ht.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Ht.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Ht.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(B.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(B.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(B.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(B.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(B.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(B.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function Jt(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var Yt=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function Xt(e){if(!e||e.length===0)return Yt.slice(0,6);let t=e.toLowerCase();return Yt.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function Zt(e){let t=Yt.find(t=>t.trigger===e);return t?t.expand:null}function Qt(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function $t(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{p.style.display===`block`?h():m()};let g=$t(e);return e.querySelector(`#btn-help`).onclick=()=>{g.open()},{setContext(e={}){e.presentes!==void 0&&(c.presentes=e.presentes),e.indicadorActivo!==void 0&&(c.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(c.indicadoresDisponibles=e.indicadoresDisponibles)}}}var V=null,tn=[],nn=null,H=-1,rn=!1,an=null,on=!1,sn=0,cn=0;function ln(){if(!V){if(V=document.createElement(`div`),V.id=`pm-autocomplete-popup`,V.className=`pm-autocomplete-popup`,V.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(V)}}function un(e,t,n={}){if(ln(),tn=e||[],nn=t,an=n.trigger||null,H=-1,rn=!0,gn(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),V.style.left=`${i}px`,V.style.top=`${a}px`}V.onmousedown=dn,document.addEventListener(`mousemove`,fn),document.addEventListener(`mouseup`,pn),V.style.display=`block`}function dn(e){e.target.closest(`.pm-ac-option`)||(on=!0,sn=e.clientX-V.offsetLeft,cn=e.clientY-V.offsetTop,V.style.cursor=`grabbing`,V.style.transition=`none`)}function fn(e){if(!on)return;let t=e.clientX-sn,n=e.clientY-cn;V.style.left=`${Math.max(0,t)}px`,V.style.top=`${Math.max(0,n)}px`}function pn(){on&&(on=!1,V.style.cursor=``)}function mn(){V&&(V.style.display=`none`,on=!1,document.removeEventListener(`mousemove`,fn),document.removeEventListener(`mouseup`,pn)),tn=[],nn=null,H=-1,rn=!1,an=null}function hn(e){tn=e||[],H=-1,gn(e)}function gn(e){if(!V)return;if(!e||e.length===0){V.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${bn(an)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===H,o=xn(an,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Cn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Cn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),V.innerHTML=t,V.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{_n(parseInt(e.dataset.index,10))})})}function _n(e){if(e>=0&&e<tn.length){let t=tn[e];nn&&nn(t),mn()}}function vn(e){if(!(!rn||tn.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),H=Math.min(H+1,tn.length-1),gn(tn),yn();break;case`ArrowUp`:e.preventDefault(),H=Math.max(H-1,0),gn(tn),yn();break;case`Enter`:e.preventDefault(),H>=0?_n(H):tn.length>0&&_n(0);break;case`Escape`:e.preventDefault(),mn();break;case`Tab`:tn.length>0&&H===-1&&(e.preventDefault(),_n(0));break}}function yn(){if(!V||H<0)return;let e=V.querySelector(`.pm-ac-option[data-index="${H}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function bn(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function xn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?Sn(t.type):`•`}function Sn(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Cn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function wn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Tn(){return rn}function En(){return H}var Dn={show:un,hide:mn,updateOptions:hn,handleKeyDown:vn,getCursorPosition:wn,isOpen:Tn,getSelectedIndex:En},On=`portal-maestros-catalogs`,kn=1,An={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},jn=null;async function Mn(){return jn||(jn=await oe(On,kn,{upgrade(e){for(let[t,n]of Object.entries(An))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),jn)}async function Nn(e,t){let n=await Mn(),r=await n.get(e,t);if(!r)return null;let i=An[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Pn(e){let t=await(await Mn()).getAll(e),n=An[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Fn(e,t,n){return(await Mn()).getAllFromIndex(e,t,n)}async function In(e,t){let n=await Mn(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Ln(e,t){let n=(await Mn()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Rn(e,t){await(await Mn()).delete(e,t)}async function zn(e){await(await Mn()).clear(e)}async function Bn(e){let t=await Mn(),n=An[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Vn(){let e=await Mn();for(let t of Object.keys(An))await e.clear(t)}async function Hn(e){return(await Pn(e)).length}async function Un(e,t){let n=await Mn(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Wn(e){return(await Mn()).get(`historial`,e)}async function Gn(e,t=5){return(await(await Mn()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var U={get:Nn,getAll:Pn,getByIndex:Fn,set:In,setBulk:Ln,remove:Rn,clear:zn,cleanExpired:Bn,clearAll:Vn,getStoreSize:Hn,addToHistorial:Un,getHistorial:Wn,getTopUsed:Gn};async function Kn(e){if(!e)return[];try{let{data:t,error:n}=await k.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function qn(){let e=await U.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await k.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Jn(){let e=await U.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await k.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Yn(){let e=await U.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await k.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function Xn(){let e=await U.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await k.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function Zn(){let e=await U.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await k.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await k.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await k.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await U.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function Qn(e=null){let t=await U.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=k.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await U.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function $n(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Kn(n.claseId));break;case`[`:r=await qn();break;case`(`:r=await Yn();break;case`{`:r=await Xn();break;case`$`:r=await Jn();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await Zn():await Qn(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=er(r,t)),e&&e!==`#`){let t=(await U.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function er(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=tr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function tr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function nr(e,t){await U.addToHistorial(e,t)}var rr=`
...
`;function ir(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o={};e.innerHTML=`
...
`,fr=class{constructor(e,t=ur){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){this._mounted||(this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(cr)||(this._autoTimer=setTimeout(()=>this.start(),lr)))}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(cr,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=dr,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function mr(t,n=null,r=[],i=[],a={},s){let l=t===`edit`&&!!n,d=l?n:{...a};!l&&a.contenido&&!d.notas_dsl&&(d.notas_dsl=a.contenido),!l&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let f=new e(d),p=document.getElementById(`pm-planificacion-modal`);if(p&&p.remove(),p=document.createElement(`div`),p.id=`pm-planificacion-modal`,p.className=`pm-plan-modal-overlay`,p.innerHTML=gr(l,f,r,i),document.body.appendChild(p),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=_r(),document.head.appendChild(e)}let m=()=>{p.classList.remove(`open`),setTimeout(()=>p.remove(),200)};p.querySelector(`.pm-plan-close-x`).onclick=m,p.querySelector(`.pm-plan-cancel-btn`).onclick=m,p.querySelector(`.pm-plan-backdrop`).onclick=m;let h=e=>{e.key===`Escape`&&(m(),document.removeEventListener(`keydown`,h))};document.addEventListener(`keydown`,h);let g=p.querySelector(`#pl-plantilla`);g&&g.addEventListener(`change`,e=>{let t=pr.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(p.querySelector(`#pl-objetivos`).value=t.objetivos,p.querySelector(`#pl-contenido`).value=t.contenido,p.querySelector(`#pl-recursos`).value=t.recursos,p.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,yr(p))});let _=p.querySelector(`#pl-clase_id`);_&&_.addEventListener(`change`,()=>{let e=p.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${br(r,_.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),vr(p);let v=p.querySelector(`#dsl-editor-container`);if(v){let e=c({onSelect:async e=>{let n=(await o()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=u({initialContent:f.notas_dsl||``,onChange:(e,t)=>{let n=p.querySelector(`#dsl-summary`);n&&(n.textContent=Sr(t))},onAlumnoClick:()=>e.openModal()});v.appendChild(t),p._dslEditor=t}let y=p.querySelector(`.pm-plan-save-btn`);y.onclick=async()=>{let e=p.querySelector(`#pl-tema`)?.value.trim(),t=p.querySelector(`#pl-clase_id`)?.value;if(!e){p.querySelector(`#pl-tema`).focus();return}if(!t){p.querySelector(`#pl-clase_id`).focus();return}y.disabled=!0,y.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=p.querySelector(`#pl-recursos`)?.value||``,r=p._dslEditor,i={clase_id:t,maestro_id:p.querySelector(`#pl-maestro_id`)?.value||null,instrumento:p.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:p.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:p.querySelector(`#pl-objetivos`)?.value.trim(),contenido:p.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:p.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:p.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:l&&p.querySelector(`#pl-estado`)?.value||`planificado`};s&&await s(i),m()}catch(e){console.error(`[planificacionModal] Error:`,e),y.disabled=!1,y.textContent=l?`Guardar cambios`:`Guardar`}};let b=p.querySelector(`.pm-plan-body`);if(b){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;b.firstChild;)t.appendChild(b.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),b.appendChild(e);let i=p.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=r.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&hr(t.instrumento,t.plan_estudio,p)}),f.clase_id)){let e=r.find(e=>e.id===f.clase_id);e?.instrumento&&e?.plan_estudio&&hr(e.instrumento,e.plan_estudio,p)}}requestAnimationFrame(()=>{p.classList.add(`open`),p.querySelector(`#pl-tema`)?.focus()})}async function hr(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await i(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
      ...
      </div>`).join(``)}catch(e){r.innerHTML=`<p class="text-danger small">${e.message}</p>`}}}function gr(e,t,n,r){let i=n.length?n.map(e=>`<option value="${e.id}" ${t.clase_id===e.id?`selected`:``}>${xr(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin clases disponibles</option>`,a=r.length?`<option value="">Sin asignar</option>`+r.map(e=>`<option value="${e.id}" ${t.maestro_id===e.id?`selected`:``}>${xr(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin maestros disponibles</option>`,o=Array.isArray(t.recursos)?t.recursos.join(`, `):``,s=pr.map(e=>`<option value="${e.id}">${e.nombre}</option>`).join(``);return`
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-objetivos" rows="2" maxlength="1000"
              placeholder="¿Qué quieres lograr en esta clase?">${xr(t.objetivos||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-contenido" rows="3" maxlength="2000"
              placeholder="Desarrollo del tema, actividades...">${xr(t.contenido||``)}</textarea>
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-evaluacion" rows="2" maxlength="500"
              placeholder="¿Cómo evaluarás el aprendizaje?">${xr(t.evaluacion_metodo||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-observaciones" rows="2" maxlength="1000"
              placeholder="Notas adicionales...">${xr(t.observaciones||``)}</textarea>
  ...
  `}function vr(e){[{input:`pl-tema`,count:`pl-tema-count`},{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&r.addEventListener(`input`,()=>{i.textContent=r.value.length})})}function yr(e){[{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&(i.textContent=r.value.length)})}function br(e,t,n){let r=e.find(e=>e.id===t);return r?.instrumento?r.instrumento.split(`,`).map(e=>e.trim()).filter(Boolean).map(e=>`<option value="${xr(e)}" ${n===e?`selected`:``}>${xr(e)}</option>`).join(``):``}function xr(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function Sr(e){let t=[];return e.alumnos.length&&t.push(`${e.alumnos.length} alum.`),e.contenido.length&&t.push(`${e.contenido.length} cont.`),e.tareas.length&&t.push(`${e.tareas.length} tar.`),e.calificacion&&t.push(`${e.calificacion.valor}/${e.calificacion.sobre}`),t.length?t.join(`, `):`Sin tokens`}var W={async getClasses(){let{data:e,error:t}=await k.from(`plan_clases`).select(`*`).eq(`activo`,!0).order(`nombre`);return t?(console.error(`Error loading classes:`,t),[]):e},async resolveSmartPlan(e){let t=await this.getClasses();if(!t.length)return null;let n=(e.nombre||``).toLowerCase(),r=(e.instrumento||``).toLowerCase(),i=t.find(e=>(e.nombre||``).toLowerCase()===n);return i||r&&(i=t.find(e=>(e.nombre||``).toLowerCase().includes(r)),i)?i:(i=t.find(e=>{let t=(e.nombre||``).toLowerCase();return n.includes(t)||t.includes(n)}),i||t[0])},async addClass(e){let{data:t,error:n}=await k.from(`plan_clases`).insert([{nombre:e}]).select().single();if(n)throw n;return t},async updateClass(e,t){let{error:n}=await k.from(`plan_clases`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteClass(e){let{error:t}=await k.from(`plan_clases`).delete().eq(`id`,e);if(t)throw t},async getLevelsByClass(e){let{data:t,error:n}=await k.from(`plan_niveles`).select(`*`).eq(`clase_id`,e).order(`numero_nivel`,{ascending:!0});return n?(console.error(`Error loading levels:`,n),[]):t},async addLevel({clase_id:e,nombre:t,numero_nivel:n}){let{data:r,error:i}=await k.from(`plan_niveles`).insert([{clase_id:e,nombre:t,numero_nivel:n||1}]).select().single();if(i)throw i;return r},async updateLevel(e,t){let{error:n}=await k.from(`plan_niveles`).update(t).eq(`id`,e);if(n)throw n},async deleteLevel(e){let{error:t}=await k.from(`plan_niveles`).delete().eq(`id`,e);if(t)throw t},async getNodesByLevel(e){let{data:t,error:n}=await k.from(`plan_temas`).select(`*`).eq(`nivel_id`,e).order(`orden_index`);return n?(console.error(`Error loading topics:`,n),[]):t},async addNode({nivel_id:e,nombre:t,tipo:n}){let{data:r,error:i}=await k.from(`plan_temas`).insert([{nivel_id:e,nombre:t,tipo:n||`TECNICA`}]).select().single();if(i)throw i;return r},async updateNode(e,t){let{error:n}=await k.from(`plan_temas`).update(t).eq(`id`,e);if(n)throw n},async deleteNode(e){let{error:t}=await k.from(`plan_temas`).delete().eq(`id`,e);if(t)throw t},async getObjectivesByNode(e){let{data:t,error:n}=await k.from(`plan_objetivos`).select(`*`).eq(`tema_id`,e).order(`orden_index`);return n?(console.error(`Error loading objectives:`,n),[]):t},async addObjective({tema_id:e,nombre:t}){let{data:n,error:r}=await k.from(`plan_objetivos`).insert([{tema_id:e,nombre:t}]).select().single();if(r)throw r;return n},async updateObjective(e,t){let{error:n}=await k.from(`plan_objetivos`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteObjective(e){let{error:t}=await k.from(`plan_objetivos`).delete().eq(`id`,e);if(t)throw t},async getIndicatorsByObjective(e){let{data:t,error:n}=await k.from(`plan_indicadores`).select(`*`).eq(`objetivo_id`,e).order(`orden_index`);return n?(console.error(`Error loading indicators:`,n),[]):t},async addIndicator({objetivo_id:e,descripcion:t,es_requerido:n}){let{data:r,error:i}=await k.from(`plan_indicadores`).insert([{objetivo_id:e,descripcion:t,es_requerido:n??!0}]).select().single();if(i)throw i;return r},async updateIndicator(e,t){let{error:n}=await k.from(`plan_indicadores`).update(t).eq(`id`,e);if(n)throw n},async deleteIndicator(e){let{error:t}=await k.from(`plan_indicadores`).delete().eq(`id`,e);if(t)throw t},async getRouteHierarchy(e){let t=e;if(!t){let e=await this.getClasses();if(e.length>0)t=e[0].id;else return null}let{data:n,error:r}=await k.from(`plan_niveles`).select(`
        *,
        plan_temas (
          *,
          plan_objetivos (
      ...
      `).eq(`clase_id`,t).order(`numero_nivel`);return r?(console.error(`Error loading hierarchy:`,r),null):n},async importStructure(e,t){if(!e||!t)throw Error(`Faltan datos para la importación.`);console.log(`[Adapter] Iniciando importación masiva optimizada (4 niveles) para clase: ${e}`);for(let n of t.niveles||[]){let{data:t,error:r}=await k.from(`plan_niveles`).insert([{clase_id:e,nombre:n.nombre,numero_nivel:n.numero_nivel||1,objetivo_general:n.objetivo_general}]).select().single();if(r)throw r;let i=(n.temas||[]).map(e=>({nivel_id:t.id,nombre:e.nombre,tipo:e.tipo||`TECNICA`,es_critico:e.es_critico||!1,_originalRef:e}));if(!i.length)continue;let{data:a,error:o}=await k.from(`plan_temas`).insert(i.map(({_originalRef:e,...t})=>t)).select();if(o)throw o;for(let e=0;e<a.length;e++){let t=a[e],n=i[e]._originalRef.objetivos||[];if(!n.length)continue;let r=n.map(e=>({tema_id:t.id,nombre:e.nombre||e,_originalRef:e})),{data:o,error:s}=await k.from(`plan_objetivos`).insert(r.map(({_originalRef:e,...t})=>t)).select();if(s)throw s;let c=[];if(o.forEach((e,t)=>{let n=r[t]._originalRef;n.indicadores&&n.indicadores.length>0&&n.indicadores.forEach(t=>{c.push({objetivo_id:e.id,descripcion:t.descripcion,es_requerido:t.es_requerido??!0})})}),c.length>0){let{error:e}=await k.from(`plan_indicadores`).insert(c);if(e)throw e}}}return console.log(`[Adapter] Importación masiva (4 niveles) completada con éxito.`),!0}},G={activeClassId:null,activeLevelId:null,activeNodeId:null,activeObjectiveId:null};async function Cr(e,t=null){t&&(G.activeClassId=t),e.innerHTML=`
  ...
  `,await Er()}async function wr(e,t,n,r){ke.open({title:`Editar ${e}`,body:`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Tr(`Clase`,null,()=>Er()),G.activeClassId?Dr(G.activeClassId):jr(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),wr(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Er())},e.onclick=()=>{G.activeClassId=t,G.activeLevelId=G.activeNodeId=G.activeObjectiveId=null,Er(),Dr(t),jr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),jr(`#pm-rc-objs-wrapper`,`Elegí Tema`),jr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Dr(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await W.getLevelsByClass(e);!n.some(e=>e.id===G.activeLevelId)&&n.length>0?G.activeLevelId=n[0].id:n.length===0&&(G.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Tr(`Nivel`,e,()=>Dr(e)),G.activeLevelId?Or(G.activeLevelId):jr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),wr(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Dr(e))},t.onclick=()=>{G.activeLevelId=n,G.activeNodeId=G.activeObjectiveId=null,Dr(e),Or(n),jr(`#pm-rc-objs-wrapper`,`Elegí Tema`),jr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Or(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await W.getNodesByLevel(e);!n.some(e=>e.id===G.activeNodeId)&&n.length>0?G.activeNodeId=n[0].id:n.length===0&&(G.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Tr(`Tema`,e,()=>Or(e)),G.activeNodeId?kr(G.activeNodeId):jr(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),wr(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Or(e))},t.onclick=()=>{G.activeNodeId=n,G.activeObjectiveId=null,Or(e),kr(n),jr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function kr(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await W.getObjectivesByNode(e);!n.some(e=>e.id===G.activeObjectiveId)&&n.length>0?G.activeObjectiveId=n[0].id:n.length===0&&(G.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Tr(`Objetivo`,e,()=>kr(e)),G.activeObjectiveId?Ar(G.activeObjectiveId):jr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),wr(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>kr(e))},t.onclick=()=>{G.activeObjectiveId=n,kr(e),Ar(n)}})}async function Ar(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
  ...
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Tr(`Indicador`,e,()=>Ar(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=()=>{let n=t.dataset.id,r=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;wr(`Indicador`,n,r,()=>Ar(e))}})}function jr(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}var Mr=null;function Nr(e,t){Mr=e}function Pr(e){Mr&&Mr(e)}function Fr(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Ir(e,{claseId:t,rutaId:n,completedTopics:r=[],onIndicadorSelect:i}){let a=[],o=!1,s=null,c=document.createElement(`div`);if(c.className=`pm-route-bar-wrapper`,e.appendChild(c),!document.getElementById(`pm-route-bar-styles`)){let e=document.createElement(`style`);e.id=`pm-route-bar-styles`,e.textContent=`
        ...
        ${(e.plan_temas||[]).map(e=>`
          <div class="pm-tree-node" data-type="node">
            <div class="pm-tree-header">
              <span class="pm-tree-title">${Fr(e.nombre)}</span>
              <span class="pm-tree-badge">${e.tipo}</span>
            </div>
          </div>
          <div class="pm-tree-children">
            ${(e.plan_objetivos||[]).map(e=>{let t=(r||[]).includes(e.nombre);return`
                <div class="pm-tree-obj" data-type="obj" data-id="${e.id}" data-nombre="${Fr(e.nombre)}">
                  <i class="bi ${t?`bi-check-circle-fill text-success`:s?.id===e.id?`bi-circle-fill text-primary`:`bi-circle`}"></i>
                  <span style="${t?`text-decoration: line-through; opacity: 0.6;`:``}">${Fr(e.nombre)}</span>
                </div>
              `}).join(``)}
          </div>
        `).join(``)}
      </div>
    `).join(``)}async function d(){if(n){o=!0,u();try{a=await W.getRouteHierarchy(n)}catch(e){console.error(`[routeTreeBar] Error:`,e)}finally{o=!1,u()}}}function f(){c.removeEventListener(`click`,l),c.remove()}function p(){return s}return d(),{refresh:d,destroy:f,getActiveIndicador:p}}function Lr(e){return!e||typeof e!=`string`||!e.trim()||/[#\[\(\{\$>]/.test(e)?`dsl`:`natural`}function Rr(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=Kt(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function zr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Br(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Vr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await k.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Hr(e,t){let{data:n,error:r}=await k.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await k.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await k.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Br(a??[],l),indicators:n,totalAlumnos:l}}async function Ur(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Lr(e);try{let t=e;i===`natural`&&(t=await je(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=zr(Rr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Wr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function K(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Gr(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function Kr(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function qr(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function Jr(e,t){let{data:n,error:r}=await k.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await k.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=qr(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function Yr(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${K(Gr(e.nombre_completo))}</div>
      <div>
  ...
  `}function Xr(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${K(Kr(e.created_at))}</span>
  ...
  `}function Zr(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Qr(e){return e.length?`
  ...
  `:``}function $r(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${Yr(e,n)}
  ...
  `}function ni({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Wr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){De()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=Ce(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=M();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await k.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=ei(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=Me(o,{onClose:()=>h()});try{let n=await Jr(e.id,t);s=n.indicatorSummaries,o.innerHTML=$r(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=ti(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}function ri({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ii(e,t,n){let{data:r,error:i}=await k.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await k.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await k.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function ai(e,t){let{data:n,error:r}=await k.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function oi(e){let{error:t}=await k.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function si(e,t,n,r,i=null){let{error:a}=await k.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await k.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var ci=`soi_ruta_tema_pendiente`;function li(e){sessionStorage.setItem(ci,JSON.stringify(e))}function ui(){let e=sessionStorage.getItem(ci);if(!e)return null;sessionStorage.removeItem(ci);try{return JSON.parse(e)}catch{return null}}function di(e,{onSave:t,onCancel:n}){let r=document.getElementById(`pm-justif-modal`);if(!r&&(r=document.createElement(`div`),r.id=`pm-justif-modal`,r.className=`pm-justif-modal-overlay`,r.innerHTML=`
    ...
    `,document.body.appendChild(r),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let i=null,a=null,o=null,s=null,c=!1,l=null,u=null,d=r.querySelector(`#pm-justif-title`),f=r.querySelector(`#pm-justif-subtitle`),p=r.querySelector(`#pm-justif-btn-text`),m=r.querySelector(`#pm-justif-alumno-nombre`),h=r.querySelector(`#pm-justif-motivo`),g=r.querySelector(`#pm-justif-file`),_=r.querySelector(`.pm-justif-file-placeholder`),v=r.querySelector(`.pm-justif-file-preview`),y=r.querySelector(`#pm-justif-preview-img`),b=r.querySelector(`#pm-justif-remove-file`);function x(e,t=null,n=null){i=e,a=t,o=null,s=null,c=!!t,l=n,c?(d.textContent=`Editar Justificación`,f.textContent=`Modifica el motivo de la inasistencia`,p.textContent=`Actualizar`):(d.textContent=`Justificar Inasistencia`,f.textContent=`Registra el motivo de la ausencia`,p.textContent=`Guardar Justificación`),m.textContent=e.nombre_completo,h.value=t?.motivo||``;let b=t?.evidencia_url||t?.evidencia_base64;b?(s=b,y.src=b,_.style.display=`none`,v.style.display=`block`):(s=null,_.style.display=`flex`,v.style.display=`none`),g.value=``,r.classList.add(`open`),h.focus();let x=r.querySelector(`.pm-justif-modal`);x&&(u&&u.dispose(),u=Me(x,{onClose:()=>S(!0)}))}function S(e=!1){e&&n&&i&&l!==null&&n(i.id,l),r.classList.remove(`open`),i=null,a=null,o=null,s=null,l=null,u&&=(u.dispose(),null)}r.querySelector(`#pm-justif-close`).onclick=()=>S(!0),r.querySelector(`#pm-justif-cancel`).onclick=()=>S(!0),r.querySelector(`.pm-justif-backdrop`).onclick=()=>S(!0),g.onchange=e=>{let t=e.target.files[0];t&&(o=t,s=URL.createObjectURL(t),y.src=s,_.style.display=`none`,v.style.display=`block`)},b.onclick=()=>{s&&!(a?.evidencia_url||a?.evidencia_base64)&&URL.revokeObjectURL(s),o=null,s=null,g.value=``,_.style.display=`flex`,v.style.display=`none`},r.querySelector(`#pm-justif-save`).onclick=()=>{let e=h.value.trim();if(!e){h.focus(),h.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{h.style.borderColor=``},2e3);return}t&&i&&t({alumnoId:i.id,motivo:e,evidenciaFile:o,evidenciaPreview:s,justificacionId:a?.id||null,existingUrl:a?.evidencia_url||a?.evidencia_base64||null,isEdit:c})};let C=e=>{e.key===`Escape`&&(S(),document.removeEventListener(`keydown`,C))};return document.addEventListener(`keydown`,C),{open:x,close:S}}var fi=`documentos`;async function pi(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await k.storage.from(fi).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=k.storage.from(fi).getPublicUrl(r);return o.publicUrl}async function mi({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await pi(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await k.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function hi(e,t){if(!e||!t)return null;let{data:n,error:r}=await k.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function gi(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await k.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function _i(e,t,n,r,i=`Clase`){if(!r||r.length===0)return{success:!0};let a=r.filter(e=>e.observacion&&e.observacion.trim().length>0);if(a.length===0)return{success:!0};let o=a.map(r=>new s({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON()),{data:c,error:l}=await k.from(`observaciones_alumnos`).upsert(o,{onConflict:`sesion_clase_id,alumno_id`});return l?(console.error(`[Promotion] Error promoviendo observaciones:`,l),{success:!1,error:l.message}):{success:!0,data:c}}function vi(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}async function yi(e,{claseId:t,fecha:n}={}){let r=typeof e==`string`?document.getElementById(e):e;if(!r){console.error(`[asistenciaView] Container not found:`,e);return}r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=M();if(!i){r.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){r.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let a=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,s,c]=await Promise.all([S(),m([t]),ne([t]),k.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,i.id).eq(`fecha`,a).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let l=n.find(e=>e.id===t);if(!l){console.log(`[DEBUG] Clase not found in misClases`),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let u=o.find(t=>t.dia?.toLowerCase()===e),d=(s||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),f=c.data?.[0],p=f?.id||null,h=f?.updated_at||null,g=f?.contenido||``,_=l.salon?[l.salon]:[],[v,y]=await Promise.all([p?k.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,p).then(e=>e.data||[]):Promise.resolve([]),_.length>0?D(_):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let b=y.length>0?y[0].nombre:null,x=`pm_asistencia_${t}_${a}`,C=localStorage.getItem(`${x}_updated`),w=!1;h&&C&&new Date(h).getTime()>new Date(C).getTime()+5e3&&(w=!0);let T=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await k.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();T=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let E={},ee={};d.forEach(e=>{E[e.id]=null});let te=f?.asistencia||[];if(te.length===0&&p)try{let{data:e}=await k.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,p);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};te=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let O={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};te.forEach(e=>{if(E.hasOwnProperty(e.alumno_id)){let t=O[e.estado]??e.estado;E[e.alumno_id]=t}});let re=[];if(p)try{re=await k.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,p).then(e=>e.data||[]),re.forEach(e=>{E.hasOwnProperty(e.alumno_id)&&(E[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}let A=di(document.body,{onSave:async({alumnoId:e,motivo:n,evidenciaFile:r,evidenciaPreview:o,justificacionId:s,existingUrl:c,isEdit:l})=>{try{if(l&&s){let e=c;if(r){if(c){let e=c.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await k.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await k.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${r.name.split(`.`).pop()}`,r).catch(()=>({data:null}));if(t){let{data:n}=k.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{error:t}=await k.from(`justificaciones`).update({motivo:n,evidencia_url:e}).eq(`id`,s).select().single();if(t)throw t}else{let o=await mi({sesionId:p,alumnoId:e,claseId:t,fecha:a,motivo:n,creadoPor:i.id},r);if(o.error)throw o.error}A.close()}catch(e){console.error(`[justificacion] Error guardando:`,e)}},onCancel:(e,t)=>{E[e]=t,renderLista(e),_updateProgress()}});bi(r,{clase:l,horario:u,alumnos:d,estado:E,justificaciones:ee,maestro:i,fechaHoy:a,claseId:t,sesionId:p,hasConflict:w,serverDSL:g,snapshots:v,salonNombre:b,rutaId:T,sesionExistenteData:f,_justifModal:A})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function bi(e,r){let{clase:i,horario:a,alumnos:o,estado:s,justificaciones:c,maestro:l,fechaHoy:u,claseId:d,snapshots:f,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v,_justifModal:y}=r,b=r.sesionId,x=[],C=`pm_asistencia_${d}_${u}`,w=m,T=null,E=vi(),D=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          ...
          <p class="pm-asist-subtitle">
            ${g?`📍 ${I(g)} · `:``}
            ${a?`${Te(a.hora_inicio)} – ${Te(a.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${xe(new Date(u+`T12:00:00`))}</span> · 
            ${o.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let ee=e.querySelector(`#pm-dsl-toolbar-container`),te=e.querySelector(`#pm-dsl-editor-container`),O=ir(te,{initialContent:m,onChange:e=>{w=e}});O.setContext({claseId:d});let ne=sr(e,{onAceptar:e=>{O.setValue(e)}}),re=Qt(e,{onAccept:e=>{O.setValue(e)}}),A=en(ee,{onInsert:(e,t,n)=>O.insertText(e,t,n),getEditorContent:()=>O.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=ee.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Ae(e);ne.open({original:e,improved:t})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=ee.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=D?.getActiveIndicador(),n=await je(e,{presentes:o.filter(e=>s[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});re.open({original:e,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}}}),j=null,ie=e.querySelector(`#pm-planificacion-card`),M=e.querySelector(`#pm-planificacion-dropdown`),ae=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let oe=e.querySelector(`#pm-plan-list-rutas`),se=e.querySelector(`#pm-plan-list-planificaciones`),ce=e.querySelector(`#pm-planificacion-header`);ce&&ce.addEventListener(`click`,()=>{let e=ie.classList.toggle(`open`);M.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;oe.style.display=n===`rutas`?``:`none`,se.style.display=n===`planificaciones`?``:`none`})});function ue(t){j=t.id,localStorage.setItem(`pm_default_plan_${d}`,t.id),ae&&(ae.textContent=t.nombre||t.name||`Sin nombre`),se.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),D&&=(D.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);j&&n&&(n.innerHTML=``,we(d).then(e=>{D=Ir(n,{claseId:d,rutaId:j,completedTopics:e,onIndicadorSelect:e=>{O.insertText(`[${e.nombre}] `),A.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),ie.classList.remove(`open`),M.style.display=`none`}}),x.push(()=>D.destroy())}))}let de=e.querySelector(`#btn-manage-planning`);de&&(de.onclick=e=>{if(e.stopPropagation(),!j){ke.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}ke.open({title:`Gestionar Estructura: ${ae.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(D&&D.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Cr(t,j)}),ie&&(async()=>{try{let e=await W.getClasses(),t=localStorage.getItem(`pm_default_plan_${d}`),n=(i.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});oe&&(oe.innerHTML=r.length?r.map(e=>`
              ...
              </div>`).join(``):`<div style="padding:0.5rem;font-size:0.8rem;color:var(--pm-text-muted)">No hay planes sugeridos para este instrumento</div>`,oe.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=r.find(t=>t.id===e.dataset.planId);t&&ue(t)})})),se&&(se.innerHTML=e.map(e=>`
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${I(e.nombre||e.name)}</span>
            </div>`).join(``),se.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&ue(n)})})),ie.style.display=``;let a=e.find(e=>e.id===t)||r[0]||await W.resolveSmartPlan(i);a&&ue(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let fe=e.querySelector(`#btn-copy-as-plan`);fe&&fe.addEventListener(`click`,async()=>{let e=O.getValue();mr(`create`,null,await S(),[],{clase_id:d,maestro_id:l?.id||null,maestro_nombre:l?.nombre_completo||null,contenido:e||``,fecha_inicio:u},async e=>{try{await t({...e,estado:`planificado`});let n=document.createElement(`div`);n.className=`pm-toast-success`,n.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(n),setTimeout(()=>n.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),_&&(D=Ir(e.querySelector(`#pm-route-tree-container`),{claseId:d,rutaId:_,onIndicadorSelect:t=>{O.insertText(`[${t.nombre}] `),A.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),x.push(()=>D.destroy())),console.log(`[DEBUG] Reached handoff section`);let pe=ui();if(pe&&pe.claseId===d){let t=`[${pe.nombre}] `;O.insertText(t),A.setContext({indicadorActivo:pe.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        Tema cargado desde Ruta: <strong>${pe.nombre.replace(/</g,`&lt;`)}</strong>
        <button onclick="this.parentElement.remove()" style="
          margin-left:auto;background:none;border:none;cursor:pointer;
          font-size:12px;color:#1d4ed8;
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let me=null,he=e.querySelector(`#pm-draft-indicator`);if(b){me=ri({saveFn:async e=>{b&&await ii(b,l.id,e)},debounceMs:3e4}),me.onSaved(()=>{let e=new Date;he.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,he.style.display=``}),O.getValue;let e=te.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),me&&me.onInput(O.getValue())}}x.push(()=>me.destroy()),v?.borrador===!0&&ai(b,l.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(O.setValue(e.contenido_raw),w=e.contenido_raw):oi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let N=e.querySelector(`#btn-guardar-obs`);N&&(_&&(N.style.display=``),N.onclick=async()=>{let t=O.getValue();if(!t||!t.trim()){P.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!b){P.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let n=null,r=await Ee(t),a=D?.getActiveIndicador();if(n=r||a,!n){P.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let c=e.querySelector(`#pm-active-tema-badge`);c&&n.nombre&&(c.textContent=n.nombre,c.style.display=`inline-block`),N.disabled=!0,N.textContent=`Procesando...`;try{let e=o.filter(e=>s[e.id]===`P`),r=await Ur(t,n.id,e,n.nombre);if(r.error)throw Error(r.error);if(r.modo===`natural`&&r.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+r.dslGenerado+`

¿Guardar la evaluación?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(r.missing.length>0&&!confirm(`Faltan ${r.missing.length} alumno(s) sin evaluar:\n${r.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(r.evaluaciones.length>0){let{error:e}=await Vr(b,n.id,r.evaluaciones,l.id);if(e)throw e}let a={indicador_id:n.id,evaluaciones:r.evaluaciones};await si(b,l.id,t,a,r.dslGenerado||null);let c=await _i(b,d,l.id,r.evaluaciones,i.nombre||`Clase`);c.success||console.warn(`[Fase C] Fallo parcial en promoción:`,c.error),D&&await D.refresh(),O.setValue(``),w=``;let u=document.createElement(`div`);u.innerHTML=`
        ...
        `,u.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(u),setTimeout(()=>u.remove(),4500),N.textContent=`¡Guardado!`,setTimeout(()=>{N.textContent=`Guardar observación`,N.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),P.error(`Error al guardar: `+(e.message||e)),N.disabled=!1,N.textContent=`Guardar observación`}});let ge=null,_e=e.querySelector(`#pm-alumnos-list`);function ve(e=null){let t=xi(o,s),n=null;if(e){let t=_e.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(_e.innerHTML=t.map(e=>ye(e,s[e.id])).join(``),e&&n){let t=_e.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function ye(e,t){return`
    ...
    `}_e.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),r=t.target.closest(`.pm-asist-nombre`);if(r){let t=r.closest(`.pm-asist-item`).dataset.id,n=o.find(e=>e.id===t);if(_){ge&&ge.destroy(),ge=ni({alumno:n,rutaId:_,sessionId:b,claseId:d,fecha:u,horaInicio:a?.hora_inicio||null}),ge.open(),x.push(()=>{ge&&ge.destroy()});return}let i=f.filter(e=>e.student_id===t);if(i.length===0)try{let{academicService:e}=await be(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(b,t,u);n?(i=n,f.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}or(e,{student:n,sessionId:b,teacherId:l.id,snapshots:i});return}if(!n)return;let{id:i,action:c}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),c===`J`){let e=o.find(e=>e.id===i);if(!e)return;if(s[i]===`J`){if(b){let e=await hi(b,i);if(e?.id){if(e.evidencia_url){let t=e.evidencia_url.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);t&&k.storage.from(`documentos`).remove([t[1]]).catch(()=>{})}gi(e.id).catch(console.warn)}}s[i]=null,ve(i),F(),await Se(!0),_t(`Justificación eliminada para ${e.nombre_completo}.`)}else{s[i]=`J`,ve(i),F(),await Se(!0);let t=null;b&&(t=await hi(b,i)),y.open(e,t,null),_t(`Justificación marcada para ${e.nombre_completo}.`)}return}s[i]=s[i]===c?null:c,ve(i),F();let p=Object.values(s).filter(e=>e===`P`).length,m=Object.values(s).filter(e=>e===`A`).length,h=Object.values(s).filter(e=>e===`J`).length;_t(`Asistencia actualizada. ${p} presentes, ${m} ausentes, ${h} justificados.`),await Se(!0)};function F(){let t=o.length,n=Object.values(s).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),a=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,a.textContent=`${n}/${t}`}async function Se(e=!1,t=!1){T&&clearTimeout(T);let n=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t={clase_id:d,maestro_id:l.id,fecha:u,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:w||``};if(navigator.onLine)try{if(b){let{error:e}=await k.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,b);if(!e){localStorage.setItem(`${C}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await k.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){b=e.id,console.log(`[asistencia] Nueva sesión creada:`,b),localStorage.setItem(`${C}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await le({tabla:`sesiones_clase`,operacion:b?`update`:`insert`,payload:{...b?{id:b}:{},...t}}),localStorage.setItem(`${C}_updated`,new Date().toISOString())};e?t?await n():await E.run(n):T=setTimeout(()=>{E.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),r=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await E.run(async()=>{try{let r=o.filter(e=>s[e.id]).map(e=>({clase_id:d,alumno_id:e.id,fecha:u,estado:s[e.id],registrado_por:l.id})),a=r.length>0,c=w&&w.trim().length>0;if(!a&&!c)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Se(!0,!0),!b){let{data:e}=await k.from(`sesiones_clase`).select(`id`).eq(`clase_id`,d).eq(`maestro_id`,l.id).eq(`fecha`,u).maybeSingle();e&&(b=e.id)}if(a)try{let e=r.map(e=>({...e,...b&&{sesion_clase_id:b}}));await n(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){throw console.error(`[asistencia] Error registrando asistencias en bulk:`,e),Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(b&&(a||c)){let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),{error:t}=await k.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await k.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,b).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await k.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,b))}p(),Pr(`hoy`),Pr(`calendario`),Pr(`metricas`)}if(b){let{academicService:n}=await be(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await be(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BQVYinl0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await n.processSessionClosure(b);i&&i.length>0&&(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i))}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let f=Object.values(s).filter(e=>e===`P`).length,m=Object.values(s).filter(e=>e===`A`).length;_t(`Sesión guardada exitosamente. ${f} presentes, ${m} ausentes.`);let h=document.createElement(`div`);if(h.className=`pm-saved-overlay`,h.innerHTML=`
      ...
      `,e.querySelector(`.pm-asist-root`).appendChild(h),!document.getElementById(`pm-saved-styles`)){let e=document.createElement(`style`);e.id=`pm-saved-styles`,e.textContent=`
          .pm-saved-overlay {
            position: absolute;
            inset: 0;
        ...
        `,document.head.appendChild(e)}let g=h.querySelector(`#btn-editar-asistencia`),_=h.querySelector(`#btn-compartir-correo`),v=h.querySelector(`#btn-compartir-whatsapp`),y=h.querySelector(`#btn-volver-hoy`),x=h.querySelector(`#btn-ir-calendario`);g&&(g.onclick=()=>{h.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),_&&(_.onclick=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${i.nombre} - ${u}`),n=encodeURIComponent(Ce(e,w,o,i));window.open(`mailto:?subject=${t}&body=${n}`,`_blank`)}),v&&(v.onclick=async()=>{let e=o.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(Ce(e,w,o,i));window.open(`https://wa.me/?text=${t}`,`_blank`)}),y&&(y.onclick=()=>{window.location.hash=`#/hoy`}),x&&(x.onclick=()=>{window.location.hash=`#/calendario`})}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=r,t.style.background=``},3e3)}})};function Ce(e,t,n,r){let i=e.filter(e=>e.estado===`P`).length,a=e.filter(e=>e.estado===`A`).length,o=e.filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre}\n`;return s+=`Fecha: ${u}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,e.forEach(e=>{let t=n.find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}e.querySelector(`#pm-asist-back`).onclick=()=>{De.destroy();try{y.close()}catch{}x.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{o.forEach(e=>{s[e.id]=`P`}),ve(),F(),await Se(!0),_t(`Todos los ${o.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{o.forEach(e=>{s[e.id]=`A`}),ve(),F(),await Se(!0),_t(`Todos los ${o.length} alumnos marcados como ausentes.`)},ve();async function we(e){try{let{data:t}=await k.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Ee(e){if(!e||!j)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await W.getRouteHierarchy(j),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let De=new fr(e);De.mount();let Oe=e.querySelector(`#pm-btn-help`);return Oe&&(Oe.onclick=()=>De.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),De.destroy();try{y.close()}catch{}x.forEach(e=>{try{e()}catch{}})}}function xi(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Si(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Ci(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await k.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Si(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await le({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var wi={async open(){let e=await ve(),t=await ge();ke.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await fe()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await ye();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await pe()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await de({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},Ti={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function Ei(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>Ti[e])}var Di={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Ai(n,t),ji(n,t),Ri(n,t),Mi(r),Ni(r,t),Pi(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Fi(r),Ii(r),Ki(t),Vi(t),qi(),be(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-D0NSQfHK.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Li(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Ai(e,t){let n=Se(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ji(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Mi(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ni(e,t){let n=me(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Pi(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Fi(e){e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function Ii(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Li(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await be(async()=>{let{getPermisos:e}=await import(`./permisoService-D0NSQfHK.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));Li(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Ri(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Oi.map(e=>zi(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function zi(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function Vi(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{q.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>Hi(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,Wi),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await ye();e.success?(q.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await pe(),q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>wi.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>Di.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await fe();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>Gi(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>Gi(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>Gi(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await be(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-BrxV20p_.js`);return{ausenciasPanel:e}},__vite__mapDeps([10,3,11,7,5,12,1,13]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>Ne.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,Bi(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function Hi(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=d(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=Ui();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}q.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await re(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await k.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let s={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(ae,JSON.stringify(s)),q.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{q.saving=!1,a.disabled=!1,a.innerHTML=o}}function Ui(){let e={};return Oi.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function Wi(){ke.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await A(),window.location.reload(),!0)})}function Gi(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),q.theme=e}function Ki(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function qi(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var Ji=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`).trim():``}async function ia(e,t){let n=e.querySelector(`#pm-alumno-progreso-root`);if(n)try{let{data:e,error:r}=await k.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1});if(r)throw r;if(!e||e.length===0){n.innerHTML=`<p class="pm-empty">Sin evaluaciones registradas.</p>`;return}let i=[...new Set(e.map(e=>e.indicator_id))],{data:a}=await k.from(`indicators`).select(`id, nombre, node_id`).in(`id`,i),o=[...new Set((a||[]).map(e=>e.node_id).filter(Boolean))],{data:s}=await k.from(`nodes`).select(`id, name`).in(`id`,o),c=new Map((s||[]).map(e=>[e.id,e.name])),l=new Map((a||[]).map(e=>[e.id,e])),u=new Map;for(let t of e){if(u.has(t.indicator_id))continue;let e=l.get(t.indicator_id);u.set(t.indicator_id,{id:t.indicator_id,nombre:e?.nombre||``,nodeName:c.get(e?.node_id)||``,latest:t,history:[]})}for(let t of e)if(u.has(t.indicator_id)){let e=u.get(t.indicator_id);(e.history.length===0||e.history[0].id!==t.id)&&e.history.push(t)}let d=Array.from(u.values()).filter(e=>e.latest.nota!=null&&e.latest.nota!==0||e.latest.observations&&e.latest.observations.trim()!==``),f=d.filter(e=>e.latest.nota>=4).length,p=d.length,m=p>0?Math.round(f/p*100):0;function h(e){return e==null?`⚫`:e>=4?`🟢`:e>=2?`🟡`:`🔴`}function g(e){return e==null?`pm-route-indicador--gray`:e>=4?`pm-route-indicador--green`:e>=2?`pm-route-indicador--yellow`:`pm-route-indicador--red`}n.innerHTML=`
    ...
    `,n.querySelectorAll(`.pm-eval-indicador`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.querySelector(`.pm-eval-timeline`),n=e.querySelector(`.pm-eval-toggle`),r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.classList.toggle(`bi-chevron-down`,r),n.classList.toggle(`bi-chevron-up`,!r)})})}catch(t){let n=e.querySelector(`#pm-alumno-progreso-root`);n&&(n.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger);">Error al cargar evaluaciones: ${I(t.message)}</p>`)}}async function aa(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=M();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){e.innerHTML=`<p class="pm-empty">No se especificó el alumno.</p>`;return}try{let{data:r,error:i}=await k.from(`alumnos`).select(`id, nombre_completo, instrumento_principal, tlf_alumno, fecha_nacimiento, created_at, nivel_actual, representante_nombre, representante_tlf, correo_representante, direccion`).eq(`id`,t).single();if(i||!r){console.error(`[AlumnoPerfil] Error al obtener alumno:`,i),e.innerHTML=`
      ...
      `;return}let{data:a}=await k.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await k.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await k.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await k.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await k.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,_=c.filter(e=>e.estado===`J`).length,v=c.filter(e=>e.estado===`T`).length,y=p>0?Math.round(m/p*100):0,b=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],x=b.length>0?Math.round(b.reduce((e,t)=>e+t.nota,0)/b.length*10)/10:0,S=b.filter(e=>e.nota>=4).length,C=b.length,w=C>0?Math.round(S/C*100):0,T={};c.forEach(e=>{T[e.clase_id]||(T[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(T[e.clase_id][e.estado]=(T[e.clase_id][e.estado]||0)+1,T[e.clase_id].total++)});let E=new Set([...o,...Object.keys(T)]),{data:D}=E.size>0?await k.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...E]):{data:[]},ee=new Map((D||[]).map(e=>[e.id,e])),te=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),O=l?.filter(e=>e.observations?.trim())||[],ne=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;ne=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&ne--}let re=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,A=(r.instrumento_principal||``).toLowerCase(),j=`var(--pm-primary)`;(A.includes(`violin`)||A.includes(`cuerda`))&&(j=`#FF3B30`),(A.includes(`piano`)||A.includes(`teclado`))&&(j=`#FF9500`),A.includes(`guitarra`)&&(j=`#5856D6`),(A.includes(`canto`)||A.includes(`voz`))&&(j=`#AF52DE`),e.innerHTML=`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-clases-grid">
              ${o.map(e=>{let t=ee.get(e);if(!t)return``;let n=T[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null;return`
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${te.map(e=>{let t=ee.get(e.clase_id),n=ra(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion">
            <summary class="pm-zen-accordion-header">
              ...
              <span class="pm-zen-accordion-meta">${O.length} observación${O.length===1?``:`es`}</span>
              <i class="bi bi-chevron-down pm-accordion-chevron"></i>
            </summary>
            <div class="pm-zen-desenvolvimiento" style="margin-top:0.75rem;">
              ${O.map(e=>{let t=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
          ...
          <details class="pm-zen-section pm-zen-accordion" ${c.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${c.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:c.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=ee.get(e.clase_id),i=e.estado===`J`?f.get(e.sesion_id):null;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${g(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ie=Zi(r.tlf_alumno||r.representante_tlf);if(ie){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var oa={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},sa={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},ca={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function la(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(oa))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function ua(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await k.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await k.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
    ...
    `,e.querySelector(`#pm-student-select`).addEventListener(`change`,async t=>{let n=t.target.value;if(!n){e.querySelector(`#pm-progress-content`).innerHTML=``;return}await da(e,n)})}catch(t){e.innerHTML=`<p class="pm-empty">Error: ${I(t.message)}</p>`}}async function da(e,t){let n=e.querySelector(`#pm-progress-content`);n.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:e}=await k.from(`alumnos`).select(`nombre, apellido`).eq(`id`,t).single(),{data:r}=await k.from(`academic_plans`).select(`id, route_version_id, status`).eq(`student_id`,t).in(`status`,[`in_process`,`active`]).order(`created_at`,{ascending:!1}).limit(1).maybeSingle();if(!r){n.innerHTML=`
      ...
      `;return}let{data:i}=await k.from(`levels`).select(`*`).eq(`route_version_id`,r.route_version_id).order(`level_number`,{ascending:!0}),{data:a}=await k.from(`student_level_progress`).select(`*`).eq(`student_id`,t),{data:o}=await k.from(`nodes`).select(`*, indicators(*)`).in(`level_id`,(i||[]).map(e=>e.id)).order(`order_index`,{ascending:!0}),{data:s}=await k.from(`student_node_progress`).select(`*, indicator_attempts(*)`).eq(`student_id`,t),c=(a||[]).filter(e=>e.status===`approved`).length,l=i?.length||0,u=l>0?Math.round(c/l*100):0;n.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${la(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${I(e.name)}</span>
                          <span class="pm-node-status">${ca[n]}</span>
                        </div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${sa[t?.status||`pending`]};"></span>
    ...
    `}catch(e){n.innerHTML=`<p class="pm-empty">Error: ${I(e.message)}</p>`}}async function fa(e){let t=(await S())?.find(t=>t.id===e)?.instrumento;if(!t)return null;let n=t.split(`,`)[0].trim().toLowerCase(),{data:r,error:i}=await k.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${n}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();return i?(console.warn(`[rutaService] resolveRutaIdForClase error:`,i.message),null):r?.route_versions?.[0]?.id||r?.route_versions?.id||null}async function pa(e,t){let{data:n,error:r}=await k.from(`blocks`).select(`id, nombre:name, order_index`).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(r)throw Error(`[rutaService] blocks: `+r.message);if(!n||n.length===0)return[];let i=n.map(e=>e.id),{data:a,error:o}=await k.from(`levels`).select(`id, block_id, nombre:name, order_index`).in(`block_id`,i).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(o)throw Error(`[rutaService] levels: `+o.message);let s=(a??[]).map(e=>e.id);if(s.length===0)return n.map(e=>({...e,levels:[]}));let{data:c,error:l}=await k.from(`nodes`).select(`id, level_id, nombre:name, order_index`).in(`level_id`,s).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(l)throw Error(`[rutaService] nodes: `+l.message);let u=(c??[]).map(e=>e.id),{data:d,error:f}=u.length>0?await k.from(`indicators`).select(`id, node_id, nombre:description, order_index`).in(`node_id`,u).eq(`activo`,!0).order(`order_index`,{ascending:!0}):{data:[],error:null};if(f)throw Error(`[rutaService] indicators: `+f.message);let p=await Promise.all((c??[]).map(e=>Hr(e.id,t).then(t=>({nodeId:e.id,semaphore:t.semaphore})).catch(()=>({nodeId:e.id,semaphore:`gray`})))),m=new Map(p.map(e=>[e.nodeId,e.semaphore])),h=new Map;for(let e of d??[])h.has(e.node_id)||h.set(e.node_id,[]),h.get(e.node_id).push({...e,semaphore:m.get(e.node_id)??`gray`});let g=new Map;for(let e of c??[])g.has(e.level_id)||g.set(e.level_id,[]),g.get(e.level_id).push({...e,semaphore:m.get(e.id)??`gray`,indicators:h.get(e.id)??[]});let _=new Map;for(let[e]of i.map(e=>[e]))_.set(e,[]);let v=new Map;for(let e of a??[])v.has(e.block_id)||v.set(e.block_id,[]),v.get(e.block_id).push(e);for(let[e,t]of v){let n=t.map((e,t,n)=>{let r=g.get(e.id)??[],i=r.flatMap(e=>h.get(e.id)??[]),a=i.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length,o=i.length>0?Math.round(a/i.length*100):0,s=r.map(e=>e.semaphore),c=s.every(e=>e===`green`)&&s.length>0?`green`:s.every(e=>e===`gray`)||s.length===0?`gray`:`yellow`,l=!1;if(t>0){let e=n[t-1],r=(g.get(e.id)??[]).flatMap(e=>h.get(e.id)??[]),i=r.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length;l=r.length>0&&i/r.length<.8}return{...e,semaphore:c,locked:l,percentage:o,nodes:r}});_.set(e,n)}return n.map(e=>({...e,levels:_.get(e.id)??[]}))}var ma=new Map,ha={on(e,t){ma.has(e)||ma.set(e,[]),ma.get(e).push(t)},off(e,t){if(!ma.has(e))return;let n=ma.get(e),r=n.indexOf(t);r>-1&&n.splice(r,1)},emit(e,t){ma.has(e)&&ma.get(e).forEach(n=>{try{n(t)}catch(t){console.error(`[rutaEventEmitter] Error in listener for ${e}:`,t)}})},clearAllListeners(){ma.clear()}};function ga(e,t){let{blockId:n,blockName:r,isExpanded:i,childCount:a,onToggle:o}=t;e.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var _a=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():M(),va=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):S(...e),ya=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):pa(...e),J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},ba=!1;async function xa(e,{onTopicSelected:t}={}){if(J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!_a()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(p(),J.clases=await va(!0),!J.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}J.activeClaseId=J.clases[0].id,await Sa(),Ca(e),Da(e),Oa(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Sa(){J.loading=!0,J.rutaId=await fa(J.activeClaseId),J.rutaId?J.blocks=await ya(J.rutaId,J.activeClaseId):J.blocks=[],J.loading=!1}function Ca(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!J.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(J.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}J.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),ga(r,{blockId:n.id,blockName:n.nombre,isExpanded:J.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{J.expandedBlocks.has(t)?J.expandedBlocks.delete(t):J.expandedBlocks.add(t),Ca(e)}}),J.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(wa(n,e))})}}),Ta(e)}function wa(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=J.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${Ea(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${Ea(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${Ea(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{J.expandedLevels.has(e.id)?J.expandedLevels.delete(e.id):J.expandedLevels.add(e.id),Ca(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),J.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},Ca(t)})}),n}function Ta(e){let t=e.querySelector(`#ruta-action-panel`);if(!J.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{J.selectedIndicator=null,Ca(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{li({...J.selectedIndicator,indicatorId:J.selectedIndicator.id,claseId:J.activeClaseId}),J.onTopicSelected&&J.onTopicSelected(J.activeClaseId)})}function Ea(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Da(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{J.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Sa(),Ca(e),Da(e)})}function Oa(e){ba||(ba=!0,ha.on(`node-covered`,()=>{Sa().then(()=>{Ca(e),Da(e)})}))}var ka=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Aa(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await k.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
      ...
      `;return}let{data:r}=await k.from(`instrumentos`).select(`id, nombre`).order(`nombre`),{data:i}=await k.from(`maestros`).select(`id, nombre, email`).neq(`id`,t.id).order(`nombre`);e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${ka.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await k.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await F.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await F.createAcademicPlan(t,u),await k.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${I(t.message)}</p></div>`}}async function Ma(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await k.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await F.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await k.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await F.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},Pa={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([F.getRouteDetail(t),n?F.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},Y={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function Fa(e){let t=M();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}Y.maestro=t,Y.submitting=!1;let n=await ze(t.id);if(Y.permisos=n,Y.checked=!0,!n.puede_registrar_alumnos){Ia(e,n,t.id);return}try{let e=await S();Y.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),Y.clases=[]}La(e),Ba(),Ha()}function Ia(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
        ...
        <div id="pm-register-action-container">
          ...
          `}
            ...
            <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.3); padding: 0.85rem; border-radius: 10px; display: inline-flex; align-items: center; gap: 8px; color: #eab308; font-weight: 600; font-size: 0.85rem; animation: pm-error-fade-in 0.3s ease;">
              <i class="bi bi-clock-history"></i> Solicitud Pendiente de Aprobación
            </div>`)}catch(t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al solicitar: `+t.message,type:`danger`}})),a.disabled=!1,a.innerHTML=e}})}function La(e){e.innerHTML=`
    <div class="pm-settings pm-fade-in registro-alumno-view" role="main" aria-label="Registro de alumnos">
      <header class="pm-settings-header">
    ...
    </style>`}function Ra(){return{nombre:document.getElementById(`reg-nombre`)?.value.trim(),fechaNac:document.getElementById(`reg-fecha-nac`)?.value,instrumento:document.getElementById(`reg-instrumento`)?.value.trim(),repNombre:document.getElementById(`reg-rep-nombre`)?.value.trim(),repTlf:document.getElementById(`reg-rep-tlf`)?.value.trim(),repCedula:document.getElementById(`reg-rep-cedula`)?.value.trim(),repEmail:document.getElementById(`reg-rep-email`)?.value.trim(),direccion:document.getElementById(`reg-direccion`)?.value.trim(),claseId:document.getElementById(`reg-clase`)?.value}}function za(e){let t=[];if(e.nombre?e.nombre.length<3?t.push({fieldId:`reg-nombre`,message:`El nombre debe tener al menos 3 caracteres`}):e.nombre.length>100&&t.push({fieldId:`reg-nombre`,message:`El nombre no puede exceder 100 caracteres`}):t.push({fieldId:`reg-nombre`,message:`El nombre del alumno es obligatorio`}),!e.fechaNac)t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento es obligatoria`});else{let n=new Date(e.fechaNac),r=new Date;n>r&&t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento no puede ser futura`});let i=r.getFullYear()-n.getFullYear();i<3&&t.push({fieldId:`reg-fecha-nac`,message:`El alumno debe tener mínimo 3 años`}),i>100&&t.push({fieldId:`reg-fecha-nac`,message:`Verifica la fecha de nacimiento`})}return e.instrumento?e.instrumento.length>100&&t.push({fieldId:`reg-instrumento`,message:`El instrumento no puede exceder 100 caracteres`}):t.push({fieldId:`reg-instrumento`,message:`El instrumento principal es obligatorio`}),e.repNombre?e.repNombre.length>100&&t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante es obligatorio`}),e.repTlf?e.repTlf.length>20&&t.push({fieldId:`reg-rep-tlf`,message:`El teléfono no puede exceder 20 caracteres`}):t.push({fieldId:`reg-rep-tlf`,message:`El teléfono del representante es obligatorio`}),e.repCedula&&e.repCedula.length>20&&t.push({fieldId:`reg-rep-cedula`,message:`La cédula no puede exceder 20 caracteres`}),e.repEmail&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.repEmail)?e.repEmail.length>100&&t.push({fieldId:`reg-rep-email`,message:`El correo no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-email`,message:`El formato del correo electrónico no es válido`})),e.direccion&&e.direccion.length>255&&t.push({fieldId:`reg-direccion`,message:`La dirección no puede exceder 255 caracteres`}),t}function Ba(){document.getElementById(`btn-registrar-alumno`)?.addEventListener(`click`,Va),document.getElementById(`btn-cancelar-registro`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Registro cancelado`,type:`info`}})),window.location.hash=`#/hoy`})}async function Va(){if(Y.submitting)return;let e=Ra(),t=za(e);if(t.length>0){bt(document.getElementById(`reg-nombre`)?.closest(`.pm-settings`)||document),t.forEach(e=>{let t=document.getElementById(e.fieldId);t&&vt(t,e.message)});return}if(e.repEmail&&await l(e.repEmail)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El correo del representante ya está registrado en el sistema`,type:`danger`}})),Y.submitting=!1;return}if(e.repCedula&&await a(e.repCedula)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`La cédula del representante ya está registrada en el sistema`,type:`danger`}})),Y.submitting=!1;return}Y.submitting=!0;let n=document.getElementById(`btn-registrar-alumno`),i=n.innerHTML;n.disabled=!0,n.innerHTML=`<span class="pm-settings-spinner"></span><span>Registrando...</span>`;try{let t=await r({nombre:e.nombre,nombre_completo:e.nombre,fecha_nacimiento:e.fechaNac,instrumento:e.instrumento,instrumento_principal:e.instrumento,representante_nombre:e.repNombre,familiar_nombre:e.repNombre,representante_tlf:d(e.repTlf)||e.repTlf,familiar_telefono:d(e.repTlf)||e.repTlf,representante_cedula:e.repCedula||null,correo_representante:e.repEmail||null,direccion:e.direccion||null,is_active:!0,activo:!0});if(e.claseId)try{let{inscribirAlumno:n}=await be(async()=>{let{inscribirAlumno:e}=await import(`./clasesApi-rTtQZLyp.js`).then(e=>e.r);return{inscribirAlumno:e}},__vite__mapDeps([16,1,3]));typeof n==`function`&&await n(e.claseId,t.id)}catch(e){console.warn(`[Registro] No se pudo inscribir en clase:`,e.message)}window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Alumno ${e.nombre} registrado exitosamente`,type:`success`}})),document.getElementById(`reg-nombre`).value=``,document.getElementById(`reg-fecha-nac`).value=``,document.getElementById(`reg-instrumento`).value=``,document.getElementById(`reg-rep-nombre`).value=``,document.getElementById(`reg-rep-tlf`).value=``,document.getElementById(`reg-rep-cedula`).value=``,document.getElementById(`reg-rep-email`).value=``,document.getElementById(`reg-direccion`).value=``,document.getElementById(`reg-clase`).value=``}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al registrar: `+e.message,type:`danger`}}))}finally{Y.submitting=!1,n.disabled=!1,n.innerHTML=i}}function Ha(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}function Ua(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Wa(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function Ga(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var Ka=null,qa=[],Ja=new Set;async function Ya(e){e.innerHTML=co();let t=M();if(!t){e.innerHTML=lo(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await ze(t.id);if(!n.puede_inscribir_clases){e.innerHTML=Za(n),Qa(t.id);return}let[r,i]=await Promise.all([Le(t.id),T().catch(()=>[])]);qa=i.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=$a(r),ao(r),r.length>0&&await to(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=lo(`bi-exclamation-triangle`,`Error al cargar`,Ua(t.message))}}function Xa(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function Za(e){return`
    <div class="gcv-root">
  ...
  `}function Qa(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Re(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){P.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function $a(e){return`
    <div class="gcv-root">
      ...
      ${e.length===0?lo(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function eo(e){let t=Ua(e.nombre||`Clase sin nombre`),n=Ga(e.horarios||[]),r=Ua(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function to(e,t){Ka=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await Fe(e),a=i.map(e=>e.alumno).filter(Boolean);Ja=new Set(i.map(e=>e.alumno_id)),n.innerHTML=no(r,a,qa.filter(e=>!Ja.has(e.id))),oo(e,t)}catch(e){n.innerHTML=lo(`bi-exclamation-circle`,`Error al cargar alumnos`,Ua(e.message))}}}function no(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${Ua(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>ro(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>io(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function ro(e){let t=Ua(e.nombre_completo||e.nombre||`Alumno`),n=Ua(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${Wa(t)}</div>
  ...
  `}function io(e){let t=Ua(e.nombre_completo||e.nombre||`Alumno`),n=Ua(e.instrumento_principal||e.instrumento||``);return`
    <label class="gcv-student-row gcv-student-selectable disponible-item"
           data-alumno-id="${e.id}"
           data-name="${t.toLowerCase()}"
           data-instrumento="${n.toLowerCase()}">
      <input class="gcv-checkbox" type="checkbox" value="${e.id}" />
      <div class="gcv-student-avatar gcv-avatar-primary">${Wa(t)}</div>
      <div class="gcv-student-data">
        <span class="gcv-student-name">${t}</span>
        ${n?`<span class="gcv-student-sub"><i class="bi bi-music-note"></i> ${n}</span>`:``}
      </div>
    </label>
  `}function ao(e){document.getElementById(`gcv-clase-list`)?.addEventListener(`click`,async t=>{let n=t.target.closest(`.gcv-clase-card`);if(!n)return;let r=n.dataset.claseId;r&&r!==Ka&&await to(r,e)})}function oo(e,t){document.getElementById(`gcv-search`)?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();document.querySelectorAll(`.inscrito-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`}),document.querySelectorAll(`.disponible-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`})}),document.getElementById(`gcv-btn-nuevo`)?.addEventListener(`click`,()=>{document.getElementById(`gcv-new-form`)?.classList.remove(`d-none`),document.getElementById(`gcv-nuevo-nombre`)?.focus()}),document.getElementById(`gcv-btn-cancelar-nuevo`)?.addEventListener(`click`,so),document.getElementById(`gcv-btn-guardar-nuevo`)?.addEventListener(`click`,async()=>{let n=document.getElementById(`gcv-nuevo-nombre`).value.trim(),i=document.getElementById(`gcv-nuevo-instrumento`).value.trim(),a=document.getElementById(`gcv-nuevo-telefono`).value.trim();if(!n||!i||!a){P.error(`Nombre, instrumento y teléfono son obligatorios`);return}let o=document.getElementById(`gcv-btn-guardar-nuevo`);o.disabled=!0,o.innerHTML=`<span class="gcv-spinner-sm"></span> Guardando...`;try{await Ie(e,(await r({nombre_completo:n,instrumento_principal:i,familiar_telefono:a,activo:!0})).id),P.success(`${n} registrado e inscrito exitosamente`),qa=(await T().catch(()=>qa)).filter(e=>e.activo!==!1&&e.is_active!==!1),await to(e,t)}catch(e){P.error(`Error: `+e.message),o.disabled=!1,o.innerHTML=`<i class="bi bi-floppy"></i> Guardar e inscribir`}}),document.getElementById(`gcv-lista-inscritos`)?.addEventListener(`click`,async n=>{let r=n.target.closest(`.desinscribir-btn`);if(!r)return;let i=r.dataset.alumnoId,a=r.closest(`.gcv-student-row`)?.querySelector(`.gcv-student-name`)?.textContent||`este alumno`;if(confirm(`¿Quitar a ${a} de esta clase?`)){r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span>`;try{await Pe(e,i),P.success(`${a} quitado de la clase`),await to(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-x"></i>`}}}),document.getElementById(`gcv-btn-inscribir`)?.addEventListener(`click`,async()=>{let n=[...document.querySelectorAll(`#gcv-lista-disponibles .gcv-checkbox:checked`)];if(!n.length){P.error(`Seleccioná al menos un alumno`);return}let r=document.getElementById(`gcv-btn-inscribir`);r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span> Inscribiendo...`;try{for(let t of n)await Ie(e,t.value);P.success(`${n.length} alumno${n.length>1?`s`:``} inscrito${n.length>1?`s`:``} correctamente`),await to(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-check"></i> Inscribir seleccionados`}})}function so(){let e=document.getElementById(`gcv-new-form`);e&&e.classList.add(`d-none`),[`gcv-nuevo-nombre`,`gcv-nuevo-instrumento`,`gcv-nuevo-telefono`].forEach(e=>{let t=document.getElementById(e);t&&(t.value=``)})}function co(){return`
    <div class="gcv-root">
      <div class="gcv-header">
  ...
  `}var uo=null,fo=!1,po={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};function mo(e){if(!e)return``;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function ho(e){return e===`alta`?`<i class="bi bi-exclamation-circle-fill" style="color:#ef4444"></i>`:e===`media`?`<i class="bi bi-exclamation-circle-fill" style="color:#f59e0b"></i>`:`<i class="bi bi-info-circle-fill" style="color:#22c55e"></i>`}function go(){if(document.getElementById(`admin-ausencias-insights-styles`))return;let e=document.createElement(`style`);e.id=`admin-ausencias-insights-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function _o(e){document.querySelectorAll(`[data-route="admin-ausencias"],[data-route="admin-notificaciones"]`).forEach(t=>{let n=t.querySelector(`.aai-nav-badge`);e>0?(n||(n=document.createElement(`span`),n.className=`aai-nav-badge`,t.appendChild(n)),n.textContent=e>99?`99+`:String(e),n.style.display=`flex`):n&&(n.style.display=`none`)})}function vo(){return uo||(uo=document.createElement(`div`),uo.id=`admin-ausencias-insights`,uo.setAttribute(`role`,`status`),uo.setAttribute(`aria-live`,`polite`),document.body.appendChild(uo),uo)}function yo(e){let t=vo(),n=e.length,r=e[0],i=n===1&&r?`
    <div class="aai-preview">
      <div class="aai-preview-row">
        ${ho(r.urgencia)}
        <span>${r.maestros?.nombre_completo??`Maestro`}</span>
        <span class="aai-chip">${po[r.tipo_ausencia]??r.tipo_ausencia??`—`}</span>
        <span style="opacity:.7">${mo(r.fecha_inicio)}${r.fecha_fin&&r.fecha_fin!==r.fecha_inicio?` → `+mo(r.fecha_fin):``}</span>
      </div>
    </div>
  `:``;t.innerHTML=`
    <div class="aai-row">
  ...
  `,requestAnimationFrame(()=>{t.classList.add(`visible`)}),t.querySelector(`#aai-btn-revisar`)?.addEventListener(`click`,()=>{bo(),window.router&&window.router.navigate(`admin-ausencias`)}),t.querySelector(`#aai-btn-dismiss`)?.addEventListener(`click`,()=>{xo()})}function bo(){uo&&uo.classList.remove(`visible`)}function xo(){bo();let e=Date.now()+1800*1e3;localStorage.setItem(`admin-ausencias-insights-dismiss`,String(e))}function So(){let e=localStorage.getItem(`admin-ausencias-insights-dismiss`);return e?Date.now()<Number(e):!1}var Co={init(){window.adminAusenciasInsights=this,go(),vo(),this.evaluate()},async evaluate(){if(!fo){fo=!0;try{if((window.router?.currentRoute?.()??``).split(`?`)[0]===`admin-ausencias`){bo(),_o((await E())?.length??0);return}if(So())return;let e=await E();if(_o(e?.length??0),!e||e.length===0){bo();return}yo(e)}catch(e){console.warn(`[adminAusenciasInsights] Error evaluando:`,e),bo()}finally{fo=!1}}}},wo=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function To(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Eo(e){let{claseId:t,fecha:n,isValid:r}=To(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}ue(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),No(e.notification);let t=e.notification;t?.data?.deep_link?Eo(t.data.deep_link):t?.data?.deep_link_url&&Eo(t.data.deep_link_url),X.some(t=>t.id===e.notification.id)||(X.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Bo())}});var Do=30*1e3,Oo=60*1e3,ko=120*1e3,Ao=new Map;function jo(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Oo)}`}function Mo(){let e=Date.now();for(let[t,n]of Ao.entries())e>n&&Ao.delete(t)}function No(e){let t=jo(e),n=Date.now()+ko;Ao.set(t,n)}function Po(){return Mo(),Ao.size}function Fo(e){return`notif_cache_${e}`}function Io(e){try{let t=X.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Fo(e),JSON.stringify(t))}catch{}}function Lo(e){try{let t=localStorage.getItem(Fo(e));return t?JSON.parse(t):[]}catch{return[]}}var X=[],Ro=[];function zo(e){return Ro.push(e),e(X),()=>{Ro=Ro.filter(t=>t!==e)}}function Bo(){Ro.forEach(e=>e([...X]))}async function Vo(){let e=M();if(!e)return[];X.length===0&&(X=Lo(e.id),X.length>0&&Bo());try{let{data:t,error:n}=await k.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),X;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=X.filter(e=>String(e.id).startsWith(`local_`));return X=[...r,...i],await Ho(e.id),Io(e.id),Bo(),X}catch(e){return console.error(`[NotifService]`,e),X}}async function Ho(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([S(),y(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await m(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(X.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let d=e.hora_fin?e.hora_fin.slice(0,5):``,f=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=f&&d?` (${f}–${d})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;X.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(X.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=Math.round(a);X.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${d} ${d===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Uo(e){let t=M(),n=X.find(t=>t.id===e);if(n&&(n.estado=`leida`),Bo(),t&&Io(t.id),!String(e).startsWith(`local_`))try{await k.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Wo(e){let t=M();if(X=X.filter(t=>t.id!==e),Bo(),t&&Io(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await k.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Go(){let e=M();if(X.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Bo(),e&&Io(e.id),e)try{await k.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Ko(){return X.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var qo=null;function Jo(){let e=M();e&&(qo||=k.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};X.some(e=>e.id===n.id)||(X.unshift(n),Io(e.id),Bo(),Xo(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=X.findIndex(e=>e.id===t.new.id);n!==-1&&(X[n]={...X[n],...t.new},Io(e.id),Bo())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),e===`CHANNEL_ERROR`&&(console.warn(`[Realtime] Canal cerrado, el polling de fallback sigue activo.`),qo=null)}))}function Yo(){qo&&=(k.removeChannel(qo),null)}function Xo(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Zo(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),$o(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Zo(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Qo=!1;function $o(){if(Qo)return;Qo=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var es=null;function ts(){es===null&&(es=setInterval(()=>{document.visibilityState!==`hidden`&&Vo()},Do))}function ns(){es!==null&&(clearInterval(es),es=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Vo(),ts()):ns()});function rs(){let e=new Date().toISOString().split(`T`)[0];X=X.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}rs(),document.visibilityState!==`hidden`&&ts(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var is=null;function as(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var os={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(is=document.createElement(`div`),is.innerHTML=`
    ...
    `,document.body.appendChild(is),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Go()}),zo(e=>{this.renderList(e)}),Vo())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=Po();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tenés notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=ls(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=us(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${cs(e.tipo)}">
            <i class="bi ${ss(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${as(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>Uo(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),os.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>Uo(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Uo(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await Wo(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Vo()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=Me(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Vo()},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function ss(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function cs(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function ls(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function us(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}if(te(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}console.log(`[SOI] Initializing professionalization services...`),tt(),Ze({windowMs:6e4,max:100}),Ye({enabled:!1,consent:!1}),it({debug:!1}),Ke({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&P.show(t,n)});var ds=!1;function fs(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_registrar_alumnos&&t.push({id:`registrar-alumno`,label:`Registrar`,icon:`bi-person-plus`}),e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}var ps=[{id:`admin-alumnos`,label:`Alumnos`,icon:`bi-people-fill`},{id:`admin-programas`,label:`Programas`,icon:`bi-grid-1x2`},{id:`admin-maestros`,label:`Maestros`,icon:`bi-person-badge`},{id:`admin-notificaciones`,label:`Actividad`,icon:`bi-bell-fill`},{id:`admin-ausencias`,label:`Ausencias`,icon:`bi-calendar-x`},{id:`admin-metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}],ms=e=>ds?[...ps,...fs(e)]:fs(e),hs=null,gs=null,Z=ht();window.router=Z;async function _s(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await k.from(t).insert([i]);if(e)throw console.error(`[SYNC] Error en INSERT ${t}:`,e),e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await k.from(t).update(n).eq(`id`,e);if(r)throw console.error(`[SYNC] Error en UPDATE ${t}:`,r),r}else if(n===`delete`){let{error:e}=await k.from(t).delete().eq(`id`,i.id);if(e)throw console.error(`[SYNC] Error en DELETE ${t}:`,e),e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await k.from(t).select().limit(1);e&&e.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico en _syncWithSupabase:`,e),e}}var vs=null;async function ys(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await ce();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function bs(){clearTimeout(vs),vs=setTimeout(async()=>{if(navigator.onLine)try{await se(_s)}finally{await ys()}},1e3)}window.addEventListener(`online`,bs),window.addEventListener(`offline`,ys);function xs(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function Ss(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=``),n&&(n.style.display=``),r&&(r.style.display=``)}function Cs(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=(Z.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){console.log(`[Auth] Manteniendo ruta pública:`,n),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Ns(),ws(),Z.setAuthGuard(()=>ft.isAuthenticated(),t),Z.start();return}let r=js.login;if(r){xs(),r.style.display=`block`,r.innerHTML=``,xt(r,{onSuccess:e=>{e&&e!==`login`?(Ss(),Z.navigate(e)):Ls()}});return}e.innerHTML=``,xt(e,{onSuccess:()=>Ls()})}function ws(){Z.on(`login`,(e,t)=>$(`login`,t)),Z.on(`logout`,(e,t)=>$(`logout`,t)),Z.on(`calendario`,(e,t)=>$(`calendario`,t)),Z.on(`clases`,(e,t)=>$(`clases`,t)),Z.on(`hoy`,(e,t)=>$(`hoy`,t)),Z.on(`asistencia`,(e,t)=>$(`asistencia`,t)),Z.on(`metricas`,(e,t)=>$(`metricas`,t)),Z.on(`perfil`,(e,t)=>$(`perfil`,t)),Z.on(`clase-emergente`,(e,t)=>$(`clase-emergente`,t)),Z.on(`planificacion`,(e,t)=>$(`planificacion`,t)),Z.on(`alumno`,(e,t)=>$(`alumno`,t)),Z.on(`gamificacion`,(e,t)=>$(`gamificacion`,t)),Z.on(`ruta`,(e,t)=>$(`ruta`,t)),Z.on(`crear-clase`,(e,t)=>$(`crear-clase`,t)),Z.on(`ruta-plan-builder`,(e,t)=>$(`ruta-plan-builder`,t)),Z.on(`ruta-semanal`,(e,t)=>$(`ruta-semanal`,t)),Z.on(`ruta-libreria`,(e,t)=>$(`ruta-libreria`,t)),Z.on(`ruta-detalle/:id`,(e,t)=>$(`ruta-detalle`,t)),Z.on(`registrar-alumno`,(e,t)=>$(`registrar-alumno`,t)),Z.on(`gestionar-clases`,(e,t)=>$(`gestionar-clases`,t)),Z.on(`register`,(e,t)=>$(`register`,t)),Z.on(`pending-approval`,(e,t)=>$(`pending-approval`,t)),ds?(Z.on(`admin-alumnos`,(e,t)=>$(`admin-alumnos`,t)),Z.on(`admin-programas`,(e,t)=>$(`admin-programas`,t)),Z.on(`admin-maestros`,(e,t)=>$(`admin-maestros`,t)),Z.on(`admin-metricas`,(e,t)=>$(`admin-metricas`,t)),Z.on(`admin-config`,(e,t)=>$(`admin-config`,t)),Z.on(`admin-clases`,(e,t)=>$(`admin-clases`,t)),Z.on(`admin-sesiones`,(e,t)=>$(`admin-sesiones`,t)),Z.on(`admin-aprobacion`,(e,t)=>$(`admin-aprobacion`,t)),Z.on(`admin-ausencias`,(e,t)=>$(`admin-ausencias`,t)),Z.on(`admin-notificaciones`,(e,t)=>$(`admin-notificaciones`,t)),Z.onNotFound(()=>$(`admin-alumnos`))):Z.onNotFound(()=>$(`hoy`))}function Ts(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}var Es=Ts();window.addEventListener(`resize`,()=>{let e=Ts();e!==Es&&(Es=e,document.body.dataset.pmLayout=e)},{passive:!0});function Ds(e,t,n){hs=t,gs=n||gs;let r=ms(gs);e.innerHTML=`
    ...
    <div class="pm-main-area">
      ...
      <header class="pm-header" id="pm-header">
        <div class="pm-header-left" id="pm-header-left">
          <span class="pm-header-greeting">${ds?`Panel Admin`:`Portal Maestros`}</span>
          <span class="pm-header-title" style="font-size:clamp(1rem,3.5vw,1.5rem);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:52vw;">
            ${ds?t?.nombre_completo??`Administrador`:`Prof. `+(t?.nombre_completo??``)}
  ...
  `,ys();let i=document.getElementById(`pm-theme-toggle-container`);i&&i.appendChild(wo.createToggleButton());let a=document.getElementById(`pm-footer-nav`);a&&a.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let o=document.getElementById(`pm-sidebar`);o&&o.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)});let s=document.getElementById(`pm-header`),c=document.getElementById(`pm-header-search-input`),l=document.getElementById(`pm-search-toggle-btn`),u=document.getElementById(`pm-search-back-btn`),d=()=>{s?.classList.add(`search-active`),setTimeout(()=>{c?.focus()},50)},f=()=>{s?.classList.remove(`search-active`),c&&(c.value=``),document.getElementById(`pm-header-search-dropdown`)?.remove()};l?.addEventListener(`click`,e=>{e.stopPropagation(),d()}),u?.addEventListener(`click`,e=>{e.stopPropagation(),f()});let p=null,m=null,h=()=>{p?.remove(),p=null},g=e=>{if(h(),!e.length)return;let t=document.createElement(`div`);t.id=`pm-header-search-dropdown`,t.setAttribute(`role`,`listbox`),t.innerHTML=e.map(e=>`
      ...
      </div>`).join(``),document.body.appendChild(t);let n=c.getBoundingClientRect();t.style.cssText=`position:fixed;top:${n.bottom+4}px;left:${Math.max(8,n.left)}px;width:${Math.min(320,window.innerWidth-16)}px;z-index:9999;background:var(--pm-surface);border:1px solid var(--pm-border);border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.18);overflow:hidden;`,p=t,t.querySelectorAll(`.pm-hsd-item`).forEach(e=>{let t=()=>{f(),h(),Z.navigate(`alumno?id=${e.dataset.id}`)};e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})};if(c?.addEventListener(`input`,()=>{let e=c.value.trim();if(clearTimeout(m),e.length<1){h();return}let t=Bt();if(t){let n=e.toLowerCase();g(t.filter(e=>e.nombre_completo?.toLowerCase().includes(n)).slice(0,8).map(e=>({...e,instrumento_principal:e.clases?.join(`, `)||null})));return}m=setTimeout(async()=>{try{let{data:t}=await k.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).ilike(`nombre_completo`,`%${e}%`).limit(8);g(t||[])}catch{h()}},200)}),c?.addEventListener(`keydown`,e=>{e.key===`Escape`&&(f(),h())}),!document.getElementById(`pm-hsd-styles`)){let e=document.createElement(`style`);e.id=`pm-hsd-styles`,e.textContent=`.pm-hsd-item{display:flex;align-items:center;gap:0.625rem;padding:0.75rem 1rem;cursor:pointer;border-bottom:1px solid var(--pm-border);transition:background 0.1s}.pm-hsd-item:last-child{border-bottom:none}.pm-hsd-item:hover,.pm-hsd-item:focus{background:var(--pm-surface-2);outline:none}.pm-hsd-icon{font-size:1rem;color:var(--pm-primary);flex-shrink:0}.pm-hsd-info{flex:1;min-width:0}.pm-hsd-name{display:block;font-size:0.875rem;font-weight:500;color:var(--pm-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.pm-hsd-meta{font-size:0.7rem;color:var(--pm-text-muted)}.pm-hsd-arrow{color:var(--pm-text-muted);font-size:0.75rem}`,document.head.appendChild(e)}document.addEventListener(`click`,e=>{!c?.contains(e.target)&&!p?.contains(e.target)&&h()}),document.getElementById(`pm-sync-indicator`).addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await bs()}),document.getElementById(`pm-bell-btn`)?.addEventListener(`click`,()=>{os.open()});let _=(Z.currentRoute?.()||`hoy`).split(`?`)[0];As(_)}var Os=!1;function ks(){if(Os)return;if(Os=!0,zo(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=Ko();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Vo(),Jo(),!ds){let e=hs;if(e?.id){let t=k.channel(`permisos-maestro:${e.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${e.id}`},async t=>{console.log(`[Realtime] Permisos actualizados:`,t.new);try{let t=await ze(e.id),n=document.getElementById(`portal-app`);if(!n)return;let r=[];t.puede_registrar_alumnos&&!gs?.puede_registrar_alumnos&&r.push(`Registrar Alumnos`),t.puede_inscribir_clases&&!gs?.puede_inscribir_clases&&r.push(`Gestionar e Inscribir Clases`);let i=[];gs?.puede_registrar_alumnos&&!t.puede_registrar_alumnos&&i.push(`Registrar Alumnos`),gs?.puede_inscribir_clases&&!t.puede_inscribir_clases&&i.push(`Gestionar e Inscribir Clases`);let a=(Z.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`registrar-alumno`&&!t.puede_registrar_alumnos||a===`gestionar-clases`&&!t.puede_inscribir_clases?`hoy`:a;a===`pending-approval`&&r.length>0&&(o=`hoy`),Ds(n,e,t),Ns(),ws(),Z.setAuthGuard(()=>ft.isAuthenticated(),[`login`,`register`,`pending-approval`]),Ms.clear(),await $(o),Z.navigate(o),r.length>0?P.success(`¡Nuevos permisos activados: ${r.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):i.length>0?P.show(`El administrador removió tu acceso a: ${i.join(`, `)}.`,`warning`):P.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>{console.log(`[Realtime] Canal permisos_maestros:`,e)});window.addEventListener(`beforeunload`,()=>{k.removeChannel(t)},{once:!0})}}document.addEventListener(`keydown`,e=>{if(Ts()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`)switch(e.key.toLowerCase()){case`h`:Z.navigate(`hoy`),t.length=0;break;case`c`:Z.navigate(`calendario`),t.length=0;break;case`r`:Z.navigate(`ruta`),t.length=0;break;case`m`:Z.navigate(`metricas`),t.length=0;break;case`p`:Z.navigate(`perfil`),t.length=0;break;default:break}t.length>3&&t.splice(0,t.length-2)});let e=null;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{let e=Ts();if(e!==Es){Es=e,document.body.dataset.pmLayout=e,Ds(document.getElementById(`portal-app`),hs),Ns();let t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];As(t)}},250)},{passive:!0})}function As(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}var js={},Q=null,Ms=new Set;function Ns(){let e=document.getElementById(`pm-view-container`);e&&(e.innerHTML=``,[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`registrar-alumno`,`gestionar-clases`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),js[t]=n}),ds&&[`admin-alumnos`,`admin-programas`,`admin-maestros`,`admin-metricas`,`admin-config`,`admin-clases`,`admin-sesiones`,`admin-aprobacion`,`admin-ausencias`,`admin-notificaciones`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),js[t]=n}))}async function $(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e&&e.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}As(a),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}let o=js[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Q==`function`&&(console.log(`[Router] Ejecutando cleanup de vista anterior...`),Q(),Q=null),Object.values(js).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),Ms.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{switch(a){case`login`:xt(o,{onSuccess:()=>Ls()});break;case`register`:St(o,{onSuccess:()=>Z.navigate(`pending-approval`)});break;case`pending-approval`:Ct(o,{onBackToLogin:()=>Z.navigate(`login`)});break;case`logout`:Cs(),Yo(),pt().then(()=>window.location.reload());break;case`calendario`:case`clases`:Q=await jt(o);break;case`hoy`:Q=await wt(o,{onClaseClick:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`asistencia`:Q=await yi(o,{claseId:i.get(`clase`),fecha:i.get(`fecha`)});break;case`metricas`:Q=Vt(o);break;case`perfil`:Q=ki(o);break;case`clase-emergente`:Q=Ci(o,{maestroId:hs?.id});break;case`planificacion`:Q=await Yi(o);break;case`alumno`:Q=aa(o,{alumnoId:i.get(`id`)});break;case`gamificacion`:await ua(o);break;case`ruta`:await xa(o,{onTopicSelected:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:Aa(o);break;case`ruta-plan-builder`:ja(o,{alumnoId:i.get(`id`)});break;case`ruta-semanal`:Ma(o,{alumnoId:i.get(`id`)});break;case`ruta-libreria`:Na.render().then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`ruta-detalle`:Pa.render(t).then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`admin-alumnos`:_(o);break;case`admin-programas`:b(o);break;case`admin-maestros`:h(o);break;case`admin-metricas`:ee(o);break;case`admin-config`:C(o);break;case`admin-clases`:f?.(o);break;case`admin-sesiones`:break;case`admin-aprobacion`:await v(o),Q=null;break;case`admin-ausencias`:await x(o),Q=null;break;case`admin-notificaciones`:await O(o),Q=null;break;case`registrar-alumno`:if(!gs?.puede_registrar_alumnos){Z.navigate(`hoy`);return}Fa(o);break;case`gestionar-clases`:if(!gs?.puede_inscribir_clases){Z.navigate(`hoy`);return}Q=await Ya(o);break;default:}clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]).has(a)&&Ms.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}async function Ps(){if(hs)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[r,i,a]=await Promise.all([S(),S().then(e=>m(e.map(e=>e.id))),S().then(()=>y(hs.id,n,n))]),o=Object.fromEntries(r.map(e=>[e.id,e]));await he(i.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:o[e.clase_id]?.nombre||`Clase`})),a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}function Fs(){Ms.clear()}function Is(e){Ms.delete(e)}async function Ls(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`),console.log(`[Init] Llamando usePortalAuth.init()...`);let t=await ft.init();console.log(`[Init] Auth completado:`,t?`con maestro`:`sin maestro`),ds=t?.es_admin===!0,console.log(`[Init] IS_ADMIN:`,ds);let n=window.router||ht(),r=[`login`,`register`,`pending-approval`],i=n.currentRoute().split(`?`)[0],a=r.includes(i);if(!t&&!a){console.log(`[Init] No maestro y ruta privada, mostrando login screen`),Cs();return}if(!t&&a){console.log(`[Init] No maestro pero ruta pública detectada:`,i),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Ns(),ws(),Z.setAuthGuard(()=>ft.isAuthenticated(),r),Z.start();return}let o=null;if(!ds)try{o=await ze(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}console.log(`[Init] Renderizando shell...`),Ds(e,t,o),console.log(`[Init] Shell renderizado`),ds&&Co.init(),Ns(),ks(),Nr(Is,Fs),ws(),Z.setAuthGuard(()=>ft.isAuthenticated(),[`login`,`register`,`pending-approval`]),Z.start(),w().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!Ms.has(e)).reduce((e,t)=>e.then(()=>{if(js[t])return $(t,{},{silent:!0})}),Promise.resolve()),Ps(),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),bs()}window.addEventListener(`error`,e=>{let t=[`useCache`,`WebSocket`,`content.js`],n=e.message||``;if(t.some(e=>n.includes(e))){console.warn(`[Ignored Error]`,n);return}qe(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let r=document.getElementById(`portal-app`);r&&(r.innerHTML=`
    ...
    </div>`)}),Ls().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});