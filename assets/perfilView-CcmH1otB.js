const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushService-CMfdphyW.js","assets/AppToast-BfaQtGFE.js","assets/supabase-Cgh_dhNB.js","assets/maestroAuth-DOk-16l6.js","assets/main-maestros-BkX4faBA.js","assets/pwaInstaller-BEgVc-OU.js","assets/vendor-Bs2a3q3z.js","assets/vendor-COf7rB16.css","assets/idb-hTByFGMt.js","assets/lifecycleManager-CbU9MPkW.js","assets/main-maestros-CbPoeCO_.css","assets/sistemaView-7fRCAZKu.js","assets/router-Dfb4XAS3.js","assets/groqService-Cu889xeB.js","assets/config-CNiOV0RX.js","assets/CHANGELOG-DPV2OdzA.js","assets/ausenciasPanel-N7OByP3a.js","assets/ausenciaModal-BjMX3Rxx.js","assets/AppModal-C8uxOJPY.js","assets/portalUtils-CkF82Yyk.js"])))=>i.map(i=>d[i]);
import{a as e,i as t}from"./supabase-Cgh_dhNB.js";import{i as n,n as r,o as i}from"./maestroAuth-DOk-16l6.js";import{t as a}from"./main-maestros-BkX4faBA.js";import{a as o,c as s,d as c,f as l,i as u,l as d,n as f,p,r as m}from"./pushService-CMfdphyW.js";import{n as h,t as g}from"./AppModal-C8uxOJPY.js";import{n as _}from"./phoneUtils-Cpl-jyW9.js";import{i as v}from"./disponibilidadApi-xm0wbIpZ.js";import{n as y}from"./CHANGELOG-DPV2OdzA.js";import{c as b,i as x}from"./portalUtils-CkF82Yyk.js";import{t as S}from"./ausenciaModal-BjMX3Rxx.js";var C={async open(){let e=await f(),t=await u();g.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await l()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await c();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else(await p()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await d({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},w={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)},bindEvents(){document.getElementById(`push-diagnostic-close`).addEventListener(`click`,()=>this.close()),document.getElementById(`push-diagnostic-overlay`).addEventListener(`click`,e=>{e.target.id===`push-diagnostic-overlay`&&this.close()}),document.getElementById(`btn-enable-push`).addEventListener(`click`,()=>this.enablePush()),document.getElementById(`btn-test-push`).addEventListener(`click`,()=>this.testPush())},async checkStatus(){let e=[],t=document.getElementById(`diagnostic-details`),n=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),r=/iPhone|iPad|iPod/i.test(navigator.userAgent),i=/^((?!chrome|android).)*safari/i.test(navigator.userAgent);e.push({text:`📱 Dispositivo: ${n?r?`iOS`:`Android`:`Desktop`}`,type:`info`}),n&&i&&e.push({text:`⚠️ iOS Safari: Requiere iOS 16.4+ y agregar a pantalla de inicio`,type:`warn`});let a=o();e.push({text:`Navegador: ${a?`✅ Compatible`:`❌ No compatible`}`,type:a?`ok`:`error`}),this.updateStatusItem(`status-browser`,a);let s=`default`;`Notification`in window&&(s=Notification.permission);let c=s===`granted`;e.push({text:`Permiso: ${s===`granted`?`✅ Otorgado`:s===`denied`?`❌ Denegado - ve a Configuración del navegador`:`⚠️ No solicitado - click en Activar abajo`}`,type:c?`ok`:`warn`}),this.updateStatusItem(`status-permission`,c,s);let l=`no-registrado`,u=!1;if(`serviceWorker`in navigator)try{let t=await navigator.serviceWorker.getRegistration(`/sw.js`);t?(l=t.active?`✅ Activo`:`⏳ Registrado`,u=!!t.active,e.push({text:`Service Worker: ${l}`,type:`ok`})):e.push({text:`Service Worker: ❌ No registrado`,type:`error`}),this.updateStatusItem(`status-serviceworker`,u)}catch(t){e.push({text:`Service Worker: ❌ Error - ${t.message}`,type:`error`}),this.updateStatusItem(`status-serviceworker`,!1)}else e.push({text:`Service Worker: ❌ No soportado`,type:`error`}),this.updateStatusItem(`status-serviceworker`,!1);let d=`no-suscrito`;if(u)try{let t=await m();d=t.subscribed?`✅ Suscrito`:`❌ No suscrito`,e.push({text:`Suscripción: ${d}`,type:t.subscribed?`ok`:`warn`}),this.updateStatusItem(`status-subscription`,t.subscribed)}catch(t){e.push({text:`Suscripción: ❌ Error - ${t.message}`,type:`error`}),this.updateStatusItem(`status-subscription`,!1)}else e.push({text:`Suscripción: ⚠️ SW inactivo`,type:`warn`}),this.updateStatusItem(`status-subscription`,!1);return t.innerHTML=e.map(e=>`<div class="log-item log-${e.type}">${e.text}</div>`).join(``),{browserSupported:a,permOk:c,swActive:u}},updateStatusItem(e,t,n=``){let r=document.getElementById(e);r.className=`push-status-item ${t?`success`:`warning`}`;let i=r.querySelector(`.status-value`);i.textContent=t?`✓ Listo`:`⚠ Revisar`,n&&(i.textContent+=` (${n})`)},async enablePush(){let e=document.getElementById(`diagnostic-result`),t=document.getElementById(`btn-enable-push`);t.disabled=!0,t.innerHTML=`<span class="pm-spinner-sm me-2"></span> Configurando...`;try{e.className=`push-diagnostic-result info`;let t=/Android|webOS|iPhone|iPad|iPod/i.test(navigator.userAgent),n=/iPhone|iPad|iPod/i.test(navigator.userAgent);t&&n?e.innerHTML=`📱 iOS detectado: Se abrirá una solicitud de permiso...`:t?e.innerHTML=`📱 Android detectado: Solicitando permiso...`:e.innerHTML=`Solicitando permiso de notificaciones...`;let{granted:r,error:i}=await s();if(!r)throw Error((i||`Permiso denegado`)+(t?`<br><br><strong>En móvil:</strong> Ve a Configuración → Safari → Notificaciones → Permitir`:``));e.innerHTML=`Registrando en el sistema de notificaciones...`;let a=await c();if(!a.success)throw Error(a.error||`Error al suscribirse a push`);e.className=`push-diagnostic-result success`;let o=/Android|webOS|iPhone|iPad|iPod/i.test(navigator.userAgent),l=`✅ ¡Notificaciones push activadas!`;o&&(l+=`<br><small>💡 En móvil, agrega la app a pantalla de inicio para notificaciones completas (botón Compartir → Agregar a pantalla de inicio)</small>`),e.innerHTML=l,await this.checkStatus(),setTimeout(()=>this.testPush(),2e3)}catch(t){e.className=`push-diagnostic-result error`,e.innerHTML=`❌ ${t.message}`}finally{t.disabled=!1,t.innerHTML=`<i class="bi bi-bell me-2"></i>Activar Notificaciones Push`}},async testPush(){let e=document.getElementById(`diagnostic-result`);try{let t=await l();t.success?(e.className=`push-diagnostic-result success`,e.innerHTML=`✅ ${t.method===`serviceWorker`?`¡Notificación del sistema enviada! Deberías verla en tu escritorio.`:`Notificación enviada (modo local).`}`):(e.className=`push-diagnostic-result error`,e.innerHTML=`❌ ${h(t.error)}`)}catch(t){e.className=`push-diagnostic-result error`,e.innerHTML=`❌ Error: ${h(t.message)}`}},open(){this.init();let e=document.getElementById(`push-diagnostic-overlay`);e.style.display=`flex`;let t=document.querySelector(`#push-diagnostic-panel .push-diagnostic-card`);t&&(this._trap&&this._trap.dispose(),this._trap=a(t,{onClose:()=>this.close()}))},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`push-diagnostic-overlay`);e&&(e.style.display=`none`)}},T={dirty:!1,saving:!1,theme:localStorage.getItem(`portal-maestros-theme`)||`system`,fontScale:localStorage.getItem(`portal-maestros-font-scale`)||`1`,pushEnabled:!1},E=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`},{key:`domingo`,label:`Domingo`}];function D(t){let r=n();if(!r){t.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa.</p>
      </div>`;return}T.dirty=!1,T.saving=!1,e(()=>import(`./pushService-CMfdphyW.js`).then(e=>e.s).then(async e=>{T.pushEnabled=(await e.getNotificationPreferences()).push_activo;let t=document.querySelector(`#btn-toggle-push-main input`);t&&(t.checked=T.pushEnabled);let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=T.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),__vite__mapDeps([0,1,2,3])),t.innerHTML=`
    <div class="pm-settings pm-fade-in" role="main" aria-label="Configuración del perfil">
      ...
      <footer class="pm-settings-footer">
        ...
        <p class="pm-settings-footer__version">
          v${y} &copy; 2026
          ${r?.es_admin?`<button id="pm-ver-sistema-btn" style="
    ...
    </div>`;let i=document.getElementById(`col-izquierda`),a=document.getElementById(`col-derecha`);O(i,r),k(i,r),A(a),j(a,r),M(a),N(a,r),a.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),L(a),R(a),q(r),B(r),J(),e(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./main-maestros-BkX4faBA.js`).then(e=>e.a);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([4,1,5,2,3,6,7,8,0,9,10])).then(async({getPermisos:e,solicitarPermiso:t})=>{try{await e(r.id),document.getElementById(`pm-collaboration-container`)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function O(e,t){let n=b(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function j(e,t){let n=o(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${T.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`),P(t)}async function P(e){await I(e.id),document.getElementById(`btn-nueva-necesidad`)?.addEventListener(`click`,()=>{F(e)})}function F(e){g.open({title:`Nueva Solicitud`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
    ...
    </div>`}function B(t){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{T.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>V(t)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,U),document.getElementById(`pm-ver-sistema-btn`)?.addEventListener(`click`,()=>{e(async()=>{let{renderSistemaView:e}=await import(`./sistemaView-7fRCAZKu.js`);return{renderSistemaView:e}},__vite__mapDeps([11,1,2,4,5,3,6,7,8,0,9,10,12,13,14,15])).then(({renderSistemaView:e})=>{g.open({title:`<i class="bi bi-cpu-fill me-2"></i>Sistema SOI — v${y}`,size:`xl`,saveText:null,cancelText:`Cerrar`,body:`<div id="pm-sistema-modal-body"></div>`,onOpen:t=>{e(t.querySelector(`#pm-sistema-modal-body`))}})})}),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let n=document.querySelector(`#btn-toggle-push-main input`);n?.addEventListener(`change`,async e=>{if(n.disabled=!0,n.checked){let e=await c();e.success?(T.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(n.checked=!1,T.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await p(),T.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));n.disabled=!1;let t=document.getElementById(`pm-notif-sub-badge`);t&&(t.textContent=T.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>C.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>w.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await l();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>W(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>W(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>W(`system`)),document.querySelectorAll(`.pm-font-size-btn`).forEach(e=>{e.addEventListener(`click`,()=>G(e.dataset.fontScale))}),K(T.fontScale),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:t}=await e(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-N7OByP3a.js`);return{ausenciasPanel:e}},__vite__mapDeps([16,1,2,3,17,4,5,6,7,8,0,9,10,18,19]));t.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>S.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,z(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),T.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),T.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function V(e){let n=document.getElementById(`perfilNombre`).value.trim(),i=_(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),a=document.getElementById(`perfilEspecialidad`).value.trim(),o=H();if(!n){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}T.saving=!0;let s=document.getElementById(`btnGuardarPerfil`),c=s.innerHTML;s.disabled=!0,s.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let s=await v(e.id,o);if(!s.success){let e=s.errors.join(`
`);throw Error(e)}let{error:c}=await t.from(`maestros`).update({nombre_completo:n,tlf:i,especialidad:a}).eq(`id`,e.id);if(c)throw c;let l={...e,nombre_completo:n,nombre:n,telefono:i,tlf:i,especialidad:a,disponibilidad:o};localStorage.setItem(r,JSON.stringify(l)),T.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{T.saving=!1,s.disabled=!1,s.innerHTML=c}}function H(){let e={};return E.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function U(){g.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
