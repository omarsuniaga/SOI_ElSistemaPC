      ...
      <section class="pm-dashboard-section" aria-label="Resumen por clase">
        ...
        <div class="pm-classes-list" id="pm-clases-grid">
          ${l.map(e=>{let t=e.avgAttendance,n=t<70?`danger`:t<85?`warning`:`success`,r=t<70?`linear-gradient(135deg,#ff3b30,#ff6b6b)`:t<85?`linear-gradient(135deg,#ff9500,#ffcc00)`:`linear-gradient(135deg,#30d158,#34c759)`,i=e.sessionAttendance.length>0?e.sessionAttendance.map((e,t,n)=>{let r=Math.max(8,e),i=e<70?`#ff3b30`:e<85?`#ff9500`:`#30d158`;return`<div class="pm-spark-bar ${t===n.length-1?`pm-spark-last`:``}" style="height:${r}%;background:${i};" title="${e}%"></div>`}).join(``):`<span class="pm-spark-empty">—</span>`;return`
            <div class="pm-class-card2" data-clase-id="${e.id}" role="article" aria-label="Clase ${k(e.nombre)}">
              ...
              <div class="pm-class-card2__body">
                <div class="pm-class-card2__top">
                  <div class="pm-class-card2__info">
                    <span class="pm-class-card2__name">${k(e.nombre)}</span>
                    ${e.instrumento?`<span class="pm-class-card2__inst"><i class="bi bi-music-note-beamed"></i> ${k(e.instrumento)}</span>`:``}
                  </div>
...
`);r&&(n[r]=rn(i))}),{...rn(e),por_capas:n}}function on(e){if(!e)return``;let t=sn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(R.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${en.capas}22; color:${en.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${en.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${en.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(R.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(R.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(R.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(R.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(R.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(R.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function sn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var cn=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function ln(e){if(!e||e.length===0)return cn.slice(0,6);let t=e.toLowerCase();return cn.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function un(e){let t=cn.find(t=>t.trigger===e);return t?t.expand:null}function dn(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function fn(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{p.style.display===`block`?h():m()};let g=fn(e);return e.querySelector(`#btn-help`).onclick=()=>{g.open()},{setContext(e={}){e.presentes!==void 0&&(c.presentes=e.presentes),e.indicadorActivo!==void 0&&(c.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(c.indicadoresDisponibles=e.indicadoresDisponibles)}}}var z=null,B=[],mn=null,V=-1,hn=!1,gn=null,_n=!1,vn=0,yn=0;function bn(){if(!z){if(z=document.createElement(`div`),z.id=`pm-autocomplete-popup`,z.className=`pm-autocomplete-popup`,z.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(z)}}function xn(e,t,n={}){if(bn(),B=e||[],mn=t,gn=n.trigger||null,V=-1,hn=!0,Dn(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),z.style.left=`${i}px`,z.style.top=`${a}px`}z.onmousedown=Sn,document.addEventListener(`mousemove`,Cn),document.addEventListener(`mouseup`,wn),z.style.display=`block`}function Sn(e){e.target.closest(`.pm-ac-option`)||(_n=!0,vn=e.clientX-z.offsetLeft,yn=e.clientY-z.offsetTop,z.style.cursor=`grabbing`,z.style.transition=`none`)}function Cn(e){if(!_n)return;let t=e.clientX-vn,n=e.clientY-yn;z.style.left=`${Math.max(0,t)}px`,z.style.top=`${Math.max(0,n)}px`}function wn(){_n&&(_n=!1,z.style.cursor=``)}function Tn(){z&&(z.style.display=`none`,_n=!1,document.removeEventListener(`mousemove`,Cn),document.removeEventListener(`mouseup`,wn)),B=[],mn=null,V=-1,hn=!1,gn=null}function En(e){B=e||[],V=-1,Dn(e)}function Dn(e){if(!z)return;if(!e||e.length===0){z.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${jn(gn)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===V,o=Mn(gn,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Pn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Pn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),z.innerHTML=t,z.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{On(parseInt(e.dataset.index,10))})})}function On(e){if(e>=0&&e<B.length){let t=B[e];mn&&mn(t),Tn()}}function kn(e){if(!(!hn||B.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),V=Math.min(V+1,B.length-1),Dn(B),An();break;case`ArrowUp`:e.preventDefault(),V=Math.max(V-1,0),Dn(B),An();break;case`Enter`:e.preventDefault(),V>=0?On(V):B.length>0&&On(0);break;case`Escape`:e.preventDefault(),Tn();break;case`Tab`:B.length>0&&V===-1&&(e.preventDefault(),On(0));break}}function An(){if(!z||V<0)return;let e=z.querySelector(`.pm-ac-option[data-index="${V}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function jn(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Mn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?Nn(t.type):`•`}function Nn(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Pn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Fn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function In(){return hn}function Ln(){return V}var Rn={show:xn,hide:Tn,updateOptions:En,handleKeyDown:kn,getCursorPosition:Fn,isOpen:In,getSelectedIndex:Ln},zn=`portal-maestros-catalogs`,Bn=1,Vn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Hn=null;async function H(){return Hn||(Hn=await w(zn,Bn,{upgrade(e){for(let[t,n]of Object.entries(Vn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Hn)}async function Un(e,t){let n=await H(),r=await n.get(e,t);if(!r)return null;let i=Vn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Wn(e){let t=await(await H()).getAll(e),n=Vn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Gn(e,t,n){return(await H()).getAllFromIndex(e,t,n)}async function Kn(e,t){let n=await H(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function qn(e,t){let n=(await H()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Jn(e,t){await(await H()).delete(e,t)}async function Yn(e){await(await H()).clear(e)}async function Xn(e){let t=await H(),n=Vn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Zn(){let e=await H();for(let t of Object.keys(Vn))await e.clear(t)}async function Qn(e){return(await Wn(e)).length}async function $n(e,t){let n=await H(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function er(e){return(await H()).get(`historial`,e)}async function tr(e,t=5){return(await(await H()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var U={get:Un,getAll:Wn,getByIndex:Gn,set:Kn,setBulk:qn,remove:Jn,clear:Yn,cleanExpired:Xn,clearAll:Zn,getStoreSize:Qn,addToHistorial:$n,getHistorial:er,getTopUsed:tr};async function nr(e){if(!e)return[];try{let{data:t,error:n}=await x.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function rr(){let e=await U.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function ir(){let e=await U.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function ar(){let e=await U.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function or(){let e=await U.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await x.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function sr(){let e=await U.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await x.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await x.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await x.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await U.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function cr(e=null){let t=await U.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=x.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await U.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function lr(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await nr(n.claseId));break;case`[`:r=await rr();break;case`(`:r=await ar();break;case`{`:r=await or();break;case`$`:r=await ir();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await sr():await cr(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=ur(r,t)),e&&e!==`#`){let t=(await U.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function ur(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=dr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function dr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function fr(e,t){await U.addToHistorial(e,t)}function pr(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o={};e.innerHTML=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function vr(n,r=null,i=[],o=[],s={},c){let l=n===`edit`&&!!r,u=l?r:{...s};!l&&s.contenido&&!u.notas_dsl&&(u.notas_dsl=s.contenido),!l&&s.maestro_nombre&&!o.find(e=>e.nombre===s.maestro_nombre)&&(o=[{id:s.maestro_id,nombre:s.maestro_nombre},...o]);let d=new m(u),f=document.getElementById(`pm-planificacion-modal`);if(f&&f.remove(),f=document.createElement(`div`),f.id=`pm-planificacion-modal`,f.className=`pm-plan-modal-overlay`,f.innerHTML=br(l,d,i,o),document.body.appendChild(f),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=xr(),document.head.appendChild(e)}let p=()=>{f.classList.remove(`open`),setTimeout(()=>f.remove(),200)};f.querySelector(`.pm-plan-close-x`).onclick=p,f.querySelector(`.pm-plan-cancel-btn`).onclick=p,f.querySelector(`.pm-plan-backdrop`).onclick=p;let h=e=>{e.key===`Escape`&&(p(),document.removeEventListener(`keydown`,h))};document.addEventListener(`keydown`,h);let g=f.querySelector(`#pl-plantilla`);g&&g.addEventListener(`change`,e=>{let t=_r.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(f.querySelector(`#pl-objetivos`).value=t.objetivos,f.querySelector(`#pl-contenido`).value=t.contenido,f.querySelector(`#pl-recursos`).value=t.recursos,f.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Cr(f))});let _=f.querySelector(`#pl-clase_id`);_&&_.addEventListener(`change`,()=>{let e=f.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${wr(i,_.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),Sr(f);let v=f.querySelector(`#dsl-editor-container`);if(v){let n=a({onSelect:async t=>{let n=(await e()).filter(e=>t.includes(e.id)).map(e=>`#${e.nombre_completo}`).join(`, `);r.component&&r.component.insertText(n+` `)}});document.body.appendChild(n);let r=t({initialContent:d.notas_dsl||``,onChange:(e,t)=>{let n=f.querySelector(`#dsl-summary`);n&&(n.textContent=Er(t))},onAlumnoClick:()=>n.openModal()});v.appendChild(r),f._dslEditor=r}let y=f.querySelector(`.pm-plan-save-btn`);y.onclick=async()=>{let e=f.querySelector(`#pl-tema`)?.value.trim(),t=f.querySelector(`#pl-clase_id`)?.value;if(!e){f.querySelector(`#pl-tema`).focus();return}if(!t){f.querySelector(`#pl-clase_id`).focus();return}y.disabled=!0,y.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=f.querySelector(`#pl-recursos`)?.value||``,r=f._dslEditor,i={clase_id:t,maestro_id:f.querySelector(`#pl-maestro_id`)?.value||null,instrumento:f.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:f.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:f.querySelector(`#pl-objetivos`)?.value.trim(),contenido:f.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:f.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:f.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:l&&f.querySelector(`#pl-estado`)?.value||`planificado`};c&&await c(i),p()}catch(e){console.error(`[planificacionModal] Error:`,e),y.disabled=!1,y.textContent=l?`Guardar cambios`:`Guardar`}};let b=f.querySelector(`.pm-plan-body`);if(b){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;b.firstChild;)t.appendChild(b.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
  ...
  `,await Ar()}async function Or(e,t,n,r){Ce.open({title:`Editar ${e}`,body:`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>kr(`Clase`,null,()=>Ar()),G.activeClassId?jr(G.activeClassId):Fr(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),Or(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Ar())},e.onclick=()=>{G.activeClassId=t,G.activeLevelId=G.activeNodeId=G.activeObjectiveId=null,Ar(),jr(t),Fr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Fr(`#pm-rc-objs-wrapper`,`Elegí Tema`),Fr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function jr(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await W.getLevelsByClass(e);!n.some(e=>e.id===G.activeLevelId)&&n.length>0?G.activeLevelId=n[0].id:n.length===0&&(G.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>kr(`Nivel`,e,()=>jr(e)),G.activeLevelId?Mr(G.activeLevelId):Fr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Or(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>jr(e))},t.onclick=()=>{G.activeLevelId=n,G.activeNodeId=G.activeObjectiveId=null,jr(e),Mr(n),Fr(`#pm-rc-objs-wrapper`,`Elegí Tema`),Fr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Mr(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await W.getNodesByLevel(e);!n.some(e=>e.id===G.activeNodeId)&&n.length>0?G.activeNodeId=n[0].id:n.length===0&&(G.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>kr(`Tema`,e,()=>Mr(e)),G.activeNodeId?Nr(G.activeNodeId):Fr(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Or(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Mr(e))},t.onclick=()=>{G.activeNodeId=n,G.activeObjectiveId=null,Mr(e),Nr(n),Fr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Nr(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await W.getObjectivesByNode(e);!n.some(e=>e.id===G.activeObjectiveId)&&n.length>0?G.activeObjectiveId=n[0].id:n.length===0&&(G.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>kr(`Objetivo`,e,()=>Nr(e)),G.activeObjectiveId?Pr(G.activeObjectiveId):Fr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Or(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Nr(e))},t.onclick=()=>{G.activeObjectiveId=n,Nr(e),Pr(n)}})}async function Pr(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
...
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=an(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function Ur(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Wr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Gr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await x.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Kr(e,t){let{data:n,error:r}=await x.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await x.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await x.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Wr(a??[],l),indicators:n,totalAlumnos:l}}async function qr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Vr(e);try{let t=e;i===`natural`&&(t=await Te(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=Ur(Hr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Jr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
  ...
  `}function ei(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${K(Xr(e.created_at))}</span>
  ...
  `}function oi({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Jr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){xe()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=ve(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=C();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await x.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=ii(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=j(o,{onClose:()=>h()});try{let n=await Qr(e.id,t);s=n.indicatorSummaries,o.innerHTML=ri(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=ai(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}function si({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ci(e,t,n){let{data:r,error:i}=await x.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await x.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function li(e,t){let{data:n,error:r}=await x.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function ui(e){let{error:t}=await x.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function di(e,t,n,r,i=null){let{error:a}=await x.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await x.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var fi=`soi_ruta_tema_pendiente`;function pi(e){sessionStorage.setItem(fi,JSON.stringify(e))}function mi(){let e=sessionStorage.getItem(fi);if(!e)return null;sessionStorage.removeItem(fi);try{return JSON.parse(e)}catch{return null}}function hi(e,{onSave:t,onCancel:n}){let r=document.getElementById(`pm-justif-modal`);if(!r&&(r=document.createElement(`div`),r.id=`pm-justif-modal`,r.className=`pm-justif-modal-overlay`,r.innerHTML=`
...
`,e.forEach(e=>{let t=n.find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}e.querySelector(`#pm-asist-back`).onclick=()=>{_.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{i.forEach(e=>{a[e.id]=`P`}),j(),De(),await M(!0),At(`Todos los ${i.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{i.forEach(e=>{a[e.id]=`A`}),j(),De(),await M(!0),At(`Todos los ${i.length} alumnos marcados como ausentes.`)},j();async function ke(e){try{let{data:t}=await x.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Ae(e){if(!e||!se)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await W.getRouteHierarchy(se),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let je=[{target:`.pm-asist-header`,title:`📍 Cabecera de Clase`,body:`Aquí puede ver los datos de la clase, el salón y la fecha. Es su panel de control principal.`},{target:`.pm-asist-bulk-circles`,title:`👥 Asistencia Rápida`,body:`¿Asistieron todos? Presione "P" para marcar a todos los alumnos como presentes en un solo clic.`},{target:`#pm-alumnos-list`,title:`🙋‍♂️ Lista de Alumnos`,body:`Presione el círculo de cada alumno para cambiar entre Presente, Ausente o Retraso.`},{target:`#pm-planificacion-card`,title:`🗺️ Planificación Académica`,body:`Seleccione una Ruta o busque en la Biblioteca. Los temas que ya impartió aparecerán con un check ✅ verde.`},{target:`#pm-dsl-toolbar-container`,title:`🛠️ Caja de Herramientas`,body:`Use el micrófono 🎤 para dictar la clase, o el botón de IA ✨ para mejorar y profesionalizar su redacción automáticamente.`},{target:`#pm-dsl-editor-container`,title:`✍️ Escritura Inteligente (DSL)`,body:`Use [Corchetes] para vincular temas de la planificación y asteriscos * para puntos clave. La IA le ayudará a darle formato profesional.`},{target:`#btn-guardar`,title:`💾 Guardar Sesión`,body:`Al finalizar, no olvide guardar su sesión para que el progreso de los alumnos se registre en el sistema.`}],Me=0,Ne=e.querySelector(`#pm-tour-overlay`),Pe=e.querySelector(`#pm-tour-spotlight`),Fe=e.querySelector(`#pm-tour-tooltip`),Ie=e.querySelector(`#pm-tour-title`),Le=e.querySelector(`#pm-tour-body`),Re=e.querySelector(`#pm-tour-next`),ze=e.querySelector(`#pm-tour-skip`);function Be(){Me=0,Ne.style.display=`block`,setTimeout(()=>Ne.style.opacity=`1`,10),Ve(0)}function Ve(t){let n=je[t],r=e.querySelector(n.target);if(!r){He();return}r.scrollIntoView({behavior:`smooth`,block:`center`});let i=r.getBoundingClientRect(),a=window.scrollY;Pe.style.width=`${i.width+20}px`,Pe.style.height=`${i.height+20}px`,Pe.style.top=`${i.top+a-10}px`,Pe.style.left=`${i.left-10}px`,Ie.innerHTML=`<span>${n.title}</span>`,Le.textContent=n.body,Re.textContent=t===je.length-1?`Finalizar`:`Siguiente`;let o=i.bottom+a+20;o+200>document.documentElement.scrollHeight&&(o=i.top+a-220),Fe.style.top=`${o}px`,Fe.style.left=`${Math.max(10,Math.min(window.innerWidth-300,i.left))}px`}function He(){Me++,Me<je.length?Ve(Me):Ue()}function Ue(){Ne.style.opacity=`0`,setTimeout(()=>{Ne.style.display=`none`,localStorage.setItem(`pm_tour_completed`,`true`)},300)}Re.onclick=He,ze.onclick=Ue;let We=e.querySelector(`#pm-btn-help`);return We&&(We.onclick=Be),localStorage.getItem(`pm_tour_completed`)||setTimeout(Be,1500),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),_.forEach(e=>{try{e()}catch{}})}}function Ti(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Ei(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Di(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await x.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Ei(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await ie({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var Oi={async open(){let e=await me(),t=await fe();Ce.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
  ...
  `,document.body.appendChild(r);let i=r.querySelectorAll(`[role="tab"]`),a=r.querySelector(`#btn-crear-clase`),o=r.querySelector(`#crear-clase-form`),s=r.querySelector(`#crear-clase-error`),c=r.querySelector(`#crear-clase-error-message`);i.forEach(e=>{e.addEventListener(`click`,()=>{e.getAttribute(`aria-controls`)===`clases-create`?a.style.display=`inline-block`:a.style.display=`none`})}),a.addEventListener(`click`,p);async function l(){try{let e=r.querySelector(`#clases-container`),i=r.querySelector(`#clases-loading`),a=r.querySelector(`#clases-empty`),o=r.querySelector(`#clases-error`);i.style.display=`block`,e.style.display=`none`,a.style.display=`none`,o.style.display=`none`;let{data:s,error:c}=await x.from(`clases`).select(`*`).eq(`maestro_id`,t).order(`creado_en`,{ascending:!1});if(c)throw c;n=s||[],i.style.display=`none`,n.length===0?a.style.display=`block`:(e.innerHTML=u(n),e.style.display=`block`,d(e))}catch(e){console.error(`[gestionarClasesModal] Error loading clases:`,e);let t=r.querySelector(`#clases-error`),n=r.querySelector(`#clases-error-message`);n.textContent=e.message||`Error al cargar las clases`,t.style.display=`block`,r.querySelector(`#clases-loading`).style.display=`none`}}function u(e){return`
    ...
    `,(()=>{let e=null,n=null,r=document.getElementById(`pm-btn-new-alumno`);r&&r.addEventListener(`click`,()=>{e||=ki(),e.show(t.id)});let i=document.getElementById(`pm-btn-new-clase`);i&&i.addEventListener(`click`,()=>{n||=Ai(),n.show(t.id)})})(),document.getElementById(`pm-btn-req-alumno`)?.addEventListener(`click`,async n=>{try{n.target.disabled=!0,n.target.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Solicitando...`,await De(t.id,`alumnos:create`),alert(`Solicitud enviada al administrador.`),ji(e)}catch(e){alert(`Error al solicitar permiso: `+e.message),n.target.disabled=!1,n.target.innerHTML=`<i class="bi bi-lock"></i> Solicitar Permiso`}}),document.getElementById(`pm-btn-req-clase`)?.addEventListener(`click`,async n=>{try{n.target.disabled=!0,n.target.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Solicitando...`,await De(t.id,`clases:enroll`),alert(`Solicitud enviada al administrador.`),ji(e)}catch(e){alert(`Error al solicitar permiso: `+e.message),n.target.disabled=!1,n.target.innerHTML=`<i class="bi bi-lock"></i> Solicitar Permiso`}});let a=()=>ji(e);window.removeEventListener(`alumno-registrado`,a),window.addEventListener(`alumno-registrado`,a,{once:!0}),window.removeEventListener(`clase-creada`,a),window.addEventListener(`clase-creada`,a,{once:!0})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:red">Error: ${k(t.message)}</p>`,console.error(`[GestionAlumnosClasesView]`,t)}}var q={dirty:!1,saving:!1,theme:localStorage.getItem(`portal-maestros-theme`)||`system`,pushEnabled:!1},Mi=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`},{key:`domingo`,label:`Domingo`}];function Ni(e){let t=C();if(!t){e.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Pi(n,t),Fi(n,t),Vi(n,t),Ii(r),Li(r,t),Ri(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),r.insertAdjacentHTML(`beforeend`,`<div id="pm-gestion-container" style="display:none;"></div>`),zi(r),Yi(t),Wi(t),Xi(),D(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-DqFoRP7a.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Bi(i,r,t.id,n);let a=document.getElementById(`pm-gestion-container`);a&&(r.puede_registrar_alumnos||r.puede_inscribir_clases)&&(a.style.display=`block`,await ji(a))}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Pi(e,t){let n=_e(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Fi(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ii(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Li(e,t){let n=le(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ri(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Bi(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await D(async()=>{let{getPermisos:e}=await import(`./permisoService-DqFoRP7a.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));Bi(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;if(t===`registrar-alumno`){ki().show(n);let e=t=>{window.removeEventListener(`alumno-registrado`,e)};window.addEventListener(`alumno-registrado`,e)}else if(t===`gestionar-clases`){Ai().show(n);let e=t=>{window.removeEventListener(`clase-creada`,e)};window.addEventListener(`clase-creada`,e)}})})}function Vi(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Mi.map(e=>Hi(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function Hi(e,t,n){let r=t.length>0;return`
    ...
    <div class="pm-avail-franja" data-dia="${e}" data-index="${t}">
    ...
    </div>`}function Wi(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{q.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>Gi(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,qi),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await he();e.success?(q.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await ce(),q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>Oi.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await se();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>Ji(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>Ji(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>Ji(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await D(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-DIdVZoeQ.js`);return{ausenciasPanel:e}},__vite__mapDeps([10,3,11,7,5,12,1,13]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>Ee.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,Ui(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function Gi(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=p(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=Ki();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}q.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let{error:a}=await x.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r,disponibilidad:i}).eq(`id`,e.id);if(a)throw a;let o={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(ne,JSON.stringify(o)),q.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}}))}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{q.saving=!1,a.disabled=!1,a.innerHTML=o}}function Ki(){let e={};return Mi.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function qi(){Ce.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await S(),window.location.reload(),!0)})}function Ji(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),q.theme=e}function Yi(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function Xi(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var Zi=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=Zi,document.head.appendChild(e)}async function Qi(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await W.getClasses(),{data:r}=await x.from(`clases`).select(`id, nombre, instrumento`).eq(`maestro_id`,t.id).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let t=await W.getRouteHierarchy(e);if(!t||t.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let n=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,r=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}async function ea(e,t){let n=e.querySelector(`#pm-alumno-progreso-root`);if(n)try{let{data:e,error:r}=await x.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1});if(r)throw r;if(!e||e.length===0){n.innerHTML=`<p class="pm-empty">Sin evaluaciones registradas.</p>`;return}let i=[...new Set(e.map(e=>e.indicator_id))],{data:a}=await x.from(`indicators`).select(`id, nombre, node_id`).in(`id`,i),o=[...new Set((a||[]).map(e=>e.node_id).filter(Boolean))],{data:s}=await x.from(`nodes`).select(`id, name`).in(`id`,o),c=new Map((s||[]).map(e=>[e.id,e.name])),l=new Map((a||[]).map(e=>[e.id,e])),u=new Map;for(let t of e){if(u.has(t.indicator_id))continue;let e=l.get(t.indicator_id);u.set(t.indicator_id,{id:t.indicator_id,nombre:e?.nombre||``,nodeName:c.get(e?.node_id)||``,latest:t,history:[]})}for(let t of e)if(u.has(t.indicator_id)){let e=u.get(t.indicator_id);(e.history.length===0||e.history[0].id!==t.id)&&e.history.push(t)}let d=Array.from(u.values()).filter(e=>e.latest.nota!=null&&e.latest.nota!==0||e.latest.observations&&e.latest.observations.trim()!==``),f=d.filter(e=>e.latest.nota>=4).length,p=d.length,m=p>0?Math.round(f/p*100):0;function h(e){return e==null?`⚫`:e>=4?`🟢`:e>=2?`🟡`:`🔴`}function g(e){return e==null?`pm-route-indicador--gray`:e>=4?`pm-route-indicador--green`:e>=2?`pm-route-indicador--yellow`:`pm-route-indicador--red`}n.innerHTML=`
    ...
    `,n.querySelectorAll(`.pm-eval-indicador`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.querySelector(`.pm-eval-timeline`),n=e.querySelector(`.pm-eval-toggle`),r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.classList.toggle(`bi-chevron-down`,r),n.classList.toggle(`bi-chevron-up`,!r)})})}catch(t){let n=e.querySelector(`#pm-alumno-progreso-root`);n&&(n.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger);">Error al cargar evaluaciones: ${k(t.message)}</p>`)}}async function ta(e,{alumnoId:t}){if(e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`,!C()){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){e.innerHTML=`<p class="pm-empty">No se especificó el alumno.</p>`;return}try{let{data:n,error:r}=await x.from(`alumnos`).select(`id, nombre_completo, instrumento_principal, tlf_alumno, fecha_nacimiento, created_at, nivel_actual`).eq(`id`,t).single();if(r||!n){console.error(`[AlumnoPerfil] Error al obtener alumno:`,r),e.innerHTML=`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back(),ea(e,t)}catch(t){console.error(`[AlumnoPerfil] Error crítico:`,t),e.innerHTML=`
    ...
    `}}var na={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},ra={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},ia={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function aa(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(na))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function oa(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await x.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await x.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${aa(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${k(e.name)}</span>
                          <span class="pm-node-status">${ia[n]}</span>
                        </div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${ra[t?.status||`pending`]};"></span>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var pa=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():C(),ma=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):F(...e),ha=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):la(...e),J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},ga=!1;async function _a(e,{onTopicSelected:t}={}){if(J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!pa()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(Ot(),J.clases=await ma(!0),!J.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}J.activeClaseId=J.clases[0].id,await va(),ya(e),Ca(e),wa(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function va(){J.loading=!0,J.rutaId=await ca(J.activeClaseId),J.rutaId?J.blocks=await ha(J.rutaId,J.activeClaseId):J.blocks=[],J.loading=!1}function ya(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!J.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(J.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}J.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),fa(r,{blockId:n.id,blockName:n.nombre,isExpanded:J.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{J.expandedBlocks.has(t)?J.expandedBlocks.delete(t):J.expandedBlocks.add(t),ya(e)}}),J.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(ba(n,e))})}}),xa(e)}function ba(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=J.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${Sa(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${Sa(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${Sa(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{J.expandedLevels.has(e.id)?J.expandedLevels.delete(e.id):J.expandedLevels.add(e.id),ya(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),J.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},ya(t)})}),n}function xa(e){let t=e.querySelector(`#ruta-action-panel`);if(!J.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{J.selectedIndicator=null,ya(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{pi({...J.selectedIndicator,indicatorId:J.selectedIndicator.id,claseId:J.activeClaseId}),J.onTopicSelected&&J.onTopicSelected(J.activeClaseId)})}function Sa(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Ca(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{J.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await va(),ya(e),Ca(e)})}function wa(e){ga||(ga=!0,da.on(`node-covered`,()=>{va().then(()=>{ya(e),Ca(e)})}))}var Ta=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Ea(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=C();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await x.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${Ta.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function Da(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await O.getStudent(t),r=await O.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await O.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},Aa={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([O.getRouteDetail(t),n?O.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},Y={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function ja(e){let t=C();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}Y.maestro=t,Y.submitting=!1;let n=await M(t.id);if(Y.permisos=n,Y.checked=!0,!n.puede_registrar_alumnos){Ma(e,n,t.id);return}try{let e=await F();Y.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),Y.clases=[]}Na(e),Ia(),Ra()}function Ma(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
        ...
        <div id="pm-register-action-container">
          ...
          `}
            ...
            <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.3); padding: 0.85rem; border-radius: 10px; display: inline-flex; align-items: center; gap: 8px; color: #eab308; font-weight: 600; font-size: 0.85rem; animation: pm-error-fade-in 0.3s ease;">
              <i class="bi bi-clock-history"></i> Solicitud Pendiente de Aprobación
            </div>`)}catch(t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al solicitar: `+t.message,type:`danger`}})),a.disabled=!1,a.innerHTML=e}})}function Na(e){e.innerHTML=`
    <div class="pm-settings pm-fade-in registro-alumno-view" role="main" aria-label="Registro de alumnos">
      <header class="pm-settings-header">
  ...
  `}function Ja(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await De(e,`clases:enroll`),E.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
    ...
    <div class="gcv-root">
      ...
      ${e.length===0?ao(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function Xa(e){let t=za(e.nombre||`Clase sin nombre`),n=Va(e.horarios||[]),r=za(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function Za(e,t){Ha=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await ke(e),a=i.map(e=>e.alumno).filter(Boolean);Wa=new Set(i.map(e=>e.alumno_id)),n.innerHTML=Qa(r,a,Ua.filter(e=>!Wa.has(e.id))),no(e,t)}catch(e){n.innerHTML=ao(`bi-exclamation-circle`,`Error al cargar alumnos`,za(e.message))}}}function Qa(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${za(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>$a(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>eo(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function $a(e){let t=za(e.nombre_completo||e.nombre||`Alumno`),n=za(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${Ba(t)}</div>
  ...
  `}async function oo(e){e.innerHTML=`
  ...
  `;try{let{data:t,error:n}=await x.from(`profiles`).select(`id, email, nombre_completo, created_at`).eq(`rol`,`maestro`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(n)throw n;let r=e.querySelector(`#aprobacion-content`);if(!t||t.length===0){r.innerHTML=`
          ...
          <tbody>
            ${t.map(e=>`
              <tr data-profile-id="${e.id}">
                <td>${co(e.nombre_completo||`—`)}</td>
                <td>${co(e.email)}</td>
                <td>${co(e.instrumento||`—`)}</td>
                <td>${lo(e.created_at)}</td>
    ...
    `,r.querySelectorAll(`.btn-aprobar`).forEach(e=>{e.addEventListener(`click`,()=>so(e.dataset.id,`activo`,r))}),r.querySelectorAll(`.btn-rechazar`).forEach(e=>{e.addEventListener(`click`,()=>so(e.dataset.id,`rechazado`,r))})}catch(t){let n=e.querySelector(`#aprobacion-content`);n.innerHTML=`
    ...
    `,console.error(`[AprobacionView] Error:`,t.message)}}async function so(e,t,n){let r=n.querySelector(`tr[data-profile-id="${e}"]`);if(r){r.querySelectorAll(`button`).forEach(e=>e.disabled=!0);try{let{error:i}=await x.from(`profiles`).update({estado:t}).eq(`id`,e);if(i)throw i;r.style.transition=`opacity 0.3s ease`,r.style.opacity=`0`,setTimeout(()=>r.remove(),300),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t===`activo`?`Maestro aprobado correctamente`:`Maestro rechazado`,type:`success`}}));let a=n.querySelector(`tbody`);a&&a.querySelectorAll(`tr`).length===0&&(n.innerHTML=`
      ...
      `)}catch(e){r.querySelectorAll(`button`).forEach(e=>e.disabled=!1),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al ${t===`activo`?`aprobar`:`rechazar`} maestro: ${e.message}`,type:`error`}})),console.error(`[AprobacionView] Action error:`,e.message)}}}function co(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function lo(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`})}catch{return e}}async function uo(){let{data:e,error:t}=await x.from(`ausencias_maestros`).select(`
      id,
      maestro_id,
      tipo_ausencia,
      urgencia,
    ...
    `).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(t)throw t;return e||[]}async function fo(e,t,n){let{data:r,error:i}=await x.from(`ausencias_maestros`).update({estado:t,decision_notas:n||null,decidido_en:new Date().toISOString()}).eq(`id`,e).select().single();if(i)throw i;return r}function po(e,t=``){return fo(e,`aprobada`,t)}function mo(e,t=``){return fo(e,`rechazada`,t)}function ho(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function go(e){return e.fecha_inicio===e.fecha_fin?e.fecha_inicio:`${e.fecha_inicio} al ${e.fecha_fin}`}function _o(e){return e.maestros?.nombre_completo||e.maestro_nombre||`Maestro no especificado`}function vo(e){return e.clase_emergente?.fecha?`Reprogramada para ${e.clase_emergente.fecha}${e.clase_emergente.hora?` a las ${e.clase_emergente.hora}`:``}`:e.maestro_suplente_id||e.suplente_nombre?`Suplente: ${e.suplente_nombre||e.maestro_suplente_id}`:`Pendiente de coordinación`}function yo(e,{onApprove:t=()=>{},onReject:n=()=>{}}={}){let r=document.createElement(`article`);r.className=`ausencia-approval-card`,r.dataset.ausenciaCard=e.id;let i=Array.isArray(e.clases_afectadas)?e.clases_afectadas.length:0;r.innerHTML=`
    <div class="ausencia-card-header">
      <div>
        <h3>${ho(_o(e))}</h3>
        <p>${ho(go(e))}</p>
      </div>
      <span class="badge bg-warning text-dark">${ho(e.estado||`pendiente`)}</span>
    </div>

    <dl class="ausencia-card-details">
      <div><dt>Tipo</dt><dd>${ho(e.tipo_ausencia)}</dd></div>
      <div><dt>Urgencia</dt><dd>${ho(e.urgencia)}</dd></div>
      <div><dt>Clases afectadas</dt><dd>Clases afectadas: ${i}</dd></div>
      <div><dt>Cobertura</dt><dd>${ho(vo(e))}</dd></div>
    </dl>

    <p class="ausencia-card-motivo">${ho(e.motivo||`Sin motivo especificado`)}</p>
  ...
  `;let a=()=>r.querySelector(`[data-decision-notes]`)?.value?.trim()||``;return r.querySelector(`[data-action="approve"]`).addEventListener(`click`,()=>t(e.id,a())),r.querySelector(`[data-action="reject"]`).addEventListener(`click`,()=>n(e.id,a())),r}function bo(e,t=`success`){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}function xo(e){e.innerHTML=`
    <div class="pm-view-header">
  ...
  `}async function Co(e){let t=e.querySelector(`#ausencias-admin-content`);t||(t=document.createElement(`div`),t.id=`ausencias-admin-content`,e.appendChild(t));let n=await uo();if(!n.length){So(t);return}t.innerHTML=`<div class="ausencias-admin-list"></div>`;let r=t.querySelector(`.ausencias-admin-list`);for(let t of n)r.appendChild(yo(t,{onApprove:async(t,n)=>{await po(t,n),bo(`Ausencia aprobada correctamente`,`success`),await Co(e)},onReject:async(t,n)=>{await mo(t,n),bo(`Ausencia rechazada`,`success`),await Co(e)}}))}async function wo(e){xo(e);try{await Co(e)}catch(t){let n=e.querySelector(`#ausencias-admin-content`);n||=(xo(e),e.querySelector(`#ausencias-admin-content`)),n||(n=document.createElement(`div`),n.id=`ausencias-admin-content`,e.appendChild(n)),n.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function Eo(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Do(e){let{claseId:t,fecha:n,isValid:r}=Eo(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}ae(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),Po(e.notification);let t=e.notification;t?.data?.deep_link?Do(t.data.deep_link):t?.data?.deep_link_url&&Do(t.data.deep_link_url),X.some(t=>t.id===e.notification.id)||(X.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Vo())}});var Oo=30*1e3,ko=60*1e3,Ao=120*1e3,jo=new Map;function Mo(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/ko)}`}function No(){let e=Date.now();for(let[t,n]of jo.entries())e>n&&jo.delete(t)}function Po(e){let t=Mo(e),n=Date.now()+Ao;jo.set(t,n)}function Fo(){return No(),jo.size}function Io(e){return`notif_cache_${e}`}function Lo(e){try{let t=X.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Io(e),JSON.stringify(t))}catch{}}function Ro(e){try{let t=localStorage.getItem(Io(e));return t?JSON.parse(t):[]}catch{return[]}}var X=[],zo=[];function Bo(e){return zo.push(e),e(X),()=>{zo=zo.filter(t=>t!==e)}}function Vo(){zo.forEach(e=>e([...X]))}async function Ho(){let e=C();if(!e)return[];X.length===0&&(X=Ro(e.id),X.length>0&&Vo());try{let{data:t,error:n}=await x.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),X;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=X.filter(e=>String(e.id).startsWith(`local_`));return X=[...r,...i],await Uo(e.id),Lo(e.id),Vo(),X}catch(e){return console.error(`[NotifService]`,e),X}}async function Uo(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([F(),St(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await xt(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;X.some(e=>e.referencia_id===c&&e.tipo===`in_app`)||X.unshift({id:`local_`+c,tipo:`in_app`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`} terminó hace ${Math.round(a)} min y no registraste asistencia.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;X.some(e=>e.referencia_id===c)||X.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`} empieza en ${Math.round(a)} minutos.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Wo(e){let t=C(),n=X.find(t=>t.id===e);if(n&&(n.estado=`leida`),Vo(),t&&Lo(t.id),!String(e).startsWith(`local_`))try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Go(e){let t=C();if(X=X.filter(t=>t.id!==e),Vo(),t&&Lo(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await x.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Ko(){let e=C();if(X.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Vo(),e&&Lo(e.id),e)try{await x.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function qo(){return X.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Jo=null;function Yo(){let e=C();e&&(Jo||=x.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};X.some(e=>e.id===n.id)||(X.unshift(n),Lo(e.id),Vo(),Zo(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=X.findIndex(e=>e.id===t.new.id);n!==-1&&(X[n]={...X[n],...t.new},Lo(e.id),Vo())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),e===`CHANNEL_ERROR`&&(console.warn(`[Realtime] Canal cerrado, el polling de fallback sigue activo.`),Jo=null)}))}function Xo(){Jo&&=(x.removeChannel(Jo),null)}function Zo(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Qo(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),es(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Qo(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var $o=!1;function es(){if($o)return;$o=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var ts=null;function ns(){ts===null&&(ts=setInterval(()=>{document.visibilityState!==`hidden`&&Ho()},Oo))}function rs(){ts!==null&&(clearInterval(ts),ts=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Ho(),ns()):rs()});function is(){let e=new Date().toISOString().split(`T`)[0];X=X.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}is(),document.visibilityState!==`hidden`&&ns(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{e.data?.type===`NAVIGATE_TO`&&e.data.hash&&(window.location.hash=e.data.hash)});var as=null;function os(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var ss={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(as=document.createElement(`div`),as.innerHTML=`
    ...
    `,document.body.appendChild(as),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Ko()}),Bo(e=>{this.renderList(e)}),Ho())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=Fo();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tenés notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=us(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=ds(e.tipo,e.items[0]);return`
        <div
        ...
        >
          <div class="pm-notif-icon ${ls(e.tipo)}">
            <i class="bi ${cs(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-time">${os(e.items[0].created_at)}</div>
          </div>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`))return;e.dataset.ids.split(`,`).forEach(e=>Wo(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Wo(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await Go(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Ho()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=j(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Ho()},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function cs(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function ls(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function us(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function ds(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}var fs={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    <div class="pm-main-area">
      ...
      <header class="pm-header">
        <div class="pm-header-left">
          <span class="pm-header-greeting">${ps?`Panel Admin`:`Hola,`}</span>
          <span class="pm-header-title">
            ${ps?t?.nombre_completo?.split(` `)[0]??`Administrador`:t?.nombre_completo?.split(` `)[0]??`Maestro`}
          </span>
        </div>
  ...
  `,xs();let a=document.getElementById(`pm-theme-toggle-container`);a&&a.appendChild(To.createToggleButton());let o=document.getElementById(`pm-footer-nav`);o&&o.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let s=document.getElementById(`pm-header-tabs`);s&&s.querySelectorAll(`.pm-header-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let c=document.getElementById(`pm-sidebar`);c&&c.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)}),document.getElementById(`pm-header-search-input`)?.addEventListener(`keydown`,e=>{if(e.key===`Enter`){let t=e.target.value.trim();t.length>1&&Z.navigate(`alumno?id=${encodeURIComponent(t)}`)}}),document.getElementById(`pm-sync-indicator`).addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await Ss()}),document.getElementById(`pm-bell-btn`)?.addEventListener(`click`,()=>{ss.open()}),document.getElementById(`pm-btn-push-diagnostic`)?.addEventListener(`click`,()=>{fs.open()}),document.getElementById(`pm-btn-install`)?.addEventListener(`click`,()=>{window.pwaInstaller&&window.pwaInstaller.promptInstall()});let l=(Z.currentRoute?.()||`hoy`).split(`?`)[0];Ms(l)}var As=!1;function js(){if(As)return;if(As=!0,Bo(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=qo();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Ho(),Yo(),!ps){let e=_s;if(e?.id){let t=x.channel(`permisos-maestro:${e.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${e.id}`},async t=>{console.log(`[Realtime] Permisos actualizados:`,t.new);try{let t=await M(e.id),n=document.getElementById(`portal-app`);if(!n)return;let r=[];t.puede_registrar_alumnos&&!vs?.puede_registrar_alumnos&&r.push(`Registrar Alumnos`),t.puede_inscribir_clases&&!vs?.puede_inscribir_clases&&r.push(`Gestionar e Inscribir Clases`);let i=(Z.currentRoute?.()||`perfil`).split(`?`)[0];ks(n,e,t),Fs(),Es(),Z.setAuthGuard(()=>it.isAuthenticated(),[`login`,`register`,`pending-approval`]),Ps.clear(),await $(i),Z.navigate(i),r.length>0?E.success(`¡Nuevos permisos activados: ${r.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):E.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>{console.log(`[Realtime] Canal permisos_maestros:`,e)});window.addEventListener(`beforeunload`,()=>{x.removeChannel(t)},{once:!0})}}document.addEventListener(`keydown`,e=>{if(Ds()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`)switch(e.key.toLowerCase()){case`h`:Z.navigate(`hoy`),t.length=0;break;case`c`:Z.navigate(`calendario`),t.length=0;break;case`r`:Z.navigate(`ruta`),t.length=0;break;case`m`:Z.navigate(`metricas`),t.length=0;break;case`p`:Z.navigate(`perfil`),t.length=0;break;default:break}t.length>3&&t.splice(0,t.length-2)});let e=null;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{let e=Ds();if(e!==Os){Os=e,document.body.dataset.pmLayout=e,ks(document.getElementById(`portal-app`),_s),Fs();let t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];Ms(t)}},250)},{passive:!0})}function Ms(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-header-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}var Ns={},Q=null,Ps=new Set;function Fs(){let e=document.getElementById(`pm-view-container`);e&&(e.innerHTML=``,[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`registrar-alumno`,`gestionar-clases`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),Ns[t]=n}),ps&&[`admin-alumnos`,`admin-programas`,`admin-maestros`,`admin-metricas`,`admin-config`,`admin-clases`,`admin-sesiones`,`admin-aprobacion`,`admin-ausencias`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),Ns[t]=n}))}async function $(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];n||Ms(a);let o=Ns[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Q==`function`&&(console.log(`[Router] Ejecutando cleanup de vista anterior...`),Q(),Q=null),Object.values(Ns).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),Ps.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{switch(a){case`login`:Pt(o,{onSuccess:()=>zs()});break;case`register`:Ft(o,{onSuccess:()=>Z.navigate(`pending-approval`)});break;case`pending-approval`:It(o,{onBackToLogin:()=>Z.navigate(`login`)});break;case`logout`:Ts(),Xo(),at().then(()=>window.location.reload());break;case`calendario`:case`clases`:Q=await Wt(o);break;case`hoy`:Q=await Lt(o,{onClaseClick:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`asistencia`:Q=await Ci(o,{claseId:i.get(`clase`),fecha:i.get(`fecha`)});break;case`metricas`:Q=$t(o);break;case`perfil`:Q=Ni(o);break;case`clase-emergente`:Q=Di(o,{maestroId:_s?.id});break;case`planificacion`:Q=await Qi(o);break;case`alumno`:Q=ta(o,{alumnoId:i.get(`id`)});break;case`gamificacion`:await oa(o);break;case`ruta`:await _a(o,{onTopicSelected:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:Ea(o);break;case`ruta-plan-builder`:Da(o,{alumnoId:i.get(`id`)});break;case`ruta-semanal`:Oa(o,{alumnoId:i.get(`id`)});break;case`ruta-libreria`:ka.render().then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`ruta-detalle`:Aa.render(t).then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`admin-alumnos`:u(o);break;case`admin-programas`:_(o);break;case`admin-maestros`:l(o);break;case`admin-metricas`:h(o);break;case`admin-config`:f(o);break;case`admin-clases`:g?.(o);break;case`admin-sesiones`:break;case`admin-aprobacion`:await oo(o),Q=null;break;case`admin-ausencias`:await wo(o),Q=null;break;case`registrar-alumno`:ja(o);break;case`gestionar-clases`:Q=await Ga(o);break;default:}clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]).has(a)&&Ps.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}async function Is(){if(_s)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[r,i,a]=await Promise.all([F(),F().then(e=>xt(e.map(e=>e.id))),F().then(()=>St(_s.id,n,n))]),o=Object.fromEntries(r.map(e=>[e.id,e]));await ue(i.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:o[e.clase_id]?.nombre||`Clase`})),a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}function Ls(){Ps.clear()}function Rs(e){Ps.delete(e)}async function zs(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`),console.log(`[Init] Llamando usePortalAuth.init()...`);let t=await it.init();console.log(`[Init] Auth completado:`,t?`con maestro`:`sin maestro`);let n=window.router||st(),r=[`login`,`register`,`pending-approval`],i=n.currentRoute().split(`?`)[0],a=r.includes(i);if(!t&&!a){console.log(`[Init] No maestro y ruta privada, mostrando login screen`),Ts();return}if(!t&&a){console.log(`[Init] No maestro pero ruta pública detectada:`,i),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Fs(),Es(),Z.setAuthGuard(()=>it.isAuthenticated(),r),Z.start();return}let o=null;if(!ps)try{o=await M(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}console.log(`[Init] Renderizando shell...`),ks(e,t,o),console.log(`[Init] Shell renderizado`),Fs(),js(),Lr(Rs,Ls),Es(),Z.setAuthGuard(()=>it.isAuthenticated(),[`login`,`register`,`pending-approval`]),Z.start(),Dt().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!Ps.has(e)).reduce((e,t)=>e.then(()=>{if(Ns[t])return $(t,{},{silent:!0})}),Promise.resolve()),Is()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),Ss()}window.addEventListener(`error`,e=>{let t=[`useCache`,`WebSocket`,`content.js`],n=e.message||``;if(t.some(e=>n.includes(e))){console.warn(`[Ignored Error]`,n);return}ze(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let r=document.getElementById(`portal-app`);r&&(r.innerHTML=`
    ...
    </div>`)}),zs().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});