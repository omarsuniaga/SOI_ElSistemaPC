...
const FIELDS = [
  {
    ...
    label: 'Calentamiento',
    type: 'text',
    placeholder: 'Ej: ejercicios preparatorios, técnica básica',
  },
  {
    key: 'sound_focus',
    label: 'Enfoque de Sonido',
    type: 'text',
    placeholder: 'Ej: calidad sonora, proyección',
  },
  {
    key: 'intonation_focus',
    label: 'Enfoque de Afinación',
    type: 'text',
    placeholder: 'Ej: intervalos, escalas',
  },
  {
    key: 'technical_focus',
    label: 'Enfoque Técnico',
    type: 'text',
    placeholder: 'Ej: técnica específica del área',
  },
  {
    key: 'study_used',
    label: 'Estudio/Método',
    type: 'text',
    placeholder: 'Ej: nombre del método o estudio',
  },
  {
    key: 'repertoire_used',
    label: 'Repertorio / Material',
    type: 'text',
    placeholder: 'Ej: obra o material trabajado',
  },
...
export function createMethodologyForm({ classEventId, onSave, initialData = {} }) {
  ...
  el.addEventListener('click', (e) => {
    if (
      e.target.closest('.pm-methodology-form-toggle') ||
      e.target.closest('.pm-methodology-form-header')
    ) {
      collapsed = !collapsed
