import"./modulepreload-polyfill-Dezn_h7o.js";import{i as e}from"./supabase-Cgh_dhNB.js";import"./vendor-GwDQZeW3.js";import{t}from"./horarioBuilderView-BJV277MI.js";import{t as n}from"./tareasView-Dxc2hHaO.js";async function r(t){let{data:n}=await e.from(`profiles`).select(`rol`).eq(`id`,t).maybeSingle();return[`admin`,`superadmin`,`coordinacion_academica`,`direccion`].includes(n?.rol)}function i(t,n=null){t.style.background=``,t.innerHTML=`
