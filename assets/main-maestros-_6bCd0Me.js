...
import{A as e,D as t,G as n,I as r,J as i,K as a,O as o,Q as s,U as c,X as l,Y as u,_ as d,a as f,at as p,ct as m,et as h,f as g,g as _,h as v,i as y,it as b,m as x,n as S,nt as C,o as w,ot as T,q as E,r as D,rt as O,s as ee,st as k,t as te,tt as ne,y as re}from"./adminNotificacionesView-_PbUiyxT.js";import{i as A}from"./supabase-C4ics26R.js";import{a as ie,i as ae,n as oe,r as j,t as se}from"./maestroAuth-Cae-9DFh.js";import{t as ce}from"./idb-DOPm7uLh.js";import{i as le,n as ue,t as de}from"./offlineQueue-Cjwl3aiF.js";import{a as fe,c as pe,d as me,f as he,i as ge,l as _e,n as ve,r as ye,s as be,t as M,u as xe}from"./pushService-DQD3mJWH.js";import"./vendor-BWfrAznO.js";import{t as N}from"./AppToast-BOjiJExQ.js";import{t as Se}from"./preload-helper-CsoeaaUJ.js";import{t as P}from"./academicService-DX1WEsMf.js";import{a as Ce,c as we,i as F,l as Te,n as Ee,o as De,r as Oe,s as ke,t as Ae}from"./portalUtils-CisZ9vg-.js";import{t as je}from"./AppModal-CLA9fW7x.js";import{a as Me,i as Ne,o as Pe,s as Fe,t as Ie}from"./groqService-KWo346Hv.js";import{n as Le,t as Re}from"./ausenciaModal-BAKZ-Gr2.js";import{n as ze,r as Be,t as Ve}from"./reportService-5Q32cAEY.js";import{a as He,c as Ue,s as We,u as Ge}from"./clasesApi-CiNtdXkj.js";import{r as Ke,t as qe}from"./permisoService-CVH_7Qhu.js";var Je=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ye(e=``){let t=String(e).toLowerCase();return Je.some(e=>t.includes(e.toLowerCase()))}var Xe=console.error;console.error=function(...e){e.length>0&&!Ye(e[0])&&Xe.apply(console,e)};var Ze=console.warn;console.warn=function(...e){e.length>0&&!Ye(e[0])&&Ze.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ye(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ye(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Qe=window.fetch;window.fetch=async function(...e){try{return await Qe.apply(window,e)}catch(e){if(!Ye(e.message))throw e;return null}};var $e=!1;function et(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),$e=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function tt(e,t={}){if(!$e&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var nt=!1;function rt(e={}){let{enabled:t=!1,consent:n=!1}=e;nt=t&&n,console.log(`[Analytics] Initialized, enabled:`,nt)}var it={windowMs:6e4,max:100};function at(e={}){it={...it,...e},console.log(`[RateLimit] Initialized: ${it.max} requests per ${it.windowMs}ms`)}var ot=null,st=new Set;function ct(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function lt(e={}){ot=ct(e.length||32),st.clear(),st.add(ot),console.log(`[CSRF] Initialized`)}var ut={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function dt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function ft(e={}){let{debug:t=!1,onReport:n=null}=e;if(!dt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),pt(t,n),mt(t,n),ht(t,n),gt(t,n),_t(t,n)}function pt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];ut.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function mt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ut.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function ht(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);ut.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function gt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ut.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function _t(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ut.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var I={maestro:null,loading:!0,listeners:[]},vt=null;function yt(){I.listeners.forEach(e=>e({...I}))}var bt={subscribe(e){return I.listeners.push(e),()=>{I.listeners=I.listeners.filter(t=>t!==e)}},async init(){if(console.log(`[usePortalAuth.init] Iniciando...`),I.maestro=j(),console.log(`[usePortalAuth.init] Maestro local:`,I.maestro?`found`:`not found`),I.loading=!0,yt(),typeof process<`u`&&{}.VITEST)return I.loading=!1,yt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),I.maestro;if(!vt){let{data:{subscription:e}}=A.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),I.maestro=null,yt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=j();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);let e=await oe();e&&(I.maestro=e,yt())}}});vt=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([oe(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),I.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),I.maestro=null}return I.loading=!1,yt(),console.log(`[usePortalAuth.init] Completado`),I.maestro},setMaestro(e){I.maestro=e,I.loading=!1,yt()},async logout(){await ie(),I.maestro=null,yt()},getMaestro:()=>I.maestro,isAuthenticated:()=>!!I.maestro,isLoading:()=>I.loading},xt=bt.logout,St=`calendario`;function Ct(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):St}function s(e,t=[`login`]){r=e,i=t,a=!0}function c(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.pushState({route:e},``,t),m(e)}function l(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),m(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),m(e)}function u(t,n){e.set(t,n)}function d(e){t=e}let f=null;function p(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function m(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}let s=a||t;if(!s)return;let c=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||f){f&&=(f.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),c();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),p(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await c()});f=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{f=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>p(e))})}catch{f=null,c()}}function h(){window.addEventListener(`popstate`,e=>{e.state?.route?m(e.state.route):m(o())});let e=o();e!==St&&history.replaceState({route:e},``,`#/${e}`),m(e)}return{currentRoute:o,setAuthGuard:s,navigate:c,replace:l,on:u,onNotFound:d,start:h,_dispatch:m}}var wt=null,Tt=null;function Et(e,t=`polite`){wt||(wt=document.createElement(`div`),wt.setAttribute(`aria-live`,t),wt.setAttribute(`aria-atomic`,`true`),wt.classList.add(`pm-visually-hidden`),document.body.appendChild(wt)),t===`assertive`?(wt.setAttribute(`role`,`alert`),wt.setAttribute(`aria-live`,`assertive`)):(wt.removeAttribute(`role`),wt.setAttribute(`aria-live`,`polite`)),clearTimeout(Tt),Tt=setTimeout(()=>{wt.textContent=``,requestAnimationFrame(()=>{wt.textContent=e})},50)}function Dt(e,t){if(!e||!e.id)return;Ot(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function Ot(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function kt(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>Ot(e))}function At(e,{onSuccess:t}){e.innerHTML=`
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function Nt(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=j();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let o=await O();if(!o||o.length===0){e.innerHTML=`<p class="pm-empty">No tenés clases asignadas.</p>`;return}let s=o.map(e=>e.id),c=Object.fromEntries(o.map(e=>[e.id,e])),l=(await ne(s)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!l||l.length===0){e.innerHTML=`
      ...
      `;return}let u=new Date(r);u.setDate(u.getDate()-3);let d=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,`0`)}-${String(u.getDate()).padStart(2,`0`)}`,f=new Date(r);f.setDate(f.getDate()-1);let m=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,`0`)}-${String(f.getDate()).padStart(2,`0`)}`,h=(await p(n.id,d,m)||[]).filter(e=>{if(!s.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),g=(await p(n.id,a,a)).filter(e=>s.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),_=new Set(g.map(e=>e.clase_id)),v=await C(s),y={};for(let e of v||[])e.clase_id&&(y[e.clase_id]=(y[e.clase_id]||0)+1);let x=[...new Set(l.map(e=>e.salon_id).filter(Boolean))],S=x.length>0?await b(x):[],w=Object.fromEntries(S.map(e=>[e.id,e.nombre])),T=l.map(e=>{let t=c[e.clase_id],n=_.has(t.id),r=y[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
        <div class="pm-clase-card ${i}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${F(w[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),E=h.length>0?`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await P.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await P.createSnapshotFromPlan(r,a,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${F(t.message)}</p>`}}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);e.id=`pm-hoy-pendientes-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Pt=null,Ft=null;function It(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],maestroId:i=null,onSave:a=null}=e;Pt=a,Ft=i,je.open({title:`⚡ Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
          ...
          <div class="pm-emergente-grid">
            ...
            <div class="pm-emergente-field">
              ...
              <select class="pm-emergente-select" id="modal-clase_id" required>
                ...
                ${r.map(e=>`<option value="${e.id}" ${e.id===n?`selected`:``}>${Lt(e.nombre)}</option>`).join(``)}
              </select>
            </div>
            <div class="pm-emergente-field">
  ...
  `}function Jt(e){e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);L.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await Gt(n,L.maestroId),r=Kt(t);L.clasesData=r.clasesData,L.todasSesiones=t.sesiones,L.inscripcionesPorClase=t.inscripcionesPorClase,L.alertasRiesgo=r.alertasRiesgo,e.innerHTML=qt(r),Jt(e),Et(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${F(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=L.clasesData.find(e=>e.id===i)?.alumnos||[],o=L.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
        ...
        <div class="pm-clase-students-list" role="list">
          ...
          `).join(``)}
        </div>`,n.appendChild(c),c.querySelector(`.pm-clase-students-close`).addEventListener(`click`,()=>c.remove());let l=t=>{!c.contains(t.target)&&t.target!==e&&(c.remove(),document.removeEventListener(`click`,l))};setTimeout(()=>document.addEventListener(`click`,l),10),c.querySelectorAll(`.pm-clase-student-row`).forEach(e=>{let t=()=>window.location.hash=`#/alumno?id=${e.dataset.alumno}`;e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})})})}function Yt(){if(!L.clasesData.length&&!Object.keys(L.inscripcionesPorClase).length)return null;let e=new Map;for(let[t,n]of Object.entries(L.inscripcionesPorClase)){let r=L.clasesData.find(e=>e.id===t);for(let t of n)e.has(t.id)||e.set(t.id,{...t,clases:[]}),r&&e.get(t.id).clases.push(r.nombre)}return[...e.values()]}async function Xt(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=j();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}L.maestroId=t.id;try{let n=await Gt(L.periodo,t.id),r=Kt(n);L.clasesData=r.clasesData,L.todasSesiones=n.sesiones,L.inscripcionesPorClase=n.inscripcionesPorClase,L.alertasRiesgo=r.alertasRiesgo,e.innerHTML=qt(r),Jt(e),Et(`Métricas actualizadas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`
      ...
      </div>`}}var R={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g,estados:/!(LOGRADO|EN_PROGRESO|INICIADO)\b/gi},Zt={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`,estados:{LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}};function Qt(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#\[\(\{\$>])/)[0].trim()),n.push(e)}return n}function $t(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function en(e){return{alumnos:Qt(e,R.alumnos),contenido:Qt(e,R.contenido),sugerencias:Qt(e,R.sugerencias),tareas:Qt(e,R.tareas),medidas:Qt(e,R.medidas),calificacion:$t(e),objetivos:Qt(e,R.objetivos),niveles:Qt(e,R.niveles),nodos:Qt(e,R.nodos),capas:Qt(e,R.capas),estados:Qt(e,R.estados).map(e=>e.toUpperCase())}}function tn(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],estados:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=en(i))}),{...en(e),por_capas:n}}function nn(e){if(!e)return``;let t=rn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(R.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Zt.capas}22; color:${Zt.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Zt.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Zt.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(R.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(R.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(R.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(R.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(R.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(R.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function rn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var an=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function on(e){if(!e||e.length===0)return an.slice(0,6);let t=e.toLowerCase();return an.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function sn(e){let t=an.find(t=>t.trigger===e);return t?t.expand:null}function cn(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function ln(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=ln(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var z=null,dn=[],fn=null,B=-1,pn=!1,mn=null,hn=!1,gn=0,_n=0;function vn(){if(!z){if(z=document.createElement(`div`),z.id=`pm-autocomplete-popup`,z.className=`pm-autocomplete-popup`,z.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(z)}}function yn(e,t,n={}){if(vn(),dn=e||[],fn=t,mn=n.trigger||null,B=-1,pn=!0,Tn(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),z.style.left=`${i}px`,z.style.top=`${a}px`}z.onmousedown=bn,document.addEventListener(`mousemove`,xn),document.addEventListener(`mouseup`,Sn),z.style.display=`block`}function bn(e){e.target.closest(`.pm-ac-option`)||(hn=!0,gn=e.clientX-z.offsetLeft,_n=e.clientY-z.offsetTop,z.style.cursor=`grabbing`,z.style.transition=`none`)}function xn(e){if(!hn)return;let t=e.clientX-gn,n=e.clientY-_n;z.style.left=`${Math.max(0,t)}px`,z.style.top=`${Math.max(0,n)}px`}function Sn(){hn&&(hn=!1,z.style.cursor=``)}function Cn(){z&&(z.style.display=`none`,hn=!1,document.removeEventListener(`mousemove`,xn),document.removeEventListener(`mouseup`,Sn)),dn=[],fn=null,B=-1,pn=!1,mn=null}function wn(e){dn=e||[],B=-1,Tn(e)}function Tn(e){if(!z)return;if(!e||e.length===0){z.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${kn(mn)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===B,o=An(mn,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Mn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Mn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),z.innerHTML=t,z.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{En(parseInt(e.dataset.index,10))})})}function En(e){if(e>=0&&e<dn.length){let t=dn[e];fn&&fn(t),Cn()}}function Dn(e){if(!(!pn||dn.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),B=Math.min(B+1,dn.length-1),Tn(dn),On();break;case`ArrowUp`:e.preventDefault(),B=Math.max(B-1,0),Tn(dn),On();break;case`Enter`:e.preventDefault(),B>=0?En(B):dn.length>0&&En(0);break;case`Escape`:e.preventDefault(),Cn();break;case`Tab`:dn.length>0&&B===-1&&(e.preventDefault(),En(0));break}}function On(){if(!z||B<0)return;let e=z.querySelector(`.pm-ac-option[data-index="${B}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function kn(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function An(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?jn(t.type):`•`}function jn(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Mn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Nn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Pn(){return pn}function Fn(){return B}var In={show:yn,hide:Cn,updateOptions:wn,handleKeyDown:Dn,getCursorPosition:Nn,isOpen:Pn,getSelectedIndex:Fn},Ln=`portal-maestros-catalogs`,Rn=1,zn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Bn=null;async function V(){return Bn||(Bn=await ce(Ln,Rn,{upgrade(e){for(let[t,n]of Object.entries(zn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Bn)}async function Vn(e,t){let n=await V(),r=await n.get(e,t);if(!r)return null;let i=zn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Hn(e){let t=await(await V()).getAll(e),n=zn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Un(e,t,n){return(await V()).getAllFromIndex(e,t,n)}async function Wn(e,t){let n=await V(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Gn(e,t){let n=(await V()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Kn(e,t){await(await V()).delete(e,t)}async function qn(e){await(await V()).clear(e)}async function Jn(e){let t=await V(),n=zn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Yn(){let e=await V();for(let t of Object.keys(zn))await e.clear(t)}async function Xn(e){return(await Hn(e)).length}async function Zn(e,t){let n=await V(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Qn(e){return(await V()).get(`historial`,e)}async function $n(e,t=5){return(await(await V()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var H={get:Vn,getAll:Hn,getByIndex:Un,set:Wn,setBulk:Gn,remove:Kn,clear:qn,cleanExpired:Jn,clearAll:Yn,getStoreSize:Xn,addToHistorial:Zn,getHistorial:Qn,getTopUsed:$n};async function er(e){if(!e)return[];try{let{data:t,error:n}=await A.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function tr(){let e=await H.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await A.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function nr(){let e=await H.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await A.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function rr(){let e=await H.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await A.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function ir(){let e=await H.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await A.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ar(){let e=await H.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await A.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await A.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await A.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await H.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function or(e=null){let t=await H.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=A.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await H.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function sr(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await er(n.claseId));break;case`[`:r=await tr();break;case`(`:r=await rr();break;case`{`:r=await ir();break;case`$`:r=await nr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ar():await or(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=cr(r,t)),e&&e!==`#`){let t=(await H.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function cr(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=lr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function lr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function ur(e,t){await H.addToHistorial(e,t)}var dr=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function Sr(e,t=null,r=[],i=[],a={},o){let c=e===`edit`&&!!t,l=c?t:{...a};!c&&a.contenido&&!l.notas_dsl&&(l.notas_dsl=a.contenido),!c&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let u=new h(l),d=document.getElementById(`pm-planificacion-modal`);if(d&&d.remove(),d=document.createElement(`div`),d.id=`pm-planificacion-modal`,d.className=`pm-plan-modal-overlay`,d.innerHTML=wr(c,u,r,i),document.body.appendChild(d),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Tr(),document.head.appendChild(e)}let f=()=>{d.classList.remove(`open`),setTimeout(()=>d.remove(),200)};d.querySelector(`.pm-plan-close-x`).onclick=f,d.querySelector(`.pm-plan-cancel-btn`).onclick=f,d.querySelector(`.pm-plan-backdrop`).onclick=f;let p=e=>{e.key===`Escape`&&(f(),document.removeEventListener(`keydown`,p))};document.addEventListener(`keydown`,p);let m=d.querySelector(`#pl-plantilla`);m&&m.addEventListener(`change`,e=>{let t=xr.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(d.querySelector(`#pl-objetivos`).value=t.objetivos,d.querySelector(`#pl-contenido`).value=t.contenido,d.querySelector(`#pl-recursos`).value=t.recursos,d.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Dr(d))});let g=d.querySelector(`#pl-clase_id`);g&&g.addEventListener(`change`,()=>{let e=d.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Or(r,g.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),Er(d);let _=d.querySelector(`#dsl-editor-container`);if(_){let e=n({onSelect:async e=>{let n=(await E()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=s({initialContent:u.notas_dsl||``,onChange:(e,t)=>{let n=d.querySelector(`#dsl-summary`);n&&(n.textContent=Ar(t))},onAlumnoClick:()=>e.openModal()});_.appendChild(t),d._dslEditor=t}let v=d.querySelector(`.pm-plan-save-btn`);v.onclick=async()=>{let e=d.querySelector(`#pl-tema`)?.value.trim(),t=d.querySelector(`#pl-clase_id`)?.value;if(!e){d.querySelector(`#pl-tema`).focus();return}if(!t){d.querySelector(`#pl-clase_id`).focus();return}v.disabled=!0,v.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=d.querySelector(`#pl-recursos`)?.value||``,r=d._dslEditor,i={clase_id:t,maestro_id:d.querySelector(`#pl-maestro_id`)?.value||null,instrumento:d.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:d.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:d.querySelector(`#pl-objetivos`)?.value.trim(),contenido:d.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:d.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:d.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:c&&d.querySelector(`#pl-estado`)?.value||`planificado`};o&&await o(i),f()}catch(e){console.error(`[planificacionModal] Error:`,e),v.disabled=!1,v.textContent=c?`Guardar cambios`:`Guardar`}};let y=d.querySelector(`.pm-plan-body`);if(y){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;y.firstChild;)t.appendChild(y.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
  ...
  `}function Er(e){[{input:`pl-tema`,count:`pl-tema-count`},{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&r.addEventListener(`input`,()=>{i.textContent=r.value.length})})}function Dr(e){[{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&(i.textContent=r.value.length)})}function Or(e,t,n){let r=e.find(e=>e.id===t);return r?.instrumento?r.instrumento.split(`,`).map(e=>e.trim()).filter(Boolean).map(e=>`<option value="${kr(e)}" ${n===e?`selected`:``}>${kr(e)}</option>`).join(``):``}function kr(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function Ar(e){let t=[];return e.alumnos.length&&t.push(`${e.alumnos.length} alum.`),e.contenido.length&&t.push(`${e.contenido.length} cont.`),e.tareas.length&&t.push(`${e.tareas.length} tar.`),e.calificacion&&t.push(`${e.calificacion.valor}/${e.calificacion.sobre}`),t.length?t.join(`, `):`Sin tokens`}var U={async getClasses(){let{data:e,error:t}=await A.from(`plan_clases`).select(`*`).eq(`activo`,!0).order(`nombre`);return t?(console.error(`Error loading classes:`,t),[]):e},async resolveSmartPlan(e){let t=await this.getClasses();if(!t.length)return null;let n=(e.nombre||``).toLowerCase(),r=(e.instrumento||``).toLowerCase(),i=t.find(e=>(e.nombre||``).toLowerCase()===n);return i||r&&(i=t.find(e=>(e.nombre||``).toLowerCase().includes(r)),i)?i:(i=t.find(e=>{let t=(e.nombre||``).toLowerCase();return n.includes(t)||t.includes(n)}),i||t[0])},async addClass(e){let{data:t,error:n}=await A.from(`plan_clases`).insert([{nombre:e}]).select().single();if(n)throw n;return t},async updateClass(e,t){let{error:n}=await A.from(`plan_clases`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteClass(e){let{error:t}=await A.from(`plan_clases`).delete().eq(`id`,e);if(t)throw t},async getLevelsByClass(e){let{data:t,error:n}=await A.from(`plan_niveles`).select(`*`).eq(`clase_id`,e).order(`numero_nivel`,{ascending:!0});return n?(console.error(`Error loading levels:`,n),[]):t},async addLevel({clase_id:e,nombre:t,numero_nivel:n}){let{data:r,error:i}=await A.from(`plan_niveles`).insert([{clase_id:e,nombre:t,numero_nivel:n||1}]).select().single();if(i)throw i;return r},async updateLevel(e,t){let{error:n}=await A.from(`plan_niveles`).update(t).eq(`id`,e);if(n)throw n},async deleteLevel(e){let{error:t}=await A.from(`plan_niveles`).delete().eq(`id`,e);if(t)throw t},async getNodesByLevel(e){let{data:t,error:n}=await A.from(`plan_temas`).select(`*`).eq(`nivel_id`,e).order(`orden_index`);return n?(console.error(`Error loading topics:`,n),[]):t},async addNode({nivel_id:e,nombre:t,tipo:n}){let{data:r,error:i}=await A.from(`plan_temas`).insert([{nivel_id:e,nombre:t,tipo:n||`TECNICA`}]).select().single();if(i)throw i;return r},async updateNode(e,t){let{error:n}=await A.from(`plan_temas`).update(t).eq(`id`,e);if(n)throw n},async deleteNode(e){let{error:t}=await A.from(`plan_temas`).delete().eq(`id`,e);if(t)throw t},async getObjectivesByNode(e){let{data:t,error:n}=await A.from(`plan_objetivos`).select(`*`).eq(`tema_id`,e).order(`orden_index`);return n?(console.error(`Error loading objectives:`,n),[]):t},async addObjective({tema_id:e,nombre:t}){let{data:n,error:r}=await A.from(`plan_objetivos`).insert([{tema_id:e,nombre:t}]).select().single();if(r)throw r;return n},async updateObjective(e,t){let{error:n}=await A.from(`plan_objetivos`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteObjective(e){let{error:t}=await A.from(`plan_objetivos`).delete().eq(`id`,e);if(t)throw t},async getIndicatorsByObjective(e){let{data:t,error:n}=await A.from(`plan_indicadores`).select(`*`).eq(`objetivo_id`,e).order(`orden_index`);return n?(console.error(`Error loading indicators:`,n),[]):t},async addIndicator({objetivo_id:e,descripcion:t,es_requerido:n}){let{data:r,error:i}=await A.from(`plan_indicadores`).insert([{objetivo_id:e,descripcion:t,es_requerido:n??!0}]).select().single();if(i)throw i;return r},async updateIndicator(e,t){let{error:n}=await A.from(`plan_indicadores`).update(t).eq(`id`,e);if(n)throw n},async deleteIndicator(e){let{error:t}=await A.from(`plan_indicadores`).delete().eq(`id`,e);if(t)throw t},async getRouteHierarchy(e){let t=e;if(!t){let e=await this.getClasses();if(e.length>0)t=e[0].id;else return null}let{data:n,error:r}=await A.from(`plan_niveles`).select(`
        *,
        plan_temas (
          *,
          plan_objetivos (
      ...
      `).eq(`clase_id`,t).order(`numero_nivel`);return r?(console.error(`Error loading hierarchy:`,r),null):n},async importStructure(e,t){if(!e||!t)throw Error(`Faltan datos para la importación.`);console.log(`[Adapter] Iniciando importación masiva optimizada (4 niveles) para clase: ${e}`);for(let n of t.niveles||[]){let{data:t,error:r}=await A.from(`plan_niveles`).insert([{clase_id:e,nombre:n.nombre,numero_nivel:n.numero_nivel||1,objetivo_general:n.objetivo_general}]).select().single();if(r)throw r;let i=(n.temas||[]).map(e=>({nivel_id:t.id,nombre:e.nombre,tipo:e.tipo||`TECNICA`,es_critico:e.es_critico||!1,_originalRef:e}));if(!i.length)continue;let{data:a,error:o}=await A.from(`plan_temas`).insert(i.map(({_originalRef:e,...t})=>t)).select();if(o)throw o;for(let e=0;e<a.length;e++){let t=a[e],n=i[e]._originalRef.objetivos||[];if(!n.length)continue;let r=n.map(e=>({tema_id:t.id,nombre:e.nombre||e,_originalRef:e})),{data:o,error:s}=await A.from(`plan_objetivos`).insert(r.map(({_originalRef:e,...t})=>t)).select();if(s)throw s;let c=[];if(o.forEach((e,t)=>{let n=r[t]._originalRef;n.indicadores&&n.indicadores.length>0&&n.indicadores.forEach(t=>{c.push({objetivo_id:e.id,descripcion:t.descripcion,es_requerido:t.es_requerido??!0})})}),c.length>0){let{error:e}=await A.from(`plan_indicadores`).insert(c);if(e)throw e}}}return console.log(`[Adapter] Importación masiva (4 niveles) completada con éxito.`),!0}},W={activeClassId:null,activeLevelId:null,activeNodeId:null,activeObjectiveId:null};async function jr(e,t=null){t&&(W.activeClassId=t),e.innerHTML=`
  ...
  `,await Pr()}async function Mr(e,t,n,r){je.open({title:`Editar ${e}`,body:`
...
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=tn(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function qr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Jr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Yr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await A.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Xr(e,t){let{data:n,error:r}=await A.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await A.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await A.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Jr(a??[],l),indicators:n,totalAlumnos:l}}async function Zr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Gr(e);try{let t=e;i===`natural`&&(t=await Pe(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=qr(Kr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Qr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
  ...
  `}function ui({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Qr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){ke()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=Te(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=j();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await A.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=ci(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=Le(o,{onClose:()=>h()});try{let n=await ni(e.id,t);s=n.indicatorSummaries,o.innerHTML=si(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=li(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}function di({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function fi(e,t,n){let{data:r,error:i}=await A.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await A.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await A.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function pi(e,t){let{data:n,error:r}=await A.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function mi(e){let{error:t}=await A.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function hi(e,t,n,r,i=null){let{error:a}=await A.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await A.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var gi=`soi_ruta_tema_pendiente`;function _i(e){sessionStorage.setItem(gi,JSON.stringify(e))}function vi(){let e=sessionStorage.getItem(gi);if(!e)return null;sessionStorage.removeItem(gi);try{return JSON.parse(e)}catch{return null}}function yi(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
`),s=[];for(let e of o){let t=tn(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:ji({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ni({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await A.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Di(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Di(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await A.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Pi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Fi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function K(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Ii={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Li(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Ii[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Ri(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${K(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${K(n.join(`, `))}</span>`:``}}function o(e,t){let n=Pi[e.estado]??Pi.EN_PROGRESO,r=e.nota?` · ${K(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${K(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Ii[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${K(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${K(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${K((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${K(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${K(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Li(c)}</div>`:``,d=Fe(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${K(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${K(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,zi(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Fi.indexOf(i)+1)%Fi.length;r[n].estado=Fi[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function zi(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function Bi(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await A.from(`progresos`).select(`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${Ui(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${Ui(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${Ui(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}function Gi(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Ki(e){let{claseId:t,fecha:n,isValid:r}=Gi(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}fe(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),$i(e.notification);let t=e.notification;t?.data?.deep_link?Ki(t.data.deep_link):t?.data?.deep_link_url&&Ki(t.data.deep_link_url),q.some(t=>t.id===e.notification.id)||(q.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),oa())}});var qi=30*1e3,Ji=60*1e3,Yi=120*1e3,Xi=new Map;function Zi(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Ji)}`}function Qi(){let e=Date.now();for(let[t,n]of Xi.entries())e>n&&Xi.delete(t)}function $i(e){let t=Zi(e),n=Date.now()+Yi;Xi.set(t,n)}function ea(){return Qi(),Xi.size}function ta(e){return`notif_cache_${e}`}function na(e){try{let t=q.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(ta(e),JSON.stringify(t))}catch{}}function ra(e){try{let t=localStorage.getItem(ta(e));return t?JSON.parse(t):[]}catch{return[]}}var q=[],ia=[];function aa(e){return ia.push(e),e(q),()=>{ia=ia.filter(t=>t!==e)}}function oa(){ia.forEach(e=>e([...q]))}async function sa(){let e=j();if(!e)return[];q.length===0&&(q=ra(e.id),q.length>0&&oa());try{let{data:t,error:n}=await A.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),q;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=q.filter(e=>String(e.id).startsWith(`local_`));return q=[...r,...i],await ca(e.id),na(e.id),oa(),q}catch(e){return console.error(`[NotifService]`,e),q}}async function ca(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([O(),p(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await ne(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(q.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let d=e.hora_fin?e.hora_fin.slice(0,5):``,f=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=f&&d?` (${f}–${d})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;q.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(q.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=Math.round(a);q.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${d} ${d===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function la(e){let t=j(),n=q.find(t=>t.id===e);if(n&&(n.estado=`leida`),oa(),t&&na(t.id),!String(e).startsWith(`local_`))try{await A.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function ua(e){let t=j();if(q=q.filter(t=>t.id!==e),oa(),t&&na(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await A.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function da(){let e=j();if(q.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),oa(),e&&na(e.id),e)try{await A.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function fa(){return q.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var pa=null;function ma(){let e=j();e&&(pa||=A.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};q.some(e=>e.id===n.id)||(q.unshift(n),na(e.id),oa(),ga(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=q.findIndex(e=>e.id===t.new.id);n!==-1&&(q[n]={...q[n],...t.new},na(e.id),oa())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),e===`CHANNEL_ERROR`&&(console.warn(`[Realtime] Canal cerrado, el polling de fallback sigue activo.`),pa=null)}))}function ha(){pa&&=(A.removeChannel(pa),null)}function ga(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=_a(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),ya(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function _a(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var va=!1;function ya(){if(va)return;va=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var ba=null;function xa(){ba===null&&(ba=setInterval(()=>{document.visibilityState!==`hidden`&&sa()},qi))}function Sa(){ba!==null&&(clearInterval(ba),ba=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(sa(),xa()):Sa()});function Ca(){let e=new Date().toISOString().split(`T`)[0];q=q.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}Ca(),document.visibilityState!==`hidden`&&xa();async function wa(e,{claseId:t,fecha:n}={}){let r=typeof e==`string`?document.getElementById(e):e;if(!r){console.error(`[asistenciaView] Container not found:`,e);return}r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=j();if(!i){r.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){r.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let a=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,s,c]=await Promise.all([O(),ne([t]),C([t]),A.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,i.id).eq(`fecha`,a).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let l=n.find(e=>e.id===t);if(!l){console.log(`[DEBUG] Clase not found in misClases`),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let u=o.find(t=>t.dia?.toLowerCase()===e),d=(s||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),f=c.data?.[0],p=f?.id||null,m=f?.updated_at||null,h=f?.contenido||``,g=l.salon?[l.salon]:[],[_,v]=await Promise.all([p?A.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,p).then(e=>e.data||[]):Promise.resolve([]),g.length>0?b(g):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let y=v.length>0?v[0].nombre:null,x=`pm_asistencia_${t}_${a}`,S=localStorage.getItem(`${x}_updated`),w=!1;m&&S&&new Date(m).getTime()>new Date(S).getTime()+5e3&&(w=!0);let T=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await A.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();T=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let E={},D={};d.forEach(e=>{E[e.id]=null});let ee=f?.asistencia||[];if(ee.length===0&&p)try{let{data:e}=await A.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,p);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};ee=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let k={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};ee.forEach(e=>{if(E.hasOwnProperty(e.alumno_id)){let t=k[e.estado]??e.estado;E[e.alumno_id]=t}});let te=[];if(p)try{te=await A.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,p).then(e=>e.data||[]),te.forEach(e=>{E.hasOwnProperty(e.alumno_id)&&(E[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Ta(r,{clase:l,horario:u,alumnos:d,estado:E,justificaciones:D,maestro:i,fechaHoy:a,claseId:t,sesionId:p,hasConflict:w,serverDSL:h,snapshots:_,salonNombre:y,rutaId:T,sesionExistenteData:f})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${F(e.message)}</p>`}}function Ta(n,i){let{clase:a,horario:o,alumnos:s,estado:c,justificaciones:l,maestro:u,fechaHoy:d,claseId:f,snapshots:p,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v}=i,y=i.sesionId,b=[],x=`pm_asistencia_${f}_${d}`,S=m,C=null,w=Ei(),E=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          ...
          <p class="pm-asist-subtitle">
            ${g?`📍 ${F(g)} · `:``}
            ${o?`${De(o.hora_inicio)} – ${De(o.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${Ce(new Date(d+`T12:00:00`))}</span> · 
            ${s.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let D=n.querySelector(`#pm-dsl-toolbar-container`),ee=n.querySelector(`#pm-dsl-editor-container`),k=fr(ee,{initialContent:m,onChange:e=>{S=e}});k.setContext({claseId:f});let te=hr(n,{onAceptar:e=>{k.setValue(e)}}),ne=cn(n,{onAccept:e=>{k.setValue(e)}}),re=Ri(ee.parentNode,{onConfirm:async e=>{try{let t=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await ji({sesionId:y,claseId:f,maestroId:u.id,fechaHoy:d,progressRecords:e,alumnos:t});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=n.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(e){n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),N.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Wi(n.querySelector(`#pm-planificacion-dropdown`)||n,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await r({instrumento:e,nivel:t,descripcion:n,pilares:i}),{linked:s}=await Ni({claseId:f,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;N.success(c)}catch(e){N.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=un(D,{onInsert:(e,t,n)=>k.insertText(e,t,n),getEditorContent:()=>k.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=D.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Ne(e);te.open({original:e,improved:t})}catch(e){N.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=D.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=E?.getActiveIndicador(),n=await Pe(e,{presentes:s.filter(e=>c[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){N.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async e=>{try{let t=s.filter(e=>c[e.id]&&c[e.id]!==`A`),r=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},i=s.map(e=>e.nombre_completo||e.nombre||``),o=await Ie(e,{alumnos:s.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),presentes:t.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),tipoClase:Ae(a),instrumento:a.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:E?.getActiveIndicador()?.nombre||``});n.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`),re.open({progreso:o.progreso,resumen:o.resumen})}catch(e){N.error(`Error al analizar con IA: `+e.message)}}}),oe=null,j=n.querySelector(`#pm-planificacion-card`),se=n.querySelector(`#pm-planificacion-dropdown`),ce=n.querySelector(`#pm-planificacion-nombre`);n.querySelector(`#pm-planificacion-detail`);let le=n.querySelector(`#pm-plan-list-rutas`),ue=n.querySelector(`#pm-plan-list-planificaciones`),fe=n.querySelector(`#pm-planificacion-header`);fe&&fe.addEventListener(`click`,()=>{let e=j.classList.toggle(`open`);se.style.display=e?`block`:`none`}),n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>{e.addEventListener(`click`,()=>{n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;le.style.display=t===`rutas`?``:`none`,ue.style.display=t===`planificaciones`?``:`none`})});function pe(e){oe=e.id,localStorage.setItem(`pm_default_plan_${f}`,e.id),ce&&(ce.textContent=e.nombre||e.name||`Sin nombre`),ue.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.planId===e.id)}),E&&=(E.destroy(),null);let t=n.querySelector(`#pm-route-tree-container`),r=n.querySelector(`#pm-active-tema-badge`);oe&&t&&(t.innerHTML=``,Re(f).then(e=>{E=Wr(t,{claseId:f,rutaId:oe,completedTopics:e,onIndicadorSelect:e=>{k.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),j.classList.remove(`open`),se.style.display=`none`}}),b.push(()=>E.destroy())}))}let me=n.querySelector(`#btn-manage-planning`);me&&(me.onclick=e=>{if(e.stopPropagation(),!oe){je.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}je.open({title:`Gestionar Estructura: ${ce.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(E&&E.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&jr(t,oe)}),j&&(async()=>{try{let e=await U.getClasses(),t=localStorage.getItem(`pm_default_plan_${f}`),n=(a.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});le&&(le.innerHTML=r.length?r.map(e=>`
              ...
              </div>`).join(``):`<div style="padding:0.5rem;font-size:0.8rem;color:var(--pm-text-muted)">No hay planes sugeridos para este instrumento</div>`,le.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=r.find(t=>t.id===e.dataset.planId);t&&pe(t)})})),ue&&(ue.innerHTML=e.map(e=>`
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${F(e.nombre||e.name)}</span>
            </div>`).join(``),ue.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&pe(n)})})),j.style.display=``;let i=e.find(e=>e.id===t)||r[0]||await U.resolveSmartPlan(a);i&&pe(i)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let he=n.querySelector(`#btn-proponer-curriculo`);he&&(he.onclick=async()=>{he.disabled=!0,he.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await Bi(f,12);if(e.registros.length===0){N.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Me(e,{instrumento:a?.instrumento||``,nivel:``,nombreClase:a?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:a?.instrumento||``,nivel:``})}catch(e){N.error(`Error al generar propuesta: `+e.message)}finally{he.disabled=!1,he.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let ge=n.querySelector(`#btn-copy-as-plan`);ge&&ge.addEventListener(`click`,async()=>{let t=k.getValue();Sr(`create`,null,await O(),[],{clase_id:f,maestro_id:u?.id||null,maestro_nombre:u?.nombre_completo||null,contenido:t||``,fecha_inicio:d},async t=>{try{await e({...t,estado:`planificado`});let n=document.createElement(`div`);n.className=`pm-toast-success`,n.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(n),setTimeout(()=>n.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),N.error(`Error al guardar la planificación: `+(e.message||e))}})}),_&&(E=Wr(n.querySelector(`#pm-route-tree-container`),{claseId:f,rutaId:_,onIndicadorSelect:e=>{k.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``)}}),b.push(()=>E.destroy())),console.log(`[DEBUG] Reached handoff section`);let _e=vi();if(_e&&_e.claseId===f){let e=`[${_e.nombre}] `;k.insertText(e),ae.setContext({indicadorActivo:_e.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``);let r=n.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let ve=yi(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&A.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&wi(t).catch(console.warn),c[e]=null,delete l[e],we(e),Ee(),await Oe(!0),Et(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await A.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await A.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=A.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await A.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{y||await Oe(!0,!1);let r=await Si({sesionId:y,alumnoId:e,claseId:f,fecha:d,motivo:t,creadoPor:u.id},n);if(r.error)throw r.error;o=r.data}o&&(l[e]=o),ve.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{c[e]=t,we(e),Ee()}});b.push(()=>{try{ve.close()}catch{}});let ye=null,be=n.querySelector(`#pm-draft-indicator`);if(y){ye=di({saveFn:async e=>{y&&await fi(y,u.id,e)},debounceMs:3e4}),ye.onSaved(()=>{let e=new Date;be.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,be.style.display=``}),k.getValue;let e=ee.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),ye&&ye.onInput(k.getValue())}}b.push(()=>ye.destroy()),v?.borrador===!0&&pi(y,u.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(k.setValue(e.contenido_raw),S=e.contenido_raw):mi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}n.querySelector(`#pm-academic-tools`);let M=n.querySelector(`#btn-guardar-obs`);M&&(_&&(M.style.display=``),M.onclick=async()=>{let e=k.getValue();if(!e||!e.trim()){N.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!y){N.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let t=null,r=await He(e),i=E?.getActiveIndicador();if(t=r||i,!t){N.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let o=n.querySelector(`#pm-active-tema-badge`);o&&t.nombre&&(o.textContent=t.nombre,o.style.display=`inline-block`),M.disabled=!0,M.textContent=`Procesando...`;try{let n=s.filter(e=>c[e.id]===`P`),r=await Zr(e,t.id,n,t.nombre);if(r.error)throw Error(r.error);if(r.modo===`natural`&&r.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+r.dslGenerado+`

¿Guardar la evaluación?`)){M.disabled=!1,M.textContent=`Guardar observación`;return}if(r.missing.length>0&&!confirm(`Faltan ${r.missing.length} alumno(s) sin evaluar:\n${r.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){M.disabled=!1,M.textContent=`Guardar observación`;return}if(r.evaluaciones.length>0){let{error:e}=await Yr(y,t.id,r.evaluaciones,u.id);if(e)throw e}let i={indicador_id:t.id,evaluaciones:r.evaluaciones};await hi(y,u.id,e,i,r.dslGenerado||null);let o=tn(e);if(o.estados&&o.estados.length>0){let t=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Mi({sesionId:y,claseId:f,maestroId:u.id,fechaHoy:d,dslText:e,alumnos:t}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Fe(e,ee)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await Ti(y,f,u.id,r.evaluaciones,a.nombre||`Clase`);l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),E&&await E.refresh(),k.setValue(``),S=``;let p=document.createElement(`div`);p.innerHTML=`
        ...
        `,p.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(p),setTimeout(()=>p.remove(),4500),M.textContent=`¡Guardado!`,setTimeout(()=>{M.textContent=`Guardar observación`,M.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),N.error(`Error al guardar: `+(e.message||e)),M.disabled=!1,M.textContent=`Guardar observación`}});let xe=null,P=n.querySelector(`#pm-alumnos-list`);function we(e=null){let t=Ea(s,c),n=null;if(e){let t=P.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(P.innerHTML=t.map(e=>Te(e,c[e.id])).join(``),e&&n){let t=P.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Te(e,t){return`
    ...
    `}P.onclick=async e=>{let t=e.target.closest(`.pm-asist-btn`),r=e.target.closest(`.pm-asist-nombre`);if(r){let e=r.closest(`.pm-asist-item`).dataset.id,t=s.find(t=>t.id===e);if(_){xe&&xe.destroy(),xe=ui({alumno:t,rutaId:_,sessionId:y,claseId:f,fecha:d,horaInicio:o?.hora_inicio||null}),xe.open(),b.push(()=>{xe&&xe.destroy()});return}let i=p.filter(t=>t.student_id===e);if(i.length===0)try{let{academicService:t}=await Se(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(y,e,d);n?(i=n,p.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${e}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}mr(n,{student:t,sessionId:y,teacherId:u.id,snapshots:i});return}if(!t)return;let{id:i,action:a}=t.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),a===`J`){let e=s.find(e=>e.id===i);if(!e)return;if(c[i]===`J`){let t=l[i]||null;!t&&y&&(t=await Ci(y,i),t&&(l[i]=t)),ve.open(e,t,null),Et(`Editando justificación de ${e.nombre_completo}.`)}else c[i]=`J`,we(i),Ee(),await Oe(!0),ve.open(e,null,null),Et(`Justificación marcada para ${e.nombre_completo}.`);return}c[i]=c[i]===a?null:a,we(i),Ee();let m=Object.values(c).filter(e=>e===`P`).length,h=Object.values(c).filter(e=>e===`A`).length,g=Object.values(c).filter(e=>e===`J`).length;Et(`Asistencia actualizada. ${m} presentes, ${h} ausentes, ${g} justificados.`),await Oe(!0)};function Ee(){let e=s.length,t=Object.values(c).filter(e=>e!==null).length,r=n.querySelector(`#pm-progress-wrap`),i=n.querySelector(`#pm-progress-fill`),a=n.querySelector(`#pm-progress-label`);if(t===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${t/e*100}%`,a.textContent=`${t}/${e}`}async function Oe(e=!1,t=!1){C&&clearTimeout(C);let n=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t={clase_id:f,maestro_id:u.id,fecha:d,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:S||``};if(navigator.onLine)try{if(y){let{error:e}=await A.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,y);if(!e){localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await A.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){y=e.id,console.log(`[asistencia] Nueva sesión creada:`,y),localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await de({tabla:`sesiones_clase`,operacion:y?`update`:`insert`,payload:{...y?{id:y}:{},...t}}),localStorage.setItem(`${x}_updated`,new Date().toISOString())};e?t?await n():await w.run(n):C=setTimeout(()=>{w.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let ke=n.querySelector(`.pm-asist-actions-fixed`);if(ke){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),y&&(e.disabled=!0,e.innerHTML=`⏳...`,await Ve(y),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=ke.querySelector(`#btn-guardar`);ke.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),f&&(n.disabled=!0,n.innerHTML=`⏳...`,await ze(f,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),ke.insertBefore(n,t)}n.querySelector(`#btn-guardar`).onclick=async()=>{let e=n.querySelector(`#btn-guardar`),r=e.textContent;e.textContent=`Guardando...`,e.disabled=!0,await w.run(async()=>{try{let r=s.filter(e=>c[e.id]).map(e=>({clase_id:f,alumno_id:e.id,fecha:d,estado:c[e.id],registrado_por:u.id})),i=r.length>0,o=S&&S.trim().length>0;if(!i&&!o)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Oe(!0,!0),!y){let{data:e}=await A.from(`sesiones_clase`).select(`id`).eq(`clase_id`,f).eq(`maestro_id`,u.id).eq(`fecha`,d).maybeSingle();e&&(y=e.id)}if(i)try{let e=r.map(e=>({...e,...y&&{sesion_clase_id:y}}));await t(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){throw console.error(`[asistencia] Error registrando asistencias en bulk:`,e),Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(y&&(i||o)){let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),{error:t}=await A.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await A.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await A.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y))}T(),Hr(`hoy`),Hr(`calendario`),Hr(`metricas`),sa().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(y){let{academicService:t}=await Se(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await Se(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DyEVGrEb.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await t.processSessionClosure(y);i&&i.length>0&&(e.textContent=`¡Logros detectados!`,e.style.background=`var(--pm-success)`,await r(n,i))}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);e.textContent=`✓ Guardado`,e.style.background=`var(--apple-success)`;let l=ke?.querySelector(`#btn-reporte-dia`);l&&(l.style.display=``);let p=ke?.querySelector(`#btn-resumen-mes`);p&&(p.style.display=``);let m=Object.values(c).filter(e=>e===`P`).length,h=Object.values(c).filter(e=>e===`A`).length;Et(`Sesión guardada exitosamente. ${m} presentes, ${h} ausentes.`);let g=document.createElement(`div`);g.className=`pm-saved-overlay`,g.innerHTML=`
      ...
      `,document.body.appendChild(g);let _=g.querySelector(`#btn-editar-asistencia`),v=g.querySelector(`#btn-compartir-correo`),b=g.querySelector(`#btn-compartir-whatsapp`),x=g.querySelector(`#btn-volver-hoy`),C=g.querySelector(`#btn-ir-calendario`);_&&(_.onclick=()=>{g.remove(),e.textContent=`Guardar sesión`,e.style.background=``,e.disabled=!1,e.style.display=``}),v&&(v.onclick=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${a.nombre} - ${d}`),n=encodeURIComponent(Le(e,S,s,a));window.open(`mailto:?subject=${t}&body=${n}`,`_blank`)}),b&&(b.onclick=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t=encodeURIComponent(Le(e,S,s,a));window.open(`https://wa.me/?text=${t}`,`_blank`)}),x&&(x.onclick=()=>{window.location.hash=`#/hoy`}),C&&(C.onclick=()=>{window.location.hash=`#/calendario`});let w=g.querySelector(`#btn-reporte-dia-overlay`);w&&(w.onclick=async()=>{w.disabled=!0,w.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`,await Ve(y),w.disabled=!1,w.innerHTML=`<i class="bi bi-file-earmark-pdf"></i> Reporte del día (PDF)`});let E=g.querySelector(`#btn-resumen-mes-overlay`);E&&(E.onclick=async()=>{E.disabled=!0,E.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;let e=new Date;await ze(f,e.getFullYear(),e.getMonth()+1),E.disabled=!1,E.innerHTML=`<i class="bi bi-bar-chart-line"></i> Resumen del mes (PDF)`});let D=g.querySelector(`#btn-informe-ped-overlay`);D&&(D.onclick=async()=>{D.disabled=!0,D.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;let e=new Date;await Be(f,e.getFullYear(),e.getMonth()+1),D.disabled=!1,D.innerHTML=`<i class="bi bi-mortarboard"></i> Informe pedagógico (PDF)`})}catch(t){console.error(`Error al guardar sesión:`,t),e.textContent=t.message||`Error al guardar`,e.style.background=`var(--pm-danger)`,e.disabled=!1,setTimeout(()=>{e.textContent=r,e.style.background=``},3e3)}})};function Ae(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Fe(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function Le(e,t,n,r){let i=e.filter(e=>e.estado===`P`).length,a=e.filter(e=>e.estado===`A`).length,o=e.filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre}\n`;return s+=`Fecha: ${d}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,e.forEach(e=>{let t=n.find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}n.querySelector(`#pm-asist-back`).onclick=()=>{Ue.destroy();try{ve.close()}catch{}b.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},n.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{c[e.id]=`P`}),we(),Ee(),await Oe(!0),Et(`Todos los ${s.length} alumnos marcados como presentes.`)},n.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{c[e.id]=`A`}),we(),Ee(),await Oe(!0),Et(`Todos los ${s.length} alumnos marcados como ausentes.`)},we();async function Re(e){try{let{data:t}=await A.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function He(e){if(!e||!oe)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await U.getRouteHierarchy(oe),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Ue=new br(n);Ue.mount();let We=n.querySelector(`#pm-btn-help`);return We&&(We.onclick=()=>Ue.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Ue.destroy();try{ve.close()}catch{}b.forEach(e=>{try{e()}catch{}})}}function Ea(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Da(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Oa(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await A.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Da(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await de({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var ka={async open(){let e=await M(),t=await ye();je.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Fa(n,t),Ia(n,t),Ua(n,t),La(r),Ra(r,t),za(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Ba(r),Va(r),Za(t),Ka(t),Qa(),Se(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Ha(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Fa(e,t){let n=we(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ia(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function La(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ra(e,t){let n=ge(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${J.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function za(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ba(e){e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function Va(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ha(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await Se(async()=>{let{getPermisos:e}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));Ha(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Ua(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Na.map(e=>Wa(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function Wa(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function Ka(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{J.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>qa(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,Ya),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await xe();e.success?(J.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,J.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await he(),J.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=J.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>ka.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>Ma.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await me();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>Xa(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>Xa(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>Xa(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await Se(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-BPslrDVV.js`);return{ausenciasPanel:e}},__vite__mapDeps([10,3,11,7,5,12,1,13]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>Re.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,Ga(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),J.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),J.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function qa(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=d(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=Ja();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}J.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await re(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await A.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let s={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(se,JSON.stringify(s)),J.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{J.saving=!1,a.disabled=!1,a.innerHTML=o}}function Ja(){let e={};return Na.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function Ya(){je.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await ie(),window.location.reload(),!0)})}function Xa(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),J.theme=e}function Za(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function Qa(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var $a=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=$a,document.head.appendChild(e)}async function eo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=j();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await U.getClasses(),{data:r}=await A.from(`clases`).select(`id, nombre, instrumento`).eq(`maestro_id`,t.id).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let t=await U.getRouteHierarchy(e);if(!t||t.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let n=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,r=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}function no(e){if(!e)return null;let t=e.replace(/\D/g,``);return t.length===10&&/^(809|829|849)/.test(t)?`1`+t:t.length===11&&t.startsWith(`1`)||t.length>=10?t:null}var ro=e=>`soi_wa_templates_${e}`,io=[{id:`tpl-1`,label:`📋 Asistencia`,text:`Hola Saludos, le escribo de "El Sistema Punta Cana" para informarle sobre las asistencias de clases de {alumno}. Por favor comuníquese con nosotros para más detalles.`},{id:`tpl-2`,label:`📝 Evaluación`,text:`Hola Saludos, le informamos que {alumno} tiene evaluaciones recientes disponibles para revisión. Puede consultar su progreso con nosotros.`},{id:`tpl-3`,label:`📅 Recordatorio`,text:`Hola Saludos, le recordamos que {alumno} tiene clase próximamente. Cualquier ausencia debe ser justificada con anticipación.`},{id:`tpl-4`,label:`🤝 Reunión`,text:`Hola Saludos, me gustaría coordinar una reunión para conversar sobre el progreso de {alumno}. ¿Cuándo le viene bien?`}];function ao(e){try{let t=localStorage.getItem(ro(e));return t?JSON.parse(t):io.map(e=>({...e}))}catch{return io.map(e=>({...e}))}}function oo(e,t){localStorage.setItem(ro(e),JSON.stringify(t))}function so(e,{alumno:t,contacto:n}){return e.replace(/\{alumno\}/g,t).replace(/\{contacto\}/g,n)}function co(e){return e?e.replace(/\[([^\]]+)\]/g,(e,t)=>{let n=t.indexOf(`:`);if(n>0){let e=t.slice(0,n).trim(),r=t.slice(n+1).trim();return r?`${e}: ${r}`:e}return t.trim()}).replace(/\n{3,}/g,`

`).trim():``}var lo={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function uo(e,t){let n=e.querySelector(`#pm-alumno-progresos-root`);if(n)try{let{data:e,error:r}=await A.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).limit(60);if(r)throw r;if(!e||e.length===0){n.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`;return}let i=[...new Set(e.map(e=>e.clase_id).filter(Boolean))],{data:a}=i.length?await A.from(`clases`).select(`id, nombre`).in(`id`,i):{data:[]},o=new Map((a||[]).map(e=>[e.id,e.nombre])),s=new Map;for(let t of e){let e=t.contenido_dsl;s.has(e)||s.set(e,{contenido:e,entries:[]}),s.get(e).entries.push(t)}n.innerHTML=`
      <div class="pm-prog-list">
        ${Array.from(s.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=lo[n.estado_cualitativo]??lo.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
            <details class="pm-prog-card">
              ...
              <div class="pm-prog-card__timeline">
                ${t.map(e=>{let t=lo[e.estado_cualitativo]??lo.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=o.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
    ...
    `}catch(t){let n=e.querySelector(`#pm-alumno-progresos-root`);n&&(n.innerHTML=`<p style="color:var(--pm-danger);font-size:0.82rem;">Error al cargar historial: ${F(t.message)}</p>`)}}async function fo(e,t){let n=e.querySelector(`#pm-alumno-progreso-root`);if(n)try{let{data:e,error:r}=await A.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1});if(r)throw r;if(!e||e.length===0){n.innerHTML=`<p class="pm-empty">Sin evaluaciones registradas.</p>`;return}let i=[...new Set(e.map(e=>e.indicator_id))],{data:a}=await A.from(`indicators`).select(`id, nombre, node_id`).in(`id`,i),o=[...new Set((a||[]).map(e=>e.node_id).filter(Boolean))],{data:s}=await A.from(`nodes`).select(`id, name`).in(`id`,o),c=new Map((s||[]).map(e=>[e.id,e.name])),l=new Map((a||[]).map(e=>[e.id,e])),u=new Map;for(let t of e){if(u.has(t.indicator_id))continue;let e=l.get(t.indicator_id);u.set(t.indicator_id,{id:t.indicator_id,nombre:e?.nombre||``,nodeName:c.get(e?.node_id)||``,latest:t,history:[]})}for(let t of e)if(u.has(t.indicator_id)){let e=u.get(t.indicator_id);(e.history.length===0||e.history[0].id!==t.id)&&e.history.push(t)}let d=Array.from(u.values()).filter(e=>e.latest.nota!=null&&e.latest.nota!==0||e.latest.observations&&e.latest.observations.trim()!==``),f=d.filter(e=>e.latest.nota>=4).length,p=d.length,m=p>0?Math.round(f/p*100):0;function h(e){return e==null?`⚫`:e>=4?`🟢`:e>=2?`🟡`:`🔴`}function g(e){return e==null?`pm-route-indicador--gray`:e>=4?`pm-route-indicador--green`:e>=2?`pm-route-indicador--yellow`:`pm-route-indicador--red`}n.innerHTML=`
      ...
      <div class="pm-eval-progress-header">
        ...
        <span class="pm-eval-progress-pct" style="color:${m>=70?`var(--pm-success)`:m>=40?`var(--pm-warning)`:`var(--pm-danger)`}">${m}%</span>
      </div>
      <div class="pm-student-panel__progress-bar" style="height:6px;border-radius:3px;background:var(--pm-border);">
        <div class="pm-student-panel__progress-fill" style="width:${m}%;height:100%;border-radius:3px;background:${m>=70?`var(--pm-success)`:m>=40?`var(--pm-warning)`:`var(--pm-danger)`};"></div>
      </div>
      <p class="pm-eval-progress-sub">${f} de ${d.length} indicadores aprobados</p>

      <div class="pm-eval-indicadores">
        ${d.length===0?`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin indicadores evaluados aún</p>`:d.map(e=>{let t=e.latest.nota>=4?`var(--pm-success)`:e.latest.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
              <div class="pm-eval-indicador ${g(e.latest.nota)}" data-ind-id="${e.id}">
                <div class="pm-eval-indicador-header">
                  ...
                  <div class="pm-eval-info">
                    <span class="pm-eval-nombre">${F(e.nombre||`Indicador`)}</span>
                    ${e.nodeName?`<span class="pm-eval-node">${F(e.nodeName)}</span>`:``}
                  </div>
                  <span class="pm-eval-nota" style="color:${e.latest.nota==null?`var(--pm-text-muted)`:t}">${e.latest.nota??`—`}</span>
                  ...
                  ${e.history.map(e=>`
                    <div class="pm-eval-entry">
                      <div class="pm-eval-entry-meta">
                        ...
                        <strong style="color:${e.nota==null?`inherit`:t}">${h(e.nota)} ${e.nota??`—`}</strong>
                      </div>
                      ${e.observations?`<p class="pm-eval-entry-obs">${F(e.observations)}</p>`:``}
                      ${e.tarea?`<p class="pm-eval-entry-tarea">📋 ${F(e.tarea)}</p>`:``}
                    </div>
                  `).join(``)}
                </div>
              </div>
    ...
    `,n.querySelectorAll(`.pm-eval-indicador`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.querySelector(`.pm-eval-timeline`),n=e.querySelector(`.pm-eval-toggle`),r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.classList.toggle(`bi-chevron-down`,r),n.classList.toggle(`bi-chevron-up`,!r)})})}catch(t){let n=e.querySelector(`#pm-alumno-progreso-root`);n&&(n.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger);">Error al cargar evaluaciones: ${F(t.message)}</p>`)}}async function po(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=j();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){e.innerHTML=`<p class="pm-empty">No se especificó el alumno.</p>`;return}try{let{data:r,error:i}=await A.from(`alumnos`).select(`id, nombre_completo, instrumento_principal, tlf_alumno, fecha_nacimiento, created_at, nivel_actual, representante_nombre, representante_tlf, correo_representante, direccion`).eq(`id`,t).single();if(i||!r){console.error(`[AlumnoPerfil] Error al obtener alumno:`,i),e.innerHTML=`
        ...
        <div class="pm-zen-body">
            ...
            <div class="pm-zen-clases-grid">
              ${o.map(e=>{let t=O.get(e);if(!t)return``;let n=T[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null;return`
                  <div class="pm-zen-clase-card pm-glass">
                    ...
                    <p class="pm-zen-clase-inst">${F(t.instrumento||``)}</p>
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${ee.map(e=>{let t=O.get(e.clase_id),n=co(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion">
            <summary class="pm-zen-accordion-header">
              ...
              <span class="pm-zen-accordion-meta">${k.length} observación${k.length===1?``:`es`}</span>
              <i class="bi bi-chevron-down pm-accordion-chevron"></i>
            </summary>
            <div class="pm-zen-desenvolvimiento" style="margin-top:0.75rem;">
              ${k.map(e=>{let t=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ae=no(r.tlf_alumno||r.representante_tlf);if(ae){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var mo={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},ho={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},go={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function _o(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(mo))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function vo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=j();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await A.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await A.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
    ...
    `,e.querySelector(`#pm-student-select`).addEventListener(`change`,async t=>{let n=t.target.value;if(!n){e.querySelector(`#pm-progress-content`).innerHTML=``;return}await yo(e,n)})}catch(t){e.innerHTML=`<p class="pm-empty">Error: ${F(t.message)}</p>`}}async function yo(e,t){let n=e.querySelector(`#pm-progress-content`);n.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:e}=await A.from(`alumnos`).select(`nombre, apellido`).eq(`id`,t).single(),{data:r}=await A.from(`academic_plans`).select(`id, route_version_id, status`).eq(`student_id`,t).in(`status`,[`in_process`,`active`]).order(`created_at`,{ascending:!1}).limit(1).maybeSingle();if(!r){n.innerHTML=`
      ...
      `;return}let{data:i}=await A.from(`levels`).select(`*`).eq(`route_version_id`,r.route_version_id).order(`level_number`,{ascending:!0}),{data:a}=await A.from(`student_level_progress`).select(`*`).eq(`student_id`,t),{data:o}=await A.from(`nodes`).select(`*, indicators(*)`).in(`level_id`,(i||[]).map(e=>e.id)).order(`order_index`,{ascending:!0}),{data:s}=await A.from(`student_node_progress`).select(`*, indicator_attempts(*)`).eq(`student_id`,t),c=(a||[]).filter(e=>e.status===`approved`).length,l=i?.length||0,u=l>0?Math.round(c/l*100):0;n.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${_o(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${F(e.name)}</span>
                          <span class="pm-node-status">${go[n]}</span>
                        </div>
    ...
    `}catch(e){n.innerHTML=`<p class="pm-empty">Error: ${F(e.message)}</p>`}}async function bo(e){let t=(await O())?.find(t=>t.id===e)?.instrumento;if(!t)return null;let n=t.split(`,`)[0].trim().toLowerCase(),{data:r,error:i}=await A.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${n}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();return i?(console.warn(`[rutaService] resolveRutaIdForClase error:`,i.message),null):r?.route_versions?.[0]?.id||r?.route_versions?.id||null}async function xo(e,t){let{data:n,error:r}=await A.from(`blocks`).select(`id, nombre:name, order_index`).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(r)throw Error(`[rutaService] blocks: `+r.message);if(!n||n.length===0)return[];let i=n.map(e=>e.id),{data:a,error:o}=await A.from(`levels`).select(`id, block_id, nombre:name, order_index`).in(`block_id`,i).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(o)throw Error(`[rutaService] levels: `+o.message);let s=(a??[]).map(e=>e.id);if(s.length===0)return n.map(e=>({...e,levels:[]}));let{data:c,error:l}=await A.from(`nodes`).select(`id, level_id, nombre:name, order_index`).in(`level_id`,s).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(l)throw Error(`[rutaService] nodes: `+l.message);let u=(c??[]).map(e=>e.id),{data:d,error:f}=u.length>0?await A.from(`indicators`).select(`id, node_id, nombre:description, order_index`).in(`node_id`,u).eq(`activo`,!0).order(`order_index`,{ascending:!0}):{data:[],error:null};if(f)throw Error(`[rutaService] indicators: `+f.message);let p=await Promise.all((c??[]).map(e=>Xr(e.id,t).then(t=>({nodeId:e.id,semaphore:t.semaphore})).catch(()=>({nodeId:e.id,semaphore:`gray`})))),m=new Map(p.map(e=>[e.nodeId,e.semaphore])),h=new Map;for(let e of d??[])h.has(e.node_id)||h.set(e.node_id,[]),h.get(e.node_id).push({...e,semaphore:m.get(e.node_id)??`gray`});let g=new Map;for(let e of c??[])g.has(e.level_id)||g.set(e.level_id,[]),g.get(e.level_id).push({...e,semaphore:m.get(e.id)??`gray`,indicators:h.get(e.id)??[]});let _=new Map;for(let[e]of i.map(e=>[e]))_.set(e,[]);let v=new Map;for(let e of a??[])v.has(e.block_id)||v.set(e.block_id,[]),v.get(e.block_id).push(e);for(let[e,t]of v){let n=t.map((e,t,n)=>{let r=g.get(e.id)??[],i=r.flatMap(e=>h.get(e.id)??[]),a=i.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length,o=i.length>0?Math.round(a/i.length*100):0,s=r.map(e=>e.semaphore),c=s.every(e=>e===`green`)&&s.length>0?`green`:s.every(e=>e===`gray`)||s.length===0?`gray`:`yellow`,l=!1;if(t>0){let e=n[t-1],r=(g.get(e.id)??[]).flatMap(e=>h.get(e.id)??[]),i=r.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length;l=r.length>0&&i/r.length<.8}return{...e,semaphore:c,locked:l,percentage:o,nodes:r}});_.set(e,n)}return n.map(e=>({...e,levels:_.get(e.id)??[]}))}var So=new Map,Co={on(e,t){So.has(e)||So.set(e,[]),So.get(e).push(t)},off(e,t){if(!So.has(e))return;let n=So.get(e),r=n.indexOf(t);r>-1&&n.splice(r,1)},emit(e,t){So.has(e)&&So.get(e).forEach(n=>{try{n(t)}catch(t){console.error(`[rutaEventEmitter] Error in listener for ${e}:`,t)}})},clearAllListeners(){So.clear()}};function wo(e,t){let{blockId:n,blockName:r,isExpanded:i,childCount:a,onToggle:o}=t;e.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var To=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():j(),Eo=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):O(...e),Do=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):xo(...e),Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Oo=!1;async function ko(e,{onTopicSelected:t}={}){if(Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!To()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(T(),Y.clases=await Eo(!0),!Y.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}Y.activeClaseId=Y.clases[0].id,await Ao(),jo(e),Fo(e),Io(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Ao(){Y.loading=!0,Y.rutaId=await bo(Y.activeClaseId),Y.rutaId?Y.blocks=await Do(Y.rutaId,Y.activeClaseId):Y.blocks=[],Y.loading=!1}function jo(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!Y.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(Y.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}Y.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),wo(r,{blockId:n.id,blockName:n.nombre,isExpanded:Y.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{Y.expandedBlocks.has(t)?Y.expandedBlocks.delete(t):Y.expandedBlocks.add(t),jo(e)}}),Y.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(Mo(n,e))})}}),No(e)}function Mo(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=Y.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${Po(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${Po(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${Po(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Y.expandedLevels.has(e.id)?Y.expandedLevels.delete(e.id):Y.expandedLevels.add(e.id),jo(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Y.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},jo(t)})}),n}function No(e){let t=e.querySelector(`#ruta-action-panel`);if(!Y.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Y.selectedIndicator=null,jo(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{_i({...Y.selectedIndicator,indicatorId:Y.selectedIndicator.id,claseId:Y.activeClaseId}),Y.onTopicSelected&&Y.onTopicSelected(Y.activeClaseId)})}function Po(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Fo(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Y.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Ao(),jo(e),Fo(e)})}function Io(e){Oo||(Oo=!0,Co.on(`node-covered`,()=>{Ao().then(()=>{jo(e),Fo(e)})}))}var Lo=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Ro(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=j();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await A.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
      ...
      `;return}let{data:r}=await A.from(`instrumentos`).select(`id, nombre`).order(`nombre`),{data:i}=await A.from(`maestros`).select(`id, nombre, email`).neq(`id`,t.id).order(`nombre`);e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${Lo.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await A.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await P.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await P.createAcademicPlan(t,u),await A.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${F(t.message)}</p></div>`}}async function Bo(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await A.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await P.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await A.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await P.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},Ho={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([P.getRouteDetail(t),n?P.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
          ...
          ${e.levels.map(e=>`
            <div class="pm-level-card card-apple" style="margin-bottom: 1rem; border-left: 4px solid var(--apple-secondary);">
              ...
              <div class="pm-nodes-grid" style="display: flex; flex-direction: column; gap: 0.75rem;">
                ${e.nodes.map(e=>{let t=o.get(e.id)?.status||`pending`,n=P.getStatusToken(t);return`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},X={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function Uo(e){let t=j();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}X.maestro=t,X.submitting=!1;let n=await qe(t.id);if(X.permisos=n,X.checked=!0,!n.puede_registrar_alumnos){Wo(e,n,t.id);return}try{let e=await O();X.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),X.clases=[]}Go(e),Jo(),Xo()}function Wo(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
        ...
        <div id="pm-register-action-container">
          ...
          `}
            ...
            <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.3); padding: 0.85rem; border-radius: 10px; display: inline-flex; align-items: center; gap: 8px; color: #eab308; font-weight: 600; font-size: 0.85rem; animation: pm-error-fade-in 0.3s ease;">
              <i class="bi bi-clock-history"></i> Solicitud Pendiente de Aprobación
            </div>`)}catch(t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al solicitar: `+t.message,type:`danger`}})),a.disabled=!1,a.innerHTML=e}})}function Go(e){e.innerHTML=`
    <div class="pm-settings pm-fade-in registro-alumno-view" role="main" aria-label="Registro de alumnos">
      <header class="pm-settings-header">
          ...
          <div class="pm-settings-form-grid" style="grid-template-columns: 1fr;">
            <div class="pm-settings-field">
              ...
              <select class="input-apple" id="reg-clase">
                ...
                ${X.clases.map(e=>`<option value="${F(e.id)}">${F(e.nombre||`Clase sin nombre`)}</option>`).join(``)}
              </select>
              ${X.clases.length===0?`<p class="apple-caption" style="color:var(--pm-warning); margin-top:0.25rem;"><i class="bi bi-exclamation-triangle"></i> No tienes clases asignadas</p>`:``}
            </div>
          </div>
        </section>
    ...
    </style>`}function Ko(){return{nombre:document.getElementById(`reg-nombre`)?.value.trim(),fechaNac:document.getElementById(`reg-fecha-nac`)?.value,instrumento:document.getElementById(`reg-instrumento`)?.value.trim(),repNombre:document.getElementById(`reg-rep-nombre`)?.value.trim(),repTlf:document.getElementById(`reg-rep-tlf`)?.value.trim(),repCedula:document.getElementById(`reg-rep-cedula`)?.value.trim(),repEmail:document.getElementById(`reg-rep-email`)?.value.trim(),direccion:document.getElementById(`reg-direccion`)?.value.trim(),claseId:document.getElementById(`reg-clase`)?.value}}function qo(e){let t=[];if(e.nombre?e.nombre.length<3?t.push({fieldId:`reg-nombre`,message:`El nombre debe tener al menos 3 caracteres`}):e.nombre.length>100&&t.push({fieldId:`reg-nombre`,message:`El nombre no puede exceder 100 caracteres`}):t.push({fieldId:`reg-nombre`,message:`El nombre del alumno es obligatorio`}),!e.fechaNac)t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento es obligatoria`});else{let n=new Date(e.fechaNac),r=new Date;n>r&&t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento no puede ser futura`});let i=r.getFullYear()-n.getFullYear();i<3&&t.push({fieldId:`reg-fecha-nac`,message:`El alumno debe tener mínimo 3 años`}),i>100&&t.push({fieldId:`reg-fecha-nac`,message:`Verifica la fecha de nacimiento`})}return e.instrumento?e.instrumento.length>100&&t.push({fieldId:`reg-instrumento`,message:`El instrumento no puede exceder 100 caracteres`}):t.push({fieldId:`reg-instrumento`,message:`El instrumento principal es obligatorio`}),e.repNombre?e.repNombre.length>100&&t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante es obligatorio`}),e.repTlf?e.repTlf.length>20&&t.push({fieldId:`reg-rep-tlf`,message:`El teléfono no puede exceder 20 caracteres`}):t.push({fieldId:`reg-rep-tlf`,message:`El teléfono del representante es obligatorio`}),e.repCedula&&e.repCedula.length>20&&t.push({fieldId:`reg-rep-cedula`,message:`La cédula no puede exceder 20 caracteres`}),e.repEmail&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.repEmail)?e.repEmail.length>100&&t.push({fieldId:`reg-rep-email`,message:`El correo no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-email`,message:`El formato del correo electrónico no es válido`})),e.direccion&&e.direccion.length>255&&t.push({fieldId:`reg-direccion`,message:`La dirección no puede exceder 255 caracteres`}),t}function Jo(){document.getElementById(`btn-registrar-alumno`)?.addEventListener(`click`,Yo),document.getElementById(`btn-cancelar-registro`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Registro cancelado`,type:`info`}})),window.location.hash=`#/hoy`})}async function Yo(){if(X.submitting)return;let e=Ko(),t=qo(e);if(t.length>0){kt(document.getElementById(`reg-nombre`)?.closest(`.pm-settings`)||document),t.forEach(e=>{let t=document.getElementById(e.fieldId);t&&Dt(t,e.message)});return}if(e.repEmail&&await l(e.repEmail)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El correo del representante ya está registrado en el sistema`,type:`danger`}})),X.submitting=!1;return}if(e.repCedula&&await u(e.repCedula)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`La cédula del representante ya está registrada en el sistema`,type:`danger`}})),X.submitting=!1;return}X.submitting=!0;let n=document.getElementById(`btn-registrar-alumno`),r=n.innerHTML;n.disabled=!0,n.innerHTML=`<span class="pm-settings-spinner"></span><span>Registrando...</span>`;try{let t=await a({nombre:e.nombre,nombre_completo:e.nombre,fecha_nacimiento:e.fechaNac,instrumento:e.instrumento,instrumento_principal:e.instrumento,representante_nombre:e.repNombre,familiar_nombre:e.repNombre,representante_tlf:d(e.repTlf)||e.repTlf,familiar_telefono:d(e.repTlf)||e.repTlf,representante_cedula:e.repCedula||null,correo_representante:e.repEmail||null,direccion:e.direccion||null,is_active:!0,activo:!0});if(e.claseId)try{let{inscribirAlumno:n}=await Se(async()=>{let{inscribirAlumno:e}=await import(`./clasesApi-CiNtdXkj.js`).then(e=>e.r);return{inscribirAlumno:e}},__vite__mapDeps([16,1,3]));typeof n==`function`&&await n(e.claseId,t.id)}catch(e){console.warn(`[Registro] No se pudo inscribir en clase:`,e.message)}window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Alumno ${e.nombre} registrado exitosamente`,type:`success`}})),document.getElementById(`reg-nombre`).value=``,document.getElementById(`reg-fecha-nac`).value=``,document.getElementById(`reg-instrumento`).value=``,document.getElementById(`reg-rep-nombre`).value=``,document.getElementById(`reg-rep-tlf`).value=``,document.getElementById(`reg-rep-cedula`).value=``,document.getElementById(`reg-rep-email`).value=``,document.getElementById(`reg-direccion`).value=``,document.getElementById(`reg-clase`).value=``}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al registrar: `+e.message,type:`danger`}}))}finally{X.submitting=!1,n.disabled=!1,n.innerHTML=r}}function Xo(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}function Zo(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Qo(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function $o(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var es=null,ts=[],ns=new Set;async function rs(e){e.innerHTML=gs();let t=j();if(!t){e.innerHTML=_s(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await qe(t.id);if(!n.puede_inscribir_clases){e.innerHTML=as(n),os(t.id);return}let[r,a]=await Promise.all([Ge(t.id),i().catch(()=>[])]);ts=a.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=ss(r),ps(r),r.length>0&&await ls(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=_s(`bi-exclamation-triangle`,`Error al cargar`,Zo(t.message))}}function is(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function as(e){return`
    <div class="gcv-root">
  ...
  `}function os(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Ke(e,`clases:enroll`),N.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){N.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function ss(e){return`
    <div class="gcv-root">
      ...
      ${e.length===0?_s(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function cs(e){let t=Zo(e.nombre||`Clase sin nombre`),n=$o(e.horarios||[]),r=Zo(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function ls(e,t){es=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await Ue(e),a=i.map(e=>e.alumno).filter(Boolean);ns=new Set(i.map(e=>e.alumno_id)),n.innerHTML=us(r,a,ts.filter(e=>!ns.has(e.id))),ms(e,t)}catch(e){n.innerHTML=_s(`bi-exclamation-circle`,`Error al cargar alumnos`,Zo(e.message))}}}function us(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${Zo(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>ds(e)).join(``)}
        </div>
      </div>
  ...
  `}function ds(e){let t=Zo(e.nombre_completo||e.nombre||`Alumno`),n=Zo(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${Qo(t)}</div>
  ...
  `}var vs=null,ys=!1,bs={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};function xs(e){if(!e)return``;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function Ss(e){return e===`alta`?`<i class="bi bi-exclamation-circle-fill" style="color:#ef4444"></i>`:e===`media`?`<i class="bi bi-exclamation-circle-fill" style="color:#f59e0b"></i>`:`<i class="bi bi-info-circle-fill" style="color:#22c55e"></i>`}function Cs(){if(document.getElementById(`admin-ausencias-insights-styles`))return;let e=document.createElement(`style`);e.id=`admin-ausencias-insights-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function ws(e){document.querySelectorAll(`[data-route="admin-ausencias"],[data-route="admin-notificaciones"]`).forEach(t=>{let n=t.querySelector(`.aai-nav-badge`);e>0?(n||(n=document.createElement(`span`),n.className=`aai-nav-badge`,t.appendChild(n)),n.textContent=e>99?`99+`:String(e),n.style.display=`flex`):n&&(n.style.display=`none`)})}function Ts(){return vs||(vs=document.createElement(`div`),vs.id=`admin-ausencias-insights`,vs.setAttribute(`role`,`status`),vs.setAttribute(`aria-live`,`polite`),document.body.appendChild(vs),vs)}function Es(e){let t=Ts(),n=e.length,r=e[0],i=n===1&&r?`
    <div class="aai-preview">
      <div class="aai-preview-row">
        ${Ss(r.urgencia)}
        <span>${r.maestros?.nombre_completo??`Maestro`}</span>
        <span class="aai-chip">${bs[r.tipo_ausencia]??r.tipo_ausencia??`—`}</span>
        <span style="opacity:.7">${xs(r.fecha_inicio)}${r.fecha_fin&&r.fecha_fin!==r.fecha_inicio?` → `+xs(r.fecha_fin):``}</span>
      </div>
    </div>
  `:``;t.innerHTML=`
    <div class="aai-row">
  ...
  `,requestAnimationFrame(()=>{t.classList.add(`visible`)}),t.querySelector(`#aai-btn-revisar`)?.addEventListener(`click`,()=>{Ds(),window.router&&window.router.navigate(`admin-ausencias`)}),t.querySelector(`#aai-btn-dismiss`)?.addEventListener(`click`,()=>{Os()})}function Ds(){vs&&vs.classList.remove(`visible`)}function Os(){Ds();let e=Date.now()+1800*1e3;localStorage.setItem(`admin-ausencias-insights-dismiss`,String(e))}function ks(){let e=localStorage.getItem(`admin-ausencias-insights-dismiss`);return e?Date.now()<Number(e):!1}var As={init(){window.adminAusenciasInsights=this,Cs(),Ts(),this.evaluate()},async evaluate(){if(!ys){ys=!0;try{if((window.router?.currentRoute?.()??``).split(`?`)[0]===`admin-ausencias`){Ds(),ws((await D())?.length??0);return}if(ks())return;let e=await D();if(ws(e?.length??0),!e||e.length===0){Ds();return}Es(e)}catch(e){console.warn(`[adminAusenciasInsights] Error evaluando:`,e),Ds()}finally{ys=!1}}}},js=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var Ms=null;function Ns(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var Ps={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(Ms=document.createElement(`div`),Ms.innerHTML=`
    ...
    `,document.body.appendChild(Ms),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{da()}),aa(e=>{this.renderList(e)}),sa())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=ea();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tenés notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=Ls(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=Rs(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${Is(e.tipo)}">
            <i class="bi ${Fs(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${Ns(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>la(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),Ps.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>la(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>la(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await ua(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),sa()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=Le(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),sa()},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function Fs(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function Is(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function Ls(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function Rs(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}if(m(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}console.log(`[SOI] Initializing professionalization services...`),lt(),at({windowMs:6e4,max:100}),rt({enabled:!1,consent:!1}),ft({debug:!1}),et({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&N.show(t,n)});var zs=!1;function Bs(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_registrar_alumnos&&t.push({id:`registrar-alumno`,label:`Registrar`,icon:`bi-person-plus`}),e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}var Vs=[{id:`admin-alumnos`,label:`Alumnos`,icon:`bi-people-fill`},{id:`admin-programas`,label:`Programas`,icon:`bi-grid-1x2`},{id:`admin-maestros`,label:`Maestros`,icon:`bi-person-badge`},{id:`admin-notificaciones`,label:`Actividad`,icon:`bi-bell-fill`},{id:`admin-ausencias`,label:`Ausencias`,icon:`bi-calendar-x`},{id:`admin-metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}],Hs=e=>zs?[...Vs,...Bs(e)]:Bs(e),Us=null,Ws=null,Z=Ct();window.router=Z;async function Gs(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await A.from(t).insert([i]);if(e)throw console.error(`[SYNC] Error en INSERT ${t}:`,e),e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await A.from(t).update(n).eq(`id`,e);if(r)throw console.error(`[SYNC] Error en UPDATE ${t}:`,r),r}else if(n===`delete`){let{error:e}=await A.from(t).delete().eq(`id`,i.id);if(e)throw console.error(`[SYNC] Error en DELETE ${t}:`,e),e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await A.from(t).select().limit(1);e&&e.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico en _syncWithSupabase:`,e),e}}var Ks=null;async function qs(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await ue();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function Js(){clearTimeout(Ks),Ks=setTimeout(async()=>{if(navigator.onLine)try{await le(Gs)}finally{await qs()}},1e3)}window.addEventListener(`online`,Js),window.addEventListener(`offline`,qs);function Ys(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function Xs(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=``),n&&(n.style.display=``),r&&(r.style.display=``)}function Zs(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=(Z.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){console.log(`[Auth] Manteniendo ruta pública:`,n),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),sc(),Qs(),Z.setAuthGuard(()=>bt.isAuthenticated(),t),Z.start();return}let r=ac.login;if(r){Ys(),r.style.display=`block`,r.innerHTML=``,At(r,{onSuccess:e=>{e&&e!==`login`?(Xs(),Z.navigate(e)):dc()}});return}e.innerHTML=``,At(e,{onSuccess:()=>dc()})}function Qs(){Z.on(`login`,(e,t)=>$(`login`,t)),Z.on(`logout`,(e,t)=>$(`logout`,t)),Z.on(`calendario`,(e,t)=>$(`calendario`,t)),Z.on(`clases`,(e,t)=>$(`clases`,t)),Z.on(`hoy`,(e,t)=>$(`hoy`,t)),Z.on(`asistencia`,(e,t)=>$(`asistencia`,t)),Z.on(`metricas`,(e,t)=>$(`metricas`,t)),Z.on(`perfil`,(e,t)=>$(`perfil`,t)),Z.on(`clase-emergente`,(e,t)=>$(`clase-emergente`,t)),Z.on(`planificacion`,(e,t)=>$(`planificacion`,t)),Z.on(`alumno`,(e,t)=>$(`alumno`,t)),Z.on(`gamificacion`,(e,t)=>$(`gamificacion`,t)),Z.on(`ruta`,(e,t)=>$(`ruta`,t)),Z.on(`crear-clase`,(e,t)=>$(`crear-clase`,t)),Z.on(`ruta-plan-builder`,(e,t)=>$(`ruta-plan-builder`,t)),Z.on(`ruta-semanal`,(e,t)=>$(`ruta-semanal`,t)),Z.on(`ruta-libreria`,(e,t)=>$(`ruta-libreria`,t)),Z.on(`ruta-detalle/:id`,(e,t)=>$(`ruta-detalle`,t)),Z.on(`registrar-alumno`,(e,t)=>$(`registrar-alumno`,t)),Z.on(`gestionar-clases`,(e,t)=>$(`gestionar-clases`,t)),Z.on(`register`,(e,t)=>$(`register`,t)),Z.on(`pending-approval`,(e,t)=>$(`pending-approval`,t)),zs?(Z.on(`admin-alumnos`,(e,t)=>$(`admin-alumnos`,t)),Z.on(`admin-programas`,(e,t)=>$(`admin-programas`,t)),Z.on(`admin-maestros`,(e,t)=>$(`admin-maestros`,t)),Z.on(`admin-metricas`,(e,t)=>$(`admin-metricas`,t)),Z.on(`admin-config`,(e,t)=>$(`admin-config`,t)),Z.on(`admin-clases`,(e,t)=>$(`admin-clases`,t)),Z.on(`admin-sesiones`,(e,t)=>$(`admin-sesiones`,t)),Z.on(`admin-aprobacion`,(e,t)=>$(`admin-aprobacion`,t)),Z.on(`admin-ausencias`,(e,t)=>$(`admin-ausencias`,t)),Z.on(`admin-notificaciones`,(e,t)=>$(`admin-notificaciones`,t)),Z.onNotFound(()=>$(`admin-alumnos`))):Z.onNotFound(()=>$(`hoy`))}function $s(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}var ec=$s();window.addEventListener(`resize`,()=>{let e=$s();e!==ec&&(ec=e,document.body.dataset.pmLayout=e)},{passive:!0});function tc(e,t,n){Us=t,Ws=n||Ws;let r=Hs(Ws);e.innerHTML=`
    ...
    <div class="pm-main-area">
      ...
      <header class="pm-header" id="pm-header">
        <div class="pm-header-left" id="pm-header-left">
          <span class="pm-header-greeting">${zs?`Panel Admin`:`Portal Maestros`}</span>
          <span class="pm-header-title" style="font-size:clamp(1rem,3.5vw,1.5rem);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:52vw;">
            ${zs?t?.nombre_completo??`Administrador`:`Prof. `+(t?.nombre_completo??``)}
  ...
  `,qs();let i=document.getElementById(`pm-theme-toggle-container`);i&&i.appendChild(js.createToggleButton());let a=document.getElementById(`pm-footer-nav`);a&&a.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let o=document.getElementById(`pm-sidebar`);o&&o.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)});let s=document.getElementById(`pm-header`),c=document.getElementById(`pm-header-search-input`),l=document.getElementById(`pm-search-toggle-btn`),u=document.getElementById(`pm-search-back-btn`),d=()=>{s?.classList.add(`search-active`),setTimeout(()=>{c?.focus()},50)},f=()=>{s?.classList.remove(`search-active`),c&&(c.value=``),document.getElementById(`pm-header-search-dropdown`)?.remove()};l?.addEventListener(`click`,e=>{e.stopPropagation(),d()}),u?.addEventListener(`click`,e=>{e.stopPropagation(),f()});let p=null,m=null,h=()=>{p?.remove(),p=null},g=e=>{if(h(),!e.length)return;let t=document.createElement(`div`);t.id=`pm-header-search-dropdown`,t.setAttribute(`role`,`listbox`),t.innerHTML=e.map(e=>`
      ...
      </div>`).join(``),document.body.appendChild(t);let n=c.getBoundingClientRect();t.style.cssText=`position:fixed;top:${n.bottom+4}px;left:${Math.max(8,n.left)}px;width:${Math.min(320,window.innerWidth-16)}px;z-index:9999;background:var(--pm-surface);border:1px solid var(--pm-border);border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.18);overflow:hidden;`,p=t,t.querySelectorAll(`.pm-hsd-item`).forEach(e=>{let t=()=>{f(),h(),Z.navigate(`alumno?id=${e.dataset.id}`)};e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})};if(c?.addEventListener(`input`,()=>{let e=c.value.trim();if(clearTimeout(m),e.length<1){h();return}let t=Yt();if(t){let n=e.toLowerCase();g(t.filter(e=>e.nombre_completo?.toLowerCase().includes(n)).slice(0,8).map(e=>({...e,instrumento_principal:e.clases?.join(`, `)||null})));return}m=setTimeout(async()=>{try{let{data:t}=await A.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).ilike(`nombre_completo`,`%${e}%`).limit(8);g(t||[])}catch{h()}},200)}),c?.addEventListener(`keydown`,e=>{e.key===`Escape`&&(f(),h())}),!document.getElementById(`pm-hsd-styles`)){let e=document.createElement(`style`);e.id=`pm-hsd-styles`,e.textContent=`.pm-hsd-item{display:flex;align-items:center;gap:0.625rem;padding:0.75rem 1rem;cursor:pointer;border-bottom:1px solid var(--pm-border);transition:background 0.1s}.pm-hsd-item:last-child{border-bottom:none}.pm-hsd-item:hover,.pm-hsd-item:focus{background:var(--pm-surface-2);outline:none}.pm-hsd-icon{font-size:1rem;color:var(--pm-primary);flex-shrink:0}.pm-hsd-info{flex:1;min-width:0}.pm-hsd-name{display:block;font-size:0.875rem;font-weight:500;color:var(--pm-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.pm-hsd-meta{font-size:0.7rem;color:var(--pm-text-muted)}.pm-hsd-arrow{color:var(--pm-text-muted);font-size:0.75rem}`,document.head.appendChild(e)}document.addEventListener(`click`,e=>{!c?.contains(e.target)&&!p?.contains(e.target)&&h()}),document.getElementById(`pm-sync-indicator`).addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await Js()}),document.getElementById(`pm-bell-btn`)?.addEventListener(`click`,()=>{Ps.open()});let _=(Z.currentRoute?.()||`hoy`).split(`?`)[0];ic(_)}var nc=!1;function rc(){if(nc)return;if(nc=!0,aa(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=fa();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),sa(),ma(),!zs){let e=Us;if(e?.id){let t=A.channel(`permisos-maestro:${e.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${e.id}`},async t=>{console.log(`[Realtime] Permisos actualizados:`,t.new);try{let t=await qe(e.id),n=document.getElementById(`portal-app`);if(!n)return;let r=[];t.puede_registrar_alumnos&&!Ws?.puede_registrar_alumnos&&r.push(`Registrar Alumnos`),t.puede_inscribir_clases&&!Ws?.puede_inscribir_clases&&r.push(`Gestionar e Inscribir Clases`);let i=[];Ws?.puede_registrar_alumnos&&!t.puede_registrar_alumnos&&i.push(`Registrar Alumnos`),Ws?.puede_inscribir_clases&&!t.puede_inscribir_clases&&i.push(`Gestionar e Inscribir Clases`);let a=(Z.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`registrar-alumno`&&!t.puede_registrar_alumnos||a===`gestionar-clases`&&!t.puede_inscribir_clases?`hoy`:a;a===`pending-approval`&&r.length>0&&(o=`hoy`),tc(n,e,t),sc(),Qs(),Z.setAuthGuard(()=>bt.isAuthenticated(),[`login`,`register`,`pending-approval`]),oc.clear(),await $(o),Z.navigate(o),r.length>0?N.success(`¡Nuevos permisos activados: ${r.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):i.length>0?N.show(`El administrador removió tu acceso a: ${i.join(`, `)}.`,`warning`):N.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>{console.log(`[Realtime] Canal permisos_maestros:`,e)});window.addEventListener(`beforeunload`,()=>{A.removeChannel(t)},{once:!0})}}document.addEventListener(`keydown`,e=>{if($s()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`)switch(e.key.toLowerCase()){case`h`:Z.navigate(`hoy`),t.length=0;break;case`c`:Z.navigate(`calendario`),t.length=0;break;case`r`:Z.navigate(`ruta`),t.length=0;break;case`m`:Z.navigate(`metricas`),t.length=0;break;case`p`:Z.navigate(`perfil`),t.length=0;break;default:break}t.length>3&&t.splice(0,t.length-2)});let e=null;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{let e=$s();if(e!==ec){ec=e,document.body.dataset.pmLayout=e,tc(document.getElementById(`portal-app`),Us),sc();let t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];ic(t)}},250)},{passive:!0})}function ic(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}var ac={},Q=null,oc=new Set;function sc(){let e=document.getElementById(`pm-view-container`);e&&(e.innerHTML=``,[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`registrar-alumno`,`gestionar-clases`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),ac[t]=n}),zs&&[`admin-alumnos`,`admin-programas`,`admin-maestros`,`admin-metricas`,`admin-config`,`admin-clases`,`admin-sesiones`,`admin-aprobacion`,`admin-ausencias`,`admin-notificaciones`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),ac[t]=n}))}async function $(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e&&e.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}ic(a),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}let o=ac[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Q==`function`&&(console.log(`[Router] Ejecutando cleanup de vista anterior...`),Q(),Q=null),Object.values(ac).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),oc.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{switch(a){case`login`:At(o,{onSuccess:()=>dc()});break;case`register`:jt(o,{onSuccess:()=>Z.navigate(`pending-approval`)});break;case`pending-approval`:Mt(o,{onBackToLogin:()=>Z.navigate(`login`)});break;case`logout`:Zs(),ha(),xt().then(()=>window.location.reload());break;case`calendario`:case`clases`:Q=await Bt(o);break;case`hoy`:Q=await Nt(o,{onClaseClick:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`asistencia`:Q=await wa(o,{claseId:i.get(`clase`),fecha:i.get(`fecha`)});break;case`metricas`:Q=Xt(o);break;case`perfil`:Q=Pa(o);break;case`clase-emergente`:Q=Oa(o,{maestroId:Us?.id});break;case`planificacion`:Q=await eo(o);break;case`alumno`:Q=po(o,{alumnoId:i.get(`id`)});break;case`gamificacion`:await vo(o);break;case`ruta`:await ko(o,{onTopicSelected:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:Ro(o);break;case`ruta-plan-builder`:zo(o,{alumnoId:i.get(`id`)});break;case`ruta-semanal`:Bo(o,{alumnoId:i.get(`id`)});break;case`ruta-libreria`:Vo.render().then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`ruta-detalle`:Ho.render(t).then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`admin-alumnos`:v(o);break;case`admin-programas`:x(o);break;case`admin-maestros`:g(o);break;case`admin-metricas`:ee(o);break;case`admin-config`:w(o);break;case`admin-clases`:f?.(o);break;case`admin-sesiones`:break;case`admin-aprobacion`:await y(o),Q=null;break;case`admin-ausencias`:await S(o),Q=null;break;case`admin-notificaciones`:await te(o),Q=null;break;case`registrar-alumno`:if(!Ws?.puede_registrar_alumnos){Z.navigate(`hoy`);return}Uo(o);break;case`gestionar-clases`:if(!Ws?.puede_inscribir_clases){Z.navigate(`hoy`);return}Q=await rs(o);break;default:}clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]).has(a)&&oc.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}async function cc(){if(Us)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[r,i,a]=await Promise.all([O(),O().then(e=>ne(e.map(e=>e.id))),O().then(()=>p(Us.id,n,n))]),o=Object.fromEntries(r.map(e=>[e.id,e]));await _e(i.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:o[e.clase_id]?.nombre||`Clase`})),a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}function lc(){oc.clear()}function uc(e){oc.delete(e)}async function dc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`),console.log(`[Init] Llamando usePortalAuth.init()...`);let t=await bt.init();console.log(`[Init] Auth completado:`,t?`con maestro`:`sin maestro`),zs=t?.es_admin===!0,console.log(`[Init] IS_ADMIN:`,zs);let n=window.router||Ct(),r=[`login`,`register`,`pending-approval`],i=n.currentRoute().split(`?`)[0],a=r.includes(i);if(!t&&!a){console.log(`[Init] No maestro y ruta privada, mostrando login screen`),Zs();return}if(!t&&a){console.log(`[Init] No maestro pero ruta pública detectada:`,i),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),sc(),Qs(),Z.setAuthGuard(()=>bt.isAuthenticated(),r),Z.start();return}let o=null;if(!zs)try{o=await qe(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}console.log(`[Init] Renderizando shell...`),tc(e,t,o),console.log(`[Init] Shell renderizado`),zs&&As.init(),sc(),rc(),Vr(uc,lc),Qs(),Z.setAuthGuard(()=>bt.isAuthenticated(),[`login`,`register`,`pending-approval`]),Z.start(),k().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!oc.has(e)).reduce((e,t)=>e.then(()=>{if(ac[t])return $(t,{},{silent:!0})}),Promise.resolve()),cc(),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),Js()}window.addEventListener(`error`,e=>{let t=[`useCache`,`WebSocket`,`content.js`],n=e.message||``;if(t.some(e=>n.includes(e))){console.warn(`[Ignored Error]`,n);return}tt(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let r=document.getElementById(`portal-app`);r&&(r.innerHTML=`
    ...
    </div>`)}),dc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});