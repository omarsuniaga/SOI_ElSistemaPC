const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-DX1WEsMf.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CsoeaaUJ.js","assets/supabase-C4ics26R.js","assets/AchievementsSummaryModal-DyEVGrEb.js","assets/portalUtils-CisZ9vg-.js","assets/pushService-DQD3mJWH.js","assets/maestroAuth-Cae-9DFh.js","assets/permisoService-CVH_7Qhu.js","assets/permisosSupabase-CIKt_2Y3.js","assets/ausenciasPanel-BPslrDVV.js","assets/ausenciaModal-BAKZ-Gr2.js","assets/AppModal-CLA9fW7x.js","assets/AppToast-BOjiJExQ.js","assets/planningParserService-B-5095RH.js","assets/groqService-CpEtzfwM.js","assets/clasesApi-CiNtdXkj.js"])))=>i.map(i=>d[i]);
import{A as e,D as t,G as n,I as r,J as i,K as a,O as o,Q as s,U as c,X as l,Y as u,_ as d,a as f,at as p,ct as m,et as h,f as g,g as _,h as v,i as y,it as b,m as x,n as S,nt as C,o as w,ot as T,q as E,r as D,rt as O,s as k,st as A,t as ee,tt as te,y as ne}from"./adminNotificacionesView-CzLmbsW2.js";import{i as j}from"./supabase-C4ics26R.js";import{a as re,i as ie,n as ae,r as M,t as oe}from"./maestroAuth-Cae-9DFh.js";import{t as se}from"./idb-DOPm7uLh.js";import{i as ce,n as le,t as ue}from"./offlineQueue-Cjwl3aiF.js";import{a as de,c as fe,d as pe,f as me,i as he,l as ge,n as _e,r as ve,s as ye,t as N,u as be}from"./pushService-DQD3mJWH.js";import"./vendor-BhXhnmkW.js";import{t as P}from"./AppToast-BOjiJExQ.js";import{t as xe}from"./preload-helper-CsoeaaUJ.js";import{t as F}from"./academicService-DX1WEsMf.js";import{a as Se,c as Ce,i as I,l as we,n as Te,o as Ee,r as De,s as Oe,t as ke}from"./portalUtils-CisZ9vg-.js";import{t as Ae}from"./AppModal-CLA9fW7x.js";import{a as je,i as Me,o as Ne,s as Pe,t as Fe}from"./groqService-CpEtzfwM.js";import{n as Ie,t as Le}from"./ausenciaModal-BAKZ-Gr2.js";import{n as Re,r as ze,t as Be}from"./reportService-DPq6aYOX.js";import{a as Ve,c as He,s as Ue,u as We}from"./clasesApi-CiNtdXkj.js";import{r as Ge,t as Ke}from"./permisoService-CVH_7Qhu.js";var qe=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Je(e=``){let t=String(e).toLowerCase();return qe.some(e=>t.includes(e.toLowerCase()))}var Ye=console.error;console.error=function(...e){e.length>0&&!Je(e[0])&&Ye.apply(console,e)};var Xe=console.warn;console.warn=function(...e){e.length>0&&!Je(e[0])&&Xe.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Je(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Je(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ze=window.fetch;window.fetch=async function(...e){try{return await Ze.apply(window,e)}catch(e){if(!Je(e.message))throw e;return null}};var Qe=!1;function $e(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Qe=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function et(e,t={}){if(!Qe&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var tt=!1;function nt(e={}){let{enabled:t=!1,consent:n=!1}=e;tt=t&&n,console.log(`[Analytics] Initialized, enabled:`,tt)}var rt={windowMs:6e4,max:100};function it(e={}){rt={...rt,...e},console.log(`[RateLimit] Initialized: ${rt.max} requests per ${rt.windowMs}ms`)}var at=null,ot=new Set;function st(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function ct(e={}){at=st(e.length||32),ot.clear(),ot.add(at),console.log(`[CSRF] Initialized`)}var lt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function ut(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function dt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!ut()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ft(t,n),pt(t,n),mt(t,n),ht(t,n),gt(t,n)}function ft(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];lt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function pt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function mt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);lt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ht(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function gt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var L={maestro:null,loading:!0,listeners:[]},_t=null;function vt(){L.listeners.forEach(e=>e({...L}))}var yt={subscribe(e){return L.listeners.push(e),()=>{L.listeners=L.listeners.filter(t=>t!==e)}},async init(){if(console.log(`[usePortalAuth.init] Iniciando...`),L.maestro=M(),console.log(`[usePortalAuth.init] Maestro local:`,L.maestro?`found`:`not found`),L.loading=!0,vt(),typeof process<`u`&&{}.VITEST)return L.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),L.maestro;if(!_t){let{data:{subscription:e}}=j.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),L.maestro=null,vt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=M();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);let e=await ae();e&&(L.maestro=e,vt())}}});_t=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([ae(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),L.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),L.maestro=null}return L.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado`),L.maestro},setMaestro(e){L.maestro=e,L.loading=!1,vt()},async logout(){await re(),L.maestro=null,vt()},getMaestro:()=>L.maestro,isAuthenticated:()=>!!L.maestro,isLoading:()=>L.loading},bt=yt.logout,xt=`calendario`;function St(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):xt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())});let e=o();e!==xt&&history.replaceState({route:e},``,`#/${e}`),h(e)}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var Ct=null,wt=null;function Tt(e,t=`polite`){Ct||(Ct=document.createElement(`div`),Ct.setAttribute(`aria-live`,t),Ct.setAttribute(`aria-atomic`,`true`),Ct.classList.add(`pm-visually-hidden`),document.body.appendChild(Ct)),t===`assertive`?(Ct.setAttribute(`role`,`alert`),Ct.setAttribute(`aria-live`,`assertive`)):(Ct.removeAttribute(`role`),Ct.setAttribute(`aria-live`,`polite`)),clearTimeout(wt),wt=setTimeout(()=>{Ct.textContent=``,requestAnimationFrame(()=>{Ct.textContent=e})},50)}function Et(e,t){if(!e||!e.id)return;Dt(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function Dt(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function Ot(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>Dt(e))}function kt(e,{onSuccess:t}){e.innerHTML=`
    <div class="pm-login">
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function Mt(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=M();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let o=await O();if(!o||o.length===0){e.innerHTML=`<p class="pm-empty">No tenés clases asignadas.</p>`;return}let s=o.map(e=>e.id),c=Object.fromEntries(o.map(e=>[e.id,e])),l=(await te(s)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!l||l.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${De(i)} ${Se(r)}</h2>
        <p class="pm-empty">No tenés clases hoy.</p>
      `;return}let u=new Date(r);u.setDate(u.getDate()-3);let d=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,`0`)}-${String(u.getDate()).padStart(2,`0`)}`,f=new Date(r);f.setDate(f.getDate()-1);let m=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,`0`)}-${String(f.getDate()).padStart(2,`0`)}`,h=(await p(n.id,d,m)||[]).filter(e=>{if(!s.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),g=(await p(n.id,a,a)).filter(e=>s.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),_=new Set(g.map(e=>e.clase_id)),v=await C(s),y={};for(let e of v||[])e.clase_id&&(y[e.clase_id]=(y[e.clase_id]||0)+1);let x=[...new Set(l.map(e=>e.salon_id).filter(Boolean))],S=x.length>0?await b(x):[],w=Object.fromEntries(S.map(e=>[e.id,e.nombre])),T=l.map(e=>{let t=c[e.clase_id],n=_.has(t.id),r=y[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
        <div class="pm-clase-card ${i}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${I(w[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),E=h.length>0?`
      <div class="pm-pendientes-banner">
        ...
        <div class="pm-pendientes-list">
          ${h.map(e=>{let t=c[e.clase_id];if(!t)return``;let n=e.fecha?e.fecha.split(`-`).reverse().slice(0,2).join(`/`):`—`;return`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await F.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await F.createSnapshotFromPlan(r,a,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${I(t.message)}</p>`}}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);e.id=`pm-hoy-pendientes-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Nt=null,Pt=null;function Ft(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],maestroId:i=null,onSave:a=null}=e;Nt=a,Pt=i,Ae.open({title:`⚡ Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
          ...
          <div class="pm-emergente-grid">
            ...
            <div class="pm-emergente-field">
              ...
              <select class="pm-emergente-select" id="modal-clase_id" required>
                ...
                ${r.map(e=>`<option value="${e.id}" ${e.id===n?`selected`:``}>${It(e.nombre)}</option>`).join(``)}
              </select>
            </div>
            <div class="pm-emergente-field">
    ...
    `,onShow:e=>{let t=e.querySelector(`#modal-es_co-docencia`),n=e.querySelector(`#codocencia-fields`);t?.addEventListener(`change`,e=>{n.style.display=e.target.checked?`block`:`none`}),e.querySelector(`#modal-clase_id`)?.addEventListener(`change`,async n=>{let i=n.target.value,a=r.find(e=>e.id===i);if(a?.maestro_auxiliar_id&&t.checked){let t=e.querySelector(`#modal-maestro_auxiliar_id`);t.value=a.maestro_auxiliar_id}})},onSave:async e=>{let t={fecha:e.querySelector(`#modal-fecha`).value,clase_id:e.querySelector(`#modal-clase_id`).value,hora_inicio:e.querySelector(`#modal-hora_inicio`).value,hora_fin:e.querySelector(`#modal-hora_fin`).value,tema:e.querySelector(`#modal-tema`).value.trim(),contenido:e.querySelector(`#modal-contenido`).value.trim(),motivo:e.querySelector(`#modal-motivo`).value,tipo:`emergente`,es_codocencia:e.querySelector(`#modal-es_co-docencia`).checked,maestro_auxiliar_id:e.querySelector(`#modal-maestro_auxiliar_id`)?.value||null,estado:`pendiente`,maestro_id:Pt};return!t.fecha||!t.clase_id||!t.hora_inicio||!t.hora_fin||!t.tema||!t.motivo?(P.error(`Todos los campos obligatorios deben completarse`),!1):t.hora_inicio>=t.hora_fin?(P.error(`La hora de inicio debe ser menor que la hora de fin`),!1):(Nt&&await Nt(t),!0)}})}function It(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}var Lt=[`Do`,`Lu`,`Ma`,`Mi`,`Ju`,`Vi`,`Sa`],Rt=7;async function zt(e,{onFechaClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=M();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.getFullYear(),a=r.getMonth();async function o(){try{let s=await Bt(n.id,i,a);Vt(e,i,a,r,s,{onFechaClick:e=>{Ht(e),t?.(e)},onPrev:()=>{a===0?(i--,a=11):a--,o()},onNext:()=>{a===11?(i++,a=0):a++,o()}})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar calendario: ${I(t.message)}</p>`}}await o()}async function Bt(e,t,n){let r=new Date(t,n,1),i=new Date(t,n+1,0),a=r.toISOString().split(`T`)[0],o=i.toISOString().split(`T`)[0],s=(await O()).map(e=>e.id);if(s.length===0)return new Map;let c=await te(s),l=new Set(c.map(e=>e.dia?.toLowerCase())),u=new Map;c.forEach(e=>{let t=e.dia?.toLowerCase(),n=e.hora_fin||`23:59`;(t&&!u.has(t)||n>u.get(t))&&u.set(t,n)});let d=await p(e,a,o),f=d.filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return e.estado===`registrada`||e.estado===`cerrada`||t||e.borrador===!1&&n}),m=new Set(f.map(e=>e.fecha)),h=new Map,g=new Date;g.setHours(0,0,0,0);for(let e=new Date(r);e<=i;e.setDate(e.getDate()+1)){let t=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,n=ke[e.getDay()];if(!l.has(n)){h.set(t,`sin-clase`);continue}let r=new Date(e),i=Math.floor((g-r)/864e5);if(i===0){let e=d.find(e=>e.fecha===t);if(e&&Array.isArray(e.asistencia)&&e.asistencia.length>0){h.set(t,`registrada`);continue}let r=u.get(n);if(r){let e=new Date,[n,i]=r.split(`:`),a=parseInt(n)*60*60*1e3+parseInt(i||0)*60*1e3;if(e.getHours()*60*60*1e3+e.getMinutes()*60*1e3<a){h.set(t,`sin-clase`);continue}}h.set(t,`pendiente`);continue}if(i>0&&m.has(t)){h.set(t,`registrada`);continue}i<0?h.set(t,`sin-clase`):i<=Rt?h.set(t,`pendiente`):h.set(t,`vencida`)}return h}function Vt(e,t,n,r,i,{onFechaClick:a,onPrev:o,onNext:s}){let c=new Date(t,n,1),l=new Date(t,n+1,0),u=c.getDay(),d=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`,f=l.getDate(),p=`${t}-${String(n+1).padStart(2,`0`)}-01`,m=`${t}-${String(n+1).padStart(2,`0`)}-${String(f).padStart(2,`0`)}`,h=d>=p&&d<=m?d:p,g=Lt.map(e=>`<div class="pm-cal-day-header">${e}</div>`).join(``);for(let e=0;e<u;e++)g+=`<div class="pm-cal-day otro-mes"></div>`;for(let e=1;e<=f;e++){let r=`${t}-${String(n+1).padStart(2,`0`)}-${String(e).padStart(2,`0`)}`,a=i.get(r)||`sin-clase`,o=r===d?`today`:``,s=r===h,c=`${e} de ${Te[n]} ${t}`;g+=`
    ...
    <div class="pm-dashboard" role="main" aria-label="Panel de métricas">
      ...
      <header class="pm-dashboard-header">
        ...
        <select id="pm-filter-periodo" class="pm-dashboard-select" aria-label="Período de análisis">
          <option value="4" ${R.periodo===4?`selected`:``}>4 semanas</option>
          <option value="8" ${R.periodo===8?`selected`:``}>8 semanas</option>
          <option value="12" ${R.periodo===12?`selected`:``}>12 semanas</option>
        </select>
      </header>
  ...
  `}function qt(e){e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);R.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await Wt(n,R.maestroId),r=Gt(t);R.clasesData=r.clasesData,R.todasSesiones=t.sesiones,R.inscripcionesPorClase=t.inscripcionesPorClase,R.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Kt(r),qt(e),Tt(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${I(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=R.clasesData.find(e=>e.id===i)?.alumnos||[],o=R.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
        ...
        <div class="pm-clase-students-list" role="list">
          ...
          `).join(``)}
        </div>`,n.appendChild(c),c.querySelector(`.pm-clase-students-close`).addEventListener(`click`,()=>c.remove());let l=t=>{!c.contains(t.target)&&t.target!==e&&(c.remove(),document.removeEventListener(`click`,l))};setTimeout(()=>document.addEventListener(`click`,l),10),c.querySelectorAll(`.pm-clase-student-row`).forEach(e=>{let t=()=>window.location.hash=`#/alumno?id=${e.dataset.alumno}`;e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})})})}function Jt(){if(!R.clasesData.length&&!Object.keys(R.inscripcionesPorClase).length)return null;let e=new Map;for(let[t,n]of Object.entries(R.inscripcionesPorClase)){let r=R.clasesData.find(e=>e.id===t);for(let t of n)e.has(t.id)||e.set(t.id,{...t,clases:[]}),r&&e.get(t.id).clases.push(r.nombre)}return[...e.values()]}async function Yt(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}R.maestroId=t.id;try{let n=await Wt(R.periodo,t.id),r=Gt(n);R.clasesData=r.clasesData,R.todasSesiones=n.sesiones,R.inscripcionesPorClase=n.inscripcionesPorClase,R.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Kt(r),qt(e),Tt(`Métricas actualizadas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`
      ...
      </div>`}}var z={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g,estados:/!(LOGRADO|EN_PROGRESO|INICIADO)\b/gi},Xt={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`,estados:{LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}};function Zt(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#\[\(\{\$>])/)[0].trim()),n.push(e)}return n}function Qt(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function $t(e){return{alumnos:Zt(e,z.alumnos),contenido:Zt(e,z.contenido),sugerencias:Zt(e,z.sugerencias),tareas:Zt(e,z.tareas),medidas:Zt(e,z.medidas),calificacion:Qt(e),objetivos:Zt(e,z.objetivos),niveles:Zt(e,z.niveles),nodos:Zt(e,z.nodos),capas:Zt(e,z.capas),estados:Zt(e,z.estados).map(e=>e.toUpperCase())}}function en(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],estados:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=$t(i))}),{...$t(e),por_capas:n}}function tn(e){if(!e)return``;let t=nn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(z.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Xt.capas}22; color:${Xt.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Xt.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Xt.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(z.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(z.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(z.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(z.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(z.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(z.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function nn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var rn=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function an(e){if(!e||e.length===0)return rn.slice(0,6);let t=e.toLowerCase();return rn.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function on(e){let t=rn.find(t=>t.trigger===e);return t?t.expand:null}function sn(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function cn(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=cn(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var B=null,un=[],dn=null,V=-1,fn=!1,pn=null,mn=!1,hn=0,gn=0;function _n(){if(!B){if(B=document.createElement(`div`),B.id=`pm-autocomplete-popup`,B.className=`pm-autocomplete-popup`,B.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(B)}}function vn(e,t,n={}){if(_n(),un=e||[],dn=t,pn=n.trigger||null,V=-1,fn=!0,wn(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),B.style.left=`${i}px`,B.style.top=`${a}px`}B.onmousedown=yn,document.addEventListener(`mousemove`,bn),document.addEventListener(`mouseup`,xn),B.style.display=`block`}function yn(e){e.target.closest(`.pm-ac-option`)||(mn=!0,hn=e.clientX-B.offsetLeft,gn=e.clientY-B.offsetTop,B.style.cursor=`grabbing`,B.style.transition=`none`)}function bn(e){if(!mn)return;let t=e.clientX-hn,n=e.clientY-gn;B.style.left=`${Math.max(0,t)}px`,B.style.top=`${Math.max(0,n)}px`}function xn(){mn&&(mn=!1,B.style.cursor=``)}function Sn(){B&&(B.style.display=`none`,mn=!1,document.removeEventListener(`mousemove`,bn),document.removeEventListener(`mouseup`,xn)),un=[],dn=null,V=-1,fn=!1,pn=null}function Cn(e){un=e||[],V=-1,wn(e)}function wn(e){if(!B)return;if(!e||e.length===0){B.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${On(pn)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===V,o=kn(pn,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${jn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${jn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),B.innerHTML=t,B.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{Tn(parseInt(e.dataset.index,10))})})}function Tn(e){if(e>=0&&e<un.length){let t=un[e];dn&&dn(t),Sn()}}function En(e){if(!(!fn||un.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),V=Math.min(V+1,un.length-1),wn(un),Dn();break;case`ArrowUp`:e.preventDefault(),V=Math.max(V-1,0),wn(un),Dn();break;case`Enter`:e.preventDefault(),V>=0?Tn(V):un.length>0&&Tn(0);break;case`Escape`:e.preventDefault(),Sn();break;case`Tab`:un.length>0&&V===-1&&(e.preventDefault(),Tn(0));break}}function Dn(){if(!B||V<0)return;let e=B.querySelector(`.pm-ac-option[data-index="${V}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function On(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function kn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?An(t.type):`•`}function An(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function jn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Mn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Nn(){return fn}function Pn(){return V}var Fn={show:vn,hide:Sn,updateOptions:Cn,handleKeyDown:En,getCursorPosition:Mn,isOpen:Nn,getSelectedIndex:Pn},In=`portal-maestros-catalogs`,Ln=1,Rn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},zn=null;async function Bn(){return zn||(zn=await se(In,Ln,{upgrade(e){for(let[t,n]of Object.entries(Rn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),zn)}async function Vn(e,t){let n=await Bn(),r=await n.get(e,t);if(!r)return null;let i=Rn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Hn(e){let t=await(await Bn()).getAll(e),n=Rn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Un(e,t,n){return(await Bn()).getAllFromIndex(e,t,n)}async function Wn(e,t){let n=await Bn(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Gn(e,t){let n=(await Bn()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Kn(e,t){await(await Bn()).delete(e,t)}async function qn(e){await(await Bn()).clear(e)}async function Jn(e){let t=await Bn(),n=Rn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function Yn(){let e=await Bn();for(let t of Object.keys(Rn))await e.clear(t)}async function Xn(e){return(await Hn(e)).length}async function Zn(e,t){let n=await Bn(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Qn(e){return(await Bn()).get(`historial`,e)}async function $n(e,t=5){return(await(await Bn()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var H={get:Vn,getAll:Hn,getByIndex:Un,set:Wn,setBulk:Gn,remove:Kn,clear:qn,cleanExpired:Jn,clearAll:Yn,getStoreSize:Xn,addToHistorial:Zn,getHistorial:Qn,getTopUsed:$n};async function er(e){if(!e)return[];try{let{data:t,error:n}=await j.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function tr(){let e=await H.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function nr(){let e=await H.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function rr(){let e=await H.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function ir(){let e=await H.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await H.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ar(){let e=await H.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await j.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await j.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await j.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await H.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function or(e=null){let t=await H.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=j.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await H.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function sr(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await er(n.claseId));break;case`[`:r=await tr();break;case`(`:r=await rr();break;case`{`:r=await ir();break;case`$`:r=await nr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ar():await or(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=cr(r,t)),e&&e!==`#`){let t=(await H.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function cr(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=lr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function lr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function ur(e,t){await H.addToHistorial(e,t)}var dr=`
...
`;function fr(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o={};e.innerHTML=`
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{pr(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function hr(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,br=class{constructor(e,t=vr){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){this._mounted||(this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(gr)||(this._autoTimer=setTimeout(()=>this.start(),_r)))}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(gr,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=yr,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function Sr(e,t=null,r=[],i=[],a={},o){let c=e===`edit`&&!!t,l=c?t:{...a};!c&&a.contenido&&!l.notas_dsl&&(l.notas_dsl=a.contenido),!c&&a.maestro_nombre&&!i.find(e=>e.nombre===a.maestro_nombre)&&(i=[{id:a.maestro_id,nombre:a.maestro_nombre},...i]);let u=new h(l),d=document.getElementById(`pm-planificacion-modal`);if(d&&d.remove(),d=document.createElement(`div`),d.id=`pm-planificacion-modal`,d.className=`pm-plan-modal-overlay`,d.innerHTML=wr(c,u,r,i),document.body.appendChild(d),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Tr(),document.head.appendChild(e)}let f=()=>{d.classList.remove(`open`),setTimeout(()=>d.remove(),200)};d.querySelector(`.pm-plan-close-x`).onclick=f,d.querySelector(`.pm-plan-cancel-btn`).onclick=f,d.querySelector(`.pm-plan-backdrop`).onclick=f;let p=e=>{e.key===`Escape`&&(f(),document.removeEventListener(`keydown`,p))};document.addEventListener(`keydown`,p);let m=d.querySelector(`#pl-plantilla`);m&&m.addEventListener(`change`,e=>{let t=xr.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(d.querySelector(`#pl-objetivos`).value=t.objetivos,d.querySelector(`#pl-contenido`).value=t.contenido,d.querySelector(`#pl-recursos`).value=t.recursos,d.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Dr(d))});let g=d.querySelector(`#pl-clase_id`);g&&g.addEventListener(`change`,()=>{let e=d.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Or(r,g.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),Er(d);let _=d.querySelector(`#dsl-editor-container`);if(_){let e=n({onSelect:async e=>{let n=(await E()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=s({initialContent:u.notas_dsl||``,onChange:(e,t)=>{let n=d.querySelector(`#dsl-summary`);n&&(n.textContent=Ar(t))},onAlumnoClick:()=>e.openModal()});_.appendChild(t),d._dslEditor=t}let v=d.querySelector(`.pm-plan-save-btn`);v.onclick=async()=>{let e=d.querySelector(`#pl-tema`)?.value.trim(),t=d.querySelector(`#pl-clase_id`)?.value;if(!e){d.querySelector(`#pl-tema`).focus();return}if(!t){d.querySelector(`#pl-clase_id`).focus();return}v.disabled=!0,v.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=d.querySelector(`#pl-recursos`)?.value||``,r=d._dslEditor,i={clase_id:t,maestro_id:d.querySelector(`#pl-maestro_id`)?.value||null,instrumento:d.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:d.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:d.querySelector(`#pl-objetivos`)?.value.trim(),contenido:d.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:d.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:d.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:c&&d.querySelector(`#pl-estado`)?.value||`planificado`};o&&await o(i),f()}catch(e){console.error(`[planificacionModal] Error:`,e),v.disabled=!1,v.textContent=c?`Guardar cambios`:`Guardar`}};let y=d.querySelector(`.pm-plan-body`);if(y){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;y.firstChild;)t.appendChild(y.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),y.appendChild(e);let i=d.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=r.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&Cr(t.instrumento,t.plan_estudio,d)}),u.clase_id)){let e=r.find(e=>e.id===u.clase_id);e?.instrumento&&e?.plan_estudio&&Cr(e.instrumento,e.plan_estudio,d)}}requestAnimationFrame(()=>{d.classList.add(`open`),d.querySelector(`#pl-tema`)?.focus()})}async function Cr(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await c(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
      ...
      </div>`).join(``)}catch(e){r.innerHTML=`<p class="text-danger small">${e.message}</p>`}}}function wr(e,t,n,r){let i=n.length?n.map(e=>`<option value="${e.id}" ${t.clase_id===e.id?`selected`:``}>${kr(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin clases disponibles</option>`,a=r.length?`<option value="">Sin asignar</option>`+r.map(e=>`<option value="${e.id}" ${t.maestro_id===e.id?`selected`:``}>${kr(e.nombre||e.id)}</option>`).join(``):`<option value="">Sin maestros disponibles</option>`,o=Array.isArray(t.recursos)?t.recursos.join(`, `):``,s=xr.map(e=>`<option value="${e.id}">${e.nombre}</option>`).join(``);return`
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-objetivos" rows="2" maxlength="1000"
              placeholder="¿Qué quieres lograr en esta clase?">${kr(t.objetivos||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-contenido" rows="3" maxlength="2000"
              placeholder="Desarrollo del tema, actividades...">${kr(t.contenido||``)}</textarea>
        ...
        <div class="pm-plan-section">
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-evaluacion" rows="2" maxlength="500"
              placeholder="¿Cómo evaluarás el aprendizaje?">${kr(t.evaluacion_metodo||``)}</textarea>
          ...
          <div class="pm-plan-field">
            ...
            <textarea class="pm-plan-textarea" id="pl-observaciones" rows="2" maxlength="1000"
              placeholder="Notas adicionales...">${kr(t.observaciones||``)}</textarea>
  ...
  `,await Pr()}async function Mr(e,t,n,r){Ae.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:await U.addClass(i);break;case`Nivel`:await U.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await U.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await U.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await U.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function Pr(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=await U.getClasses();!t.some(e=>e.id===W.activeClassId)&&t.length>0?W.activeClassId=t[0].id:t.length===0&&(W.activeClassId=null),e.innerHTML=`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Nr(`Clase`,null,()=>Pr()),W.activeClassId?Fr(W.activeClassId):zr(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),Mr(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Pr())},e.onclick=()=>{W.activeClassId=t,W.activeLevelId=W.activeNodeId=W.activeObjectiveId=null,Pr(),Fr(t),zr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),zr(`#pm-rc-objs-wrapper`,`Elegí Tema`),zr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Fr(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await U.getLevelsByClass(e);!n.some(e=>e.id===W.activeLevelId)&&n.length>0?W.activeLevelId=n[0].id:n.length===0&&(W.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Nr(`Nivel`,e,()=>Fr(e)),W.activeLevelId?Ir(W.activeLevelId):zr(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Mr(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Fr(e))},t.onclick=()=>{W.activeLevelId=n,W.activeNodeId=W.activeObjectiveId=null,Fr(e),Ir(n),zr(`#pm-rc-objs-wrapper`,`Elegí Tema`),zr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ir(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await U.getNodesByLevel(e);!n.some(e=>e.id===W.activeNodeId)&&n.length>0?W.activeNodeId=n[0].id:n.length===0&&(W.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Nr(`Tema`,e,()=>Ir(e)),W.activeNodeId?Lr(W.activeNodeId):zr(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Mr(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ir(e))},t.onclick=()=>{W.activeNodeId=n,W.activeObjectiveId=null,Ir(e),Lr(n),zr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Lr(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await U.getObjectivesByNode(e);!n.some(e=>e.id===W.activeObjectiveId)&&n.length>0?W.activeObjectiveId=n[0].id:n.length===0&&(W.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Nr(`Objetivo`,e,()=>Lr(e)),W.activeObjectiveId?Rr(W.activeObjectiveId):zr(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Mr(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Lr(e))},t.onclick=()=>{W.activeObjectiveId=n,Lr(e),Rr(n)}})}async function Rr(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
  ...
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Nr(`Indicador`,e,()=>Rr(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=()=>{let n=t.dataset.id,r=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;Mr(`Indicador`,n,r,()=>Rr(e))}})}function zr(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}var Br=null;function Vr(e,t){Br=e}function Hr(e){Br&&Br(e)}function Ur(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Wr(e,{claseId:t,rutaId:n,completedTopics:r=[],onIndicadorSelect:i}){let a=[],o=!1,s=null,c=document.createElement(`div`);if(c.className=`pm-route-bar-wrapper`,e.appendChild(c),!document.getElementById(`pm-route-bar-styles`)){let e=document.createElement(`style`);e.id=`pm-route-bar-styles`,e.textContent=`
        ...
        ${(e.plan_temas||[]).map(e=>`
          <div class="pm-tree-node" data-type="node">
            <div class="pm-tree-header">
              <span class="pm-tree-title">${Ur(e.nombre)}</span>
              <span class="pm-tree-badge">${e.tipo}</span>
            </div>
          </div>
          <div class="pm-tree-children">
            ${(e.plan_objetivos||[]).map(e=>{let t=(r||[]).includes(e.nombre);return`
                <div class="pm-tree-obj" data-type="obj" data-id="${e.id}" data-nombre="${Ur(e.nombre)}">
                  <i class="bi ${t?`bi-check-circle-fill text-success`:s?.id===e.id?`bi-circle-fill text-primary`:`bi-circle`}"></i>
                  <span style="${t?`text-decoration: line-through; opacity: 0.6;`:``}">${Ur(e.nombre)}</span>
                </div>
              `}).join(``)}
          </div>
        `).join(``)}
      </div>
    `).join(``)}async function d(){if(n){o=!0,u();try{a=await U.getRouteHierarchy(n)}catch(e){console.error(`[routeTreeBar] Error:`,e)}finally{o=!1,u()}}}function f(){c.removeEventListener(`click`,l),c.remove()}function p(){return s}return d(),{refresh:d,destroy:f,getActiveIndicador:p}}function Gr(e){return!e||typeof e!=`string`||!e.trim()||/[#\[\(\{\$>]/.test(e)?`dsl`:`natural`}function Kr(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=en(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function qr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function Jr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Yr(e,t,n,r){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let i=n.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea})),{data:a,error:o}=await j.from(`indicator_attempts`).upsert(i,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});return{data:a,error:o}}async function Xr(e,t){let{data:n,error:r}=await j.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await j.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await j.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:Jr(a??[],l),indicators:n,totalAlumnos:l}}async function Zr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=Gr(e);try{let t=e;i===`natural`&&(t=await Ne(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=qr(Kr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],error:e.message||`Error desconocido`}}}function Qr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function G(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function $r(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function ei(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function ti(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function ni(e,t){let{data:n,error:r}=await j.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await j.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=ti(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,u=c.length,d=u>0?Math.round(l/u*100):0,f=new Set;return{indicatorSummaries:c.filter(e=>{if(f.has(e.id))return!1;f.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:u,avance:d,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function ri(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${G($r(e.nombre_completo))}</div>
      <div>
        <div class="pm-student-panel__name">${G(e.nombre_completo)}</div>
  ...
  `}function ii(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${G(ei(e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Nota: ${G(String(e.nota??`-`))}</span>
      ${e.observations?`<span class="pm-eval-timeline__detail">${G(e.observations)}</span>`:``}
      ${e.tarea?`<span class="pm-eval-timeline__detail"><strong>Tarea:</strong> ${G(e.tarea)}</span>`:``}
    </li>
  `).join(``)||`<p class="pm-empty-history">Sin evaluaciones previas</p>`}
    </ul>
  `}function ai(e){return e.length?e.map((e,t)=>`
    <div class="pm-route-indicador pm-route-indicador--${G(e.semColor)}"
      ...
      <div class="pm-route-indicador__info">
        <span class="pm-route-indicador__name">${G(e.nombre)}</span>
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function oi(e){return e.length?`
      ...
      <ul class="pm-pending-tasks">
        ${e.map(e=>`
          <li class="pm-pending-tasks__item">
            <strong>${G(e.indicadorNombre)}:</strong> ${G(e.tarea)}
          </li>
        `).join(``)}
      </ul>
    </section>
  `:``}function si(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${ri(e,n)}
  ...
  `}function ui({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){Qr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){Oe()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let u=we(l);l();function d(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){h();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;f(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;f(e,n);return}}async function f(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
      <div class="pm-student-panel__modal-content">
        ...
        <p class="pm-student-panel__modal-indicator-name">${G(n.nombre)}</p>
        ...
        <div class="pm-student-panel__modal-body">
          ...
          <div class="pm-student-panel__modal-field">
            ...
            <textarea id="modal-obs" rows="4" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 12px; font-size: 0.9rem; resize: none; outline: none;" placeholder="Escribe aquí las observaciones...">${r?G(r.observations):``}</textarea>
          </div>
        </div>
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await p(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function p(t,n,o,s=null){try{let s=M();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await j.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await m()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,d),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function m(){o.innerHTML=ci(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=Ie(o,{onClose:()=>h()});try{let n=await ni(e.id,t);s=n.indicatorSummaries,o.innerHTML=si(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=li(e?.message??`Error desconocido al cargar datos.`)}}function h(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function g(){c&&=(c.dispose(),null),u(),o.removeEventListener(`click`,d),o.remove()}return{open:m,close:h,destroy:g}}var di={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},fi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`],pi={CONDUCTA:{label:`Conducta`,icon:`🚨`},ATENCION:{label:`Atención y concentración`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`Riesgo pedagógico`,icon:`📉`}};function mi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function hi(){let e=null,t=[],n=null;function r(e,t){let n=!!e.alerta,r=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos.join(`, `):e.scope===`grupo`||e.scope===`all`?`Todos los presentes`:`—`;if(n){let t=pi[e.alertaTipo]??{label:`Alerta`,icon:`⚠️`};return`
      ...
      <div class="ssp-card">
        ...
        <div class="ssp-contenido">${mi(e.contenido_dsl)||`—`}</div>
        ${e.observacion?`<div class="ssp-obs">${mi(e.observacion)}</div>`:``}
        ${e.tarea?`<div class="ssp-tarea">📝 ${mi(e.tarea)}</div>`:``}
      </div>
    `}function i(e,n){let r=(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})(),i=t.filter(e=>e.alerta),a=t.filter(e=>!e.alerta),o=[`📚 Resumen clase ${e} — ${r}`];if(i.length){o.push(``,`⚠️ Alertas:`);for(let e of i){let t=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos[0]:`Alumno`,n=pi[e.alertaTipo]??{label:`Alerta`},r=e.tarea?` — ${e.tarea}`:``;o.push(`• ${t}: ${n.label}${r}`)}}if(a.length){o.push(``,`✅ Logros:`);for(let e of a){let t=Array.isArray(e.alumnos)&&e.alumnos.length?e.alumnos.join(`, `):`Todos`,n=di[e.estado]?.label??e.estado;o.push(`• ${t}: ${e.contenido_dsl||`—`} — ${n}`)}}return o.push(``,`🎯 El Sistema PC`),o.join(`
`)}function a(n,a){if(!e)return;let s=t.filter(e=>e.alerta),l=t.filter(e=>!e.alerta),u=t.length>0;e.innerHTML=`
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${mi(n)} · ${mi(a)}</div>
          </div>
        </div>
    ...
    `,gi(),e.querySelectorAll(`.ssp-estado-btn`).forEach(e=>{e.onclick=()=>o(parseInt(e.dataset.idx),n,a)}),e.querySelector(`#ssp-whatsapp`).onclick=()=>{let e=i(n,a);window.open(`https://wa.me/?text=${encodeURIComponent(e)}`,`_blank`)},e.querySelector(`#ssp-close`).onclick=c,e.querySelector(`.ssp-backdrop`).onclick=c}async function o(e,r,i){let o=t[e];if(!o||!n)return;let s=fi[(fi.indexOf(o.estado)+1)%fi.length];t[e]={...o,estado:s},a(r,i);let{error:c}=await n.from(`progresos`).update({estado:s}).eq(`id`,o.id);c&&(console.error(`[SessionSummaryPanel] Error actualizando estado:`,c),t[e]=o,a(r,i))}async function s({sesionId:r,claseNombre:i,fecha:o,supabase:s}){n=s,e||(e=document.createElement(`div`),e.className=`ssp-wrapper`,document.body.appendChild(e)),e.style.display=`flex`,e.innerHTML=`
      <div class="ssp-backdrop"></div>
      <div class="ssp-dialog">
        <div class="ssp-header">
          <span class="ssp-icon">📊</span>
          <div><strong>Resumen Pedagógico</strong><div class="ssp-subtitle">${mi(i)}</div></div>
        </div>
        <div class="ssp-loading">Cargando registros...</div>
      </div>
    `,gi(),e.querySelector(`.ssp-backdrop`).onclick=c;let{data:l,error:u}=await s.from(`progresos`).select(`id, alumno_id, contenido_dsl, estado, observacion, tarea, alerta, alertaTipo, scope, alumnos`).eq(`sesion_clase_id`,r).order(`alerta`,{ascending:!1});u?(console.error(`[SessionSummaryPanel] Error cargando progresos:`,u),t=[]):t=l||[],a(i,o)}function c(){e&&(e.style.display=`none`,e.innerHTML=``),t=[],n=null}return{open:s,close:c}}function gi(){if(document.getElementById(`ssp-styles`))return;let e=document.createElement(`style`);e.id=`ssp-styles`,e.textContent=`
    /* ── Wrapper & backdrop ────────────────────────── */
    .ssp-wrapper {
      position: fixed;
      inset: 0;
  ...
  `,document.head.appendChild(e)}function _i({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function vi(e,t,n){let{data:r,error:i}=await j.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await j.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function yi(e,t){let{data:n,error:r}=await j.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function bi(e){let{error:t}=await j.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function xi(e,t,n,r,i=null){let{error:a}=await j.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(a)throw a;let{data:o,error:s}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,es_borrador:!1}).select().single();if(s)throw s;return o}var Si=`soi_ruta_tema_pendiente`;function Ci(e){sessionStorage.setItem(Si,JSON.stringify(e))}function wi(){let e=sessionStorage.getItem(Si);if(!e)return null;sessionStorage.removeItem(Si);try{return JSON.parse(e)}catch{return null}}function Ti(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `,document.body.appendChild(i),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let a=null,o=null,s=null,c=null,l=!1,u=null,d=null,f=i.querySelector(`#pm-justif-title`),p=i.querySelector(`#pm-justif-subtitle`),m=i.querySelector(`#pm-justif-btn-text`),h=i.querySelector(`#pm-justif-alumno-nombre`),g=i.querySelector(`#pm-justif-motivo`),_=i.querySelector(`#pm-justif-file`),v=i.querySelector(`.pm-justif-file-placeholder`),y=i.querySelector(`.pm-justif-file-preview`),b=i.querySelector(`#pm-justif-preview-img`),x=i.querySelector(`#pm-justif-remove-file`),S=i.querySelector(`#pm-justif-delete`);function C(e,t=null,n=null){a=e,o=t,s=null,c=null,l=!!t,u=n,l?(f.textContent=`Editar Justificación`,p.textContent=`Modifica el motivo de la inasistencia`,m.textContent=`Actualizar`,S.style.display=`flex`):(f.textContent=`Justificar Inasistencia`,p.textContent=`Registra el motivo de la ausencia`,m.textContent=`Guardar Justificación`,S.style.display=`none`),h.textContent=e.nombre_completo,g.value=t?.motivo||``;let r=t?.evidencia_url||t?.evidencia_base64;r?(c=r,b.src=r,v.style.display=`none`,y.style.display=`block`):(c=null,v.style.display=`flex`,y.style.display=`none`),_.value=``,i.classList.add(`open`),g.focus();let x=i.querySelector(`.pm-justif-modal`);x&&(d&&d.dispose(),d=Ie(x,{onClose:()=>w(!0)}))}function w(e=!1){e&&n&&a&&u!==null&&n(a.id,u),i.classList.remove(`open`),a=null,o=null,s=null,c=null,u=null,d&&=(d.dispose(),null)}i.querySelector(`#pm-justif-close`).onclick=()=>w(!0),i.querySelector(`#pm-justif-cancel`).onclick=()=>w(!0),S.onclick=()=>{a&&confirm(`¿Eliminar la justificación de ${a.nombre_completo}?`)&&(r&&r({alumnoId:a.id,justificacionId:o?.id,existingUrl:o?.evidencia_url||o?.evidencia_base64}),w(!1))},i.querySelector(`.pm-justif-backdrop`).onclick=()=>w(!0),_.onchange=e=>{let t=e.target.files[0];t&&(s=t,c=URL.createObjectURL(t),b.src=c,v.style.display=`none`,y.style.display=`block`)},x.onclick=()=>{c&&!(o?.evidencia_url||o?.evidencia_base64)&&URL.revokeObjectURL(c),s=null,c=null,_.value=``,v.style.display=`flex`,y.style.display=`none`},i.querySelector(`#pm-justif-save`).onclick=()=>{let e=g.value.trim();if(!e){g.focus(),g.style.borderColor=`var(--pm-danger)`,setTimeout(()=>{g.style.borderColor=``},2e3);return}t&&a&&t({alumnoId:a.id,motivo:e,evidenciaFile:s,evidenciaPreview:c,justificacionId:o?.id||null,existingUrl:o?.evidencia_url||o?.evidencia_base64||null,isEdit:l})};let T=e=>{e.key===`Escape`&&(w(),document.removeEventListener(`keydown`,T))};return document.addEventListener(`keydown`,T),{open:C,close:w}}var Ei=`documentos`;async function Di(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await j.storage.from(Ei).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=j.storage.from(Ei).getPublicUrl(r);return o.publicUrl}async function Oi({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await Di(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:u,error:d}=await j.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:u,error:d}}async function ki(e,t){if(!e||!t)return null;let{data:n,error:r}=await j.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function Ai(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await j.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}async function ji(e,t,n,r,i=`Clase`){if(!r||r.length===0)return{success:!0};let a=r.filter(e=>e.observacion&&e.observacion.trim().length>0);if(a.length===0)return{success:!0};let s=a.map(r=>new o({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON()),{data:c,error:l}=await j.from(`observaciones_alumnos`).upsert(s,{onConflict:`sesion_clase_id,alumno_id`});return l?(console.error(`[Promotion] Error promoviendo observaciones:`,l),{success:!1,error:l.message}):{success:!0,data:c}}function Mi(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function Ni(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function Pi(e,t){let n=Ni(e);return t.find(e=>Ni(e.nombre)===n||Ni(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&Ni(e.nombre).includes(n)||n.length>=3&&n.includes(Ni(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Fi(e,t){let n=[],r=[];for(let i of e){if(Ni(i)===`todos`){n.push(...t);continue}let e=Pi(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Ii(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await j.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function Li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Fi(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Ii(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function Ri({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=en(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function zi({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await j.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Ni(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Ni(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await j.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Bi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Vi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Hi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Ui={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Wi(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Ui[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Gi(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Hi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Hi(n.join(`, `))}</span>`:``}}function o(e,t){let n=Bi[e.estado]??Bi.EN_PROGRESO,r=e.nota?` · ${Hi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Hi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Ui[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${Hi(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${Hi(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${Hi(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${Hi((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${Hi(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${Hi(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Wi(c)}</div>`:``,d=Pe(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${Hi(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${Hi(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,Ki(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Vi.indexOf(i)+1)%Vi.length;r[n].estado=Vi[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function Ki(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function qi(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await j.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=Ji[e.tipo]??Ji.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${Xi(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${Xi(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${Xi(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}function Qi(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function $i(e){let{claseId:t,fecha:n,isValid:r}=Qi(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}de(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),oa(e.notification);let t=e.notification;t?.data?.deep_link?$i(t.data.deep_link):t?.data?.deep_link_url&&$i(t.data.deep_link_url),K.some(t=>t.id===e.notification.id)||(K.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),pa())}});var ea=30*1e3,ta=60*1e3,na=120*1e3,ra=new Map;function ia(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/ta)}`}function aa(){let e=Date.now();for(let[t,n]of ra.entries())e>n&&ra.delete(t)}function oa(e){let t=ia(e),n=Date.now()+na;ra.set(t,n)}function sa(){return aa(),ra.size}function ca(e){return`notif_cache_${e}`}function la(e){try{let t=K.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(ca(e),JSON.stringify(t))}catch{}}function ua(e){try{let t=localStorage.getItem(ca(e));return t?JSON.parse(t):[]}catch{return[]}}var K=[],da=[];function fa(e){return da.push(e),e(K),()=>{da=da.filter(t=>t!==e)}}function pa(){da.forEach(e=>e([...K]))}async function ma(){let e=M();if(!e)return[];K.length===0&&(K=ua(e.id),K.length>0&&pa());try{let{data:t,error:n}=await j.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),K;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=K.filter(e=>String(e.id).startsWith(`local_`));return K=[...r,...i],await ha(e.id),la(e.id),pa(),K}catch(e){return console.error(`[NotifService]`,e),K}}async function ha(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([O(),p(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),c=(await te(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let l=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),u=new Date;for(let e of c){if(!e.hora_fin||l.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(u-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(K.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let d=e.hora_fin?e.hora_fin.slice(0,5):``,f=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=f&&d?` (${f}–${d})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;K.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of c){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-u)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(K.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=Math.round(a);K.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${d} ${d===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function ga(e){let t=M(),n=K.find(t=>t.id===e);if(n&&(n.estado=`leida`),pa(),t&&la(t.id),!String(e).startsWith(`local_`))try{await j.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function _a(e){let t=M();if(K=K.filter(t=>t.id!==e),pa(),t&&la(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await j.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function va(){let e=M();if(K.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),pa(),e&&la(e.id),e)try{await j.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function ya(){return K.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var ba=null;function xa(){let e=M();e&&(ba||=j.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};K.some(e=>e.id===n.id)||(K.unshift(n),la(e.id),pa(),Ca(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=K.findIndex(e=>e.id===t.new.id);n!==-1&&(K[n]={...K[n],...t.new},la(e.id),pa())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),e===`CHANNEL_ERROR`&&(console.warn(`[Realtime] Canal cerrado, el polling de fallback sigue activo.`),ba=null)}))}function Sa(){ba&&=(j.removeChannel(ba),null)}function Ca(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=wa(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),Ea(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function wa(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Ta=!1;function Ea(){if(Ta)return;Ta=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var Da=null;function Oa(){Da===null&&(Da=setInterval(()=>{document.visibilityState!==`hidden`&&ma()},ea))}function ka(){Da!==null&&(clearInterval(Da),Da=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(ma(),Oa()):ka()});function Aa(){let e=new Date().toISOString().split(`T`)[0];K=K.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}Aa(),document.visibilityState!==`hidden`&&Oa();async function ja(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||P!==void 0&&P&&P.error(`Error inesperado: `+(e.message||e)),null}}async function Ma(e,{claseId:t,fecha:n}={}){let r=typeof e==`string`?document.getElementById(e):e;if(!r){console.error(`[asistenciaView] Container not found:`,e);return}r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let i=M();if(!i){r.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){r.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let a=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,s,c]=await Promise.all([O(),te([t]),C([t]),j.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,i.id).eq(`fecha`,a).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let l=n.find(e=>e.id===t);if(!l){console.log(`[DEBUG] Clase not found in misClases`),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let u=o.find(t=>t.dia?.toLowerCase()===e),d=(s||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),f=c.data?.[0],p=f?.id||null,m=f?.updated_at||null,h=f?.contenido||``,g=l.salon?[l.salon]:[],[_,v]=await Promise.all([p?j.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,p).then(e=>e.data||[]):Promise.resolve([]),g.length>0?b(g):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let y=v.length>0?v[0].nombre:null,x=`pm_asistencia_${t}_${a}`,S=localStorage.getItem(`${x}_updated`),w=!1;m&&S&&new Date(m).getTime()>new Date(S).getTime()+5e3&&(w=!0);let T=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await j.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();T=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let E={},D={};d.forEach(e=>{E[e.id]=null});let k=f?.asistencia||[];if(k.length===0&&p)try{let{data:e}=await j.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,p);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};k=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let A={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};k.forEach(e=>{if(E.hasOwnProperty(e.alumno_id)){let t=A[e.estado]??e.estado;E[e.alumno_id]=t}});let ee=[];if(p)try{ee=await j.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,p).then(e=>e.data||[]),ee.forEach(e=>{E.hasOwnProperty(e.alumno_id)&&(E[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Na(r,{clase:l,horario:u,alumnos:d,estado:E,justificaciones:D,maestro:i,fechaHoy:a,claseId:t,sesionId:p,hasConflict:w,serverDSL:h,snapshots:_,salonNombre:y,rutaId:T,sesionExistenteData:f})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),r.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function Na(n,i){let{clase:a,horario:o,alumnos:s,estado:c,justificaciones:l,maestro:u,fechaHoy:d,claseId:f,snapshots:p,serverDSL:m,hasConflict:h,salonNombre:g,rutaId:_,sesionExistenteData:v}=i,y=i.sesionId,b=[],x=`pm_asistencia_${f}_${d}`,S=m,C=null,w=Mi(),E=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${I(a.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${g?`📍 ${I(g)} · `:``}
            ${o?`${Ee(o.hora_inicio)} – ${Ee(o.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${Se(new Date(d+`T12:00:00`))}</span> · 
            ${s.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let D=n.querySelector(`#pm-dsl-toolbar-container`),k=n.querySelector(`#pm-dsl-editor-container`),A=fr(k,{initialContent:m,onChange:e=>{S=e}});A.setContext({claseId:f});let ee=hr(n,{onAceptar:e=>{A.setValue(e)}}),te=sn(n,{onAccept:e=>{A.setValue(e)}}),ne=Gi(k.parentNode,{onConfirm:async e=>{try{let t=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Li({sesionId:y,claseId:f,maestroId:u.id,fechaHoy:d,progressRecords:e,alumnos:t});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=n.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(e){n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P.error(`Error al guardar progreso: `+e.message)}},onCancel:()=>{n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),re=Zi(n.querySelector(`#pm-planificacion-dropdown`)||n,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await r({instrumento:e,nivel:t,descripcion:n,pilares:i}),{linked:s}=await zi({claseId:f,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;P.success(c)}catch(e){P.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ie=ln(D,{onInsert:(e,t,n)=>A.insertText(e,t,n),getEditorContent:()=>A.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=D.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Me(e);ee.open({original:e,improved:t})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=D.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=E?.getActiveIndicador(),n=await Ne(e,{presentes:s.filter(e=>c[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});te.open({original:e,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async e=>{await ja(async()=>{let t=s.filter(e=>c[e.id]&&c[e.id]!==`A`),r=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},i=s.map(e=>e.nombre_completo||e.nombre||``),o={alumnos:s.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),presentes:t.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,i)}}),tipoClase:ke(a),instrumento:a.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:E?.getActiveIndicador()?.nombre||``};n.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Fe(e,o);if(!l?.progreso?.length){n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.warning(`La IA no detectó registros de progreso en este texto.`);return}ne.open({progreso:l.progreso,resumen:l.resumen})},{onError:e=>{n.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.error(`Error al analizar con IA: `+e.message)}})}}),ae=null,M=n.querySelector(`#pm-planificacion-card`),oe=n.querySelector(`#pm-planificacion-dropdown`),se=n.querySelector(`#pm-planificacion-nombre`);n.querySelector(`#pm-planificacion-detail`);let ce=n.querySelector(`#pm-plan-list-rutas`),le=n.querySelector(`#pm-plan-list-planificaciones`),de=n.querySelector(`#pm-planificacion-header`);de&&de.addEventListener(`click`,()=>{let e=M.classList.toggle(`open`);oe.style.display=e?`block`:`none`}),n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>{e.addEventListener(`click`,()=>{n.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.dataset.tab;ce.style.display=t===`rutas`?``:`none`,le.style.display=t===`planificaciones`?``:`none`})});function fe(e){ae=e.id,localStorage.setItem(`pm_default_plan_${f}`,e.id),se&&(se.textContent=e.nombre||e.name||`Sin nombre`),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.planId===e.id)}),E&&=(E.destroy(),null);let t=n.querySelector(`#pm-route-tree-container`),r=n.querySelector(`#pm-active-tema-badge`);ae&&t&&(t.innerHTML=``,Ve(f).then(e=>{E=Wr(t,{claseId:f,rutaId:ae,completedTopics:e,onIndicadorSelect:e=>{A.insertText(`[${e.nombre}] `),ie.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),M.classList.remove(`open`),oe.style.display=`none`}}),b.push(()=>E.destroy())}))}let pe=n.querySelector(`#btn-manage-planning`);pe&&(pe.onclick=e=>{if(e.stopPropagation(),!ae){Ae.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ae.open({title:`Gestionar Estructura: ${se.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(E&&E.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&jr(t,ae)}),M&&(async()=>{try{let e=await U.getClasses(),t=localStorage.getItem(`pm_default_plan_${f}`),n=(a.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});ce&&(ce.innerHTML=r.length?r.map(e=>`
              ...
              </div>`).join(``):`<div style="padding:0.5rem;font-size:0.8rem;color:var(--pm-text-muted)">No hay planes sugeridos para este instrumento</div>`,ce.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=r.find(t=>t.id===e.dataset.planId);t&&fe(t)})})),le&&(le.innerHTML=e.map(e=>`
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${I(e.nombre||e.name)}</span>
            </div>`).join(``),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&fe(n)})})),M.style.display=``;let i=e.find(e=>e.id===t)||r[0]||await U.resolveSmartPlan(a);i&&fe(i)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let me=n.querySelector(`#btn-proponer-curriculo`);me&&(me.onclick=async()=>{me.disabled=!0,me.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await qi(f,12);if(e.registros.length===0){P.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await je(e,{instrumento:a?.instrumento||``,nivel:``,nombreClase:a?.nombre||``});re.open({pilares:t.pilares,resumen:t.resumen,instrumento:a?.instrumento||``,nivel:``})}catch(e){P.error(`Error al generar propuesta: `+e.message)}finally{me.disabled=!1,me.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let he=n.querySelector(`#btn-copy-as-plan`);he&&he.addEventListener(`click`,async()=>{let t=A.getValue();Sr(`create`,null,await O(),[],{clase_id:f,maestro_id:u?.id||null,maestro_nombre:u?.nombre_completo||null,contenido:t||``,fecha_inicio:d},async t=>{try{await e({...t,estado:`planificado`});let n=document.createElement(`div`);n.className=`pm-toast-success`,n.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(n),setTimeout(()=>n.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),_&&(E=Wr(n.querySelector(`#pm-route-tree-container`),{claseId:f,rutaId:_,onIndicadorSelect:e=>{A.insertText(`[${e.nombre}] `),ie.setContext({indicadorActivo:e.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``)}}),b.push(()=>E.destroy())),console.log(`[DEBUG] Reached handoff section`);let ge=wi();if(ge&&ge.claseId===f){let e=`[${ge.nombre}] `;A.insertText(e),ie.setContext({indicadorActivo:ge.nombre});let t=n.querySelector(`#btn-guardar-obs`);t&&(t.style.display=``);let r=n.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        Tema cargado desde Ruta: <strong>${ge.nombre.replace(/</g,`&lt;`)}</strong>
        <button onclick="this.parentElement.remove()" style="
          margin-left:auto;background:none;border:none;cursor:pointer;
          font-size:12px;color:#1d4ed8;
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let _e=Ti(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&j.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&Ai(t).catch(console.warn),c[e]=null,delete l[e],Ce(e),Te(),await De(!0),Tt(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await j.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await j.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=j.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await j.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{y||await De(!0,!1);let r=await Oi({sesionId:y,alumnoId:e,claseId:f,fecha:d,motivo:t,creadoPor:u.id},n);if(r.error)throw r.error;o=r.data}o&&(l[e]=o),_e.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{c[e]=t,Ce(e),Te()}});b.push(()=>{try{_e.close()}catch{}});let ve=null,ye=n.querySelector(`#pm-draft-indicator`);if(y){ve=_i({saveFn:async e=>{y&&await vi(y,u.id,e)},debounceMs:3e4}),ve.onSaved(()=>{let e=new Date;ye.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,ye.style.display=``}),A.getValue;let e=k.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),ve&&ve.onInput(A.getValue())}}b.push(()=>ve.destroy()),v?.borrador===!0&&yi(y,u.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(A.setValue(e.contenido_raw),S=e.contenido_raw):bi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}n.querySelector(`#pm-academic-tools`);let N=n.querySelector(`#btn-guardar-obs`);N&&(_&&(N.style.display=``),N.onclick=async()=>{let e=A.getValue();if(!e||!e.trim()){P.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!y){P.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let t=null,r=await He(e),i=E?.getActiveIndicador();if(t=r||i,!t){P.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let o=n.querySelector(`#pm-active-tema-badge`);o&&t.nombre&&(o.textContent=t.nombre,o.style.display=`inline-block`),N.disabled=!0,N.textContent=`Procesando...`;try{let n=s.filter(e=>c[e.id]===`P`),r=await Zr(e,t.id,n,t.nombre);if(r.error)throw Error(r.error);if(r.modo===`natural`&&r.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+r.dslGenerado+`

¿Guardar la evaluación?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(r.missing.length>0&&!confirm(`Faltan ${r.missing.length} alumno(s) sin evaluar:\n${r.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(r.evaluaciones.length>0){let{error:e}=await Yr(y,t.id,r.evaluaciones,u.id);if(e)throw e}let i={indicador_id:t.id,evaluaciones:r.evaluaciones};await xi(y,u.id,e,i,r.dslGenerado||null);let o=en(e);if(o.estados&&o.estados.length>0){let t=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Ri({sesionId:y,claseId:f,maestroId:u.id,fechaHoy:d,dslText:e,alumnos:t}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Pe(e,k)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await ji(y,f,u.id,r.evaluaciones,a.nombre||`Clase`);l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),E&&await E.refresh(),A.setValue(``),S=``;let p=document.createElement(`div`);p.innerHTML=`
          <div style="display:flex; flex-direction:column; align-items:center; gap:4px;">
            <span>✅ Observación guardada exitosamente (${r.evaluaciones.length} eval.)</span>
            <span style="font-size:0.85em; opacity:0.9;">Tema detectado: <b>${t.nombre}</b></span>
          </div>
        `,p.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(p),setTimeout(()=>p.remove(),4500),N.textContent=`¡Guardado!`,setTimeout(()=>{N.textContent=`Guardar observación`,N.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),P.error(`Error al guardar: `+(e.message||e)),N.disabled=!1,N.textContent=`Guardar observación`}});let be=null,F=n.querySelector(`#pm-alumnos-list`);function Ce(e=null){let t=Pa(s,c),n=null;if(e){let t=F.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(F.innerHTML=t.map(e=>we(e,c[e.id])).join(``),e&&n){let t=F.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function we(e,t){return`
    ...
    `}F.onclick=async e=>{let t=e.target.closest(`.pm-asist-btn`),r=e.target.closest(`.pm-asist-nombre`);if(r){let e=r.closest(`.pm-asist-item`).dataset.id,t=s.find(t=>t.id===e);if(_){be&&be.destroy(),be=ui({alumno:t,rutaId:_,sessionId:y,claseId:f,fecha:d,horaInicio:o?.hora_inicio||null}),be.open(),b.push(()=>{be&&be.destroy()});return}let i=p.filter(t=>t.student_id===e);if(i.length===0)try{let{academicService:t}=await xe(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(y,e,d);n?(i=n,p.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${e}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}mr(n,{student:t,sessionId:y,teacherId:u.id,snapshots:i});return}if(!t)return;let{id:i,action:a}=t.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),a===`J`){let e=s.find(e=>e.id===i);if(!e)return;if(c[i]===`J`){let t=l[i]||null;!t&&y&&(t=await ki(y,i),t&&(l[i]=t)),_e.open(e,t,null),Tt(`Editando justificación de ${e.nombre_completo}.`)}else c[i]=`J`,Ce(i),Te(),await De(!0),_e.open(e,null,null),Tt(`Justificación marcada para ${e.nombre_completo}.`);return}c[i]=c[i]===a?null:a,Ce(i),Te();let m=Object.values(c).filter(e=>e===`P`).length,h=Object.values(c).filter(e=>e===`A`).length,g=Object.values(c).filter(e=>e===`J`).length;Tt(`Asistencia actualizada. ${m} presentes, ${h} ausentes, ${g} justificados.`),await De(!0)};function Te(){let e=s.length,t=Object.values(c).filter(e=>e!==null).length,r=n.querySelector(`#pm-progress-wrap`),i=n.querySelector(`#pm-progress-fill`),a=n.querySelector(`#pm-progress-label`);if(t===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${t/e*100}%`,a.textContent=`${t}/${e}`}async function De(e=!1,t=!1){C&&clearTimeout(C);let n=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t={clase_id:f,maestro_id:u.id,fecha:d,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:S||``};if(navigator.onLine)try{if(y){let{error:e}=await j.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,y);if(!e){localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await j.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){y=e.id,console.log(`[asistencia] Nueva sesión creada:`,y),localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await ue({tabla:`sesiones_clase`,operacion:y?`update`:`insert`,payload:{...y?{id:y}:{},...t}}),localStorage.setItem(`${x}_updated`,new Date().toISOString())};e?t?await n():await w.run(n):C=setTimeout(()=>{w.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Oe=n.querySelector(`.pm-asist-actions-fixed`);if(Oe){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),y&&(e.disabled=!0,e.innerHTML=`⏳...`,await Be(y),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Oe.querySelector(`#btn-guardar`);Oe.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),f&&(n.disabled=!0,n.innerHTML=`⏳...`,await Re(f,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Oe.insertBefore(n,t)}n.querySelector(`#btn-guardar`).onclick=async()=>{let e=n.querySelector(`#btn-guardar`),r=e.textContent;e.textContent=`Guardando...`,e.disabled=!0,await w.run(async()=>{try{let r=s.filter(e=>c[e.id]).map(e=>({clase_id:f,alumno_id:e.id,fecha:d,estado:c[e.id],registrado_por:u.id})),i=r.length>0,o=S&&S.trim().length>0;if(!i&&!o)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await De(!0,!0),!y){let{data:e}=await j.from(`sesiones_clase`).select(`id`).eq(`clase_id`,f).eq(`maestro_id`,u.id).eq(`fecha`,d).maybeSingle();e&&(y=e.id)}if(i)try{let e=r.map(e=>({...e,...y&&{sesion_clase_id:y}}));await t(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!y){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of r)await ue({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:f,alumno_id:e.alumno_id,fecha:d,estado:e.estado,registrado_por:u.id,...y?{sesion_clase_id:y}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(y&&(i||o)){let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),{error:t}=await j.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await j.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await j.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,y))}T(),Hr(`hoy`),Hr(`calendario`),Hr(`metricas`),ma().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(y){let{academicService:t}=await xe(async()=>{let{academicService:e}=await import(`./academicService-DX1WEsMf.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await xe(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DyEVGrEb.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await t.processSessionClosure(y);i&&i.length>0?(e.textContent=`¡Logros detectados!`,e.style.background=`var(--pm-success)`,await r(n,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);e.textContent=`✓ Guardado`,e.style.background=`var(--apple-success)`;let l=Oe?.querySelector(`#btn-reporte-dia`);l&&(l.style.display=``);let p=Oe?.querySelector(`#btn-resumen-mes`);p&&(p.style.display=``);let m=Object.values(c).filter(e=>e===`P`).length,h=Object.values(c).filter(e=>e===`A`).length;Tt(`Sesión guardada exitosamente. ${m} presentes, ${h} ausentes.`);let g=document.createElement(`div`);g.className=`pm-saved-overlay`,g.innerHTML=`
      ...
      `,document.body.appendChild(g);let _=g.querySelector(`#btn-resumen-pedagogico`),v=g.querySelector(`#btn-editar-asistencia`),b=g.querySelector(`#btn-compartir-correo`),x=g.querySelector(`#btn-compartir-whatsapp`),C=g.querySelector(`#btn-volver-hoy`),w=g.querySelector(`#btn-ir-calendario`),E=hi();_&&(_.onclick=()=>{E.open({sesionId:y,claseNombre:a?.nombre||`Clase`,fecha:d,supabase:j})}),v&&(v.onclick=()=>{g.remove(),e.textContent=`Guardar sesión`,e.style.background=``,e.disabled=!1,e.style.display=``}),b&&(b.onclick=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${a?.nombre||``} - ${d}`),n=Ie(e,S,s,a);Le(`mailto:?subject=${t}&body=`,n,1800)}),x&&(x.onclick=async()=>{Le(`https://wa.me/?text=`,Ie(s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),S,s,a),1600)}),C&&(C.onclick=()=>{window.location.hash=`#/hoy`}),w&&(w.onclick=()=>{window.location.hash=`#/calendario`});let D=g.querySelector(`#btn-reporte-dia-overlay`);D&&(D.onclick=async()=>{D.disabled=!0,D.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`,await Be(y),D.disabled=!1,D.innerHTML=`<i class="bi bi-file-earmark-pdf"></i> Reporte del día (PDF)`});let O=g.querySelector(`#btn-resumen-mes-overlay`);O&&(O.onclick=async()=>{O.disabled=!0,O.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;let e=new Date;await Re(f,e.getFullYear(),e.getMonth()+1),O.disabled=!1,O.innerHTML=`<i class="bi bi-bar-chart-line"></i> Resumen del mes (PDF)`});let k=g.querySelector(`#btn-informe-ped-overlay`);k&&(k.onclick=async()=>{k.disabled=!0,k.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;let e=new Date;await ze(f,e.getFullYear(),e.getMonth()+1),k.disabled=!1,k.innerHTML=`<i class="bi bi-mortarboard"></i> Informe pedagógico (PDF)`})}catch(t){console.error(`Error al guardar sesión:`,t),e.textContent=t.message||`Error al guardar`,e.style.background=`var(--pm-danger)`,e.disabled=!1,setTimeout(()=>{e.textContent=r,e.style.background=``},3e3)}})};function ke(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Pe(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function Ie(e,t,n,r){if(!r)return`No hay datos de clase disponibles.`;let i=(e||[]).filter(e=>e.estado===`P`).length,a=(e||[]).filter(e=>e.estado===`A`).length,o=(e||[]).filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return s+=`Fecha: ${d||``}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}function Le(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;P.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}n.querySelector(`#pm-asist-back`).onclick=()=>{Ue.destroy();try{_e.close()}catch{}b.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},n.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{c[e.id]=`P`}),Ce(),Te(),await De(!0),Tt(`Todos los ${s.length} alumnos marcados como presentes.`)},n.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{c[e.id]=`A`}),Ce(),Te(),await De(!0),Tt(`Todos los ${s.length} alumnos marcados como ausentes.`)},Ce();async function Ve(e){try{let{data:t}=await j.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function He(e){if(!e||!ae)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await U.getRouteHierarchy(ae),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Ue=new br(n);Ue.mount();let We=n.querySelector(`#pm-btn-help`);return We&&(We.onclick=()=>Ue.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Ue.destroy();try{_e.close()}catch{}b.forEach(e=>{try{e()}catch{}})}}function Pa(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Fa(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function Ia(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await j.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Fa(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await ue({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var La={async open(){let e=await N(),t=await ve();Ae.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await pe()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await be();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await me()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await fe({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},Ra={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function za(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>Ra[e])}var Ba={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);Ua(n,t),Wa(n,t),Za(n,t),Ga(r),Ka(r,t),qa(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),Ja(r),Ya(r),ao(t),eo(t),oo(),xe(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Xa(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function Ua(e,t){let n=Ce(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Wa(e,t){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ka(e,t){let n=he(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function qa(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ja(e){e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function Ya(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Xa(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await xe(async()=>{let{getPermisos:e}=await import(`./permisoService-CVH_7Qhu.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([8,1,9,3]));Xa(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Za(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Va.map(e=>Qa(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function Qa(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function eo(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{q.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>to(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,ro),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await be();e.success?(q.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await me(),q.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=q.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>La.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>Ba.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await pe();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>io(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>io(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>io(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await xe(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-BPslrDVV.js`);return{ausenciasPanel:e}},__vite__mapDeps([10,3,11,7,5,12,1,13]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>Le.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,$a(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),q.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function to(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=d(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=no();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}q.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await ne(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await j.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let s={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(oe,JSON.stringify(s)),q.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{q.saving=!1,a.disabled=!1,a.innerHTML=o}}function no(){let e={};return Va.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function ro(){Ae.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await re(),window.location.reload(),!0)})}function io(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),q.theme=e}function ao(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function oo(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var so=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=so,document.head.appendChild(e)}async function co(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await U.getClasses(),{data:r}=await j.from(`clases`).select(`id, nombre, instrumento`).eq(`maestro_id`,t.id).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let t=await U.getRouteHierarchy(e);if(!t||t.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let n=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,r=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}var uo=`alumno_plan_entradas`;async function fo(e){let{data:t,error:n}=await j.from(uo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function po(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await j.from(uo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function mo(e){let{error:t}=await j.from(uo).delete().eq(`id`,e);if(t)throw Error(t.message)}var ho={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},go=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],_o=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await fo(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
    ...
    `}_buildEntry(e){let t=ho[e.tipo]||ho.logro,n=new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`});return`
      ...
      <div class="pe-form-overlay">
        <div class="pe-form">
          ...
          <select class="pe-select" id="pe-tipo">
            ${go.map(e=>`
              <option value="${e}" ${e===t?`selected`:``}>${ho[e].icon} ${ho[e].label}</option>
            `).join(``)}
          </select>
...
`).trim():``}var To={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Eo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await j.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await j.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=To[n.estado_cualitativo]??To.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          ...
          <div class="pm-prog-card__timeline">
            ${t.map(e=>{let t=To[e.estado_cualitativo]??To.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=l.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
      ...
      `;return}let{data:a}=await j.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await j.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await j.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await j.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await j.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,g=c.filter(e=>e.estado===`J`).length,v=c.filter(e=>e.estado===`T`).length,y=p>0?Math.round(m/p*100):0,b=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],x=b.length>0?Math.round(b.reduce((e,t)=>e+t.nota,0)/b.length*10)/10:0,S=b.filter(e=>e.nota>=4).length,C=b.length,w=C>0?Math.round(S/C*100):0,T={};c.forEach(e=>{T[e.clase_id]||(T[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(T[e.clase_id][e.estado]=(T[e.clase_id][e.estado]||0)+1,T[e.clase_id].total++)});let E=new Set([...o,...Object.keys(T)]),{data:D}=E.size>0?await j.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...E]):{data:[]},O=new Map((D||[]).map(e=>[e.id,e])),k=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),A=l?.filter(e=>e.observations?.trim())||[],ee=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;ee=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&ee--}let te=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,ne=(r.instrumento_principal||``).toLowerCase(),re=`var(--pm-primary)`;(ne.includes(`violin`)||ne.includes(`cuerda`))&&(re=`#FF3B30`),(ne.includes(`piano`)||ne.includes(`teclado`))&&(re=`#FF9500`),ne.includes(`guitarra`)&&(re=`#5856D6`),(ne.includes(`canto`)||ne.includes(`voz`))&&(re=`#AF52DE`),e.innerHTML=`
        ...
        <div class="pm-zen-hero" style="--accent-gradient: ${re}">
          ...
          <div class="pm-zen-hero__content">
            ...
            <div class="pm-zen-info">
              ...
              <p style="font-size:0.8rem;opacity:0.8;margin-top:4px;">Nivel ${r.nivel_actual||1} • ${ee} años</p>
            </div>
          </div>
        </div>
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-mosaic" style="grid-template-columns: repeat(2, 1fr);">
            ...
            <div class="pm-zen-card pm-glass">
              ...
              ${p>0?`<div style="display:flex;align-items:baseline;gap:0.25rem;">
                     <span class="pm-zen-card__value" style="font-size:1.8rem;color:${y>=75?`var(--pm-success)`:y>=50?`var(--pm-warning)`:`var(--pm-danger)`};line-height:1;">${m}</span>
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-clases-grid">
              ${o.map(e=>{let t=O.get(e);if(!t)return``;let n=T[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null;return`
                  <div class="pm-zen-clase-card pm-glass">
                    ...
                    <p class="pm-zen-clase-inst">${I(t.instrumento||``)}</p>
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${k.map(e=>{let t=O.get(e.clase_id),n=wo(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion" ${c.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${c.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:c.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=O.get(e.clase_id),i=e.estado===`J`?f.get(e.sesion_id):null;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${_(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ie=vo(r.tlf_alumno||r.representante_tlf);if(ie){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var Oo={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},ko={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},Ao={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function jo(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(Oo))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function Mo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await j.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await j.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                  ...
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        ...
                        <div class="pm-node-info">
                          ...
                          <span class="pm-node-status">${Ao[n]}</span>
                        </div>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var zo=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():M(),Bo=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):O(...e),Vo=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):Fo(...e),J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Ho=!1;async function Uo(e,{onTopicSelected:t}={}){if(J={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!zo()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(T(),J.clases=await Bo(!0),!J.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tenés clases asignadas.</p></div>`;return}J.activeClaseId=J.clases[0].id,await Wo(),Go(e),Yo(e),Xo(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function Wo(){J.loading=!0,J.rutaId=await Po(J.activeClaseId),J.rutaId?J.blocks=await Vo(J.rutaId,J.activeClaseId):J.blocks=[],J.loading=!1}function Go(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#ruta-tree-area`);if(!J.rutaId){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;"><i class="bi bi-map fs-1 d-block mb-3"></i>No se encontró ruta publicada para esta clase.</div>`;return}if(J.blocks.length===0){t.innerHTML=`<div style="padding:60px; text-align:center; color:#94a3b8;">La ruta no tiene bloques configurados.</div>`;return}J.blocks.forEach(n=>{let r=document.createElement(`div`);if(t.appendChild(r),Ro(r,{blockId:n.id,blockName:n.nombre,isExpanded:J.expandedBlocks.has(n.id),childCount:n.levels?.length||0,onToggle:t=>{J.expandedBlocks.has(t)?J.expandedBlocks.delete(t):J.expandedBlocks.add(t),Go(e)}}),J.expandedBlocks.has(n.id)){let t=r.querySelector(`.block-section-content`);n.levels.forEach(n=>{t.appendChild(Ko(n,e))})}}),qo(e)}function Ko(e,t){let n=document.createElement(`div`);n.className=`pm-level-row`,n.style.cssText=`
  ...
  `;let r=J.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${Jo(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${Jo(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${Jo(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{J.expandedLevels.has(e.id)?J.expandedLevels.delete(e.id):J.expandedLevels.add(e.id),Go(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),J.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},Go(t)})}),n}function qo(e){let t=e.querySelector(`#ruta-action-panel`);if(!J.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{J.selectedIndicator=null,Go(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Ci({...J.selectedIndicator,indicatorId:J.selectedIndicator.id,claseId:J.activeClaseId}),J.onTopicSelected&&J.onTopicSelected(J.activeClaseId)})}function Jo(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Yo(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{J.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await Wo(),Go(e),Yo(e)})}function Xo(e){Ho||(Ho=!0,Lo.on(`node-covered`,()=>{Wo().then(()=>{Go(e),Yo(e)})}))}var Zo=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function Qo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await j.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${Zo.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function $o(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await F.getStudent(t),r=await F.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await j.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await F.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await F.createAcademicPlan(t,u),await j.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${I(t.message)}</p></div>`}}async function es(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await j.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await F.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await j.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await F.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},ns={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([F.getRouteDetail(t),n?F.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}},Y={maestro:null,permisos:null,clases:[],submitting:!1,checked:!1};async function rs(e){let t=M();if(!t){e.innerHTML=`
      <div class="pm-settings-empty">
        <i class="bi bi-shield-lock"></i>
        <p>No hay sesión activa. Inicia sesión para continuar.</p>
      </div>`;return}Y.maestro=t,Y.submitting=!1;let n=await Ke(t.id);if(Y.permisos=n,Y.checked=!0,!n.puede_registrar_alumnos){is(e,n,t.id);return}try{let e=await O();Y.clases=Array.isArray(e)?e:[]}catch(e){console.warn(`[RegistroAlumno] Error cargando clases:`,e.message),Y.clases=[]}as(e),cs(),us()}function is(e,t,n){let r=t?.solicitudes||[],i=t?.solicitud_actual;e.innerHTML=`
        ...
        <div id="pm-register-action-container">
          ...
          `}
            ...
            <div style="background: rgba(234, 179, 8, 0.1); border: 1px solid rgba(234, 179, 8, 0.3); padding: 0.85rem; border-radius: 10px; display: inline-flex; align-items: center; gap: 8px; color: #eab308; font-weight: 600; font-size: 0.85rem; animation: pm-error-fade-in 0.3s ease;">
              <i class="bi bi-clock-history"></i> Solicitud Pendiente de Aprobación
            </div>`)}catch(t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al solicitar: `+t.message,type:`danger`}})),a.disabled=!1,a.innerHTML=e}})}function as(e){e.innerHTML=`
    <div class="pm-settings pm-fade-in registro-alumno-view" role="main" aria-label="Registro de alumnos">
      <header class="pm-settings-header">
          ...
          <div class="pm-settings-form-grid" style="grid-template-columns: 1fr;">
            <div class="pm-settings-field">
              ...
              <select class="input-apple" id="reg-clase">
                ...
                ${Y.clases.map(e=>`<option value="${I(e.id)}">${I(e.nombre||`Clase sin nombre`)}</option>`).join(``)}
              </select>
    ...
    </style>`}function os(){return{nombre:document.getElementById(`reg-nombre`)?.value.trim(),fechaNac:document.getElementById(`reg-fecha-nac`)?.value,instrumento:document.getElementById(`reg-instrumento`)?.value.trim(),repNombre:document.getElementById(`reg-rep-nombre`)?.value.trim(),repTlf:document.getElementById(`reg-rep-tlf`)?.value.trim(),repCedula:document.getElementById(`reg-rep-cedula`)?.value.trim(),repEmail:document.getElementById(`reg-rep-email`)?.value.trim(),direccion:document.getElementById(`reg-direccion`)?.value.trim(),claseId:document.getElementById(`reg-clase`)?.value}}function ss(e){let t=[];if(e.nombre?e.nombre.length<3?t.push({fieldId:`reg-nombre`,message:`El nombre debe tener al menos 3 caracteres`}):e.nombre.length>100&&t.push({fieldId:`reg-nombre`,message:`El nombre no puede exceder 100 caracteres`}):t.push({fieldId:`reg-nombre`,message:`El nombre del alumno es obligatorio`}),!e.fechaNac)t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento es obligatoria`});else{let n=new Date(e.fechaNac),r=new Date;n>r&&t.push({fieldId:`reg-fecha-nac`,message:`La fecha de nacimiento no puede ser futura`});let i=r.getFullYear()-n.getFullYear();i<3&&t.push({fieldId:`reg-fecha-nac`,message:`El alumno debe tener mínimo 3 años`}),i>100&&t.push({fieldId:`reg-fecha-nac`,message:`Verifica la fecha de nacimiento`})}return e.instrumento?e.instrumento.length>100&&t.push({fieldId:`reg-instrumento`,message:`El instrumento no puede exceder 100 caracteres`}):t.push({fieldId:`reg-instrumento`,message:`El instrumento principal es obligatorio`}),e.repNombre?e.repNombre.length>100&&t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-nombre`,message:`El nombre del representante es obligatorio`}),e.repTlf?e.repTlf.length>20&&t.push({fieldId:`reg-rep-tlf`,message:`El teléfono no puede exceder 20 caracteres`}):t.push({fieldId:`reg-rep-tlf`,message:`El teléfono del representante es obligatorio`}),e.repCedula&&e.repCedula.length>20&&t.push({fieldId:`reg-rep-cedula`,message:`La cédula no puede exceder 20 caracteres`}),e.repEmail&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.repEmail)?e.repEmail.length>100&&t.push({fieldId:`reg-rep-email`,message:`El correo no puede exceder 100 caracteres`}):t.push({fieldId:`reg-rep-email`,message:`El formato del correo electrónico no es válido`})),e.direccion&&e.direccion.length>255&&t.push({fieldId:`reg-direccion`,message:`La dirección no puede exceder 255 caracteres`}),t}function cs(){document.getElementById(`btn-registrar-alumno`)?.addEventListener(`click`,ls),document.getElementById(`btn-cancelar-registro`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Registro cancelado`,type:`info`}})),window.location.hash=`#/hoy`})}async function ls(){if(Y.submitting)return;let e=os(),t=ss(e);if(t.length>0){Ot(document.getElementById(`reg-nombre`)?.closest(`.pm-settings`)||document),t.forEach(e=>{let t=document.getElementById(e.fieldId);t&&Et(t,e.message)});return}if(e.repEmail&&await l(e.repEmail)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El correo del representante ya está registrado en el sistema`,type:`danger`}})),Y.submitting=!1;return}if(e.repCedula&&await u(e.repCedula)){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`La cédula del representante ya está registrada en el sistema`,type:`danger`}})),Y.submitting=!1;return}Y.submitting=!0;let n=document.getElementById(`btn-registrar-alumno`),r=n.innerHTML;n.disabled=!0,n.innerHTML=`<span class="pm-settings-spinner"></span><span>Registrando...</span>`;try{let t=await a({nombre:e.nombre,nombre_completo:e.nombre,fecha_nacimiento:e.fechaNac,instrumento:e.instrumento,instrumento_principal:e.instrumento,representante_nombre:e.repNombre,familiar_nombre:e.repNombre,representante_tlf:d(e.repTlf)||e.repTlf,familiar_telefono:d(e.repTlf)||e.repTlf,representante_cedula:e.repCedula||null,correo_representante:e.repEmail||null,direccion:e.direccion||null,is_active:!0,activo:!0});if(e.claseId)try{let{inscribirAlumno:n}=await xe(async()=>{let{inscribirAlumno:e}=await import(`./clasesApi-CiNtdXkj.js`).then(e=>e.r);return{inscribirAlumno:e}},__vite__mapDeps([16,1,3]));typeof n==`function`&&await n(e.claseId,t.id)}catch(e){console.warn(`[Registro] No se pudo inscribir en clase:`,e.message)}window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Alumno ${e.nombre} registrado exitosamente`,type:`success`}})),document.getElementById(`reg-nombre`).value=``,document.getElementById(`reg-fecha-nac`).value=``,document.getElementById(`reg-instrumento`).value=``,document.getElementById(`reg-rep-nombre`).value=``,document.getElementById(`reg-rep-tlf`).value=``,document.getElementById(`reg-rep-cedula`).value=``,document.getElementById(`reg-rep-email`).value=``,document.getElementById(`reg-direccion`).value=``,document.getElementById(`reg-clase`).value=``}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al registrar: `+e.message,type:`danger`}}))}finally{Y.submitting=!1,n.disabled=!1,n.innerHTML=r}}function us(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}function ds(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function fs(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function ps(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var ms=null,hs=[],gs=new Set;async function _s(e){e.innerHTML=As();let t=M();if(!t){e.innerHTML=js(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await Ke(t.id);if(!n.puede_inscribir_clases){e.innerHTML=ys(n),bs(t.id);return}let[r,a]=await Promise.all([We(t.id),i().catch(()=>[])]);hs=a.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=xs(r),Ds(r),r.length>0&&await Cs(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=js(`bi-exclamation-triangle`,`Error al cargar`,ds(t.message))}}function vs(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function ys(e){return`
    <div class="gcv-root">
  ...
  `}function bs(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Ge(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){P.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function xs(e){return`
    <div class="gcv-root">
      ...
      ${e.length===0?js(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function Ss(e){let t=ds(e.nombre||`Clase sin nombre`),n=ps(e.horarios||[]),r=ds(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function Cs(e,t){ms=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await He(e),a=i.map(e=>e.alumno).filter(Boolean);gs=new Set(i.map(e=>e.alumno_id)),n.innerHTML=ws(r,a,hs.filter(e=>!gs.has(e.id))),Os(e,t)}catch(e){n.innerHTML=js(`bi-exclamation-circle`,`Error al cargar alumnos`,ds(e.message))}}}function ws(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${ds(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>Ts(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>Es(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function Ts(e){let t=ds(e.nombre_completo||e.nombre||`Alumno`),n=ds(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${fs(t)}</div>
  ...
  `}function Es(e){let t=ds(e.nombre_completo||e.nombre||`Alumno`),n=ds(e.instrumento_principal||e.instrumento||``);return`
    <label class="gcv-student-row gcv-student-selectable disponible-item"
           data-alumno-id="${e.id}"
           data-name="${t.toLowerCase()}"
           data-instrumento="${n.toLowerCase()}">
      <input class="gcv-checkbox" type="checkbox" value="${e.id}" />
      <div class="gcv-student-avatar gcv-avatar-primary">${fs(t)}</div>
      <div class="gcv-student-data">
        <span class="gcv-student-name">${t}</span>
        ${n?`<span class="gcv-student-sub"><i class="bi bi-music-note"></i> ${n}</span>`:``}
      </div>
    </label>
  `}function Ds(e){document.getElementById(`gcv-clase-list`)?.addEventListener(`click`,async t=>{let n=t.target.closest(`.gcv-clase-card`);if(!n)return;let r=n.dataset.claseId;r&&r!==ms&&await Cs(r,e)})}function Os(e,t){document.getElementById(`gcv-search`)?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();document.querySelectorAll(`.inscrito-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`}),document.querySelectorAll(`.disponible-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`})}),document.getElementById(`gcv-btn-nuevo`)?.addEventListener(`click`,()=>{document.getElementById(`gcv-new-form`)?.classList.remove(`d-none`),document.getElementById(`gcv-nuevo-nombre`)?.focus()}),document.getElementById(`gcv-btn-cancelar-nuevo`)?.addEventListener(`click`,ks),document.getElementById(`gcv-btn-guardar-nuevo`)?.addEventListener(`click`,async()=>{let n=document.getElementById(`gcv-nuevo-nombre`).value.trim(),r=document.getElementById(`gcv-nuevo-instrumento`).value.trim(),o=document.getElementById(`gcv-nuevo-telefono`).value.trim();if(!n||!r||!o){P.error(`Nombre, instrumento y teléfono son obligatorios`);return}let s=document.getElementById(`gcv-btn-guardar-nuevo`);s.disabled=!0,s.innerHTML=`<span class="gcv-spinner-sm"></span> Guardando...`;try{await Ue(e,(await a({nombre_completo:n,instrumento_principal:r,familiar_telefono:o,activo:!0})).id),P.success(`${n} registrado e inscrito exitosamente`),hs=(await i().catch(()=>hs)).filter(e=>e.activo!==!1&&e.is_active!==!1),await Cs(e,t)}catch(e){P.error(`Error: `+e.message),s.disabled=!1,s.innerHTML=`<i class="bi bi-floppy"></i> Guardar e inscribir`}}),document.getElementById(`gcv-lista-inscritos`)?.addEventListener(`click`,async n=>{let r=n.target.closest(`.desinscribir-btn`);if(!r)return;let i=r.dataset.alumnoId,a=r.closest(`.gcv-student-row`)?.querySelector(`.gcv-student-name`)?.textContent||`este alumno`;if(confirm(`¿Quitar a ${a} de esta clase?`)){r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span>`;try{await Ve(e,i),P.success(`${a} quitado de la clase`),await Cs(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-x"></i>`}}}),document.getElementById(`gcv-btn-inscribir`)?.addEventListener(`click`,async()=>{let n=[...document.querySelectorAll(`#gcv-lista-disponibles .gcv-checkbox:checked`)];if(!n.length){P.error(`Seleccioná al menos un alumno`);return}let r=document.getElementById(`gcv-btn-inscribir`);r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span> Inscribiendo...`;try{for(let t of n)await Ue(e,t.value);P.success(`${n.length} alumno${n.length>1?`s`:``} inscrito${n.length>1?`s`:``} correctamente`),await Cs(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-check"></i> Inscribir seleccionados`}})}function ks(){let e=document.getElementById(`gcv-new-form`);e&&e.classList.add(`d-none`),[`gcv-nuevo-nombre`,`gcv-nuevo-instrumento`,`gcv-nuevo-telefono`].forEach(e=>{let t=document.getElementById(e);t&&(t.value=``)})}function As(){return`
    <div class="gcv-root">
      <div class="gcv-header">
  ...
  `}var Ms=null,Ns=!1,Ps={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};function Fs(e){if(!e)return``;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function Is(e){return e===`alta`?`<i class="bi bi-exclamation-circle-fill" style="color:#ef4444"></i>`:e===`media`?`<i class="bi bi-exclamation-circle-fill" style="color:#f59e0b"></i>`:`<i class="bi bi-info-circle-fill" style="color:#22c55e"></i>`}function Ls(){if(document.getElementById(`admin-ausencias-insights-styles`))return;let e=document.createElement(`style`);e.id=`admin-ausencias-insights-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Rs(e){document.querySelectorAll(`[data-route="admin-ausencias"],[data-route="admin-notificaciones"]`).forEach(t=>{let n=t.querySelector(`.aai-nav-badge`);e>0?(n||(n=document.createElement(`span`),n.className=`aai-nav-badge`,t.appendChild(n)),n.textContent=e>99?`99+`:String(e),n.style.display=`flex`):n&&(n.style.display=`none`)})}function zs(){return Ms||(Ms=document.createElement(`div`),Ms.id=`admin-ausencias-insights`,Ms.setAttribute(`role`,`status`),Ms.setAttribute(`aria-live`,`polite`),document.body.appendChild(Ms),Ms)}function Bs(e){let t=zs(),n=e.length,r=e[0],i=n===1&&r?`
    <div class="aai-preview">
      <div class="aai-preview-row">
        ${Is(r.urgencia)}
        <span>${r.maestros?.nombre_completo??`Maestro`}</span>
        <span class="aai-chip">${Ps[r.tipo_ausencia]??r.tipo_ausencia??`—`}</span>
        <span style="opacity:.7">${Fs(r.fecha_inicio)}${r.fecha_fin&&r.fecha_fin!==r.fecha_inicio?` → `+Fs(r.fecha_fin):``}</span>
      </div>
    </div>
  `:``;t.innerHTML=`
    <div class="aai-row">
  ...
  `,requestAnimationFrame(()=>{t.classList.add(`visible`)}),t.querySelector(`#aai-btn-revisar`)?.addEventListener(`click`,()=>{Vs(),window.router&&window.router.navigate(`admin-ausencias`)}),t.querySelector(`#aai-btn-dismiss`)?.addEventListener(`click`,()=>{Hs()})}function Vs(){Ms&&Ms.classList.remove(`visible`)}function Hs(){Vs();let e=Date.now()+1800*1e3;localStorage.setItem(`admin-ausencias-insights-dismiss`,String(e))}function Us(){let e=localStorage.getItem(`admin-ausencias-insights-dismiss`);return e?Date.now()<Number(e):!1}var Ws={init(){window.adminAusenciasInsights=this,Ls(),zs(),this.evaluate()},async evaluate(){if(!Ns){Ns=!0;try{if((window.router?.currentRoute?.()??``).split(`?`)[0]===`admin-ausencias`){Vs(),Rs((await D())?.length??0);return}if(Us())return;let e=await D();if(Rs(e?.length??0),!e||e.length===0){Vs();return}Bs(e)}catch(e){console.warn(`[adminAusenciasInsights] Error evaluando:`,e),Vs()}finally{Ns=!1}}}},Gs=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var Ks=null;function qs(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var Js={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(Ks=document.createElement(`div`),Ks.innerHTML=`
    ...
    `,document.body.appendChild(Ks),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{va()}),fa(e=>{this.renderList(e)}),ma())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=sa();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tenés notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=Zs(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=Qs(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${Xs(e.tipo)}">
            <i class="bi ${Ys(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${qs(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>ga(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),Js.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>ga(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>ga(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await _a(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),ma()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=Ie(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),ma()},close(){this._trap&&=(this._trap.dispose(),null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function Ys(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function Xs(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function Zs(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function Qs(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}if(m(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}console.log(`[SOI] Initializing professionalization services...`),ct(),it({windowMs:6e4,max:100}),nt({enabled:!1,consent:!1}),dt({debug:!1}),$e({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&P.show(t,n)});var X=!1,$s=null;function ec(e,t=!1){let n=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`}];return n.push({id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}),e?.puede_registrar_alumnos&&n.push({id:`registrar-alumno`,label:`Registrar`,icon:`bi-person-plus`}),e?.puede_inscribir_clases&&n.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),n}var tc=[{id:`admin-alumnos`,label:`Alumnos`,icon:`bi-people-fill`},{id:`admin-programas`,label:`Programas`,icon:`bi-grid-1x2`},{id:`admin-maestros`,label:`Maestros`,icon:`bi-person-badge`},{id:`admin-notificaciones`,label:`Actividad`,icon:`bi-bell-fill`},{id:`admin-ausencias`,label:`Ausencias`,icon:`bi-calendar-x`},{id:`admin-metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}],nc=e=>X?[...tc,...ec(e,!0)]:ec(e,!1),rc=null,ic=null,Z=St();window.router=Z;async function ac(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await j.from(t).insert([i]);if(e)throw console.error(`[SYNC] Error en INSERT ${t}:`,e),e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await j.from(t).update(n).eq(`id`,e);if(r)throw console.error(`[SYNC] Error en UPDATE ${t}:`,r),r}else if(n===`delete`){let{error:e}=await j.from(t).delete().eq(`id`,i.id);if(e)throw console.error(`[SYNC] Error en DELETE ${t}:`,e),e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await j.from(t).select().limit(1);e&&e.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico en _syncWithSupabase:`,e),e}}var oc=null;async function sc(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await le();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function cc(){clearTimeout(oc),oc=setTimeout(async()=>{if(navigator.onLine)try{await ce(ac)}finally{await sc()}},1e3)}window.addEventListener(`online`,cc),window.addEventListener(`offline`,sc);function lc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function uc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=``),n&&(n.style.display=``),r&&(r.style.display=``)}function dc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=(Z.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){console.log(`[Auth] Manteniendo ruta pública:`,n),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),xc(),fc(),Z.setAuthGuard(()=>yt.isAuthenticated(),t),Z.start();return}let r=yc.login;if(r){lc(),r.style.display=`block`,r.innerHTML=``,kt(r,{onSuccess:e=>{e&&e!==`login`?(uc(),Z.navigate(e)):Tc()}});return}e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`,xc(),fc(),Z.setAuthGuard(()=>yt.isAuthenticated(),t),history.replaceState({route:`login`},``,`#/login`),$(`login`)}function fc(){Z.on(`login`,(e,t)=>$(`login`,t)),Z.on(`logout`,(e,t)=>$(`logout`,t)),Z.on(`calendario`,(e,t)=>$(`calendario`,t)),Z.on(`clases`,(e,t)=>$(`clases`,t)),Z.on(`hoy`,(e,t)=>$(`hoy`,t)),Z.on(`asistencia`,(e,t)=>$(`asistencia`,t)),Z.on(`metricas`,(e,t)=>$(`metricas`,t)),Z.on(`perfil`,(e,t)=>$(`perfil`,t)),Z.on(`clase-emergente`,(e,t)=>$(`clase-emergente`,t)),Z.on(`planificacion`,(e,t)=>$(`planificacion`,t)),Z.on(`alumno`,(e,t)=>$(`alumno`,t)),Z.on(`gamificacion`,(e,t)=>$(`gamificacion`,t)),Z.on(`ruta`,(e,t)=>$(`ruta`,t)),Z.on(`crear-clase`,(e,t)=>$(`crear-clase`,t)),Z.on(`ruta-plan-builder`,(e,t)=>$(`ruta-plan-builder`,t)),Z.on(`ruta-semanal`,(e,t)=>$(`ruta-semanal`,t)),Z.on(`ruta-libreria`,(e,t)=>$(`ruta-libreria`,t)),Z.on(`ruta-detalle/:id`,(e,t)=>$(`ruta-detalle`,t)),Z.on(`registrar-alumno`,(e,t)=>$(`registrar-alumno`,t)),Z.on(`gestionar-clases`,(e,t)=>$(`gestionar-clases`,t)),Z.on(`register`,(e,t)=>$(`register`,t)),Z.on(`pending-approval`,(e,t)=>$(`pending-approval`,t)),X?(Z.on(`admin-alumnos`,(e,t)=>$(`admin-alumnos`,t)),Z.on(`admin-programas`,(e,t)=>$(`admin-programas`,t)),Z.on(`admin-maestros`,(e,t)=>$(`admin-maestros`,t)),Z.on(`admin-metricas`,(e,t)=>$(`admin-metricas`,t)),Z.on(`admin-config`,(e,t)=>$(`admin-config`,t)),Z.on(`admin-clases`,(e,t)=>$(`admin-clases`,t)),Z.on(`admin-sesiones`,(e,t)=>$(`admin-sesiones`,t)),Z.on(`admin-aprobacion`,(e,t)=>$(`admin-aprobacion`,t)),Z.on(`admin-ausencias`,(e,t)=>$(`admin-ausencias`,t)),Z.on(`admin-notificaciones`,(e,t)=>$(`admin-notificaciones`,t)),Z.onNotFound(()=>$(`admin-alumnos`))):Z.onNotFound(()=>$(`hoy`))}function pc(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}var mc=pc();window.addEventListener(`resize`,()=>{let e=pc();e!==mc&&(mc=e,document.body.dataset.pmLayout=e)},{passive:!0});function hc(e,t,n){rc=t,ic=n||ic;let r=nc(ic);e.innerHTML=`
  ...
  `,sc();let i=document.getElementById(`pm-theme-toggle-container`);i&&i.appendChild(Gs.createToggleButton());let a=document.getElementById(`pm-footer-nav`);a&&a.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let o=document.getElementById(`pm-sidebar`);o&&o.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)});let s=document.getElementById(`pm-header`),c=document.getElementById(`pm-header-search-input`),l=document.getElementById(`pm-search-toggle-btn`),u=document.getElementById(`pm-search-back-btn`),d=()=>{s?.classList.add(`search-active`),setTimeout(()=>{c?.focus()},50)},f=()=>{s?.classList.remove(`search-active`),c&&(c.value=``),document.getElementById(`pm-header-search-dropdown`)?.remove()};l?.addEventListener(`click`,e=>{e.stopPropagation(),d()}),u?.addEventListener(`click`,e=>{e.stopPropagation(),f()});let p=null,m=null,h=()=>{p?.remove(),p=null},g=e=>{if(h(),!e.length)return;let t=document.createElement(`div`);t.id=`pm-header-search-dropdown`,t.setAttribute(`role`,`listbox`),t.innerHTML=e.map(e=>`
      ...
      </div>`).join(``),document.body.appendChild(t);let n=c.getBoundingClientRect();t.style.cssText=`position:fixed;top:${n.bottom+4}px;left:${Math.max(8,n.left)}px;width:${Math.min(320,window.innerWidth-16)}px;z-index:9999;background:var(--pm-surface);border:1px solid var(--pm-border);border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.18);overflow:hidden;`,p=t,t.querySelectorAll(`.pm-hsd-item`).forEach(e=>{let t=()=>{f(),h(),Z.navigate(`alumno?id=${e.dataset.id}`)};e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})};if(c?.addEventListener(`input`,()=>{let e=c.value.trim();if(clearTimeout(m),e.length<1){h();return}let t=Jt();if(t){let n=e.toLowerCase();g(t.filter(e=>e.nombre_completo?.toLowerCase().includes(n)).slice(0,8).map(e=>({...e,instrumento_principal:e.clases?.join(`, `)||null})));return}m=setTimeout(async()=>{try{let{data:t}=await j.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).ilike(`nombre_completo`,`%${e}%`).limit(8);g(t||[])}catch{h()}},200)}),c?.addEventListener(`keydown`,e=>{e.key===`Escape`&&(f(),h())}),!document.getElementById(`pm-hsd-styles`)){let e=document.createElement(`style`);e.id=`pm-hsd-styles`,e.textContent=`.pm-hsd-item{display:flex;align-items:center;gap:0.625rem;padding:0.75rem 1rem;cursor:pointer;border-bottom:1px solid var(--pm-border);transition:background 0.1s}.pm-hsd-item:last-child{border-bottom:none}.pm-hsd-item:hover,.pm-hsd-item:focus{background:var(--pm-surface-2);outline:none}.pm-hsd-icon{font-size:1rem;color:var(--pm-primary);flex-shrink:0}.pm-hsd-info{flex:1;min-width:0}.pm-hsd-name{display:block;font-size:0.875rem;font-weight:500;color:var(--pm-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.pm-hsd-meta{font-size:0.7rem;color:var(--pm-text-muted)}.pm-hsd-arrow{color:var(--pm-text-muted);font-size:0.75rem}`,document.head.appendChild(e)}document.addEventListener(`click`,e=>{!c?.contains(e.target)&&!p?.contains(e.target)&&h()}),document.getElementById(`pm-sync-indicator`).addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await cc()}),document.getElementById(`pm-bell-btn`)?.addEventListener(`click`,()=>{Js.open()});let _=(Z.currentRoute?.()||`hoy`).split(`?`)[0];vc(_)}var gc=!1;function _c(){if(gc)return;if(gc=!0,fa(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=ya();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),ma(),xa(),!X){$s!==void 0&&$s&&(j.removeChannel($s),$s=null);let e=rc;e?.id&&($s=j.channel(`permisos-maestro:${e.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${e.id}`},async t=>{console.log(`[Realtime] Permisos actualizados:`,t.new);try{let t=await Ke(e.id),n=document.getElementById(`portal-app`);if(!n)return;let r=[];t.puede_registrar_alumnos&&!ic?.puede_registrar_alumnos&&r.push(`Registrar Alumnos`),t.puede_inscribir_clases&&!ic?.puede_inscribir_clases&&r.push(`Gestionar e Inscribir Clases`);let i=[];ic?.puede_registrar_alumnos&&!t.puede_registrar_alumnos&&i.push(`Registrar Alumnos`),ic?.puede_inscribir_clases&&!t.puede_inscribir_clases&&i.push(`Gestionar e Inscribir Clases`);let a=(Z.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`registrar-alumno`&&!t.puede_registrar_alumnos||a===`gestionar-clases`&&!t.puede_inscribir_clases?`hoy`:a;a===`pending-approval`&&r.length>0&&(o=`hoy`),hc(n,e,t),xc(),fc(),Z.setAuthGuard(()=>yt.isAuthenticated(),[`login`,`register`,`pending-approval`]),bc.clear(),await $(o),Z.navigate(o),r.length>0?P.success(`¡Nuevos permisos activados: ${r.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):i.length>0?P.show(`El administrador removió tu acceso a: ${i.join(`, `)}.`,`warning`):P.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>{console.log(`[Realtime] Canal permisos_maestros:`,e)}),window.addEventListener(`beforeunload`,()=>{j.removeChannel(permisosChannel)},{once:!0}))}document.addEventListener(`keydown`,e=>{if(pc()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`)switch(e.key.toLowerCase()){case`h`:Z.navigate(`hoy`),t.length=0;break;case`c`:Z.navigate(`calendario`),t.length=0;break;case`r`:Z.navigate(`ruta`),t.length=0;break;case`m`:Z.navigate(`metricas`),t.length=0;break;case`p`:Z.navigate(`perfil`),t.length=0;break;default:break}t.length>3&&t.splice(0,t.length-2)});let e=null;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{let e=pc();if(e!==mc){mc=e,document.body.dataset.pmLayout=e,hc(document.getElementById(`portal-app`),rc),xc();let t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];vc(t)}},250)},{passive:!0})}function vc(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}var yc={},Q=null,bc=new Set;function xc(){let e=document.getElementById(`pm-view-container`);e&&(e.innerHTML=``,[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`registrar-alumno`,`gestionar-clases`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),yc[t]=n}),X&&[`admin-alumnos`,`admin-programas`,`admin-maestros`,`admin-metricas`,`admin-config`,`admin-clases`,`admin-sesiones`,`admin-aprobacion`,`admin-ausencias`,`admin-notificaciones`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),yc[t]=n}))}async function $(e,t={},{silent:n=!1}={}){let r=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e&&e.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}vc(a),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}let o=yc[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof Q==`function`&&(console.log(`[Router] Ejecutando cleanup de vista anterior...`),Q(),Q=null),Object.values(yc).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),bc.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{switch(a){case`login`:kt(o,{onSuccess:()=>Tc()});break;case`register`:At(o,{onSuccess:()=>Z.navigate(`pending-approval`)});break;case`pending-approval`:jt(o,{onBackToLogin:()=>Z.navigate(`login`)});break;case`logout`:dc(),Sa(),bt().then(()=>window.location.reload());break;case`calendario`:case`clases`:Q=await zt(o);break;case`hoy`:Q=await Mt(o,{onClaseClick:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`asistencia`:Q=await Ma(o,{claseId:i.get(`clase`),fecha:i.get(`fecha`)});break;case`metricas`:Q=Yt(o);break;case`perfil`:Q=Ha(o);break;case`clase-emergente`:Q=Ia(o,{maestroId:rc?.id});break;case`planificacion`:Q=await co(o);break;case`alumno`:Q=Do(o,{alumnoId:i.get(`id`)});break;case`gamificacion`:await Mo(o);break;case`ruta`:await Uo(o,{onTopicSelected:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:Qo(o);break;case`ruta-plan-builder`:$o(o,{alumnoId:i.get(`id`)});break;case`ruta-semanal`:es(o,{alumnoId:i.get(`id`)});break;case`ruta-libreria`:ts.render().then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`ruta-detalle`:ns.render(t).then(e=>{o.innerHTML=``,o.appendChild(e)});break;case`admin-alumnos`:v(o);break;case`admin-programas`:x(o);break;case`admin-maestros`:g(o);break;case`admin-metricas`:k(o);break;case`admin-config`:w(o);break;case`admin-clases`:f?.(o);break;case`admin-sesiones`:break;case`admin-aprobacion`:await y(o),Q=null;break;case`admin-ausencias`:await S(o),Q=null;break;case`admin-notificaciones`:Q=await ee(o);break;case`registrar-alumno`:if(!ic?.puede_registrar_alumnos){Z.navigate(`hoy`);return}rs(o);break;case`gestionar-clases`:if(!ic?.puede_inscribir_clases){Z.navigate(`hoy`);return}Q=await _s(o);break;default:}clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]).has(a)&&bc.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}async function Sc(){if(rc)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[r,i,a]=await Promise.all([O(),O().then(e=>te(e.map(e=>e.id))),O().then(()=>p(rc.id,n,n))]),o=Object.fromEntries(r.map(e=>[e.id,e]));await ge(i.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:o[e.clase_id]?.nombre||`Clase`})),a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}function Cc(){bc.clear()}function wc(e){bc.delete(e)}async function Tc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`),console.log(`[Init] Llamando usePortalAuth.init()...`);let t=await yt.init();console.log(`[Init] Auth completado:`,t?`con maestro`:`sin maestro`),X=t?.es_admin===!0,console.log(`[Init] IS_ADMIN:`,X,`| maestro.es_admin:`,t?.es_admin,`| tipo:`,typeof t?.es_admin);let n=window.router||St(),r=[`login`,`register`,`pending-approval`],i=n.currentRoute().split(`?`)[0],a=r.includes(i);if(!t&&!a){console.log(`[Init] No maestro y ruta privada, mostrando login screen`),dc();return}if(!t&&a){console.log(`[Init] No maestro pero ruta pública detectada:`,i),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),xc(),fc(),Z.setAuthGuard(()=>yt.isAuthenticated(),r),Z.start();return}let o=null;if(!X)try{o=await Ke(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}console.log(`[Init] Renderizando shell...`),hc(e,t,o),console.log(`[Init] Shell renderizado`),X&&Ws.init(),xc(),_c(),Vr(wc,Cc),fc(),Z.setAuthGuard(()=>yt.isAuthenticated(),[`login`,`register`,`pending-approval`]),Z.start(),A().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!bc.has(e)).reduce((e,t)=>e.then(()=>{if(yc[t])return $(t,{},{silent:!0})}),Promise.resolve()),Sc(),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),cc()}window.addEventListener(`error`,e=>{let t=[`useCache`,`WebSocket`,`content.js`],n=e.message||``;if(t.some(e=>n.includes(e))){console.warn(`[Ignored Error]`,n);return}et(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let r=document.getElementById(`portal-app`);r&&(r.innerHTML=`
    ...
    </div>`)}),window.addEventListener(`unhandledrejection`,e=>{et(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`
    <div style="padding:40px; color:#fff; font-family:'Outfit',sans-serif; background:radial-gradient(circle at top right, #1e293b, #0f172a); z-index:9999; position:fixed; top:0; left:0; right:0; bottom:0; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center;">
      <div style="background:rgba(255,255,255,0.05); backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,0.1); border-radius:24px; padding:40px; max-width:600px; width:90%; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
        <div style="width:80px; height:80px; background:rgba(239,68,68,0.1); color:#ef4444; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:40px; margin:0 auto 24px;">
          <i class="bi bi-exclamation-triangle-fill"></i>
    ...
    </div>`)}),Tc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});