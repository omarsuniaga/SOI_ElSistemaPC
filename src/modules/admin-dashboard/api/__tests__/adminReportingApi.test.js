...
describe('adminReportingApi trend functions', () => {
  ...
  it('should generate institution trend report with filling behavior', async () => {
    ...
    analyticsService.getTeacherFillingMetricsPerSession.mockResolvedValueOnce(mockMetrics)
    ...
    expect(analyticsService.getTeacherFillingMetricsPerSession).toHaveBeenCalled()
  })
})
