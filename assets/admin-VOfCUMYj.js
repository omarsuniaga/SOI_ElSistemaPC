const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ausenciaForm-NQ4IT9M8.js","assets/supabase-DJmkTfk1.js","assets/ausenciaHistorial-CbkTMy_Z.js","assets/jspdf.es.min-C6WUHrjo.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CsoeaaUJ.js","assets/typeof-C7CwdyHk.js","assets/jspdf.plugin.autotable-BYntMLuC.js","assets/configView-BH05qUt9.js","assets/pushService-Do3bZQZh.js","assets/maestroAuth-BmUoS2wq.js","assets/importView-BGTx_H7m.js","assets/reportService-BNTcQUH_.js","assets/groqService-CzM57djA.js","assets/AppToast-BOjiJExQ.js"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-tcWNtVWY.js";import{$ as t,A as n,Ct as r,D as i,Et as a,F as o,Ft as s,G as c,H as l,I as u,J as d,K as f,M as p,N as m,O as h,P as g,Q as ee,R as te,S as ne,St as re,Tt as ie,U as ae,W as oe,X as _,Z as se,_ as ce,_t as le,at as ue,b as de,bt as fe,c as pe,ct as me,d as he,dt as ge,et as _e,f as ve,ft as ye,g as be,gt as xe,h as Se,i as Ce,it as we,j as v,k as Te,l as Ee,lt as De,m as Oe,mt as ke,n as Ae,nt as je,o as Me,p as Ne,pt as Pe,q as Fe,r as Ie,rt as Le,s as Re,st as ze,t as Be,tt as Ve,u as He,ut as Ue,v as We,vt as Ge,wt as Ke,x as qe,xt as Je,y as Ye,yt as Xe,z as Ze}from"./adminNotificacionesView-D21n5pSE.js";import{i as y,n as Qe,r as $e,t as et}from"./supabase-DJmkTfk1.js";import{n as tt,r as nt}from"./vendor-BhXhnmkW.js";import{t as b}from"./AppToast-BOjiJExQ.js";import{t as rt}from"./preload-helper-CsoeaaUJ.js";import{t as x}from"./AppModal-DIPPctm9.js";import{n as it}from"./groqService-CzM57djA.js";import{i as at}from"./permisosSupabase-DyHvcCfe.js";import{t as S}from"./router-CcRIuSbB.js";import{t as ot}from"./jspdf.es.min-C6WUHrjo.js";import{t as st}from"./jspdf.plugin.autotable-BYntMLuC.js";import{t as ct}from"./clases-C94TYo1J.js";import{t as lt}from"./sesiones-Dk3BCHe7.js";import{t as ut}from"./cumplimientoMaestrosWidget-DuFFjVW0.js";import{r as dt,t as ft}from"./analyticsFillingBehaviorWidget-BCYa3k4D.js";var pt=`auth-session`;function mt(e,t=!0){let n={access_token:e.access_token,refresh_token:e.refresh_token,user:e.user,expires_at:e.expires_at,persistent:t};(t?localStorage:sessionStorage).setItem(pt,JSON.stringify(n)),t?sessionStorage.removeItem(pt):localStorage.removeItem(pt)}function ht(){let e=localStorage.getItem(pt),t=sessionStorage.getItem(pt),n=e||t;if(!n)return null;try{return JSON.parse(n)}catch{return null}}function gt(){localStorage.removeItem(pt),sessionStorage.removeItem(pt)}function _t(){let e=ht();return!e||!e.expires_at?!1:Date.now()/1e3<e.expires_at-10}var vt=[];async function yt(e,t,n=!1){console.log(`🔑 authManager.login:`,e,`remember:`,n);let{data:r,error:i}=await et(e,t);return console.log(`🔑 login result:`,{data:r,error:i}),i?(console.error(`🔑 login error:`,i),{user:null,session:null,error:i}):(r.session&&mt(r.session,n),{user:r.user,session:r.session,error:null})}async function bt(e,t,n={}){let{data:r,error:i}=await $e(e,t,n);return i?{user:null,session:null,error:i}:{user:r.user,session:r.session,error:null}}async function xt(){let{error:e}=await Qe();return gt(),vt.forEach(e=>e(null)),{error:e}}function St(){return _t()}function Ct(){return ht()?.user||null}var C={user:null,session:null,loading:!0,error:null,listeners:[]};function w(){C.listeners.forEach(e=>e(C))}function wt(e){return C.listeners.push(e),()=>{C.listeners=C.listeners.filter(t=>t!==e)}}async function Tt(e,t,n=!1){if(C.loading=!0,C.error=null,w(),e===`demo@soi.com`&&t===`demo123`){let e={id:`demo-user-id`,email:`demo@soi.com`,user_metadata:{full_name:`Usuario Demo`},role:`admin`},t={user:e,access_token:`demo-token`};return localStorage.setItem(`demo_mode`,`true`),r.isDemoMode=!0,mt(t,n),C.user=e,C.session=t,C.loading=!1,w(),{success:!0,user:e,session:t}}try{let r=await yt(e,t,n),i=r?.error&&(r.error.message||r.error),a=r?.user&&!i;return C.user=a?r.user:null,C.session=a?r.session:null,C.loading=!1,w(),i?{success:!1,error:typeof i==`string`?i:i.message||`Error desconocido`}:{success:a,user:C.user,session:C.session}}catch(e){return C.loading=!1,C.error=e.message,w(),{success:!1,error:e.message}}}async function Et(e,t,n){C.loading=!0,C.error=null,w();try{let r=await bt(e,t,n);C.user=r.user,C.session=r.session,C.loading=!1,w();let i=!r.error&&!!r.user,a=i&&!r.session;return{...r,success:i,needsConfirmation:a,message:a?`Registro exitoso. Tu cuenta está pendiente de aprobación por un administrador.`:void 0}}catch(e){return C.loading=!1,C.error=e.message,w(),{success:!1,error:e.message}}}function Dt(){xt(),localStorage.removeItem(`demo_mode`),r.isDemoMode=!1,C.user=null,C.session=null,C.error=null,w()}function Ot(){return Ct()}function kt(){return C.user?!0:St()}async function At(){let{data:{session:e},error:t}=await y.auth.getSession();return t||!e?(gt(),C.user=null,C.session=null,C.loading=!1,w(),{authenticated:!1}):(mt(e,ht()?.persistent??!0),C.session=e,C.user=e.user,C.loading=!1,w(),{authenticated:!0,user:C.user})}At();var T={subscribe:wt,login:Tt,register:Et,logout:Dt,getUser:Ot,isAuthenticated:kt,notifyListeners:w,refreshAuth:At,getState:()=>({...C})},jt={config:{fontSizeBase:`0.8rem`,fontSizeSmall:`0.7rem`,paddingX:`0.5rem`,paddingY:`0.35rem`,gap:`0.35rem`},styles:`
    /* Compact Tables */
    .table-compact {
      font-size: 0.8rem;
  ...
  `}function Ft(e){let t=document.getElementById(`loginForm`),n=document.getElementById(`loginEmail`),r=document.getElementById(`loginPassword`),i=document.getElementById(`togglePassword`),a=document.getElementById(`linkRegister`);t?.addEventListener(`submit`,async t=>{t.preventDefault();let i=n.value.trim(),a=r.value;await It(i,a,document.getElementById(`rememberMe`)?.checked||!1,e)}),i?.addEventListener(`click`,()=>{let e=r.type===`password`?`text`:`password`;r.type=e,i.innerHTML=e===`password`?`<i class="bi bi-eye"></i>`:`<i class="bi bi-eye-slash"></i>`}),a?.addEventListener(`click`,e=>{e.preventDefault(),S.navigate(`register`)})}async function It(e,t,n,r){if(!e||!t){Rt(`Por favor ingresa email y contraseña`,`error`,r);return}Mt.loading=!0,Lt(!0);try{let i=await T.login(e,t,n);i.success?(Rt(`¡Bienvenido!`,`success`,r),setTimeout(()=>{let e=localStorage.getItem(`intended-route`);localStorage.removeItem(`intended-route`),S.navigate(e||`programas`)},500)):Rt(i.error||`Error al iniciar sesión`,`error`,r)}catch(e){console.error(`Login error:`,e),Rt(`Error de conexión`,`error`,r)}finally{Mt.loading=!1,Lt(!1)}}function Lt(e){let t=document.getElementById(`btnLogin`),n=t?.querySelector(`.btn-text`),r=t?.querySelector(`.btn-loading`);t&&(t.disabled=e,e?(n?.classList.add(`d-none`),r?.classList.remove(`d-none`)):(n?.classList.remove(`d-none`),r?.classList.add(`d-none`)))}function Rt(e,t,n){let r=document.getElementById(`toastContainer`);if(!r)return;let i=e&&typeof e==`object`?e.message||e.error||JSON.stringify(e):String(e||`Error`),a=`
  ...
  `,o=document.createElement(`div`);o.innerHTML=a;let s=o.firstElementChild;r.appendChild(s),new tt(s,{autohide:!0,delay:3e3}).show(),s.addEventListener(`hidden.bs.toast`,()=>{s.remove()})}var zt={loading:!1},Bt=[{test:e=>e.length>=8,message:`Mínimo 8 caracteres`},{test:e=>/[A-Z]/.test(e),message:`Al menos 1 mayúscula`},{test:e=>/[0-9]/.test(e),message:`Al menos 1 número`},{test:e=>/[!@#$%^&*(),.?":{}|<>]/.test(e),message:`Al menos 1 símbolo`}];function Vt(e){jt.injectStyles(),Ht(e),Wt(e)}function Ht(e){e.innerHTML=`
    <div class="auth-page">
      <div class="auth-container">
        <div class="auth-card">
          <div class="auth-header">
  ...
  `,a=document.createElement(`div`);a.innerHTML=i;let o=a.firstElementChild;r.appendChild(o),new tt(o,{autohide:!0,delay:3e3}).show(),o.addEventListener(`hidden.bs.toast`,()=>{o.remove()})}function Zt(e){return e?e.replace(/[&<>]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`})[e]):``}var Qt={loading:!1,error:null};function $t(e){let t=T.getUser();if(!t){e.innerHTML=`
  ...
  `,en(e)}async function en(e){let{renderAusenciaForm:t}=await rt(async()=>{let{renderAusenciaForm:e}=await import(`./ausenciaForm-NQ4IT9M8.js`);return{renderAusenciaForm:e}},__vite__mapDeps([0,1])),{renderAusenciaHistorial:n}=await rt(async()=>{let{renderAusenciaHistorial:e}=await import(`./ausenciaHistorial-CbkTMy_Z.js`);return{renderAusenciaHistorial:e}},__vite__mapDeps([2,1]));document.getElementById(`ausenciaModalBody`).innerHTML=t();let r=e.querySelector(`.card-apple:last-child`);if(r){let e=document.createElement(`div`);e.className=`mt-4`,e.innerHTML=`
      <h6 class="fw-bold mb-3">
        <i class="bi bi-clock-history me-2"></i>Historial de Ausencias
      </h6>
      <div id="ausenciaHistorialContainer"></div>
    `,r.appendChild(e),document.getElementById(`ausenciaHistorialContainer`).innerHTML=n()}e.querySelector(`#btnGuardarDatos`)?.addEventListener(`click`,tn),e.querySelector(`#perfilPasswordForm`)?.addEventListener(`submit`,nn)}async function tn(){let e=document.getElementById(`perfilNombre`).value.trim();if(!e){rn(`El nombre no puede estar vacío`);return}Qt.loading=!0;let t=document.getElementById(`btnGuardarDatos`);t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Guardando...`;try{let{error:t}=await y.auth.updateUser({data:{full_name:e}});if(t)throw t;an(`Datos guardados correctamente`)}catch(e){rn(e.message)}finally{Qt.loading=!1,t.disabled=!1,t.innerHTML=`<i class="bi bi-check-lg me-1"></i>Guardar cambios`}}async function nn(e){e.preventDefault(),document.getElementById(`passwordActual`).value;let t=document.getElementById(`passwordNueva`).value,n=document.getElementById(`passwordConfirmar`).value;if(document.getElementById(`passwordError`),t.length<8){on(`La contraseña debe tener al menos 8 caracteres`);return}if(t!==n){on(`Las contraseñas no coinciden`);return}Qt.loading=!0;let r=document.getElementById(`btnCambiarPassword`);r.disabled=!0,r.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Cambiando...`;try{let{error:e}=await y.auth.updateUser({password:t});if(e)throw e;document.getElementById(`perfilPasswordForm`).reset(),an(`Contraseña cambiada correctamente`)}catch(e){e.message.includes(`same`)?on(`La nueva contraseña debe ser diferente a la actual`):on(e.message)}finally{Qt.loading=!1,r.disabled=!1,r.innerHTML=`<i class="bi bi-key-fill me-1"></i>Cambiar contraseña`}}function rn(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`danger`}}))}function an(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`success`}}))}function on(e){let t=document.getElementById(`passwordError`);t&&(t.textContent=e,t.classList.remove(`d-none`))}function sn(){S.register(`login`,Nt),S.register(`register`,Vt),S.register(`perfil`,$t)}sn();function cn(){S.register(`maestros`,Se)}function ln(){S.register(`programas`,h)}var un=[0,86,179],dn=[255,193,7],fn=[30,30,30],pn=[``,`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`];function E(e,t=`—`){return String(e??``).trim()||t}function mn(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`).map(Number),i=new Date,a=i.getFullYear()-t;return(i.getMonth()+1<n||i.getMonth()+1===n&&i.getDate()<r)&&a--,String(a)}catch{return`—`}}function hn(e){return{cantar:`Cantar`,instrumento:`Instrumento`,ambas:`Ambas`}[e]??E(e)}function gn(e,t,n){let r=e.internal.pageSize.getWidth();e.setFillColor(...un),e.rect(0,0,r,26,`F`),e.setFillColor(...dn),e.rect(0,26,r,2,`F`),e.setTextColor(255,255,255),e.setFontSize(14),e.setFont(`helvetica`,`bold`),e.text(`El Sistema Punta Cana`,14,10),e.setFontSize(10),e.setFont(`helvetica`,`normal`),e.text(t,14,18),e.setFontSize(7.5),e.text(n,14,24),e.setTextColor(...fn)}function _n(e,t,n){let r=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();e.setFillColor(...un),e.rect(0,i-8,r,8,`F`),e.setTextColor(255,255,255),e.setFontSize(6.5);let a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});e.text(`El Sistema Punta Cana — Generado: ${a}`,10,i-3),e.text(`Página ${t} de ${n}`,r-10,i-3,{align:`right`})}function vn(e,t,n){let r=new ot({orientation:`landscape`,unit:`mm`,format:`letter`});r.internal.pageSize.getWidth();let i=`${pn[n]} ${t}`,a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});gn(r,`REPORTE DE INSCRIPCIONES — ${i.toUpperCase()}`,`Generado: ${a} · Total inscritos: ${e.length}`);let o=e.filter(e=>e.tiene_conocimientos_musicales===!0).length,s=e.filter(e=>e.tiene_conocimientos_musicales===!1||e.requiere_iniciacion_musical).length,c=e.filter(e=>e.beneficiario_subsidio_estado===!0).length,l=e.filter(e=>e.familia_monoparental===!0).length,u=e.filter(e=>e.autoriza_fotos_redes===!0).length;st(r,{startY:36,margin:{left:10,right:10},theme:`grid`,head:[[`Total inscritos`,`Con conocimientos`,`Requieren iniciación`,`Beneficiarios subsidio`,`Fam. monoparental`,`Autorizan fotos`]],body:[[e.length,o,s,c,l,u]],headStyles:{fillColor:un,textColor:255,fontStyle:`bold`,fontSize:8,halign:`center`},bodyStyles:{halign:`center`,fontSize:11,fontStyle:`bold`}}),st(r,{startY:r.lastAutoTable.finalY+6,margin:{left:10,right:10},theme:`striped`,head:[[`#`,`Nombre completo`,`Edad`,`Nac.`,`Municipio`,`Representante / Tlf`,`Interés`,`Instrumento`,`Iniciación`,`Pagó 600`]],body:e.map((e,t)=>[t+1,E(e.nombre_completo),mn(e.fecha_nacimiento),E(e.nacionalidad),E(e.municipio_residencia),E(e.representante_nombre)+`
`+E(e.representante_tlf),hn(e.interes_musical),E(e.instrumento_interes),e.requiere_iniciacion_musical?`Sí`:`No`,e.acepta_pago_600?`Sí`:`No`]),headStyles:{fillColor:un,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:42},2:{cellWidth:10,halign:`center`},3:{cellWidth:14},4:{cellWidth:20},5:{cellWidth:42},6:{cellWidth:16},7:{cellWidth:22},8:{cellWidth:15,halign:`center`},9:{cellWidth:14,halign:`center`}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();_n(r,e.pageNumber,t)}}),e.length>0&&(r.addPage(),gn(r,`PERFIL SOCIOCULTURAL — ${i.toUpperCase()}`,`Información motivacional y social de los alumnos inscritos`),st(r,{startY:36,margin:{left:10,right:10},theme:`striped`,head:[[`#`,`Nombre`,`Colegio`,`Grado`,`Padres en vida`,`Monopar.`,`Subsidio`,`¿Por qué se unió?`,`Músico favorito`]],body:e.map((e,t)=>[t+1,E(e.nombre_completo),E(e.centro_estudios),E(e.grado_nivel),e.padres_en_vida===`ambos`?`Ambos`:e.padres_en_vida===`solo_madre`?`Solo madre`:e.padres_en_vida===`solo_padre`?`Solo padre`:e.padres_en_vida===`ninguno`?`Ninguno`:`—`,e.familia_monoparental?`Sí`:`No`,e.beneficiario_subsidio_estado?`Sí`:`No`,E(e.por_que_unirse).slice(0,80)+(E(e.por_que_unirse).length>80?`…`:``),E(e.musico_favorito)]),headStyles:{fillColor:un,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:38},2:{cellWidth:38},3:{cellWidth:16},4:{cellWidth:20},5:{cellWidth:14,halign:`center`},6:{cellWidth:14,halign:`center`},7:{cellWidth:55},8:{cellWidth:28}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();_n(r,e.pageNumber,t)}}));let d=r.internal.getNumberOfPages();for(let e=1;e<=d;e++)r.setPage(e),_n(r,e,d);return r}function yn(e,t,n){vn(e,t,n).save(`reporte-inscripciones-${[``,`enero`,`febrero`,`marzo`,`abril`,`mayo`,`junio`,`julio`,`agosto`,`septiembre`,`octubre`,`noviembre`,`diciembre`][n]}-${t}.pdf`)}function bn(e){return xe.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}function xn(e){let t=e||{};return`<form class="row g-3">
    <div class="col-12">
    ...
    <div class="col-md-4">
      <label class="form-check form-switch">
        ...
        <span class="form-check-label small">Acepta beca RD$4,500</span>
          ...
          </span>`}function jn(e){if(!e.length)return``;let t=e.length,n=e.filter(e=>kn(e).estado===`completa`).length,r=e.filter(e=>kn(e).estado===`incompleta`).length;return`
    <div class="row g-3 mt-1 mb-2">
      ...
      <div class="col-6 col-md-3">
        <div class="card text-center border-warning h-100">
          <div class="card-body py-3">
            <div class="fs-2 fw-bold text-warning-emphasis">${e.filter(e=>kn(e).estado===`casi_completa`).length}</div>
    ...
    </div>`}function Mn(e){if(!e.length)return`<div class="alert alert-info mt-3">
              <i class="bi bi-info-circle me-2"></i>No hay alumnos inscritos en este período.
            </div>`;let t=e.map((e,t)=>{let{porcentaje:n,camposFaltantes:r,estado:i,completados:a,total:o}=kn(e),s=e.representante_tlf||e.madre_tlf_whatsapp||`—`,c=Dn(e.fecha_nacimiento),l=c===null?``:`${c} años`,u=r.length>0?`<div class="d-flex flex-wrap gap-1 mt-1">
    ...
    </div>`}function Nn(e){e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-alumno-id]`);if(!t)return;let n=t.dataset.alumnoId;if(!n)return;let r=t.closest(`#reporte-resultado`)?.querySelector(`#btn-filtrar`);Cn(n,{onSaved:()=>r?.click()})})}async function Pn(e){let t=new Date,n=t.getFullYear(),r=t.getMonth()+1,i=[];async function a(t,n){let r=e.querySelector(`#reporte-resultado`);r&&(r.innerHTML=`
      <div class="text-center py-4">
        <div class="spinner-border text-primary" role="status"></div>
        <p class="mt-2 text-muted">Cargando inscritos de ${wn[n]} ${t}...</p>
      </div>`);try{i=await re(t,n),r&&(r.innerHTML=jn(i)+Mn(i),Nn(r));let a=e.querySelector(`#btn-descargar-pdf`);a&&(a.disabled=i.length===0,a.textContent=i.length>0?`Descargar PDF (${i.length} alumnos)`:`Sin inscritos`)}catch(e){console.error(e),r&&(r.innerHTML=`
    ...
    </div>`,e.querySelector(`#btn-filtrar`)?.addEventListener(`click`,()=>{let[t,i]=(e.querySelector(`#select-mes`)?.value??``).split(`-`).map(Number);t&&i&&(n=t,r=i,a(t,i))}),e.querySelector(`#btn-descargar-pdf`)?.addEventListener(`click`,()=>{try{yn(i,n,r)}catch(e){console.error(`Error generando PDF:`,e),alert(`Error al generar el PDF. Por favor intenta de nuevo.`)}}),a(n,r)}function Fn(e){return{currentStep:1,totalSteps:e,maxReachedStep:e,draft:{},errors:{},submitted:!1}}function In(e,t,n){if(e.currentStep>=e.totalSteps)return e;let r={...e.draft,...t};if(n){let{valid:t,errors:i}=n(r);if(!t)return{...e,draft:r,errors:i||{}}}let i=e.currentStep+1;return{...e,draft:r,errors:{},currentStep:i,maxReachedStep:Math.max(e.maxReachedStep,i)}}function Ln(e){return e.currentStep<=1?{...e,errors:{}}:{...e,currentStep:e.currentStep-1,errors:{}}}function Rn(e,t){return t<1||t>e.maxReachedStep?e:{...e,currentStep:t,errors:{}}}function zn(e){return{...e,submitted:!0}}var Bn=`wizard-inscripcion-draft`;function Vn(e){localStorage.setItem(Bn,JSON.stringify(e))}function Hn(){let e=localStorage.getItem(Bn);if(e===null)return null;try{return JSON.parse(e)}catch{return null}}function Un(){localStorage.removeItem(Bn)}function Wn({currentStep:e,totalSteps:t}){let n=Math.round(e/t*100);return`
    <div class="progress mb-3" role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="100" aria-label="Progreso del formulario">
      <div class="progress-bar" style="width: ${n}%">${n}%</div>
    </div>`}function Gn({steps:e,currentStep:t,maxReachedStep:n}){return`<ul class="nav nav-pills nav-fill mb-3 flex-wrap">${e.map((e,r)=>{let i=r+1,a=i===t,o=i<=n,s=a?`active`:``,c=o?``:`disabled aria-disabled="true"`;return`
        ...
        </li>`}).join(``)}</ul>`}var Kn=`system_config`;async function qn(e){let{data:t,error:n}=await y.from(Kn).select(`value`).eq(`key`,e).single();return n?(console.warn(`Config not found:`,e),null):t?.value}async function Jn(e,t){let{error:n}=await y.from(Kn).upsert({key:e,value:t,updated_at:new Date().toISOString()},{onConflict:`key`});if(n)throw console.error(`Error saving config:`,n),n;return{key:e,value:t}}async function Yn(){return qn(`groq_api_key`)}async function Xn(e){return Jn(`groq_api_key`,e)}async function Zn(){return qn(`openrouter_api_key`)}async function Qn(e){return Jn(`openrouter_api_key`,e)}async function $n(){return qn(`preferred_ai_model`)}async function er(e){return Jn(`preferred_ai_model`,e)}var tr={URL_REGLAMENTO:`url_reglamento`,URL_HORARIO:`url_horario`,URL_BIENVENIDA:`url_bienvenida`};async function nr(){let[e,t,n]=await Promise.all([qn(tr.URL_REGLAMENTO),qn(tr.URL_HORARIO),qn(tr.URL_BIENVENIDA)]);return{reglamento:e,horario:t,bienvenida:n}}async function rr({reglamento:e,horario:t,bienvenida:n}){let r=[];e!==void 0&&r.push(Jn(tr.URL_REGLAMENTO,e)),t!==void 0&&r.push(Jn(tr.URL_HORARIO,t)),n!==void 0&&r.push(Jn(tr.URL_BIENVENIDA,n)),await Promise.all(r)}var D={azul:[20,60,130],azulMedio:[40,90,170],azulClaro:[220,232,250],dorado:[198,160,20],doradoClaro:[255,245,200],blanco:[255,255,255],grisOscuro:[40,40,40],grisMedio:[100,100,100],grisClaro:[245,245,248],rojo:[180,20,20],verde:[20,120,60]},ir={id:`demo-0001-uuid`,nombre_completo:`María Gabriela Rodríguez Pérez`,fecha_nacimiento:`2013-06-15`,genero:`F`,nacionalidad:`Dominicana`,tiene_pasaporte:!1,sabe_leer:!0,sabe_escribir:!0,tlf_alumno:`8091234567`,como_se_entero:`Redes sociales`,municipio_residencia:`bavaro`,sector_calle_numero:`Bávaro, Calle Los Corales #12`,direccion:`Sector Los Corales, Bávaro, La Altagracia`,ubicacion_maps_url:`https://maps.google.com`,madre_nombre:`Carmen Pérez de Rodríguez`,madre_cedula:`001-1234567-8`,madre_tlf_whatsapp:`8097654321`,padre_nombre:`José Rafael Rodríguez`,padre_cedula:`001-9876543-2`,padre_tlf_whatsapp:`8299876543`,representante_nombre:`Carmen Pérez de Rodríguez`,representante_parentesco:`Madre`,representante_cedula:`001-1234567-8`,representante_tlf:`8097654321`,correo_representante:`carmen.perez@email.com`,otro_responsable_nombre:`José Rafael Rodríguez`,otro_responsable_cedula:`001-9876543-2`,otro_responsable_tlf:`8299876543`,contacto_emergencia_nombre:`Luisa Martínez`,contacto_emergencia_telefono:`8091112222`,beneficiario_subsidio_estado:!1,subsidio_descripcion:null,apoyo_actividades:`Disponible para apoyo en actividades los fines de semana`,instrumento_principal:`Violín`,nivel_actual:`Iniciación`,tiene_conocimientos_musicales:!1,instrumento_previo:null,nivel_lectura_musical:`Ninguno`,interes_musical:`instrumento`,instrumento_interes:`Violín`,sentimiento_musica_clasica:`Me emociona mucho y me parece muy bonita`,sentimiento_aprender_instrumento:`Estoy muy emocionada y quiero aprender rápido`,aspiracion_instrumento:`Llegar a tocar en una orquesta`,musico_favorito:`Beethoven`,preferencia_aprendizaje_musical:`Visual y auditiva`,por_que_unirse:`Siempre soñé con tocar un instrumento y El Sistema me da esa oportunidad`,alergias_descripcion:null,condicion_transmisible_desc:null,alergia_medicamento_desc:null,problemas_conducta:`no`,tiene_alergias:!1,tiene_condicion_transmisible:!1,tiene_alergia_medicamento:!1,centro_estudios:`Colegio San Juan Bosco`,grado_nivel:`5to de Primaria`,padres_en_vida:`ambos`,autoriza_fotos_redes:!0,acepta_beca_4500:!0,acepta_pago_600:!0,fecha_aceptacion_compromisos:new Date().toISOString(),requiere_iniciacion_musical:!0,familia_monoparental:!1};function O(e,t=`—`){return String(e??``).trim()||t}function ar(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}catch{return e}}function or(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`).map(Number),i=new Date,a=i.getFullYear()-t;return(i.getMonth()+1<n||i.getMonth()+1===n&&i.getDate()<r)&&a--,`${a} años`}catch{return`—`}}function k(e){return e===!0||e===`true`||e===`t`?`Sí`:e===!1||e===`false`||e===`f`?`No`:`—`}function sr(e){return{punta_cana:`Punta Cana`,bavaro:`Bávaro`,veron:`Verón`,friusa:`Friusa`,el_cortecito:`El Cortecito`,los_corales:`Los Corales`,otro:`Otro`}[e]??O(e)}function cr(e){return{cantar:`Cantar`,instrumento:`Instrumento`,ambas:`Ambas`}[e]??O(e)}function lr(e){return{ambos:`Ambos`,solo_madre:`Solo madre`,solo_padre:`Solo padre`,ninguno:`Ninguno`}[e]??O(e)}function ur(e){return{no:`Sin problemas`,pocas_veces:`Pocas veces`,si:`Sí presenta`,violento:`Conducta violenta`}[e]??O(e)}function dr(e){return`SOI-PC-${new Date().getFullYear()}-${e.id?e.id.replace(/-/g,``).slice(-8).toUpperCase():Date.now().toString(36).toUpperCase().slice(-8)}`}function fr(){return new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`})}var A=215.9,pr=279.4,j=14;function mr(e,t,n=``){return e.setFillColor(...D.azul),e.rect(0,0,A,32,`F`),e.setFillColor(...D.dorado),e.rect(0,32,A,2.5,`F`),e.setFillColor(...D.dorado),e.rect(0,0,4,34.5,`F`),e.setTextColor(...D.blanco),e.setFont(`helvetica`,`bold`),e.setFontSize(15),e.text(`EL SISTEMA PUNTA CANA`,j+2,13),e.setFont(`helvetica`,`normal`),e.setFontSize(8),e.setTextColor(200,215,240),e.text(`Programa de Formación Musical · República Dominicana`,j+2,20),e.setFont(`helvetica`,`bold`),e.setFontSize(9),e.setTextColor(...D.dorado),e.text(t,A-j,13,{align:`right`}),n&&(e.setFont(`helvetica`,`normal`),e.setFontSize(7.5),e.setTextColor(190,205,230),e.text(n,A-j,20,{align:`right`})),e.setTextColor(...D.grisOscuro),38}function hr(e,t=1){e.setFillColor(...D.azul),e.rect(0,pr-12,A,12,`F`),e.setFillColor(...D.dorado),e.rect(0,pr-12,4,12,`F`),e.setFont(`helvetica`,`normal`),e.setFontSize(6.5),e.setTextColor(...D.blanco),e.text(`El Sistema Punta Cana · Punta Cana, Rep. Dominicana`,j+2,pr-4.5),e.text(`Pág. ${t}`,A-j,pr-4.5,{align:`right`})}function gr(e,t,n,r=D.azul){return e.setFillColor(...r),e.rect(j,n,A-j*2,6.5,`F`),e.setFont(`helvetica`,`bold`),e.setFontSize(8),e.setTextColor(...D.blanco),e.text(t,j+3,n+4.4),e.setTextColor(...D.grisOscuro),n+7.5}function _r(e,t,n,r={}){return st(e,{startY:n,margin:{left:j,right:j},theme:`grid`,styles:{fontSize:7.5,cellPadding:{top:1.2,bottom:1.2,left:2.5,right:2.5},lineColor:[210,215,225],lineWidth:.2,textColor:D.grisOscuro,font:`helvetica`},alternateRowStyles:{fillColor:D.grisClaro},columnStyles:{0:{fontStyle:`bold`,cellWidth:r.labelW??42,fillColor:D.azulClaro,textColor:D.azul},2:{fontStyle:`bold`,cellWidth:r.labelW??42,fillColor:D.azulClaro,textColor:D.azul}},body:t,...r.extra}),e.lastAutoTable.finalY+2.5}function vr(e,t,n,r={}){return st(e,{startY:n,margin:{left:j,right:j},theme:`grid`,styles:{fontSize:7.5,cellPadding:{top:1.2,bottom:1.2,left:2.5,right:2.5},lineColor:[210,215,225],lineWidth:.2,textColor:D.grisOscuro},columnStyles:{0:{fontStyle:`bold`,cellWidth:r.labelW??52,fillColor:D.azulClaro,textColor:D.azul}},body:t,...r.extra}),e.lastAutoTable.finalY+2.5}function yr(e,t,n,r){return hr(e,r-1),e.addPage(),mr(e,t,`Continuación · ${n}`)}function br(e,t,n,r,i,a){return t+n>pr-22?(a.n++,yr(e,r,i,a.n)):t}function xr(e){let t=new ot({unit:`mm`,format:`letter`}),n={n:1},r=`FICHA TÉCNICA DEL ALUMNO`,i=mr(t,r,`Generado: ${fr()}`);t.setFont(`helvetica`,`bold`),t.setFontSize(55),t.setTextColor(235,240,252),t.text(`USO INTERNO`,A/2,pr/2,{align:`center`,angle:45}),t.setTextColor(...D.grisOscuro),t.setFillColor(...D.azulClaro),t.roundedRect(j,i,A-j*2,18,2,2,`F`),t.setFont(`helvetica`,`bold`),t.setFontSize(13),t.setTextColor(...D.azul),t.text(O(e.nombre_completo),j+4,i+7),t.setFont(`helvetica`,`normal`),t.setFontSize(8.5),t.setTextColor(...D.grisMedio);let a=[`Edad: ${or(e.fecha_nacimiento)}`,`F. Nac.: ${ar(e.fecha_nacimiento)}`,`Instrumento: ${O(e.instrumento_principal)}`,`Nivel: ${O(e.nivel_actual)}`].join(`    ·    `);t.text(a,j+4,i+13),t.setTextColor(...D.grisOscuro),i+=22,i=gr(t,`1 · DATOS PERSONALES`,i),i=_r(t,[[`Nombre completo`,O(e.nombre_completo),`Fecha de nacimiento`,ar(e.fecha_nacimiento)],[`Edad`,or(e.fecha_nacimiento),`Nacionalidad`,O(e.nacionalidad)],[`Género`,O(e.genero),`Tiene pasaporte`,k(e.tiene_pasaporte)],[`Sabe leer`,k(e.sabe_leer),`Sabe escribir`,k(e.sabe_escribir)],[`Cómo se enteró`,O(e.como_se_entero),`Municipio`,sr(e.municipio_residencia)],[`Sector / Calle`,O(e.sector_calle_numero),`Teléfono`,O(e.tlf_alumno)]],i),i=vr(t,[[`Dirección completa`,O(e.direccion)],[`Enlace Google Maps`,O(e.ubicacion_maps_url)]],i),i=br(t,i,40,r,e.nombre_completo,n),i=gr(t,`2 · DATOS DE LA MADRE / 3 · DATOS DEL PADRE`,i),i=_r(t,[[`Nombre (Madre)`,O(e.madre_nombre),`Nombre (Padre)`,O(e.padre_nombre)],[`Cédula Madre`,O(e.madre_cedula),`Cédula Padre`,O(e.padre_cedula)],[`WhatsApp Madre`,O(e.madre_tlf_whatsapp),`WhatsApp Padre`,O(e.padre_tlf_whatsapp)]],i),i=br(t,i,60,r,e.nombre_completo,n),i=gr(t,`4 · REPRESENTANTE Y CONTACTOS`,i),i=_r(t,[[`Representante`,O(e.representante_nombre),`Parentesco`,O(e.representante_parentesco)],[`Cédula`,O(e.representante_cedula),`Teléfono`,O(e.representante_tlf)],[`Correo`,O(e.correo_representante),`Fam. monoparen.`,k(e.familia_monoparental)],[`Otro responsable`,O(e.otro_responsable_nombre),`Cédula`,O(e.otro_responsable_cedula)],[`Tlf otro resp.`,O(e.otro_responsable_tlf),``,``],[`Emergencia 1`,O(e.contacto_emergencia_nombre),`Tlf`,O(e.contacto_emergencia_telefono)],[`Emergencia 2`,O(e.contacto_emergencia_2_nombre),`Tlf`,O(e.contacto_emergencia_2_telefono)]],i),i=gr(t,`5 · SITUACIÓN SOCIAL`,i),i=_r(t,[[`Beneficiario subsidio`,k(e.beneficiario_subsidio_estado),`Descripción`,O(e.subsidio_descripcion)],[`Apoyo actividades`,{content:O(e.apoyo_actividades),colSpan:3}]],i,{extra:{columnStyles:{0:{fontStyle:`bold`,cellWidth:42,fillColor:D.azulClaro,textColor:D.azul},2:{fontStyle:`bold`,cellWidth:42,fillColor:D.azulClaro,textColor:D.azul}}}}),i=br(t,i,70,r,e.nombre_completo,n),i=gr(t,`6 · PERFIL MUSICAL`,i,D.dorado),t.setFillColor(...D.doradoClaro),i=_r(t,[[`Conocimientos musicales`,k(e.tiene_conocimientos_musicales),`Instrumento previo`,O(e.instrumento_previo)],[`Nivel lectura musical`,O(e.nivel_lectura_musical),`Interés`,cr(e.interes_musical)],[`Instrumento de interés`,O(e.instrumento_interes),`Requiere iniciación`,k(e.requiere_iniciacion_musical)],[`Músico favorito`,O(e.musico_favorito),`Pref. aprendizaje`,O(e.preferencia_aprendizaje_musical)]],i),i=vr(t,[[`Por qué quiere unirse`,O(e.por_que_unirse)],[`Sentimiento música clásica`,O(e.sentimiento_musica_clasica)],[`Sentimiento al aprender`,O(e.sentimiento_aprender_instrumento)],[`Aspiración con instrumento`,O(e.aspiracion_instrumento)]],i,{labelW:55}),i=br(t,i,50,r,e.nombre_completo,n),i=gr(t,`7 · SALUD Y CONDUCTA`,i,D.rojo),i=_r(t,[[`Tiene alergias`,k(e.tiene_alergias),`Cuáles`,O(e.alergias_descripcion)],[`Cond. transmisible`,k(e.tiene_condicion_transmisible),`Cuál`,O(e.condicion_transmisible_desc)],[`Alergia medicamento`,k(e.tiene_alergia_medicamento),`Cuál`,O(e.alergia_medicamento_desc)],[`Impedimento social`,k(e.impedimento_social),`Conducta`,ur(e.problemas_conducta)]],i),i=gr(t,`8 · DATOS ESCOLARES`,i),i=_r(t,[[`Centro de estudios`,O(e.centro_estudios),`Grado / Nivel`,O(e.grado_nivel)],[`Padres en vida`,lr(e.padres_en_vida),``,``]],i),i=br(t,i,55,r,e.nombre_completo,n),i=gr(t,`9 · COMPROMISOS Y AUTORIZACIONES`,i,D.verde),i=_r(t,[[`Acepta beca RD$4,500`,k(e.acepta_beca_4500),`Acepta pago RD$600/mes`,k(e.acepta_pago_600)],[`Autoriza fotos/redes`,k(e.autoriza_fotos_redes),`Fecha compromisos`,ar(e.fecha_aceptacion_compromisos?.slice(0,10))]],i),i=br(t,i,45,r,e.nombre_completo,n),i+=8,t.setDrawColor(...D.grisMedio),t.setLineWidth(.3),t.line(j,i+18,j+78,i+18),t.setFont(`helvetica`,`bold`),t.setFontSize(7.5),t.setTextColor(...D.grisOscuro),t.text(`Firma del Representante`,j,i+23),t.setFont(`helvetica`,`normal`),t.setFontSize(7),t.setTextColor(...D.grisMedio),t.text(O(e.representante_nombre),j,i+27),t.text(`C.I.: ${O(e.representante_cedula)}`,j,i+31);let o=A/2+8;return t.setDrawColor(...D.grisMedio),t.line(o,i+18,A-j,i+18),t.setFont(`helvetica`,`bold`),t.setFontSize(7.5),t.setTextColor(...D.grisOscuro),t.text(`Encargado Administrativo`,o,i+23),t.setFont(`helvetica`,`normal`),t.setFontSize(7),t.setTextColor(...D.grisMedio),t.text(`El Sistema Punta Cana`,o,i+27),t.text(`Fecha: ${fr()}`,o,i+31),hr(t,n.n),t}function Sr(e,t={}){let n=new ot({unit:`mm`,format:`letter`}),r=dr(e),i=fr(),a=mr(n,`CONSTANCIA DE INSCRIPCIÓN`,`Serie: ${r}`);n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.setTextColor(...D.dorado),n.setDrawColor(...D.dorado),n.setLineWidth(.6),n.roundedRect(A-j-28,36,28,7,1,1,`S`),n.text(`ORIGINAL`,A-j-14,41,{align:`center`}),n.setTextColor(...D.grisOscuro),n.setLineWidth(.2),n.setFont(`helvetica`,`normal`),n.setFontSize(9.5),n.setTextColor(...D.grisMedio),n.text(`Punta Cana, ${i}`,A-j,a,{align:`right`}),a+=8,n.setFont(`helvetica`,`bold`),n.setFontSize(10.5),n.setTextColor(...D.azul),n.text(`A QUIEN PUEDA INTERESAR:`,j,a),a+=10,n.setFont(`helvetica`,`normal`),n.setFontSize(10),n.setTextColor(...D.grisOscuro);let o=O(e.nombre_completo).toUpperCase(),s=O(e.representante_nombre),c=O(e.representante_parentesco);[`Por medio de la presente, El Sistema Punta Cana hace constar que:`,``,`El/La estudiante ${o}, de ${or(e.fecha_nacimiento)}, nacido/a el ${ar(e.fecha_nacimiento)}, de nacionalidad ${O(e.nacionalidad)}, ha sido debidamente inscrito/a en el Programa de Formación Musical de El Sistema Punta Cana, a partir del día ${i}.`,``,e.requiere_iniciacion_musical?`El/La estudiante participará en el programa de iniciación musical, con interés en ${cr(e.interes_musical).toLowerCase()} — instrumento asignado: ${O(e.instrumento_interes)}.`:`El/La estudiante cuenta con conocimientos musicales previos, con interés en ${cr(e.interes_musical).toLowerCase()} — instrumento: ${O(e.instrumento_interes)}.`,``,`El representante, ${s} (${c}), ha aceptado los términos del programa, incluyendo el aporte mensual de RD$600, con pleno conocimiento de que el/la estudiante recibe una beca valorada en RD$4,500 mensuales, la cual se mantendrá mientras demuestre rendimiento, interés y asistencia notable.`].forEach(e=>{if(!e){a+=4;return}let t=n.splitTextToSize(e,A-j*2);n.text(t,j,a),a+=t.length*5.8}),a+=6;let l=[[`bi-credit-card`,`✓  Tarjeta de pagos mensuales`],[`bi-calendar`,`✓  Horario de clases asignado`],[`bi-pencil`,`✓  Lista de útiles: lápiz HB, cuaderno pentagramado, borrador`],[`bi-shirt`,`✓  T-Shirt oficial de El Sistema Punta Cana`]],u=9+l.length*7+12;n.setFillColor(...D.azulClaro),n.setDrawColor(...D.azulMedio),n.setLineWidth(.5),n.roundedRect(j,a,A-j*2,u,3,3,`FD`),n.setFillColor(...D.azul),n.roundedRect(j,a,A-j*2,9,3,3,`F`),n.rect(j,a+5,A-j*2,4,`F`),n.setFont(`helvetica`,`bold`),n.setFontSize(9),n.setTextColor(...D.blanco),n.text(`AL PRESENTAR ESTA CONSTANCIA EN CAJA RECIBIRÁ:`,j+4,a+6.5),a+=13,n.setFont(`helvetica`,`normal`),n.setFontSize(9.5),n.setTextColor(...D.azul),l.forEach(([,e])=>{n.text(e,j+5,a),a+=7}),a+=1,n.setFillColor(...D.rojo),n.roundedRect(j+3,a,A-j*2-6,8,1.5,1.5,`F`),n.setFont(`helvetica`,`bold`),n.setFontSize(8.5),n.setTextColor(...D.blanco),n.text(`PAGO OBLIGATORIO: RD$600 en caja al retirar los materiales`,j+(A-j*2)/2,a+5.2,{align:`center`}),a+=16;let d=[t.horario&&{icon:`📅`,label:`Consultar horario de clases:`,url:t.horario},t.reglamento&&{icon:`📋`,label:`Reglamento / Manual de convivencia:`,url:t.reglamento},t.bienvenida&&{icon:`⭐`,label:`Manual de bienvenida al programa:`,url:t.bienvenida}].filter(Boolean);d.length>0?(n.setFont(`helvetica`,`bold`),n.setFontSize(9),n.setTextColor(...D.azul),n.text(`Recursos digitales para el representante:`,j,a),a+=6,d.forEach(({icon:e,label:t,url:r})=>{n.setFont(`helvetica`,`bold`),n.setFontSize(8.5),n.setTextColor(...D.grisOscuro),n.text(`${e}  ${t}`,j+2,a),a+=5,n.setFont(`helvetica`,`normal`),n.setFontSize(8),n.setTextColor(...D.azulMedio);let i=n.splitTextToSize(r,A-j*2-10);n.textWithLink(i[0],j+6,a,{url:r}),a+=7}),a+=2):(n.setFont(`helvetica`,`italic`),n.setFontSize(8),n.setTextColor(...D.grisMedio),n.text(`Los recursos digitales serán comunicados por el coordinador del programa.`,j,a),a+=8),a>pr-55&&(hr(n,1),n.addPage(),a=mr(n,`CONSTANCIA DE INSCRIPCIÓN (cont.)`,`Serie: ${r}`)),a+=6,n.setDrawColor(...D.grisMedio),n.setLineWidth(.3),n.setTextColor(...D.grisOscuro),n.line(j,a+20,j+80,a+20),n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.text(`Encargado Administrativo`,j,a+25),n.setFont(`helvetica`,`normal`),n.setFontSize(7.5),n.setTextColor(...D.grisMedio),n.text(`El Sistema Punta Cana`,j,a+29),n.text(i,j,a+33);let f=A/2+6;return n.setTextColor(...D.grisOscuro),n.line(f,a+20,A-j,a+20),n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.text(`Firma del Representante`,f,a+25),n.setFont(`helvetica`,`normal`),n.setFontSize(7.5),n.setTextColor(...D.grisMedio),n.text(O(e.representante_nombre),f,a+29),n.text(`C.I.: ${O(e.representante_cedula)}`,f,a+33),n.setFont(`helvetica`,`normal`),n.setFontSize(6.5),n.setTextColor(170,170,170),n.text(`Serie: ${r}`,A-j,pr-15,{align:`right`}),hr(n,1),n}function Cr(e){let t=xr(e),n=(e.nombre_completo??`alumno`).toLowerCase().replace(/\s+/g,`-`);t.save(`ficha-${n}.pdf`)}async function wr(e){let t={};try{t=await nr()}catch{}let n=Sr(e,t),r=(e.nombre_completo??`alumno`).toLowerCase().replace(/\s+/g,`-`);n.save(`constancia-${r}.pdf`)}function Tr(){Cr(ir)}async function Er(){await wr(ir)}var Dr={postulado:[`contactado`,`descartado`],contactado:[`cita_agendada`,`descartado`],cita_agendada:[`documentos_ok`,`no_show`,`descartado`],no_show:[`reprogramado`,`descartado`],reprogramado:[`cita_agendada`,`descartado`],documentos_ok:[`inscrito`,`en_espera`],en_espera:[`cita_agendada`,`descartado`],inscrito:[],descartado:[]},Or={postulado:`Postulado`,contactado:`Contactado`,cita_agendada:`Cita agendada`,documentos_ok:`Documentos OK`,inscrito:`Inscrito`,no_show:`No show`,reprogramado:`Reprogramado`,en_espera:`En espera`,descartado:`Descartado`},kr={postulado:`secondary`,contactado:`info`,cita_agendada:`primary`,documentos_ok:`warning`,inscrito:`success`,no_show:`danger`,reprogramado:`warning`,en_espera:`secondary`,descartado:`dark`};function Ar(e,t){if(!e||!t)return!1;let n=Dr[e];return n?n.includes(t):!1}function jr(e,t,n={}){if(!e)throw Error(`El postulante es requerido para aplicar la transición`);let r=e.estado||`postulado`;if(!Ar(r,t))throw Error(`Transición inválida: no se puede pasar del estado "${r}" al estado "${t}"`);let i={...e,estado:t};return n.fecha_cita!==void 0&&(i.fecha_cita=n.fecha_cita),n.notas_seguimiento!==void 0&&(i.notas_seguimiento?i.notas_seguimiento=`${i.notas_seguimiento}\n${n.notas_seguimiento}`.trim():i.notas_seguimiento=n.notas_seguimiento),n.alumno_id!==void 0&&(i.alumno_id=n.alumno_id),t===`contactado`&&(i.fecha_contacto=new Date().toISOString()),i}async function Mr(e){let{data:t,error:n}=await y.from(`postulantes`).select(`*`).eq(`id`,e).maybeSingle();if(n)throw console.error(`[postuladosSupabase] Error al obtener postulante:`,n),Error(`Error al obtener postulante: ${n.message}`);return t}async function Nr(e,t,n={}){try{let r=await Mr(e);if(!r)throw Error(`Postulante con ID ${e} no encontrado`);let i=r.estado||`postulado`;if(!Ar(i,t))throw Error(`Transición inválida: No se puede pasar de "${i}" a "${t}"`);let a={estado:t};n.fecha_cita!==void 0&&(a.fecha_cita=n.fecha_cita),n.notas_seguimiento!==void 0&&(r.notes||r.notas_seguimiento?a.notas_seguimiento=`${r.notas_seguimiento||r.notes||``}\n${n.notas_seguimiento}`.trim():a.notas_seguimiento=n.notas_seguimiento),n.alumno_id!==void 0&&(a.alumno_id=n.alumno_id),t===`contactado`&&(a.fecha_contacto=new Date().toISOString());let{data:o,error:s}=await y.from(`postulantes`).update(a).eq(`id`,e).select().single();if(s)throw console.error(`[postuladosSupabase] Error en update:`,s),s;return o}catch(e){throw console.error(`[postuladosSupabase] Error al actualizar estado:`,e.message),e}}async function Pr(e,t){try{let n=new Date(e,t-1,1).toISOString(),r=new Date(e,t,1).toISOString(),{data:i,error:a}=await y.from(`postulantes`).select(`*`).gte(`created_at`,n).lt(`created_at`,r).order(`created_at`,{ascending:!1});if(a)throw console.error(`[postuladosSupabase] Error al listar por mes:`,a),a;return i??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarPostulantesPorMes:`,e.message),e}}async function Fr(e,t){try{let{data:n,error:r}=await y.from(`postulantes`).select(`*`).gte(`created_at`,e).lte(`created_at`,t+`T23:59:59.999Z`).order(`created_at`,{ascending:!1});if(r)throw console.error(`[postuladosSupabase] Error al listar por rango:`,r),r;return n??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarPostulantesPorRango:`,e.message),e}}async function Ir(e,t){try{let{data:n,error:r}=await y.from(`postulantes`).select(`*`).gte(`fecha_cita`,e).lte(`fecha_cita`,t).not(`fecha_cita`,`is`,null).order(`fecha_cita`,{ascending:!0});if(r)throw console.error(`[postuladosSupabase] Error al listar citas:`,r),r;return n??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarCitas:`,e.message),e}}async function Lr(e,t=null){try{let n=new Date(e).getTime();if(isNaN(n))throw Error(`Fecha/Hora de cita inválida`);let r=new Date(n-1800*1e3).toISOString(),i=new Date(n+1800*1e3).toISOString(),a=y.from(`postulantes`).select(`id, nombre_completo, fecha_cita`).gte(`fecha_cita`,r).lte(`fecha_cita`,i).not(`fecha_cita`,`is`,null);t&&(a=a.ne(`id`,t));let{data:o,error:s}=await a;if(s)throw console.error(`[postuladosSupabase] Error al verificar conflicto de cita:`,s),s;return(o??[]).length>0}catch(e){throw console.error(`[postuladosSupabase] Error en hayConflictoCita:`,e.message),e}}async function Rr(e,t){try{if(!t||!t.trim())return;let n=await Mr(e);if(!n)throw Error(`Postulante con ID ${e} no encontrado`);let r=n.notas_seguimiento||n.notes||``,i=r?`${r}\n${t}`.trim():t.trim(),{data:a,error:o}=await y.from(`postulantes`).update({notas_seguimiento:i}).eq(`id`,e).select().single();if(o)throw console.error(`[postuladosSupabase] Error al agregar nota:`,o),o;return a}catch(e){throw console.error(`[postuladosSupabase] Error en agregarNota:`,e.message),e}}async function zr(e){try{let{error:t}=await y.from(`postulantes`).delete().eq(`id`,e);if(t)throw console.error(`[postuladosSupabase] Error al eliminar postulante:`,t),t;return!0}catch(e){throw console.error(`[postuladosSupabase] Error en eliminarPostulante:`,e.message),e}}var Br=e({actualizarEstadoPostulante:()=>Nr,agregarNota:()=>Rr,backfillDesdePostulantes:()=>Kr,buscarPostulante:()=>Hr,eliminarPostulante:()=>zr,hayConflictoCita:()=>Lr,listarCitas:()=>Ir,listarPostulantes:()=>Gr,listarPostulantesPorMes:()=>Pr,listarPostulantesPorRango:()=>Fr,obtenerPostulante:()=>Ur,sincronizarPostulantes:()=>Wr});function Vr(e){return(e??``).toLowerCase().replace(/\s+/g,` `).trim()}async function Hr(e){let t=Vr(e);if(!t||t.length<2)return[];let{data:n,error:r}=await y.from(`postulantes`).select(`*`).or(`nombre_completo.ilike.*${t}*,telefono_alumno.ilike.*${t}*,madre_tlf_whatsapp.ilike.*${t}*,padre_tlf_whatsapp.ilike.*${t}*`).limit(20);if(r)throw console.error(`[postulantesSupabase] Error searching:`,r),r;let i=new Set;return(n??[]).filter(e=>{let t=`${e.nombre_completo||``}|${e.correo||``}`;return i.has(t)?!1:(i.add(t),!0)})}async function Ur(e){let{data:t,error:n}=await y.from(`postulantes`).select(`*`).eq(`id`,e).maybeSingle();if(n)throw console.error(`[postulantesSupabase] Error fetching:`,n),n;return t}async function Wr(){let{data:e,error:t}=await y.functions.invoke(`sync-postulantes`,{method:`POST`});if(t){console.error(`[postulantesSupabase] Error syncing:`,t);let e=t.context?.status??0,n=t.context?.body??{},r=Error(n?.error||t.message||`Error al sincronizar`);throw r.status=e,r}return e}async function Gr(){let{data:e,error:t}=await y.from(`postulantes`).select(`*`).order(`created_at`,{ascending:!1});if(t)throw console.error(`[postulantesSupabase] Error listing:`,t),t;return e??[]}async function Kr(e=!1){let{data:t,error:n}=await y.rpc(`backfill_alumnos_desde_postulantes`,{dry_run:e});if(n)throw console.error(`[postulantesSupabase] Error backfilling:`,n.message),Error(`Error al backfillear: ${n.message}`);return{success:!0,data:t??[],dry_run:e}}var qr=[{id:`post-001`,nombre_completo:`Marcos Merone Cocco`,fecha_nacimiento:`2015-08-30`,telefono_alumno:`8295577722`,correo:`elisabetta.cocco@hotmail.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Avenida real norte MC1-10-b`,madre_nombre:`Elisabetta Cocco`,madre_tlf_whatsapp:`8295577722`,padre_nombre:`Esnor Merone`,padre_tlf_whatsapp:``,representante_parentesco:`ambos`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-002`,nombre_completo:`Ana Pérez Guerrero`,fecha_nacimiento:`2017-03-15`,telefono_alumno:`8091112233`,correo:`ana.perez@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Los Robles #45`,madre_nombre:`María Guerrero`,madre_tlf_whatsapp:`8091112233`,padre_nombre:`Juan Pérez`,padre_tlf_whatsapp:`8091112234`,representante_parentesco:`madre`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Fines de semana`,tiene_transporte:!0,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-003`,nombre_completo:`Luis Gómez Rodríguez`,fecha_nacimiento:`2016-11-22`,telefono_alumno:`8297778899`,correo:`luis.gomez@example.com`,nacionalidad:`Venezolana`,sector_calle_numero:`Residencial Punta Cana, Edif 3 Apto 2B`,madre_nombre:`Carmen Rodríguez`,madre_tlf_whatsapp:`8297778899`,padre_nombre:`Pedro Gómez`,padre_tlf_whatsapp:``,representante_parentesco:`madre`,acepta_pago_600:!1,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!1,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-004`,nombre_completo:`María José López`,fecha_nacimiento:`2014-06-10`,telefono_alumno:`8493334455`,correo:`maria.lopez@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Principal #12, Verón`,madre_nombre:`Sofía López`,madre_tlf_whatsapp:`8493334455`,padre_nombre:`Carlos López`,padre_tlf_whatsapp:`8493334456`,representante_parentesco:`ambos`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Tardes después de las 3pm`,tiene_transporte:!0,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-005`,nombre_completo:`Juan García Marte`,fecha_nacimiento:`2018-01-05`,telefono_alumno:`8095556677`,correo:`juan.garcia@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Las Palmas #7, Bavaro`,madre_nombre:`Ana Marte`,madre_tlf_whatsapp:`8095556677`,padre_nombre:`Roberto García`,padre_tlf_whatsapp:``,representante_parentesco:`madre`,acepta_pago_600:!0,autoriza_fotos_redes:!1,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`}],Jr=(e=50)=>new Promise(t=>setTimeout(t,e)),M=[...qr];function Yr(){M=[...qr]}async function Xr(e,t,n={}){await Jr();let r=M.findIndex(t=>t.id===e);if(r===-1)throw Error(`Postulante con ID ${e} no encontrado`);let i=M[r],a=jr(i,t,n);return M[r]=a,a}async function Zr(e,t){return await Jr(),M.filter(n=>{if(!n.created_at)return!1;let r=new Date(n.created_at);return r.getFullYear()===e&&r.getMonth()+1===t})}async function Qr(e,t){await Jr();let n=new Date(e).getTime(),r=new Date(t+`T23:59:59.999Z`).getTime();return M.filter(e=>{if(!e.created_at)return!1;let t=new Date(e.created_at).getTime();return t>=n&&t<=r}).sort((e,t)=>new Date(t.created_at)-new Date(e.created_at))}async function $r(e,t){await Jr();let n=new Date(e).getTime(),r=new Date(t).getTime();return M.filter(e=>{if(!e.fecha_cita)return!1;let t=new Date(e.fecha_cita).getTime();return t>=n&&t<=r}).sort((e,t)=>new Date(e.fecha_cita)-new Date(t.fecha_cita))}async function ei(e,t=null){await Jr();let n=new Date(e).getTime();if(isNaN(n))throw Error(`Fecha/Hora de cita inválida`);return M.some(e=>{if(t&&e.id===t||!e.fecha_cita||e.estado!==`cita_agendada`&&e.estado!==`reprogramado`)return!1;let r=new Date(e.fecha_cita).getTime();return Math.abs(r-n)<=18e5})}async function ti(e,t){await Jr();let n=M.findIndex(t=>t.id===e);if(n===-1)throw Error(`Postulante con ID ${e} no encontrado`);let r=M[n],i=r.notas_seguimiento||r.notes||``,a=i?`${i}\n${t}`.trim():t.trim(),o={...r,notas_seguimiento:a};return M[n]=o,o}async function ni(e){await Jr();let t=M.findIndex(t=>t.id===e);if(t===-1)throw Error(`Postulante con ID ${e} no encontrado`);return M.splice(t,1),!0}var ri=e({actualizarEstadoPostulante:()=>Xr,agregarNota:()=>ti,backfillDesdePostulantes:()=>ui,buscarPostulante:()=>oi,data:()=>M,eliminarPostulante:()=>ni,hayConflictoCita:()=>ei,listarCitas:()=>$r,listarPostulantes:()=>li,listarPostulantesPorMes:()=>Zr,listarPostulantesPorRango:()=>Qr,obtenerPostulante:()=>si,resetMockData:()=>Yr,sincronizarPostulantes:()=>ci}),ii=(e=300)=>new Promise(t=>setTimeout(t,e));function ai(e){return(e??``).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\s+/g,` `).trim()}async function oi(e){await ii();let t=ai(e);return!t||t.length<2?[]:M.filter(e=>{let n=ai(e.nombre_completo),r=ai(e.telefono_alumno),i=ai(e.madre_tlf_whatsapp),a=ai(e.padre_tlf_whatsapp);return n.includes(t)||r.includes(t)||i.includes(t)||a.includes(t)})}async function si(e){return await ii(100),M.find(t=>t.id===e)??null}async function ci(){return await ii(500),{status:`success`,total_rows:M.length,upserted:M.length,errors:0,timestamp:new Date().toISOString(),_mock:!0}}async function li(){return await ii(),[...M]}async function ui(e=!1){await ii(400);let t=M.filter(e=>e.estado!==`inscrito`).map(t=>({alumno_id:`mock-`+t.id,alumno_nombre:t.nombre_completo,postulante_id:t.id,postulante_nombre:t.nombre_completo,match_tipo:`email`,campos_llenados:5,accion:e?`preview`:`updated`}));return e||t.forEach(e=>{let t=M.findIndex(t=>t.id===e.postulante_id);t!==-1&&(M[t]={...M[t],estado:`inscrito`,alumno_id:e.alumno_id})}),{success:!0,data:t,dry_run:e}}var N=()=>r.isDemoMode?ri:Br,di=(...e)=>N().buscarPostulante(...e),fi=(...e)=>N().obtenerPostulante(...e),pi=(...e)=>N().sincronizarPostulantes(...e),mi=(...e)=>N().backfillDesdePostulantes(...e),hi=(...e)=>N().actualizarEstadoPostulante(...e),gi=(...e)=>N().listarPostulantesPorMes(...e),_i=(...e)=>N().listarPostulantesPorRango(...e),vi=(...e)=>N().listarCitas(...e),yi=(...e)=>N().hayConflictoCita(...e),bi=(...e)=>N().agregarNota(...e),xi=(...e)=>N().eliminarPostulante(...e);function Si(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-DO`,{day:`2-digit`,month:`2-digit`,year:`numeric`})}catch{return`—`}}function Ci(e){return e.estado===`inscrito`?`<span class="badge bg-success-subtle text-success-emphasis"><i class="bi bi-check-circle-fill me-1"></i>Inscrito</span>`:`<span class="badge bg-warning-subtle text-warning-emphasis"><i class="bi bi-clock me-1"></i>Pendiente</span>`}function wi(e){return new Promise(t=>{if((()=>{try{return JSON.parse(localStorage.getItem(`wizard-inscripcion-draft`)||`null`)}catch{return null}})()?._postulante_id){t(null);return}let n=`pendiente`;e.innerHTML=`
      <div class="preload-search card shadow-sm mb-4">
        ...
        </div>`;try{let r=await di(e);if(n===`pendiente`&&(r=r.filter(e=>e.estado!==`inscrito`)),!r.length){o.innerHTML=`
            ...
            <div class="d-flex justify-content-between align-items-start gap-2">
              <div class="flex-grow-1 min-w-0">
                ...
                <div class="small text-muted d-flex flex-wrap gap-3">
                  ${r?`<span><i class="bi bi-calendar3 me-1"></i>${Si(r)}</span>`:``}
        ...
        </div>`;try{let t=await mi(e),n=t.data.length,r=t.data.filter(e=>e.campos_llenados>0).length,i=t.data.reduce((e,t)=>e+t.campos_llenados,0);if(e){ee.innerHTML=`
        ...
        <tr>
          ...
          </div>`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t,type:`danger`}}))}finally{d.disabled=!1,d.innerHTML=`<i class="bi bi-check2-circle me-1"></i>Sincronizar ahora`}})})}function Ti({currentStep:e,totalSteps:t,title:n,content:r,canGoPrev:i,canGoNext:a,isLastStep:o,isLastRequiredStep:s,isLastOptionalStep:c,isOptionalStep:l,steps:u,maxReachedStep:d}){return`
    <div class="wizard-inscripcion container-fluid py-3">
      ${Wn({currentStep:e,totalSteps:t})}
      ${Gn({steps:u,currentStep:e,maxReachedStep:d})}
      <div class="card shadow-sm">
        ...
        </div>`,e.querySelector(`#btn-pdf-ficha`)?.addEventListener(`click`,()=>{try{Cr(a)}catch(e){console.error(`Error generando ficha:`,e)}}),e.querySelector(`#btn-pdf-constancia`)?.addEventListener(`click`,()=>{try{wr(a)}catch(e){console.error(`Error generando constancia:`,e)}})}catch{t&&(t.disabled=!1,t.innerHTML=t.dataset.label??`Finalizar`);let n=e.querySelector(`#wizard-step-slot`);if(n){let e=document.createElement(`div`);e.className=`alert alert-danger mt-3`,e.textContent=`Error al guardar. Por favor intenta de nuevo.`,n.after(e)}}}function u(){let t=e.querySelector(`#wiz-btn-prev`),n=e.querySelector(`#wiz-btn-next`),r=e.querySelector(`#wiz-btn-submit`),i=e.querySelector(`#wiz-btn-submit-basic`),a=e.querySelector(`#wiz-btn-draft`);t&&t.addEventListener(`click`,()=>{o=Ln(o),c()}),n&&n.addEventListener(`click`,()=>{let t=s().getState(e);o=In(o,t),Vn(o.draft),c()}),r&&(r.dataset.label=r.textContent,r.addEventListener(`click`,()=>l(r))),i&&(i.dataset.label=i.textContent,i.addEventListener(`click`,()=>l(i))),a&&a.addEventListener(`click`,()=>{let t=s().getState(e);o={...o,draft:{...o.draft,...t}},Vn(o.draft),a.textContent=`¡Guardado!`,setTimeout(()=>{a.innerHTML=`<i class="bi bi-floppy"></i> Guardar borrador`},1500)}),e.querySelectorAll(`[data-step]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=parseInt(t.getAttribute(`data-step`),10),r=s().getState(e);o={...o,draft:{...o.draft,...r}},Vn(o.draft),o=Rn(o,n),c()})})}return wi(e).then(e=>{e&&(o={...o,draft:{...o.draft,...e}}),c()}),{destroy(){e.innerHTML=``}}}function Di(e){return String(e??``).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function P(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function F(e){let{name:t,label:n,type:r=`text`,value:i=``,error:a=``,required:o=!1,placeholder:s=``,hint:c=``,options:l=[],readOnly:u=!1}=e,d=`wiz-${t}`,f=o?`required`:``,p=u?`readonly`:``,m=a?`is-invalid`:``,h=a?`<div class="invalid-feedback">${P(a)}</div>`:``,g=c?`<div class="form-text">${P(c)}</div>`:``;if(r===`select`){let e=l.map(e=>`<option value="${Di(e.value)}"${i===e.value?` selected`:``}>${P(e.label)}</option>`).join(``);return`
      <div class="mb-3">
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="${d}-${Di(e.value)}">${P(e.label)}</label>
        </div>`).join(``);return`
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label for="${d}" class="form-label">${P(n)}${o?` <span class="text-danger">*</span>`:``}</label>
        <textarea id="${d}" name="${t}" class="form-control ${m}" placeholder="${Di(s)}" ${f} ${p} rows="3">${P(i)}</textarea>
        ${h}${g}
      </div>`:`
    <div class="mb-3">
      <label for="${d}" class="form-label">${P(n)}${o?` <span class="text-danger">*</span>`:``}</label>
      ...
      >
      ${h}${g}
    </div>`}var Oi=/^https?:\/\/(www\.)?google\.com\/maps|^https?:\/\/goo\.gl\/maps/;function ki(e){return{valid:Object.keys(e).length===0,errors:e}}function Ai(e){let t={};if((!e.nombre_completo||!e.nombre_completo.trim())&&(t.nombre_completo=`El nombre completo es requerido`),!e.fecha_nacimiento)t.fecha_nacimiento=`La fecha de nacimiento es requerida`;else{let n=new Date(e.fecha_nacimiento);isNaN(n.getTime())?t.fecha_nacimiento=`Fecha de nacimiento inválida`:n>new Date&&(t.fecha_nacimiento=`La fecha de nacimiento no puede ser en el futuro`)}return(!e.nacionalidad||!e.nacionalidad.trim())&&(t.nacionalidad=`La nacionalidad es requerida`),(!e.como_se_entero||!e.como_se_entero.trim())&&(t.como_se_entero=`Este campo es requerido`),(!e.direccion||!e.direccion.trim())&&(t.direccion=`La dirección es requerida`),e.ubicacion_maps_url&&e.ubicacion_maps_url.trim()&&(Oi.test(e.ubicacion_maps_url.trim())||(t.ubicacion_maps_url=`URL debe ser de Google Maps`)),ki(t)}function ji(e,t=new Date){if(!e)throw Error(`fechaNacimiento is required`);let n=new Date(e);if(isNaN(n.getTime()))throw Error(`Invalid date: "${e}"`);if(n>t)throw Error(`fechaNacimiento cannot be in the future`);let r=t.getFullYear()-n.getFullYear(),i=t.getMonth()-n.getMonth(),a=t.getDate()-n.getDate();return(i<0||i===0&&a<0)&&--r,r}var Mi=e({getState:()=>Li,id:()=>Ni,render:()=>Fi,title:()=>Pi,validate:()=>Ii}),Ni=`step1`,Pi=`Datos del Alumno`;function Fi(e,t={}){let n=e.fecha_nacimiento?(()=>{try{return ji(e.fecha_nacimiento)}catch{return``}})():``;return`
    ...
    </form>`}function Hi(e){return{valid:!0,errors:{}}}function Ui(e){let t=e?.querySelector(`#wiz-form-step2`);return t?{madre_nombre:t.querySelector(`[name="madre_nombre"]`)?.value?.trim()??``,madre_cedula:t.querySelector(`[name="madre_cedula"]`)?.value?.trim()??``,madre_tlf_whatsapp:t.querySelector(`[name="madre_tlf_whatsapp"]`)?.value?.trim()??``}:{}}var Wi=e({getState:()=>Yi,id:()=>Gi,render:()=>qi,title:()=>Ki,validate:()=>Ji}),Gi=`step3`,Ki=`Datos del Padre`;function qi(e,t={}){return`
    ...
    </form>`}function Ji(e){return{valid:!0,errors:{}}}function Yi(e){let t=e?.querySelector(`#wiz-form-step3`);return t?{padre_nombre:t.querySelector(`[name="padre_nombre"]`)?.value?.trim()??``,padre_cedula:t.querySelector(`[name="padre_cedula"]`)?.value?.trim()??``,padre_tlf_whatsapp:t.querySelector(`[name="padre_tlf_whatsapp"]`)?.value?.trim()??``}:{}}var Xi=e({getState:()=>ta,id:()=>Zi,render:()=>$i,title:()=>Qi,validate:()=>ea}),Zi=`step4`,Qi=`Representante y Entorno`;function $i(e,t={}){let n=e.beneficiario_subsidio_estado===!0;return`
    ...
    </form>`}function oa(e){let t={};return e.acepta_beca_4500||(t.acepta_beca_4500=`Debe aceptar los términos de la beca para continuar`),e.acepta_pago_600||(t.acepta_pago_600=`Debe comprometerse con el aporte mensual para continuar`),{valid:Object.keys(t).length===0,errors:t}}function sa(e){let t=e?.querySelector(`#wiz-form-step7`);return t?{acepta_beca_4500:t.querySelector(`[name="acepta_beca_4500"]`)?.checked??!1,acepta_pago_600:t.querySelector(`[name="acepta_pago_600"]`)?.checked??!1,autoriza_fotos_redes:t.querySelector(`[name="autoriza_fotos_redes"]`)?.checked??!1}:{}}var ca=e({getState:()=>pa,id:()=>la,render:()=>da,title:()=>ua,validate:()=>fa}),la=`step5`,ua=`Perfil Musical`;function da(e,t={}){let n=e.tiene_conocimientos_musicales===!0;return`
  ...
  `}function ja(e){if(!e)return`?`;let t=e.trim().split(/\s+/);return t.length===1?t[0][0].toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}async function Ma(e,t={}){let r=t.alumnoId||t.id;if(!r){e.innerHTML=`<div class="alert alert-danger m-4">ID de alumno no especificado.</div>`;return}e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height:300px">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando...</span>
      </div>
    </div>
  `;let{data:i,error:a}=await y.from(`alumnos`).select(`*`).eq(`id`,r).single();if(a||!i){e.innerHTML=`<div class="alert alert-danger m-4">Error al cargar el alumno: ${v(a?.message||`No encontrado`)}</div>`;return}let{data:o}=await y.from(`alumnos_clases`).select(`clase_id, clases(id, nombre, dia, hora_inicio)`).eq(`alumno_id`,r).eq(`activo`,!0),s=(o||[]).map(e=>e.clases).filter(Boolean),c=!1,l=!1;function u(){let t=ja(i.nombre_completo),r=n(i.fecha_nacimiento),a=i.activo?`<span class="badge bg-success">Activo</span>`:`<span class="badge bg-secondary">Inactivo</span>`,o=[`personal`,`madre`,`padre`,`representante`,`salud`,`musical`],c=[...o,`clases`,`progreso`,`asistencias`].map((e,t)=>`
      <li class="nav-item" role="presentation">
        <button
    ...
    `).join(``);function l(e){let t=Ea[e];return`
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h6 class="fw-bold text-uppercase text-muted small mb-0">${v(Da[e])}</h6>
              ...
              <div class="d-flex gap-3 align-items-center">
                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    ${r===null?``:`<span class="text-muted small">${v(String(r))} años</span>`}
                    ${i.created_at?`<span class="text-muted small">Inscrito: ${I(p(i.created_at))}</span>`:``}
                  </div>
                </div>
              </div>
              <div class="d-flex gap-2 flex-wrap">
          ...
          <div class="list-group list-group-flush">
            ${t.map(e=>`
              <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-start">
                <div>
                  ${I(e.observaciones)}
                  ${e.fecha?`<div class="text-muted small mt-1">${I(p(e.fecha))}</div>`:``}
                </div>
    ...
    `}async function f(){if(l)return;l=!0;let e=document.getElementById(`asistencias-content`);if(!e)return;let{data:t,error:n}=await y.from(`asistencias`).select(`*`).eq(`alumno_id`,r).order(`fecha`,{ascending:!1}).limit(30);if(n){e.innerHTML=`<div class="alert alert-warning">Error al cargar asistencias: ${v(n.message)}</div>`;return}if(!t||t.length===0){e.innerHTML=`<p class="text-muted fst-italic">Sin registros de asistencia.</p>`;return}let i=0,a=0,o=0;for(let e of t){let t=(e.estado||e.asistio||``).toString().toLowerCase();t===`true`||t===`presente`||t===`1`?i++:t===`justificado`||t===`justified`?o++:a++}let s=t.length,c=s>0?Math.round(i/s*100):0;function u(e){let t=(e.estado||e.asistio||``).toString().toLowerCase();return t===`true`||t===`presente`||t===`1`?`<span class="badge bg-success">Presente</span>`:t===`justificado`||t===`justified`?`<span class="badge bg-warning text-dark">Justificado</span>`:`<span class="badge bg-danger">Ausente</span>`}e.innerHTML=`
      ...
      <div class="row g-2 mb-3">
        ...
        <div class="col-6 col-md-3">
          <div class="card text-center border-0 bg-light">
            <div class="card-body py-2">
              <div class="fs-4 fw-bold text-warning">${v(String(o))}</div>
      ...
      <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
          ...
          <tbody>
            ${t.map(e=>`
              <tr>
                <td class="text-nowrap">${I(e.fecha?p(e.fecha):null)}</td>
                <td>${u(e)}</td>
    ...
    `}let m=null,h=null;function g(){document.getElementById(`btn-toggle-completitud`)?.addEventListener(`click`,e=>{let t=document.getElementById(`completitud-detalle`),n=e.currentTarget,r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.innerHTML=r?`<i class="bi bi-chevron-down"></i> Ver detalle`:`<i class="bi bi-chevron-up"></i> Ocultar`});let t=document.getElementById(`btn-back`);t&&t.addEventListener(`click`,()=>{window.router?.navigate?window.router.navigate(`alumnos`):history.back()});let n=document.getElementById(`btn-ficha-pdf`);n&&n.addEventListener(`click`,async()=>{try{n.disabled=!0,await Cr(i)}catch(e){console.error(`Error generando ficha PDF:`,e)}finally{n.disabled=!1}});let r=document.getElementById(`btn-constancia`);r&&r.addEventListener(`click`,async()=>{try{r.disabled=!0,await wr(i)}catch(e){console.error(`Error generando constancia:`,e)}finally{r.disabled=!1}});let a=document.getElementById(`btn-postulante`);a&&a.addEventListener(`click`,()=>Na(i,e));let o=document.getElementById(`tab-progreso`);o&&o.addEventListener(`shown.bs.tab`,d);let s=document.getElementById(`tab-asistencias`);s&&s.addEventListener(`shown.bs.tab`,f),document.querySelectorAll(`[data-edit-section]`).forEach(e=>{e.addEventListener(`click`,()=>{ee(e.getAttribute(`data-edit-section`))})});let c=document.getElementById(`btn-modal-save`);c&&c.addEventListener(`click`,te)}function ee(e){m=e;let t=Ea[e],n=document.getElementById(`editModalBody`),r=document.getElementById(`editModalLabel`);r&&(r.textContent=`Editar — ${Da[e]}`),n&&(n.innerHTML=`<form id="edit-form">${t.map(e=>Aa(e,i)).join(``)}</form>`);let a=document.getElementById(`editModal`);a&&(h||=new bootstrap.Modal(a),h.show())}async function te(){if(!m)return;let e=Ea[m],t=document.getElementById(`modal-save-spinner`),n=document.getElementById(`btn-modal-save`);t&&t.classList.remove(`d-none`),n&&(n.disabled=!0);let a={};for(let t of e){let e=document.querySelector(`[name="${t.key}"]`);if(e)if(t.type===`checkbox`)a[t.key]=e.checked;else{let n=e.value.trim();a[t.key]=n===``?null:n}}let{error:o}=await y.from(`alumnos`).update(a).eq(`id`,r);if(t&&t.classList.add(`d-none`),n&&(n.disabled=!1),o){alert(`Error al guardar: ${o.message}`);return}Object.assign(i,a);let s=document.getElementById(`fields-${m}`);s&&(s.innerHTML=ka(e,i)),h&&h.hide()}u()}async function Na(e,t){let n=t.querySelector(`#postulante-panel`);if(n){n.innerHTML=`
    <div class="card border-warning shadow-sm mb-4">
      <div class="card-body text-center py-3">
        <div class="spinner-border spinner-border-sm text-warning me-2"></div>
        <span class="small text-muted">Buscando en postulantes...</span>
      </div>
    </div>`;try{let t=await Hr(e.nombre_completo);if(!t||t.length===0){n.innerHTML=`
      ...
      <div class="alert alert-danger d-flex align-items-center gap-2 mb-4">
        ...
        <button class="btn btn-sm btn-outline-secondary ms-auto" id="btn-close-panel"><i class="bi bi-x"></i></button>
      </div>`,n.querySelector(`#btn-close-panel`)?.addEventListener(`click`,()=>n.innerHTML=``)}}}async function Pa(e){e.innerHTML=`
      ...
      <div class="card mt-4 border-0 bg-body-secondary">
        <div class="card-body">
          ...
          <div class="row row-cols-2 row-cols-md-3 g-2 small">
            <div><span class="text-muted">Nombre:</span><br><strong>${ir.nombre_completo}</strong></div>
            <div><span class="text-muted">Nacimiento:</span><br><strong>${ir.fecha_nacimiento}</strong></div>
            <div><span class="text-muted">Instrumento:</span><br><strong>${ir.instrumento_principal}</strong></div>
            <div><span class="text-muted">Representante:</span><br><strong>${ir.representante_nombre}</strong></div>
            <div><span class="text-muted">Municipio:</span><br><strong>${ir.municipio_residencia}</strong></div>
            <div><span class="text-muted">Centro estudios:</span><br><strong>${ir.centro_estudios}</strong></div>
          </div>
    ...
    </div>`,e.querySelector(`#btn-demo-ficha`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Generando...`;try{await Tr()}finally{t.disabled=!1,t.innerHTML=`<i class="bi bi-download me-2"></i>Descargar ficha demo`}}),e.querySelector(`#btn-demo-constancia`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Generando...`;try{await Er()}finally{t.disabled=!1,t.innerHTML=`<i class="bi bi-download me-2"></i>Descargar constancia demo`}})}var Fa=[0,86,179],Ia=[255,193,7],La=[30,30,30];function Ra(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(e=>e.length>0)??`Sin nombre registrado`}function za(e){let t=[];return e.madre_nombre&&e.madre_nombre.trim()&&t.push(`Madre: ${e.madre_nombre.trim()}`),e.padre_nombre&&e.padre_nombre.trim()&&t.push(`Padre: ${e.padre_nombre.trim()}`),e.representante_nombre&&e.representante_nombre.trim()&&t.push(`Rep: ${e.representante_nombre.trim()}`),t.length>0?t.join(`
`):`—`}function Ba(e){let t=[];return e.telefono_alumno&&e.telefono_alumno.trim()&&t.push(`Al: ${e.telefono_alumno.trim()}`),e.madre_tlf_whatsapp&&e.madre_tlf_whatsapp.trim()&&t.push(`Ma: ${e.madre_tlf_whatsapp.trim()}`),e.padre_tlf_whatsapp&&e.padre_tlf_whatsapp.trim()&&t.push(`Pa: ${e.padre_tlf_whatsapp.trim()}`),t.length>0?t.join(`
`):`—`}function Va(e,t,n){let r=e.internal.pageSize.getWidth();e.setFillColor(...Fa),e.rect(0,0,r,26,`F`),e.setFillColor(...Ia),e.rect(0,26,r,2,`F`),e.setTextColor(255,255,255),e.setFontSize(14),e.setFont(`helvetica`,`bold`),e.text(`El Sistema Punta Cana`,14,10),e.setFontSize(10),e.setFont(`helvetica`,`normal`),e.text(t,14,18),e.setFontSize(7.5),e.text(n,14,24),e.setTextColor(...La)}function Ha(e,t,n){let r=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();e.setFillColor(...Fa),e.rect(0,i-8,r,8,`F`),e.setTextColor(255,255,255),e.setFontSize(6.5);let a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});e.text(`El Sistema Punta Cana — Generado: ${a}`,10,i-3),e.text(`Página ${t} de ${n}`,r-10,i-3,{align:`right`})}function Ua(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`})}catch{return`—`}}function Wa(e,t,n){let r=new ot({orientation:`landscape`,unit:`mm`,format:`letter`});Va(r,`LISTADO DE POSTULADOS`,`Rango: ${`${Ua(t)} — ${Ua(n)}`} · Generado: ${new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`})} · Total: ${e.length}`),st(r,{startY:36,margin:{left:8,right:8},theme:`striped`,head:[[`#`,`Nombre del interesado`,`Padres / Representante`,`Teléfonos`,`Correo`,`Fecha`,`Estado`]],body:e.map((e,t)=>[t+1,Ra(e),za(e),Ba(e),e.correo||`—`,Ua(e.fecha_postulacion||e.created_at),Or[e.estado||`postulado`]||e.estado||`—`]),headStyles:{fillColor:Fa,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:8,halign:`center`},1:{cellWidth:48},2:{cellWidth:48},3:{cellWidth:40},4:{cellWidth:50},5:{cellWidth:22,halign:`center`},6:{cellWidth:20,halign:`center`}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();Ha(r,e.pageNumber,t)}});let i=r.internal.getNumberOfPages();for(let e=1;e<=i;e++)r.setPage(e),Ha(r,e,i);return r}function Ga(e,t,n){Wa(e,t,n).save(`postulados-${t}-${n}.pdf`)}function Ka(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-01`}function qa(){let e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,0);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}var L={year:new Date().getFullYear(),month:new Date().getMonth()+1,postulantes:[],filtroEstado:`todos`,cargando:!1,page:1,limit:50,pdfDesde:Ka(),pdfHasta:qa()},Ja=[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`],Ya=/\b(alumno|alumna|puede|asistir|depende|transporte|p[uú]blico|propio|padres|amigos|familiares|punta\s*cana|veron|ver[oó]n|bávaro|bavaro|friusa|cortecito|ciudad|pueblo|municipio|sector|calle|avenida|disponibilidad|extracu|actividades|limitada|posible|haré|hare|cristiano|evang[eé]lico|cat[oó]lico)\b/i;function Xa(e){if(!e||e.length===0)return!1;let t=e.trim();return!(t.length>70||t.includes(`,`)||t.split(/\s+/).length>5||Ya.test(t)||!/[A-ZÁÉÍÓÚÑ]/.test(t)||t.length<4)}function Za(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(e=>Xa(e))??`Sin nombre registrado`}function Qa(e){return[{persona:e.madre_nombre,numero:e.madre_tlf_whatsapp,rol:`Madre`},{persona:e.padre_nombre,numero:e.padre_tlf_whatsapp,rol:`Padre`},{persona:e.representante_nombre,numero:e.representante_tlf||e.telefono_representante,rol:`Representante`},{persona:null,numero:e.telefono_alumno,rol:`Alumno`}].filter(({numero:e})=>{let t=(e??``).trim();return t.length>=7&&!/^(sin definir|no tiene|n\/a)$/i.test(t)}).map(({persona:e,numero:t,rol:n})=>({rol:n,nombre:Xa(e??``)?e.trim():null,numero:t.trim()}))}function $a(e){return Qa(e)[0]?.numero??null}function eo(e){let t=e.replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:e}async function to(e){L.filtroEstado=`todos`,L.page=1,await no(e)}async function no(e){try{L.cargando=!0,ro(e),L.postulantes=(await gi(L.year,L.month)).filter(e=>$a(e)!==null),L.cargando=!1,oo(e)}catch(t){L.cargando=!1,io(e,t.message)}}function ro(e){e.innerHTML=`
  ...
  `,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>to(e))}function ao(e,t){return t===0?``:`
  ...
  `}function oo(e){let t=so();t.sort((e,t)=>{let n=new Date(e.fecha_postulacion||e.created_at);return new Date(t.fecha_postulacion||t.created_at)-n});let n=t.length,r=Math.ceil(n/L.limit)||1;L.page>r&&(L.page=r),L.page<1&&(L.page=1);let i=(L.page-1)*L.limit,a=Math.min(i+L.limit,n),o=t.slice(i,a),s=co();e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4 max-w-7xl mx-auto">
      ...
      <div class="d-flex gap-4 overflow-x-auto border-bottom border-secondary-subtle mb-4 scrollbar-hidden" style="white-space: nowrap;">
        ...
        ${Object.entries(Or).map(([e,t])=>{let n=s[e]||0;return n===0&&L.filtroEstado!==e?``:`
  ...
  `,fo(e)}function so(){return L.filtroEstado===`todos`?[...L.postulantes]:L.postulantes.filter(e=>e.estado===L.filtroEstado)}function co(){let e={};return Object.keys(Or).forEach(t=>e[t]=0),L.postulantes.forEach(t=>{let n=t.estado||`postulado`;e[n]!==void 0&&e[n]++}),e}function lo(){return`
  ...
  `}function uo(e){return`
    <div class="w-100">
      ...
      <div class="d-none d-md-block table-responsive">
        <table class="table align-middle mb-0 border-transparent">
          ...
          <tbody>
            ${e.map(e=>{let t=Qa(e).map(({rol:e,nombre:t,numero:n})=>{let r=`https://wa.me/${n.replace(/\D/g,``)}?text=Hola%2C%20le%20contactamos%20de%20El%20Sistema%20Punta%20Cana.`,i=t?`${t} (${e})`:e;return`<a href="${r}" target="_blank" rel="noopener" class="d-flex align-items-center gap-2 text-decoration-none text-body mb-1" title="${i}">
        <i class="bi bi-whatsapp text-success small"></i>
        <span class="small">${eo(n)}</span>
        <span class="text-body-secondary small fw-light">· ${i}</span>
      </a>`}).join(``),n=e.fecha_postulacion||e.created_at,r=n?new Date(n).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):`-`,i=kr[e.estado||`postulado`],a=Or[e.estado||`postulado`];return`
      <tr class="cursor-pointer" data-id="${e.id}">
        <td class="py-3">
          <div class="fw-medium text-body">${Za(e)}</div>
          ${a?`
        ...
        <td class="text-end pe-2 py-3 align-middle">
          <button class="btn btn-link text-body-secondary p-0 hover-danger btn-delete-postulante" data-id="${e.id}" data-name="${Za(e)}" title="Eliminar">
    ...
    `}).join(``)}
      ...
      <div class="d-block d-md-none">
        ${e.map(e=>{let t=Qa(e).map(({rol:e,nombre:t,numero:n})=>`<a href="${`https://wa.me/${n.replace(/\D/g,``)}?text=Hola%2C%20le%20contactamos%20de%20El%20Sistema%20Punta%20Cana.`}" target="_blank" rel="noopener" class="text-decoration-none text-body me-3 mb-2 d-inline-flex align-items-center gap-1">
        <i class="bi bi-whatsapp text-success"></i> <span class="small fw-medium">${eo(n)}</span>
      </a>`).join(``),n=e.fecha_postulacion||e.created_at,r=n?new Date(n).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`}):`-`,i=kr[e.estado||`postulado`],a=Or[e.estado||`postulado`];return`
      <div class="border-bottom border-secondary-subtle py-3 cursor-pointer" data-id="${e.id}">
        <div class="d-flex justify-content-between align-items-start mb-2">
          <div>
            <div class="fw-semibold text-body fs-6">${Za(e)}</div>
            ${a?`
            <div class="d-flex align-items-center gap-1 mt-1">
              <i class="bi bi-circle-fill text-${i}" style="font-size: 8px;"></i>
              <span class="text-body-secondary small">${a}</span>
  ...
  `}function fo(e){e.querySelectorAll(`.btn-wa-link`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation()})}),document.getElementById(`btn-month-prev`)?.addEventListener(`click`,()=>{L.month--,L.month<1&&(L.month=12,L.year--),L.page=1,no(e)}),document.getElementById(`btn-month-next`)?.addEventListener(`click`,()=>{L.month++,L.month>12&&(L.month=1,L.year++),L.page=1,no(e)}),document.getElementById(`btn-sync`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`btn-sync`),n=document.getElementById(`sync-spinner`),r=document.getElementById(`sync-icon`);try{t.disabled=!0,n.classList.remove(`d-none`),r.classList.add(`d-none`);let i=await pi();alert(`Sincronización exitosa. Registros procesados: ${i.total_rows||i.upserted||0}`),L.page=1,no(e)}catch(e){alert(`Error al sincronizar: ${e.message}`),t.disabled=!1,n.classList.add(`d-none`),r.classList.remove(`d-none`)}}),e.querySelectorAll(`[data-filter]`).forEach(t=>{t.addEventListener(`click`,t=>{L.filtroEstado=t.currentTarget.getAttribute(`data-filter`),L.page=1,oo(e)})}),e.querySelectorAll(`.hover-table-row`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget.getAttribute(`data-id`);S.navigate(`postulado`,{id:t})})}),e.querySelectorAll(`.btn-delete-postulante`).forEach(t=>{t.addEventListener(`click`,async t=>{t.stopPropagation();let n=t.currentTarget,r=n.getAttribute(`data-id`),i=n.getAttribute(`data-name`);if(confirm(`¿Estás seguro de que deseas eliminar permanentemente la postulación de "${i}"?\n\nEsta acción eliminará el registro de la base de datos de forma irreversible.`))try{n.disabled=!0,await xi(r),alert(`Postulación eliminada con éxito`),no(e)}catch(e){alert(`Error al eliminar: ${e.message}`),n.disabled=!1}})}),document.getElementById(`btn-descargar-pdf`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`pdf-desde`)?.value,t=document.getElementById(`pdf-hasta`)?.value,n=document.getElementById(`btn-descargar-pdf`),r=document.getElementById(`pdf-spinner`),i=document.getElementById(`pdf-icon`);if(!e||!t){alert(`Debe seleccionar una fecha de inicio y una fecha de fin.`);return}if(e>t){alert(`La fecha "Desde" no puede ser posterior a la fecha "Hasta".`);return}try{n.disabled=!0,r.classList.remove(`d-none`),i.classList.add(`d-none`);let a=await _i(e,t);if(!a||a.length===0){alert(`No hay postulados registrados en el rango de fechas seleccionado.`);return}Ga(a,e,t)}catch(e){alert(`Error al generar el PDF: ${e.message}`)}finally{n.disabled=!1,r.classList.add(`d-none`),i.classList.remove(`d-none`)}}),document.getElementById(`btn-page-prev`)?.addEventListener(`click`,()=>{L.page>1&&(L.page--,oo(e))}),document.getElementById(`btn-page-next`)?.addEventListener(`click`,()=>{L.page++,oo(e)})}var po=/\b(alumno|alumna|puede|asistir|depende|transporte|p[uú]blico|propio|padres|amigos|familiares|punta\s*cana|veron|ver[oó]n|bávaro|bavaro|friusa|cortecito|ciudad|pueblo|municipio|sector|calle|avenida|disponibilidad|actividades|limitada|posible|haré|hare|cristiano|evang[eé]lico|cat[oó]lico)\b/i,mo=[{id:`cedula_rep`,label:`Cédula del representante`},{id:`partida`,label:`Partida de nacimiento`},{id:`constancia`,label:`Constancia escolar`},{id:`foto`,label:`Foto del alumno`},{id:`docs_medicos`,label:`Documentos médicos (si aplica)`}],ho=[{id:`postulado`,label:`Postulado`,num:1},{id:`contactado`,label:`Contactado`,num:2},{id:`cita_agendada`,label:`Cita agendada`,num:3},{id:`documentos_ok`,label:`Documentos OK`,num:4},{id:`inscrito`,label:`Inscrito`,num:5}],R={postulante:null,cargando:!1};function go(e){if(!e)return!1;let t=e.trim();return t.length>=4&&t.length<=70&&!t.includes(`,`)&&t.split(/\s+/).length<=5&&!po.test(t)&&/[A-ZÁÉÍÓÚÑ]/.test(t)}function _o(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(go)??`Sin nombre registrado`}function vo(e){return{_postulante_id:e.id,nombre_completo:_o(e),fecha_nacimiento:e.fecha_nacimiento||``,nacionalidad:e.nacionalidad||``,tiene_pasaporte:e.tiene_pasaporte??!1,sabe_leer:e.sabe_leer??null,sabe_escribir:e.sabe_escribir??null,genero:e.genero||``,como_se_entero:e.como_se_entero||``,municipio_residencia:e.municipio_residencia||``,sector_calle_numero:e.sector_calle_numero||``,direccion:e.direccion||``,ubicacion_maps_url:e.ubicacion_maps_url||``,madre_nombre:e.madre_nombre||``,madre_cedula:e.madre_cedula||``,madre_tlf_whatsapp:e.madre_tlf_whatsapp||``,padre_nombre:e.padre_nombre||``,padre_cedula:e.padre_cedula||``,padre_tlf_whatsapp:e.padre_tlf_whatsapp||``,representante_nombre:e.representante_nombre||e.madre_nombre||``,representante_parentesco:e.representante_parentesco||``,representante_cedula:e.representante_cedula||``,representante_tlf:e.representante_tlf||e.telefono_representante||e.madre_tlf_whatsapp||``,correo_representante:e.correo||``,beneficiario_subsidio_estado:e.beneficiario_subsidio_estado??!1,acepta_pago_600:e.acepta_pago_600??!1,instrumento_interes:e.instrumento_interes||``,tiene_conocimientos_musicales:e.tiene_conocimientos_musicales??!1,instrumento_previo:e.instrumento_previo||``,nivel_lectura_musical:e.nivel_lectura_musical||``,interes_musical:e.interes_musical||``,por_que_unirse:e.por_que_unirse||``,sentimiento_musica_clasica:e.sentimiento_musica_clasica||``,musico_favorito:e.musico_favorito||``,autoriza_fotos_redes:e.autoriza_fotos_redes??!1}}function yo(e){if(!e)return`Sin definir`;let t=new Date(e);if(isNaN(t.getTime()))return`Sin definir`;let n=new Date,r=n.getFullYear()-t.getFullYear(),i=n.getMonth()-t.getMonth();return(i<0||i===0&&n.getDate()<t.getDate())&&r--,`${r} años`}function bo(e){return e?new Date(e).toLocaleString(`es-ES`,{day:`2-digit`,month:`long`,year:`numeric`,hour:`2-digit`,minute:`2-digit`}):``}function xo(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`long`,year:`numeric`}):`-`}function So(e,t,n){return`https://wa.me/${(e||``).replace(/[^0-9]/g,``)}?text=${encodeURIComponent(`Hola ${t}, le contactamos de *El Sistema Punta Cana*. Hemos recibido la postulación de *${n}* y queremos coordinar el proceso de inscripción. ¿Cuándo podría venir a nuestra sede para la entrevista? 🎵`)}`}function Co(e){return`docs_${e}`}function wo(e){try{let t=localStorage.getItem(Co(e));return t?JSON.parse(t):{}}catch{return{}}}function To(e,t){localStorage.setItem(Co(e),JSON.stringify(t))}async function Eo(e,t){let n=t?.id;if(!n){e.innerHTML=`<div class="alert alert-danger m-4">Error: ID de postulante no provisto.</div>`;return}await Do(e,n)}async function Do(e,t){R.cargando=!0,e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height:400px">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando perfil...</span>
      </div>
    </div>`;try{if(R.postulante=await fi(t),R.cargando=!1,!R.postulante){e.innerHTML=`
        ...
        </div>`,document.getElementById(`btn-error-back`)?.addEventListener(`click`,()=>S.navigate(`postulados`));return}Oo(e)}catch(n){R.cargando=!1,e.innerHTML=`
      <div class="container py-5 text-center">
      ...
      </div>`,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>Do(e,t))}}function Oo(e){let t=R.postulante,n=t.estado||`postulado`,r=_o(t),i=t.representante_nombre||t.madre_nombre||`Representante`,a=kr[n]||`secondary`,o=Or[n]||`Postulado`;e.innerHTML=`
    <div class="container-fluid py-3 px-3 px-md-4">
  ...
  `,Po(e)}function ko(e){let t=[`no_show`,`en_espera`,`descartado`,`reprogramado`].includes(e),n={no_show:2,reprogramado:2,en_espera:3,descartado:-1},r=ho.findIndex(t=>t.id===e);return t&&(r=n[e]??-1),`
    <div class="d-flex align-items-center gap-1 overflow-auto py-1">
      ${ho.map((n,i)=>{let a=i<r,o=i===r&&!t,s=i===r&&t,c=`bg-light border border-secondary text-secondary`,l=`text-secondary`;if(a)c=`bg-success text-white border border-success`,l=`text-success fw-semibold`;else if(o){let e=kr[n.id]||`primary`;c=`bg-${e} text-white border border-${e}`,l=`text-${e} fw-bold`}else if(s){let t=kr[e]||`secondary`;c=`bg-${t} bg-opacity-25 text-${t} border border-${t}`,l=`text-${t} fw-semibold`}let u=i<ho.length-1?`<div class="flex-grow-1 border-top border-secondary-subtle" style="min-width:20px;margin-top:-8px"></div>`:``;return`
          <div class="d-flex flex-column align-items-center" style="min-width:64px">
            ...
            ${s?`<span class="badge bg-${kr[e]} mt-1" style="font-size:.65rem">${Or[e]}</span>`:``}
          </div>
          ${u}`}).join(``)}
    </div>
  `}function Ao(e,t,n,r){let i=kr[t]||`secondary`;switch(t){case`postulado`:return`
        ...
        <div class="card-body px-4 pb-4">
          ...
          <div class="d-flex flex-wrap gap-2 mb-3">
            ${e.madre_tlf_whatsapp?`
              <a href="${So(e.madre_tlf_whatsapp,n,r)}"
                 target="_blank" rel="noopener"
                 class="btn btn-success btn-sm rounded-pill">
                <i class="bi bi-whatsapp me-1"></i> WhatsApp Madre
              </a>`:``}
            ${e.padre_tlf_whatsapp?`
              <a href="${So(e.padre_tlf_whatsapp,n,r)}"
                 target="_blank" rel="noopener"
                 class="btn btn-success btn-sm rounded-pill">
                <i class="bi bi-whatsapp me-1"></i> WhatsApp Padre
              </a>`:``}
        ...
        <div class="card-header bg-${i} bg-opacity-10 border-0 pt-3 pb-0 px-4">
          <h6 class="fw-bold text-${i}"><i class="bi bi-calendar-event me-2"></i>Cita agendada para: ${e.fecha_cita?bo(e.fecha_cita):`Sin fecha registrada`}</h6>
        </div>
        <div class="card-body px-4 pb-4">
...
`).find(e=>e.toLowerCase().includes(`descart`))||``;return`
    ...
    ${t(`Representante`,n)}
    ${t(`Correo`,e.correo)}
    ${t(`Postulado el`,xo(e.created_at))}
  `}function Mo(e){let t=wo(e);return mo.map(e=>`
  ...
  `).join(``)}function No(e){let t=(e.notas_seguimiento||e.notes||``).split(`
`).filter(e=>e.trim());return t.length===0?`<p class="text-muted small fst-italic">Sin notas registradas.</p>`:`
  ...
  `}function Po(e){let t=R.postulante,n=t.id;t.estado,e.querySelector(`#btn-back-list`)?.addEventListener(`click`,()=>{window.router?.navigate(`postulados`)??S.navigate(`postulados`)}),e.querySelector(`#btn-ver-alumno`)?.addEventListener(`click`,()=>{window.router?.navigate(`alumno`,{id:t.alumno_id})??S.navigate(`alumno`,{id:t.alumno_id})}),e.querySelectorAll(`.doc-check`).forEach(e=>{e.addEventListener(`change`,()=>{let t=wo(n),r=e.getAttribute(`data-doc-id`);e.checked?t[r]=!0:delete t[r],To(n,t)})}),e.querySelector(`#btn-save-note`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#textarea-nueva-nota`),r=(t?.value||``).trim();if(!r)return;let i=e.querySelector(`#btn-save-note`),a=e.querySelector(`#save-note-spinner`);try{i.disabled=!0,a?.classList.remove(`d-none`),R.postulante=await bi(n,r),t.value=``;let o=e.querySelector(`#notes-timeline`);o&&(o.innerHTML=No(R.postulante))}catch(e){alert(`Error al agregar nota: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-contactado`)?.addEventListener(`click`,async()=>{try{R.postulante=await hi(n,`contactado`,{notas_seguimiento:`Contacto iniciado vía WhatsApp.`}),Oo(e)}catch(e){alert(`Error al cambiar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-cita-agendada`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-cita`),r=e.querySelector(`#cita-inline-error`),i=e.querySelector(`#btn-accion-cita-agendada`),a=e.querySelector(`#spinner-cita`);if(!t?.value){r?.classList.remove(`d-none`),r&&(r.textContent=`Debe seleccionar una fecha y hora.`);return}try{i.disabled=!0,a?.classList.remove(`d-none`),r?.classList.add(`d-none`);let o=new Date(t.value).toISOString();if(await yi(o,n)){r?.classList.remove(`d-none`),r&&(r.textContent=`Conflicto: ya existe otra cita en un rango de ±30 minutos.`);return}R.postulante=await hi(n,`cita_agendada`,{fecha_cita:o,notas_seguimiento:`Cita agendada para: ${bo(o)}`}),Oo(e)}catch(e){alert(`Error al agendar cita: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-documentos-ok`)?.addEventListener(`click`,async()=>{try{R.postulante=await hi(n,`documentos_ok`,{notas_seguimiento:`Representante presente. Documentación revisada.`}),Oo(e)}catch(e){alert(`Error al actualizar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-no-show`)?.addEventListener(`click`,async()=>{try{R.postulante=await hi(n,`no_show`,{notas_seguimiento:`No se presentó a la cita agendada.`}),Oo(e)}catch(e){alert(`Error al actualizar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-inscribir`)?.addEventListener(`click`,()=>{Vn(vo(t)),window.router?.navigate(`alumnos-inscribir`)??S.navigate(`alumnos-inscribir`)}),e.querySelector(`#btn-accion-reprogramar`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-reprogramar`),r=e.querySelector(`#btn-accion-reprogramar`),i=e.querySelector(`#spinner-reprogramar`);if(!t?.value){alert(`Seleccioná una nueva fecha para la cita.`);return}try{r.disabled=!0,i?.classList.remove(`d-none`);let a=new Date(t.value).toISOString();if(await yi(a,n)){alert(`Conflicto: ya existe otra cita en un rango de ±30 minutos.`);return}let o=await hi(n,`reprogramado`,{notas_seguimiento:`Cita reprogramada para: ${bo(a)}`});o=await hi(n,`cita_agendada`,{fecha_cita:a,notas_seguimiento:`Nueva cita agendada: ${bo(a)}`}),R.postulante=o,Oo(e)}catch(e){alert(`Error al reprogramar: ${e.message}`)}finally{r.disabled=!1,i?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-descartar`)?.addEventListener(`click`,async()=>{let t=prompt(`Indicá la razón del descarte:`);if(t!==null)try{R.postulante=await hi(n,`descartado`,{notas_seguimiento:`Postulación descartada. Razón: ${t||`Sin detallar`}`}),Oo(e)}catch(e){alert(`Error al descartar: ${e.message}`)}}),e.querySelector(`#btn-accion-espera-cita`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-espera`),r=e.querySelector(`#espera-cita-error`),i=e.querySelector(`#btn-accion-espera-cita`),a=e.querySelector(`#spinner-espera`);if(!t?.value){r?.classList.remove(`d-none`),r&&(r.textContent=`Seleccioná una fecha para la cita.`);return}try{i.disabled=!0,a?.classList.remove(`d-none`),r?.classList.add(`d-none`);let o=new Date(t.value).toISOString();if(await yi(o,n)){r?.classList.remove(`d-none`),r&&(r.textContent=`Conflicto: ya existe otra cita en ±30 minutos.`);return}R.postulante=await hi(n,`cita_agendada`,{fecha_cita:o,notas_seguimiento:`Cita agendada desde lista de espera: ${bo(o)}`}),Oo(e)}catch(e){alert(`Error al agendar cita: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}})}var z={year:new Date().getFullYear(),month:new Date().getMonth()+1,citas:[],cargando:!1},Fo=[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`],Io=[`Dom`,`Lun`,`Mar`,`Mié`,`Jue`,`Vie`,`Sáb`];async function Lo(e){await Ro(e)}async function Ro(e){try{z.cargando=!0,zo(e),z.citas=await vi(new Date(z.year,z.month-1,1,0,0,0).toISOString(),new Date(z.year,z.month,0,23,59,59).toISOString()),z.cargando=!1,Vo(e)}catch(t){z.cargando=!1,Bo(e,t.message)}}function zo(e){e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4">
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
  ...
  `,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>Lo(e))}function Vo(e){let t=new Date(z.year,z.month,0).getDate(),n=new Date(z.year,z.month-1,1).getDay();e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4">
      <!-- HEADER -->
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
      ...
      <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-body p-0">
          ...
          <div class="row g-0 bg-light text-center border-bottom py-2 fw-bold text-muted small">
            ${Io.map(e=>`<div class="col" style="width: 14.28%;">${e}</div>`).join(``)}
          </div>
  ...
  `,Wo(e)}function Ho(e,t){let n=``;for(let t=0;t<e;t++)n+=`
    ...
    `;let r=new Date,i=r.getFullYear()===z.year&&r.getMonth()+1===z.month;for(let e=1;e<=t;e++){let t=i&&r.getDate()===e,a=Uo(e);n+=`
    ...
    `}let a=(e+t)%7;if(a>0){let e=7-a;for(let t=0;t<e;t++)n+=`
      ...
      `}return n}function Uo(e){return z.citas.filter(t=>{if(!t.fecha_cita)return!1;let n=new Date(t.fecha_cita);return n.getDate()===e&&n.getMonth()+1===z.month&&n.getFullYear()===z.year})}function Wo(e){document.getElementById(`btn-month-prev`)?.addEventListener(`click`,()=>{z.month--,z.month<1&&(z.month=12,z.year--),Ro(e)}),document.getElementById(`btn-month-next`)?.addEventListener(`click`,()=>{z.month++,z.month>12&&(z.month=1,z.year++),Ro(e)}),document.getElementById(`btn-today`)?.addEventListener(`click`,()=>{z.year=new Date().getFullYear(),z.month=new Date().getMonth()+1,Ro(e)}),e.querySelectorAll(`.btn-goto-perfil`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=e.currentTarget.getAttribute(`data-id`);S.navigate(`postulado`,{id:t})})}),e.querySelectorAll(`.btn-view-mobile-day`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=parseInt(e.currentTarget.getAttribute(`data-day`)),n=Uo(t),r=n.map(e=>{let t=new Date(e.fecha_cita).toLocaleTimeString(`es-ES`,{hour:`2-digit`,minute:`2-digit`,hour12:!0});return`• ${e.nombre_completo} (${t})`}).join(`
`);alert(`Citas para el día ${t} de ${Fo[z.month-1]}:\n\n${r}\n\nSelecciona el perfil para ver detalles.`),n.length===1&&S.navigate(`postulado`,{id:n[0].id})})})}function Go(){S.register(`alumnos`,Te),S.register(`alumnos-reporte-mes`,Pn),S.register(`alumnos-inscribir`,xa),S.register(`alumnos-pdf-demo`,Pa),S.register(`alumno`,Ma),S.register(`postulados`,to),S.register(`postulado`,Eo),S.register(`postulados-calendario`,Lo)}function Ko(e){return e?{...e,nombre:e.nombre??e.name??``,codigo:e.codigo_salon??``,ubicacion:e.ubicacion??e.location??``,condicion:e.condicion_fisica??`buena`,is_active:e.is_active??e.isActive??e.activo??!0,capacidad:parseInt(e.capacidad)||20,piso:e.piso!==void 0&&e.piso!==null?parseInt(e.piso):null,equipamiento:Array.isArray(e.equipamiento)?e.equipamiento.join(`, `):e.equipamiento||``,descripcion:e.descripcion||``}:null}async function qo(){let{data:e,error:t}=await y.from(`salones`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando salones:`,t.message),Error(`No se pudieron cargar los salones`);return e.map(Ko)}async function Jo(e){let t=(e.nombre||``).trim(),n=(e.codigo_salon||``).trim();if(!t)throw Error(`El nombre es obligatorio`);let{data:r,error:i}=await y.from(`salones`).select(`id, nombre, codigo_salon`).or(`nombre.eq."${t}", codigo_salon.eq."${n}"`).maybeSingle();if(i&&console.error(`Error validando duplicados:`,i),r){if(r.nombre.toLowerCase()===t.toLowerCase())throw Error(`Ya existe un salón con ese nombre`);if(n&&r.codigo_salon?.toLowerCase()===n.toLowerCase())throw Error(`Ya existe un salón con ese código`)}let a={nombre:t,codigo_salon:n||void 0,capacidad:parseInt(e.capacidad)||20,ubicacion:(e.ubicacion||``).trim(),piso:e.piso===void 0?null:parseInt(e.piso),condicion_fisica:e.condicion_fisica||`buena`,equipamiento:typeof e.equipamiento==`string`?e.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(e.equipamiento)?e.equipamiento:[],descripcion:(e.descripcion||``).trim(),is_active:e.is_active===void 0?!0:e.is_active,responsable_id:e.responsable_id||null},{data:o,error:s}=await y.from(`salones`).insert([a]).select();if(s)throw s.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error creando salon:`,s.message),Error(`No se pudo crear el salon`));return o[0]}async function Yo(e,t){let n=(t.nombre||``).trim(),r=(t.codigo_salon||``).trim();if(n||r){let{data:t}=await y.from(`salones`).select(`id, nombre, codigo_salon`).neq(`id`,e);if(t){if(n&&t.find(e=>e.nombre.toLowerCase()===n.toLowerCase()))throw Error(`Ya existe otro salón con ese nombre`);if(r&&t.find(e=>e.codigo_salon?.toLowerCase()===r.toLowerCase()))throw Error(`Ya existe otro salón con ese código`)}}let i={...t};n&&(i.nombre=n),r&&(i.codigo_salon=r),i.capacidad&&=parseInt(i.capacidad),i.piso!==void 0&&(i.piso=parseInt(i.piso)),i.equipamiento!==void 0&&(i.equipamiento=typeof i.equipamiento==`string`?i.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(i.equipamiento)?i.equipamiento:[]),i.updated_at=new Date().toISOString();let{data:a,error:o}=await y.from(`salones`).update(i).eq(`id`,e).select();if(o)throw o.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error actualizando salon:`,o.message),Error(`No se pudo actualizar el salon`));return a[0]}async function Xo(e){let{error:t}=await y.from(`salones`).update({is_active:!1,updated_at:new Date().toISOString()}).eq(`id`,e);if(t)throw console.error(`Error eliminando salon:`,t.message),Error(`No se pudo inactivar el salon`)}var B=new class{constructor(){this.salones=[],this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notify(){this.listeners.forEach(e=>e(this))}async fetchSalones(){this.cargando=!0,this.error=null,this.notify();try{this.salones=await qo()}catch(e){this.error=e.message,console.error(e)}finally{this.cargando=!1,this.notify()}}getFiltered(e=``,t=``,n=``){return this.salones.filter(r=>{let i=e.toLowerCase(),a=r.nombre.toLowerCase().includes(i)||r.codigo&&r.codigo.toLowerCase().includes(i)||r.ubicacion.toLowerCase().includes(i),o=t===``||String(r.piso)===String(t),s=n===``||r.condicion===n;return a&&o&&s})}},Zo={editandoId:null};function V(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function Qo(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].substring(0,2).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function $o(e){e.innerHTML=`
  ...
  `;let t=e.querySelector(`#salonesTableBody`),n=e.querySelector(`#searchSalon`),r=e.querySelector(`#filterCondicion`),i=e.querySelector(`#filterPiso`),a=e.querySelector(`#salonesCount`),o=()=>{let e=n.value,o=r.value,c=i.value,l=B.getFiltered(e,c,o);if(B.cargando){t.innerHTML=`<div class="text-center py-5 text-muted"><div class="spinner-border text-primary mb-3" role="status"></div><br><small class="text-muted">Cargando salones...</small></div>`;return}if(B.error){t.innerHTML=`<div class="text-center py-5 text-danger"><i class="bi bi-exclamation-triangle fs-3 d-block mb-2"></i> Error: ${V(B.error)}</div>`;return}if(l.length===0){t.innerHTML=`
        ...
        </div>`;return}a.textContent=l.length,t.innerHTML=l.map(e=>{let t=Qo(e.nombre||`S`),n=e.is_active!==!1,r=s(e.condicion),i=`border-accent-${n?`success`:`secondary`}`,a=`bg-${n?`success`:`secondary`}`;return`
    ...
    `})}function rs(e){let t=B.salones.find(t=>t.id===e);if(!t){b.error(`Salón no encontrado`);return}x.open({title:`⚠️ Inactivar Salón`,size:`sm`,saveText:`Inactivar`,body:`<p>¿Inactivar el salón <strong>${V(t.nombre)}</strong>?</p>
           <p class="text-muted small mb-0">Esta acción lo ocultará de las asignaciones de clases.</p>`,onSave:async()=>{await Xo(e),B.fetchSalones(),b.success(`Salón inactivado correctamente`)}})}function is(){S.register(`salones`,$o)}function as(){S.register(`clases`,Re)}var H={timeline:[],periodos:[],periodoActivo:null,clases:[],resumenGlobal:null,cargando:!1,filtroPeriodo:null,filtroClase:`todas`,container:null};async function os(e){if(e)try{H.container=e,H.cargando=!0,cs(e);let[t,n,r]=await Promise.all([f(),c(),ae()]);H.periodos=t,H.periodoActivo=n,n?.id?H.filtroPeriodo=n.id:t&&t.length>0?H.filtroPeriodo=t[0].id:H.filtroPeriodo=null,H.clases=r,console.log(`🔍 renderAsistenciasView init:`,{periodosCount:t?.length||0,periodoActivo:n?.nombre,filtroPeriodo:H.filtroPeriodo}),await ss(),us(e),ms(e)}catch(t){console.error(t),ls(e,t.message)}}async function ss(){let{timelineByDate:e,resumenGlobal:t}=await Fe({periodoId:H.filtroPeriodo});H.timeline=e||[],H.resumenGlobal=t||{totalClases:0,totalPresentes:0,totalAusentes:0,totalJustificados:0,totalRegistros:0,totalSesiones:0}}function cs(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status"></div>
    </div>
  `}function ls(e,t){e.innerHTML=`
  ...
  `,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>os(e))}function us(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function ds(){return H.timeline.length===0?`<div class="text-center py-5 text-muted"><i class="bi bi-calendar-x fs-1 d-block mb-2"></i>No hay clases registradas.</div>`:H.timeline.map((e,t)=>{let n=ps(e.fecha),r=`accordion-fecha-${t}`,a=e.clases.map((e,n)=>{let r=`accordion-clase-${t}-${n}`,a=e.hora_inicio?`${e.hora_inicio.slice(0,5)} - ${e.hora_fin?.slice(0,5)||`??:??`}`:`Sin horario`;return`
    ...
    `}).join(``)}function fs(e){let t=e.asistencias||[],n=t.filter(e=>e.estado===`presente`),r=t.filter(e=>e.estado===`ausente`),a=t.filter(e=>e.estado===`justificado`),o=(e,t,n)=>t.length===0?``:`
      <div class="mb-3">
  ...
  `}function ps(e){return new Date(e+`T12:00:00`).toLocaleDateString(`es-ES`,{weekday:`long`,day:`numeric`,month:`long`})}function ms(e){e.querySelector(`#select-periodo`)?.addEventListener(`change`,async e=>{H.filtroPeriodo=e.target.value,await hs()}),e.querySelector(`#accordion-dias`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="view-detail"]`);t&&gs(t.dataset.id)}),e.querySelector(`#btn-nueva-sesion`)?.addEventListener(`click`,()=>_s())}async function hs(){let e=H.container;b.info(`Cargando asistencias...`),await ss();let t=e.querySelector(`.asistencias-header-premium p.text-muted`);t&&(t.textContent=`${H.resumenGlobal?.totalRegistros||0} registros en total`);let n=e.querySelector(`.stats-panel`);n&&(n.innerHTML=`
      <div class="stats-grid">
        <div class="stat-card stat-total">
          <div class="stat-label">Total Registros</div>
          <div class="stat-value">${H.resumenGlobal?.totalRegistros||0}</div>
    ...
    `);let r=e.querySelector(`#accordion-dias`);r&&(r.innerHTML=ds()),ms(e),b.success(`Asistencias cargadas`)}async function gs(e){b.info(`Cargando detalle...`);try{let t=await oe(e);x.open({title:`Sesión: ${t.sesion.claseNombre}`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
        <div class="row g-4">
          <div class="col-md-8">
                  ...
                  ${t.asistencias.map(e=>`
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="badge bg-${l[e.estado]?.css||`secondary`}">${l[e.estado]?.label||e.estado}</span>
                      </td>
  ...
  `}var ys={periodoActivo:null,periodos:[],datos:{programas:{},niveles:{},totales:{sesiones:0,presentes:0,ausentes:0,justificados:0}},cargando:!1};async function bs(e){ys.cargando=!0,e.innerHTML=xs(),await Ss(),ys.cargando=!1,ws(e)}function xs(){return`
  ...
  `}async function Ss(){let[e,t]=await Promise.all([f(),c()]);ys.periodos=e,ys.periodoActivo=t,t&&(ys.datos=Cs(await d({periodoId:t.id})))}function Cs(e){let t={},n={},r=0,i=0,a=0,o=0;for(let s of e)for(let e of s.sesiones){let s=e.claseNombre?.split(`-`)[0]?.trim()||`General`,c=e.instrumento||`General`;t[s]||(t[s]={total:0,presentes:0,ausentes:0,justificados:0}),t[s].total+=e.totalRegistros||0,t[s].presentes+=e.totalPresentes||0,t[s].ausentes+=e.totalAusentes||0,t[s].justificados+=e.totalJustificados||0,n[c]||(n[c]={total:0,presentes:0,ausentes:0,justificados:0}),n[c].total+=e.totalRegistros||0,n[c].presentes+=e.totalPresentes||0,n[c].ausentes+=e.totalAusentes||0,n[c].justificados+=e.totalJustificados||0,r++,i+=e.totalPresentes||0,a+=e.totalAusentes||0,o+=e.totalJustificados||0}return{programas:t,niveles:n,totales:{sesiones:r,presentes:i,ausentes:a,justificados:o}}}function ws(e){let{programas:t,niveles:n,totales:r}=ys.datos,i=r.presentes+r.ausentes+r.justificados?Math.round(r.presentes/i*100):0;e.innerHTML=`
    <div class="page-container py-3">
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-3">${vs({titulo:`Sesiones`,valor:r.sesiones,colorClass:`primary`,icono:`bi-calendar3`})}</div>
        <div class="col-md-3">${vs({titulo:`Tasa Asistencia`,valor:`${i}%`,colorClass:i>=80?`success`:i>=50?`warning`:`danger`,icono:`bi-check-circle`})}</div>
        <div class="col-md-3">${vs({titulo:`Ausentes`,valor:r.ausentes,colorClass:`danger`,icono:`bi-x-circle`})}</div>
        <div class="col-md-3">${vs({titulo:`Justificados`,valor:r.justificados,colorClass:`warning`,icono:`bi-file-earmark-check`})}</div>
      </div>
  ...
  `}function Ts(e,t){if(!Object.keys(e).length)return`<p class="text-muted text-center py-3">Sin datos disponibles</p>`;let n=Object.entries(e).sort((e,t)=>t[1].presentes+t[1].ausentes-(e[1].presentes+e[1].ausentes));return Math.max(...n.map(([,e])=>e.presentes+e.ausentes+e.justificados)),n.slice(0,8).map(([e,t])=>{let n=t.presentes+t.ausentes+t.justificados,r=n?t.presentes/n*100:0,i=n?t.ausentes/n*100:0,a=n?t.justificados/n*100:0;return`
    ...
    `}).join(``)}function Es(){S.register(`asistencias`,os),S.register(`asistencias-reportes`,bs)}var Ds=!window.location.href.includes(`supabase`);async function Os(e={}){if(Ds){let t=[...lt.sesiones];return e.fecha&&(t=t.filter(t=>t.fecha===e.fecha)),e.clase_id&&(t=t.filter(t=>t.clase_id===e.clase_id)),e.maestro_id&&(t=t.filter(t=>t.maestro_id===e.maestro_id)),e.tipo&&(t=t.filter(t=>t.tipo===e.tipo)),t}let t=y.from(`sesiones_clase`).select(`*`).order(`fecha`,{ascending:!1});e.fecha&&(t=t.eq(`fecha`,e.fecha)),e.clase_id&&(t=t.eq(`clase_id`,e.clase_id)),e.maestro_id&&(t=t.eq(`maestro_id`,e.maestro_id)),e.tipo&&(t=t.eq(`tipo`,e.tipo));let{data:n,error:r}=await t;if(r)throw console.error(`Error cargando sesiones:`,r.message),Error(`No se pudieron cargar las sesiones`);return n}async function ks(e){if(!e.clase_id)throw Error(`La clase es obligatoria`);if(!e.fecha)throw Error(`La fecha es obligatoria`);if(!e.tema)throw Error(`El tema es obligatorio`);let t=null,n=null;if(!Ds){let r=[`domingo`,`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`][new Date(e.fecha).getDay()].toLowerCase(),{data:i,error:a}=await y.from(`clase_horarios`).select(`id, salon_id`).eq(`clase_id`,e.clase_id).eq(`dia`,r).limit(1);!a&&i&&i.length>0&&(t=i[0].id,n=i[0].salon_id)}let r={clase_id:e.clase_id,maestro_id:e.maestro_id||null,fecha:e.fecha,hora_inicio:e.hora_inicio||null,hora_fin:e.hora_fin||null,horario_id:t,salon_id:n,tema:e.tema.trim(),contenido:e.contenido?.trim()||null,motivo:e.motivo?.trim()||null,tipo:e.tipo||`regular`,estado:e.estado||`pendiente`,es_codocencia:e.es_codocencia||!1,maestro_auxiliar_id:e.maestro_auxiliar_id||null,asistencia:null};if(Ds){let e={...r,id:`sesion_${Date.now()}`,created_at:new Date().toISOString()};return lt.sesiones.push(e),e}let{data:i,error:a}=await y.from(`sesiones_clase`).insert([r]).select();if(a)throw console.error(`Error creando sesión:`,a.message),Error(`No se pudo crear la sesión`);return i[0]}async function As(e,t){let n={};if(t.tema!==void 0&&(n.tema=t.tema.trim()),t.contenido!==void 0&&(n.contenido=t.contenido?.trim()||null),t.hora_inicio!==void 0&&(n.hora_inicio=t.hora_inicio),t.hora_fin!==void 0&&(n.hora_fin=t.hora_fin),t.estado!==void 0&&(n.estado=t.estado),t.asistencia!==void 0&&(n.asistencia=t.asistencia),t.es_codocencia!==void 0&&(n.es_codocencia=t.es_codocencia),t.maestro_auxiliar_id!==void 0&&(n.maestro_auxiliar_id=t.maestro_auxiliar_id),Ds){let t=lt.sesiones.findIndex(t=>t.id===e);if(t===-1)throw Error(`Sesión no encontrada`);return lt.sesiones[t]={...lt.sesiones[t],...n,updated_at:new Date().toISOString()},lt.sesiones[t]}let{data:r,error:i}=await y.from(`sesiones_clase`).update(n).eq(`id`,e).select();if(i)throw console.error(`Error actualizando sesión:`,i.message),Error(`No se pudo actualizar la sesión`);return r[0]}async function js(e){if(Ds){let t=lt.sesiones.findIndex(t=>t.id===e);if(t===-1)throw Error(`Sesión no encontrada`);return lt.sesiones.splice(t,1),{success:!0}}let{error:t}=await y.from(`sesiones_clase`).delete().eq(`id`,e);if(t)throw console.error(`Error eliminando sesión:`,t.message),Error(`No se pudo eliminar la sesión`);return{success:!0}}async function Ms(e,t){return As(e,{asistencia:t||[]})}async function Ns(e){if(Ds)return lt.sesiones.filter(t=>t.maestro_auxiliar_id===e);let{data:t,error:n}=await y.from(`sesiones_clase`).select(`*`).eq(`maestro_auxiliar_id`,e).order(`fecha`,{ascending:!1});if(n)throw console.error(`Error cargando sesiones de co-docencia:`,n.message),Error(`Error al cargar sesiones`);return t}async function Ps(e){if(Ds)return ct.clases.filter(t=>t.maestro_titular_id===e||t.maestro_auxiliar_id===e);let{data:t,error:n}=await y.from(`clases`).select(`*`).or(`maestro_principal_id.eq.${e},maestro_auxiliar_id.eq.${e}`);if(n)throw console.error(`Error cargando clases del maestro:`,n.message),Error(`Error al cargar clases`);return t}var Fs=class{constructor(){this.planificaciones=[],this.planificacionActual=null,this.sesiones=[],this.clases=[],this.maestroActualId=null,this.esCoDocencia=!1,this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}setMaestroActual(e,t=!1){this.maestroActualId=e,this.esCoDocencia=t,this.notifyListeners()}notifyListeners(){this.listeners.forEach(e=>{e({planificaciones:this.planificaciones,planificacionActual:this.planificacionActual,sesiones:this.sesiones,clases:this.clases,maestroActualId:this.maestroActualId,esCoDocencia:this.esCoDocencia,cargando:this.cargando,error:this.error})})}async fetchPlanificaciones(){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificaciones=await je(this.maestroActualId),this.cargando=!1,this.notifyListeners(),this.planificaciones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchPlanificacionesConDetalles(){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificaciones=await Le(this.maestroActualId),this.cargando=!1,this.notifyListeners(),this.planificaciones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchPlanificacion(e){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificacionActual=await Ve(e),this.cargando=!1,this.notifyListeners(),this.planificacionActual}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}reset(){this.planificaciones=[],this.planificacionActual=null,this.cargando=!1,this.error=null,this.notifyListeners()}search(e){if(!e)return this.planificaciones;let t=e.toLowerCase();return this.planificaciones.filter(e=>(e.tema||``).toLowerCase().includes(t)||(e.contenido||``).toLowerCase().includes(t)||(e.objetivos||``).toLowerCase().includes(t)||(e.observaciones||``).toLowerCase().includes(t))}filterByClase(e){return this.planificaciones.filter(t=>t.clase_id===e)}filterByMaestro(e){return this.planificaciones.filter(t=>t.maestro_id===e)}filterByEstado(e){return this.planificaciones.filter(t=>t.estado===e)}getById(e){return this.planificaciones.find(t=>t.id===e)||null}getActivas(){return this.planificaciones.filter(e=>e.estado===`planificado`)}count(){return this.planificaciones.length}countByEstado(){return this.planificaciones.reduce((e,t)=>{let n=t.estado||`Sin estado`;return e[n]=(e[n]||0)+1,e},{})}countByClase(){return this.planificaciones.reduce((e,t)=>{let n=t.clase_id||`Sin clase`;return e[n]=(e[n]||0)+1,e},{})}async fetchSesiones(e={}){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.sesiones=await Os(e),this.cargando=!1,this.notifyListeners(),this.sesiones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchClasesDelMaestro(e){this.cargando=!0,this.error=null;try{return this.clases=await Ps(e),this.cargando=!1,this.notifyListeners(),this.clases}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchSesionesCoDocencia(e){this.cargando=!0,this.error=null;try{return this.sesiones=await Ns(e),this.esCoDocencia=!0,this.cargando=!1,this.notifyListeners(),this.sesiones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async crearSesionEmergente(e){this.cargando=!0,this.error=null;try{let t=await ks({...e,maestro_id:this.maestroActualId});return this.sesiones.unshift(t),this.cargando=!1,this.notifyListeners(),t}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async actualizarSesionPasada(e,t){this.cargando=!0,this.error=null;try{let n=await As(e,t),r=this.sesiones.findIndex(t=>t.id===e);return r!==-1&&(this.sesiones[r]={...this.sesiones[r],...n}),this.cargando=!1,this.notifyListeners(),n}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async eliminarSesion(e){this.cargando=!0,this.error=null;try{return await js(e),this.sesiones=this.sesiones.filter(t=>t.id!==e),this.cargando=!1,this.notifyListeners(),{success:!0}}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async registrarAsistencia(e,t){this.cargando=!0,this.error=null;try{let n=await Ms(e,t),r=this.sesiones.findIndex(t=>t.id===e);return r!==-1&&(this.sesiones[r]={...this.sesiones[r],...n}),this.cargando=!1,this.notifyListeners(),n}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}getSesionesPorFecha(e){return this.sesiones.filter(t=>t.fecha===e)}getSesionesEmergentes(){return this.sesiones.filter(e=>e.tipo===`emergente`)}getSesionesRegulares(){return this.sesiones.filter(e=>e.tipo===`regular`)}puedeEditarSesion(e){return this.esCoDocencia?e.maestro_auxiliar_id===this.maestroActualId:e.maestro_id===this.maestroActualId}resetSesiones(){this.sesiones=[],this.clases=[],this.maestroActualId=null,this.esCoDocencia=!1,this.notifyListeners()}},Is=null;function Ls(){return Is||=new Fs,Is}async function Rs(e){let{data:t,error:n}=await y.from(`cobertura_alumno_objetivo`).upsert(e,{onConflict:`alumno_id,objetivo_id`}).select();if(n)throw n;return t}async function zs(e){let{data:t,error:n}=await y.from(`cobertura_alumno_objetivo`).select(`
      id, nivel, confirmado, fecha, plan_id, objetivo_id,
      curriculo_objetivos ( id, descripcion, pilar_id,
        curriculo_pilares ( id, nombre )
      )
    `).eq(`alumno_id`,e);if(n)throw n;return t||[]}function Bs(){return`/functions/v1/groq-proxy`}async function Vs(){let{data:{session:e}}=await y.auth.getSession();return{Authorization:`Bearer ${e?.access_token??``}`,"Content-Type":`application/json`,apikey:``}}async function Hs(e,{maxTokens:t,temperature:n,responseFormat:i}={}){let a=await Vs(),o={model:r.groq.model,messages:e,...t&&{max_tokens:t},...n!==void 0&&{temperature:n},...i&&{response_format:i}},s=await fetch(`${Bs()}/chat`,{method:`POST`,headers:a,body:JSON.stringify(o)}),c=await s.json();if(!s.ok||c.error)throw Error(c.error?.message??`Groq proxy error ${s.status}`);return c.choices[0].message.content.trim()}async function Us(e,t,n){let i=`Eres un asistente pedagógico musical. Dado el contenido de un plan de clase y una lista de objetivos curriculares, identifica cuáles objetivos probablemente se cubrieron.
...
Solo incluye objetivos que tengan evidencia real en el plan. No inventes coberturas.`;if(r.isDemoMode)return{success:!0,coberturas:t.slice(0,2).flatMap(e=>n.slice(0,2).map(t=>({alumno:e,objetivo_id:t.id,nivel:`en_proceso`,razon:`Demo: objetivo relacionado con el tema`}))),isMock:!0};try{let e=await Hs([{role:`user`,content:i}],{maxTokens:1500,temperature:.3,responseFormat:{type:`json_object`}});return{success:!0,coberturas:JSON.parse(e||`{"coberturas":[]}`).coberturas||[],isMock:!1}}catch(e){return console.error(`extraerCobertura error:`,e),{success:!1,coberturas:[],error:e.message}}}async function Ws(e,t,n){let i=`Eres un asistente pedagógico musical. Genera un borrador de plan de clase personalizado.
...
Tono: colega experto, respetuoso, propositivo. Sin tecnicismos innecesarios. Responde en español.`;if(r.isDemoMode)return{success:!0,feedback:`Tu enfoque en las últimas semanas muestra consistencia y dedicación. Se nota claridad en la presentación de contenidos técnicos.

Hay oportunidad de ampliar el trabajo en repertorio variado y lectura a primera vista.

Para las próximas semanas, incorporá al menos una pieza nueva por mes y dedicá 5-10 minutos a ejercicios de lectura rítmica.`,isMock:!0};try{return{success:!0,feedback:await Hs([{role:`user`,content:a}],{maxTokens:600,temperature:.8}),isMock:!1}}catch(e){return console.error(`analizarEnfoque error:`,e),{success:!1,feedback:``,error:e.message}}}var Ks=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),qs=`
...
</style>`;async function Js({plan:e,claseId:t,instrumento:n,nivel:r,maestroId:i,onConfirm:a,onSkip:o}){let s=document.createElement(`div`);s.innerHTML=`${qs}
    <div class="modal fade" id="cob-modal" tabindex="-1" data-bs-backdrop="static">
      ...
      ${Object.entries(t).map(([e,{nombre:t,rows:n}])=>`
        <div class="cob-alumno-block">
          <div class="cob-alumno-name"><i class="bi bi-person me-1"></i>${Ks(t)}</div>
          ${n.map(e=>{let t=u.indexOf(e);return`
            <div class="cob-obj-row">
              ...
              <span style="flex:1">
                <span class="text-muted small">${Ks(e.pilar_nombre)} /</span> ${Ks(e.obj_descripcion)}
        ...
        </div>`).join(``)}`,e.querySelectorAll(`.cob-check`).forEach(t=>{t.addEventListener(`change`,()=>{let n=+t.dataset.idx;u[n].checked=t.checked;let r=e.querySelector(`.cob-nivel-sel[data-idx="${n}"]`);r&&(r.disabled=!t.checked)})}),e.querySelectorAll(`.cob-nivel-sel`).forEach(e=>{e.addEventListener(`change`,()=>{u[+e.dataset.idx].nivel=e.value})})}}var Ys=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);async function Xs(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card border-warning border-opacity-25">
          <div class="card-body">
            ...
            <div class="text-body" style="line-height:1.7; white-space:pre-line">${Ys(c.feedback)}</div>
          </div>
        </div>`,e.querySelector(`#ap-btn-regenerate`)?.addEventListener(`click`,()=>{e.querySelector(`#ap-btn-feedback`).click()})}catch(e){r.innerHTML=`<div class="alert alert-danger small">${e.message}</div>`}finally{n.disabled=!1,n.innerHTML=`<i class="bi bi-chat-quote me-1"></i>Analizar mi enfoque`}})}var Zs=`
...
.cm-obj-input { flex:1; }
</style>`;function Qs(e){let t=document.getElementById(`curriculo-list-modal`);t&&t.remove();let n=document.createElement(`div`);n.id=`curriculo-list-modal`,n.innerHTML=`${Zs}
    <div class="modal fade" id="curriculo-list-modal-dialog" tabindex="-1">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        ...
        </table>`,e.querySelectorAll(`.cl-toggle`).forEach(e=>{e.addEventListener(`change`,async()=>{await ke(e.dataset.id,e.checked),b.success(e.checked?`Currículo activado`:`Currículo desactivado`)})}),e.querySelectorAll(`.cl-btn-edit`).forEach(e=>{e.addEventListener(`click`,()=>ec(e.dataset.id,a))})}catch(t){e.innerHTML=`<p class="text-danger">${t.message}</p>`}}n.querySelector(`#cl-btn-nuevo`).addEventListener(`click`,()=>{$s(a)}),r.addEventListener(`hidden.bs.modal`,()=>{n.remove(),e?.()}),i.show(),a()}function $s(e){let t=document.createElement(`div`);t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);let n=t.querySelector(`#cc-modal`),r=new bootstrap.Modal(n);t.querySelector(`#cc-btn-save`).addEventListener(`click`,async()=>{let n=t.querySelector(`#cc-instrumento`).value.trim(),i=t.querySelector(`#cc-nivel`).value.trim();if(!n||!i){b.error(`Instrumento y nivel son obligatorios`);return}try{await ze({instrumento:n,nivel:i,descripcion:t.querySelector(`#cc-desc`).value.trim()}),b.success(`Currículo creado`),r.hide(),e?.()}catch(e){b.error(e.message)}}),n.addEventListener(`hidden.bs.modal`,()=>t.remove()),r.show()}async function ec(e,t){let{data:n,error:r}=await y.from(`curriculos`).select(`id, instrumento, nivel, descripcion, curriculo_pilares(id, nombre, orden, curriculo_objetivos(id, descripcion, orden))`).eq(`id`,e).single();if(r){b.error(r.message);return}let i=document.createElement(`div`);i.innerHTML=`
    <div class="modal fade" id="ce-modal" tabindex="-1">
      ...
      </div>`,e.querySelectorAll(`.pilar-nombre`).forEach(e=>{e.addEventListener(`blur`,async()=>{await ue(e.closest(`[data-pilar-id]`).dataset.pilarId,{nombre:e.value.trim()})})}),e.querySelectorAll(`.pilar-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`).dataset.pilarId;confirm(`¿Eliminar este pilar y todos sus objetivos?`)&&(await ge(t),n.curriculo_pilares=n.curriculo_pilares.filter(e=>e.id!==t),s())})}),e.querySelectorAll(`.obj-desc`).forEach(e=>{e.addEventListener(`blur`,async()=>{await we(e.closest(`[data-obj-id]`).dataset.objId,{descripcion:e.value.trim()})})}),e.querySelectorAll(`.obj-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-obj-id]`),r=t.dataset.objId;await Ue(r);let i=t.closest(`[data-pilar-id]`).dataset.pilarId,a=n.curriculo_pilares.find(e=>e.id===i);a&&(a.curriculo_objetivos=a.curriculo_objetivos.filter(e=>e.id!==r)),s()})}),e.querySelectorAll(`.new-obj-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`),r=t.dataset.pilarId,i=t.querySelector(`.new-obj-input`),a=i.value.trim();if(!a)return;let o=n.curriculo_pilares.find(e=>e.id===r),c=(o?.curriculo_objetivos||[]).length,l=await me(r,a,c);o&&(o.curriculo_objetivos=[...o.curriculo_objetivos||[],l]),i.value=``,s()})}),document.getElementById(`ce-add-pilar`)?.addEventListener(`click`,async()=>{let e=prompt(`Nombre del nuevo pilar:`);if(!e?.trim())return;let t=n.curriculo_pilares.length,r=await De(n.id,e.trim(),t);n.curriculo_pilares.push({...r,curriculo_objetivos:[]}),s()})}a.addEventListener(`hidden.bs.modal`,()=>{i.remove(),t?.()}),o.show(),s()}var tc=`
...
</style>`;function nc(e){let t=document.getElementById(`ruta-crear-modal`);t&&t.remove();let n=document.createElement(`div`);n.id=`ruta-crear-modal`,n.innerHTML=`${tc}
...
.cambio-move { color: #ffc107; }
</style>`;function ic(e,t){let n=document.getElementById(`ruta-variante-modal`);n&&n.remove();let r=document.createElement(`div`);r.id=`ruta-variante-modal`,r.innerHTML=`${rc}
    <div class="modal fade" id="ruta-variante-dialog" tabindex="-1">
    ...
    </div>`,document.body.appendChild(r);let i=document.getElementById(`ruta-variante-dialog`),a=new bootstrap.Modal(i);async function o(){let n=document.getElementById(`variante-body`);try{let r=await de(e);n.innerHTML=`
      ...
      `;let i=JSON.parse(JSON.stringify(r.objetivos));function o(){let e=document.getElementById(`objetivos-variante`);e.innerHTML=i.map((e,t)=>`
        ...
        `).join(``),document.querySelectorAll(`[data-remove-idx]`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.removeIdx);i.splice(t,1),o()})})}document.getElementById(`btn-agregar-obj-var`).addEventListener(`click`,()=>{let e=Math.max(...i.map(e=>e.semana_fin));i.push({descripcion:``,semana_inicio:e+1,semana_fin:e+2,orden:i.length+1}),o()}),document.getElementById(`btn-proponer-variante`).addEventListener(`click`,async()=>{let n=document.getElementById(`variante-nombre`).value,r=document.getElementById(`variante-razon`).value;if(!n||!r){b.warning(`Completa nombre y razón`);return}try{let o=await ne(e,n,r,i);b.success(`Variante propuesta para aprobación`),a.hide(),t&&t(o)}catch(e){b.error(`Error: ${e.message}`)}}),o()}catch(e){n.innerHTML=`<div class="alert alert-danger">${e.message}</div>`}}i.addEventListener(`shown.bs.modal`,o),a.show()}var ac=`
...
</style>`;async function oc(e){if(e)try{let t=await qe();if(t.length===0){e.innerHTML=`${ac}<div class="alert alert-info">No hay variantes pendientes de aprobación.</div>`;return}let n=`${ac}
      <div class="mb-3">
        <h5><span class="badge bg-warning">${t.length} pendientes</span></h5>
      </div>`;for(let e of t){let t=e.ruta_base_id?await de(e.ruta_base_id):null;n+=`
...
`;async function cc(e,t=`maestro`){if(!e)return;let n=t===`admin`;try{let r=sc;if(n?r+=`
      ...
      `,e.innerHTML=r,n){e.querySelector(`#btn-crear-ruta-soi`)?.addEventListener(`click`,()=>{nc(n=>{b.success(`Ruta "${n.nombre}" creada exitosamente`),cc(e,t)})});let n=e.querySelector(`#variantes-dashboard-container`);n&&oc(n)}else{e.querySelector(`#btn-proponer-variante`)?.addEventListener(`click`,async()=>{try{let n=await Ye({tipo:`soi-estandar`,estado:`activa`});if(n.length===0){b.warning(`No hay rutas estándar disponibles para proponer variantes`);return}let r=await lc(n);if(!r)return;ic(r.id,n=>{b.success(`Variante propuesta para aprobación`),cc(e,t)})}catch(e){b.error(`Error: ${e.message}`)}});let n=e.querySelector(`#rutas-list-container`);if(n)try{let e=await Ye({estado:`activa`});e.length===0?n.innerHTML=`
    ...
    `}}async function lc(e){return new Promise(t=>{let n=document.createElement(`div`);n.innerHTML=`
...
{Actividad} Construcción de acordes en el instrumento`}],U={planes:[],cargando:!1,viewMode:`maestro`,activeTab:`planes`,asistenteRendered:!1,rutasRendered:!1,seleccionados:new Set,container:null},W=Ls();async function dc(e,{viewMode:t=`maestro`}={}){if(e){if(U.container=e,U.viewMode=t,U.seleccionados=new Set,U.asistenteRendered=!1,U.rutasRendered=!1,t===`plantillas`){vc(e);return}try{U.cargando=!0,fc(e),await W.fetchPlanificacionesConDetalles(),U.planes=[...W.planificaciones],U.cargando=!1,mc(e),bc(e)}catch(t){console.error(`[planificacionView]`,t),pc(e,t.message)}}}function fc(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando...</span>
      </div>
    </div>`}function pc(e,t){e.innerHTML=`
    <div class="page-container">
    ...
    </div>`}function mc(e){let t=U.viewMode===`admin`,n=t?`Todas las Planificaciones`:`Mis Planes de Clase`,r=t?`bi-shield-check`:`bi-journal-check`,o=t?`${W.planificaciones.length} planes pendientes de revisión`:`${W.planificaciones.length} planes registrados`,s=t?hc():``;e.innerHTML=`
    <div class="page-container">
      <!-- Header -->
      ...
      <div class="planificacion-filter-toolbar mb-4">
        ...
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-maestro">
            ...
            ${Array.from(new Set(W.planificaciones.map(e=>e.maestro_nombre).filter(e=>e&&e!==`Sin asignar`))).sort().map(e=>`<option value="${i(e)}">${i(e)}</option>`).join(``)}
          </select>
        </div>
        `:``}
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-clase">
            ...
            ${Array.from(new Set(W.planificaciones.map(e=>e.clase_nombre).filter(e=>e&&e!==`Sin asignar`))).sort().map(e=>`<option value="${i(e)}">${i(e)}</option>`).join(``)}
          </select>
        </div>
        <div class="premium-select-container">
          <i class="bi bi-funnel select-icon-muted"></i>
          <select class="form-select premium-filter-select" id="select-estado">
            ...
            ${a.getEstados().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
      </div>
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${U.planes.length===0?_c():``}</div>
      </div>
      </div>
  ...
  `}function hc(){let e=W.planificaciones,t=e.filter(e=>e.estado===`ejecutado`).length,n=e.filter(e=>e.estado===`revisado`).length,r=e.length;return`
    <div class="stats-panel mb-4">
      <div class="stats-grid">
  ...
  `}function gc(e){if(!e||e.length===0)return``;let t=U.viewMode===`admin`;return e.map(e=>{let n=a.getEstadoConfig(e.estado),r=e.estado===`revisado`?`border-accent-success`:e.estado===`ejecutado`?`border-accent-warning`:`border-accent-secondary`;return`
    ...
    `}).join(``)}function _c(){let e=U.viewMode===`admin`;return`
  ...
  `,e.querySelectorAll(`button[data-template-id]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=uc.find(t=>t.id===e.dataset.templateId);t&&yc(t)})})}function yc(e){x.open({title:`Usar plantilla: ${e.nombre}`,saveText:`Crear Plan`,size:`lg`,body:`
    ...
    `,onOpen:async e=>{let{data:t}=await y.from(`clases`).select(`id, nombre`).order(`nombre`),n=e.querySelector(`#tpl-clase_id`);n.innerHTML=`<option value="">Seleccionar clase...</option>`+(t||[]).map(e=>`<option value="${e.id}">${i(e.nombre)}</option>`).join(``)},onSave:async e=>{let t={tema:e.querySelector(`#tpl-tema`).value.trim(),clase_id:e.querySelector(`#tpl-clase_id`).value,objetivos:e.querySelector(`#tpl-objetivos`).value.trim(),contenido:e.querySelector(`#tpl-contenido`).value.trim()};try{return await ee(t),b.success(`Plan creado desde plantilla`),!0}catch(e){return b.error(e.message),!1}}})}function bc(e){let t=U.viewMode===`admin`;e.querySelector(`#buscar-plan`)?.addEventListener(`input`,xc),e.querySelector(`#select-estado`)?.addEventListener(`change`,xc),e.querySelector(`#select-clase`)?.addEventListener(`change`,xc),t&&e.querySelector(`#select-maestro`)?.addEventListener(`change`,xc),e.querySelector(`#btn-help-planificacion`)?.addEventListener(`click`,()=>{be.open({title:`Planificación`,intro:`Módulo para gestionar los planes de clase. Cada plan documenta qué se trabajará en una clase, en qué fecha, y si fue ejecutado o no.`,sections:[{icon:`bi-journal-text`,title:`Tab Mis planes`,description:`Lista tus planes personales. Filtrá por estado (planificado, ejecutado, cancelado) y creá nuevos desde "Nuevo plan".`,color:`#3b82f6`},{icon:`bi-file-earmark-template`,title:`Tab Plantillas`,description:`Plantillas reutilizables en formato DSL. Sirven como base para crear nuevos planes rápidamente.`,color:`#6366f1`},{icon:`bi-journal-check`,title:`Todas las planes (admin)`,description:`Solo visible para administradores. Muestra los planes de todos los maestros para supervisión.`,color:`#10b981`},{icon:`bi-circle-fill`,title:`Estados del plan`,description:`"Planificado" = no dictado aún. "Ejecutado" = clase dada. "Cancelado" = no se realizó. Mantenerlos actualizados mejora los reportes.`,color:`#f59e0b`}]})}),t||e.querySelector(`#btn-nuevo-plan`)?.addEventListener(`click`,()=>Cc(null)),t&&(e.querySelector(`#check-all`)?.addEventListener(`change`,t=>{let n=t.target.checked;U.seleccionados=n?new Set(U.planes.map(e=>e.id)):new Set,e.querySelectorAll(`.plan-check`).forEach(e=>{e.checked=n}),Sc()}),e.querySelector(`#btn-aprobar-bulk`)?.addEventListener(`click`,async()=>{let t=[...U.seleccionados];if(t.length)try{await _e(t),b.success(`${t.length} plan(es) aprobados`),dc(e,{viewMode:U.viewMode})}catch(e){b.error(e.message)}})),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(t=>{t.addEventListener(`click`,()=>{if(U.activeTab=t.dataset.tab,[`planes`,`plantillas`,`rutas`,`asistente`].forEach(t=>{let n=e.querySelector(`#tab-content-${t}`);n&&(n.style.display=U.activeTab===t?`block`:`none`)}),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),U.activeTab===`rutas`&&!U.rutasRendered){let t=e.querySelector(`#tab-content-rutas`);t&&(cc(t,U.viewMode),U.rutasRendered=!0)}if(U.activeTab===`asistente`&&!U.asistenteRendered){let t=e.querySelector(`#tab-content-asistente`);t&&(Xs(t),U.asistenteRendered=!0)}})}),document.addEventListener(`planificacion:nuevoPlan`,e=>{Cc(null)},{once:!0}),t&&e.querySelector(`#btn-curriculo-admin`)?.addEventListener(`click`,()=>{Qs()}),e.querySelector(`#planes-tbody`)?.addEventListener(`change`,e=>{if(!e.target.classList.contains(`plan-check`))return;let t=e.target.value;e.target.checked?U.seleccionados.add(t):U.seleccionados.delete(t),Sc()}),e.querySelector(`#planes-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&Cc(r),n===`delete`&&Dc(r),n===`approve`&&Tc(r),n===`view`&&wc(r),n===`ejecutar`&&Ec(r)})}function xc(){let e=U.container.querySelector(`#buscar-plan`)?.value.toLowerCase()||``,t=U.container.querySelector(`#select-estado`)?.value||``,n=U.container.querySelector(`#select-clase`)?.value||``,r=U.container.querySelector(`#select-maestro`)?.value||``;U.planes=W.planificaciones.filter(i=>{let a=(i.tema||``).toLowerCase().includes(e)||(i.clase_nombre||``).toLowerCase().includes(e),o=!t||i.estado===t,s=!n||i.clase_nombre===n,c=!r||i.maestro_nombre===r;return a&&o&&s&&c});let i=U.container.querySelector(`#planes-tbody`),a=U.container.querySelector(`#empty-container`);i&&(i.innerHTML=gc(U.planes)),a&&(a.innerHTML=U.planes.length===0?_c():``)}function Sc(){let e=U.container?.querySelector(`#btn-aprobar-bulk`);e&&(e.style.display=U.seleccionados.size>0?``:`none`)}async function Cc(e,t={}){let n=e&&W.getById(e)||new a(t);x.open({title:e?`Editar Plan de Clase`:`Nuevo Plan de Clase`,saveText:`Guardar Plan`,size:`lg`,body:`
    ...
    `,onOpen:async e=>{let{data:t}=await y.from(`clases`).select(`id, nombre`).order(`nombre`),r=e.querySelector(`#plan-clase_id`);r.innerHTML=`<option value="">Seleccionar clase...</option>`+(t||[]).map(e=>`<option value="${e.id}" ${e.id===n.clase_id?`selected`:``}>${i(e.nombre)}</option>`).join(``);let a=e.querySelector(`#plan-dsl-container`),o=Ke({initialContent:n.notas_dsl||``,onChange:(t,n)=>{let r=e.querySelector(`#plan-dsl-summary`);r&&n.items&&n.items.length>0&&(r.innerHTML=`<strong>Elementos:</strong> ${n.items.length} indicadores/actividades parseadas`)},onAlumnoClick:async()=>{let e=(await Xe()).slice(0,3).map(e=>`#${e.nombre_completo}`).join(`, `);o.component&&o.component.insertText(e+` `)}});a.appendChild(o),e._dslEditor=o},onSave:async t=>{let n=t._dslEditor,r={tema:t.querySelector(`#plan-tema`).value.trim(),clase_id:t.querySelector(`#plan-clase_id`).value,objetivos:t.querySelector(`#plan-objetivos`).value.trim(),contenido:t.querySelector(`#plan-contenido`)?.value.trim()||``,notas_dsl:n?n.getContent():``,fecha_inicio:t.querySelector(`#plan-fecha`).value||null,instrumento:t.querySelector(`#plan-instrumento`).value.trim()||null,evaluacion_metodo:t.querySelector(`#plan-eval`).value.trim()||null},i=new a(r).validate();if(i.length>0)return b.error(i[0]),!1;try{return e?(await se(e,r),b.success(`Plan actualizado correctamente`)):(await ee(r),b.success(`Plan creado correctamente`)),dc(U.container,{viewMode:U.viewMode}),!0}catch(e){return b.error(e.message),!1}}})}function wc(e){let t=W.getById(e);if(!t)return;let n=a.getEstadoConfig(t.estado);x.open({title:`Plan: ${t.clase_nombre||`Sin clase`}`,hideSave:!0,size:`lg`,body:`
    ...
    `})}async function Tc(e){try{await _e([e]),b.success(`Plan aprobado y marcado como revisado`),dc(U.container,{viewMode:U.viewMode})}catch(e){b.error(e.message)}}async function Ec(e){let t=W.getById(e);if(!t)return;let n=t.instrumento,r=null,i=t.clase_id;if(i){let{data:e}=await y.from(`clases`).select(`instrumento, plan_estudio`).eq(`id`,i).single();e&&(n||=e.instrumento,r=e.plan_estudio)}let{data:{user:a}}=await y.auth.getUser(),{data:o}=await y.from(`maestros`).select(`id`).eq(`user_id`,a.id).single(),s=o?.id;Js({plan:t,claseId:i,instrumento:n,nivel:r,maestroId:s,onConfirm:async()=>{try{await se(e,{estado:`ejecutado`}),b.success(`Plan marcado como ejecutado`),dc(U.container,{viewMode:U.viewMode})}catch(e){b.error(e.message)}},onSkip:async()=>{try{await se(e,{estado:`ejecutado`}),b.success(`Plan ejecutado (sin cobertura)`),dc(U.container,{viewMode:U.viewMode})}catch(e){b.error(e.message)}}})}async function Dc(e){let n=W.getById(e);n&&x.open({title:`⚠️ Eliminar Plan`,saveText:`Eliminar`,body:`<p>¿Estás seguro de eliminar el plan <strong>"${i(n.tema)}"</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await t(e),b.success(`Plan eliminado`),dc(U.container,{viewMode:U.viewMode}),!0}catch(e){return b.error(e.message),!1}}})}function Oc(){S.register(`planificacion`,e=>dc(e,{viewMode:`maestro`})),S.register(`planificacion-plantillas`,e=>dc(e,{viewMode:`plantillas`})),S.register(`planificacion-maestros`,e=>dc(e,{viewMode:`admin`}))}var kc={attendance_min_rate:.7,attendance_window_weeks:4,grade_min_avg:6,grade_window_count:3,indicator_min_pass_rate:.5,indicator_window_weeks:4};async function Ac(){let{data:e,error:t}=await y.from(`alumnos`).select(`*`).order(`nombre_completo`,{ascending:!0});if(t)throw console.error(`Error cargando alumnos:`,t.message),Error(`No se pudieron cargar los alumnos`);return e}async function jc(){let{data:e,error:t}=await y.from(`clases`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando clases:`,t.message),Error(`No se pudieron cargar las clases`);return e}async function Mc(){let{data:e,error:t}=await y.from(`progresos`).select(`*`).order(`fecha_evaluacion`,{ascending:!1});if(t)throw console.error(`Error cargando progresos:`,t.message),Error(`No se pudieron cargar los progresos`);return e}async function Nc(e){if(!e.alumno_id)throw Error(`El alumno es obligatorio`);if(!e.clase_id)throw Error(`La clase es obligatoria`);if(!e.evaluacion_tipo)throw Error(`El tipo de evaluacion es obligatorio`);let t={alumno_id:e.alumno_id,clase_id:e.clase_id,maestro_id:e.maestro_id||null,fecha_evaluacion:e.fecha_evaluacion||null,evaluacion_tipo:e.evaluacion_tipo.trim(),calificacion:e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,estado_cualitativo:(e.estado_cualitativo||`en_progreso`).trim(),observaciones:(e.observaciones||``).trim(),indicadores:e.indicadores||null};if(e.sesion_clase_id&&(t.sesion_clase_id=e.sesion_clase_id),e.asistencia_id&&(t.asistencia_id=e.asistencia_id),e.ejercicio_id&&(t.ejercicio_id=e.ejercicio_id),t.calificacion!==null&&(t.calificacion<0||t.calificacion>5))throw Error(`La calificacion debe estar entre 0 y 5`);let{data:n,error:r}=await y.from(`progresos`).insert([t]).select();if(r)throw r.message.includes(`duplicate key`)||r.code===`23505`?Error(`Ya existe una evaluacion con ese tipo para este alumno en esta clase`):(console.error(`Error creando progreso:`,r.message),Error(`No se pudo crear el progreso`));return n[0]}async function Pc(e){let{data:t,error:n}=await y.from(`progresos`).select(`*`).eq(`clase_id`,e).order(`fecha_evaluacion`,{ascending:!1});if(n)throw console.error(`Error cargando progresos de la clase:`,n.message),Error(`No se pudieron cargar los progresos de la clase`);return t}async function Fc(e,t){let{jsPDF:n}=await rt(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-C6WUHrjo.js`).then(e=>e.n);return{jsPDF:e}},__vite__mapDeps([3,4,5,6])),{default:r}=await rt(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-BYntMLuC.js`).then(e=>e.n);return{default:e}},__vite__mapDeps([7,4])),i=new n,a=e.name||e.nombre||`Sin nombre`,o=e.section||`Sin sección`,s=Ic(t),c=s!==null&&Lc(s);i.setFontSize(18),i.text(`Boletín Académico`,14,22),i.setFontSize(11),i.text(`Alumno: ${a}`,14,32),i.text(`Sección: ${o}`,14,38),i.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,44);let l=c?`EN RIESGO`:`SATISFACTORIO`,u=c?[185,27,27]:[39,174,96];i.setFillColor(...u),i.rect(14,50,60,10,`F`),i.setTextColor(255,255,255),i.setFontSize(10),i.text(l,18,57),i.setTextColor(0,0,0),i.setFontSize(12),i.text(`Promedio: ${s===null?`N/A`:s.toFixed(2)}`,80,55),i.text(`Evaluaciones: ${t.length}`,80,62),t.length>0&&r(i,{head:[[`Fecha`,`Tipo`,`Calificación`,`Etiqueta`,`Observaciones`]],body:t.map(e=>[e.fecha_evaluacion?Rc(e.fecha_evaluacion):`-`,zc(e.tipo_evaluacion),e.calificacion===null?`-`:e.calificacion.toFixed(2),Bc(e.calificacion),e.observaciones?e.observaciones.substring(0,40)+(e.observaciones.length>40?`...`:``):`-`]),startY:70,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),i.save(`boletin-${a.replace(/\s+/g,`-`).toLowerCase()}.pdf`)}function Ic(e){if(!e||e.length===0)return null;let t=e.filter(e=>e.calificacion!==null&&e.calificacion!==void 0).map(e=>parseFloat(e.calificacion));return t.length===0?null:t.reduce((e,t)=>e+t,0)/t.length}function Lc(e){return e==null?!1:parseFloat(e)<3}function Rc(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):`-`}function zc(e){return{oral:`Oral`,escrita:`Escrita`,practica:`Práctica`,evaluacion_parcial:`Parcial`,evaluacion_final:`Final`}[e]||e||`-`}function Bc(e){if(e==null)return`-`;let t=parseFloat(e);return t>=4.5?`Sobresaliente`:t>=4?`Muy Bueno`:t>=3?`Bueno`:t>=2?`En Progreso`:`Necesita Mejorar`}var Vc=class e{constructor(e={}){this.id=e.id||null,this.alumno_id=e.alumno_id||``,this.clase_id=e.clase_id||``,this.maestro_id=e.maestro_id||null,this.fecha_evaluacion=e.fecha_evaluacion||``,this.tipo_evaluacion=e.tipo_evaluacion||e.evaluacion_tipo||``,this.calificacion=e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,this.observaciones=e.observaciones||``,this.estado=e.estado||`en_progreso`,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(){let t=[];this.alumno_id||t.push(`El alumno es obligatorio`),this.clase_id||t.push(`La clase es obligatoria`),!this.tipo_evaluacion||!this.tipo_evaluacion.trim()?t.push(`El tipo de evaluación es obligatorio`):e.getTiposEvaluacion().map(e=>e.value).includes(this.tipo_evaluacion)||t.push(`Tipo de evaluación no válido`),this.calificacion!==null&&this.calificacion!==void 0&&(isNaN(this.calificacion)||this.calificacion<0||this.calificacion>5)&&t.push(`La calificación debe estar entre 0.0 y 5.0`),this.observaciones&&this.observaciones.length>500&&t.push(`Las observaciones no pueden exceder 500 caracteres`);let n=e.getEstados().map(e=>e.value);return this.estado&&!n.includes(this.estado)&&t.push(`Estado no válido`),t}static getTiposEvaluacion(){return[{value:`parcial`,label:`Parcial`},{value:`final`,label:`Final`},{value:`continua`,label:`Continua`},{value:`oral`,label:`Oral`},{value:`escrita`,label:`Escrita`},{value:`practica`,label:`Práctica`}]}static getEstados(){return[{value:`en_progreso`,label:`En Progreso`,color:`bg-primary`},{value:`completado`,label:`Completado`,color:`bg-success`},{value:`pendiente`,label:`Pendiente`,color:`bg-secondary`}]}static getEstadoConfig(e){return this.getEstados().find(t=>t.value===e)||{value:e,label:e,color:`bg-secondary`}}toJSON(){return{alumno_id:this.alumno_id,clase_id:this.clase_id,maestro_id:this.maestro_id,fecha_evaluacion:this.fecha_evaluacion||null,tipo_evaluacion:this.tipo_evaluacion.trim(),calificacion:this.calificacion,observaciones:this.observaciones?this.observaciones.trim():null,estado:this.estado}}};function Hc(e){if(!e||e.length===0)return{promedio:null,total:0,enRiesgo:!1};let t=e.map(e=>e.calificacion).filter(e=>e!=null&&!isNaN(e));if(t.length===0)return{promedio:null,total:e.length,enRiesgo:!1};let n=t.reduce((e,t)=>e+t,0),r=parseFloat((n/t.length).toFixed(2));return{promedio:r,total:e.length,enRiesgo:r<3}}async function Uc(e){let t=await Pc(e),n={};return t.forEach(e=>{n[e.alumno_id]||(n[e.alumno_id]=[]),n[e.alumno_id].push(e)}),Object.entries(n).map(([e,t])=>({alumnoId:e,progresos:t,rendimiento:Hc(t)}))}var Wc={calcularRendimiento:Hc,getResumenProgresosClase:Uc},G={progresos:[],progresosOriginales:[],alumnos:[],clases:[],cargando:!1,filtroClase:`todas`,container:null};async function Gc(e){if(e)try{G.container=e,G.cargando=!0,Kc(e);let[t,n,r]=await Promise.all([Mc(),Ac(),jc()]);G.progresos=(t||[]).map(e=>new Vc(e)),G.progresosOriginales=[...G.progresos],G.alumnos=n||[],G.clases=r||[],G.cargando=!1,Jc(e),Xc(e)}catch(t){console.error(t),qc(e,t.message)}}function Kc(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function qc(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
  ...
  `}function Yc(){let e=G.container.querySelector(`#buscar-progreso`)?.value.trim().toLowerCase()||``,t=G.filtroClase,n={};G.progresosOriginales.forEach(r=>{let i=G.alumnos.find(e=>e.id===r.alumno_id),a=G.clases.find(e=>e.id===r.clase_id);t!==`todas`&&r.clase_id!==t||e&&!i?.nombre_completo.toLowerCase().includes(e)&&!a?.nombre.toLowerCase().includes(e)||(n[r.alumno_id]||(n[r.alumno_id]={alumno:i,lista:[]}),n[r.alumno_id].lista.push(r))});let r=Object.values(n);return r.length===0?`<tr><td colspan="5" class="text-center py-5 text-muted">No hay resultados.</td></tr>`:r.map(({alumno:e,lista:t})=>{let n=Wc.calcularRendimiento(t);return`
    ...
    `}).join(``)}function Xc(e){e.querySelector(`#select-clase`)?.addEventListener(`change`,t=>{G.filtroClase=t.target.value,e.querySelector(`#progresos-tbody`).innerHTML=Yc()}),e.querySelector(`#buscar-progreso`)?.addEventListener(`input`,()=>{e.querySelector(`#progresos-tbody`).innerHTML=Yc()}),e.querySelector(`#progresos-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,alumnoId:r}=t.dataset;n===`pdf`&&Zc(r),n===`view-detail`&&Qc(r)}),e.querySelector(`#btn-nueva-nota`)?.addEventListener(`click`,()=>$c())}async function Zc(e){let t=G.alumnos.find(t=>t.id===e),n=G.progresosOriginales.filter(t=>t.alumno_id===e);b.info(`Generando boletín institucional...`);try{await Fc(t,n),b.success(`Boletín generado exitosamente`)}catch(e){b.error(`Error al generar PDF: `+e.message)}}function Qc(e){let t=G.alumnos.find(t=>t.id===e),n=G.progresosOriginales.filter(t=>t.alumno_id===e),r=Wc.calcularRendimiento(n);x.open({title:`Detalle Académico: ${t.nombre_completo}`,size:`lg`,hideSave:!0,body:`
      <div class="row g-3 mb-4">
        <div class="col-md-4">
    ...
    `})}function $c(){x.open({title:`Registrar Nueva Calificación`,saveText:`Guardar Nota`,body:`
      <form id="form-nota" class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select class="form-select input-dense" id="nota-tipo" required>
            ${Vc.getTiposEvaluacion().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-4">
    ...
    `,onSave:async e=>{let t={alumno_id:e.querySelector(`#nota-alumno_id`).value,clase_id:e.querySelector(`#nota-clase_id`).value,tipo_evaluacion:e.querySelector(`#nota-tipo`).value,calificacion:parseFloat(e.querySelector(`#nota-valor`).value),fecha_evaluacion:e.querySelector(`#nota-fecha`).value,observaciones:e.querySelector(`#nota-obs`).value.trim()},n=new Vc(t).validate();if(n.length>0)return b.error(n[0]),!1;try{return await Nc(t),b.success(`Nota registrada exitosamente`),Gc(G.container),!0}catch(e){return b.error(e.message),!1}}})}function el(){S.register(`progresos`,Gc)}function tl(e){return e?Array.isArray(e)?e.map(e=>new _(e)):new _(e):null}async function nl(){let{data:e,error:t}=await y.from(`observaciones_alumnos`).select(`
      *,
      alumno:alumnos(nombre_completo),
      maestro:maestros(nombre_completo)
    `).order(`fecha_observacion`,{ascending:!1});if(t)throw console.error(`Error cargando observaciones:`,t.message),Error(`No se pudieron cargar las observaciones`);return e.map(e=>{let t=new _(e);return t.alumno_nombre=e.alumno?.nombre_completo||`Desconocido`,t.maestro_nombre=e.maestro?.nombre_completo||`N/A`,t})}async function rl(e){let t=new _(e),n=t.validate();if(n.length>0)throw Error(n[0]);let{data:r,error:i}=await y.from(`observaciones_alumnos`).insert([t.toJSON()]).select();if(i)throw i;return tl(r[0])}async function il(e,t){let{data:n}=await y.from(`observaciones_alumnos`).select(`*`).eq(`id`,e).single(),r=new _({...n,...t}),i=r.validate();if(i.length>0)throw Error(i[0]);let{data:a,error:o}=await y.from(`observaciones_alumnos`).update(r.toJSON()).eq(`id`,e).select();if(o)throw o;return tl(a[0])}async function al(e){let{error:t}=await y.from(`observaciones_alumnos`).delete().eq(`id`,e);if(t)throw t}async function ol(e,t){let{data:n,error:r}=await y.from(`observaciones_alumnos`).update({seguimiento_observacion:t.trim(),seguimiento_fecha:new Date().toISOString().split(`T`)[0],estado:`seguimiento`,requiere_seguimiento:!0}).eq(`id`,e).select();if(r)throw r;return tl(n[0])}async function sl(){let{data:e,error:t}=await y.from(`observaciones_alumnos`).select(`estado, prioridad, tipo`);if(t)throw t;return{total:e.length,abiertas:e.filter(e=>e.estado===`abierta`).length,seguimiento:e.filter(e=>e.estado===`seguimiento`).length,altas:e.filter(e=>e.prioridad===`alta`).length,porTipo:e.reduce((e,t)=>(e[t.tipo]=(e[t.tipo]||0)+1,e),{})}}function cl(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}var K={observaciones:[],observacionesOriginales:[],alumnos:[],estadisticas:null,cargando:!1,filtroTipo:``,filtroEstado:`todos`,container:null};async function ll(e){if(e)try{K.container=e,K.cargando=!0,ul(e);let[t,n,r]=await Promise.all([nl(),Je().catch(()=>[]),sl().catch(()=>null)]);K.observaciones=t,K.observacionesOriginales=[...t],K.alumnos=n,K.estadisticas=r,K.cargando=!1,fl(e),hl(e)}catch(t){console.error(t),dl(e,t.message)}}function ul(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function dl(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
          <h5 class="alert-heading mb-1">Tabla no encontrada o sin acceso</h5>
          <p class="mb-2 small">${cl(t)}</p>
    ...
    </div>`,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>ll(e))}function fl(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${K.observaciones.length===0?ml():``}</div>
      </div>
    </div>
  `}function pl(e){return e.map(e=>{let t=_.getTipos().find(t=>t.value===e.tipo),n=_.getPrioridades().find(t=>t.value===e.prioridad),r=_.getEstados().find(t=>t.value===e.estado),i=e.prioridad===`alta`?`border-accent-danger`:e.prioridad===`media`?`border-accent-warning`:`border-accent-secondary`;return`
      <tr data-id="${e.id}" class="border-start-accent ${i}">
        <td>
          <div class="fw-bold text-truncate" style="max-width: 250px;">${cl(e.titulo)}</div>
          <div class="small text-muted">${cl(e.alumno_nombre)}</div>
        </td>
        <td class="d-none d-md-table-cell align-middle">
          <div class="d-flex align-items-center gap-2">
    ...
    `}).join(``)}function ml(){return`<div class="text-center py-5 text-muted"><i class="bi bi-chat-left-dots fs-1 d-block mb-2"></i>No se encontraron observaciones.</div>`}function hl(e){e.querySelector(`#buscar-obs`)?.addEventListener(`input`,gl),e.querySelector(`#select-tipo`)?.addEventListener(`change`,gl),e.querySelector(`#obs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&_l(r),n===`delete`&&yl(r),n===`follow`&&vl(r)}),e.querySelector(`#btn-nueva-obs`)?.addEventListener(`click`,()=>_l(null))}function gl(){let e=K.container.querySelector(`#buscar-obs`).value.toLowerCase(),t=K.container.querySelector(`#select-tipo`).value;K.observaciones=K.observacionesOriginales.filter(n=>{let r=n.titulo.toLowerCase().includes(e)||n.alumno_nombre.toLowerCase().includes(e),i=!t||n.tipo===t;return r&&i}),K.container.querySelector(`#obs-tbody`).innerHTML=pl(K.observaciones)}async function _l(e){let t=e?K.observacionesOriginales.find(t=>t.id===e):new _;x.open({title:e?`Editar Observación`:`Nueva Observación`,saveText:`Guardar`,body:`
      <form id="form-obs" class="row g-3">
        <div class="col-12">
          <label class="form-label-compact">Alumno *</label>
          <select class="form-select input-dense" id="obs-alumno_id" required>
            <option value="">Seleccionar alumno...</option>
            ${K.alumnos.map(e=>`<option value="${e.id}" ${e.id===t.alumno_id?`selected`:``}>${cl(e.nombre_completo)}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-8">
          <label class="form-label-compact">Título de la Incidencia *</label>
          <input type="text" class="form-control input-dense" id="obs-titulo" value="${cl(t.titulo)}" required>
        </div>
        <div class="col-md-4">
          ...
          <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                  <input type="date" class="form-control form-control-sm" id="genDesde" value="${Il()}">
                  <input type="date" class="form-control form-control-sm" id="genHasta" value="${Fl()}">
                </div>
              </div>
              <div class="mb-3">
  ...
  `}function Tl(e){let t={diaria:`danger`,semanal:`warning`,mensual:`info`}[e.frecuencia]||`secondary`;return`
...
`).filter(e=>e.trim()!==``),c=65;s.forEach(e=>{let t=a.splitTextToSize(e.trim(),o-28);c+t.length*5>280&&(a.addPage(),c=20),a.text(t,14,c),c+=t.length*5+2}),n&&n.length>0&&i(a,{startY:c+10,head:[[`Indicador / Estudiante`,`Valor`,`Unidad`]],body:n.map(e=>[e.nombre,e.valor,e.unidad]),theme:`striped`,headStyles:{fillColor:[41,128,185]},styles:{fontSize:9}});let l=a.internal.getNumberOfPages();for(let e=1;e<=l;e++)a.setPage(e),a.setFontSize(8),a.setTextColor(150),a.text(`Página ${e} de ${l} - Generado por SOI Intelligence`,o/2,290,{align:`center`});a.save(`Reporte_SOI_${e.replace(/\s+/g,`_`)}.pdf`),b.success(`PDF descargado con éxito`)}function Nl(e,t){let n=q.reportes.find(t=>t.id===e);n&&x.open({title:`Editar Reporte`,size:`md`,saveText:`Guardar`,body:`
    ...
    `,onSave:()=>{let n=q.reportes.findIndex(t=>t.id===e);n!==-1&&(q.reportes[n]={...q.reportes[n],nombre:document.getElementById(`editReporteNombre`).value,descripcion:document.getElementById(`editReporteDesc`).value,tipo:document.getElementById(`editReporteTipo`).value,frecuencia:document.getElementById(`editReporteFreq`).value}),wl(t),x.close()}})}function Pl(e){let t=e.querySelector(`#generarAhoraSelect`).value;e.querySelector(`#genDesde`).value,e.querySelector(`#genHasta`).value;let n=e.querySelector(`input[name="genFormat"]:checked`).value;if(!t){alert(`Selecciona un reporte`);return}x.showLoading(`Generando reporte...`),setTimeout(()=>{x.close();let e=new Blob([`Reporte generado`],{type:`text/plain`}),r=URL.createObjectURL(e),i=document.createElement(`a`);i.href=r,i.download=`reporte-${t}-${new Date().toISOString().slice(0,10)}.${n}`,i.click(),URL.revokeObjectURL(r)},1500)}function Fl(){return new Date().toISOString().slice(0,10)}function Il(){let e=new Date;return e.setDate(e.getDate()-7),e.toISOString().slice(0,10)}function Ll(){S.register(`metricas`,Ee),S.register(`metricas-alertas`,Ee),S.register(`metricas-riesgo`,Ee),S.register(`metricas-maestros`,Ee),S.register(`metricas-destacados`,Ee),S.register(`metricas-ia-reportes`,Sl)}new class{constructor(){this.cache=new Map,this.cacheExpiry=300*1e3}getCached(e){let t=this.cache.get(e);return t&&Date.now()-t.timestamp<this.cacheExpiry?t.data:null}setCached(e,t){this.cache.set(e,{data:t,timestamp:Date.now()})}async getDashboardData(){let e=this.getCached(`dashboard`);if(e)return e;let t={periodoActivo:await ve(),alertas:await Ne(),alertasActivas:await he()};return this.setCached(`dashboard`,t),t}async getTasaAsistenciaAlumno(e,t=30){let n=new Date;return n.setDate(n.getDate()-t),Oe(e,n.toISOString().split(`T`)[0])}calcularPorcentaje(e,t){return e<t.rojo?`rojo`:e<t.naranja?`naranja`:e<t.amarillo?`amarillo`:`verde`}generarAlertas(e,t){let n=[];return e<t.umbral_rojo?n.push({nivel:`rojo`,mensaje:`Asistencia crítica`}):e<t.umbral_naranja?n.push({nivel:`naranja`,mensaje:`Asistencia baja`}):e<t.umbral_amarillo&&n.push({nivel:`amarillo`,mensaje:`Precaución`}),n}clearCache(){this.cache.clear()}};function Rl(){S.register(`configuracion`,async e=>{let{renderConfigView:t}=await rt(async()=>{let{renderConfigView:e}=await import(`./configView-BH05qUt9.js`);return{renderConfigView:e}},__vite__mapDeps([8,9,4,1,10]));await t(e)}),S.register(`importar-datos`,async e=>{let{renderImportView:t}=await rt(async()=>{let{renderImportView:e}=await import(`./importView-BGTx_H7m.js`);return{renderImportView:e}},__vite__mapDeps([11,1]));await t(e)})}function zl(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function Bl(e){let t=e.progress_percentage||0,n=t<40?`progress-low`:t<80?`progress-mid`:`progress-high`,r=e.health_status||`not_started`,i=e.last_activity_at?new Date(e.last_activity_at).toLocaleDateString():`Sin actividad`;return`
        <tr>
            <td>
                <div class="d-flex align-items-center gap-2">
    ...
    `}function Vl(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function Hl(e){let t=e.failure_percentage||0;return`
...
`,Object.entries(t.byTrend).forEach(([t,n])=>{e+=`${t},${n}\n`}),e}return t}catch(e){throw console.error(`[exportComplianceReport] Error:`,e),e}}async function Xl(e=30){try{let t=new Date(Date.now()-e*24*60*60*1e3).toISOString().split(`T`)[0],n=(await dt()).filter(e=>e.fecha>=t),r=Gl(n),i=Kl(n);return{daysBack:e,total_classes:n.length,total_maestros:Object.keys(i).length,date_trends:r,maestro_trends:i,institution_summary:{avg_ai_usage_institution:n.length>0?(n.reduce((e,t)=>e+(t.uso_ai_fill_percent||0),0)/n.length).toFixed(1):0,asistencia_first_percent:n.length>0?(n.filter(e=>e.orden_asistencia_primero===1).length/n.length*100).toFixed(1):0,observaciones_first_percent:n.length>0?(n.filter(e=>e.orden_observaciones_primero===1).length/n.length*100).toFixed(1):0},generatedAt:new Date().toISOString()}}catch(e){throw console.error(`[getInstitutionTrendReportWithFilling] Error:`,e),e}}var Zl=class{constructor(e){this.containerId=e,this.container=document.getElementById(e),this.summary=null,this.critical=null}async init(){try{this.container.innerHTML=`
      ...
      `}}async loadData(){this.summary=await ql(),this.critical=await Jl()}render(){let e=`
    ...
    `}return{async init(){t.innerHTML=`
      ...
      `;try{n=await Xl(30),this.render()}catch(e){console.error(`[directorTrendReportView] Error:`,e),t.innerHTML=`
          <div class="premium-error-card">
            <i class="bi bi-exclamation-triangle-fill"></i>
      ...
      `}}}function $l(){S.register(`admin-dashboard`,e=>{try{e.innerHTML=`<div id="admin-dashboard-container"></div>`,new ut(`admin-dashboard-container`).init()}catch(t){console.error(`[admin-dashboard] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar cumplimiento: ${t.message}</p></div>`}}),S.register(`admin-dashboard-reportes`,e=>{try{e.innerHTML=`<div id="director-reporting-container"></div>`,new Zl(`director-reporting-container`).init()}catch(t){console.error(`[admin-dashboard-reportes] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar reportes: ${t.message}</p></div>`}}),S.register(`admin-dashboard-analitca-llenado`,e=>{try{e.innerHTML=`<div id="analytics-filling-container"></div>`,ft(`analytics-filling-container`).init()}catch(t){console.error(`[admin-dashboard-analitca-llenado] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar analítica: ${t.message}</p></div>`}}),S.register(`admin-dashboard-tendencias`,e=>{try{e.innerHTML=`<div id="trend-report-container"></div>`,Ql(`trend-report-container`).init()}catch(t){console.error(`[admin-dashboard-tendencias] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar tendencias: ${t.message}</p></div>`}})}var eu=[{id:`perm-001`,maestro_id:`maestro_001`,maestro_nombre:`Carlos Méndez`,maestro_email:`carlos.mendez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`planificacion:write`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-15T10:00:00Z`,actualizado_en:`2026-05-01T14:30:00Z`},{id:`perm-002`,maestro_id:`maestro_002`,maestro_nombre:`María López`,maestro_email:`maria.lopez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!1,permisos:[`alumnos:create`,`planificacion:write`],solicitudes:[`clases:enroll`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-02-20T09:00:00Z`,actualizado_en:`2026-04-10T11:00:00Z`},{id:`perm-003`,maestro_id:`maestro_003`,maestro_nombre:`Ana Martínez`,maestro_email:`ana.martinez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[`alumnos:create`],concedido_por:null,concedido_por_nombre:null,creado_en:`2026-03-01T08:00:00Z`,actualizado_en:`2026-03-01T08:00:00Z`},{id:`perm-004`,maestro_id:`maestro_004`,maestro_nombre:`Pedro Ramírez`,maestro_email:`pedro.ramirez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-20T15:00:00Z`,actualizado_en:`2026-05-05T09:00:00Z`},{id:`perm-005`,maestro_id:`maestro_005`,maestro_nombre:`Laura Fernández`,maestro_email:`laura.fernandez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!0,permisos:[`clases:enroll`],solicitudes:[`alumnos:create`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-04-01T12:00:00Z`,actualizado_en:`2026-04-15T16:00:00Z`}],tu=e({actualizarPermiso:()=>ou,obtenerPermisoPorMaestro:()=>au,obtenerPermisos:()=>iu}),nu=(e=300)=>new Promise(t=>setTimeout(t,e)),J=[...eu];function ru(e){return e?{id:e.id,maestro_id:e.maestro_id??``,maestro_nombre:e.maestro_nombre??``,maestro_email:e.maestro_email??``,puede_registrar_alumnos:e.puede_registrar_alumnos??!1,puede_inscribir_clases:e.puede_inscribir_clases??!1,permisos:Array.isArray(e.permisos)?e.permisos:[],solicitudes:Array.isArray(e.solicitudes)?e.solicitudes:[],concedido_por:e.concedido_por??null,concedido_por_nombre:e.concedido_por_nombre??null,creado_en:e.creado_en||null,actualizado_en:e.actualizado_en||null}:null}async function iu(){return await nu(),J.map(ru)}async function au(e){await nu();let t=J.find(t=>t.maestro_id===e);return t?ru(t):{id:null,maestro_id:e,maestro_nombre:``,maestro_email:``,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[],concedido_por:null,concedido_por_nombre:null,creado_en:null,actualizado_en:null}}async function ou(e,t){await nu();let n=J.findIndex(t=>t.maestro_id===e),r=new Date().toISOString();if(n===-1){let n={id:Math.random().toString(36).substr(2,9),maestro_id:e,maestro_nombre:t.maestro_nombre||``,maestro_email:t.maestro_email||``,puede_registrar_alumnos:t.puede_registrar_alumnos??!1,puede_inscribir_clases:t.puede_inscribir_clases??!1,permisos:Array.isArray(t.permisos)?t.permisos:[],solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:[],concedido_por:t.concedido_por||null,concedido_por_nombre:t.concedido_por_nombre||null,creado_en:r,actualizado_en:r};return J.push(n),ru(n)}return J[n]={...J[n],puede_registrar_alumnos:t.puede_registrar_alumnos??J[n].puede_registrar_alumnos,puede_inscribir_clases:t.puede_inscribir_clases??J[n].puede_inscribir_clases,permisos:Array.isArray(t.permisos)?t.permisos:J[n].permisos,solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:J[n].solicitudes,concedido_por:t.concedido_por??J[n].concedido_por,concedido_por_nombre:t.concedido_por_nombre??J[n].concedido_por_nombre,actualizado_en:r},ru(J[n])}var su=()=>r.isDemoMode?tu:at,cu=(...e)=>su().obtenerPermisos(...e),lu=(...e)=>su().actualizarPermiso(...e),Y={permisos:[],cargando:!1,togglingId:null,togglingField:null};function X(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}async function uu(e){try{Y.cargando=!0,du(e),Y.permisos=await cu(),Y.cargando=!1,pu(e),_u(e)}catch(t){console.error(t),fu(e,t.message)}}function du(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
  ...
  `,document.getElementById(`retryBtn`)?.addEventListener(`click`,()=>uu(e))}function pu(e){let t=T.getUser?T.getUser():null;t?.nombre_completo||t?.email,e.innerHTML=`
    <div class="page-container">
      <!-- Page Header -->
      ...
      <div class="mt-3 text-muted small">
        ...
        ${r.isDemoMode?`<span class="badge bg-warning text-dark ms-1">Demo</span>`:``}
      </div>
    </div>
  `}function mu(){return Y.permisos.map(e=>{let t=Y.togglingId===e.maestro_id,n=e.concedido_por_nombre||e.concedido_por||`-`,r=e.actualizado_en?new Date(e.actualizado_en).toLocaleDateString(`es-ES`,{day:`numeric`,month:`short`}):`-`,i=e.solicitudes||[],a=!e.puede_registrar_alumnos&&i.includes(`alumnos:create`),o=!e.puede_inscribir_clases&&i.includes(`clases:enroll`);return`
      <tr data-maestro-id="${X(e.maestro_id)}">
        <td>
          <div class="d-flex align-items-center gap-2">
            <div class="avatar-compact bg-primary text-white">${gu(e.maestro_nombre||e.maestro_id)}</div>
  ...
  `}function gu(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function _u(e){let t=e.querySelector(`#permisosTable`);t&&(t.addEventListener(`change`,async t=>{let n=t.target.closest(`.permiso-toggle`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.field,a=n.checked;n.disabled=!0,Y.togglingId=r,Y.togglingField=i;let o=n.closest(`.form-check`)?.querySelector(`span`);o&&(o.textContent=a?`Sí`:`No`,o.className=`small ${a?`text-success`:`text-muted`}`);try{let t=Y.permisos.find(e=>e.maestro_id===r),n={[i]:a};if(t){if(a){let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=t.permisos||[];r.includes(e)||r.push(e);let a=(t.solicitudes||[]).filter(t=>t!==e),o=T.getUser?T.getUser():null,s=o?.nombre_completo||o?.email||`Administrador`;n={...n,permisos:r,solicitudes:a,concedido_por:o?.id||`admin`,concedido_por_nombre:s},t.permisos=r,t.solicitudes=a,t.concedido_por=o?.id||`admin`,t.concedido_por_nombre=s}else{let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=(t.permisos||[]).filter(t=>t!==e);n={...n,permisos:r},t.permisos=r}t.actualizado_en=new Date().toISOString()}await lu(r,n),t&&(t[i]=a),b.success(`Permiso actualizado: ${i===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let o=e.querySelector(`#permisosTBody`);o&&(o.innerHTML=mu())}catch(e){n.checked=!a,o&&(o.textContent=a?`No`:`Sí`,o.className=`small ${a?`text-muted`:`text-success`}`),b.error(`Error al actualizar permiso: `+e.message)}finally{n.disabled=!1,Y.togglingId=null,Y.togglingField=null}}),t.addEventListener(`click`,async t=>{let n=t.target.closest(`.aprobar-btn`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.permiso,a=n.dataset.field;n.disabled=!0;let o=n.innerHTML;n.innerHTML=`<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>`;try{let t=Y.permisos.find(e=>e.maestro_id===r);if(!t)throw Error(`No se encontró el registro de permisos del maestro`);let n=t.permisos||[];n.includes(i)||n.push(i);let o=(t.solicitudes||[]).filter(e=>e!==i),s=T.getUser?T.getUser():null,c=s?.nombre_completo||s?.email||`Administrador`;await lu(r,{permisos:n,solicitudes:o,concedido_por:s?.id||`admin`,concedido_por_nombre:c,[a]:!0}),t.permisos=n,t.solicitudes=o,t.concedido_por=s?.id||`admin`,t.concedido_por_nombre=c,t[a]=!0,t.actualizado_en=new Date().toISOString(),b.success(`Solicitud aprobada: ${a===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let l=e.querySelector(`#permisosTBody`);l&&(l.innerHTML=mu())}catch(e){b.error(`Error al aprobar solicitud: `+e.message),n.disabled=!1,n.innerHTML=o}}))}function vu(){S.register(`permisos`,uu)}async function yu(e){if(e){e.innerHTML=Su();try{let[t,n]=await Promise.all([bu(),xu()]);e.innerHTML=Cu(t,n),Eu(e)}catch(t){console.error(`[DashboardPedagogico]`,t),e.innerHTML=`
    ...
    </div>`}function Cu(e,t){let n=e.tasaAsistencia===null?`secondary`:e.tasaAsistencia>=80?`success`:e.tasaAsistencia>=60?`warning`:`danger`;return`
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        <div class="brand-badge bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center" style="width:42px;height:42px;">
          <i class="bi bi-grid-1x2 fs-4"></i>
      ...
      <div class="row g-3 mb-4">
        ${wu(`bi-people-fill`,`Alumnos activos`,e.alumnosActivos,`primary`,null)}
        ${wu(`bi-easel2`,`Clases activas`,e.clasesActivas,`indigo`,null)}
        ${wu(`bi-journal-text`,`Planes esta semana`,e.planesEstaSemana,`success`,`${e.planesEjecutados} ejecutados · ${e.planesPlanificados} pendientes`)}
        ${wu(`bi-calendar-check`,`Asistencia (7 días)`,e.tasaAsistencia===null?`—`:e.tasaAsistencia+`%`,n,null)}
      </div>
      ...
      <div class="row g-3">
        ${Tu(`bi-journal-text`,`Planificación`,`Planes de clase, plantillas y revisión`,`planificacion`,`primary`)}
        ${Tu(`bi-person-lines-fill`,`Seguimiento`,`Progreso y asistencia por alumno`,`pedagogico-seguimiento`,`success`)}
        ${Tu(`bi-graph-up`,`Evaluaciones`,`Calificaciones y boletines`,`progresos`,`warning`)}
        ${Tu(`bi-file-earmark-bar-graph`,`Reportes`,`Rendimiento por clase y riesgo`,`pedagogico-reportes`,`info`)}
      </div>
    </div>`}function wu(e,t,n,r,i){return`
    <div class="col-6 col-md-3">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body">
    ...
    <div class="page-container">
      ...
      <div class="d-flex flex-column gap-2" id="lista-alumnos">
        ${i.map(e=>ju(e)).join(``)||`<div class="text-center text-muted py-5">Sin resultados</div>`}
      </div>
    </div>`,Mu()}function ju(e){let t=ku(e.id),n=Z.asistenciaMap[e.id],r=Z.progresosMap[e.id],i=Z.observacionesMap[e.id]||[],a=n?.rate==null?null:Math.round(n.rate*100),o=a===null?`secondary`:a>=80?`success`:a>=60?`warning`:`danger`,s=r?r.promedio>=7?`success`:r.promedio>=5?`warning`:`danger`:`secondary`;return`
    ...
    <div class="page-container">
      ...
      <h6 class="text-muted text-uppercase mb-2" style="font-size:0.72rem;letter-spacing:0.08em;">
        Alumnos en riesgo — asistencia &lt; ${Math.round(kc.attendance_min_rate*100)}% (4 semanas)
      </h6>
      ${t.length?`
      <div class="card border-0 shadow-sm">
        <div class="table-responsive">
    ...
    </div>`}function zu(){S.register(`pedagogico-dashboard`,e=>yu(e)),S.register(`pedagogico-seguimiento`,e=>Du(e)),S.register(`pedagogico-reportes`,e=>Fu(e))}var Bu=[{id:`m-001`,nombre:`Carlos Méndez`,especialidad:`Violín`,habilidades:[`violín`,`viola`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],martes:[{inicio:`10:00`,fin:`13:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],jueves:[{inicio:`10:00`,fin:`13:00`}],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-002`,nombre:`María Torres`,especialidad:`Piano`,habilidades:[`piano`,`teclado`,`teoría musical`],disponibilidad:{lunes:[{inicio:`14:00`,fin:`19:00`}],martes:[{inicio:`10:00`,fin:`19:00`}],miércoles:[{inicio:`14:00`,fin:`19:00`}],jueves:[{inicio:`10:00`,fin:`19:00`}],viernes:[],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-003`,nombre:`José Ramírez`,especialidad:`Percusión`,habilidades:[`percusión`,`batería`,`timbales`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`14:00`}],martes:[{inicio:`10:00`,fin:`14:00`}],miércoles:[{inicio:`10:00`,fin:`14:00`}],jueves:[{inicio:`10:00`,fin:`14:00`}],viernes:[{inicio:`10:00`,fin:`14:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}},{id:`m-004`,nombre:`Ana Luisa Herrera`,especialidad:`Cello`,habilidades:[`cello`,`contrabajo`,`música de cámara`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`19:00`}],martes:[],miércoles:[{inicio:`10:00`,fin:`19:00`}],jueves:[],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-005`,nombre:`Roberto Sánchez`,especialidad:`Guitarra`,habilidades:[`guitarra`,`cuatro`,`mandolina`],disponibilidad:{lunes:[{inicio:`15:00`,fin:`19:00`}],martes:[{inicio:`15:00`,fin:`19:00`}],miércoles:[{inicio:`15:00`,fin:`19:00`}],jueves:[{inicio:`15:00`,fin:`19:00`}],viernes:[{inicio:`15:00`,fin:`19:00`}],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-006`,nombre:`Luisa Fernanda Díaz`,especialidad:`Voz`,habilidades:[`voz`,`coro`,`técnica vocal`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`}],martes:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`}],jueves:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],viernes:[{inicio:`10:00`,fin:`13:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}}],Vu=[{id:`s-101`,nombre:`Salón Mozart (Grande)`,capacidad:30,piso:1,is_active:!0},{id:`s-102`,nombre:`Salón Beethoven (Mediano)`,capacidad:15,piso:1,is_active:!0},{id:`s-103`,nombre:`Salón Bach (Piano)`,capacidad:10,piso:2,is_active:!0},{id:`s-104`,nombre:`Salón Vivaldi (Violín)`,capacidad:8,piso:2,is_active:!0},{id:`s-105`,nombre:`Salón Chopin (Teclados)`,capacidad:12,piso:2,is_active:!0}],Hu=[{id:`c-001`,nombre:`Violín Inicial`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:10,total_alumnos:6,horarios:[]},{id:`c-002`,nombre:`Violín Intermedio`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:8,total_alumnos:5,horarios:[]},{id:`c-003`,nombre:`Piano Inicial A`,instrumento:`Piano`,maestro_principal_id:`m-002`,capacidad_maxima:12,total_alumnos:10,horarios:[]},{id:`c-004`,nombre:`Teoría y Solfeo I`,instrumento:`Solfeo`,maestro_principal_id:`m-006`,capacidad_maxima:25,total_alumnos:18,horarios:[]},{id:`c-005`,nombre:`Batería Básica`,instrumento:`Percusión`,maestro_principal_id:`m-003`,capacidad_maxima:6,total_alumnos:4,horarios:[]},{id:`c-006`,nombre:`Guitarra Clásica I`,instrumento:`Guitarra`,maestro_principal_id:`m-005`,capacidad_maxima:15,total_alumnos:11,horarios:[]},{id:`c-007`,nombre:`Cello y Cámara`,instrumento:`Cello`,maestro_principal_id:`m-004`,capacidad_maxima:8,total_alumnos:3,horarios:[]},{id:`c-008`,nombre:`Técnica Vocal A`,instrumento:`Voz`,maestro_principal_id:`m-006`,capacidad_maxima:10,total_alumnos:8,horarios:[]}],Uu=[];async function Wu(){let{data:e,error:t}=await y.from(`salones`).select(`id, nombre, capacidad, is_active`).eq(`is_active`,!0).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar salones reales: `+t.message);return e}async function Gu(){let{data:e,error:t}=await y.from(`clases`).select(`id, nombre, maestro_principal_id, capacidad_maxima, instrumento`).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar clases reales: `+t.message);let{data:n}=await y.from(`clase_horarios`).select(`*`),{data:r}=await y.from(`alumnos_clases`).select(`clase_id`);return(e||[]).map(e=>{let t=(n||[]).filter(t=>t.clase_id===e.id),i=(r||[]).filter(t=>t.clase_id===e.id).length;return{id:e.id,nombre:e.nombre,instrumento:e.instrumento||`General`,maestro_principal_id:e.maestro_principal_id,capacidad_maxima:e.capacidad_maxima||20,total_alumnos:i,horarios:t.map(e=>({dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id}))}})}async function Ku(){if(r.isDemoMode)return{maestros:Bu,salones:Vu,clases:Hu};try{let[e,t,n]=await Promise.all([Ze(),Wu(),Gu()]);return{maestros:e,salones:t,clases:n}}catch(e){throw console.error(`[horarioBuilderApi] Error fetching data:`,e),e}}async function qu(e){if(r.isDemoMode){let t={id:`run-${Date.now()}`,created_at:new Date().toISOString(),estado:e.estado||`borrador`,periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas};return Uu.push(t),t}let{data:t,error:n}=await y.from(`schedule_runs`).insert([{periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas,estado:e.estado||`borrador`}]).select().single();if(n)throw console.error(`[horarioBuilderApi] Error saving run:`,n),Error(`No se pudo guardar la corrida de horario: `+n.message);return t}async function Ju(){if(r.isDemoMode)return Uu;let{data:e,error:t}=await y.from(`schedule_runs`).select(`*`).order(`created_at`,{ascending:!1});if(t)throw console.error(`[horarioBuilderApi] Error fetching runs:`,t),Error(`No se pudieron obtener las corridas de horarios`);return e}var Yu={lunes:{inicio:`10:00`,fin:`19:00`},martes:{inicio:`10:00`,fin:`19:00`},miércoles:{inicio:`10:00`,fin:`19:00`},jueves:{inicio:`10:00`,fin:`19:00`},viernes:{inicio:`10:00`,fin:`19:00`},sábado:{inicio:`09:00`,fin:`13:00`},domingo:{inicio:`00:00`,fin:`00:00`}},Xu=[{id:`S1-2026`,nombre:`Semestre 1 (Ene–Jul 2026)`,inicio:`2026-01-01`,fin:`2026-07-31`},{id:`S2-2026`,nombre:`Semestre 2 (Ago–Dic 2026)`,inicio:`2026-08-01`,fin:`2026-12-31`}],Zu=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`}];function Qu(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function $u(e){let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`}function ed(e,t,n,r,i=0){return e<r+i&&n-i<t}function td(e,t,n){let r=e[t]||[],i=n[t];if(!i||i.inicio===`00:00`&&i.fin===`00:00`)return[];let a=Qu(i.inicio),o=Qu(i.fin),s=[];return r.forEach(e=>{let t=Qu(e.inicio),n=Qu(e.fin),r=Math.max(t,a),i=Math.min(n,o);r<i&&s.push({start:r,end:i})}),s}function nd({clasesConMaestro:e,maestros:t,salones:n,config:r}){let i={jornada:r?.jornada||Yu,gapMinimo:r?.gapMinimo===void 0?15:parseInt(r.gapMinimo),duracionBloque:r?.duracionBloque===void 0?60:parseInt(r.duracionBloque)},a=[],o=[],s={};t.forEach(e=>{s[e.id]=[]});let c={};n.forEach(e=>{c[e.id]=[]});let l=e.map(e=>{let n=t.find(t=>t.id===e.maestro_principal_id),r=0;return n&&n.disponibilidad&&Object.keys(n.disponibilidad).forEach(e=>{td(n.disponibilidad,e,i.jornada).forEach(e=>{r+=e.end-e.start})}),{...e,duracion:e.duracion||i.duracionBloque,totalAlumnos:e.total_alumnos||0,availableMinutes:r||1}});l.sort((e,t)=>e.availableMinutes===t.availableMinutes?t.totalAlumnos-e.totalAlumnos:e.availableMinutes-t.availableMinutes),l.forEach(e=>{let r=t.find(t=>t.id===e.maestro_principal_id);if(!r){o.push({clase_id:e.id,nombre:e.nombre,razon:`El maestro principal asignado (ID: ${e.maestro_principal_id}) no está registrado.`});return}let l=e.duracion,u=[];if(Object.keys(i.jornada).forEach(t=>{let a=i.jornada[t];if(!a||a.inicio===`00:00`&&a.fin===`00:00`)return;let o=td(r.disponibilidad||{},t,i.jornada);if(o.length===0)return;Qu(a.inicio),Qu(a.fin);let d=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1);d.length!==0&&o.forEach(e=>{for(let n=e.start;n+l<=e.end;n+=30){let e=n+l;(s[r.id]||[]).some(r=>r.day===t&&ed(n,e,r.start,r.end,i.gapMinimo))||d.forEach(a=>{(c[a.id]||[]).some(r=>r.day===t&&ed(n,e,r.start,r.end,i.gapMinimo))||u.push({day:t,start:n,end:e,salon:a,teacher:r})})}})}),u.length===0){let t=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1),i=`Sin disponibilidad compatible con maestro y salones.`;i=t.length===0?`No hay salones activos con capacidad suficiente para ${e.totalAlumnos} alumnos.`:`Conflicto de agenda: el maestro ${r.nombre} o los salones adecuados están ocupados en sus horas disponibles.`,o.push({clase_id:e.id,nombre:e.nombre,razon:i});return}u.forEach(t=>{let n=100,r=t.salon.capacidad-e.totalAlumnos;n-=Math.min(r*2,40);let i=(s[t.teacher.id]||[]).reduce((e,t)=>e+(t.end-t.start),0)/60;n-=Math.min(i*3,20),(s[t.teacher.id]||[]).some(e=>e.day===t.day&&(e.end===t.start||e.start===t.end))&&(n+=15),t.score=n}),u.sort((e,t)=>t.score-e.score);let d=u[0];a.push({clase_id:e.id,clase_nombre:e.nombre,maestro_id:r.id,maestro_nombre:r.nombre,salon_id:d.salon.id,salon_nombre:d.salon.nombre,dia:d.day,hora_inicio:$u(d.start),hora_fin:$u(d.end),color:rd(r.id)}),s[r.id].push({day:d.day,start:d.start,end:d.end,classId:e.id}),c[d.salon.id].push({day:d.day,start:d.start,end:d.end,classId:e.id})});let u=e.length,d=a.length,f=o.length,p={};n.forEach(e=>{let t=(c[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0),n=0;Object.keys(i.jornada).forEach(e=>{let t=i.jornada[e];t&&(t.inicio!==`00:00`||t.fin!==`00:00`)&&(n+=Qu(t.fin)-Qu(t.inicio))}),p[e.id]={nombre:e.nombre,porcentaje:Math.round(t/(n||1)*100)}});let m={};t.forEach(e=>{let t=(s[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0);m[e.id]={nombre:e.nombre,horas:Math.round(t/60*10)/10}});let h=u>0?d/u*100:100;return{assignments:a,noAsignadas:o,metricas:{totalClases:u,clasesAsignadas:d,clasesNoAsignadas:f,ocupacionSalones:p,cargaMaestros:m,score:Math.max(0,Math.round(h))}}}function rd(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function id(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function ad(e,t,n=0){let r=id(e.hora_inicio),i=id(e.hora_fin),a=id(t.hora_inicio);return r<id(t.hora_fin)+n&&a-n<i}function od(e,{returnAnnotated:t=!1,gapMinutes:n=0}={}){let r=[],i=new Set;for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let o=e[t],s=e[a];o.dia===s.dia&&ad(o,s,n)&&(o.maestro_id&&o.maestro_id===s.maestro_id&&(r.push({type:`teacher`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.maestro_nombre} tiene dos clases al mismo tiempo: "${o.clase_nombre}" y "${s.clase_nombre}"`}),i.add(o.clase_id),i.add(s.clase_id)),o.salon_id&&o.salon_id===s.salon_id&&(r.push({type:`room`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.salon_nombre} está ocupado por "${o.clase_nombre}" y "${s.clase_nombre}" al mismo tiempo`}),i.add(o.clase_id),i.add(s.clase_id)))}return t?{conflicts:r,assignments:e.map(e=>({...e,hasConflict:i.has(e.clase_id)}))}:r}function sd({conflictDescription:e}){return new Promise(t=>{let n=document.createElement(`div`);n.className=`modal-backdrop fade show`,n.style.zIndex=`1040`;let r=document.createElement(`div`);r.className=`modal fade show d-block`,r.style.zIndex=`1050`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
    ...
    `;let i=r.querySelector(`.modal-body p`);i&&(i.textContent=e);function a(e){document.body.removeChild(r),document.body.removeChild(n),t(e)}r.querySelector(`[data-action="confirm"]`).addEventListener(`click`,()=>a(!0)),r.querySelector(`[data-action="cancel"]`).addEventListener(`click`,()=>a(!1)),document.body.appendChild(n),document.body.appendChild(r)})}function cd(e,{assignments:t,onMove:n,onConflict:r}){let i=new AbortController,{signal:a}=i,o=null;return e.addEventListener(`dragstart`,e=>{let t=e.target.closest(`[draggable="true"][data-clase-id]`);t&&(o=t.dataset.claseId,t.classList.add(`hb-dragging`),e.dataTransfer&&(e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,o)))},{signal:a}),e.addEventListener(`dragend`,e=>{let t=e.target.closest(`[draggable="true"][data-clase-id]`);t&&t.classList.remove(`hb-dragging`),o=null},{signal:a}),e.addEventListener(`dragover`,e=>{let t=e.target.closest(`[data-day][data-hour]`);t&&(e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`move`),t.classList.contains(`hb-drop-target`)||t.classList.add(`hb-drop-target`))},{signal:a}),e.addEventListener(`dragleave`,e=>{let t=e.target.closest(`[data-day][data-hour]`);t&&(t.contains(e.relatedTarget)||t.classList.remove(`hb-drop-target`))},{signal:a}),e.addEventListener(`drop`,e=>{let i=e.target.closest(`[data-day][data-hour]`);if(!i)return;e.preventDefault(),i.classList.remove(`hb-drop-target`);let a=o??(e.dataTransfer?e.dataTransfer.getData(`text/plain`):null);if(!a)return;let s=i.dataset.day,c=i.dataset.hour,l=t.find(e=>String(e.clase_id)===String(a));if(!l)return;let u=l.dia,d=l.hora_inicio,f=od(t.map(e=>{if(String(e.clase_id)!==String(a))return e;let[t,n]=e.hora_inicio.split(`:`).map(Number),[r,i]=e.hora_fin.split(`:`).map(Number),o=r*60+i-(t*60+n),[l,u]=c.split(`:`).map(Number),d=l*60+u+o,f=`${String(Math.floor(d/60)).padStart(2,`0`)}:${String(d%60).padStart(2,`0`)}`;return{...e,dia:s,hora_inicio:c,hora_fin:f}}),{gapMinutes:0});f.length===0?n({claseId:a,fromDay:u,fromHour:d,toDay:s,toHour:c}):r({assignment:l,targetDay:s,targetHour:c,conflicts:f})},{signal:a}),{destroy(){i.abort()}}}var ld={piano:`#818cf8`,violín:`#34d399`,violin:`#34d399`,guitarra:`#f472b6`,canto:`#fb923c`,voz:`#ec4899`,percusión:`#a78bfa`,percusion:`#a78bfa`,solfeo:`#38bdf8`,cello:`#f59e0b`,flauta:`#06b6d4`,trompeta:`#84cc16`,general:`#94a3b8`};function ud(e=``){return ld[e.toLowerCase()]??ld.general}function dd(e=``){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function fd(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function pd(e,{draggable:t=!1}={}){let{clase_id:n,clase_nombre:r,instrumento:i=`General`,maestro_id:a,maestro_nombre:o=``,salon_nombre:s=``,hora_inicio:c,hora_fin:l,locked:u=!1,hasConflict:d=!1}=e,f=ud(i),p=dd(a||``),m=t&&!u,h=fd(o.split(` `).slice(0,2).map(e=>e[0]??``).join(``).toUpperCase()),g=d?`border: 2px solid #ef4444;`:`border: 2px solid transparent;`,ee=d?`<span class="sb-conflict-icon" title="Conflicto detectado">⚠</span>`:``,te=fd(n),ne=m?`<button class="sb-lock-btn" data-clase-id="${te}" data-locked="${u}"
    ...
    <div class="schedule-block"
      ...
      <div class="sb-header" style="background:${f};padding:3px 6px;display:flex;align-items:center;justify-content:space-between;gap:4px;">
        <span style="font-size:0.65rem;font-weight:700;color:#1e293b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;">${fd(r)}</span>
      ...
      <div class="sb-body" style="background:#f8fafc;padding:3px 6px;display:flex;align-items:center;gap:5px;">
        ...
        <span style="font-size:0.58rem;color:#475569;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${fd(o)}</span>
      </div>
      ${s?`<div style="background:#f1f5f9;padding:2px 6px;font-size:0.55rem;color:#64748b;border-top:1px solid #e2e8f0;">${fd(s)} · ${c}–${l}</div>`:``}
    </div>
  `}var md=`<p class="text-muted text-center py-4">No hay asignaciones para mostrar.</p>`;function hd(e){if(!e||!e.includes(`:`))return`00:00`;let[t]=e.split(`:`);return`${t.padStart(2,`0`)}:00`}function gd(e,t,n){let r=new Map;for(let t of e){let e=hd(t.hora_inicio);r.has(e)||r.set(e,new Map);let n=r.get(e),i=(t.dia||``).toLowerCase();n.has(i)||n.set(i,[]),n.get(i).push(t)}let i=[...r.keys()].sort(),a=Zu.map(e=>`<th class="sg-col-header" data-day="${e.key}" style="text-align:center;padding:4px 6px;font-size:0.75rem;">${e.label}</th>`).join(``),o=i.map(e=>{let n=r.get(e);return`<tr>
      <td class="sg-hour-label" style="font-size:0.7rem;color:#64748b;padding:4px 8px;white-space:nowrap;vertical-align:top;">${e}</td>
      ${Zu.map(r=>{let i=(n.get(r.key)||[]).map(e=>pd(e,{draggable:t})).join(``);return`<td class="sg-cell" data-day="${r.key}" data-hour="${e}" style="vertical-align:top;padding:3px;min-width:100px;">${i}</td>`}).join(``)}
    </tr>`}).join(``);return`
  ...
  `}function _d(e,t,n){let r=new Map;for(let n of e){let e=n[t]||`(Sin asignar)`;r.has(e)||r.set(e,[]),r.get(e).push(n)}return`<div class="schedule-grouped-view">${[...r.entries()].map(([e,t])=>{let r=t.map(e=>pd(e,{draggable:n})).join(``);return`
      <div class="sg-group" style="margin-bottom:1rem;">
        <h4 class="sg-group-title" style="font-size:0.85rem;font-weight:700;color:#1e293b;margin-bottom:0.5rem;">${fd(e)}</h4>
        <div class="sg-group-blocks" style="display:flex;flex-wrap:wrap;gap:6px;">${r}</div>
      </div>
    `}).join(``)}</div>`}function vd({assignments:e,activeView:t,draggable:n=!1,periodoId:r}={}){if(!e||e.length===0)return md;switch(t){case`teacher`:return _d(e,`maestro_nombre`,n);case`room`:return _d(e,`salon_nombre`,n);case`student`:return _d(e,`clase_nombre`,n);default:return gd(e,n,r)}}var yd=[`grid`,`teacher`,`room`,`student`],bd={grid:{label:`Grilla`,icon:`bi-grid-3x3`},teacher:{label:`Por Maestro`,icon:`bi-person-lines-fill`},room:{label:`Por Salón`,icon:`bi-door-open`},student:{label:`Por Alumno`,icon:`bi-mortarboard`}};function xd(e=`grid`){return bd[e]||(e=`grid`),`
    <div class="view-toggle" style="display:flex;gap:0.4rem;flex-wrap:wrap;" role="tablist" aria-label="Modo de visualización">
      ${yd.map(t=>{let{label:n,icon:r}=bd[t],i=t===e;return`
  ...
  `}var Sd={lunes:`Lun`,martes:`Mar`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sábado:`Sáb`};function Cd(e=[],t=!1){if(e.length===0)return``;let n=e.length,r=e.map((e,t)=>{e.type;let n=fd(Sd[e.day]??e.day);return`
      <div class="cp-row"
           ...
           ">
        <span style="background:#fecaca;color:#991b1b;border-radius:4px;padding:1px 5px;font-size:0.6rem;font-weight:700;flex-shrink:0;margin-top:1px;">${fd(e.type)}</span>
        <span style="font-size:0.72rem;color:#7f1d1d;line-height:1.4;">${n} ${e.hora_inicio} — ${fd(e.description)}</span>
      </div>
    `}).join(``);return`
  ...
  `}function wd(e,t,n){let r=e.querySelector(`.cp-header`),i=e.querySelector(`.cp-body`),a=e.querySelector(`.cp-chevron`);r?.addEventListener(`click`,()=>{let e=i.style.display!==`none`;i.style.display=e?`none`:`block`,a.className=`bi ${e?`bi-chevron-down`:`bi-chevron-up`}`}),e.querySelectorAll(`.cp-row`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{e.style.background=`#fff1f2`}),e.addEventListener(`mouseleave`,()=>{e.style.background=`transparent`}),e.addEventListener(`click`,()=>{let r=parseInt(e.dataset.conflictIndex,10);isNaN(r)||!t[r]||n?.(t[r])})})}var Td=[`borrador`,`revision`,`publicado`],Ed={borrador:`Borrador`,revision:`Revisión`,publicado:`Publicado`};function Dd(e){let t=document.createElement(`li`);t.className=`pw-feedback-item d-flex align-items-start gap-2 mb-1`;let n=document.createElement(`span`);n.className=`badge bg-secondary`,n.textContent=e.tipo;let r=document.createElement(`span`);return r.textContent=e.comentario,t.appendChild(n),t.appendChild(r),t}function Od(e,{runId:t,estadoActual:n,isAdmin:r,feedback:i=[],onEstadoChange:a,onFeedbackAdd:o}){let s=Td.indexOf(n);e.innerHTML=`
    <div class="pw-wizard">
      <!-- Stage indicators -->
      <div class="pw-stages d-flex align-items-center gap-2 mb-3">
        ${Td.map((e,t)=>{let n=`pw-stage`;t===s?n+=` pw-stage--active`:t<s&&(n+=` pw-stage--done`);let r=t<Td.length-1?`<div class="pw-stage-connector"></div>`:``;return`
      <div class="${n}" data-stage="${e}">
        <span class="pw-stage-dot"></span>
        <span class="pw-stage-label">${Ed[e]}</span>
      </div>
      ${r}
    `}).join(``)}
      </div>
  ...
  `;let c=e.querySelector(`.pw-send-revision-btn`);c&&c.addEventListener(`click`,()=>a?.(`revision`));let l=e.querySelector(`.pw-approve-btn`);l&&l.addEventListener(`click`,()=>a?.(`publicado`));let u=e.querySelector(`.pw-add-feedback-btn`),d=e.querySelector(`.pw-feedback-input`);function f(){let e=d?.value?.trim();e&&(o?.({comentario:e,tipo:`observacion`}),d&&(d.value=``))}u&&u.addEventListener(`click`,f),d&&d.addEventListener(`keydown`,e=>{e.key===`Enter`&&f()});let p=e.querySelector(`.pw-feedback-list`);p&&(p.innerHTML=``,(i||[]).forEach(e=>p.appendChild(Dd(e))))}async function kd(e){let{data:t,error:n}=await y.from(`schedule_run_feedback`).select(`*`).eq(`run_id`,e).order(`created_at`,{ascending:!0});if(n)throw n;return t}async function Ad({runId:e,comentario:t,tipo:n=`observacion`}){let{data:r,error:i}=await y.from(`schedule_run_feedback`).insert([{run_id:e,comentario:t,tipo:n}]).select().single();if(i)throw i;return r}async function jd(){let{data:{user:e}}=await y.auth.getUser();if(!e)return!1;let{data:t,error:n}=await y.from(`maestros`).select(`es_admin`).eq(`user_id`,e.id).single();return n||!t?!1:t.es_admin===!0}async function Md(e,t){let{data:n,error:r}=await y.from(`schedule_runs`).update({estado:t}).eq(`id`,e).select().single();if(r)throw r;return n}function Nd(){return{assignments:[],conflicts:[],activeView:`grid`,activePeriodo:Xu[0].id,draggable:!1,conflictPanelExpanded:!1,scheduleRuns:[],loading:!1,error:null,undoStack:[],redoStack:[],estado:`borrador`,runId:null,isAdmin:!1,feedback:[],publishWizardOpen:!1}}var Q=Nd(),$=null,Pd=null;function Fd(e){$=e,Q=Nd(),Id(),qd(),Ju().then(e=>{Q.scheduleRuns=e||[]}).catch(e=>console.warn(`[horarioBuilderView] getScheduleRuns failed:`,e)),jd().then(e=>{Q.isAdmin=e}).catch(()=>{})}function Id(){let e=Xu.map(e=>`<option value="${e.id}" ${e.id===Q.activePeriodo?`selected`:``}>${e.nombre}</option>`).join(``),t=Q.draggable?`bi-unlock-fill`:`bi-lock-fill`,n=Q.draggable?`Bloqueando`:`Editar`;$.innerHTML=`
    <div class="hb-view">
      <!-- Toolbar -->
  ...
  `}function Ld(){let e=$.querySelector(`#hb-grid-wrapper`);e&&(e.innerHTML=vd({assignments:Q.assignments,activeView:Q.activeView,draggable:Q.draggable,periodoId:Q.activePeriodo}))}function Rd(){let e=$.querySelector(`#hb-conflict-panel-wrapper`);if(!e)return;let t=e.querySelector(`.cp-body`);t&&(Q.conflictPanelExpanded=t.style.display===`block`),e.innerHTML=Cd(Q.conflicts,Q.conflictPanelExpanded),wd(e,Q.conflicts,e=>{let t=$.querySelector(`.hb-view`);e.ids.forEach(e=>{let n=t?.querySelector(`[data-clase-id="${e}"]`);n&&(n.scrollIntoView({behavior:`smooth`,block:`nearest`}),n.classList.add(`hb-highlight`),setTimeout(()=>n.classList.remove(`hb-highlight`),1500))})})}function zd(){let e=$.querySelector(`#hb-view-toggle-slot`);e&&(e.innerHTML=xd(Q.activeView))}function Bd(){let e=$.querySelector(`#hb-publish-wrapper`);if(e){if(!Q.publishWizardOpen||!Q.runId){e.style.display=`none`;return}e.style.display=``,Od(e,{runId:Q.runId,estadoActual:Q.estado,isAdmin:Q.isAdmin,feedback:Q.feedback,async onEstadoChange(e){try{await Md(Q.runId,e),Q.estado=e,Bd()}catch(e){console.error(`[horario-builder] estado update failed:`,e)}},async onFeedbackAdd({comentario:e,tipo:t}){try{let n=await Ad({runId:Q.runId,comentario:e,tipo:t});Q.feedback=[...Q.feedback,n],Bd()}catch(e){console.error(`[horario-builder] feedback add failed:`,e)}}})}}function Vd(e){Q.loading=e;let t=$.querySelector(`#hb-status`);t&&(t.innerHTML=e?`<div class="d-flex align-items-center gap-2 mt-2 text-muted" style="font-size:0.85rem;">
         <div class="spinner-border spinner-border-sm" role="status"></div>
         <span>Generando horario optimizado…</span>
       </div>`:``)}function Hd(e,t=`success`){let n=document.createElement(`div`);n.className=`hb-toast`;let r=`bi-check-circle-fill text-success`,i=`#10b981`;t===`danger`?(r=`bi-exclamation-octagon-fill text-danger`,i=`#ef4444`):t===`warning`&&(r=`bi-info-circle-fill text-warning`,i=`#f59e0b`),n.style.borderLeftColor=i,n.innerHTML=`
    <i class="bi ${r}"></i>
    <span style="font-size:0.85rem;font-weight:650;color:var(--hb-text);">${e}</span>
  `,document.body.appendChild(n),setTimeout(()=>{n.style.animation=`fadeIn 0.3s reverse forwards`,setTimeout(()=>n.remove(),300)},3500)}function Ud(e,t){let[n,r]=e.split(`:`).map(Number),[i,a]=t.split(`:`).map(Number);return i*60+a-(n*60+r)}function Wd(e,t){let[n,r]=e.split(`:`).map(Number),i=n*60+r+t,a=Math.floor(i/60),o=i%60;return`${String(a).padStart(2,`0`)}:${String(o).padStart(2,`0`)}`}function Gd(){let e=$?.querySelector(`#hb-undo-btn`),t=$?.querySelector(`#hb-redo-btn`);e&&(e.disabled=Q.undoStack.length===0),t&&(t.disabled=Q.redoStack.length===0)}function Kd(){Pd&&Pd.destroy(),Q.draggable&&(Pd=cd($.querySelector(`#hb-grid-wrapper`),{assignments:Q.assignments,onMove({claseId:e,fromDay:t,fromHour:n,toDay:r,toHour:i}){Q.undoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.redoStack=[];let a=Q.assignments.findIndex(t=>t.clase_id===e);if(a===-1)return;let o={...Q.assignments[a]},s=Ud(o.hora_inicio,o.hora_fin);o.dia=r,o.hora_inicio=i,o.hora_fin=Wd(i,s),Q.assignments[a]=o;let{conflicts:c,assignments:l}=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=c,Q.assignments=l,Ld(),Rd(),Gd(),Kd()},async onConflict({assignment:e,targetDay:t,targetHour:n,conflicts:r}){let i=$.querySelector(`#hb-drag-toggle`);[i,$.querySelector(`#hb-undo-btn`),$.querySelector(`#hb-redo-btn`)].forEach(e=>{e&&(e.disabled=!0)});try{if(!await sd({conflictDescription:r.map(e=>e.description).join(`
`)}))return;Q.undoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.redoStack=[];let i=Q.assignments.findIndex(t=>t.clase_id===e.clase_id);if(i===-1)return;let a={...Q.assignments[i]},o=Ud(a.hora_inicio,a.hora_fin);a.dia=t,a.hora_inicio=n,a.hora_fin=Wd(n,o),Q.assignments[i]=a;let s=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=s.conflicts,Q.assignments=s.assignments,Ld(),Rd(),Gd(),Kd()}finally{i&&(i.disabled=!1),Gd()}}}))}function qd(){$.addEventListener(`change`,e=>{e.target.id===`hb-periodo-select`&&(Q.activePeriodo=e.target.value,Ld())}),$.addEventListener(`click`,async e=>{let t=e.target.closest(`.vt-pill[data-view]`);if(t){let e=t.dataset.view;yd.includes(e)&&e!==Q.activeView&&(Q.activeView=e,zd(),Ld());return}if(e.target.closest(`#hb-drag-toggle`)){Q.draggable=!Q.draggable;let e=$.querySelector(`#hb-drag-toggle`);e&&(e.innerHTML=Q.draggable?`<i class="bi bi-unlock-fill"></i> Bloqueando`:`<i class="bi bi-lock-fill"></i> Editar`),Ld(),Kd();return}if(e.target.closest(`#hb-undo-btn`)){if(Q.undoStack.length===0)return;Q.redoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.assignments=Q.undoStack.pop();let e=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=e.conflicts,Q.assignments=e.assignments,Ld(),Rd(),Gd(),Kd();return}if(e.target.closest(`#hb-redo-btn`)){if(Q.redoStack.length===0)return;Q.undoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.assignments=Q.redoStack.pop();let e=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=e.conflicts,Q.assignments=e.assignments,Ld(),Rd(),Gd(),Kd();return}if(e.target.closest(`#hb-generate-btn`)){Jd();return}if(e.target.closest(`#hb-save-btn`)){Yd();return}if(e.target.closest(`#hb-publish-btn`)){if(Q.publishWizardOpen=!Q.publishWizardOpen,Q.publishWizardOpen&&Q.runId)try{Q.feedback=await kd(Q.runId)}catch{Q.feedback=[]}Bd();return}})}async function Jd(){let e=$.querySelector(`#hb-generate-btn`);e&&(e.disabled=!0),Vd(!0);try{let e=await Ku(),{conflicts:t,assignments:n}=od(nd({clasesConMaestro:(e.clases||[]).map(e=>({id:e.id,nombre:e.nombre,maestro_principal_id:e.maestro_principal_id,total_alumnos:e.total_alumnos||0,duracion:60})),maestros:e.maestros||[],salones:e.salones||[],config:{gapMinimo:15,duracionBloque:60}}).assignments,{returnAnnotated:!0,gapMinutes:15});Q.assignments=n,Q.conflicts=t,Ld(),Rd(),Kd();let r=$.querySelector(`#hb-save-btn`);r&&(r.disabled=Q.assignments.length===0),Hd(t.length>0?`Horario generado con ${t.length} conflicto(s)`:`Horario optimizado sin conflictos`,t.length>0?`warning`:`success`)}catch(e){console.error(`[horarioBuilderView] handleGenerate error:`,e),Hd(`Error al generar: `+e.message,`danger`)}finally{Vd(!1),e&&(e.disabled=!1)}}async function Yd(){let e=$.querySelector(`#hb-save-btn`);e&&(e.disabled=!0,e.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Guardando…`);try{let e=await qu({assignments:Q.assignments,periodo_id:Q.activePeriodo,estado:`borrador`});if(e?.id){Q.runId=e.id,Q.estado=`borrador`;let t=$.querySelector(`#hb-publish-btn`);t&&(t.disabled=!1),Hd(`Horario guardado como borrador`,`success`)}else Hd(`Guardado incompleto: no se obtuvo ID del registro`,`warning`);Q.error=null}catch(e){console.error(`[horarioBuilderView] handleSave error:`,e),Q.error=e.message,Hd(`Error al guardar: `+e.message,`danger`)}finally{e&&(e.disabled=!1,e.innerHTML=`<i class="bi bi-floppy-fill"></i> Guardar`)}}function Xd(){S.register(`horario-builder`,Fd)}function Zd(){S.register(`admin-notificaciones`,e=>{try{Be(e)}catch(t){console.error(`[admin-notificaciones] Error al renderizar la vista:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar el Centro de Actividad: ${t.message}</p>
        </div>
      `}})}function Qd(){S.register(`admin-aprobacion`,async e=>{try{await Me(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de aprobaciones:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la aprobación de maestros: ${t.message}</p>
        </div>
      `}}),S.register(`admin-ausencias`,async e=>{try{await Ce(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de ausencias:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la gestión de ausencias: ${t.message}</p>
        </div>
      `}})}if(s(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;window.bootstrap=nt,window.router=S;var $d=[{id:`programas`,label:`Programas`,icon:`bi-book`,description:`Gestión de programas académicos`,enabled:!0,register:ln},{id:`academic-admin`,label:`Gestión Curricular`,icon:`bi-diagram-3`,description:`Gestión de mapa curricular y recursos`,enabled:!0,register:Wl},{id:`admin-dashboard`,label:`Dashboard Administrativo`,icon:`bi-speedometer2`,description:`Panel de control, reportes y analítica de maestros`,enabled:!0,register:$l},{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`,description:`Alertas tempranas de riesgo y sustituciones sugeridas`,enabled:!0,register:Zd},{id:`admin-aprobacion`,label:`Aprobación de Maestros`,icon:`bi-person-check`,description:`Aprobación de maestros y gestión de ausencias`,enabled:!0,register:Qd},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`,description:`Gestión de maestros/docentes`,enabled:!0,register:cn},{id:`alumnos`,label:`Alumnos`,icon:`bi-people`,description:`Gestión de estudiantes`,enabled:!0,register:Go},{id:`salones`,label:`Salones`,icon:`bi-door-open`,description:`Gestión de espacios de clase`,enabled:!0,register:is},{id:`clases`,label:`Clases`,icon:`bi-easel`,description:`Gestión de clases y horarios`,enabled:!0,register:as},{id:`horario-builder`,label:`Constructor de Horarios`,icon:`bi-calendar-range`,description:`Motor de asignación y optimización de horarios`,enabled:!0,register:Xd},{id:`asistencias`,label:`Asistencias`,icon:`bi-calendar-check`,description:`Control de asistencia`,enabled:!0,register:Es},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`,description:`Planificación pedagógica`,enabled:!0,register:Oc},{id:`progresos`,label:`Progresos`,icon:`bi-graph-up`,description:`Calificaciones y progreso`,enabled:!0,register:el},{id:`observaciones`,label:`Observaciones`,icon:`bi-chat-quote`,description:`Anotaciones disciplinarias`,enabled:!0,register:bl},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`,description:`KPIs, alertas y análisis institucional`,enabled:!0,register:Ll},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`,description:`Permisos y roles de maestros`,enabled:!0,register:vu},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,description:`Dashboard, seguimiento y reportes pedagógicos`,enabled:!0,register:zu},{id:`config`,label:`Configuración`,icon:`bi-gear`,description:`Configuración del sistema`,enabled:!0,register:Rl}];function ef(){let e=localStorage.getItem(`app-theme`),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches,n=e===`dark`||e===null&&t;return document.documentElement.setAttribute(`data-bs-theme`,n?`dark`:`light`),n}function tf(){let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-bs-theme`,e),localStorage.setItem(`app-theme`,e)}var nf=[{id:`academico`,label:`Académico`,icon:`bi-easel`,items:[{id:`programas`,label:`Programas`,icon:`bi-book`},{id:`clases`,label:`Clases`,icon:`bi-easel2`},{id:`salones`,label:`Salones`,icon:`bi-door-open`},{id:`horario-builder`,label:`Constructor Horarios`,icon:`bi-calendar-range`}]},{id:`personas`,label:`Personas`,icon:`bi-people`,items:[{id:`alumnos`,label:`Alumnos`,icon:`bi-people`},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`},{id:`postulados`,label:`Postulados`,icon:`bi-person-plus-fill`},{id:`postulados-calendario`,label:`Calendario Citas`,icon:`bi-calendar-event`}]},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,items:[{id:`pedagogico-dashboard`,label:`Dashboard`,icon:`bi-grid-1x2`},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`},{id:`planificacion-maestros`,label:`Todas las Planes`,icon:`bi-journal-check`},{id:`pedagogico-seguimiento`,label:`Seguimiento`,icon:`bi-person-lines-fill`},{id:`pedagogico-reportes`,label:`Reportes`,icon:`bi-file-earmark-bar-graph`}]},{id:`analisis`,label:`Análisis`,icon:`bi-bar-chart-line`,items:[{id:`metricas`,label:`Dashboard`,icon:`bi-bar-chart-line`},{id:`admin-dashboard`,label:`Cumplimiento Maestros`,icon:`bi-clipboard-check`},{id:`admin-dashboard-reportes`,label:`Reportes Director`,icon:`bi-file-earmark-pdf`},{id:`admin-dashboard-analitca-llenado`,label:`Analítica Llenado`,icon:`bi-graph-up`},{id:`admin-dashboard-tendencias`,label:`Tendencias`,icon:`bi-arrow-up-right`}]},{id:`sistema`,label:`Sistema`,icon:`bi-gear`,items:[{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`},{id:`admin-aprobacion`,label:`Aprobaciones`,icon:`bi-person-check`},{id:`admin-ausencias`,label:`Gestión Ausencias`,icon:`bi-calendar-x`},{id:`configuracion`,label:`Configuración`,icon:`bi-sliders`},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`},{id:`importar-datos`,label:`Importar Datos`,icon:`bi-cloud-upload`}]}];function rf(e){for(let t of nf)if(t.items.some(t=>t.id===e))return t.id;return nf[0].id}var af=null;function of(e){let t=document.getElementById(`sidebar-notif-badge`);t&&(e>0?(t.textContent=e>99?`99+`:String(e),t.style.display=`inline-flex`):t.style.display=`none`)}function sf(e,t=!1){af?.abort(),af=new AbortController;let{signal:n}=af;if(document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),document.querySelector(`.mobile-sub-sheet`)?.remove(),!t)return;let i=T.getUser(),a=i?i.email||i.full_name||`Usuario`:``,o=localStorage.getItem(`current-view`)||`programas`,s=rf(o),c=document.documentElement.getAttribute(`data-bs-theme`)===`dark`,l=r.isDemoMode,u=document.createElement(`aside`);u.className=`app-sidebar`,u.innerHTML=`
    <div class="sidebar-brand">
      <div class="sidebar-brand-icon"><i class="bi bi-mortarboard-fill"></i></div>
      <span class="sidebar-brand-text">SOI</span>
      ${l?`<span class="badge bg-warning text-dark ms-2" style="font-size: 0.6rem;">DEMO</span>`:``}
    </div>
  ...
  `;let d=document.createElement(`nav`);d.className=`app-bottom-nav`,d.innerHTML=nf.map(e=>`
  ...
  `,document.body.prepend(f),document.body.prepend(d),document.body.prepend(u),u.querySelectorAll(`.nav-group-header`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`.nav-group`),n=t.classList.contains(`expanded`);u.querySelectorAll(`.nav-group`).forEach(e=>e.classList.remove(`expanded`)),n||t.classList.add(`expanded`)})}),u.querySelectorAll(`.nav-item-btn`).forEach(e=>{e.addEventListener(`click`,()=>S.navigate(e.dataset.route))}),u.querySelector(`#sidebarBtnTheme`).addEventListener(`click`,()=>{tf();let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`;u.querySelector(`#sidebarBtnTheme i`).className=e?`bi bi-sun-fill`:`bi bi-moon-fill`}),u.querySelector(`#sidebarBtnLogout`).addEventListener(`click`,async()=>{await T.logout(),S.navigate(`login`)});function p(e){let t=nf.find(t=>t.id===e);if(!t)return;let n=localStorage.getItem(`current-view`)||``;document.getElementById(`sheetTitle`).textContent=t.label,document.getElementById(`sheetItems`).innerHTML=t.items.map(e=>`
      <button class="sheet-item ${e.id===n?`active`:``}" data-route="${e.id}">
        <i class="bi ${e.icon}"></i>
        <span>${e.label}</span>
      </button>
    `).join(``),f.dataset.group=e,f.classList.add(`open`),f.querySelectorAll(`.sheet-item`).forEach(e=>{e.addEventListener(`click`,()=>{S.navigate(e.dataset.route),f.classList.remove(`open`)})})}d.querySelectorAll(`.bottom-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.group;f.classList.contains(`open`)&&f.dataset.group===t?f.classList.remove(`open`):(p(t),d.querySelectorAll(`.bottom-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.group===t)))})}),document.addEventListener(`click`,e=>{f.classList.contains(`open`)&&!f.contains(e.target)&&!d.contains(e.target)&&f.classList.remove(`open`)},{signal:n}),window.addEventListener(`routeChanged`,e=>{let t=e.detail,n=rf(t);u.querySelectorAll(`.nav-item-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.route===t)),u.querySelectorAll(`.nav-group`).forEach(e=>{e.dataset.group===n?e.classList.add(`expanded`):e.classList.remove(`expanded`)}),d.querySelectorAll(`.bottom-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.group===n))},{signal:n})}function cf(){try{sn()}catch(e){console.error(`Error registering auth routes:`,e)}$d.filter(e=>e.enabled&&e.register).forEach(e=>{try{e.register()}catch(t){console.error(`Error registering module ${e.id}:`,t)}})}async function lf(){let e=document.querySelector(`#app`);if(!e){console.error(`El contenedor #app no existe en el HTML`);return}ef(),cf(),S.initCustomEvents(),console.log(`🔄 Sincronizando sesión...`),await T.refreshAuth();let t=[`login`,`register`];S.setAuthGuard(()=>T.isAuthenticated(),t);let n=localStorage.getItem(`current-view`)||`programas`,r=T.isAuthenticated();!r&&!t.includes(n)?(localStorage.setItem(`current-view`,`login`),S.navigate(`login`)):r&&t.includes(n)?(localStorage.setItem(`current-view`,`programas`),sf(e,!0),S.navigate(`programas`)):(r&&sf(e,!0),S.init()),T.subscribe(t=>{if(t.user)sf(e,!0),Ae(of);else{Ie(),e.innerHTML=``;let t=document.querySelector(`.app-navbar`);t&&t.remove(),document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),document.querySelector(`.mobile-sub-sheet`)?.remove(),S.navigate(`login`)}})}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,lf):lf();function uf(){let e=localStorage.getItem(`current-view`)||`programas`,t=document.querySelector(`.teacher-bridge`);t&&(e===`programas`?t.classList.add(`visible`):t.classList.remove(`visible`))}uf(),window.addEventListener(`routeChanged`,e=>{uf()});var df=document.querySelector(`.teacher-bridge`);df&&df.addEventListener(`click`,()=>{localStorage.setItem(`pm-modo`,`maestro`)});export{rr as a,er as c,$n as i,Yn as n,Xn as o,Zn as r,Qn as s,nr as t};