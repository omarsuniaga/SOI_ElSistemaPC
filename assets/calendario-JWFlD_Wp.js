import"./early-error-suppression-K9hxPIVV.js";import{i as e}from"./supabase-Cgh_dhNB.js";import"./vendor-mK9cUK6A.js";import{t}from"./tareasView-D7s9Oetn.js";import{t as n}from"./horarioBuilderView-DEvJ5u94.js";async function r(t){let{data:n}=await e.from(`profiles`).select(`rol`).eq(`id`,t).maybeSingle();return[`admin`,`superadmin`,`coordinacion_academica`,`direccion`].includes(n?.rol)}function i(t,n=null){t.style.background=``,t.innerHTML=`
