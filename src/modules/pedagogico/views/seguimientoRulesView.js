...
import {
  listSeguimientoRules,
  createSeguimientoRule,
  updateSeguimientoRule,
  toggleSeguimientoRule,
  seedDefaultSeguimientoRules,
    ...
    <div class="page-container">
      ...
      ${
        ...
        <div class="text-center py-5 text-muted">
          ...
          : state.rules.map(_renderRule).join('')
      }
    </div>`
      ...
      <div class="row g-2 small">
        ...
        <div class="col-12">
          ...
          <select class="form-select form-select-sm" id="rm-tipo" ${isEdit ? 'disabled' : ''}>
            ...
            <option value="eventos_importantes_ausencia_total" ${rule?.tipo === 'eventos_importantes_ausencia_total' ? 'selected' : ''}>Ausencia total a eventos importantes</option>
          </select>
        </div>
        <div class="col-12">
