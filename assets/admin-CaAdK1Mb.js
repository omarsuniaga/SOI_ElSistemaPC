const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ausenciaForm-yYYkiXOF.js","assets/supabase-BryBf0UA.js","assets/ausenciaHistorial-BAUowKdN.js","assets/jspdf.es.min-B53WQQE_.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CQ36nxok.js","assets/typeof-DxaMiMZt.js","assets/jspdf.plugin.autotable-95nmaIim.js","assets/alumnos-F-Cpvyq_.js","assets/clases-C8FwunQU.js","assets/configView-ZysdBRdo.js","assets/pushService-DsWSFa6I.js","assets/maestroAuth-BZ2ChDTg.js","assets/importView-CiLpJE3y.js","assets/exportView-BTpj8t19.js","assets/alumnosApi-CeFKHcQC.js","assets/router-BHZZEeZ4.js","assets/vendor-CAKU_njC.js","assets/vendor-COf7rB16.css","assets/reportService-G7_xh_x_.js","assets/groqService-CNWH1ut_.js","assets/AppToast-L43yfvBt.js"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-tcWNtVWY.js";import{$ as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as ee,P as te,R as ne,T as re,V as ie,W as ae,X as oe,Y as se,Z as ce,_ as le,a as ue,b as de,c as fe,d as h,dt as pe,et as me,f as he,g as ge,h as _e,i as ve,j as g,k as ye,l as be,m as xe,n as Se,nt as Ce,o as we,p as Te,q as Ee,r as De,s as Oe,t as ke,tt as Ae,u as je,v as Me,w as Ne,x as Pe,y as Fe,z as Ie}from"./clasesApi-DlGjhAio.js";import{i as _,n as Le,r as Re,t as ze}from"./supabase-BryBf0UA.js";import{n as Be,r as Ve}from"./vendor-CAKU_njC.js";import{i as He}from"./permisosSupabase-DX8LFO6R.js";import{t as v}from"./AppToast-L43yfvBt.js";import{t as y}from"./preload-helper-CQ36nxok.js";import{t as b}from"./AppModal-BohrepL3.js";import{n as Ue}from"./groqService-CNWH1ut_.js";import{a as We,c as Ge,i as Ke,l as qe,n as Je,o as Ye,r as Xe,s as Ze,t as Qe,u as x}from"./alumnosApi-CeFKHcQC.js";import{t as $e}from"./clases-C8FwunQU.js";import{t as S}from"./router-BHZZEeZ4.js";import{t as et}from"./jspdf.es.min-B53WQQE_.js";import{t as tt}from"./jspdf.plugin.autotable-95nmaIim.js";var nt=`auth-session`;function rt(e,t=!0){let n={access_token:e.access_token,refresh_token:e.refresh_token,user:e.user,expires_at:e.expires_at,persistent:t};(t?localStorage:sessionStorage).setItem(nt,JSON.stringify(n)),t?sessionStorage.removeItem(nt):localStorage.removeItem(nt)}function it(){let e=localStorage.getItem(nt),t=sessionStorage.getItem(nt),n=e||t;if(!n)return null;try{return JSON.parse(n)}catch{return null}}function at(){localStorage.removeItem(nt),sessionStorage.removeItem(nt)}function ot(){let e=it();return!e||!e.expires_at?!1:Date.now()/1e3<e.expires_at-10}var st=[];async function ct(e,t,n=!1){let{data:r,error:i}=await ze(e,t);return i?(console.error(`🔑 login error:`,i),{user:null,session:null,error:i}):(r.session&&rt(r.session,n),{user:r.user,session:r.session,error:null})}async function lt(e,t,n={}){let{data:r,error:i}=await Re(e,t,n);return i?{user:null,session:null,error:i}:{user:r.user,session:r.session,error:null}}async function ut(){let{error:e}=await Le();return at(),st.forEach(e=>e(null)),{error:e}}function dt(){return ot()}function ft(){return it()?.user||null}var C={user:null,session:null,loading:!0,error:null,listeners:[]};function pt(){C.listeners.forEach(e=>e(C))}function mt(e){return C.listeners.push(e),()=>{C.listeners=C.listeners.filter(t=>t!==e)}}async function ht(e,t,n=!1){if(C.loading=!0,C.error=null,pt(),e===`demo@soi.com`&&t===`demo123`){let e={id:`demo-user-id`,email:`demo@soi.com`,user_metadata:{full_name:`Usuario Demo`},role:`admin`},t={user:e,access_token:`demo-token`};return localStorage.setItem(`demo_mode`,`true`),x.isDemoMode=!0,rt(t,n),C.user=e,C.session=t,C.loading=!1,pt(),{success:!0,user:e,session:t}}try{let r=await ct(e,t,n),i=r?.error&&(r.error.message||r.error),a=r?.user&&!i;return C.user=a?r.user:null,C.session=a?r.session:null,C.loading=!1,pt(),i?{success:!1,error:typeof i==`string`?i:i.message||`Error desconocido`}:{success:a,user:C.user,session:C.session}}catch(e){return C.loading=!1,C.error=e.message,pt(),{success:!1,error:e.message}}}async function gt(e,t,n){C.loading=!0,C.error=null,pt();try{let r=await lt(e,t,n);C.user=r.user,C.session=r.session,C.loading=!1,pt();let i=!r.error&&!!r.user,a=i&&!r.session;return{...r,success:i,needsConfirmation:a,message:a?`Registro exitoso. Tu cuenta está pendiente de aprobación por un administrador.`:void 0}}catch(e){return C.loading=!1,C.error=e.message,pt(),{success:!1,error:e.message}}}function _t(){ut(),localStorage.removeItem(`demo_mode`),x.isDemoMode=!1,C.user=null,C.session=null,C.error=null,pt()}function vt(){return ft()}function yt(){return C.user?!0:dt()}async function bt(){let{data:{session:e},error:t}=await _.auth.getSession();return t||!e?(at(),C.user=null,C.session=null,C.loading=!1,pt(),{authenticated:!1}):(rt(e,it()?.persistent??!0),C.session=e,C.user=e.user,C.loading=!1,pt(),{authenticated:!0,user:C.user})}bt();var w={subscribe:mt,login:ht,register:gt,logout:_t,getUser:vt,isAuthenticated:yt,notifyListeners:pt,refreshAuth:bt,getState:()=>({...C})},xt={config:{fontSizeBase:`0.8rem`,fontSizeSmall:`0.7rem`,paddingX:`0.5rem`,paddingY:`0.35rem`,gap:`0.35rem`},styles:`
    /* Compact Tables */
    .table-compact {
      font-size: 0.8rem;
  ...
  `}function Tt(e){let t=document.getElementById(`loginForm`),n=document.getElementById(`loginEmail`),r=document.getElementById(`loginPassword`),i=document.getElementById(`togglePassword`),a=document.getElementById(`linkRegister`);t?.addEventListener(`submit`,async t=>{t.preventDefault();let i=n.value.trim(),a=r.value;await Et(i,a,document.getElementById(`rememberMe`)?.checked||!1,e)}),i?.addEventListener(`click`,()=>{let e=r.type===`password`?`text`:`password`;r.type=e,i.innerHTML=e===`password`?`<i class="bi bi-eye"></i>`:`<i class="bi bi-eye-slash"></i>`}),a?.addEventListener(`click`,e=>{e.preventDefault(),S.navigate(`register`)})}async function Et(e,t,n,r){if(!e||!t){Ot(`Por favor ingresa email y contraseña`,`error`,r);return}St.loading=!0,Dt(!0);try{let i=await w.login(e,t,n);i.success?(Ot(`¡Bienvenido!`,`success`,r),setTimeout(()=>{let e=localStorage.getItem(`intended-route`);localStorage.removeItem(`intended-route`),S.navigate(e||`programas`)},500)):Ot(i.error||`Error al iniciar sesión`,`error`,r)}catch(e){console.error(`Login error:`,e),Ot(`Error de conexión`,`error`,r)}finally{St.loading=!1,Dt(!1)}}function Dt(e){let t=document.getElementById(`btnLogin`),n=t?.querySelector(`.btn-text`),r=t?.querySelector(`.btn-loading`);t&&(t.disabled=e,e?(n?.classList.add(`d-none`),r?.classList.remove(`d-none`)):(n?.classList.remove(`d-none`),r?.classList.add(`d-none`)))}function Ot(e,t,n){let r=document.getElementById(`toastContainer`);if(!r)return;let i=e&&typeof e==`object`?e.message||e.error||JSON.stringify(e):String(e||`Error`),a=`
  ...
  `,o=document.createElement(`div`);o.innerHTML=a;let s=o.firstElementChild;r.appendChild(s),new Be(s,{autohide:!0,delay:3e3}).show(),s.addEventListener(`hidden.bs.toast`,()=>{s.remove()})}var kt={loading:!1},At=[{test:e=>e.length>=8,message:`Mínimo 8 caracteres`},{test:e=>/[A-Z]/.test(e),message:`Al menos 1 mayúscula`},{test:e=>/[0-9]/.test(e),message:`Al menos 1 número`},{test:e=>/[!@#$%^&*(),.?":{}|<>]/.test(e),message:`Al menos 1 símbolo`}];function jt(e){xt.injectStyles(),Mt(e),Pt(e)}function Mt(e){e.innerHTML=`
    <div class="auth-page">
      <div class="auth-container">
        <div class="auth-card">
          <div class="auth-header">
  ...
  `}function Nt(e){return At.map((t,n)=>{let r=t.test(e);return`
      <div class="password-requirement ${r?`valid`:`invalid`}" id="req-${n}">
        <i class="bi ${r?`bi-check-circle-fill`:`bi-circle`}"></i>
        <span>${t.message}</span>
      </div>
    `}).join(``)}function Pt(e){let t=document.getElementById(`registerForm`);document.getElementById(`registerName`),document.getElementById(`registerEmail`);let n=document.getElementById(`registerPassword`),r=document.getElementById(`registerConfirmPassword`),i=document.getElementById(`togglePassword`),a=document.getElementById(`linkLogin`);n?.addEventListener(`input`,e=>{let t=e.target.value;Ft(t),It()}),r?.addEventListener(`input`,It),t?.addEventListener(`submit`,async t=>{t.preventDefault(),await Rt(e)}),i?.addEventListener(`click`,()=>{let e=n.type===`password`?`text`:`password`;n.type=e,r.type=e,i.innerHTML=e===`password`?`<i class="bi bi-eye"></i>`:`<i class="bi bi-eye-slash"></i>`}),a?.addEventListener(`click`,e=>{e.preventDefault(),S.navigate(`login`)})}function Ft(e){document.getElementById(`passwordRequirements`)&&At.forEach((t,n)=>{let r=document.getElementById(`req-${n}`);if(r){let n=t.test(e);r.className=`password-requirement ${n?`valid`:`invalid`}`,r.innerHTML=`
        <i class="bi ${n?`bi-check-circle-fill`:`bi-circle`}"></i>
        <span>${t.message}</span>
      `}})}function It(){let e=document.getElementById(`registerPassword`).value,t=document.getElementById(`registerConfirmPassword`).value,n=document.getElementById(`confirmPasswordError`),r=document.getElementById(`registerConfirmPassword`);return t&&e!==t?(n?.classList.remove(`d-none`),r?.classList.add(`is-invalid`),!1):(n?.classList.add(`d-none`),r?.classList.remove(`is-invalid`),!0)}function Lt(e){return At.every(t=>t.test(e))}async function Rt(e){let t=document.getElementById(`registerName`).value.trim(),n=document.getElementById(`registerEmail`).value.trim(),r=document.getElementById(`registerPassword`).value,i=document.getElementById(`registerConfirmPassword`).value,a=document.getElementById(`acceptTerms`).checked;if(!t||!n||!r||!i){Bt(`Por favor completa todos los campos`,`error`,e);return}if(!Lt(r)){Bt(`La contraseña no cumple los requisitos`,`error`,e);return}if(r!==i){Bt(`Las contraseñas no coinciden`,`error`,e);return}if(!a){Bt(`Debes aceptar los términos y condiciones`,`error`,e);return}kt.loading=!0,zt(!0);try{let i=await w.register(n,r,{full_name:t,rol:`maestro`});i.success?i.needsConfirmation?(Bt(i.message,`info`,e),setTimeout(()=>{S.navigate(`login`)},2e3)):(Bt(`¡Cuenta creada exitosamente!`,`success`,e),setTimeout(()=>{S.navigate(`programas`)},500)):Bt(i.error||`Error al registrar`,`error`,e)}catch(t){console.error(`Register error:`,t),Bt(`Error de conexión`,`error`,e)}finally{kt.loading=!1,zt(!1)}}function zt(e){let t=document.getElementById(`btnRegister`),n=t?.querySelector(`.btn-text`),r=t?.querySelector(`.btn-loading`);t&&(t.disabled=e,e?(n?.classList.add(`d-none`),r?.classList.remove(`d-none`)):(n?.classList.remove(`d-none`),r?.classList.add(`d-none`)))}function Bt(e,t,n){let r=document.getElementById(`toastContainer`);if(!r)return;let i=`
    <div id="${`toast-`+Date.now()}" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
  ...
  `,a=document.createElement(`div`);a.innerHTML=i;let o=a.firstElementChild;r.appendChild(o),new Be(o,{autohide:!0,delay:3e3}).show(),o.addEventListener(`hidden.bs.toast`,()=>{o.remove()})}function Vt(e){return e?e.replace(/[&<>]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`})[e]):``}var Ht={loading:!1,error:null};function Ut(e){let t=w.getUser();if(!t){e.innerHTML=`
  ...
  `,Wt(e)}async function Wt(e){let{renderAusenciaForm:t}=await y(async()=>{let{renderAusenciaForm:e}=await import(`./ausenciaForm-yYYkiXOF.js`);return{renderAusenciaForm:e}},__vite__mapDeps([0,1])),{renderAusenciaHistorial:n}=await y(async()=>{let{renderAusenciaHistorial:e}=await import(`./ausenciaHistorial-BAUowKdN.js`);return{renderAusenciaHistorial:e}},__vite__mapDeps([2,1]));document.getElementById(`ausenciaModalBody`).innerHTML=t();let r=e.querySelector(`.card-apple:last-child`);if(r){let e=document.createElement(`div`);e.className=`mt-4`,e.innerHTML=`
      <h6 class="fw-bold mb-3">
        <i class="bi bi-clock-history me-2"></i>Historial de Ausencias
      </h6>
      <div id="ausenciaHistorialContainer"></div>
    `,r.appendChild(e),document.getElementById(`ausenciaHistorialContainer`).innerHTML=n()}e.querySelector(`#btnGuardarDatos`)?.addEventListener(`click`,Gt),e.querySelector(`#perfilPasswordForm`)?.addEventListener(`submit`,Kt)}async function Gt(){let e=document.getElementById(`perfilNombre`).value.trim();if(!e){qt(`El nombre no puede estar vacío`);return}Ht.loading=!0;let t=document.getElementById(`btnGuardarDatos`);t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Guardando...`;try{let{error:t}=await _.auth.updateUser({data:{full_name:e}});if(t)throw t;Jt(`Datos guardados correctamente`)}catch(e){qt(e.message)}finally{Ht.loading=!1,t.disabled=!1,t.innerHTML=`<i class="bi bi-check-lg me-1"></i>Guardar cambios`}}async function Kt(e){e.preventDefault(),document.getElementById(`passwordActual`).value;let t=document.getElementById(`passwordNueva`).value,n=document.getElementById(`passwordConfirmar`).value;if(document.getElementById(`passwordError`),t.length<8){Yt(`La contraseña debe tener al menos 8 caracteres`);return}if(t!==n){Yt(`Las contraseñas no coinciden`);return}Ht.loading=!0;let r=document.getElementById(`btnCambiarPassword`);r.disabled=!0,r.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Cambiando...`;try{let{error:e}=await _.auth.updateUser({password:t});if(e)throw e;document.getElementById(`perfilPasswordForm`).reset(),Jt(`Contraseña cambiada correctamente`)}catch(e){e.message.includes(`same`)?Yt(`La nueva contraseña debe ser diferente a la actual`):Yt(e.message)}finally{Ht.loading=!1,r.disabled=!1,r.innerHTML=`<i class="bi bi-key-fill me-1"></i>Cambiar contraseña`}}function qt(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`danger`}}))}function Jt(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:`success`}}))}function Yt(e){let t=document.getElementById(`passwordError`);t&&(t.textContent=e,t.classList.remove(`d-none`))}function Xt(){S.register(`login`,Ct),S.register(`register`,jt),S.register(`perfil`,Ut)}Xt();function Zt(e){return e?{...e,user_id:e.user_id??null,nombre:e.nombre_completo??``,email:e.correo??``,telefono:e.tlf??``,instrumento:e.especialidad??``,bio:e.resena??``,is_active:e.activo??!0,especialidades:Array.isArray(e.especialidades)?e.especialidades:[]}:null}async function Qt(){let{data:e,error:t}=await _.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0});if(t)throw console.error(`Error cargando maestros:`,t.message),Error(`No se pudieron cargar los maestros`);return e.map(Zt)}async function $t(e,t){let n={},r=t.nombre||t.nombre_completo;r!==void 0&&(n.nombre_completo=r.trim());let i=t.email||t.correo;i!==void 0&&(n.correo=i.trim().toLowerCase());let a=t.telefono||t.tlf;a!==void 0&&(n.tlf=a.trim());let o=t.instrumento||t.especialidad;o!==void 0&&(n.especialidad=o.trim());let s=t.bio||t.resena;s!==void 0&&(n.resena=s.trim()),t.is_active!==void 0&&(n.activo=t.is_active),t.activo!==void 0&&(n.activo=t.activo),t.especialidades!==void 0&&(n.especialidades=Array.isArray(t.especialidades)?t.especialidades:[]);let{data:c,error:l}=await _.from(`maestros`).update(n).eq(`id`,e).select();if(l)throw console.error(`Error actualizando maestro:`,l.message),Error(`No se pudo actualizar el maestro`);return Zt(c[0])}async function en(e){let{error:t}=await _.from(`maestros`).update({activo:!1}).eq(`id`,e);if(t)throw console.error(`Error inactivando maestro:`,t.message),Error(`No se pudo desactivar el maestro`)}async function tn(e){let{error:t}=await _.from(`maestros`).update({activo:!0}).eq(`id`,e);if(t)throw console.error(`Error activando maestro:`,t.message),Error(`No se pudo activar el maestro`)}async function nn(e){let{data:t,error:n}=await _.from(`maestros`).select(`id`).eq(`correo`,e.trim().toLowerCase()).maybeSingle();return n&&n.code!==`PGRST116`&&console.error(`Error validando email:`,n.message),!!t}function T(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}function rn(e){return e?`success`:`secondary`}function an(e){return e?`Activo`:`Inactivo`}function on(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}var sn=class{constructor(e={}){this.id=e.id,this.instrumento=e.instrumento,this.nivel=e.nivel,this.nombre=e.nombre,this.tipo=e.tipo,this.estado=e.estado,this.descripcion=e.descripcion,this.ruta_base_id=e.ruta_base_id,this.duracion_semanas=e.duracion_semanas||40,this.creada_por=e.creada_por,this.aprobada_por=e.aprobada_por,this.fecha_aprobacion=e.fecha_aprobacion,this.objetivos=e.objetivos||[],this.created_at=e.created_at,this.updated_at=e.updated_at}validate(){let e=[];return this.instrumento?.trim()||e.push(`Instrumento es requerido`),this.nivel?.trim()||e.push(`Nivel es requerido`),this.nombre?.trim()||e.push(`Nombre es requerido`),this.nombre?.length>200&&e.push(`Nombre máximo 200 caracteres`),[`soi-estandar`,`maestro-variante`].includes(this.tipo)||e.push(`Tipo debe ser soi-estandar o maestro-variante`),[`activa`,`pendiente`,`aprobada`,`rechazada`].includes(this.estado)||e.push(`Estado inválido`),this.tipo===`maestro-variante`&&!this.ruta_base_id&&e.push(`Variante debe referenciar ruta base`),(this.duracion_semanas<1||this.duracion_semanas>52)&&e.push(`Duración debe estar entre 1 y 52 semanas`),(!Array.isArray(this.objetivos)||this.objetivos.length===0)&&e.push(`Debe haber al menos 1 objetivo`),this.objetivos.forEach((t,n)=>{t.descripcion?.trim()||e.push(`Objetivo ${n+1}: descripción requerida`),t.semana_inicio<1&&e.push(`Objetivo ${n+1}: semana_inicio >= 1`),t.semana_fin>this.duracion_semanas&&e.push(`Objetivo ${n+1}: semana_fin <= ${this.duracion_semanas}`),t.semana_fin<t.semana_inicio&&e.push(`Objetivo ${n+1}: semana_fin >= semana_inicio`)}),e}isVariante(){return this.tipo===`maestro-variante`}isActiva(){return this.estado===`activa`}isPendiente(){return this.estado===`pendiente`}toJSON(){return{id:this.id,instrumento:this.instrumento,nivel:this.nivel,nombre:this.nombre,tipo:this.tipo,estado:this.estado,descripcion:this.descripcion,ruta_base_id:this.ruta_base_id,duracion_semanas:this.duracion_semanas,creada_por:this.creada_por,aprobada_por:this.aprobada_por,fecha_aprobacion:this.fecha_aprobacion,objetivos:this.objetivos,created_at:this.created_at,updated_at:this.updated_at}}static getEstados(){return[{value:`activa`,label:`Activa`,color:`bg-success`},{value:`pendiente`,label:`Pendiente de aprobación`,color:`bg-warning`},{value:`aprobada`,label:`Aprobada`,color:`bg-info`},{value:`rechazada`,label:`Rechazada`,color:`bg-danger`}]}};async function cn(e){let t=new sn(e).validate();if(t.length>0)throw Error(`Validación fallida: ${t.join(`, `)}`);let{data:n,error:r}=await _.from(`rutas_contenido`).insert({instrumento:e.instrumento,nivel:e.nivel,nombre:e.nombre,tipo:e.tipo,estado:e.estado,descripcion:e.descripcion,ruta_base_id:e.ruta_base_id,duracion_semanas:e.duracion_semanas,creada_por:e.creada_por}).select().single();if(r)throw r;let i=e.objetivos.map((e,t)=>({ruta_id:n.id,descripcion:e.descripcion,semana_inicio:e.semana_inicio,semana_fin:e.semana_fin,orden:e.orden||t+1,objetivo_id:e.objetivo_id||null})),{data:a,error:o}=await _.from(`ruta_contenido_objetivos`).insert(i).select();if(o)throw o;return{...n,objetivos:a}}async function ln(e){let{data:t,error:n}=await _.from(`rutas_contenido`).select(`*`).eq(`id`,e).single();if(n)throw n;let{data:r,error:i}=await _.from(`ruta_contenido_objetivos`).select(`*`).eq(`ruta_id`,e).order(`orden`,{ascending:!0});if(i)throw i;return{...t,objetivos:r}}async function un(e={}){let t=_.from(`rutas_contenido`).select(`*`);e.instrumento&&(t=t.eq(`instrumento`,e.instrumento)),e.nivel&&(t=t.eq(`nivel`,e.nivel)),e.estado&&(t=t.eq(`estado`,e.estado)),e.tipo&&(t=t.eq(`tipo`,e.tipo));let{data:n,error:r}=await t.order(`created_at`,{ascending:!1});if(r)throw r;return n||[]}async function dn(){let{data:e,error:t}=await _.from(`rutas_contenido`).select(`*, rutas_contenido!ruta_base_id(nombre)`).eq(`tipo`,`maestro-variante`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(t)throw t;return e||[]}async function fn(e,t,n=null){let{data:r}=await _.auth.getUser(),{data:i,error:a}=await _.from(`rutas_contenido`).update({estado:t?`aprobada`:`rechazada`,aprobada_por:r?.user?.id,fecha_aprobacion:new Date().toISOString(),descripcion:t?void 0:n,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(a)throw a;return i}async function pn(e,t,n,r){let i=await ln(e),{data:a}=await _.auth.getUser();return await cn({instrumento:i.instrumento,nivel:i.nivel,nombre:t,tipo:`maestro-variante`,estado:`pendiente`,descripcion:n,ruta_base_id:e,duracion_semanas:i.duracion_semanas,creada_por:a?.user?.id,objetivos:r})}var mn=`
...
.ruta-info { font-size: 0.85rem; color: #666; margin-top: 4px; }
</style>`;function hn(e,t,n){let r=document.getElementById(`ruta-selector-modal`);r&&r.remove();let i=document.createElement(`div`);i.id=`ruta-selector-modal`,i.innerHTML=`${mn}
    <div class="modal fade" id="ruta-selector-dialog" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
        ...
        `).join(``)}</div>
      `,document.querySelectorAll(`.ruta-option`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.ruta-option`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),s=e.dataset.rutaId})});let l=a.querySelector(`.btn-close`);l.onclick=()=>{o.hide(),s&&n(s)}}catch(e){r.innerHTML=`<div class="alert alert-danger">${e.message}</div>`,v.error(`Error cargando rutas`)}}a.addEventListener(`shown.bs.modal`,s),o.show()}var gn={maestros:[],salones:[],programas:[],alumnos:[],onSuccess:null},_n={nombreMax:100,notasMax:500};async function vn(e=null,t={}){gn={...gn,...t};let n=!!e,r=[],i=[];if(n){v.info(`Cargando datos de la clase...`);let t=await Oe(e.id);r=(t||[]).map(e=>e.alumno_id),i=t||[]}let a=n?`Editar Clase: ${e.nombre}`:`Nueva Clase`,o=n?`Guardar Cambios`:`Crear Clase`;b.open({title:a,saveText:o,size:`lg`,body:yn(e,r,i),onShow:t=>{xn(t,e)},onSave:async t=>await Sn(t,e)})}function yn(e,t,n=[]){return`
    <form class="row g-3" id="formClase">
      <div class="col-md-6">
        <label class="form-label-compact">Nombre de la Clase *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required placeholder="Ej: Violín Básico A" value="${h(e?.nombre||``)}" maxlength="${_n.nombreMax}">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-12">
        ...
        <textarea class="form-control input-dense" id="modal-notas_pedagogicas" rows="2" placeholder="Observaciones sobre el grupo o metodología..." maxlength="${_n.notasMax}">${h(e?.descripcion||``)}</textarea>
      </div>
  ...
  `}function bn(e=[]){let t=gn.alumnos||[],n=(e=``,n=``,r=``)=>(t.find(t=>t.id===e),`
    ...
    <div class="text-end mt-1">
      ...
      <button type="button" class="btn btn-sm btn-link text-danger p-0 btn-remove-slot" title="Quitar turno">
        <i class="bi bi-x-circle-fill fs-5"></i>
      </button>`,s.appendChild(n),l()}),s?.addEventListener(`click`,e=>{if(e.target.closest(`.btn-remove-slot`)){if(s.querySelectorAll(`.slot-row`).length<=1){v.warning(`Debe haber al menos un turno en una clase rotativa`);return}e.target.closest(`.slot-row`).remove(),l()}});let u=e.querySelector(`#search-modal-alumnos`),d=e.querySelectorAll(`.alumno-check-item`);u?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();d.forEach(e=>{let n=e.dataset.nombre.includes(t)||e.dataset.instrumento.includes(t);e.style.display=n?`block`:`none`})});let f=e.querySelectorAll(`.alumnos-list input[type="checkbox"]`),p=e.querySelector(`#alumnos-selection-count`),m=()=>{let e=Array.from(f).filter(e=>e.checked).length;p&&(p.textContent=`${e} alumnos seleccionados`)};f.forEach(e=>e.addEventListener(`change`,m)),m()}async function Sn(e,t){let n=!!t,r=(()=>{let t=e.querySelector(`#modal-maestro_suplente_id`).value,n=e.querySelector(`#modal-tiene_suplente`).checked;return{nombre:e.querySelector(`#modal-nombre`).value.trim(),programa_id:e.querySelector(`#modal-programa_id`).value,maestro_principal_id:e.querySelector(`#modal-maestro_id`).value,maestro_suplente_id:n?t:null,tiene_suplente:n,instrumento:e.querySelector(`#modal-instrumento`).value.trim(),capacidad_maxima:parseInt(e.querySelector(`#modal-max_alumnos`).value)||20,estado:e.querySelector(`#modal-estado`).value,tipo_clase:e.querySelector(`input[name="modal-tipo_clase"]:checked`)?.value||`grupal`,descripcion:e.querySelector(`#modal-notas_pedagogicas`).value.trim(),ruta_id:e.querySelector(`#modal-ruta_id`)?.value||null,horarios:Array.from(e.querySelectorAll(`.horario-row`)).map(e=>({dia:e.querySelector(`[name="horario-dia"]`).value,hora_inicio:e.querySelector(`[name="horario-hora_inicio"]`).value,hora_fin:e.querySelector(`[name="horario-hora_fin"]`).value,salon_id:e.querySelector(`[name="horario-salon_id"]`).value||null}))}})(),i=new je(r).validate();if(i.length>0)return v.error(i[0]),!1;let a=()=>Array.from(e.querySelectorAll(`#slots-container .slot-row`)).map(e=>({alumno_id:e.querySelector(`.slot-alumno-select`).value,hora_inicio:e.querySelector(`.slot-hora-inicio`).value,hora_fin:e.querySelector(`.slot-hora-fin`).value})).filter(e=>e.alumno_id),o=async t=>{let n=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value),r=(await Oe(t)).map(e=>e.alumno_id),i=n.filter(e=>!r.includes(e)),a=r.filter(e=>!n.includes(e));await Promise.all([...i.map(e=>we(t,e)),...a.map(e=>ve(t,e))])},s=async e=>{let t=a();if(t.length===0)return v.warning(`Agregá al menos un turno`),!1;if(t.find(e=>!e.hora_inicio||!e.hora_fin))return v.error(`Todos los turnos deben tener hora de inicio y fin`),!1;let n=(await Oe(e)).map(e=>e.alumno_id),r=t.map(e=>e.alumno_id),i=n.filter(e=>!r.includes(e));return await Promise.all(i.map(t=>ve(e,t))),await Promise.all(t.map(t=>n.includes(t.alumno_id)?Se(e,t.alumno_id,t.hora_inicio,t.hora_fin):we(e,t.alumno_id,t.hora_inicio,t.hora_fin))),!0};try{let i;if(n)if(i=await ke(t.id,r),r.tipo_clase===`rotativa`){if(!await s(i.id))return!1}else await o(i.id);else if(i=await De(r),r.tipo_clase===`rotativa`){if(!await s(i.id))return!1}else{let t=Array.from(e.querySelectorAll(`.alumnos-list input[type="checkbox"]:checked`)).map(e=>e.value);t.length>0&&await Promise.all(t.map(e=>we(i.id,e)))}return v.success(n?`Clase actualizada`:`Clase creada`),gn.onSuccess&&gn.onSuccess(),!0}catch(e){return e.isConflict?v.warning(`Conflicto detected: ${e.message}`):v.error(e.message),!1}}function Cn(e=``){return`<option value="">Seleccionar maestro...</option>`+gn.maestros.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${h(t.nombre_completo||t.nombre)}</option>`).join(``)}function wn(e=``){return`<option value="">Sin salón (Online/Otro)</option>`+gn.salones.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${h(t.nombre)}</option>`).join(``)}function Tn(e=``){return`<option value="">Seleccionar programa...</option>`+gn.programas.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${h(t.nombre)}</option>`).join(``)}function En(e=`activa`){return je.getEstados().map(t=>`<option value="${t}" ${t===e?`selected`:``}>${je.getEstadoLabel(t)}</option>`).join(``)}function Dn(){return`<datalist id="instrumentos-list">${[`Violín`,`Viola`,`Cello`,`Piano`,`Flauta`,`Teoría`,`Coro`].map(e=>`<option value="${e}">`).join(``)}</datalist>`}function On(e,t){return`
  ...
  `}function kn(e=[]){return e.length===0?On(null,0):e.map((e,t)=>On(e,t)).join(``)}function An(e=[]){return`
  ...
  `}var jn=`app-help-panel`,Mn=`app-help-overlay`,Nn=!1;function Pn(){if(Nn)return;Nn=!0;let e=document.createElement(`style`);e.id=`app-help-panel-styles`,e.textContent=`
    /* ── Overlay ─────────────────────────────────────────── */
    #app-help-overlay {
      display: none;
      position: fixed;
  ...
  `,document.head.appendChild(e)}function Fn(){if(document.getElementById(jn))return;Pn();let e=document.createElement(`div`);e.id=Mn,document.body.appendChild(e);let t=document.createElement(`div`);t.id=jn,t.setAttribute(`role`,`complementary`),t.setAttribute(`aria-label`,`Ayuda`),t.innerHTML=`
    <div id="ahp-header">
    ...
    <div id="ahp-body"></div>
  `,document.body.appendChild(t),e.addEventListener(`click`,()=>In.close()),t.querySelector(`#ahp-close`).addEventListener(`click`,()=>In.close()),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&In.close()})}var In={open({title:e,intro:t,sections:n=[]}){Fn();let r=document.getElementById(jn),i=document.getElementById(Mn);document.getElementById(`ahp-title`).textContent=e||`Ayuda`,document.getElementById(`ahp-body`).innerHTML=`
    ...
    `,i.style.display=`block`,requestAnimationFrame(()=>{i.classList.add(`hp-visible`),r.classList.add(`hp-visible`)})},close(){let e=document.getElementById(jn),t=document.getElementById(Mn);!e||!e.classList.contains(`hp-visible`)||(e.classList.remove(`hp-visible`),t.classList.remove(`hp-visible`),setTimeout(()=>{t&&(t.style.display=`none`)},280))}},E={maestros:[],maestrosOriginales:[],editando:null,deletingId:null},Ln={nombreMax:100},Rn=null,zn=[`Piano`,`Guitarra`,`Violín`,`Viola`,`Cello`,`Contrabajo`,`Flauta`,`Clarinete`,`Oboe`,`Fagot`,`Saxofón`,`Trompeta`,`Trombón`,`Corno`,`Tuba`,`Percusión`,`Batería`,`Canto`,`Teoría`,`Solfeo`,`Dirección`,`Composición`,`Arreglos`];async function Bn(e){try{Vn(e);let t=await Qt();E.maestros=t,E.maestrosOriginales=[...t],Kn(e),Jn(e)}catch(t){console.error(t),Hn(e,t.message)}}function Vn(e){e.innerHTML=`
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>Bn(e))}function Un(e=[],t=`modal-especialidades-input`){return`
    <div class="mb-3">
  ...
  `}function Wn(e){let t=e.querySelector(`.especialidades-chips-container`);if(!t)return[];let n=t.querySelectorAll(`.chip-item`);return Array.from(n).map(e=>e.textContent.replace(/×$/,``).trim())}function Gn(e,t){let n=e.querySelector(`#modal-especialidades-input`),r=e.querySelector(`#btnAddEspecialidad`),i=e.querySelector(`.especialidades-chips-container`),a=r=>{let a=r.trim();if(a){if(!Wn(e).includes(a)){let e=i.querySelector(`.chips-wrapper`),n=document.createElement(`span`);n.className=`badge bg-primary-subtle text-primary rounded-pill chip-item`,n.innerHTML=`${T(a)}<i class="bi bi-x-lg chip-remove" data-especialidad="${T(a)}" style="cursor:pointer;margin-left:4px;"></i>`,e.appendChild(n),t&&t()}n.value=``}};n?.addEventListener(`keypress`,e=>{e.key===`Enter`&&(e.preventDefault(),a(n.value))}),r?.addEventListener(`click`,()=>a(n.value)),i?.addEventListener(`click`,e=>{e.target.classList.contains(`chip-remove`)&&(e.target.closest(`.chip-item`).remove(),t&&t()),e.target.classList.contains(`suggest-chip`)&&(e.preventDefault(),a(e.target.dataset.especialidad))})}function Kn(e){e.innerHTML=`
  ...
  `}function qn(e){return e.length?e.map(e=>{let t=e.nombre||e.name||`-`,n=e.is_active??!0,r=`border-accent-${n?`success`:`secondary`}`,i=`bg-${n?`success`:`secondary`}`;return`
    ...
    `}).join(``):`
      ...
      </div>`}function Jn(e){Rn=e,e.querySelector(`#btnAgregarMaestro`).addEventListener(`click`,()=>Zn()),e.querySelector(`#btn-help-maestros`)?.addEventListener(`click`,()=>{In.open({title:`Maestros`,intro:`Gestión del plantel docente. Desde acá podés ver, agregar, editar y desactivar maestros, y acceder al perfil completo de cada uno.`,sections:[{icon:`bi-search`,title:`Buscador y filtros`,description:`Filtrá por nombre, instrumento o estado (activo/inactivo) en tiempo real.`,color:`#6b7280`},{icon:`bi-person-badge`,title:`Tarjeta de maestro`,description:`Nombre, instrumento principal, clases activas y estado. Badge verde = activo, gris = inactivo.`,color:`#3b82f6`},{icon:`bi-eye`,title:`Ver perfil`,description:`Perfil completo: datos personales, clases (titular y suplente), horarios y ocupación.`,color:`#10b981`},{icon:`bi-pencil`,title:`Editar desde el perfil`,description:`Desde el perfil podés editar cualquier clase que dicte directamente, sin salir del modal.`,color:`#f59e0b`},{icon:`bi-person-x`,title:`Desactivar maestro`,description:`Desactivar oculta al maestro de listas operativas pero conserva su historial. No elimina datos.`,color:`#ef4444`}]})}),e.querySelector(`#btnExportarCSV`)?.addEventListener(`click`,()=>rr()),e.querySelector(`#buscar`).addEventListener(`input`,()=>Xn()),e.querySelector(`#filtroEstado`).addEventListener(`change`,()=>Xn()),e.querySelector(`#maestrosTBody`).addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t&&!e.target.closest(`[data-action]`)){$n(t.dataset.id);return}let n=e.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.id,i=n.dataset.action;i===`edit`?Qn(r):i===`delete`?er(r):i===`whatsapp`&&Yn(r)})}function Yn(e){let t=E.maestrosOriginales.find(t=>t.id===e);if(!t||!t.telefono)return;let n=t.telefono.replace(/\D/g,``);b.open({title:`Enviar WhatsApp a `+T(t.nombre||t.name||``),size:`md`,saveText:`Enviar WhatsApp`,body:`
      <div class="mb-3">
    ...
    `,onSave:async e=>{let t=e.querySelector(`#modal-whatsapp-msg`).value.trim(),r=`https://wa.me/${n}?text=${encodeURIComponent(t)}`;window.open(r,`_blank`)}})}function Xn(){let e=Rn.querySelector(`#buscar`).value.trim().toLowerCase(),t=Rn.querySelector(`#filtroEstado`).value;E.maestros=E.maestrosOriginales.filter(n=>{let r=(n.nombre||n.name||``).toLowerCase(),i=!e||r.includes(e)||(n.email||``).toLowerCase().includes(e)||(n.instrumento||``).toLowerCase().includes(e)||(n.especialidad||``).toLowerCase().includes(e)||(n.especialidades||[]).some(t=>t.toLowerCase().includes(e)),a=n.is_active??!0;return i&&(t===`todos`||t===`activo`&&a||t===`inactivo`&&!a)}),tr()}function Zn(){E.editando=null,b.open({title:`Crear Nuevo Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${Ln.nombreMax}" placeholder="Juan Pérez">
        <small class="text-muted" id="modal-nombreCount">0/${Ln.nombreMax}</small>
      </div>
      <div class="col-md-6">
    ...
    </form>`,onShow:e=>Gn(e),saveText:`Guardar`,onSave:async e=>{let t=e.querySelector(`#modal-nombre`).value.trim(),n=e.querySelector(`#modal-email`).value.trim().toLowerCase(),r=e.querySelector(`#modal-password`)?.value,i=e.querySelector(`#modal-telefono`).value.trim(),a=e.querySelector(`#modal-instrumento`).value.trim(),o=e.querySelector(`#modal-bio`).value.trim();if(!t)return D(`El nombre es obligatorio`,`error`),!1;if(!n)return D(`El email es obligatorio`,`error`),!1;if(!nr(n))return D(`El formato del email no es válido`,`error`),!1;if(!r||r.length<6)return D(`La contraseña debe tener al menos 6 caracteres`,`error`),!1;if(!a)return D(`El instrumento es obligatorio`,`error`),!1;if(n&&await nn(n))return D(`El email ya está registrado`,`error`),!1;let s=Wn(e);try{let{data:e,error:c}=await _.auth.signUp({email:n,password:r,options:{data:{full_name:t,rol:`maestro`}}});if(c)return D(c.message||`Error al crear usuario`,`error`),!1;if(!e?.user)return D(`No se pudo crear el usuario`,`error`),!1;let l=e.user.id;await _.from(`profiles`).update({estado:`activo`}).eq(`id`,l),await _.from(`maestros`).update({tlf:i||null,especialidad:a||null,resena:o||null,especialidades:s}).eq(`user_id`,l);let u=await Qt();E.maestros=u,E.maestrosOriginales=[...u],Xn(),D(`Maestro creado exitosamente. Ya puede iniciar sesión.`,`success`)}catch(e){console.error(`Error creando maestro:`,e),D(`Error al crear el maestro: `+e.message,`error`)}}})}function Qn(e){let t=E.maestrosOriginales.find(t=>t.id===e);if(!t){D(`Maestro no encontrado`,`error`);return}E.editando=e,b.open({title:`Editar Maestro`,body:`<form class="row g-2" novalidate>
      <div class="col-12">
        <label class="form-label-compact">Nombre Completo *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required maxlength="${Ln.nombreMax}" value="${T(t.nombre||t.name||``)}">
        <small class="text-muted" id="modal-nombreCount">${(t.nombre||t.name||``).length}/${Ln.nombreMax}</small>
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Email *</label>
      ...
      ${Un(t.especialidades||[],`modal-especialidades-input`)}
      <div class="col-12">
        <label class="form-label-compact">Biografía</label>
    ...
    </form>`,onShow:e=>Gn(e),saveText:`Guardar cambios`,onSave:async e=>{let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-telefono`).value.trim(),a=e.querySelector(`#modal-instrumento`).value.trim(),o=e.querySelector(`#modal-especialidad`).value.trim(),s=e.querySelector(`#modal-bio`).value.trim(),c=e.querySelector(`#modal-esActivo`).checked;if(!n)return D(`El nombre es obligatorio`,`error`),!1;if(!r)return D(`El email es obligatorio`,`error`),!1;if(!nr(r))return D(`El formato del email no es válido`,`error`),!1;if(r&&t.email!==r&&await nn(r))return D(`El email ya está registrado`,`error`),!1;let l=Wn(e),u={nombre:n,email:r||null,telefono:i||null,instrumento:a||null,especialidad:o||null,bio:s||null,is_active:c,especialidades:l};await $t(E.editando,u);let d=E.maestrosOriginales.findIndex(e=>e.id===E.editando);d!==-1&&(E.maestrosOriginales[d]={...E.maestrosOriginales[d],...u}),Xn(),D(`Maestro actualizado correctamente`,`success`)}})}function $n(e){let t=E.maestrosOriginales.find(t=>t.id===e);if(!t){D(`Maestro no encontrado`,`error`);return}let n=t.nombre||t.name||`-`,r=t.is_active??!0;b.open({title:n,hideSave:!0,cancelText:`Cerrar`,body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">
              <span class="badge ${rn(r)}">${an(r)}</span>
            </p>
          </div>
        </div>
      </div>
    ...
    `,onShow:async t=>{t.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>Qn(e),300)}),t.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>er(e),300)});let n=t.querySelector(`#maestro-clases-container`),r=t.querySelector(`#maestro-clases-badge`);(async()=>{try{let[t,i,a,o,s]=await Promise.all([be(e),_.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),_.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),_.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),_.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]),c={maestros:i.data||[],salones:a.data||[],programas:o.data||[],alumnos:s.data||[]};if(r.textContent=`${t.length} clase${t.length===1?``:`s`}`,t.length===0){n.innerHTML=`
            ...
            </div>`,n.querySelectorAll(`.btn-editar-clase`).forEach(n=>{n.addEventListener(`click`,n=>{let r=n.currentTarget.dataset.claseId,i=t.find(e=>e.id===r);i&&(b.close(),setTimeout(()=>{vn(i,{...c,onSuccess:()=>{setTimeout(()=>$n(e),300)}})},300))})}),n.querySelectorAll(`.btn-desvincular-clase`).forEach(t=>{t.addEventListener(`click`,async t=>{let n=t.currentTarget.dataset.claseId,r=t.currentTarget.dataset.claseNombre,i=t.currentTarget.dataset.esSuplente===`true`?`maestro_suplente_id`:`maestro_principal_id`;if(confirm(`¿Quitar a este maestro de "${r}"?`))try{t.currentTarget.disabled=!0,t.currentTarget.innerHTML=`<span class="spinner-border spinner-border-sm"></span>`,await ke(n,{[i]:null},!0),D(`Maestro desvinculado correctamente`,`success`),b.close(),setTimeout(()=>$n(e),300)}catch(e){D(`Error al desvincular: `+e.message,`error`),t.currentTarget.disabled=!1,t.currentTarget.innerHTML=`<i class="bi bi-person-dash" style="font-size:1rem;"></i><span>Quitar</span>`}})})}catch{r.textContent=`Error`,n.innerHTML=`
            <div class="alert alert-danger py-2 mb-0 small">
              <i class="bi bi-exclamation-triangle me-1"></i> Error al cargar las clases.
            </div>`}})()}})}function er(e){let t=E.maestrosOriginales.find(t=>t.id===e);if(!t){D(`Maestro no encontrado`,`error`);return}E.deletingId=e;let n=t.nombre||t.name||``,r=t.is_active!==!1;b.open({title:r?`⏸️ Desactivar Maestro`:`▶️ Reactivar Maestro`,size:`sm`,saveText:r?`Desactivar`:`Reactivar`,body:r?`<p>¿Desactivar al maestro <strong>${T(n)}</strong>?</p>
         ...
         <p class="text-muted small mb-0">El maestro volverá a aparecer en las listas.</p>`,onSave:async()=>{r?(await en(e),D(`Maestro desactivado correctamente`,`success`)):(await tn(e),D(`Maestro reactivado correctamente`,`success`)),Xn()}})}function tr(){let e=Rn.querySelector(`#maestrosTBody`);if(!e)return;e.innerHTML=qn(E.maestros);let t=Rn.querySelector(`.maestros-header-premium p.text-muted`);t&&(t.textContent=`${E.maestros.length} maestros en total`)}function nr(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function rr(){if(E.maestrosOriginales.length===0){D(`No hay maestros para exportar`,`error`);return}let e=[[`Nombre`,`Email`,`Teléfono`,`Instrumento`,`Especialidad`,`Estado`],...E.maestrosOriginales.map(e=>[e.nombre||``,e.email||``,e.telefono||``,e.instrumento||``,e.especialidad||``,e.is_active===!1?`Inactivo`:`Activo`])].map(e=>e.map(e=>`"${String(e).replace(/"/g,`""`)}"`).join(`,`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`maestros-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),D(`CSV exportado exitosamente`,`success`)}function D(e,t=`info`){let n=Rn.querySelector(`#toastContainer`);if(!n)return;let r=t===`success`?`bg-success`:t===`error`?`bg-danger`:`bg-info`,i=t===`success`?`bi-check-circle`:t===`error`?`bi-exclamation-circle`:`bi-info-circle`,a=t===`success`?`Éxito`:t===`error`?`Error`:`Información`,o=document.createElement(`div`);o.className=`toast`,o.setAttribute(`role`,`alert`),o.setAttribute(`aria-live`,`assertive`),o.setAttribute(`aria-atomic`,`true`),o.innerHTML=`
  ...
  `,n.appendChild(o),new Be(o,{autohide:!0,delay:3e3}).show(),o.addEventListener(`hidden.bs.toast`,()=>o.remove())}function ir(){S.register(`maestros`,Bn)}var ar=class{constructor(e={}){this.id=e.id||null,this.nombre=e.nombre||``,this.descripcion=e.descripcion||``,this.nivel=e.nivel||``,this.duracion_anios=e.duracion_anios||null,this.activo=e.activo===void 0?!0:e.activo,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(e=[]){let t=[];return!this.nombre||!this.nombre.trim()?t.push(`El nombre del programa es obligatorio`):this.nombre.length>100&&t.push(`El nombre no puede exceder los 100 caracteres`),this.nivel?e.length>0&&!e.includes(this.nivel)&&t.push(`El nivel seleccionado no es válido`):t.push(`El nivel es obligatorio`),this.descripcion&&this.descripcion.length>500&&t.push(`La descripción no puede exceder los 500 caracteres`),this.duracion_anios!==null&&(isNaN(this.duracion_anios)||this.duracion_anios<0)&&t.push(`La duración debe ser un número positivo`),t}toJSON(){return{nombre:this.nombre.trim(),descripcion:this.descripcion?this.descripcion.trim():``,nivel:this.nivel,duracion_anios:this.duracion_anios,activo:this.activo}}},or=[{value:``,label:`Sin nivel específico`},{value:`1`,label:`1° Año`},{value:`2`,label:`2° Año`},{value:`3`,label:`3° Año`},{value:`4`,label:`4° Año`},{value:`5`,label:`5° Año`},{value:`6`,label:`6° Año`},{value:`inicial`,label:`Nivel Inicial`},{value:`intermedio`,label:`Nivel Intermedio`},{value:`avanzado`,label:`Nivel Avanzado`},{value:`preuniversitario`,label:`Pre-Universitario`}];function sr(e){let t=or.find(t=>t.value===e);return t?t.label:e||`-`}async function cr(){let{data:e,error:t}=await _.from(`programas`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando programas:`,t.message),t;return(e||[]).map(e=>new ar(e))}async function lr(e){let t=new ar(e),n=or.map(e=>e.value).filter(Boolean),r=t.validate(n);if(r.length>0)throw Error(r.join(`. `));let{data:i,error:a}=await _.from(`programas`).insert([t.toJSON()]).select();if(a)throw console.error(`Error creando programa:`,a.message),a;return new ar(i[0])}async function ur(e,t){let n=new ar(t),r=or.map(e=>e.value).filter(Boolean),i=n.validate(r);if(i.length>0)throw Error(i.join(`. `));let{data:a,error:o}=await _.from(`programas`).update(n.toJSON()).eq(`id`,e).select();if(o)throw console.error(`Error actualizando programa:`,o.message),o;return new ar(a[0])}async function dr(e){let{error:t}=await _.from(`programas`).delete().eq(`id`,e);if(t)throw console.error(`Error eliminando programa:`,t.message),t}async function fr(e){let{jsPDF:t}=await y(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-B53WQQE_.js`).then(e=>e.n);return{jsPDF:e}},__vite__mapDeps([3,4,5,6])),{default:n}=await y(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-95nmaIim.js`).then(e=>e.n);return{default:e}},__vite__mapDeps([7,4])),r=new t;r.setFontSize(18),r.text(`Programas Académicos`,14,22),r.setFontSize(10),r.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,30),n(r,{head:[[`Nombre`,`Nivel`,`Descripción`,`Estado`,`Creado`]],body:e.map(e=>[e.nombre,sr(e.nivel),e.descripcion?e.descripcion.substring(0,50)+(e.descripcion.length>50?`...`:``):`-`,e.activo?`Activo`:`Inactivo`,e.created_at?new Date(e.created_at).toLocaleDateString(`es-ES`):`-`]),startY:35,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),r.save(`programas.pdf`)}var O={programas:[],programasOriginales:[],cargando:!1},pr={nombreMax:100,descripcionMax:500};function mr(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function hr(e){return e?new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`}):`N/A`}function gr(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].charAt(0).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function _r(e=``){return or.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}async function vr(e){try{O.cargando=!0,yr(e);let t=await cr();O.programas=t,O.programasOriginales=[...t],O.cargando=!1,xr(e),Tr(e)}catch(t){console.error(`[ProgramasView]`,t),br(e,t.message)}}function yr(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>vr(e))}function xr(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded w-100">
        ...
        <div id="emptyContainer">
          ${O.programas.length===0?Cr():``}
        </div>
      </div>
    </div>
  `}function Sr(e){return e.length?e.map(e=>{let t=gr(e.nombre),n=sr(e.nivel),r=mr(e.descripcion||`Sin descripción`),i=`border-accent-${e.activo?`success`:`secondary`}`,a=`bg-${e.activo?`success`:`secondary`}`;return`
      <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${i}" data-id="${e.id}" style="cursor: pointer;">
        <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
          ...
          <div class="d-flex flex-column flex-grow-1 overflow-hidden pe-3">
            <span class="fw-bold text-truncate" style="font-size: 1.05rem;">${mr(e.nombre)}</span>
    ...
    `}).join(``):``}function Cr(){return`
    <div class="text-center py-5 text-muted">
      <i class="bi bi-inbox fs-1 d-block mb-2"></i>
      <p>No hay programas que coincidan con la búsqueda.</p>
    </div>
  `}var wr=null;function Tr(e){wr=e,e.querySelector(`#btnAgregarPrograma`)?.addEventListener(`click`,()=>Or()),e.querySelector(`#btnExportarPDF`)?.addEventListener(`click`,async()=>{try{await fr(O.programas),v.success(`PDF generado exitosamente`)}catch{v.error(`Error al generar PDF`)}}),e.querySelector(`#buscar`)?.addEventListener(`input`,Er),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,Er),e.querySelector(`#programasTBody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t){let t=e.target.closest(`.list-group-item[data-id]`);t&&jr(t.dataset.id);return}let{action:n,id:r}=t.dataset;n===`edit`&&kr(r),n===`delete`&&Mr(r)})}function Er(){let e=wr.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=wr.querySelector(`#filtroEstado`)?.value||`todos`;O.programas=O.programasOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||(n.descripcion||``).toLowerCase().includes(e),i=t===`todos`||t===`activo`&&n.activo||t===`inactivo`&&!n.activo;return r&&i}),Dr()}function Dr(){let e=wr.querySelector(`#programasTBody`);e&&(e.innerHTML=Sr(O.programas));let t=wr.querySelector(`#emptyContainer`);t&&(t.innerHTML=O.programas.length===0?Cr():``)}function Or(){Ar({title:`Nuevo Programa`,saveText:`Crear Programa`})}function kr(e){let t=O.programasOriginales.find(t=>t.id===e);if(!t)return v.error(`Programa no encontrado`);Ar({title:`Editar Programa`,saveText:`Guardar Cambios`,programa:t})}function Ar({title:e,saveText:t,programa:n=null}){b.open({title:e,saveText:t,body:`
      <form id="form-programa" class="row g-3">
        <div class="col-12">
          <label class="form-label-compact">Nombre del Programa *</label>
          <input type="text" class="form-control input-dense" id="prog-nombre" required maxlength="${pr.nombreMax}" value="${mr(n?.nombre||``)}">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control input-dense" id="prog-descripcion" rows="3" maxlength="${pr.descripcionMax}">${mr(n?.descripcion||``)}</textarea>
        </div>
        <div class="col-12">
          <div class="form-check">
    ...
    `,onSave:async e=>{let t={nombre:e.querySelector(`#prog-nombre`).value.trim(),nivel:e.querySelector(`#prog-nivel`).value,duracion_anios:e.querySelector(`#prog-duracion`).value?parseFloat(e.querySelector(`#prog-duracion`).value):null,descripcion:e.querySelector(`#prog-descripcion`).value.trim(),activo:e.querySelector(`#prog-activo`).checked},r=new ar(t),i=or.map(e=>e.value).filter(Boolean),a=r.validate(i);if(a.length>0)return v.error(a[0]),!1;try{if(n){let e=await ur(n.id,t),r=O.programasOriginales.findIndex(e=>e.id===n.id);O.programasOriginales[r]=e,v.success(`Programa actualizado`)}else{let e=await lr(t);O.programasOriginales.unshift(e),v.success(`Programa creado`)}return Er(),!0}catch(e){return v.error(e.message),!1}}})}function jr(e){let t=O.programasOriginales.find(t=>t.id===e);t&&b.open({title:`Perfil del Programa`,hideSave:!0,cancelText:`Cerrar`,body:`
      <div class="programa-profile">
        ...
        <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-light-subtle">
          ...
          <div class="overflow-hidden">
            <h4 class="h5 mb-1 fw-bold text-truncate" style="letter-spacing: -0.01em;">${mr(t.nombre)}</h4>
            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle">${sr(t.nivel)}</span>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="programa-profile-card">
              ...
              <p class="mb-0 programa-profile-desc" style="font-size: 0.9rem; line-height: 1.5; white-space: pre-line;">
                ${mr(t.descripcion||`Sin descripción detallada.`)}
              </p>
            </div>
          </div>
            ...
            <div class="programa-profile-card">
              <div class="row g-2">
                <div class="col-sm-6">
                  ...
                  <p class="mb-0 programa-profile-value small" style="opacity: 0.85;">${hr(t.created_at)}</p>
                </div>
                <div class="col-sm-6">
                  <label class="programa-profile-label small text-uppercase fw-bold mb-1 d-block" style="font-size: 0.72rem; letter-spacing: 0.05em;">
                    <i class="bi bi-calendar-event me-1"></i> Modificado
                  </label>
                  <p class="mb-0 programa-profile-value small" style="opacity: 0.85;">${t.updated_at?hr(t.updated_at):hr(t.created_at)}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    `,onShow:n=>{n.querySelector(`#view-edit-btn`).addEventListener(`click`,()=>{b.close(),setTimeout(()=>kr(e),300)}),n.querySelector(`#view-delete-btn`).addEventListener(`click`,()=>{b.close(),setTimeout(()=>Mr(e),300)}),n.querySelector(`#copy-id-btn`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(t.id),v.success(`ID copiado al portapapeles`)})}})}function Mr(e){let t=O.programasOriginales.find(t=>t.id===e);t&&b.open({title:`⚠️ Eliminar Programa`,saveText:`Confirmar Eliminación`,body:`
      <p>¿Estás seguro de eliminar el programa <strong>${mr(t.nombre)}</strong>?</p>
      <p class="text-danger small mb-0"><i class="bi bi-exclamation-triangle-fill me-1"></i> Esta acción no se puede deshacer.</p>
    `,onSave:async()=>{try{return await dr(e),O.programasOriginales=O.programasOriginales.filter(t=>t.id!==e),Er(),v.success(`Programa eliminado`),!0}catch{return v.error(`Error al eliminar`),!1}}})}function Nr(){S.register(`programas`,vr)}var Pr=[{key:`nombre_completo`,label:`Nombre completo`,peso:10,grupo:`Personal`},{key:`fecha_nacimiento`,label:`Fecha de nacimiento`,peso:8,grupo:`Personal`},{key:`genero`,label:`Género`,peso:3,grupo:`Personal`},{key:`nacionalidad`,label:`Nacionalidad`,peso:3,grupo:`Personal`},{key:`municipio_residencia`,label:`Municipio`,peso:4,grupo:`Personal`},{key:`direccion`,label:`Dirección`,peso:4,grupo:`Personal`},{key:`madre_tlf_whatsapp`,label:`WhatsApp de la madre`,peso:8,grupo:`Contacto`},{key:`padre_tlf_whatsapp`,label:`WhatsApp del padre`,peso:5,grupo:`Contacto`},{key:`representante_tlf`,label:`Teléfono representante`,peso:5,grupo:`Contacto`},{key:`madre_nombre`,label:`Nombre de la madre`,peso:6,grupo:`Familia`},{key:`padre_nombre`,label:`Nombre del padre`,peso:5,grupo:`Familia`},{key:`representante_nombre`,label:`Nombre del representante`,peso:6,grupo:`Familia`},{key:`representante_parentesco`,label:`Parentesco representante`,peso:3,grupo:`Familia`},{key:`contacto_emergencia_nombre`,label:`Contacto de emergencia`,peso:4,grupo:`Familia`},{key:`instrumento_principal`,label:`Instrumento principal`,peso:8,grupo:`Musical`},{key:`instrumento_interes`,label:`Instrumento de interés`,peso:4,grupo:`Musical`},{key:`nivel_actual`,label:`Nivel actual`,peso:4,grupo:`Musical`},{key:`centro_estudios`,label:`Centro de estudios`,peso:4,grupo:`Escolar`},{key:`grado_nivel`,label:`Grado / Nivel`,peso:3,grupo:`Escolar`},{key:`alergias_descripcion`,label:`Alergias (declaradas)`,peso:3,grupo:`Salud`,opcional:!0},{key:`problemas_conducta`,label:`Conducta (declarada)`,peso:3,grupo:`Salud`,opcional:!0},{key:`acepta_pago_600`,label:`Acepta pago RD$600`,peso:5,grupo:`Compromisos`},{key:`autoriza_fotos_redes`,label:`Autoriza fotos en redes`,peso:3,grupo:`Compromisos`}],Fr=Pr.reduce((e,t)=>e+t.peso,0);function Ir(e,t){let n=e[t];return!(n==null||n===``||typeof n==`string`&&n.trim()===``)}function Lr(e){let t=[],n=[];for(let r of Pr)Ir(e,r.key)?n.push(r):t.push(r);let r=n.reduce((e,t)=>e+t.peso,0),i=Math.round(r/Fr*100),a=i>=90?`completo`:i>=65?`bueno`:i>=35?`parcial`:`critico`,o={};for(let t of Pr)o[t.grupo]||(o[t.grupo]={total:0,completos:0,porcentaje:0,faltantes:[]}),o[t.grupo].total++,Ir(e,t.key)?o[t.grupo].completos++:o[t.grupo].faltantes.push(t.label);for(let e of Object.values(o))e.porcentaje=Math.round(e.completos/e.total*100);return{porcentaje:i,nivel:a,camposFaltantes:t,camposCompletos:n,porGrupo:o}}var Rr={critico:`danger`,parcial:`warning`,bueno:`info`,completo:`success`},zr={critico:`Crítico`,parcial:`Parcial`,bueno:`Bueno`,completo:`Completo`};function Br(e){return e?new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`}):`Fecha desconocida`}function Vr(e){if(!e)return null;let t=new Date,n=new Date(e),r=t.getFullYear()-n.getFullYear(),i=t.getMonth()-n.getMonth();return(i<0||i===0&&t.getDate()<n.getDate())&&r--,r}function k(e){return e==null?``:String(e).replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e})}function Hr(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}var A={alumnos:[],alumnosOriginales:[],cargando:!1,editando:null,viewingId:null,deletingId:null,filtroGenero:``,filtroEstado:`todos`},Ur=null,Wr={nombreMax:100,emailMax:100,cedulaMax:20,telefonoMax:20,acudienteMax:100,direccionMax:255,sectionMax:100};async function Gr(e){try{A.cargando=!0,Kr(e);let t=await Ze();A.alumnos=t,A.alumnosOriginales=[...t],A.cargando=!1,Jr(e),Zr(e)}catch(t){console.error(t),qr(e,t.message)}}function Kr(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status">
          <span class="visually-hidden">Cargando...</span>
  ...
  `,document.getElementById(`retryBtn`)?.addEventListener(`click`,()=>Gr(e))}function Jr(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded w-100">
        ...
        <div id="emptyContainer">
          ${A.alumnos.length===0?Xr():``}
        </div>
      </div>

    </div>
  `}function Yr(e){return e.length?e.map(e=>{let t=e.nombre||`-`,n=e.is_active??!0,r=`border-accent-${n?`success`:`secondary`}`,i=`bg-${n?`success`:`secondary`}`,{porcentaje:a,nivel:o}=Lr(e),s=o!==`completo`,c=s?Rr[o]:``;return`
      <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${r}" data-id="${e.id}" style="cursor: pointer;">
        <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
          <div class="position-relative flex-shrink-0">
            <div class="avatar-compact bg-primary bg-opacity-10 text-primary border border-primary-subtle d-flex align-items-center justify-content-center rounded-circle" style="width: 48px; height: 48px; font-size: 1.2rem; font-weight: 600;">
        ...
        <div class="d-flex align-items-center gap-3 flex-shrink-0">
          ...
          <div class="d-flex justify-content-center align-items-center flex-shrink-0" style="width: 52px;">
            ${s?`
              <span class="badge badge-completitud badge-completitud-${c}" title="Perfil ${a}% completo — ${zr[o]}">
                ${a}%
              </span>
            `:``}
          </div>
  ...
  `}function Zr(e){Ur=e,e.querySelector(`#btnAgregarAlumno`)?.addEventListener(`click`,()=>ri()),e.querySelector(`#btnInscribir`)?.addEventListener(`click`,()=>window.router?.navigate(`alumnos-inscribir`)),e.querySelector(`#btnReporteMes`)?.addEventListener(`click`,()=>window.router?.navigate(`alumnos-reporte-mes`)),e.querySelector(`#btnPdfDemo`)?.addEventListener(`click`,()=>window.router?.navigate(`alumnos-pdf-demo`)),e.querySelector(`#btnExportarCSV`)?.addEventListener(`click`,()=>oi()),e.querySelector(`#buscar`)?.addEventListener(`input`,$r),e.querySelector(`#filtroWhatsapp`)?.addEventListener(`change`,$r),e.querySelector(`#filtroCompletitud`)?.addEventListener(`change`,$r),e.querySelector(`#filtroInstrumento`)?.addEventListener(`change`,$r),e.querySelector(`#btnLimpiarFiltros`)?.addEventListener(`click`,t=>{t.stopPropagation();let n=e.querySelector(`#filtroWhatsapp`),r=e.querySelector(`#filtroCompletitud`),i=e.querySelector(`#filtroInstrumento`);n&&(n.value=`todos`),r&&(r.value=`todos`),i&&(i.value=`todos`),$r()}),e.querySelector(`#alumnosTBody`)?.addEventListener(`click`,async e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t&&!e.target.closest(`[data-action]`)){window.router?.navigate(`alumno`,{id:t.dataset.id});return}let n=e.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.id;n.dataset.action===`edit`?window.router?.navigate(`alumno`,{id:r}):n.dataset.action===`delete`?ii(r):n.dataset.action===`whatsapp`&&Qr(r)})}function Qr(e){let t=A.alumnosOriginales.find(t=>t.id===e);!t||!t.telefono||b.open({title:`Enviar WhatsApp a `+k(t.nombre),size:`md`,saveText:`Enviar WhatsApp`,body:`
      <div class="mb-3">
        <label class="form-label-compact">Número de destino</label>
        <p class="form-control-plaintext fw-bold mb-0">
    ...
    `,onSave:async e=>{let n=e.querySelector(`#modal-whatsapp-msg`).value.trim(),r=de(t.telefono,n);r&&window.open(r,`_blank`)}})}function $r(){let e=Ur.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=Ur.querySelector(`#filtroWhatsapp`)?.value||`todos`,n=Ur.querySelector(`#filtroCompletitud`)?.value||`todos`,r=Ur.querySelector(`#filtroInstrumento`)?.value||`todos`;A.alumnos=A.alumnosOriginales.filter(i=>{let a=!e||(i.nombre||``).toLowerCase().includes(e)||(i.instrumento||``).toLowerCase().includes(e)||(i.telefono||``).toLowerCase().includes(e)||(i.familiar_nombre||``).toLowerCase().includes(e),o=!!i.telefono&&i.telefono.trim()!==``,s=t===`todos`||t===`con_whatsapp`&&o||t===`sin_whatsapp`&&!o,{nivel:c}=Lr(i),l=n===`todos`||n===c,u=!!i.instrumento&&i.instrumento.trim()!==``&&i.instrumento.toLowerCase()!==`sin instrumento especificado`;return a&&s&&l&&(r===`todos`||r===`con_instrumento`&&u||r===`sin_instrumento`&&!u)});let i=0;t!==`todos`&&i++,n!==`todos`&&i++,r!==`todos`&&i++;let a=Ur.querySelector(`#filtrosBadgeCount`);a&&(a.textContent=i,i>0?a.classList.remove(`d-none`):a.classList.add(`d-none`));let o=Ur.querySelector(`#filtrosActivosCount`);o&&(o.textContent=`Filtros activos: ${i}`),ai()}function ei(e=``){return Qe.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}function ti(e=null){let t=e||{};return`<form class="row g-2">
    <div class="col-12">
      <label class="form-label-compact">Nombre Completo *</label>
      <input type="text" class="form-control input-dense" id="modal-nombre" maxlength="${Wr.nombreMax}" required placeholder="Juan Pérez" autocomplete="off" value="${k(t.nombre||``)}">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      <label class="form-label-compact">Email</label>
      <input type="email" class="form-control input-dense" id="modal-email" maxlength="${Wr.emailMax}" placeholder="representante@ejemplo.com" autocomplete="off" value="${k(t.email||``)}">
    </div>
    <div class="col-md-6">
      <label class="form-label-compact">Cédula del Alumno</label>
      <input type="text" class="form-control input-dense" id="modal-cedula" maxlength="${Wr.cedulaMax}" placeholder="12345678" autocomplete="off" value="${k(t.cedula||``)}">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      <label class="form-label-compact">Instrumento *</label>
      <input type="text" class="form-control input-dense" id="modal-instrumento" required maxlength="${Wr.sectionMax}" placeholder="Violín, Piano..." autocomplete="off" value="${k(t.instrumento||``)}">
    </div>
    <div class="col-12">
      <label class="form-label-compact">Dirección</label>
      <input type="text" class="form-control input-dense" id="modal-direccion" maxlength="${Wr.direccionMax}" placeholder="Dirección completa" autocomplete="off" value="${k(t.direccion||``)}">
    </div>
        ...
        <div class="row g-2">
          ...
          <div class="col-md-4">
            ...
            <select class="form-select input-dense" id="modal-contacto-emergencia-parentesco">
              ${ei(t.contacto_emergencia_parentesco)}
            </select>
          </div>
        </div>
      </div>
    ...
    <div class="col-12">
      <div class="form-check">
  ...
  </form>`}async function ni(e,t=null){let n=e.querySelector(`#modal-nombre`).value.trim(),r=e.querySelector(`#modal-email`).value.trim().toLowerCase(),i=e.querySelector(`#modal-telefono`).value.trim(),a=e.querySelector(`#modal-cedula`).value.trim(),o=e.querySelector(`#modal-fechaNacimiento`).value,s=e.querySelector(`#modal-genero`).value,c=e.querySelector(`#modal-instrumento`).value.trim(),l=e.querySelector(`#modal-familiar-nombre`).value.trim(),u=e.querySelector(`#modal-familiar-telefono-input`).value.trim()||i,d=e.querySelector(`#modal-familiar-parentesco-input`).value,f=e.querySelector(`#modal-esActivo`).checked;return n?c?i?{nombre:n,email:r||null,telefono:Fe(i)||i,cedula:a||null,fecha_nacimiento:o||null,genero:s||null,instrumento:c,is_active:f,familiar_nombre:l||null,familiar_telefono:Fe(u)||u||null,familiar_parentesco:d||null,contacto_emergencia_nombre:e.querySelector(`#modal-contacto-emergencia-nombre`).value.trim()||null,contacto_emergencia_telefono:Fe(e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim())||e.querySelector(`#modal-contacto-emergencia-telefono`).value.trim()||null,contacto_emergencia_parentesco:e.querySelector(`#modal-contacto-emergencia-parentesco`).value||null,condiciones_medicas:e.querySelector(`#modal-condiciones-medicas`).value.trim()||null,alergias:e.querySelector(`#modal-alergias`).value.trim()||null,medicamentos:e.querySelector(`#modal-medicamentos`).value.trim()||null}:(v.error(`El teléfono es obligatorio para WhatsApp`),null):(v.error(`El instrumento es obligatorio`),null):(v.error(`El nombre es obligatorio`),null)}function ri(){A.editando=null,b.open({title:`Crear Nuevo Alumno`,size:`lg`,body:ti(),saveText:`Guardar`,onSave:async e=>{let t=await ni(e);if(!t)return!1;let n=await Xe(t);A.alumnosOriginales.push(n),$r(),v.success(`Alumno creado exitosamente`)}})}function ii(e){let t=A.alumnosOriginales.find(t=>t.id===e);if(!t){v.error(`Alumno no encontrado`);return}A.deletingId=e,b.open({title:`⚠️ Eliminar Alumno`,size:`md`,saveText:`Eliminar`,body:`<div class="d-flex flex-column align-items-center justify-content-center py-5">
             <div class="spinner-border text-primary mb-3" role="status">
               <span class="visually-hidden">Cargando...</span>
             </div>
             <p class="text-muted mb-0">Analizando estado de inscripciones...</p>
           </div>`,onSave:async()=>{await Ke(e),A.alumnosOriginales=A.alumnosOriginales.filter(t=>t.id!==e),$r(),b.close(),v.success(`Alumno eliminado correctamente`)}});let n=document.querySelector(`#app-global-modal .app-modal-btn-save`);n&&(n.style.display=`none`),setTimeout(async()=>{try{if(A.deletingId!==e)return;let r=await qe(e),i=document.querySelector(`#app-global-modal .app-modal-body`);if(!i||A.deletingId!==e)return;n&&(n.style.display=``),r.length===0?i.innerHTML=`
        ...
        `)}},300)}function ai(){let e=Ur.querySelector(`#alumnosTBody`);if(!e)return;A.alumnos.length===0?e.innerHTML=Xr():e.innerHTML=Yr(A.alumnos);let t=Ur.querySelector(`#emptyContainer`);t&&(t.innerHTML=A.alumnos.length===0?Xr():``);let n=Ur.querySelector(`.alumnos-header-premium p.text-muted`);n&&(n.textContent=`${A.alumnos.length} alumnos en total`)}function oi(){if(A.alumnosOriginales.length===0){v.error(`No hay alumnos para exportar`);return}let e=[[`Nombre`,`Email`,`Teléfono`,`Estado`,`Fecha Nac.`,`Sección`],...A.alumnosOriginales.map(e=>[e.nombre||``,e.email||``,e.telefono||``,e.estado||`activo`,e.fecha_nacimiento||``,e.section||``])].map(e=>e.map(e=>`"${String(e).replace(/"/g,`""`)}"`).join(`,`)).join(`
`),t=new Blob([e],{type:`text/csv;charset=utf-8;`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`alumnos-${new Date().toISOString().split(`T`)[0]}.csv`,n.click(),v.success(`CSV exportado exitosamente`)}var si=[0,86,179],ci=[255,193,7],li=[30,30,30],ui=[``,`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`];function di(e,t=`—`){return String(e??``).trim()||t}function fi(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`).map(Number),i=new Date,a=i.getFullYear()-t;return(i.getMonth()+1<n||i.getMonth()+1===n&&i.getDate()<r)&&a--,String(a)}catch{return`—`}}function pi(e){return{cantar:`Cantar`,instrumento:`Instrumento`,ambas:`Ambas`}[e]??di(e)}function mi(e,t,n){let r=e.internal.pageSize.getWidth();e.setFillColor(...si),e.rect(0,0,r,26,`F`),e.setFillColor(...ci),e.rect(0,26,r,2,`F`),e.setTextColor(255,255,255),e.setFontSize(14),e.setFont(`helvetica`,`bold`),e.text(`El Sistema Punta Cana`,14,10),e.setFontSize(10),e.setFont(`helvetica`,`normal`),e.text(t,14,18),e.setFontSize(7.5),e.text(n,14,24),e.setTextColor(...li)}function hi(e,t,n){let r=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();e.setFillColor(...si),e.rect(0,i-8,r,8,`F`),e.setTextColor(255,255,255),e.setFontSize(6.5);let a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});e.text(`El Sistema Punta Cana — Generado: ${a}`,10,i-3),e.text(`Página ${t} de ${n}`,r-10,i-3,{align:`right`})}function gi(e,t,n){let r=new et({orientation:`landscape`,unit:`mm`,format:`letter`});r.internal.pageSize.getWidth();let i=`${ui[n]} ${t}`,a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});mi(r,`REPORTE DE INSCRIPCIONES — ${i.toUpperCase()}`,`Generado: ${a} · Total inscritos: ${e.length}`);let o=e.filter(e=>e.tiene_conocimientos_musicales===!0).length,s=e.filter(e=>e.tiene_conocimientos_musicales===!1||e.requiere_iniciacion_musical).length,c=e.filter(e=>e.beneficiario_subsidio_estado===!0).length,l=e.filter(e=>e.familia_monoparental===!0).length,u=e.filter(e=>e.autoriza_fotos_redes===!0).length;tt(r,{startY:36,margin:{left:10,right:10},theme:`grid`,head:[[`Total inscritos`,`Con conocimientos`,`Requieren iniciación`,`Beneficiarios subsidio`,`Fam. monoparental`,`Autorizan fotos`]],body:[[e.length,o,s,c,l,u]],headStyles:{fillColor:si,textColor:255,fontStyle:`bold`,fontSize:8,halign:`center`},bodyStyles:{halign:`center`,fontSize:11,fontStyle:`bold`}}),tt(r,{startY:r.lastAutoTable.finalY+6,margin:{left:10,right:10},theme:`striped`,head:[[`#`,`Nombre completo`,`Edad`,`Nac.`,`Municipio`,`Representante / Tlf`,`Interés`,`Instrumento`,`Iniciación`,`Pagó 600`]],body:e.map((e,t)=>[t+1,di(e.nombre_completo),fi(e.fecha_nacimiento),di(e.nacionalidad),di(e.municipio_residencia),di(e.representante_nombre)+`
`+di(e.representante_tlf),pi(e.interes_musical),di(e.instrumento_interes),e.requiere_iniciacion_musical?`Sí`:`No`,e.acepta_pago_600?`Sí`:`No`]),headStyles:{fillColor:si,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:42},2:{cellWidth:10,halign:`center`},3:{cellWidth:14},4:{cellWidth:20},5:{cellWidth:42},6:{cellWidth:16},7:{cellWidth:22},8:{cellWidth:15,halign:`center`},9:{cellWidth:14,halign:`center`}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();hi(r,e.pageNumber,t)}}),e.length>0&&(r.addPage(),mi(r,`PERFIL SOCIOCULTURAL — ${i.toUpperCase()}`,`Información motivacional y social de los alumnos inscritos`),tt(r,{startY:36,margin:{left:10,right:10},theme:`striped`,head:[[`#`,`Nombre`,`Colegio`,`Grado`,`Padres en vida`,`Monopar.`,`Subsidio`,`¿Por qué se unió?`,`Músico favorito`]],body:e.map((e,t)=>[t+1,di(e.nombre_completo),di(e.centro_estudios),di(e.grado_nivel),e.padres_en_vida===`ambos`?`Ambos`:e.padres_en_vida===`solo_madre`?`Solo madre`:e.padres_en_vida===`solo_padre`?`Solo padre`:e.padres_en_vida===`ninguno`?`Ninguno`:`—`,e.familia_monoparental?`Sí`:`No`,e.beneficiario_subsidio_estado?`Sí`:`No`,di(e.por_que_unirse).slice(0,80)+(di(e.por_que_unirse).length>80?`…`:``),di(e.musico_favorito)]),headStyles:{fillColor:si,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:38},2:{cellWidth:38},3:{cellWidth:16},4:{cellWidth:20},5:{cellWidth:14,halign:`center`},6:{cellWidth:14,halign:`center`},7:{cellWidth:55},8:{cellWidth:28}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();hi(r,e.pageNumber,t)}}));let d=r.internal.getNumberOfPages();for(let e=1;e<=d;e++)r.setPage(e),hi(r,e,d);return r}function _i(e,t,n){gi(e,t,n).save(`reporte-inscripciones-${[``,`enero`,`febrero`,`marzo`,`abril`,`mayo`,`junio`,`julio`,`agosto`,`septiembre`,`octubre`,`noviembre`,`diciembre`][n]}-${t}.pdf`)}function vi(e){return Qe.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}function yi(e){let t=e||{};return`<form class="row g-3">
    <div class="col-12">
    ...
    <div class="col-md-4">
      <label class="form-check form-switch">
        ...
        <span class="form-check-label small">Acepta beca RD$4,500</span>
          ...
          </span>`}function ki(e){if(!e.length)return``;let t=e.length,n=e.filter(e=>Di(e).estado===`completa`).length,r=e.filter(e=>Di(e).estado===`incompleta`).length;return`
    <div class="row g-3 mt-1 mb-2">
      ...
      <div class="col-6 col-md-3">
        <div class="card text-center border-warning h-100">
          <div class="card-body py-3">
            <div class="fs-2 fw-bold text-warning-emphasis">${e.filter(e=>Di(e).estado===`casi_completa`).length}</div>
    ...
    </div>`}function Ai(e){if(!e.length)return`<div class="alert alert-info mt-3">
              <i class="bi bi-info-circle me-2"></i>No hay alumnos inscritos en este período.
            </div>`;let t=e.map((e,t)=>{let{porcentaje:n,camposFaltantes:r,estado:i,completados:a,total:o}=Di(e),s=e.representante_tlf||e.madre_tlf_whatsapp||`—`,c=Ti(e.fecha_nacimiento),l=c===null?``:`${c} años`,u=r.length>0?`<div class="d-flex flex-wrap gap-1 mt-1">
    ...
    </div>`}function ji(e){e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-alumno-id]`);if(!t)return;let n=t.dataset.alumnoId;if(!n)return;let r=t.closest(`#reporte-resultado`)?.querySelector(`#btn-filtrar`);xi(n,{onSaved:()=>r?.click()})})}async function Mi(e){let t=new Date,n=t.getFullYear(),r=t.getMonth()+1,i=[];async function a(t,n){let r=e.querySelector(`#reporte-resultado`);r&&(r.innerHTML=`
      <div class="text-center py-4">
        <div class="spinner-border text-primary" role="status"></div>
        <p class="mt-2 text-muted">Cargando inscritos de ${Si[n]} ${t}...</p>
      </div>`);try{i=await Ge(t,n),r&&(r.innerHTML=ki(i)+Ai(i),ji(r));let a=e.querySelector(`#btn-descargar-pdf`);a&&(a.disabled=i.length===0,a.textContent=i.length>0?`Descargar PDF (${i.length} alumnos)`:`Sin inscritos`)}catch(e){console.error(e),r&&(r.innerHTML=`
    ...
    </div>`,e.querySelector(`#btn-filtrar`)?.addEventListener(`click`,()=>{let[t,i]=(e.querySelector(`#select-mes`)?.value??``).split(`-`).map(Number);t&&i&&(n=t,r=i,a(t,i))}),e.querySelector(`#btn-descargar-pdf`)?.addEventListener(`click`,()=>{try{_i(i,n,r)}catch(e){console.error(`Error generando PDF:`,e),alert(`Error al generar el PDF. Por favor intenta de nuevo.`)}}),a(n,r)}function Ni(e){return{currentStep:1,totalSteps:e,maxReachedStep:e,draft:{},errors:{},submitted:!1}}function Pi(e,t,n){if(e.currentStep>=e.totalSteps)return e;let r={...e.draft,...t};if(n){let{valid:t,errors:i}=n(r);if(!t)return{...e,draft:r,errors:i||{}}}let i=e.currentStep+1;return{...e,draft:r,errors:{},currentStep:i,maxReachedStep:Math.max(e.maxReachedStep,i)}}function Fi(e){return e.currentStep<=1?{...e,errors:{}}:{...e,currentStep:e.currentStep-1,errors:{}}}function Ii(e,t){return t<1||t>e.maxReachedStep?e:{...e,currentStep:t,errors:{}}}function Li(e){return{...e,submitted:!0}}var Ri=`wizard-inscripcion-draft`;function zi(e){localStorage.setItem(Ri,JSON.stringify(e))}function Bi(){let e=localStorage.getItem(Ri);if(e===null)return null;try{return JSON.parse(e)}catch{return null}}function Vi(){localStorage.removeItem(Ri)}function Hi({currentStep:e,totalSteps:t}){let n=Math.round(e/t*100);return`
    <div class="progress mb-3" role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="100" aria-label="Progreso del formulario">
      <div class="progress-bar" style="width: ${n}%">${n}%</div>
    </div>`}function Ui({steps:e,currentStep:t,maxReachedStep:n}){return`<ul class="nav nav-pills nav-fill mb-3 flex-wrap">${e.map((e,r)=>{let i=r+1,a=i===t,o=i<=n,s=a?`active`:``,c=o?``:`disabled aria-disabled="true"`;return`
        ...
        </li>`}).join(``)}</ul>`}var Wi=`system_config`;async function Gi(e){let{data:t,error:n}=await _.from(Wi).select(`value`).eq(`key`,e).single();return n?(console.warn(`Config not found:`,e),null):t?.value}async function Ki(e,t){let{error:n}=await _.from(Wi).upsert({key:e,value:t,updated_at:new Date().toISOString()},{onConflict:`key`});if(n)throw console.error(`Error saving config:`,n),n;return{key:e,value:t}}async function qi(){return Gi(`groq_api_key`)}async function Ji(e){return Ki(`groq_api_key`,e)}async function Yi(){return Gi(`openrouter_api_key`)}async function Xi(e){return Ki(`openrouter_api_key`,e)}async function Zi(){return Gi(`preferred_ai_model`)}async function Qi(e){return Ki(`preferred_ai_model`,e)}var $i={URL_REGLAMENTO:`url_reglamento`,URL_HORARIO:`url_horario`,URL_BIENVENIDA:`url_bienvenida`};async function ea(){let[e,t,n]=await Promise.all([Gi($i.URL_REGLAMENTO),Gi($i.URL_HORARIO),Gi($i.URL_BIENVENIDA)]);return{reglamento:e,horario:t,bienvenida:n}}async function ta({reglamento:e,horario:t,bienvenida:n}){let r=[];e!==void 0&&r.push(Ki($i.URL_REGLAMENTO,e)),t!==void 0&&r.push(Ki($i.URL_HORARIO,t)),n!==void 0&&r.push(Ki($i.URL_BIENVENIDA,n)),await Promise.all(r)}var j={azul:[20,60,130],azulMedio:[40,90,170],azulClaro:[220,232,250],dorado:[198,160,20],doradoClaro:[255,245,200],blanco:[255,255,255],grisOscuro:[40,40,40],grisMedio:[100,100,100],grisClaro:[245,245,248],rojo:[180,20,20],verde:[20,120,60]},na={id:`demo-0001-uuid`,nombre_completo:`María Gabriela Rodríguez Pérez`,fecha_nacimiento:`2013-06-15`,genero:`F`,nacionalidad:`Dominicana`,tiene_pasaporte:!1,sabe_leer:!0,sabe_escribir:!0,tlf_alumno:`8091234567`,como_se_entero:`Redes sociales`,municipio_residencia:`bavaro`,sector_calle_numero:`Bávaro, Calle Los Corales #12`,direccion:`Sector Los Corales, Bávaro, La Altagracia`,ubicacion_maps_url:`https://maps.google.com`,madre_nombre:`Carmen Pérez de Rodríguez`,madre_cedula:`001-1234567-8`,madre_tlf_whatsapp:`8097654321`,padre_nombre:`José Rafael Rodríguez`,padre_cedula:`001-9876543-2`,padre_tlf_whatsapp:`8299876543`,representante_nombre:`Carmen Pérez de Rodríguez`,representante_parentesco:`Madre`,representante_cedula:`001-1234567-8`,representante_tlf:`8097654321`,correo_representante:`carmen.perez@email.com`,otro_responsable_nombre:`José Rafael Rodríguez`,otro_responsable_cedula:`001-9876543-2`,otro_responsable_tlf:`8299876543`,contacto_emergencia_nombre:`Luisa Martínez`,contacto_emergencia_telefono:`8091112222`,beneficiario_subsidio_estado:!1,subsidio_descripcion:null,apoyo_actividades:`Disponible para apoyo en actividades los fines de semana`,instrumento_principal:`Violín`,nivel_actual:`Iniciación`,tiene_conocimientos_musicales:!1,instrumento_previo:null,nivel_lectura_musical:`Ninguno`,interes_musical:`instrumento`,instrumento_interes:`Violín`,sentimiento_musica_clasica:`Me emociona mucho y me parece muy bonita`,sentimiento_aprender_instrumento:`Estoy muy emocionada y quiero aprender rápido`,aspiracion_instrumento:`Llegar a tocar en una orquesta`,musico_favorito:`Beethoven`,preferencia_aprendizaje_musical:`Visual y auditiva`,por_que_unirse:`Siempre soñé con tocar un instrumento y El Sistema me da esa oportunidad`,alergias_descripcion:null,condicion_transmisible_desc:null,alergia_medicamento_desc:null,problemas_conducta:`no`,tiene_alergias:!1,tiene_condicion_transmisible:!1,tiene_alergia_medicamento:!1,centro_estudios:`Colegio San Juan Bosco`,grado_nivel:`5to de Primaria`,padres_en_vida:`ambos`,autoriza_fotos_redes:!0,acepta_beca_4500:!0,acepta_pago_600:!0,fecha_aceptacion_compromisos:new Date().toISOString(),requiere_iniciacion_musical:!0,familia_monoparental:!1};function M(e,t=`—`){return String(e??``).trim()||t}function ra(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}catch{return e}}function ia(e){if(!e)return`—`;try{let[t,n,r]=e.split(`-`).map(Number),i=new Date,a=i.getFullYear()-t;return(i.getMonth()+1<n||i.getMonth()+1===n&&i.getDate()<r)&&a--,`${a} años`}catch{return`—`}}function N(e){return e===!0||e===`true`||e===`t`?`Sí`:e===!1||e===`false`||e===`f`?`No`:`—`}function aa(e){return{punta_cana:`Punta Cana`,bavaro:`Bávaro`,veron:`Verón`,friusa:`Friusa`,el_cortecito:`El Cortecito`,los_corales:`Los Corales`,otro:`Otro`}[e]??M(e)}function oa(e){return{cantar:`Cantar`,instrumento:`Instrumento`,ambas:`Ambas`}[e]??M(e)}function sa(e){return{ambos:`Ambos`,solo_madre:`Solo madre`,solo_padre:`Solo padre`,ninguno:`Ninguno`}[e]??M(e)}function ca(e){return{no:`Sin problemas`,pocas_veces:`Pocas veces`,si:`Sí presenta`,violento:`Conducta violenta`}[e]??M(e)}function la(e){return`SOI-PC-${new Date().getFullYear()}-${e.id?e.id.replace(/-/g,``).slice(-8).toUpperCase():Date.now().toString(36).toUpperCase().slice(-8)}`}function ua(){return new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`})}var P=215.9,da=279.4,F=14;function fa(e,t,n=``){return e.setFillColor(...j.azul),e.rect(0,0,P,32,`F`),e.setFillColor(...j.dorado),e.rect(0,32,P,2.5,`F`),e.setFillColor(...j.dorado),e.rect(0,0,4,34.5,`F`),e.setTextColor(...j.blanco),e.setFont(`helvetica`,`bold`),e.setFontSize(15),e.text(`EL SISTEMA PUNTA CANA`,F+2,13),e.setFont(`helvetica`,`normal`),e.setFontSize(8),e.setTextColor(200,215,240),e.text(`Programa de Formación Musical · República Dominicana`,F+2,20),e.setFont(`helvetica`,`bold`),e.setFontSize(9),e.setTextColor(...j.dorado),e.text(t,P-F,13,{align:`right`}),n&&(e.setFont(`helvetica`,`normal`),e.setFontSize(7.5),e.setTextColor(190,205,230),e.text(n,P-F,20,{align:`right`})),e.setTextColor(...j.grisOscuro),38}function pa(e,t=1){e.setFillColor(...j.azul),e.rect(0,da-12,P,12,`F`),e.setFillColor(...j.dorado),e.rect(0,da-12,4,12,`F`),e.setFont(`helvetica`,`normal`),e.setFontSize(6.5),e.setTextColor(...j.blanco),e.text(`El Sistema Punta Cana · Punta Cana, Rep. Dominicana`,F+2,da-4.5),e.text(`Pág. ${t}`,P-F,da-4.5,{align:`right`})}function ma(e,t,n,r=j.azul){return e.setFillColor(...r),e.rect(F,n,P-F*2,6.5,`F`),e.setFont(`helvetica`,`bold`),e.setFontSize(8),e.setTextColor(...j.blanco),e.text(t,F+3,n+4.4),e.setTextColor(...j.grisOscuro),n+7.5}function ha(e,t,n,r={}){return tt(e,{startY:n,margin:{left:F,right:F},theme:`grid`,styles:{fontSize:7.5,cellPadding:{top:1.2,bottom:1.2,left:2.5,right:2.5},lineColor:[210,215,225],lineWidth:.2,textColor:j.grisOscuro,font:`helvetica`},alternateRowStyles:{fillColor:j.grisClaro},columnStyles:{0:{fontStyle:`bold`,cellWidth:r.labelW??42,fillColor:j.azulClaro,textColor:j.azul},2:{fontStyle:`bold`,cellWidth:r.labelW??42,fillColor:j.azulClaro,textColor:j.azul}},body:t,...r.extra}),e.lastAutoTable.finalY+2.5}function ga(e,t,n,r={}){return tt(e,{startY:n,margin:{left:F,right:F},theme:`grid`,styles:{fontSize:7.5,cellPadding:{top:1.2,bottom:1.2,left:2.5,right:2.5},lineColor:[210,215,225],lineWidth:.2,textColor:j.grisOscuro},columnStyles:{0:{fontStyle:`bold`,cellWidth:r.labelW??52,fillColor:j.azulClaro,textColor:j.azul}},body:t,...r.extra}),e.lastAutoTable.finalY+2.5}function _a(e,t,n,r){return pa(e,r-1),e.addPage(),fa(e,t,`Continuación · ${n}`)}function va(e,t,n,r,i,a){return t+n>da-22?(a.n++,_a(e,r,i,a.n)):t}function ya(e){let t=new et({unit:`mm`,format:`letter`}),n={n:1},r=`FICHA TÉCNICA DEL ALUMNO`,i=fa(t,r,`Generado: ${ua()}`);t.setFont(`helvetica`,`bold`),t.setFontSize(55),t.setTextColor(235,240,252),t.text(`USO INTERNO`,P/2,da/2,{align:`center`,angle:45}),t.setTextColor(...j.grisOscuro),t.setFillColor(...j.azulClaro),t.roundedRect(F,i,P-F*2,18,2,2,`F`),t.setFont(`helvetica`,`bold`),t.setFontSize(13),t.setTextColor(...j.azul),t.text(M(e.nombre_completo),F+4,i+7),t.setFont(`helvetica`,`normal`),t.setFontSize(8.5),t.setTextColor(...j.grisMedio);let a=[`Edad: ${ia(e.fecha_nacimiento)}`,`F. Nac.: ${ra(e.fecha_nacimiento)}`,`Instrumento: ${M(e.instrumento_principal)}`,`Nivel: ${M(e.nivel_actual)}`].join(`    ·    `);t.text(a,F+4,i+13),t.setTextColor(...j.grisOscuro),i+=22,i=ma(t,`1 · DATOS PERSONALES`,i),i=ha(t,[[`Nombre completo`,M(e.nombre_completo),`Fecha de nacimiento`,ra(e.fecha_nacimiento)],[`Edad`,ia(e.fecha_nacimiento),`Nacionalidad`,M(e.nacionalidad)],[`Género`,M(e.genero),`Tiene pasaporte`,N(e.tiene_pasaporte)],[`Sabe leer`,N(e.sabe_leer),`Sabe escribir`,N(e.sabe_escribir)],[`Cómo se enteró`,M(e.como_se_entero),`Municipio`,aa(e.municipio_residencia)],[`Sector / Calle`,M(e.sector_calle_numero),`Teléfono`,M(e.tlf_alumno)]],i),i=ga(t,[[`Dirección completa`,M(e.direccion)],[`Enlace Google Maps`,M(e.ubicacion_maps_url)]],i),i=va(t,i,40,r,e.nombre_completo,n),i=ma(t,`2 · DATOS DE LA MADRE / 3 · DATOS DEL PADRE`,i),i=ha(t,[[`Nombre (Madre)`,M(e.madre_nombre),`Nombre (Padre)`,M(e.padre_nombre)],[`Cédula Madre`,M(e.madre_cedula),`Cédula Padre`,M(e.padre_cedula)],[`WhatsApp Madre`,M(e.madre_tlf_whatsapp),`WhatsApp Padre`,M(e.padre_tlf_whatsapp)]],i),i=va(t,i,60,r,e.nombre_completo,n),i=ma(t,`4 · REPRESENTANTE Y CONTACTOS`,i),i=ha(t,[[`Representante`,M(e.representante_nombre),`Parentesco`,M(e.representante_parentesco)],[`Cédula`,M(e.representante_cedula),`Teléfono`,M(e.representante_tlf)],[`Correo`,M(e.correo_representante),`Fam. monoparen.`,N(e.familia_monoparental)],[`Otro responsable`,M(e.otro_responsable_nombre),`Cédula`,M(e.otro_responsable_cedula)],[`Tlf otro resp.`,M(e.otro_responsable_tlf),``,``],[`Emergencia 1`,M(e.contacto_emergencia_nombre),`Tlf`,M(e.contacto_emergencia_telefono)],[`Emergencia 2`,M(e.contacto_emergencia_2_nombre),`Tlf`,M(e.contacto_emergencia_2_telefono)]],i),i=ma(t,`5 · SITUACIÓN SOCIAL`,i),i=ha(t,[[`Beneficiario subsidio`,N(e.beneficiario_subsidio_estado),`Descripción`,M(e.subsidio_descripcion)],[`Apoyo actividades`,{content:M(e.apoyo_actividades),colSpan:3}]],i,{extra:{columnStyles:{0:{fontStyle:`bold`,cellWidth:42,fillColor:j.azulClaro,textColor:j.azul},2:{fontStyle:`bold`,cellWidth:42,fillColor:j.azulClaro,textColor:j.azul}}}}),i=va(t,i,70,r,e.nombre_completo,n),i=ma(t,`6 · PERFIL MUSICAL`,i,j.dorado),t.setFillColor(...j.doradoClaro),i=ha(t,[[`Conocimientos musicales`,N(e.tiene_conocimientos_musicales),`Instrumento previo`,M(e.instrumento_previo)],[`Nivel lectura musical`,M(e.nivel_lectura_musical),`Interés`,oa(e.interes_musical)],[`Instrumento de interés`,M(e.instrumento_interes),`Requiere iniciación`,N(e.requiere_iniciacion_musical)],[`Músico favorito`,M(e.musico_favorito),`Pref. aprendizaje`,M(e.preferencia_aprendizaje_musical)]],i),i=ga(t,[[`Por qué quiere unirse`,M(e.por_que_unirse)],[`Sentimiento música clásica`,M(e.sentimiento_musica_clasica)],[`Sentimiento al aprender`,M(e.sentimiento_aprender_instrumento)],[`Aspiración con instrumento`,M(e.aspiracion_instrumento)]],i,{labelW:55}),i=va(t,i,50,r,e.nombre_completo,n),i=ma(t,`7 · SALUD Y CONDUCTA`,i,j.rojo),i=ha(t,[[`Tiene alergias`,N(e.tiene_alergias),`Cuáles`,M(e.alergias_descripcion)],[`Cond. transmisible`,N(e.tiene_condicion_transmisible),`Cuál`,M(e.condicion_transmisible_desc)],[`Alergia medicamento`,N(e.tiene_alergia_medicamento),`Cuál`,M(e.alergia_medicamento_desc)],[`Impedimento social`,N(e.impedimento_social),`Conducta`,ca(e.problemas_conducta)]],i),i=ma(t,`8 · DATOS ESCOLARES`,i),i=ha(t,[[`Centro de estudios`,M(e.centro_estudios),`Grado / Nivel`,M(e.grado_nivel)],[`Padres en vida`,sa(e.padres_en_vida),``,``]],i),i=va(t,i,55,r,e.nombre_completo,n),i=ma(t,`9 · COMPROMISOS Y AUTORIZACIONES`,i,j.verde),i=ha(t,[[`Acepta beca RD$4,500`,N(e.acepta_beca_4500),`Acepta pago RD$600/mes`,N(e.acepta_pago_600)],[`Autoriza fotos/redes`,N(e.autoriza_fotos_redes),`Fecha compromisos`,ra(e.fecha_aceptacion_compromisos?.slice(0,10))]],i),i=va(t,i,45,r,e.nombre_completo,n),i+=8,t.setDrawColor(...j.grisMedio),t.setLineWidth(.3),t.line(F,i+18,F+78,i+18),t.setFont(`helvetica`,`bold`),t.setFontSize(7.5),t.setTextColor(...j.grisOscuro),t.text(`Firma del Representante`,F,i+23),t.setFont(`helvetica`,`normal`),t.setFontSize(7),t.setTextColor(...j.grisMedio),t.text(M(e.representante_nombre),F,i+27),t.text(`C.I.: ${M(e.representante_cedula)}`,F,i+31);let o=P/2+8;return t.setDrawColor(...j.grisMedio),t.line(o,i+18,P-F,i+18),t.setFont(`helvetica`,`bold`),t.setFontSize(7.5),t.setTextColor(...j.grisOscuro),t.text(`Encargado Administrativo`,o,i+23),t.setFont(`helvetica`,`normal`),t.setFontSize(7),t.setTextColor(...j.grisMedio),t.text(`El Sistema Punta Cana`,o,i+27),t.text(`Fecha: ${ua()}`,o,i+31),pa(t,n.n),t}function ba(e,t={}){let n=new et({unit:`mm`,format:`letter`}),r=la(e),i=ua(),a=fa(n,`CONSTANCIA DE INSCRIPCIÓN`,`Serie: ${r}`);n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.setTextColor(...j.dorado),n.setDrawColor(...j.dorado),n.setLineWidth(.6),n.roundedRect(P-F-28,36,28,7,1,1,`S`),n.text(`ORIGINAL`,P-F-14,41,{align:`center`}),n.setTextColor(...j.grisOscuro),n.setLineWidth(.2),n.setFont(`helvetica`,`normal`),n.setFontSize(9.5),n.setTextColor(...j.grisMedio),n.text(`Punta Cana, ${i}`,P-F,a,{align:`right`}),a+=8,n.setFont(`helvetica`,`bold`),n.setFontSize(10.5),n.setTextColor(...j.azul),n.text(`A QUIEN PUEDA INTERESAR:`,F,a),a+=10,n.setFont(`helvetica`,`normal`),n.setFontSize(10),n.setTextColor(...j.grisOscuro);let o=M(e.nombre_completo).toUpperCase(),s=M(e.representante_nombre),c=M(e.representante_parentesco);[`Por medio de la presente, El Sistema Punta Cana hace constar que:`,``,`El/La estudiante ${o}, de ${ia(e.fecha_nacimiento)}, nacido/a el ${ra(e.fecha_nacimiento)}, de nacionalidad ${M(e.nacionalidad)}, ha sido debidamente inscrito/a en el Programa de Formación Musical de El Sistema Punta Cana, a partir del día ${i}.`,``,e.requiere_iniciacion_musical?`El/La estudiante participará en el programa de iniciación musical, con interés en ${oa(e.interes_musical).toLowerCase()} — instrumento asignado: ${M(e.instrumento_interes)}.`:`El/La estudiante cuenta con conocimientos musicales previos, con interés en ${oa(e.interes_musical).toLowerCase()} — instrumento: ${M(e.instrumento_interes)}.`,``,`El representante, ${s} (${c}), ha aceptado los términos del programa, incluyendo el aporte mensual de RD$600, con pleno conocimiento de que el/la estudiante recibe una beca valorada en RD$4,500 mensuales, la cual se mantendrá mientras demuestre rendimiento, interés y asistencia notable.`].forEach(e=>{if(!e){a+=4;return}let t=n.splitTextToSize(e,P-F*2);n.text(t,F,a),a+=t.length*5.8}),a+=6;let l=[[`bi-credit-card`,`✓  Tarjeta de pagos mensuales`],[`bi-calendar`,`✓  Horario de clases asignado`],[`bi-pencil`,`✓  Lista de útiles: lápiz HB, cuaderno pentagramado, borrador`],[`bi-shirt`,`✓  T-Shirt oficial de El Sistema Punta Cana`]],u=9+l.length*7+12;n.setFillColor(...j.azulClaro),n.setDrawColor(...j.azulMedio),n.setLineWidth(.5),n.roundedRect(F,a,P-F*2,u,3,3,`FD`),n.setFillColor(...j.azul),n.roundedRect(F,a,P-F*2,9,3,3,`F`),n.rect(F,a+5,P-F*2,4,`F`),n.setFont(`helvetica`,`bold`),n.setFontSize(9),n.setTextColor(...j.blanco),n.text(`AL PRESENTAR ESTA CONSTANCIA EN CAJA RECIBIRÁ:`,F+4,a+6.5),a+=13,n.setFont(`helvetica`,`normal`),n.setFontSize(9.5),n.setTextColor(...j.azul),l.forEach(([,e])=>{n.text(e,F+5,a),a+=7}),a+=1,n.setFillColor(...j.rojo),n.roundedRect(F+3,a,P-F*2-6,8,1.5,1.5,`F`),n.setFont(`helvetica`,`bold`),n.setFontSize(8.5),n.setTextColor(...j.blanco),n.text(`PAGO OBLIGATORIO: RD$600 en caja al retirar los materiales`,F+(P-F*2)/2,a+5.2,{align:`center`}),a+=16;let d=[t.horario&&{icon:`📅`,label:`Consultar horario de clases:`,url:t.horario},t.reglamento&&{icon:`📋`,label:`Reglamento / Manual de convivencia:`,url:t.reglamento},t.bienvenida&&{icon:`⭐`,label:`Manual de bienvenida al programa:`,url:t.bienvenida}].filter(Boolean);d.length>0?(n.setFont(`helvetica`,`bold`),n.setFontSize(9),n.setTextColor(...j.azul),n.text(`Recursos digitales para el representante:`,F,a),a+=6,d.forEach(({icon:e,label:t,url:r})=>{n.setFont(`helvetica`,`bold`),n.setFontSize(8.5),n.setTextColor(...j.grisOscuro),n.text(`${e}  ${t}`,F+2,a),a+=5,n.setFont(`helvetica`,`normal`),n.setFontSize(8),n.setTextColor(...j.azulMedio);let i=n.splitTextToSize(r,P-F*2-10);n.textWithLink(i[0],F+6,a,{url:r}),a+=7}),a+=2):(n.setFont(`helvetica`,`italic`),n.setFontSize(8),n.setTextColor(...j.grisMedio),n.text(`Los recursos digitales serán comunicados por el coordinador del programa.`,F,a),a+=8),a>da-55&&(pa(n,1),n.addPage(),a=fa(n,`CONSTANCIA DE INSCRIPCIÓN (cont.)`,`Serie: ${r}`)),a+=6,n.setDrawColor(...j.grisMedio),n.setLineWidth(.3),n.setTextColor(...j.grisOscuro),n.line(F,a+20,F+80,a+20),n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.text(`Encargado Administrativo`,F,a+25),n.setFont(`helvetica`,`normal`),n.setFontSize(7.5),n.setTextColor(...j.grisMedio),n.text(`El Sistema Punta Cana`,F,a+29),n.text(i,F,a+33);let f=P/2+6;return n.setTextColor(...j.grisOscuro),n.line(f,a+20,P-F,a+20),n.setFont(`helvetica`,`bold`),n.setFontSize(8),n.text(`Firma del Representante`,f,a+25),n.setFont(`helvetica`,`normal`),n.setFontSize(7.5),n.setTextColor(...j.grisMedio),n.text(M(e.representante_nombre),f,a+29),n.text(`C.I.: ${M(e.representante_cedula)}`,f,a+33),n.setFont(`helvetica`,`normal`),n.setFontSize(6.5),n.setTextColor(170,170,170),n.text(`Serie: ${r}`,P-F,da-15,{align:`right`}),pa(n,1),n}function xa(e){let t=ya(e),n=(e.nombre_completo??`alumno`).toLowerCase().replace(/\s+/g,`-`);t.save(`ficha-${n}.pdf`)}async function Sa(e){let t={};try{t=await ea()}catch{}let n=ba(e,t),r=(e.nombre_completo??`alumno`).toLowerCase().replace(/\s+/g,`-`);n.save(`constancia-${r}.pdf`)}function Ca(){xa(na)}async function wa(){await Sa(na)}var Ta={postulado:[`contactado`,`descartado`],contactado:[`cita_agendada`,`descartado`],cita_agendada:[`documentos_ok`,`no_show`,`descartado`],no_show:[`reprogramado`,`descartado`],reprogramado:[`cita_agendada`,`descartado`],documentos_ok:[`inscrito`,`en_espera`],en_espera:[`cita_agendada`,`descartado`],inscrito:[],descartado:[]},Ea={postulado:`Postulado`,contactado:`Contactado`,cita_agendada:`Cita agendada`,documentos_ok:`Documentos OK`,inscrito:`Inscrito`,no_show:`No show`,reprogramado:`Reprogramado`,en_espera:`En espera`,descartado:`Descartado`},Da={postulado:`secondary`,contactado:`info`,cita_agendada:`primary`,documentos_ok:`warning`,inscrito:`success`,no_show:`danger`,reprogramado:`warning`,en_espera:`secondary`,descartado:`dark`};function Oa(e,t){if(!e||!t)return!1;let n=Ta[e];return n?n.includes(t):!1}function ka(e,t,n={}){if(!e)throw Error(`El postulante es requerido para aplicar la transición`);let r=e.estado||`postulado`;if(!Oa(r,t))throw Error(`Transición inválida: no se puede pasar del estado "${r}" al estado "${t}"`);let i={...e,estado:t};return n.fecha_cita!==void 0&&(i.fecha_cita=n.fecha_cita),n.notas_seguimiento!==void 0&&(i.notas_seguimiento?i.notas_seguimiento=`${i.notas_seguimiento}\n${n.notas_seguimiento}`.trim():i.notas_seguimiento=n.notas_seguimiento),n.alumno_id!==void 0&&(i.alumno_id=n.alumno_id),t===`contactado`&&(i.fecha_contacto=new Date().toISOString()),i}async function Aa(e){let{data:t,error:n}=await _.from(`postulantes`).select(`*`).eq(`id`,e).maybeSingle();if(n)throw console.error(`[postuladosSupabase] Error al obtener postulante:`,n),Error(`Error al obtener postulante: ${n.message}`);return t}async function ja(e,t,n={}){try{let r=await Aa(e);if(!r)throw Error(`Postulante con ID ${e} no encontrado`);let i=r.estado||`postulado`;if(!Oa(i,t))throw Error(`Transición inválida: No se puede pasar de "${i}" a "${t}"`);let a={estado:t};n.fecha_cita!==void 0&&(a.fecha_cita=n.fecha_cita),n.notas_seguimiento!==void 0&&(r.notes||r.notas_seguimiento?a.notas_seguimiento=`${r.notas_seguimiento||r.notes||``}\n${n.notas_seguimiento}`.trim():a.notas_seguimiento=n.notas_seguimiento),n.alumno_id!==void 0&&(a.alumno_id=n.alumno_id),t===`contactado`&&(a.fecha_contacto=new Date().toISOString());let{data:o,error:s}=await _.from(`postulantes`).update(a).eq(`id`,e).select().single();if(s)throw console.error(`[postuladosSupabase] Error en update:`,s),s;return o}catch(e){throw console.error(`[postuladosSupabase] Error al actualizar estado:`,e.message),e}}async function Ma(e,t){try{let n=new Date(e,t-1,1).toISOString(),r=new Date(e,t,1).toISOString(),{data:i,error:a}=await _.from(`postulantes`).select(`*`).gte(`created_at`,n).lt(`created_at`,r).order(`created_at`,{ascending:!1});if(a)throw console.error(`[postuladosSupabase] Error al listar por mes:`,a),a;return i??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarPostulantesPorMes:`,e.message),e}}async function Na(e,t){try{let{data:n,error:r}=await _.from(`postulantes`).select(`*`).gte(`created_at`,e).lte(`created_at`,t+`T23:59:59.999Z`).order(`created_at`,{ascending:!1});if(r)throw console.error(`[postuladosSupabase] Error al listar por rango:`,r),r;return n??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarPostulantesPorRango:`,e.message),e}}async function Pa(e,t){try{let{data:n,error:r}=await _.from(`postulantes`).select(`*`).gte(`fecha_cita`,e).lte(`fecha_cita`,t).not(`fecha_cita`,`is`,null).order(`fecha_cita`,{ascending:!0});if(r)throw console.error(`[postuladosSupabase] Error al listar citas:`,r),r;return n??[]}catch(e){throw console.error(`[postuladosSupabase] Error en listarCitas:`,e.message),e}}async function Fa(e,t=null){try{let n=new Date(e).getTime();if(isNaN(n))throw Error(`Fecha/Hora de cita inválida`);let r=new Date(n-1800*1e3).toISOString(),i=new Date(n+1800*1e3).toISOString(),a=_.from(`postulantes`).select(`id, nombre_completo, fecha_cita`).gte(`fecha_cita`,r).lte(`fecha_cita`,i).not(`fecha_cita`,`is`,null);t&&(a=a.ne(`id`,t));let{data:o,error:s}=await a;if(s)throw console.error(`[postuladosSupabase] Error al verificar conflicto de cita:`,s),s;return(o??[]).length>0}catch(e){throw console.error(`[postuladosSupabase] Error en hayConflictoCita:`,e.message),e}}async function Ia(e,t){try{if(!t||!t.trim())return;let n=await Aa(e);if(!n)throw Error(`Postulante con ID ${e} no encontrado`);let r=n.notas_seguimiento||n.notes||``,i=r?`${r}\n${t}`.trim():t.trim(),{data:a,error:o}=await _.from(`postulantes`).update({notas_seguimiento:i}).eq(`id`,e).select().single();if(o)throw console.error(`[postuladosSupabase] Error al agregar nota:`,o),o;return a}catch(e){throw console.error(`[postuladosSupabase] Error en agregarNota:`,e.message),e}}async function La(e){try{let{error:t}=await _.from(`postulantes`).delete().eq(`id`,e);if(t)throw console.error(`[postuladosSupabase] Error al eliminar postulante:`,t),t;return!0}catch(e){throw console.error(`[postuladosSupabase] Error en eliminarPostulante:`,e.message),e}}var Ra=e({actualizarEstadoPostulante:()=>ja,agregarNota:()=>Ia,backfillDesdePostulantes:()=>Wa,buscarPostulante:()=>Ba,eliminarPostulante:()=>La,hayConflictoCita:()=>Fa,listarCitas:()=>Pa,listarPostulantes:()=>Ua,listarPostulantesPorMes:()=>Ma,listarPostulantesPorRango:()=>Na,obtenerPostulante:()=>Va,sincronizarPostulantes:()=>Ha});function za(e){return(e??``).toLowerCase().replace(/\s+/g,` `).trim()}async function Ba(e){let t=za(e);if(!t||t.length<2)return[];let{data:n,error:r}=await _.from(`postulantes`).select(`*`).or(`nombre_completo.ilike.*${t}*,telefono_alumno.ilike.*${t}*,madre_tlf_whatsapp.ilike.*${t}*,padre_tlf_whatsapp.ilike.*${t}*`).limit(20);if(r)throw console.error(`[postulantesSupabase] Error searching:`,r),r;let i=new Set;return(n??[]).filter(e=>{let t=`${e.nombre_completo||``}|${e.correo||``}`;return i.has(t)?!1:(i.add(t),!0)})}async function Va(e){let{data:t,error:n}=await _.from(`postulantes`).select(`*`).eq(`id`,e).maybeSingle();if(n)throw console.error(`[postulantesSupabase] Error fetching:`,n),n;return t}async function Ha(){let{data:e,error:t}=await _.functions.invoke(`sync-postulantes`,{method:`POST`});if(t){console.error(`[postulantesSupabase] Error syncing:`,t);let e=t.context?.status??0,n=t.context?.body??{},r=Error(n?.error||t.message||`Error al sincronizar`);throw r.status=e,r}return e}async function Ua(){let{data:e,error:t}=await _.from(`postulantes`).select(`*`).order(`created_at`,{ascending:!1});if(t)throw console.error(`[postulantesSupabase] Error listing:`,t),t;return e??[]}async function Wa(e=!1){let{data:t,error:n}=await _.rpc(`backfill_alumnos_desde_postulantes`,{dry_run:e});if(n)throw console.error(`[postulantesSupabase] Error backfilling:`,n.message),Error(`Error al backfillear: ${n.message}`);return{success:!0,data:t??[],dry_run:e}}var Ga=[{id:`post-001`,nombre_completo:`Marcos Merone Cocco`,fecha_nacimiento:`2015-08-30`,telefono_alumno:`8295577722`,correo:`elisabetta.cocco@hotmail.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Avenida real norte MC1-10-b`,madre_nombre:`Elisabetta Cocco`,madre_tlf_whatsapp:`8295577722`,padre_nombre:`Esnor Merone`,padre_tlf_whatsapp:``,representante_parentesco:`ambos`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-002`,nombre_completo:`Ana Pérez Guerrero`,fecha_nacimiento:`2017-03-15`,telefono_alumno:`8091112233`,correo:`ana.perez@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Los Robles #45`,madre_nombre:`María Guerrero`,madre_tlf_whatsapp:`8091112233`,padre_nombre:`Juan Pérez`,padre_tlf_whatsapp:`8091112234`,representante_parentesco:`madre`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Fines de semana`,tiene_transporte:!0,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-003`,nombre_completo:`Luis Gómez Rodríguez`,fecha_nacimiento:`2016-11-22`,telefono_alumno:`8297778899`,correo:`luis.gomez@example.com`,nacionalidad:`Venezolana`,sector_calle_numero:`Residencial Punta Cana, Edif 3 Apto 2B`,madre_nombre:`Carmen Rodríguez`,madre_tlf_whatsapp:`8297778899`,padre_nombre:`Pedro Gómez`,padre_tlf_whatsapp:``,representante_parentesco:`madre`,acepta_pago_600:!1,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!1,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-004`,nombre_completo:`María José López`,fecha_nacimiento:`2014-06-10`,telefono_alumno:`8493334455`,correo:`maria.lopez@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Principal #12, Verón`,madre_nombre:`Sofía López`,madre_tlf_whatsapp:`8493334455`,padre_nombre:`Carlos López`,padre_tlf_whatsapp:`8493334456`,representante_parentesco:`ambos`,acepta_pago_600:!0,autoriza_fotos_redes:!0,religion_limita:!1,disponibilidad_tiempo:`Tardes después de las 3pm`,tiene_transporte:!0,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`},{id:`post-005`,nombre_completo:`Juan García Marte`,fecha_nacimiento:`2018-01-05`,telefono_alumno:`8095556677`,correo:`juan.garcia@example.com`,nacionalidad:`Dominicana`,sector_calle_numero:`Calle Las Palmas #7, Bavaro`,madre_nombre:`Ana Marte`,madre_tlf_whatsapp:`8095556677`,padre_nombre:`Roberto García`,padre_tlf_whatsapp:``,representante_parentesco:`madre`,acepta_pago_600:!0,autoriza_fotos_redes:!1,religion_limita:!1,disponibilidad_tiempo:`Flexibilidad según la programación`,tiene_transporte:!1,representantes_apoyan:!0,copia_cedula:!0,sincronizado_en:`2026-05-28T00:00:00Z`,created_at:`2026-05-28T00:00:00Z`,updated_at:`2026-05-28T00:00:00Z`}],Ka=(e=50)=>new Promise(t=>setTimeout(t,e)),I=[...Ga];function qa(){I=[...Ga]}async function Ja(e,t,n={}){await Ka();let r=I.findIndex(t=>t.id===e);if(r===-1)throw Error(`Postulante con ID ${e} no encontrado`);let i=I[r],a=ka(i,t,n);return I[r]=a,a}async function Ya(e,t){return await Ka(),I.filter(n=>{if(!n.created_at)return!1;let r=new Date(n.created_at);return r.getFullYear()===e&&r.getMonth()+1===t})}async function Xa(e,t){await Ka();let n=new Date(e).getTime(),r=new Date(t+`T23:59:59.999Z`).getTime();return I.filter(e=>{if(!e.created_at)return!1;let t=new Date(e.created_at).getTime();return t>=n&&t<=r}).sort((e,t)=>new Date(t.created_at)-new Date(e.created_at))}async function Za(e,t){await Ka();let n=new Date(e).getTime(),r=new Date(t).getTime();return I.filter(e=>{if(!e.fecha_cita)return!1;let t=new Date(e.fecha_cita).getTime();return t>=n&&t<=r}).sort((e,t)=>new Date(e.fecha_cita)-new Date(t.fecha_cita))}async function Qa(e,t=null){await Ka();let n=new Date(e).getTime();if(isNaN(n))throw Error(`Fecha/Hora de cita inválida`);return I.some(e=>{if(t&&e.id===t||!e.fecha_cita||e.estado!==`cita_agendada`&&e.estado!==`reprogramado`)return!1;let r=new Date(e.fecha_cita).getTime();return Math.abs(r-n)<=18e5})}async function $a(e,t){await Ka();let n=I.findIndex(t=>t.id===e);if(n===-1)throw Error(`Postulante con ID ${e} no encontrado`);let r=I[n],i=r.notas_seguimiento||r.notes||``,a=i?`${i}\n${t}`.trim():t.trim(),o={...r,notas_seguimiento:a};return I[n]=o,o}async function eo(e){await Ka();let t=I.findIndex(t=>t.id===e);if(t===-1)throw Error(`Postulante con ID ${e} no encontrado`);return I.splice(t,1),!0}var to=e({actualizarEstadoPostulante:()=>Ja,agregarNota:()=>$a,backfillDesdePostulantes:()=>co,buscarPostulante:()=>io,data:()=>I,eliminarPostulante:()=>eo,hayConflictoCita:()=>Qa,listarCitas:()=>Za,listarPostulantes:()=>so,listarPostulantesPorMes:()=>Ya,listarPostulantesPorRango:()=>Xa,obtenerPostulante:()=>ao,resetMockData:()=>qa,sincronizarPostulantes:()=>oo}),no=(e=300)=>new Promise(t=>setTimeout(t,e));function ro(e){return(e??``).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\s+/g,` `).trim()}async function io(e){await no();let t=ro(e);return!t||t.length<2?[]:I.filter(e=>{let n=ro(e.nombre_completo),r=ro(e.telefono_alumno),i=ro(e.madre_tlf_whatsapp),a=ro(e.padre_tlf_whatsapp);return n.includes(t)||r.includes(t)||i.includes(t)||a.includes(t)})}async function ao(e){return await no(100),I.find(t=>t.id===e)??null}async function oo(){return await no(500),{status:`success`,total_rows:I.length,upserted:I.length,errors:0,timestamp:new Date().toISOString(),_mock:!0}}async function so(){return await no(),[...I]}async function co(e=!1){await no(400);let t=I.filter(e=>e.estado!==`inscrito`).map(t=>({alumno_id:`mock-`+t.id,alumno_nombre:t.nombre_completo,postulante_id:t.id,postulante_nombre:t.nombre_completo,match_tipo:`email`,campos_llenados:5,accion:e?`preview`:`updated`}));return e||t.forEach(e=>{let t=I.findIndex(t=>t.id===e.postulante_id);t!==-1&&(I[t]={...I[t],estado:`inscrito`,alumno_id:e.alumno_id})}),{success:!0,data:t,dry_run:e}}var lo=()=>x.isDemoMode?to:Ra,uo=(...e)=>lo().buscarPostulante(...e),fo=(...e)=>lo().obtenerPostulante(...e),po=(...e)=>lo().sincronizarPostulantes(...e),mo=(...e)=>lo().backfillDesdePostulantes(...e),ho=(...e)=>lo().actualizarEstadoPostulante(...e),go=(...e)=>lo().listarPostulantesPorMes(...e),_o=(...e)=>lo().listarPostulantesPorRango(...e),vo=(...e)=>lo().listarCitas(...e),yo=(...e)=>lo().hayConflictoCita(...e),bo=(...e)=>lo().agregarNota(...e),xo=(...e)=>lo().eliminarPostulante(...e);function So(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-DO`,{day:`2-digit`,month:`2-digit`,year:`numeric`})}catch{return`—`}}function Co(e){return e.estado===`inscrito`?`<span class="badge bg-success-subtle text-success-emphasis"><i class="bi bi-check-circle-fill me-1"></i>Inscrito</span>`:`<span class="badge bg-warning-subtle text-warning-emphasis"><i class="bi bi-clock me-1"></i>Pendiente</span>`}function wo(e){return new Promise(t=>{if((()=>{try{return JSON.parse(localStorage.getItem(`wizard-inscripcion-draft`)||`null`)}catch{return null}})()?._postulante_id){t(null);return}let n=`pendiente`;e.innerHTML=`
      <div class="preload-search card shadow-sm mb-4">
        ...
        </div>`;try{let r=await uo(e);if(n===`pendiente`&&(r=r.filter(e=>e.estado!==`inscrito`)),!r.length){o.innerHTML=`
            ...
            <div class="d-flex justify-content-between align-items-start gap-2">
              <div class="flex-grow-1 min-w-0">
                ...
                <div class="small text-muted d-flex flex-wrap gap-3">
                  ${r?`<span><i class="bi bi-calendar3 me-1"></i>${So(r)}</span>`:``}
        ...
        </div>`;try{let t=await mo(e),n=t.data.length,r=t.data.filter(e=>e.campos_llenados>0).length,i=t.data.reduce((e,t)=>e+t.campos_llenados,0);if(e){ne.innerHTML=`
        ...
        <tr>
          ...
          </div>`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t,type:`danger`}}))}finally{d.disabled=!1,d.innerHTML=`<i class="bi bi-check2-circle me-1"></i>Sincronizar ahora`}})})}function To({currentStep:e,totalSteps:t,title:n,content:r,canGoPrev:i,canGoNext:a,isLastStep:o,isLastRequiredStep:s,isLastOptionalStep:c,isOptionalStep:l,steps:u,maxReachedStep:d}){return`
    <div class="wizard-inscripcion container-fluid py-3">
      ${Hi({currentStep:e,totalSteps:t})}
      ${Ui({steps:u,currentStep:e,maxReachedStep:d})}
      <div class="card shadow-sm">
        ...
        </div>`,e.querySelector(`#btn-pdf-ficha`)?.addEventListener(`click`,()=>{try{xa(a)}catch(e){console.error(`Error generando ficha:`,e)}}),e.querySelector(`#btn-pdf-constancia`)?.addEventListener(`click`,()=>{try{Sa(a)}catch(e){console.error(`Error generando constancia:`,e)}})}catch{t&&(t.disabled=!1,t.innerHTML=t.dataset.label??`Finalizar`);let n=e.querySelector(`#wizard-step-slot`);if(n){let e=document.createElement(`div`);e.className=`alert alert-danger mt-3`,e.textContent=`Error al guardar. Por favor intenta de nuevo.`,n.after(e)}}}function u(){let t=e.querySelector(`#wiz-btn-prev`),n=e.querySelector(`#wiz-btn-next`),r=e.querySelector(`#wiz-btn-submit`),i=e.querySelector(`#wiz-btn-submit-basic`),a=e.querySelector(`#wiz-btn-draft`);t&&t.addEventListener(`click`,()=>{o=Fi(o),c()}),n&&n.addEventListener(`click`,()=>{let t=s().getState(e);o=Pi(o,t),zi(o.draft),c()}),r&&(r.dataset.label=r.textContent,r.addEventListener(`click`,()=>l(r))),i&&(i.dataset.label=i.textContent,i.addEventListener(`click`,()=>l(i))),a&&a.addEventListener(`click`,()=>{let t=s().getState(e);o={...o,draft:{...o.draft,...t}},zi(o.draft),a.textContent=`¡Guardado!`,setTimeout(()=>{a.innerHTML=`<i class="bi bi-floppy"></i> Guardar borrador`},1500)}),e.querySelectorAll(`[data-step]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=parseInt(t.getAttribute(`data-step`),10),r=s().getState(e);o={...o,draft:{...o.draft,...r}},zi(o.draft),o=Ii(o,n),c()})})}return wo(e).then(e=>{e&&(o={...o,draft:{...o.draft,...e}}),c()}),{destroy(){e.innerHTML=``}}}function Do(e){return String(e??``).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Oo(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function L(e){let{name:t,label:n,type:r=`text`,value:i=``,error:a=``,required:o=!1,placeholder:s=``,hint:c=``,options:l=[],readOnly:u=!1}=e,d=`wiz-${t}`,f=o?`required`:``,p=u?`readonly`:``,m=a?`is-invalid`:``,ee=a?`<div class="invalid-feedback">${Oo(a)}</div>`:``,te=c?`<div class="form-text">${Oo(c)}</div>`:``;if(r===`select`){let e=l.map(e=>`<option value="${Do(e.value)}"${i===e.value?` selected`:``}>${Oo(e.label)}</option>`).join(``);return`
      <div class="mb-3">
        <label for="${d}" class="form-label">${Oo(n)}${o?` <span class="text-danger">*</span>`:``}</label>
        ...
        <div class="form-check">
          <input class="form-check-input ${m}" type="radio" name="${t}" id="${d}-${Do(e.value)}" value="${Do(e.value)}"${i===e.value?` checked`:``} ${f}>
          <label class="form-check-label" for="${d}-${Do(e.value)}">${Oo(e.label)}</label>
        </div>`).join(``);return`
      <div class="mb-3">
        <label class="form-label">${Oo(n)}${o?` <span class="text-danger">*</span>`:``}</label>
        ${e}
        ${a?`<div class="text-danger small">${Oo(a)}</div>`:``}
        ${te}
      </div>`}return r===`checkbox`?`
      <div class="mb-3 form-check">
        <input class="form-check-input ${m}" type="checkbox" id="${d}" name="${t}"${i===!0||i===`true`?` checked`:``}>
        <label class="form-check-label" for="${d}">${Oo(n)}</label>
        ${ee}${te}
      </div>`:r===`textarea`?`
      <div class="mb-3">
        <label for="${d}" class="form-label">${Oo(n)}${o?` <span class="text-danger">*</span>`:``}</label>
        <textarea id="${d}" name="${t}" class="form-control ${m}" placeholder="${Do(s)}" ${f} ${p} rows="3">${Oo(i)}</textarea>
        ${ee}${te}
      </div>`:`
    <div class="mb-3">
      <label for="${d}" class="form-label">${Oo(n)}${o?` <span class="text-danger">*</span>`:``}</label>
      ...
      >
      ${ee}${te}
    </div>`}var ko=/^https?:\/\/(www\.)?google\.com\/maps|^https?:\/\/goo\.gl\/maps/;function Ao(e){return{valid:Object.keys(e).length===0,errors:e}}function jo(e){let t={};if((!e.nombre_completo||!e.nombre_completo.trim())&&(t.nombre_completo=`El nombre completo es requerido`),!e.fecha_nacimiento)t.fecha_nacimiento=`La fecha de nacimiento es requerida`;else{let n=new Date(e.fecha_nacimiento);isNaN(n.getTime())?t.fecha_nacimiento=`Fecha de nacimiento inválida`:n>new Date&&(t.fecha_nacimiento=`La fecha de nacimiento no puede ser en el futuro`)}return(!e.nacionalidad||!e.nacionalidad.trim())&&(t.nacionalidad=`La nacionalidad es requerida`),(!e.como_se_entero||!e.como_se_entero.trim())&&(t.como_se_entero=`Este campo es requerido`),(!e.direccion||!e.direccion.trim())&&(t.direccion=`La dirección es requerida`),e.ubicacion_maps_url&&e.ubicacion_maps_url.trim()&&(ko.test(e.ubicacion_maps_url.trim())||(t.ubicacion_maps_url=`URL debe ser de Google Maps`)),Ao(t)}function Mo(e,t=new Date){if(!e)throw Error(`fechaNacimiento is required`);let n=new Date(e);if(isNaN(n.getTime()))throw Error(`Invalid date: "${e}"`);if(n>t)throw Error(`fechaNacimiento cannot be in the future`);let r=t.getFullYear()-n.getFullYear(),i=t.getMonth()-n.getMonth(),a=t.getDate()-n.getDate();return(i<0||i===0&&a<0)&&--r,r}var No=e({getState:()=>Ro,id:()=>Po,render:()=>Io,title:()=>Fo,validate:()=>Lo}),Po=`step1`,Fo=`Datos del Alumno`;function Io(e,t={}){let n=e.fecha_nacimiento?(()=>{try{return Mo(e.fecha_nacimiento)}catch{return``}})():``;return`
    ...
    </form>`}function Uo(e){return{valid:!0,errors:{}}}function Wo(e){let t=e?.querySelector(`#wiz-form-step2`);return t?{madre_nombre:t.querySelector(`[name="madre_nombre"]`)?.value?.trim()??``,madre_cedula:t.querySelector(`[name="madre_cedula"]`)?.value?.trim()??``,madre_tlf_whatsapp:t.querySelector(`[name="madre_tlf_whatsapp"]`)?.value?.trim()??``}:{}}var Go=e({getState:()=>Xo,id:()=>Ko,render:()=>Jo,title:()=>qo,validate:()=>Yo}),Ko=`step3`,qo=`Datos del Padre`;function Jo(e,t={}){return`
    ...
    </form>`}function Yo(e){return{valid:!0,errors:{}}}function Xo(e){let t=e?.querySelector(`#wiz-form-step3`);return t?{padre_nombre:t.querySelector(`[name="padre_nombre"]`)?.value?.trim()??``,padre_cedula:t.querySelector(`[name="padre_cedula"]`)?.value?.trim()??``,padre_tlf_whatsapp:t.querySelector(`[name="padre_tlf_whatsapp"]`)?.value?.trim()??``}:{}}var Zo=e({getState:()=>ns,id:()=>Qo,render:()=>es,title:()=>$o,validate:()=>ts}),Qo=`step4`,$o=`Representante y Entorno`;function es(e,t={}){let n=e.beneficiario_subsidio_estado===!0;return`
    ...
    </form>`}function ss(e){let t={};return e.acepta_beca_4500||(t.acepta_beca_4500=`Debe aceptar los términos de la beca para continuar`),e.acepta_pago_600||(t.acepta_pago_600=`Debe comprometerse con el aporte mensual para continuar`),{valid:Object.keys(t).length===0,errors:t}}function cs(e){let t=e?.querySelector(`#wiz-form-step7`);return t?{acepta_beca_4500:t.querySelector(`[name="acepta_beca_4500"]`)?.checked??!1,acepta_pago_600:t.querySelector(`[name="acepta_pago_600"]`)?.checked??!1,autoriza_fotos_redes:t.querySelector(`[name="autoriza_fotos_redes"]`)?.checked??!1}:{}}var ls=e({getState:()=>ms,id:()=>us,render:()=>fs,title:()=>ds,validate:()=>ps}),us=`step5`,ds=`Perfil Musical`;function fs(e,t={}){let n=e.tiene_conocimientos_musicales===!0;return`
  ...
  `;let{data:r,error:i}=await _.from(`alumnos`).select(`*`).eq(`id`,n).single();if(i||!r){e.innerHTML=`<div class="alert alert-danger m-4">Error al cargar el alumno: ${k(i?.message||`No encontrado`)}</div>`;return}let{data:a}=await _.from(`alumnos_clases`).select(`clase_id, clases(id, nombre, dia, hora_inicio)`).eq(`alumno_id`,n).eq(`activo`,!0),o=(a||[]).map(e=>e.clases).filter(Boolean),s=!1,c=!1;function l(){let t=Ms(r.nombre_completo),n=Vr(r.fecha_nacimiento),i=r.activo?`<span class="badge bg-success">Activo</span>`:`<span class="badge bg-secondary">Inactivo</span>`,a=[`personal`,`madre`,`padre`,`representante`,`salud`,`musical`],s=[...a,`clases`,`progreso`,`asistencias`].map((e,t)=>`
    ...
    `).join(``);function c(e){let t=Ds[e];return`
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h6 class="fw-bold text-uppercase text-muted small mb-0">${k(Os[e])}</h6>
              ...
              <div class="d-flex gap-3 align-items-center">
                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    ${r.created_at?`<span class="text-muted small">Inscrito: ${R(Br(r.created_at))}</span>`:``}
                  </div>
                </div>
              </div>
              <div class="d-flex gap-2 flex-wrap">
          ...
          <div class="list-group list-group-flush">
            ${t.map(e=>`
              <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-start">
                <div>
                  ${R(e.observaciones)}
                  ${e.fecha?`<div class="text-muted small mt-1">${R(Br(e.fecha))}</div>`:``}
                </div>
      ...
      <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
          ...
          <tbody>
            ${t.map(e=>`
              <tr>
                <td class="text-nowrap">${R(e.fecha?Br(e.fecha):null)}</td>
                <td>${u(e)}</td>
    ...
    <div class="card border-warning shadow-sm mb-4">
      ...
      <div class="alert alert-danger d-flex align-items-center gap-2 mb-4">
        ...
        <button class="btn btn-sm btn-outline-secondary ms-auto" id="btn-close-panel"><i class="bi bi-x"></i></button>
      </div>`,n.querySelector(`#btn-close-panel`)?.addEventListener(`click`,()=>n.innerHTML=``)}}}async function Fs(e){e.innerHTML=`
      ...
      <div class="card mt-4 border-0 bg-body-secondary">
        <div class="card-body">
          ...
          <div class="row row-cols-2 row-cols-md-3 g-2 small">
            <div><span class="text-muted">Nombre:</span><br><strong>${na.nombre_completo}</strong></div>
            <div><span class="text-muted">Nacimiento:</span><br><strong>${na.fecha_nacimiento}</strong></div>
            <div><span class="text-muted">Instrumento:</span><br><strong>${na.instrumento_principal}</strong></div>
            <div><span class="text-muted">Representante:</span><br><strong>${na.representante_nombre}</strong></div>
            <div><span class="text-muted">Municipio:</span><br><strong>${na.municipio_residencia}</strong></div>
            <div><span class="text-muted">Centro estudios:</span><br><strong>${na.centro_estudios}</strong></div>
          </div>
    ...
    </div>`,e.querySelector(`#btn-demo-ficha`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Generando...`;try{await Ca()}finally{t.disabled=!1,t.innerHTML=`<i class="bi bi-download me-2"></i>Descargar ficha demo`}}),e.querySelector(`#btn-demo-constancia`).addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.innerHTML=`<span class="spinner-border spinner-border-sm me-2"></span>Generando...`;try{await wa()}finally{t.disabled=!1,t.innerHTML=`<i class="bi bi-download me-2"></i>Descargar constancia demo`}})}var Is=[0,86,179],Ls=[255,193,7],Rs=[30,30,30];function zs(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(e=>e.length>0)??`Sin nombre registrado`}function Bs(e){let t=[];return e.madre_nombre&&e.madre_nombre.trim()&&t.push(`Madre: ${e.madre_nombre.trim()}`),e.padre_nombre&&e.padre_nombre.trim()&&t.push(`Padre: ${e.padre_nombre.trim()}`),e.representante_nombre&&e.representante_nombre.trim()&&t.push(`Rep: ${e.representante_nombre.trim()}`),t.length>0?t.join(`
`):`—`}function Vs(e){let t=[];return e.telefono_alumno&&e.telefono_alumno.trim()&&t.push(`Al: ${e.telefono_alumno.trim()}`),e.madre_tlf_whatsapp&&e.madre_tlf_whatsapp.trim()&&t.push(`Ma: ${e.madre_tlf_whatsapp.trim()}`),e.padre_tlf_whatsapp&&e.padre_tlf_whatsapp.trim()&&t.push(`Pa: ${e.padre_tlf_whatsapp.trim()}`),t.length>0?t.join(`
`):`—`}function Hs(e,t,n){let r=e.internal.pageSize.getWidth();e.setFillColor(...Is),e.rect(0,0,r,26,`F`),e.setFillColor(...Ls),e.rect(0,26,r,2,`F`),e.setTextColor(255,255,255),e.setFontSize(14),e.setFont(`helvetica`,`bold`),e.text(`El Sistema Punta Cana`,14,10),e.setFontSize(10),e.setFont(`helvetica`,`normal`),e.text(t,14,18),e.setFontSize(7.5),e.text(n,14,24),e.setTextColor(...Rs)}function Us(e,t,n){let r=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();e.setFillColor(...Is),e.rect(0,i-8,r,8,`F`),e.setTextColor(255,255,255),e.setFontSize(6.5);let a=new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`});e.text(`El Sistema Punta Cana — Generado: ${a}`,10,i-3),e.text(`Página ${t} de ${n}`,r-10,i-3,{align:`right`})}function Ws(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`})}catch{return`—`}}function Gs(e,t,n){let r=new et({orientation:`landscape`,unit:`mm`,format:`letter`});Hs(r,`LISTADO DE POSTULADOS`,`Rango: ${`${Ws(t)} — ${Ws(n)}`} · Generado: ${new Date().toLocaleDateString(`es-DO`,{day:`2-digit`,month:`long`,year:`numeric`})} · Total: ${e.length}`),tt(r,{startY:36,margin:{left:8,right:8},theme:`striped`,head:[[`#`,`Nombre del interesado`,`Padres / Representante`,`Teléfonos`,`Correo`,`Fecha`,`Estado`]],body:e.map((e,t)=>[t+1,zs(e),Bs(e),Vs(e),e.correo||`—`,Ws(e.fecha_postulacion||e.created_at),Ea[e.estado||`postulado`]||e.estado||`—`]),headStyles:{fillColor:Is,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:8,halign:`center`},1:{cellWidth:48},2:{cellWidth:48},3:{cellWidth:40},4:{cellWidth:50},5:{cellWidth:22,halign:`center`},6:{cellWidth:20,halign:`center`}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();Us(r,e.pageNumber,t)}});let i=r.internal.getNumberOfPages();for(let e=1;e<=i;e++)r.setPage(e),Us(r,e,i);return r}function Ks(e,t,n){Gs(e,t,n).save(`postulados-${t}-${n}.pdf`)}function qs(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-01`}function Js(){let e=new Date,t=new Date(e.getFullYear(),e.getMonth()+1,0);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}var z={year:new Date().getFullYear(),month:new Date().getMonth()+1,postulantes:[],filtroEstado:`todos`,cargando:!1,page:1,limit:50,pdfDesde:qs(),pdfHasta:Js()},Ys=[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`],Xs=/\b(alumno|alumna|puede|asistir|depende|transporte|p[uú]blico|propio|padres|amigos|familiares|punta\s*cana|veron|ver[oó]n|bávaro|bavaro|friusa|cortecito|ciudad|pueblo|municipio|sector|calle|avenida|disponibilidad|extracu|actividades|limitada|posible|haré|hare|cristiano|evang[eé]lico|cat[oó]lico)\b/i;function Zs(e){if(!e||e.length===0)return!1;let t=e.trim();return!(t.length>70||t.includes(`,`)||t.split(/\s+/).length>5||Xs.test(t)||!/[A-ZÁÉÍÓÚÑ]/.test(t)||t.length<4)}function Qs(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(e=>Zs(e))??`Sin nombre registrado`}function $s(e){return[{persona:e.madre_nombre,numero:e.madre_tlf_whatsapp,rol:`Madre`},{persona:e.padre_nombre,numero:e.padre_tlf_whatsapp,rol:`Padre`},{persona:e.representante_nombre,numero:e.representante_tlf||e.telefono_representante,rol:`Representante`},{persona:null,numero:e.telefono_alumno,rol:`Alumno`}].filter(({numero:e})=>{let t=(e??``).trim();return t.length>=7&&!/^(sin definir|no tiene|n\/a)$/i.test(t)}).map(({persona:e,numero:t,rol:n})=>({rol:n,nombre:Zs(e??``)?e.trim():null,numero:t.trim()}))}function ec(e){return $s(e)[0]?.numero??null}function tc(e){let t=e.replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:e}async function nc(e){z.filtroEstado=`todos`,z.page=1,await rc(e)}async function rc(e){try{z.cargando=!0,ic(e),z.postulantes=(await go(z.year,z.month)).filter(e=>ec(e)!==null),z.cargando=!1,sc(e)}catch(t){z.cargando=!1,ac(e,t.message)}}function ic(e){e.innerHTML=`
  ...
  `,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>nc(e))}function oc(e,t){return t===0?``:`
  ...
  `}function sc(e){let t=cc();t.sort((e,t)=>{let n=new Date(e.fecha_postulacion||e.created_at);return new Date(t.fecha_postulacion||t.created_at)-n});let n=t.length,r=Math.ceil(n/z.limit)||1;z.page>r&&(z.page=r),z.page<1&&(z.page=1);let i=(z.page-1)*z.limit,a=Math.min(i+z.limit,n),o=t.slice(i,a),s=lc();e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4 max-w-7xl mx-auto">
      ...
      <div class="d-flex gap-4 overflow-x-auto border-bottom border-secondary-subtle mb-4 scrollbar-hidden" style="white-space: nowrap;">
        ...
        ${Object.entries(Ea).map(([e,t])=>{let n=s[e]||0;return n===0&&z.filtroEstado!==e?``:`
  ...
  `,fc(e)}function cc(){return z.filtroEstado===`todos`?[...z.postulantes]:z.postulantes.filter(e=>e.estado===z.filtroEstado)}function lc(){let e={};return Object.keys(Ea).forEach(t=>e[t]=0),z.postulantes.forEach(t=>{let n=t.estado||`postulado`;e[n]!==void 0&&e[n]++}),e}function uc(){return`
  ...
  `}function dc(e){return`
    <div class="w-100">
      ...
      <div class="d-none d-md-block table-responsive">
        <table class="table align-middle mb-0 border-transparent">
          ...
          <tbody>
            ${e.map(e=>{let t=$s(e).map(({rol:e,nombre:t,numero:n})=>{let r=`https://wa.me/${n.replace(/\D/g,``)}?text=Hola%2C%20le%20contactamos%20de%20El%20Sistema%20Punta%20Cana.`,i=t?`${t} (${e})`:e;return`<a href="${r}" target="_blank" rel="noopener" class="d-flex align-items-center gap-2 text-decoration-none text-body mb-1" title="${i}">
        <i class="bi bi-whatsapp text-success small"></i>
        <span class="small">${tc(n)}</span>
        <span class="text-body-secondary small fw-light">· ${i}</span>
      </a>`}).join(``),n=e.fecha_postulacion||e.created_at,r=n?new Date(n).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):`-`,i=Da[e.estado||`postulado`],a=Ea[e.estado||`postulado`];return`
      <tr class="cursor-pointer" data-id="${e.id}">
        <td class="py-3">
          <div class="fw-medium text-body">${Qs(e)}</div>
          ${a?`
        ...
        <td class="text-end pe-2 py-3 align-middle">
          <button class="btn btn-link text-body-secondary p-0 hover-danger btn-delete-postulante" data-id="${e.id}" data-name="${Qs(e)}" title="Eliminar">
    ...
    `}).join(``)}
      ...
      <div class="d-block d-md-none">
        ${e.map(e=>{let t=$s(e).map(({rol:e,nombre:t,numero:n})=>`<a href="${`https://wa.me/${n.replace(/\D/g,``)}?text=Hola%2C%20le%20contactamos%20de%20El%20Sistema%20Punta%20Cana.`}" target="_blank" rel="noopener" class="text-decoration-none text-body me-3 mb-2 d-inline-flex align-items-center gap-1">
        <i class="bi bi-whatsapp text-success"></i> <span class="small fw-medium">${tc(n)}</span>
      </a>`).join(``),n=e.fecha_postulacion||e.created_at,r=n?new Date(n).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`}):`-`,i=Da[e.estado||`postulado`],a=Ea[e.estado||`postulado`];return`
      <div class="border-bottom border-secondary-subtle py-3 cursor-pointer" data-id="${e.id}">
        <div class="d-flex justify-content-between align-items-start mb-2">
          <div>
            <div class="fw-semibold text-body fs-6">${Qs(e)}</div>
            ${a?`
            <div class="d-flex align-items-center gap-1 mt-1">
              <i class="bi bi-circle-fill text-${i}" style="font-size: 8px;"></i>
              <span class="text-body-secondary small">${a}</span>
  ...
  `}function fc(e){e.querySelectorAll(`.btn-wa-link`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation()})}),document.getElementById(`btn-month-prev`)?.addEventListener(`click`,()=>{z.month--,z.month<1&&(z.month=12,z.year--),z.page=1,rc(e)}),document.getElementById(`btn-month-next`)?.addEventListener(`click`,()=>{z.month++,z.month>12&&(z.month=1,z.year++),z.page=1,rc(e)}),document.getElementById(`btn-sync`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`btn-sync`),n=document.getElementById(`sync-spinner`),r=document.getElementById(`sync-icon`);try{t.disabled=!0,n.classList.remove(`d-none`),r.classList.add(`d-none`);let i=await po();alert(`Sincronización exitosa. Registros procesados: ${i.total_rows||i.upserted||0}`),z.page=1,rc(e)}catch(e){alert(`Error al sincronizar: ${e.message}`),t.disabled=!1,n.classList.add(`d-none`),r.classList.remove(`d-none`)}}),e.querySelectorAll(`[data-filter]`).forEach(t=>{t.addEventListener(`click`,t=>{z.filtroEstado=t.currentTarget.getAttribute(`data-filter`),z.page=1,sc(e)})}),e.querySelectorAll(`.hover-table-row`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget.getAttribute(`data-id`);S.navigate(`postulado`,{id:t})})}),e.querySelectorAll(`.btn-delete-postulante`).forEach(t=>{t.addEventListener(`click`,async t=>{t.stopPropagation();let n=t.currentTarget,r=n.getAttribute(`data-id`),i=n.getAttribute(`data-name`);if(confirm(`¿Estás seguro de que deseas eliminar permanentemente la postulación de "${i}"?\n\nEsta acción eliminará el registro de la base de datos de forma irreversible.`))try{n.disabled=!0,await xo(r),alert(`Postulación eliminada con éxito`),rc(e)}catch(e){alert(`Error al eliminar: ${e.message}`),n.disabled=!1}})}),document.getElementById(`btn-descargar-pdf`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`pdf-desde`)?.value,t=document.getElementById(`pdf-hasta`)?.value,n=document.getElementById(`btn-descargar-pdf`),r=document.getElementById(`pdf-spinner`),i=document.getElementById(`pdf-icon`);if(!e||!t){alert(`Debe seleccionar una fecha de inicio y una fecha de fin.`);return}if(e>t){alert(`La fecha "Desde" no puede ser posterior a la fecha "Hasta".`);return}try{n.disabled=!0,r.classList.remove(`d-none`),i.classList.add(`d-none`);let a=await _o(e,t);if(!a||a.length===0){alert(`No hay postulados registrados en el rango de fechas seleccionado.`);return}Ks(a,e,t)}catch(e){alert(`Error al generar el PDF: ${e.message}`)}finally{n.disabled=!1,r.classList.add(`d-none`),i.classList.remove(`d-none`)}}),document.getElementById(`btn-page-prev`)?.addEventListener(`click`,()=>{z.page>1&&(z.page--,sc(e))}),document.getElementById(`btn-page-next`)?.addEventListener(`click`,()=>{z.page++,sc(e)})}var pc=/\b(alumno|alumna|puede|asistir|depende|transporte|p[uú]blico|propio|padres|amigos|familiares|punta\s*cana|veron|ver[oó]n|bávaro|bavaro|friusa|cortecito|ciudad|pueblo|municipio|sector|calle|avenida|disponibilidad|actividades|limitada|posible|haré|hare|cristiano|evang[eé]lico|cat[oó]lico)\b/i,mc=[{id:`cedula_rep`,label:`Cédula del representante`},{id:`partida`,label:`Partida de nacimiento`},{id:`constancia`,label:`Constancia escolar`},{id:`foto`,label:`Foto del alumno`},{id:`docs_medicos`,label:`Documentos médicos (si aplica)`}],hc=[{id:`postulado`,label:`Postulado`,num:1},{id:`contactado`,label:`Contactado`,num:2},{id:`cita_agendada`,label:`Cita agendada`,num:3},{id:`documentos_ok`,label:`Documentos OK`,num:4},{id:`inscrito`,label:`Inscrito`,num:5}],B={postulante:null,cargando:!1};function gc(e){if(!e)return!1;let t=e.trim();return t.length>=4&&t.length<=70&&!t.includes(`,`)&&t.split(/\s+/).length<=5&&!pc.test(t)&&/[A-ZÁÉÍÓÚÑ]/.test(t)}function _c(e){return[e.nombre_completo,e.madre_nombre,e.padre_nombre,e.representante_nombre].map(e=>(e??``).trim()).find(gc)??`Sin nombre registrado`}function vc(e){return{_postulante_id:e.id,nombre_completo:_c(e),fecha_nacimiento:e.fecha_nacimiento||``,nacionalidad:e.nacionalidad||``,tiene_pasaporte:e.tiene_pasaporte??!1,sabe_leer:e.sabe_leer??null,sabe_escribir:e.sabe_escribir??null,genero:e.genero||``,como_se_entero:e.como_se_entero||``,municipio_residencia:e.municipio_residencia||``,sector_calle_numero:e.sector_calle_numero||``,direccion:e.direccion||``,ubicacion_maps_url:e.ubicacion_maps_url||``,madre_nombre:e.madre_nombre||``,madre_cedula:e.madre_cedula||``,madre_tlf_whatsapp:e.madre_tlf_whatsapp||``,padre_nombre:e.padre_nombre||``,padre_cedula:e.padre_cedula||``,padre_tlf_whatsapp:e.padre_tlf_whatsapp||``,representante_nombre:e.representante_nombre||e.madre_nombre||``,representante_parentesco:e.representante_parentesco||``,representante_cedula:e.representante_cedula||``,representante_tlf:e.representante_tlf||e.telefono_representante||e.madre_tlf_whatsapp||``,correo_representante:e.correo||``,beneficiario_subsidio_estado:e.beneficiario_subsidio_estado??!1,acepta_pago_600:e.acepta_pago_600??!1,instrumento_interes:e.instrumento_interes||``,tiene_conocimientos_musicales:e.tiene_conocimientos_musicales??!1,instrumento_previo:e.instrumento_previo||``,nivel_lectura_musical:e.nivel_lectura_musical||``,interes_musical:e.interes_musical||``,por_que_unirse:e.por_que_unirse||``,sentimiento_musica_clasica:e.sentimiento_musica_clasica||``,musico_favorito:e.musico_favorito||``,autoriza_fotos_redes:e.autoriza_fotos_redes??!1}}function yc(e){if(!e)return`Sin definir`;let t=new Date(e);if(isNaN(t.getTime()))return`Sin definir`;let n=new Date,r=n.getFullYear()-t.getFullYear(),i=n.getMonth()-t.getMonth();return(i<0||i===0&&n.getDate()<t.getDate())&&r--,`${r} años`}function bc(e){return e?new Date(e).toLocaleString(`es-ES`,{day:`2-digit`,month:`long`,year:`numeric`,hour:`2-digit`,minute:`2-digit`}):``}function xc(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`long`,year:`numeric`}):`-`}function Sc(e,t,n){return`https://wa.me/${(e||``).replace(/[^0-9]/g,``)}?text=${encodeURIComponent(`Hola ${t}, le contactamos de *El Sistema Punta Cana*. Hemos recibido la postulación de *${n}* y queremos coordinar el proceso de inscripción. ¿Cuándo podría venir a nuestra sede para la entrevista? 🎵`)}`}function Cc(e){return`docs_${e}`}function wc(e){try{let t=localStorage.getItem(Cc(e));return t?JSON.parse(t):{}}catch{return{}}}function Tc(e,t){localStorage.setItem(Cc(e),JSON.stringify(t))}async function Ec(e,t){let n=t?.id;if(!n){e.innerHTML=`<div class="alert alert-danger m-4">Error: ID de postulante no provisto.</div>`;return}await Dc(e,n)}async function Dc(e,t){B.cargando=!0,e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height:400px">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando perfil...</span>
      </div>
    </div>`;try{if(B.postulante=await fo(t),B.cargando=!1,!B.postulante){e.innerHTML=`
        ...
        </div>`,document.getElementById(`btn-error-back`)?.addEventListener(`click`,()=>S.navigate(`postulados`));return}Oc(e)}catch(n){B.cargando=!1,e.innerHTML=`
      <div class="container py-5 text-center">
      ...
      </div>`,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>Dc(e,t))}}function Oc(e){let t=B.postulante,n=t.estado||`postulado`,r=_c(t),i=t.representante_nombre||t.madre_nombre||`Representante`,a=Da[n]||`secondary`,o=Ea[n]||`Postulado`;e.innerHTML=`
    <div class="container-fluid py-3 px-3 px-md-4">
  ...
  `,Pc(e)}function kc(e){let t=[`no_show`,`en_espera`,`descartado`,`reprogramado`].includes(e),n={no_show:2,reprogramado:2,en_espera:3,descartado:-1},r=hc.findIndex(t=>t.id===e);return t&&(r=n[e]??-1),`
    <div class="d-flex align-items-center gap-1 overflow-auto py-1">
      ${hc.map((n,i)=>{let a=i<r,o=i===r&&!t,s=i===r&&t,c=`bg-light border border-secondary text-secondary`,l=`text-secondary`;if(a)c=`bg-success text-white border border-success`,l=`text-success fw-semibold`;else if(o){let e=Da[n.id]||`primary`;c=`bg-${e} text-white border border-${e}`,l=`text-${e} fw-bold`}else if(s){let t=Da[e]||`secondary`;c=`bg-${t} bg-opacity-25 text-${t} border border-${t}`,l=`text-${t} fw-semibold`}let u=i<hc.length-1?`<div class="flex-grow-1 border-top border-secondary-subtle" style="min-width:20px;margin-top:-8px"></div>`:``;return`
          <div class="d-flex flex-column align-items-center" style="min-width:64px">
            ...
            ${s?`<span class="badge bg-${Da[e]} mt-1" style="font-size:.65rem">${Ea[e]}</span>`:``}
          </div>
          ${u}`}).join(``)}
    </div>
  `}function Ac(e,t,n,r){let i=Da[t]||`secondary`;switch(t){case`postulado`:return`
        ...
        <div class="card-body px-4 pb-4">
          ...
          <div class="d-flex flex-wrap gap-2 mb-3">
            ${e.madre_tlf_whatsapp?`
              <a href="${Sc(e.madre_tlf_whatsapp,n,r)}"
                 target="_blank" rel="noopener"
                 class="btn btn-success btn-sm rounded-pill">
                <i class="bi bi-whatsapp me-1"></i> WhatsApp Madre
              </a>`:``}
            ${e.padre_tlf_whatsapp?`
              <a href="${Sc(e.padre_tlf_whatsapp,n,r)}"
                 target="_blank" rel="noopener"
                 class="btn btn-success btn-sm rounded-pill">
                <i class="bi bi-whatsapp me-1"></i> WhatsApp Padre
              </a>`:``}
        ...
        <div class="card-header bg-${i} bg-opacity-10 border-0 pt-3 pb-0 px-4">
          <h6 class="fw-bold text-${i}"><i class="bi bi-calendar-event me-2"></i>Cita agendada para: ${e.fecha_cita?bc(e.fecha_cita):`Sin fecha registrada`}</h6>
        </div>
        <div class="card-body px-4 pb-4">
...
`).find(e=>e.toLowerCase().includes(`descart`))||``;return`
    ...
    ${t(`Representante`,n)}
    ${t(`Correo`,e.correo)}
    ${t(`Postulado el`,xc(e.created_at))}
  `}function Mc(e){let t=wc(e);return mc.map(e=>`
  ...
  `).join(``)}function Nc(e){let t=(e.notas_seguimiento||e.notes||``).split(`
`).filter(e=>e.trim());return t.length===0?`<p class="text-muted small fst-italic">Sin notas registradas.</p>`:`
  ...
  `}function Pc(e){let t=B.postulante,n=t.id;t.estado,e.querySelector(`#btn-back-list`)?.addEventListener(`click`,()=>{window.router?.navigate(`postulados`)??S.navigate(`postulados`)}),e.querySelector(`#btn-ver-alumno`)?.addEventListener(`click`,()=>{window.router?.navigate(`alumno`,{id:t.alumno_id})??S.navigate(`alumno`,{id:t.alumno_id})}),e.querySelectorAll(`.doc-check`).forEach(e=>{e.addEventListener(`change`,()=>{let t=wc(n),r=e.getAttribute(`data-doc-id`);e.checked?t[r]=!0:delete t[r],Tc(n,t)})}),e.querySelector(`#btn-save-note`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#textarea-nueva-nota`),r=(t?.value||``).trim();if(!r)return;let i=e.querySelector(`#btn-save-note`),a=e.querySelector(`#save-note-spinner`);try{i.disabled=!0,a?.classList.remove(`d-none`),B.postulante=await bo(n,r),t.value=``;let o=e.querySelector(`#notes-timeline`);o&&(o.innerHTML=Nc(B.postulante))}catch(e){alert(`Error al agregar nota: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-contactado`)?.addEventListener(`click`,async()=>{try{B.postulante=await ho(n,`contactado`,{notas_seguimiento:`Contacto iniciado vía WhatsApp.`}),Oc(e)}catch(e){alert(`Error al cambiar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-cita-agendada`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-cita`),r=e.querySelector(`#cita-inline-error`),i=e.querySelector(`#btn-accion-cita-agendada`),a=e.querySelector(`#spinner-cita`);if(!t?.value){r?.classList.remove(`d-none`),r&&(r.textContent=`Debe seleccionar una fecha y hora.`);return}try{i.disabled=!0,a?.classList.remove(`d-none`),r?.classList.add(`d-none`);let o=new Date(t.value).toISOString();if(await yo(o,n)){r?.classList.remove(`d-none`),r&&(r.textContent=`Conflicto: ya existe otra cita en un rango de ±30 minutos.`);return}B.postulante=await ho(n,`cita_agendada`,{fecha_cita:o,notas_seguimiento:`Cita agendada para: ${bc(o)}`}),Oc(e)}catch(e){alert(`Error al agendar cita: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-documentos-ok`)?.addEventListener(`click`,async()=>{try{B.postulante=await ho(n,`documentos_ok`,{notas_seguimiento:`Representante presente. Documentación revisada.`}),Oc(e)}catch(e){alert(`Error al actualizar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-no-show`)?.addEventListener(`click`,async()=>{try{B.postulante=await ho(n,`no_show`,{notas_seguimiento:`No se presentó a la cita agendada.`}),Oc(e)}catch(e){alert(`Error al actualizar estado: ${e.message}`)}}),e.querySelector(`#btn-accion-inscribir`)?.addEventListener(`click`,()=>{zi(vc(t)),window.router?.navigate(`alumnos-inscribir`)??S.navigate(`alumnos-inscribir`)}),e.querySelector(`#btn-accion-reprogramar`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-reprogramar`),r=e.querySelector(`#btn-accion-reprogramar`),i=e.querySelector(`#spinner-reprogramar`);if(!t?.value){alert(`Seleccioná una nueva fecha para la cita.`);return}try{r.disabled=!0,i?.classList.remove(`d-none`);let a=new Date(t.value).toISOString();if(await yo(a,n)){alert(`Conflicto: ya existe otra cita en un rango de ±30 minutos.`);return}let o=await ho(n,`reprogramado`,{notas_seguimiento:`Cita reprogramada para: ${bc(a)}`});o=await ho(n,`cita_agendada`,{fecha_cita:a,notas_seguimiento:`Nueva cita agendada: ${bc(a)}`}),B.postulante=o,Oc(e)}catch(e){alert(`Error al reprogramar: ${e.message}`)}finally{r.disabled=!1,i?.classList.add(`d-none`)}}),e.querySelector(`#btn-accion-descartar`)?.addEventListener(`click`,async()=>{let t=prompt(`Indicá la razón del descarte:`);if(t!==null)try{B.postulante=await ho(n,`descartado`,{notas_seguimiento:`Postulación descartada. Razón: ${t||`Sin detallar`}`}),Oc(e)}catch(e){alert(`Error al descartar: ${e.message}`)}}),e.querySelector(`#btn-accion-espera-cita`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#input-fecha-espera`),r=e.querySelector(`#espera-cita-error`),i=e.querySelector(`#btn-accion-espera-cita`),a=e.querySelector(`#spinner-espera`);if(!t?.value){r?.classList.remove(`d-none`),r&&(r.textContent=`Seleccioná una fecha para la cita.`);return}try{i.disabled=!0,a?.classList.remove(`d-none`),r?.classList.add(`d-none`);let o=new Date(t.value).toISOString();if(await yo(o,n)){r?.classList.remove(`d-none`),r&&(r.textContent=`Conflicto: ya existe otra cita en ±30 minutos.`);return}B.postulante=await ho(n,`cita_agendada`,{fecha_cita:o,notas_seguimiento:`Cita agendada desde lista de espera: ${bc(o)}`}),Oc(e)}catch(e){alert(`Error al agendar cita: ${e.message}`)}finally{i.disabled=!1,a?.classList.add(`d-none`)}})}var V={year:new Date().getFullYear(),month:new Date().getMonth()+1,citas:[],cargando:!1},Fc=[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`],Ic=[`Dom`,`Lun`,`Mar`,`Mié`,`Jue`,`Vie`,`Sáb`];async function Lc(e){await Rc(e)}async function Rc(e){try{V.cargando=!0,zc(e),V.citas=await vo(new Date(V.year,V.month-1,1,0,0,0).toISOString(),new Date(V.year,V.month,0,23,59,59).toISOString()),V.cargando=!1,Vc(e)}catch(t){V.cargando=!1,Bc(e,t.message)}}function zc(e){e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4">
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
  ...
  `,document.getElementById(`btn-error-retry`)?.addEventListener(`click`,()=>Lc(e))}function Vc(e){let t=new Date(V.year,V.month,0).getDate(),n=new Date(V.year,V.month-1,1).getDay();e.innerHTML=`
    <div class="container-fluid py-4 px-3 px-md-4">
      <!-- HEADER -->
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
      ...
      <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-body p-0">
          ...
          <div class="row g-0 bg-light text-center border-bottom py-2 fw-bold text-muted small">
            ${Ic.map(e=>`<div class="col" style="width: 14.28%;">${e}</div>`).join(``)}
          </div>
  ...
  `,Wc(e)}function Hc(e,t){let n=``;for(let t=0;t<e;t++)n+=`
    ...
    `;let r=new Date,i=r.getFullYear()===V.year&&r.getMonth()+1===V.month;for(let e=1;e<=t;e++){let t=i&&r.getDate()===e,a=Uc(e);n+=`
    ...
    `}let a=(e+t)%7;if(a>0){let e=7-a;for(let t=0;t<e;t++)n+=`
      ...
      `}return n}function Uc(e){return V.citas.filter(t=>{if(!t.fecha_cita)return!1;let n=new Date(t.fecha_cita);return n.getDate()===e&&n.getMonth()+1===V.month&&n.getFullYear()===V.year})}function Wc(e){document.getElementById(`btn-month-prev`)?.addEventListener(`click`,()=>{V.month--,V.month<1&&(V.month=12,V.year--),Rc(e)}),document.getElementById(`btn-month-next`)?.addEventListener(`click`,()=>{V.month++,V.month>12&&(V.month=1,V.year++),Rc(e)}),document.getElementById(`btn-today`)?.addEventListener(`click`,()=>{V.year=new Date().getFullYear(),V.month=new Date().getMonth()+1,Rc(e)}),e.querySelectorAll(`.btn-goto-perfil`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=e.currentTarget.getAttribute(`data-id`);S.navigate(`postulado`,{id:t})})}),e.querySelectorAll(`.btn-view-mobile-day`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=parseInt(e.currentTarget.getAttribute(`data-day`)),n=Uc(t),r=n.map(e=>{let t=new Date(e.fecha_cita).toLocaleTimeString(`es-ES`,{hour:`2-digit`,minute:`2-digit`,hour12:!0});return`• ${e.nombre_completo} (${t})`}).join(`
`);alert(`Citas para el día ${t} de ${Fc[V.month-1]}:\n\n${r}\n\nSelecciona el perfil para ver detalles.`),n.length===1&&S.navigate(`postulado`,{id:n[0].id})})})}function Gc(){S.register(`alumnos`,Gr),S.register(`alumnos-reporte-mes`,Mi),S.register(`alumnos-inscribir`,Ss),S.register(`alumnos-pdf-demo`,Fs),S.register(`alumno`,Ns),S.register(`postulados`,nc),S.register(`postulado`,Ec),S.register(`postulados-calendario`,Lc)}function Kc(e){return e?{...e,nombre:e.nombre??e.name??``,codigo:e.codigo_salon??``,ubicacion:e.ubicacion??e.location??``,condicion:e.condicion_fisica??`buena`,is_active:e.is_active??e.isActive??e.activo??!0,capacidad:parseInt(e.capacidad)||20,piso:e.piso!==void 0&&e.piso!==null?parseInt(e.piso):null,equipamiento:Array.isArray(e.equipamiento)?e.equipamiento.join(`, `):e.equipamiento||``,descripcion:e.descripcion||``}:null}async function qc(){let{data:e,error:t}=await _.from(`salones`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando salones:`,t.message),Error(`No se pudieron cargar los salones`);return e.map(Kc)}async function Jc(e){let t=(e.nombre||``).trim(),n=(e.codigo_salon||``).trim();if(!t)throw Error(`El nombre es obligatorio`);let{data:r,error:i}=await _.from(`salones`).select(`id, nombre, codigo_salon`).or(`nombre.eq."${t}", codigo_salon.eq."${n}"`).maybeSingle();if(i&&console.error(`Error validando duplicados:`,i),r){if(r.nombre.toLowerCase()===t.toLowerCase())throw Error(`Ya existe un salón con ese nombre`);if(n&&r.codigo_salon?.toLowerCase()===n.toLowerCase())throw Error(`Ya existe un salón con ese código`)}let a={nombre:t,codigo_salon:n||void 0,capacidad:parseInt(e.capacidad)||20,ubicacion:(e.ubicacion||``).trim(),piso:e.piso===void 0?null:parseInt(e.piso),condicion_fisica:e.condicion_fisica||`buena`,equipamiento:typeof e.equipamiento==`string`?e.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(e.equipamiento)?e.equipamiento:[],descripcion:(e.descripcion||``).trim(),is_active:e.is_active===void 0?!0:e.is_active,responsable_id:e.responsable_id||null},{data:o,error:s}=await _.from(`salones`).insert([a]).select();if(s)throw s.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error creando salon:`,s.message),Error(`No se pudo crear el salon`));return o[0]}async function Yc(e,t){let n=(t.nombre||``).trim(),r=(t.codigo_salon||``).trim();if(n||r){let{data:t}=await _.from(`salones`).select(`id, nombre, codigo_salon`).neq(`id`,e);if(t){if(n&&t.find(e=>e.nombre.toLowerCase()===n.toLowerCase()))throw Error(`Ya existe otro salón con ese nombre`);if(r&&t.find(e=>e.codigo_salon?.toLowerCase()===r.toLowerCase()))throw Error(`Ya existe otro salón con ese código`)}}let i={...t};n&&(i.nombre=n),r&&(i.codigo_salon=r),i.capacidad&&=parseInt(i.capacidad),i.piso!==void 0&&(i.piso=parseInt(i.piso)),i.equipamiento!==void 0&&(i.equipamiento=typeof i.equipamiento==`string`?i.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(i.equipamiento)?i.equipamiento:[]),i.updated_at=new Date().toISOString();let{data:a,error:o}=await _.from(`salones`).update(i).eq(`id`,e).select();if(o)throw o.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error actualizando salon:`,o.message),Error(`No se pudo actualizar el salon`));return a[0]}async function Xc(e){let{error:t}=await _.from(`salones`).update({is_active:!1,updated_at:new Date().toISOString()}).eq(`id`,e);if(t)throw console.error(`Error eliminando salon:`,t.message),Error(`No se pudo inactivar el salon`)}var Zc=new class{constructor(){this.salones=[],this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notify(){this.listeners.forEach(e=>e(this))}async fetchSalones(){this.cargando=!0,this.error=null,this.notify();try{this.salones=await qc()}catch(e){this.error=e.message,console.error(e)}finally{this.cargando=!1,this.notify()}}getFiltered(e=``,t=``,n=``){return this.salones.filter(r=>{let i=e.toLowerCase(),a=r.nombre.toLowerCase().includes(i)||r.codigo&&r.codigo.toLowerCase().includes(i)||r.ubicacion.toLowerCase().includes(i),o=t===``||String(r.piso)===String(t),s=n===``||r.condicion===n;return a&&o&&s})}},Qc={editandoId:null};function $c(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function el(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].substring(0,2).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function tl(e){e.innerHTML=`
    <div class="page-container">
  ...
  `;let t=e.querySelector(`#salonesTableBody`),n=e.querySelector(`#searchSalon`),r=e.querySelector(`#filterCondicion`),i=e.querySelector(`#filterPiso`),a=e.querySelector(`#salonesCount`),o=()=>{let e=n.value,o=r.value,c=i.value,l=Zc.getFiltered(e,c,o);if(Zc.cargando){t.innerHTML=`<div class="text-center py-5 text-muted"><div class="spinner-border text-primary mb-3" role="status"></div><br><small class="text-muted">Cargando salones...</small></div>`;return}if(Zc.error){t.innerHTML=`<div class="text-center py-5 text-danger"><i class="bi bi-exclamation-triangle fs-3 d-block mb-2"></i> Error: ${$c(Zc.error)}</div>`;return}if(l.length===0){t.innerHTML=`
        <div class="text-center py-5 w-100 text-muted list-group-item" style="background: transparent; border: none;">
          <i class="bi bi-inbox fs-1 d-block mb-3" style="color: var(--bs-secondary);"></i>
          No se encontraron salones con esos filtros.
        </div>`;return}a.textContent=l.length,t.innerHTML=l.map(e=>{let t=el(e.nombre||`S`),n=e.is_active!==!1,r=s(e.condicion),i=`border-accent-${n?`success`:`secondary`}`,a=`bg-${n?`success`:`secondary`}`;return`
        <div class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 w-100 border-start-accent ${i}" data-id="${e.id}" style="cursor: pointer;">
          <div class="d-flex align-items-center gap-3 flex-grow-1 overflow-hidden">
            <div class="position-relative flex-shrink-0">
            ...
            <div class="d-flex flex-column flex-grow-1 overflow-hidden pe-3">
              <span class="fw-bold text-truncate" style="font-size: 1.05rem;">${$c(e.nombre||`-`)}</span>
      ...
      `}).join(``)},s=e=>`<span class="badge badge-compact ${{excelente:`bg-success`,buena:`bg-primary`,regular:`bg-warning`,mala:`bg-danger`}[e]||`bg-secondary`}">${{excelente:`Excelente`,buena:`Buena`,regular:`Regular`,mala:`Mala`}[e]||`-`}</span>`,c=Zc.subscribe(o),l;n.addEventListener(`input`,()=>{clearTimeout(l),l=setTimeout(o,300)}),r.addEventListener(`change`,o),i.addEventListener(`change`,o),e.querySelector(`#btnCrearSalon`)?.addEventListener(`click`,()=>{nl()}),t?.addEventListener(`click`,async e=>{let t=e.target.closest(`.list-group-item[data-id]`);if(t){let e=t.dataset.id;il(e)}}),Zc.fetchSalones(),e.cleanup=()=>{c()}}function nl(){Qc.editandoId=null,b.open({title:`Crear Nuevo Salón`,body:`<form class="row g-2" id="formSalon">
      <div class="col-12">
        <label class="form-label-compact">Nombre *</label>
    ...
    </form>`,saveText:`Guardar`,onSave:async e=>{let t=e.querySelector(`#modal-nombre`).value.trim(),n=parseInt(e.querySelector(`#modal-capacidad`).value),r=e.querySelector(`#modal-piso`).value,i=e.querySelector(`#modal-condicion`).value,a=e.querySelector(`#modal-esActivo`).value===`true`,o=e.querySelector(`#modal-equipamiento`).value.trim(),s=e.querySelector(`#modal-descripcion`).value.trim();if(!t||!n||!r)return v.error(`Por favor complete los campos obligatorios`),!1;await Jc({nombre:t,capacidad:n,piso:r,condicion_fisica:i,is_active:a,equipamiento:o,descripcion:s}),Zc.fetchSalones(),v.success(`Salón creado correctamente`)}})}function rl(e){let t=Zc.salones.find(t=>t.id===e);if(!t){v.error(`Salón no encontrado`);return}Qc.editandoId=e,b.open({title:`Editar Salón`,body:`<form class="row g-2" id="formSalon">
      <div class="col-12">
        <label class="form-label-compact">Nombre *</label>
        <input type="text" class="form-control input-dense" id="modal-nombre" required value="${$c(t.nombre||``)}">
      </div>
      <div class="col-md-6">
        <label class="form-label-compact">Capacidad *</label>
      ...
      <div class="col-12">
        <label class="form-label-compact">Equipamiento</label>
        <textarea class="form-control input-dense" id="modal-equipamiento" rows="2">${$c(t.equipamiento||``)}</textarea>
      </div>
      <div class="col-12">
        <label class="form-label-compact">Descripción</label>
        <textarea class="form-control input-dense" id="modal-descripcion" rows="2">${$c(t.descripcion||``)}</textarea>
      </div>
    </form>`,saveText:`Guardar cambios`,onSave:async t=>{try{let n=t.querySelector(`#modal-nombre`).value.trim(),r=parseInt(t.querySelector(`#modal-capacidad`).value),i=t.querySelector(`#modal-piso`).value,a=t.querySelector(`#modal-condicion`).value,o=t.querySelector(`#modal-esActivo`).value===`true`,s=t.querySelector(`#modal-equipamiento`).value.trim(),c=t.querySelector(`#modal-descripcion`).value.trim();return!n||!r||!i?(v.error(`Por favor complete los campos obligatorios`),!1):(await Yc(e,{nombre:n,capacidad:r,piso:i,condicion_fisica:a,is_active:o,equipamiento:s,descripcion:c}),await Zc.fetchSalones(),v.success(`Salón actualizado correctamente`),!0)}catch(e){return console.error(`Error al actualizar salón:`,e),v.error(e.message||`Error al actualizar el salón`),!1}}})}function il(e){let t=Zc.salones.find(t=>t.id===e);if(!t){v.error(`Salón no encontrado`);return}let n=t.piso===0||t.piso===`0`?`Planta Baja`:`Piso ${t.piso}`,r={excelente:`Excelente`,buena:`Buena`,regular:`Regular`,mala:`Mala`}[t.condicion]||`-`,i=t.is_active===!1?`Inactivo`:`Activo`,a=t.is_active===!1?`bg-secondary`:`bg-success`;b.open({title:$c(t.nombre||`Salón`),hideSave:!0,cancelText:`Cerrar`,onShow:t=>{t.querySelector(`#modal-view-btn-edit`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>rl(e),300)}),t.querySelector(`#modal-view-btn-delete`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>al(e),300)})},body:`
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            <label class="form-label fw-bold">Código</label>
            <p class="form-control-plaintext"><code>${$c(t.codigo||`-`)}</code></p>
          </div>
          <div class="mb-3">
            <label class="form-label fw-bold">Nombre</label>
            <p class="form-control-plaintext">${$c(t.nombre||`-`)}</p>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${$c(n)}</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${$c(t.equipamiento||`Sin equipamiento registrado`)}</p>
          </div>
        </div>
      </div>
      ${t.descripcion?`
      ...
      <div class="row">
        <div class="col-12">
          <div class="mb-3">
            ...
            <p class="form-control-plaintext">${$c(t.descripcion)}</p>
          </div>
        </div>
      </div>
      `:``}
    ...
    `})}function al(e){let t=Zc.salones.find(t=>t.id===e);if(!t){v.error(`Salón no encontrado`);return}b.open({title:`⚠️ Inactivar Salón`,size:`sm`,saveText:`Inactivar`,body:`<p>¿Inactivar el salón <strong>${$c(t.nombre)}</strong>?</p>
           <p class="text-muted small mb-0">Esta acción lo ocultará de las asignaciones de clases.</p>`,onSave:async()=>{await Xc(e),Zc.fetchSalones(),v.success(`Salón inactivado correctamente`)}})}function ol(){S.register(`salones`,tl)}var H={clases:[],clasesOriginales:[],maestros:[],salones:[],programas:[],alumnos:[],cargando:!1,filtroEstado:`todos`,filtroInstrumento:``,vista:`tabla`,container:null,mostrarDiasVacios:!0};async function sl(e){if(e)try{H.container=e,H.cargando=!0,cl(e);let[t,n,r,i,a]=await Promise.all([fe(),_.from(`maestros`).select(`*`).order(`nombre_completo`,{ascending:!0}),_.from(`salones`).select(`*`).order(`nombre`,{ascending:!0}),_.from(`programas`).select(`*`).order(`nombre`,{ascending:!0}),_.from(`alumnos`).select(`*`).eq(`activo`,!0).order(`nombre_completo`,{ascending:!0})]);H.clases=t,H.clasesOriginales=[...t],H.maestros=n.data||[],H.salones=r.data||[],H.programas=i.data||[],H.alumnos=a.data||[],H.cargando=!1,ul(e),gl(e)}catch(t){console.error(t),ll(e,t.message)}}function cl(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status"></div>
  ...
  `,e.querySelector(`#retryBtn`)?.addEventListener(`click`,()=>sl(e))}function ul(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function dl(){return H.clases.length===0?pl():`
    <div class="page-glass rounded w-100">
      <div class="list-group list-group-flush w-100" id="clasesListBody">
        ${H.clases.map(e=>fl(e)).join(``)}
      </div>
    </div>
  `}function fl(e){let t=e.nombre||`Sin nombre`,n=H.maestros.find(t=>t.id===e.maestro_principal_id),r=n?n.nombre_completo||n.nombre:`Sin maestro`,i=_e(t),a=e.estado||`activa`,o=`border-accent-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,s=`bg-${a===`activa`?`success`:a===`suspendida`?`warning`:`secondary`}`,c=(e.horarios||[]).slice(0,3),l=c.length>0?c.map(e=>`${(e.dia||``).slice(0,2).toUpperCase()} ${(e.hora_inicio||``).slice(0,5)}`).join(` • `):`Sin horarios`;return`
  ...
  `}function ml(){if(H.clases.length===0)return pl();let e=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`],t={lunes:`Lunes`,martes:`Martes`,miércoles:`Miércoles`,jueves:`Jueves`,viernes:`Viernes`,sábado:`Sábado`},n={lunes:[],martes:[],miércoles:[],jueves:[],viernes:[],sábado:[]};H.clases.forEach(e=>{(e.horarios||[]).forEach(t=>{let r=(t.dia||``).toLowerCase().trim();n[r]&&n[r].push({...t,clase:e})})}),Object.keys(n).forEach(e=>{n[e].sort((e,t)=>le(e.hora_inicio)-le(t.hora_inicio))});let r=H.mostrarDiasVacios?``:`hide-empty-days`;return`
        ...
        ${e.map(e=>{let r=n[e],i=t[e];return`
            <div class="schedule-day-column ${r.length===0?`is-empty`:``}" data-day="${e}">
              ...
              <div class="schedule-blocks-container">
                ${r.length>0?r.map(e=>{let t=e.clase,n=t.estado||`activa`,r=he(e.hora_inicio),i=he(e.hora_fin),a=H.salones.find(t=>t.id===e.salon_id),o=a?a.nombre:`Online/Otro`;return`
                    <div class="time-block-card p-2 rounded mb-2 border-start-accent ${`border-accent-${n===`activa`?`success`:n===`suspendida`?`warning`:`secondary`}`}" data-id="${t.id}" style="cursor: pointer;">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <i class="bi ${ge(t.instrumento)} text-muted" style="font-size: 0.85rem;"></i>
                      </div>
  ...
  `}async function hl(e){if(e){b.open({title:`Cargando...`,hideSave:!0,size:`md`,body:`
        ...
        <div class="list-group list-group-flush border-top">
          ${t.map(e=>{let t=e.alumno;if(!t)return``;let n=_e(t.nombre_completo||t.nombre||`?`);return`
              <div class="list-group-item d-flex align-items-center gap-3 py-2 px-3 border-bottom-0 bg-transparent">
                <div class="avatar-compact text-white d-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; font-size: 0.85rem; background-color: ${Te(t.id)}; font-weight:600;">
                  ${n}
                </div>
      ...
      <div class="class-profile-container">
        ...
        <div class="class-hero-card d-flex align-items-center gap-3 p-3 rounded mb-4" style="background: linear-gradient(135deg, rgba(13,110,253,0.08) 0%, rgba(88,86,214,0.08) 100%); border: 1px solid rgba(13,110,253,0.15);">
          ...
          <div class="overflow-hidden">
            ...
            <span class="badge rounded-pill bg-${e.estado===`activa`?`success`:e.estado===`suspendida`?`warning`:`secondary`} text-capitalize" style="font-size: 0.75rem;">${xe(e.estado)}</span>
          </div>
        </div>
    ...
    `;b.open({title:`Perfil de Clase: ${e.nombre}`,hideSave:!0,size:`md`,body:m,onShow:t=>{let n=t.closest(`.app-modal-dialog`)?.querySelector(`.app-modal-footer`);n&&n.style.setProperty(`display`,`none`,`important`),t.querySelector(`.btn-profile-edit`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>{vn(e,{maestros:H.maestros,salones:H.salones,programas:H.programas,alumnos:H.alumnos,onSuccess:()=>sl(H.container)})},250)}),t.querySelector(`.btn-profile-delete`)?.addEventListener(`click`,()=>{b.close(),setTimeout(()=>{vl(e.id)},250)}),t.querySelector(`.btn-profile-close`)?.addEventListener(`click`,()=>{b.close()})}})}catch(e){console.error(e),v.error(`Error al cargar la información detallada de la clase`),b.close()}}}function gl(e){e.querySelector(`#btn-help-clases`)?.addEventListener(`click`,()=>{In.open({title:`Clases`,intro:`Gestión completa de clases: creación, horarios, asignación de maestros, inscripción de alumnos y control de capacidad.`,sections:[{icon:`bi-easel2`,title:`Lista de clases`,description:`Todas las clases del sistema. Filtrá por instrumento, nivel y estado. Las activas aparecen primero.`,color:`#3b82f6`},{icon:`bi-clock`,title:`Horarios`,description:`Cada clase puede tener múltiples horarios semanales. El sistema detecta conflictos de salón y de maestro automáticamente.`,color:`#6366f1`},{icon:`bi-people`,title:`Inscripción de alumnos`,description:`"Grupal": todos comparten el horario. "Rotativa (Turnos)": cada alumno tiene su propio horario individual dentro de la clase.`,color:`#10b981`},{icon:`bi-bar-chart`,title:`Capacidad`,description:`Barra de ocupación: inscriptos vs capacidad máxima. Rojo cuando supera el 90%.`,color:`#f59e0b`},{icon:`bi-person-workspace`,title:`Maestro titular y suplente`,description:`Cada clase tiene un maestro principal (obligatorio) y puede tener suplente (opcional). Ambos aparecen en el perfil del maestro.`,color:`#6b7280`}]})}),e.querySelector(`#btnAgregarClase`)?.addEventListener(`click`,()=>{vn(null,{maestros:H.maestros,salones:H.salones,programas:H.programas,alumnos:H.alumnos,onSuccess:()=>sl(e)})}),e.querySelector(`#btn-vista-tabla`)?.addEventListener(`click`,()=>{H.vista=`tabla`,ul(e),gl(e)}),e.querySelector(`#btn-vista-calendario`)?.addEventListener(`click`,()=>{H.vista=`calendario`,ul(e),gl(e)}),e.querySelector(`#buscar`)?.addEventListener(`input`,_l),e.querySelector(`#filtroEstado`)?.addEventListener(`change`,_l);let t=e.querySelector(`#view-content`);t?.addEventListener(`change`,t=>{if(t.target&&t.target.id===`toggle-empty-days`){H.mostrarDiasVacios=t.target.checked;let n=e.querySelector(`.weekly-schedule-grid`);n&&(H.mostrarDiasVacios?n.classList.remove(`hide-empty-days`):n.classList.add(`hide-empty-days`))}}),t?.addEventListener(`click`,e=>{let t=e.target.closest(`.list-group-item[data-id], .time-block-card[data-id]`);if(t){let e=t.dataset.id,n=H.clasesOriginales.find(t=>t.id===e);n&&hl(n)}})}function _l(){let e=H.container.querySelector(`#buscar`)?.value.trim().toLowerCase()||``,t=H.container.querySelector(`#filtroEstado`)?.value||`todos`;H.clases=H.clasesOriginales.filter(n=>{let r=!e||n.nombre.toLowerCase().includes(e)||n.instrumento.toLowerCase().includes(e),i=t===`todos`||n.estado===t;return r&&i});let n=H.container.querySelector(`#view-content`);n&&(n.innerHTML=H.vista===`tabla`?dl():ml())}function vl(e){let t=H.clasesOriginales.find(t=>t.id===e);t&&b.open({title:`⚠️ Eliminar Clase`,saveText:`Eliminar Definitivamente`,body:`<p>¿Estás seguro de eliminar la clase <strong>${h(t.nombre)}</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await ue(e),v.success(`Clase eliminada`),sl(H.container),!0}catch(e){return v.error(e.message),!1}}})}function yl(){S.register(`clases`,sl)}var U={timeline:[],periodos:[],periodoActivo:null,clases:[],resumenGlobal:null,cargando:!1,filtroPeriodo:null,filtroClase:`todas`,container:null};async function bl(e){if(e)try{U.container=e,U.cargando=!0,Sl(e);let[t,n,r]=await Promise.all([i(),a(),Ne()]);U.periodos=t,U.periodoActivo=n,n?.id?U.filtroPeriodo=n.id:t&&t.length>0?U.filtroPeriodo=t[0].id:U.filtroPeriodo=null,U.clases=r,await xl(),wl(e),Ol(e)}catch(t){console.error(t),Cl(e,t.message)}}async function xl(){let{timelineByDate:e,resumenGlobal:t}=await ee({periodoId:U.filtroPeriodo});U.timeline=e||[],U.resumenGlobal=t||{totalClases:0,totalPresentes:0,totalAusentes:0,totalJustificados:0,totalRegistros:0,totalSesiones:0}}function Sl(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status"></div>
    </div>
  ...
  `,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>bl(e))}function wl(e){e.innerHTML=`
    <div class="page-container">
  ...
  `}function Tl(){return U.timeline.length===0?`<div class="text-center py-5 text-muted"><i class="bi bi-calendar-x fs-1 d-block mb-2"></i>No hay clases registradas.</div>`:U.timeline.map((e,t)=>{let n=Dl(e.fecha),r=`accordion-fecha-${t}`,i=e.clases.map((e,n)=>{let r=`accordion-clase-${t}-${n}`,i=e.hora_inicio?`${e.hora_inicio.slice(0,5)} - ${e.hora_fin?.slice(0,5)||`??:??`}`:`Sin horario`;return`
    ...
    `}).join(``)}function El(e){let t=e.asistencias||[],n=t.filter(e=>e.estado===`presente`),r=t.filter(e=>e.estado===`ausente`),i=t.filter(e=>e.estado===`justificado`),a=(e,t,n)=>t.length===0?``:`
      <div class="mb-3">
  ...
  `}function Dl(e){return new Date(e+`T12:00:00`).toLocaleDateString(`es-ES`,{weekday:`long`,day:`numeric`,month:`long`})}function Ol(e){e.querySelector(`#select-periodo`)?.addEventListener(`change`,async e=>{U.filtroPeriodo=e.target.value,await kl()}),e.querySelector(`#accordion-dias`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="view-detail"]`);t&&Al(t.dataset.id)}),e.querySelector(`#btn-nueva-sesion`)?.addEventListener(`click`,()=>jl())}async function kl(){let e=U.container;v.info(`Cargando asistencias...`),await xl();let t=e.querySelector(`.asistencias-header-premium p.text-muted`);t&&(t.textContent=`${U.resumenGlobal?.totalRegistros||0} registros en total`);let n=e.querySelector(`.stats-panel`);n&&(n.innerHTML=`
      <div class="stats-grid">
        <div class="stat-card stat-total">
          <div class="stat-label">Total Registros</div>
          <div class="stat-value">${U.resumenGlobal?.totalRegistros||0}</div>
    ...
    `);let r=e.querySelector(`#accordion-dias`);r&&(r.innerHTML=Tl()),Ol(e),v.success(`Asistencias cargadas`)}async function Al(e){v.info(`Cargando detalle...`);try{let t=await re(e);b.open({title:`Sesión: ${t.sesion.claseNombre}`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
        <div class="row g-4">
          <div class="col-md-8">
                  ...
                  ${t.asistencias.map(e=>`
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="badge bg-${r[e.estado]?.css||`secondary`}">${r[e.estado]?.label||e.estado}</span>
                      </td>
  ...
  `}var Nl={periodoActivo:null,periodos:[],datos:{programas:{},niveles:{},totales:{sesiones:0,presentes:0,ausentes:0,justificados:0}},cargando:!1};async function Pl(e){Nl.cargando=!0,e.innerHTML=Fl(),await Il(),Nl.cargando=!1,Rl(e)}function Fl(){return`
  ...
  `}async function Il(){let[e,t]=await Promise.all([i(),a()]);Nl.periodos=e,Nl.periodoActivo=t,t&&(Nl.datos=Ll(await ye({periodoId:t.id})))}function Ll(e){let t={},n={},r=0,i=0,a=0,o=0;for(let s of e)for(let e of s.sesiones){let s=e.claseNombre?.split(`-`)[0]?.trim()||`General`,c=e.instrumento||`General`;t[s]||(t[s]={total:0,presentes:0,ausentes:0,justificados:0}),t[s].total+=e.totalRegistros||0,t[s].presentes+=e.totalPresentes||0,t[s].ausentes+=e.totalAusentes||0,t[s].justificados+=e.totalJustificados||0,n[c]||(n[c]={total:0,presentes:0,ausentes:0,justificados:0}),n[c].total+=e.totalRegistros||0,n[c].presentes+=e.totalPresentes||0,n[c].ausentes+=e.totalAusentes||0,n[c].justificados+=e.totalJustificados||0,r++,i+=e.totalPresentes||0,a+=e.totalAusentes||0,o+=e.totalJustificados||0}return{programas:t,niveles:n,totales:{sesiones:r,presentes:i,ausentes:a,justificados:o}}}function Rl(e){let{programas:t,niveles:n,totales:r}=Nl.datos,i=r.presentes+r.ausentes+r.justificados?Math.round(r.presentes/i*100):0;e.innerHTML=`
    <div class="page-container py-3">
      ...
      <div class="row g-3 mb-4">
        <div class="col-md-3">${Ml({titulo:`Sesiones`,valor:r.sesiones,colorClass:`primary`,icono:`bi-calendar3`})}</div>
        <div class="col-md-3">${Ml({titulo:`Tasa Asistencia`,valor:`${i}%`,colorClass:i>=80?`success`:i>=50?`warning`:`danger`,icono:`bi-check-circle`})}</div>
        <div class="col-md-3">${Ml({titulo:`Ausentes`,valor:r.ausentes,colorClass:`danger`,icono:`bi-x-circle`})}</div>
        <div class="col-md-3">${Ml({titulo:`Justificados`,valor:r.justificados,colorClass:`warning`,icono:`bi-file-earmark-check`})}</div>
      </div>
  ...
  `}function zl(e,t){if(!Object.keys(e).length)return`<p class="text-muted text-center py-3">Sin datos disponibles</p>`;let n=Object.entries(e).sort((e,t)=>t[1].presentes+t[1].ausentes-(e[1].presentes+e[1].ausentes));return Math.max(...n.map(([,e])=>e.presentes+e.ausentes+e.justificados)),n.slice(0,8).map(([e,t])=>{let n=t.presentes+t.ausentes+t.justificados,r=n?t.presentes/n*100:0,i=n?t.ausentes/n*100:0,a=n?t.justificados/n*100:0;return`
    ...
    `}).join(``)}function Bl(){S.register(`asistencias`,bl),S.register(`asistencias-reportes`,Pl)}var Vl=e({default:()=>Ul,sesiones:()=>Hl}),Hl=[{id:`sesion_001`,clase_id:`clase_001`,maestro_id:`maestro_001`,fecha:`2026-05-05`,hora_inicio:`16:00`,hora_fin:`17:00`,tema:`Escala Do Mayor - posición básica`,contenido:`Practicar primera posición, arco arriba y abajo. Ejercicios de flexibilidad.`,asistencia:{presentes:8,ausentes:2,justificados:2},tipo:`regular`,estado:`registrada`,created_at:`2026-05-05T17:30:00Z`},{id:`sesion_002`,clase_id:`clase_002`,maestro_id:`maestro_002`,fecha:`2026-05-05`,hora_inicio:`17:00`,hora_fin:`18:00`,tema:`Arpegios en Do mayor`,contenido:`Digitación de arpegios, cambio de posición suave.`,asistencia:{presentes:6,ausentes:1,justificados:1},tipo:`regular`,estado:`registrada`,created_at:`2026-05-05T18:15:00Z`},{id:`sesion_003`,clase_id:`clase_001`,maestro_id:`maestro_001`,fecha:`2026-04-30`,hora_inicio:`16:00`,hora_fin:`17:00`,tema:`Notas sostenido - práctica`,contenido:`Introducción a notas sostenido, ejercicios de digitación.`,asistencia:{presentes:7,ausentes:3,justificados:1},tipo:`regular`,estado:`registrada`,created_at:`2026-04-30T17:20:00Z`},{id:`sesion_004`,clase_id:`clase_003`,maestro_id:`maestro_001`,fecha:`2026-04-28`,hora_inicio:`18:00`,hora_fin:`19:30`,tema:`Técnica de rasgueo avanzado`,contenido:`Patrones de rasgueo, práctica de pieza de examen.`,asistencia:{presentes:9,ausentes:1,justificados:0},tipo:`regular`,estado:`registrada`,created_at:`2026-04-28T19:45:00Z`},{id:`sesion_emergente_001`,clase_id:`clase_001`,maestro_id:`maestro_001`,fecha:`2026-05-08`,hora_inicio:`16:00`,hora_fin:`17:00`,tema:`CLASE ESPECIAL - Concerto`,contenido:`Preparación para recital de fin de semester. Sesión adicional programada.`,asistencia:null,tipo:`emergente`,motivo:`Preparación para Concerto de fin de año`,estado:`pendiente`,created_at:`2026-05-05T10:00:00Z`},{id:`sesion_emergente_002`,clase_id:`clase_004`,maestro_id:`maestro_003`,fecha:`2026-05-10`,hora_inicio:`15:00`,hora_fin:`16:00`,tema:`CLASE DE REEMPLAZO`,contenido:`Reemplazo de clase del 9 de mayo (feriado).`,asistencia:null,tipo:`emergente`,motivo:`Recuperación por feriado`,estado:`pendiente`,created_at:`2026-05-05T11:30:00Z`},{id:`sesion_005`,clase_id:`clase_005`,maestro_id:`maestro_004`,fecha:`2026-04-29`,hora_inicio:`16:30`,hora_fin:`17:30`,tema:`Repertorio合唱`,contenido:`Práctica de canciones para actuación escolar.`,asistencia:{presentes:22,ausentes:2,justificados:1},tipo:`regular`,estado:`registrada`,created_at:`2026-04-29T18:00:00Z`}],Ul={sesiones:Hl},Wl=!window.location.href.includes(`supabase`);async function Gl(e={}){if(Wl){let t=[...Ul.sesiones];return e.fecha&&(t=t.filter(t=>t.fecha===e.fecha)),e.clase_id&&(t=t.filter(t=>t.clase_id===e.clase_id)),e.maestro_id&&(t=t.filter(t=>t.maestro_id===e.maestro_id)),e.tipo&&(t=t.filter(t=>t.tipo===e.tipo)),t}let t=_.from(`sesiones_clase`).select(`*`).order(`fecha`,{ascending:!1});e.fecha&&(t=t.eq(`fecha`,e.fecha)),e.clase_id&&(t=t.eq(`clase_id`,e.clase_id)),e.maestro_id&&(t=t.eq(`maestro_id`,e.maestro_id)),e.tipo&&(t=t.eq(`tipo`,e.tipo));let{data:n,error:r}=await t;if(r)throw console.error(`Error cargando sesiones:`,r.message),Error(`No se pudieron cargar las sesiones`);return n}async function Kl(e){if(!e.clase_id)throw Error(`La clase es obligatoria`);if(!e.fecha)throw Error(`La fecha es obligatoria`);if(!e.tema)throw Error(`El tema es obligatorio`);let t=null,n=null;if(!Wl){let r=[`domingo`,`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`][new Date(e.fecha).getDay()].toLowerCase(),{data:i,error:a}=await _.from(`clase_horarios`).select(`id, salon_id`).eq(`clase_id`,e.clase_id).eq(`dia`,r).limit(1);!a&&i&&i.length>0&&(t=i[0].id,n=i[0].salon_id)}let r={clase_id:e.clase_id,maestro_id:e.maestro_id||null,fecha:e.fecha,hora_inicio:e.hora_inicio||null,hora_fin:e.hora_fin||null,horario_id:t,salon_id:n,tema:e.tema.trim(),contenido:e.contenido?.trim()||null,motivo:e.motivo?.trim()||null,tipo:e.tipo||`regular`,estado:e.estado||`pendiente`,es_codocencia:e.es_codocencia||!1,maestro_auxiliar_id:e.maestro_auxiliar_id||null,asistencia:null};if(Wl){let e={...r,id:`sesion_${Date.now()}`,created_at:new Date().toISOString()};return Ul.sesiones.push(e),e}let{data:i,error:a}=await _.from(`sesiones_clase`).insert([r]).select();if(a)throw console.error(`Error creando sesión:`,a.message),Error(`No se pudo crear la sesión`);return i[0]}async function ql(e,t){let n={};if(t.tema!==void 0&&(n.tema=t.tema.trim()),t.contenido!==void 0&&(n.contenido=t.contenido?.trim()||null),t.hora_inicio!==void 0&&(n.hora_inicio=t.hora_inicio),t.hora_fin!==void 0&&(n.hora_fin=t.hora_fin),t.estado!==void 0&&(n.estado=t.estado),t.asistencia!==void 0&&(n.asistencia=t.asistencia),t.es_codocencia!==void 0&&(n.es_codocencia=t.es_codocencia),t.maestro_auxiliar_id!==void 0&&(n.maestro_auxiliar_id=t.maestro_auxiliar_id),Wl){let t=Ul.sesiones.findIndex(t=>t.id===e);if(t===-1)throw Error(`Sesión no encontrada`);return Ul.sesiones[t]={...Ul.sesiones[t],...n,updated_at:new Date().toISOString()},Ul.sesiones[t]}let{data:r,error:i}=await _.from(`sesiones_clase`).update(n).eq(`id`,e).select();if(i)throw console.error(`Error actualizando sesión:`,i.message),Error(`No se pudo actualizar la sesión`);return r[0]}async function Jl(e){if(Wl){let t=Ul.sesiones.findIndex(t=>t.id===e);if(t===-1)throw Error(`Sesión no encontrada`);return Ul.sesiones.splice(t,1),{success:!0}}let{error:t}=await _.from(`sesiones_clase`).delete().eq(`id`,e);if(t)throw console.error(`Error eliminando sesión:`,t.message),Error(`No se pudo eliminar la sesión`);return{success:!0}}async function Yl(e,t){return ql(e,{asistencia:t||[]})}async function Xl(e){if(Wl)return Ul.sesiones.filter(t=>t.maestro_auxiliar_id===e);let{data:t,error:n}=await _.from(`sesiones_clase`).select(`*`).eq(`maestro_auxiliar_id`,e).order(`fecha`,{ascending:!1});if(n)throw console.error(`Error cargando sesiones de co-docencia:`,n.message),Error(`Error al cargar sesiones`);return t}async function Zl(e){if(Wl)return $e.clases.filter(t=>t.maestro_titular_id===e||t.maestro_auxiliar_id===e);let{data:t,error:n}=await _.from(`clases`).select(`*`).or(`maestro_principal_id.eq.${e},maestro_auxiliar_id.eq.${e}`);if(n)throw console.error(`Error cargando clases del maestro:`,n.message),Error(`Error al cargar clases`);return t}var Ql=class{constructor(){this.planificaciones=[],this.planificacionActual=null,this.sesiones=[],this.clases=[],this.maestroActualId=null,this.esCoDocencia=!1,this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}setMaestroActual(e,t=!1){this.maestroActualId=e,this.esCoDocencia=t,this.notifyListeners()}notifyListeners(){this.listeners.forEach(e=>{e({planificaciones:this.planificaciones,planificacionActual:this.planificacionActual,sesiones:this.sesiones,clases:this.clases,maestroActualId:this.maestroActualId,esCoDocencia:this.esCoDocencia,cargando:this.cargando,error:this.error})})}async fetchPlanificaciones(){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificaciones=await Ie(this.maestroActualId),this.cargando=!1,this.notifyListeners(),this.planificaciones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchPlanificacionesConDetalles(){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificaciones=await n(this.maestroActualId),this.cargando=!1,this.notifyListeners(),this.planificaciones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchPlanificacion(e){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.planificacionActual=await ne(e),this.cargando=!1,this.notifyListeners(),this.planificacionActual}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}reset(){this.planificaciones=[],this.planificacionActual=null,this.cargando=!1,this.error=null,this.notifyListeners()}search(e){if(!e)return this.planificaciones;let t=e.toLowerCase();return this.planificaciones.filter(e=>(e.tema||``).toLowerCase().includes(t)||(e.contenido||``).toLowerCase().includes(t)||(e.objetivos||``).toLowerCase().includes(t)||(e.observaciones||``).toLowerCase().includes(t))}filterByClase(e){return this.planificaciones.filter(t=>t.clase_id===e)}filterByMaestro(e){return this.planificaciones.filter(t=>t.maestro_id===e)}filterByEstado(e){return this.planificaciones.filter(t=>t.estado===e)}getById(e){return this.planificaciones.find(t=>t.id===e)||null}getActivas(){return this.planificaciones.filter(e=>e.estado===`planificado`)}count(){return this.planificaciones.length}countByEstado(){return this.planificaciones.reduce((e,t)=>{let n=t.estado||`Sin estado`;return e[n]=(e[n]||0)+1,e},{})}countByClase(){return this.planificaciones.reduce((e,t)=>{let n=t.clase_id||`Sin clase`;return e[n]=(e[n]||0)+1,e},{})}async fetchSesiones(e={}){this.cargando=!0,this.error=null,this.notifyListeners();try{return this.sesiones=await Gl(e),this.cargando=!1,this.notifyListeners(),this.sesiones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchClasesDelMaestro(e){this.cargando=!0,this.error=null;try{return this.clases=await Zl(e),this.cargando=!1,this.notifyListeners(),this.clases}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async fetchSesionesCoDocencia(e){this.cargando=!0,this.error=null;try{return this.sesiones=await Xl(e),this.esCoDocencia=!0,this.cargando=!1,this.notifyListeners(),this.sesiones}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async crearSesionEmergente(e){this.cargando=!0,this.error=null;try{let t=await Kl({...e,maestro_id:this.maestroActualId});return this.sesiones.unshift(t),this.cargando=!1,this.notifyListeners(),t}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async actualizarSesionPasada(e,t){this.cargando=!0,this.error=null;try{let n=await ql(e,t),r=this.sesiones.findIndex(t=>t.id===e);return r!==-1&&(this.sesiones[r]={...this.sesiones[r],...n}),this.cargando=!1,this.notifyListeners(),n}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async eliminarSesion(e){this.cargando=!0,this.error=null;try{return await Jl(e),this.sesiones=this.sesiones.filter(t=>t.id!==e),this.cargando=!1,this.notifyListeners(),{success:!0}}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}async registrarAsistencia(e,t){this.cargando=!0,this.error=null;try{let n=await Yl(e,t),r=this.sesiones.findIndex(t=>t.id===e);return r!==-1&&(this.sesiones[r]={...this.sesiones[r],...n}),this.cargando=!1,this.notifyListeners(),n}catch(e){throw this.error=e.message,this.cargando=!1,this.notifyListeners(),e}}getSesionesPorFecha(e){return this.sesiones.filter(t=>t.fecha===e)}getSesionesEmergentes(){return this.sesiones.filter(e=>e.tipo===`emergente`)}getSesionesRegulares(){return this.sesiones.filter(e=>e.tipo===`regular`)}puedeEditarSesion(e){return this.esCoDocencia?e.maestro_auxiliar_id===this.maestroActualId:e.maestro_id===this.maestroActualId}resetSesiones(){this.sesiones=[],this.clases=[],this.maestroActualId=null,this.esCoDocencia=!1,this.notifyListeners()}},$l=null;function eu(){return $l||=new Ql,$l}async function tu(e){let{data:t,error:n}=await _.from(`cobertura_alumno_objetivo`).upsert(e,{onConflict:`alumno_id,objetivo_id`}).select();if(n)throw n;return t}async function nu(e){let{data:t,error:n}=await _.from(`cobertura_alumno_objetivo`).select(`
      id, nivel, confirmado, fecha, plan_id, objetivo_id,
      curriculo_objetivos ( id, descripcion, pilar_id,
        curriculo_pilares ( id, nombre )
      )
    `).eq(`alumno_id`,e);if(n)throw n;return t||[]}function ru(){return`/functions/v1/groq-proxy`}async function iu(){let{data:{session:e}}=await _.auth.getSession();return{Authorization:`Bearer ${e?.access_token??``}`,"Content-Type":`application/json`,apikey:``}}async function au(e,{maxTokens:t,temperature:n,responseFormat:r}={}){let i=await iu(),a={model:x.groq.model,messages:e,...t&&{max_tokens:t},...n!==void 0&&{temperature:n},...r&&{response_format:r}},o=await fetch(`${ru()}/chat`,{method:`POST`,headers:i,body:JSON.stringify(a)}),s=await o.json();if(!o.ok||s.error)throw Error(s.error?.message??`Groq proxy error ${o.status}`);return s.choices[0].message.content.trim()}async function ou(e,t,n){let r=`Eres un asistente pedagógico musical. Dado el contenido de un plan de clase y una lista de objetivos curriculares, identifica cuáles objetivos probablemente se cubrieron.
...
Para las próximas semanas, incorporá al menos una pieza nueva por mes y dedicá 5-10 minutos a ejercicios de lectura rítmica.`,isMock:!0};try{return{success:!0,feedback:await au([{role:`user`,content:i}],{maxTokens:600,temperature:.8}),isMock:!1}}catch(e){return console.error(`analizarEnfoque error:`,e),{success:!1,feedback:``,error:e.message}}}var lu=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),uu=`
...
.cob-ai-badge { font-size:.7rem; color: var(--bs-warning-text-emphasis); }
</style>`;async function du({plan:e,claseId:t,instrumento:n,nivel:r,maestroId:i,onConfirm:a,onSkip:o}){let s=document.createElement(`div`);s.innerHTML=`${uu}
    <div class="modal fade" id="cob-modal" tabindex="-1" data-bs-backdrop="static">
    ...
    </div>`,document.body.appendChild(s);let c=s.querySelector(`#cob-modal`),l=new bootstrap.Modal(c),u=[];s.querySelector(`#cob-btn-skip`).addEventListener(`click`,()=>{l.hide(),o?.()}),s.querySelector(`#cob-btn-confirm`).addEventListener(`click`,async()=>{let t=u.filter(e=>e.checked).map(t=>({alumno_id:t.alumno_id,objetivo_id:t.objetivo_id,plan_id:e.id,maestro_id:i,nivel:t.nivel,confirmado:!0,fecha:e.fecha_inicio||new Date().toISOString().slice(0,10)}));try{t.length>0&&await tu(t),v.success(`Cobertura registrada`),l.hide(),a?.()}catch(e){v.error(e.message)}}),c.addEventListener(`hidden.bs.modal`,()=>s.remove()),l.show();try{let i=[],a=null;if(t){let{data:e}=await _.from(`clases`).select(`ruta_id`).eq(`id`,t).single();e?.ruta_id&&(a=await ln(e.ruta_id),i=a.objetivos.map(e=>({id:e.objetivo_id,descripcion:e.descripcion,pilar_nombre:null})))}let o=null;i.length===0&&n&&r&&(o=await oe(n,r),o&&(i=o.curriculo_pilares.flatMap(e=>e.curriculo_objetivos.map(t=>({...t,pilar_nombre:e.nombre})))));let c=me(e.notas_dsl||e.contenido||``).alumnos||[],l=[];if(c.length>0||t){let{data:e}=await _.from(`alumnos`).select(`id, nombre_completo`);c.length>0&&(l=(e||[]).filter(e=>c.some(t=>e.nombre_completo.toLowerCase().includes(t.toLowerCase()))))}if(l.length===0&&t){let{data:e}=await _.from(`alumnos_clases`).select(`alumnos(id, nombre_completo)`).eq(`clase_id`,t);l=(e||[]).map(e=>e.alumnos).filter(Boolean)}let f=[];o&&i.length>0&&(f=(await ou({tema:e.tema,objetivos:e.objetivos,contenido:e.contenido,notas_dsl:e.notas_dsl},c,i.map(e=>({id:e.id,descripcion:e.descripcion})))).coberturas||[]),u=[],l.forEach(e=>{i.forEach(t=>{let n=f.find(n=>n.objetivo_id===t.id&&e.nombre_completo.toLowerCase().includes((n.alumno||``).toLowerCase()));u.push({alumno_id:e.id,alumno_nombre:e.nombre_completo,objetivo_id:t.id,obj_descripcion:t.descripcion,pilar_nombre:t.pilar_nombre,nivel:n?.nivel||`en_proceso`,checked:!!n,ai_suggested:!!n,razon:n?.razon||``})})}),d(),s.querySelector(`#cob-btn-confirm`).disabled=!1}catch(e){document.getElementById(`cob-body`).innerHTML=`
      <div class="alert alert-warning">
        <i class="bi bi-exclamation-triangle me-2"></i>
      ...
      ${Object.entries(t).map(([e,{nombre:t,rows:n}])=>`
        <div class="cob-alumno-block">
          <div class="cob-alumno-name"><i class="bi bi-person me-1"></i>${lu(t)}</div>
          ${n.map(e=>{let t=u.indexOf(e);return`
            <div class="cob-obj-row">
              ...
              <span style="flex:1">
                <span class="text-muted small">${lu(e.pilar_nombre)} /</span> ${lu(e.obj_descripcion)}
        ...
        </div>`).join(``)}`,e.querySelectorAll(`.cob-check`).forEach(t=>{t.addEventListener(`change`,()=>{let n=+t.dataset.idx;u[n].checked=t.checked;let r=e.querySelector(`.cob-nivel-sel[data-idx="${n}"]`);r&&(r.disabled=!t.checked)})}),e.querySelectorAll(`.cob-nivel-sel`).forEach(e=>{e.addEventListener(`change`,()=>{u[+e.dataset.idx].nivel=e.value})})}}var fu=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);async function pu(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card border-warning border-opacity-25">
          <div class="card-body">
            ...
            <div class="text-body" style="line-height:1.7; white-space:pre-line">${fu(c.feedback)}</div>
          </div>
        </div>`,e.querySelector(`#ap-btn-regenerate`)?.addEventListener(`click`,()=>{e.querySelector(`#ap-btn-feedback`).click()})}catch(e){r.innerHTML=`<div class="alert alert-danger small">${e.message}</div>`}finally{n.disabled=!1,n.innerHTML=`<i class="bi bi-chat-quote me-1"></i>Analizar mi enfoque`}})}var mu=`
...
.cm-obj-input { flex:1; }
</style>`;function hu(e){let t=document.getElementById(`curriculo-list-modal`);t&&t.remove();let n=document.createElement(`div`);n.id=`curriculo-list-modal`,n.innerHTML=`${mu}
    <div class="modal fade" id="curriculo-list-modal-dialog" tabindex="-1">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
    ...
    </div>`,document.body.appendChild(n);let r=n.querySelector(`#curriculo-list-modal-dialog`),i=new bootstrap.Modal(r);async function a(){let e=document.getElementById(`cl-body`);try{let t=await se();if(t.length===0){e.innerHTML=`<p class="text-muted text-center py-4">No hay currículos creados aún.</p>`;return}e.innerHTML=`
        <table class="table table-sm table-hover align-middle">
          <thead class="table-light">
            <tr>
        ...
        </table>`,e.querySelectorAll(`.cl-toggle`).forEach(e=>{e.addEventListener(`change`,async()=>{await ce(e.dataset.id,e.checked),v.success(e.checked?`Currículo activado`:`Currículo desactivado`)})}),e.querySelectorAll(`.cl-btn-edit`).forEach(e=>{e.addEventListener(`click`,()=>_u(e.dataset.id,a))})}catch(t){e.innerHTML=`<p class="text-danger">${t.message}</p>`}}n.querySelector(`#cl-btn-nuevo`).addEventListener(`click`,()=>{gu(a)}),r.addEventListener(`hidden.bs.modal`,()=>{n.remove(),e?.()}),i.show(),a()}function gu(e){let t=document.createElement(`div`);t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);let n=t.querySelector(`#cc-modal`),r=new bootstrap.Modal(n);t.querySelector(`#cc-btn-save`).addEventListener(`click`,async()=>{let n=t.querySelector(`#cc-instrumento`).value.trim(),i=t.querySelector(`#cc-nivel`).value.trim();if(!n||!i){v.error(`Instrumento y nivel son obligatorios`);return}try{await ae({instrumento:n,nivel:i,descripcion:t.querySelector(`#cc-desc`).value.trim()}),v.success(`Currículo creado`),r.hide(),e?.()}catch(e){v.error(e.message)}}),n.addEventListener(`hidden.bs.modal`,()=>t.remove()),r.show()}async function _u(e,t){let{data:n,error:r}=await _.from(`curriculos`).select(`id, instrumento, nivel, descripcion, curriculo_pilares(id, nombre, orden, curriculo_objetivos(id, descripcion, orden))`).eq(`id`,e).single();if(r){v.error(r.message);return}let i=document.createElement(`div`);i.innerHTML=`
    <div class="modal fade" id="ce-modal" tabindex="-1">
    ...
    </div>`,document.body.appendChild(i);let a=i.querySelector(`#ce-modal`),o=new bootstrap.Modal(a);function l(){let e=document.getElementById(`ce-body`);e.innerHTML=`
      <div class="mb-3">
      ...
      </div>`,e.querySelectorAll(`.pilar-nombre`).forEach(e=>{e.addEventListener(`blur`,async()=>{await c(e.closest(`[data-pilar-id]`).dataset.pilarId,{nombre:e.value.trim()})})}),e.querySelectorAll(`.pilar-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`).dataset.pilarId;confirm(`¿Eliminar este pilar y todos sus objetivos?`)&&(await u(t),n.curriculo_pilares=n.curriculo_pilares.filter(e=>e.id!==t),l())})}),e.querySelectorAll(`.obj-desc`).forEach(e=>{e.addEventListener(`blur`,async()=>{await ie(e.closest(`[data-obj-id]`).dataset.objId,{descripcion:e.value.trim()})})}),e.querySelectorAll(`.obj-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-obj-id]`),r=t.dataset.objId;await Ee(r);let i=t.closest(`[data-pilar-id]`).dataset.pilarId,a=n.curriculo_pilares.find(e=>e.id===i);a&&(a.curriculo_objetivos=a.curriculo_objetivos.filter(e=>e.id!==r)),l()})}),e.querySelectorAll(`.new-obj-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`),r=t.dataset.pilarId,i=t.querySelector(`.new-obj-input`),a=i.value.trim();if(!a)return;let o=n.curriculo_pilares.find(e=>e.id===r),c=(o?.curriculo_objetivos||[]).length,u=await s(r,a,c);o&&(o.curriculo_objetivos=[...o.curriculo_objetivos||[],u]),i.value=``,l()})}),document.getElementById(`ce-add-pilar`)?.addEventListener(`click`,async()=>{let e=prompt(`Nombre del nuevo pilar:`);if(!e?.trim())return;let t=n.curriculo_pilares.length,r=await d(n.id,e.trim(),t);n.curriculo_pilares.push({...r,curriculo_objetivos:[]}),l()})}a.addEventListener(`hidden.bs.modal`,()=>{i.remove(),t?.()}),o.show(),l()}var vu=`
...
</style>`;function yu(e){let t=document.getElementById(`ruta-crear-modal`);t&&t.remove();let n=document.createElement(`div`);n.id=`ruta-crear-modal`,n.innerHTML=`${vu}
...
.cambio-move { color: #ffc107; }
</style>`;function xu(e,t){let n=document.getElementById(`ruta-variante-modal`);n&&n.remove();let r=document.createElement(`div`);r.id=`ruta-variante-modal`,r.innerHTML=`${bu}
    <div class="modal fade" id="ruta-variante-dialog" tabindex="-1">
    ...
    </div>`,document.body.appendChild(r);let i=document.getElementById(`ruta-variante-dialog`),a=new bootstrap.Modal(i);async function o(){let n=document.getElementById(`variante-body`);try{let r=await ln(e);n.innerHTML=`
        <div class="alert alert-info small mb-3">
          <i class="bi bi-info-circle me-2"></i>
      ...
      `;let i=JSON.parse(JSON.stringify(r.objetivos));function o(){let e=document.getElementById(`objetivos-variante`);e.innerHTML=i.map((e,t)=>`
        ...
        `).join(``),document.querySelectorAll(`[data-remove-idx]`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.removeIdx);i.splice(t,1),o()})})}document.getElementById(`btn-agregar-obj-var`).addEventListener(`click`,()=>{let e=Math.max(...i.map(e=>e.semana_fin));i.push({descripcion:``,semana_inicio:e+1,semana_fin:e+2,orden:i.length+1}),o()}),document.getElementById(`btn-proponer-variante`).addEventListener(`click`,async()=>{let n=document.getElementById(`variante-nombre`).value,r=document.getElementById(`variante-razon`).value;if(!n||!r){v.warning(`Completa nombre y razón`);return}try{let o=await pn(e,n,r,i);v.success(`Variante propuesta para aprobación`),a.hide(),t&&t(o)}catch(e){v.error(`Error: ${e.message}`)}}),o()}catch(e){n.innerHTML=`<div class="alert alert-danger">${e.message}</div>`}}i.addEventListener(`shown.bs.modal`,o),a.show()}var Su=`
...
</style>`;async function Cu(e){if(e)try{let t=await dn();if(t.length===0){e.innerHTML=`${Su}<div class="alert alert-info">No hay variantes pendientes de aprobación.</div>`;return}let n=`${Su}
      <div class="mb-3">
        <h5><span class="badge bg-warning">${t.length} pendientes</span></h5>
      </div>`;for(let e of t){let t=e.ruta_base_id?await ln(e.ruta_base_id):null;n+=`
...
`;async function Tu(e,t=`maestro`){if(!e)return;let n=t===`admin`;try{let r=wu;if(n?r+=`
      ...
      `,e.innerHTML=r,n){e.querySelector(`#btn-crear-ruta-soi`)?.addEventListener(`click`,()=>{yu(n=>{v.success(`Ruta "${n.nombre}" creada exitosamente`),Tu(e,t)})});let n=e.querySelector(`#variantes-dashboard-container`);n&&Cu(n)}else{e.querySelector(`#btn-proponer-variante`)?.addEventListener(`click`,async()=>{try{let n=await un({tipo:`soi-estandar`,estado:`activa`});if(n.length===0){v.warning(`No hay rutas estándar disponibles para proponer variantes`);return}let r=await Eu(n);if(!r)return;xu(r.id,n=>{v.success(`Variante propuesta para aprobación`),Tu(e,t)})}catch(e){v.error(`Error: ${e.message}`)}});let n=e.querySelector(`#rutas-list-container`);if(n)try{let e=await un({estado:`activa`});e.length===0?n.innerHTML=`
    ...
    `}}async function Eu(e){return new Promise(t=>{let n=document.createElement(`div`);n.innerHTML=`
...
{Actividad} Construcción de acordes en el instrumento`}],W={planes:[],cargando:!1,viewMode:`maestro`,activeTab:`planes`,asistenteRendered:!1,rutasRendered:!1,seleccionados:new Set,container:null},G=eu();async function Ou(e,{viewMode:t=`maestro`}={}){if(e){if(W.container=e,W.viewMode=t,W.seleccionados=new Set,W.asistenteRendered=!1,W.rutasRendered=!1,t===`plantillas`){Fu(e);return}try{W.cargando=!0,ku(e),await G.fetchPlanificacionesConDetalles(),W.planes=[...G.planificaciones],W.cargando=!1,ju(e),Lu(e)}catch(t){console.error(`[planificacionView]`,t),Au(e,t.message)}}}function ku(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando...</span>
      </div>
    </div>`}function Au(e,t){e.innerHTML=`
    <div class="page-container">
    ...
    </div>`}function ju(e){let t=W.viewMode===`admin`,n=t?`Todas las Planificaciones`:`Mis Planes de Clase`,r=t?`bi-shield-check`:`bi-journal-check`,i=t?`${G.planificaciones.length} planes pendientes de revisión`:`${G.planificaciones.length} planes registrados`,a=t?Mu():``;e.innerHTML=`
    <div class="page-container">
      <!-- Header -->
      ...
      <div class="planificacion-filter-toolbar mb-4">
        ...
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-maestro">
            ...
            ${Array.from(new Set(G.planificaciones.map(e=>e.maestro_nombre).filter(e=>e&&e!==`Sin asignar`))).sort().map(e=>`<option value="${h(e)}">${h(e)}</option>`).join(``)}
          </select>
        </div>
        `:``}
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-clase">
            ...
            ${Array.from(new Set(G.planificaciones.map(e=>e.clase_nombre).filter(e=>e&&e!==`Sin asignar`))).sort().map(e=>`<option value="${h(e)}">${h(e)}</option>`).join(``)}
          </select>
        </div>
        <div class="premium-select-container">
          <i class="bi bi-funnel select-icon-muted"></i>
          <select class="form-select premium-filter-select" id="select-estado">
            ...
            ${Ae.getEstados().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
      </div>
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${W.planes.length===0?Pu():``}</div>
      </div>
      </div>
  ...
  `}function Mu(){let e=G.planificaciones,t=e.filter(e=>e.estado===`ejecutado`).length,n=e.filter(e=>e.estado===`revisado`).length,r=e.length;return`
    <div class="stats-panel mb-4">
      <div class="stats-grid">
  ...
  `}function Nu(e){if(!e||e.length===0)return``;let t=W.viewMode===`admin`;return e.map(e=>{let n=Ae.getEstadoConfig(e.estado),r=e.estado===`revisado`?`border-accent-success`:e.estado===`ejecutado`?`border-accent-warning`:`border-accent-secondary`;return`
    ...
    `}).join(``)}function Pu(){let e=W.viewMode===`admin`;return`
  ...
  `,e.querySelectorAll(`button[data-template-id]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Du.find(t=>t.id===e.dataset.templateId);t&&Iu(t)})})}function Iu(e){b.open({title:`Usar plantilla: ${e.nombre}`,saveText:`Crear Plan`,size:`lg`,body:`
    ...
    `,onOpen:async e=>{let t=await l(),n=e.querySelector(`#tpl-clase_id`);n.innerHTML=`<option value="">Seleccionar clase...</option>`+t.map(e=>`<option value="${e.id}">${h(e.nombre)}</option>`).join(``)},onSave:async e=>{let t={tema:e.querySelector(`#tpl-tema`).value.trim(),clase_id:e.querySelector(`#tpl-clase_id`).value,objetivos:e.querySelector(`#tpl-objetivos`).value.trim(),contenido:e.querySelector(`#tpl-contenido`).value.trim()};try{return await m(t),v.success(`Plan creado desde plantilla`),!0}catch(e){return v.error(e.message),!1}}})}function Lu(e){let t=W.viewMode===`admin`;e.querySelector(`#buscar-plan`)?.addEventListener(`input`,Ru),e.querySelector(`#select-estado`)?.addEventListener(`change`,Ru),e.querySelector(`#select-clase`)?.addEventListener(`change`,Ru),t&&e.querySelector(`#select-maestro`)?.addEventListener(`change`,Ru),e.querySelector(`#btn-help-planificacion`)?.addEventListener(`click`,()=>{In.open({title:`Planificación`,intro:`Módulo para gestionar los planes de clase. Cada plan documenta qué se trabajará en una clase, en qué fecha, y si fue ejecutado o no.`,sections:[{icon:`bi-journal-text`,title:`Tab Mis planes`,description:`Lista tus planes personales. Filtrá por estado (planificado, ejecutado, cancelado) y creá nuevos desde "Nuevo plan".`,color:`#3b82f6`},{icon:`bi-file-earmark-template`,title:`Tab Plantillas`,description:`Plantillas reutilizables en formato DSL. Sirven como base para crear nuevos planes rápidamente.`,color:`#6366f1`},{icon:`bi-journal-check`,title:`Todas las planes (admin)`,description:`Solo visible para administradores. Muestra los planes de todos los maestros para supervisión.`,color:`#10b981`},{icon:`bi-circle-fill`,title:`Estados del plan`,description:`"Planificado" = no dictado aún. "Ejecutado" = clase dada. "Cancelado" = no se realizó. Mantenerlos actualizados mejora los reportes.`,color:`#f59e0b`}]})}),t||e.querySelector(`#btn-nuevo-plan`)?.addEventListener(`click`,()=>Bu(null)),t&&(e.querySelector(`#check-all`)?.addEventListener(`change`,t=>{let n=t.target.checked;W.seleccionados=n?new Set(W.planes.map(e=>e.id)):new Set,e.querySelectorAll(`.plan-check`).forEach(e=>{e.checked=n}),zu()}),e.querySelector(`#btn-aprobar-bulk`)?.addEventListener(`click`,async()=>{let t=[...W.seleccionados];if(t.length)try{await o(t),v.success(`${t.length} plan(es) aprobados`),Ou(e,{viewMode:W.viewMode})}catch(e){v.error(e.message)}})),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(t=>{t.addEventListener(`click`,()=>{if(W.activeTab=t.dataset.tab,[`planes`,`plantillas`,`rutas`,`asistente`].forEach(t=>{let n=e.querySelector(`#tab-content-${t}`);n&&(n.style.display=W.activeTab===t?`block`:`none`)}),e.querySelectorAll(`#planificacion-tabs .nav-link`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),W.activeTab===`rutas`&&!W.rutasRendered){let t=e.querySelector(`#tab-content-rutas`);t&&(Tu(t,W.viewMode),W.rutasRendered=!0)}if(W.activeTab===`asistente`&&!W.asistenteRendered){let t=e.querySelector(`#tab-content-asistente`);t&&(pu(t),W.asistenteRendered=!0)}})}),document.addEventListener(`planificacion:nuevoPlan`,e=>{Bu(null)},{once:!0}),t&&e.querySelector(`#btn-curriculo-admin`)?.addEventListener(`click`,()=>{hu()}),e.querySelector(`#planes-tbody`)?.addEventListener(`change`,e=>{if(!e.target.classList.contains(`plan-check`))return;let t=e.target.value;e.target.checked?W.seleccionados.add(t):W.seleccionados.delete(t),zu()}),e.querySelector(`#planes-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&Bu(r),n===`delete`&&Wu(r),n===`approve`&&Hu(r),n===`view`&&Vu(r),n===`ejecutar`&&Uu(r)})}function Ru(){let e=W.container.querySelector(`#buscar-plan`)?.value.toLowerCase()||``,t=W.container.querySelector(`#select-estado`)?.value||``,n=W.container.querySelector(`#select-clase`)?.value||``,r=W.container.querySelector(`#select-maestro`)?.value||``;W.planes=G.planificaciones.filter(i=>{let a=(i.tema||``).toLowerCase().includes(e)||(i.clase_nombre||``).toLowerCase().includes(e),o=!t||i.estado===t,s=!n||i.clase_nombre===n,c=!r||i.maestro_nombre===r;return a&&o&&s&&c});let i=W.container.querySelector(`#planes-tbody`),a=W.container.querySelector(`#empty-container`);i&&(i.innerHTML=Nu(W.planes)),a&&(a.innerHTML=W.planes.length===0?Pu():``)}function zu(){let e=W.container?.querySelector(`#btn-aprobar-bulk`);e&&(e.style.display=W.seleccionados.size>0?``:`none`)}async function Bu(e,n={}){let r=e&&G.getById(e)||new Ae(n);b.open({title:e?`Editar Plan de Clase`:`Nuevo Plan de Clase`,saveText:`Guardar Plan`,size:`lg`,body:`
    ...
    `,onOpen:async e=>{let n=await l(),i=e.querySelector(`#plan-clase_id`);i.innerHTML=`<option value="">Seleccionar clase...</option>`+n.map(e=>`<option value="${e.id}" ${e.id===r.clase_id?`selected`:``}>${h(e.nombre)}</option>`).join(``);let a=e.querySelector(`#plan-dsl-container`),o=t({initialContent:r.notas_dsl||``,onChange:(t,n)=>{let r=e.querySelector(`#plan-dsl-summary`);r&&n.items&&n.items.length>0&&(r.innerHTML=`<strong>Elementos:</strong> ${n.items.length} indicadores/actividades parseadas`)},onAlumnoClick:async()=>{let e=(await We()).slice(0,3).map(e=>`#${e.nombre_completo}`).join(`, `);o.component&&o.component.insertText(e+` `)}});a.appendChild(o),e._dslEditor=o},onSave:async t=>{let n=t._dslEditor,r={tema:t.querySelector(`#plan-tema`).value.trim(),clase_id:t.querySelector(`#plan-clase_id`).value,objetivos:t.querySelector(`#plan-objetivos`).value.trim(),contenido:t.querySelector(`#plan-contenido`)?.value.trim()||``,notas_dsl:n?n.getContent():``,fecha_inicio:t.querySelector(`#plan-fecha`).value||null,instrumento:t.querySelector(`#plan-instrumento`).value.trim()||null,evaluacion_metodo:t.querySelector(`#plan-eval`).value.trim()||null},i=new Ae(r).validate();if(i.length>0)return v.error(i[0]),!1;try{return e?(await p(e,r),v.success(`Plan actualizado correctamente`)):(await m(r),v.success(`Plan creado correctamente`)),Ou(W.container,{viewMode:W.viewMode}),!0}catch(e){return v.error(e.message),!1}}})}function Vu(e){let t=G.getById(e);if(!t)return;let n=Ae.getEstadoConfig(t.estado);b.open({title:`Plan: ${t.clase_nombre||`Sin clase`}`,hideSave:!0,size:`lg`,body:`
    ...
    `})}async function Hu(e){try{await o([e]),v.success(`Plan aprobado y marcado como revisado`),Ou(W.container,{viewMode:W.viewMode})}catch(e){v.error(e.message)}}async function Uu(e){let t=G.getById(e);if(!t)return;let n=t.instrumento,r=null,i=t.clase_id;if(i){let e=(await l()).find(e=>e.id===i);e&&(n||=e.instrumento,r=e.plan_estudio)}let a=G.maestroActualId||t.maestro_id;du({plan:t,claseId:i,instrumento:n,nivel:r,maestroId:a,onConfirm:async()=>{try{await p(e,{estado:`ejecutado`}),v.success(`Plan marcado como ejecutado`),Ou(W.container,{viewMode:W.viewMode})}catch(e){v.error(e.message)}},onSkip:async()=>{try{await p(e,{estado:`ejecutado`}),v.success(`Plan ejecutado (sin cobertura)`),Ou(W.container,{viewMode:W.viewMode})}catch(e){v.error(e.message)}}})}async function Wu(e){let t=G.getById(e);t&&b.open({title:`⚠️ Eliminar Plan`,saveText:`Eliminar`,body:`<p>¿Estás seguro de eliminar el plan <strong>"${h(t.tema)}"</strong>? Esta acción no se puede deshacer.</p>`,onSave:async()=>{try{return await te(e),v.success(`Plan eliminado`),Ou(W.container,{viewMode:W.viewMode}),!0}catch(e){return v.error(e.message),!1}}})}async function Gu(e){if(e)try{e.innerHTML=`
      <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
        <div class="spinner-border text-primary" role="status">
          <span class="visually-hidden">Cargando cobertura...</span>
        </div>
      </div>`;let t=await f(),n=t.length,r=t.filter(e=>e.tiene_plan).length,i=n-r,a=n>0?Math.round(r/n*100):0;e.innerHTML=`
    <div class="page-container">
      <div class="planificacion-header-premium mb-4">
        <div class="d-flex align-items-center gap-3">
    ...
    </div>`,e.querySelector(`#btn-refresh-cobertura`).addEventListener(`click`,()=>{Gu(e)}),e.querySelectorAll(`.btn-crear-plan-cobertura`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId;e.dataset.claseNombre,await G.fetchPlanificacionesConDetalles(),Bu(null,{clase_id:t})})}),e.querySelectorAll(`.btn-ver-plan-cobertura`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.planId;await G.fetchPlanificacion(t),Bu(t)})})}catch(t){console.error(`[coberturaView]`,t),e.innerHTML=`
      <div class="page-container">
        <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
          <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
          <div>
      ...
      </div>`}}function Ku(e){let t=e.tiene_plan?qu(e.plan_estado):`<span class="badge bg-secondary">Sin plan</span>`,n=e.tiene_plan?`<button class="btn btn-outline-primary btn-sm btn-ver-plan-cobertura" data-plan-id="${h(e.plan_id)}">
    ...
    </tr>`}function qu(e){let t={planificado:{cls:`bg-primary`,icon:`bi-file-text`},ejecutado:{cls:`bg-warning text-dark`,icon:`bi-play-circle`},revisado:{cls:`bg-success`,icon:`bi-check-circle`}}[e]||{cls:`bg-secondary`,icon:`bi-question`};return`<span class="badge `+t.cls+`"><i class="bi `+t.icon+` me-1"></i>`+e+`</span>`}function Ju(){S.register(`planificacion`,e=>Ou(e,{viewMode:`maestro`})),S.register(`planificacion-plantillas`,e=>Ou(e,{viewMode:`plantillas`})),S.register(`planificacion-maestros`,e=>Ou(e,{viewMode:`admin`})),S.register(`planificacion-cobertura`,e=>Gu(e))}var Yu={attendance_min_rate:.7,attendance_window_weeks:4,grade_min_avg:6,grade_window_count:3,indicator_min_pass_rate:.5,indicator_window_weeks:4};async function Xu(){let{data:e,error:t}=await _.from(`alumnos`).select(`*`).order(`nombre_completo`,{ascending:!0});if(t)throw console.error(`Error cargando alumnos:`,t.message),Error(`No se pudieron cargar los alumnos`);return e}async function Zu(){let{data:e,error:t}=await _.from(`clases`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando clases:`,t.message),Error(`No se pudieron cargar las clases`);return e}async function Qu(){let{data:e,error:t}=await _.from(`progresos`).select(`*`).order(`fecha_evaluacion`,{ascending:!1});if(t)throw console.error(`Error cargando progresos:`,t.message),Error(`No se pudieron cargar los progresos`);return e}async function $u(e){if(!e.alumno_id)throw Error(`El alumno es obligatorio`);if(!e.clase_id)throw Error(`La clase es obligatoria`);if(!e.evaluacion_tipo)throw Error(`El tipo de evaluacion es obligatorio`);let t={alumno_id:e.alumno_id,clase_id:e.clase_id,maestro_id:e.maestro_id||null,fecha_evaluacion:e.fecha_evaluacion||null,evaluacion_tipo:e.evaluacion_tipo.trim(),calificacion:e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,estado_cualitativo:(e.estado_cualitativo||`en_progreso`).trim(),observaciones:(e.observaciones||``).trim(),indicadores:e.indicadores||null};if(e.sesion_clase_id&&(t.sesion_clase_id=e.sesion_clase_id),e.asistencia_id&&(t.asistencia_id=e.asistencia_id),e.ejercicio_id&&(t.ejercicio_id=e.ejercicio_id),t.calificacion!==null&&(t.calificacion<0||t.calificacion>5))throw Error(`La calificacion debe estar entre 0 y 5`);let{data:n,error:r}=await _.from(`progresos`).insert([t]).select();if(r)throw r.message.includes(`duplicate key`)||r.code===`23505`?Error(`Ya existe una evaluacion con ese tipo para este alumno en esta clase`):(console.error(`Error creando progreso:`,r.message),Error(`No se pudo crear el progreso`));return n[0]}async function ed(e){let{data:t,error:n}=await _.from(`progresos`).select(`*`).eq(`alumno_id`,e).order(`fecha_evaluacion`,{ascending:!1});if(n)throw console.error(`Error cargando progresos del alumno:`,n.message),Error(`No se pudieron cargar los progresos del alumno`);return t}async function td(e){let{data:t,error:n}=await _.from(`progresos`).select(`*`).eq(`clase_id`,e).order(`fecha_evaluacion`,{ascending:!1});if(n)throw console.error(`Error cargando progresos de la clase:`,n.message),Error(`No se pudieron cargar los progresos de la clase`);return t}async function nd(e,t){let{jsPDF:n}=await y(async()=>{let{jsPDF:e}=await import(`./jspdf.es.min-B53WQQE_.js`).then(e=>e.n);return{jsPDF:e}},__vite__mapDeps([3,4,5,6])),{default:r}=await y(async()=>{let{default:e}=await import(`./jspdf.plugin.autotable-95nmaIim.js`).then(e=>e.n);return{default:e}},__vite__mapDeps([7,4])),i=new n,a=e.name||e.nombre||`Sin nombre`,o=e.section||`Sin sección`,s=rd(t),c=s!==null&&id(s);i.setFontSize(18),i.text(`Boletín Académico`,14,22),i.setFontSize(11),i.text(`Alumno: ${a}`,14,32),i.text(`Sección: ${o}`,14,38),i.text(`Fecha: ${new Date().toLocaleDateString(`es-ES`)}`,14,44);let l=c?`EN RIESGO`:`SATISFACTORIO`,u=c?[185,27,27]:[39,174,96];i.setFillColor(...u),i.rect(14,50,60,10,`F`),i.setTextColor(255,255,255),i.setFontSize(10),i.text(l,18,57),i.setTextColor(0,0,0),i.setFontSize(12),i.text(`Promedio: ${s===null?`N/A`:s.toFixed(2)}`,80,55),i.text(`Evaluaciones: ${t.length}`,80,62),t.length>0&&r(i,{head:[[`Fecha`,`Tipo`,`Calificación`,`Etiqueta`,`Observaciones`]],body:t.map(e=>[e.fecha_evaluacion?ad(e.fecha_evaluacion):`-`,od(e.tipo_evaluacion),e.calificacion===null?`-`:e.calificacion.toFixed(2),sd(e.calificacion),e.observaciones?e.observaciones.substring(0,40)+(e.observaciones.length>40?`...`:``):`-`]),startY:70,styles:{fontSize:9},headStyles:{fillColor:[41,128,185]}}),i.save(`boletin-${a.replace(/\s+/g,`-`).toLowerCase()}.pdf`)}function rd(e){if(!e||e.length===0)return null;let t=e.filter(e=>e.calificacion!==null&&e.calificacion!==void 0).map(e=>parseFloat(e.calificacion));return t.length===0?null:t.reduce((e,t)=>e+t,0)/t.length}function id(e){return e==null?!1:parseFloat(e)<3}function ad(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):`-`}function od(e){return{oral:`Oral`,escrita:`Escrita`,practica:`Práctica`,evaluacion_parcial:`Parcial`,evaluacion_final:`Final`}[e]||e||`-`}function sd(e){if(e==null)return`-`;let t=parseFloat(e);return t>=4.5?`Sobresaliente`:t>=4?`Muy Bueno`:t>=3?`Bueno`:t>=2?`En Progreso`:`Necesita Mejorar`}var cd=class e{constructor(e={}){this.id=e.id||null,this.alumno_id=e.alumno_id||``,this.clase_id=e.clase_id||``,this.maestro_id=e.maestro_id||null,this.fecha_evaluacion=e.fecha_evaluacion||``,this.tipo_evaluacion=e.tipo_evaluacion||e.evaluacion_tipo||``,this.calificacion=e.calificacion!==void 0&&e.calificacion!==null?parseFloat(e.calificacion):null,this.observaciones=e.observaciones||``,this.estado=e.estado||`en_progreso`,this.created_at=e.created_at||null,this.updated_at=e.updated_at||null}validate(){let t=[];this.alumno_id||t.push(`El alumno es obligatorio`),this.clase_id||t.push(`La clase es obligatoria`),!this.tipo_evaluacion||!this.tipo_evaluacion.trim()?t.push(`El tipo de evaluación es obligatorio`):e.getTiposEvaluacion().map(e=>e.value).includes(this.tipo_evaluacion)||t.push(`Tipo de evaluación no válido`),this.calificacion!==null&&this.calificacion!==void 0&&(isNaN(this.calificacion)||this.calificacion<0||this.calificacion>5)&&t.push(`La calificación debe estar entre 0.0 y 5.0`),this.observaciones&&this.observaciones.length>500&&t.push(`Las observaciones no pueden exceder 500 caracteres`);let n=e.getEstados().map(e=>e.value);return this.estado&&!n.includes(this.estado)&&t.push(`Estado no válido`),t}static getTiposEvaluacion(){return[{value:`parcial`,label:`Parcial`},{value:`final`,label:`Final`},{value:`continua`,label:`Continua`},{value:`oral`,label:`Oral`},{value:`escrita`,label:`Escrita`},{value:`practica`,label:`Práctica`}]}static getEstados(){return[{value:`en_progreso`,label:`En Progreso`,color:`bg-primary`},{value:`completado`,label:`Completado`,color:`bg-success`},{value:`pendiente`,label:`Pendiente`,color:`bg-secondary`}]}static getEstadoConfig(e){return this.getEstados().find(t=>t.value===e)||{value:e,label:e,color:`bg-secondary`}}toJSON(){return{alumno_id:this.alumno_id,clase_id:this.clase_id,maestro_id:this.maestro_id,fecha_evaluacion:this.fecha_evaluacion||null,tipo_evaluacion:this.tipo_evaluacion.trim(),calificacion:this.calificacion,observaciones:this.observaciones?this.observaciones.trim():null,estado:this.estado}}};function ld(e){if(!e||e.length===0)return{promedio:null,total:0,enRiesgo:!1};let t=e.map(e=>e.calificacion).filter(e=>e!=null&&!isNaN(e));if(t.length===0)return{promedio:null,total:e.length,enRiesgo:!1};let n=t.reduce((e,t)=>e+t,0),r=parseFloat((n/t.length).toFixed(2));return{promedio:r,total:e.length,enRiesgo:r<3}}async function ud(e){let t=await td(e),n={};return t.forEach(e=>{n[e.alumno_id]||(n[e.alumno_id]=[]),n[e.alumno_id].push(e)}),Object.entries(n).map(([e,t])=>({alumnoId:e,progresos:t,rendimiento:ld(t)}))}var dd={calcularRendimiento:ld,getResumenProgresosClase:ud},K={progresos:[],progresosOriginales:[],alumnos:[],clases:[],cargando:!1,filtroClase:`todas`,container:null};async function fd(e){if(e)try{K.container=e,K.cargando=!0,pd(e);let[t,n,r]=await Promise.all([Qu(),Xu(),Zu()]);K.progresos=(t||[]).map(e=>new cd(e)),K.progresosOriginales=[...K.progresos],K.alumnos=n||[],K.clases=r||[],K.cargando=!1,hd(e),_d(e)}catch(t){console.error(t),md(e,t.message)}}function pd(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function md(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
  ...
  `}function gd(){let e=K.container.querySelector(`#buscar-progreso`)?.value.trim().toLowerCase()||``,t=K.filtroClase,n={};K.progresosOriginales.forEach(r=>{let i=K.alumnos.find(e=>e.id===r.alumno_id),a=K.clases.find(e=>e.id===r.clase_id);t!==`todas`&&r.clase_id!==t||e&&!i?.nombre_completo.toLowerCase().includes(e)&&!a?.nombre.toLowerCase().includes(e)||(n[r.alumno_id]||(n[r.alumno_id]={alumno:i,lista:[]}),n[r.alumno_id].lista.push(r))});let r=Object.values(n);return r.length===0?`<tr><td colspan="5" class="text-center py-5 text-muted">No hay resultados.</td></tr>`:r.map(({alumno:e,lista:t})=>{let n=dd.calcularRendimiento(t);return`
    ...
    `}).join(``)}function _d(e){e.querySelector(`#select-clase`)?.addEventListener(`change`,t=>{K.filtroClase=t.target.value,e.querySelector(`#progresos-tbody`).innerHTML=gd()}),e.querySelector(`#buscar-progreso`)?.addEventListener(`input`,()=>{e.querySelector(`#progresos-tbody`).innerHTML=gd()}),e.querySelector(`#progresos-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,alumnoId:r}=t.dataset;n===`pdf`&&vd(r),n===`view-detail`&&yd(r)}),e.querySelector(`#btn-nueva-nota`)?.addEventListener(`click`,()=>bd())}async function vd(e){let t=K.alumnos.find(t=>t.id===e),n=K.progresosOriginales.filter(t=>t.alumno_id===e);v.info(`Generando boletín institucional...`);try{await nd(t,n),v.success(`Boletín generado exitosamente`)}catch(e){v.error(`Error al generar PDF: `+e.message)}}function yd(e){let t=K.alumnos.find(t=>t.id===e),n=K.progresosOriginales.filter(t=>t.alumno_id===e),r=dd.calcularRendimiento(n);b.open({title:`Detalle Académico: ${t.nombre_completo}`,size:`lg`,hideSave:!0,body:`
      <div class="row g-3 mb-4">
        <div class="col-md-4">
    ...
    `})}function bd(){b.open({title:`Registrar Nueva Calificación`,saveText:`Guardar Nota`,body:`
      <form id="form-nota" class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select class="form-select input-dense" id="nota-tipo" required>
            ${cd.getTiposEvaluacion().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-4">
    ...
    `,onSave:async e=>{let t={alumno_id:e.querySelector(`#nota-alumno_id`).value,clase_id:e.querySelector(`#nota-clase_id`).value,tipo_evaluacion:e.querySelector(`#nota-tipo`).value,calificacion:parseFloat(e.querySelector(`#nota-valor`).value),fecha_evaluacion:e.querySelector(`#nota-fecha`).value,observaciones:e.querySelector(`#nota-obs`).value.trim()},n=new cd(t).validate();if(n.length>0)return v.error(n[0]),!1;try{return await $u(t),v.success(`Nota registrada exitosamente`),fd(K.container),!0}catch(e){return v.error(e.message),!1}}})}function xd(){S.register(`progresos`,fd)}function Sd(e){return e?Array.isArray(e)?e.map(e=>new g(e)):new g(e):null}async function Cd(){let{data:e,error:t}=await _.from(`observaciones_alumnos`).select(`
      *,
      alumno:alumnos(nombre_completo),
      maestro:maestros(nombre_completo)
    `).order(`fecha_observacion`,{ascending:!1});if(t)throw console.error(`Error cargando observaciones:`,t.message),Error(`No se pudieron cargar las observaciones`);return e.map(e=>{let t=new g(e);return t.alumno_nombre=e.alumno?.nombre_completo||`Desconocido`,t.maestro_nombre=e.maestro?.nombre_completo||`N/A`,t})}async function wd(e){let t=new g(e),n=t.validate();if(n.length>0)throw Error(n[0]);let{data:r,error:i}=await _.from(`observaciones_alumnos`).insert([t.toJSON()]).select();if(i)throw i;return Sd(r[0])}async function Td(e,t){let{data:n}=await _.from(`observaciones_alumnos`).select(`*`).eq(`id`,e).single(),r=new g({...n,...t}),i=r.validate();if(i.length>0)throw Error(i[0]);let{data:a,error:o}=await _.from(`observaciones_alumnos`).update(r.toJSON()).eq(`id`,e).select();if(o)throw o;return Sd(a[0])}async function Ed(e){let{error:t}=await _.from(`observaciones_alumnos`).delete().eq(`id`,e);if(t)throw t}async function Dd(e,t){let{data:n,error:r}=await _.from(`observaciones_alumnos`).update({seguimiento_observacion:t.trim(),seguimiento_fecha:new Date().toISOString().split(`T`)[0],estado:`seguimiento`,requiere_seguimiento:!0}).eq(`id`,e).select();if(r)throw r;return Sd(n[0])}async function Od(){let{data:e,error:t}=await _.from(`observaciones_alumnos`).select(`estado, prioridad, tipo`);if(t)throw t;return{total:e.length,abiertas:e.filter(e=>e.estado===`abierta`).length,seguimiento:e.filter(e=>e.estado===`seguimiento`).length,altas:e.filter(e=>e.prioridad===`alta`).length,porTipo:e.reduce((e,t)=>(e[t.tipo]=(e[t.tipo]||0)+1,e),{})}}function kd(e){return e?e.replace(/[&<>]/g,function(e){return e===`&`?`&amp;`:e===`<`?`&lt;`:e===`>`?`&gt;`:e}):``}var q={observaciones:[],observacionesOriginales:[],alumnos:[],estadisticas:null,cargando:!1,filtroTipo:``,filtroEstado:`todos`,container:null};async function Ad(e){if(e)try{q.container=e,q.cargando=!0,jd(e);let[t,n,r]=await Promise.all([Cd(),Ze().catch(()=>[]),Od().catch(()=>null)]);q.observaciones=t,q.observacionesOriginales=[...t],q.alumnos=n,q.estadisticas=r,q.cargando=!1,Nd(e),Id(e)}catch(t){console.error(t),Md(e,t.message)}}function jd(e){e.innerHTML=`<div class="d-flex justify-content-center align-items-center" style="min-height: 400px;"><div class="spinner-border text-primary" role="status"></div></div>`}function Md(e,t){e.innerHTML=`
    <div class="page-container">
      <div class="alert alert-warning d-flex align-items-start gap-3 m-0" role="alert">
        <i class="bi bi-database-exclamation fs-3 text-warning mt-1"></i>
        <div>
          <h5 class="alert-heading mb-1">Tabla no encontrada o sin acceso</h5>
          <p class="mb-2 small">${kd(t)}</p>
    ...
    </div>`,e.querySelector(`#retry-btn`)?.addEventListener(`click`,()=>Ad(e))}function Nd(e){e.innerHTML=`
    <div class="page-container">
      ...
      <div class="page-glass rounded">
        ...
        <div id="empty-container">${q.observaciones.length===0?Fd():``}</div>
      </div>
    </div>
  `}function Pd(e){return e.map(e=>{let t=g.getTipos().find(t=>t.value===e.tipo),n=g.getPrioridades().find(t=>t.value===e.prioridad),r=g.getEstados().find(t=>t.value===e.estado),i=e.prioridad===`alta`?`border-accent-danger`:e.prioridad===`media`?`border-accent-warning`:`border-accent-secondary`;return`
      <tr data-id="${e.id}" class="border-start-accent ${i}">
        <td>
          <div class="fw-bold text-truncate" style="max-width: 250px;">${kd(e.titulo)}</div>
          <div class="small text-muted">${kd(e.alumno_nombre)}</div>
        </td>
        <td class="d-none d-md-table-cell align-middle">
          <div class="d-flex align-items-center gap-2">
    ...
    `}).join(``)}function Fd(){return`<div class="text-center py-5 text-muted"><i class="bi bi-chat-left-dots fs-1 d-block mb-2"></i>No se encontraron observaciones.</div>`}function Id(e){e.querySelector(`#buscar-obs`)?.addEventListener(`input`,Ld),e.querySelector(`#select-tipo`)?.addEventListener(`change`,Ld),e.querySelector(`#obs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-action]`);if(!t)return;let{action:n,id:r}=t.dataset;n===`edit`&&Rd(r),n===`delete`&&Bd(r),n===`follow`&&zd(r)}),e.querySelector(`#btn-nueva-obs`)?.addEventListener(`click`,()=>Rd(null))}function Ld(){let e=q.container.querySelector(`#buscar-obs`).value.toLowerCase(),t=q.container.querySelector(`#select-tipo`).value;q.observaciones=q.observacionesOriginales.filter(n=>{let r=n.titulo.toLowerCase().includes(e)||n.alumno_nombre.toLowerCase().includes(e),i=!t||n.tipo===t;return r&&i}),q.container.querySelector(`#obs-tbody`).innerHTML=Pd(q.observaciones)}async function Rd(e){let t=e?q.observacionesOriginales.find(t=>t.id===e):new g;b.open({title:e?`Editar Observación`:`Nueva Observación`,saveText:`Guardar`,body:`
      <form id="form-obs" class="row g-3">
        <div class="col-12">
          <label class="form-label-compact">Alumno *</label>
          <select class="form-select input-dense" id="obs-alumno_id" required>
            <option value="">Seleccionar alumno...</option>
            ${q.alumnos.map(e=>`<option value="${e.id}" ${e.id===t.alumno_id?`selected`:``}>${kd(e.nombre_completo)}</option>`).join(``)}
          </select>
        </div>
        <div class="col-md-8">
          <label class="form-label-compact">Título de la Incidencia *</label>
          <input type="text" class="form-control input-dense" id="obs-titulo" value="${kd(t.titulo)}" required>
        </div>
        <div class="col-md-4">
  ...
  `}function ep(e){let t=null,n=`ALL`,r=null,i=null;async function a(){t&&(t.innerHTML=`
      <div class="row g-3">
    ...
    `,o(),await s(),c())}function o(){let e=t.querySelector(`#live-net-status`);e&&(e.innerHTML=navigator.onLine?`<span class="badge bg-success rounded-pill px-2.5 py-1 d-inline-flex align-items-center gap-1 shadow-sm small"><span class="spinner-grow spinner-grow-sm text-white obs-net-spinner obs-spinner-slow"></span> ONLINE</span>`:`<span class="badge bg-warning text-dark rounded-pill px-2.5 py-1 d-inline-flex align-items-center gap-1 shadow-sm small obs-pulse-offline"><span class="spinner-grow spinner-grow-sm text-dark obs-net-spinner"></span> OFFLINE</span>`)}async function s(){let e=t.querySelector(`#logs-body`);if(!e)return;let r=await Yf(),i=n===`ALL`?r:r.filter(e=>e.level===n);if(i.length===0){e.innerHTML=`<div class="text-center text-muted py-5">[Consola vacía. No hay logs registrados con severidad "${n}"]</div>`;return}e.innerHTML=i.map(e=>{let t=`obs-log-level-info`;e.level===`WARNING`&&(t=`obs-log-level-warning`),e.level===`ERROR`&&(t=`obs-log-level-error`);let n=`
      ...
      `;return e.stack&&(n+=`<pre class="obs-log-stack">${h(e.stack)}</pre>`),n+=`</div>`,n}).join(``)}function c(){t.querySelectorAll(`[data-log-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{t.querySelectorAll(`[data-log-filter]`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),n=e.dataset.logFilter,s()})}),t.querySelector(`#btn-clear-logs`)?.addEventListener(`click`,()=>{localStorage.setItem(`soi_system_logs`,JSON.stringify([])),v.show(`Consola de logs de sistema limpiada con éxito`,`success`),s()}),t.querySelector(`#btn-mock-rls`)?.addEventListener(`click`,async()=>{await Zf({level:`ERROR`,module:`SupabaseClient`,message:`Security policy violation for select on public.ausencias_auditoria table (RLS error).`,stack:`Error: Row Level Security block
  at executeSelect (supabaseClient.js:84:18)
  at getAuditLogs (observabilidadSupabase.js:46:12)`}),v.show(`Log de error de RLS inyectado`,`danger`),s()}),t.querySelector(`#btn-mock-timeout`)?.addEventListener(`click`,async()=>{await Zf({level:`WARNING`,module:`HTTPClient`,message:`Request timed out for endpoint /rpc/get_institutional_radar. Falling back to offline fallback state.`,stack:`TimeoutException: Request took longer than 5000ms`}),v.show(`Log de timeout de red inyectado`,`warning`),s()}),t.querySelector(`#btn-mock-vitals`)?.addEventListener(`click`,async()=>{await Zf({level:`INFO`,module:`PWA`,message:`Core Web Vitals: FID: 11ms (Excelente), LCP: 980ms (Excelente), CLS: 0.012 (Excelente).`}),v.show(`Log de Core Web Vitals inyectado`,`success`),s()})}return{async init(){if(t=document.getElementById(e),!t){console.error(`[systemLogsWidget] Contenedor #${e} no encontrado en el DOM`);return}await a(),r=()=>{o(),v.show(`Conectividad restablecida. Sistema Online.`,`success`)},i=()=>{o(),v.show(`Conexión perdida. Trabajando en modo Offline.`,`warning`)},window.addEventListener(`online`,r),window.addEventListener(`offline`,i)},destroy(){r&&window.removeEventListener(`online`,r),i&&window.removeEventListener(`offline`,i)}}}function tp(e){let t=null,n=``,r=`ALL`;async function i(){t&&(t.innerHTML=`
  ...
  `,sp()}function sp(){let e=J.container.querySelector(`#offline-network-badge-container`);e&&(e.innerHTML=navigator.onLine?`<span class="badge bg-success rounded-pill px-3 py-2 d-inline-flex align-items-center gap-1 shadow-sm"><span class="spinner-grow spinner-grow-sm text-white obs-spinner-slow" role="status"></span><i class="bi bi-cloud-check me-1"></i> Online</span>`:`<span class="badge bg-warning text-dark rounded-pill px-3 py-2 d-inline-flex align-items-center gap-1 shadow-sm"><span class="spinner-grow spinner-grow-sm text-dark animate-pulse" role="status"></span><i class="bi bi-cloud-slash me-1"></i> Offline - Logs encolados</span>`)}function cp(){switch(J.activeTab){case`resumen`:return lp();case`operaciones`:return up();case`logs`:return dp();case`auditoria`:return fp();case`ia`:return pp();default:return lp()}}function lp(){let e=J.stats||{},t=J.resumenAlertas||{total:0,rojas:0};return`
    <div class="row g-3">
      <div class="col-md-6 col-lg-3">
        ${$f({label:`Alumnos Activos`,value:e.total_alumnos||0,icon:`bi-people`,color:`primary`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${$f({label:`Promedio Global`,value:(e.promedio_general||0).toFixed(2),icon:`bi-star`,color:`success`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${$f({label:`Alertas Rojas`,value:t.rojas,icon:`bi-exclamation-octagon`,color:`danger`})}
      </div>
      <div class="col-md-6 col-lg-3">
        ${$f({label:`Asistencia Hoy`,value:(e.asistencia_hoy_porcentaje||0)+`%`,icon:`bi-check2-circle`,color:`info`})}
      </div>
  ...
  `}function mp(e){e.querySelectorAll(`[data-tab]`).forEach(t=>{t.addEventListener(`click`,()=>{np(),J.activeTab=t.dataset.tab,localStorage.setItem(`pm_metrics_tab`,J.activeTab),op(e),mp(e),hp()})}),e.querySelector(`#btn-guia-analisis`)?.addEventListener(`click`,()=>{vp()}),J._onlineListener=sp,J._offlineListener=sp,window.addEventListener(`online`,J._onlineListener),window.addEventListener(`offline`,J._offlineListener),hp()}async function hp(){if(J.activeTab===`resumen`){let e=await jf(),t=J.container.querySelector(`#destacados-placeholder`);t&&(t.className=``,t.innerHTML=`
        <table class="table table-compact table-hover mb-0">
          <tbody class="small">
            ${e.slice(0,5).map(e=>`
              <tr>
      ...
      `,J.container.querySelector(`#btn-copy-report`)?.addEventListener(`click`,()=>{navigator.clipboard.writeText(n),v.show(`Reporte copiado al portapapeles`,`success`)})}catch(t){console.error(`Error en análisis IA:`,t),e.innerHTML=`<div class="alert alert-danger small"><i class="bi bi-exclamation-triangle me-1"></i> Error al compilar análisis: ${h(t.message)}</div>`}}})}function _p(e){let t=[];if(e.radarData&&e.radarData.length>0){let n=(e.radarData.reduce((e,t)=>e+(t.value||0),0)/e.radarData.length).toFixed(1);t.push(`Indicadores promedio: ${n}%.`)}if(e.nodeDifficulty&&e.nodeDifficulty.length>0){let n=e.nodeDifficulty.filter(e=>e.difficulty>.7).length;n>0&&t.push(`Se detectaron ${n} nodos de alto riesgo que requieren intervención.`)}return e.complianceData&&t.push(`Estado de cumplimiento docente compilado en el período actual.`),t.length>0?t.join(` `):`Análisis completado. Consulta el Generador de Reportes para análisis más detallados.`}function vp(){b.open({title:`Guía de Análisis Académico y Observabilidad`,body:`
          ...
          <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                  <input type="date" class="form-control form-control-sm" id="genDesde" value="${Pp()}">
                  <input type="date" class="form-control form-control-sm" id="genHasta" value="${Np()}">
                </div>
              </div>
              <div class="mb-3">
  ...
  `}function Cp(e){let t={diaria:`danger`,semanal:`warning`,mensual:`info`}[e.frecuencia]||`secondary`;return`
...
`).filter(e=>e.trim()!==``),c=65;s.forEach(e=>{let t=a.splitTextToSize(e.trim(),o-28);c+t.length*5>280&&(a.addPage(),c=20),a.text(t,14,c),c+=t.length*5+2}),n&&n.length>0&&i(a,{startY:c+10,head:[[`Indicador / Estudiante`,`Valor`,`Unidad`]],body:n.map(e=>[e.nombre,e.valor,e.unidad]),theme:`striped`,headStyles:{fillColor:[41,128,185]},styles:{fontSize:9}});let l=a.internal.getNumberOfPages();for(let e=1;e<=l;e++)a.setPage(e),a.setFontSize(8),a.setTextColor(150),a.text(`Página ${e} de ${l} - Generado por SOI Intelligence`,o/2,290,{align:`center`});a.save(`Reporte_SOI_${e.replace(/\s+/g,`_`)}.pdf`),v.success(`PDF descargado con éxito`)}function jp(e,t){let n=Y.reportes.find(t=>t.id===e);n&&b.open({title:`Editar Reporte`,size:`md`,saveText:`Guardar`,body:`
    ...
    `,onSave:()=>{let n=Y.reportes.findIndex(t=>t.id===e);n!==-1&&(Y.reportes[n]={...Y.reportes[n],nombre:document.getElementById(`editReporteNombre`).value,descripcion:document.getElementById(`editReporteDesc`).value,tipo:document.getElementById(`editReporteTipo`).value,frecuencia:document.getElementById(`editReporteFreq`).value}),Sp(t),b.close()}})}function Mp(e){let t=e.querySelector(`#generarAhoraSelect`).value;e.querySelector(`#genDesde`).value,e.querySelector(`#genHasta`).value;let n=e.querySelector(`input[name="genFormat"]:checked`).value;if(!t){alert(`Selecciona un reporte`);return}b.showLoading(`Generando reporte...`),setTimeout(()=>{b.close();let e=new Blob([`Reporte generado`],{type:`text/plain`}),r=URL.createObjectURL(e),i=document.createElement(`a`);i.href=r,i.download=`reporte-${t}-${new Date().toISOString().slice(0,10)}.${n}`,i.click(),URL.revokeObjectURL(r)},1500)}function Np(){return new Date().toISOString().slice(0,10)}function Pp(){let e=new Date;return e.setDate(e.getDate()-7),e.toISOString().slice(0,10)}function Fp(){S.register(`metricas`,rp),S.register(`metricas-alertas`,rp),S.register(`metricas-riesgo`,rp),S.register(`metricas-maestros`,rp),S.register(`metricas-destacados`,rp),S.register(`metricas-ia-reportes`,bp)}new class{constructor(){this.cache=new Map,this.cacheExpiry=300*1e3}getCached(e){let t=this.cache.get(e);return t&&Date.now()-t.timestamp<this.cacheExpiry?t.data:null}setCached(e,t){this.cache.set(e,{data:t,timestamp:Date.now()})}async getDashboardData(){let e=this.getCached(`dashboard`);if(e)return e;let t={periodoActivo:await Df(),alertas:await Af(),alertasActivas:await kf()};return this.setCached(`dashboard`,t),t}async getTasaAsistenciaAlumno(e,t=30){let n=new Date;return n.setDate(n.getDate()-t),Of(e,n.toISOString().split(`T`)[0])}calcularPorcentaje(e,t){return e<t.rojo?`rojo`:e<t.naranja?`naranja`:e<t.amarillo?`amarillo`:`verde`}generarAlertas(e,t){let n=[];return e<t.umbral_rojo?n.push({nivel:`rojo`,mensaje:`Asistencia crítica`}):e<t.umbral_naranja?n.push({nivel:`naranja`,mensaje:`Asistencia baja`}):e<t.umbral_amarillo&&n.push({nivel:`amarillo`,mensaje:`Precaución`}),n}clearCache(){this.cache.clear()}};function Ip(){S.register(`configuracion`,async e=>{let{renderConfigView:t}=await y(async()=>{let{renderConfigView:e}=await import(`./configView-ZysdBRdo.js`);return{renderConfigView:e}},__vite__mapDeps([10,11,4,1,12]));await t(e)}),S.register(`importar-datos`,async e=>{let{renderImportView:t}=await y(async()=>{let{renderImportView:e}=await import(`./importView-CiLpJE3y.js`);return{renderImportView:e}},__vite__mapDeps([13,1]));await t(e)}),S.register(`exportar-datos`,async e=>{let{renderExportView:t}=await y(async()=>{let{renderExportView:e}=await import(`./exportView-BTpj8t19.js`);return{renderExportView:e}},__vite__mapDeps([14,3,4,5,6,1,7,15,8]));await t(e)})}var Lp=class{constructor(e,t={}){this.container=e,this.data=t.data||[],this.onSelect=t.onSelect||(()=>{}),this.expandedNodes=new Set,this.selectedNodeId=null,this.icons={block:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>`,level:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 17h20M2 12h20M2 7h20"></path></svg>`,node:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="3"></circle></svg>`,indicator:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>`,expander:`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>`},this._injectStyles(),this.render(),this._bindEvents()}setData(e){this.data=e,this.render()}render(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function Rp(){let{data:e,error:t}=await _.from(`routes`).select(`*`).order(`name`);if(t)throw console.error(`Error fetching routes:`,t.message),Error(`No se pudieron cargar las rutas`);return e}async function zp(e){let{data:t,error:n}=await _.from(`route_versions`).select(`*`).eq(`route_id`,e).order(`version_number`,{ascending:!1});if(n)throw console.error(`Error fetching route versions:`,n.message),Error(`No se pudieron cargar las versiones de la ruta`);return t}async function Bp(e){if(!e)return[];try{let{data:t,error:n}=await _.from(`blocks`).select(`*`).eq(`route_version_id`,e).order(`order_index`);if(n)throw n;if(!t.length)return[];let r=t.map(e=>e.id),{data:i,error:a}=await _.from(`levels`).select(`*`).in(`block_id`,r).order(`order_index`);if(a)throw a;let o=i.map(e=>e.id),{data:s,error:c}=await _.from(`nodes`).select(`*`).in(`level_id`,o).order(`order_index`).limit(5e3);if(c)throw c;let l=s.map(e=>e.id),{data:u,error:d}=await _.from(`indicators`).select(`*`).in(`node_id`,l).order(`order_index`).limit(1e4);if(d)throw d;return t.map(e=>({...e,type:`block`,children:i.filter(t=>t.block_id===e.id).map(e=>({...e,type:`level`,children:s.filter(t=>t.level_id===e.id).map(e=>({...e,type:`node`,children:u.filter(t=>t.node_id===e.id).map(e=>({...e,type:`indicator`}))}))}))}))}catch(e){throw console.error(`Error building academic tree:`,e.message),Error(`Error al construir el árbol académico`)}}async function Vp(e){let{data:t,error:n}=await _.from(`node_resources`).select(`*`).eq(`node_id`,e).order(`order_index`);if(n)throw n;return t}async function Hp(e){let{id:t,...n}=e;if(t){let{data:e,error:r}=await _.from(`node_resources`).update(n).eq(`id`,t).select().single();if(r)throw r;return e}else{let{data:e,error:t}=await _.from(`node_resources`).insert([n]).select().single();if(t)throw t;return e}}async function Up(e){let{error:t}=await _.from(`node_resources`).delete().eq(`id`,e);if(t)throw t;return!0}async function Wp(e,t){let{data:n,error:r}=await _.from(`nodes`).update(t).eq(`id`,e).select().single();if(r)throw r;return n}var Gp=class{constructor(e,t={}){this.container=e,this.node=null,this.resources=[],this.onUpdate=t.onUpdate||(()=>{}),this._injectStyles(),this.renderEmpty()}async setNode(e){if(!e){this.node=null,this.resources=[],this.renderEmpty();return}this.node=e,this.renderLoading();try{this.resources=await Vp(e.id),this.render()}catch(e){console.error(`Error loading resources:`,e),this.renderError(`No se pudieron cargar los recursos del nodo.`)}}renderEmpty(){this.container.innerHTML=`
    ...
    `,document.head.appendChild(e)}};async function Kp(e){qp(),e.innerHTML=`
  ...
  `;let t=e.querySelector(`#tree-container`),n=e.querySelector(`#detail-container`),r=e.querySelector(`#route-selector`),i=e.querySelector(`#version-selector`),a=new Gp(n,{onUpdate:e=>{}}),o=new Lp(t,{onSelect:e=>{a.setNode(e)}});try{(await Rp()).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,r.appendChild(t)})}catch(e){console.error(`Error loading routes:`,e)}r.addEventListener(`change`,async()=>{let e=r.value;if(i.innerHTML=`<option value="">Versión...</option>`,i.disabled=!0,t.innerHTML=`<div class="tree-placeholder"><p>Cargando versiones...</p></div>`,!e){t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una ruta para comenzar.</p></div>`;return}try{(await zp(e)).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=`V${e.version_number} - ${new Date(e.created_at).toLocaleDateString()}`,i.appendChild(t)}),i.disabled=!1,t.innerHTML=`<div class="tree-placeholder"><p>Selecciona una versión.</p></div>`}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar versiones.</p></div>`}}),i.addEventListener(`change`,async()=>{let e=i.value;if(e){t.innerHTML=`
      <div class="tree-loading">
        <div class="spinner-border spinner-border-sm text-primary"></div>
        <span>Construyendo mapa curricular...</span>
      </div>
    `;try{let t=await Bp(e);o.setData(t)}catch{t.innerHTML=`<div class="tree-placeholder text-danger"><p>Error al cargar el árbol curricular.</p></div>`}}})}function qp(){if(document.getElementById(`academic-admin-layout-styles`))return;let e=document.createElement(`style`);e.id=`academic-admin-layout-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Jp(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function Yp(e){let t=e.progress_percentage||0,n=t<40?`progress-low`:t<80?`progress-mid`:`progress-high`,r=e.health_status||`not_started`,i=e.last_activity_at?new Date(e.last_activity_at).toLocaleDateString():`Sin actividad`;return`
        <tr>
            <td>
                <div class="d-flex align-items-center gap-2">
    ...
    `}function Xp(e=[]){return!e||e.length===0?`
            <div class="pm-empty">
    ...
    `}function Zp(e){let t=e.failure_percentage||0;return`
    ...
    `}function $p(){S.register(`gestion-curricular`,e=>{Kp(e)}),S.register(`planificacion-curricular`,e=>{Kp(e)}),S.register(`torre-de-control`,async e=>{e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{e.innerHTML=await Qp()}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar el dashboard: ${t.message}</p></div>`}})}async function em(){try{let{data:e,error:t}=await _.from(`maestro_desempeño`).select(`
        id,
        maestro_id,
        ...
        updated_at
        `).order(`updated_at`,{ascending:!1});if(t)throw console.error(`[getMaestrosComplianceStatus] Error:`,t),t;return e||[]}catch(e){throw console.error(`[getMaestrosComplianceStatus] Exception:`,e),e}}async function tm(e){try{let{data:t,error:n}=await _.from(`registros_pendientes`).select(`
        id,
        created_at,
        notification_state,
        notif_count,
        ...
        `).eq(`maestro_id`,e).eq(`estado`,`pendiente`).in(`tipo`,[`asistencia_pendiente`,`contenido_pendiente`]).order(`created_at`,{ascending:!1});if(n)throw console.error(`[getMaestroPendingRegistros] Error:`,n),n;return t||[]}catch(e){throw console.error(`[getMaestroPendingRegistros] Exception:`,e),e}}var nm=e({CumplimientoMaestrosWidget:()=>rm,default:()=>rm}),rm=class{constructor(e){this.containerId=e,this.container=document.getElementById(e),this.maestros=[],this.filteredMaestros=[],this.currentFilter={categoria:null,estado:null,diasAtrasoMin:0,diasAtrasoMax:999}}async init(){try{this.container.innerHTML=`
...
`,Object.entries(t.byTrend).forEach(([t,n])=>{e+=`${t},${n}\n`}),e}return t}catch(e){throw console.error(`[exportComplianceReport] Error:`,e),e}}async function um(e=30){try{let t=new Date(Date.now()-e*24*60*60*1e3).toISOString().split(`T`)[0],n=(await im()).filter(e=>e.fecha>=t),r=am(n),i=om(n);return{daysBack:e,total_classes:n.length,total_maestros:Object.keys(i).length,date_trends:r,maestro_trends:i,institution_summary:{avg_ai_usage_institution:n.length>0?(n.reduce((e,t)=>e+(t.uso_ai_fill_percent||0),0)/n.length).toFixed(1):0,asistencia_first_percent:n.length>0?(n.filter(e=>e.orden_asistencia_primero===1).length/n.length*100).toFixed(1):0,observaciones_first_percent:n.length>0?(n.filter(e=>e.orden_observaciones_primero===1).length/n.length*100).toFixed(1):0},generatedAt:new Date().toISOString()}}catch(e){throw console.error(`[getInstitutionTrendReportWithFilling] Error:`,e),e}}var dm=class{constructor(e){this.containerId=e,this.container=document.getElementById(e),this.summary=null,this.critical=null}async init(){try{this.container.innerHTML=`
        <div class="premium-loading">
          <div class="premium-loading-spinner"></div>
      ...
      `}}async loadData(){this.summary=await sm(),this.critical=await cm()}render(){let e=`
    ...
    `}function r(e){let t=e.length,n=e.filter(e=>e.orden_asistencia_primero===1).length,r=e.filter(e=>e.orden_observaciones_primero===1).length,i=e.filter(e=>e.orden_simultaneo===1).length,a=e.length>0?(e.reduce((e,t)=>e+(t.uso_ai_fill_percent||0),0)/e.length).toFixed(1):0;return{asistenciaPrimero:t>0?(n/t*100).toFixed(1):0,observacionesPrimero:t>0?(r/t*100).toFixed(1):0,simultaneo:t>0?(i/t*100).toFixed(1):0,avgAiUsage:a,total:t}}return{async init(){t.innerHTML=`
      ...
      `;try{let e=await im();if(!e||e.length===0){t.innerHTML=`
      ...
      `},destroy(){t&&(t.innerHTML=``)}}}function mm(e){let t=document.getElementById(e),n=null;function r(e){return`
    ...
    `}return{async init(){t.innerHTML=`
      ...
      `;try{n=await um(30),this.render()}catch(e){console.error(`[directorTrendReportView] Error:`,e),t.innerHTML=`
          <div class="premium-error-card">
            <i class="bi bi-exclamation-triangle-fill"></i>
      ...
      `}}}function hm(){S.register(`admin-dashboard`,e=>{try{e.innerHTML=`<div id="admin-dashboard-container"></div>`,new rm(`admin-dashboard-container`).init()}catch(t){console.error(`[admin-dashboard] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar cumplimiento: ${t.message}</p></div>`}}),S.register(`admin-dashboard-reportes`,e=>{try{e.innerHTML=`<div id="director-reporting-container"></div>`,new dm(`director-reporting-container`).init()}catch(t){console.error(`[admin-dashboard-reportes] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar reportes: ${t.message}</p></div>`}}),S.register(`admin-dashboard-analitca-llenado`,e=>{try{e.innerHTML=`<div id="analytics-filling-container"></div>`,pm(`analytics-filling-container`).init()}catch(t){console.error(`[admin-dashboard-analitca-llenado] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar analítica: ${t.message}</p></div>`}}),S.register(`admin-dashboard-tendencias`,e=>{try{e.innerHTML=`<div id="trend-report-container"></div>`,mm(`trend-report-container`).init()}catch(t){console.error(`[admin-dashboard-tendencias] Error:`,t),e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error al cargar tendencias: ${t.message}</p></div>`}})}var gm=[{id:`perm-001`,maestro_id:`maestro_001`,maestro_nombre:`Carlos Méndez`,maestro_email:`carlos.mendez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`planificacion:write`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-15T10:00:00Z`,actualizado_en:`2026-05-01T14:30:00Z`},{id:`perm-002`,maestro_id:`maestro_002`,maestro_nombre:`María López`,maestro_email:`maria.lopez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!1,permisos:[`alumnos:create`,`planificacion:write`],solicitudes:[`clases:enroll`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-02-20T09:00:00Z`,actualizado_en:`2026-04-10T11:00:00Z`},{id:`perm-003`,maestro_id:`maestro_003`,maestro_nombre:`Ana Martínez`,maestro_email:`ana.martinez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[`alumnos:create`],concedido_por:null,concedido_por_nombre:null,creado_en:`2026-03-01T08:00:00Z`,actualizado_en:`2026-03-01T08:00:00Z`},{id:`perm-004`,maestro_id:`maestro_004`,maestro_nombre:`Pedro Ramírez`,maestro_email:`pedro.ramirez@ejemplo.com`,puede_registrar_alumnos:!0,puede_inscribir_clases:!0,permisos:[`alumnos:create`,`clases:enroll`,`asistencias:write`],solicitudes:[],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-01-20T15:00:00Z`,actualizado_en:`2026-05-05T09:00:00Z`},{id:`perm-005`,maestro_id:`maestro_005`,maestro_nombre:`Laura Fernández`,maestro_email:`laura.fernandez@ejemplo.com`,puede_registrar_alumnos:!1,puede_inscribir_clases:!0,permisos:[`clases:enroll`],solicitudes:[`alumnos:create`],concedido_por:`admin_001`,concedido_por_nombre:`Admin Sistema`,creado_en:`2026-04-01T12:00:00Z`,actualizado_en:`2026-04-15T16:00:00Z`}],_m=e({actualizarPermiso:()=>Cm,obtenerPermisoPorMaestro:()=>Sm,obtenerPermisos:()=>xm}),vm=(e=300)=>new Promise(t=>setTimeout(t,e)),ym=[...gm];function bm(e){return e?{id:e.id,maestro_id:e.maestro_id??``,maestro_nombre:e.maestro_nombre??``,maestro_email:e.maestro_email??``,puede_registrar_alumnos:e.puede_registrar_alumnos??!1,puede_inscribir_clases:e.puede_inscribir_clases??!1,permisos:Array.isArray(e.permisos)?e.permisos:[],solicitudes:Array.isArray(e.solicitudes)?e.solicitudes:[],concedido_por:e.concedido_por??null,concedido_por_nombre:e.concedido_por_nombre??null,creado_en:e.creado_en||null,actualizado_en:e.actualizado_en||null}:null}async function xm(){return await vm(),ym.map(bm)}async function Sm(e){await vm();let t=ym.find(t=>t.maestro_id===e);return t?bm(t):{id:null,maestro_id:e,maestro_nombre:``,maestro_email:``,puede_registrar_alumnos:!1,puede_inscribir_clases:!1,permisos:[],solicitudes:[],concedido_por:null,concedido_por_nombre:null,creado_en:null,actualizado_en:null}}async function Cm(e,t){await vm();let n=ym.findIndex(t=>t.maestro_id===e),r=new Date().toISOString();if(n===-1){let n={id:Math.random().toString(36).substr(2,9),maestro_id:e,maestro_nombre:t.maestro_nombre||``,maestro_email:t.maestro_email||``,puede_registrar_alumnos:t.puede_registrar_alumnos??!1,puede_inscribir_clases:t.puede_inscribir_clases??!1,permisos:Array.isArray(t.permisos)?t.permisos:[],solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:[],concedido_por:t.concedido_por||null,concedido_por_nombre:t.concedido_por_nombre||null,creado_en:r,actualizado_en:r};return ym.push(n),bm(n)}return ym[n]={...ym[n],puede_registrar_alumnos:t.puede_registrar_alumnos??ym[n].puede_registrar_alumnos,puede_inscribir_clases:t.puede_inscribir_clases??ym[n].puede_inscribir_clases,permisos:Array.isArray(t.permisos)?t.permisos:ym[n].permisos,solicitudes:Array.isArray(t.solicitudes)?t.solicitudes:ym[n].solicitudes,concedido_por:t.concedido_por??ym[n].concedido_por,concedido_por_nombre:t.concedido_por_nombre??ym[n].concedido_por_nombre,actualizado_en:r},bm(ym[n])}var wm=()=>x.isDemoMode?_m:He,Tm=(...e)=>wm().obtenerPermisos(...e),Em=(...e)=>wm().actualizarPermiso(...e),Dm={permisos:[],cargando:!1,togglingId:null,togglingField:null};function Om(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}async function km(e){try{Dm.cargando=!0,Am(e),Dm.permisos=await Tm(),Dm.cargando=!1,Mm(e),Im(e)}catch(t){console.error(t),jm(e,t.message)}}function Am(e){e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height: 400px;">
      <div class="text-center">
        <div class="spinner-border text-primary mb-3" role="status">
          <span class="visually-hidden">Cargando...</span>
  ...
  `,document.getElementById(`retryBtn`)?.addEventListener(`click`,()=>km(e))}function Mm(e){let t=w.getUser?w.getUser():null;t?.nombre_completo||t?.email,e.innerHTML=`
    <div class="page-container">
      <!-- Page Header -->
      <div class="page-header">
        <div class="d-flex align-items-center gap-2">
          <span class="page-title"><i class="bi bi-shield-lock me-2 text-primary"></i>Permisos de Maestros</span>
          <span class="badge bg-secondary">${Dm.permisos.length}</span>
        </div>
      </div>
  ...
  `}function Nm(){return Dm.permisos.map(e=>{let t=Dm.togglingId===e.maestro_id,n=e.concedido_por_nombre||e.concedido_por||`-`,r=e.actualizado_en?new Date(e.actualizado_en).toLocaleDateString(`es-ES`,{day:`numeric`,month:`short`}):`-`,i=e.solicitudes||[],a=!e.puede_registrar_alumnos&&i.includes(`alumnos:create`),o=!e.puede_inscribir_clases&&i.includes(`clases:enroll`);return`
      <tr data-maestro-id="${Om(e.maestro_id)}">
        <td>
          <div class="d-flex align-items-center gap-2">
            <div class="avatar-compact bg-primary text-white">${Fm(e.maestro_nombre||e.maestro_id)}</div>
            <span class="text-truncate" style="max-width: 150px;" title="${Om(e.maestro_nombre)}">${Om(e.maestro_nombre||`Sin nombre`)}</span>
          </div>
        </td>
        <td class="text-truncate" style="max-width: 150px;" title="${Om(e.maestro_email)}">${Om(e.maestro_email||`-`)}</td>
        <td>
          <div class="form-check form-switch mb-0 d-flex align-items-center gap-2">
            <input class="form-check-input permiso-toggle" type="checkbox"
              data-maestro-id="${Om(e.maestro_id)}"
        ...
        <td class="small text-muted">${Om(n)}</td>
        <td class="small text-muted">${r}</td>
      </tr>
    `}).join(``)}function Pm(){return`
  ...
  `}function Fm(e){return e?e.split(` `).map(e=>e[0]).join(``).toUpperCase().slice(0,2):`?`}function Im(e){let t=e.querySelector(`#permisosTable`);t&&(t.addEventListener(`change`,async t=>{let n=t.target.closest(`.permiso-toggle`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.field,a=n.checked;n.disabled=!0,Dm.togglingId=r,Dm.togglingField=i;let o=n.closest(`.form-check`)?.querySelector(`span`);o&&(o.textContent=a?`Sí`:`No`,o.className=`small ${a?`text-success`:`text-muted`}`);try{let t=Dm.permisos.find(e=>e.maestro_id===r),n={[i]:a};if(t){if(a){let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=t.permisos||[];r.includes(e)||r.push(e);let a=(t.solicitudes||[]).filter(t=>t!==e),o=w.getUser?w.getUser():null,s=o?.nombre_completo||o?.email||`Administrador`;n={...n,permisos:r,solicitudes:a,concedido_por:o?.id||`admin`,concedido_por_nombre:s},t.permisos=r,t.solicitudes=a,t.concedido_por=o?.id||`admin`,t.concedido_por_nombre=s}else{let e=i===`puede_registrar_alumnos`?`alumnos:create`:`clases:enroll`,r=(t.permisos||[]).filter(t=>t!==e);n={...n,permisos:r},t.permisos=r}t.actualizado_en=new Date().toISOString()}await Em(r,n),t&&(t[i]=a),v.success(`Permiso actualizado: ${i===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let o=e.querySelector(`#permisosTBody`);o&&(o.innerHTML=Nm())}catch(e){n.checked=!a,o&&(o.textContent=a?`No`:`Sí`,o.className=`small ${a?`text-muted`:`text-success`}`),v.error(`Error al actualizar permiso: `+e.message)}finally{n.disabled=!1,Dm.togglingId=null,Dm.togglingField=null}}),t.addEventListener(`click`,async t=>{let n=t.target.closest(`.aprobar-btn`);if(!n)return;let r=n.dataset.maestroId,i=n.dataset.permiso,a=n.dataset.field;n.disabled=!0;let o=n.innerHTML;n.innerHTML=`<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>`;try{let t=Dm.permisos.find(e=>e.maestro_id===r);if(!t)throw Error(`No se encontró el registro de permisos del maestro`);let n=t.permisos||[];n.includes(i)||n.push(i);let o=(t.solicitudes||[]).filter(e=>e!==i),s=w.getUser?w.getUser():null,c=s?.nombre_completo||s?.email||`Administrador`;await Em(r,{permisos:n,solicitudes:o,concedido_por:s?.id||`admin`,concedido_por_nombre:c,[a]:!0}),t.permisos=n,t.solicitudes=o,t.concedido_por=s?.id||`admin`,t.concedido_por_nombre=c,t[a]=!0,t.actualizado_en=new Date().toISOString(),v.success(`Solicitud aprobada: ${a===`puede_registrar_alumnos`?`Registrar Alumnos`:`Inscribir Clases`}`);let l=e.querySelector(`#permisosTBody`);l&&(l.innerHTML=Nm())}catch(e){v.error(`Error al aprobar solicitud: `+e.message),n.disabled=!1,n.innerHTML=o}}))}function Lm(){S.register(`permisos`,km)}async function Rm(e){if(e){e.innerHTML=Vm();try{let[t,n]=await Promise.all([zm(),Bm()]);e.innerHTML=Hm(t,n),Gm(e)}catch(t){console.error(`[DashboardPedagogico]`,t),e.innerHTML=`
      <div class="page-container">
        <div class="alert alert-warning">Error al cargar el dashboard: ${t.message}</div>
      </div>`}}}async function zm(){let[e,t,n,r]=await Promise.all([_.from(`alumnos`).select(`id`,{count:`exact`}).eq(`activo`,!0),_.from(`planificaciones`).select(`id, estado`).gte(`fecha_inicio`,new Date(Date.now()-10080*60*1e3).toISOString().split(`T`)[0]),_.from(`clases`).select(`id`,{count:`exact`}).eq(`estado`,`activa`),_.from(`asistencias`).select(`estado`).gte(`fecha`,new Date(Date.now()-10080*60*1e3).toISOString().split(`T`)[0])]),i=r.data?.length||0,a=r.data?.filter(e=>e.estado===`P`).length||0,o=i>0?Math.round(a/i*100):null,s=t.data?.filter(e=>e.estado===`ejecutado`).length||0,c=t.data?.filter(e=>e.estado===`planificado`).length||0;return{alumnosActivos:e.count||0,clasesActivas:n.count||0,planesEstaSemana:t.data?.length||0,planesEjecutados:s,planesPlanificados:c,tasaAsistencia:o}}async function Bm(){let e=new Date(Date.now()-672*60*60*1e3).toISOString().split(`T`)[0],{data:t}=await _.from(`asistencias`).select(`alumno_id, estado`).gte(`fecha`,e);if(!t?.length)return[];let n={};t.forEach(e=>{n[e.alumno_id]||(n[e.alumno_id]={total:0,presentes:0}),n[e.alumno_id].total++,e.estado===`P`&&n[e.alumno_id].presentes++});let r=Object.entries(n).filter(([,e])=>e.total>=4&&e.presentes/e.total<Yu.attendance_min_rate).map(([e])=>e);if(!r.length)return[];let{data:i}=await _.from(`alumnos`).select(`id, nombre_completo`).in(`id`,r.slice(0,5));return i||[]}function Vm(){return`
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        <div class="brand-badge bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center" style="width:42px;height:42px;">
    ...
    </div>`}function Hm(e,t){let n=e.tasaAsistencia===null?`secondary`:e.tasaAsistencia>=80?`success`:e.tasaAsistencia>=60?`warning`:`danger`;return`
    <div class="page-container">
      <div class="d-flex align-items-center gap-3 mb-4">
        <div class="brand-badge bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center" style="width:42px;height:42px;">
          <i class="bi bi-grid-1x2 fs-4"></i>
      ...
      <div class="row g-3 mb-4">
        ${Um(`bi-people-fill`,`Alumnos activos`,e.alumnosActivos,`primary`,null)}
        ${Um(`bi-easel2`,`Clases activas`,e.clasesActivas,`indigo`,null)}
        ${Um(`bi-journal-text`,`Planes esta semana`,e.planesEstaSemana,`success`,`${e.planesEjecutados} ejecutados · ${e.planesPlanificados} pendientes`)}
        ${Um(`bi-calendar-check`,`Asistencia (7 días)`,e.tasaAsistencia===null?`—`:e.tasaAsistencia+`%`,n,null)}
      </div>
      ...
      <div class="row g-3">
        ${Wm(`bi-journal-text`,`Planificación`,`Planes de clase, plantillas y revisión`,`planificacion`,`primary`)}
        ${Wm(`bi-person-lines-fill`,`Seguimiento`,`Progreso y asistencia por alumno`,`pedagogico-seguimiento`,`success`)}
        ${Wm(`bi-graph-up`,`Evaluaciones`,`Calificaciones y boletines`,`progresos`,`warning`)}
        ${Wm(`bi-file-earmark-bar-graph`,`Reportes`,`Rendimiento por clase y riesgo`,`pedagogico-reportes`,`info`)}
      </div>
    </div>`}function Um(e,t,n,r,i){return`
    <div class="col-6 col-md-3">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body">
    ...
    </div>`}function Wm(e,t,n,r,i){return`
    ...
    <div class="page-container">
      ...
      <div class="d-flex flex-column gap-2" id="lista-alumnos">
        ${i.map(e=>Xm(e)).join(``)||`<div class="text-center text-muted py-5">Sin resultados</div>`}
      </div>
    </div>`,Zm()}function Xm(e){let t=Jm(e.id),n=X.asistenciaMap[e.id],r=X.progresosMap[e.id],i=X.observacionesMap[e.id]||[],a=n?.rate==null?null:Math.round(n.rate*100),o=a===null?`secondary`:a>=80?`success`:a>=60?`warning`:`danger`,s=r?r.promedio>=7?`success`:r.promedio>=5?`warning`:`danger`:`secondary`;return`
    ...
    <div class="page-container">
      ...
      <h6 class="text-muted text-uppercase mb-2" style="font-size:0.72rem;letter-spacing:0.08em;">
        Alumnos en riesgo — asistencia &lt; ${Math.round(Yu.attendance_min_rate*100)}% (4 semanas)
      </h6>
      ${t.length?`
      <div class="card border-0 shadow-sm">
        <div class="table-responsive">
    ...
    </div>`}function ih(){S.register(`pedagogico-dashboard`,e=>Rm(e)),S.register(`pedagogico-seguimiento`,e=>Km(e)),S.register(`pedagogico-reportes`,e=>eh(e))}var ah=[{id:`m-001`,nombre:`Carlos Méndez`,especialidad:`Violín`,habilidades:[`violín`,`viola`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],martes:[{inicio:`10:00`,fin:`13:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`},{inicio:`14:00`,fin:`18:00`}],jueves:[{inicio:`10:00`,fin:`13:00`}],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-002`,nombre:`María Torres`,especialidad:`Piano`,habilidades:[`piano`,`teclado`,`teoría musical`],disponibilidad:{lunes:[{inicio:`14:00`,fin:`19:00`}],martes:[{inicio:`10:00`,fin:`19:00`}],miércoles:[{inicio:`14:00`,fin:`19:00`}],jueves:[{inicio:`10:00`,fin:`19:00`}],viernes:[],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-003`,nombre:`José Ramírez`,especialidad:`Percusión`,habilidades:[`percusión`,`batería`,`timbales`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`14:00`}],martes:[{inicio:`10:00`,fin:`14:00`}],miércoles:[{inicio:`10:00`,fin:`14:00`}],jueves:[{inicio:`10:00`,fin:`14:00`}],viernes:[{inicio:`10:00`,fin:`14:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}},{id:`m-004`,nombre:`Ana Luisa Herrera`,especialidad:`Cello`,habilidades:[`cello`,`contrabajo`,`música de cámara`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`19:00`}],martes:[],miércoles:[{inicio:`10:00`,fin:`19:00`}],jueves:[],viernes:[{inicio:`10:00`,fin:`19:00`}],sábado:[],domingo:[]}},{id:`m-005`,nombre:`Roberto Sánchez`,especialidad:`Guitarra`,habilidades:[`guitarra`,`cuatro`,`mandolina`],disponibilidad:{lunes:[{inicio:`15:00`,fin:`19:00`}],martes:[{inicio:`15:00`,fin:`19:00`}],miércoles:[{inicio:`15:00`,fin:`19:00`}],jueves:[{inicio:`15:00`,fin:`19:00`}],viernes:[{inicio:`15:00`,fin:`19:00`}],sábado:[{inicio:`09:00`,fin:`13:00`}],domingo:[]}},{id:`m-006`,nombre:`Luisa Fernanda Díaz`,especialidad:`Voz`,habilidades:[`voz`,`coro`,`técnica vocal`,`solfeo`],disponibilidad:{lunes:[{inicio:`10:00`,fin:`13:00`}],martes:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],miércoles:[{inicio:`10:00`,fin:`13:00`}],jueves:[{inicio:`10:00`,fin:`13:00`},{inicio:`15:00`,fin:`18:00`}],viernes:[{inicio:`10:00`,fin:`13:00`}],sábado:[{inicio:`09:00`,fin:`12:00`}],domingo:[]}}],oh=[{id:`s-101`,nombre:`Salón Mozart (Grande)`,capacidad:30,piso:1,is_active:!0},{id:`s-102`,nombre:`Salón Beethoven (Mediano)`,capacidad:15,piso:1,is_active:!0},{id:`s-103`,nombre:`Salón Bach (Piano)`,capacidad:10,piso:2,is_active:!0},{id:`s-104`,nombre:`Salón Vivaldi (Violín)`,capacidad:8,piso:2,is_active:!0},{id:`s-105`,nombre:`Salón Chopin (Teclados)`,capacidad:12,piso:2,is_active:!0}],sh=[{id:`c-001`,nombre:`Violín Inicial`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:10,total_alumnos:6,horarios:[]},{id:`c-002`,nombre:`Violín Intermedio`,instrumento:`Violín`,maestro_principal_id:`m-001`,capacidad_maxima:8,total_alumnos:5,horarios:[]},{id:`c-003`,nombre:`Piano Inicial A`,instrumento:`Piano`,maestro_principal_id:`m-002`,capacidad_maxima:12,total_alumnos:10,horarios:[]},{id:`c-004`,nombre:`Teoría y Solfeo I`,instrumento:`Solfeo`,maestro_principal_id:`m-006`,capacidad_maxima:25,total_alumnos:18,horarios:[]},{id:`c-005`,nombre:`Batería Básica`,instrumento:`Percusión`,maestro_principal_id:`m-003`,capacidad_maxima:6,total_alumnos:4,horarios:[]},{id:`c-006`,nombre:`Guitarra Clásica I`,instrumento:`Guitarra`,maestro_principal_id:`m-005`,capacidad_maxima:15,total_alumnos:11,horarios:[]},{id:`c-007`,nombre:`Cello y Cámara`,instrumento:`Cello`,maestro_principal_id:`m-004`,capacidad_maxima:8,total_alumnos:3,horarios:[]},{id:`c-008`,nombre:`Técnica Vocal A`,instrumento:`Voz`,maestro_principal_id:`m-006`,capacidad_maxima:10,total_alumnos:8,horarios:[]}],ch=[];async function lh(){let{data:e,error:t}=await _.from(`salones`).select(`id, nombre, capacidad, is_active`).eq(`is_active`,!0).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar salones reales: `+t.message);return e}async function uh(){let{data:e,error:t}=await _.from(`clases`).select(`id, nombre, maestro_principal_id, capacidad_maxima, instrumento`).order(`nombre`,{ascending:!0});if(t)throw Error(`Error al cargar clases reales: `+t.message);let{data:n}=await _.from(`clase_horarios`).select(`*`),{data:r}=await _.from(`alumnos_clases`).select(`clase_id`);return(e||[]).map(e=>{let t=(n||[]).filter(t=>t.clase_id===e.id),i=(r||[]).filter(t=>t.clase_id===e.id).length;return{id:e.id,nombre:e.nombre,instrumento:e.instrumento||`General`,maestro_principal_id:e.maestro_principal_id,capacidad_maxima:e.capacidad_maxima||20,total_alumnos:i,horarios:t.map(e=>({dia:e.dia,hora_inicio:e.hora_inicio,hora_fin:e.hora_fin,salon_id:e.salon_id}))}})}async function dh(){if(x.isDemoMode)return{maestros:ah,salones:oh,clases:sh};try{let[e,t,n]=await Promise.all([Pe(),lh(),uh()]);return{maestros:e,salones:t,clases:n}}catch(e){throw console.error(`[horarioBuilderApi] Error fetching data:`,e),e}}async function fh(e){if(x.isDemoMode){let t={id:`run-${Date.now()}`,created_at:new Date().toISOString(),estado:e.estado||`borrador`,periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas};return ch.push(t),t}let{data:t,error:n}=await _.from(`schedule_runs`).insert([{periodo:e.periodo,config:e.config,resultado:e.resultado,metricas:e.metricas,estado:e.estado||`borrador`}]).select().single();if(n)throw console.error(`[horarioBuilderApi] Error saving run:`,n),Error(`No se pudo guardar la corrida de horario: `+n.message);return t}async function ph(){if(x.isDemoMode)return ch;let{data:e,error:t}=await _.from(`schedule_runs`).select(`*`).order(`created_at`,{ascending:!1});if(t)throw console.error(`[horarioBuilderApi] Error fetching runs:`,t),Error(`No se pudieron obtener las corridas de horarios`);return e}var mh={lunes:{inicio:`10:00`,fin:`19:00`},martes:{inicio:`10:00`,fin:`19:00`},miércoles:{inicio:`10:00`,fin:`19:00`},jueves:{inicio:`10:00`,fin:`19:00`},viernes:{inicio:`10:00`,fin:`19:00`},sábado:{inicio:`09:00`,fin:`13:00`},domingo:{inicio:`00:00`,fin:`00:00`}},hh=[{id:`S1-2026`,nombre:`Semestre 1 (Ene–Jul 2026)`,inicio:`2026-01-01`,fin:`2026-07-31`},{id:`S2-2026`,nombre:`Semestre 2 (Ago–Dic 2026)`,inicio:`2026-08-01`,fin:`2026-12-31`}],gh=[{key:`lunes`,label:`Lunes`},{key:`martes`,label:`Martes`},{key:`miércoles`,label:`Miércoles`},{key:`jueves`,label:`Jueves`},{key:`viernes`,label:`Viernes`},{key:`sábado`,label:`Sábado`}];function _h(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function vh(e,t){let n=_h(e)+t,r=Math.floor(n/60),i=n%60;return`${String(r).padStart(2,`0`)}:${String(i).padStart(2,`0`)}`}function yh(e,t){return _h(t)-_h(e)}function bh(e){if(!e||!e.includes(`:`))return`00:00`;let[t]=e.split(`:`);return`${t.padStart(2,`0`)}:00`}function xh(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function Sh(e){let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`}function Ch(e,t,n,r,i=0){return e<r+i&&n-i<t}function wh(e,t,n){let r=e[t]||[],i=n[t];if(!i||i.inicio===`00:00`&&i.fin===`00:00`)return[];let a=xh(i.inicio),o=xh(i.fin),s=[];return r.forEach(e=>{let t=xh(e.inicio),n=xh(e.fin),r=Math.max(t,a),i=Math.min(n,o);r<i&&s.push({start:r,end:i})}),s}function Th({clasesConMaestro:e,maestros:t,salones:n,config:r}){let i={jornada:r?.jornada||mh,gapMinimo:r?.gapMinimo===void 0?15:parseInt(r.gapMinimo),duracionBloque:r?.duracionBloque===void 0?60:parseInt(r.duracionBloque)},a=[],o=[],s={};t.forEach(e=>{s[e.id]=[]});let c={};n.forEach(e=>{c[e.id]=[]});let l=e.map(e=>{let n=t.find(t=>t.id===e.maestro_principal_id),r=0;return n&&n.disponibilidad&&Object.keys(n.disponibilidad).forEach(e=>{wh(n.disponibilidad,e,i.jornada).forEach(e=>{r+=e.end-e.start})}),{...e,duracion:e.duracion||i.duracionBloque,totalAlumnos:e.total_alumnos||0,availableMinutes:r||1}});l.sort((e,t)=>e.availableMinutes===t.availableMinutes?t.totalAlumnos-e.totalAlumnos:e.availableMinutes-t.availableMinutes),l.forEach(e=>{let r=t.find(t=>t.id===e.maestro_principal_id);if(!r){o.push({clase_id:e.id,nombre:e.nombre,razon:`El maestro principal asignado (ID: ${e.maestro_principal_id}) no está registrado.`});return}let l=e.duracion,u=[];if(Object.keys(i.jornada).forEach(t=>{let a=i.jornada[t];if(!a||a.inicio===`00:00`&&a.fin===`00:00`)return;let o=wh(r.disponibilidad||{},t,i.jornada);if(o.length===0)return;xh(a.inicio),xh(a.fin);let d=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1);d.length!==0&&o.forEach(e=>{for(let n=e.start;n+l<=e.end;n+=30){let e=n+l;(s[r.id]||[]).some(r=>r.day===t&&Ch(n,e,r.start,r.end,i.gapMinimo))||d.forEach(a=>{(c[a.id]||[]).some(r=>r.day===t&&Ch(n,e,r.start,r.end,i.gapMinimo))||u.push({day:t,start:n,end:e,salon:a,teacher:r})})}})}),u.length===0){let t=n.filter(t=>t.capacidad>=e.totalAlumnos&&t.is_active!==!1),i=`Sin disponibilidad compatible con maestro y salones.`;i=t.length===0?`No hay salones activos con capacidad suficiente para ${e.totalAlumnos} alumnos.`:`Conflicto de agenda: el maestro ${r.nombre} o los salones adecuados están ocupados en sus horas disponibles.`,o.push({clase_id:e.id,nombre:e.nombre,razon:i});return}u.forEach(t=>{let n=100,r=t.salon.capacidad-e.totalAlumnos;n-=Math.min(r*2,40);let i=(s[t.teacher.id]||[]).reduce((e,t)=>e+(t.end-t.start),0)/60;n-=Math.min(i*3,20),(s[t.teacher.id]||[]).some(e=>e.day===t.day&&(e.end===t.start||e.start===t.end))&&(n+=15),t.score=n}),u.sort((e,t)=>t.score-e.score);let d=u[0];a.push({clase_id:e.id,clase_nombre:e.nombre,maestro_id:r.id,maestro_nombre:r.nombre,salon_id:d.salon.id,salon_nombre:d.salon.nombre,dia:d.day,hora_inicio:Sh(d.start),hora_fin:Sh(d.end),color:Eh(r.id)}),s[r.id].push({day:d.day,start:d.start,end:d.end,classId:e.id}),c[d.salon.id].push({day:d.day,start:d.start,end:d.end,classId:e.id})});let u=e.length,d=a.length,f=o.length,p={};n.forEach(e=>{let t=(c[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0),n=0;Object.keys(i.jornada).forEach(e=>{let t=i.jornada[e];t&&(t.inicio!==`00:00`||t.fin!==`00:00`)&&(n+=xh(t.fin)-xh(t.inicio))}),p[e.id]={nombre:e.nombre,porcentaje:Math.round(t/(n||1)*100)}});let m={};t.forEach(e=>{let t=(s[e.id]||[]).reduce((e,t)=>e+(t.end-t.start),0);m[e.id]={nombre:e.nombre,horas:Math.round(t/60*10)/10}});let ee=u>0?d/u*100:100;return{assignments:a,noAsignadas:o,metricas:{totalClases:u,clasesAsignadas:d,clasesNoAsignadas:f,ocupacionSalones:p,cargaMaestros:m,score:Math.max(0,Math.round(ee))}}}function Eh(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function Dh(e){let[t,n]=e.split(`:`).map(Number);return t*60+n}function Oh(e,t,n=0){let r=Dh(e.hora_inicio),i=Dh(e.hora_fin),a=Dh(t.hora_inicio);return r<Dh(t.hora_fin)+n&&a-n<i}function kh(e,{returnAnnotated:t=!1,gapMinutes:n=0}={}){let r=[],i=new Set;for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let o=e[t],s=e[a];o.dia===s.dia&&Oh(o,s,n)&&(o.maestro_id&&o.maestro_id===s.maestro_id&&(r.push({type:`teacher`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.maestro_nombre} tiene dos clases al mismo tiempo: "${o.clase_nombre}" y "${s.clase_nombre}"`}),i.add(o.clase_id),i.add(s.clase_id)),o.salon_id&&o.salon_id===s.salon_id&&(r.push({type:`room`,ids:[o.clase_id,s.clase_id],day:o.dia,hora_inicio:o.hora_inicio,description:`${o.salon_nombre} está ocupado por "${o.clase_nombre}" y "${s.clase_nombre}" al mismo tiempo`}),i.add(o.clase_id),i.add(s.clase_id)))}return t?{conflicts:r,assignments:e.map(e=>({...e,hasConflict:i.has(e.clase_id)}))}:r}function Ah({conflictDescription:e}){return new Promise(t=>{let n=document.createElement(`div`);n.className=`modal-backdrop fade show`,n.style.zIndex=`1040`;let r=document.createElement(`div`);r.className=`modal fade show d-block`,r.style.zIndex=`1050`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
    ...
    `;let i=r.querySelector(`.modal-body p`);i&&(i.textContent=e);function a(e){document.body.removeChild(r),document.body.removeChild(n),t(e)}r.querySelector(`[data-action="confirm"]`).addEventListener(`click`,()=>a(!0)),r.querySelector(`[data-action="cancel"]`).addEventListener(`click`,()=>a(!1)),document.body.appendChild(n),document.body.appendChild(r)})}function jh(e,{assignments:t,onMove:n,onConflict:r}){let i=new AbortController,{signal:a}=i,o=null;return e.addEventListener(`dragstart`,e=>{let t=e.target.closest(`[draggable="true"][data-clase-id]`);t&&(o=t.dataset.claseId,t.classList.add(`hb-dragging`),e.dataTransfer&&(e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,o)))},{signal:a}),e.addEventListener(`dragend`,e=>{let t=e.target.closest(`[draggable="true"][data-clase-id]`);t&&t.classList.remove(`hb-dragging`),o=null},{signal:a}),e.addEventListener(`dragover`,e=>{let t=e.target.closest(`[data-day][data-hour]`);t&&(e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`move`),t.classList.contains(`hb-drop-target`)||t.classList.add(`hb-drop-target`))},{signal:a}),e.addEventListener(`dragleave`,e=>{let t=e.target.closest(`[data-day][data-hour]`);t&&(t.contains(e.relatedTarget)||t.classList.remove(`hb-drop-target`))},{signal:a}),e.addEventListener(`drop`,e=>{let i=e.target.closest(`[data-day][data-hour]`);if(!i)return;e.preventDefault(),i.classList.remove(`hb-drop-target`);let a=o??(e.dataTransfer?e.dataTransfer.getData(`text/plain`):null);if(!a)return;let s=i.dataset.day,c=i.dataset.hour,l=t.find(e=>String(e.clase_id)===String(a));if(!l)return;let u=l.dia,d=l.hora_inicio,f=kh(t.map(e=>{if(String(e.clase_id)!==String(a))return e;let t=yh(e.hora_inicio,e.hora_fin);return{...e,dia:s,hora_inicio:c,hora_fin:vh(c,t)}}),{gapMinutes:0});f.length===0?n({claseId:a,fromDay:u,fromHour:d,toDay:s,toHour:c}):r({assignment:l,targetDay:s,targetHour:c,conflicts:f})},{signal:a}),{destroy(){i.abort()}}}var Mh={piano:`#818cf8`,violín:`#34d399`,violin:`#34d399`,guitarra:`#f472b6`,canto:`#fb923c`,voz:`#ec4899`,percusión:`#a78bfa`,percusion:`#a78bfa`,solfeo:`#38bdf8`,cello:`#f59e0b`,flauta:`#06b6d4`,trompeta:`#84cc16`,general:`#94a3b8`};function Nh(e=``){return Mh[e.toLowerCase()]??Mh.general}function Ph(e=``){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return`hsl(${Math.abs(t%360)}, 70%, 88%)`}function Fh(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Ih(e,{draggable:t=!1}={}){let{clase_id:n,clase_nombre:r,instrumento:i=`General`,maestro_id:a,maestro_nombre:o=``,salon_nombre:s=``,hora_inicio:c,hora_fin:l,locked:u=!1,hasConflict:d=!1}=e,f=Nh(i),p=Ph(a||``),m=t&&!u,ee=Fh(o.split(` `).slice(0,2).map(e=>e[0]??``).join(``).toUpperCase()),te=Fh(n),ne=d?` schedule-block--conflict`:``,re=d?`<span class="sb-conflict-icon" title="Conflicto detectado">⚠</span>`:``,ie=m?`<button class="sb-lock-btn" data-clase-id="${te}" data-locked="${u}"
    ...
    <div class="schedule-block${ne}"
      ...
      <div class="schedule-block__header" style="background:${f};">
        <span class="schedule-block__title">${Fh(r)}</span>
      ...
      <div class="schedule-block__body">
        ...
        <span class="schedule-block__teacher-name">${Fh(o)}</span>
      </div>
      ${s?`<div class="schedule-block__footer">${Fh(s)} · ${c}–${l}</div>`:``}
    </div>
  `}var Lh=`<p class="text-muted text-center py-4">No hay asignaciones para mostrar.</p>`;function Rh(e,t,n){let r=new Map;for(let t of e){let e=bh(t.hora_inicio);r.has(e)||r.set(e,new Map);let n=r.get(e),i=(t.dia||``).toLowerCase();n.has(i)||n.set(i,[]),n.get(i).push(t)}let i=[...r.keys()].sort(),a=gh.map(e=>`<th class="sg-col-header" data-day="${e.key}">${e.label}</th>`).join(``),o=i.map(e=>{let n=r.get(e);return`<tr>
      <td class="sg-hour-label">${e}</td>
      ${gh.map(r=>{let i=(n.get(r.key)||[]).map(e=>Ih(e,{draggable:t})).join(``);return`<td class="sg-cell" data-day="${r.key}" data-hour="${e}">${i}</td>`}).join(``)}
    </tr>`}).join(``);return`
  ...
  `}function zh(e,t,n){let r=new Map;for(let n of e){let e=n[t]||`(Sin asignar)`;r.has(e)||r.set(e,[]),r.get(e).push(n)}return`<div class="schedule-grouped-view">${[...r.entries()].map(([e,t])=>{let r=t.map(e=>Ih(e,{draggable:n})).join(``);return`
      <div class="sg-group">
        <h4 class="sg-group-title">${Fh(e)}</h4>
        <div class="sg-group-blocks">${r}</div>
      </div>
    `}).join(``)}</div>`}function Bh({assignments:e,activeView:t,draggable:n=!1,periodoId:r}={}){if(!e||e.length===0)return Lh;switch(t){case`teacher`:return zh(e,`maestro_nombre`,n);case`room`:return zh(e,`salon_nombre`,n);case`student`:return zh(e,`clase_nombre`,n);default:return Rh(e,n,r)}}var Vh=[`grid`,`teacher`,`room`,`student`],Hh={grid:{label:`Grilla`,icon:`bi-grid-3x3`},teacher:{label:`Por Maestro`,icon:`bi-person-lines-fill`},room:{label:`Por Salón`,icon:`bi-door-open`},student:{label:`Por Alumno`,icon:`bi-mortarboard`}};function Uh(e=`grid`){return Hh[e]||(e=`grid`),`
    <div class="view-toggle" style="display:flex;gap:0.4rem;flex-wrap:wrap;" role="tablist" aria-label="Modo de visualización">
      ${Vh.map(t=>{let{label:n,icon:r}=Hh[t],i=t===e;return`
  ...
  `}var Wh={lunes:`Lun`,martes:`Mar`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sábado:`Sáb`};function Gh(e=[],t=!1){if(e.length===0)return``;let n=e.length,r=e.map((e,t)=>{e.type;let n=Fh(Wh[e.day]??e.day);return`
      <div class="cp-row"
           ...
           ">
        <span style="background:#fecaca;color:#991b1b;border-radius:4px;padding:1px 5px;font-size:0.6rem;font-weight:700;flex-shrink:0;margin-top:1px;">${Fh(e.type)}</span>
        <span style="font-size:0.72rem;color:#7f1d1d;line-height:1.4;">${n} ${e.hora_inicio} — ${Fh(e.description)}</span>
      </div>
    `}).join(``);return`
  ...
  `}function Kh(e,t,n){let r=e.querySelector(`.cp-header`),i=e.querySelector(`.cp-body`),a=e.querySelector(`.cp-chevron`);r?.addEventListener(`click`,()=>{let e=i.style.display!==`none`;i.style.display=e?`none`:`block`,a.className=`bi ${e?`bi-chevron-down`:`bi-chevron-up`}`}),e.querySelectorAll(`.cp-row`).forEach(e=>{e.addEventListener(`mouseenter`,()=>{e.style.background=`#fff1f2`}),e.addEventListener(`mouseleave`,()=>{e.style.background=`transparent`}),e.addEventListener(`click`,()=>{let r=parseInt(e.dataset.conflictIndex,10);isNaN(r)||!t[r]||n?.(t[r])})})}var qh=[`borrador`,`revision`,`publicado`],Jh={borrador:`Borrador`,revision:`Revisión`,publicado:`Publicado`};function Yh(e){let t=document.createElement(`li`);t.className=`pw-feedback-item d-flex align-items-start gap-2 mb-1`;let n=document.createElement(`span`);n.className=`badge bg-secondary`,n.textContent=e.tipo;let r=document.createElement(`span`);return r.textContent=e.comentario,t.appendChild(n),t.appendChild(r),t}function Xh(e,{runId:t,estadoActual:n,isAdmin:r,feedback:i=[],onEstadoChange:a,onFeedbackAdd:o}){let s=qh.indexOf(n);e.innerHTML=`
    <div class="pw-wizard">
      <!-- Stage indicators -->
      <div class="pw-stages d-flex align-items-center gap-2 mb-3">
        ${qh.map((e,t)=>{let n=`pw-stage`;t===s?n+=` pw-stage--active`:t<s&&(n+=` pw-stage--done`);let r=t<qh.length-1?`<div class="pw-stage-connector"></div>`:``;return`
      <div class="${n}" data-stage="${e}">
        <span class="pw-stage-dot"></span>
        <span class="pw-stage-label">${Jh[e]}</span>
      </div>
      ${r}
    `}).join(``)}
      </div>
  ...
  `}function og(){let e=hh.map(e=>`<option value="${e.id}" ${e.id===Z.activePeriodo?`selected`:``}>${e.nombre}</option>`).join(``),t=Z.draggable,n=Z.assignments.length>0;Q.innerHTML=`
    <div class="hb-view">
      ...
      <!-- Stats bar -->
      <div id="hb-stats-wrapper">${n?ag():``}</div>
      ...
      <div class="hb-toolbar-main">
        ...
        <div class="hb-toolbar-group hb-toolbar-group--views">
          ...
          <div id="hb-view-toggle-slot">${Uh(Z.activeView)}</div>
        </div>
        <div class="hb-toolbar-divider"></div>
        <div class="hb-toolbar-group">
  ...
  `}function cg(){if(document.getElementById(`hb-shell-styles`))return;let e=document.createElement(`style`);e.id=`hb-shell-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function lg(){let e=Q?.querySelector(`#hb-stats-wrapper`);e&&(e.innerHTML=Z.assignments.length>0?ag():``)}function ug(){let e=Q.querySelector(`#hb-grid-wrapper`);e&&(lg(),e.innerHTML=Bh({assignments:Z.assignments,activeView:Z.activeView,draggable:Z.draggable,periodoId:Z.activePeriodo}))}function dg(){let e=Q.querySelector(`#hb-conflict-panel-wrapper`);if(!e)return;let t=e.querySelector(`.cp-body`);t&&(Z.conflictPanelExpanded=t.style.display===`block`),e.innerHTML=Gh(Z.conflicts,Z.conflictPanelExpanded),Kh(e,Z.conflicts,e=>{let t=Q.querySelector(`.hb-view`);e.ids.forEach(e=>{let n=t?.querySelector(`[data-clase-id="${e}"]`);n&&(n.scrollIntoView({behavior:`smooth`,block:`nearest`}),n.classList.add(`hb-highlight`),setTimeout(()=>n.classList.remove(`hb-highlight`),1500))})})}function fg(){let e=Q.querySelector(`#hb-view-toggle-slot`);e&&(e.innerHTML=Uh(Z.activeView))}function pg(){let e=Q.querySelector(`#hb-publish-wrapper`);if(e){if(!Z.publishWizardOpen||!Z.runId){e.style.display=`none`;return}e.style.display=``,Xh(e,{runId:Z.runId,estadoActual:Z.estado,isAdmin:Z.isAdmin,feedback:Z.feedback,async onEstadoChange(e){try{await eg(Z.runId,e),Z.estado=e,pg()}catch(e){console.error(`[horario-builder] estado update failed:`,e)}},async onFeedbackAdd({comentario:e,tipo:t}){try{let n=await Qh({runId:Z.runId,comentario:e,tipo:t});Z.feedback=[...Z.feedback,n],pg()}catch(e){console.error(`[horario-builder] feedback add failed:`,e)}}})}}function mg(e){Z.loading=e;let t=Q.querySelector(`#hb-status`);t&&(t.innerHTML=e?`<div class="d-flex align-items-center gap-2 mt-2 text-muted" style="font-size:0.85rem;">
         <div class="spinner-border spinner-border-sm" role="status"></div>
         <span>Generando horario optimizado…</span>
       </div>`:``)}function hg(e,t=`success`){if(t===`danger`){v.error(e);return}if(t===`warning`){v.show(e,`warning`);return}v.success(e)}function gg(e){return JSON.parse(JSON.stringify(e))}function _g(){let e=Q?.querySelector(`#hb-undo-btn`),t=Q?.querySelector(`#hb-redo-btn`);e&&(e.disabled=Z.undoStack.length===0),t&&(t.disabled=Z.redoStack.length===0)}function vg(){ng&&ng.destroy(),Z.draggable&&(ng=jh(Q.querySelector(`#hb-grid-wrapper`),{assignments:Z.assignments,onMove({claseId:e,fromDay:t,fromHour:n,toDay:r,toHour:i}){Z.undoStack.push(gg(Z.assignments)),Z.redoStack=[];let a=Z.assignments.findIndex(t=>t.clase_id===e);if(a===-1)return;let o={...Z.assignments[a]},s=yh(o.hora_inicio,o.hora_fin);o.dia=r,o.hora_inicio=i,o.hora_fin=vh(i,s),Z.assignments[a]=o;let{conflicts:c,assignments:l}=kh(Z.assignments,{returnAnnotated:!0});Z.conflicts=c,Z.assignments=l,ug(),dg(),_g(),vg()},async onConflict({assignment:e,targetDay:t,targetHour:n,conflicts:r}){let i=Q.querySelector(`#hb-drag-toggle`);[i,Q.querySelector(`#hb-undo-btn`),Q.querySelector(`#hb-redo-btn`)].forEach(e=>{e&&(e.disabled=!0)});try{if(!await Ah({conflictDescription:r.map(e=>e.description).join(`
`)}))return;Z.undoStack.push(gg(Z.assignments)),Z.redoStack=[];let i=Z.assignments.findIndex(t=>t.clase_id===e.clase_id);if(i===-1)return;let a={...Z.assignments[i]},o=yh(a.hora_inicio,a.hora_fin);a.dia=t,a.hora_inicio=n,a.hora_fin=vh(n,o),Z.assignments[i]=a;let s=kh(Z.assignments,{returnAnnotated:!0});Z.conflicts=s.conflicts,Z.assignments=s.assignments,ug(),dg(),_g(),vg()}finally{i&&(i.disabled=!1),_g()}}}))}function yg(){Q.addEventListener(`change`,e=>{e.target.id===`hb-periodo-select`&&(Z.activePeriodo=e.target.value,ug())}),Q.addEventListener(`click`,async e=>{let t=e.target.closest(`.vt-pill[data-view]`);if(t){let e=t.dataset.view;Vh.includes(e)&&e!==Z.activeView&&(Z.activeView=e,fg(),ug());return}if(e.target.closest(`#hb-drag-toggle`)){Z.draggable=!Z.draggable;let e=Q.querySelector(`#hb-drag-toggle`);e&&(e.innerHTML=Z.draggable?`<i class="bi bi-unlock-fill"></i> Bloqueando`:`<i class="bi bi-lock-fill"></i> Editar`),ug(),vg();return}if(e.target.closest(`#hb-undo-btn`)){if(Z.undoStack.length===0)return;Z.redoStack.push(gg(Z.assignments)),Z.assignments=Z.undoStack.pop();let e=kh(Z.assignments,{returnAnnotated:!0});Z.conflicts=e.conflicts,Z.assignments=e.assignments,ug(),dg(),_g(),vg();return}if(e.target.closest(`#hb-redo-btn`)){if(Z.redoStack.length===0)return;Z.undoStack.push(gg(Z.assignments)),Z.assignments=Z.redoStack.pop();let e=kh(Z.assignments,{returnAnnotated:!0});Z.conflicts=e.conflicts,Z.assignments=e.assignments,ug(),dg(),_g(),vg();return}if(e.target.closest(`#hb-generate-btn`)){bg();return}if(e.target.closest(`#hb-save-btn`)){xg();return}if(e.target.closest(`#hb-publish-btn`)){if(Z.publishWizardOpen=!Z.publishWizardOpen,Z.publishWizardOpen&&Z.runId)try{Z.feedback=await Zh(Z.runId)}catch{Z.feedback=[]}pg();return}})}async function bg(){let e=Q.querySelector(`#hb-generate-btn`);e&&(e.disabled=!0),mg(!0);try{let e=await dh(),{conflicts:t,assignments:n}=kh(Th({clasesConMaestro:(e.clases||[]).map(e=>({id:e.id,nombre:e.nombre,maestro_principal_id:e.maestro_principal_id,total_alumnos:e.total_alumnos||0,duracion:60})),maestros:e.maestros||[],salones:e.salones||[],config:{gapMinimo:15,duracionBloque:60}}).assignments,{returnAnnotated:!0,gapMinutes:15});Z.assignments=n,Z.conflicts=t,ug(),dg(),vg();let r=Q.querySelector(`#hb-save-btn`);r&&(r.disabled=Z.assignments.length===0),hg(t.length>0?`Horario generado con ${t.length} conflicto(s)`:`Horario optimizado sin conflictos`,t.length>0?`warning`:`success`)}catch(e){console.error(`[horarioBuilderView] handleGenerate error:`,e),hg(`Error al generar: `+e.message,`danger`)}finally{mg(!1),e&&(e.disabled=!1)}}async function xg(){let e=Q.querySelector(`#hb-save-btn`);e&&(e.disabled=!0,e.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Guardando…`);try{let e=await fh({assignments:Z.assignments,periodo_id:Z.activePeriodo,estado:`borrador`});if(e?.id){Z.runId=e.id,Z.estado=`borrador`;let t=Q.querySelector(`#hb-publish-btn`);t&&(t.disabled=!1),hg(`Horario guardado como borrador`,`success`)}else hg(`Guardado incompleto: no se obtuvo ID del registro`,`warning`);Z.error=null}catch(e){console.error(`[horarioBuilderView] handleSave error:`,e),Z.error=e.message,hg(`Error al guardar: `+e.message,`danger`)}finally{e&&(e.disabled=!1,e.innerHTML=`<i class="bi bi-floppy-fill"></i> Guardar`)}}function Sg(){S.register(`horario-builder`,rg)}function Cg(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().split(`T`)[0]}function wg(e){return e?new Date(e).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):``}function Tg(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4),r=Math.floor(t/36e5),i=Math.floor(t/864e5);return n<2?`ahora mismo`:n<60?`hace ${n} min`:r<24?`hace ${r}h`:i<7?`hace ${i}d`:wg(e)}var Eg={enfermedad:`Médica`,personal:`Personal`,capacitacion:`Capacitación`,vacaciones:`Vacaciones`,otro:`Otro`};async function Dg(){let e=Cg(30),{data:t,error:n}=await _.from(`ausencias_maestros`).select(`
    ...
    `).gte(`fecha`,e).order(`fecha`,{ascending:!1});if(n)return console.warn(`[adminNotifApi] early warning fetch warn:`,n.message),[];let r={};for(let e of t||[]){let t=e.alumno_id;t&&(r[t]||(r[t]={nombre:e.alumnos?.nombre_completo||`Estudiante`,asistencias:[]}),r[t].asistencias.push(e.estado))}let i=[];for(let[e,t]of Object.entries(r)){let n=t.asistencias.length;if(n<3)continue;let r=0;for(let e of t.asistencias)if(e===`A`||e===`ausente`)r++;else if(e===`P`||e===`presente`||e===`T`||e===`tarde`)break;if(r>=3){i.push({id:`riesgo-alumno-ausencias:${e}`,source:`riesgo`,sourceId:e,priority:`alta`,actionable:!1,estado:`info`,icon:`bi-exclamation-triangle-fill`,iconColor:`#ef4444`,category:`compliance`,titulo:`Riesgo de Deserción: ${t.nombre}`,subtitulo:`Acumula ${r} inasistencias consecutivas en los últimos 30 días.`,motivo:`Acción recomendada: Contactar de urgencia al tutor legal o revisar ficha médica.`,timestamp:new Date().toISOString(),timeAgo:`ahora mismo`,actionRoute:`alumno?id=${e}`,actionLabel:`Ver Ficha`});continue}let a=t.asistencias.filter(e=>e===`P`||e===`presente`).length,o=a/n;o<.7&&i.push({id:`riesgo-alumno-rate:${e}`,source:`riesgo`,sourceId:e,priority:`media`,actionable:!1,estado:`info`,icon:`bi-graph-down`,iconColor:`#f59e0b`,category:`compliance`,titulo:`Bajo Compliance Académico: ${t.nombre}`,subtitulo:`Asistencia del ${Math.round(o*100)}% en los últimos 30 días (${a} de ${n} clases).`,motivo:`Acción recomendada: Coordinar entrevista de seguimiento y analizar tutoría.`,timestamp:new Date().toISOString(),timeAgo:`ahora mismo`,actionRoute:`alumno?id=${e}`,actionLabel:`Ver Ficha`})}return i}async function Lg(){let[e,t,n,r,i,a]=await Promise.allSettled([Dg(),kg(),jg(),Ng(),Fg(),Ig()]),o=[];try{o=await Fg()}catch(e){console.warn(`[adminNotifApi] fallback active maestros failed:`,e)}let s=e.status===`fulfilled`?e.value.map(e=>Og(e,o)):[],c=t.status===`fulfilled`?Ag(t.value):[],l=n.status===`fulfilled`?Mg(n.value):[],u=r.status===`fulfilled`?r.value.map(Pg):[],d=a.status===`fulfilled`?a.value:[],f=[...s,...c,...l,...u,...d],p={alta:0,media:1,baja:2,info:3};return f.sort((e,t)=>{if(e.actionable!==t.actionable)return e.actionable?-1:1;let n=p[e.priority]??4,r=p[t.priority]??4;return n===r?(t.timestamp||``).localeCompare(e.timestamp||``):n-r}),f}async function Rg(){let[e,t]=await Promise.allSettled([_.from(`ausencias_maestros`).select(`id`,{count:`exact`,head:!0}).eq(`estado`,`pendiente`),_.from(`profiles`).select(`id`,{count:`exact`,head:!0}).eq(`rol`,`maestro`).eq(`estado`,`pendiente`)]);return(e.status===`fulfilled`&&!e.value.error&&e.value.count||0)+(t.status===`fulfilled`&&!t.value.error&&t.value.count||0)}async function zg(){let{data:e,error:t}=await _.from(`profiles`).select(`id, nombre_completo, email`).eq(`rol`,`maestro`).eq(`estado`,`activo`).order(`nombre_completo`,{ascending:!0});if(t)throw t;return(e||[]).map(e=>({profile_id:e.id,nombre:e.nombre_completo||e.email||`Maestro`,email:e.email}))}async function Bg(e,{titulo:t,mensaje:n,deep_link:r=`/notificaciones`}){if(!e?.length)throw Error(`Se requiere al menos un destinatario`);let i=e.map(e=>({profile_id:e,tipo:`aviso_admin`,titulo:t,mensaje:n,deep_link:r,estado:`pendiente`})),{error:a}=await _.from(`notificaciones`).insert(i);if(a)throw a;let o=0;try{o=(await Promise.allSettled(e.map(e=>fetch(`/functions/v1/send-push`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer `,apikey:``},body:JSON.stringify({profile_id:e,title:t,body:n,data:{tipo:`aviso_admin`,deepLink:r}})}).then(e=>e.ok?e.json():Promise.reject(Error(`HTTP ${e.status}`)))))).filter(e=>e.status===`fulfilled`&&e.value?.sent>0).length}catch(e){console.warn(`[adminNotifApi] Web push dispatch failed (in-app notif still sent):`,e.message)}return{sent:i.length,pushed:o}}async function Vg({limit:e=50}={}){let{data:t,error:n}=await _.from(`notificaciones`).select(`id, titulo, mensaje, deep_link, estado, created_at, profile_id`).eq(`tipo`,`aviso_admin`).order(`created_at`,{ascending:!1}).limit(e*20);if(n)throw n;if(!t?.length)return[];let r=new Map;for(let e of t){let t=e.created_at?.slice(0,16),n=`${e.titulo}|${t}`;r.has(n)||r.set(n,{titulo:e.titulo,mensaje:e.mensaje,deep_link:e.deep_link,created_at:e.created_at,recipients:[]}),r.get(n).recipients.push(e.profile_id)}return[...r.values()].slice(0,e).map(e=>({...e,recipientCount:e.recipients.length}))}async function Hg(){let{data:e,error:t}=await _.from(`ausencias_maestros`).select(`
      ...
      estado,
      created_at
    `).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(t)throw t;if(!e||e.length===0)return[];let n=[...new Set(e.map(e=>e.maestro_id).filter(Boolean))];if(n.length>0){let{data:t,error:r}=await _.from(`profiles`).select(`id, nombre_completo, email`).in(`id`,n);if(!r&&t){let n=new Map(t.map(e=>[e.id,e]));return e.map(e=>{let t=n.get(e.maestro_id);return{...e,maestros:t?{nombre_completo:t.nombre_completo,correo:t.email}:e.maestros||null}})}}return e.map(e=>({...e,maestros:e.maestros||null}))}async function Ug(e,t,n){let{data:r,error:i}=await _.from(`ausencias_maestros`).update({estado:t,decision_notas:n||null,decidido_en:new Date().toISOString()}).eq(`id`,e).select().single();if(i)throw i;return r}function Wg(e,t=``){return Ug(e,`aprobada`,t)}function Gg(e,t=``){return Ug(e,`rechazada`,t)}var Kg=new Ce(`admin-notifications`),qg=null,Jg=null,Yg=null;function Xg(){clearTimeout(Yg),Yg=setTimeout(async()=>{try{let e=await Rg();Jg?.(e)}catch(e){console.warn(`[realtimeService] count fetch failed:`,e.message)}},800)}function Zg(e,t){if(!(typeof Notification>`u`)&&Notification.permission===`granted`&&(localStorage.getItem(`current-view`)||``)!==`admin-notificaciones`)try{new Notification(e,{body:t,icon:`/icons/icon-192x192.png`,badge:`/icons/icon-72x72.png`,tag:`admin-notif`,renotify:!0})}catch{}}function Qg(e){qg||(Jg=e,typeof Notification<`u`&&Notification.permission===`default`&&Notification.requestPermission().catch(()=>{}),qg=_.channel(`admin-notif-realtime`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`ausencias_maestros`},e=>{Zg(`📅 Nueva solicitud de ausencia`,`Un maestro solicitó una ausencia — revisá el Centro de Actividad.`),Xg()}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`ausencias_maestros`,filter:`estado=eq.pendiente`},()=>Xg()).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`profiles`,filter:`rol=eq.maestro`},e=>{Zg(`👤 Nuevo maestro pendiente de aprobación`,`${e.new?.nombre_completo||`Un maestro`} se registró y está esperando aprobación.`),Xg()}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`profiles`,filter:`estado=eq.pendiente`},()=>Xg()).subscribe(e=>{e===`SUBSCRIBED`?Xg():(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&console.warn(`[realtimeService] Channel error, will retry on reconnect`)}),Kg.registerChannel(qg))}function $g(){Kg.destroy(),qg=null,Jg=null,clearTimeout(Yg),Yg=null}function e_(){Jg?.(0)}function t_(){if(document.getElementById(`anv-styles`))return;let e=document.createElement(`style`);e.id=`anv-styles`,e.textContent=`
    .anv-root {
  ...
  `,document.head.appendChild(e)}var n_=[{key:`all`,label:`Todo`,icon:`bi-grid-fill`},{key:`ausencia`,label:`Ausencias`,icon:`bi-calendar-x-fill`},{key:`compliance`,label:`Alertas`,icon:`bi-exclamation-triangle-fill`},{key:`alumno`,label:`Novedades`,icon:`bi-person-plus-fill`}],r_={ausencia:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`},compliance:{bg:`rgba(245,158,11,0.1)`,color:`#f59e0b`},alumno:{bg:`rgba(59,130,246,0.1)`,color:`#3b82f6`},maestro:{bg:`rgba(239,68,68,0.1)`,color:`#ef4444`}},i_={ausencia:`Ausencia`,compliance:`Alerta`,alumno:`Novedad`,maestro:`Seguridad`},a_={aprobada:{label:`Aprobada`,bg:`rgba(34,197,94,0.12)`,color:`#16a34a`,icon:`bi-check-circle-fill`},rechazada:{label:`Rechazada`,bg:`rgba(239,68,68,0.12)`,color:`#dc2626`,icon:`bi-x-circle-fill`},pendiente:{label:`Pendiente`,bg:`rgba(245,158,11,0.12)`,color:`#d97706`,icon:`bi-hourglass-split`}};async function o_(e){t_(),`Notification`in window&&Notification.permission===`default`&&Notification.requestPermission();let t=[],n=`all`,r=``,i=null;function a(){e.innerHTML=`
      <div class="anv-root">
    ...
    `,n.querySelectorAll(`[data-action]`).forEach(r=>{r.addEventListener(`click`,async i=>{i.stopPropagation();let a=r.dataset.action;if(a===`goto`){let e=window.router||S;if(e){let[t,n]=(r.dataset.route||``).split(`?`),i=r.dataset.params?JSON.parse(r.dataset.params):{};n&&new URLSearchParams(n).forEach((e,t)=>{i[t]=e}),e.navigate(t,i)}return}if(a===`notify-sub`){let e=r.dataset.subName;r.disabled=!0,r.innerHTML=`<i class="bi bi-check-lg"></i> Propuesto`,r.className=`anv-suplente-btn notified`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Propuesta de suplencia enviada a ${e}`,type:`success`}}));return}if(n.querySelectorAll(`[data-action="approve"],[data-action="reject"],[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!0),a===`approve`){r.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{await Wg(e.sourceId,``),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Ausencia aprobada con éxito`,type:`success`}})),e.actionable=!1,e.estado=`aprobada`,e.priority=`info`,e.icon=`bi-calendar-check-fill`,e.iconColor=`#22c55e`;let r=u(e,t);r.style.animation=`anv-fadein 0.3s ease`,n.replaceWith(r),s(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),n.querySelectorAll(`[data-action="approve"],[data-action="reject"]`).forEach(e=>e.disabled=!1),r.innerHTML=`<i class="bi bi-check-circle"></i> Aprobar`}}else if(a===`reject`){r.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{await Gg(e.sourceId,``),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Ausencia rechazada con éxito`,type:`success`}})),e.actionable=!1,e.estado=`rechazada`,e.priority=`info`,e.icon=`bi-calendar-minus-fill`,e.iconColor=`#ef4444`;let r=u(e,t);r.style.animation=`anv-fadein 0.3s ease`,n.replaceWith(r),s(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),n.querySelectorAll(`[data-action="approve"],[data-action="reject"]`).forEach(e=>e.disabled=!1),r.innerHTML=`<i class="bi bi-x-circle"></i> Rechazar`}}else if(a===`approve-maestro`){r.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{let{error:r}=await _.from(`profiles`).update({estado:`activo`}).eq(`id`,e.sourceId);if(r)throw r;window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Maestro aprobado con éxito`,type:`success`}})),e.actionable=!1,e.estado=`activo`,e.priority=`info`,e.icon=`bi-person-check-fill`,e.iconColor=`#22c55e`,e.titulo=`Maestro registrado aprobado: ${e.titulo.replace(`Nuevo maestro registrado esperando aprobación: `,``)}`;let i=u(e,t);i.style.animation=`anv-fadein 0.3s ease`,n.replaceWith(i),s()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),n.querySelectorAll(`[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!1),r.innerHTML=`<i class="bi bi-check-circle"></i> Aprobar`}}else if(a===`reject-maestro`){r.innerHTML=`<span class="anv-spinner" style="width:0.8rem;height:0.8rem;border-width:2px;margin:0"></span>`;try{let{error:r}=await _.from(`profiles`).update({estado:`rechazado`}).eq(`id`,e.sourceId);if(r)throw r;window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Maestro rechazado con éxito`,type:`success`}})),e.actionable=!1,e.estado=`rechazado`,e.priority=`info`,e.icon=`bi-person-dash-fill`,e.iconColor=`#ef4444`,e.titulo=`Maestro registrado rechazado: ${e.titulo.replace(`Nuevo maestro registrado esperando aprobación: `,``)}`;let i=u(e,t);i.style.animation=`anv-fadein 0.3s ease`,n.replaceWith(i),s()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error: `+e.message,type:`error`}})),n.querySelectorAll(`[data-action="approve-maestro"],[data-action="reject-maestro"]`).forEach(e=>e.disabled=!1),r.innerHTML=`<i class="bi bi-x-circle"></i> Rechazar`}}})}),n}function d(){let i=e.querySelector(`#anv-body`),a=e.querySelector(`#anv-showing`);if(!i)return;let o=t;if(n===`critica`?o=t.filter(e=>e.actionable||e.priority===`alta`):n!==`all`&&(o=t.filter(e=>e.category===n)),r.trim().length>0){let e=r.toLowerCase().trim();o=o.filter(t=>(t.titulo||``).toLowerCase().includes(e)||(t.subtitulo||``).toLowerCase().includes(e)||(t.motivo||``).toLowerCase().includes(e)||(t.maestroInstrumento||``).toLowerCase().includes(e))}if(a&&(a.textContent=o.length===0?`Sin eventos encontrados`:`${o.length} evento${o.length>1?`s`:``}`),o.length===0){i.innerHTML=`
      ...
      `);try{t=await Lg(),s(),o(),d(),l()}catch(n){console.error(`[adminNotificacionesView] load error:`,n);let r=e.querySelector(`#anv-body`);r&&t.length===0&&(r.innerHTML=`
          <div class="anv-center">
    ...
    `,size:`lg`,hideSave:!0,cancelText:`Entendido`})}async function m(){let e=[];try{e=await zg()}catch{}let t=e.map(e=>`<option value="${e.profile_id}">${e.nombre}</option>`).join(``);b.open({title:`<i class="bi bi-send-fill me-2 text-warning"></i>Enviar notificación a maestros`,body:`
        <div class="mb-3">
      ...
      </div>`).join(``);b.open({title:`<i class="bi bi-clock-history me-2"></i>Historial <span class="badge bg-secondary ms-1">${e.length}</span>`,body:`<div style="max-height:420px;overflow-y:auto;">${n}</div>`,hideSave:!0,cancelText:`Cerrar`})}return a(),await f(),e_(),e.querySelector(`#anv-refresh-btn`)?.addEventListener(`click`,()=>f(!1)),e.querySelector(`#anv-btn-send-notif`)?.addEventListener(`click`,()=>m()),e.querySelector(`#anv-btn-historial`)?.addEventListener(`click`,()=>ee()),function(){i&&=(_.removeChannel(i),null)}}function s_(){S.register(`admin-notificaciones`,e=>{try{o_(e)}catch(t){console.error(`[admin-notificaciones] Error al renderizar la vista:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar el Centro de Actividad: ${t.message}</p>
        </div>
      `}})}async function c_(e){e.innerHTML=`
  ...
  `;try{let{data:t,error:n}=await _.from(`profiles`).select(`id, email, nombre_completo, created_at`).eq(`rol`,`maestro`).eq(`estado`,`pendiente`).order(`created_at`,{ascending:!0});if(n)throw n;let r=e.querySelector(`#aprobacion-content`);if(!t||t.length===0){r.innerHTML=`
          ...
          <tbody>
            ${t.map(e=>`
              <tr data-profile-id="${e.id}">
                <td>${d_(e.nombre_completo||`—`)}</td>
                <td>${d_(e.email)}</td>
                <td>${d_(e.instrumento||`—`)}</td>
                <td>${f_(e.created_at)}</td>
    ...
    `,r.querySelectorAll(`.btn-aprobar`).forEach(e=>{e.addEventListener(`click`,()=>l_(e.dataset.id,r))}),r.querySelectorAll(`.btn-rechazar`).forEach(e=>{e.addEventListener(`click`,()=>u_(e.dataset.id,`rechazado`,null,r))})}catch(t){let n=e.querySelector(`#aprobacion-content`);n.innerHTML=`
    ...
    `,n.querySelector(`#btn-retry-aprobacion`)?.addEventListener(`click`,()=>c_(e)),console.error(`[AprobacionView] Error:`,t.message)}}function l_(e,t){b.open({title:`Aprobar Usuario`,size:`sm`,saveText:`Aprobar`,body:`
    ...
    `,onSave:async n=>{let r=n.querySelector(`#aprobacion-rol-select`).value;await u_(e,`activo`,r,t)}})}async function u_(e,t,n,r){let i=r?.querySelector(`tr[data-profile-id="${e}"]`);if(!(!i&&r)){i?.querySelectorAll(`button`).forEach(e=>e.disabled=!0);try{if(t===`activo`){let t=!1,{data:r,error:i}=await _.rpc(`approve_maestro_profile`,{p_profile_id:e,p_new_rol:n||`maestro`,p_new_estado:`activo`});if(!i&&r?.success&&(t=!0),!t){console.warn(`[AprobacionView] RPC falló, usando operaciones directas:`,i?.message||r?.error);let{error:t,count:a}=await _.from(`profiles`).update({rol:n||`maestro`,estado:`activo`}).eq(`id`,e).select();if(t)throw Error(`No se pudo actualizar el perfil: ${t.message}`);let{data:o}=await _.from(`profiles`).select(`estado, rol`).eq(`id`,e).maybeSingle();if(o?.estado!==`activo`)throw Error(`No se pudo activar el perfil. Por favor cerrá sesión e iniciá sesión nuevamente como admin, luego intentá aprobar de nuevo.`)}if(n===`maestro`||!n){let{data:t}=await _.from(`profiles`).select(`id, email, nombre_completo`).eq(`id`,e).maybeSingle();if(t){let{data:e}=await _.from(`maestros`).select(`id, user_id`).or(`user_id.eq.${t.id},correo.eq.${t.email}`).maybeSingle();e?e.user_id||await _.from(`maestros`).update({user_id:t.id}).eq(`id`,e.id):await _.from(`maestros`).insert({user_id:t.id,nombre_completo:t.nombre_completo,correo:t.email,instrumento:``,activo:!0})}}}else{let{error:n}=await _.from(`profiles`).update({estado:t}).eq(`id`,e);if(n)throw n}i&&(i.style.transition=`opacity 0.3s ease`,i.style.opacity=`0`,setTimeout(()=>i.remove(),300));let a=n===`admin`?`Admin`:`Maestro`;if(window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t===`activo`?`${a} aprobado correctamente`:`Usuario rechazado`,type:`success`}})),r){let e=r.querySelector(`tbody`);e&&e.querySelectorAll(`tr`).length===0&&(r.innerHTML=`
        ...
        `)}}catch(e){i?.querySelectorAll(`button`).forEach(e=>e.disabled=!1),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al ${t===`activo`?`aprobar`:`rechazar`} usuario: ${e.message}`,type:`error`}})),console.error(`[AprobacionView] Action error:`,e.message)}}}function d_(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function f_(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`es-ES`,{year:`numeric`,month:`short`,day:`numeric`})}catch{return e}}function $(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function p_(e){if(!e)return`—`;let[t,n,r]=e.split(`-`);return`${r}/${n}/${t}`}function m_(e){let t=p_(e.fecha_inicio);return!e.fecha_fin||e.fecha_fin===e.fecha_inicio?t:`${t} → ${p_(e.fecha_fin)}`}function h_(e){return e.maestros?.nombre_completo||e.maestro_nombre||`Maestro no especificado`}function g_(e){return e.maestros?.correo||``}var __={enfermedad:{label:`Médica`,icon:`bi-heart-pulse-fill`,color:`#ef4444`},personal:{label:`Personal`,icon:`bi-person-fill`,color:`#3b82f6`},capacitacion:{label:`Capacitación`,icon:`bi-mortarboard-fill`,color:`#8b5cf6`},vacaciones:{label:`Vacaciones`,icon:`bi-sun-fill`,color:`#f59e0b`},otro:{label:`Otro`,icon:`bi-three-dots`,color:`#6b7280`}},v_={baja:{label:`Baja`,color:`#22c55e`,bg:`rgba(34,197,94,0.12)`},media:{label:`Media`,color:`#f59e0b`,bg:`rgba(245,158,11,0.12)`},alta:{label:`Alta`,color:`#ef4444`,bg:`rgba(239,68,68,0.12)`}};function y_(e){if(e.clase_emergente?.fecha){let t=e.clase_emergente.hora?` a las ${e.clase_emergente.hora}`:``;return`<i class="bi bi-calendar-check"></i> Reprogramada para ${e.clase_emergente.fecha}${t}`}return e.maestro_suplente_id||e.suplente_nombre?`<i class="bi bi-person-check"></i> Suplente: ${$(e.suplente_nombre||e.maestro_suplente_id)}`:`<i class="bi bi-clock"></i> Pendiente de coordinación`}function b_(){if(document.getElementById(`ausencia-aprobacion-card-styles`))return;let e=document.createElement(`style`);e.id=`ausencia-aprobacion-card-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function x_(e,{onApprove:t=()=>{},onReject:n=()=>{}}={}){b_();let r=__[e.tipo_ausencia]||__.otro,i=v_[e.urgencia]||{label:e.urgencia||`Normal`,color:`#6b7280`,bg:`rgba(107,114,128,0.12)`},a=Array.isArray(e.clases_afectadas)?e.clases_afectadas.length:0,o=h_(e),s=o.split(` `).map(e=>e[0]).join(``).slice(0,2).toUpperCase(),c=document.createElement(`article`);c.className=`ausencia-approval-card`,c.dataset.ausenciaCard=e.id,c.style.setProperty(`--aac-tipo-color`,r.color);let l=e.created_at?new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}):``;c.innerHTML=`
    ...
    <div class="aac-header">
      ...
      <div class="aac-header-info">
        ...
        <p class="aac-teacher-email">${$(g_(e))}</p>
    ...
    <div class="aac-body">
      ...
      <div class="aac-coverage">${y_(e)}</div>
  ...
  `,document.head.appendChild(e)}function w_(e){C_(),e.innerHTML=`
    <div class="aav-root">
  ...
  `}function T_(e,t){let n=t.length,r=t.filter(e=>e.urgencia===`alta`).length,i=t.filter(e=>e.urgencia===`media`).length;e.innerHTML=`
    <div class="aav-stat">
      <div>
  ...
  `}async function D_(e){let t=e.querySelector(`#aav-content`),n=e.querySelector(`#aav-stats-row`),r=e.querySelector(`#aav-count-label`),i=e.querySelector(`#aav-refresh-btn`);t&&(t.innerHTML=`
      <div class="aav-loading">
        <div class="aav-spinner"></div>
        <span>Cargando solicitudes...</span>
      </div>
    `);try{let i=await Hg();if(n&&T_(n,i),r&&(r.textContent=i.length===0?`Sin solicitudes pendientes`:`${i.length} solicitud${i.length>1?`es`:``} pendiente${i.length>1?`s`:``}`),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate(),!i.length){E_(t);return}t.innerHTML=``;let a=document.createElement(`div`);a.className=`aav-list`,t.appendChild(a);let o=[...i].sort((e,t)=>{let n={alta:0,media:1,baja:2},r=n[e.urgencia]??3,i=n[t.urgencia]??3;return r===i?(e.created_at||``).localeCompare(t.created_at||``):r-i});for(let t of o)a.appendChild(x_(t,{onApprove:async(t,n)=>{await Wg(t,n),S_(`Ausencia aprobada`,`success`),await D_(e)},onReject:async(t,n)=>{await Gg(t,n),S_(`Ausencia rechazada`,`success`),await D_(e)}}))}catch(e){t&&(t.innerHTML=`
        <div class="aav-error">
          <i class="bi bi-exclamation-triangle"></i>
          Error al cargar solicitudes: ${e.message}
        </div>
      `),S_(`Error al cargar ausencias: ${e.message}`,`error`)}finally{i&&i.classList.remove(`spinning`)}}async function O_(e){w_(e);let t=e.querySelector(`.aav-root`);await D_(t);let n=e.querySelector(`#aav-refresh-btn`);n&&n.addEventListener(`click`,async()=>{n.classList.add(`spinning`),await D_(t)})}function k_(){S.register(`admin-aprobacion`,async e=>{try{await c_(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de aprobaciones:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la aprobación de maestros: ${t.message}</p>
        </div>
      `}}),S.register(`admin-ausencias`,async e=>{try{await O_(e)}catch(t){console.error(`[admin-aprobacion] Error al renderizar la vista de ausencias:`,t),e.innerHTML=`
        <div class="pm-placeholder">
          <i class="bi bi-exclamation-triangle"></i>
          <p>Error al cargar la gestión de ausencias: ${t.message}</p>
        </div>
      `}})}if(pe(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;window.bootstrap=Ve,window.router=S;var A_=[{id:`programas`,label:`Programas`,icon:`bi-book`,description:`Gestión de programas académicos`,enabled:!0,register:Nr},{id:`academic-admin`,label:`Gestión Curricular`,icon:`bi-diagram-3`,description:`Gestión de mapa curricular y recursos`,enabled:!0,register:$p},{id:`admin-dashboard`,label:`Dashboard Administrativo`,icon:`bi-speedometer2`,description:`Panel de control, reportes y analítica de maestros`,enabled:!0,register:hm},{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`,description:`Alertas tempranas de riesgo y sustituciones sugeridas`,enabled:!0,register:s_},{id:`admin-aprobacion`,label:`Aprobación de Maestros`,icon:`bi-person-check`,description:`Aprobación de maestros y gestión de ausencias`,enabled:!0,register:k_},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`,description:`Gestión de maestros/docentes`,enabled:!0,register:ir},{id:`alumnos`,label:`Alumnos`,icon:`bi-people`,description:`Gestión de estudiantes`,enabled:!0,register:Gc},{id:`salones`,label:`Salones`,icon:`bi-door-open`,description:`Gestión de espacios de clase`,enabled:!0,register:ol},{id:`clases`,label:`Clases`,icon:`bi-easel`,description:`Gestión de clases y horarios`,enabled:!0,register:yl},{id:`horario-builder`,label:`Constructor de Horarios`,icon:`bi-calendar-range`,description:`Motor de asignación y optimización de horarios`,enabled:!0,register:Sg},{id:`asistencias`,label:`Asistencias`,icon:`bi-calendar-check`,description:`Control de asistencia`,enabled:!0,register:Bl},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`,description:`Planificación pedagógica`,enabled:!0,register:Ju},{id:`progresos`,label:`Progresos`,icon:`bi-graph-up`,description:`Calificaciones y progreso`,enabled:!0,register:xd},{id:`observaciones`,label:`Observaciones`,icon:`bi-chat-quote`,description:`Anotaciones disciplinarias`,enabled:!0,register:Vd},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`,description:`KPIs, alertas y análisis institucional`,enabled:!0,register:Fp},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`,description:`Permisos y roles de maestros`,enabled:!0,register:Lm},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,description:`Dashboard, seguimiento y reportes pedagógicos`,enabled:!0,register:ih},{id:`config`,label:`Configuración`,icon:`bi-gear`,description:`Configuración del sistema`,enabled:!0,register:Ip}];function j_(){let e=localStorage.getItem(`app-theme`),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches,n=e===`dark`||e===null&&t;return document.documentElement.setAttribute(`data-bs-theme`,n?`dark`:`light`),n}function M_(){let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-bs-theme`,e),localStorage.setItem(`app-theme`,e)}var N_=[{id:`academico`,label:`Académico`,icon:`bi-easel`,items:[{id:`programas`,label:`Programas`,icon:`bi-book`},{id:`clases`,label:`Clases`,icon:`bi-easel2`},{id:`salones`,label:`Salones`,icon:`bi-door-open`},{id:`horario-builder`,label:`Constructor Horarios`,icon:`bi-calendar-range`}]},{id:`personas`,label:`Personas`,icon:`bi-people`,items:[{id:`alumnos`,label:`Alumnos`,icon:`bi-people`},{id:`maestros`,label:`Maestros`,icon:`bi-person-check`},{id:`postulados`,label:`Postulados`,icon:`bi-person-plus-fill`},{id:`postulados-calendario`,label:`Calendario Citas`,icon:`bi-calendar-event`}]},{id:`pedagogico`,label:`Pedagógico`,icon:`bi-journal-check`,items:[{id:`pedagogico-dashboard`,label:`Dashboard`,icon:`bi-grid-1x2`},{id:`planificacion`,label:`Planificación`,icon:`bi-journal-text`},{id:`planificacion-maestros`,label:`Todas las Planes`,icon:`bi-journal-check`},{id:`planificacion-cobertura`,label:`Cobertura Curricular`,icon:`bi-grid-3x3-gap`},{id:`pedagogico-seguimiento`,label:`Seguimiento`,icon:`bi-person-lines-fill`},{id:`pedagogico-reportes`,label:`Reportes`,icon:`bi-file-earmark-bar-graph`}]},{id:`analisis`,label:`Análisis`,icon:`bi-bar-chart-line`,items:[{id:`metricas`,label:`Dashboard`,icon:`bi-bar-chart-line`},{id:`admin-dashboard`,label:`Cumplimiento Maestros`,icon:`bi-clipboard-check`},{id:`admin-dashboard-reportes`,label:`Reportes Director`,icon:`bi-file-earmark-pdf`},{id:`admin-dashboard-analitca-llenado`,label:`Analítica Llenado`,icon:`bi-graph-up`},{id:`admin-dashboard-tendencias`,label:`Tendencias`,icon:`bi-arrow-up-right`}]},{id:`sistema`,label:`Sistema`,icon:`bi-gear`,items:[{id:`admin-notificaciones`,label:`Centro de Actividad`,icon:`bi-bell`},{id:`admin-aprobacion`,label:`Aprobaciones`,icon:`bi-person-check`},{id:`admin-ausencias`,label:`Gestión Ausencias`,icon:`bi-calendar-x`},{id:`configuracion`,label:`Configuración`,icon:`bi-sliders`},{id:`permisos`,label:`Permisos`,icon:`bi-shield-lock`},{id:`importar-datos`,label:`Importar Datos`,icon:`bi-cloud-upload`},{id:`exportar-datos`,label:`Exportar Datos`,icon:`bi-file-earmark-arrow-down`}]}];function P_(e){for(let t of N_)if(t.items.some(t=>t.id===e))return t.id;return N_[0].id}var F_=null;function I_(e){let t=document.getElementById(`sidebar-notif-badge`);t&&(e>0?(t.textContent=e>99?`99+`:String(e),t.style.display=`inline-flex`):t.style.display=`none`)}function L_(e,t=!1){F_?.abort(),F_=new AbortController;let{signal:n}=F_;if(document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),document.querySelector(`.mobile-sub-sheet`)?.remove(),!t)return;let r=w.getUser(),i=r?r.email||r.full_name||`Usuario`:``,a=localStorage.getItem(`current-view`)||`programas`,o=P_(a),s=document.documentElement.getAttribute(`data-bs-theme`)===`dark`,c=x.isDemoMode,l=document.createElement(`aside`);l.className=`app-sidebar`,l.innerHTML=`
  ...
  `;let u=document.createElement(`nav`);u.className=`app-bottom-nav`,u.innerHTML=N_.map(e=>`
  ...
  `,document.body.prepend(d),document.body.prepend(u),document.body.prepend(l),l.querySelectorAll(`.nav-group-header`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`.nav-group`),n=t.classList.contains(`expanded`);l.querySelectorAll(`.nav-group`).forEach(e=>e.classList.remove(`expanded`)),n||t.classList.add(`expanded`)})}),l.querySelectorAll(`.nav-item-btn`).forEach(e=>{e.addEventListener(`click`,()=>S.navigate(e.dataset.route))}),l.querySelector(`#sidebarBtnTheme`).addEventListener(`click`,()=>{M_();let e=document.documentElement.getAttribute(`data-bs-theme`)===`dark`;l.querySelector(`#sidebarBtnTheme i`).className=e?`bi bi-sun-fill`:`bi bi-moon-fill`}),l.querySelector(`#sidebarBtnLogout`).addEventListener(`click`,async()=>{await w.logout(),S.navigate(`login`)});function f(e){let t=N_.find(t=>t.id===e);if(!t)return;let n=localStorage.getItem(`current-view`)||``;document.getElementById(`sheetTitle`).textContent=t.label,document.getElementById(`sheetItems`).innerHTML=t.items.map(e=>`
      <button class="sheet-item ${e.id===n?`active`:``}" data-route="${e.id}">
        <i class="bi ${e.icon}"></i>
        <span>${e.label}</span>
      </button>
    `).join(``),d.dataset.group=e,d.classList.add(`open`),d.querySelectorAll(`.sheet-item`).forEach(e=>{e.addEventListener(`click`,()=>{S.navigate(e.dataset.route),d.classList.remove(`open`)})})}u.querySelectorAll(`.bottom-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.group;d.classList.contains(`open`)&&d.dataset.group===t?d.classList.remove(`open`):(f(t),u.querySelectorAll(`.bottom-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.group===t)))})}),document.addEventListener(`click`,e=>{d.classList.contains(`open`)&&!d.contains(e.target)&&!u.contains(e.target)&&d.classList.remove(`open`)},{signal:n}),window.addEventListener(`routeChanged`,e=>{let t=e.detail,n=P_(t);l.querySelectorAll(`.nav-item-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.route===t)),l.querySelectorAll(`.nav-group`).forEach(e=>{e.dataset.group===n?e.classList.add(`expanded`):e.classList.remove(`expanded`)}),u.querySelectorAll(`.bottom-tab`).forEach(e=>e.classList.toggle(`active`,e.dataset.group===n))},{signal:n})}function R_(){try{Xt()}catch(e){console.error(`Error registering auth routes:`,e)}A_.filter(e=>e.enabled&&e.register).forEach(e=>{try{e.register()}catch(t){console.error(`Error registering module ${e.id}:`,t)}})}async function z_(){let e=document.querySelector(`#app`);if(!e){console.error(`El contenedor #app no existe en el HTML`);return}j_(),R_(),S.initCustomEvents(),console.log(`🔄 Sincronizando sesión...`),await w.refreshAuth();let t=[`login`,`register`];S.setAuthGuard(()=>w.isAuthenticated(),t);let n=localStorage.getItem(`current-view`)||`programas`,r=w.isAuthenticated();!r&&!t.includes(n)?(localStorage.setItem(`current-view`,`login`),S.navigate(`login`)):r&&t.includes(n)?(localStorage.setItem(`current-view`,`programas`),L_(e,!0),S.navigate(`programas`)):(r&&L_(e,!0),S.init()),w.subscribe(t=>{if(t.user)L_(e,!0),Qg(I_);else{$g(),e.innerHTML=``;let t=document.querySelector(`.app-navbar`);t&&t.remove(),document.querySelector(`.app-sidebar`)?.remove(),document.querySelector(`.app-bottom-nav`)?.remove(),document.querySelector(`.mobile-sub-sheet`)?.remove(),S.navigate(`login`)}})}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,z_):z_();function B_(){let e=localStorage.getItem(`current-view`)||`programas`,t=document.querySelector(`.teacher-bridge`);t&&(e===`programas`?t.classList.add(`visible`):t.classList.remove(`visible`))}B_(),window.addEventListener(`routeChanged`,e=>{B_()});var V_=document.querySelector(`.teacher-bridge`);V_&&V_.addEventListener(`click`,()=>{localStorage.setItem(`pm-modo`,`maestro`)});export{Zi as a,Xi as c,Yi as i,Qi as l,ea as n,ta as o,qi as r,Ji as s,ed as t,Qt as u};