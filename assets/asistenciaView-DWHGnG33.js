const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-CgmFcPKt.js","assets/AppModal-Du6jXNYA.js","assets/supabase-Cgh_dhNB.js","assets/LevelCompletionModal-Du_KQRU_.js","assets/portalUtils-CkF82Yyk.js","assets/AchievementsSummaryModal-DrGzVr84.js"])))=>i.map(i=>d[i]);
import{i as e,r as t,s as n}from"./AppModal-Du6jXNYA.js";import{c as r,d as i,o as a,p as o,r as s}from"./pwaInstaller-CABasb_l.js";import{a as c,i as l}from"./supabase-Cgh_dhNB.js";import{i as u}from"./maestroAuth-BMzDPnai.js";import{c as d,n as f,r as p,s as m,t as h}from"./main-maestros-DyyComUz.js";import{S as g}from"./planificacion-BdwKIwFz.js";import{t as _}from"./config-CNiOV0RX.js";import{l as v}from"./asistenciasApi-CKT-fCIb.js";import{t as y}from"./aiEvaluacionService-_0RGpDzq.js";import{_ as b,v as x,x as S}from"./mapaClaseService-DaoOTdhF.js";import{i as C,n as w,o as T,r as E}from"./reportService-RG3W9EjK.js";import{a as D,c as O,l as k,n as A,s as ee,u as j}from"./groqService-BEo2aU8D.js";import{t as M}from"./academicService-CgmFcPKt.js";import{t as N}from"./calificacionIndicadorPanel-BK40cdMQ.js";import{a as te,i as P,l as F,o as I,s as ne}from"./portalUtils-CkF82Yyk.js";import{t as re}from"./a11yUtils-DRYT20ux.js";import{a as L,c as R,d as ie,i as z,l as B,n as V,o as H,r as ae,s as oe,t as se}from"./weeklyPlanAdapter-E65PNMYx.js";import{a as ce,i as le,n as ue,o as de,r as fe}from"./evaluationService-Obv-vQVO.js";import{n as pe,r as U}from"./catalogService-M5LBxZnn.js";function me(e={}){let{showSyncButton:t=!0}=e,n=document.createElement(`div`);n.className=`pm-sync-badge`,n.style.cssText=`
    display: none;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{he(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function _e(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,Ce=class{constructor(e,t=xe){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(ye)||(this._autoTimer=setTimeout(()=>this.start(),be))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(ye,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=Se,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `,document.head.appendChild(e)}function W(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Te(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function G(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}var Ee={achieved:{color:`green`,icon:`🟢`,label:`Dominado`},in_process:{color:`yellow`,icon:`🟡`,label:`En proceso`},needs_reinforcement:{color:`orange`,icon:`🟠`,label:`Requiere refuerzo`},failed:{color:`red`,icon:`🔴`,label:`No aprobado`},exceeded:{color:`blue`,icon:`🔵`,label:`Sobresaliente`},not_started:{color:`gray`,icon:`⚫`,label:`Sin iniciar`}};function K(e){return Ee[e]||Ee.not_started}async function q(e,t,n=null){let r=[];if(n){let e=await L(n).catch(()=>null),t=e?.plan?.items||[],i=new Set;r=t.filter(e=>{let t=e.indicator_id||`${e.node_id}:${e.week_number}`;return i.has(t)?!1:(i.add(t),!0)}).map(t=>({id:t.indicator_id||t.node_id||t.id,nombre:t.topic||t.objective||`Indicador`,node:{id:t.node_id||t.id,name:t.topic||`Tema`,level:{id:e?.route?.level_id||null,level_number:t.week_number,name:`Semana ${t.week_number}`}}}))}if(!r.length&&_.isDemoMode){let{getFullHierarchy:e}=await c(async()=>{let{getFullHierarchy:e}=await import(`./routeMock-BWnDIWqo.js`);return{getFullHierarchy:e}},[]);(await e(n||`pclase_001`)).forEach(e=>{e.plan_temas.forEach(t=>{t.plan_objetivos.forEach(n=>{n.plan_indicators.forEach(n=>{r.push({id:n.id,nombre:n.descripcion,node:{id:t.id,name:t.nombre,level:{id:e.id,level_number:e.numero_nivel,name:e.nombre}}})})})})})}else if(!r.length){let{data:e,error:n}=await l.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(n)throw n;r=(e??[]).filter(e=>e.nodes!==null).map(e=>({id:e.id,nombre:e.nombre||e.description,node:e.nodes}))}let i=await R(n),a=r.map(t=>{let n=`${e}_${t.id}`,r=i[n]||null,a=K(r?.status||`not_started`);return{id:t.id,nombre:t.nombre,node:t.node,latestStatus:r?.status||`not_started`,latestObs:r?.observation||``,latestEvidence:r?.evidence_url||``,semColor:a.color,semIcon:a.icon,history:r?[r]:[]}}),o=a.filter(e=>e.latestStatus===`achieved`||e.latestStatus===`exceeded`).length,s=a.length;return{indicatorSummaries:a,dominados:o,total:s,avance:s>0?Math.round(o/s*100):0,pendingTasks:[]}}function De(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${W(Te(e.nombre_completo))}</div>
      <div>
  ...
  `}function Oe(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${W(G(e.updated_at||e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Estado: ${K(e.status).label}</span>
      ${e.observation?`<span class="pm-eval-timeline__detail">${W(e.observation)}</span>`:``}
  ...
  `}function ke(e){return e.length?e.map((e,t)=>`
    <div class="pm-route-indicador pm-route-indicador--${W(e.semColor)}"
      ...
      <div class="pm-route-indicador__info">
        ...
        <span class="pm-route-indicador__stats">
          ${e.latestStatus===`not_started`?`Sin evaluar`:`Estado: ${K(e.latestStatus).label}`}
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores cargados para este nivel.</p>`}function Ae(e,{indicatorSummaries:t,avance:n}){return`
    ${De(e,n)}
  ...
  `}function Ne({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a,onProgressSaved:o}){we();let s=document.createElement(`aside`);s.className=`pm-student-panel`,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-modal`,`false`),s.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(s);let c=[],l=null;function d(){ne()===`desktop`?s.classList.add(`pm-student-panel--desktop`):s.classList.remove(`pm-student-panel--desktop`)}let f=F(d);d();function p(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){v();return}if(n===`toggle-history`){let e=t.dataset.idx,n=s.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;m(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;m(e,n);return}}async function m(e,t=null){let n=c[e],r=t===null?null:n.history[t],i=r?.status??`not_started`,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
      <div class="pm-student-panel__modal-content">
        ...
        <div class="pm-student-panel__modal-body">
          ...
          <div class="pm-student-panel__modal-field">
            ...
            <textarea id="modal-obs" rows="3" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 12px; font-size: 0.9rem; resize: none; outline: none;" placeholder="Comentarios sobre el desempeño...">${r?W(r.observation):``}</textarea>
          </div>
          
          <div class="pm-student-panel__modal-field">
            <label>Enlace de Evidencia (Video/Audio)</label>
            <input type="text" id="modal-evidence" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 10px; font-size: 0.9rem; outline: none;" placeholder="URL de video o audio en drive/supabase..." value="${r?W(r.evidence_url):``}">
          </div>
        </div>
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-status]`);if(t){a.querySelectorAll(`[data-status]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=t.dataset.status;return}let r=e.target.closest(`[data-action]`)?.dataset.action;if(r===`modal-close`)a.remove();else if(r===`modal-save`){let e=a.querySelector(`#modal-obs`).value,t=a.querySelector(`#modal-evidence`).value;await g(n.id,i,e,t),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function g(t,r,i,a){try{if(!u())throw Error(`No hay sesión de maestro activa.`);await ie(e.id,t,r,i.trim(),a.trim(),n),typeof o==`function`&&await o({alumnoId:e.id,indicatorId:t,status:r}),await _()}catch(e){console.error(`[studentProgressPanel] Error saving:`,e),alert(`Error al guardar: `+(e.message||e))}}s.addEventListener(`click`,p),s.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function _(){s.innerHTML=je(),s.classList.add(`pm-student-panel--open`),l&&l.dispose(),l=h(s,{onClose:()=>v()});try{let n=await q(e.id,t,r);c=n.indicatorSummaries,s.innerHTML=Ae(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading:`,e),s.innerHTML=Me(e?.message??`Error desconocido al cargar datos.`)}}function v(){s.classList.remove(`pm-student-panel--open`),l&&=(l.dispose(),null),setTimeout(()=>{s.classList.contains(`pm-student-panel--open`)||(s.innerHTML=``,c=[])},300)}function y(){l&&=(l.dispose(),null),f(),s.removeEventListener(`click`,p),s.remove()}return{open:_,close:v,destroy:y}}var Pe={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Fe={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Ie={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function Le(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Re(e){return(e||``).trim().toLowerCase()}function ze(e){let t=new Map;for(let n of e){let e=Re(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Be(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Ie[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Ie[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=Pe[e.estado]||Pe.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Fe[e.estado]||``}`:`ssp-alumno-chip`}">${Le(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Le(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Le(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${Le(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Le(i)} · ${Le(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}var He=`documentos`;async function Ue(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await l.storage.from(He).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=l.storage.from(He).getPublicUrl(r);return o.publicUrl}async function We({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){let c=[];if(e||c.push(`sesionId`),t||c.push(`alumnoId`),r||c.push(`fecha`),i||c.push(`motivo`),o||c.push(`creadoPor`),c.length>0)return{error:{message:`Faltan campos requeridos: ${c.join(`, `)}`}};let u=null;if(s)try{u=await Ue(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let d={sesion_id:e,alumno_id:t,clase_id:n||null,fecha:r,motivo:i,evidencia_url:u||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:f,error:p}=await l.from(`justificaciones`).upsert([d],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:f,error:p}}async function Ge(e,t){if(!e||!t)return null;let{data:n,error:r}=await l.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function Ke(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await l.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}function qe(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function J(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function Je(e,t){let n=J(e);return t.find(e=>J(e.nombre)===n||J(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&J(e.nombre).includes(n)||n.length>=3&&n.includes(J(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Ye(e,t){let n=[],r=[];for(let i of e){if(J(i)===`todos`){n.push(...t);continue}let e=Je(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Xe(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await l.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function Ze({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=k(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await Xe(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function Qe({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Ye(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Xe(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function $e({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=ce(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Qe({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function et({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await l.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:J(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=J(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await l.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var tt={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},nt=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Y(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var rt={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function it(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=rt[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function at(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Y(n.join(`, `))}</span>`:``}}function o(e,t){let n=tt[e.estado]??tt.EN_PROGRESO,r=e.nota?` · ${Y(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Y(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=rt[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${it(c)}</div>`:``,d=j(r),f=d.length>0?`
    ...
    `,ot(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(nt.indexOf(i)+1)%nt.length;r[n].estado=nt[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function ot(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
  ...
  `,document.head.appendChild(e)}async function st(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await l.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=ct[e.tipo]??ct.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${ut(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${ut(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${ut(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}new Date().toISOString();var ft=n({actualizarCurriculo:()=>gt,actualizarObjetivo:()=>St,actualizarPilar:()=>yt,adoptarPropuesta:()=>wt,crearCurriculo:()=>ht,crearObjetivo:()=>xt,crearPilar:()=>vt,eliminarObjetivo:()=>Ct,eliminarPilar:()=>bt,listarCurriculos:()=>mt,obtenerCurriculo:()=>pt,toggleActivoCurriculo:()=>_t});async function pt(e,t){let n=l.from(`curriculos`).select(`
      id, instrumento, nivel, descripcion, activo,
      curriculo_pilares (
        id, nombre, orden,
        curriculo_objetivos ( id, descripcion, orden )
      )
    `).eq(`activo`,!0);e&&(n=n.eq(`instrumento`,e)),t&&(n=n.eq(`nivel`,t));let{data:r,error:i}=await n.maybeSingle();if(i)throw i;return r||null}async function mt(){let{data:e,error:t}=await l.from(`curriculos`).select(`
      id, instrumento, nivel, descripcion, activo, created_at,
      curriculo_pilares ( curriculo_objetivos ( id ) )
    `).order(`instrumento`);if(t)throw t;return(e||[]).map(e=>({...e,total_objetivos:e.curriculo_pilares?.reduce((e,t)=>e+(t.curriculo_objetivos?.length||0),0)??0}))}async function ht({instrumento:e,nivel:t,descripcion:n}){let{data:r,error:i}=await l.from(`curriculos`).insert({instrumento:e,nivel:t,descripcion:n}).select().single();if(i)throw i;return r}async function gt(e,t){let{data:n,error:r}=await l.from(`curriculos`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw r;return n}async function _t(e,t){return gt(e,{activo:t})}async function vt(e,t,n=0){let{data:r,error:i}=await l.from(`curriculo_pilares`).insert({curriculo_id:e,nombre:t,orden:n}).select().single();if(i)throw i;return r}async function yt(e,t){let{data:n,error:r}=await l.from(`curriculo_pilares`).update(t).eq(`id`,e).select().single();if(r)throw r;return n}async function bt(e){let{error:t}=await l.from(`curriculo_pilares`).delete().eq(`id`,e);if(t)throw t}async function xt(e,t,n=0){let{data:r,error:i}=await l.from(`curriculo_objetivos`).insert({pilar_id:e,descripcion:t,orden:n}).select().single();if(i)throw i;return r}async function St(e,t){let{data:n,error:r}=await l.from(`curriculo_objetivos`).update(t).eq(`id`,e).select().single();if(r)throw r;return n}async function Ct(e){let{error:t}=await l.from(`curriculo_objetivos`).delete().eq(`id`,e);if(t)throw t}async function wt({instrumento:e,nivel:t,descripcion:n,pilares:r}){if(!e||e.trim()===``)throw Error(`El instrumento es obligatorio para crear el plan.`);if(!r||r.length===0)throw Error(`La propuesta debe tener al menos un pilar.`);let i=await ht({instrumento:e.trim(),nivel:t?.trim()||``,descripcion:n?.trim()||`Plan generado por IA`}),a=[];for(let e=0;e<r.length;e++){let t=r[e],n=await vt(i.id,t.nombre||`Pilar ${e+1}`,e),o=t.objetivos||[];for(let e=0;e<o.length;e++){let t=await xt(n.id,o[e].descripcion||`Objetivo ${e+1}`,e);a.push({id:t.id,descripcion:t.descripcion})}}return{curriculo:i,allObjetivos:a}}var Tt=ft;async function Et(e){return Tt.adoptarPropuesta(e)}function Dt(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Ot(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function kt(e,t,n,r,i){if(!r)return`No hay datos de clase disponibles.`;let a=(e||[]).filter(e=>e.estado===`P`).length,o=(e||[]).filter(e=>e.estado===`A`).length,s=(e||[]).filter(e=>e.estado===`J`).length,c=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return c+=`Fecha: ${i||``}\n`,c+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,c+=`RESUMEN DE ASISTENCIA
`,c+=`Presentes: ${a} | Ausentes: ${o} | Justificados: ${s}\n\n`,t&&t.trim()&&(c+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),c+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;c+=`- ${t}: ${r}\n`}),c}function At(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function jt(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ${s?`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        ...
        <p class="pm-asist-subtitle">
          ${i?`📍 ${P(i)} · `:``}
          ${r?`${I(r.hora_inicio)} – ${I(r.hora_fin)} · `:``}
          <span style="color:var(--pm-primary); font-weight:700;">${te(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `;let d=e.querySelector(`#pm-asist-back`);return d&&u(d,`click`,c),{destroy(){l.forEach(e=>{try{e()}catch{}}),l.length=0}}}function Mt(e,{editor:t,toolbar:n}){let r=!1;return{inject(i,a){if(r||!i||i.claseId!==a)return;let o=`[${i.nombre}] `;t.insertText(o),n.setContext({indicadorActivo:i.nombre});let s=e.querySelector(`#btn-guardar-obs`);s&&(s.style.display=``);let c=e.querySelector(`#pm-dsl-editor-container`);if(c){let e=c.parentElement.querySelector(`.pm-ruta-tema-banner`);e&&e.remove();let t=document.createElement(`div`);t.className=`pm-ruta-tema-banner`,t.style.cssText=`
        ...
        `,t.innerHTML=`
          ...
          ">✕</button>
        `,c.parentElement.insertBefore(t,c)}},destroy(){r=!0}}}var Nt={pending:{label:`Pendiente`,icon:`⚪`,className:`pending`},viewed:{label:`Vista`,icon:`🟡`,className:`viewed`},graded:{label:`Calificada`,icon:`🟢`,className:`graded`},current:{label:`En curso`,icon:`🔵`,className:`current`}};function Pt(t,n){let r=null,i=null,a={},o={},s=[],c=t.querySelector(`#pm-planificacion-card`),l=t.querySelector(`#pm-planificacion-dropdown`),u=t.querySelector(`#pm-planificacion-nombre`),d=t.querySelector(`#pm-planificacion-header`),f=t.querySelector(`#pm-route-tree-container`);d&&(d.onclick=()=>{let e=c.classList.toggle(`open`);l.style.display=e?`block`:`none`});let p=t.querySelector(`.pm-planificacion-tabs-pill`);p&&(p.style.display=`none`);let m=t.querySelector(`#pm-plan-list-rutas`);m&&(m.style.display=`none`);let h=t.querySelector(`#pm-plan-list-planificaciones`);h&&(h.style.display=`none`);let g=t.querySelector(`#pm-curriculo-proposal-trigger`);if(g&&(g.style.display=`none`),!document.getElementById(`pm-weekly-card-styles`)){let e=document.createElement(`style`);e.id=`pm-weekly-card-styles`,e.textContent=`
      .pm-weekly-nav {
    ...
    `,document.head.appendChild(e)}function v(){return typeof n.getSessionState==`function`?n.getSessionState():{isRegistered:!1}}async function y(e){return!e||!n.claseId||!n.maestro?.id?{}:(await z(n.claseId,n.maestro.id,e).catch(()=>[])).reduce((e,t)=>(e[String(t.week_number)]=t,e),{})}function b(e){let t=o[String(e.week_number)]||null;return{...e,teacher_strategy:t?.teacher_strategy||e.teacher_strategy,student_activity:t?.student_activity||e.student_activity,homework:t?.homework||e.homework,evidence:t?.evidence||e.evidence,teacher_notes:t?.teacher_notes||``,hasTeacherAdjustment:!!t}}async function x(){try{if(c.style.display=``,r=await B(n.claseId),!r)if(_.isDemoMode)r=await V({group_id:n.claseId,weekly_plan_id:`wplan-violin-n0`,level_id:`pnivel_001`,teacher_id:n.maestro?.id||`maestro_001`});else{u&&(u.textContent=`Sin guía ACM asignada`),f&&(f.innerHTML=`
            ...
            `);return}a=await R(n.claseId).catch(()=>({})),i=r.weekly_plan_id&&await H?.(r.weekly_plan_id)||await oe(r.level_id,`violín`),o=await y(r?.weekly_plan_id),u&&(u.textContent=i?.instrument?`${i.instrument} · Ruta Activa ACM`:`Ruta Activa ACM`),T()}catch(e){console.error(`[PlanificationCard] Error inicializando:`,e),f&&(f.innerHTML=`<div style="color:#ef4444;font-size:0.8rem;padding:8px;">Error al cargar planificación semanal: ${e.message}</div>`)}}function S(e,t){return Object.keys(a).some(t=>e.indicator_id?t.endsWith(`_${e.indicator_id}`)&&a[t]?.status&&a[t]?.status!==`not_started`:!1)?Nt.graded:e.week_number<t||e.week_number===t&&v().isRegistered?Nt.viewed:e.week_number===t?Nt.current:Nt.pending}function C(e){return`
        ...
        <div class="pm-weekly-sequence">
          ${(i?.items||[]).map(t=>{let n=b(t),r=S(t,e);return`
              <div class="pm-weekly-sequence-item ${r.className}">
                <div>
                  <div class="pm-weekly-sequence-title">Semana ${t.week_number} · ${P(t.topic)}</div>
                  <div class="pm-weekly-sequence-meta">${P(n.assessment_method||n.evidence||`Sin evidencia registrada`)}</div>
      ...
      <div style="width:min(720px,100%);max-height:90vh;overflow:auto;background:var(--pm-surface,#0f172a);color:var(--pm-text,#fff);border:1px solid var(--pm-border,rgba(255,255,255,.1));border-radius:18px;">
        ...
        <form id="pm-weekly-adjustment-form" style="padding:16px 18px;display:grid;gap:14px;">
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Estrategia docente ajustada
            <textarea name="teacher_strategy" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${P(t.teacher_strategy||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Actividad del estudiante
            <textarea name="student_activity" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${P(t.student_activity||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Tarea
            <textarea name="homework" rows="2" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${P(t.homework||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Evidencia esperada ajustada
            <textarea name="evidence" rows="2" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${P(t.evidence||``)}</textarea>
          </label>
          <label style="display:grid;gap:6px;font-size:.85rem;font-weight:700;">Notas pedagógicas del maestro
            <textarea name="teacher_notes" rows="3" style="width:100%;border-radius:12px;padding:10px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);color:inherit;">${P(t.teacher_notes||``)}</textarea>
          </label>
    ...
    `;let a=()=>i.remove();i.querySelectorAll(`[data-close-modal]`).forEach(e=>{e.onclick=a}),i.onclick=e=>{e.target===i&&a()};let o=i.querySelector(`#pm-weekly-adjustment-form`);o.onsubmit=async i=>{i.preventDefault();let s=new FormData(o);try{await ae({group_id:n.claseId,teacher_id:n.maestro?.id,weekly_plan_id:r?.weekly_plan_id,week_number:t.week_number,teacher_strategy:String(s.get(`teacher_strategy`)||``).trim(),student_activity:String(s.get(`student_activity`)||``).trim(),homework:String(s.get(`homework`)||``).trim(),evidence:String(s.get(`evidence`)||``).trim(),teacher_notes:String(s.get(`teacher_notes`)||``).trim()}),e.success(`Ajuste docente guardado sin modificar la guía ACM.`),a(),await x()}catch(t){console.error(`[PlanificationCard] Error guardando ajuste docente:`,t),e.error(t.message||`No se pudo guardar el ajuste docente.`)}},document.body.appendChild(i)}function T(){if(!f||!i)return;let e=r.current_week||1,a=(i.items||[]).find(t=>t.week_number===e),o=a?b(a):null;if(!o){f.innerHTML=`<div style="padding:10px;font-size:0.8rem;color:var(--pm-text-muted);">No hay planificación registrada para la Semana ${e}</div>`;return}let s=t.querySelector(`#pm-active-tema-badge`);s&&(s.textContent=`Semana ${e}: ${o.topic}`,s.style.display=`inline-block`),f.innerHTML=`
      ...
      <div class="pm-weekly-box">
        ...
        <div class="pm-weekly-text">${P(o.topic)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Objetivo Pedagógico</div>
        <div class="pm-weekly-desc">${P(o.objective)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Estrategia Metodológica / Actividades</div>
        <div class="pm-weekly-desc">${P(o.teacher_strategy||`Sin estrategia registrada`)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Evidencia Requerida</div>
        <div class="pm-weekly-desc">📸 ${P(o.evidence||`Sin evidencia registrada`)}</div>
      </div>

      <div class="pm-weekly-box">
        <div class="pm-weekly-label">Actividad del Estudiante / Tarea</div>
        <div class="pm-weekly-desc">${P(o.student_activity||`Sin actividad registrada`)}</div>
        <div class="pm-weekly-desc" style="margin-top:8px;"><strong>Tarea:</strong> ${P(o.homework||`Sin tarea registrada`)}</div>
        ${o.teacher_notes?`<div class="pm-weekly-desc" style="margin-top:8px;"><strong>Nota docente:</strong> ${P(o.teacher_notes)}</div>`:``}
      ...
      <div class="pm-weekly-box">
        ...
        <div class="pm-weekly-indicator-badge" id="btn-eval-indicator-weekly">
          🎯 ${P((o.topic||``).split(` `)[0]||`Indicador`)} — Evaluar
        </div>
      </div>

      ${C(e)}
    `,f.querySelector(`.pm-weekly-nav-btn.prev`).onclick=async t=>{t.stopPropagation(),e>1&&(r=await se(r.id,e-1),await x())},f.querySelector(`.pm-weekly-nav-btn.next`).onclick=async t=>{t.stopPropagation(),e<i.items.length&&(r=await se(r.id,e+1),await x())};let c=f.querySelector(`#btn-eval-indicator-weekly`);c&&(c.onclick=e=>{e.stopPropagation(),n.onIndicadorSelect?.({id:o.indicator_id,nombre:o.topic,node_id:o.node_id})});let l=f.querySelector(`#btn-edit-weekly-adjustment`);l&&(l.onclick=e=>{e.stopPropagation(),w(o)})}x();function E(){s.forEach(e=>{try{e()}catch{}}),s.length=0}return{destroy:E,getActiveIndicador:()=>{if(!i||!r)return null;let e=i.items.find(e=>e.week_number===r.current_week);return e?{id:e.indicator_id,nombre:e.topic}:null},refreshTree:async()=>{await x()},getActivePlanificacionId:()=>r?.weekly_plan_id||null}}var X=null,Z=[],Ft=null,Q=-1,It=!1,Lt=null,Rt=!1,zt=0,Bt=0;function Vt(){if(!X){if(X=document.createElement(`div`),X.id=`pm-autocomplete-popup`,X.className=`pm-autocomplete-popup`,X.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(X)}}function Ht(e,t,n={}){if(Vt(),Z=e||[],Ft=t,Lt=n.trigger||null,Q=-1,It=!0,Jt(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+6;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),X.style.left=`${i}px`,X.style.top=`${a}px`}X.onmousedown=Ut,document.addEventListener(`mousemove`,Wt),document.addEventListener(`mouseup`,Gt),X.style.display=`block`}function Ut(e){e.target.closest(`.pm-ac-option`)||(Rt=!0,zt=e.clientX-X.offsetLeft,Bt=e.clientY-X.offsetTop,X.style.cursor=`grabbing`,X.style.transition=`none`)}function Wt(e){if(!Rt)return;let t=e.clientX-zt,n=e.clientY-Bt;X.style.left=`${Math.max(0,t)}px`,X.style.top=`${Math.max(0,n)}px`}function Gt(){Rt&&(Rt=!1,X.style.cursor=``)}function Kt(){X&&(X.style.display=`none`,Rt=!1,document.removeEventListener(`mousemove`,Wt),document.removeEventListener(`mouseup`,Gt)),Z=[],Ft=null,Q=-1,It=!1,Lt=null}function qt(e){Z=e||[],Q=-1,Jt(e)}function Jt(e){if(!X)return;if(!e||e.length===0){X.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${Qt(Lt)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===Q,o=$t(Lt,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${tn(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${tn(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),X.innerHTML=t,X.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{Yt(parseInt(e.dataset.index,10))})})}function Yt(e){if(e>=0&&e<Z.length){let t=Z[e];Ft&&Ft(t),Kt()}}function Xt(e){if(!(!It||Z.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),Q=Math.min(Q+1,Z.length-1),Jt(Z),Zt();break;case`ArrowUp`:e.preventDefault(),Q=Math.max(Q-1,0),Jt(Z),Zt();break;case`Enter`:e.preventDefault(),Q>=0?Yt(Q):Z.length>0&&Yt(0);break;case`Escape`:e.preventDefault(),Kt();break;case`Tab`:Z.length>0&&Q===-1&&(e.preventDefault(),Yt(0));break}}function Zt(){if(!X||Q<0)return;let e=X.querySelector(`.pm-ac-option[data-index="${Q}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Qt(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function $t(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?en(t.type):`•`}function en(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function tn(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function nn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.bottom}}function rn(){return It}function an(){return Q}var on={show:Ht,hide:Kt,updateOptions:qt,handleKeyDown:Xt,getCursorPosition:nn,isOpen:rn,getSelectedIndex:an},sn=`
...
`;function cn(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
    <div class="pm-dsl-editor-container">
      <div
        ...
        spellcheck="false"
      ></div>
      <div class="pm-dsl-placeholder" id="pm-dsl-placeholder">${sn}</div>
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=fn(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}function mn(e,t){let n=e.querySelector(`#pm-dsl-toolbar-container`),r=e.querySelector(`#pm-dsl-editor-container`),i=null,a=cn(r,{initialContent:t.initialContent||``,onChange:e=>{t.onEditorChange?.(e)}});a.setContext({claseId:t.claseId});function o(e){i=pn(n,{onInsert:(e,t,n)=>a.insertText(e,t,n),getEditorContent:()=>a.getValue(),onLoading:()=>{},onIaProposal:t=>e.onIaProposal?.(t),onImproveClick:t=>e.onImproveClick?.(t),onStructureClick:t=>e.onStructureClick?.(t),onAnalyzeClick:t=>e.onAnalyzeClick?.(t)})}function s(){i&&i.destroy(),a.destroy()}return{getEditor:()=>a,getToolbar:()=>i,getValue:()=>a.getValue(),setValue:e=>a.setValue(e),setContext:e=>a.setContext(e),initToolbar:o,destroy:s}}var hn={ESC:`Escalas`,ARP:`Arpegios y patrones`,MI:`Mano izquierda`,ARC:`Arco`,SON:`Sonido`,AFI:`Afinación`,EST:`Estudios técnicos`,REP:`Repertorio`},$={EXPLICITO:`explicito`,DERIVADO:`derivado`,MANUAL:`manual`};function gn(e){if(!e)return null;let t=String(e).match(/>([A-Z]{2,3})\b/)?.[1];return t&&hn[t]?t:null}async function _n(e){if(!e||!e.trim())return[];let{data:t,error:n}=await l.rpc(`fn_sugerir_nodo_por_texto`,{p_texto:e});return n?(console.warn(`[nodoSesionApi] No se pudo obtener sugerencias:`,n.message),[]):t??[]}async function vn(e){let t=gn(e);if(t)return{codigo:t,nombre:hn[t],origen:$.EXPLICITO,confianza:`alta`,alternativas:[]};let n=await _n(e);if(n.length===0)return{codigo:null,nombre:null,origen:null,confianza:null,alternativas:[]};let[r,...i]=n;return{codigo:r.codigo,nombre:r.nombre,origen:$.DERIVADO,confianza:r.aciertos>=2&&(i.length===0||i[0].aciertos<r.aciertos)?`alta`:`media`,alternativas:i}}async function yn(e,t,n=$.DERIVADO){if(!e)return null;if(t&&!hn[t])throw Error(`Categoría desconocida: ${t}`);let{data:r,error:i}=await l.from(`sesiones_clase`).update({node_codigo:t,node_origen:t?n:null}).eq(`id`,e).select(`id, node_codigo, node_origen`).maybeSingle();if(i)throw Error(`No se pudo guardar la categoría: ${i.message}`);return r}var bn=700;function xn(e,n={}){let r=document.createElement(`div`);r.className=`pm-categoria-bar`,r.style.cssText=`
  ...
  `,e.appendChild(r);let i={codigo:n.codigoInicial??null,origen:n.origenInicial??null,confirmada:!!n.codigoInicial,alternativas:[],cargando:!1},a=null,o=``;function s(){n.onChange?.({codigo:i.confirmada?i.codigo:null,origen:i.confirmada?i.origen:null})}function c(){if(!i.codigo&&!i.cargando){r.style.display=`none`,r.innerHTML=``;return}if(r.style.display=`flex`,i.cargando&&!i.codigo){r.innerHTML=`<span class="text-muted">Analizando el registro…</span>`;return}let e=hn[i.codigo]??i.codigo;if(i.confirmada)r.innerHTML=`
      ...
      `}}function l(){let e=Object.entries(hn).map(([e,n])=>`<button type="button" class="pm-cat-opt" data-codigo="${e}">${t(n)}</button>`).join(``);r.innerHTML=`
    ...
    `}r.addEventListener(`click`,e=>{let t=e.target.closest(`button`);if(!t)return;let{accion:n,codigo:r}=t.dataset;if(n===`confirmar`)i.confirmada=!0,i.origen=$.DERIVADO;else if(n===`elegir`)i.codigo=r,i.confirmada=!0,i.origen=$.MANUAL;else if(n===`cambiar`||n===`otra`){l();return}else if(n===`ninguna`)i.codigo=null,i.confirmada=!1,i.alternativas=[];else if(r)i.codigo=r,i.confirmada=!0,i.origen=$.MANUAL;else return;c(),s()});async function u(e){if(e!==o&&(o=e,!(i.confirmada&&i.origen===$.MANUAL))){i.cargando=!0,c();try{let t=await vn(e);t.codigo?t.origen===$.EXPLICITO?(i.codigo=t.codigo,i.origen=$.EXPLICITO,i.confirmada=!0,i.alternativas=[],s()):i.confirmada||(i.codigo=t.codigo,i.origen=t.origen,i.alternativas=t.alternativas??[]):i.confirmada||(i.codigo=null,i.alternativas=[])}catch(e){console.warn(`[CategoriaTrabajoBar]`,e.message)}finally{i.cargando=!1,c()}}}function d(e){clearTimeout(a),a=setTimeout(()=>u(e??``),bn)}return c(),{el:r,onTextoCambia:d,analizarAhora:e=>u(e??``),getCategoria:()=>i.confirmada?{codigo:i.codigo,origen:i.origen}:{codigo:null,origen:null},destroy:()=>{clearTimeout(a),r.remove()}}}function Sn(e,{onMarkAll:t,onClearAll:n}){let r=e.querySelector(`#btn-bulk-p`),i=e.querySelector(`#btn-bulk-a`),a=e.querySelector(`#btn-bulk-clear`),o=[];function s(e,t,n){e&&(e.addEventListener(t,n),o.push(()=>e.removeEventListener(t,n)))}return s(r,`click`,e=>{e.preventDefault(),t&&t(`P`)}),s(i,`click`,e=>{e.preventDefault(),t&&t(`A`)}),s(a,`click`,e=>{e.preventDefault(),n&&n()}),{destroy(){o.forEach(e=>{try{e()}catch{}}),o.length=0}}}function Cn({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function wn(e,t,n){let{data:r,error:i}=await l.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await l.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await l.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function Tn(e,t){let{data:n,error:r}=await l.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function En(e){let{error:t}=await l.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function Dn(e,t,n,r,i=null,a=null){try{let{error:o}=await l.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await l.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await m({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}function On(e,{sesionId:t,maestroId:n,editor:r,sesionExistenteData:i,onDraftRecovered:a}){if(!t)return{destroy(){}};let o=null,s=!1,c=e.querySelector(`#pm-draft-indicator`);o=Cn({saveFn:async e=>{!t||s||await wn(t,n,e)},debounceMs:3e4}),o.onSaved(()=>{if(s||!c)return;let e=new Date,t=String(e.getHours()).padStart(2,`0`),n=String(e.getMinutes()).padStart(2,`0`);c.textContent=`Borrador guardado ${t}:${n}`,c.style.display=``});let l=e.querySelector(`#pm-dsl-editable`);if(l){let e=l.oninput;l.oninput=function(t){e&&e.call(this,t),o&&!s&&o.onInput(r.getValue())}}return i?.borrador===!0&&Tn(t,n).then(e=>{if(!s&&e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?a&&a(e.contenido_raw):En(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e)),{destroy(){s=!0,o&&o.destroy()}}}function kn(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `,document.body.appendChild(i),!document.getElementById(`pm-justif-styles`))){let e=document.createElement(`style`);e.id=`pm-justif-styles`,e.textContent=`
      ...
      <div class="pm-asist-item ${n}" data-id="${e.id}">
        ...
        <div class="pm-asist-info">
          ...
          <span class="pm-asist-instrumento">${P(e.instrumento_principal||`—`)}${P(r)}</span>
        </div>
...
¿Guardar la evaluación?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:t}=await fe(n.sesionId,a.id,o.evaluaciones,n.maestro.id,e);if(t)throw t}let s={indicador_id:a.id,evaluaciones:o.evaluaciones};await Dn(n.sesionId,n.maestro.id,i,s,o.dslGenerado||null,o.textoMejorado||null);let l=ce(i);if(l.estados&&l.estados.length>0){let e=n.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));$e({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,dslText:i,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Ot(e,n.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await Mn(n.sesionId,n.claseId,n.maestro.id,o.evaluaciones,n.claseNombre||`Clase`,e);if(u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),n.planificationCard&&await n.planificationCard.refreshTree(),n.setEditorValue(``),n.onDslContentClear&&n.onDslContentClear(),In(o.evaluaciones.length,a.nombre),n.activeClassEventId){try{await Nn(n.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(n.activeLevel)try{let{academicService:t}=await c(async()=>{let{academicService:e}=await import(`./academicService-CgmFcPKt.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2]));for(let r of e){let e=await t.checkLevelCompletion(r.id,n.activeLevel);if(e&&e.status===`approved`){let{createLevelCompletionModal:e}=await c(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-Du_KQRU_.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([3,2,4])),t=e({studentId:r.id,levelId:n.activeLevel});n.onAppendModal?.(t.el||t)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&n.claseId&&a?.nombre){let{error:e}=await Ze({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,contenido:a.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(n.sesionId){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-CgmFcPKt.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),r=await e.processSessionClosure(n.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:e}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DrGzVr84.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4]));await e(t,r)}}r.textContent=`¡Guardado!`,setTimeout(()=>{r.textContent=`Guardar observación`,r.disabled=!1},2e3)}catch(t){console.error(`[asistencia] Error saving observation:`,t),e.error(`Error al guardar: `+(t.message||t)),r.disabled=!1,r.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function In(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function Ln(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await Pn.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function Rn(e,t){if(!e)throw Error(`sesion_id es requerido`);let n={sesion_id:e,clase_id:t.clase_id,maestro_id:t.maestro_id,texto_libre:t.texto_libre??``,tareas_enviadas:t.tareas_enviadas??!1,tareas_detalle:t.tareas_detalle||null,incidencia_comportamiento:t.incidencia_comportamiento??!1,incidencia_detalle:t.incidencia_detalle||null,clase_no_realizada:t.clase_no_realizada??!1,motivo_no_realizada:t.motivo_no_realizada||null},{data:r,error:i}=await l.from(`sesion_bitacora`).upsert(n,{onConflict:`sesion_id`}).select().single();if(i)throw i;return r}async function zn(e,t,n={}){if(n.aceptadoPorMaestro!==!0)throw Error(`El texto profesionalizado por IA requiere aceptación explícita del maestro antes de guardarse (REQ-11)`);let{data:r,error:i}=await l.from(`sesion_bitacora`).update({texto_ia:t}).eq(`sesion_id`,e).select().single();if(i)throw i;return r}var Bn=[{key:`tareas`,toggleId:`bitacora-toggle-tareas`,detalleId:`bitacora-detalle-tareas`,label:`Tareas enviadas`,placeholder:`Detalle de las tareas enviadas...`},{key:`incidencia`,toggleId:`bitacora-toggle-incidencia`,detalleId:`bitacora-detalle-incidencia`,label:`Incidencia de comportamiento`,placeholder:`Detalle de la incidencia...`},{key:`no-realizada`,toggleId:`bitacora-toggle-no-realizada`,detalleId:`bitacora-detalle-no-realizada`,label:`Clase no realizada`,placeholder:`Motivo por el que no se realizó la clase...`}];function Vn({sesionId:e,claseId:t,maestroId:n=null,onSaved:r=null,onClosed:i=null}){document.querySelectorAll(`.bitacora-panel-overlay`).forEach(e=>e.remove());let a=document.createElement(`div`);if(a.className=`bitacora-panel-overlay`,a.innerHTML=Wn(),document.body.appendChild(a),!document.getElementById(`bitacora-panel-styles`)){let e=document.createElement(`style`);e.id=`bitacora-panel-styles`,e.textContent=qn(),document.head.appendChild(e)}let o=()=>{a.remove(),i?.()};a.querySelector(`.bitacora-panel-close-x`)?.addEventListener(`click`,o),a.querySelector(`.bitacora-panel-backdrop`)?.addEventListener(`click`,o),a.querySelector(`.bitacora-panel-cancelar-btn`)?.addEventListener(`click`,o),Bn.forEach(e=>Hn(a,e)),a.querySelector(`.bitacora-panel-ia-btn`)?.addEventListener(`click`,async()=>{let t=a.querySelector(`.bitacora-panel-ia-btn`),n=a.querySelector(`#bitacora-texto-libre`)?.value||``;t.disabled=!0;try{let t=await y(n);Un({overlay:a,sesionId:e,textoIA:t})}catch(e){console.error(`[bitacoraSesionPanel] Error generando versión profesionalizada:`,e),Gn(a,`No se pudo generar la versión profesionalizada`)}finally{t.disabled=!1}}),a.querySelector(`.bitacora-panel-guardar-btn`)?.addEventListener(`click`,async()=>{let i=a.querySelector(`.bitacora-panel-guardar-btn`);i.disabled=!0;let s={clase_id:t,maestro_id:n,texto_libre:a.querySelector(`#bitacora-texto-libre`)?.value||``,tareas_enviadas:a.querySelector(`#bitacora-toggle-tareas`)?.checked||!1,tareas_detalle:a.querySelector(`#bitacora-detalle-tareas`)?.value||null,incidencia_comportamiento:a.querySelector(`#bitacora-toggle-incidencia`)?.checked||!1,incidencia_detalle:a.querySelector(`#bitacora-detalle-incidencia`)?.value||null,clase_no_realizada:a.querySelector(`#bitacora-toggle-no-realizada`)?.checked||!1,motivo_no_realizada:a.querySelector(`#bitacora-detalle-no-realizada`)?.value||null};try{let t=await Rn(e,s);r?.(t),o()}catch(e){console.error(`[bitacoraSesionPanel] Error guardando bitácora:`,e),Gn(a,`No se pudo guardar la bitácora`),i.disabled=!1}})}function Hn(e,t){let n=e.querySelector(`#${t.toggleId}`);n?.addEventListener(`change`,()=>{let r=e.querySelector(`.bitacora-detalle-slot[data-slot="${t.key}"]`);r&&(n.checked?r.innerHTML=`<textarea id="${t.detalleId}" class="form-control form-control-sm mt-1" rows="2" placeholder="${Kn(t.placeholder)}"></textarea>`:r.innerHTML=``)})}function Un({overlay:e,sesionId:t,textoIA:n}){let r=e.querySelector(`.bitacora-ia-preview-slot`);r&&(r.innerHTML=`
    <div class="bitacora-ia-preview">${Kn(n)}</div>
  ...
  `,r.querySelector(`.bitacora-ia-descartar-btn`)?.addEventListener(`click`,()=>{r.innerHTML=``}),r.querySelector(`.bitacora-ia-aceptar-btn`)?.addEventListener(`click`,async()=>{try{await zn(t,n,{aceptadoPorMaestro:!0}),r.innerHTML=``}catch(t){console.error(`[bitacoraSesionPanel] Error guardando versión profesionalizada:`,t),Gn(e,`No se pudo guardar la versión profesionalizada`)}}))}function Wn(){return`
  ...
  `}function Gn(e,t){let n=e.querySelector(`.bitacora-panel-error-msg`);n&&(n.textContent=t,n.classList.remove(`d-none`),setTimeout(()=>n.classList.add(`d-none`),3e3))}function Kn(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function qn(){return`
  ...
  `}function Jn(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function Yn({claseId:t,fecha:n,evaluadoPor:r,getPresentes:i}){document.querySelectorAll(`.indicador-selector-overlay`).forEach(e=>e.remove());let a={niveles:[],objetivos:[],objetivoIdSeleccionado:null,indicadores:[],cargando:!0},o=document.createElement(`div`);if(o.className=`indicador-selector-overlay`,document.body.appendChild(o),!document.getElementById(`indicador-selector-styles`)){let e=document.createElement(`style`);e.id=`indicador-selector-styles`,e.textContent=Zn(),document.head.appendChild(e)}let s=()=>o.remove(),c=()=>{o.innerHTML=Xn(a),l()};function l(){o.querySelector(`.indicador-selector-close-x`)?.addEventListener(`click`,s),o.querySelector(`.indicador-selector-backdrop`)?.addEventListener(`click`,s),o.querySelector(`.indicador-selector-cerrar-btn`)?.addEventListener(`click`,s),o.querySelector(`#indicador-selector-objetivo`)?.addEventListener(`change`,async t=>{let n=t.target.value||null;if(a.objetivoIdSeleccionado=n,a.indicadores=[],n){c();try{a.indicadores=await b(n)}catch(t){console.error(`[IndicadorSelectorPanel] Error cargando indicadores:`,t),e.error(`No se pudieron cargar los indicadores de este objetivo.`)}}c()}),o.querySelectorAll(`.btn-indicador-calificar`).forEach(o=>{o.addEventListener(`click`,()=>{let c=a.indicadores.find(e=>String(e.id)===o.dataset.indicadorId);if(!c)return;let l=i();if(l.length===0){e.warning(`No hay alumnos presentes registrados para hoy.`);return}s(),N({claseId:t,claseIndicadorId:c.id,indicadorDescripcion:c.descripcion,presentes:l,fecha:n,evaluadoPor:r,onGuardado:({guardados:t,total:n})=>{e.success(`Calificación guardada: ${t}/${n} alumnos`)}})})})}c(),Promise.all([x(t),S(t)]).then(([e,t])=>{a.niveles=e||[],a.objetivos=t||[],a.cargando=!1,c()}).catch(e=>{console.error(`[IndicadorSelectorPanel] Error cargando objetivos/niveles:`,e),a.cargando=!1,a.error=!0,c()})}function Xn(e){let t=new Map(e.niveles.map(e=>[e.id,e.nombre])),n=new Map;for(let r of e.objetivos){let e=t.get(r.level_id)||`Sin unidad`;n.has(e)||n.set(e,[]),n.get(e).push(r)}let r=[...n.entries()].map(([t,n])=>`
      <optgroup label="${Jn(t)}">
        ${n.map(t=>`<option value="${t.id}" ${e.objetivoIdSeleccionado===t.id?`selected`:``}>${Jn(t.nombre)}</option>`).join(``)}
      </optgroup>
    `).join(``),i=e.indicadores.map(e=>`
      <div class="indicador-selector-row">
        <span>${Jn(e.descripcion)}</span>
  ...
  `}async function Qn(t,{onError:n,silent:r=!1}={}){try{return await t()}catch(t){return console.error(`[safeAsync]`,t),n?n(t):r||e!==void 0&&e&&e.error(`Error inesperado: `+(t.message||t)),null}}async function $n(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await l.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){i?.navigate?i.navigate(`fechas`):window.location.hash=`#/fechas`;return}let s=new Date,c=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,`0`)}-${String(s.getDate()).padStart(2,`0`)}`,u=n||a.fecha||c,d={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let f=Array.isArray(a.asistencia)?a.asistencia:[],p=f.map(e=>e.alumno_id).filter(Boolean),m=[];if(p.length>0){let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,p);m=e||[]}let h={},g={};m.forEach(e=>{h[e.id]=null}),f.forEach(e=>{e.estado&&m.some(t=>t.id===e.alumno_id)&&(h[e.alumno_id]=e.estado)});let _=tr(e,{clase:d,horario:null,alumnos:m,estado:h,justificaciones:g,maestro:r,fechaHoy:u,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i});return typeof _==`function`?_:void 0}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${P(t.message)}</p>`}}async function er(e,{claseId:t,fecha:n,sesionId:o,router:c}={}){let d=typeof e==`string`?document.getElementById(e):e;if(!d){console.error(`[asistenciaView] Container not found:`,e);return}d.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let f=u();if(!f){d.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(o)return $n(d,{sesionId:o,fecha:n,maestro:f,router:c});c?.navigate?c.navigate(`fechas`):window.location.hash=`#/fechas`;return}localStorage.setItem(`pm_active_clase_id`,t);let p=new Date,m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,h=n||m;try{let e=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,o,u,m]=await Promise.all([r(),s([t]),a([t]),l.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,f.id).eq(`fecha`,h).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),g=n.find(e=>e.id===t);if(!g){d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let _=o.find(t=>t.dia?.toLowerCase()===e),v=(u||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),y=m.data||[],b=y[0]||null,x=(()=>{let e=new Map;for(let t of[...y].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),S=Array.isArray(b?.asistencia)?b.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(b?.tipo===`emergente`&&S.length>0){let e=new Set(S),t=new Set(v.map(e=>e.id)),n=S.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);v=v.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}v=v.filter(t=>e.has(t.id))}let C=b?.id||null,w=b?.updated_at||null,T=b?.contenido||``,E=g.salon?[g.salon]:[],[D,O]=await Promise.all([C?l.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?i(E):Promise.resolve([])]),k=O.length>0?O[0].nombre:null,A=`pm_asistencia_${t||C}_${h}`,ee=localStorage.getItem(`${A}_updated`),j=!1;w&&ee&&new Date(w).getTime()>new Date(ee).getTime()+5e3&&(j=!0);let M=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await l.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();M=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let N={},te={};v.forEach(e=>{N[e.id]=null});let P=x,F={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(P.length===0)try{let e=null,n=y.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:t}=await l.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);e=t}if((!e||e.length===0)&&t&&h){let{data:n}=await l.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,h);e=n}e?.length>0&&(P=e.map(e=>({alumno_id:e.alumno_id,estado:F[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}P.forEach(e=>{if(Object.prototype.hasOwnProperty.call(N,e.alumno_id)){let t=F[e.estado]??e.estado;N[e.alumno_id]=t}});let I=[];if(C)try{I=await l.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),I.forEach(e=>{Object.prototype.hasOwnProperty.call(N,e.alumno_id)&&(N[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}tr(d,{clase:g,horario:_,alumnos:v,estado:N,justificaciones:te,maestro:f,fechaHoy:h,claseId:t,sesionId:C,hasConflict:j,serverDSL:T,snapshots:D,salonNombre:k,rutaId:M,sesionExistenteData:b,router:c})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${P(e.message)}</p>`}}function tr(t,n){let{clase:r,horario:i,alumnos:a,estado:s,justificaciones:u,maestro:d,fechaHoy:h,claseId:_,snapshots:y,serverDSL:b,hasConflict:x,salonNombre:S,rutaId:T,sesionExistenteData:k,router:j}=n,M=n.sesionId,N=!!n.sesionId&&(k?.borrador===!1||k?.estado===`registrada`||k?.estado===`cerrada`),te=e=>{if(j?.navigate){j.navigate(e);return}window.location.hash=`#/${e}`},P=[],F=`pm_asistencia_${_||M}_${h}`,I=b,ne=null,L=qe(),R=null,ie=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let z=jt(t.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:S,fechaHoy:h,totalAlumnos:a.length,hasConflict:x,onBack:()=>{Oe.destroy();try{we.close()}catch{}P.forEach(e=>{try{e()}catch{}}),te(`hoy`)}});P.push(()=>z.destroy());let B=t.querySelector(`#pm-sync-badge-container`);if(B){let e=me();B.appendChild(e.el)}let V=mn(t,{initialContent:b,claseId:_,onEditorChange:e=>{I=e,se?.onTextoCambia(e)}}),H=V.getEditor(),ae=t.querySelector(`#pm-dsl-editor-container`),oe={codigo:null,origen:null},se=xn(t.querySelector(`.pm-asist-dsl-section`)||t,{onChange:async({codigo:e,origen:t})=>{if(oe={codigo:e,origen:t},M)try{await yn(M,e,t)}catch(e){console.warn(`[asistencia] No se pudo guardar la categoría:`,e.message)}}});b&&se.analizarAhora(b);let ce=_e(t,{onAceptar:e=>{H.setValue(e)}}),le=ve(t,{onAccept:e=>{H.setValue(e)}}),ue=at(ae.parentNode,{onConfirm:async n=>{try{let e=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Qe({sesionId:M,claseId:_,maestroId:d.id,fechaHoy:h,progressRecords:n,alumnos:e});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=t.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(n){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e.error(`Error al guardar progreso: `+n.message)}},onCancel:()=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),fe=dt(t.querySelector(`#pm-planificacion-dropdown`)||t,{onAdopt:async({instrumento:t,nivel:n,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await Et({instrumento:t,nivel:n,descripcion:r,pilares:i}),{linked:s}=await et({claseId:_,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;e.success(c)}catch(t){e.error(`Error al crear el plan: `+t.message)}},onCancel:()=>{}});V.initToolbar({onImproveClick:async n=>{let r=t.querySelector(`#btn-generar-informe`);r&&(r.disabled=!0);try{let e=await D(n);ce.open({original:n,improved:e})}catch(t){e.error(`Error al generar informe: `+t.message)}finally{r&&(r.disabled=!1)}},onStructureClick:async n=>{let r=t.querySelector(`#btn-ia-magic`);r&&(r.disabled=!0);try{let e=R?.getActiveIndicador(),t=await O(n,{presentes:a.filter(e=>s[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});le.open({original:n,dsl:t})}catch(t){e.error(`Error al estructurar con IA: `+t.message)}finally{r&&(r.disabled=!1)}},onAnalyzeClick:async n=>{await Qn(async()=>{let i=a.filter(e=>s[e.id]&&s[e.id]!==`A`),o=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},c=a.map(e=>e.nombre_completo||e.nombre||``),l={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,c)}}),presentes:i.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:o(t,c)}}),tipoClase:Dt(r),instrumento:r.instrumento||``,sesionesRecientes:(y||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:R?.getActiveIndicador()?.nombre||``};t.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let u=await A(n,l);if(!u?.progreso?.length){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.warning(`La IA no detectó registros de progreso en este texto.`);return}ue.open({progreso:u.progreso,resumen:u.resumen})},{onError:n=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.error(`Error al analizar con IA: `+n.message)}})}});let pe=V.getToolbar();R=Pt(t,{claseId:_,clase:r,maestro:d,fechaHoy:h,rutaId:T,editor:H,onIndicadorSelect:e=>{H.insertText(`[${e.nombre}] `),pe&&pe.setContext({indicadorActivo:e.nombre});let n=t.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getSessionState:()=>({isRegistered:N,hasContent:!!(I&&I.trim()),sessionId:M}),getDslContent:()=>H.getValue()}),P.push(()=>R.destroy());let U=t.querySelector(`#btn-proponer-curriculo`);U&&(U.onclick=async()=>{U.disabled=!0,U.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let t=await st(_,12);if(t.registros.length===0){e.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let n=await ee(t,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});fe.open({pilares:n.pilares,resumen:n.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(t){e.error(`Error al generar propuesta: `+t.message)}finally{U.disabled=!1,U.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let he=t.querySelector(`#btn-ir-modo-sesion`);he&&(he.onclick=()=>{te(`planificacion-mapa-clase?clase=${_}`)});let ye=t.querySelector(`#btn-calificar-indicadores`);ye&&(ye.onclick=()=>{if(!M){e.warning(`Guardá la asistencia de hoy antes de calificar indicadores.`);return}Yn({claseId:_,fecha:h,evaluadoPor:d.id,getPresentes:()=>a.filter(e=>s[e.id]===`P`).map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``}))})});let be=t.querySelector(`#btn-abrir-bitacora`);be&&(be.onclick=()=>{if(!M){e.warning(`Guardá la asistencia de hoy antes de abrir la bitácora de la sesión.`);return}Vn({sesionId:M,claseId:_,maestroId:d.id,onSaved:()=>e.success(`Bitácora guardada`)})});let xe=Mt(t,{editor:H,toolbar:pe}),Se=de();xe.inject(Se,_),P.push(()=>xe.destroy());let we=An(t,{sesionId:M,getSesionId:()=>M,claseId:_,fechaHoy:h,maestroId:d.id,supabase:l,guardarJustificacion:We,eliminarJustificacion:Ke,onJustifDeleted:e=>{s[e]=null,delete u[e]},onJustifSaved:(e,t)=>{u[e]=t},onJustifCancelled:(e,t)=>{s[e]=t},onRenderLista:e=>Te.render(e),onUpdateProgress:()=>Ee(),onAutoSave:e=>K(e),onAnnounce:e=>re(e)});P.push(()=>{try{we.close()}catch{}});let W=On(t,{sesionId:M,maestroId:d.id,editor:H,sesionExistenteData:k,onDraftRecovered:e=>{I=e,H.setValue(e)}});P.push(()=>W.destroy()),t.querySelector(`#pm-academic-tools`),Fn(t,{rutaId:T,sesionId:M,claseId:_,maestro:d,fechaHoy:h,alumnos:a,estado:s,planificationCard:R,editorContainer:ae,getEditorValue:()=>H.getValue(),setEditorValue:e=>H.setValue(e),onDslContentClear:()=>{I=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:e=>{let n=t.querySelector(`.pm-asist-root`);n&&n.appendChild(e)}});let Te=jn(t,{alumnos:a,estado:s,rutaId:T,canOpenProgressPanel:!!(_||T),sesionId:M,fechaHoy:h,snapshots:y,justificaciones:u,obtenerJustificacion:Ge,eliminarJustificacion:Ke,onJustifDeleted:e=>{delete u[e]},onEstadoChange:(e,t)=>{s[e]=t},onOpenProgressPanel:e=>{G&&G.destroy(),G=Ne({alumno:e,rutaId:T,sessionId:M,claseId:_,fecha:h,horaInicio:i?.hora_inicio||null,onProgressSaved:async()=>{R?.refreshTree&&await R.refreshTree()}}),G.open(),P.push(()=>{G&&G.destroy()})},onOpenEvaluationDrawer:(e,n)=>{ge(t,{student:e,sessionId:M,teacherId:d.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{we.open(e,t,n)},onAutoSave:e=>K(e),onAnnounce:e=>re(e),onUpdateSnapshots:e=>{y.push(...e)}});P.push(()=>Te.destroy());let G=null;function Ee(){let e=a.length,n=Object.values(s).filter(e=>e!==null).length,r=t.querySelector(`#pm-progress-wrap`),i=t.querySelector(`#pm-progress-fill`),o=t.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/e*100}%`,o.textContent=`${n}/${e}`}async function K(e=!1,t=!1){ne&&clearTimeout(ne);let n=async()=>{let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t={...M?{}:{clase_id:_},maestro_id:d.id,fecha:h,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:I||``,...oe.codigo?{node_codigo:oe.codigo,node_origen:oe.origen}:{}};if(e.length===0&&!(I||``).trim()&&M)try{await g(M),M=null,localStorage.removeItem(`${F}_updated`),console.log(`[asistencia] Borrador vaciado y eliminado automáticamente`);return}catch(e){console.warn(`[asistencia] Error al autolimpiar borrador:`,e)}if(navigator.onLine)try{if(M){let{error:e}=await l.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,M);if(!e){localStorage.setItem(`${F}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await l.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){M=e.id,console.log(`[asistencia] Nueva sesión creada:`,M),localStorage.setItem(`${F}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await m({tabla:`sesiones_clase`,operacion:M?`update`:`insert`,payload:{...M?{id:M}:{},...t}}),localStorage.setItem(`${F}_updated`,new Date().toISOString())};e?t?await n():await L.run(n):ne=setTimeout(()=>{L.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let q=t.querySelector(`.pm-asist-actions-fixed`);if(q){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),M&&(e.disabled=!0,e.innerHTML=`⏳...`,await w(M),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=q.querySelector(`#btn-guardar`);q.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),_&&(n.disabled=!0,n.innerHTML=`⏳...`,await E(_,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),q.insertBefore(n,t)}t.querySelector(`#btn-guardar`).onclick=async()=>{let n=t.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await L.run(async()=>{try{let i=a.filter(e=>s[e.id]).map(e=>({..._?{clase_id:_}:{},alumno_id:e.id,fecha:h,estado:s[e.id],registrado_por:d.id})),u=i.length>0,y=I&&I.trim().length>0;if(!u&&!y)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await K(!0,!0),!M){let{data:e}=await l.from(`sesiones_clase`).select(`id`).eq(`clase_id`,_).eq(`maestro_id`,d.id).eq(`fecha`,h).maybeSingle();e&&(M=e.id)}if(u&&_)try{let e=i.map(e=>({...e,...M&&{sesion_clase_id:M}}));await v(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!M){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await m({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:_,alumno_id:e.alumno_id,fecha:h,estado:e.estado,registrado_por:d.id,...M?{sesion_clase_id:M}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(M&&(u||y)){let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),{error:t}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,M).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,M).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await l.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:I||``,updated_at:new Date().toISOString()}).eq(`id`,M))}o(),p(`hoy`),p(`calendario`),p(`metricas`),f().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e)),N=!0,R?.refreshTree&&await R.refreshTree()}if(M){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-CgmFcPKt.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),{createAchievementsSummaryModal:r}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DrGzVr84.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4])),i=await e.processSessionClosure(M);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(t,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let b=q?.querySelector(`#btn-reporte-dia`);b&&(b.style.display=``);let x=q?.querySelector(`#btn-resumen-mes`);x&&(x.style.display=``);let S=Object.values(s).filter(e=>e===`P`).length,T=Object.values(s).filter(e=>e===`A`).length;re(`Sesión guardada exitosamente. ${S} presentes, ${T} ausentes.`);let D=document.createElement(`div`);D.className=`pm-saved-overlay`,D.innerHTML=`
      ...
      `,document.body.appendChild(D);let O=D.querySelector(`#btn-resumen-pedagogico`),A=D.querySelector(`#btn-editar-asistencia`),ee=D.querySelector(`#btn-compartir-correo`),j=D.querySelector(`#btn-compartir-whatsapp`),P=D.querySelector(`#btn-volver-hoy`),F=D.querySelector(`#btn-ir-calendario`);ie&&ie.destroy(),ie=Be();let ne=ie;O&&(O.onclick=()=>{ne.open({sesionId:M,claseNombre:r?.nombre||`Clase`,fecha:h,supabase:l})}),A&&(A.onclick=()=>{D.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),ee&&(ee.onclick=async()=>{let e=a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${h}`),n=kt(e,I,a,r,h);At(`mailto:?subject=${t}&body=`,n,1800)}),j&&(j.onclick=async()=>{At(`https://wa.me/?text=`,kt(a.filter(e=>s[e.id]).map(e=>({alumno_id:e.id,estado:s[e.id]})),I,a,r,h),1600)}),P&&(P.onclick=()=>{D.remove(),te(`hoy`)}),F&&(F.onclick=()=>{D.remove(),te(`fechas`)});let L=D.querySelector(`#btn-reporte-dia-overlay`);L&&(L.onclick=async()=>{let e=L.innerHTML;L.disabled=!0,L.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await w(M)}finally{L.disabled=!1,L.innerHTML=e}});let z=t.querySelector(`#btn-descartar-borrador`);z&&z.addEventListener(`click`,async()=>{if(confirm(`¿Deseas descartar este borrador? La fecha se limpiará por completo.`))try{z.disabled=!0,z.innerHTML=`<span class="spinner-border spinner-border-sm" role="status"></span> Descartando...`,k?.id&&await g(k.id),e.show(`Borrador descartado correctamente`,`success`),o(),p(`calendario`),window.location.hash=`#/fechas`}catch(t){e.show(`Error al descartar: `+t.message,`danger`),z.disabled=!1,z.innerHTML=`<i class="bi bi-trash"></i> Descartar`}});let B=D.querySelector(`#btn-resumen-mes-overlay`);B&&(_?B.onclick=async()=>{let e=B.innerHTML;B.disabled=!0,B.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await E(_,e.getFullYear(),e.getMonth()+1)}finally{B.disabled=!1,B.innerHTML=e}}:(B.disabled=!0,B.title=`No disponible para actividades especiales`,B.style.opacity=`0.5`));let V=D.querySelector(`#btn-informe-ped-overlay`);V&&(_?V.onclick=async()=>{let e=V.innerHTML;V.disabled=!0,V.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await C(_,e.getFullYear(),e.getMonth()+1)}finally{V.disabled=!1,V.innerHTML=e}}:(V.disabled=!0,V.title=`No disponible para actividades especiales`,V.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};let De=Sn(t,{onMarkAll:async e=>{a.forEach(t=>{s[t.id]=e}),Te.render(),Ee();try{await K(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}re(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)},onClearAll:async()=>{a.forEach(e=>{s[e.id]=null}),Te.render(),Ee();try{await K(!0)}catch(e){console.warn(`[asistencia] autoSave error on clear all:`,e)}re(`Se desmarcaron las asistencias de todos los alumnos.`)}});P.push(()=>De.destroy()),Te.render();let Oe=new Ce(t);Oe.mount();let ke=t.querySelector(`#pm-btn-help`);return ke&&(ke.onclick=()=>Oe.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Oe.destroy();try{we.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),P.forEach(e=>{try{e()}catch{}})}}export{er as renderAsistenciaView};