import{i as e}from"./supabase-Cgh_dhNB.js";import{t}from"./academicService-gfoJzItj.js";import{i as n}from"./portalUtils-CkF82Yyk.js";async function r(r,{alumnoId:i}){r.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let a=await t.getStudent(i),o=await t.fetchRoutes();r.innerHTML=`
