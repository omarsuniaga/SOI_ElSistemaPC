import{a as e,d as t,f as n,i as r,l as i,n as a,r as o,u as s}from"./pushService-DoUwZMPe.js";import{B as c,F as l,G as u,H as d,I as f,K as p,L as m,R as h,U as g,V as _,W as v,z as y}from"./scoreDirectorView-JUtkZlg8.js";var b=[{id:`google/gemini-2.0-flash-exp`,name:`🔥 Gemini 2.0 Flash (Gratis)`,provider:`openrouter`},{id:`google/gemini-flash-1.5-exp`,name:`Google Gemini Flash 1.5 (Gratis)`,provider:`openrouter`},{id:`google/gemma-4-31b`,name:`Google Gemma 4 31B (Gratis)`,provider:`openrouter`},{id:`google/gemma-4-26b-a4b`,name:`Google Gemma 4 26B (Gratis)`,provider:`openrouter`},{id:`nvidia/nemotron-3-super-8b`,name:`NVIDIA Nemotron 3 Super (Gratis)`,provider:`openrouter`},{id:`nvidia/nemotron-nano-9b-v2`,name:`NVIDIA Nemotron Nano 9B (Gratis)`,provider:`openrouter`},{id:`poolside/laguna-xs.2`,name:`Poolside Laguna XS (Gratis)`,provider:`openrouter`},{id:`mistralai/mistral-7b-instruct`,name:`Mistral 7B (Gratis)`,provider:`openrouter`},{id:`anthropic/claude-3-haiku`,name:`Claude 3 Haiku (Gratis)`,provider:`openrouter`},{id:`openrouter/auto`,name:`🤖 Auto-Selector (Gratis - El mejor gratuito)`,provider:`openrouter`},{id:`groq-llama-3.3-70b`,name:`LLaMA 3.3 70B (GROQ - Rápido)`,provider:`groq`},{id:`groq-llama-3.1-70b`,name:`LLaMA 3.1 70B (GROQ)`,provider:`groq`}];function x(e){try{return localStorage.getItem(`portal-maestros:${e}`)}catch{return null}}function S(e,t){try{localStorage.setItem(`portal-maestros:${e}`,t)}catch{}}function C(){try{let e=localStorage.getItem(`portal-maestros:groq-usage`);return e?JSON.parse(e):null}catch{return null}}async function w(w){let[T,E,D,O,k,A]=await Promise.all([f()||x(`groq-key`)||``,h()||x(`openrouter-key`)||``,y()||`google/gemini-2.0-flash-exp`,c()||`llama-3.1-8b-instant`,m()||`llama-3.1-8b-instant`,l()]),j=b.find(e=>e.id===D)||b[0];w.innerHTML=`
