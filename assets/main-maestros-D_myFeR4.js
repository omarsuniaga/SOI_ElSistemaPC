...
import{$ as e,A as t,N as n,Q as r,S as i,U as a,X as o,at as s,ct as c,dt as l,i as u,it as d,j as f,l as p,lt as m,nt as h,o as g,ot as _,rt as v,s as y,st as b,tt as x,ut as S,v as ee,y as C}from"./clasesApi-DlGjhAio.js";import{i as w}from"./supabase-BryBf0UA.js";import{a as T,i as E,n as D,o as O,r as k,t as A}from"./maestroAuth-BZ2ChDTg.js";import"./vendor-CAKU_njC.js";import{t as j}from"./idb-BJPCiZxS.js";import{a as te,n as ne,r as re,t as M}from"./offlineQueue-CfcIbhXO.js";import{a as ie,c as ae,d as N,f as oe,i as se,l as ce,n as le,o as ue,p as de,r as fe,t as pe,u as me}from"./pushService-DsWSFa6I.js";import{r as he,t as ge}from"./permisoService-BqWyDF0U.js";import{t as P}from"./AppToast-L43yfvBt.js";import{n as _e,t as ve}from"./ausenciaModal-Cp0Ixu1n.js";import{a as ye,c as be,i as F,l as I,n as xe,o as Se,r as Ce,s as we,t as Te}from"./portalUtils-BqwkK1cV.js";import{t as L}from"./preload-helper-CQ36nxok.js";import{t as R}from"./academicService-lra55_F4.js";import{t as Ee}from"./AppModal-BohrepL3.js";import{a as De,c as Oe,i as ke,o as Ae,s as je,t as Me}from"./groqService-CNWH1ut_.js";import{a as Ne,r as Pe,s as Fe}from"./alumnosApi-CeFKHcQC.js";import{n as Ie,r as Le,t as Re}from"./reportService-G7_xh_x_.js";import{n as ze}from"./CHANGELOG-3bXRjOq2.js";var Be=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Ve(e=``){let t=String(e).toLowerCase();return Be.some(e=>t.includes(e.toLowerCase()))}var He=console.error;console.error=function(...e){e.length>0&&!Ve(e[0])&&He.apply(console,e)};var Ue=console.warn;console.warn=function(...e){e.length>0&&!Ve(e[0])&&Ue.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Ve(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Ve(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var We=window.fetch;window.fetch=async function(...e){try{return await We.apply(window,e)}catch(e){if(!Ve(e.message))throw e;return null}};var Ge=!1;function Ke(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Ge=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function qe(e,t={}){if(!Ge&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var Je=!1;function Ye(e={}){let{enabled:t=!1,consent:n=!1}=e;Je=t&&n,console.log(`[Analytics] Initialized, enabled:`,Je)}var Xe={windowMs:6e4,max:100};function Ze(e={}){Xe={...Xe,...e},console.log(`[RateLimit] Initialized: ${Xe.max} requests per ${Xe.windowMs}ms`)}var Qe=null,$e=new Set;function et(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function tt(e={}){Qe=et(e.length||32),$e.clear(),$e.add(Qe),console.log(`[CSRF] Initialized`)}var nt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function rt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function it(e={}){let{debug:t=!1,onReport:n=null}=e;if(!rt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),at(t,n),ot(t,n),st(t,n),ct(t,n),lt(t,n)}function at(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];nt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function ot(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function st(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);nt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ct(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function lt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];nt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var z={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},ut=null,dt=!1;function ft(){z.listeners.forEach(e=>e({...z}))}var pt={subscribe(e){return z.listeners.push(e),()=>{z.listeners=z.listeners.filter(t=>t!==e)}},async init(){dt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),z.maestro=E(),console.log(`[usePortalAuth.init] Maestro local:`,z.maestro?`found`:`not found`),z.loading=!0,ft(),typeof process<`u`&&{}.VITEST)return z.loading=!1,ft(),console.log(`[usePortalAuth.init] Completado (Test Env)`),z.maestro;if(!ut){let{data:{subscription:e}}=w.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),dt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),z.maestro=null,ft();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=E();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await k();e&&(z.maestro=e,ft())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});ut=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([k(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===A||t?.__pendingApproval?(z.maestro=null,z.pendingApproval=!0):(z.maestro=t,z.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),z.maestro=null,z.pendingApproval=!1}return z.loading=!1,ft(),console.log(`[usePortalAuth.init] Completado`),z.maestro}finally{dt=!1}},setMaestro(e){z.maestro=e,z.loading=!1,ft()},async logout(){await O(),z.maestro=null,ft()},getMaestro:()=>z.maestro,isAuthenticated:()=>!!z.maestro,isLoading:()=>z.loading,isPendingApproval:()=>z.pendingApproval},mt=pt.logout,ht=`calendario`;function gt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):ht}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:ht},``,`#/${ht}`),h(ht);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var _t=null;function vt(e,t){_t=e}function yt(e){_t&&_t(e)}var bt=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function xt(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function St(e){let{claseId:t,fecha:n,isValid:r}=xt(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}ue(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),At(e.notification);let t=e.notification;t?.data?.deep_link?St(t.data.deep_link):t?.data?.deep_link_url&&St(t.data.deep_link_url),B.some(t=>t.id===e.notification.id)||(B.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Lt())}});var Ct=new h(`maestro-notifications`),wt=30*1e3,Tt=60*1e3,Et=120*1e3,Dt=new Map;function Ot(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/Tt)}`}function kt(){let e=Date.now();for(let[t,n]of Dt.entries())e>n&&Dt.delete(t)}function At(e){let t=Ot(e),n=Date.now()+Et;Dt.set(t,n)}function jt(){return kt(),Dt.size}function Mt(e){return`notif_cache_${e}`}function Nt(e){try{let t=B.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(Mt(e),JSON.stringify(t))}catch{}}function Pt(e){try{let t=localStorage.getItem(Mt(e));return t?JSON.parse(t):[]}catch{return[]}}var B=[],Ft=[];function It(e){return Ft.push(e),e(B),()=>{Ft=Ft.filter(t=>t!==e)}}function Lt(){Ft.forEach(e=>e([...B]))}async function Rt(){let e=E();if(!e)return[];B.length===0&&(B=Pt(e.id),B.length>0&&Lt());try{let{data:t,error:n}=await w.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),B;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=B.filter(e=>String(e.id).startsWith(`local_`));return B=[...r,...i],await zt(e.id),Nt(e.id),Lt(),B}catch(e){return console.error(`[NotifService]`,e),B}}async function zt(e){try{let t=new Date,n=t.toISOString().split(`T`)[0],r=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[i,a]=await Promise.all([_(),c(e,n,n)]),o=i.map(e=>e.id),s=Object.fromEntries(i.map(e=>[e.id,e])),l=(await d(o)).filter(e=>e.dia?.toLowerCase()===r);a.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let u=new Set(a.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id)),f=new Date;for(let e of l){if(!e.hora_fin||u.has(e.clase_id))continue;let[t,r]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(f-i)/6e4;if(a<30)continue;let o=s[e.clase_id],c=`${e.clase_id}_${n}`;if(B.some(e=>e.referencia_id===c&&e.tipo===`sesion_sin_registrar`))continue;let l=e.hora_fin?e.hora_fin.slice(0,5):``,d=e.hora_inicio?e.hora_inicio.slice(0,5):``,p=d&&l?` (${d}–${l})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;B.unshift({id:`local_`+c,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${p} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}for(let e of l){if(!e.hora_inicio)continue;let[t,r]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(r,10),0,0);let a=(i-f)/6e4;if(a<0||a>15)continue;let o=s[e.clase_id],c=`prox_${e.clase_id}_${n}`;if(B.some(e=>e.referencia_id===c))continue;let l=e.hora_inicio?e.hora_inicio.slice(0,5):``,u=Math.round(a);B.unshift({id:`local_`+c,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${l?` a las ${l}`:``} empieza en ${u} ${u===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:c,clase_id:e.clase_id,fecha:n})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Bt(e){let t=E(),n=B.find(t=>t.id===e);if(n&&(n.estado=`leida`),Lt(),t&&Nt(t.id),!String(e).startsWith(`local_`))try{await w.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Vt(e){let t=E();if(B=B.filter(t=>t.id!==e),Lt(),t&&Nt(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await w.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Ht(){let e=E();if(B.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Lt(),e&&Nt(e.id),e)try{await w.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function Ut(){return B.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Wt=null;function Gt(){let e=E();e&&(Wt||(Wt=w.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};B.some(e=>e.id===n.id)||(B.unshift(n),Nt(e.id),Lt(),Kt(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=B.findIndex(e=>e.id===t.new.id);n!==-1&&(B[n]={...B[n],...t.new},Nt(e.id),Lt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),Wt=null,Zt())}),Ct.registerChannel(Wt)))}function Kt(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=qt(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),Yt(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function qt(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Jt=!1;function Yt(){if(Jt)return;Jt=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var Xt=null;function Zt(){Xt===null&&(Xt=setInterval(()=>{document.visibilityState!==`hidden`&&Rt()},wt),Ct.registerInterval(Xt))}function Qt(){Xt!==null&&(clearInterval(Xt),Xt=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Rt(),Zt()):Qt()});function $t(){let e=new Date().toISOString().split(`T`)[0];B=B.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}$t(),document.visibilityState!==`hidden`&&Zt(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var en=null,tn=null;function nn(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var rn={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(en=document.createElement(`div`),en.innerHTML=`
    ...
    `,document.body.appendChild(en),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Ht()}),tn=It(e=>{this.renderList(e)}),Rt())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=jt();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tienes notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=sn(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=cn(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${on(e.tipo)}">
            <i class="bi ${an(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${nn(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>Bt(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),rn.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>Bt(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Bt(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await Vt(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Rt()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=_e(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Rt()},close(){this._trap&&=(this._trap.dispose(),null),tn&&typeof tn==`function`&&(tn(),tn=null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function an(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function on(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function sn(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function cn(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=t.fecha||new Date().toISOString().split(`T`)[0];switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${i}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),P.show(`Auto-navegación cancelada`,`info`)})}async function Mn(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=E();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let o=await v(n.id,a);if(o&&o.length>0){e.innerHTML=Nn(o,i,r),Fn(e,a,n.id);return}let l=await _();if(!l||l.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let u=l.map(e=>e.id),f=Object.fromEntries(l.map(e=>[e.id,e])),p=(await d(u)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!p||p.length===0){e.innerHTML=`
      ...
      `;return}let m=new Date(r);m.setDate(m.getDate()-3);let h=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,`0`)}-${String(m.getDate()).padStart(2,`0`)}`,g=new Date(r);g.setDate(g.getDate()-1);let y=`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,`0`)}-${String(g.getDate()).padStart(2,`0`)}`,x=(await c(n.id,h,y)||[]).filter(e=>{if(!u.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await c(n.id,a,a)).filter(e=>u.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),ee=new Set(S.map(e=>e.clase_id)),C=await s(u),w={};for(let e of C||[])e.clase_id&&(w[e.clase_id]=(w[e.clase_id]||0)+1);let T=[...new Set(p.map(e=>e.salon_id).filter(Boolean))],E=T.length>0?await b(T):[],D=Object.fromEntries(E.map(e=>[e.id,e.nombre])),O=r.getHours()*60+r.getMinutes(),k=null,A=null,j=p.map(e=>{let t=f[e.clase_id],n=ee.has(t.id),r=w[t.id]||0,i=An(e.hora_inicio,e.hora_fin,O);i===`en-curso`&&(!n&&!k&&(k=t.id),n&&!A&&(A=t.id));let a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`,o=i===`en-curso`?`<span class="pm-badge pm-badge-en-curso"><i class="bi bi-circle-fill pm-pulse-dot me-1"></i>En curso</span>`:i===`proxima`?`<span class="pm-badge pm-badge-proxima"><i class="bi bi-clock me-1"></i>Próximamente</span>`:``;return`
        <div class="pm-clase-card ${[n?`registrada`:`sin-registrar`,i===`en-curso`?`pm-clase-en-curso`:``,i===`proxima`?`pm-clase-proxima`:``,i===`pasada`?`pm-clase-pasada`:``].filter(Boolean).join(` `)}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            <div class="meta-item"><i class="bi bi-clock"></i> ${Se(e.hora_inicio)} – ${Se(e.hora_fin)}</div>
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${F(D[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),te=x.length>0?`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await R.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await R.createSnapshotFromPlan(r,a,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})});let ne=k||A;ne&&(requestAnimationFrame(()=>{e.querySelector(`[data-clase-id="${ne}"]`)?.scrollIntoView({behavior:`smooth`,block:`center`})}),k&&setTimeout(()=>{jn(k,a,t)},800))}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${F(t.message)}</p>`}}function Nn(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=Pn(e.motivo);return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${Ce(t)} ${ye(n)}</h2>
  ...
  `}function Pn(e){return{suplencia:`pm-eme-motivo-suplencia`,eventual:`pm-eme-motivo-eventual`,reforzamiento:`pm-eme-motivo-reforzamiento`,otro:`pm-eme-motivo-otro`}[e]||`pm-eme-motivo-otro`}function Fn(e,t,n){e.querySelectorAll(`.pm-emergente-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`pm-card-loading`)||(e.classList.add(`pm-card-loading`),window.router&&window.router.navigate(`clase-emergente?fecha=${t}`),e.classList.remove(`pm-card-loading`))})})}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);if(e.id=`pm-hoy-pendientes-styles`,!document.getElementById(`pm-badge-warning-style`)){let e=document.createElement(`style`);e.id=`pm-badge-warning-style`,e.textContent=`
        .pm-badge-warning {
          background: rgba(245,158,11,0.15);
          color: #d97706;
  ...
  `,document.head.appendChild(e)}var In=null,Ln=null;function Rn(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;In=o,Ln=a,Ee.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
    ...
    <div class="pm-calendar-wrapper">
      ...
      <div class="pm-cal-grid-container">
        <div class="pm-cal-grid" role="grid" aria-label="Calendario ${xe[n]} ${t}">
          ${g}
        </div>
      </div>
...
`);r&&(n[r]=$n(i))}),{...$n(e),por_capas:n}}function tr(e){if(!e)return``;let t=nr(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(U.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Xn.capas}22; color:${Xn.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Xn.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Xn.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(U.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(U.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(U.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(U.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(U.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(U.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function nr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var rr=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function ir(e){if(!e||e.length===0)return rr.slice(0,6);let t=e.toLowerCase();return rr.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function ar(e){let t=rr.find(t=>t.trigger===e);return t?t.expand:null}function or(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function sr(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=sr(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var W=null,lr=[],ur=null,G=-1,dr=!1,fr=null,pr=!1,mr=0,hr=0;function gr(){if(!W){if(W=document.createElement(`div`),W.id=`pm-autocomplete-popup`,W.className=`pm-autocomplete-popup`,W.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(W)}}function _r(e,t,n={}){if(gr(),lr=e||[],ur=t,fr=n.trigger||null,G=-1,dr=!0,Cr(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),W.style.left=`${i}px`,W.style.top=`${a}px`}W.onmousedown=vr,document.addEventListener(`mousemove`,yr),document.addEventListener(`mouseup`,br),W.style.display=`block`}function vr(e){e.target.closest(`.pm-ac-option`)||(pr=!0,mr=e.clientX-W.offsetLeft,hr=e.clientY-W.offsetTop,W.style.cursor=`grabbing`,W.style.transition=`none`)}function yr(e){if(!pr)return;let t=e.clientX-mr,n=e.clientY-hr;W.style.left=`${Math.max(0,t)}px`,W.style.top=`${Math.max(0,n)}px`}function br(){pr&&(pr=!1,W.style.cursor=``)}function xr(){W&&(W.style.display=`none`,pr=!1,document.removeEventListener(`mousemove`,yr),document.removeEventListener(`mouseup`,br)),lr=[],ur=null,G=-1,dr=!1,fr=null}function Sr(e){lr=e||[],G=-1,Cr(e)}function Cr(e){if(!W)return;if(!e||e.length===0){W.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${Dr(fr)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===G,o=Or(fr,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Ar(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Ar(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),W.innerHTML=t,W.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{wr(parseInt(e.dataset.index,10))})})}function wr(e){if(e>=0&&e<lr.length){let t=lr[e];ur&&ur(t),xr()}}function Tr(e){if(!(!dr||lr.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),G=Math.min(G+1,lr.length-1),Cr(lr),Er();break;case`ArrowUp`:e.preventDefault(),G=Math.max(G-1,0),Cr(lr),Er();break;case`Enter`:e.preventDefault(),G>=0?wr(G):lr.length>0&&wr(0);break;case`Escape`:e.preventDefault(),xr();break;case`Tab`:lr.length>0&&G===-1&&(e.preventDefault(),wr(0));break}}function Er(){if(!W||G<0)return;let e=W.querySelector(`.pm-ac-option[data-index="${G}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Dr(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Or(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?kr(t.type):`•`}function kr(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Ar(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function jr(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function Mr(){return dr}function Nr(){return G}var Pr={show:_r,hide:xr,updateOptions:Sr,handleKeyDown:Tr,getCursorPosition:jr,isOpen:Mr,getSelectedIndex:Nr},Fr=`portal-maestros-catalogs`,Ir=1,Lr={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Rr=null;async function K(){return Rr||(Rr=await j(Fr,Ir,{upgrade(e){for(let[t,n]of Object.entries(Lr))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Rr)}async function zr(e,t){let n=await K(),r=await n.get(e,t);if(!r)return null;let i=Lr[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Br(e){let t=await(await K()).getAll(e),n=Lr[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Vr(e,t,n){return(await K()).getAllFromIndex(e,t,n)}async function Hr(e,t){let n=await K(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Ur(e,t){let n=(await K()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Wr(e,t){await(await K()).delete(e,t)}async function Gr(e){await(await K()).clear(e)}async function Kr(e){let t=await K(),n=Lr[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function qr(){let e=await K();for(let t of Object.keys(Lr))await e.clear(t)}async function Jr(e){return(await Br(e)).length}async function Yr(e,t){let n=await K(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Xr(e){return(await K()).get(`historial`,e)}async function Zr(e,t=5){return(await(await K()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var q={get:zr,getAll:Br,getByIndex:Vr,set:Hr,setBulk:Ur,remove:Wr,clear:Gr,cleanExpired:Kr,clearAll:qr,getStoreSize:Jr,addToHistorial:Yr,getHistorial:Xr,getTopUsed:Zr};async function Qr(e){if(!e)return[];try{let{data:t,error:n}=await w.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function $r(){let e=await q.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await w.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function ei(){let e=await q.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await w.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function ti(){let e=await q.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await w.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function ni(){let e=await q.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await w.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await q.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ri(){let e=await q.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await w.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await w.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await w.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await q.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function ii(e=null){let t=await q.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=w.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await q.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function ai(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Qr(n.claseId));break;case`[`:r=await $r();break;case`(`:r=await ti();break;case`{`:r=await ni();break;case`$`:r=await ei();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ri():await ii(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=oi(r,t)),e&&e!==`#`){let t=(await q.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function oi(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=si(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function si(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function ci(e,t){await q.addToHistorial(e,t)}var li=`
...
`;function ui(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
  ...
  `;let c=e.querySelector(`#pm-dsl-editable`),l=e.querySelector(`#pm-dsl-placeholder`),u=document.createElement(`div`);u.className=`dsl-tooltip`,e.appendChild(u);function d(){i=c.innerText,l.style.display=i.trim()===``?`block`:`none`,n&&n(i)}c.addEventListener(`mouseover`,t=>{let n=t.target.closest(`.dsl-objetivo`);if(n){u.textContent=`Objetivo: ${n.dataset.objetivo}`,u.style.display=`block`;let t=n.getBoundingClientRect(),r=e.getBoundingClientRect();u.style.left=`${t.left-r.left}px`,u.style.top=`${t.top-r.top-25}px`}}),c.addEventListener(`mouseout`,()=>{u.style.display=`none`});function f(){if(!a&&!o){a=!0;try{let e=window.getSelection();if(!e||e.rangeCount===0){a=!1;return}let t=ee(c,e.getRangeAt(0)),n=window.scrollY;i=c.innerText,c.innerHTML=tr(i),C(c,t),window.scrollY!==n&&window.scrollTo({top:n,behavior:`instant`})}catch(e){console.warn(`[DSL] Error en highlight:`,e),i=c.innerText}a=!1}}function p(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0),n=document.createRange();n.selectNodeContents(c),n.setEnd(t.endContainer,t.endOffset);let r=n.toString().match(/([#\[\(\{\$>])\s*([^\[\(\{\$]*)$/);return r?{trigger:r[1],query:r[2]||``}:null}let m=null;c.addEventListener(`mousedown`,()=>{m=null});function h(){let e=window.getSelection();!e||e.rangeCount===0||(m=ee(c,e.getRangeAt(0)))}function g(){c.focus(),m!==null&&C(c,m)}let _=null;async function v(e=null){let t,n;if(e)t=e,n=``;else{let e=p();if(!e){Pr.hide();return}t=e.trigger,n=e.query}try{let e=await ai(t,n,s);if(e.length>0){let r=jr();r&&(h(),Pr.show(e,e=>{y(e,t,n)},{trigger:t,position:r}))}else Pr.hide()}catch(e){console.warn(`[DSL] Error en autocompletado:`,e)}}function y(e,t,n){let r=x(e.nombre||e.name||e.label||e.descripcion||``),i=``;switch(t){case`#`:i=r;break;case`[`:i=r+`]`;break;case`(`:i=r+`)`;break;case`{`:i=r+`}`;break;case`$`:i=e.codigo||r;break;case`>`:i=e.level_number?`NIVEL-${e.level_number}`:e.type?`NODO:${e.type}`:r;break}g();let a=window.getSelection();if(!a||a.rangeCount===0){console.warn(`[DSL] Sin selección activa al insertar autocomplete`);return}if(n.length>0){let e=a.getRangeAt(0),t=document.createRange();t.selectNodeContents(c),t.setEnd(e.endContainer,e.endOffset);let r=t.toString(),i=r.length-n.length;try{let e=document.createRange();b(c,e,i,r.length),e.deleteContents()}catch(e){console.warn(`[DSL] Error limpiando query parcial:`,e)}}S(i+` `),ci(t,r)}function b(e,t,n,r){let i=0,a=[e],o=!1;for(;a.length>0;){let e=a.pop();if(e.nodeType===3){let a=i+e.length;if(!o&&n<=a&&(t.setStart(e,n-i),o=!0),o&&r<=a){t.setEnd(e,r-i);return}i=a}else for(let t=e.childNodes.length-1;t>=0;t--)a.push(e.childNodes[t])}}function x(e){if(!e)return``;let t=document.createElement(`div`);return t.innerHTML=e,t.textContent||t.innerText||``}function S(e){let t=x(e),n=window.getSelection();if(!n||n.rangeCount===0)return;let r=n.getRangeAt(0);r.deleteContents();let i=document.createTextNode(t);r.insertNode(i),r.setStartAfter(i),r.collapse(!0),n.removeAllRanges(),n.addRange(r),d(),f()}function ee(e,t){let n=t.cloneRange();return n.selectNodeContents(e),n.setEnd(t.endContainer,t.endOffset),n.toString().length}function C(e,t){let n=document.createRange(),r=window.getSelection();if(!r)return;let i=0,a=[e],o,s=!1;for(;a.length>0&&!s;)if(o=a.pop(),o.nodeType===3){let e=i+o.length;t<=e&&(n.setStart(o,t-i),n.collapse(!0),s=!0),i=e}else{let e=o.childNodes.length;for(;e--;)a.push(o.childNodes[e])}r.removeAllRanges(),r.addRange(n)}c.addEventListener(`compositionstart`,()=>{o=!0}),c.addEventListener(`compositionend`,()=>{o=!1,clearTimeout(w),w=setTimeout(f,150)});let w=null;c.oninput=()=>{d(),clearTimeout(w),w=setTimeout(f,150),clearTimeout(_),_=setTimeout(()=>v(),300)},c.addEventListener(`keydown`,e=>{Mr()&&Tr(e)}),c.addEventListener(`paste`,e=>{let t=e.clipboardData?.items;if(t&&Array.from(t).some(e=>e.type&&e.type.startsWith(`image/`))){e.preventDefault();let t=document.createElement(`div`);t.className=`pm-toast-image-blocked`,t.textContent=`🚫 No puedes pegar imágenes. Usa 🎤 para grabar audio o describe el contenido.`,t.style.cssText=`position:fixed; bottom:20px; left:50%; transform:translateX(-50%); background:#dc3545; color:white; padding:12px 20px; border-radius:8px; z-index:10000; font-size:14px;`,document.body.appendChild(t),setTimeout(()=>t.remove(),4e3)}});function T(e,t=0,n=null){c.focus();let r=window.getSelection();if(!r||r.rangeCount===0)return;let i=r.getRangeAt(0);i.deleteContents();let a=x(e),o=document.createTextNode(a);if(i.insertNode(o),t>0&&t<e.length){let e=document.createRange();e.setStart(o,t),e.collapse(!0),r.removeAllRanges(),r.addRange(e)}else i.setStartAfter(o),i.collapse(!0),r.removeAllRanges(),r.addRange(i);d(),f(),n&&setTimeout(()=>v(n),50)}return t&&(c.innerText=t,d(),f()),{insertText:T,getValue:()=>i,setValue:e=>{c.innerText=e,d(),f()},setContext:e=>{s=e}}}function di(e,{indicator:t,sessionId:n,studentId:r,teacherId:i,onSave:a}){let o=t.status||`pending`;R.getStatusToken(o);let s=document.createElement(`div`);s.className=`pm-node-eval-card pm-animate-fade-in status-${o}`,s.dataset.indicatorId=t.indicator_id,s.innerHTML=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function bi(t,n=null,i=[],a=[],o={},s){let c=t===`edit`&&!!n,l=c?n:{...o};!c&&o.contenido&&!l.notas_dsl&&(l.notas_dsl=o.contenido),!c&&o.maestro_nombre&&!a.find(e=>e.nombre===o.maestro_nombre)&&(a=[{id:o.maestro_id,nombre:o.maestro_nombre},...a]);let u=new x(l),d=document.getElementById(`pm-planificacion-modal`);if(d&&d.remove(),d=document.createElement(`div`),d.id=`pm-planificacion-modal`,d.className=`pm-plan-modal-overlay`,d.innerHTML=Si(c,u,i,a),document.body.appendChild(d),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Ci(),document.head.appendChild(e)}let f=()=>{d.classList.remove(`open`),setTimeout(()=>d.remove(),200)};d.querySelector(`.pm-plan-close-x`).onclick=f,d.querySelector(`.pm-plan-cancel-btn`).onclick=f,d.querySelector(`.pm-plan-backdrop`).onclick=f;let p=e=>{e.key===`Escape`&&(f(),document.removeEventListener(`keydown`,p))};document.addEventListener(`keydown`,p);let m=d.querySelector(`#pl-plantilla`);m&&m.addEventListener(`change`,e=>{let t=yi.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(d.querySelector(`#pl-objetivos`).value=t.objetivos,d.querySelector(`#pl-contenido`).value=t.contenido,d.querySelector(`#pl-recursos`).value=t.recursos,d.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Ti(d))});let h=d.querySelector(`#pl-clase_id`);h&&h.addEventListener(`change`,()=>{let e=d.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Ei(i,h.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),wi(d);let g=d.querySelector(`#dsl-editor-container`);if(g){let t=r({onSelect:async e=>{let t=(await Ne()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);n.component&&n.component.insertText(t+` `)}});document.body.appendChild(t);let n=e({initialContent:u.notas_dsl||``,onChange:(e,t)=>{let n=d.querySelector(`#dsl-summary`);n&&(n.textContent=Oi(t))},onAlumnoClick:()=>t.openModal()});g.appendChild(n),d._dslEditor=n}let _=d.querySelector(`.pm-plan-save-btn`);_.onclick=async()=>{let e=d.querySelector(`#pl-tema`)?.value.trim(),t=d.querySelector(`#pl-clase_id`)?.value;if(!e){d.querySelector(`#pl-tema`).focus();return}if(!t){d.querySelector(`#pl-clase_id`).focus();return}_.disabled=!0,_.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=d.querySelector(`#pl-recursos`)?.value||``,r=d._dslEditor,i={clase_id:t,maestro_id:d.querySelector(`#pl-maestro_id`)?.value||null,instrumento:d.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:d.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:d.querySelector(`#pl-objetivos`)?.value.trim(),contenido:d.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:d.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:d.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:c&&d.querySelector(`#pl-estado`)?.value||`planificado`};s&&await s(i),f()}catch(e){console.error(`[planificacionModal] Error:`,e),_.disabled=!1,_.textContent=c?`Guardar cambios`:`Guardar`}};let v=d.querySelector(`.pm-plan-body`);if(v){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;v.firstChild;)t.appendChild(v.firstChild);let n=document.createElement(`div`);n.style.cssText=`flex:1;min-width:0`,n.appendChild(t),e.appendChild(n),e.insertAdjacentHTML(`beforeend`,`
  ...
  `}function wi(e){[{input:`pl-tema`,count:`pl-tema-count`},{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&r.addEventListener(`input`,()=>{i.textContent=r.value.length})})}function Ti(e){[{input:`pl-objetivos`,count:`pl-obj-count`},{input:`pl-contenido`,count:`pl-cont-count`},{input:`pl-evaluacion`,count:`pl-eval-count`},{input:`pl-observaciones`,count:`pl-obs-count`}].forEach(({input:t,count:n})=>{let r=e.querySelector(`#`+t),i=e.querySelector(`#`+n);r&&i&&(i.textContent=r.value.length)})}function Ei(e,t,n){let r=e.find(e=>e.id===t);return r?.instrumento?r.instrumento.split(`,`).map(e=>e.trim()).filter(Boolean).map(e=>`<option value="${Di(e)}" ${n===e?`selected`:``}>${Di(e)}</option>`).join(``):``}function Di(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`):``}function Oi(e){let t=[];return e.alumnos.length&&t.push(`${e.alumnos.length} alum.`),e.contenido.length&&t.push(`${e.contenido.length} cont.`),e.tareas.length&&t.push(`${e.tareas.length} tar.`),e.calificacion&&t.push(`${e.calificacion.valor}/${e.calificacion.sobre}`),t.length?t.join(`, `):`Sin tokens`}var J={async getClasses(e=null){let t=w.from(`plan_clases`).select(`*`).eq(`activo`,!0);e&&(t=t.eq(`maestro_id`,e));let{data:n,error:r}=await t.order(`nombre`);return r?(console.error(`Error loading classes:`,r),[]):n},async resolveSmartPlan(e,t=null){let n=await this.getClasses(t||e.maestro_id);if(!n.length)return null;let r=n.find(t=>t.clase_id===e.id);if(r)return r;let i=(e.nombre||``).toLowerCase(),a=(e.instrumento||``).toLowerCase();return r=n.find(e=>(e.nombre||``).toLowerCase()===i),r||a&&(r=n.find(e=>(e.nombre||``).toLowerCase().includes(a)),r)?r:(r=n.find(e=>{let t=(e.nombre||``).toLowerCase();return i.includes(t)||t.includes(i)}),r||n[0])},async addClass(e,t=null,n=null){let r={nombre:e};t&&(r.maestro_id=t),n&&(r.clase_id=n);let{data:i,error:a}=await w.from(`plan_clases`).insert([r]).select().single();if(a)throw a;return i},async updateClass(e,t){let{error:n}=await w.from(`plan_clases`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteClass(e){let{error:t}=await w.from(`plan_clases`).delete().eq(`id`,e);if(t)throw t},async getLevelsByClass(e){let{data:t,error:n}=await w.from(`plan_niveles`).select(`*`).eq(`clase_id`,e).order(`numero_nivel`,{ascending:!0});return n?(console.error(`Error loading levels:`,n),[]):t},async addLevel({clase_id:e,nombre:t,numero_nivel:n}){let{data:r,error:i}=await w.from(`plan_niveles`).insert([{clase_id:e,nombre:t,numero_nivel:n||1}]).select().single();if(i)throw i;return r},async updateLevel(e,t){let{error:n}=await w.from(`plan_niveles`).update(t).eq(`id`,e);if(n)throw n},async deleteLevel(e){let{error:t}=await w.from(`plan_niveles`).delete().eq(`id`,e);if(t)throw t},async getNodesByLevel(e){let{data:t,error:n}=await w.from(`plan_temas`).select(`*`).eq(`nivel_id`,e).order(`orden_index`);return n?(console.error(`Error loading topics:`,n),[]):t},async addNode({nivel_id:e,nombre:t,tipo:n}){let{data:r,error:i}=await w.from(`plan_temas`).insert([{nivel_id:e,nombre:t,tipo:n||`TECNICA`}]).select().single();if(i)throw i;return r},async updateNode(e,t){let{error:n}=await w.from(`plan_temas`).update(t).eq(`id`,e);if(n)throw n},async deleteNode(e){let{error:t}=await w.from(`plan_temas`).delete().eq(`id`,e);if(t)throw t},async getObjectivesByNode(e){let{data:t,error:n}=await w.from(`plan_objetivos`).select(`*`).eq(`tema_id`,e).order(`orden_index`);return n?(console.error(`Error loading objectives:`,n),[]):t},async addObjective({tema_id:e,nombre:t}){let{data:n,error:r}=await w.from(`plan_objetivos`).insert([{tema_id:e,nombre:t}]).select().single();if(r)throw r;return n},async updateObjective(e,t){let{error:n}=await w.from(`plan_objetivos`).update({nombre:t}).eq(`id`,e);if(n)throw n},async deleteObjective(e){let{error:t}=await w.from(`plan_objetivos`).delete().eq(`id`,e);if(t)throw t},async getIndicatorsByObjective(e){let{data:t,error:n}=await w.from(`plan_indicadores`).select(`*`).eq(`objetivo_id`,e).order(`orden_index`);return n?(console.error(`Error loading indicators:`,n),[]):t},async addIndicator({objetivo_id:e,descripcion:t,es_requerido:n}){let{data:r,error:i}=await w.from(`plan_indicadores`).insert([{objetivo_id:e,descripcion:t,es_requerido:n??!0}]).select().single();if(i)throw i;return r},async updateIndicator(e,t){let{error:n}=await w.from(`plan_indicadores`).update(t).eq(`id`,e);if(n)throw n},async deleteIndicator(e){let{error:t}=await w.from(`plan_indicadores`).delete().eq(`id`,e);if(t)throw t},async getRouteHierarchy(e,t=null){let n=e;if(!n){let e=await this.getClasses(t);if(e.length>0)n=e[0].id;else return null}let{data:r,error:i}=await w.from(`plan_niveles`).select(`
        *,
        plan_temas (
          *,
          plan_objetivos (
  ...
  `,await Mi()}async function Ai(e,t,n,r){Ee.open({title:`Editar ${e}`,body:`
...
`)}function r(e,t){let n=sa[e.estado]||sa.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${ca[e.estado]||``}`:`ssp-alumno-chip`}">${ua(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${ua(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${ua(e.tarea)}</div>`:``;return`
  ...
  `,document.head.appendChild(e)}function ha({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function ga(e,t,n){let{data:r,error:i}=await w.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await w.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await w.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function _a(e,t){let{data:n,error:r}=await w.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function va(e){let{error:t}=await w.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function ya(e,t,n,r,i=null,a=null){try{let{error:o}=await w.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await w.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await M({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}var ba=`soi_ruta_tema_pendiente`;function xa(e){sessionStorage.setItem(ba,JSON.stringify(e))}function Sa(){let e=sessionStorage.getItem(ba);if(!e)return null;sessionStorage.removeItem(ba);try{return JSON.parse(e)}catch{return null}}function Ca(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
`),s=[];for(let e of o){let t=er(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ia({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ra({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await w.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ja(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ja(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await w.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var za={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Ba=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Va(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Ha={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function Ua(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Ha[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function Wa(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Va(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Va(n.join(`, `))}</span>`:``}}function o(e,t){let n=za[e.estado]??za.EN_PROGRESO,r=e.nota?` · ${Va(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Va(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Ha[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${Ua(c)}</div>`:``,d=Oe(r),f=d.length>0?`
  ...
  `,document.head.appendChild(e)}async function Ka(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await w.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${F(i.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${v?`📍 ${F(v)} · `:``}
            ${o?`${Se(o.hora_inicio)} – ${Se(o.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${ye(new Date(d+`T12:00:00`))}</span> · 
            ${s.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let O=e.querySelector(`#pm-sync-badge-container`);if(O){let e=Yn();O.appendChild(e.el)}let k=e.querySelector(`#pm-dsl-toolbar-container`),A=e.querySelector(`#pm-dsl-editor-container`),j=ui(A,{initialContent:h,onChange:e=>{C=e}});j.setContext({claseId:f});let te=pi(e,{onAceptar:e=>{j.setValue(e)}}),ne=or(e,{onAccept:e=>{j.setValue(e)}}),re=Wa(A.parentNode,{onConfirm:async t=>{try{let n=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ia({sesionId:x,claseId:f,maestroId:u.id,fechaHoy:d,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let a=e.querySelector(`#btn-guardar`);a&&(a.style.removeProperty(`display`),a.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Xa(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:o}=await a({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:s}=await Ra({claseId:f,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;P.success(c)}catch(e){P.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=cr(k,{onInsert:(e,t,n)=>j.insertText(e,t,n),getEditorContent:()=>j.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=k.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await ke(e);te.open({original:e,improved:t})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=k.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=D?.getActiveIndicador(),n=await Ae(e,{presentes:s.filter(e=>c[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async t=>{await Za(async()=>{let n=s.filter(e=>c[e.id]&&c[e.id]!==`A`),r=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},a=s.map(e=>e.nombre_completo||e.nombre||``),o={alumnos:s.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,a)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:r(t,a)}}),tipoClase:Ne(i),instrumento:i.instrumento||``,sesionesRecientes:(p||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:D?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Me(t,o);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.error(`Error al analizar con IA: `+t.message)}})}}),N=null,oe=e.querySelector(`#pm-planificacion-card`),se=e.querySelector(`#pm-planificacion-dropdown`),ce=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let le=e.querySelector(`#pm-plan-list-rutas`),ue=e.querySelector(`#pm-plan-list-planificaciones`),de=e.querySelector(`#pm-planificacion-header`);de&&de.addEventListener(`click`,()=>{let e=oe.classList.toggle(`open`);se.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;le.style.display=n===`rutas`?``:`none`,ue.style.display=n===`planificaciones`?``:`none`})});function fe(t){N=t.id,localStorage.setItem(`pm_default_plan_${f}`,t.id),ce&&(ce.textContent=t.nombre||t.name||`Sin nombre`),ue.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),D&&=(D.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);N&&n&&(n.innerHTML=``,Be(f).then(e=>{D=zi(n,{claseId:f,rutaId:N,completedTopics:e,onIndicadorSelect:e=>{j.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),oe.classList.remove(`open`),se.style.display=`none`}}),S.push(()=>D.destroy())}))}let pe=e.querySelector(`#btn-manage-planning`);pe&&(pe.onclick=e=>{if(e.stopPropagation(),!N){Ee.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ee.open({title:`Gestionar Estructura: ${ce.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(D&&D.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&ki(t,N)}),oe&&(async()=>{try{let e=await J.getClasses(u?u.id:null),t=localStorage.getItem(`pm_default_plan_${f}`),n=(i.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),r=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});le&&(le.innerHTML=r.length?r.map(e=>`
            ...
            </div>`).join(``),ue.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&fe(n)})})),oe.style.display=``;let a=e.find(e=>e.id===t)||r[0]||await J.resolveSmartPlan(i);a&&fe(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let me=e.querySelector(`#btn-proponer-curriculo`);me&&(me.onclick=async()=>{me.disabled=!0,me.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await Ka(f,12);if(e.registros.length===0){P.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await De(e,{instrumento:i?.instrumento||``,nivel:``,nombreClase:i?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:i?.instrumento||``,nivel:``})}catch(e){P.error(`Error al generar propuesta: `+e.message)}finally{me.disabled=!1,me.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let he=e.querySelector(`#btn-copy-as-plan`);he&&he.addEventListener(`click`,async()=>{let e=j.getValue();bi(`create`,null,await _(),[],{clase_id:f,maestro_id:u?.id||null,maestro_nombre:u?.nombre_completo||null,contenido:e||``,fecha_inicio:d},async e=>{try{await n({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),y&&(D=zi(e.querySelector(`#pm-route-tree-container`),{claseId:f,rutaId:y,onIndicadorSelect:t=>{j.insertText(`[${t.nombre}] `),ae.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),S.push(()=>D.destroy()));let ge=Sa();if(ge&&ge.claseId===f){let t=`[${ge.nombre}] `;j.insertText(t),ae.setContext({indicadorActivo:ge.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let _e=Ca(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&w.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&Oa(t).catch(console.warn),c[e]=null,delete l[e],we(e),R(),await Oe(!0),un(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await w.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await w.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=w.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await w.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{x||await Oe(!0,!1);let r=await Ea({sesionId:x,alumnoId:e,claseId:f,fecha:d,motivo:t,creadoPor:u.id},n);if(r.error)throw r.error;o=r.data}o&&(l[e]=o),_e.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{c[e]=t,we(e),R()}});S.push(()=>{try{_e.close()}catch{}});let ve=null,be=e.querySelector(`#pm-draft-indicator`);if(x){ve=ha({saveFn:async e=>{x&&await ga(x,u.id,e)},debounceMs:3e4}),ve.onSaved(()=>{let e=new Date;be.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,be.style.display=``}),j.getValue;let e=A.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),ve&&ve.onInput(j.getValue())}}S.push(()=>ve.destroy()),b?.borrador===!0&&_a(x,u.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(j.setValue(e.contenido_raw),C=e.contenido_raw):va(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let I=e.querySelector(`#btn-guardar-obs`);I&&(y&&(I.style.display=``),I.onclick=async()=>{let t=j.getValue();if(!t||!t.trim()){P.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!x){P.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let n=null,r=await Ve(t),a=D?.getActiveIndicador();if(n=r||a,!n){P.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let o=e.querySelector(`#pm-active-tema-badge`);o&&n.nombre&&(o.textContent=n.nombre,o.style.display=`inline-block`),I.disabled=!0,I.textContent=`Procesando...`;try{let r=s.filter(e=>c[e.id]===`P`),a=await Ki(t,n.id,r,n.nombre);if(a.error)throw Error(a.error);if(a.modo===`natural`&&a.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+a.dslGenerado+`

¿Guardar la evaluación?`)){I.disabled=!1,I.textContent=`Guardar observación`;return}if(a.missing.length>0&&!confirm(`Faltan ${a.missing.length} alumno(s) sin evaluar:\n${a.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){I.disabled=!1,I.textContent=`Guardar observación`;return}if(a.evaluaciones.length>0){let{error:e}=await Wi(x,n.id,a.evaluaciones,u.id,r);if(e)throw e}let o={indicador_id:n.id,evaluaciones:a.evaluaciones};await ya(x,u.id,t,o,a.dslGenerado||null,a.textoMejorado||null);let l=er(t);if(l.estados&&l.estados.length>0){let e=s.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));La({sesionId:x,claseId:f,maestroId:u.id,fechaHoy:d,dslText:t,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Pe(e,A)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let p=await ka(x,f,u.id,a.evaluaciones,i.nombre||`Clase`,r);p.success||console.warn(`[Fase C] Fallo parcial en promoción:`,p.error),D&&await D.refresh(),j.setValue(``),C=``;let m=document.createElement(`div`);if(m.innerHTML=`
        ...
        `,m.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(m),setTimeout(()=>m.remove(),4500),a.evaluaciones.length>0&&f&&n?.nombre){let{saved:e,error:t}=await Fa({sesionId:x,claseId:f,maestroId:u.id,fechaHoy:d,contenido:n.nombre,evaluaciones:a.evaluaciones});t&&console.warn(`[asistencia] Error al sincronizar progresos:`,t)}if(x){let{academicService:t}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:n}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DK2whUzX.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),r=await t.processSessionClosure(x);r&&r.length>0&&await n(e,r)}I.textContent=`¡Guardado!`,setTimeout(()=>{I.textContent=`Guardar observación`,I.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),P.error(`Error al guardar: `+(e.message||e)),I.disabled=!1,I.textContent=`Guardar observación`}});let xe=null,Ce=e.querySelector(`#pm-alumnos-list`);function we(e=null){let t=to(s,c),n=null;if(e){let t=Ce.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(Ce.innerHTML=t.map(e=>Te(e,c[e.id])).join(``),e&&n){let t=Ce.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Te(e,t){return`
    ...
    `}Ce.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),r=t.target.closest(`.pm-asist-nombre`);if(r){let t=r.closest(`.pm-asist-item`).dataset.id,n=s.find(e=>e.id===t);if(y){xe&&xe.destroy(),xe=oa({alumno:n,rutaId:y,sessionId:x,claseId:f,fecha:d,horaInicio:o?.hora_inicio||null}),xe.open(),S.push(()=>{xe&&xe.destroy()});return}let i=p.filter(e=>e.student_id===t);if(i.length===0)try{let{academicService:e}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(x,t,d);n?(i=n,p.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}fi(e,{student:n,sessionId:x,teacherId:u.id,snapshots:i});return}if(!n)return;let{id:i,action:a}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),a===`J`){let e=s.find(e=>e.id===i);if(!e)return;if(c[i]===`J`){let t=l[i]||null;!t&&x&&(t=await Da(x,i),t&&(l[i]=t)),_e.open(e,t,null),un(`Editando justificación de ${e.nombre_completo}.`)}else c[i]=`J`,we(i),R(),await Oe(!0),_e.open(e,null,null),un(`Justificación marcada para ${e.nombre_completo}.`);return}c[i]=c[i]===a?null:a,we(i),R();let m=Object.values(c).filter(e=>e===`P`).length,h=Object.values(c).filter(e=>e===`A`).length,g=Object.values(c).filter(e=>e===`J`).length;un(`Asistencia actualizada. ${m} presentes, ${h} ausentes, ${g} justificados.`),await Oe(!0)};function R(){let t=s.length,n=Object.values(c).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),a=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,a.textContent=`${n}/${t}`}async function Oe(e=!1,t=!1){T&&clearTimeout(T);let n=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t={...x?{}:{clase_id:f},maestro_id:u.id,fecha:d,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:C||``};if(navigator.onLine)try{if(x){let{error:e}=await w.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,x);if(!e){localStorage.setItem(`${ee}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await w.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){x=e.id,console.log(`[asistencia] Nueva sesión creada:`,x),localStorage.setItem(`${ee}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await M({tabla:`sesiones_clase`,operacion:x?`update`:`insert`,payload:{...x?{id:x}:{},...t}}),localStorage.setItem(`${ee}_updated`,new Date().toISOString())};e?t?await n():await E.run(n):T=setTimeout(()=>{E.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let je=e.querySelector(`.pm-asist-actions-fixed`);if(je){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),x&&(e.disabled=!0,e.innerHTML=`⏳...`,await Re(x),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=je.querySelector(`#btn-guardar`);je.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),f&&(n.disabled=!0,n.innerHTML=`⏳...`,await Ie(f,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),je.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let n=e.querySelector(`#btn-guardar`),r=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await E.run(async()=>{try{let r=s.filter(e=>c[e.id]).map(e=>({...f?{clase_id:f}:{},alumno_id:e.id,fecha:d,estado:c[e.id],registrado_por:u.id})),a=r.length>0,o=C&&C.trim().length>0;if(!a&&!o)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Oe(!0,!0),!x){let{data:e}=await w.from(`sesiones_clase`).select(`id`).eq(`clase_id`,f).eq(`maestro_id`,u.id).eq(`fecha`,d).maybeSingle();e&&(x=e.id)}if(a&&f)try{let e=r.map(e=>({...e,...x&&{sesion_clase_id:x}}));await t(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!x){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of r)await M({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:f,alumno_id:e.alumno_id,fecha:d,estado:e.estado,registrado_por:u.id,...x?{sesion_clase_id:x}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(x&&(a||o)){let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),{error:t}=await w.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,x).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await w.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,x).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await w.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,x))}m(),yt(`hoy`),yt(`calendario`),yt(`metricas`),Rt().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(x){let{academicService:t}=await L(async()=>{let{academicService:e}=await import(`./academicService-lra55_F4.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await L(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DK2whUzX.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await t.processSessionClosure(x);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let l=je?.querySelector(`#btn-reporte-dia`);l&&(l.style.display=``);let p=je?.querySelector(`#btn-resumen-mes`);p&&(p.style.display=``);let h=Object.values(c).filter(e=>e===`P`).length,g=Object.values(c).filter(e=>e===`A`).length;un(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
      ...
      `,document.body.appendChild(_);let v=_.querySelector(`#btn-resumen-pedagogico`),y=_.querySelector(`#btn-editar-asistencia`),b=_.querySelector(`#btn-compartir-correo`),S=_.querySelector(`#btn-compartir-whatsapp`),ee=_.querySelector(`#btn-volver-hoy`),T=_.querySelector(`#btn-ir-calendario`),E=pa();v&&(v.onclick=()=>{E.open({sesionId:x,claseNombre:i?.nombre||`Clase`,fecha:d,supabase:w})}),y&&(y.onclick=()=>{_.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),b&&(b.onclick=async()=>{let e=s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${i?.nombre||``} - ${d}`),n=Fe(e,C,s,i);ze(`mailto:?subject=${t}&body=`,n,1800)}),S&&(S.onclick=async()=>{ze(`https://wa.me/?text=`,Fe(s.filter(e=>c[e.id]).map(e=>({alumno_id:e.id,estado:c[e.id]})),C,s,i),1600)}),ee&&(ee.onclick=()=>{window.location.hash=`#/hoy`}),T&&(T.onclick=()=>{window.location.hash=`#/calendario`});let D=_.querySelector(`#btn-reporte-dia-overlay`);D&&(D.onclick=async()=>{let e=D.innerHTML;D.disabled=!0,D.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await Re(x)}finally{D.disabled=!1,D.innerHTML=e}});let O=_.querySelector(`#btn-resumen-mes-overlay`);O&&(f?O.onclick=async()=>{let e=O.innerHTML;O.disabled=!0,O.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Ie(f,e.getFullYear(),e.getMonth()+1)}finally{O.disabled=!1,O.innerHTML=e}}:(O.disabled=!0,O.title=`No disponible para actividades especiales`,O.style.opacity=`0.5`));let k=_.querySelector(`#btn-informe-ped-overlay`);k&&(f?k.onclick=async()=>{let e=k.innerHTML;k.disabled=!0,k.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Le(f,e.getFullYear(),e.getMonth()+1)}finally{k.disabled=!1,k.innerHTML=e}}:(k.disabled=!0,k.title=`No disponible para actividades especiales`,k.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=r,n.style.background=``},3e3)}})};function Ne(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Pe(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function Fe(e,t,n,r){if(!r)return`No hay datos de clase disponibles.`;let i=(e||[]).filter(e=>e.estado===`P`).length,a=(e||[]).filter(e=>e.estado===`A`).length,o=(e||[]).filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return s+=`Fecha: ${d||``}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
`,s+=`Presentes: ${i} | Ausentes: ${a} | Justificados: ${o}\n\n`,t&&t.trim()&&(s+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),s+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;s+=`- ${t}: ${r}\n`}),s}function ze(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;P.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}e.querySelector(`#pm-asist-back`).onclick=()=>{He.destroy();try{_e.close()}catch{}S.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{s.forEach(e=>{c[e.id]=`P`}),we(),R(),await Oe(!0),un(`Todos los ${s.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{s.forEach(e=>{c[e.id]=`A`}),we(),R(),await Oe(!0),un(`Todos los ${s.length} alumnos marcados como ausentes.`)},we();async function Be(e){try{let{data:t}=await w.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Ve(e){if(!e||!N)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await J.getRouteHierarchy(N),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let He=new vi(e);He.mount();let Ue=e.querySelector(`#pm-btn-help`);return Ue&&(Ue.onclick=()=>He.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),He.destroy();try{_e.close()}catch{}S.forEach(e=>{try{e()}catch{}})}}function to(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function no(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await w.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=no(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await M({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var io={async open(){let e=await le(),t=await se();Ee.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await oe()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await N();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await de()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await ce({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},ao={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function oo(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>ao[e])}var so={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);uo(n,t),fo(n,t),yo(n,t),po(r),mo(r,t),ho(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),go(r),_o(r),Do(t),So(t),Oo(),L(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-BqWyDF0U.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&vo(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function uo(e,t){let n=be(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function mo(e,t){let n=ie(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=ko,document.head.appendChild(e)}async function Ao(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=E();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await J.getClasses(t.id),{data:r}=await w.from(`clases`).select(`id, nombre, instrumento`).or(`maestro_principal_id.eq.${t.id},maestro_suplente_id.eq.${t.id},maestro_id.eq.${t.id}`).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let n=await J.getRouteHierarchy(e,t.id);if(!n||n.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let r=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,i=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}var Mo=`alumno_plan_entradas`;async function No(e){let{data:t,error:n}=await w.from(Mo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function Po(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await w.from(Mo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function Fo(e){let{error:t}=await w.from(Mo).delete().eq(`id`,e);if(t)throw Error(t.message)}var Io={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},Lo=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],Ro=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await No(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
...
`).trim():``}var Ko={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function qo(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await w.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await w.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Ko[n.estado_cualitativo]??Ko.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
      ...
      `;return}let{data:a}=await w.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await w.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await w.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id, covered_by_clase_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await w.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await w.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,g=c.filter(e=>e.estado===`J`).length,_=c.filter(e=>e.estado===`T`).length,v=p>0?Math.round(m/p*100):0,y=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],b={};y.forEach(e=>{let t=e.covered_by_clase_id||`sin_clase`;b[t]||(b[t]=[]),b[t].push(e.nota)});let x=Object.values(b).map(e=>e.reduce((e,t)=>e+t,0)/e.length),S=x.length>0?Math.round(x.reduce((e,t)=>e+t,0)/x.length*10)/10:0,C=y.filter(e=>e.nota>=4).length,T=y.length,E=T>0?Math.round(C/T*100):0,D={};c.forEach(e=>{D[e.clase_id]||(D[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(D[e.clase_id][e.estado]=(D[e.clase_id][e.estado]||0)+1,D[e.clase_id].total++)});let O=new Set([...o,...Object.keys(D)]),{data:k}=O.size>0?await w.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...O]):{data:[]},A=new Map((k||[]).map(e=>[e.id,e])),j=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),te=l?.filter(e=>e.observations?.trim())||[],ne=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;ne=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&ne--}let re=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,M=(r.instrumento_principal||``).toLowerCase(),ie=`var(--pm-primary)`;(M.includes(`violin`)||M.includes(`cuerda`))&&(ie=`#FF3B30`),(M.includes(`piano`)||M.includes(`teclado`))&&(ie=`#FF9500`),M.includes(`guitarra`)&&(ie=`#5856D6`),(M.includes(`canto`)||M.includes(`voz`))&&(ie=`#AF52DE`),e.innerHTML=`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-mosaic" style="grid-template-columns: repeat(2, 1fr);">
            <div class="pm-zen-card pm-zen-card--large pm-glass" style="grid-column: span 2;">
              ...
              <p style="font-size:0.72rem;color:var(--pm-text-muted);margin-top:0.4rem;">
                ${C} de ${T} indicadores aprobados · ${E}%
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-clases-grid">
              ${o.map(e=>{let t=A.get(e);if(!t)return``;let n=D[e]||{P:0,A:0,J:0,T:0,total:0},r=n.total>0?Math.round(n.P/n.total*100):null,i=l?.filter(t=>t.covered_by_clase_id===e&&t.nota!=null&&t.nota!==0)||[],a=i.length>0?Math.round(i.reduce((e,t)=>e+t.nota,0)/i.length*10)/10:null;return`
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${j.map(e=>{let t=A.get(e.clase_id),n=Go(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion" ${c.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${c.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:c.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=A.get(e.clase_id),i=e.estado===`J`?f.get(e.sesion_id):null;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${ee(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `}}var Yo={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},Xo={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},Zo={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function Qo(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(Yo))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function $o(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=E();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await w.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await w.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
    ...
    `,e.querySelector(`#pm-student-select`).addEventListener(`change`,async t=>{let n=t.target.value;if(!n){e.querySelector(`#pm-progress-content`).innerHTML=``;return}await es(e,n)})}catch(t){e.innerHTML=`<p class="pm-empty">Error: ${F(t.message)}</p>`}}async function es(e,t){let n=e.querySelector(`#pm-progress-content`);n.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:e}=await w.from(`alumnos`).select(`nombre, apellido`).eq(`id`,t).single(),{data:r}=await w.from(`academic_plans`).select(`id, route_version_id, status`).eq(`student_id`,t).in(`status`,[`in_process`,`active`]).order(`created_at`,{ascending:!1}).limit(1).maybeSingle();if(!r){n.innerHTML=`
      ...
      `;return}let{data:i}=await w.from(`levels`).select(`*`).eq(`route_version_id`,r.route_version_id).order(`level_number`,{ascending:!0}),{data:a}=await w.from(`student_level_progress`).select(`*`).eq(`student_id`,t),{data:o}=await w.from(`nodes`).select(`*, indicators(*)`).in(`level_id`,(i||[]).map(e=>e.id)).order(`order_index`,{ascending:!0}),{data:s}=await w.from(`student_node_progress`).select(`*, indicator_attempts(*)`).eq(`student_id`,t),c=(a||[]).filter(e=>e.status===`approved`).length,l=i?.length||0,u=l>0?Math.round(c/l*100):0;n.innerHTML=`
    ...
    `}catch(e){n.innerHTML=`<p class="pm-empty">Error: ${F(e.message)}</p>`}}async function ts(e){let t=(await _())?.find(t=>t.id===e)?.instrumento;if(!t)return null;let n=t.split(`,`)[0].trim().toLowerCase(),{data:r,error:i}=await w.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${n}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();return i?(console.warn(`[rutaService] resolveRutaIdForClase error:`,i.message),null):r?.route_versions?.[0]?.id||r?.route_versions?.id||null}async function ns(e,t){let{data:n,error:r}=await w.from(`blocks`).select(`id, nombre:name, order_index`).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(r)throw Error(`[rutaService] blocks: `+r.message);if(!n||n.length===0)return[];let i=n.map(e=>e.id),{data:a,error:o}=await w.from(`levels`).select(`id, block_id, nombre:name, order_index`).in(`block_id`,i).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(o)throw Error(`[rutaService] levels: `+o.message);let s=(a??[]).map(e=>e.id);if(s.length===0)return n.map(e=>({...e,levels:[]}));let{data:c,error:l}=await w.from(`nodes`).select(`id, level_id, nombre:name, order_index`).in(`level_id`,s).eq(`route_version_id`,e).order(`order_index`,{ascending:!0});if(l)throw Error(`[rutaService] nodes: `+l.message);let u=(c??[]).map(e=>e.id),{data:d,error:f}=u.length>0?await w.from(`indicators`).select(`id, node_id, nombre:description, order_index`).in(`node_id`,u).eq(`activo`,!0).order(`order_index`,{ascending:!0}):{data:[],error:null};if(f)throw Error(`[rutaService] indicators: `+f.message);let p=await Promise.all((c??[]).map(e=>Gi(e.id,t).then(t=>({nodeId:e.id,semaphore:t.semaphore})).catch(()=>({nodeId:e.id,semaphore:`gray`})))),m=new Map(p.map(e=>[e.nodeId,e.semaphore])),h=new Map;for(let e of d??[])h.has(e.node_id)||h.set(e.node_id,[]),h.get(e.node_id).push({...e,semaphore:m.get(e.node_id)??`gray`});let g=new Map;for(let e of c??[])g.has(e.level_id)||g.set(e.level_id,[]),g.get(e.level_id).push({...e,semaphore:m.get(e.id)??`gray`,indicators:h.get(e.id)??[]});let _=new Map;for(let[e]of i.map(e=>[e]))_.set(e,[]);let v=new Map;for(let e of a??[])v.has(e.block_id)||v.set(e.block_id,[]),v.get(e.block_id).push(e);for(let[e,t]of v){let n=t.map((e,t,n)=>{let r=g.get(e.id)??[],i=r.flatMap(e=>h.get(e.id)??[]),a=i.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length,o=i.length>0?Math.round(a/i.length*100):0,s=r.map(e=>e.semaphore),c=s.every(e=>e===`green`)&&s.length>0?`green`:s.every(e=>e===`gray`)||s.length===0?`gray`:`yellow`,l=!1;if(t>0){let e=n[t-1],r=(g.get(e.id)??[]).flatMap(e=>h.get(e.id)??[]),i=r.filter(e=>(m.get(e.node_id)??`gray`)===`green`).length;l=r.length>0&&i/r.length<.8}return{...e,semaphore:c,locked:l,percentage:o,nodes:r}});_.set(e,n)}return n.map(e=>({...e,levels:_.get(e.id)??[]}))}var rs=new Map,is={on(e,t){rs.has(e)||rs.set(e,[]),rs.get(e).push(t)},off(e,t){if(!rs.has(e))return;let n=rs.get(e),r=n.indexOf(t);r>-1&&n.splice(r,1)},emit(e,t){rs.has(e)&&rs.get(e).forEach(n=>{try{n(t)}catch(t){console.error(`[rutaEventEmitter] Error in listener for ${e}:`,t)}})},clearAllListeners(){rs.clear()}};function as(e,t){let{blockId:n,blockName:r,isExpanded:i,childCount:a,onToggle:o}=t;e.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,fs(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{xa({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function hs(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function gs(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await ds(),fs(e),gs(e)})}function _s(e){ls||(ls=!0,is.on(`node-covered`,()=>{ds().then(()=>{fs(e),gs(e)})}))}var vs=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function ys(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=E();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await w.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
      ...
      `;return}let{data:r}=await w.from(`instrumentos`).select(`id, nombre`).order(`nombre`),{data:i}=await w.from(`maestros`).select(`id, nombre, email`).neq(`id`,t.id).order(`nombre`);e.innerHTML=`
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,u=null,d=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{let{data:e}=await w.from(`route_versions`).select(`id`).eq(`route_id`,l).eq(`is_current`,!0).single();u=e.id,d=await R.getRouteDetail(l);let t=[];d.forEach(e=>{e.levels.forEach(n=>{t.push({id:n.id,name:n.name,blockName:e.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await R.createAcademicPlan(t,u),await w.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${F(t.message)}</p></div>`}}async function xs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await w.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await R.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await w.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
  ...
  `}function Ns(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await he(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){P.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function Ps(e){return`
    <div class="gcv-root">
