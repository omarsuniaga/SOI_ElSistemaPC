...
canonical_path: 09_SOI_WEB_PORTAL\sistema-academico-pwa\docs\USER_GUIDE.md
origin_path: null
...
| Save observation | Ctrl+S |
| New plan | Ctrl+N |

### Pro Tips

- Use **@mentions** to reference other students in observations
- Use **#indicators** to tag specific learning outcomes
- Review **progress charts** weekly to identify struggling students
- Enable **Web Push** for real-time class reminders

---

## Need Help?

- Check the [Developer Guide](./DEVELOPER.md) for technical issues
...
*Built for teachers, by teachers at El Sistema Punta Cana.*