...
import{A as e,D as t,G as n,I as r,J as i,K as a,O as o,Q as s,U as c,X as l,Y as u,_ as d,a as f,at as p,ct as m,et as h,f as g,g as _,h as v,i as y,it as b,m as x,n as S,nt as C,o as w,ot as T,q as E,r as D,rt as O,s as k,st as A,t as ee,tt as te,y as ne}from"./adminNotificacionesView-Dsg5lD04.js";import{i as j}from"./supabase-C4ics26R.js";import{a as re,i as ie,n as ae,r as M,t as oe}from"./maestroAuth-Cae-9DFh.js";import{t as se}from"./idb-DOPm7uLh.js";import{i as ce,n as le,t as ue}from"./offlineQueue-Cjwl3aiF.js";import{a as de,c as fe,d as pe,f as me,i as he,l as ge,n as _e,r as ve,s as ye,t as N,u as be}from"./pushService-DQD3mJWH.js";import"./vendor-BhXhnmkW.js";import{t as P}from"./AppToast-BOjiJExQ.js";import{t as xe}from"./preload-helper-CsoeaaUJ.js";import{t as F}from"./academicService-DX1WEsMf.js";import{a as Se,c as Ce,i as I,l as we,n as Te,o as Ee,r as De,s as Oe,t as ke}from"./portalUtils-CisZ9vg-.js";import{t as Ae}from"./AppModal-CLA9fW7x.js";import{a as je,i as Me,o as Ne,s as Pe,t as Fe}from"./groqService-CpEtzfwM.js";import{n as Ie,t as Le}from"./ausenciaModal-BAKZ-Gr2.js";import{n as Re,r as ze,t as Be}from"./reportService-B_GwkrIg.js";import{a as Ve,c as He,s as Ue,u as We}from"./clasesApi-CiNtdXkj.js";import{r as Ge,t as Ke}from"./permisoService-CVH_7Qhu.js";var qe=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Je(e=``){let t=String(e).toLowerCase();return qe.some(e=>t.includes(e.toLowerCase()))}var Ye=console.error;console.error=function(...e){e.length>0&&!Je(e[0])&&Ye.apply(console,e)};var Xe=console.warn;console.warn=function(...e){e.length>0&&!Je(e[0])&&Xe.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Je(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Je(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ze=window.fetch;window.fetch=async function(...e){try{return await Ze.apply(window,e)}catch(e){if(!Je(e.message))throw e;return null}};var Qe=!1;function $e(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Qe=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function et(e,t={}){if(!Qe&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var tt=!1;function nt(e={}){let{enabled:t=!1,consent:n=!1}=e;tt=t&&n,console.log(`[Analytics] Initialized, enabled:`,tt)}var rt={windowMs:6e4,max:100};function it(e={}){rt={...rt,...e},console.log(`[RateLimit] Initialized: ${rt.max} requests per ${rt.windowMs}ms`)}var at=null,ot=new Set;function st(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function ct(e={}){at=st(e.length||32),ot.clear(),ot.add(at),console.log(`[CSRF] Initialized`)}var lt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function ut(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function dt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!ut()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ft(t,n),pt(t,n),mt(t,n),ht(t,n),gt(t,n)}function ft(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];lt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function pt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function mt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);lt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ht(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function gt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var L={maestro:null,loading:!0,listeners:[]},_t=null;function vt(){L.listeners.forEach(e=>e({...L}))}var yt={subscribe(e){return L.listeners.push(e),()=>{L.listeners=L.listeners.filter(t=>t!==e)}},async init(){if(console.log(`[usePortalAuth.init] Iniciando...`),L.maestro=M(),console.log(`[usePortalAuth.init] Maestro local:`,L.maestro?`found`:`not found`),L.loading=!0,vt(),typeof process<`u`&&{}.VITEST)return L.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),L.maestro;if(!_t){let{data:{subscription:e}}=j.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),L.maestro=null,vt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=M();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);let e=await ae();e&&(L.maestro=e,vt())}}});_t=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([ae(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),L.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),L.maestro=null}return L.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado`),L.maestro},setMaestro(e){L.maestro=e,L.loading=!1,vt()},async logout(){await re(),L.maestro=null,vt()},getMaestro:()=>L.maestro,isAuthenticated:()=>!!L.maestro,isLoading:()=>L.loading},bt=yt.logout,xt=`calendario`;function St(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):xt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())});let e=o();e!==xt&&history.replaceState({route:e},``,`#/${e}`),h(e)}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var R=null,Ct=null;function wt(e,t=`polite`){R||(R=document.createElement(`div`),R.setAttribute(`aria-live`,t),R.setAttribute(`aria-atomic`,`true`),R.classList.add(`pm-visually-hidden`),document.body.appendChild(R)),t===`assertive`?(R.setAttribute(`role`,`alert`),R.setAttribute(`aria-live`,`assertive`)):(R.removeAttribute(`role`),R.setAttribute(`aria-live`,`polite`)),clearTimeout(Ct),Ct=setTimeout(()=>{R.textContent=``,requestAnimationFrame(()=>{R.textContent=e})},50)}function Tt(e,t){if(!e||!e.id)return;Et(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function Et(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function Dt(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>Et(e))}function Ot(e,{onSuccess:t}){e.innerHTML=`
  ...
  `,document.head.appendChild(e)}var Mt=null,Nt=null;function Pt(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],maestroId:i=null,onSave:a=null}=e;Mt=a,Nt=i,Ae.open({title:`⚡ Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
          ...
          <div class="pm-emergente-grid">
            ...
            <div class="pm-emergente-field">
              ...
              <select class="pm-emergente-select" id="modal-clase_id" required>
                ...
                ${r.map(e=>`<option value="${e.id}" ${e.id===n?`selected`:``}>${Ft(e.nombre)}</option>`).join(``)}
              </select>
            </div>
            <div class="pm-emergente-field">
...
`);r&&(n[r]=Qt(i))}),{...Qt(e),por_capas:n}}function en(e){if(!e)return``;let t=tn(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(B.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${Yt.capas}22; color:${Yt.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${Yt.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${Yt.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(B.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(B.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(B.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(B.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(B.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(B.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function tn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var nn=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function rn(e){if(!e||e.length===0)return nn.slice(0,6);let t=e.toLowerCase();return nn.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function an(e){let t=nn.find(t=>t.trigger===e);return t?t.expand:null}function on(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function sn(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=sn(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var V=null,ln=[],un=null,H=-1,dn=!1,fn=null,pn=!1,mn=0,hn=0;function gn(){if(!V){if(V=document.createElement(`div`),V.id=`pm-autocomplete-popup`,V.className=`pm-autocomplete-popup`,V.style.cssText=`
    position: fixed;
    display: none;
