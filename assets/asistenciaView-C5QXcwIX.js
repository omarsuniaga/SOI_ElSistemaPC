const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/academicService-CcV8qAMj.js","assets/AppModal-B8f8dDnR.js","assets/supabase-Cgh_dhNB.js","assets/LevelCompletionModal-Du_KQRU_.js","assets/portalUtils-CkF82Yyk.js","assets/AchievementsSummaryModal-CJ9jpoV7.js"])))=>i.map(i=>d[i]);
import{i as e,r as t,s as n}from"./AppModal-B8f8dDnR.js";import{a as r,i,n as a,r as o,s}from"./pwaInstaller-BvjserFL.js";import{a as c,i as l}from"./supabase-Cgh_dhNB.js";import{i as u}from"./maestroAuth-DOk-16l6.js";import{c as d,n as f,r as p,s as m,t as h}from"./main-maestros-C3SjGtt-.js";import{t as g}from"./idb-hTByFGMt.js";import{x as _}from"./planificacion-Hh8kRf8q.js";import{t as v}from"./config-CNiOV0RX.js";import{c as y}from"./asistenciasApi-D2Jkgv58.js";import{i as b,n as x,o as S,r as C}from"./reportService-DdRegosF.js";import{c as w,i as T,l as E,o as D,s as O,t as k}from"./groqService-Cu889xeB.js";import{t as A}from"./academicService-CcV8qAMj.js";import{a as j,i as M,l as N,o as P,s as ee}from"./portalUtils-CkF82Yyk.js";import{t as te}from"./a11yUtils-DRYT20ux.js";import{a as F,c as I,d as L,i as ne,l as R,n as z,o as re,r as B,s as V,t as H}from"./weeklyPlanAdapter-DNVUXbnX.js";import{a as U,i as ie,n as ae,o as oe,r as se}from"./evaluationService-NyCN2RlY.js";function ce(e={}){let{showSyncButton:t=!0}=e,n=document.createElement(`div`);n.className=`pm-sync-badge`,n.style.cssText=`
    display: none;
    align-items: center;
    gap: 6px;
    padding: 4px 10px;
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{le(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function de(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,_e=class{constructor(e,t=he){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(pe)||(this._autoTimer=setTimeout(()=>this.start(),me))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(pe,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=ge,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
  ...
  `}function we(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${W(be(e.updated_at||e.created_at))}</span>
  ...
  `}function Te(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores cargados para este nivel.</p>`}function Ee(e,{indicatorSummaries:t,avance:n}){return`
    ${Ce(e,n)}
  ...
  `}function ke({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a,onProgressSaved:o}){ve();let s=document.createElement(`aside`);s.className=`pm-student-panel`,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-modal`,`false`),s.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(s);let c=[],l=null;function d(){ee()===`desktop`?s.classList.add(`pm-student-panel--desktop`):s.classList.remove(`pm-student-panel--desktop`)}let f=N(d);d();function p(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){v();return}if(n===`toggle-history`){let e=t.dataset.idx,n=s.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;m(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;m(e,n);return}}async function m(e,t=null){let n=c[e],r=t===null?null:n.history[t],i=r?.status??`not_started`,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-status]`);if(t){a.querySelectorAll(`[data-status]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=t.dataset.status;return}let r=e.target.closest(`[data-action]`)?.dataset.action;if(r===`modal-close`)a.remove();else if(r===`modal-save`){let e=a.querySelector(`#modal-obs`).value,t=a.querySelector(`#modal-evidence`).value;await g(n.id,i,e,t),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function g(t,r,i,a){try{if(!u())throw Error(`No hay sesión de maestro activa.`);await L(e.id,t,r,i.trim(),a.trim(),n),typeof o==`function`&&await o({alumnoId:e.id,indicatorId:t,status:r}),await _()}catch(e){console.error(`[studentProgressPanel] Error saving:`,e),alert(`Error al guardar: `+(e.message||e))}}s.addEventListener(`click`,p),s.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function _(){s.innerHTML=De(),s.classList.add(`pm-student-panel--open`),l&&l.dispose(),l=h(s,{onClose:()=>v()});try{let n=await Se(e.id,t,r);c=n.indicatorSummaries,s.innerHTML=Ee(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading:`,e),s.innerHTML=Oe(e?.message??`Error desconocido al cargar datos.`)}}function v(){s.classList.remove(`pm-student-panel--open`),l&&=(l.dispose(),null),setTimeout(()=>{s.classList.contains(`pm-student-panel--open`)||(s.innerHTML=``,c=[])},300)}function y(){l&&=(l.dispose(),null),f(),s.removeEventListener(`click`,p),s.remove()}return{open:_,close:v,destroy:y}}var Ae={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},je={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Me={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function Ne(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Pe(e){return(e||``).trim().toLowerCase()}function Fe(e){let t=new Map;for(let n of e){let e=Pe(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Ie(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Me[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Me[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=Ae[e.estado]||Ae.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${je[e.estado]||``}`:`ssp-alumno-chip`}">${Ne(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Ne(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Ne(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${Ne(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Ne(i)} · ${Ne(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}var Re=`documentos`;async function ze(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await l.storage.from(Re).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=l.storage.from(Re).getPublicUrl(r);return o.publicUrl}async function Be({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){let c=[];if(e||c.push(`sesionId`),t||c.push(`alumnoId`),r||c.push(`fecha`),i||c.push(`motivo`),o||c.push(`creadoPor`),c.length>0)return{error:{message:`Faltan campos requeridos: ${c.join(`, `)}`}};let u=null;if(s)try{u=await ze(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let d={sesion_id:e,alumno_id:t,clase_id:n||null,fecha:r,motivo:i,evidencia_url:u||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:f,error:p}=await l.from(`justificaciones`).upsert([d],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:f,error:p}}async function Ve(e,t){if(!e||!t)return null;let{data:n,error:r}=await l.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function He(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await l.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}function Ue(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function K(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function We(e,t){let n=K(e);return t.find(e=>K(e.nombre)===n||K(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&K(e.nombre).includes(n)||n.length>=3&&n.includes(K(e.nombreCorto||e.nombre.split(` `)[0])))??null}function Ge(e,t){let n=[],r=[];for(let i of e){if(K(i)===`todos`){n.push(...t);continue}let e=We(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function Ke(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await l.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function qe({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=w(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await Ke(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function Je({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=Ge(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await Ke(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function Ye({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=U(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Je({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Xe({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await l.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:K(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=K(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await l.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Ze={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Qe=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function q(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var $e={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function et(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=$e[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function tt(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${q(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${q(n.join(`, `))}</span>`:``}}function o(e,t){let n=Ze[e.estado]??Ze.EN_PROGRESO,r=e.nota?` · ${q(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${q(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=$e[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${et(c)}</div>`:``,d=E(r),f=d.length>0?`
    ...
    `,nt(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(Qe.indexOf(i)+1)%Qe.length;r[n].estado=Qe[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function nt(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
  ...
  `,document.head.appendChild(e)}async function rt(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await l.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=it[e.tipo]??it.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${ot(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${ot(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${ot(o)}" placeholder="ej. Básico" />
          </label>
        </div>
    ...
    `,a.querySelectorAll(`.cpp-pilar-title`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=document.createElement(`input`);n.type=`text`,n.className=`cpp-input cpp-inline-input`,n.value=r[t].nombre,e.replaceWith(n),n.focus();let i=()=>{r[t].nombre=n.value.trim()||r[t].nombre,d(c(),l())};n.onblur=i,n.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),i())}}}),a.querySelectorAll(`.cpp-objetivo-text`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj),i=document.createElement(`input`);i.type=`text`,i.className=`cpp-input cpp-inline-input`,i.value=r[t].objetivos[n].descripcion,e.replaceWith(i),i.focus();let a=()=>{r[t].objetivos[n].descripcion=i.value.trim()||r[t].objetivos[n].descripcion,d(c(),l())};i.onblur=a,i.onkeydown=e=>{e.key===`Enter`&&(e.preventDefault(),a())}}}),a.querySelectorAll(`.cpp-remove-obj`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar),n=parseInt(e.dataset.obj);r[t].objetivos.splice(n,1),d(c(),l())}}),a.querySelectorAll(`.cpp-remove-pilar`).forEach(e=>{e.onclick=()=>{let t=parseInt(e.dataset.pilar);r.splice(t,1),d(c(),l())}});let m=a.querySelector(`#cpp-instrumento`),h=a.querySelector(`#cpp-adopt`);m&&h&&(m.oninput=()=>{h.disabled=!u()}),h&&(h.onclick=()=>{let e=c(),n=l();if(!e){m?.focus();return}t({instrumento:e,nivel:n,resumen:i,pilares:r}),p()});let g=a.querySelector(`#cpp-cancel`);g&&(g.onclick=()=>{n&&n(),p()})}function f({pilares:t=[],resumen:n=``,instrumento:o=``,nivel:s=``}){r=t.map(e=>({...e,objetivos:(e.objetivos||[]).map(e=>({...e}))})),i=n,a||(a=document.createElement(`div`),a.className=`cpp-panel`,e.appendChild(a)),a.style.display=`block`,d(o,s),setTimeout(()=>a.scrollIntoView({behavior:`smooth`,block:`nearest`}),50)}function p(){a&&(a.style.display=`none`,a.innerHTML=``)}return{open:f,close:p}}new Date().toISOString();var ct=n({actualizarCurriculo:()=>ft,actualizarObjetivo:()=>vt,actualizarPilar:()=>ht,adoptarPropuesta:()=>bt,crearCurriculo:()=>dt,crearObjetivo:()=>_t,crearPilar:()=>mt,eliminarObjetivo:()=>yt,eliminarPilar:()=>gt,listarCurriculos:()=>ut,obtenerCurriculo:()=>lt,toggleActivoCurriculo:()=>pt});async function lt(e,t){let n=l.from(`curriculos`).select(`
      id, instrumento, nivel, descripcion, activo,
      curriculo_pilares (
        id, nombre, orden,
        curriculo_objetivos ( id, descripcion, orden )
      )
    `).eq(`activo`,!0);e&&(n=n.eq(`instrumento`,e)),t&&(n=n.eq(`nivel`,t));let{data:r,error:i}=await n.maybeSingle();if(i)throw i;return r||null}async function ut(){let{data:e,error:t}=await l.from(`curriculos`).select(`
      id, instrumento, nivel, descripcion, activo, created_at,
      curriculo_pilares ( curriculo_objetivos ( id ) )
    `).order(`instrumento`);if(t)throw t;return(e||[]).map(e=>({...e,total_objetivos:e.curriculo_pilares?.reduce((e,t)=>e+(t.curriculo_objetivos?.length||0),0)??0}))}async function dt({instrumento:e,nivel:t,descripcion:n}){let{data:r,error:i}=await l.from(`curriculos`).insert({instrumento:e,nivel:t,descripcion:n}).select().single();if(i)throw i;return r}async function ft(e,t){let{data:n,error:r}=await l.from(`curriculos`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw r;return n}async function pt(e,t){return ft(e,{activo:t})}async function mt(e,t,n=0){let{data:r,error:i}=await l.from(`curriculo_pilares`).insert({curriculo_id:e,nombre:t,orden:n}).select().single();if(i)throw i;return r}async function ht(e,t){let{data:n,error:r}=await l.from(`curriculo_pilares`).update(t).eq(`id`,e).select().single();if(r)throw r;return n}async function gt(e){let{error:t}=await l.from(`curriculo_pilares`).delete().eq(`id`,e);if(t)throw t}async function _t(e,t,n=0){let{data:r,error:i}=await l.from(`curriculo_objetivos`).insert({pilar_id:e,descripcion:t,orden:n}).select().single();if(i)throw i;return r}async function vt(e,t){let{data:n,error:r}=await l.from(`curriculo_objetivos`).update(t).eq(`id`,e).select().single();if(r)throw r;return n}async function yt(e){let{error:t}=await l.from(`curriculo_objetivos`).delete().eq(`id`,e);if(t)throw t}async function bt({instrumento:e,nivel:t,descripcion:n,pilares:r}){if(!e||e.trim()===``)throw Error(`El instrumento es obligatorio para crear el plan.`);if(!r||r.length===0)throw Error(`La propuesta debe tener al menos un pilar.`);let i=await dt({instrumento:e.trim(),nivel:t?.trim()||``,descripcion:n?.trim()||`Plan generado por IA`}),a=[];for(let e=0;e<r.length;e++){let t=r[e],n=await mt(i.id,t.nombre||`Pilar ${e+1}`,e),o=t.objetivos||[];for(let e=0;e<o.length;e++){let t=await _t(n.id,o[e].descripcion||`Objetivo ${e+1}`,e);a.push({id:t.id,descripcion:t.descripcion})}}return{curriculo:i,allObjetivos:a}}var xt=ct;async function St(e){return xt.adoptarPropuesta(e)}function Ct(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function wt(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function Tt(e,t,n,r,i){if(!r)return`No hay datos de clase disponibles.`;let a=(e||[]).filter(e=>e.estado===`P`).length,o=(e||[]).filter(e=>e.estado===`A`).length,s=(e||[]).filter(e=>e.estado===`J`).length,c=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return c+=`Fecha: ${i||``}\n`,c+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,c+=`RESUMEN DE ASISTENCIA
`,c+=`Presentes: ${a} | Ausentes: ${o} | Justificados: ${s}\n\n`,t&&t.trim()&&(c+=`CONTENIDO DE LA CLASE:\n${t}\n\n`),c+=`DETALLE DE ALUMNOS:
`,(e||[]).forEach(e=>{let t=(n||[]).find(t=>t.id===e.alumno_id)?.nombre_completo||`Alumno`,r=e.estado===`P`?`Presente`:e.estado===`A`?`Ausente`:`Justificado`;c+=`- ${t}: ${r}\n`}),c}function Et(e,t,n=1800){if(t.length>n){let r=t.slice(0,n)+`…

[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function Dt(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ${s?`
  ...
  `;let d=e.querySelector(`#pm-asist-back`);return d&&u(d,`click`,c),{destroy(){l.forEach(e=>{try{e()}catch{}}),l.length=0}}}function Ot(e,{editor:t,toolbar:n}){let r=!1;return{inject(i,a){if(r||!i||i.claseId!==a)return;let o=`[${i.nombre}] `;t.insertText(o),n.setContext({indicadorActivo:i.nombre});let s=e.querySelector(`#btn-guardar-obs`);s&&(s.style.display=``);let c=e.querySelector(`#pm-dsl-editor-container`);if(c){let e=c.parentElement.querySelector(`.pm-ruta-tema-banner`);e&&e.remove();let t=document.createElement(`div`);t.className=`pm-ruta-tema-banner`,t.style.cssText=`
        ...
        `,t.innerHTML=`
          ...
          ">✕</button>
        `,c.parentElement.insertBefore(t,c)}},destroy(){r=!0}}}var kt={pending:{label:`Pendiente`,icon:`⚪`,className:`pending`},viewed:{label:`Vista`,icon:`🟡`,className:`viewed`},graded:{label:`Calificada`,icon:`🟢`,className:`graded`},current:{label:`En curso`,icon:`🔵`,className:`current`}};function At(t,n){let r=null,i=null,a={},o={},s=[],c=t.querySelector(`#pm-planificacion-card`),l=t.querySelector(`#pm-planificacion-dropdown`),u=t.querySelector(`#pm-planificacion-nombre`),d=t.querySelector(`#pm-planificacion-header`),f=t.querySelector(`#pm-route-tree-container`);d&&(d.onclick=()=>{let e=c.classList.toggle(`open`);l.style.display=e?`block`:`none`});let p=t.querySelector(`.pm-planificacion-tabs-pill`);p&&(p.style.display=`none`);let m=t.querySelector(`#pm-plan-list-rutas`);m&&(m.style.display=`none`);let h=t.querySelector(`#pm-plan-list-planificaciones`);h&&(h.style.display=`none`);let g=t.querySelector(`#pm-curriculo-proposal-trigger`);if(g&&(g.style.display=`none`),!document.getElementById(`pm-weekly-card-styles`)){let e=document.createElement(`style`);e.id=`pm-weekly-card-styles`,e.textContent=`
      .pm-weekly-nav {
    ...
    `,document.head.appendChild(e)}function _(){return typeof n.getSessionState==`function`?n.getSessionState():{isRegistered:!1}}async function y(e){return!e||!n.claseId||!n.maestro?.id?{}:(await ne(n.claseId,n.maestro.id,e).catch(()=>[])).reduce((e,t)=>(e[String(t.week_number)]=t,e),{})}function b(e){let t=o[String(e.week_number)]||null;return{...e,teacher_strategy:t?.teacher_strategy||e.teacher_strategy,student_activity:t?.student_activity||e.student_activity,homework:t?.homework||e.homework,evidence:t?.evidence||e.evidence,teacher_notes:t?.teacher_notes||``,hasTeacherAdjustment:!!t}}async function x(){try{if(c.style.display=``,r=await R(n.claseId),!r)if(v.isDemoMode)r=await z({group_id:n.claseId,weekly_plan_id:`wplan-violin-n0`,level_id:`pnivel_001`,teacher_id:n.maestro?.id||`maestro_001`});else{u&&(u.textContent=`Sin guía ACM asignada`),f&&(f.innerHTML=`
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(J)}}function Rt(e,t,n={}){if(Lt(),Y=e||[],jt=t,Nt=n.trigger||null,X=-1,Mt=!0,Wt(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+6;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),J.style.left=`${i}px`,J.style.top=`${a}px`}J.onmousedown=zt,document.addEventListener(`mousemove`,Bt),document.addEventListener(`mouseup`,Vt),J.style.display=`block`}function zt(e){e.target.closest(`.pm-ac-option`)||(Pt=!0,Ft=e.clientX-J.offsetLeft,It=e.clientY-J.offsetTop,J.style.cursor=`grabbing`,J.style.transition=`none`)}function Bt(e){if(!Pt)return;let t=e.clientX-Ft,n=e.clientY-It;J.style.left=`${Math.max(0,t)}px`,J.style.top=`${Math.max(0,n)}px`}function Vt(){Pt&&(Pt=!1,J.style.cursor=``)}function Ht(){J&&(J.style.display=`none`,Pt=!1,document.removeEventListener(`mousemove`,Bt),document.removeEventListener(`mouseup`,Vt)),Y=[],jt=null,X=-1,Mt=!1,Nt=null}function Ut(e){Y=e||[],X=-1,Wt(e)}function Wt(e){if(!J)return;if(!e||e.length===0){J.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${Jt(Nt)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===X,o=Yt(Nt,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Zt(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Zt(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),J.innerHTML=t,J.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{Gt(parseInt(e.dataset.index,10))})})}function Gt(e){if(e>=0&&e<Y.length){let t=Y[e];jt&&jt(t),Ht()}}function Kt(e){if(!(!Mt||Y.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),X=Math.min(X+1,Y.length-1),Wt(Y),qt();break;case`ArrowUp`:e.preventDefault(),X=Math.max(X-1,0),Wt(Y),qt();break;case`Enter`:e.preventDefault(),X>=0?Gt(X):Y.length>0&&Gt(0);break;case`Escape`:e.preventDefault(),Ht();break;case`Tab`:Y.length>0&&X===-1&&(e.preventDefault(),Gt(0));break}}function qt(){if(!J||X<0)return;let e=J.querySelector(`.pm-ac-option[data-index="${X}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Jt(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Yt(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?Xt(t.type):`•`}function Xt(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Zt(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Qt(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.bottom}}function $t(){return Mt}function en(){return X}var tn={show:Rt,hide:Ht,updateOptions:Ut,handleKeyDown:Kt,getCursorPosition:Qt,isOpen:$t,getSelectedIndex:en},nn=`portal-maestros-catalogs`,rn=1,an={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},on=null;async function Z(){return on||(on=await g(nn,rn,{upgrade(e){for(let[t,n]of Object.entries(an))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),on)}async function sn(e,t){let n=await Z(),r=await n.get(e,t);if(!r)return null;let i=an[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function cn(e){let t=await(await Z()).getAll(e),n=an[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>!e.updated_at||r<=new Date(e.updated_at).getTime()+n.ttl)}async function ln(e,t,n){return(await Z()).getAllFromIndex(e,t,n)}async function un(e,t){let n=await Z(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function dn(e,t){let n=(await Z()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function fn(e,t){await(await Z()).delete(e,t)}async function pn(e){await(await Z()).clear(e)}async function mn(e){let t=await Z(),n=an[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function hn(){let e=await Z();for(let t of Object.keys(an))await e.clear(t)}async function gn(e){return(await cn(e)).length}async function _n(e,t){let n=await Z(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function vn(e){return(await Z()).get(`historial`,e)}async function yn(e,t=5){return(await(await Z()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var Q={get:sn,getAll:cn,getByIndex:ln,set:un,setBulk:dn,remove:fn,clear:pn,cleanExpired:mn,clearAll:hn,getStoreSize:gn,addToHistorial:_n,getHistorial:vn,getTopUsed:yn};async function bn(e){if(!e)return[];try{let{data:t,error:n}=await l.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function xn(){let e=await Q.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await l.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await Q.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Sn(){let e=await Q.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await l.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await Q.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function Cn(){let e=await Q.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await l.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await Q.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function wn(){let e=await Q.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await l.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await Q.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function Tn(){let e=await Q.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await l.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await l.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await l.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await Q.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function En(e=null){let t=await Q.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=l.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await Q.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function Dn(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await bn(n.claseId));break;case`[`:r=await xn();break;case`(`:r=await Cn();break;case`{`:r=await wn();break;case`$`:r=await Sn();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await Tn():await En(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=On(r,t)),e&&e!==`#`){let t=(await Q.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function On(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=kn(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function kn(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function An(e,t){await Q.addToHistorial(e,t)}var jn=`
...
`;function Mn(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
    <div class="pm-dsl-editor-container">
      <div
        ...
        spellcheck="false"
      ></div>
      <div class="pm-dsl-placeholder" id="pm-dsl-placeholder">${jn}</div>
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=In(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}function Rn(e,t){let n=e.querySelector(`#pm-dsl-toolbar-container`),r=e.querySelector(`#pm-dsl-editor-container`),i=null,a=Mn(r,{initialContent:t.initialContent||``,onChange:e=>{t.onEditorChange?.(e)}});a.setContext({claseId:t.claseId});function o(e){i=Ln(n,{onInsert:(e,t,n)=>a.insertText(e,t,n),getEditorContent:()=>a.getValue(),onLoading:()=>{},onIaProposal:t=>e.onIaProposal?.(t),onImproveClick:t=>e.onImproveClick?.(t),onStructureClick:t=>e.onStructureClick?.(t),onAnalyzeClick:t=>e.onAnalyzeClick?.(t)})}function s(){i&&i.destroy(),a.destroy()}return{getEditor:()=>a,getToolbar:()=>i,getValue:()=>a.getValue(),setValue:e=>a.setValue(e),setContext:e=>a.setContext(e),initToolbar:o,destroy:s}}var zn={ESC:`Escalas`,ARP:`Arpegios y patrones`,MI:`Mano izquierda`,ARC:`Arco`,SON:`Sonido`,AFI:`Afinación`,EST:`Estudios técnicos`,REP:`Repertorio`},$={EXPLICITO:`explicito`,DERIVADO:`derivado`,MANUAL:`manual`};function Bn(e){if(!e)return null;let t=String(e).match(/>([A-Z]{2,3})\b/)?.[1];return t&&zn[t]?t:null}async function Vn(e){if(!e||!e.trim())return[];let{data:t,error:n}=await l.rpc(`fn_sugerir_nodo_por_texto`,{p_texto:e});return n?(console.warn(`[nodoSesionApi] No se pudo obtener sugerencias:`,n.message),[]):t??[]}async function Hn(e){let t=Bn(e);if(t)return{codigo:t,nombre:zn[t],origen:$.EXPLICITO,confianza:`alta`,alternativas:[]};let n=await Vn(e);if(n.length===0)return{codigo:null,nombre:null,origen:null,confianza:null,alternativas:[]};let[r,...i]=n;return{codigo:r.codigo,nombre:r.nombre,origen:$.DERIVADO,confianza:r.aciertos>=2&&(i.length===0||i[0].aciertos<r.aciertos)?`alta`:`media`,alternativas:i}}async function Un(e,t,n=$.DERIVADO){if(!e)return null;if(t&&!zn[t])throw Error(`Categoría desconocida: ${t}`);let{data:r,error:i}=await l.from(`sesiones_clase`).update({node_codigo:t,node_origen:t?n:null}).eq(`id`,e).select(`id, node_codigo, node_origen`).maybeSingle();if(i)throw Error(`No se pudo guardar la categoría: ${i.message}`);return r}var Wn=700;function Gn(e,n={}){let r=document.createElement(`div`);r.className=`pm-categoria-bar`,r.style.cssText=`
  ...
  `,e.appendChild(r);let i={codigo:n.codigoInicial??null,origen:n.origenInicial??null,confirmada:!!n.codigoInicial,alternativas:[],cargando:!1},a=null,o=``;function s(){n.onChange?.({codigo:i.confirmada?i.codigo:null,origen:i.confirmada?i.origen:null})}function c(){if(!i.codigo&&!i.cargando){r.style.display=`none`,r.innerHTML=``;return}if(r.style.display=`flex`,i.cargando&&!i.codigo){r.innerHTML=`<span class="text-muted">Analizando el registro…</span>`;return}let e=zn[i.codigo]??i.codigo;if(i.confirmada)r.innerHTML=`
      ...
      `}}function l(){let e=Object.entries(zn).map(([e,n])=>`<button type="button" class="pm-cat-opt" data-codigo="${e}">${t(n)}</button>`).join(``);r.innerHTML=`
    ...
    `}r.addEventListener(`click`,e=>{let t=e.target.closest(`button`);if(!t)return;let{accion:n,codigo:r}=t.dataset;if(n===`confirmar`)i.confirmada=!0,i.origen=$.DERIVADO;else if(n===`elegir`)i.codigo=r,i.confirmada=!0,i.origen=$.MANUAL;else if(n===`cambiar`||n===`otra`){l();return}else if(n===`ninguna`)i.codigo=null,i.confirmada=!1,i.alternativas=[];else if(r)i.codigo=r,i.confirmada=!0,i.origen=$.MANUAL;else return;c(),s()});async function u(e){if(e!==o&&(o=e,!(i.confirmada&&i.origen===$.MANUAL))){i.cargando=!0,c();try{let t=await Hn(e);t.codigo?t.origen===$.EXPLICITO?(i.codigo=t.codigo,i.origen=$.EXPLICITO,i.confirmada=!0,i.alternativas=[],s()):i.confirmada||(i.codigo=t.codigo,i.origen=t.origen,i.alternativas=t.alternativas??[]):i.confirmada||(i.codigo=null,i.alternativas=[])}catch(e){console.warn(`[CategoriaTrabajoBar]`,e.message)}finally{i.cargando=!1,c()}}}function d(e){clearTimeout(a),a=setTimeout(()=>u(e??``),Wn)}return c(),{el:r,onTextoCambia:d,analizarAhora:e=>u(e??``),getCategoria:()=>i.confirmada?{codigo:i.codigo,origen:i.origen}:{codigo:null,origen:null},destroy:()=>{clearTimeout(a),r.remove()}}}function Kn(e,{onMarkAll:t,onClearAll:n}){let r=e.querySelector(`#btn-bulk-p`),i=e.querySelector(`#btn-bulk-a`),a=e.querySelector(`#btn-bulk-clear`),o=[];function s(e,t,n){e&&(e.addEventListener(t,n),o.push(()=>e.removeEventListener(t,n)))}return s(r,`click`,e=>{e.preventDefault(),t&&t(`P`)}),s(i,`click`,e=>{e.preventDefault(),t&&t(`A`)}),s(a,`click`,e=>{e.preventDefault(),n&&n()}),{destroy(){o.forEach(e=>{try{e()}catch{}}),o.length=0}}}function qn({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function Jn(e,t,n){let{data:r,error:i}=await l.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await l.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await l.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function Yn(e,t){let{data:n,error:r}=await l.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function Xn(e){let{error:t}=await l.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function Zn(e,t,n,r,i=null,a=null){try{let{error:o}=await l.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await l.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await m({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}function Qn(e,{sesionId:t,maestroId:n,editor:r,sesionExistenteData:i,onDraftRecovered:a}){if(!t)return{destroy(){}};let o=null,s=!1,c=e.querySelector(`#pm-draft-indicator`);o=qn({saveFn:async e=>{!t||s||await Jn(t,n,e)},debounceMs:3e4}),o.onSaved(()=>{if(s||!c)return;let e=new Date,t=String(e.getHours()).padStart(2,`0`),n=String(e.getMinutes()).padStart(2,`0`);c.textContent=`Borrador guardado ${t}:${n}`,c.style.display=``});let l=e.querySelector(`#pm-dsl-editable`);if(l){let e=l.oninput;l.oninput=function(t){e&&e.call(this,t),o&&!s&&o.onInput(r.getValue())}}return i?.borrador===!0&&Yn(t,n).then(e=>{if(!s&&e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?a&&a(e.contenido_raw):Xn(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e)),{destroy(){s=!0,o&&o.destroy()}}}function $n(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
¿Guardar la evaluación?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){r.disabled=!1,r.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:t}=await se(n.sesionId,a.id,o.evaluaciones,n.maestro.id,e);if(t)throw t}let s={indicador_id:a.id,evaluaciones:o.evaluaciones};await Zn(n.sesionId,n.maestro.id,i,s,o.dslGenerado||null,o.textoMejorado||null);let l=U(i);if(l.estados&&l.estados.length>0){let e=n.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));Ye({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,dslText:i,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&wt(e,n.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await nr(n.sesionId,n.claseId,n.maestro.id,o.evaluaciones,n.claseNombre||`Clase`,e);if(u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),n.planificationCard&&await n.planificationCard.refreshTree(),n.setEditorValue(``),n.onDslContentClear&&n.onDslContentClear(),or(o.evaluaciones.length,a.nombre),n.activeClassEventId){try{await rr(n.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(n.activeLevel)try{let{academicService:t}=await c(async()=>{let{academicService:e}=await import(`./academicService-CcV8qAMj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2]));for(let r of e){let e=await t.checkLevelCompletion(r.id,n.activeLevel);if(e&&e.status===`approved`){let{createLevelCompletionModal:e}=await c(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-Du_KQRU_.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([3,2,4])),t=e({studentId:r.id,levelId:n.activeLevel});n.onAppendModal?.(t.el||t)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&n.claseId&&a?.nombre){let{error:e}=await qe({sesionId:n.sesionId,claseId:n.claseId,maestroId:n.maestro.id,fechaHoy:n.fechaHoy,contenido:a.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(n.sesionId){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-CcV8qAMj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),r=await e.processSessionClosure(n.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:e}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CJ9jpoV7.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4]));await e(t,r)}}r.textContent=`¡Guardado!`,setTimeout(()=>{r.textContent=`Guardar observación`,r.disabled=!1},2e3)}catch(t){console.error(`[asistencia] Error saving observation:`,t),e.error(`Error al guardar: `+(t.message||t)),r.disabled=!1,r.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function or(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    </div>`,n.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(n),setTimeout(()=>n.remove(),4500)}async function sr(e,t){let n=t.planificationCard?.getActivePlanificacionId();if(!e||!n)return null;let r=e.match(/\[(.*?)\]/);if(!r||!r[1])return null;let i=r[1].trim().toLowerCase(),a=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},o=a(i);if(o.length===0)return null;try{let e=await ir.getRouteHierarchy(n),t=null,r=0;for(let n of e)for(let e of n.plan_temas||[])for(let n of e.plan_objetivos||[]){let e=a(n.nombre),i=o.filter(t=>e.includes(t)).length;i>r&&(r=i,t=n)}return t}catch(e){return console.warn(`[asistencia] Error resolving indicador:`,e),null}}async function cr(t,{onError:n,silent:r=!1}={}){try{return await t()}catch(t){return console.error(`[safeAsync]`,t),n?n(t):r||e!==void 0&&e&&e.error(`Error inesperado: `+(t.message||t)),null}}async function lr(e,{sesionId:t,fecha:n,maestro:r,router:i}){try{let{data:a,error:o}=await l.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(o||!a){i?.navigate?i.navigate(`fechas`):window.location.hash=`#/fechas`;return}let s=new Date,c=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,`0`)}-${String(s.getDate()).padStart(2,`0`)}`,u=n||a.fecha||c,d={id:t,nombre:a.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let f=Array.isArray(a.asistencia)?a.asistencia:[],p=f.map(e=>e.alumno_id).filter(Boolean),m=[];if(p.length>0){let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,p);m=e||[]}let h={},g={};m.forEach(e=>{h[e.id]=null}),f.forEach(e=>{e.estado&&m.some(t=>t.id===e.alumno_id)&&(h[e.alumno_id]=e.estado)});let _=dr(e,{clase:d,horario:null,alumnos:m,estado:h,justificaciones:g,maestro:r,fechaHoy:u,claseId:null,sesionId:t,hasConflict:!1,serverDSL:a.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:a,router:i});return typeof _==`function`?_:void 0}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${M(t.message)}</p>`}}async function ur(e,{claseId:t,fecha:n,sesionId:s,router:c}={}){let d=typeof e==`string`?document.getElementById(e):e;if(!d){console.error(`[asistenciaView] Container not found:`,e);return}d.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let f=u();if(!f){d.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(s)return lr(d,{sesionId:s,fecha:n,maestro:f,router:c});c?.navigate?c.navigate(`fechas`):window.location.hash=`#/fechas`;return}localStorage.setItem(`pm_active_clase_id`,t);let p=new Date,m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,h=n||m;try{let e=p.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,s,u,m]=await Promise.all([i(),a([t]),o([t]),l.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,f.id).eq(`fecha`,h).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1})]),g=n.find(e=>e.id===t);if(!g){d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let _=s.find(t=>t.dia?.toLowerCase()===e),v=(u||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),y=m.data||[],b=y[0]||null,x=(()=>{let e=new Map;for(let t of[...y].reverse())Array.isArray(t.asistencia)&&t.asistencia.forEach(t=>{t?.alumno_id&&e.set(t.alumno_id,t.estado)});return[...e.entries()].map(([e,t])=>({alumno_id:e,estado:t}))})(),S=Array.isArray(b?.asistencia)?b.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(b?.tipo===`emergente`&&S.length>0){let e=new Set(S),t=new Set(v.map(e=>e.id)),n=S.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await l.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);v=v.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}v=v.filter(t=>e.has(t.id))}let C=b?.id||null,w=b?.updated_at||null,T=b?.contenido||``,E=g.salon?[g.salon]:[],[D,O]=await Promise.all([C?l.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,C).then(e=>e.data||[]):Promise.resolve([]),E.length>0?r(E):Promise.resolve([])]),k=O.length>0?O[0].nombre:null,A=`pm_asistencia_${t||C}_${h}`,j=localStorage.getItem(`${A}_updated`),M=!1;w&&j&&new Date(w).getTime()>new Date(j).getTime()+5e3&&(M=!0);let N=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await l.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();N=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let P={},ee={};v.forEach(e=>{P[e.id]=null});let te=x,F={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};if(te.length===0)try{let e=null,n=y.map(e=>e.id).filter(Boolean);if(n.length>0){let{data:t}=await l.from(`asistencias`).select(`alumno_id, estado`).in(`sesion_clase_id`,n);e=t}if((!e||e.length===0)&&t&&h){let{data:n}=await l.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,t).eq(`fecha`,h);e=n}e?.length>0&&(te=e.map(e=>({alumno_id:e.alumno_id,estado:F[e.estado]??e.estado})))}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}te.forEach(e=>{if(Object.prototype.hasOwnProperty.call(P,e.alumno_id)){let t=F[e.estado]??e.estado;P[e.alumno_id]=t}});let I=[];if(C)try{I=await l.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,C).then(e=>e.data||[]),I.forEach(e=>{Object.prototype.hasOwnProperty.call(P,e.alumno_id)&&(P[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}dr(d,{clase:g,horario:_,alumnos:v,estado:P,justificaciones:ee,maestro:f,fechaHoy:h,claseId:t,sesionId:C,hasConflict:M,serverDSL:T,snapshots:D,salonNombre:k,rutaId:N,sesionExistenteData:b,router:c})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),d.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${M(e.message)}</p>`}}function dr(t,n){let{clase:r,horario:i,alumnos:a,estado:o,justificaciones:u,maestro:d,fechaHoy:h,claseId:g,snapshots:v,serverDSL:S,hasConflict:w,salonNombre:E,rutaId:A,sesionExistenteData:j,router:M}=n,N=n.sesionId,P=!!n.sesionId&&(j?.borrador===!1||j?.estado===`registrada`||j?.estado===`cerrada`),ee=e=>{if(M?.navigate){M.navigate(e);return}window.location.hash=`#/${e}`},F=[],I=`pm_asistencia_${g||N}_${h}`,L=S,ne=null,R=Ue(),z=null,re=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <!-- Modales... -->
  `;let B=Dt(t.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:E,fechaHoy:h,totalAlumnos:a.length,hasConflict:w,onBack:()=>{De.destroy();try{be.close()}catch{}F.forEach(e=>{try{e()}catch{}}),ee(`hoy`)}});F.push(()=>B.destroy());let V=t.querySelector(`#pm-sync-badge-container`);if(V){let e=ce();V.appendChild(e.el)}let H=Rn(t,{initialContent:S,claseId:g,onEditorChange:e=>{L=e,se?.onTextoCambia(e)}}),U=H.getEditor(),ie=t.querySelector(`#pm-dsl-editor-container`),ae={codigo:null,origen:null},se=Gn(t.querySelector(`.pm-asist-dsl-section`)||t,{onChange:async({codigo:e,origen:t})=>{if(ae={codigo:e,origen:t},N)try{await Un(N,e,t)}catch(e){console.warn(`[asistencia] No se pudo guardar la categoría:`,e.message)}}});S&&se.analizarAhora(S);let le=de(t,{onAceptar:e=>{U.setValue(e)}}),pe=fe(t,{onAccept:e=>{U.setValue(e)}}),me=tt(ie.parentNode,{onConfirm:async n=>{try{let e=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Je({sesionId:N,claseId:g,maestroId:d.id,fechaHoy:h,progressRecords:n,alumnos:e});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=t.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(n){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e.error(`Error al guardar progreso: `+n.message)}},onCancel:()=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),he=st(t.querySelector(`#pm-planificacion-dropdown`)||t,{onAdopt:async({instrumento:t,nivel:n,resumen:r,pilares:i})=>{try{let{curriculo:a,allObjetivos:o}=await St({instrumento:t,nivel:n,descripcion:r,pilares:i}),{linked:s}=await Xe({claseId:g,objetivos:o}),c=s>0?`Plan creado · ${s} registro${s===1?``:`s`} vinculado${s===1?``:`s`}`:`Plan curricular creado correctamente.`;e.success(c)}catch(t){e.error(`Error al crear el plan: `+t.message)}},onCancel:()=>{}});H.initToolbar({onImproveClick:async n=>{let r=t.querySelector(`#btn-generar-informe`);r&&(r.disabled=!0);try{let e=await T(n);le.open({original:n,improved:e})}catch(t){e.error(`Error al generar informe: `+t.message)}finally{r&&(r.disabled=!1)}},onStructureClick:async n=>{let r=t.querySelector(`#btn-ia-magic`);r&&(r.disabled=!0);try{let e=z?.getActiveIndicador(),t=await O(n,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});pe.open({original:n,dsl:t})}catch(t){e.error(`Error al estructurar con IA: `+t.message)}finally{r&&(r.disabled=!1)}},onAnalyzeClick:async n=>{await cr(async()=>{let i=a.filter(e=>o[e.id]&&o[e.id]!==`A`),s=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},c=a.map(e=>e.nombre_completo||e.nombre||``),l={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:s(t,c)}}),presentes:i.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:s(t,c)}}),tipoClase:Ct(r),instrumento:r.instrumento||``,sesionesRecientes:(v||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:z?.getActiveIndicador()?.nombre||``};t.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let u=await k(n,l);if(!u?.progreso?.length){t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.warning(`La IA no detectó registros de progreso en este texto.`);return}me.open({progreso:u.progreso,resumen:u.resumen})},{onError:n=>{t.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),e!==void 0&&e&&e.error(`Error al analizar con IA: `+n.message)}})}});let ge=H.getToolbar();z=At(t,{claseId:g,clase:r,maestro:d,fechaHoy:h,rutaId:A,editor:U,onIndicadorSelect:e=>{U.insertText(`[${e.nombre}] `),ge&&ge.setContext({indicadorActivo:e.nombre});let n=t.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getSessionState:()=>({isRegistered:P,hasContent:!!(L&&L.trim()),sessionId:N}),getDslContent:()=>U.getValue()}),F.push(()=>z.destroy());let ve=t.querySelector(`#btn-proponer-curriculo`);ve&&(ve.onclick=async()=>{ve.disabled=!0,ve.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let t=await rt(g,12);if(t.registros.length===0){e.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let n=await D(t,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});he.open({pilares:n.pilares,resumen:n.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(t){e.error(`Error al generar propuesta: `+t.message)}finally{ve.disabled=!1,ve.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let W=Ot(t,{editor:U,toolbar:ge}),ye=oe();W.inject(ye,g),F.push(()=>W.destroy());let be=er(t,{sesionId:N,getSesionId:()=>N,claseId:g,fechaHoy:h,maestroId:d.id,supabase:l,guardarJustificacion:Be,eliminarJustificacion:He,onJustifDeleted:e=>{o[e]=null,delete u[e]},onJustifSaved:(e,t)=>{u[e]=t},onJustifCancelled:(e,t)=>{o[e]=t},onRenderLista:e=>G.render(e),onUpdateProgress:()=>Ce(),onAutoSave:e=>we(e),onAnnounce:e=>te(e)});F.push(()=>{try{be.close()}catch{}});let xe=Qn(t,{sesionId:N,maestroId:d.id,editor:U,sesionExistenteData:j,onDraftRecovered:e=>{L=e,U.setValue(e)}});F.push(()=>xe.destroy()),t.querySelector(`#pm-academic-tools`),ar(t,{rutaId:A,sesionId:N,claseId:g,maestro:d,fechaHoy:h,alumnos:a,estado:o,planificationCard:z,editorContainer:ie,getEditorValue:()=>U.getValue(),setEditorValue:e=>U.setValue(e),onDslContentClear:()=>{L=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:e=>{let n=t.querySelector(`.pm-asist-root`);n&&n.appendChild(e)}});let G=tr(t,{alumnos:a,estado:o,rutaId:A,canOpenProgressPanel:!!(g||A),sesionId:N,fechaHoy:h,snapshots:v,justificaciones:u,obtenerJustificacion:Ve,eliminarJustificacion:He,onJustifDeleted:e=>{delete u[e]},onEstadoChange:(e,t)=>{o[e]=t},onOpenProgressPanel:e=>{Se&&Se.destroy(),Se=ke({alumno:e,rutaId:A,sessionId:N,claseId:g,fecha:h,horaInicio:i?.hora_inicio||null,onProgressSaved:async()=>{z?.refreshTree&&await z.refreshTree()}}),Se.open(),F.push(()=>{Se&&Se.destroy()})},onOpenEvaluationDrawer:(e,n)=>{ue(t,{student:e,sessionId:N,teacherId:d.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{be.open(e,t,n)},onAutoSave:e=>we(e),onAnnounce:e=>te(e),onUpdateSnapshots:e=>{v.push(...e)}});F.push(()=>G.destroy());let Se=null;function Ce(){let e=a.length,n=Object.values(o).filter(e=>e!==null).length,r=t.querySelector(`#pm-progress-wrap`),i=t.querySelector(`#pm-progress-fill`),s=t.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/e*100}%`,s.textContent=`${n}/${e}`}async function we(e=!1,t=!1){ne&&clearTimeout(ne);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...N?{}:{clase_id:g},maestro_id:d.id,fecha:h,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:L||``,...ae.codigo?{node_codigo:ae.codigo,node_origen:ae.origen}:{}};if(e.length===0&&!(L||``).trim()&&N)try{await _(N),N=null,localStorage.removeItem(`${I}_updated`),console.log(`[asistencia] Borrador vaciado y eliminado automáticamente`);return}catch(e){console.warn(`[asistencia] Error al autolimpiar borrador:`,e)}if(navigator.onLine)try{if(N){let{error:e}=await l.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,N);if(!e){localStorage.setItem(`${I}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await l.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){N=e.id,console.log(`[asistencia] Nueva sesión creada:`,N),localStorage.setItem(`${I}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await m({tabla:`sesiones_clase`,operacion:N?`update`:`insert`,payload:{...N?{id:N}:{},...t}}),localStorage.setItem(`${I}_updated`,new Date().toISOString())};e?t?await n():await R.run(n):ne=setTimeout(()=>{R.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Te=t.querySelector(`.pm-asist-actions-fixed`);if(Te){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),N&&(e.disabled=!0,e.innerHTML=`⏳...`,await x(N),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Te.querySelector(`#btn-guardar`);Te.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),g&&(n.disabled=!0,n.innerHTML=`⏳...`,await C(g,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Te.insertBefore(n,t)}t.querySelector(`#btn-guardar`).onclick=async()=>{let n=t.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await R.run(async()=>{try{let i=a.filter(e=>o[e.id]).map(e=>({...g?{clase_id:g}:{},alumno_id:e.id,fecha:h,estado:o[e.id],registrado_por:d.id})),u=i.length>0,v=L&&L.trim().length>0;if(!u&&!v)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await we(!0,!0),!N){let{data:e}=await l.from(`sesiones_clase`).select(`id`).eq(`clase_id`,g).eq(`maestro_id`,d.id).eq(`fecha`,h).maybeSingle();e&&(N=e.id)}if(u&&g)try{let e=i.map(e=>({...e,...N&&{sesion_clase_id:N}}));await y(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!N){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await m({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:g,alumno_id:e.alumno_id,fecha:h,estado:e.estado,registrado_por:d.id,...N?{sesion_clase_id:N}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(N&&(u||v)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:t}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:L||``,updated_at:new Date().toISOString()}).eq(`id`,N).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await l.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:L||``,updated_at:new Date().toISOString()}).eq(`id`,N).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await l.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:L||``,updated_at:new Date().toISOString()}).eq(`id`,N))}s(),p(`hoy`),p(`calendario`),p(`metricas`),f().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e)),P=!0,z?.refreshTree&&await z.refreshTree()}if(N){let{academicService:e}=await c(async()=>{let{academicService:e}=await import(`./academicService-CcV8qAMj.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2])),{createAchievementsSummaryModal:r}=await c(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-CJ9jpoV7.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([5,4])),i=await e.processSessionClosure(N);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(t,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let S=Te?.querySelector(`#btn-reporte-dia`);S&&(S.style.display=``);let w=Te?.querySelector(`#btn-resumen-mes`);w&&(w.style.display=``);let T=Object.values(o).filter(e=>e===`P`).length,E=Object.values(o).filter(e=>e===`A`).length;te(`Sesión guardada exitosamente. ${T} presentes, ${E} ausentes.`);let D=document.createElement(`div`);D.className=`pm-saved-overlay`,D.innerHTML=`
      ...
      `,document.body.appendChild(D);let O=D.querySelector(`#btn-resumen-pedagogico`),k=D.querySelector(`#btn-editar-asistencia`),A=D.querySelector(`#btn-compartir-correo`),M=D.querySelector(`#btn-compartir-whatsapp`),F=D.querySelector(`#btn-volver-hoy`),I=D.querySelector(`#btn-ir-calendario`);re&&re.destroy(),re=Ie();let ne=re;O&&(O.onclick=()=>{ne.open({sesionId:N,claseNombre:r?.nombre||`Clase`,fecha:h,supabase:l})}),k&&(k.onclick=()=>{D.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),A&&(A.onclick=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${h}`),n=Tt(e,L,a,r,h);Et(`mailto:?subject=${t}&body=`,n,1800)}),M&&(M.onclick=async()=>{Et(`https://wa.me/?text=`,Tt(a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),L,a,r,h),1600)}),F&&(F.onclick=()=>{D.remove(),ee(`hoy`)}),I&&(I.onclick=()=>{D.remove(),ee(`fechas`)});let R=D.querySelector(`#btn-reporte-dia-overlay`);R&&(R.onclick=async()=>{let e=R.innerHTML;R.disabled=!0,R.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await x(N)}finally{R.disabled=!1,R.innerHTML=e}});let B=t.querySelector(`#btn-descartar-borrador`);B&&B.addEventListener(`click`,async()=>{if(confirm(`¿Deseas descartar este borrador? La fecha se limpiará por completo.`))try{B.disabled=!0,B.innerHTML=`<span class="spinner-border spinner-border-sm" role="status"></span> Descartando...`,j?.id&&await _(j.id),e.show(`Borrador descartado correctamente`,`success`),s(),p(`calendario`),window.location.hash=`#/fechas`}catch(t){e.show(`Error al descartar: `+t.message,`danger`),B.disabled=!1,B.innerHTML=`<i class="bi bi-trash"></i> Descartar`}});let V=D.querySelector(`#btn-resumen-mes-overlay`);V&&(g?V.onclick=async()=>{let e=V.innerHTML;V.disabled=!0,V.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await C(g,e.getFullYear(),e.getMonth()+1)}finally{V.disabled=!1,V.innerHTML=e}}:(V.disabled=!0,V.title=`No disponible para actividades especiales`,V.style.opacity=`0.5`));let H=D.querySelector(`#btn-informe-ped-overlay`);H&&(g?H.onclick=async()=>{let e=H.innerHTML;H.disabled=!0,H.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await b(g,e.getFullYear(),e.getMonth()+1)}finally{H.disabled=!1,H.innerHTML=e}}:(H.disabled=!0,H.title=`No disponible para actividades especiales`,H.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};let Ee=Kn(t,{onMarkAll:async e=>{a.forEach(t=>{o[t.id]=e}),G.render(),Ce();try{await we(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}te(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)},onClearAll:async()=>{a.forEach(e=>{o[e.id]=null}),G.render(),Ce();try{await we(!0)}catch(e){console.warn(`[asistencia] autoSave error on clear all:`,e)}te(`Se desmarcaron las asistencias de todos los alumnos.`)}});F.push(()=>Ee.destroy()),G.render();let De=new _e(t);De.mount();let Oe=t.querySelector(`#pm-btn-help`);return Oe&&(Oe.onclick=()=>De.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),De.destroy();try{be.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),F.forEach(e=>{try{e()}catch{}})}}export{ur as renderAsistenciaView};