import{i as e}from"./portalUtils-d8JQ9zxl.js";function t(t,n){if(!n||n.length===0)return;let r=document.createElement(`div`);r.className=`pm-modal-overlay pm-animate-fade-in`,r.style.zIndex=`9999`;let i=document.createElement(`div`);return i.className=`pm-modal-content pm-achievements-modal pm-animate-scale-up`,i.innerHTML=`
    <style>
