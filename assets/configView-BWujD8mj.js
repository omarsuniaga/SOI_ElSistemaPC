import{a as e,d as t,f as n,i as r,l as i,n as a,p as o,r as s}from"./pushService-DsWSFa6I.js";import{a as c,c as l,i as u,l as d,n as f,o as p,r as m,s as h}from"./admin-C2BToTHk.js";var g=[{id:`google/gemini-2.0-flash-exp`,name:`🔥 Gemini 2.0 Flash (Gratis)`,provider:`openrouter`},{id:`google/gemini-flash-1.5-exp`,name:`Google Gemini Flash 1.5 (Gratis)`,provider:`openrouter`},{id:`google/gemma-4-31b`,name:`Google Gemma 4 31B (Gratis)`,provider:`openrouter`},{id:`google/gemma-4-26b-a4b`,name:`Google Gemma 4 26B (Gratis)`,provider:`openrouter`},{id:`nvidia/nemotron-3-super-8b`,name:`NVIDIA Nemotron 3 Super (Gratis)`,provider:`openrouter`},{id:`nvidia/nemotron-nano-9b-v2`,name:`NVIDIA Nemotron Nano 9B (Gratis)`,provider:`openrouter`},{id:`poolside/laguna-xs.2`,name:`Poolside Laguna XS (Gratis)`,provider:`openrouter`},{id:`mistralai/mistral-7b-instruct`,name:`Mistral 7B (Gratis)`,provider:`openrouter`},{id:`anthropic/claude-3-haiku`,name:`Claude 3 Haiku (Gratis)`,provider:`openrouter`},{id:`openrouter/auto`,name:`🤖 Auto-Selector (Gratis - El mejor gratuito)`,provider:`openrouter`},{id:`groq-llama-3.3-70b`,name:`LLaMA 3.3 70B (GROQ - Rápido)`,provider:`groq`},{id:`groq-llama-3.1-70b`,name:`LLaMA 3.1 70B (GROQ)`,provider:`groq`}];function _(e){try{return localStorage.getItem(`portal-maestros:${e}`)}catch{return null}}function v(e,t){try{localStorage.setItem(`portal-maestros:${e}`,t)}catch{}}function y(){try{let e=localStorage.getItem(`portal-maestros:groq-usage`);return e?JSON.parse(e):null}catch{return null}}async function b(b){let[x,S,C,w]=await Promise.all([m()||_(`groq-key`)||``,u()||_(`openrouter-key`)||``,c()||`google/gemini-2.0-flash-exp`,f()]),T=g.find(e=>e.id===C)||g[0];b.innerHTML=`
