...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'planificacion-maestros', label: 'Todos los planes', icon: 'bi-collection' },
      ...
      { id: 'pedagogico-solicitudes', label: 'Solicitudes', icon: 'bi-envelope-paper' },
  ...
  },
  {
    ...
    icon: 'bi-graph-up',
    items: [
      { id: 'progresos', label: 'Progresos', icon: 'bi-bar-chart-steps' },
