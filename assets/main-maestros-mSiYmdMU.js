...
import{Bt as e,C as t,Ct as n,Et as r,Ft as i,G as a,I as o,It as s,J as c,L as l,Lt as u,M as d,Mt as f,N as p,Nt as m,P as h,Pt as g,Rt as _,W as v,a as y,at as b,bt as x,c as S,dt as C,i as w,j as T,jt as E,kt as D,l as O,nt as ee,o as k,rt as te,s as ne,t as re,vt as ie,wt as ae,zt as A}from"./adminNotificacionesView-qoiTpZxq.js";import{i as j}from"./supabase-DJmkTfk1.js";import{a as oe,i as se,n as ce,r as M,t as le}from"./maestroAuth-BmUoS2wq.js";import{t as ue}from"./idb-DOPm7uLh.js";import{i as de,n as fe,t as pe}from"./offlineQueue-Cjwl3aiF.js";import{a as me,c as he,d as ge,f as _e,i as ve,l as ye,n as N,r as be,s as xe,t as Se,u as Ce}from"./pushService-BGEnW8G7.js";import"./vendor-BhXhnmkW.js";import{t as P}from"./AppToast-BOjiJExQ.js";import{t as we}from"./preload-helper-CsoeaaUJ.js";import{t as F}from"./academicService-76BH8TVA.js";import{a as Te,c as Ee,i as I,l as De,n as Oe,o as ke,r as Ae,s as je,t as Me}from"./portalUtils-CisZ9vg-.js";import{t as Ne}from"./AppModal-DIPPctm9.js";import{a as Pe,c as Fe,i as Ie,o as Le,s as Re,t as ze}from"./groqService-CzM57djA.js";import{n as Be,t as Ve}from"./ausenciaModal-CZgtaMUH.js";import{n as He,r as Ue,t as We}from"./reportService-BNTcQUH_.js";import{r as Ge,t as Ke}from"./permisoService-B2O2fSHa.js";var qe=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function Je(e=``){let t=String(e).toLowerCase();return qe.some(e=>t.includes(e.toLowerCase()))}var Ye=console.error;console.error=function(...e){e.length>0&&!Je(e[0])&&Ye.apply(console,e)};var Xe=console.warn;console.warn=function(...e){e.length>0&&!Je(e[0])&&Xe.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{Je(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{Je(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Ze=window.fetch;window.fetch=async function(...e){try{return await Ze.apply(window,e)}catch(e){if(!Je(e.message))throw e;return null}};var Qe=!1;function $e(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Qe=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function et(e,t={}){if(!Qe&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var tt=!1;function nt(e={}){let{enabled:t=!1,consent:n=!1}=e;tt=t&&n,console.log(`[Analytics] Initialized, enabled:`,tt)}var rt={windowMs:6e4,max:100};function it(e={}){rt={...rt,...e},console.log(`[RateLimit] Initialized: ${rt.max} requests per ${rt.windowMs}ms`)}var at=null,ot=new Set;function st(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function ct(e={}){at=st(e.length||32),ot.clear(),ot.add(at),console.log(`[CSRF] Initialized`)}var lt={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function ut(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function dt(e={}){let{debug:t=!1,onReport:n=null}=e;if(!ut()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ft(t,n),pt(t,n),mt(t,n),ht(t,n),gt(t,n)}function ft(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];lt.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function pt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function mt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);lt.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function ht(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function gt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];lt.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var L={maestro:null,loading:!0,listeners:[]},_t=null,vt=!1;function yt(){L.listeners.forEach(e=>e({...L}))}var bt={subscribe(e){return L.listeners.push(e),()=>{L.listeners=L.listeners.filter(t=>t!==e)}},async init(){vt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),L.maestro=M(),console.log(`[usePortalAuth.init] Maestro local:`,L.maestro?`found`:`not found`),L.loading=!0,yt(),typeof process<`u`&&{}.VITEST)return L.loading=!1,yt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),L.maestro;if(!_t){let{data:{subscription:e}}=j.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),vt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),L.maestro=null,yt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=M();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await ce();e&&(L.maestro=e,yt())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});_t=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([ce(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),L.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),L.maestro=null}return L.loading=!1,yt(),console.log(`[usePortalAuth.init] Completado`),L.maestro}finally{vt=!1}},setMaestro(e){L.maestro=e,L.loading=!1,yt()},async logout(){await oe(),L.maestro=null,yt()},getMaestro:()=>L.maestro,isAuthenticated:()=>!!L.maestro,isLoading:()=>L.loading},xt=bt.logout,St=`calendario`;function Ct(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):St}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:St},``,`#/${St}`),h(St);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var wt=null,Tt=null;function Et(e,t=`polite`){wt||(wt=document.createElement(`div`),wt.setAttribute(`aria-live`,t),wt.setAttribute(`aria-atomic`,`true`),wt.classList.add(`pm-visually-hidden`),document.body.appendChild(wt)),t===`assertive`?(wt.setAttribute(`role`,`alert`),wt.setAttribute(`aria-live`,`assertive`)):(wt.removeAttribute(`role`),wt.setAttribute(`aria-live`,`polite`)),clearTimeout(Tt),Tt=setTimeout(()=>{wt.textContent=``,requestAnimationFrame(()=>{wt.textContent=e})},50)}function Dt(e,t){if(!e||!e.id)return;Ot(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function Ot(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function kt(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>Ot(e))}function At(e,{onSuccess:t}){e.innerHTML=`
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function Nt(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=M();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,a=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),o=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let c=await f(n.id,o);if(c&&c.length>0){e.innerHTML=Pt(c,a,r),It(e,o,n.id);return}let l=await i();if(!l||l.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let d=l.map(e=>e.id),p=Object.fromEntries(l.map(e=>[e.id,e])),h=(await m(d)).filter(e=>e.dia?.toLowerCase()===a).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!h||h.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${Ae(a)} ${Te(r)}</h2>
        <p class="pm-empty">No tienes clases hoy.</p>
      `;return}let _=new Date(r);_.setDate(_.getDate()-3);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=new Date(r);y.setDate(y.getDate()-1);let b=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,`0`)}-${String(y.getDate()).padStart(2,`0`)}`,x=(await u(n.id,v,b)||[]).filter(e=>{if(!d.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await u(n.id,o,o)).filter(e=>d.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),C=new Set(S.map(e=>e.clase_id)),w=await g(d),T={};for(let e of w||[])e.clase_id&&(T[e.clase_id]=(T[e.clase_id]||0)+1);let E=[...new Set(h.map(e=>e.salon_id).filter(Boolean))],D=E.length>0?await s(E):[],O=Object.fromEntries(D.map(e=>[e.id,e.nombre])),ee=h.map(e=>{let t=p[e.clase_id],n=C.has(t.id),r=T[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
        <div class="pm-clase-card ${i}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            <div class="meta-item"><i class="bi bi-clock"></i> ${ke(e.hora_inicio)} – ${ke(e.hora_fin)}</div>
      ...
      <div class="pm-pendientes-banner">
        ...
        <div class="pm-pendientes-list">
          ${x.map(e=>{let t=p[e.clase_id];if(!t)return``;let n=e.fecha?e.fecha.split(`-`).reverse().slice(0,2).join(`/`):`—`;return`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,r=e.dataset.fecha;try{await F.createSnapshotFromPlan(t,r,n.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${r}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let r=e.dataset.claseId;try{await F.createSnapshotFromPlan(r,o,n.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(r)})})}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${I(t.message)}</p>`}}function Pt(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=Ft(e.motivo);return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${Ae(t)} ${Te(n)}</h2>
  ...
  `,document.head.appendChild(e)}var Lt=null,Rt=null;function zt(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;Lt=o,Rt=a,Ne.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
    ...
    <div class="pm-calendar-wrapper">
      ...
      <div class="pm-cal-grid-container">
        <div class="pm-cal-grid" role="grid" aria-label="Calendario ${Oe[n]} ${t}">
          ${g}
        </div>
      </div>
...
`);r&&(n[r]=on(i))}),{...on(e),por_capas:n}}function cn(e){if(!e)return``;let t=ln(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(z.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${nn.capas}22; color:${nn.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${nn.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${nn.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(z.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(z.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(z.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(z.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(z.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(z.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function ln(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var un=[{trigger:`escalas`,label:`Escalas`,icon:`🎼`,expand:`[Escala Do Mayor] [Escala Re Mayor] [Escala Sol Mayor]`},{trigger:`arpegios`,label:`Arpegios`,icon:`🎹`,expand:`[Arpegio Do Mayor] [Arpegio La menor] [Arpegio Sol Mayor]`},{trigger:`tecnica`,label:`Técnica`,icon:`🎸`,expand:`$Tecnica_mano_derecha $Tecnica_mano_izquierda`},{trigger:`postura`,label:`Postura`,icon:`🧘`,expand:`$Postura_corporal $Posicion_manos`},{trigger:`evaluar`,label:`Evaluar`,icon:`📝`,expand:`4/5 (buen trabajo) {practicar 30 min diarios}`},{trigger:`mejorar`,label:`Mejorar`,icon:`💪`,expand:`(continuar mejorando la digitación) {repetir练习}`},{trigger:`ritmo`,label:`Ritmo`,icon:`🥁`,expand:`$Ritmo_binario $Ritmo_ternario`},{trigger:`dinamica`,label:`Dinámica`,icon:`🔊`,expand:`$Dinamica_piano $Dinamica_forte $Dinamica_mezzo`},{trigger:`afinacion`,label:`Afinación`,icon:`🎵`,expand:`$Afinacion_precisa $Afinacion_relativa`},{trigger:`lectura`,label:`Lectura`,icon:`📖`,expand:`[Lectura a primera vista] [Lectura de notas]`},{trigger:`respiracion`,label:`Respiración`,icon:`🌬️`,expand:`$Respiracion_diafragmatica $Respiracion_costeado`},{trigger:`memo`,label:`Memoria`,icon:`🧠`,expand:`[Técnica de memorización] {practicar de memoria}`}];function dn(e){if(!e||e.length===0)return un.slice(0,6);let t=e.toLowerCase();return un.filter(e=>e.trigger.toLowerCase().includes(t)||e.label.toLowerCase().includes(t)).slice(0,6)}function fn(e){let t=un.find(t=>t.trigger===e);return t?t.expand:null}function pn(e,{onAccept:t}){let n=document.getElementById(`pm-structure-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-structure-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),!document.getElementById(`pm-structure-modal-styles`))){let e=document.createElement(`style`);e.id=`pm-structure-modal-styles`,e.textContent=`
      ...
      `,document.head.appendChild(e)}let r=n.querySelector(`#pm-structure-original`),i=n.querySelector(`#pm-structure-dsl`);function a({original:e,dsl:t}){r.textContent=e,i.textContent=t,n.classList.add(`open`)}function o(){n.classList.remove(`open`)}return n.querySelector(`#pm-structure-close`).onclick=o,n.querySelector(`#pm-structure-reject`).onclick=o,n.querySelector(`#pm-structure-accept`).onclick=()=>{t&&t(i.textContent),o()},{open:a,close:o}}function mn(e,t={}){let n=document.getElementById(`pm-toolbar-help-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-toolbar-help-modal`,n.className=`pm-help-modal-overlay`,n.innerHTML=`
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=mn(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}var B=null,gn=[],_n=null,V=-1,vn=!1,yn=null,bn=!1,xn=0,Sn=0;function Cn(){if(!B){if(B=document.createElement(`div`),B.id=`pm-autocomplete-popup`,B.className=`pm-autocomplete-popup`,B.style.cssText=`
    position: fixed;
    display: none;
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(B)}}function wn(e,t,n={}){if(Cn(),gn=e||[],_n=t,yn=n.trigger||null,V=-1,vn=!0,An(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+20;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),B.style.left=`${i}px`,B.style.top=`${a}px`}B.onmousedown=Tn,document.addEventListener(`mousemove`,En),document.addEventListener(`mouseup`,Dn),B.style.display=`block`}function Tn(e){e.target.closest(`.pm-ac-option`)||(bn=!0,xn=e.clientX-B.offsetLeft,Sn=e.clientY-B.offsetTop,B.style.cursor=`grabbing`,B.style.transition=`none`)}function En(e){if(!bn)return;let t=e.clientX-xn,n=e.clientY-Sn;B.style.left=`${Math.max(0,t)}px`,B.style.top=`${Math.max(0,n)}px`}function Dn(){bn&&(bn=!1,B.style.cursor=``)}function On(){B&&(B.style.display=`none`,bn=!1,document.removeEventListener(`mousemove`,En),document.removeEventListener(`mouseup`,Dn)),gn=[],_n=null,V=-1,vn=!1,yn=null}function kn(e){gn=e||[],V=-1,An(e)}function An(e){if(!B)return;if(!e||e.length===0){B.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${Pn(yn)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===V,o=Fn(yn,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${Ln(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${Ln(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),B.innerHTML=t,B.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{jn(parseInt(e.dataset.index,10))})})}function jn(e){if(e>=0&&e<gn.length){let t=gn[e];_n&&_n(t),On()}}function Mn(e){if(!(!vn||gn.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),V=Math.min(V+1,gn.length-1),An(gn),Nn();break;case`ArrowUp`:e.preventDefault(),V=Math.max(V-1,0),An(gn),Nn();break;case`Enter`:e.preventDefault(),V>=0?jn(V):gn.length>0&&jn(0);break;case`Escape`:e.preventDefault(),On();break;case`Tab`:gn.length>0&&V===-1&&(e.preventDefault(),jn(0));break}}function Nn(){if(!B||V<0)return;let e=B.querySelector(`.pm-ac-option[data-index="${V}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Pn(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function Fn(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?In(t.type):`•`}function In(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function Ln(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Rn(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.top}}function zn(){return vn}function Bn(){return V}var Vn={show:wn,hide:On,updateOptions:kn,handleKeyDown:Mn,getCursorPosition:Rn,isOpen:zn,getSelectedIndex:Bn},Hn=`portal-maestros-catalogs`,Un=1,Wn={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},Gn=null;async function H(){return Gn||(Gn=await ue(Hn,Un,{upgrade(e){for(let[t,n]of Object.entries(Wn))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),Gn)}async function Kn(e,t){let n=await H(),r=await n.get(e,t);if(!r)return null;let i=Wn[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function qn(e){let t=await(await H()).getAll(e),n=Wn[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Jn(e,t,n){return(await H()).getAllFromIndex(e,t,n)}async function Yn(e,t){let n=await H(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Xn(e,t){let n=(await H()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Zn(e,t){await(await H()).delete(e,t)}async function Qn(e){await(await H()).clear(e)}async function $n(e){let t=await H(),n=Wn[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function er(){let e=await H();for(let t of Object.keys(Wn))await e.clear(t)}async function tr(e){return(await qn(e)).length}async function nr(e,t){let n=await H(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function rr(e){return(await H()).get(`historial`,e)}async function ir(e,t=5){return(await(await H()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var U={get:Kn,getAll:qn,getByIndex:Jn,set:Yn,setBulk:Xn,remove:Zn,clear:Qn,cleanExpired:$n,clearAll:er,getStoreSize:tr,addToHistorial:nr,getHistorial:rr,getTopUsed:ir};async function ar(e){if(!e)return[];try{let{data:t,error:n}=await j.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function or(){let e=await U.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function sr(){let e=await U.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function cr(){let e=await U.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function lr(){let e=await U.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await j.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await U.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function ur(){let e=await U.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await j.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await j.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await j.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await U.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function dr(e=null){let t=await U.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=j.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await U.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function fr(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await ar(n.claseId));break;case`[`:r=await or();break;case`(`:r=await cr();break;case`{`:r=await lr();break;case`$`:r=await sr();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await ur():await dr(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=pr(r,t)),e&&e!==`#`){let t=(await U.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function pr(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=mr(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function mr(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function hr(e,t){await U.addToHistorial(e,t)}var gr=`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function Dr(e,t=null,n=[],r=[],i={},a){let o=e===`edit`&&!!t,s=o?t:{...i};!o&&i.contenido&&!s.notas_dsl&&(s.notas_dsl=i.contenido),!o&&i.maestro_nombre&&!r.find(e=>e.nombre===i.maestro_nombre)&&(r=[{id:i.maestro_id,nombre:i.maestro_nombre},...r]);let c=new E(s),l=document.getElementById(`pm-planificacion-modal`);if(l&&l.remove(),l=document.createElement(`div`),l.id=`pm-planificacion-modal`,l.className=`pm-plan-modal-overlay`,l.innerHTML=kr(o,c,n,r),document.body.appendChild(l),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Ar(),document.head.appendChild(e)}let u=()=>{l.classList.remove(`open`),setTimeout(()=>l.remove(),200)};l.querySelector(`.pm-plan-close-x`).onclick=u,l.querySelector(`.pm-plan-cancel-btn`).onclick=u,l.querySelector(`.pm-plan-backdrop`).onclick=u;let d=e=>{e.key===`Escape`&&(u(),document.removeEventListener(`keydown`,d))};document.addEventListener(`keydown`,d);let f=l.querySelector(`#pl-plantilla`);f&&f.addEventListener(`change`,e=>{let t=Er.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(l.querySelector(`#pl-objetivos`).value=t.objetivos,l.querySelector(`#pl-contenido`).value=t.contenido,l.querySelector(`#pl-recursos`).value=t.recursos,l.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Mr(l))});let p=l.querySelector(`#pl-clase_id`);p&&p.addEventListener(`change`,()=>{let e=l.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Nr(n,p.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),jr(l);let m=l.querySelector(`#dsl-editor-container`);if(m){let e=x({onSelect:async e=>{let n=(await ae()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=D({initialContent:c.notas_dsl||``,onChange:(e,t)=>{let n=l.querySelector(`#dsl-summary`);n&&(n.textContent=Fr(t))},onAlumnoClick:()=>e.openModal()});m.appendChild(t),l._dslEditor=t}let h=l.querySelector(`.pm-plan-save-btn`);h.onclick=async()=>{let e=l.querySelector(`#pl-tema`)?.value.trim(),t=l.querySelector(`#pl-clase_id`)?.value;if(!e){l.querySelector(`#pl-tema`).focus();return}if(!t){l.querySelector(`#pl-clase_id`).focus();return}h.disabled=!0,h.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=l.querySelector(`#pl-recursos`)?.value||``,r=l._dslEditor,i={clase_id:t,maestro_id:l.querySelector(`#pl-maestro_id`)?.value||null,instrumento:l.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:l.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:l.querySelector(`#pl-objetivos`)?.value.trim(),contenido:l.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:l.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:l.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:o&&l.querySelector(`#pl-estado`)?.value||`planificado`};a&&await a(i),u()}catch(e){console.error(`[planificacionModal] Error:`,e),h.disabled=!1,h.textContent=o?`Guardar cambios`:`Guardar`}};let g=l.querySelector(`.pm-plan-body`);if(g){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;g.firstChild;)t.appendChild(g.firstChild);let r=document.createElement(`div`);r.style.cssText=`flex:1;min-width:0`,r.appendChild(t),e.appendChild(r),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),g.appendChild(e);let i=l.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=n.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&Or(t.instrumento,t.plan_estudio,l)}),c.clase_id)){let e=n.find(e=>e.id===c.clase_id);e?.instrumento&&e?.plan_estudio&&Or(e.instrumento,e.plan_estudio,l)}}requestAnimationFrame(()=>{l.classList.add(`open`),l.querySelector(`#pl-tema`)?.focus()})}async function Or(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await ie(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
  ...
  `,await zr()}async function Lr(e,t,n,r){Ne.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:let e=M();await W.addClass(i,e?e.id:null);break;case`Nivel`:await W.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await W.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await W.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await W.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function zr(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=M(),n=await W.getClasses(t?t.id:null);!n.some(e=>e.id===G.activeClassId)&&n.length>0?G.activeClassId=n[0].id:n.length===0&&(G.activeClassId=null),e.innerHTML=`
...
`)}function r(e,t){let n=_i[e.estado]||_i.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${vi[e.estado]||``}`:`ssp-alumno-chip`}">${bi(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${bi(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${bi(e.tarea)}</div>`:``;return`
  ...
  `,document.head.appendChild(e)}function Ti({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function Ei(e,t,n){let{data:r,error:i}=await j.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await j.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function Di(e,t){let{data:n,error:r}=await j.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function Oi(e){let{error:t}=await j.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function ki(e,t,n,r,i=null,a=null){let{error:o}=await j.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await j.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}var Ai=`soi_ruta_tema_pendiente`;function ji(e){sessionStorage.setItem(Ai,JSON.stringify(e))}function Mi(){let e=sessionStorage.getItem(Ai);if(!e)return null;sessionStorage.removeItem(Ai);try{return JSON.parse(e)}catch{return null}}function Ni(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
...
`),s=[];for(let e of o){let t=sn(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ki({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ji({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await j.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Vi(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Vi(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await j.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Yi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Xi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Zi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Qi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function $i(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Qi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function ea(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Zi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Zi(n.join(`, `))}</span>`:``}}function o(e,t){let n=Yi[e.estado]??Yi.EN_PROGRESO,r=e.nota?` · ${Zi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Zi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Qi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
    ...
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${$i(c)}</div>`:``,d=Fe(r),f=d.length>0?`
  ...
  `,document.head.appendChild(e)}async function na(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await j.from(`progresos`).select(`
      contenido_dsl,
      tipo,
      estado_cualitativo,
      fecha_evaluacion,
  ...
  `,document.head.appendChild(e)}var Ia=null;function La(){Ia===null&&(Ia=setInterval(()=>{document.visibilityState!==`hidden`&&Ca()},la))}function Ra(){Ia!==null&&(clearInterval(Ia),Ia=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Ca(),La()):Ra()});function za(){let e=new Date().toISOString().split(`T`)[0];q=q.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}za(),document.visibilityState!==`hidden`&&La();async function Ba(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||P!==void 0&&P&&P.error(`Error inesperado: `+(e.message||e)),null}}async function Va(e,{sesionId:t,fecha:n,maestro:r}){try{let{data:i,error:a}=await j.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(a||!i){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let o=n||i.fecha||new Date().toISOString().split(`T`)[0],s={id:t,nombre:i.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let c=Array.isArray(i.asistencia)?i.asistencia:[],l=c.map(e=>e.alumno_id).filter(Boolean),u=[];if(l.length>0){let{data:e}=await j.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,l);u=e||[]}let d={};u.forEach(e=>{d[e.id]=null}),c.forEach(e=>{e.estado&&u.some(t=>t.id===e.alumno_id)&&(d[e.alumno_id]=e.estado)}),Ua(e,{clase:s,horario:null,alumnos:u,estado:d,justificaciones:{},maestro:r,fechaHoy:o,claseId:null,sesionId:t,hasConflict:!1,serverDSL:i.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:i})}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(t.message)}</p>`}}async function Ha(e,{claseId:t,fecha:n,sesionId:r}={}){let a=typeof e==`string`?document.getElementById(e):e;if(!a){console.error(`[asistenciaView] Container not found:`,e);return}a.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let o=M();if(!o){a.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(r)return Va(a,{sesionId:r,fecha:n,maestro:o,containerOrId:e});a.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let c=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,r,l,u]=await Promise.all([i(),m([t]),g([t]),j.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,o.id).eq(`fecha`,c).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let d=n.find(e=>e.id===t);if(!d){console.log(`[DEBUG] Clase not found in misClases`),a.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let f=r.find(t=>t.dia?.toLowerCase()===e),p=(l||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),h=u.data?.[0],_=Array.isArray(h?.asistencia)?h.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(h?.tipo===`emergente`&&_.length>0){let e=new Set(_),t=new Set(p.map(e=>e.id)),n=_.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await j.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);p=p.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}p=p.filter(t=>e.has(t.id))}let v=h?.id||null,y=h?.updated_at||null,b=h?.contenido||``,x=d.salon?[d.salon]:[],[S,C]=await Promise.all([v?j.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,v).then(e=>e.data||[]):Promise.resolve([]),x.length>0?s(x):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let w=C.length>0?C[0].nombre:null,T=`pm_asistencia_${t||v}_${c}`,E=localStorage.getItem(`${T}_updated`),D=!1;y&&E&&new Date(y).getTime()>new Date(E).getTime()+5e3&&(D=!0);let O=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await j.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();O=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let ee={},k={};p.forEach(e=>{ee[e.id]=null});let te=h?.asistencia||[];if(te.length===0&&v)try{let{data:e}=await j.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,v);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};te=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let ne={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};te.forEach(e=>{if(Object.prototype.hasOwnProperty.call(ee,e.alumno_id)){let t=ne[e.estado]??e.estado;ee[e.alumno_id]=t}});let re=[];if(v)try{re=await j.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,v).then(e=>e.data||[]),re.forEach(e=>{Object.prototype.hasOwnProperty.call(ee,e.alumno_id)&&(ee[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Ua(a,{clase:d,horario:f,alumnos:p,estado:ee,justificaciones:k,maestro:o,fechaHoy:c,claseId:t,sesionId:v,hasConflict:D,serverDSL:b,snapshots:S,salonNombre:w,rutaId:O,sesionExistenteData:h})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),a.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${I(e.message)}</p>`}}function Ua(e,t){let{clase:n,horario:r,alumnos:a,estado:o,justificaciones:s,maestro:c,fechaHoy:l,claseId:u,snapshots:d,serverDSL:f,hasConflict:p,salonNombre:m,rutaId:h,sesionExistenteData:g}=t,v=t.sesionId,y=[],x=`pm_asistencia_${u}_${l}`,S=f,w=null,T=Bi(),E=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
    ...
    <div class="pm-asist-root pm-animate-fade-in" style="position:relative; min-height:100vh; padding: 0;">
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          <h2 class="pm-asist-title">${I(n.nombre)}</h2>
          <p class="pm-asist-subtitle">
            ${m?`📍 ${I(m)} · `:``}
            ${r?`${ke(r.hora_inicio)} – ${ke(r.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${Te(new Date(l+`T12:00:00`))}</span> · 
            ${a.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let D=e.querySelector(`#pm-dsl-toolbar-container`),O=e.querySelector(`#pm-dsl-editor-container`),k=_r(O,{initialContent:f,onChange:e=>{S=e}});k.setContext({claseId:u});let te=br(e,{onAceptar:e=>{k.setValue(e)}}),ne=pn(e,{onAccept:e=>{k.setValue(e)}}),re=ea(O.parentNode,{onConfirm:async t=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ki({sesionId:v,claseId:u,maestroId:c.id,fechaHoy:l,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=oa(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await C({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await Ji({claseId:u,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;P.success(s)}catch(e){P.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ae=hn(D,{onInsert:(e,t,n)=>k.insertText(e,t,n),getEditorContent:()=>k.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=D.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Ie(e);te.open({original:e,improved:t})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=D.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=E?.getActiveIndicador(),n=await Le(e,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});ne.open({original:e,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async t=>{await Ba(async()=>{let r=a.filter(e=>o[e.id]&&o[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),presentes:r.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),tipoClase:Oe(n),instrumento:n.instrumento||``,sesionesRecientes:(d||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:E?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await ze(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.error(`Error al analizar con IA: `+t.message)}})}}),A=null,oe=e.querySelector(`#pm-planificacion-card`),se=e.querySelector(`#pm-planificacion-dropdown`),ce=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let M=e.querySelector(`#pm-plan-list-rutas`),le=e.querySelector(`#pm-plan-list-planificaciones`),ue=e.querySelector(`#pm-planificacion-header`);ue&&ue.addEventListener(`click`,()=>{let e=oe.classList.toggle(`open`);se.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;M.style.display=n===`rutas`?``:`none`,le.style.display=n===`planificaciones`?``:`none`})});function de(t){A=t.id,localStorage.setItem(`pm_default_plan_${u}`,t.id),ce&&(ce.textContent=t.nombre||t.name||`Sin nombre`),le.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),E&&=(E.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);A&&n&&(n.innerHTML=``,Fe(u).then(e=>{E=Yr(n,{claseId:u,rutaId:A,completedTopics:e,onIndicadorSelect:e=>{k.insertText(`[${e.nombre}] `),ae.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),oe.classList.remove(`open`),se.style.display=`none`}}),y.push(()=>E.destroy())}))}let fe=e.querySelector(`#btn-manage-planning`);fe&&(fe.onclick=e=>{if(e.stopPropagation(),!A){Ne.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Ne.open({title:`Gestionar Estructura: ${ce.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(E&&E.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Ir(t,A)}),oe&&(async()=>{try{let e=await W.getClasses(c?c.id:null),t=localStorage.getItem(`pm_default_plan_${u}`),r=(n.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===t)return!0;let n=(e.nombre||``).toLowerCase();return r.some(e=>n.includes(e))});M&&(M.innerHTML=i.length?i.map(e=>`
              ...
              </div>`).join(``):`<div style="padding:0.5rem;font-size:0.8rem;color:var(--pm-text-muted)">No hay planes sugeridos para este instrumento</div>`,M.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=i.find(t=>t.id===e.dataset.planId);t&&de(t)})})),le&&(le.innerHTML=e.map(e=>`
            <div class="pm-plan-item" data-plan-id="${e.id}">
              <span class="pm-plan-item-icon">📚</span>
              <span class="pm-plan-item-name">${I(e.nombre||e.name)}</span>
            </div>`).join(``),le.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&de(n)})})),oe.style.display=``;let a=e.find(e=>e.id===t)||i[0]||await W.resolveSmartPlan(n);a&&de(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let me=e.querySelector(`#btn-proponer-curriculo`);me&&(me.onclick=async()=>{me.disabled=!0,me.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await na(u,12);if(e.registros.length===0){P.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Pe(e,{instrumento:n?.instrumento||``,nivel:``,nombreClase:n?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:n?.instrumento||``,nivel:``})}catch(e){P.error(`Error al generar propuesta: `+e.message)}finally{me.disabled=!1,me.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let he=e.querySelector(`#btn-copy-as-plan`);he&&he.addEventListener(`click`,async()=>{let e=k.getValue();Dr(`create`,null,await i(),[],{clase_id:u,maestro_id:c?.id||null,maestro_nombre:c?.nombre_completo||null,contenido:e||``,fecha_inicio:l},async e=>{try{await b({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),h&&(E=Yr(e.querySelector(`#pm-route-tree-container`),{claseId:u,rutaId:h,onIndicadorSelect:t=>{k.insertText(`[${t.nombre}] `),ae.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),y.push(()=>E.destroy())),console.log(`[DEBUG] Reached handoff section`);let ge=Mi();if(ge&&ge.claseId===u){let t=`[${ge.nombre}] `;k.insertText(t),ae.setContext({indicadorActivo:ge.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let _e=Ni(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&j.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&Ri(t).catch(console.warn),o[e]=null,delete s[e],Se(e),F(),await Ee(!0),Et(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await j.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await j.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=j.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await j.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{v||await Ee(!0,!1);let r=await Ii({sesionId:v,alumnoId:e,claseId:u,fecha:l,motivo:t,creadoPor:c.id},n);if(r.error)throw r.error;o=r.data}o&&(s[e]=o),_e.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{o[e]=t,Se(e),F()}});y.push(()=>{try{_e.close()}catch{}});let ve=null,ye=e.querySelector(`#pm-draft-indicator`);if(v){ve=Ti({saveFn:async e=>{v&&await Ei(v,c.id,e)},debounceMs:3e4}),ve.onSaved(()=>{let e=new Date;ye.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,ye.style.display=``}),k.getValue;let e=O.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),ve&&ve.onInput(k.getValue())}}y.push(()=>ve.destroy()),g?.borrador===!0&&Di(v,c.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(k.setValue(e.contenido_raw),S=e.contenido_raw):Oi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let N=e.querySelector(`#btn-guardar-obs`);N&&(h&&(N.style.display=``),N.onclick=async()=>{let t=k.getValue();if(!t||!t.trim()){P.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!v){P.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let r=null,i=await Re(t),s=E?.getActiveIndicador();if(r=i||s,!r){P.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let d=e.querySelector(`#pm-active-tema-badge`);d&&r.nombre&&(d.textContent=r.nombre,d.style.display=`inline-block`),N.disabled=!0,N.textContent=`Procesando...`;try{let i=a.filter(e=>o[e.id]===`P`),s=await ni(t,r.id,i,r.nombre);if(s.error)throw Error(s.error);if(s.modo===`natural`&&s.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+s.dslGenerado+`

¿Guardar la evaluación?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(s.missing.length>0&&!confirm(`Faltan ${s.missing.length} alumno(s) sin evaluar:\n${s.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){N.disabled=!1,N.textContent=`Guardar observación`;return}if(s.evaluaciones.length>0){let{error:e}=await ei(v,r.id,s.evaluaciones,c.id,i);if(e)throw e}let d={indicador_id:r.id,evaluaciones:s.evaluaciones};await ki(v,c.id,t,d,s.dslGenerado||null,s.textoMejorado||null);let f=sn(t);if(f.estados&&f.estados.length>0){let e=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));qi({sesionId:v,claseId:u,maestroId:c.id,fechaHoy:l,dslText:t,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&Ae(e,O)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let p=await zi(v,u,c.id,s.evaluaciones,n.nombre||`Clase`,i);p.success||console.warn(`[Fase C] Fallo parcial en promoción:`,p.error),E&&await E.refresh(),k.setValue(``),S=``;let m=document.createElement(`div`);if(m.innerHTML=`
        ...
        `,m.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(m),setTimeout(()=>m.remove(),4500),s.evaluaciones.length>0&&u&&r?.nombre){let{saved:e,error:t}=await Gi({sesionId:v,claseId:u,maestroId:c.id,fechaHoy:l,contenido:r.nombre,evaluaciones:s.evaluaciones});t&&console.warn(`[asistencia] Error al sincronizar progresos:`,t)}if(v){let{academicService:t}=await we(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:n}=await we(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-QpVpXpLq.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),r=await t.processSessionClosure(v);r&&r.length>0&&await n(e,r)}N.textContent=`¡Guardado!`,setTimeout(()=>{N.textContent=`Guardar observación`,N.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),P.error(`Error al guardar: `+(e.message||e)),N.disabled=!1,N.textContent=`Guardar observación`}});let be=null,xe=e.querySelector(`#pm-alumnos-list`);function Se(e=null){let t=Wa(a,o),n=null;if(e){let t=xe.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(xe.innerHTML=t.map(e=>Ce(e,o[e.id])).join(``),e&&n){let t=xe.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Ce(e,t){return`
    ...
    `}xe.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),i=t.target.closest(`.pm-asist-nombre`);if(i){let t=i.closest(`.pm-asist-item`).dataset.id,n=a.find(e=>e.id===t);if(h){be&&be.destroy(),be=gi({alumno:n,rutaId:h,sessionId:v,claseId:u,fecha:l,horaInicio:r?.hora_inicio||null}),be.open(),y.push(()=>{be&&be.destroy()});return}let o=d.filter(e=>e.student_id===t);if(o.length===0)try{let{academicService:e}=await we(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(v,t,l);n?(o=n,d.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}yr(e,{student:n,sessionId:v,teacherId:c.id,snapshots:o});return}if(!n)return;let{id:f,action:p}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),p===`J`){let e=a.find(e=>e.id===f);if(!e)return;if(o[f]===`J`){let t=s[f]||null;!t&&v&&(t=await Li(v,f),t&&(s[f]=t)),_e.open(e,t,null),Et(`Editando justificación de ${e.nombre_completo}.`)}else o[f]=`J`,Se(f),F(),await Ee(!0),_e.open(e,null,null),Et(`Justificación marcada para ${e.nombre_completo}.`);return}o[f]=o[f]===p?null:p,Se(f),F();let m=Object.values(o).filter(e=>e===`P`).length,g=Object.values(o).filter(e=>e===`A`).length,_=Object.values(o).filter(e=>e===`J`).length;Et(`Asistencia actualizada. ${m} presentes, ${g} ausentes, ${_} justificados.`),await Ee(!0)};function F(){let t=a.length,n=Object.values(o).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function Ee(e=!1,t=!1){w&&clearTimeout(w);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...v?{}:{clase_id:u},maestro_id:c.id,fecha:l,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:S||``};if(navigator.onLine)try{if(v){let{error:e}=await j.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,v);if(!e){localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await j.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){v=e.id,console.log(`[asistencia] Nueva sesión creada:`,v),localStorage.setItem(`${x}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await pe({tabla:`sesiones_clase`,operacion:v?`update`:`insert`,payload:{...v?{id:v}:{},...t}}),localStorage.setItem(`${x}_updated`,new Date().toISOString())};e?t?await n():await T.run(n):w=setTimeout(()=>{T.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let De=e.querySelector(`.pm-asist-actions-fixed`);if(De){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),v&&(e.disabled=!0,e.innerHTML=`⏳...`,await We(v),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=De.querySelector(`#btn-guardar`);De.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),u&&(n.disabled=!0,n.innerHTML=`⏳...`,await He(u,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),De.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let t=e.querySelector(`#btn-guardar`),r=t.textContent;t.textContent=`Guardando...`,t.disabled=!0,await T.run(async()=>{try{let r=a.filter(e=>o[e.id]).map(e=>({...u?{clase_id:u}:{},alumno_id:e.id,fecha:l,estado:o[e.id],registrado_por:c.id})),i=r.length>0,s=S&&S.trim().length>0;if(!i&&!s)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Ee(!0,!0),!v){let{data:e}=await j.from(`sesiones_clase`).select(`id`).eq(`clase_id`,u).eq(`maestro_id`,c.id).eq(`fecha`,l).maybeSingle();e&&(v=e.id)}if(i&&u)try{let e=r.map(e=>({...e,...v&&{sesion_clase_id:v}}));await ee(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!v){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of r)await pe({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:u,alumno_id:e.alumno_id,fecha:l,estado:e.estado,registrado_por:c.id,...v?{sesion_clase_id:v}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(v&&(i||s)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:t}=await j.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,v).select();if(t){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,t.message);let{error:n}=await j.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,v).select();n&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,n.message),await j.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:S||``,updated_at:new Date().toISOString()}).eq(`id`,v))}_(),qr(`hoy`),qr(`calendario`),qr(`metricas`),Ca().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(v){let{academicService:n}=await we(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await we(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-QpVpXpLq.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await n.processSessionClosure(v);i&&i.length>0?(t.textContent=`¡Logros detectados!`,t.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);t.textContent=`✓ Guardado`,t.style.background=`var(--apple-success)`;let d=De?.querySelector(`#btn-reporte-dia`);d&&(d.style.display=``);let f=De?.querySelector(`#btn-resumen-mes`);f&&(f.style.display=``);let p=Object.values(o).filter(e=>e===`P`).length,m=Object.values(o).filter(e=>e===`A`).length;Et(`Sesión guardada exitosamente. ${p} presentes, ${m} ausentes.`);let h=document.createElement(`div`);h.className=`pm-saved-overlay`,h.innerHTML=`
      ...
      `,document.body.appendChild(h);let g=h.querySelector(`#btn-resumen-pedagogico`),y=h.querySelector(`#btn-editar-asistencia`),b=h.querySelector(`#btn-compartir-correo`),x=h.querySelector(`#btn-compartir-whatsapp`),C=h.querySelector(`#btn-volver-hoy`),w=h.querySelector(`#btn-ir-calendario`),T=Ci();g&&(g.onclick=()=>{T.open({sesionId:v,claseNombre:n?.nombre||`Clase`,fecha:l,supabase:j})}),y&&(y.onclick=()=>{h.remove(),t.textContent=`Guardar sesión`,t.style.background=``,t.disabled=!1,t.style.display=``}),b&&(b.onclick=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${n?.nombre||``} - ${l}`),r=je(e,S,a,n);Me(`mailto:?subject=${t}&body=`,r,1800)}),x&&(x.onclick=async()=>{Me(`https://wa.me/?text=`,je(a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),S,a,n),1600)}),C&&(C.onclick=()=>{window.location.hash=`#/hoy`}),w&&(w.onclick=()=>{window.location.hash=`#/calendario`});let E=h.querySelector(`#btn-reporte-dia-overlay`);E&&(E.onclick=async()=>{let e=E.innerHTML;E.disabled=!0,E.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await We(v)}finally{E.disabled=!1,E.innerHTML=e}});let D=h.querySelector(`#btn-resumen-mes-overlay`);D&&(u?D.onclick=async()=>{let e=D.innerHTML;D.disabled=!0,D.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await He(u,e.getFullYear(),e.getMonth()+1)}finally{D.disabled=!1,D.innerHTML=e}}:(D.disabled=!0,D.title=`No disponible para actividades especiales`,D.style.opacity=`0.5`));let O=h.querySelector(`#btn-informe-ped-overlay`);O&&(u?O.onclick=async()=>{let e=O.innerHTML;O.disabled=!0,O.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Ue(u,e.getFullYear(),e.getMonth()+1)}finally{O.disabled=!1,O.innerHTML=e}}:(O.disabled=!0,O.title=`No disponible para actividades especiales`,O.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),t.textContent=e.message||`Error al guardar`,t.style.background=`var(--pm-danger)`,t.disabled=!1,setTimeout(()=>{t.textContent=r,t.style.background=``},3e3)}})};function Oe(e){let t=(e?.nombre||``).toLowerCase();return(e?.instrumento||``).toLowerCase(),/orquesta|ensamble|ensemble|coro|ensayo/.test(t)?`ensayo_general`:/teor[ií]a|solfeo|lenguaje\s+musical/.test(t)?`teoria`:`instrumento`}function Ae(e,t){if(!e||e.length===0)return;t.parentNode.querySelectorAll(`.pm-progress-feedback`).forEach(e=>e.remove());let n=[...new Set(e.slice(0,3).map(e=>e.contenido||`progreso`))].join(` · `)+(e.length>3?` y ${e.length-3} más`:``),r=document.createElement(`div`);r.className=`pm-progress-feedback`,r.innerHTML=`<i class="bi bi-check-circle-fill"></i> <span>${e.length} registro(s) guardados — ${n}</span>`,t.parentNode.insertBefore(r,t.nextSibling),setTimeout(()=>r.remove(),4200)}function je(e,t,n,r){if(!r)return`No hay datos de clase disponibles.`;let i=(e||[]).filter(e=>e.estado===`P`).length,a=(e||[]).filter(e=>e.estado===`A`).length,o=(e||[]).filter(e=>e.estado===`J`).length,s=`Reporte de Clase - ${r.nombre||`Sin nombre`}\n`;return s+=`Fecha: ${l||``}\n`,s+=`Instrumento: ${r.instrumento||`N/A`}\n\n`,s+=`RESUMEN DE ASISTENCIA
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;P.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}e.querySelector(`#pm-asist-back`).onclick=()=>{Be.destroy();try{_e.close()}catch{}y.forEach(e=>{try{e()}catch{}}),window.location.hash=`#/hoy`},e.querySelector(`#btn-bulk-p`).onclick=async()=>{a.forEach(e=>{o[e.id]=`P`}),Se(),F(),await Ee(!0),Et(`Todos los ${a.length} alumnos marcados como presentes.`)},e.querySelector(`#btn-bulk-a`).onclick=async()=>{a.forEach(e=>{o[e.id]=`A`}),Se(),F(),await Ee(!0),Et(`Todos los ${a.length} alumnos marcados como ausentes.`)},Se();async function Fe(e){try{let{data:t}=await j.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[AsistenciaView] Error calculando progreso histórico:`,e),[]}}async function Re(e){if(!e||!A)return null;let t=e.match(/\[(.*?)\]/);if(!t||!t[1])return null;let n=t[1].trim().toLowerCase(),r=e=>{let t=[`se`,`hizo`,`la`,`el`,`los`,`las`,`un`,`una`,`de`,`del`,`en`,`con`,`por`,`para`,`y`,`o`,`tema`,`indicador`];return e.toLowerCase().replace(/[^\w\sáéíóúñ]/g,``).split(/\s+/).filter(e=>e.length>2&&!t.includes(e))},i=r(n);if(i.length===0)return null;try{let e=await W.getRouteHierarchy(A),t=null,a=0;for(let o of e)for(let e of o.plan_temas||[])for(let o of e.plan_objetivos||[]){let e=r(o.nombre),s=0;for(let t of i)e.some(e=>e.includes(t)||t.includes(e))&&s++;o.nombre.toLowerCase().includes(n)&&(s+=5);let c=s/(e.length||1);s>0&&c>a&&(a=c,t={id:o.id,nombre:o.nombre})}if(t)return console.log(`[asistencia] Indicador auto-resuelto con fuzzy match: '${t.nombre}' (Score: ${a.toFixed(2)})`),t}catch(e){console.warn(`[asistencia] Error en auto-resolución de indicador:`,e)}return null}let Be=new Tr(e);Be.mount();let Ve=e.querySelector(`#pm-btn-help`);return Ve&&(Ve.onclick=()=>Be.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),Be.destroy();try{_e.close()}catch{}y.forEach(e=>{try{e()}catch{}})}}function Wa(e,t){return[...e].sort((e,n)=>{let r=t[e.id]!==null,i=t[n.id]!==null;return!r&&i?-1:r&&!i?1:0})}function Ga(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await j.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=Ga(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await pe({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var qa={async open(){let e=await Se(),t=await be();Ne.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    `},_initLogic(e){e.querySelector(`#modal-notif-test`).addEventListener(`click`,async()=>{await ge()||window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Primero activa las notificaciones`,type:`warning`}}))});let t=e.querySelector(`#modal-notif-push`);t.addEventListener(`change`,async()=>{if(t.checked,t.checked){let e=await Ce();e.success?this._toast(`Notificaciones activadas`,`success`):(t.checked=!1,this._toast(e.error||`Error al suscribir`,`danger`))}else (await _e()).success&&this._toast(`Notificaciones desactivadas`,`info`)})},async _handleSave(e){await he({alerta_pre_clase:e.querySelector(`#modal-notif-pre`).checked,min_antes_clase:parseInt(e.querySelector(`#modal-notif-min-antes`).value,10),alerta_post_clase:e.querySelector(`#modal-notif-post`).checked,min_post_clase_sin_registro:parseInt(e.querySelector(`#modal-notif-min-post`).value,10),alerta_24h:e.querySelector(`#modal-notif-24h`).checked,alerta_48h:!0}),this._toast(`Preferencias guardadas`,`success`)},_toast(e,t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e,type:t}}))}},Ja={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`,"/":`&#x2F;`};function Ya(e){return e==null?``:String(e).replace(/[&<>"'/]/g,e=>Ja[e])}var Xa={container:null,async init(){document.getElementById(`push-diagnostic-panel`)||(this.createPanel(),await this.checkStatus())},createPanel(){this.container=document.createElement(`div`),this.container.id=`push-diagnostic-panel`,this.container.innerHTML=`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);$a(n,t),eo(n,t),so(n,t),to(r),no(r,t),ro(r),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),io(r),ao(r),go(t),uo(t),_o(),we(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-B2O2fSHa.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([8,1,9,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&oo(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function $a(e,t){let n=Ee(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function no(e,t){let n=ve(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${J.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=vo,document.head.appendChild(e)}async function yo(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let n=await W.getClasses(t.id),{data:r}=await j.from(`clases`).select(`id, nombre, instrumento`).or(`maestro_principal_id.eq.${t.id},maestro_suplente_id.eq.${t.id},maestro_id.eq.${t.id}`).order(`nombre`),i=async(e=null)=>{if(!e)return`<p class="pm-empty">Seleccioná una clase para ver su ruta académica.</p>`;let n=await W.getRouteHierarchy(e,t.id);if(!n||n.length===0)return`<p class="pm-empty">Esta clase aún no tiene una ruta configurada.</p>`;let r=e=>({ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`})[e]||`•`,i=e=>e?`var(--pm-danger)`:`var(--pm-primary)`;return`
  ...
  `}var xo=`alumno_plan_entradas`;async function So(e){let{data:t,error:n}=await j.from(xo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function Co(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await j.from(xo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function wo(e){let{error:t}=await j.from(xo).delete().eq(`id`,e);if(t)throw Error(t.message)}var To={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},Eo=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],Do=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await So(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
...
`).trim():``}var Fo={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Io(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await j.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await j.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Fo[n.estado_cualitativo]??Fo.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
      ...
      `;return}let{data:a}=await j.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await j.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await j.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id, covered_by_clase_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await j.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await j.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,g=c.filter(e=>e.estado===`J`).length,_=c.filter(e=>e.estado===`T`).length,y=p>0?Math.round(m/p*100):0,b=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],x={};b.forEach(e=>{let t=e.covered_by_clase_id||`sin_clase`;x[t]||(x[t]=[]),x[t].push(e.nota)});let S=Object.values(x).map(e=>e.reduce((e,t)=>e+t,0)/e.length),C=S.length>0?Math.round(S.reduce((e,t)=>e+t,0)/S.length*10)/10:0,w=b.filter(e=>e.nota>=4).length,T=b.length,E=T>0?Math.round(w/T*100):0,D={};c.forEach(e=>{D[e.clase_id]||(D[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(D[e.clase_id][e.estado]=(D[e.clase_id][e.estado]||0)+1,D[e.clase_id].total++)});let O=new Set([...o,...Object.keys(D)]),{data:ee}=O.size>0?await j.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...O]):{data:[]},k=new Map((ee||[]).map(e=>[e.id,e])),te=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),ne=l?.filter(e=>e.observations?.trim())||[],re=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;re=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&re--}let ie=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,ae=(r.instrumento_principal||``).toLowerCase(),A=`var(--pm-primary)`;(ae.includes(`violin`)||ae.includes(`cuerda`))&&(A=`#FF3B30`),(ae.includes(`piano`)||ae.includes(`teclado`))&&(A=`#FF9500`),ae.includes(`guitarra`)&&(A=`#5856D6`),(ae.includes(`canto`)||ae.includes(`voz`))&&(A=`#AF52DE`),e.innerHTML=`
      <div class="pm-alumno-zen pm-animate-fade-in">
        <!-- Hero Section -->
        <div class="pm-zen-hero" style="--accent-gradient: ${A}">
          ...
          <div class="pm-zen-hero__content">
            ...
            <div class="pm-zen-info">
              ...
              <p style="font-size:0.8rem;opacity:0.8;margin-top:4px;">Nivel ${r.nivel_actual||1} • ${re} años</p>
            </div>
          </div>
        </div>
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${te.map(e=>{let t=k.get(e.clase_id),n=Po(e.contenido_dsl);return`
          ...
          <details class="pm-zen-section pm-zen-accordion">
            <summary class="pm-zen-accordion-header">
              ...
              <span class="pm-zen-accordion-meta">${ne.length} observación${ne.length===1?``:`es`}</span>
              <i class="bi bi-chevron-down pm-accordion-chevron"></i>
            </summary>
            <div class="pm-zen-desenvolvimiento" style="margin-top:0.75rem;">
              ${ne.map(e=>{let t=e.nota>=4?`var(--pm-success)`:e.nota>=2?`var(--pm-warning)`:`var(--pm-danger)`;return`
          ...
          <details class="pm-zen-section pm-zen-accordion" ${c.length>0?`open`:``}>
            ...
            <div class="pm-zen-asistencia-timeline" style="margin-top:0.75rem;">
              ${c.length===0?`<p class="pm-zen-empty">Sin registros de asistencia</p>`:c.slice(0,30).map(e=>{let t={P:`Presente`,A:`Ausente`,J:`Justificado`,T:`Tardanza`},n={P:`var(--pm-success)`,A:`var(--pm-danger)`,J:`var(--pm-warning)`,T:`#FF9500`},r=k.get(e.clase_id),i=e.estado===`J`?f.get(e.sesion_id):null;return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${v(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let oe=Oo(r.tlf_alumno||r.representante_tlf);if(oe){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Yo=()=>typeof global<`u`&&global.getMaestroLocal?global.getMaestroLocal():M(),Xo=(...e)=>typeof global<`u`&&global.getMisClases?global.getMisClases(...e):i(...e),Zo=(...e)=>typeof global<`u`&&global.loadRouteTree?global.loadRouteTree(...e):Go(...e),Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},Qo=!1;async function $o(e,{onTopicSelected:t}={}){if(Y={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:t},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Yo()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(_(),Y.clases=await Xo(!0),!Y.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Y.activeClaseId=Y.clases[0].id,await es(),ts(e),as(e),os(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function es(){Y.loading=!0,Y.rutaId=await Wo(Y.activeClaseId),Y.rutaId?Y.blocks=await Zo(Y.rutaId,Y.activeClaseId):Y.blocks=[],Y.loading=!1}function ts(e){e.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Y.selectedIndicator=null,ts(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{ji({...Y.selectedIndicator,indicatorId:Y.selectedIndicator.id,claseId:Y.activeClaseId}),Y.onTopicSelected&&Y.onTopicSelected(Y.activeClaseId)})}function is(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function as(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Y.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await es(),ts(e),as(e)})}function os(e){Qo||(Qo=!0,qo.on(`node-covered`,()=>{es().then(()=>{ts(e),as(e)})}))}var ss=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function cs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=M();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await j.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
    ...
    `}}async function ls(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await F.getStudent(t),r=await F.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([F.getRouteDetail(t),n?F.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}};function ps(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ms(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function hs(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var gs=null,_s=[],vs=new Set;async function ys(e){e.innerHTML=Ms();let t=M();if(!t){e.innerHTML=Ns(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await Ke(t.id);if(!n.puede_inscribir_clases){e.innerHTML=xs(n),Ss(t.id);return}let[i,a]=await Promise.all([h(t.id),r().catch(()=>[])]);_s=a.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=Cs(i),ks(i),i.length>0&&await Ts(i[0].id,i)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=Ns(`bi-exclamation-triangle`,`Error al cargar`,ps(t.message))}}function bs(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function xs(e){return`
    <div class="gcv-root">
  ...
  `}function Ss(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await Ge(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){P.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function Cs(e){return`
    <div class="gcv-root">
  ...
  `,fc();let i=document.getElementById(`pm-theme-toggle-container`);i&&i.appendChild(qs.createToggleButton());let a=document.getElementById(`pm-footer-nav`);a&&a.querySelectorAll(`.pm-nav-tab`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let o=document.getElementById(`pm-sidebar`);o&&o.querySelectorAll(`.pm-sidebar-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Z.navigate(e.dataset.route)})});let s=document.getElementById(`pm-modo-switcher`);s&&s.addEventListener(`click`,()=>{rc(X?`maestro`:`admin`)}),document.getElementById(`pm-btn-perfil`).addEventListener(`click`,e=>{e.preventDefault(),Z.navigate(`perfil`)});let c=document.getElementById(`pm-header`),l=document.getElementById(`pm-header-search-input`),u=document.getElementById(`pm-search-toggle-btn`),d=document.getElementById(`pm-search-back-btn`),f=()=>{c?.classList.add(`search-active`),setTimeout(()=>{l?.focus()},50)},p=()=>{c?.classList.remove(`search-active`),l&&(l.value=``),document.getElementById(`pm-header-search-dropdown`)?.remove()};u?.addEventListener(`click`,e=>{e.stopPropagation(),f()}),d?.addEventListener(`click`,e=>{e.stopPropagation(),p()});let m=null,h=null,g=()=>{m?.remove(),m=null},_=e=>{if(g(),!e.length)return;let t=document.createElement(`div`);t.id=`pm-header-search-dropdown`,t.setAttribute(`role`,`listbox`),t.innerHTML=e.map(e=>`
      ...
      </div>`).join(``),document.body.appendChild(t);let n=l.getBoundingClientRect();t.style.cssText=`position:fixed;top:${n.bottom+4}px;left:${Math.max(8,n.left)}px;width:${Math.min(320,window.innerWidth-16)}px;z-index:9999;background:var(--pm-surface);border:1px solid var(--pm-border);border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.18);overflow:hidden;`,m=t,t.querySelectorAll(`.pm-hsd-item`).forEach(e=>{let t=()=>{p(),g(),Z.navigate(`alumno`,{id:e.dataset.id})};e.addEventListener(`click`,t),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&t()})})};if(l?.addEventListener(`input`,()=>{let e=l.value.trim();if(clearTimeout(h),e.length<1){g();return}let t=en();if(t){let n=e.toLowerCase();_(t.filter(e=>e.nombre_completo?.toLowerCase().includes(n)).slice(0,8).map(e=>({...e,instrumento_principal:e.clases?.join(`, `)||null})));return}h=setTimeout(async()=>{try{let{data:t}=await j.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).ilike(`nombre_completo`,`%${e}%`).limit(8);_(t||[])}catch{g()}},200)}),l?.addEventListener(`keydown`,e=>{e.key===`Escape`&&(p(),g())}),!document.getElementById(`pm-hsd-styles`)){let e=document.createElement(`style`);e.id=`pm-hsd-styles`,e.textContent=`.pm-hsd-item{display:flex;align-items:center;gap:0.625rem;padding:0.75rem 1rem;cursor:pointer;border-bottom:1px solid var(--pm-border);transition:background 0.1s}.pm-hsd-item:last-child{border-bottom:none}.pm-hsd-item:hover,.pm-hsd-item:focus{background:var(--pm-surface-2);outline:none}.pm-hsd-icon{font-size:1rem;color:var(--pm-primary);flex-shrink:0}.pm-hsd-info{flex:1;min-width:0}.pm-hsd-name{display:block;font-size:0.875rem;font-weight:500;color:var(--pm-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.pm-hsd-meta{font-size:0.7rem;color:var(--pm-text-muted)}.pm-hsd-arrow{color:var(--pm-text-muted);font-size:0.75rem}`,document.head.appendChild(e)}document.addEventListener(`click`,e=>{!l?.contains(e.target)&&!m?.contains(e.target)&&g()}),document.getElementById(`pm-sync-indicator`).addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await pc()}),document.getElementById(`pm-bell-btn`)?.addEventListener(`click`,()=>{Xs.open()});let v=(Z.currentRoute?.()||`hoy`).split(`?`)[0];Cc(v)}var xc=!1;function Sc(){if(xc)return;if(xc=!0,xa(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=Oa();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Ca(),Aa(),!X){ic!==void 0&&ic&&(j.removeChannel(ic),ic=null);let e=cc;e?.id&&(ic=j.channel(`permisos-maestro:${e.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${e.id}`},async t=>{console.log(`[Realtime] Permisos actualizados:`,t.new);try{let t=await Ke(e.id),n=document.getElementById(`portal-app`);if(!n)return;let r=[];t.puede_inscribir_clases&&!lc?.puede_inscribir_clases&&r.push(`Gestionar e Inscribir Clases`);let i=[];lc?.puede_inscribir_clases&&!t.puede_inscribir_clases&&i.push(`Gestionar e Inscribir Clases`);let a=(Z.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`gestionar-clases`&&!t.puede_inscribir_clases?`hoy`:a;a===`pending-approval`&&r.length>0&&(o=`hoy`),bc(n,e,t),Ec(),_c(),Z.setAuthGuard(()=>bt.isAuthenticated(),[`login`,`register`,`pending-approval`]),Tc.clear(),await $(o),Z.navigate(o),r.length>0?P.success(`¡Nuevos permisos activados: ${r.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):i.length>0?P.show(`El administrador removió tu acceso a: ${i.join(`, `)}.`,`warning`):P.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>{console.log(`[Realtime] Canal permisos_maestros:`,e)}),window.addEventListener(`beforeunload`,()=>{j.removeChannel(permisosChannel)},{once:!0}))}document.addEventListener(`keydown`,e=>{if(vc()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`)switch(e.key.toLowerCase()){case`h`:Z.navigate(`hoy`),t.length=0;break;case`c`:Z.navigate(`calendario`),t.length=0;break;case`r`:Z.navigate(`ruta`),t.length=0;break;case`m`:Z.navigate(`metricas`),t.length=0;break;case`p`:Z.navigate(`perfil`),t.length=0;break;default:break}t.length>3&&t.splice(0,t.length-2)});let e=null;window.addEventListener(`resize`,()=>{clearTimeout(e),e=setTimeout(()=>{let e=vc();if(e!==yc){yc=e,document.body.dataset.pmLayout=e,bc(document.getElementById(`portal-app`),cc),Ec();let t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];Cc(t)}},250)},{passive:!0})}function Cc(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}var wc={},Q=null,Tc=new Set;function Ec(){let e=document.getElementById(`pm-view-container`);e&&(e.innerHTML=``,[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`gestionar-clases`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),wc[t]=n}),X&&[`admin-alumnos`,`admin-programas`,`admin-maestros`,`admin-metricas`,`admin-config`,`admin-clases`,`admin-sesiones`,`admin-aprobacion`,`admin-ausencias`,`admin-notificaciones`].forEach(t=>{let n=document.createElement(`div`);n.id=`pm-view-${t}`,n.className=`pm-view-content`,n.style.display=`none`,e.appendChild(n),wc[t]=n}))}async function $(e,n={},{silent:r=!1}={}){let i=window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``,a=new URLSearchParams(i),s=e.split(`?`)[0];if(!r){let e=document.getElementById(`pm-header`);if(e&&e.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}Cc(s),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}let c=wc[s];if(!c){console.warn(`[Router] Contenedor no encontrado: ${s}`);return}if(r||(typeof Q==`function`&&(console.log(`[Router] Ejecutando cleanup de vista anterior...`),Q(),Q=null),Object.values(wc).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),c.style.display=`block`,c.offsetHeight,c.classList.add(`active`)),Tc.has(s))return;let u=setTimeout(()=>{c.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,c.prepend(e)},300);try{switch(s){case`login`:At(c,{onSuccess:()=>Ac()});break;case`register`:jt(c,{onSuccess:()=>Z.navigate(`pending-approval`)});break;case`pending-approval`:Mt(c,{onBackToLogin:()=>Z.navigate(`login`)});break;case`logout`:gc(),ja(),xt().then(()=>window.location.reload());break;case`calendario`:case`clases`:Q=await Gt(c);break;case`hoy`:Q=await Nt(c,{onClaseClick:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`asistencia`:Q=await Ha(c,{claseId:a.get(`clase`),fecha:a.get(`fecha`),sesionId:a.get(`sesion`)});break;case`metricas`:Q=tn(c);break;case`perfil`:Q=Qa(c);break;case`clase-emergente`:Q=Ka(c,{maestroId:cc?.id});break;case`planificacion`:Q=await yo(c);break;case`alumno`:Q=Lo(c,{alumnoId:a.get(`id`)||n.id});break;case`gamificacion`:await Ho(c);break;case`ruta`:await $o(c,{onTopicSelected:e=>Z.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:cs(c);break;case`ruta-plan-builder`:ls(c,{alumnoId:a.get(`id`)});break;case`ruta-semanal`:us(c,{alumnoId:a.get(`id`)});break;case`ruta-libreria`:ds.render().then(e=>{c.innerHTML=``,c.appendChild(e)});break;case`ruta-detalle`:fs.render(n).then(e=>{c.innerHTML=``,c.appendChild(e)});break;case`admin-alumnos`:l(c);break;case`admin-programas`:o(c);break;case`admin-maestros`:t(c);break;case`admin-metricas`:O(c);break;case`admin-config`:S(c);break;case`admin-clases`:ne?.(c);break;case`admin-sesiones`:break;case`admin-aprobacion`:await k(c),Q=null;break;case`admin-ausencias`:await w(c),Q=null;break;case`admin-notificaciones`:Q=await re(c);break;case`gestionar-clases`:if(!lc?.puede_inscribir_clases){Z.navigate(`hoy`);return}Q=await ys(c);break;default:}clearTimeout(u),c.querySelector(`.pm-loading-overlay`)?.remove(),new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]).has(s)&&Tc.add(s)}catch(e){clearTimeout(u),c.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}async function Dc(){if(cc)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),n=e.toISOString().split(`T`)[0],[r,a,o]=await Promise.all([i(),i().then(e=>m(e.map(e=>e.id))),i().then(()=>u(cc.id,n,n))]),s=Object.fromEntries(r.map(e=>[e.id,e]));await ye(a.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:s[e.clase_id]?.nombre||`Clase`})),o.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}function Oc(){Tc.clear()}function kc(e){Tc.delete(e)}async function Ac(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`),console.log(`[Init] Llamando usePortalAuth.init()...`);let t=await bt.init();console.log(`[Init] Auth completado:`,t?`con maestro`:`sin maestro`);let n=nc(t);X=t?.es_admin===!0&&n===`admin`,console.log(`[Init] IS_ADMIN:`,X,`| maestro.es_admin:`,t?.es_admin,`| es_maestro:`,t?.es_maestro,`| modo:`,n);let r=window.router||Ct(),i=[`login`,`register`,`pending-approval`],a=r.currentRoute().split(`?`)[0],o=i.includes(a);if(!t&&!o){console.log(`[Init] No maestro y ruta privada, mostrando login screen`),gc();return}if(!t&&o){console.log(`[Init] No maestro pero ruta pública detectada:`,a),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Ec(),_c(),Z.setAuthGuard(()=>bt.isAuthenticated(),i),Z.start();return}let s=null;if(!X)try{s=await Ke(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}console.log(`[Init] Renderizando shell...`),bc(e,t,s),console.log(`[Init] Shell renderizado`),X&&Ks.init(),Ec(),Sc(),Kr(kc,Oc),_c(),Z.setAuthGuard(()=>bt.isAuthenticated(),[`login`,`register`,`pending-approval`]),Z.start(),A().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=(Z.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!Tc.has(e)).reduce((e,t)=>e.then(()=>{if(wc[t])return $(t,{},{silent:!0})}),Promise.resolve()),Dc(),window.pwaInstaller&&window.pwaInstaller.evaluateInsights(),window.adminAusenciasInsights&&window.adminAusenciasInsights.evaluate()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),pc()}window.addEventListener(`error`,e=>{let t=[`useCache`,`WebSocket`,`content.js`],n=e.message||``;if(t.some(e=>n.includes(e))){console.warn(`[Ignored Error]`,n);return}et(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let r=document.getElementById(`portal-app`);r&&(r.innerHTML=`
