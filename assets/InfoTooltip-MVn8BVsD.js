import{a as e}from"./supabase-Cgh_dhNB.js";import{n as t}from"./AppModal-C8uxOJPY.js";function n(e,t={}){let{placement:n=`top`,className:r=``}=t;return`
    <span
  ...
  `}function r(e){e&&e.querySelectorAll(`.info-tooltip`).forEach(e=>{let t=e.dataset.term;t&&(e.addEventListener(`click`,e=>{e.stopPropagation(),i(t)}),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),i(t))}))})}async function i(n){let{glossary:r}=await e(async()=>{let{glossary:e}=await import(`./metrics-glossary-BCLh5qxX.js`);return{glossary:e}},[]),i=r[n];if(!i)return;let a=document.getElementById(`infoModalBackdrop`);a&&a.remove();let o=document.createElement(`div`);o.id=`infoModalBackdrop`,o.className=`info-modal-backdrop`,o.innerHTML=`
    <div class="info-modal-content">
      ...
      <div class="info-modal-body">
        <p>${t(i.description)}</p>
        ${i.example?`<p class="text-muted"><small><strong>Ej:</strong> ${t(i.example)}</small></p>`:``}
      </div>
    </div>
