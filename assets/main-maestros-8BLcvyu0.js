...
import{a as e,c as t,i as n,l as r,n as i,o as a,r as o,s,t as c,u as l}from"./pwaInstaller-BwJm9z4U.js";import{i as u}from"./supabase-KnARm58N.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./maestroAuth-lT-ZcZZd.js";import{n as _,o as v,s as y}from"./CHANGELOG-B2qeUolL.js";import"./vendor-CtPF6k7y.js";import{t as b}from"./idb-C1WH1nPN.js";import{a as x,n as S,r as C,t as w}from"./offlineQueue-Dapm0Tb7.js";import{a as T,c as E,d as D,f as O,i as ee,l as k,n as A,o as j,p as te,r as M,t as ne,u as re}from"./pushService-3VyBHY3l.js";import{r as ie,t as N}from"./permisoService-D9Za2-hc.js";import{t as P}from"./AppToast-Dk3fEiuP.js";import{C as ae,G as oe,K as se,b as ce,i as le,k as ue,o as de,s as fe,u as pe,w as me,x as he,y as ge}from"./clasesApi-pE4mvyS2.js";import{n as _e,t as ve}from"./ausenciaModal-CprNSrCK.js";import{a as ye,c as be,i as F,l as xe,n as Se,o as Ce,r as we,s as Te,t as Ee}from"./portalUtils-DSiXbuJv.js";import{a as De,c as Oe,i as ke,l as Ae,n as je,o as Me,s as Ne,t as Pe}from"./groqService-Cmal3gSu.js";import{t as I}from"./preload-helper-BQrMkyGX.js";import{t as L}from"./academicService-Cajirgsc.js";import{t as Fe}from"./AppModal-2uZhR2ML.js";import{n as Ie}from"./planificacionAdapter-BkWRUKTF.js";import{r as Le,s as Re}from"./alumnosApi-DIQGy8Mo.js";import{n as ze,r as Be,t as Ve}from"./reportService-JTvBMKOP.js";import{n as He}from"./disponibilidadApi-CIycXhxj.js";import{n as Ue,r as We,t as Ge}from"./planningService-CNKpAXnq.js";var Ke=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function qe(e=``){let t=String(e).toLowerCase();return Ke.some(e=>t.includes(e.toLowerCase()))}var Je=console.error;console.error=function(...e){e.length>0&&!qe(e[0])&&Je.apply(console,e)};var Ye=console.warn;console.warn=function(...e){e.length>0&&!qe(e[0])&&Ye.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{qe(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{qe(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Xe=window.fetch;window.fetch=async function(...e){try{return await Xe.apply(window,e)}catch(e){if(!qe(e.message))throw e;return null}};var Ze=!1;function Qe(e={}){let{enabled:t=!1,consent:n=!1}=e;Ze=t&&n,console.log(`[Analytics] Initialized, enabled:`,Ze)}var $e={windowMs:6e4,max:100};function et(e={}){$e={...$e,...e},console.log(`[RateLimit] Initialized: ${$e.max} requests per ${$e.windowMs}ms`)}var tt=null,nt=new Set;function rt(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function it(e={}){tt=rt(e.length||32),nt.clear(),nt.add(tt),console.log(`[CSRF] Initialized`)}var at={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function ot(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function st(e={}){let{debug:t=!1,onReport:n=null}=e;if(!ot()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),ct(t,n),lt(t,n),ut(t,n),dt(t,n),ft(t,n)}function ct(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];at.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function lt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];at.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function ut(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);at.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function dt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];at.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function ft(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];at.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var R={maestro:null,loading:!0,pendingApproval:!1,listeners:[]},pt=null,mt=!1;function ht(){R.listeners.forEach(e=>e({...R}))}var gt={subscribe(e){return R.listeners.push(e),()=>{R.listeners=R.listeners.filter(t=>t!==e)}},async init(){mt=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),R.maestro=f(),console.log(`[usePortalAuth.init] Maestro local:`,R.maestro?`found`:`not found`),R.loading=!0,ht(),typeof process<`u`&&{}.VITEST)return R.loading=!1,ht(),console.log(`[usePortalAuth.init] Completado (Test Env)`),R.maestro;if(!pt){let{data:{subscription:e}}=u.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),mt&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),R.maestro=null,ht();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=f();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await h();e&&(R.maestro=e,ht())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});pt=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([h(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?t.__pendingApproval?`pendiente de aprobación`:`con datos`:`sin datos`),t===g||t?.__pendingApproval?(R.maestro=null,R.pendingApproval=!0):(R.maestro=t,R.pendingApproval=!1)}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),R.maestro=null,R.pendingApproval=!1}return R.loading=!1,ht(),console.log(`[usePortalAuth.init] Completado`),R.maestro}finally{mt=!1}},setMaestro(e){R.maestro=e,R.loading=!1,ht()},async logout(){await m(),R.maestro=null,ht()},getMaestro:()=>R.maestro,isAuthenticated:()=>!!R.maestro,isLoading:()=>R.loading,isPendingApproval:()=>R.pendingApproval},_t=gt.logout,vt=`hoy`;function yt(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(/^\//,``):vt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:vt},``,vt===`hoy`?`/`:`/${vt}`),h(vt);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=e===`hoy`?`/`:`/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`/login`),h(`login`);return}let t=e===`hoy`?`/`:`/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),window.addEventListener(`hashchange`,()=>{let e=window.location.hash;if(e&&e.startsWith(`#/`)){let t=e.replace(`#/`,``);history.replaceState(null,``,window.location.pathname+window.location.search),l(t)}}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var bt=null;function xt(e,t){bt=e}function St(e){bt&&bt(e)}var Ct=new class{constructor(){this.storageKey=`portal-maestros-theme`,this.init()}init(){let e=localStorage.getItem(this.storageKey),t=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;this.currentTheme=e||t,this.applyTheme(this.currentTheme),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(this.storageKey)||(this.currentTheme=e.matches?`dark`:`light`,this.applyTheme(this.currentTheme))})}applyTheme(e){document.documentElement.setAttribute(`data-bs-theme`,e),document.documentElement.setAttribute(`data-portal-theme`,e),this.updateCustomProperties(e)}updateCustomProperties(e){let t=document.documentElement;e===`dark`?(t.style.setProperty(`--pm-glass-bg`,`rgba(30, 41, 59, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(255, 255, 255, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(15, 23, 42, 0.95)`)):(t.style.setProperty(`--pm-glass-bg`,`rgba(255, 255, 255, 0.8)`),t.style.setProperty(`--pm-glass-border`,`rgba(0, 0, 0, 0.1)`),t.style.setProperty(`--pm-header-glass`,`rgba(242, 242, 247, 0.95)`))}toggle(){this.currentTheme=this.currentTheme===`dark`?`light`:`dark`,this.applyTheme(this.currentTheme),localStorage.setItem(this.storageKey,this.currentTheme),window.dispatchEvent(new CustomEvent(`themeChanged`,{detail:{theme:this.currentTheme}}))}getCurrentTheme(){return this.currentTheme}createToggleButton(){let e=document.createElement(`button`);return e.className=`pm-theme-toggle`,e.setAttribute(`aria-label`,`Cambiar tema`),e.innerHTML=`
    ...
    `,e.addEventListener(`click`,()=>{this.toggle(),this.updateButtonIcon(e)}),window.addEventListener(`themeChanged`,()=>{this.updateButtonIcon(e)}),e}updateButtonIcon(e){let t=e.querySelector(`.pm-theme-icon`);t&&(t.className=`bi ${this.currentTheme===`dark`?`bi-moon-fill`:`bi-sun-fill`} pm-theme-icon`)}};function wt(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function Tt(e){if(!e||typeof e!=`string`)return{claseId:null,fecha:null,isValid:!1};let t=e.match(/^\/asistencia\/([a-f0-9-]{36})\/(\d{4}-\d{2}-\d{2})$/);return t?{claseId:t[1],fecha:t[2],isValid:!0}:{claseId:null,fecha:null,isValid:!1}}function Et(e){let{claseId:t,fecha:n,isValid:r}=Tt(e);if(!r){console.warn(`[notificationService] Invalid deep link:`,e);return}window.appNavigate?.({view:`asistencia`,claseId:t,fecha:n})}j(e=>{if(e.event===`subscriptionChanged`)console.log(`[Notif] Push subscription changed:`,e.subscribed);else if(e.event===`notificationReceived`){console.log(`[Notif] Real-time push received:`,e.notification),Pt(e.notification);let t=e.notification;t?.data?.deep_link?Et(t.data.deep_link):t?.data?.deep_link_url&&Et(t.data.deep_link_url),z.some(t=>t.id===e.notification.id)||(z.unshift({...e.notification,created_at:e.notification.created_at||new Date().toISOString()}),Vt())}});var Dt=new se(`maestro-notifications`),Ot=30*1e3,kt=60*1e3,At=120*1e3,jt=new Map;function Mt(e){return`${e.tipo||`unknown`}:${e.clase_id||e.alumno_id||e.id||`generic`}:${Math.floor(Date.now()/kt)}`}function Nt(){let e=Date.now();for(let[t,n]of jt.entries())e>n&&jt.delete(t)}function Pt(e){let t=Mt(e),n=Date.now()+At;jt.set(t,n)}function Ft(){return Nt(),jt.size}function It(e){return`notif_cache_${e}`}function Lt(e){try{let t=z.filter(e=>!String(e.id).startsWith(`local_`)).slice(0,30);localStorage.setItem(It(e),JSON.stringify(t))}catch{}}function Rt(e){try{let t=localStorage.getItem(It(e));return t?JSON.parse(t):[]}catch{return[]}}var z=[],zt=[];function Bt(e){return zt.push(e),e(z),()=>{zt=zt.filter(t=>t!==e)}}function Vt(){zt.forEach(e=>e([...z]))}async function Ht(){let e=f();if(!e)return[];z.length===0&&(z=Rt(e.id),z.length>0&&Vt());try{let{data:t,error:n}=await u.from(`notificaciones`).select(`*`).eq(`profile_id`,e.id).order(`created_at`,{ascending:!1}).limit(30);if(n)return console.warn(`[NotifService] Error fetch:`,n),z;let r=(t||[]).map(e=>({...e,created_at:e.created_at||new Date().toISOString()})),i=z.filter(e=>String(e.id).startsWith(`local_`));return z=[...r,...i],await Ut(e.id),Lt(e.id),Vt(),z}catch(e){return console.error(`[NotifService]`,e),z}}async function Ut(e){try{let t=new Date,r=wt(t),a=t.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[o,c]=await Promise.all([n(),s(e,r,r)]),l=o.map(e=>e.id),u=Object.fromEntries(o.map(e=>[e.id,e])),d=(await i(l)).filter(e=>e.dia?.toLowerCase()===a);c.filter(e=>e.estado===`pendiente`||e.estado===`borrador`||e.borrador===!0);let f=new Set(c.filter(e=>e.borrador===!1||e.estado===`registrada`||e.estado===`cerrada`).map(e=>e.clase_id));z=z.filter(e=>String(e.id).startsWith(`local_`)?!f.has(e.clase_id):!0);let p=new Date;for(let e of d){if(!e.hora_fin||f.has(e.clase_id))continue;let[t,n]=e.hora_fin.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(p-i)/6e4;if(a<30)continue;let o=u[e.clase_id],s=`${e.clase_id}_${r}`;if(z.some(e=>e.referencia_id===s&&e.tipo===`sesion_sin_registrar`))continue;let c=e.hora_fin?e.hora_fin.slice(0,5):``,l=e.hora_inicio?e.hora_inicio.slice(0,5):``,d=l&&c?` (${l}–${c})`:``,m=Math.round(a),h=m>=60?`hace ${Math.floor(m/60)}h ${m%60}min`:`hace ${m} min`;z.unshift({id:`local_`+s,tipo:`sesion_sin_registrar`,titulo:`Clase sin registrar`,mensaje:`${o?.nombre||`Tu clase`}${d} terminó ${h}. Registrá la asistencia para que quede guardada.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:r})}for(let e of d){if(!e.hora_inicio)continue;let[t,n]=e.hora_inicio.split(`:`),i=new Date;i.setHours(parseInt(t,10),parseInt(n,10),0,0);let a=(i-p)/6e4;if(a<0||a>15)continue;let o=u[e.clase_id],s=`prox_${e.clase_id}_${r}`;if(z.some(e=>e.referencia_id===s))continue;let c=e.hora_inicio?e.hora_inicio.slice(0,5):``,l=Math.round(a);z.unshift({id:`local_`+s,tipo:`recordatorio_clase`,titulo:`Clase por empezar`,mensaje:`${o?.nombre||`Tu clase`}${c?` a las ${c}`:``} empieza en ${l} ${l===1?`minuto`:`minutos`}. Prepará la planificación.`,estado:`pendiente`,created_at:new Date().toISOString(),referencia_id:s,clase_id:e.clase_id,fecha:r})}}catch(e){console.warn(`[NotifService] Error local alerts:`,e)}}async function Wt(e){let t=f(),n=z.find(t=>t.id===e);if(n&&(n.estado=`leida`),Vt(),t&&Lt(t.id),!String(e).startsWith(`local_`))try{await u.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`id`,e)}catch(e){console.warn(`[NotifService] Error al marcar leída`,e)}}async function Gt(e){let t=f();if(z=z.filter(t=>t.id!==e),Vt(),t&&Lt(t.id),String(e).startsWith(`local_`))return{success:!0};try{let{error:t}=await u.from(`notificaciones`).delete().eq(`id`,e);return t?(console.error(`[NotifService] Error al eliminar en base de datos:`,t.message),{success:!1,error:t}):{success:!0}}catch(e){return console.error(`[NotifService] Excepción al eliminar:`,e),{success:!1,error:e}}}async function Kt(){let e=f();if(z.forEach(e=>{e.estado!==`leida`&&(e.estado=`leida`)}),Vt(),e&&Lt(e.id),e)try{await u.from(`notificaciones`).update({estado:`leida`,leida_en:new Date().toISOString()}).eq(`profile_id`,e.id).neq(`estado`,`leida`)}catch(e){console.warn(`[NotifService] Error al marcar todas`,e)}}function qt(){return z.filter(e=>e.estado===`pendiente`||e.estado===`enviada`).length}var Jt=null;function Yt(){let e=f();e&&(Jt||(Jt=u.channel(`notificaciones:${e.id}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n={...t.new,created_at:t.new.created_at||new Date().toISOString()};z.some(e=>e.id===n.id)||(z.unshift(n),Lt(e.id),Vt(),Xt(n),console.log(`[Realtime] Nueva notificación recibida:`,n.titulo))}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`notificaciones`,filter:`profile_id=eq.${e.id}`},t=>{let n=z.findIndex(e=>e.id===t.new.id);n!==-1&&(z[n]={...z[n],...t.new},Lt(e.id),Vt())}).subscribe(e=>{console.log(`[Realtime] Canal notificaciones: ${e}`),(e===`CHANNEL_ERROR`||e===`SUBSCRIPTION_ERROR`)&&(console.warn(`[Realtime] Canal cerrado, activando polling como fallback`),Jt=null,tn())}),Dt.registerChannel(Jt)))}function Xt(e){if(document.getElementById(`pm-notificaciones-drawer-overlay`)?.classList.contains(`open`))return;let t=document.getElementById(`pm-notif-inapp-toast`);t&&t.remove();let n=Zt(e.tipo),r=document.createElement(`div`);r.id=`pm-notif-inapp-toast`,r.setAttribute(`role`,`alert`),r.setAttribute(`aria-live`,`polite`),r.innerHTML=`
  ...
  `,document.body.appendChild(r),$t(),requestAnimationFrame(()=>{requestAnimationFrame(()=>r.classList.add(`pm-iat-visible`))});let i=()=>{r.classList.remove(`pm-iat-visible`),setTimeout(()=>r.remove(),350)};r.querySelector(`.pm-iat-close`).addEventListener(`click`,i),r.addEventListener(`click`,e=>{e.target.classList.contains(`pm-iat-close`)||(document.getElementById(`pm-bell-btn`)?.click(),i())}),setTimeout(i,6e3)}function Zt(e){return{sesion_sin_registrar:`⚠️`,recordatorio_clase:`⏰`,mensaje_admin:`📣`,tarea_vencida:`📕`,in_app:`🔔`}[e]||`🔔`}var Qt=!1;function $t(){if(Qt)return;Qt=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var en=null;function tn(){en===null&&(en=setInterval(()=>{document.visibilityState!==`hidden`&&Ht()},Ot),Dt.registerInterval(en))}function nn(){en!==null&&(clearInterval(en),en=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Ht(),tn()):nn()});function rn(){let e=wt();z=z.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}rn(),document.visibilityState!==`hidden`&&tn(),`serviceWorker`in navigator&&navigator.serviceWorker.addEventListener(`message`,e=>{if(e.data?.type===`NAVIGATE_TO`){let t=e.data.url||e.data.hash;t&&(window.location.hash=t.startsWith(`#`)?t.slice(1):t)}});var an=null,on=null;function sn(e){let t=new Date(e),n=new Date-t,r=Math.floor(n/1e3),i=Math.floor(r/60),a=Math.floor(i/60),o=Math.floor(a/24),s=new Intl.RelativeTimeFormat(`es`,{numeric:`auto`});return o>0?s.format(-o,`day`):a>0?s.format(-a,`hour`):i>0?s.format(-i,`minute`):`hace un momento`}var cn={init(){document.getElementById(`pm-notificaciones-drawer-overlay`)||(an=document.createElement(`div`),an.innerHTML=`
    ...
    `,document.body.appendChild(an),document.getElementById(`pm-notificaciones-close`).addEventListener(`click`,this.close),document.getElementById(`pm-notificaciones-drawer-overlay`).addEventListener(`click`,e=>{e.target.id===`pm-notificaciones-drawer-overlay`&&this.close()}),document.getElementById(`pm-notif-mark-all`).addEventListener(`click`,()=>{Kt()}),on=Bt(e=>{this.renderList(e)}),Ht())},_updateDedupBadge(){let e=document.getElementById(`pm-notif-dedup-badge`);if(!e)return;let t=Ft();t>0?(e.textContent=`🔄 ${t} dedup`,e.style.display=`inline-flex`):e.style.display=`none`},renderList(e){let t=document.getElementById(`pm-notificaciones-list`);if(t){if(this._updateDedupBadge(),e.length===0){t.innerHTML=`
        <div class="text-center text-muted mt-5">
          <i class="bi bi-bell-slash" style="font-size: 2rem; opacity: 0.5;"></i>
          <p class="mt-2">No tienes notificaciones recientes.</p>
        </div>
      `;return}t.innerHTML=dn(e).map(e=>{let t=e.count>1,n=e.items.some(e=>e.estado!==`leida`),r=fn(e.tipo,e.items[0]),i=e.tipo===`sesion_sin_registrar`;return`
        <div
        ...
        >
          <div class="pm-notif-icon ${un(e.tipo)}">
            <i class="bi ${ln(e.tipo)}"></i>
          </div>
          <div class="pm-notif-content">
            ...
            <div class="pm-notif-footer-row">
              <span class="pm-notif-time">${sn(e.items[0].created_at)}</span>
      ...
      `}).join(``),t.querySelectorAll(`.pm-notif-cta`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.closest(`.pm-notif-item`).dataset.ids.split(`,`).forEach(e=>Wt(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``),cn.close())})}),t.querySelectorAll(`.pm-notif-item`).forEach(e=>{e.addEventListener(`click`,t=>{if(t.target.closest(`.pm-notif-actions`)||t.target.closest(`.pm-notif-cta`))return;e.dataset.ids.split(`,`).forEach(e=>Wt(e));let n=e.dataset.route;n&&n!==`#/`&&(window.location.hash=n.replace(/^#/,``))})}),t.querySelectorAll(`.pm-notif-btn-mark`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),e.dataset.ids.split(`,`).forEach(e=>Wt(e))})}),t.querySelectorAll(`.pm-notif-btn-delete`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.dataset.ids.split(`,`);if(!confirm(`¿Estás seguro de que querés eliminar esta notificación?`))return;let r=!0;for(let e of n)(await Gt(e)).success||(r=!1);r?window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificación eliminada correctamente.`,type:`info`}})):window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Hubo un problema al eliminar la notificación.`,type:`danger`}})),Ht()})})}},open(){this.init(),this._triggerEl=document.activeElement;let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e.style.display=`block`,e.offsetHeight,e.classList.add(`open`);let t=document.querySelector(`#pm-notificaciones-drawer-overlay .pm-drawer`);t&&(this._trap&&this._trap.dispose(),this._trap=_e(t,{onClose:()=>this.close()}));let n=document.getElementById(`pm-notificaciones-close`);n&&n.focus(),this._updateDedupBadge(),Ht()},close(){this._trap&&=(this._trap.dispose(),null),on&&typeof on==`function`&&(on(),on=null);let e=document.getElementById(`pm-notificaciones-drawer-overlay`);e&&(e.classList.remove(`open`),setTimeout(()=>{e.style.display=`none`},300)),this._triggerEl&&typeof this._triggerEl.focus==`function`&&this._triggerEl.focus(),this._triggerEl=null}};function ln(e){switch(e){case`sesion_sin_registrar`:return`bi-exclamation-triangle`;case`recordatorio_clase`:return`bi-clock-history`;case`mensaje_admin`:return`bi-megaphone`;case`tarea_vencida`:return`bi-journal-x`;default:return`bi-bell`}}function un(e){switch(e){case`sesion_sin_registrar`:return`bg-danger text-white`;case`recordatorio_clase`:return`bg-warning text-dark`;case`mensaje_admin`:return`bg-primary text-white`;default:return`bg-secondary text-white`}}function dn(e){let t=new Set([`recordatorio_clase`,`in_app`]),n=[],r=new Map;for(let i of e)if(t.has(i.tipo)&&r.has(i.tipo)){let e=n[r.get(i.tipo)];e.items.push(i),e.count++}else r.set(i.tipo,n.length),n.push({tipo:i.tipo,items:[i],count:1});return n}function fn(e,t){let n=t.clase_id||t.data?.clase_id,r=t.alumno_id||t.data?.alumno_id,i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,`0`)}-${String(i.getDate()).padStart(2,`0`)}`,o=t.fecha||a;switch(e){case`sesion_sin_registrar`:case`recordatorio_clase`:return n?`#/asistencia?clase=${n}&fecha=${o}`:`#/hoy`;case`mensaje_admin`:return`#/perfil`;case`tarea_vencida`:return r?`#/alumno?id=${r}`:`#/hoy`;default:return`#/hoy`}}if(!document.getElementById(`pm-notif-styles`)){let e=document.createElement(`style`);e.id=`pm-notif-styles`,e.textContent=`
    .pm-notif-item {
      display: flex;
      gap: 1rem;
      padding: 1rem;
  ...
  `,document.head.appendChild(e)}var B=null,pn=null;function mn(e,t=`polite`){B||(B=document.createElement(`div`),B.setAttribute(`aria-live`,t),B.setAttribute(`aria-atomic`,`true`),B.classList.add(`pm-visually-hidden`),document.body.appendChild(B)),t===`assertive`?(B.setAttribute(`role`,`alert`),B.setAttribute(`aria-live`,`assertive`)):(B.removeAttribute(`role`),B.setAttribute(`aria-live`,`polite`)),clearTimeout(pn),pn=setTimeout(()=>{B.textContent=``,requestAnimationFrame(()=>{B.textContent=e})},50)}function hn(e,t){if(!e||!e.id)return;gn(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function gn(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function _n(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>gn(e))}async function vn(e,t=null){try{let n=``;t&&t.sesiones&&t.sesiones.length>0&&(n=`
...
`);let r=await je([{role:`user`,content:`
...
Sé directo, pedagógico y actionable. Responde SOLO JSON válido.`}]);try{return De(r)}catch(e){return console.error(`[ClaseAnalysis] Parse error:`,e,`| raw:`,r),null}}catch(e){return console.error(`[ClaseAnalysis] Error:`,e),null}}async function yn(e,t,n=4){try{let r=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:i}=await u.from(`sesiones_clase`).select(`id, fecha, contenido, asistencia`).eq(`clase_id`,e).gte(`fecha`,r).lte(`fecha`,t).order(`fecha`,{ascending:!1});if(!i||i.length===0)return{sesiones:[],tracking:[]};let{data:a}=await u.from(`observaciones_alumnos`).select(`id, alumno_id, contenido, created_at`).eq(`clase_id`,e).gte(`created_at`,r+`T00:00:00`),o={};a&&a.forEach(e=>{o[e.alumno_id]||(o[e.alumno_id]=[]),o[e.alumno_id].push(e.contenido)});let{data:s}=await u.from(`alumnos`).select(`id, nombre_completo`),c=Object.fromEntries((s||[]).map(e=>[e.id,e.nombre_completo]));return{sesiones:i.map(e=>{let t=Array.isArray(e.asistencia)?e.asistencia:[],n=t.filter(e=>e.estado===`P`).map(e=>e.alumno_id||e),r=t.filter(e=>e.estado===`A`).map(e=>e.alumno_id||e);return{fecha:e.fecha,contenido:e.contenido||`(sin descripción)`,totalPresentes:n.length,totalAusentes:r.length,asistentes:n.map(e=>c[e]||`Desconocido`),ausentes:r.map(e=>c[e]||`Desconocido`),detalleAlumnos:t.map(e=>({alumnoId:e.alumno_id||e,alumnoNombre:c[e.alumno_id||e]||`Desconocido`,estado:e.estado,tieneObs:o[e.alumno_id||e]?.length>0,obsPreview:o[e.alumno_id||e]?.[0]||null}))}}),alumnoMap:c,obsPorAlumno:o}}catch(e){return console.error(`[ContentTracking] Error:`,e),{sesiones:[],tracking:[],alumnoMap:{},obsPorAlumno:{}}}}async function bn(e,t,n=4){try{console.log(`[getClaseDataForAnalysis] Iniciando con claseId:`,e,`fecha:`,t,`semanas:`,n);let{data:r,error:i}=await u.from(`clases`).select(`id, nombre, instrumento`).eq(`id`,e).maybeSingle();if(console.log(`[getClaseDataForAnalysis] Clase:`,r,`Error:`,i),!r)return console.warn(`[getClaseDataForAnalysis] No se encontró clase con id:`,e),null;let{data:a}=await u.from(`inscripciones`).select(`alumno_id`).eq(`clase_id`,e),o=a?.length||0,s=new Date(new Date(t).getTime()-n*7*24*60*60*1e3).toISOString().split(`T`)[0],{data:c}=await u.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(1),l=c?.[0],d=Array.isArray(l?.asistencia)?l.asistencia.filter(e=>e.estado===`P`).length:0,f=o-d,{data:p}=await u.from(`sesiones_clase`).select(`asistencia, contenido, borrador`).eq(`clase_id`,e).gte(`fecha`,s).order(`fecha`,{ascending:!1}).limit(10),m=(p||[]).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}).length,h=(p||[]).length-m,g=p&&p.length>0?Math.round(m/p.length*100):0,_=new Date(new Date(t).getTime()-672*60*60*1e3).toISOString().split(`T`)[0],{data:v}=await u.from(`asistencias`).select(`alumno_id, estado`).eq(`clase_id`,e).gte(`fecha`,_),y={};v&&v.forEach(e=>{y[e.alumno_id]||(y[e.alumno_id]={total:0,presentes:0}),y[e.alumno_id].total++,e.estado===`P`&&y[e.alumno_id].presentes++});let b=Object.values(y).filter(e=>e.total>=3&&e.presentes/e.total<.7).length;return{id:e,nombre:r.nombre,instrumento:r.instrumento||`Sin especificar`,cumplimiento:g,totalAlumnos:o,alumnosPresentes:d,alumnosAusentes:f,registrosCompletos:m,registrosPendientes:h,alumnosEnRiesgo:b,alumnosEnRiesgoDetalle:b>0?`${b} alumno(s) con <70% asistencia`:null}}catch(e){return console.error(`[ClaseDataForAnalysis] Error:`,e),null}}async function xn(e,t=new Date().toISOString().split(`T`)[0],n=4){let r=document.createElement(`div`);r.className=`clase-analysis-backdrop`,r.innerHTML=`
  ...
  `,document.body.appendChild(r),r.querySelector(`.clase-analysis-close`).addEventListener(`click`,()=>r.remove()),r.addEventListener(`click`,e=>{e.target===r&&r.remove()});try{let[i,a]=await Promise.all([bn(e,t,n),yn(e,t,n)]);if(!i)throw Error(`No se pudo obtener datos de la clase`);let o=await vn(i,a),s=r.querySelector(`.clase-analysis-body`);o?s.innerHTML=`
    ...
    `}}function Sn(){if(document.getElementById(`clase-analysis-styles`))return;let e=document.createElement(`style`);e.id=`clase-analysis-styles`,e.textContent=`
    ...
    <div class="pm-dashboard" role="main" aria-label="Panel de métricas">
      ...
      <header class="pm-dashboard-header">
        ...
        <select id="pm-filter-periodo" class="pm-dashboard-select" aria-label="Período de análisis">
          <option value="4" ${V.periodo===4?`selected`:``}>4 semanas</option>
          <option value="8" ${V.periodo===8?`selected`:``}>8 semanas</option>
          <option value="12" ${V.periodo===12?`selected`:``}>12 semanas</option>
        </select>
      </header>
  ...
  `}function En(e){console.log(`[MetricasView.bindEvents] Iniciando bind, container:`,e),console.log(`[MetricasView.bindEvents] HTML length:`,e?.innerHTML?.length||0),e.querySelector(`#pm-filter-periodo`)?.addEventListener(`change`,async t=>{let n=parseInt(t.target.value,10);V.periodo=n,e.innerHTML=`<div class="pm-loading" style="padding:2rem;"><div class="pm-spinner"></div></div>`;try{let t=await Cn(n,V.maestroId),r=wn(t);V.clasesData=r.clasesData,V.todasSesiones=t.sesiones,V.inscripcionesPorClase=t.inscripcionesPorClase,V.alertasRiesgo=r.alertasRiesgo,e.innerHTML=Tn(r),En(e),mn(`Período actualizado a ${n} semanas. ${r.asistenciaPromedio}% de asistencia general.`)}catch(t){e.innerHTML=`<p class="pm-empty">Error al cargar datos: ${F(t.message)}</p>`}}),e.querySelectorAll(`.pm-risk-item`).forEach(e=>{let t=e.dataset.alumno,n=()=>{window.location.hash=`#/alumno?id=${t}`};e.addEventListener(`click`,n),e.addEventListener(`keypress`,e=>{e.key===`Enter`&&n()})});let t=new Date,n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`,r=V.periodo||4;e.querySelectorAll(`.pm-analisis-btn-metrics`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),t.preventDefault();let i=e.dataset.claseId;xn(i,n,r)})}),e.querySelectorAll(`.pm-class-btn, .pm-class-btn2`).forEach(e=>{e.addEventListener(`click`,async t=>{t.stopPropagation();let n=e.closest(`.pm-class-card2, .pm-class-card`),r=n.querySelector(`.pm-clase-students-panel`);if(r){r.remove();return}let i=e.dataset.claseId,a=V.clasesData.find(e=>e.id===i)?.alumnos||[],o=V.todasSesiones.filter(e=>e.clase_id===i),s=a.map(e=>{let t=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).map(t=>t.asistencia.find(t=>t.alumno_id===e.id)),n=t.filter(e=>e?.estado===`P`).length,r=t.length,i=r>0?Math.round(n/r*100):0,a=o.filter(t=>t.asistencia?.some(t=>t.alumno_id===e.id)).sort((e,t)=>t.fecha.localeCompare(e.fecha))[0];return{...e,pct:i,total:r,lastFecha:a?.fecha}});s.sort((e,t)=>e.pct-t.pct);let c=document.createElement(`div`);c.className=`pm-clase-students-panel`,c.innerHTML=`
      ...
      </div>`}}var kn=An();function An(){let e=window.innerWidth;return e<768?`mobile`:e<1024?`tablet`:`desktop`}window.addEventListener(`resize`,()=>{let e=An();e!==kn&&(kn=e,document.body.dataset.pmLayout=e)},{passive:!0});function jn(){let e=document.getElementById(`portal-app`);if(!e)return;let t=e.querySelector(`.pm-header`),n=e.querySelector(`.pm-bottom-nav`),r=e.querySelector(`.pm-view`);t&&(t.style.display=`none`),n&&(n.style.display=`none`),r&&(r.style.display=`none`)}function Mn(e){document.querySelectorAll(`.pm-nav-tab`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.pm-sidebar-link`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)})}function Nn(e,t,n,r,i){let a=t?.es_admin?`<a href="/admin" class="pm-admin-link" title="Ir al Panel Admin">
  ...
  `,document.body.appendChild(r);let i=3,a=!1,o=document.getElementById(`pm-autonav-count`),s=setInterval(()=>{a||(i--,o&&(o.textContent=i),i<=0&&(clearInterval(s),r.remove(),a||(window.router?window.router.navigate(`asistencia?clase=${e}&fecha=${t}`):n?.(e))))},1e3);document.getElementById(`pm-autonav-cancel`)?.addEventListener(`click`,()=>{a=!0,clearInterval(s),r.remove(),P.show(`Auto-navegación cancelada`,`info`)})}async function Vn(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let r=f();if(!r){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let l=new Date,u=l.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),d=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,`0`)}-${String(l.getDate()).padStart(2,`0`)}`;try{let f=await c(r.id,d);if(f&&f.length>0){e.innerHTML=Hn(f,u,l),Wn(e,d,r.id);return}let p=await n();if(!p||p.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let m=p.map(e=>e.id),h=Object.fromEntries(p.map(e=>[e.id,e])),g=(await i(m)).filter(e=>e.dia?.toLowerCase()===u).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!g||g.length===0){e.innerHTML=`
      ...
      `;return}let _=new Date(l);_.setDate(_.getDate()-3);let v=`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,`0`)}-${String(_.getDate()).padStart(2,`0`)}`,y=new Date(l);y.setDate(y.getDate()-1);let b=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,`0`)}-${String(y.getDate()).padStart(2,`0`)}`,x=(await s(r.id,v,b)||[]).filter(e=>{if(!m.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),S=(await s(r.id,d,d)).filter(e=>m.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),C=new Set(S.map(e=>e.clase_id)),w=await o(m),T={};for(let e of w||[])e.clase_id&&(T[e.clase_id]=(T[e.clase_id]||0)+1);let E=[...new Set(g.map(e=>e.salon_id).filter(Boolean))],D=E.length>0?await a(E):[],O=Object.fromEntries(D.map(e=>[e.id,e.nombre])),ee=l.getHours()*60+l.getMinutes(),k=null,A=null,j=g.map(e=>{let t=h[e.clase_id],n=C.has(t.id),r=T[t.id]||0,i=zn(e.hora_inicio,e.hora_fin,ee);i===`en-curso`&&(!n&&!k&&(k=t.id),n&&!A&&(A=t.id));let a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`,o=i===`en-curso`?`<span class="pm-badge pm-badge-en-curso"><i class="bi bi-circle-fill pm-pulse-dot me-1"></i>En curso</span>`:i===`proxima`?`<span class="pm-badge pm-badge-proxima"><i class="bi bi-clock me-1"></i>Próximamente</span>`:``;return`
        <div class="pm-clase-card ${[n?`registrada`:`sin-registrar`,i===`en-curso`?`pm-clase-en-curso`:``,i===`proxima`?`pm-clase-proxima`:``,i===`pasada`?`pm-clase-pasada`:``].filter(Boolean).join(` `)}" data-clase-id="${t.id}">
          ...
          <div class="pm-clase-meta">
            <div class="meta-item"><i class="bi bi-clock"></i> ${Ce(e.hora_inicio)} – ${Ce(e.hora_fin)}</div>
            ...
            ${e.salon_id?`<div class="meta-item"><i class="bi bi-geo-alt"></i> ${F(O[e.salon_id]||`Salón`)}</div>`:``}
          </div>
        </div>
      `}).join(``),te=x.length>0?`
    ...
    `,e.querySelectorAll(`.pm-pendiente-item`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.claseId,n=e.dataset.fecha;try{await L.createSnapshotFromPlan(t,n,r.id)}catch{}window.router&&window.router.navigate(`asistencia?clase=${t}&fecha=${n}`)})}),e.querySelectorAll(`.pm-clase-card`).forEach(e=>{let n=e.querySelector(`.pm-analisis-btn`);n?n.addEventListener(`click`,e=>{e.stopPropagation(),e.preventDefault();let t=n.dataset.claseId;console.log(`[HoyView] Abriendo análisis para clase:`,t),xn(t,d)}):console.warn(`[HoyView] No se encontró botón de análisis en card`),e.addEventListener(`click`,async()=>{if(e.classList.contains(`pm-card-loading`))return;e.classList.add(`pm-card-loading`);let n=e.dataset.claseId;try{await L.createSnapshotFromPlan(n,d,r.id)}catch(e){console.error(`Error generando snapshot:`,e)}e.classList.remove(`pm-card-loading`),t?.(n)})});let M=k||A;M&&(requestAnimationFrame(()=>{e.querySelector(`[data-clase-id="${M}"]`)?.scrollIntoView({behavior:`smooth`,block:`center`})}),k&&setTimeout(()=>{Bn(k,d,t)},800))}catch(t){e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error al cargar clases: ${F(t.message)}</p>`}}function Hn(e,t,n){let r=e.map(e=>{let t=`${e.hora_inicio?e.hora_inicio.slice(0,5):`—`} – ${e.hora_fin?e.hora_fin.slice(0,5):`—`}`,n=e.motivo||``,r=e.contenido||e.observaciones||``,i=Un(e.motivo);return`
    ...
    `}).join(``);return`
    <div style="padding: 1rem 1rem 2rem;">
      <h2 class="pm-date-header">${we(t)} ${ye(n)}</h2>
  ...
  `}function Un(e){return{suplencia:`pm-eme-motivo-suplencia`,eventual:`pm-eme-motivo-eventual`,reforzamiento:`pm-eme-motivo-reforzamiento`,otro:`pm-eme-motivo-otro`}[e]||`pm-eme-motivo-otro`}function Wn(e,t,n){e.querySelectorAll(`.pm-emergente-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.contains(`pm-card-loading`)||(e.classList.add(`pm-card-loading`),window.router&&window.router.navigate(`clase-emergente?fecha=${t}`),e.classList.remove(`pm-card-loading`))})})}if(!document.getElementById(`pm-hoy-pendientes-styles`)){let e=document.createElement(`style`);if(e.id=`pm-hoy-pendientes-styles`,!document.getElementById(`pm-badge-warning-style`)){let e=document.createElement(`style`);e.id=`pm-badge-warning-style`,e.textContent=`
        .pm-badge-warning {
          background: rgba(245,158,11,0.15);
          color: #d97706;
  ...
  `,document.head.appendChild(e)}var Gn=null,Kn=null;function qn(e={}){let{fecha:t=``,claseId:n=``,clases:r=[],alumnos:i=[],maestroId:a=null,onSave:o=null}=e;Gn=o,Kn=a,Fe.open({title:`Nueva Clase Emergente`,size:`lg`,saveText:`Crear Clase`,cancelText:`Cancelar`,body:`
    ...
    <div class="pm-calendar-wrapper">
      ...
      <div class="pm-cal-grid-container">
        <div class="pm-cal-grid" role="grid" aria-label="Calendario ${Se[n]} ${t}">
          ${g}
        </div>
      </div>
  ...
  `;let c=s.querySelectorAll(`.pm-eval-btn`),l=s.querySelector(`.pm-eval-feedback-input`),u=s.querySelector(`.pm-eval-save-status`),d=null,f=async(e=null)=>{let c=e||s.dataset.status||o;u.innerHTML=`<i class="pm-spinner-sm"></i> Guardando...`;try{let e={student_id:r,indicator_id:t.indicator_id,session_id:n,created_by:i,status:c,feedback:l.value,attempt_number:(t.attempt_number||0)+1};await L.saveIndicatorAttempt(e),u.innerHTML=`<i class="bi bi-check-all"></i> Guardado localmente`,s.className=`pm-node-eval-card status-${c}`,a&&a(e)}catch(e){console.error(`Error saving evaluation:`,e),u.innerHTML=`<i class="bi bi-exclamation-circle"></i> Error al guardar`}};c.forEach(e=>{e.onclick=()=>{let t=e.dataset.status;c.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),s.dataset.status=t,f(t)}}),l.oninput=()=>{d&&clearTimeout(d),d=setTimeout(()=>f(),1500)},e.appendChild(s)}function or(e,{student:t,sessionId:n,teacherId:r,snapshots:i=[]}){let a=document.getElementById(`pm-evaluation-drawer`);a&&a.remove();let o=document.createElement(`div`);o.id=`pm-evaluation-drawer`,o.className=`pm-drawer-overlay`,o.innerHTML=`
    <div class="pm-drawer">
      <div class="pm-drawer-header">
  ...
  `,e.appendChild(o);let s=o.querySelector(`#pm-evaluation-cards-container`);s&&i.forEach(e=>{ar(s,{indicator:e,sessionId:n,studentId:t.id,teacherId:r,onSave:e=>{console.log(`Progress saved:`,e)}})}),setTimeout(()=>o.classList.add(`open`),10);let c=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),400)},l=o.querySelector(`#pm-close-eval-drawer`),u=o.querySelector(`#pm-finish-eval`);return l&&l.addEventListener(`click`,c),o.addEventListener(`click`,e=>{e.target===o&&c()}),u&&u.addEventListener(`click`,c),{close:c}}function sr(e,{onAceptar:t}){let n=document.getElementById(`pm-generar-informe-modal`);if(!n&&(n=document.createElement(`div`),n.id=`pm-generar-informe-modal`,n.className=`pm-modal-overlay`,n.innerHTML=`
...
`,pr=class{constructor(e,t=dr){this._container=e,this._steps=t,this._step=0,this._autoTimer=null,this._overlay=null,this._spotlight=null,this._tooltip=null,this._mounted=!1,this._styleEl=null}mount(){if(!this._mounted)try{this._injectStyles(),this._injectDOM(),this._bindEvents(),this._mounted=!0,localStorage.getItem(lr)||(this._autoTimer=setTimeout(()=>this.start(),ur))}catch(e){console.error(`[AsistenciaTour] Error al montar el tour:`,e),this._mounted=!1}}start(){this._overlay&&(this._step=0,this._tooltip.style.display=`block`,this._spotlight.style.display=`block`,this._overlay.style.display=`block`,this._overlay.offsetHeight,this._overlay.style.opacity=`1`,this._showStep(0),localStorage.setItem(lr,`true`))}destroy(){this._autoTimer!==null&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._overlay&&=(this._overlay.style.transition=`none`,this._overlay.style.opacity=`0`,this._overlay.style.display=`none`,this._overlay.remove(),null),this._spotlight&&=(this._spotlight.remove(),null),this._tooltip&&=(this._tooltip.remove(),null),this._styleEl&&=(this._styleEl.remove(),null),this._mounted=!1}_injectStyles(){if(document.getElementById(`pm-tour-styles`))return;let e=document.createElement(`style`);e.id=`pm-tour-styles`,e.textContent=fr,document.head.appendChild(e),this._styleEl=e}_injectDOM(){document.getElementById(`pm-tour-overlay`)?.remove(),document.getElementById(`pm-tour-spotlight`)?.remove(),document.getElementById(`pm-tour-tooltip`)?.remove();let e=document.createElement(`div`);e.id=`pm-tour-overlay`,e.className=`pm-tour-overlay`,e.setAttribute(`role`,`dialog`),e.setAttribute(`aria-modal`,`true`),e.setAttribute(`aria-label`,`Guía interactiva`),document.body.appendChild(e),this._overlay=e;let t=document.createElement(`div`);t.id=`pm-tour-spotlight`,t.className=`pm-tour-spotlight`,t.style.display=`none`,document.body.appendChild(t),this._spotlight=t;let n=document.createElement(`div`);n.id=`pm-tour-tooltip`,n.className=`pm-tour-tooltip`,n.style.display=`none`,n.innerHTML=`
    ...
    `,document.body.appendChild(n),this._tooltip=n}_bindEvents(){if(!this._tooltip||!this._overlay){console.warn(`[AsistenciaTour] DOM no inyectado correctamente, saltando event binding`);return}this._tooltip.querySelector(`#pm-tour-next`).addEventListener(`click`,()=>this._nextStep()),this._tooltip.querySelector(`#pm-tour-skip`).addEventListener(`click`,()=>this._close()),this._onKeydown=e=>{e.key===`Escape`&&this._close()},document.addEventListener(`keydown`,this._onKeydown),this._onResize=()=>{this._overlay?.style.display!==`none`&&this._showStep(this._step)},window.addEventListener(`resize`,this._onResize,{passive:!0})}_showStep(e){let t=this._steps[e],n=this._container.querySelector(t.target);if(!n){this._nextStep();return}n.scrollIntoView({behavior:`smooth`,block:`center`}),setTimeout(()=>this._positionOnElement(n,t,e),400)}_positionOnElement(e,t,n){if(!this._spotlight||!this._tooltip){console.warn(`[AsistenciaTour] Tour no montado correctamente, abortando posicionamiento`);return}let r=e.getBoundingClientRect();this._spotlight.style.width=`${r.width+20}px`,this._spotlight.style.height=`${r.height+20}px`,this._spotlight.style.top=`${r.top-10}px`,this._spotlight.style.left=`${r.left-10}px`;let i=r.bottom+16;i+200>window.innerHeight&&(i=r.top-200-16);let a=Math.max(16,Math.min(window.innerWidth-280-16,r.left));this._tooltip.style.top=`${i}px`,this._tooltip.style.left=`${a}px`,this._tooltip.querySelector(`#pm-tour-title`).innerHTML=`<span>${t.title}</span>`,this._tooltip.querySelector(`#pm-tour-body`).textContent=t.body,this._tooltip.querySelector(`#pm-tour-progress`).textContent=`${n+1} / ${this._steps.length}`,this._tooltip.querySelector(`#pm-tour-next`).textContent=n===this._steps.length-1?`Finalizar ✓`:`Siguiente →`}_nextStep(){this._step++,this._step<this._steps.length?this._showStep(this._step):this._close()}_close(){this._overlay&&(localStorage.setItem(lr,`true`),this._onKeydown&&document.removeEventListener(`keydown`,this._onKeydown),this._onResize&&window.removeEventListener(`resize`,this._onResize),this._tooltip&&(this._tooltip.style.display=`none`),this._spotlight&&(this._spotlight.style.display=`none`),this._overlay.style.opacity=`0`,setTimeout(()=>{this._overlay&&(this._overlay.style.display=`none`)},300))}},H={alumnos:/#(todos\b|[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s+(?:de|la|las|los|del|y|el)\b)?(?:\s+[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*|[A-Za-zÁÉÍÓÚáéíóúÑñ]+)/g,contenido:/\[([^\]]+)\]/g,sugerencias:/\(([^)]+)\)/g,tareas:/\{([^}]+)\}/g,medidas:/\$([^\s$]+)/g,objetivos:/>([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,niveles:/>NIVEL-(\d{1,2})/g,nodos:/>NODO:([A-Z_]+)/g,capas:/:::CAPA:\s*([A-Z_]+)/g,calificacion:/(\d)\/(\d)/g,estados:/!(LOGRADO|EN_PROGRESO|INICIADO)\b/gi},mr={alumnos:`#0d6efd`,contenido:`#198754`,sugerencias:`#fd7e14`,tareas:`#9333ea`,medidas:`#6dd5ed`,calificacion:`#dc3545`,objetivos:`#6c757d`,niveles:`#5856d6`,nodos:`#af52de`,capas:`#ff9500`,estados:{LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}};function hr(e,t){if(!e)return[];let n=[],r,i=new RegExp(t.source,t.flags);for(;(r=i.exec(e))!==null;)if(r[1]){let e=r[1].trim();t.source.includes(`#`)&&(e=e.split(/(?=\s[#([{$>])/)[0].trim()),n.push(e)}return n}function gr(e){if(!e)return null;let t=e.match(/(\d)\/(\d)/);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2],10);return n<0||n>5||r!==5?null:{valor:n,sobre:r}}function _r(e){return{alumnos:hr(e,H.alumnos),contenido:hr(e,H.contenido),sugerencias:hr(e,H.sugerencias),tareas:hr(e,H.tareas),medidas:hr(e,H.medidas),calificacion:gr(e),objetivos:hr(e,H.objetivos),niveles:hr(e,H.niveles),nodos:hr(e,H.nodos),capas:hr(e,H.capas),estados:hr(e,H.estados).map(e=>e.toUpperCase())}}function vr(e){if(!e||typeof e!=`string`)return{alumnos:[],contenido:[],sugerencias:[],tareas:[],medidas:[],calificacion:null,objetivos:[],niveles:[],nodos:[],capas:[],estados:[],por_capas:{}};let t=e.split(/:::CAPA:/),n={};return t.length>1&&t.forEach(e=>{if(!e.trim())return;let t=e.split(`
`),r=t[0].trim().toUpperCase(),i=t.slice(1).join(`
`);r&&(n[r]=_r(i))}),{..._r(e),por_capas:n}}function yr(e){if(!e)return``;let t=br(e),n=[];function r(e){let t=`__DSL_TOKEN_${n.length}__`;return n.push({id:t,html:e}),t}t=t.replace(H.capas,(e,t)=>r(`<span class="dsl-token dsl-capa" style="background:${mr.capas}22; color:${mr.capas}; font-weight:800; padding:2px 6px; border-radius:4px">:::CAPA: ${t}</span>`)),t=t.replace(/&gt;NIVEL-(\d{1,2})/g,(e,t)=>r(`<span class="dsl-token dsl-nivel" style="color:${mr.niveles}; font-weight:700">&gt;NIVEL-${t}</span>`)),t=t.replace(/&gt;NODO:([A-Z_]+)/g,(e,t)=>r(`<span class="dsl-token dsl-nodo" style="color:${mr.nodos}; font-weight:600">&gt;NODO:${t}</span>`)),t=t.replace(/&gt;([A-Z]{1,3}(?:-[A-Za-z]+)?-[0-9]+(?:\.[0-9]+)?)/g,(e,t)=>r(`<span class="dsl-token dsl-objetivo" data-objetivo="${t}">&gt;${t}</span>`)),t=t.replace(H.alumnos,(e,t)=>r(`<span class="dsl-token dsl-alumno" data-nombre="${t}">#${t}</span>`)),t=t.replace(H.contenido,(e,t)=>r(`<span class="dsl-token dsl-contenido" data-contenido="${t}">[${t}]</span>`)),t=t.replace(H.sugerencias,(e,t)=>r(`<span class="dsl-token dsl-sugerencia" data-sugerencia="${t}">(${t})</span>`)),t=t.replace(H.tareas,(e,t)=>r(`<span class="dsl-token dsl-tarea" data-tarea="${t}">{${t}}</span>`)),t=t.replace(H.medidas,(e,t)=>r(`<span class="dsl-token dsl-medida" data-medida="${t}">$${t}</span>`)),t=t.replace(/!(LOGRADO|EN_PROGRESO|INICIADO)/gi,(e,t)=>{let n=t.toUpperCase(),i={LOGRADO:`#198754`,EN_PROGRESO:`#0d6efd`,INICIADO:`#6c757d`}[n]??`#6c757d`;return r(`<span class="dsl-token dsl-estado" style="color:${i};font-weight:700;background:${i}18;padding:1px 4px;border-radius:3px">!${n}</span>`)}),t=t.replace(H.calificacion,(e,t,n)=>r(`<span class="dsl-token dsl-calificacion" data-valor="${t}" data-sobre="${n}">${t}/${n}</span>`));for(let e=n.length-1;e>=0;e--)t=t.replace(n[e].id,n[e].html);return t}function br(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function xr(e){return!e||typeof e!=`string`||!e.trim()||/[#[({$>]/.test(e)?`dsl`:`natural`}function Sr(e){return!e||typeof e!=`string`?[]:e.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).map(e=>{let t=vr(e);return{alumnos:t.alumnos,nota:t.calificacion?t.calificacion.valor:null,observacion:t.sugerencias.length>0?t.sugerencias[0]:null,tarea:t.tareas.length>0?t.tareas[0]:null}}).filter(e=>e.alumnos.length>0)}function Cr(e,t){let n=e.filter(e=>e.alumnos.includes(`todos`)),r=e.filter(e=>!e.alumnos.includes(`todos`)),i=new Map;if(n.length>0){let e=n[n.length-1];for(let n of t)i.set(n.id,{alumno_id:n.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}for(let e of r)for(let n of e.alumnos){let r=n.toLowerCase(),a=t.filter(e=>e.nombre_completo.toLowerCase().includes(r));for(let t of a)i.set(t.id,{alumno_id:t.id,nota:e.nota,observacion:e.observacion,tarea:e.tarea})}return Array.from(i.values())}function wr(e,t){if(!e||e.length===0)return`gray`;let n=t>0&&e.length>=t,r=e.every(e=>e.nota!=null&&e.nota>=4);return n&&r?`green`:`yellow`}async function Tr(e,t,n,r,i=null){if(!r)return console.error(`[evaluationService] Error: teacherId is required for saveEvaluaciones (RLS)`),{error:{message:`teacherId is required`}};let a=n;if(i&&i.length>0){let e=new Set(i.map(e=>e.id)),t=n.length;a=n.filter(t=>e.has(t.alumno_id)),a.length<t&&console.warn(`[evaluationService] saveEvaluaciones: filtrados ${t-a.length} evaluaciones de alumnos ausentes`)}let o=a.map(n=>({session_id:e,indicator_id:t,student_id:n.alumno_id,created_by:r,nota:n.nota,observations:n.observacion,tarea:n.tarea}));try{let{data:e,error:t}=await u.from(`indicator_attempts`).upsert(o,{onConflict:`session_id,indicator_id,student_id`,ignoreDuplicates:!1});if(t)throw t;return{data:e,error:null}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[evaluationService] Offline, encolando saveEvaluaciones...`);for(let e of o)await w({tabla:`indicator_attempts`,operacion:`upsert`,payload:e});return{data:null,error:null,_offline:!0}}return{data:null,error:e}}}async function Er(e,t){let{data:n,error:r}=await u.from(`indicators`).select(`id`).eq(`node_id`,e).eq(`activo`,!0);if(r)throw r;if(!n||n.length===0)return{semaphore:`gray`,indicators:[]};let i=n.map(e=>e.id),{data:a,error:o}=await u.from(`indicator_attempts`).select(`indicator_id, student_id, nota`).in(`indicator_id`,i);if(o)throw o;let{data:s,error:c}=await u.from(`alumnos_clases`).select(`alumno_id`).eq(`clase_id`,t).eq(`activo`,!0);if(c)throw c;let l=s?s.length:0;return{semaphore:wr(a??[],l),indicators:n,totalAlumnos:l}}async function Dr(e,t,n,r=null){if(!e||!e.trim())return{modo:`error`,dslGenerado:null,evaluaciones:[],missing:[],error:`Texto vacío`};let i=xr(e);try{let t=e;i===`natural`&&(t=await Ne(e,{presentes:n.map(e=>e.nombre_completo),indicadorActivo:r}));let a=Cr(Sr(t),n),o=new Set(a.map(e=>e.alumno_id)),s=n.filter(e=>!o.has(e.id)).map(e=>e.nombre_completo);return{modo:i,dslGenerado:i===`natural`?t:null,evaluaciones:a,missing:s,textoMejorado:Or(e,a,n),error:null}}catch(e){return console.error(`[evaluationService] Error en processarEvaluacion:`,e),{modo:i,dslGenerado:null,evaluaciones:[],missing:[],textoMejorado:``,error:e.message||`Error desconocido`}}}function Or(e,t,n){let r=new Map(n.map(e=>[e.id,e.nombre_completo])),i=[];e?.trim()&&(i.push(`Texto original: "${e.trim()}"`),i.push(``)),i.push(`Evaluaciones:`);for(let e of t){let t=r.get(e.alumno_id)||`Alumno`,n=e.nota!==null&&e.nota!==void 0?`${e.nota}/5`:`—`,a=e.observacion?.trim()?e.observacion:`—`,o=e.tarea?.trim()?` | Tarea: ${e.tarea}`:``;i.push(`• ${t}: ${a} | Nota: ${n}${o}`)}return i.join(`
`)}function kr(){if(document.getElementById(`pm-student-panel-styles`))return;let e=document.createElement(`style`);e.id=`pm-student-panel-styles`,e.textContent=`
    .pm-student-panel {
  ...
  `,document.head.appendChild(e)}function U(e){let t=document.createElement(`div`);return t.textContent=e??``,t.innerHTML}function Ar(e){return e?e.split(` `).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join(``):`?`}function jr(e){return e?new Date(e).toLocaleDateString(`es-AR`,{day:`2-digit`,month:`2-digit`,year:`2-digit`}):``}function Mr(e){return e==null?{color:`gray`,icon:`⚫`,label:`Sin evaluar`}:e>=4?{color:`green`,icon:`🟢`,label:`Dominado`}:e>=2?{color:`yellow`,icon:`🟡`,label:`En progreso`}:{color:`red`,icon:`🔴`,label:`Necesita trabajo`}}async function Nr(e,t){let{data:n,error:r}=await u.from(`indicators`).select(`id, nombre, description, order_index, node_id, nodes(id, name, order_index, level_id, levels(id, name, level_number))`).eq(`nodes.route_version_id`,t).eq(`activo`,!0).order(`order_index`);if(r)throw r;let i=(n??[]).filter(e=>e.nodes!==null),{data:a,error:o}=await u.from(`indicator_attempts`).select(`id, indicator_id, nota, observations, tarea, created_at, node_id, status, session_id`).eq(`student_id`,e).order(`created_at`,{ascending:!1});if(o)throw o;let s={};for(let e of a??[])s[e.indicator_id]||(s[e.indicator_id]=[]),s[e.indicator_id].push(e);let c=i.map(e=>{let t=s[e.id]??[],n=t[0]??null,r=Mr(n?.nota??null);return{id:e.id,nombre:e.nombre||e.description||`Indicador ${e.id}`,node:e.nodes,latestNota:n?.nota??null,latestObs:n?.observations??null,latestTarea:n?.tarea??null,semColor:r.color,semIcon:r.icon,history:t}}),l=c.filter(e=>e.latestNota>=4).length,d=c.length,f=d>0?Math.round(l/d*100):0,p=new Set;return{indicatorSummaries:c.filter(e=>{if(p.has(e.id))return!1;p.add(e.id);let t=e.history.length>0,n=e.latestNota!==null&&e.latestNota!==0;return t||n}),dominados:l,total:d,avance:f,pendingTasks:c.filter(e=>e.latestTarea).map(e=>({indicadorNombre:e.nombre,tarea:e.latestTarea}))}}function Pr(e,t){return`
    <div class="pm-student-panel__header">
      <div class="pm-student-panel__avatar">${U(Ar(e.nombre_completo))}</div>
      <div>
  ...
  `}function Fr(e,t){return`
    ...
    <li class="pm-eval-timeline__item">
      <div class="pm-eval-timeline__header">
        <span class="pm-eval-timeline__date">${U(jr(e.created_at))}</span>
        <button class="pm-eval-timeline__edit" data-action="edit-eval" data-idx="${t}" data-hidx="${n}">
          <i class="bi bi-pencil"></i>
        </button>
      </div>
      <span class="pm-eval-timeline__nota">Nota: ${U(String(e.nota??`-`))}</span>
      ${e.observations?`<span class="pm-eval-timeline__detail">${U(e.observations)}</span>`:``}
      ${e.tarea?`<span class="pm-eval-timeline__detail"><strong>Tarea:</strong> ${U(e.tarea)}</span>`:``}
    </li>
  `).join(``)||`<p class="pm-empty-history">Sin evaluaciones previas</p>`}
    </ul>
  `}function Ir(e){return e.length?e.map((e,t)=>`
  ...
  `).join(``):`<p style="padding:8px">No hay indicadores en esta ruta.</p>`}function Lr(e){return e.length?`
      ...
      <ul class="pm-pending-tasks">
        ${e.map(e=>`
          <li class="pm-pending-tasks__item">
            <strong>${U(e.indicadorNombre)}:</strong> ${U(e.tarea)}
          </li>
        `).join(``)}
      </ul>
    </section>
  `:``}function Rr(e,{indicatorSummaries:t,avance:n,pendingTasks:r}){return`
    ${Pr(e,n)}
  ...
  `}function Vr({alumno:e,rutaId:t,sessionId:n,claseId:r,fecha:i,horaInicio:a}){kr();let o=document.createElement(`aside`);o.className=`pm-student-panel`,o.setAttribute(`role`,`dialog`),o.setAttribute(`aria-modal`,`false`),o.setAttribute(`aria-label`,`Progreso de ${e.nombre_completo}`),document.body.appendChild(o);let s=[],c=null;function l(){Te()===`desktop`?o.classList.add(`pm-student-panel--desktop`):o.classList.remove(`pm-student-panel--desktop`)}let d=xe(l);l();function p(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.action;if(n===`close`){_();return}if(n===`toggle-history`){let e=t.dataset.idx,n=o.querySelector(`[data-timeline="${e}"]`);if(!n)return;let r=!n.hidden;n.hidden=r,t.setAttribute(`aria-expanded`,String(!r));return}if(n===`new-eval`){let e=t.dataset.idx;m(e);return}if(n===`edit-eval`){let e=t.dataset.idx,n=t.dataset.hidx;m(e,n);return}}async function m(e,t=null){let n=s[e],r=t===null?null:n.history[t],i=r?.nota??null,a=document.createElement(`div`);a.className=`pm-student-panel__modal-overlay pm-animate-fade-in`,a.innerHTML=`
      <div class="pm-student-panel__modal-content">
        ...
        <div class="pm-student-panel__modal-body">
          ...
          <div class="pm-student-panel__modal-field">
            ...
            <textarea id="modal-obs" rows="4" style="width: 100%; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; color: #fff; padding: 12px; font-size: 0.9rem; resize: none; outline: none;" placeholder="Escribe aquí las observaciones...">${r?U(r.observations):``}</textarea>
          </div>
        </div>
    ...
    `,document.body.appendChild(a),a.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-nota]`);if(t){a.querySelectorAll(`[data-nota]`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),i=parseInt(t.dataset.nota);return}let o=e.target.closest(`[data-action]`)?.dataset.action;if(o===`modal-close`)a.remove();else if(o===`modal-save`){let e=a.querySelector(`#modal-obs`).value;await h(n.id,i,e,r?.id),a.remove()}}),a.addEventListener(`click`,e=>{e.target===a&&a.remove()})}async function h(t,n,o,s=null){try{let s=f();if(!s)throw Error(`No hay sesión de maestro activa.`);console.log(`[studentProgressPanel] Saving via RPC...`,{claseId:r,fecha:i,horaInicio:a,indicatorId:t,studentId:e.id,nota:n});let{data:c,error:l}=await u.rpc(`ensure_session_and_save_evaluation`,{p_clase_id:r,p_maestro_id:s.id,p_fecha:i,p_hora_inicio:a,p_indicator_id:t,p_student_id:e.id,p_nota:n,p_observations:(o||``).trim()});if(l)throw l;console.log(`[studentProgressPanel] Save successful. Session ID:`,c),await g()}catch(e){console.error(`[studentProgressPanel] Error during RPC save flow:`,e),alert(`Error al guardar la evaluación: `+(e.message||`Error de base de datos`))}}o.addEventListener(`click`,p),o.addEventListener(`keydown`,e=>{if(e.key===`Enter`||e.key===` `){let t=e.target.closest(`[data-action="toggle-history"]`);t&&(e.preventDefault(),t.click())}});async function g(){o.innerHTML=zr(),o.classList.add(`pm-student-panel--open`),c&&c.dispose(),c=_e(o,{onClose:()=>_()});try{let n=await Nr(e.id,t);s=n.indicatorSummaries,o.innerHTML=Rr(e,n)}catch(e){console.error(`[studentProgressPanel] Error loading progress:`,e),o.innerHTML=Br(e?.message??`Error desconocido al cargar datos.`)}}function _(){o.classList.remove(`pm-student-panel--open`),c&&=(c.dispose(),null),setTimeout(()=>{o.classList.contains(`pm-student-panel--open`)||(o.innerHTML=``,s=[])},300)}function v(){c&&=(c.dispose(),null),d(),o.removeEventListener(`click`,p),o.remove()}return{open:g,close:_,destroy:v}}var Hr={LOGRADO:{label:`LOGRADO`,cls:`ssp-estado-logrado`},EN_PROGRESO:{label:`EN_PROGRESO`,cls:`ssp-estado-en-progreso`},INICIADO:{label:`INICIADO`,cls:`ssp-estado-iniciado`},MIXTO:{label:`MIXTO`,cls:`ssp-estado-mixto`}},Ur={LOGRADO:`ssp-chip-logrado`,EN_PROGRESO:`ssp-chip-en-progreso`,INICIADO:`ssp-chip-iniciado`},Wr={LOGRADO:`LOGRADO`,EN_PROGRESO:`EN_PROGRESO`,INICIADO:`INICIADO`,MIXTO:`MIXTO`};function Gr(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Kr(e){return(e||``).trim().toLowerCase()}function qr(e){let t=new Map;for(let n of e){let e=Kr(n.contenido_dsl);if(e)if(!t.has(e))t.set(e,{contenido:n.contenido_dsl,estado:n.estado_cualitativo,alumnos:[{id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}],observaciones:n.observaciones||null,tarea:n.tarea||null});else{let r=t.get(e);r.alumnos.push({id:n.alumno_id,nombre:n.alumno_nombre||`Alumno`,estado:n.estado_cualitativo}),r.estado!==`MIXTO`&&r.estado!==n.estado_cualitativo&&(r.estado=`MIXTO`),!r.observaciones&&n.observaciones&&(r.observaciones=n.observaciones),!r.tarea&&n.tarea&&(r.tarea=n.tarea)}}return Array.from(t.values())}function Jr(){let e=null,t=[];function n(e,n){let r=[`📚 Clase ${e} — ${(()=>{try{let[e,t,r]=n.split(`-`);return`${r}/${t}/${e}`}catch{return n}})()}`];for(let e of t){let t=Wr[e.estado]||e.estado,n=e.estado===`MIXTO`?e.alumnos.map(e=>{let t=Wr[e.estado]||e.estado;return`${e.nombre} (${t})`}).join(`, `):e.alumnos.map(e=>e.nombre).join(`, `);r.push(``),r.push(`🔹 ${e.contenido} — ${t}`),r.push(`   Alumnos: ${n}`),e.tarea&&r.push(`   📝 Tarea: ${e.tarea}`)}return r.push(``,`🎯 El Sistema PC`),r.join(`
`)}function r(e,t){let n=Hr[e.estado]||Hr.EN_PROGRESO,r=e.alumnos.length,i=e.estado===`MIXTO`,a=e.alumnos.map(e=>`<span class="${i?`ssp-alumno-chip ${Ur[e.estado]||``}`:`ssp-alumno-chip`}">${Gr(e.nombre)}</span>`).join(``),o=e.observaciones?`<div class="ssp-group-obs">${Gr(e.observaciones)}</div>`:``,s=e.tarea?`<div class="ssp-group-tarea">📝 Tarea: ${Gr(e.tarea)}</div>`:``;return`
      <div class="ssp-group">
        <div class="ssp-group-header">
          <span class="ssp-group-contenido">${Gr(e.contenido)}</span>
      ...
      <div class="ssp-dialog" role="dialog" aria-modal="true" aria-label="Resumen pedagógico">
        <div class="ssp-header">
          ...
          <div>
            ...
            <div class="ssp-subtitle">${Gr(i)} · ${Gr(a)}</div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}var Xr=`soi_ruta_tema_pendiente`;function Zr(e){sessionStorage.setItem(Xr,JSON.stringify(e))}function Qr(){let e=sessionStorage.getItem(Xr);if(!e)return null;sessionStorage.removeItem(Xr);try{return JSON.parse(e)}catch{return null}}var $r=`documentos`;async function ei(e,t=`justificaciones`){let n=e.name.split(`.`).pop(),r=`${t}/${`${Date.now()}_${Math.random().toString(36).slice(2)}.${n}`}`,{data:i,error:a}=await u.storage.from($r).upload(r,e,{cacheControl:`3600`,upsert:!1});if(a)throw a;let{data:o}=u.storage.from($r).getPublicUrl(r);return o.publicUrl}async function ti({sesionId:e,alumnoId:t,claseId:n,fecha:r,motivo:i,evidenciaBase64:a,creadoPor:o},s=null){if(!e||!t||!n||!r||!i)return{error:{message:`Faltan campos requeridos`}};let c=null;if(s)try{c=await ei(s)}catch(e){console.warn(`[JustificacionService] Error subiendo evidencia a Storage:`,e)}let l={sesion_id:e,alumno_id:t,clase_id:n,fecha:r,motivo:i,evidencia_url:c||null,evidencia_base64:null,creado_por:o,estado:`pendiente`},{data:d,error:f}=await u.from(`justificaciones`).upsert([l],{onConflict:`sesion_id,alumno_id`,ignoreDuplicates:!1}).select().single();return{data:d,error:f}}async function ni(e,t){if(!e||!t)return null;let{data:n,error:r}=await u.from(`justificaciones`).select(`*`).eq(`sesion_id`,e).eq(`alumno_id`,t).single();return r&&r.code!==`PGRST116`?(console.warn(`[JustificacionService] Error obteniendo justificación:`,r),null):n||null}async function ri(e){if(!e)return{error:{message:`ID requerido`}};let{error:t}=await u.from(`justificaciones`).delete().eq(`id`,e);return{error:t}}function ii(){let e=Promise.resolve();return{run(t){if(typeof t!=`function`)throw TypeError(`asyncMutex.run expects a function`);let n=e.then(()=>t());return e=n.then(()=>{},()=>{}),n}}}function ai(e){return(e||``).toLowerCase().normalize(`NFD`).replace(/[̀-ͯ]/g,``).trim()}function oi(e,t){let n=ai(e);return t.find(e=>ai(e.nombre)===n||ai(e.nombreCorto||e.nombre.split(` `)[0])===n||n.length>=3&&ai(e.nombre).includes(n)||n.length>=3&&n.includes(ai(e.nombreCorto||e.nombre.split(` `)[0])))??null}function si(e,t){let n=[],r=[];for(let i of e){if(ai(i)===`todos`){n.push(...t);continue}let e=oi(i,t);e?n.push(e):r.push(`No se encontró el alumno: "${i}"`)}let i=new Set;return{resolved:n.filter(e=>i.has(e.id)?!1:(i.add(e.id),!0)),errors:r}}async function ci(e){if(e.length===0)return{data:[],error:null};let t=new Set,n=e.filter(e=>{let n=`${e.alumno_id}|${e.clase_id}|${e.sesion_clase_id}|${e.contenido_dsl}`;return t.has(n)?!1:(t.add(n),!0)}),{data:r,error:i}=await u.from(`progresos`).upsert(n,{onConflict:`alumno_id,clase_id,sesion_clase_id,contenido_dsl`,ignoreDuplicates:!1}).select(`id, alumno_id, contenido_dsl, estado_cualitativo`);return{data:r,error:i}}async function li({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,contenido:i,evaluaciones:a,alumnos:o}){if(!a||a.length===0||!t)return{saved:0,error:null};let s=(a||[]).flatMap(e=>{if(e.seccion&&!e.alumno_id&&o&&o.length>0){let t=Oe(e.seccion,o);return t.length===0?[]:t.map(t=>({...e,alumno_id:t.id,seccion:void 0}))}return e}).map(a=>{let o=`EN_PROGRESO`;return a.nota!==null&&a.nota!==void 0&&(o=a.nota>=4?`LOGRADO`:a.nota>=2?`EN_PROGRESO`:`INICIADO`),{alumno_id:a.alumno_id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:o,calificacion:a.nota??null,contenido_dsl:i||``,observaciones:a.observacion||null,indicadores:{tipo:`tecnica`,es_colectivo:!1,tarea:a.tarea||null},objetivo_id:null}});try{let{data:e,error:t}=await ci(s);return t?(console.error(`[Progress] saveProgressFromEvaluaciones error:`,t),{saved:0,error:t.message}):{saved:(e||[]).length,error:null}}catch(e){return console.error(`[Progress] saveProgressFromEvaluaciones exception:`,e),{saved:0,error:e.message}}}async function ui({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:i,alumnos:a}){if(!i||i.length===0)return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromAI — emergente session sin clase_id`),{saved:[],errors:[]};let o=[],s=[];for(let c of i){let{resolved:i,errors:l}=si(c.alumnos||[],a);s.push(...l);for(let a of i)o.push({alumno_id:a.id,clase_id:t,sesion_clase_id:e,maestro_id:n,fecha_evaluacion:r,evaluacion_tipo:`observacion`,estado_cualitativo:c.estado||`EN_PROGRESO`,calificacion:c.nota??null,contenido_dsl:c.contenido||``,observaciones:c.observacion||null,indicadores:{tipo:c.tipo||`otro`,es_colectivo:c.es_colectivo??!1,tarea:c.tarea||null},objetivo_id:null})}try{let{data:e,error:t}=await ci(o);if(t)throw t;return{saved:(e||[]).map(e=>({alumnoId:e.alumno_id,contenido:e.contenido_dsl,estado:e.estado_cualitativo})),errors:s}}catch(e){return console.warn(`[Progress] Error al guardar progreso:`,e.message),{saved:[],errors:[...s,e.message]}}}async function di({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,dslText:i,alumnos:a}){if(!i||!i.trim())return{saved:[],errors:[]};if(!t)return console.warn(`[Progress] Skip saveProgressFromDSL — emergente session sin clase_id`),{saved:[],errors:[]};let o=i.split(`
`),s=[];for(let e of o){let t=vr(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:ui({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function fi({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await u.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:ai(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=ai(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await u.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var pi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},mi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function W(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var hi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function gi(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=hi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function _i(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${W(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${W(n.join(`, `))}</span>`:``}}function o(e,t){let n=pi[e.estado]??pi.EN_PROGRESO,r=e.nota?` · ${W(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${W(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=hi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
        <div class="ppp-card ppp-card--alerta" data-idx="${t}">
          <div class="ppp-card-header">
            <span class="ppp-alerta-badge">${n.icon} ${W(n.label===`conducta`?`Conducta`:n.label===`atención`?`Atención pedagógica`:`Riesgo pedagógico`)}</span>
          ...
          <div class="ppp-card-body">
            <span class="ppp-contenido ppp-contenido--alerta">${W(e.contenido)||`—`}</span>
          </div>
          ${e.observacion?`<div class="ppp-obs ppp-obs--alerta">${W(e.observacion)}</div>`:``}
          ${i}
        </div>
      `}return`
      <div class="ppp-card" data-idx="${t}">
        <div class="ppp-card-header">
          ${s||`<span class="ppp-alumnos">${W((e.alumnos||[]).join(`, `))}</span>`}
          <button class="ppp-remove" data-idx="${t}" title="Quitar este registro">✕</button>
        </div>
        <div class="ppp-card-body">
          <span class="ppp-contenido">${W(e.contenido)||`—`}</span>
        ...
        ${e.observacion?`<div class="ppp-obs">${W(e.observacion)}</div>`:``}
        ${i}
      </div>
    `}function s(e){if(!i)return;let a=r.length>0,c=r.filter(e=>e.alerta),u=c.length>0?`<div class="ppp-alert-banner">⚠️ ${gi(c)}</div>`:``,d=Ae(r),f=d.length>0?`
      <div class="ppp-clarification-banner">
        ...
        <div class="ppp-clarification-body">
          ${d.map(e=>`<div class="ppp-clarification-item">• ${W(e.reason)}</div>`).join(``)}
        </div>
    ...
    `:``;i.innerHTML=`
      <div class="ppp-header">
        ...
        <div class="ppp-header-text">
          ...
          ${e?`<div class="ppp-resumen">${W(e)}</div>`:``}
        </div>
      </div>
      ${u}
      ${f}
    ...
    `,vi(),i.querySelectorAll(`.ppp-remove`).forEach(t=>{t.onclick=()=>{r.splice(parseInt(t.dataset.idx),1),s(e)}}),i.querySelectorAll(`.ppp-estado-btn`).forEach(t=>{t.onclick=()=>{let n=parseInt(t.dataset.idx),i=r[n].estado,a=(mi.indexOf(i)+1)%mi.length;r[n].estado=mi[a],s(e)}}),i.querySelector(`#ppp-confirm`).onclick=()=>{t([...r]),l()},i.querySelector(`#ppp-cancel`).onclick=()=>{n&&n(),l()}}function c({progreso:t=[],resumen:n=``}){r=t.map(e=>({...e})),i||(i=document.createElement(`div`),i.className=`pm-progress-preview`,e.appendChild(i)),i.style.display=`block`,s(n),setTimeout(()=>i.scrollIntoView({behavior:`smooth`,block:`start`}),80)}function l(){i&&(i.style.display=`none`,i.innerHTML=``)}return{open:c,close:l}}function vi(){if(document.getElementById(`ppp-alert-styles`))return;let e=document.createElement(`style`);e.id=`ppp-alert-styles`,e.textContent=`
    /* ── Alert banner ────────────────────────────────────────── */
    .ppp-alert-banner {
      margin: 0 0 0.5rem 0;
      padding: 0.5rem 0.75rem;
  ...
  `,document.head.appendChild(e)}async function yi(e,t=12){let n=new Date;n.setDate(n.getDate()-t*7);let r=n.toISOString().split(`T`)[0],{data:i,error:a}=await u.from(`progresos`).select(`
    ...
    `}function s(e,t){let n=bi[e.tipo]??bi.otro,r=(e.objetivos||[]).map((e,n)=>o(e,t,n)).join(``);return`
    ...
    `}function c(){return a?.querySelector(`#cpp-instrumento`)?.value?.trim()||``}function l(){return a?.querySelector(`#cpp-nivel`)?.value?.trim()||``}function u(){return!c()||r.length===0?!1:r.every(e=>(e.objetivos||[]).length>0)}function d(e,o){if(!a)return;let f=r.length>0;a.innerHTML=`
      <div class="cpp-header">
        ...
        <div class="cpp-header-text">
          ...
          ${i?`<div class="cpp-resumen">${Si(i)}</div>`:``}
        </div>
      </div>
      ...
      <div class="cpp-footer">
        <div class="cpp-fields">
          <label class="cpp-field-label">Instrumento
            <input type="text" id="cpp-instrumento" class="cpp-input" value="${Si(e)}" placeholder="ej. Violín" />
          </label>
          <label class="cpp-field-label">Nivel
            <input type="text" id="cpp-nivel" class="cpp-input" value="${Si(o)}" placeholder="ej. Básico" />
          </label>
        </div>
...
[Texto truncado — el reporte completo excede el límite de caracteres]`;AppToast.warn(`El texto se truncó (${t.length} caracteres, máximo ${n}). Usá la opción PDF para ver el reporte completo.`),window.open(e+encodeURIComponent(r),`_blank`)}else window.open(e+encodeURIComponent(t),`_blank`)}function Oi(e,t){let{clase:n,horario:r,salonNombre:i,fechaHoy:a,totalAlumnos:o,hasConflict:s,onBack:c}=t,l=[];function u(e,t,n){e.addEventListener(t,n),l.push(()=>e.removeEventListener(t,n))}e.innerHTML=`
    ...
    <div class="pm-asist-header">
      ...
      <div style="flex:1">
        <h2 class="pm-asist-title">${F(n.nombre)}</h2>
        <p class="pm-asist-subtitle">
          ${i?`📍 ${F(i)} · `:``}
          ${r?`${Ce(r.hora_inicio)} – ${Ce(r.hora_fin)} · `:``}
          <span style="color:var(--pm-primary); font-weight:700;">${ye(new Date(a+`T12:00:00`))}</span> · 
          ${o} alumnos
        </p>
      </div>
  ...
  `,await Fi()}async function Ni(e,t,n,r){Fe.open({title:`Editar ${e}`,body:`
    ...
    `,onSave:async r=>{let i=r.querySelector(`#new-item-content`).value.trim();if(!i)return!1;try{switch(e){case`Clase`:{let e=f();await G.addClass(i,e?e.id:null);break}case`Nivel`:await G.addLevel({clase_id:t,nombre:i,numero_nivel:1});break;case`Tema`:await G.addNode({nivel_id:t,nombre:i,tipo:`TECNICA`});break;case`Objetivo`:await G.addObjective({tema_id:t,nombre:i});break;case`Indicador`:await G.addIndicator({objetivo_id:t,descripcion:i,es_requerido:!0});break}return n(),!0}catch(e){return console.error(`Error adding item:`,e),alert(`No se pudo crear: `+(e.message||`Error de base de datos`)),!1}}})}async function Fi(){let e=document.getElementById(`pm-rc-classes-wrapper`),t=f(),n=await G.getClasses(t?t.id:null);!n.some(e=>e.id===K.activeClassId)&&n.length>0?K.activeClassId=n[0].id:n.length===0&&(K.activeClassId=null),e.innerHTML=`
  ...
  `,e.querySelector(`#btn-add-class`).onclick=()=>Pi(`Clase`,null,()=>Fi()),K.activeClassId?Ii(K.activeClassId):Hi(`#pm-rc-levels-wrapper`,`Elegí Clase`),e.querySelectorAll(`.pm-rc-item`).forEach(e=>{let t=e.dataset.id;e.querySelector(`.btn-edit`).onclick=n=>{n.stopPropagation(),Ni(`Clase`,t,e.querySelector(`.pm-rc-item-text`).innerText,()=>Fi())},e.onclick=()=>{K.activeClassId=t,K.activeLevelId=K.activeNodeId=K.activeObjectiveId=null,Fi(),Ii(t),Hi(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),Hi(`#pm-rc-objs-wrapper`,`Elegí Tema`),Hi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ii(e){let t=document.getElementById(`pm-rc-levels-wrapper`),n=await G.getLevelsByClass(e);!n.some(e=>e.id===K.activeLevelId)&&n.length>0?K.activeLevelId=n[0].id:n.length===0&&(K.activeLevelId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>2. Nivel</h4> 
  ...
  `,t.querySelector(`#btn-add-level`).onclick=()=>Pi(`Nivel`,e,()=>Ii(e)),K.activeLevelId?Li(K.activeLevelId):Hi(`#pm-rc-nodes-wrapper`,`Elegí Nivel`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Ni(`Nivel`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ii(e))},t.onclick=()=>{K.activeLevelId=n,K.activeNodeId=K.activeObjectiveId=null,Ii(e),Li(n),Hi(`#pm-rc-objs-wrapper`,`Elegí Tema`),Hi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Li(e){let t=document.getElementById(`pm-rc-nodes-wrapper`),n=await G.getNodesByLevel(e);!n.some(e=>e.id===K.activeNodeId)&&n.length>0?K.activeNodeId=n[0].id:n.length===0&&(K.activeNodeId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>3. Tema</h4> 
  ...
  `,t.querySelector(`#btn-add-node`).onclick=()=>Pi(`Tema`,e,()=>Li(e)),K.activeNodeId?Ri(K.activeNodeId):Hi(`#pm-rc-objs-wrapper`,`Elegí Tema`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Ni(`Tema`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Li(e))},t.onclick=()=>{K.activeNodeId=n,K.activeObjectiveId=null,Li(e),Ri(n),Hi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`)}})}async function Ri(e){let t=document.getElementById(`pm-rc-objs-wrapper`),n=await G.getObjectivesByNode(e);!n.some(e=>e.id===K.activeObjectiveId)&&n.length>0?K.activeObjectiveId=n[0].id:n.length===0&&(K.activeObjectiveId=null),t.innerHTML=`
    <div class="pm-rc-header">
      <h4>4. Objetivo</h4> 
  ...
  `,t.querySelector(`#btn-add-obj`).onclick=()=>Pi(`Objetivo`,e,()=>Ri(e)),K.activeObjectiveId?Vi(K.activeObjectiveId):Hi(`#pm-rc-inds-wrapper`,`Elegí Objetivo`),t.querySelectorAll(`.pm-rc-item`).forEach(t=>{let n=t.dataset.id;t.querySelector(`.btn-edit`).onclick=r=>{r.stopPropagation(),Ni(`Objetivo`,n,t.querySelector(`.pm-rc-item-text`).innerText,()=>Ri(e))},t.onclick=()=>{K.activeObjectiveId=n,Ri(e),Vi(n)}})}var zi={0:`Sin eval.`,1:`Inicial`,2:`En desarrollo`,3:`Logrado`,4:`Destacado`,5:`Superado`},Bi={0:`var(--pm-text-muted)`,1:`#ef4444`,2:`#f97316`,3:`#22c55e`,4:`#06b6d4`,5:`#8b5cf6`};async function Vi(e){let t=document.getElementById(`pm-rc-inds-wrapper`);t.innerHTML=`
    <div class="pm-rc-header">
      <h4>5. Indicador</h4> 
      ...
      ${(await G.getIndicatorsByObjective(e)).map(e=>`
        <div class="pm-rc-ind-card" style="position:relative;flex-direction:column;gap:0.5rem;">
          <div style="display:flex;align-items:flex-start;gap:0.6rem;width:100%;">
            ...
            <span class="ind-text" style="flex:1;">${F(e.descripcion)}</span>
          ...
          <div class="pm-rc-calif-row" style="display:flex;gap:4px;padding-left:1.6rem;" data-indicator-id="${e.id}">
            ${[1,2,3,4,5].map(t=>`
              <button class="pm-rc-calif-btn" data-calif="${t}" style="
                width:28px;height:28px;border-radius:50%;border:2px solid ${Bi[t]};
                background:${e.calificacion===t?Bi[t]:`transparent`};
                color:${e.calificacion===t?`#fff`:Bi[t]};
            ...
            `:``}
            <span style="font-size:0.6rem;color:${Bi[e.calificacion]||`var(--pm-text-muted)`};margin-left:auto;align-self:center;font-weight:600;">
              ${zi[e.calificacion]||zi[0]}
            </span>
          </div>
        </div>
      `).join(``)}
    </div>
  `,t.querySelector(`#btn-add-ind`).onclick=()=>Pi(`Indicador`,e,()=>Vi(e)),t.querySelectorAll(`.btn-edit-ind`).forEach(t=>{t.onclick=n=>{n.stopPropagation();let r=t.dataset.id,i=t.closest(`.pm-rc-ind-card`).querySelector(`.ind-text`).innerText;Ni(`Indicador`,r,i,()=>Vi(e))}}),t.querySelectorAll(`.pm-rc-calif-btn, .pm-rc-calif-clear`).forEach(t=>{t.onclick=async n=>{n.stopPropagation();let r=t.closest(`.pm-rc-calif-row`).dataset.indicatorId,i=parseInt(t.dataset.calif,10);try{await G.updateIndicatorCalificacion(r,i),Vi(e)}catch(e){console.error(`Error updating calificacion:`,e)}}})}function Hi(e,t){let n=document.querySelector(e);n&&(n.innerHTML=`<div class="pm-rc-empty">${t}</div>`)}function Ui(e,t){let r=null,i=null,a=[],o=e.querySelector(`#pm-planificacion-card`),s=e.querySelector(`#pm-planificacion-dropdown`),c=e.querySelector(`#pm-planificacion-nombre`),l=e.querySelector(`#pm-plan-list-rutas`),u=e.querySelector(`#pm-plan-list-planificaciones`),d=e.querySelector(`#pm-planificacion-header`),f=e.querySelector(`#btn-copy-as-plan`);d&&d.addEventListener(`click`,()=>{let e=o.classList.toggle(`open`);s.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;l.style.display=n===`rutas`?``:`none`,u.style.display=n===`planificaciones`?``:`none`})});function p(n){r=n.id,localStorage.setItem(`pm_default_plan_${t.claseId}`,n.id),c&&(c.textContent=n.nombre||n.name||`Sin nombre`),u.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===n.id)}),h();let l=e.querySelector(`#pm-route-tree-container`),d=e.querySelector(`#pm-active-tema-badge`);r&&l&&(l.innerHTML=``,Wi(t.claseId).then(e=>{i=ji(l,{claseId:t.claseId,rutaId:r,completedTopics:e,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e),d&&(d.textContent=e.nombre,d.style.display=`inline-block`),o.classList.remove(`open`),s.style.display=`none`}}),a.push(()=>i.destroy())}))}let m=e.querySelector(`#btn-manage-planning`);m&&(m.onclick=e=>{if(e.stopPropagation(),!r){Fe.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Fe.open({title:`Gestionar Estructura: ${c.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(i&&i.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Mi(t,r)}),o&&(async()=>{try{let e=await G.getClasses(t.maestro?t.maestro.id:null),n=localStorage.getItem(`pm_default_plan_${t.claseId}`),r=(t.clase.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===n)return!0;let t=(e.nombre||``).toLowerCase();return r.some(e=>t.includes(e))});l&&(l.innerHTML=i.length?i.map(e=>`
            ...
            </div>`).join(``),u.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&p(n)})})),o.style.display=``;let a=e.find(e=>e.id===n)||i[0]||await G.resolveSmartPlan(t.clase);a&&p(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})(),f&&f.addEventListener(`click`,async()=>{let e=t.getDslContent();me(`create`,null,await n(),[],{clase_id:t.claseId,maestro_id:t.maestro?.id||null,maestro_nombre:t.maestro?.nombre_completo||null,contenido:e||``,fecha_inicio:t.fechaHoy},async e=>{try{await Ie({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),P.error(`Error al guardar la planificación: `+(e.message||e))}})}),t.rutaId&&(i=ji(e.querySelector(`#pm-route-tree-container`),{claseId:t.claseId,rutaId:t.rutaId,onIndicadorSelect:e=>{t.onIndicadorSelect?.(e)}}),a.push(()=>i.destroy()));function h(){i&&=(i.destroy(),null)}function g(){h(),a.forEach(e=>{try{e()}catch{}}),a.length=0}return{destroy:g,getActiveIndicador:()=>i?.getActiveIndicador()||null,refreshTree:async()=>{i&&await i.refresh()},getActivePlanificacionId:()=>r}}async function Wi(e){try{let{data:t}=await u.from(`sesiones_clase`).select(`contenido`).eq(`clase_id`,e).not(`contenido`,`is`,null);if(!t)return[];let n=new Set,r=/\[(.*?)\]/g;return t.forEach(e=>{if(!e.contenido)return;let t;for(;(t=r.exec(e.contenido))!==null;)t[1]&&n.add(t[1].trim())}),Array.from(n)}catch(e){return console.warn(`[asistencia] Error calculando progreso histórico:`,e),[]}}var q=null,Gi=[],Ki=null,J=-1,qi=!1,Ji=null,Yi=!1,Xi=0,Zi=0;function Qi(){if(!q){if(q=document.createElement(`div`),q.id=`pm-autocomplete-popup`,q.className=`pm-autocomplete-popup`,q.style.cssText=`
    position: fixed;
    display: none;
    background: var(--pm-surface, #fff);
  ...
  `,!document.getElementById(`pm-ac-styles`)){let e=document.createElement(`style`);e.id=`pm-ac-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}document.body.appendChild(q)}}function $i(e,t,n={}){if(Qi(),Gi=e||[],Ki=t,Ji=n.trigger||null,J=-1,qi=!0,aa(e),n.position){let e=n.position,t=window.innerWidth,r=window.innerHeight,i=e.x,a=e.y+6;i+320>t-20&&(i=Math.max(10,e.x-320-10)),a+280>r-20&&(a=Math.max(10,e.y-280-10)),q.style.left=`${i}px`,q.style.top=`${a}px`}q.onmousedown=ea,document.addEventListener(`mousemove`,ta),document.addEventListener(`mouseup`,na),q.style.display=`block`}function ea(e){e.target.closest(`.pm-ac-option`)||(Yi=!0,Xi=e.clientX-q.offsetLeft,Zi=e.clientY-q.offsetTop,q.style.cursor=`grabbing`,q.style.transition=`none`)}function ta(e){if(!Yi)return;let t=e.clientX-Xi,n=e.clientY-Zi;q.style.left=`${Math.max(0,t)}px`,q.style.top=`${Math.max(0,n)}px`}function na(){Yi&&(Yi=!1,q.style.cursor=``)}function ra(){q&&(q.style.display=`none`,Yi=!1,document.removeEventListener(`mousemove`,ta),document.removeEventListener(`mouseup`,na)),Gi=[],Ki=null,J=-1,qi=!1,Ji=null}function ia(e){Gi=e||[],J=-1,aa(e)}function aa(e){if(!q)return;if(!e||e.length===0){q.innerHTML=`
      <div class="pm-ac-empty">
        <span>No hay opciones disponibles</span>
      </div>
    `;return}let t=`<div class="pm-ac-header">${la(Ji)}</div>`;e.forEach((e,n)=>{let r=e.nombre||e.name||e.label||e.description||``,i=e.instrumento||e.descripcion||e.codigo||e.type||``,a=n===J,o=ua(Ji,e),s=e.is_historial?`<span class="pm-ac-badge">Reciente</span>`:``;t+=`
      <div class="pm-ac-option ${a?`selected`:``}" data-index="${n}">
        <div class="pm-ac-icon">${o}</div>
        <div class="pm-ac-text">
          <div class="pm-ac-label">${fa(r)}</div>
          ${i?`<div class="pm-ac-sublabel">${fa(i)}</div>`:``}
        </div>
        ${s}
      </div>
    `}),q.innerHTML=t,q.querySelectorAll(`.pm-ac-option`).forEach(e=>{e.addEventListener(`click`,()=>{oa(parseInt(e.dataset.index,10))})})}function oa(e){if(e>=0&&e<Gi.length){let t=Gi[e];Ki&&Ki(t),ra()}}function sa(e){if(!(!qi||Gi.length===0))switch(e.key){case`ArrowDown`:e.preventDefault(),J=Math.min(J+1,Gi.length-1),aa(Gi),ca();break;case`ArrowUp`:e.preventDefault(),J=Math.max(J-1,0),aa(Gi),ca();break;case`Enter`:e.preventDefault(),J>=0?oa(J):Gi.length>0&&oa(0);break;case`Escape`:e.preventDefault(),ra();break;case`Tab`:Gi.length>0&&J===-1&&(e.preventDefault(),oa(0));break}}function ca(){if(!q||J<0)return;let e=q.querySelector(`.pm-ac-option[data-index="${J}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function la(e){switch(e){case`#`:return`👤 Alumnos`;case`[`:return`📚 Contenidos`;case`(`:return`💡 Sugerencias`;case`{`:return`📝 Tareas`;case`$`:return`🎯 Medidas`;case`>`:return`🎓 Objetivos`;default:return`Opciones`}}function ua(e,t){if(e===`#`){let e=t.nombre||t.name||``;return t.value===`todos`||e.toLowerCase()===`todos`?`👥`:e.charAt(0).toUpperCase()}return e===`$`?`🎯`:e===`>`&&t.level_number?t.level_number:e===`>`&&t.type?da(t.type):`•`}function da(e){return{ESCALA:`🎼`,ARPEGIO:`🎹`,MANO_IZQ:`✋`,ARCO:`🎻`,SONIDO:`🔊`,AFINACION:`🎵`,TECNICA:`⚙️`,REPERTORIO:`📖`}[e]||`•`}function fa(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function pa(){let e=window.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).getBoundingClientRect();return{x:t.left,y:t.bottom}}function ma(){return qi}function ha(){return J}var ga={show:$i,hide:ra,updateOptions:ia,handleKeyDown:sa,getCursorPosition:pa,isOpen:ma,getSelectedIndex:ha},_a=`portal-maestros-catalogs`,va=1,ya={alumnos:{ttl:1440*60*1e3},contenidos:{ttl:10080*60*1e3},medidas:{ttl:720*60*60*1e3},sugerencias:{ttl:720*60*60*1e3},tareas:{ttl:720*60*60*1e3},nodos:{ttl:10080*60*1e3},niveles:{ttl:10080*60*1e3},indicadores:{ttl:10080*60*1e3},historial:{ttl:null}},ba=null;async function Y(){return ba||(ba=await b(_a,va,{upgrade(e){for(let[t,n]of Object.entries(ya))if(!e.objectStoreNames.contains(t)){let n=e.createObjectStore(t,{keyPath:`id`});n.createIndex(`by_updated`,`updated_at`),t===`alumnos`&&n.createIndex(`by_clase`,`clase_id`)}}}),ba)}async function xa(e,t){let n=await Y(),r=await n.get(e,t);if(!r)return null;let i=ya[e];if(i?.ttl&&r.updated_at){let a=new Date(r.updated_at).getTime()+i.ttl;if(Date.now()>a)return await n.delete(e,t),null}return r}async function Sa(e){let t=await(await Y()).getAll(e),n=ya[e];if(!n?.ttl)return t;let r=Date.now();return t.filter(e=>e.updated_at?r<=new Date(e.updated_at).getTime()+n.ttl:!0)}async function Ca(e,t,n){return(await Y()).getAllFromIndex(e,t,n)}async function wa(e,t){let n=await Y(),r={...t,updated_at:new Date().toISOString()};return await n.put(e,r),r}async function Ta(e,t){let n=(await Y()).transaction(e,`readwrite`);for(let e of t)await n.store.put({...e,updated_at:new Date().toISOString()});await n.done}async function Ea(e,t){await(await Y()).delete(e,t)}async function Da(e){await(await Y()).clear(e)}async function Oa(e){let t=await Y(),n=ya[e];if(!n?.ttl)return;let r=await t.getAll(e),i=Date.now();for(let a of r)a.updated_at&&i>new Date(a.updated_at).getTime()+n.ttl&&await t.delete(e,a.id)}async function ka(){let e=await Y();for(let t of Object.keys(ya))await e.clear(t)}async function Aa(e){return(await Sa(e)).length}async function ja(e,t){let n=await Y(),r=new Date().toISOString(),i=await n.get(`historial`,e);i?(i.count=(i.count||0)+1,i.last_used=r,i.recent_selections=[t,...(i.recent_selections||[]).slice(0,9)],await n.put(`historial`,i)):await n.put(`historial`,{id:e,trigger:e,count:1,last_used:r,recent_selections:[t],updated_at:r})}async function Ma(e){return(await Y()).get(`historial`,e)}async function Na(e,t=5){return(await(await Y()).getAll(`historial`)).filter(t=>t.trigger===e).sort((e,t)=>(t.count||0)-(e.count||0)).slice(0,t)}var X={get:xa,getAll:Sa,getByIndex:Ca,set:wa,setBulk:Ta,remove:Ea,clear:Da,cleanExpired:Oa,clearAll:ka,getStoreSize:Aa,addToHistorial:ja,getHistorial:Ma,getTopUsed:Na};async function Pa(e){if(!e)return[];try{let{data:t,error:n}=await u.from(`alumnos_clases`).select(`alumno_id, alumnos(id, nombre_completo, instrumento_principal)`).eq(`clase_id`,e).eq(`activo`,!0);if(n)throw n;if(t)return t.map(e=>e.alumnos).filter(Boolean).map(e=>({id:e.id,nombre:e.nombre_completo||``,instrumento:e.instrumento_principal}))}catch(e){console.warn(`[CatalogService] Error cargando alumnos:`,e)}return[]}async function Fa(){let e=await X.getAll(`contenidos`);if(e.length>0)return e;try{let{data:e,error:t}=await u.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`contenidos`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`contenidos`,e),e}catch(e){console.warn(`[CatalogService] Error cargando contenidos:`,e)}return[]}async function Ia(){let e=await X.getAll(`medidas`);if(e.length>0)return e;try{let{data:e,error:t}=await u.from(`catalogos`).select(`id, nombre, codigo, categoria`).eq(`tipo`,`medidas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`medidas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando medidas:`,e)}return[]}async function La(){let e=await X.getAll(`sugerencias`);if(e.length>0)return e;try{let{data:e,error:t}=await u.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`sugerencias`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`sugerencias`,e),e}catch(e){console.warn(`[CatalogService] Error cargando sugerencias:`,e)}return[]}async function Ra(){let e=await X.getAll(`tareas`);if(e.length>0)return e;try{let{data:e,error:t}=await u.from(`catalogos`).select(`id, nombre, descripcion`).eq(`tipo`,`tareas`).eq(`activo`,!0).order(`orden`,{ascending:!0});if(t)throw t;if(e)return await X.setBulk(`tareas`,e),e}catch(e){console.warn(`[CatalogService] Error cargando tareas:`,e)}return[]}async function za(){let e=await X.getAll(`niveles`);if(e.length>0)return e;try{let{data:e}=await u.from(`routes`).select(`id`).eq(`instrument`,`violín`).eq(`status`,`published`).limit(1);if(!e||e.length===0)return[];let t=e[0].id,{data:n}=await u.from(`route_versions`).select(`id`).eq(`route_id`,t).eq(`status`,`published`).order(`version`,{ascending:!1}).limit(1);if(!n||n.length===0)return[];let r=n[0].id,{data:i,error:a}=await u.from(`levels`).select(`id, level_number, name, main_objective`).eq(`route_version_id`,r).order(`level_number`,{ascending:!0});if(a)throw a;if(i)return await X.setBulk(`niveles`,i),i}catch(e){console.warn(`[CatalogService] Error cargando niveles:`,e)}return[]}async function Ba(e=null){let t=await X.getAll(`nodos`);if(e&&t.length>0){if(t=t.filter(t=>t.level_id===e),t.length>0)return t}else if(t.length>0)return t;try{let t=u.from(`nodes`).select(`id, name, type, is_critical, is_required, objective, level_id, order_index`);e&&(t=t.eq(`level_id`,e));let{data:n,error:r}=await t.order(`order_index`,{ascending:!0});if(r)throw r;if(n)return await X.setBulk(`nodos`,n),n}catch(e){console.warn(`[CatalogService] Error cargando nodos:`,e)}return[]}async function Va(e,t=``,n={}){let r=[];switch(e){case`#`:r=[{label:`todos`,value:`todos`,icon:`👥`,description:`Todos los presentes`}],r=r.concat(await Pa(n.claseId));break;case`[`:r=await Fa();break;case`(`:r=await La();break;case`{`:r=await Ra();break;case`$`:r=await Ia();break;case`>`:r=t.toUpperCase().startsWith(`NIVEL`)?await za():await Ba(n.nivelId);break;default:r=[]}if(t&&r.length>0&&(r=Ha(r,t)),e&&e!==`#`){let t=(await X.getTopUsed(e,3)).flatMap(e=>e.recent_selections||[]).filter(Boolean).slice(0,3);for(let e of t)r.some(t=>(t.nombre||t.name||``).toLowerCase()===e.toLowerCase())||r.unshift({nombre:e,id:`hist-${e}`,is_historial:!0})}return r}function Ha(e,t,n=`nombre`){if(!t)return e;let r=t.toLowerCase(),i=r.length;return e.map(e=>{let t=(e[n]||e.name||e.nombre||``).toLowerCase(),a=0;if(t.startsWith(r))a+=10;else if(t.includes(r))a+=5;else{let e=Ua(t,r);if(e<=2&&i>3)a+=3-e;else return null}return t.length<20&&(a+=1),{...e,_score:a}}).filter(Boolean).sort((e,t)=>(t._score||0)-(e._score||0)).slice(0,15)}function Ua(e,t){let n=[];for(let e=0;e<=t.length;e++)n[e]=[e];for(let t=0;t<=e.length;t++)n[0][t]=t;for(let r=1;r<=t.length;r++)for(let i=1;i<=e.length;i++)t.charAt(r-1)===e.charAt(i-1)?n[r][i]=n[r-1][i-1]:n[r][i]=Math.min(n[r-1][i-1]+1,n[r][i-1]+1,n[r-1][i]+1);return n[t.length][e.length]}async function Wa(e,t){await X.addToHistorial(e,t)}var Ga=`
...
`;function Ka(e,{initialContent:t=``,onChange:n,onAlumnosNeeded:r}){let i=t,a=!1,o=!1,s={};e.innerHTML=`
    <div class="pm-dsl-editor-container">
      <div
        ...
        spellcheck="false"
      ></div>
      <div class="pm-dsl-placeholder" id="pm-dsl-placeholder">${Ga}</div>
  ...
  `,!document.getElementById(`pm-dsl-toolbar-styles`)){let e=document.createElement(`style`);e.id=`pm-dsl-toolbar-styles`,e.textContent=`
    ...
    `,document.head.appendChild(e)}e.querySelector(`#btn-snippets`).onclick=()=>{h.style.display===`block`?_():g()};let v=Xa(e);return e.querySelector(`#btn-help`).onclick=()=>{v.open()},{setContext(e={}){e.presentes!==void 0&&(l.presentes=e.presentes),e.indicadorActivo!==void 0&&(l.indicadorActivo=e.indicadorActivo),e.indicadoresDisponibles!==void 0&&(l.indicadoresDisponibles=e.indicadoresDisponibles)}}}function Qa(e,t){let n=e.querySelector(`#pm-dsl-toolbar-container`),r=e.querySelector(`#pm-dsl-editor-container`),i=null,a=Ka(r,{initialContent:t.initialContent||``,onChange:e=>{t.onEditorChange?.(e)}});a.setContext({claseId:t.claseId});function o(e){i=Za(n,{onInsert:(e,t,n)=>a.insertText(e,t,n),getEditorContent:()=>a.getValue(),onLoading:()=>{},onIaProposal:t=>e.onIaProposal?.(t),onImproveClick:t=>e.onImproveClick?.(t),onStructureClick:t=>e.onStructureClick?.(t),onAnalyzeClick:t=>e.onAnalyzeClick?.(t)})}function s(){i&&i.destroy(),a.destroy()}return{getEditor:()=>a,getToolbar:()=>i,getValue:()=>a.getValue(),setValue:e=>a.setValue(e),setContext:e=>a.setContext(e),initToolbar:o,destroy:s}}function $a(e,{onMarkAll:t}){if(!t)return{destroy(){}};let n=e.querySelector(`#btn-bulk-p`),r=e.querySelector(`#btn-bulk-a`),i=[];function a(e,t,n){e&&(e.addEventListener(t,n),i.push(()=>e.removeEventListener(t,n)))}return a(n,`click`,e=>{e.preventDefault(),t(`P`)}),a(r,`click`,e=>{e.preventDefault(),t(`A`)}),{destroy(){i.forEach(e=>{try{e()}catch{}}),i.length=0}}}function eo({saveFn:e,debounceMs:t=3e4}){let n=null,r=[];function i(i){n!==null&&(clearTimeout(n),n=null),!(!i||!i.trim())&&(n=setTimeout(async()=>{n=null,await e(i),r.forEach(e=>e(i))},t))}function a(){n!==null&&(clearTimeout(n),n=null)}function o(e){r.push(e)}return{onInput:i,destroy:a,onSaved:o}}async function to(e,t,n){let{data:r,error:i}=await u.from(`observaciones_sesion`).select(`id`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(i)throw i;if(r){let{data:e,error:t}=await u.from(`observaciones_sesion`).update({contenido_raw:n}).eq(`id`,r.id).select().single();if(t)throw t;return e}else{let{data:r,error:i}=await u.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,es_borrador:!0}).select().single();if(i)throw i;return r}}async function no(e,t){let{data:n,error:r}=await u.from(`observaciones_sesion`).select(`id, contenido_raw, updated_at`).eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0).limit(1).maybeSingle();if(r)throw r;return n??null}async function ro(e){let{error:t}=await u.from(`observaciones_sesion`).delete().eq(`id`,e);if(t)throw t}async function io(e,t,n,r,i=null,a=null){try{let{error:o}=await u.from(`observaciones_sesion`).delete().eq(`sesion_id`,e).eq(`maestro_id`,t).eq(`es_borrador`,!0);if(o)throw o;let{data:s,error:c}=await u.from(`observaciones_sesion`).insert({sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}).select().single();if(c)throw c;return s}catch(o){if(!navigator.onLine||o.message?.includes(`Failed to fetch`))return console.warn(`[autoDraftService] Offline, encolando saveObservation...`),await w({tabla:`observaciones_sesion`,operacion:`upsert`,payload:{sesion_id:e,maestro_id:t,contenido_raw:n,contenido_parsed:r,contenido_ia_dsl:i,contenido_ia_mejorado:a,es_borrador:!1}}),{_offline:!0,sesion_id:e};throw o}}function ao(e,{sesionId:t,maestroId:n,editor:r,sesionExistenteData:i,onDraftRecovered:a}){if(!t)return{destroy(){}};let o=null,s=!1,c=e.querySelector(`#pm-draft-indicator`);o=eo({saveFn:async e=>{!t||s||await to(t,n,e)},debounceMs:3e4}),o.onSaved(()=>{if(s||!c)return;let e=new Date;c.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,c.style.display=``});let l=e.querySelector(`#pm-dsl-editable`);if(l){let e=l.oninput;l.oninput=function(t){e&&e.call(this,t),o&&!s&&o.onInput(r.getValue())}}return i?.borrador===!0&&no(t,n).then(e=>{if(!s&&e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?a&&a(e.contenido_raw):ro(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e)),{destroy(){s=!0,o&&o.destroy()}}}function oo(e,{onSave:t,onCancel:n,onDelete:r}){let i=document.getElementById(`pm-justif-modal`);if(!i&&(i=document.createElement(`div`),i.id=`pm-justif-modal`,i.className=`pm-justif-modal-overlay`,i.innerHTML=`
    ...
    `}return g.onclick=async e=>{let g=e.target.closest(`.pm-asist-btn`),v=e.target.closest(`.pm-asist-nombre`);if(v){let e=v.closest(`.pm-asist-item`).dataset.id,n=t.find(t=>t.id===e);if(!n)return;if(r){_&&_.destroy(),u&&u(n);return}let s=o.filter(t=>t.student_id===e);if(s.length===0)try{let{academicService:t}=await I(async()=>{let{academicService:e}=await import(`./academicService-Cajirgsc.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await t.createSnapshotForStudent(i,e,a);n&&(s=n,h&&h(n))}catch(e){console.error(`Error creando snapshot on-demand:`,e)}d&&d(n,s);return}if(!g)return;let{id:b,action:x}=g.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),x===`J`){let e=t.find(e=>e.id===b);if(!e)return;if(n[b]===`J`){let t=s[b]||null;!t&&i&&c&&(t=await c(i,b)),f&&f(e,t,null),m&&m(`Editando justificación de ${e.nombre_completo}.`)}else l&&l(b,`J`),y(b),p&&await p(!0),f&&f(e,null,null),m&&m(`Justificación marcada para ${e.nombre_completo}.`);return}if(l&&l(b,n[b]===x?null:x),y(b),m){let e=Object.values(n).filter(e=>e===`P`).length,t=Object.values(n).filter(e=>e===`A`).length,r=Object.values(n).filter(e=>e===`J`).length;m(`Asistencia actualizada. ${e} presentes, ${t} ausentes, ${r} justificados.`)}p&&await p(!0)},{render(e){y(e)},destroy(){g.onclick=null,_&&=(_.destroy(),null)}}}async function lo(e,t,n,r,i=`Clase`,a=null){if(!r||r.length===0)return{success:!0};let o=r;if(a&&a.length>0){let e=new Set(a.map(e=>e.id)),t=r.length;o=r.filter(t=>e.has(t.alumno_id)),o.length<t&&console.warn(`[Promotion] promocionarObservacionesAlumnos: filtrados ${t-o.length} evaluaciones de alumnos ausentes`)}let s=o.filter(e=>e.observacion&&e.observacion.trim().length>0);if(s.length===0)return{success:!0};let c=s.map(r=>new ae({alumno_id:r.alumno_id,maestro_id:n,clase_id:t,sesion_clase_id:e,tipo:`academico`,titulo:`Evaluación SOI: ${i}`,descripcion:r.observacion,prioridad:`media`,estado:`abierta`,fecha_observacion:new Date().toISOString().split(`T`)[0]}).toJSON());try{let{data:e,error:t}=await u.from(`observaciones_alumnos`).upsert(c,{onConflict:`sesion_clase_id,alumno_id`});if(t)throw t;return{success:!0,data:e}}catch(e){if(!navigator.onLine||e.message?.includes(`Failed to fetch`)){console.warn(`[Promotion] Offline, encolando promoción de observaciones...`);for(let e of c)await w({tabla:`observaciones_alumnos`,operacion:`upsert`,payload:e});return{success:!0,_offline:!0,count:c.length}}return console.error(`[Promotion] Error promoviendo observaciones:`,e),{success:!1,error:e.message}}}async function uo(e,t){if(!e||!t)throw Error(`classEventId and status are required`);let{data:n,error:r}=await u.from(`class_events`).update({status:t,updated_at:new Date().toISOString()}).eq(`id`,e).select().single();if(r)throw Error(`Error updating class event status: ${r.message}`);return n}function fo(e,t){let n=e.querySelector(`#btn-guardar-obs`);return n?(t.rutaId&&(n.style.display=``),n.onclick=async()=>{let r=t.getEditorValue();if(!r||!r.trim()){P.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!t.sesionId){P.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let i=null,a=await mo(r,t),o=t.planificationCard?.getActiveIndicador();if(i=a||o,!i){P.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let s=e.querySelector(`#pm-active-tema-badge`);s&&i.nombre&&(s.textContent=i.nombre,s.style.display=`inline-block`),n.disabled=!0,n.textContent=`Procesando...`;try{let a=t.alumnos.filter(e=>t.estado[e.id]===`P`),o=await Dr(r,i.id,a,i.nombre);if(o.error)throw Error(o.error);if(o.modo===`natural`&&o.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+o.dslGenerado+`

¿Guardar la evaluación?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.missing.length>0&&!confirm(`Faltan ${o.missing.length} alumno(s) sin evaluar:\n${o.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){n.disabled=!1,n.textContent=`Guardar observación`;return}if(o.evaluaciones.length>0){let{error:e}=await Tr(t.sesionId,i.id,o.evaluaciones,t.maestro.id,a);if(e)throw e}let s={indicador_id:i.id,evaluaciones:o.evaluaciones};await io(t.sesionId,t.maestro.id,r,s,o.dslGenerado||null,o.textoMejorado||null);let c=vr(r);if(c.estados&&c.estados.length>0){let e=t.alumnos.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));di({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,dslText:r,alumnos:e}).then(({saved:e,errors:n})=>{n.length&&console.warn(`[Progress DSL] Errores:`,n),e.length&&Ti(e,t.editorContainer)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let l=await lo(t.sesionId,t.claseId,t.maestro.id,o.evaluaciones,t.claseNombre||`Clase`,a);if(l.success||console.warn(`[Fase C] Fallo parcial en promoción:`,l.error),t.planificationCard&&await t.planificationCard.refreshTree(),t.setEditorValue(``),t.onDslContentClear&&t.onDslContentClear(),po(o.evaluaciones.length,i.nombre),t.activeClassEventId){try{await uo(t.activeClassEventId,`completed`)}catch(e){console.warn(`[asistencia] Error updating class event status:`,e)}if(t.activeLevel)try{let{academicService:e}=await I(async()=>{let{academicService:e}=await import(`./academicService-Cajirgsc.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3]));for(let n of a){let r=await e.checkLevelCompletion(n.id,t.activeLevel);if(r&&r.status===`approved`){let{createLevelCompletionModal:e}=await I(async()=>{let{createLevelCompletionModal:e}=await import(`./LevelCompletionModal-CVtsz6ZA.js`);return{createLevelCompletionModal:e}},__vite__mapDeps([4,3,5])),r=e({studentId:n.id,levelId:t.activeLevel});t.onAppendModal?.(r.el||r)}}}catch(e){console.warn(`[asistencia] Error checking level completion:`,e)}}if(o.evaluaciones.length>0&&t.claseId&&i?.nombre){let{error:e}=await li({sesionId:t.sesionId,claseId:t.claseId,maestroId:t.maestro.id,fechaHoy:t.fechaHoy,contenido:i.nombre,evaluaciones:o.evaluaciones});e&&console.warn(`[asistencia] Error al sincronizar progresos:`,e)}if(t.sesionId){let{academicService:n}=await I(async()=>{let{academicService:e}=await import(`./academicService-Cajirgsc.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),r=await n.processSessionClosure(t.sesionId);if(r&&r.length>0){let{createAchievementsSummaryModal:t}=await I(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DbTtn5_3.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5]));await t(e,r)}}n.textContent=`¡Guardado!`,setTimeout(()=>{n.textContent=`Guardar observación`,n.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),P.error(`Error al guardar: `+(e.message||e)),n.disabled=!1,n.textContent=`Guardar observación`}},{destroy(){}}):{destroy(){}}}function po(e,t){let n=document.createElement(`div`);n.innerHTML=`
    ...
    <!-- Modales... -->
  `;let ee=Oi(e.querySelector(`#pm-attendance-header`),{clase:r,horario:i,salonNombre:h,fechaHoy:l,totalAlumnos:a.length,hasConflict:m,onBack:()=>{ve.destroy();try{le.close()}catch{}x.forEach(e=>{try{e()}catch{}}),b(`hoy`)}});x.push(()=>ee.destroy());let k=e.querySelector(`#pm-sync-badge-container`);if(k){let e=ir();k.appendChild(e.el)}let A=Qa(e,{initialContent:p,claseId:d,onEditorChange:e=>{C=e}}),j=A.getEditor(),te=e.querySelector(`#pm-dsl-editor-container`),M=sr(e,{onAceptar:e=>{j.setValue(e)}}),ne=cr(e,{onAccept:e=>{j.setValue(e)}}),re=_i(te.parentNode,{onConfirm:async t=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await ui({sesionId:y,claseId:d,maestroId:c.id,fechaHoy:l,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),ie=Ci(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await ue({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await fi({claseId:d,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;P.success(s)}catch(e){P.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}});A.initToolbar({onImproveClick:async t=>{let n=e.querySelector(`#btn-generar-informe`);n&&(n.disabled=!0);try{let e=await ke(t);M.open({original:t,improved:e})}catch(e){P.error(`Error al generar informe: `+e.message)}finally{n&&(n.disabled=!1)}},onStructureClick:async t=>{let n=e.querySelector(`#btn-ia-magic`);n&&(n.disabled=!0);try{let e=D?.getActiveIndicador(),n=await Ne(t,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:e?.nombre||null});ne.open({original:t,dsl:n})}catch(e){P.error(`Error al estructurar con IA: `+e.message)}finally{n&&(n.disabled=!1)}},onAnalyzeClick:async t=>{await ho(async()=>{let n=a.filter(e=>o[e.id]&&o[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),tipoClase:wi(r),instrumento:r.instrumento||``,sesionesRecientes:(f||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:D?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Pe(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.warning(`La IA no detectó registros de progreso en este texto.`);return}re.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),P!==void 0&&P&&P.error(`Error al analizar con IA: `+t.message)}})}});let N=A.getToolbar();D=Ui(e,{claseId:d,clase:r,maestro:c,fechaHoy:l,rutaId:g,editor:j,onIndicadorSelect:t=>{j.insertText(`[${t.nombre}] `),N&&N.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)},getDslContent:()=>j.getValue()}),x.push(()=>D.destroy());let ae=e.querySelector(`#btn-proponer-curriculo`);ae&&(ae.onclick=async()=>{ae.disabled=!0,ae.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await yi(d,12);if(e.registros.length===0){P.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Me(e,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});ie.open({pilares:t.pilares,resumen:t.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(e){P.error(`Error al generar propuesta: `+e.message)}finally{ae.disabled=!1,ae.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let se=ki(e,{editor:j,toolbar:N}),ce=Qr();se.inject(ce,d),x.push(()=>se.destroy());let le=so(e,{sesionId:y,claseId:d,fechaHoy:l,maestroId:c.id,supabase:u,guardarJustificacion:ti,eliminarJustificacion:ri,onJustifDeleted:e=>{o[e]=null,delete s[e]},onJustifSaved:(e,t)=>{s[e]=t},onJustifCancelled:(e,t)=>{o[e]=t},onRenderLista:e=>fe.render(e),onUpdateProgress:()=>me(),onAutoSave:e=>he(e),onAnnounce:e=>mn(e)});x.push(()=>{try{le.close()}catch{}});let de=ao(e,{sesionId:y,maestroId:c.id,editor:j,sesionExistenteData:_,onDraftRecovered:e=>{C=e,j.setValue(e)}});x.push(()=>de.destroy()),e.querySelector(`#pm-academic-tools`),fo(e,{rutaId:g,sesionId:y,claseId:d,maestro:c,fechaHoy:l,alumnos:a,estado:o,planificationCard:D,editorContainer:te,getEditorValue:()=>j.getValue(),setEditorValue:e=>j.setValue(e),onDslContentClear:()=>{C=``},activeClassEventId:null,activeLevel:null,claseNombre:r?.nombre||`Clase`,onAppendModal:t=>{let n=e.querySelector(`.pm-asist-root`);n&&n.appendChild(t)}});let fe=co(e,{alumnos:a,estado:o,rutaId:g,sesionId:y,fechaHoy:l,snapshots:f,justificaciones:s,obtenerJustificacion:ni,onEstadoChange:(e,t)=>{o[e]=t},onOpenProgressPanel:e=>{pe&&pe.destroy(),pe=Vr({alumno:e,rutaId:g,sessionId:y,claseId:d,fecha:l,horaInicio:i?.hora_inicio||null}),pe.open(),x.push(()=>{pe&&pe.destroy()})},onOpenEvaluationDrawer:(t,n)=>{or(e,{student:t,sessionId:y,teacherId:c.id,snapshots:n})},onOpenJustifModal:(e,t,n)=>{le.open(e,t,n)},onAutoSave:e=>he(e),onAnnounce:e=>mn(e),onUpdateSnapshots:e=>{f.push(...e)}});x.push(()=>fe.destroy());let pe=null;function me(){let t=a.length,n=Object.values(o).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function he(e=!1,t=!1){T&&clearTimeout(T);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...y?{}:{clase_id:d},maestro_id:c.id,fecha:l,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:C||``};if(navigator.onLine)try{if(y){let{error:e}=await u.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,y);if(!e){localStorage.setItem(`${S}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await u.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){y=e.id,console.log(`[asistencia] Nueva sesión creada:`,y),localStorage.setItem(`${S}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await w({tabla:`sesiones_clase`,operacion:y?`update`:`insert`,payload:{...y?{id:y}:{},...t}}),localStorage.setItem(`${S}_updated`,new Date().toISOString())};e?t?await n():await E.run(n):T=setTimeout(()=>{E.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let ge=e.querySelector(`.pm-asist-actions-fixed`);if(ge){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),y&&(e.disabled=!0,e.innerHTML=`⏳...`,await Ve(y),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=ge.querySelector(`#btn-guardar`);ge.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),d&&(n.disabled=!0,n.innerHTML=`⏳...`,await ze(d,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),ge.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let n=e.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await E.run(async()=>{try{let i=a.filter(e=>o[e.id]).map(e=>({...d?{clase_id:d}:{},alumno_id:e.id,fecha:l,estado:o[e.id],registrado_por:c.id})),s=i.length>0,f=C&&C.trim().length>0;if(!s&&!f)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await he(!0,!0),!y){let{data:e}=await u.from(`sesiones_clase`).select(`id`).eq(`clase_id`,d).eq(`maestro_id`,c.id).eq(`fecha`,l).maybeSingle();e&&(y=e.id)}if(s&&d)try{let e=i.map(e=>({...e,...y&&{sesion_clase_id:y}}));await oe(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!y){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await w({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:d,alumno_id:e.alumno_id,fecha:l,estado:e.estado,registrado_por:c.id,...y?{sesion_clase_id:y}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(y&&(s||f)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:n}=await u.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();if(n){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,n.message);let{error:t}=await u.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y).select();t&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,t.message),await u.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:C||``,updated_at:new Date().toISOString()}).eq(`id`,y))}t(),St(`hoy`),St(`calendario`),St(`metricas`),Ht().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(y){let{academicService:t}=await I(async()=>{let{academicService:e}=await import(`./academicService-Cajirgsc.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await I(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-DbTtn5_3.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([6,5])),i=await t.processSessionClosure(y);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let p=ge?.querySelector(`#btn-reporte-dia`);p&&(p.style.display=``);let m=ge?.querySelector(`#btn-resumen-mes`);m&&(m.style.display=``);let h=Object.values(o).filter(e=>e===`P`).length,g=Object.values(o).filter(e=>e===`A`).length;mn(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
      ...
      `,document.body.appendChild(_);let v=_.querySelector(`#btn-resumen-pedagogico`),x=_.querySelector(`#btn-editar-asistencia`),S=_.querySelector(`#btn-compartir-correo`),T=_.querySelector(`#btn-compartir-whatsapp`),E=_.querySelector(`#btn-volver-hoy`),D=_.querySelector(`#btn-ir-calendario`);O&&O.destroy(),O=Jr();let ee=O;v&&(v.onclick=()=>{ee.open({sesionId:y,claseNombre:r?.nombre||`Clase`,fecha:l,supabase:u})}),x&&(x.onclick=()=>{_.remove(),n.textContent=`Guardar sesión`,n.style.background=``,n.disabled=!1,n.style.display=``}),S&&(S.onclick=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t=encodeURIComponent(`Reporte de Clase - ${r?.nombre||``} - ${l}`),n=Ei(e,C,a,r,l);Di(`mailto:?subject=${t}&body=`,n,1800)}),T&&(T.onclick=async()=>{Di(`https://wa.me/?text=`,Ei(a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),C,a,r,l),1600)}),E&&(E.onclick=()=>{_.remove(),b(`hoy`)}),D&&(D.onclick=()=>{_.remove(),b(`calendario`)});let k=_.querySelector(`#btn-reporte-dia-overlay`);k&&(k.onclick=async()=>{let e=k.innerHTML;k.disabled=!0,k.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{await Ve(y)}finally{k.disabled=!1,k.innerHTML=e}});let A=_.querySelector(`#btn-resumen-mes-overlay`);A&&(d?A.onclick=async()=>{let e=A.innerHTML;A.disabled=!0,A.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await ze(d,e.getFullYear(),e.getMonth()+1)}finally{A.disabled=!1,A.innerHTML=e}}:(A.disabled=!0,A.title=`No disponible para actividades especiales`,A.style.opacity=`0.5`));let j=_.querySelector(`#btn-informe-ped-overlay`);j&&(d?j.onclick=async()=>{let e=j.innerHTML;j.disabled=!0,j.innerHTML=`<i class="bi bi-hourglass-split"></i> Generando…`;try{let e=new Date;await Be(d,e.getFullYear(),e.getMonth()+1)}finally{j.disabled=!1,j.innerHTML=e}}:(j.disabled=!0,j.title=`No disponible para actividades especiales`,j.style.opacity=`0.5`))}catch(e){console.error(`Error al guardar sesión:`,e),n.textContent=e.message||`Error al guardar`,n.style.background=`var(--pm-danger)`,n.disabled=!1,setTimeout(()=>{n.textContent=i,n.style.background=``},3e3)}})};let _e=$a(e,{onMarkAll:async e=>{a.forEach(t=>{o[t.id]=e}),fe.render(),me();try{await he(!0)}catch(t){console.warn(`[asistencia] autoSave error on bulk ${e}:`,t)}mn(`Todos los ${a.length} alumnos marcados como ${e===`P`?`presentes`:`ausentes`}.`)}});x.push(()=>_e.destroy()),fe.render();let ve=new pr(e);ve.mount();let ye=e.querySelector(`#pm-btn-help`);return ye&&(ye.onclick=()=>ve.start()),()=>{console.log(`[AsistenciaView] Cleanup ejecutado por el Router`),ve.destroy();try{le.close()}catch{}document.querySelectorAll(`.pm-saved-overlay`).forEach(e=>e.remove()),x.forEach(e=>{try{e()}catch{}})}}function yo(e,{alumnos:t=[],onSelect:n}){let r=document.getElementById(`pm-alumno-picker-modal`);r||(r=document.createElement(`div`),r.id=`pm-alumno-picker-modal`,r.className=`pm-modal-overlay`,r.innerHTML=`
    ...
    `).join(``)}function c(){s(),r.classList.add(`open`)}function l(){r.classList.remove(`open`)}return a.onclick=l,o.onclick=()=>{let e=Array.from(r.querySelectorAll(`.pm-alumno-check:checked`)).map(e=>`#${e.value}`);e.length>0&&n(e.join(`, `)+` `),l()},{open:c,close:l}}async function bo(e,{maestroId:t}){e.innerHTML=`
  ...
  `,e.querySelector(`#eme-alumnos-chips`);let n=[];try{let{data:e}=await u.from(`alumnos_clases`).select(`alumno:alumnos(id, nombre_completo)`).eq(`activo`,!0);n=(e||[]).map(e=>e.alumno).filter(Boolean)}catch(e){console.error(e)}let r=yo(e,{alumnos:n,onSelect:e=>{alert(`Alumnos seleccionados correctamente`)}});e.querySelector(`#btn-eme-pick-alumnos`).onclick=()=>r.open(),e.querySelector(`#btn-eme-guardar`).onclick=async()=>{let n={maestro_id:t,fecha:e.querySelector(`#eme-fecha`).value,motivo:e.querySelector(`#eme-motivo`).value,nombre_clase:e.querySelector(`#eme-nombre`).value,contenido:e.querySelector(`#eme-contenido`).value,created_at:new Date().toISOString()};if(!n.nombre_clase){alert(`Por favor ingresa un nombre para la clase.`);return}await w({tabla:`clases_emergentes`,operacion:`insert`,payload:n}),alert(`Clase emergente registrada. Redirigiendo...`),window.location.hash=`#/hoy`}}var xo={async open(){let e=await A(),t=await ee();Fe.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let n=document.getElementById(`col-izquierda`),r=document.getElementById(`col-derecha`);To(n,t),Eo(n,t),Io(n,t),Do(r),Oo(r,t),ko(r),Ao(r,t),r.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),No(r),Po(r),Wo(t),zo(t),Go(),I(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-D9Za2-hc.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([9,1,10,3])).then(async({getPermisos:e,solicitarPermiso:n})=>{try{let r=await e(t.id),i=document.getElementById(`pm-collaboration-container`);i&&Fo(i,r,t.id,n)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function To(e,t){let n=be(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Do(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Oo(e,t){let n=T(),r=n?`<span class="pm-badge-sub" id="pm-notif-sub-badge" aria-live="polite" aria-atomic="true">${Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`}</span>`:``;e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function ko(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Ao(e,t){e.insertAdjacentHTML(`beforeend`,`
        ...
        <div class="card-body py-2 px-3">
          ...
          ${e.respuesta_admin?`
            <div class="border-start border-2 border-primary ps-2 mt-2">
              ...
              <div class="small">${F(e.respuesta_admin)}</div>
            </div>`:``}
        </div>
      </div>`).join(``)}catch(e){console.error(`[historial sol]`,e),t&&(t.innerHTML=`<p class="text-danger small mb-0">Error al cargar el historial.</p>`)}}function No(e){e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section" aria-labelledby="install-title" id="pm-install-section">
      ...
      <div id="pm-install-body">
        ...
        • <b>Firefox:</b> no admite PWA nativa.`)}),window.addEventListener(`beforeinstallprompt`,()=>{t&&(t.disabled=!1)},{once:!0})}function Po(e){e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`)}function Fo(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await I(async()=>{let{getPermisos:e}=await import(`./permisoService-D9Za2-hc.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([9,1,10,3]));Fo(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function Io(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${Co.map(e=>Lo(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function Lo(e,t,n){let r=t.length>0;return`
    ...
    </div>`}function zo(e){document.querySelectorAll(`#perfilNombre, #perfilTelefono, #perfilEspecialidad, .pm-apple-time`).forEach(e=>{e.addEventListener(`input`,()=>{Z.dirty=!0;let e=document.getElementById(`btnGuardarPerfil`);e&&(e.disabled=!1)})}),document.getElementById(`btnGuardarPerfil`)?.addEventListener(`click`,()=>Bo(e)),document.getElementById(`btnCerrarSesion`)?.addEventListener(`click`,Ho),document.getElementById(`pm-ver-sistema-btn`)?.addEventListener(`click`,()=>{I(async()=>{let{renderSistemaView:e}=await import(`./sistemaView-CVPPIoDS.js`);return{renderSistemaView:e}},__vite__mapDeps([11,3,12,1,13,14,15,16,17])).then(({renderSistemaView:e})=>{Fe.open({title:`<i class="bi bi-cpu-fill me-2"></i>Sistema SOI — v${_}`,size:`xl`,saveText:null,cancelText:`Cerrar`,body:`<div id="pm-sistema-modal-body"></div>`,onOpen:t=>{e(t.querySelector(`#pm-sistema-modal-body`))}})})}),document.getElementById(`btnCambiarAvatar`)?.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Cambio de avatar disponible próximamente`,type:`info`}}))});let t=document.querySelector(`#btn-toggle-push-main input`);t?.addEventListener(`change`,async e=>{if(t.disabled=!0,t.checked){let e=await D();e.success?(Z.pushEnabled=!0,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones activadas`,type:`success`}}))):(t.checked=!1,Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:e.error||`Error al activar`,type:`danger`}})))}else await te(),Z.pushEnabled=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Notificaciones desactivadas`,type:`info`}}));t.disabled=!1;let n=document.getElementById(`pm-notif-sub-badge`);n&&(n.textContent=Z.pushEnabled?`✅ Suscripción activa`:`⏸ Pausada`)}),document.getElementById(`btn-abrir-config-notif`)?.addEventListener(`click`,()=>xo.open()),document.getElementById(`btn-push-diagnostic`)?.addEventListener(`click`,()=>So.open()),document.getElementById(`btn-probar-notificacion`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`btn-probar-notificacion`);e.disabled=!0,e.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;let t=await O();t.success?(e.innerHTML=`<i class="bi bi-check2"></i> Notificación enviada`,setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3)):(e.innerHTML=`<i class="bi bi-exclamation-triangle"></i> Error`,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:t.error||`No se pudo enviar notificación de prueba. Verifica los permisos.`,type:`danger`}})),setTimeout(()=>{e.innerHTML=`<i class="bi bi-send"></i> Probar notificación`,e.disabled=!1},2e3))}),document.getElementById(`pm-theme-light`)?.addEventListener(`click`,()=>Uo(`light`)),document.getElementById(`pm-theme-dark`)?.addEventListener(`click`,()=>Uo(`dark`)),document.getElementById(`pm-theme-system`)?.addEventListener(`click`,()=>Uo(`system`)),document.getElementById(`pm-btn-ver-ausencias`)?.addEventListener(`click`,async()=>{let{ausenciasPanel:e}=await I(async()=>{let{ausenciasPanel:e}=await import(`./ausenciasPanel-DYH6Ddxx.js`);return{ausenciasPanel:e}},__vite__mapDeps([18,3,19,8,5,20,17]));e.open()}),document.getElementById(`pm-btn-solicitar-ausencia`)?.addEventListener(`click`,()=>ve.open()),document.querySelectorAll(`.pm-avail-dia__header`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.dia;let t=e.closest(`.pm-avail-dia`),n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,!n),t.classList.toggle(`open`,!n)})}),document.querySelectorAll(`.pm-avail-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.dia,n=e.closest(`.pm-avail-dia`),r=document.getElementById(`pm-avail-franjas-${t}`),i=r.querySelectorAll(`.pm-avail-franja`).length;r.insertAdjacentHTML(`beforeend`,Ro(t,i,{inicio:`08:00`,fin:`12:00`})),n.classList.add(`open`),n.querySelector(`.pm-avail-dia__header`).setAttribute(`aria-expanded`,`true`),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1})}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.pm-avail-franja__del`);t&&(t.closest(`.pm-avail-franja`).remove(),Z.dirty=!0,document.getElementById(`btnGuardarPerfil`).disabled=!1)})}async function Bo(e){let t=document.getElementById(`perfilNombre`).value.trim(),n=he(document.getElementById(`perfilTelefono`).value.trim())||document.getElementById(`perfilTelefono`).value.trim(),r=document.getElementById(`perfilEspecialidad`).value.trim(),i=Vo();if(!t){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`El nombre es obligatorio`,type:`danger`}}));return}Z.saving=!0;let a=document.getElementById(`btnGuardarPerfil`),o=a.innerHTML;a.disabled=!0,a.innerHTML=`<span class="pm-settings-spinner"></span><span>Guardando...</span>`;try{let a=await He(e.id,i);if(!a.success){let e=a.errors.join(`
`);throw Error(e)}let{error:o}=await u.from(`maestros`).update({nombre_completo:t,tlf:n,especialidad:r}).eq(`id`,e.id);if(o)throw o;let s={...e,nombre_completo:t,nombre:t,telefono:n,tlf:n,especialidad:r,disponibilidad:i};localStorage.setItem(p,JSON.stringify(s)),Z.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{Z.saving=!1,a.disabled=!1,a.innerHTML=o}}function Vo(){let e={};return Co.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function Ho(){Fe.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await m(),window.location.reload(),!0)})}function Uo(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),Z.theme=e}function Wo(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function Go(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var Ko=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=Ko,document.head.appendChild(e)}async function qo(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i,onSave:a}){let s=new Set,c=document.createElement(`div`);c.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
  ...
  `,c.appendChild(l),e.appendChild(c);try{let e=(await o([n])).map(e=>e.alumno_id);if(e.length===0){document.getElementById(`pm-students-list`).innerHTML=`<p style="color: var(--pm-text-muted); text-align: center;">No hay estudiantes en esta clase</p>`;return}let t=(await Re()).filter(t=>e.includes(t.id)),r=document.getElementById(`pm-students-list`);r.innerHTML=t.map(e=>`
    ...
    `).join(``),r.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e.addEventListener(`change`,()=>{e.checked?s.add(e.dataset.alumnoId):s.delete(e.dataset.alumnoId),d()})})}catch(e){console.error(`[registro] Error cargando estudiantes:`,e),document.getElementById(`pm-students-list`).innerHTML=`<p style="color: var(--pm-text-muted); text-align: center;">Error cargando estudiantes</p>`}document.getElementById(`pm-select-all`).addEventListener(`click`,()=>{document.querySelectorAll(`#pm-students-list input[type="checkbox"]`).forEach(e=>{e.checked=!0,s.add(e.dataset.alumnoId)}),d()}),document.getElementById(`pm-deselect-all`).addEventListener(`click`,()=>{document.querySelectorAll(`#pm-students-list input[type="checkbox"]`).forEach(e=>{e.checked=!1,s.delete(e.dataset.alumnoId)}),d()}),document.getElementById(`pm-registro-save`).addEventListener(`click`,async()=>{if(s.size===0){P.warning(`Selecciona al menos un estudiante`);return}let e=document.getElementById(`pm-registro-descripcion`).value.trim(),o=document.querySelector(`input[name="calificacion"]:checked`).value;try{let c=document.getElementById(`pm-registro-save`);c.disabled=!0,c.textContent=`Guardando...`,await Ge({maestroId:r,routeVersionId:i,nodeId:t.node_id,claseId:n,fecha:new Date().toISOString().split(`T`)[0],descripcion:e,calificacion:o,estudianteIds:Array.from(s)}),P.success(`✓ Observación guardada exitosamente`),mn(`Observación para ${t.nombre} guardada. ${s.size} estudiantes registrados.`),u(),a&&a()}catch(e){console.error(`[registro] Error guardando:`,e),P.error(`Error guardando observación`),document.getElementById(`pm-registro-save`).disabled=!1,document.getElementById(`pm-registro-save`).textContent=`Guardar Observación`}});function u(){c.remove()}document.getElementById(`pm-registro-close`).addEventListener(`click`,u),document.getElementById(`pm-registro-cancel`).addEventListener(`click`,u),c.addEventListener(`click`,e=>{e.target===c&&u()});function d(){let e=s.size;document.getElementById(`pm-counter`).textContent=`${e} ${e===1?`estudiante seleccionado`:`estudiantes seleccionados`}`}}async function Jo(e,{indicator:t,claseId:n,maestroId:r,routeVersionId:i}){let a=document.createElement(`div`);a.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
  ...
  `,a.appendChild(o),e.appendChild(a);try{let e=await Ue(t.node_id,i,r,n),a=`
    ...
    `;document.getElementById(`pm-details-body`).innerHTML=a,document.getElementById(`pm-details-title`).textContent=`${e.nombre} — Historial Completo`}catch(e){console.error(`[details] Error cargando historial:`,e),document.getElementById(`pm-details-body`).innerHTML=`<p style="color: var(--pm-text-muted); text-align: center;">Error cargando información</p>`}function s(){a.remove()}document.getElementById(`pm-details-close`).addEventListener(`click`,s),document.getElementById(`pm-details-close-btn`).addEventListener(`click`,s),a.addEventListener(`click`,e=>{e.target===a&&s()})}function Yo(e){return Array.isArray(e)&&e.find(e=>{let t=e?.estado?.estado;return t&&t!==`completado`})||null}function Xo(e){let t=Array.isArray(e)?e:[],n=t.length,r=t.filter(e=>e?.estado?.estado===`completado`).length;return{total:n,completados:r,pendientes:n-r,porcentaje:n>0?Math.round(r/n*100):0}}async function Zo(t,{maestroId:r}){let i=null,a=null,o=[];t.innerHTML=`
    <style>
  ...
  `;let s=`pm-planning-active-tab`,c=t.querySelectorAll(`.pm-planning-tab`),l=t.querySelectorAll(`.pm-planning-pane`);function u(e){c.forEach(t=>{let n=t.dataset.tab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}),l.forEach(t=>{t.hidden=t.dataset.pane!==e});try{sessionStorage.setItem(s,e)}catch{}C(e)}c.forEach(e=>{e.addEventListener(`click`,()=>u(e.dataset.tab))});let d=t.querySelector(`#pm-planning-clase-select`),f=t.querySelector(`#pm-planning-ruta-select`),p=t.querySelector(`#pm-planning-content`);try{d.innerHTML=`<option value="">Selecciona una clase...</option>`+(await n()).map(e=>`<option value="${e.id}">${e.nombre} (${e.instrumento||`S/I`})</option>`).join(``)}catch(e){console.error(`[planning] Error cargando clases:`,e),P.error(`Error cargando clases`)}d.addEventListener(`change`,async()=>{if(a=d.value,f.value=``,i=null,p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta...</p></div>`,y=null,_=null,v=null,t.querySelector(`.pm-planning-tab.active`)?.dataset.tab===`historial`&&D(),a)try{f.innerHTML=`<option value="">Selecciona una ruta...</option>`+(await e(a)).map(e=>`<option value="${e.route_version_id}">${e.name}${e.instrumento?` (${e.instrumento})`:``}</option>`).join(``)}catch(e){console.error(`[planning] Error cargando rutas:`,e),P.error(`Error cargando rutas`)}}),f.addEventListener(`change`,()=>{i=f.value||null,C(t.querySelector(`.pm-planning-tab.active`)?.dataset.tab||`semaforo`)});let m=t.querySelector(`#pm-planning-route-tree`),h=t.querySelector(`#pm-planning-manager`),g=t.querySelector(`#pm-planning-historial`),_=null,v=null,y=null,b=!1,x=!1,S=!1;function C(e){if(e===`semaforo`)return w();if(e===`ruta`)return T();if(e===`gestionar`)return E();if(e===`historial`)return D()}async function w(){if(!i||!a){p.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una clase y ruta para comenzar</p></div>`;return}p.innerHTML=`<div class="pm-planning-empty"><p>Cargando indicadores...</p></div>`;try{o=await We(i,r,a),O()}catch(e){console.error(`[planning] Error cargando indicadores:`,e),P.error(`Error cargando indicadores`),p.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar indicadores. Intenta de nuevo.</p></div>`}}async function T(){if(!i){m.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para ver su estructura</p></div>`;return}if(!(_===i||b)){b=!0,m.innerHTML=`<div class="pm-planning-empty"><p>Cargando estructura...</p></div>`;try{let{renderPlanningRouteTree:e}=await I(async()=>{let{renderPlanningRouteTree:e}=await import(`./PlanningRouteTree-DghTFEyN.js`);return{renderPlanningRouteTree:e}},__vite__mapDeps([21,22,3,5]));await e(m,{routeVersionId:i}),_=i}catch(e){console.error(`[planning] Error cargando estructura de ruta:`,e),m.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar la estructura. Intenta de nuevo.</p></div>`}finally{b=!1}}}async function E(){if(!i){h.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una ruta para gestionar su contenido</p></div>`;return}if(!(v===i||x)){x=!0,h.innerHTML=`<div class="pm-planning-empty"><p>Preparando tu borrador editable…</p></div>`;try{let{renderPlanningManager:e}=await I(async()=>{let{renderPlanningManager:e}=await import(`./PlanningManagerPanel-CgvoeWCK.js`);return{renderPlanningManager:e}},__vite__mapDeps([23,24,3,22,5,20,17]));await e(h,{publishedRouteVersionId:i,maestroId:r,onChanged:()=>{_=null}}),v=i}catch(e){console.error(`[planning] Error cargando gestor:`,e),h.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar el gestor. Intenta de nuevo.</p></div>`}finally{x=!1}}}async function D(){if(!a){g.innerHTML=`<div class="pm-planning-empty"><p>Selecciona una clase para ver el historial</p></div>`;return}let e=`${a}:${i}`;if(!(y===e||S)){S=!0,g.innerHTML=`<div class="pm-planning-empty"><p>Cargando historial...</p></div>`;try{let{renderPlanningHistorialPane:t}=await I(async()=>{let{renderPlanningHistorialPane:e}=await import(`./PlanningHistorialPane-D5XBGbn_.js`);return{renderPlanningHistorialPane:e}},__vite__mapDeps([25,3,24,22,5,20,17]));await t(g,{maestroId:r,claseId:a,publishedRouteVersionId:i,onPromoted:()=>{i&&w()}}),y=e}catch(e){console.error(`[planning] Error cargando historial:`,e),g.innerHTML=`<div class="pm-planning-empty"><p>Error al cargar el historial. Intenta de nuevo.</p></div>`}finally{S=!1}}}try{let e=sessionStorage.getItem(s);e&&e!==`semaforo`&&u(e)}catch{}function O(){if(!o||o.length===0){p.innerHTML=`<div class="pm-planning-empty"><p>No hay indicadores en esta ruta</p></div>`;return}let e={};o.forEach(t=>{let n=t.tipo||`Sin Categoría`;e[n]||(e[n]=[]),e[n].push(t)});let t=Object.entries(e).map(([e,t])=>`
    ...
    `).join(``);p.innerHTML=`${ee()}<div class="pm-planning-grid">${t}</div>`;let n=p.querySelector(`[data-faro-register]`);if(n){let e=Yo(o);n.addEventListener(`click`,()=>j(e))}p.querySelectorAll(`[data-indicator-id]`).forEach(e=>{let t=e.dataset.indicatorId,n=o.find(e=>e.node_id===t);e.addEventListener(`click`,async()=>{await A(n)})}),p.querySelectorAll(`[data-register-btn]`).forEach(e=>{let t=e.dataset.indicatorId,n=o.find(e=>e.node_id===t);e.addEventListener(`click`,e=>{e.stopPropagation(),j(n)})})}function ee(){let e=Xo(o),t=Yo(o);return t?`
    ...
    `:`
      ...
      `}function k(e){let t=e.progreso_porcentaje/100*100,{estado:n,icono:r,color:i}=e.estado;return`
    ...
    `}async function A(e){Jo(t,{indicator:e,claseId:a,maestroId:r,routeVersionId:i})}async function j(e){qo(t,{indicator:e,claseId:a,maestroId:r,routeVersionId:i,onSave:async()=>{try{o=await We(i,r,a),O(),P.success(`✓ Indicadores actualizados`)}catch(e){console.error(`[planning] Error reloading:`,e)}}})}}var Qo=`alumno_plan_entradas`;async function $o(e){let{data:t,error:n}=await u.from(Qo).select(`id, tipo, titulo, descripcion, nivel_referencia, objetivo_id, sesion_id, created_at, maestro_id`).eq(`alumno_id`,e).order(`created_at`,{ascending:!1});if(n)throw Error(n.message);return t||[]}async function es(e){if(!e.titulo?.trim())throw Error(`titulo requerido`);let{data:t,error:n}=await u.from(Qo).insert({alumno_id:e.alumno_id,maestro_id:e.maestro_id,tipo:e.tipo,titulo:e.titulo.trim(),descripcion:e.descripcion?.trim()||null,nivel_referencia:e.nivel_referencia||null,objetivo_id:e.objetivo_id||null,sesion_id:e.sesion_id||null}).select().single();if(n)throw Error(n.message);return t}async function ts(e){let{error:t}=await u.from(Qo).delete().eq(`id`,e);if(t)throw Error(t.message)}var ns={diagnostico:{label:`Diagnóstico`,icon:`🔍`,color:`#6366f1`,bg:`#6366f115`},logro:{label:`Logro`,icon:`✅`,color:`#16a34a`,bg:`#16a34a15`},en_progreso:{label:`En progreso`,icon:`📈`,color:`#2563eb`,bg:`#2563eb15`},dificultad:{label:`Dificultad`,icon:`⚠️`,color:`#dc2626`,bg:`#dc262615`},objetivo:{label:`Objetivo`,icon:`🎯`,color:`#d97706`,bg:`#d9770615`}},rs=[`diagnostico`,`logro`,`en_progreso`,`dificultad`,`objetivo`],is=class{constructor({container:e,alumnoId:t,maestroId:n}){this._container=e,this._alumnoId=t,this._maestroId=n,this._entries=[],this._formOpen=!1}async init(){this._container.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`,await this._load(),this._render()}async _load(){this._entries=await $o(this._alumnoId)}_render(){this._container.innerHTML=this._buildHTML(),this._attachEvents()}_buildHTML(){let e=this._entries.length>0,t=this._entries.some(e=>e.tipo===`diagnostico`);return`
      <div class="pe-panel">
    ...
    `}_buildEntry(e){let t=ns[e.tipo]||ns.logro,n=new Date(e.created_at).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`});return`
      ...
      <div class="pe-form-overlay">
        <div class="pe-form">
          ...
          <select class="pe-select" id="pe-tipo">
            ${rs.map(e=>`
              <option value="${e}" ${e===t?`selected`:``}>${ns[e].icon} ${ns[e].label}</option>
            `).join(``)}
          </select>
...
`).trim():``}var fs={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function ps(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await u.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await u.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),d=new Map;for(let e of a){let t=e.contenido_dsl;d.has(t)||d.set(t,{contenido:t,entries:[]}),d.get(t).entries.push(e)}let f=Array.from(d.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=fs[n.estado_cualitativo]??fs.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
        <details class="pm-prog-card">
          ...
          <div class="pm-prog-card__timeline">
            ${t.map(e=>{let t=fs[e.estado_cualitativo]??fs.EN_PROGRESO,n=new Date(e.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`numeric`}),r=l.get(e.clase_id)||`Clase`,i=e.indicadores?.tarea,a=e.calificacion==null?null:`${e.calificacion}/5`;return`
        ...
        <div class="pm-zen-body">
          ...
          <div class="pm-zen-section">
            ...
            <div class="pm-zen-bitacora">
              ${A.map(e=>{let t=k.get(e.clase_id),n=ds(e.contenido_dsl);return`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${ce(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
    ...
    `,e.querySelector(`#pm-alumno-back`).onclick=()=>window.history.back();let ie=as(r.tlf_alumno||r.representante_tlf);if(ie){let t=r.nombre_completo||`el alumno`,i=r.representante_nombre||t,a={alumno:t,contacto:i},o=document.createElement(`div`);o.id=`pm-wa-modal`,o.innerHTML=`
    ...
    `}}var hs={scales:`🎼`,arpeggios:`🎹`,left_hand:`✋`,bow:`🎻`,sound:`🔊`,intonation:`🎵`,studies:`⚙️`,repertoire:`📖`},gs={approved:`#34C759`,in_process:`#007AFF`,pending:`#ccc`,failed:`#FF3B30`},_s={approved:`Aprobado`,in_process:`En proceso`,pending:`Pendiente`,failed:`Fallido`};function vs(e){let t=(e||``).toLowerCase();for(let[e,n]of Object.entries(hs))if(t.includes(e))return n;return t.includes(`escala`)?`🎼`:t.includes(`arpegio`)?`🎹`:t.includes(`mano`)||t.includes(`izquierda`)?`✋`:t.includes(`arco`)?`🎻`:t.includes(`sonido`)?`🔊`:t.includes(`afinación`)||t.includes(`entonación`)?`🎵`:t.includes(`estudio`)?`⚙️`:t.includes(`repertorio`)||t.includes(`obra`)?`📖`:`📋`}async function ys(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=f();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await u.from(`clases`).select(`id, nombre`).eq(`maestro_id`,t.id).order(`nombre`);if(!n||n.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let{data:r}=await u.from(`inscripciones`).select(`alumno_id, alumnos(id, nombre, apellido)`).in(`clase_id`,n.map(e=>e.id));e.innerHTML=`
                ...
                <div class="pm-level-nodes">
                  ${n.map(e=>{let t=s?.find(t=>t.node_id===e.id),n=t?.status||`pending`,r=e.indicators||[],i=t?.indicator_attempts||[];return`
                      <div class="pm-node-card" onclick="this.classList.toggle('expanded')">
                        <div class="pm-node-icon">${vs(e.name)}</div>
                        <div class="pm-node-info">
                          <span class="pm-node-name">${F(e.name)}</span>
                          <span class="pm-node-status">${_s[n]}</span>
                        </div>
                        ...
                        <div class="pm-indicators">
                          ${r.length===0?`<p style="font-size:0.7rem;color:var(--pm-text-muted);">Sin indicadores</p>`:r.map(e=>{let t=i.find(t=>t.indicator_id===e.id);return`
                                <div class="pm-indicator">
                                  <span class="pm-indicator-dot" style="background:${gs[t?.status||`pending`]};"></span>
  ...
  `,e.querySelector(`.block-section-header`)?.addEventListener(`click`,()=>{o(n)})}var Es=()=>typeof globalThis<`u`&&globalThis.getMaestroLocal?globalThis.getMaestroLocal():f(),Ds=(...e)=>typeof globalThis<`u`&&globalThis.getMisClases?globalThis.getMisClases(...e):n(...e),Os=(...e)=>typeof globalThis<`u`&&globalThis.loadRouteTree?globalThis.loadRouteTree(...e):Ss(...e),Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:null},ks=!1;async function As(e,{onTopicSelected:n}={}){if(Q={clases:[],activeClaseId:null,rutaId:null,blocks:[],loading:!1,expandedBlocks:new Set,expandedLevels:new Set,selectedIndicator:null,onTopicSelected:n},e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,!Es()){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No hay sesión activa.</p></div>`;return}try{if(t(),Q.clases=await Ds(!0),!Q.clases?.length){e.innerHTML=`<div class="pm-ruta-gamificada"><p class="pm-empty">No tienes clases asignadas.</p></div>`;return}Q.activeClaseId=Q.clases[0].id,await js(),Ms(e),Is(e),Ls(e)}catch(t){console.error(`[rutaGameificadaView]`,t),e.innerHTML=`<div style="color:red;padding:20px;"><i class="bi bi-exclamation"></i> Error: ${t.message}</div>`}}async function js(){Q.loading=!0,Q.rutaId=await xs(Q.activeClaseId),Q.rutaId?Q.blocks=await Os(Q.rutaId,Q.activeClaseId):Q.blocks=[],Q.loading=!1}function Ms(e){e.innerHTML=`
  ...
  `;let r=Q.expandedLevels.has(e.id);return n.innerHTML=`
    <div class="level-header" style="padding: 12px 16px; display: flex; align-items: center; gap: 12px; cursor: ${e.locked?`not-allowed`:`pointer`};">
      <div class="level-icon" style="width: 32px; height: 32px; border-radius: 8px; background: ${Fs(e.semaphore)}; display: flex; align-items: center; justify-content: center; color: white;">
      ...
      <div style="flex: 1;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 4px;">
          <div style="flex: 1; height: 6px; background: #e2e8f0; border-radius: 3px; overflow: hidden;">
            <div style="width: ${e.percentage}%; height: 100%; background: ${Fs(e.semaphore)}; transition: width 0.3s ease;"></div>
          </div>
      ...
      ${(e.nodes||[]).map(t=>`
        <div class="node-item" style="margin-bottom: 12px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 8px; height: 8px; border-radius: 50%; background: ${Fs(t.semaphore)};"></span>
  ...
  `,e.locked||n.querySelector(`.level-header`).addEventListener(`click`,()=>{Q.expandedLevels.has(e.id)?Q.expandedLevels.delete(e.id):Q.expandedLevels.add(e.id),Ms(t)}),n.querySelectorAll(`.indicator-row`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),Q.selectedIndicator={id:e.dataset.id,nombre:e.dataset.nombre,nodeNombre:e.dataset.node,levelNombre:e.dataset.level,blockNombre:e.dataset.block},Ms(t)})}),n}function Ps(e){let t=e.querySelector(`#ruta-action-panel`);if(!Q.selectedIndicator){t.innerHTML=``;return}t.innerHTML=`
  ...
  `,t.querySelector(`#btn-cancel-select`).addEventListener(`click`,()=>{Q.selectedIndicator=null,Ms(e)}),t.querySelector(`#btn-use-topic`).addEventListener(`click`,()=>{Zr({...Q.selectedIndicator,indicatorId:Q.selectedIndicator.id,claseId:Q.activeClaseId}),Q.onTopicSelected&&Q.onTopicSelected(Q.activeClaseId)})}function Fs(e){switch(e){case`green`:return`#22c55e`;case`yellow`:return`#eab308`;case`gray`:return`#94a3b8`;default:return`#94a3b8`}}function Is(e){e.querySelector(`#ruta-clase-select`)?.addEventListener(`change`,async t=>{Q.activeClaseId=t.target.value,e.innerHTML=`<div class="pm-ruta-gamificada"><div class="pm-loading"><div class="pm-spinner"></div></div></div>`,await js(),Ms(e),Is(e)})}function Ls(e){ks||(ks=!0,ws.on(`node-covered`,()=>{js().then(()=>{Ms(e),Is(e)})}))}var Rs=[`lunes`,`martes`,`miércoles`,`jueves`,`viernes`,`sábado`,`domingo`];async function zs(e){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let t=f();if(!t){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}try{let{data:n}=await u.from(`system_config`).select(`value`).eq(`key`,`maestros_pueden_crear_clases`).maybeSingle();if(n?.value!==`true`){e.innerHTML=`
          ...
          <div id="nueva-clase-horarios">
            <div class="pm-horario-row" data-index="0">
              <select class="pm-input pm-horario-dia">
                ${Rs.map(e=>`<option value="${e}">${e.charAt(0).toUpperCase()+e.slice(1)}</option>`).join(``)}
              </select>
    ...
    `}}async function Bs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let n=await L.getStudent(t),r=await L.fetchRoutes();e.innerHTML=`
      <div class="pm-asist-header">
      ...
      <div class="card-apple pm-animate-slide-up" style="margin-top: 1.5rem; padding: 1.5rem;">
        <div class="mb-4">
          ...
          <select id="route-selector" class="input-apple">
            ...
            ${r.map(e=>`<option value="${e.id}">${F(e.name)} (${F(e.instrument||`General`)})</option>`).join(``)}
          </select>
        </div>
    ...
    `;let i=e.querySelector(`#route-selector`),a=e.querySelector(`#level-selection-container`),o=e.querySelector(`#level-selector`),s=e.querySelector(`#btn-create-plan`),c=e.querySelector(`#plan-summary`),l=null,d=null,f=null;i.addEventListener(`change`,async e=>{l=e.target.value,a.style.display=`block`,o.innerHTML=`<option value="" disabled selected>Cargando niveles...</option>`,s.disabled=!0;try{d=await L.getPublishedVersionId(l),f=await L.getRouteDetail(l,d);let e=[];f.forEach(t=>{t.levels.forEach(n=>{e.push({id:n.id,name:n.name,blockName:t.name})})}),o.innerHTML=`
        ...
        `)}),s.addEventListener(`click`,async()=>{s.disabled=!0,s.innerHTML=`<div class="pm-spinner pm-spinner-sm"></div> Creando...`;try{await L.createAcademicPlan(t,d),await u.from(`student_level_progress`).upsert({student_id:t,level_id:o.value,status:`in_process`}),alert(`Plan académico creado con éxito`),window.location.hash=`#/alumno?id=${t}`}catch(e){console.error(`Error creating plan:`,e),alert(`Error al crear el plan: `+e.message),s.disabled=!1,s.textContent=`Comenzar Plan Académico`}})}catch(t){e.innerHTML=`<div class="pm-placeholder"><i class="bi bi-exclamation-triangle"></i><p>Error: ${F(t.message)}</p></div>`}}async function Vs(e,{alumnoId:t}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;try{let{data:n,error:r}=await u.from(`academic_plans`).select(`*, route_versions(route_id, version_number, routes(name, instrument_id))`).eq(`student_id`,t).eq(`status`,`in_process`).maybeSingle();if(r)throw r;if(!n){e.innerHTML=`
      ...
      `;return}let i=await L.getRouteDetail(n.route_versions.route_id),{data:a,error:o}=await u.from(`weekly_plan_entries`).select(`*`).eq(`academic_plan_id`,n.id).order(`start_date`,{ascending:!1});if(o)throw o;e.innerHTML=`
      <div class="pm-asist-header">
    ...
    `,this.loadRoutes(e),e},async loadRoutes(e){let t=e.querySelector(`#routes-grid`);try{let n=await L.fetchRoutes();if(!n||n.length===0){t.innerHTML=`
      ...
      `}}},Us={async render(e){let t=e?.id,n=new URLSearchParams(window.location.hash.split(`?`)[1]).get(`studentId`),r=document.createElement(`div`);return r.className=`pm-view pm-animate-fade-in`,r.innerHTML=`
    ...
    `,r.querySelector(`#back-to-library`).onclick=()=>{window.location.hash=`#/ruta-libreria`},t?this.loadRouteDetail(r,t,n):r.innerHTML=`<div class="pm-placeholder"><i class="bi bi-x-circle"></i><p>ID de ruta no proporcionado.</p></div>`,r},async loadRouteDetail(e,t,n){let r=e.querySelector(`#route-header-content`),i=e.querySelector(`#route-hierarchy`);try{let[e,a]=await Promise.all([L.getRouteDetail(t),n?L.getStudentProgress(n,t):Promise.resolve([])]),o=new Map(a.map(e=>[e.node_id,e]));if(r.innerHTML=`
          ...
          ${e.levels.map(e=>`
            <div class="pm-level-card card-apple" style="margin-bottom: 1rem; border-left: 4px solid var(--apple-secondary);">
              ...
              <div class="pm-nodes-grid" style="display: flex; flex-direction: column; gap: 0.75rem;">
                ${e.nodes.map(e=>{let t=o.get(e.id)?.status||`pending`,n=L.getStatusToken(t);return`
      ...
      `).join(``)}catch(e){console.error(`Error al cargar detalle de ruta:`,e),i.innerHTML=`<p class="pm-error-msg">Error al cargar la estructura académica.</p>`}}};function Ws(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Gs(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]?.toUpperCase()??``).join(``)}function Ks(e){if(!e||e.length===0)return`<span style="color:var(--pm-text-muted);font-size:.8rem;">Sin horario asignado</span>`;let t={lunes:`Lun`,martes:`Mar`,miercoles:`Mié`,miércoles:`Mié`,jueves:`Jue`,viernes:`Vie`,sabado:`Sáb`,sábado:`Sáb`,domingo:`Dom`};return e.map(e=>`<span class="gcv-horario-chip">${t[e.dia]||e.dia||``} ${(e.hora_inicio||``).slice(0,5)}–${(e.hora_fin||``).slice(0,5)}</span>`).join(` `)}var qs=null,Js=[],Ys=new Set;async function Xs(e){e.innerHTML=lc();let t=f();if(!t){e.innerHTML=uc(`bi-lock`,`Sin sesión activa`,`Por favor ingresá nuevamente.`);return}try{let n=await N(t.id);if(!n.puede_inscribir_clases){e.innerHTML=Qs(n),$s(t.id);return}let[r,i]=await Promise.all([pe(t.id),Re().catch(()=>[])]);Js=i.filter(e=>e.activo!==!1&&e.is_active!==!1),e.innerHTML=ec(r),oc(r),r.length>0&&await nc(r[0].id,r)}catch(t){console.error(`[GestionarClases]`,t),e.innerHTML=uc(`bi-exclamation-triangle`,`Error al cargar`,Ws(t.message))}}function Zs(e){let t=e?.solicitudes||[],n=e?.solicitud_actual;return t.includes(`clases:enroll`)||t.includes(`inscribir_clases`)||n?.estado===`pendiente`&&n?.solicita_clases}function Qs(e){return`
    <div class="gcv-root">
  ...
  `}function $s(e){let t=document.getElementById(`gcv-btn-request-classes`);t&&t.addEventListener(`click`,async()=>{t.disabled=!0;let n=t.innerHTML;t.innerHTML=`<span class="gcv-spinner-sm"></span> Enviando...`;try{await ie(e,`clases:enroll`),P.success(`Solicitud de permiso enviada correctamente.`);let t=document.getElementById(`gcv-permission-action`);t&&(t.innerHTML=`
          <div class="gcv-pending-badge">
            <i class="bi bi-clock-history"></i>
            Solicitud Pendiente de Aprobación
          </div>`)}catch(e){P.error(`Error al solicitar: `+e.message),t.disabled=!1,t.innerHTML=n}})}function ec(e){return`
    <div class="gcv-root">
      ...
      ${e.length===0?uc(`bi-calendar-x`,`Sin clases asignadas`,`El administrador debe asignarte clases primero.`):`<div class="gcv-layout">
  ...
  `}function tc(e){let t=Ws(e.nombre||`Clase sin nombre`),n=Ks(e.horarios||[]),r=Ws(e.nivel||``),i=e.capacidad_maxima??e.max_alumnos??`–`;return`
  ...
  `}async function nc(e,t){qs=e,document.querySelectorAll(`.gcv-clase-card`).forEach(e=>e.classList.remove(`active`)),document.getElementById(`gcv-card-${e}`)?.classList.add(`active`);let n=document.getElementById(`gcv-panel`);if(!n)return;let r=t.find(t=>t.id===e);if(r){n.innerHTML=`<div class="gcv-loading"><div class="gcv-spinner"></div></div>`;try{let i=await fe(e),a=i.map(e=>e.alumno).filter(Boolean);Ys=new Set(i.map(e=>e.alumno_id)),n.innerHTML=rc(r,a,Js.filter(e=>!Ys.has(e.id))),sc(e,t)}catch(e){n.innerHTML=uc(`bi-exclamation-circle`,`Error al cargar alumnos`,Ws(e.message))}}}function rc(e,t,n){return`
    <div class="gcv-panel-inner">
      <div class="gcv-panel-header">
        <h3 class="gcv-panel-title"><i class="bi bi-people-fill"></i> ${Ws(e.nombre||`Clase`)}</h3>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-inscritos" class="gcv-student-list">
          ${t.length===0?`<p class="gcv-empty-list">Sin alumnos inscritos aún.</p>`:t.map(e=>ic(e)).join(``)}
        </div>
      </div>
      ...
      <div class="gcv-section">
        ...
        <div id="gcv-lista-disponibles" class="gcv-student-list gcv-available-list">
          ${n.length===0?`<p class="gcv-empty-list">Todos los alumnos activos ya están inscritos.</p>`:n.map(e=>ac(e)).join(``)}
        </div>
        ${n.length>0?`
  ...
  `}function ic(e){let t=Ws(e.nombre_completo||e.nombre||`Alumno`),n=Ws(e.instrumento_principal||e.instrumento||``);return`
    <div class="gcv-student-row inscrito-item"
         data-alumno-id="${e.id}"
         data-name="${t.toLowerCase()}"
         data-instrumento="${n.toLowerCase()}">
      <div class="gcv-student-avatar gcv-avatar-success">${Gs(t)}</div>
  ...
  `}function ac(e){let t=Ws(e.nombre_completo||e.nombre||`Alumno`),n=Ws(e.instrumento_principal||e.instrumento||``);return`
    <label class="gcv-student-row gcv-student-selectable disponible-item"
           data-alumno-id="${e.id}"
           data-name="${t.toLowerCase()}"
           data-instrumento="${n.toLowerCase()}">
      <input class="gcv-checkbox" type="checkbox" value="${e.id}" />
      <div class="gcv-student-avatar gcv-avatar-primary">${Gs(t)}</div>
      <div class="gcv-student-data">
        <span class="gcv-student-name">${t}</span>
        ${n?`<span class="gcv-student-sub"><i class="bi bi-music-note"></i> ${n}</span>`:``}
      </div>
    </label>
  `}function oc(e){document.getElementById(`gcv-clase-list`)?.addEventListener(`click`,async t=>{let n=t.target.closest(`.gcv-clase-card`);if(!n)return;let r=n.dataset.claseId;r&&r!==qs&&await nc(r,e)})}function sc(e,t){document.getElementById(`gcv-search`)?.addEventListener(`input`,e=>{let t=e.target.value.toLowerCase().trim();document.querySelectorAll(`.inscrito-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`}),document.querySelectorAll(`.disponible-item`).forEach(e=>{let n=!t||(e.dataset.name||``).includes(t)||(e.dataset.instrumento||``).includes(t);e.style.display=n?``:`none`})}),document.getElementById(`gcv-btn-nuevo`)?.addEventListener(`click`,()=>{document.getElementById(`gcv-new-form`)?.classList.remove(`d-none`),document.getElementById(`gcv-nuevo-nombre`)?.focus()}),document.getElementById(`gcv-btn-cancelar-nuevo`)?.addEventListener(`click`,cc),document.getElementById(`gcv-btn-guardar-nuevo`)?.addEventListener(`click`,async()=>{let n=document.getElementById(`gcv-nuevo-nombre`).value.trim(),r=document.getElementById(`gcv-nuevo-instrumento`).value.trim(),i=document.getElementById(`gcv-nuevo-telefono`).value.trim();if(!n||!r||!i){P.error(`Nombre, instrumento y teléfono son obligatorios`);return}let a=document.getElementById(`gcv-btn-guardar-nuevo`);a.disabled=!0,a.innerHTML=`<span class="gcv-spinner-sm"></span> Guardando...`;try{await de(e,(await Le({nombre_completo:n,instrumento_principal:r,familiar_telefono:i,activo:!0})).id),P.success(`${n} registrado e inscrito exitosamente`),Js=(await Re().catch(()=>Js)).filter(e=>e.activo!==!1&&e.is_active!==!1),await nc(e,t)}catch(e){P.error(`Error: `+e.message),a.disabled=!1,a.innerHTML=`<i class="bi bi-floppy"></i> Guardar e inscribir`}}),document.getElementById(`gcv-lista-inscritos`)?.addEventListener(`click`,async n=>{let r=n.target.closest(`.desinscribir-btn`);if(!r)return;let i=r.dataset.alumnoId,a=r.closest(`.gcv-student-row`)?.querySelector(`.gcv-student-name`)?.textContent||`este alumno`;if(confirm(`¿Quitar a ${a} de esta clase?`)){r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span>`;try{await le(e,i),P.success(`${a} quitado de la clase`),await nc(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-x"></i>`}}}),document.getElementById(`gcv-btn-inscribir`)?.addEventListener(`click`,async()=>{let n=[...document.querySelectorAll(`#gcv-lista-disponibles .gcv-checkbox:checked`)];if(!n.length){P.error(`Seleccioná al menos un alumno`);return}let r=document.getElementById(`gcv-btn-inscribir`);r.disabled=!0,r.innerHTML=`<span class="gcv-spinner-sm"></span> Inscribiendo...`;try{for(let t of n)await de(e,t.value);P.success(`${n.length} alumno${n.length>1?`s`:``} inscrito${n.length>1?`s`:``} correctamente`),await nc(e,t)}catch(e){P.error(`Error: `+e.message),r.disabled=!1,r.innerHTML=`<i class="bi bi-person-check"></i> Inscribir seleccionados`}})}function cc(){let e=document.getElementById(`gcv-new-form`);e&&e.classList.add(`d-none`),[`gcv-nuevo-nombre`,`gcv-nuevo-instrumento`,`gcv-nuevo-telefono`].forEach(e=>{let t=document.getElementById(e);t&&(t.value=``)})}function lc(){return`
    <div class="gcv-root">
      <div class="gcv-header">
  ...
  `}var dc=[`login`,`logout`,`register`,`pending-approval`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`ruta-detalle`,`gestionar-clases`],fc=new Set([`hoy`,`calendario`,`metricas`,`perfil`,`ruta`,`gamificacion`,`crear-clase`,`planificacion`,`ruta-libreria`]);function pc(e,t,n){[`login`,`logout`,`calendario`,`clases`,`hoy`,`asistencia`,`metricas`,`perfil`,`clase-emergente`,`planificacion`,`alumno`,`gamificacion`,`ruta`,`crear-clase`,`ruta-plan-builder`,`ruta-semanal`,`ruta-libreria`,`gestionar-clases`,`register`,`pending-approval`].forEach(t=>e.on(t,(e,r)=>n(t,r))),e.on(`ruta-detalle/:id`,(e,t)=>n(`ruta-detalle`,t)),e.onNotFound(()=>n(`hoy`))}function mc(){let e=document.getElementById(`pm-view-container`);if(!e)return{};e.innerHTML=``;let t={};return dc.forEach(n=>{let r=document.createElement(`div`);r.id=`pm-view-${n}`,r.className=`pm-view-content`,r.style.display=`none`,e.appendChild(r),t[n]=r}),t}async function hc(e,t,n,r,i){let{maestroId:a,permisos:o,router:s,showLoginScreen:c,cleanupPushService:l,stopRealtime:u,logoutMaestro:d}=i;switch(e){case`login`:Fn(t,{onSuccess:i.onLoginSuccess});break;case`register`:In(t,{onSuccess:()=>s.navigate(`pending-approval`)});break;case`pending-approval`:Ln(t,{onBackToLogin:()=>s.navigate(`login`)});break;case`logout`:c(),l(),u(),d().then(()=>window.location.reload());break;case`calendario`:case`clases`:return await $n(t);case`hoy`:return await Vn(t,{onClaseClick:e=>s.navigate(`asistencia?clase=${e}`)});case`asistencia`:return await _o(t,{claseId:r.get(`clase`),fecha:r.get(`fecha`),sesionId:r.get(`sesion`),router:s});case`metricas`:return On(t);case`perfil`:return wo(t);case`clase-emergente`:return bo(t,{maestroId:a});case`planificacion`:return await Zo(t,{maestroId:a});case`alumno`:return ms(t,{alumnoId:r.get(`id`)||n.id});case`gamificacion`:await ys(t);break;case`ruta`:await As(t,{onTopicSelected:e=>s.navigate(`asistencia?clase=${e}`)});break;case`crear-clase`:zs(t);break;case`ruta-plan-builder`:Bs(t,{alumnoId:r.get(`id`)});break;case`ruta-semanal`:Vs(t,{alumnoId:r.get(`id`)});break;case`ruta-libreria`:Hs.render().then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`ruta-detalle`:Us.render(n).then(e=>{t.innerHTML=``,t.appendChild(e)});break;case`gestionar-clases`:if(!o?.puede_inscribir_clases){s.navigate(`hoy`);return}return await Xs(t);default:break}return null}var gc=!1,_c=null;function vc({isAdmin:e,getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i,onResize:a}){if(gc)return;gc=!0,Bt(()=>{let e=document.getElementById(`pm-notif-badge`);if(!e)return;let t=qt();t>0?(e.textContent=t>9?`9+`:t,e.style.display=`flex`):e.style.display=`none`}),Ht(),Yt(),e||yc({getMaestro:t,getPermisosCached:n,onPermisosUpdate:r,onNavigate:i}),document.addEventListener(`keydown`,e=>{if(An()!==`desktop`||e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)return;window._globalAppKeys||(window._globalAppKeys=[]);let t=window._globalAppKeys;if(t.push(e.key.toLowerCase()),t[t.length-2]===`g`){let n={h:`hoy`,c:`calendario`,r:`ruta`,m:`metricas`,p:`perfil`}[e.key.toLowerCase()];n&&(i(n),t.length=0)}t.length>3&&t.splice(0,t.length-2)});let o=null,s=An();window.addEventListener(`resize`,()=>{clearTimeout(o),o=setTimeout(()=>{let e=An();e!==s&&(s=e,a())},250)},{passive:!0})}function yc({getMaestro:e,getPermisosCached:t,onPermisosUpdate:n,onNavigate:r}){let i=e();i?.id&&(_c&&=(u.removeChannel(_c),null),_c=u.channel(`permisos-maestro:${i.id}`).on(`postgres_changes`,{event:`*`,schema:`public`,table:`permisos_maestros`,filter:`maestro_id=eq.${i.id}`},async e=>{console.log(`[Realtime] Permisos actualizados:`,e.new);try{let e=await N(i.id),r=t(),a=[],o=[];e.puede_inscribir_clases&&!r?.puede_inscribir_clases&&a.push(`Gestionar e Inscribir Clases`),r?.puede_inscribir_clases&&!e.puede_inscribir_clases&&o.push(`Gestionar e Inscribir Clases`),await n(e,{ganados:a,perdidos:o}),a.length>0?P.success(`¡Nuevos permisos activados: ${a.join(`, `)}! Ahora podés acceder desde el Perfil o la barra de navegación.`):o.length>0?P.show(`El administrador removió tu acceso a: ${o.join(`, `)}.`,`warning`):P.show(`Tus permisos fueron actualizados por el administrador.`,`info`)}catch(e){console.warn(`[Realtime] Error actualizando permisos:`,e.message)}}).subscribe(e=>console.log(`[Realtime] Canal permisos_maestros:`,e)),window.addEventListener(`beforeunload`,()=>u.removeChannel(_c),{once:!0}))}if(l(),`serviceWorker`in navigator){let e=async()=>{try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`[PWA] Service Worker registered:`,e.scope)}catch(e){console.log(`[PWA] Service Worker registration failed:`,e)}};document.readyState===`complete`?e():window.addEventListener(`load`,e)}else `serviceWorker`in navigator;it(),et({windowMs:6e4,max:100}),Qe({enabled:!1,consent:!1}),st({debug:!1}),v({dsn:null,environment:`production`}),window.addEventListener(`showToast`,e=>{let{message:t,type:n=`info`}=e.detail||{};t&&P.show(t,n)});var bc=null,xc=null,Sc=!1,$=yt();window.router=$;var Cc={},wc=null,Tc=new Set;function Ec(e){let t=[{id:`calendario`,label:`Calendario`,icon:`bi-calendar3`},{id:`hoy`,label:`Hoy`,icon:`bi-house-door`},{id:`planificacion`,label:`Plan`,icon:`bi-signpost-split`},{id:`metricas`,label:`Métricas`,icon:`bi-bar-chart-line`}];return e?.puede_inscribir_clases&&t.push({id:`gestionar-clases`,label:`Clases`,icon:`bi-mortarboard`}),t}async function Dc(e){let{tabla:t,operacion:n,payload:r}=e,i={...r};t===`sesiones_clase`&&(i.contenido_dsl!==void 0&&(i.contenido=i.contenido_dsl,delete i.contenido_dsl),i.asistencias!==void 0&&i.asistencia===void 0&&(i.asistencia=i.asistencias,delete i.asistencias)),console.log(`[SYNC] Intentando ${n} en ${t}:`,i);try{if(n===`insert`){let{error:e}=await u.from(t).insert([i]);if(e)throw e}else if(n===`update`){let{id:e,...n}=i,{error:r}=await u.from(t).update(n).eq(`id`,e);if(r)throw r}else if(n===`delete`){let{error:e}=await u.from(t).delete().eq(`id`,i.id);if(e)throw e}}catch(e){if(e.code===`PGRST204`){let{data:e}=await u.from(t).select().limit(1);e?.length>0?console.warn(`[SYNC] Columnas REALES encontradas:`,Object.keys(e[0])):console.warn(`[SYNC] No se pueden leer las columnas. ¿Ejecutaste el SQL en Supabase?`)}throw console.error(`[SYNC] Error crítico:`,e),e}}var Oc=null;async function kc(){let e=document.getElementById(`pm-sync-indicator`);if(e)try{let t=await S();t.length===0?(e.className=`pm-online-dot synced`,e.title=`Sincronizado`):(e.className=`pm-online-dot pending`,e.title=`Pendiente (${t.length})`)}catch{e.className=`pm-online-dot error`,e.title=`Error de sincronización`}}async function Ac(){clearTimeout(Oc),Oc=setTimeout(async()=>{if(navigator.onLine)try{await x(Dc)}finally{await kc()}},1e3)}window.addEventListener(`online`,Ac),window.addEventListener(`offline`,kc);function jc(){Tc.clear()}function Mc(e){Tc.delete(e)}async function Nc(e,t={},{silent:n=!1}={}){let r=window.location.search||(window.location.hash.includes(`?`)?window.location.hash.split(`?`)[1]:``),i=new URLSearchParams(r),a=e.split(`?`)[0];if(!n){let e=document.getElementById(`pm-header`);if(e?.classList.contains(`search-active`)){e.classList.remove(`search-active`);let t=document.getElementById(`pm-header-search-input`);t&&(t.value=``)}Mn(a),window.pwaInstaller?.evaluateInsights()}let o=Cc[a];if(!o){console.warn(`[Router] Contenedor no encontrado: ${a}`);return}if(n||(typeof wc==`function`&&(wc(),wc=null),Object.values(Cc).forEach(e=>{e.style.display=`none`,e.classList.remove(`active`)}),o.style.display=`block`,o.offsetHeight,o.classList.add(`active`)),Tc.has(a))return;let s=setTimeout(()=>{o.querySelectorAll(`.pm-loading-overlay`).forEach(e=>e.remove());let e=document.createElement(`div`);e.className=`pm-loading pm-loading-overlay`,e.innerHTML=`<div class="pm-spinner"></div>`,o.prepend(e)},300);try{let e=await hc(a,o,t,i,{maestroId:bc?.id,permisos:xc,router:$,showLoginScreen:Fc,cleanupPushService:ne,stopRealtime:()=>{},logoutMaestro:_t,onLoginSuccess:()=>Rc()});e&&(wc=e),clearTimeout(s),o.querySelector(`.pm-loading-overlay`)?.remove(),fc.has(a)&&Tc.add(a)}catch(e){clearTimeout(s),o.innerHTML=`<p class="pm-error">Error cargando vista: ${e.message}</p>`}}function Pc(e,t,n){bc=t,xc=n||xc,Nn(e,t,Ec(xc),(e,t)=>$.navigate(e,t),kc),document.getElementById(`pm-sync-indicator`)?.addEventListener(`click`,async e=>{e.target.classList.contains(`error`)&&await Ac()});let r=($.currentRoute?.()||`hoy`).split(`?`)[0];Mn(r)}function Fc(){let e=document.getElementById(`portal-app`);if(!e)return;let t=[`login`,`register`,`pending-approval`],n=($.currentRoute?.()||`login`).split(`?`)[0];if(t.includes(n)&&n!==`login`){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Cc,mc()),Ic(),$.setAuthGuard(()=>gt.isAuthenticated(),t),$.start();return}let r=Cc.login;if(r){jn(),r.style.display=`block`,r.innerHTML=``,hc(`login`,r,{},new URLSearchParams,{router:$,onLoginSuccess:e=>{e&&e!==`login`?$.navigate(e):Rc()}});return}e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`,Object.assign(Cc,mc()),Ic(),$.setAuthGuard(()=>gt.isAuthenticated(),t),history.replaceState({route:`login`},``,`/login`),Nc(`login`)}function Ic(){pc($,Sc,Nc)}async function Lc(){if(bc)try{let e=new Date,t=e.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),r=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,[a,o,c]=await Promise.all([n(),n().then(e=>i(e.map(e=>e.id))),n().then(()=>s(bc.id,r,r))]),l=Object.fromEntries(a.map(e=>[e.id,e]));await re(o.filter(e=>e.dia?.toLowerCase()===t).map(e=>({...e,clase_nombre:l[e.clase_id]?.nombre||`Clase`})),c.filter(e=>e.borrador===!1||e.estado===`registrada`).map(e=>e.clase_id))}catch(e){console.warn(`[Alerts] Error programando alertas:`,e.message)}}async function Rc(){let e=document.getElementById(`portal-app`);if(!e)return;console.log(`[Init] Iniciando Portal...`);let t=await gt.init();if(console.log(`[Init] Auth:`,t?`con maestro`:`sin maestro`),gt.isPendingApproval()){console.log(`[Init] Cuenta pendiente de aprobación — mostrando pantalla de espera`),document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Cc,mc(!1)),Ic(),history.replaceState({route:`pending-approval`},``,`/pending-approval`),Nc(`pending-approval`);return}let n=[`login`,`register`,`pending-approval`],i=(window.router||$).currentRoute().split(`?`)[0],a=n.includes(i);if(!t&&!a){Fc();return}if(!t&&a){document.getElementById(`pm-view-container`)||(e.innerHTML=`<main class="pm-view" id="pm-view-container"></main>`),Object.assign(Cc,mc()),Ic(),$.setAuthGuard(()=>gt.isAuthenticated(),n),$.start();return}if(t.es_admin&&!t.es_maestro){console.log(`[Init] Admin puro detectado → redirigiendo a /admin`),window.location.href=`/admin`;return}let o=null;try{o=await N(t.id)}catch(e){console.warn(`[Init] Error fetching permissions:`,e.message)}Pc(e,t,o),Object.assign(Cc,mc()),vc({isAdmin:!1,getMaestro:()=>bc,getPermisosCached:()=>xc,onPermisosUpdate:async(t,{ganados:r,perdidos:i})=>{let a=($.currentRoute?.()||`perfil`).split(`?`)[0],o=a===`gestionar-clases`&&!t.puede_inscribir_clases||a===`pending-approval`&&r.length>0?`hoy`:a;Pc(e,bc,t),Object.assign(Cc,mc()),Ic(),$.setAuthGuard(()=>gt.isAuthenticated(),n),Tc.clear(),await Nc(o),$.navigate(o)},onNavigate:e=>$.navigate(e),onResize:()=>{Pc(e,bc,xc),Object.assign(Cc,mc());let t=($.currentRoute?.()||`hoy`).split(`?`)[0];Mn(t)}}),xt(Mc,jc),Ic(),$.setAuthGuard(()=>gt.isAuthenticated(),n),$.start();let s=($.currentRoute?.()||``).split(`?`)[0];(!s||s===`login`||s===`logout`)&&$.navigate(`hoy`),r().then(async()=>{let e=[`hoy`,`calendario`,`metricas`],t=($.currentRoute?.()||`hoy`).split(`?`)[0];await e.filter(e=>e!==t&&!Tc.has(e)).reduce((e,t)=>e.then(()=>{if(Cc[t])return Nc(t,{},{silent:!0})}),Promise.resolve()),Lc(),window.pwaInstaller?.evaluateInsights()}).catch(e=>console.warn(`[Prefetch] Error:`,e.message)),Ac()}var zc=(e,t,n,r)=>`
  ...
  </div>`;window.addEventListener(`error`,e=>{if([`useCache`,`WebSocket`,`content.js`].some(t=>(e.message||``).includes(t))){console.warn(`[Ignored Error]`,e.message);return}y(Error(e.message),{context:`window.error`,filename:e.filename,lineno:e.lineno});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=zc(`bi-x-circle-fill`,`Ups! Algo salió mal`,`Se ha producido un error inesperado en la aplicación.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">${e.message}</div><div style="color:rgba(255,255,255,0.4);">${e.filename?.split(`/`).pop()}:${e.lineno}</div>`))}),window.addEventListener(`unhandledrejection`,e=>{y(e.reason instanceof Error?e.reason:Error(String(e.reason)),{context:`unhandledRejection`});let t=document.getElementById(`portal-app`);t&&(t.innerHTML=zc(`bi-exclamation-triangle-fill`,`Error de Sincronización`,`Hubo un problema al procesar una solicitud de red.`,`<div style="color:#ef4444;font-weight:bold;margin-bottom:8px;">Promise Rejection</div><div style="color:rgba(255,255,255,0.4);">${String(e.reason)}</div>`))}),Rc().catch(e=>{let t=document.getElementById(`portal-app`);t&&(t.innerHTML=`<div style="padding:20px;color:red;font-family:monospace;background:#fff;z-index:9999;position:fixed;top:0;left:0;right:0;bottom:0;overflow:auto;"><h2>❌ initPortal() falló</h2><pre>${e?.message||e}\n${e?.stack||``}</pre></div>`)});