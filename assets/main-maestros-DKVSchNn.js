...
import{A as e,Ct as t,H as n,N as r,S as i,St as a,Tt as o,V as s,W as c,X as l,_ as u,_t as d,a as f,at as p,bt as m,c as h,ct as g,dt as _,g as v,gt as y,i as b,k as x,l as S,lt as C,m as w,mt as T,o as E,rt as D,s as O,t as k,v as A,vt as ee,wt as te,x as ne,xt as re,y as ie,yt as j}from"./adminNotificacionesView-CfDDszjU.js";import{i as M}from"./supabase-DJmkTfk1.js";import{a as ae,i as oe,n as se,r as N,t as ce}from"./maestroAuth-BmUoS2wq.js";import{t as le}from"./idb-DOPm7uLh.js";import{i as ue,n as de,t as fe}from"./offlineQueue-Cjwl3aiF.js";import{a as pe,c as me,d as he,f as ge,i as _e,l as ve,n as P,r as ye,s as be,t as xe,u as Se}from"./pushService-BGEnW8G7.js";import"./vendor-BhXhnmkW.js";import{t as F}from"./AppToast-BOjiJExQ.js";import{t as Ce}from"./preload-helper-CsoeaaUJ.js";import{t as I}from"./academicService-76BH8TVA.js";import{a as we,c as Te,i as L,l as Ee,n as De,o as Oe,r as ke,s as Ae,t as je}from"./portalUtils-CisZ9vg-.js";import{t as Me}from"./AppModal-DIPPctm9.js";import{a as Ne,c as Pe,i as Fe,o as Ie,s as Le,t as Re}from"./groqService-CzM57djA.js";import{n as ze,t as Be}from"./ausenciaModal-CZgtaMUH.js";import{n as Ve,r as He,t as Ue}from"./reportService-BNTcQUH_.js";import{r as We,t as Ge}from"./permisoService-B2O2fSHa.js";var Ke=[`useCache`,`WebSocket closed without opened`,`Could not establish connection`,`Receiving end does not exist`,`chrome-extension://`,`polyfill`,`content.js`,`Failed to load module script`,`net::ERR_BLOCKED_BY_CLIENT`];function qe(e=``){let t=String(e).toLowerCase();return Ke.some(e=>t.includes(e.toLowerCase()))}var Je=console.error;console.error=function(...e){e.length>0&&!qe(e[0])&&Je.apply(console,e)};var Ye=console.warn;console.warn=function(...e){e.length>0&&!qe(e[0])&&Ye.apply(console,e)},window.addEventListener(`unhandledrejection`,e=>{qe(String(e.reason||``))&&(e.preventDefault(),e.stopImmediatePropagation())},!0),window.addEventListener(`error`,e=>{qe(e.message||``)&&(e.preventDefault(),e.stopImmediatePropagation())},!0);var Xe=window.fetch;window.fetch=async function(...e){try{return await Xe.apply(window,e)}catch(e){if(!qe(e.message))throw e;return null}};var Ze=!1;function Qe(e={}){let{dsn:t,environment:n=`development`,tracesSampleRate:r=.1}=e;if(t&&typeof window<`u`&&window.Sentry){let e=[];window.Sentry.Replay&&e.push(new window.Sentry.Replay({maskAllText:!0,blockAllMedia:!0})),window.Sentry.init({dsn:t,environment:n,tracesSampleRate:r,integrations:e,replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}),Ze=!0,console.log(`[ErrorReporter] Initialized:`,n)}}function $e(e,t={}){if(!Ze&&!window.Sentry)return;let{userId:n,context:r,level:i=`error`,...a}=t;n&&window.Sentry?.setUser({id:n}),r&&window.Sentry?.setTag(`context`,r),Object.keys(a).length>0&&window.Sentry?.setContext(`details`,a),e instanceof Error?(window.Sentry?.captureException(e,{level:i}),console.error(`[Error] ${e.message}`,e)):(window.Sentry?.captureMessage(String(e),i),console.warn(`[${i}] ${e}`))}var et=!1;function tt(e={}){let{enabled:t=!1,consent:n=!1}=e;et=t&&n,console.log(`[Analytics] Initialized, enabled:`,et)}var nt={windowMs:6e4,max:100};function rt(e={}){nt={...nt,...e},console.log(`[RateLimit] Initialized: ${nt.max} requests per ${nt.windowMs}ms`)}var it=null,at=new Set;function ot(e=32){let t=``,n=new Uint32Array(e);if(typeof crypto<`u`&&crypto.getRandomValues)crypto.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(Math.random()*62);for(let r=0;r<e;r++)t+=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789`[n[r]%62];return t}function st(e={}){it=ot(e.length||32),at.clear(),at.add(it),console.log(`[CSRF] Initialized`)}var ct={LCP:null,FID:null,CLS:null,FCP:null,TTFB:null};function lt(){return typeof window>`u`?!1:typeof PerformanceObserver<`u`}function ut(e={}){let{debug:t=!1,onReport:n=null}=e;if(!lt()){console.warn(`[WebVitals] Not supported in this environment`);return}console.log(`[WebVitals] Initialized`),dt(t,n),ft(t,n),pt(t,n),mt(t,n),ht(t,n)}function dt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries(),i=r[r.length-1];ct.LCP=i.value,e&&console.log(`[LCP]`,i.value),t&&t(`LCP`,i.value)}).observe({entryTypes:[`largest-contentful-paint`]})}catch{e&&console.log(`[LCP] Not available`)}}function ft(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ct.FID=r.value,e&&console.log(`[FID]`,r.value),t&&t(`FID`,r.value)}).observe({entryTypes:[`first-input`]})}catch{e&&console.log(`[FID] Not available`)}}function pt(e,t){try{let n=0;new PerformanceObserver(r=>{for(let e of r.getEntries())e.hadRecentInput||(n+=e.value);ct.CLS=n,e&&console.log(`[CLS]`,n),t&&t(`CLS`,n)}).observe({entryTypes:[`layout-shift`]})}catch{e&&console.log(`[CLS] Not available`)}}function mt(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ct.FCP=r.value,e&&console.log(`[FCP]`,r.value),t&&t(`FCP`,r.value)}).observe({entryTypes:[`paint`]})}catch{e&&console.log(`[FCP] Not available`)}}function ht(e,t){try{new PerformanceObserver(n=>{let r=n.getEntries()[0];ct.TTFB=r.responseStart,e&&console.log(`[TTFB]`,r.responseStart),t&&t(`TTFB`,r.responseStart)}).observe({entryTypes:[`navigation`]})}catch{e&&console.log(`[TTFB] Not available`)}}var R={maestro:null,loading:!0,listeners:[]},gt=null,_t=!1;function vt(){R.listeners.forEach(e=>e({...R}))}var yt={subscribe(e){return R.listeners.push(e),()=>{R.listeners=R.listeners.filter(t=>t!==e)}},async init(){_t=!0;try{if(console.log(`[usePortalAuth.init] Iniciando...`),R.maestro=N(),console.log(`[usePortalAuth.init] Maestro local:`,R.maestro?`found`:`not found`),R.loading=!0,vt(),typeof process<`u`&&{}.VITEST)return R.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado (Test Env)`),R.maestro;if(!gt){let{data:{subscription:e}}=M.auth.onAuthStateChange(async(e,t)=>{if(console.log(`[usePortalAuth] Evento de auth disparado: ${e}`),_t&&(e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)){console.log(`[usePortalAuth] Ignorando SIGNED_IN durante inicialización (lo maneja init())`);return}if(e===`SIGNED_OUT`||e===`USER_DELETED`){localStorage.removeItem(`portal-maestros:maestro`),R.maestro=null,vt();let e=[`login`,`register`,`pending-approval`],t=(window.router?.currentRoute?.()||`login`).split(`?`)[0];e.includes(t)||(console.log(`[usePortalAuth] Sesión inactiva o expirada en ruta privada. Recargando aplicación...`),window.location.reload())}else if((e===`SIGNED_IN`||e===`TOKEN_REFRESHED`)&&t?.user){let e=N();if(!e||e.user_id!==t.user.id){console.log(`[usePortalAuth] Nueva sesión detectada. Sincronizando datos de maestro...`);try{let e=await se();e&&(R.maestro=e,vt())}catch(e){console.warn(`[usePortalAuth] Error sincronizando maestro post-login:`,e.message)}}}});gt=e}try{console.log(`[usePortalAuth.init] Iniciando detectarRolMaestro() con timeout de 8s...`);let e=new Promise((e,t)=>setTimeout(()=>t(Error(`Auth timeout after 8s`)),8e3)),t=await Promise.race([se(),e]);console.log(`[usePortalAuth.init] detectarRolMaestro completado:`,t?`con datos`:`sin datos`),R.maestro=t}catch(e){console.warn(`[usePortalAuth.init] Error:`,e.message),R.maestro=null}return R.loading=!1,vt(),console.log(`[usePortalAuth.init] Completado`),R.maestro}finally{_t=!1}},setMaestro(e){R.maestro=e,R.loading=!1,vt()},async logout(){await ae(),R.maestro=null,vt()},getMaestro:()=>R.maestro,isAuthenticated:()=>!!R.maestro,isLoading:()=>R.loading},bt=yt.logout,xt=`calendario`;function St(){let e=new Map,t=null,n=null,r=null,i=[`login`],a=!1;function o(){let e=window.location.pathname,t=window.location.hash;return t&&t!==`#`?t.replace(`#/`,``).replace(`#`,``):e&&e!==`/`?e.replace(`/`,``):xt}function s(e,t=[`login`]){r=e,i=t,a=!0}let c=null;function l(e,t={}){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.pushState({route:`login`},``,`#/login`),h(`login`);return}if(a&&r&&i.includes(e)&&r()){history.replaceState({route:xt},``,`#/${xt}`),h(xt);return}t&&Object.keys(t).length>0&&(c=t,n=null);let o=`#/${e}`;history.pushState({route:e},``,o),h(e)}function u(e){if(a&&r&&!i.includes(e)&&!r()){localStorage.setItem(`intended-route`,e),history.replaceState({route:`login`},``,`#/login`),h(`login`);return}let t=`#/${e}`;history.replaceState({route:e},``,t),h(e)}function d(t,n){e.set(t,n)}function f(e){t=e}let p=null;function m(e){let t=e.querySelector(`h1, h2, [role="main"]`);t&&(t.hasAttribute(`tabindex`)||t.setAttribute(`tabindex`,`-1`),t.focus({preventScroll:!0}))}function h(r){if(n===r&&n!==null)return;n=r;let i=r.split(`?`)[0],a=e.get(i),o={};if(!a){for(let[t,n]of e.entries())if(t.includes(`:`)){let e=`^`+t.replace(/:[^\s/]+/g,`([^\\/]+)`)+`$`,r=new RegExp(e),s=i.match(r);if(s){a=n,t.match(/:[^\s/]+/g).forEach((e,t)=>{o[e.substring(1)]=s[t+1]});break}}}c&&=(o={...o,...c},null);let s=a||t;if(!s)return;let l=async()=>{typeof s==`function`&&await s(r,o)};if(!document.startViewTransition||p){p&&=(p.skipTransition(),null);let e=document.querySelector(`.pm-view-content.active`);e&&(e.classList.remove(`pm-animate-fade-in`,`pm-view-enter`,`pm-view-enter-active`),e.offsetWidth),l();let t=document.querySelector(`.pm-view-content.active`);t&&(t.classList.add(`pm-animate-fade-in`),t.classList.add(`pm-view-enter`),requestAnimationFrame(()=>{t.classList.add(`pm-view-enter-active`),m(t);let e=()=>{t.classList.remove(`pm-view-enter`,`pm-view-enter-active`)};t.addEventListener(`transitionend`,e,{once:!0}),setTimeout(e,250)}));return}try{let e=document.startViewTransition(async()=>{await l()});p=e;let t=e=>e.catch(()=>{});t(e.ready),t(e.updateCallbackDone),t(e.finished),e.finished.finally(()=>{p=null;let e=document.querySelector(`.pm-view-content.active`);e&&requestAnimationFrame(()=>m(e))})}catch{p=null,l()}}function g(){window.addEventListener(`popstate`,e=>{e.state?.route?h(e.state.route):h(o())}),l(o())}return{currentRoute:o,setAuthGuard:s,navigate:l,replace:u,on:d,onNotFound:f,start:g,_dispatch:h}}var Ct=null,wt=null;function Tt(e,t=`polite`){Ct||(Ct=document.createElement(`div`),Ct.setAttribute(`aria-live`,t),Ct.setAttribute(`aria-atomic`,`true`),Ct.classList.add(`pm-visually-hidden`),document.body.appendChild(Ct)),t===`assertive`?(Ct.setAttribute(`role`,`alert`),Ct.setAttribute(`aria-live`,`assertive`)):(Ct.removeAttribute(`role`),Ct.setAttribute(`aria-live`,`polite`)),clearTimeout(wt),wt=setTimeout(()=>{Ct.textContent=``,requestAnimationFrame(()=>{Ct.textContent=e})},50)}function Et(e,t){if(!e||!e.id)return;Dt(e);let n=`${e.id}-error`,r=document.createElement(`span`);r.id=n,r.className=`pm-field-error`,r.setAttribute(`role`,`alert`),r.textContent=t,e.nextSibling?e.parentNode.insertBefore(r,e.nextSibling):e.parentNode.appendChild(r),e.setAttribute(`aria-invalid`,`true`),e.setAttribute(`aria-describedby`,n)}function Dt(e){if(e&&(e.removeAttribute(`aria-invalid`),e.removeAttribute(`aria-describedby`),e.id)){let t=document.getElementById(`${e.id}-error`);t&&t.remove()}}function Ot(e){(e||document).querySelectorAll(`[aria-invalid="true"]`).forEach(e=>Dt(e))}function kt(e,{onSuccess:t}){e.innerHTML=`
  ...
  `,e.querySelector(`[data-route="login"]`)?.addEventListener(`click`,e=>{e.preventDefault(),t?t():(history.pushState({route:`login`},``,`#/login`),window.dispatchEvent(new PopStateEvent(`popstate`,{state:{route:`login`}})))})}async function Mt(e,{onClaseClick:t}={}){e.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let n=N();if(!n){e.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}let r=new Date,i=r.toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),o=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,`0`)}-${String(r.getDate()).padStart(2,`0`)}`;try{let s=await d(n.id,o);if(s&&s.length>0){e.innerHTML=Nt(s,i,r),Ft(e,o,n.id);return}let c=await m();if(!c||c.length===0){e.innerHTML=`<p class="pm-empty">No tienes clases asignadas.</p>`;return}let l=c.map(e=>e.id),u=Object.fromEntries(c.map(e=>[e.id,e])),f=(await ee(l)).filter(e=>e.dia?.toLowerCase()===i).sort((e,t)=>e.hora_inicio.localeCompare(t.hora_inicio));if(!f||f.length===0){e.innerHTML=`
        <h2 class="pm-date-header">${ke(i)} ${we(r)}</h2>
        <p class="pm-empty">No tienes clases hoy.</p>
      `;return}let p=new Date(r);p.setDate(p.getDate()-3);let h=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,`0`)}-${String(p.getDate()).padStart(2,`0`)}`,g=new Date(r);g.setDate(g.getDate()-1);let _=`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,`0`)}-${String(g.getDate()).padStart(2,`0`)}`,v=(await a(n.id,h,_)||[]).filter(e=>{if(!l.includes(e.clase_id))return!1;let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return!t&&!(e.borrador===!1&&n)}),y=(await a(n.id,o,o)).filter(e=>l.includes(e.clase_id)).filter(e=>{let t=Array.isArray(e.asistencia)&&e.asistencia.length>0,n=typeof e.contenido==`string`&&e.contenido.trim().length>0;return t||e.borrador===!1&&n}),b=new Set(y.map(e=>e.clase_id)),x=await j(l),S={};for(let e of x||[])e.clase_id&&(S[e.clase_id]=(S[e.clase_id]||0)+1);let C=[...new Set(f.map(e=>e.salon_id).filter(Boolean))],w=C.length>0?await re(C):[],T=Object.fromEntries(w.map(e=>[e.id,e.nombre])),E=f.map(e=>{let t=u[e.clase_id],n=b.has(t.id),r=S[t.id]||0,i=n?`registrada`:`sin-registrar`,a=n?`<span class="pm-badge pm-badge-success"><i class="bi bi-check-circle-fill me-1"></i>Registrada</span>`:`<span class="pm-badge pm-badge-danger">Sin registrar</span>`;return`
      ...
      <div class="pm-pendientes-banner">
        <div class="pm-pendientes-header">
          ...
          <span>${v.length===1?`1 clase sin registrar de los últimos días`:`${v.length} clases sin registrar de los últimos días`}</span>
        </div>
        <div class="pm-pendientes-list">
          ${v.map(e=>{let t=u[e.clase_id];if(!t)return``;let n=e.fecha?e.fecha.split(`-`).reverse().slice(0,2).join(`/`):`—`;return`
...
4. Discusión y reseña`,recursos:`Audio, videos, partituras de referencia`,evaluacion_metodo:`Participación en discusión, trabajo escrito`},{id:`blanco`,nombre:`En blanco`,objetivos:``,contenido:``,recursos:``,evaluacion_metodo:``}];function Dr(e,t=null,n=[],r=[],i={},a){let o=e===`edit`&&!!t,s=o?t:{...i};!o&&i.contenido&&!s.notas_dsl&&(s.notas_dsl=i.contenido),!o&&i.maestro_nombre&&!r.find(e=>e.nombre===i.maestro_nombre)&&(r=[{id:i.maestro_id,nombre:i.maestro_nombre},...r]);let c=new y(s),l=document.getElementById(`pm-planificacion-modal`);if(l&&l.remove(),l=document.createElement(`div`),l.id=`pm-planificacion-modal`,l.className=`pm-plan-modal-overlay`,l.innerHTML=kr(o,c,n,r),document.body.appendChild(l),!document.getElementById(`pm-plan-modal-styles`)){let e=document.createElement(`style`);e.id=`pm-plan-modal-styles`,e.textContent=Ar(),document.head.appendChild(e)}let u=()=>{l.classList.remove(`open`),setTimeout(()=>l.remove(),200)};l.querySelector(`.pm-plan-close-x`).onclick=u,l.querySelector(`.pm-plan-cancel-btn`).onclick=u,l.querySelector(`.pm-plan-backdrop`).onclick=u;let d=e=>{e.key===`Escape`&&(u(),document.removeEventListener(`keydown`,d))};document.addEventListener(`keydown`,d);let f=l.querySelector(`#pl-plantilla`);f&&f.addEventListener(`change`,e=>{let t=Er.find(t=>t.id===e.target.value);t&&t.id!==`blanco`&&(l.querySelector(`#pl-objetivos`).value=t.objetivos,l.querySelector(`#pl-contenido`).value=t.contenido,l.querySelector(`#pl-recursos`).value=t.recursos,l.querySelector(`#pl-evaluacion`).value=t.evaluacion_metodo,Mr(l))});let m=l.querySelector(`#pl-clase_id`);m&&m.addEventListener(`change`,()=>{let e=l.querySelector(`#pl-instrumento`);if(e){let t=e.value;e.innerHTML=`<option value="">Todos los instrumentos</option>${Nr(n,m.value,null)}`,e.querySelector(`option[value="${t}"]`)&&(e.value=t)}}),jr(l);let h=l.querySelector(`#dsl-editor-container`);if(h){let e=p({onSelect:async e=>{let n=(await C()).filter(t=>e.includes(t.id)).map(e=>`#${e.nombre_completo}`).join(`, `);t.component&&t.component.insertText(n+` `)}});document.body.appendChild(e);let t=T({initialContent:c.notas_dsl||``,onChange:(e,t)=>{let n=l.querySelector(`#dsl-summary`);n&&(n.textContent=Fr(t))},onAlumnoClick:()=>e.openModal()});h.appendChild(t),l._dslEditor=t}let g=l.querySelector(`.pm-plan-save-btn`);g.onclick=async()=>{let e=l.querySelector(`#pl-tema`)?.value.trim(),t=l.querySelector(`#pl-clase_id`)?.value;if(!e){l.querySelector(`#pl-tema`).focus();return}if(!t){l.querySelector(`#pl-clase_id`).focus();return}g.disabled=!0,g.innerHTML=`<span class="pm-plan-spinner"></span> Guardando...`;try{let n=l.querySelector(`#pl-recursos`)?.value||``,r=l._dslEditor,i={clase_id:t,maestro_id:l.querySelector(`#pl-maestro_id`)?.value||null,instrumento:l.querySelector(`#pl-instrumento`)?.value||null,tema:e,fecha_inicio:l.querySelector(`#pl-fecha_inicio`)?.value||null,objetivos:l.querySelector(`#pl-objetivos`)?.value.trim(),contenido:l.querySelector(`#pl-contenido`)?.value.trim(),recursos:n.split(`,`).map(e=>e.trim()).filter(Boolean),evaluacion_metodo:l.querySelector(`#pl-evaluacion`)?.value.trim(),observaciones:l.querySelector(`#pl-observaciones`)?.value.trim(),notas_dsl:r?r.getContent():``,estado:o&&l.querySelector(`#pl-estado`)?.value||`planificado`};a&&await a(i),u()}catch(e){console.error(`[planificacionModal] Error:`,e),g.disabled=!1,g.textContent=o?`Guardar cambios`:`Guardar`}};let _=l.querySelector(`.pm-plan-body`);if(_){let e=document.createElement(`div`);e.style.cssText=`display:flex;gap:1rem;align-items:flex-start`;let t=document.createDocumentFragment();for(;_.firstChild;)t.appendChild(_.firstChild);let r=document.createElement(`div`);r.style.cssText=`flex:1;min-width:0`,r.appendChild(t),e.appendChild(r),e.insertAdjacentHTML(`beforeend`,`
      ...
      </div>`),_.appendChild(e);let i=l.querySelector(`#pl-clase_id`);if(i&&(i.addEventListener(`change`,()=>{let e=i.value;if(!e)return;let t=n.find(t=>t.id===e);t?.instrumento&&t?.plan_estudio&&Or(t.instrumento,t.plan_estudio,l)}),c.clase_id)){let e=n.find(e=>e.id===c.clase_id);e?.instrumento&&e?.plan_estudio&&Or(e.instrumento,e.plan_estudio,l)}}requestAnimationFrame(()=>{l.classList.add(`open`),l.querySelector(`#pl-tema`)?.focus()})}async function Or(e,t,n){let r=n.querySelector(`#pl-curriculo-body`);if(r){r.innerHTML=`<div class="text-center py-2"><div class="spinner-border spinner-border-sm text-muted"></div></div>`;try{let n=await D(e,t);if(!n){r.innerHTML=`<p class="text-muted small text-center py-2">Sin guía curricular<br>para ${e} — ${t}</p>`;return}r.innerHTML=n.curriculo_pilares.map(e=>`
      <div class="mb-2">
...
`),s=[];for(let e of o){let t=on(e);if(!t.estados||t.estados.length===0||!t.contenido||t.contenido.length===0)continue;let n=t.estados[0],r=t.contenido[0],i=t.alumnos.length>0?t.alumnos:[`todos`],a=t.calificacion?.valor??null;s.push({alumnos:i,contenido:r,tipo:`tecnica`,estado:n,nota:a,tarea:t.tareas[0]||null,observacion:t.sugerencias[0]||null,es_colectivo:i.includes(`todos`)})}return s.length===0?{saved:[],errors:[]}:Ki({sesionId:e,claseId:t,maestroId:n,fechaHoy:r,progressRecords:s,alumnos:a})}async function Ji({claseId:e,objetivos:t}){if(!e||!t||t.length===0)return{linked:0};let{data:n,error:r}=await M.from(`progresos`).select(`id, contenido_dsl`).eq(`clase_id`,e).is(`objetivo_id`,null).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``);if(r)return console.warn(`[Progress] linkProgresosToObjetivos fetch error:`,r.message),{linked:0};if(!n||n.length===0)return{linked:0};let i=t.map(e=>({id:e.id,norm:Vi(e.descripcion),raw:e.descripcion})),a=new Map;for(let e of n){let t=Vi(e.contenido_dsl);if(!t)continue;let n=i.find(e=>e.norm===t);if(!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&e.norm.includes(t))),!n&&t.length>=5&&(n=i.find(e=>e.norm.length>=5&&t.includes(e.norm))),n){let t=a.get(n.id)||[];t.push(e.id),a.set(n.id,t)}}if(a.size===0)return{linked:0};let o=0;for(let[e,t]of a.entries()){let{error:n}=await M.from(`progresos`).update({objetivo_id:e}).in(`id`,t);n?console.warn(`[Progress] linkProgresosToObjetivos update error:`,n.message):o+=t.length}return console.debug(`[Progress] linkProgresosToObjetivos: linked ${o} records`),{linked:o}}var Yi={LOGRADO:{label:`Logrado`,color:`var(--pm-success, #198754)`,bg:`#19875418`},EN_PROGRESO:{label:`En Progreso`,color:`var(--pm-primary, #0d6efd)`,bg:`#0d6efd18`},INICIADO:{label:`Iniciado`,color:`var(--pm-muted,   #6c757d)`,bg:`#6c757d18`}},Xi=[`LOGRADO`,`EN_PROGRESO`,`INICIADO`];function Zi(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}var Qi={CONDUCTA:{label:`conducta`,icon:`🚨`},ATENCION:{label:`atención`,icon:`🔔`},RIESGO_PEDAGOGICO:{label:`riesgo pedagógico`,icon:`📉`}};function $i(e){let t={};for(let n of e){let e=n.alertaTipo??n.alertDetails?.type??`CONDUCTA`;t[e]=(t[e]??0)+1}return`${Object.entries(t).map(([e,t])=>{let n=Qi[e]??{label:e.toLowerCase(),icon:`⚠️`};return`${n.icon} ${t} ${n.label}${t>1?`s`:``}`}).join(` · `)} — revisá antes de guardar`}function ea(e,{onConfirm:t,onCancel:n}){let r=[],i=null;function a(e){let t=e.scope||(e.es_colectivo?`grupo`:`individual`),n=e.alumnos||[];if(e.requires_confirmation)return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;switch(t){case`grupo`:case`all`:return`<span class="ppp-scope-chip ppp-scope--all">👥 Todos los presentes</span>`;case`grupo_excluyendo`:case`group_excluding`:return`<span class="ppp-scope-chip ppp-scope--excluding">👥 Resto del grupo</span>`;case`subgrupo_indeterminado`:case`subgroup_unknown`:return`<span class="ppp-scope-chip ppp-scope--unknown">❓ Subgrupo sin identificar</span>`;default:return n.length?n.length===1?`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Zi(n[0])}</span>`:`<span class="ppp-scope-chip ppp-scope--individual">👤 ${Zi(n.join(`, `))}</span>`:``}}function o(e,t){let n=Yi[e.estado]??Yi.EN_PROGRESO,r=e.nota?` · ${Zi(e.nota)}/5`:``,i=e.tarea?`<div class="ppp-tarea">📝 ${Zi(e.tarea)}</div>`:``,o=!!e.alerta,s=a(e);if(o){let n=Qi[e.alertaTipo]??{label:`Alerta pedagógica`,icon:`⚠️`};return`
  ...
  `,document.head.appendChild(e)}var Ia=null;function La(){Ia===null&&(Ia=setInterval(()=>{document.visibilityState!==`hidden`&&Ca()},la))}function Ra(){Ia!==null&&(clearInterval(Ia),Ia=null)}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`?(Ca(),La()):Ra()});function za(){let e=new Date().toISOString().split(`T`)[0];q=q.filter(t=>String(t.id).startsWith(`local_`)?t.referencia_id?.includes(e):!0)}za(),document.visibilityState!==`hidden`&&La();async function Ba(e,{onError:t,silent:n=!1}={}){try{return await e()}catch(e){return console.error(`[safeAsync]`,e),t?t(e):n||F!==void 0&&F&&F.error(`Error inesperado: `+(e.message||e)),null}}async function Va(e,{sesionId:t,fecha:n,maestro:r}){try{let{data:i,error:a}=await M.from(`sesiones_clase`).select(`*`).eq(`id`,t).single();if(a||!i){e.innerHTML=`<p class="pm-empty">Sesión no encontrada.</p>`;return}let o=n||i.fecha||new Date().toISOString().split(`T`)[0],s={id:t,nombre:i.actividad||`Clase Emergente`,instrumento:``};localStorage.setItem(`pm_active_clase_id`,t);let c=Array.isArray(i.asistencia)?i.asistencia:[],l=c.map(e=>e.alumno_id).filter(Boolean),u=[];if(l.length>0){let{data:e}=await M.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,l);u=e||[]}let d={};u.forEach(e=>{d[e.id]=null}),c.forEach(e=>{e.estado&&u.some(t=>t.id===e.alumno_id)&&(d[e.alumno_id]=e.estado)}),Ua(e,{clase:s,horario:null,alumnos:u,estado:d,justificaciones:{},maestro:r,fechaHoy:o,claseId:null,sesionId:t,hasConflict:!1,serverDSL:i.contenido||``,snapshots:[],salonNombre:null,rutaId:null,sesionExistenteData:i})}catch(t){console.error(`[asistenciaView] Error en sesión emergente:`,t.message,t.stack),e.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${L(t.message)}</p>`}}async function Ha(e,{claseId:t,fecha:n,sesionId:r}={}){let i=typeof e==`string`?document.getElementById(e):e;if(!i){console.error(`[asistenciaView] Container not found:`,e);return}i.innerHTML=`<div class="pm-loading"><div class="pm-spinner"></div></div>`;let a=N();if(!a){i.innerHTML=`<p class="pm-empty">No hay sesión activa.</p>`;return}if(!t){if(r)return Va(i,{sesionId:r,fecha:n,maestro:a,containerOrId:e});i.innerHTML=`<p class="pm-empty">No se indicó la clase.</p>`;return}localStorage.setItem(`pm_active_clase_id`,t);let o=n||new Date().toISOString().split(`T`)[0];try{let e=new Date().toLocaleDateString(`es-ES`,{weekday:`long`}).toLowerCase(),[n,r,s,c]=await Promise.all([m(),ee([t]),j([t]),M.from(`sesiones_clase`).select(`*`).eq(`clase_id`,t).eq(`maestro_id`,a.id).eq(`fecha`,o).order(`borrador`,{ascending:!0}).order(`updated_at`,{ascending:!1}).limit(1)]);console.log(`[DEBUG] Finished Batch 1`);let l=n.find(e=>e.id===t);if(!l){console.log(`[DEBUG] Clase not found in misClases`),i.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Clase no encontrada.</p>`;return}let u=r.find(t=>t.dia?.toLowerCase()===e),d=(s||[]).map(e=>e.alumnos).filter(Boolean).sort((e,t)=>{let n=(e.instrumento_principal||``).localeCompare(t.instrumento_principal||``);return n===0?(e.nombre_completo||``).localeCompare(t.nombre_completo||``):n}),f=c.data?.[0],p=Array.isArray(f?.asistencia)?f.asistencia.map(e=>e?.alumno_id).filter(Boolean):[];if(f?.tipo===`emergente`&&p.length>0){let e=new Set(p),t=new Set(d.map(e=>e.id)),n=p.filter(e=>!t.has(e));if(n.length>0)try{let{data:e}=await M.from(`alumnos`).select(`id, nombre_completo, instrumento_principal`).in(`id`,n);d=d.concat(e||[])}catch(e){console.warn(`[asistencia] No se pudieron cargar alumnos extra de clase emergente:`,e)}d=d.filter(t=>e.has(t.id))}let h=f?.id||null,g=f?.updated_at||null,_=f?.contenido||``,v=l.salon?[l.salon]:[],[y,b]=await Promise.all([h?M.from(`class_session_content_snapshots`).select(`*`).eq(`session_id`,h).then(e=>e.data||[]):Promise.resolve([]),v.length>0?re(v):Promise.resolve([])]);console.log(`[DEBUG] Finished Batch 2`);let x=b.length>0?b[0].nombre:null,S=`pm_asistencia_${t||h}_${o}`,C=localStorage.getItem(`${S}_updated`),w=!1;g&&C&&new Date(g).getTime()>new Date(C).getTime()+5e3&&(w=!0);let T=null;try{let e=n?.find(e=>e.id===t)?.instrumento;if(e){let t=e.split(`,`)[0].trim().toLowerCase(),{data:n}=await M.from(`routes`).select(`id, route_versions!inner(id)`).ilike(`instrument`,`%${t}%`).eq(`route_versions.status`,`published`).limit(1).maybeSingle();T=n?.route_versions?.[0]?.id||n?.route_versions?.id||null}}catch(e){console.warn(`[asistencia] No se pudo resolver route_version_id:`,e)}let E={},D={};d.forEach(e=>{E[e.id]=null});let O=f?.asistencia||[];if(O.length===0&&h)try{let{data:e}=await M.from(`asistencias`).select(`alumno_id, estado`).eq(`sesion_clase_id`,h);if(e?.length>0){console.log(`[asistencia] Restaurando desde tabla asistencias:`,e.length);let t={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};O=e.map(e=>({alumno_id:e.alumno_id,estado:t[e.estado]??e.estado}))}}catch(e){console.warn(`[asistencia] No se pudo restaurar desde tabla asistencias:`,e)}let k={presente:`P`,ausente:`A`,justificado:`J`,tarde:`T`};O.forEach(e=>{if(Object.prototype.hasOwnProperty.call(E,e.alumno_id)){let t=k[e.estado]??e.estado;E[e.alumno_id]=t}});let A=[];if(h)try{A=await M.from(`justificaciones`).select(`alumno_id`).eq(`sesion_id`,h).then(e=>e.data||[]),A.forEach(e=>{Object.prototype.hasOwnProperty.call(E,e.alumno_id)&&(E[e.alumno_id]=`J`)})}catch(e){console.warn(`[asistencia] No se pudieron restaurar justificaciones:`,e)}Ua(i,{clase:l,horario:u,alumnos:d,estado:E,justificaciones:D,maestro:a,fechaHoy:o,claseId:t,sesionId:h,hasConflict:w,serverDSL:_,snapshots:y,salonNombre:x,rutaId:T,sesionExistenteData:f})}catch(e){console.error(`[asistenciaView] Error fatal:`,e.message,e.stack),i.innerHTML=`<p class="pm-empty" style="color:var(--pm-danger)">Error: ${L(e.message)}</p>`}}function Ua(e,n){let{clase:r,horario:i,alumnos:a,estado:o,justificaciones:u,maestro:d,fechaHoy:f,claseId:p,snapshots:h,serverDSL:g,hasConflict:_,salonNombre:v,rutaId:y,sesionExistenteData:b}=n,x=n.sesionId,S=[],C=`pm_asistencia_${p}_${f}`,w=g,T=null,E=Bi(),D=null;if(!document.getElementById(`pm-asist-badge-styles`)){let e=document.createElement(`style`);e.id=`pm-asist-badge-styles`,e.textContent=`
      .pm-badge { 
      ...
      <div class="pm-asist-header">
        ...
        <div style="flex:1">
          ...
          <p class="pm-asist-subtitle">
            ${v?`📍 ${L(v)} · `:``}
            ${i?`${Oe(i.hora_inicio)} – ${Oe(i.hora_fin)} · `:``}
            <span style="color:var(--pm-primary); font-weight:700;">${we(new Date(f+`T12:00:00`))}</span> · 
            ${a.length} alumnos
          </p>
        </div>
    ...
    <!-- Modales... -->
  `;let O=e.querySelector(`#pm-dsl-toolbar-container`),k=e.querySelector(`#pm-dsl-editor-container`),A=_r(k,{initialContent:g,onChange:e=>{w=e}});A.setContext({claseId:p});let ee=br(e,{onAceptar:e=>{A.setValue(e)}}),te=fn(e,{onAccept:e=>{A.setValue(e)}}),ne=ea(k.parentNode,{onConfirm:async t=>{try{let n=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]})),{saved:r,errors:i}=await Ki({sesionId:x,claseId:p,maestroId:d.id,fechaHoy:f,progressRecords:t,alumnos:n});i.length&&console.warn(`[Progress] Errores parciales:`,i);let o=e.querySelector(`#btn-guardar`);o&&(o.style.removeProperty(`display`),o.click())}catch(t){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F.error(`Error al guardar progreso: `+t.message)}},onCancel:()=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`)}}),re=oa(e.querySelector(`#pm-planificacion-dropdown`)||e,{onAdopt:async({instrumento:e,nivel:t,resumen:n,pilares:r})=>{try{let{curriculo:i,allObjetivos:a}=await l({instrumento:e,nivel:t,descripcion:n,pilares:r}),{linked:o}=await Ji({claseId:p,objetivos:a}),s=o>0?`Plan creado · ${o} registro${o===1?``:`s`} vinculado${o===1?``:`s`}`:`Plan curricular creado correctamente.`;F.success(s)}catch(e){F.error(`Error al crear el plan: `+e.message)}},onCancel:()=>{}}),ie=mn(O,{onInsert:(e,t,n)=>A.insertText(e,t,n),getEditorContent:()=>A.getValue(),onLoading:e=>{},onIaProposal:async e=>{},onImproveClick:async e=>{let t=O.querySelector(`#btn-generar-informe`);t&&(t.disabled=!0);try{let t=await Fe(e);ee.open({original:e,improved:t})}catch(e){F.error(`Error al generar informe: `+e.message)}finally{t&&(t.disabled=!1)}},onStructureClick:async e=>{let t=O.querySelector(`#btn-ia-magic`);t&&(t.disabled=!0);try{let t=D?.getActiveIndicador(),n=await Ie(e,{presentes:a.filter(e=>o[e.id]===`P`).map(e=>e.nombre_completo),indicadorActivo:t?.nombre||null});te.open({original:e,dsl:n})}catch(e){F.error(`Error al estructurar con IA: `+e.message)}finally{t&&(t.disabled=!1)}},onAnalyzeClick:async t=>{await Ba(async()=>{let n=a.filter(e=>o[e.id]&&o[e.id]!==`A`),i=(e,t)=>{let n=e.trim().split(/\s+/),r=n[0];return t.filter(e=>e.trim().split(/\s+/)[0]===r).length>1?n.slice(0,2).join(` `):r},s=a.map(e=>e.nombre_completo||e.nombre||``),c={alumnos:a.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),presentes:n.map(e=>{let t=e.nombre_completo||e.nombre||``;return{id:e.id,nombre:t,nombreCorto:i(t,s)}}),tipoClase:De(r),instrumento:r.instrumento||``,sesionesRecientes:(h||[]).slice(-2).map(e=>e.contenido||``).filter(Boolean),indicadorActivo:D?.getActiveIndicador()?.nombre||``};e.querySelector(`#btn-guardar`)?.style.setProperty(`display`,`none`);let l=await Re(t,c);if(!l?.progreso?.length){e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.warning(`La IA no detectó registros de progreso en este texto.`);return}ne.open({progreso:l.progreso,resumen:l.resumen})},{onError:t=>{e.querySelector(`#btn-guardar`)?.style.removeProperty(`display`),F!==void 0&&F&&F.error(`Error al analizar con IA: `+t.message)}})}}),j=null,ae=e.querySelector(`#pm-planificacion-card`),oe=e.querySelector(`#pm-planificacion-dropdown`),se=e.querySelector(`#pm-planificacion-nombre`);e.querySelector(`#pm-planificacion-detail`);let N=e.querySelector(`#pm-plan-list-rutas`),ce=e.querySelector(`#pm-plan-list-planificaciones`),le=e.querySelector(`#pm-planificacion-header`);le&&le.addEventListener(`click`,()=>{let e=ae.classList.toggle(`open`);oe.style.display=e?`block`:`none`}),e.querySelectorAll(`.pm-plan-tab-pill`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.pm-plan-tab-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let n=t.dataset.tab;N.style.display=n===`rutas`?``:`none`,ce.style.display=n===`planificaciones`?``:`none`})});function ue(t){j=t.id,localStorage.setItem(`pm_default_plan_${p}`,t.id),se&&(se.textContent=t.nombre||t.name||`Sin nombre`),ce.querySelectorAll(`.pm-plan-item`).forEach(e=>{e.classList.toggle(`active`,e.dataset.planId===t.id)}),D&&=(D.destroy(),null);let n=e.querySelector(`#pm-route-tree-container`),r=e.querySelector(`#pm-active-tema-badge`);j&&n&&(n.innerHTML=``,Pe(p).then(e=>{D=Yr(n,{claseId:p,rutaId:j,completedTopics:e,onIndicadorSelect:e=>{A.insertText(`[${e.nombre}] `),ie.setContext({indicadorActivo:e.nombre}),r&&(r.textContent=e.nombre,r.style.display=`inline-block`),ae.classList.remove(`open`),oe.style.display=`none`}}),S.push(()=>D.destroy())}))}let de=e.querySelector(`#btn-manage-planning`);de&&(de.onclick=e=>{if(e.stopPropagation(),!j){Me.open({title:`Atención`,body:`<p>Seleccioná una planificación primero para poder gestionarla.</p>`,confirmText:`Entendido`,hideCancel:!0});return}Me.open({title:`Gestionar Estructura: ${se.textContent}`,size:`xl`,body:`<div id="modal-route-config-root"></div>`,saveText:`Cerrar y Actualizar`,onSave:async()=>(D&&D.refresh(),!0)});let t=document.getElementById(`modal-route-config-root`);t&&Ir(t,j)}),ae&&(async()=>{try{let e=await W.getClasses(d?d.id:null),t=localStorage.getItem(`pm_default_plan_${p}`),n=(r.instrumento||``).toLowerCase().split(`,`).map(e=>e.trim()),i=e.filter(e=>{if(e.id===t)return!0;let r=(e.nombre||``).toLowerCase();return n.some(e=>r.includes(e))});N&&(N.innerHTML=i.length?i.map(e=>`
            ...
            </div>`).join(``),ce.querySelectorAll(`.pm-plan-item`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.find(e=>e.id===t.dataset.planId);n&&ue(n)})})),ae.style.display=``;let a=e.find(e=>e.id===t)||i[0]||await W.resolveSmartPlan(r);a&&ue(a)}catch(e){console.warn(`[asistencia] Error cargando planificación unificada:`,e)}})();let pe=e.querySelector(`#btn-proponer-curriculo`);pe&&(pe.onclick=async()=>{pe.disabled=!0,pe.innerHTML=`<i class="bi bi-hourglass-split"></i> Analizando...`;try{let e=await na(p,12);if(e.registros.length===0){F.error(`No hay registros de progreso suficientes en las últimas 12 semanas para generar una propuesta.`);return}let t=await Ne(e,{instrumento:r?.instrumento||``,nivel:``,nombreClase:r?.nombre||``});re.open({pilares:t.pilares,resumen:t.resumen,instrumento:r?.instrumento||``,nivel:``})}catch(e){F.error(`Error al generar propuesta: `+e.message)}finally{pe.disabled=!1,pe.innerHTML=`<i class="bi bi-stars"></i> Proponer plan curricular con IA`}});let me=e.querySelector(`#btn-copy-as-plan`);me&&me.addEventListener(`click`,async()=>{let e=A.getValue();Dr(`create`,null,await m(),[],{clase_id:p,maestro_id:d?.id||null,maestro_nombre:d?.nombre_completo||null,contenido:e||``,fecha_inicio:f},async e=>{try{await c({...e,estado:`planificado`});let t=document.createElement(`div`);t.className=`pm-toast-success`,t.innerHTML=`
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
              <polyline points="22 4 12 14.01 9 11.01"/>
            </svg>
            Planificación creada exitosamente
          `,document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}catch(e){console.error(`[asistencia] Error guardando planificación:`,e),F.error(`Error al guardar la planificación: `+(e.message||e))}})}),y&&(D=Yr(e.querySelector(`#pm-route-tree-container`),{claseId:p,rutaId:y,onIndicadorSelect:t=>{A.insertText(`[${t.nombre}] `),ie.setContext({indicadorActivo:t.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``)}}),S.push(()=>D.destroy())),console.log(`[DEBUG] Reached handoff section`);let he=Mi();if(he&&he.claseId===p){let t=`[${he.nombre}] `;A.insertText(t),ie.setContext({indicadorActivo:he.nombre});let n=e.querySelector(`#btn-guardar-obs`);n&&(n.style.display=``);let r=e.querySelector(`#pm-dsl-editor-container`);if(r){let e=document.createElement(`div`);e.style.cssText=`
      ...
      `,e.innerHTML=`
        ...
        ">✕</button>
      `,r.parentElement.insertBefore(e,r)}}let ge=Ni(document.body,{onDelete:async({alumnoId:e,justificacionId:t,existingUrl:n})=>{if(n){let e=n.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&M.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}t&&Ri(t).catch(console.warn),o[e]=null,delete u[e],xe(e),I(),await Te(!0),Tt(`Justificación eliminada.`)},onSave:async({alumnoId:e,motivo:t,evidenciaFile:n,justificacionId:r,existingUrl:i,isEdit:a})=>{let o=document.getElementById(`pm-justif-save`);o&&(o.disabled=!0);try{let o=null;if(a&&r){let e=i;if(n){if(i){let e=i.match(/\/storage\/v1\/object\/public\/[^/]+\/(.+)/);e&&await M.storage.from(`documentos`).remove([e[1]]).catch(()=>{})}let{data:t}=await M.storage.from(`documentos`).upload(`justificaciones/${Date.now()}_${Math.random().toString(36).slice(2)}.${n.name.split(`.`).pop()}`,n).catch(()=>({data:null}));if(t){let{data:n}=M.storage.from(`documentos`).getPublicUrl(t.path);e=n.publicUrl}}let{data:a,error:s}=await M.from(`justificaciones`).update({motivo:t,evidencia_url:e}).eq(`id`,r).select().single();if(s)throw s;o=a}else{x||await Te(!0,!1);let r=await Ii({sesionId:x,alumnoId:e,claseId:p,fecha:f,motivo:t,creadoPor:d.id},n);if(r.error)throw r.error;o=r.data}o&&(u[e]=o),ge.close()}catch(e){console.error(`[justificacion] Error guardando:`,e),alert(`Error al guardar la justificación: `+e.message)}finally{o&&(o.disabled=!1)}},onCancel:(e,t)=>{o[e]=t,xe(e),I()}});S.push(()=>{try{ge.close()}catch{}});let _e=null,ve=e.querySelector(`#pm-draft-indicator`);if(x){_e=Ti({saveFn:async e=>{x&&await Ei(x,d.id,e)},debounceMs:3e4}),_e.onSaved(()=>{let e=new Date;ve.textContent=`Borrador guardado ${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`,ve.style.display=``}),A.getValue;let e=k.querySelector(`#pm-dsl-editable`);if(e){let t=e.oninput;e.oninput=function(e){t&&t.call(this,e),_e&&_e.onInput(A.getValue())}}S.push(()=>_e.destroy()),b?.borrador===!0&&Di(x,d.id).then(e=>{if(e&&e.contenido_raw&&e.contenido_raw.trim()){let t=e.updated_at?new Date(e.updated_at).toLocaleString(`es-AR`):``;confirm(`Hay un borrador guardado${t?` (${t})`:``}.\n\n¿Deseas recuperarlo?`)?(A.setValue(e.contenido_raw),w=e.contenido_raw):Oi(e.id).catch(e=>console.warn(`[autoDraft] Error discarding:`,e))}}).catch(e=>console.warn(`[autoDraft] Error loading draft:`,e))}e.querySelector(`#pm-academic-tools`);let P=e.querySelector(`#btn-guardar-obs`);P&&(y&&(P.style.display=``),P.onclick=async()=>{let t=A.getValue();if(!t||!t.trim()){F.warning(`El editor está vacío. Escribe observaciones antes de guardar.`);return}if(!x){F.warning(`Primero guarda la sesión (asistencia) para poder registrar observaciones.`);return}let n=null,i=await Le(t),s=D?.getActiveIndicador();if(n=i||s,!n){F.warning(`Seleccione un indicador en la ruta antes de guardar la observación o escríbalo entre corchetes [Ejemplo].`);return}let c=e.querySelector(`#pm-active-tema-badge`);c&&n.nombre&&(c.textContent=n.nombre,c.style.display=`inline-block`),P.disabled=!0,P.textContent=`Procesando...`;try{let i=a.filter(e=>o[e.id]===`P`),s=await ni(t,n.id,i,n.nombre);if(s.error)throw Error(s.error);if(s.modo===`natural`&&s.dslGenerado&&!confirm(`📝 Texto convertido a formato estructurado:

`+s.dslGenerado+`

¿Guardar la evaluación?`)){P.disabled=!1,P.textContent=`Guardar observación`;return}if(s.missing.length>0&&!confirm(`Faltan ${s.missing.length} alumno(s) sin evaluar:\n${s.missing.join(`, `)}\n\n¿Guardar de todas formas?`)){P.disabled=!1,P.textContent=`Guardar observación`;return}if(s.evaluaciones.length>0){let{error:e}=await ei(x,n.id,s.evaluaciones,d.id,i);if(e)throw e}let c={indicador_id:n.id,evaluaciones:s.evaluaciones};await ki(x,d.id,t,c,s.dslGenerado||null,s.textoMejorado||null);let l=on(t);if(l.estados&&l.estados.length>0){let e=a.map(e=>({id:e.id,nombre:e.nombre_completo||e.nombre||``,nombreCorto:(e.nombre_completo||e.nombre||``).split(` `)[0]}));qi({sesionId:x,claseId:p,maestroId:d.id,fechaHoy:f,dslText:t,alumnos:e}).then(({saved:e,errors:t})=>{t.length&&console.warn(`[Progress DSL] Errores:`,t),e.length&&ke(e,k)}).catch(e=>console.warn(`[Progress DSL] Error:`,e.message))}let u=await zi(x,p,d.id,s.evaluaciones,r.nombre||`Clase`,i);u.success||console.warn(`[Fase C] Fallo parcial en promoción:`,u.error),D&&await D.refresh(),A.setValue(``),w=``;let m=document.createElement(`div`);if(m.innerHTML=`
        ...
        `,m.style.cssText=`position:fixed;bottom:80px;left:50%;transform:translateX(-50%);background:var(--pm-surface, #1e1e1e);color:#fff;padding:12px 24px;border-radius:12px;z-index:10000;font-size:14px;font-weight:600;box-shadow:0 8px 24px rgba(0,0,0,0.3); border: 1px solid var(--apple-success, #22c55e);`,document.body.appendChild(m),setTimeout(()=>m.remove(),4500),s.evaluaciones.length>0&&p&&n?.nombre){let{saved:e,error:t}=await Gi({sesionId:x,claseId:p,maestroId:d.id,fechaHoy:f,contenido:n.nombre,evaluaciones:s.evaluaciones});t&&console.warn(`[asistencia] Error al sincronizar progresos:`,t)}if(x){let{academicService:t}=await Ce(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:n}=await Ce(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BQVYinl0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),r=await t.processSessionClosure(x);r&&r.length>0&&await n(e,r)}P.textContent=`¡Guardado!`,setTimeout(()=>{P.textContent=`Guardar observación`,P.disabled=!1},2e3)}catch(e){console.error(`[asistencia] Error saving observation:`,e),F.error(`Error al guardar: `+(e.message||e)),P.disabled=!1,P.textContent=`Guardar observación`}});let ye=null,be=e.querySelector(`#pm-alumnos-list`);function xe(e=null){let t=Wa(a,o),n=null;if(e){let t=be.querySelector(`[data-id="${e}"]`);t&&(n=t.getBoundingClientRect())}if(be.innerHTML=t.map(e=>Se(e,o[e.id])).join(``),e&&n){let t=be.querySelector(`[data-id="${e}"]`),r=t.getBoundingClientRect(),i=n.top-r.top;t.animate([{transform:`translateY(${i}px)`,opacity:.7},{transform:`translateY(0)`,opacity:1}],{duration:300,easing:`cubic-bezier(0.4, 0, 0.2, 1)`})}}function Se(e,t){return`
    ...
    `}be.onclick=async t=>{let n=t.target.closest(`.pm-asist-btn`),r=t.target.closest(`.pm-asist-nombre`);if(r){let t=r.closest(`.pm-asist-item`).dataset.id,n=a.find(e=>e.id===t);if(y){ye&&ye.destroy(),ye=gi({alumno:n,rutaId:y,sessionId:x,claseId:p,fecha:f,horaInicio:i?.hora_inicio||null}),ye.open(),S.push(()=>{ye&&ye.destroy()});return}let o=h.filter(e=>e.student_id===t);if(o.length===0)try{let{academicService:e}=await Ce(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),n=await e.createSnapshotForStudent(x,t,f);n?(o=n,h.push(...n)):console.warn(`No se encontró planificación activa para el alumno ${t}`)}catch(e){console.error(`Error creando snapshot on-demand:`,e)}yr(e,{student:n,sessionId:x,teacherId:d.id,snapshots:o});return}if(!n)return;let{id:s,action:c}=n.dataset;if(window.navigator.vibrate&&window.navigator.vibrate(10),c===`J`){let e=a.find(e=>e.id===s);if(!e)return;if(o[s]===`J`){let t=u[s]||null;!t&&x&&(t=await Li(x,s),t&&(u[s]=t)),ge.open(e,t,null),Tt(`Editando justificación de ${e.nombre_completo}.`)}else o[s]=`J`,xe(s),I(),await Te(!0),ge.open(e,null,null),Tt(`Justificación marcada para ${e.nombre_completo}.`);return}o[s]=o[s]===c?null:c,xe(s),I();let l=Object.values(o).filter(e=>e===`P`).length,m=Object.values(o).filter(e=>e===`A`).length,g=Object.values(o).filter(e=>e===`J`).length;Tt(`Asistencia actualizada. ${l} presentes, ${m} ausentes, ${g} justificados.`),await Te(!0)};function I(){let t=a.length,n=Object.values(o).filter(e=>e!==null).length,r=e.querySelector(`#pm-progress-wrap`),i=e.querySelector(`#pm-progress-fill`),s=e.querySelector(`#pm-progress-label`);if(n===0){r.style.display=`none`;return}r.style.display=`flex`,i.style.width=`${n/t*100}%`,s.textContent=`${n}/${t}`}async function Te(e=!1,t=!1){T&&clearTimeout(T);let n=async()=>{let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),t={...x?{}:{clase_id:p},maestro_id:d.id,fecha:f,estado:`pendiente`,borrador:!0,asistencia:e||[],contenido:w||``};if(navigator.onLine)try{if(x){let{error:e}=await M.from(`sesiones_clase`).update({...t,updated_at:new Date().toISOString()}).eq(`id`,x);if(!e){localStorage.setItem(`${C}_updated`,new Date().toISOString());return}throw e}else{let{data:e,error:n}=await M.from(`sesiones_clase`).insert([t]).select(`id`).single();if(!n&&e){x=e.id,console.log(`[asistencia] Nueva sesión creada:`,x),localStorage.setItem(`${C}_updated`,new Date().toISOString());return}throw n||Error(`No se pudo crear la sesión`)}}catch(e){console.warn(`[asistencia] Fallo operación directa, usando cola offline:`,e.message)}await fe({tabla:`sesiones_clase`,operacion:x?`update`:`insert`,payload:{...x?{id:x}:{},...t}}),localStorage.setItem(`${C}_updated`,new Date().toISOString())};e?t?await n():await E.run(n):T=setTimeout(()=>{E.run(n).catch(e=>console.error(`[asistencia] Autosave error:`,e))},2e3)}let Ee=e.querySelector(`.pm-asist-actions-fixed`);if(Ee){let e=document.createElement(`button`);e.id=`btn-reporte-dia`,e.className=`pm-asist-btn-obs`,e.innerHTML=`📄 Reporte`,e.title=`Genera el Reporte Diario de Asistencia (PDF)`,e.style.flex=`1`,e.style.display=`none`,e.addEventListener(`click`,async t=>{t.preventDefault(),x&&(e.disabled=!0,e.innerHTML=`⏳...`,await Ue(x),e.disabled=!1,e.innerHTML=`📄 Reporte`)});let t=Ee.querySelector(`#btn-guardar`);Ee.insertBefore(e,t);let n=document.createElement(`button`);n.id=`btn-resumen-mes`,n.className=`pm-asist-btn-obs`,n.innerHTML=`📊 Resumen`,n.title=`Genera el Resumen Mensual de Asistencia (PDF)`,n.style.flex=`1`,n.style.display=`none`;let r=new Date;n.addEventListener(`click`,async e=>{e.preventDefault(),p&&(n.disabled=!0,n.innerHTML=`⏳...`,await Ve(p,r.getFullYear(),r.getMonth()+1),n.disabled=!1,n.innerHTML=`📊 Resumen`)}),Ee.insertBefore(n,t)}e.querySelector(`#btn-guardar`).onclick=async()=>{let n=e.querySelector(`#btn-guardar`),i=n.textContent;n.textContent=`Guardando...`,n.disabled=!0,await E.run(async()=>{try{let i=a.filter(e=>o[e.id]).map(e=>({...p?{clase_id:p}:{},alumno_id:e.id,fecha:f,estado:o[e.id],registrado_por:d.id})),c=i.length>0,l=w&&w.trim().length>0;if(!c&&!l)throw Error(`Debes marcar asistencia o agregar contenido para guardar`);if(await Te(!0,!0),!x){let{data:e}=await M.from(`sesiones_clase`).select(`id`).eq(`clase_id`,p).eq(`maestro_id`,d.id).eq(`fecha`,f).maybeSingle();e&&(x=e.id)}if(c&&p)try{let e=i.map(e=>({...e,...x&&{sesion_clase_id:x}}));await s(e),console.log(`[asistencia] Registradas asistencias individuales:`,e.length)}catch(e){if(console.error(`[asistencia] Error registrando asistencias en bulk:`,e),!navigator.onLine||!x){console.warn(`[asistencia] Encolando asistencias para sync offline...`);for(let e of i)await fe({tabla:`asistencias`,operacion:`upsert`,payload:{clase_id:p,alumno_id:e.alumno_id,fecha:f,estado:e.estado,registrado_por:d.id,...x?{sesion_clase_id:x}:{}}})}else throw Error(`No se pudieron registrar las asistencias individuales: `+e.message)}if(x&&(c||l)){let e=a.filter(e=>o[e.id]).map(e=>({alumno_id:e.id,estado:o[e.id]})),{error:n}=await M.from(`sesiones_clase`).update({borrador:!1,estado:`registrada`,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,x).select();if(n){console.warn(`estado "registrada" no permitido, usando fallback "cerrada":`,n.message);let{error:t}=await M.from(`sesiones_clase`).update({borrador:!1,estado:`cerrada`,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,x).select();t&&(console.warn(`Fallback "cerrada" también falló, actualizando solo borrador:`,t.message),await M.from(`sesiones_clase`).update({borrador:!1,asistencia:e,contenido:w||``,updated_at:new Date().toISOString()}).eq(`id`,x))}t(),qr(`hoy`),qr(`calendario`),qr(`metricas`),Ca().catch(e=>console.warn(`[asistenciaView] Error al actualizar notificaciones:`,e))}if(x){let{academicService:t}=await Ce(async()=>{let{academicService:e}=await import(`./academicService-76BH8TVA.js`).then(e=>e.n);return{academicService:e}},__vite__mapDeps([0,1,2,3])),{createAchievementsSummaryModal:r}=await Ce(async()=>{let{createAchievementsSummaryModal:e}=await import(`./AchievementsSummaryModal-BQVYinl0.js`);return{createAchievementsSummaryModal:e}},__vite__mapDeps([4,5])),i=await t.processSessionClosure(x);i&&i.length>0?(n.textContent=`¡Logros detectados!`,n.style.background=`var(--pm-success)`,await r(e,i)):console.warn(`[asistencia] processSessionClosure devolvió 0 logros (puede que no haya progresos vinculados a esta sesión aún).`)}else console.warn(`[asistencia] No se pudo obtener sesionId para procesar logros.`);n.textContent=`✓ Guardado`,n.style.background=`var(--apple-success)`;let u=Ee?.querySelector(`#btn-reporte-dia`);u&&(u.style.display=``);let m=Ee?.querySelector(`#btn-resumen-mes`);m&&(m.style.display=``);let h=Object.values(o).filter(e=>e===`P`).length,g=Object.values(o).filter(e=>e===`A`).length;Tt(`Sesión guardada exitosamente. ${h} presentes, ${g} ausentes.`);let _=document.createElement(`div`);_.className=`pm-saved-overlay`,_.innerHTML=`
...
`).trim():``}var Fo={LOGRADO:{label:`Logrado`,color:`#198754`,bg:`#19875418`,icon:`✅`},EN_PROGRESO:{label:`En progreso`,color:`#0d6efd`,bg:`#0d6efd18`,icon:`📈`},INICIADO:{label:`Iniciado`,color:`#6c757d`,bg:`#6c757d18`,icon:`🔰`},DIFICULTAD:{label:`Dificultad`,color:`#dc3545`,bg:`#dc354518`,icon:`⚠️`}};async function Io(e,t,n=0){let r=e.querySelector(`#pm-alumno-progresos-root`);if(!r)return;let i=n===0;i&&(r.innerHTML=`<div class="pm-loading-zen"><div class="pm-pulse"></div></div>`);try{let{data:a,error:o}=await M.from(`progresos`).select(`id, contenido_dsl, estado_cualitativo, calificacion, observaciones, fecha_evaluacion, clase_id, indicadores`).eq(`alumno_id`,t).not(`contenido_dsl`,`is`,null).neq(`contenido_dsl`,``).order(`fecha_evaluacion`,{ascending:!1}).range(n,n+19);if(o)throw o;if(!a||a.length===0){i&&(r.innerHTML=`<p style="font-size:0.82rem;color:var(--pm-text-muted);text-align:center;padding:1rem 0;">Sin registros de progreso generados por IA aún.</p>`);return}let s=[...new Set(a.map(e=>e.clase_id).filter(Boolean))],{data:c}=s.length?await M.from(`clases`).select(`id, nombre`).in(`id`,s):{data:[]},l=new Map((c||[]).map(e=>[e.id,e.nombre])),u=new Map;for(let e of a){let t=e.contenido_dsl;u.has(t)||u.set(t,{contenido:t,entries:[]}),u.get(t).entries.push(e)}let d=Array.from(u.values()).map(({contenido:e,entries:t})=>{let n=t[0],r=Fo[n.estado_cualitativo]??Fo.EN_PROGRESO,i=new Date(n.fecha_evaluacion).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`,year:`2-digit`});return`
      ...
      `;return}let{data:a}=await M.from(`alumnos_clases`).select(`clase_id`).eq(`alumno_id`,t).eq(`activo`,!0),o=(a||[]).map(e=>e.clase_id).filter(Boolean),{data:s}=await M.from(`sesiones_clase`).select(`id, clase_id, fecha, contenido_dsl, asistencia`).filter(`asistencia`,`cs`,JSON.stringify([{alumno_id:t}])).order(`fecha`,{ascending:!1}).limit(60),c=(s||[]).map(e=>{let n=e.asistencia?.find(e=>e.alumno_id===t);return n?{fecha:e.fecha,estado:n.estado,clase_id:e.clase_id,sesion_id:e.id,contenido_dsl:e.contenido_dsl,observaciones:n.observaciones||null}:null}).filter(Boolean);new Map(c.map(e=>[e.sesion_id,e.contenido_dsl]));let{data:l}=await M.from(`indicator_attempts`).select(`id, nota, observations, tarea, created_at, indicator_id, covered_by_clase_id`).eq(`student_id`,t).order(`created_at`,{ascending:!1}).limit(30),{data:u}=await M.from(`ausencias`).select(`id, fecha_inicio, fecha_fin, motivo, estado, clase_id`).eq(`alumno_id`,t).order(`fecha_inicio`,{ascending:!1}).limit(10),{data:d}=await M.from(`justificaciones`).select(`sesion_id, motivo, evidencia_url, estado, fecha`).eq(`alumno_id`,t).order(`fecha`,{ascending:!1}),f=new Map((d||[]).map(e=>[e.sesion_id,e])),p=c.length,m=c.filter(e=>e.estado===`P`).length,h=c.filter(e=>e.estado===`A`).length,g=c.filter(e=>e.estado===`J`).length,_=c.filter(e=>e.estado===`T`).length,v=p>0?Math.round(m/p*100):0,y=l?.filter(e=>e.nota!=null&&e.nota!==0)||[],b={};y.forEach(e=>{let t=e.covered_by_clase_id||`sin_clase`;b[t]||(b[t]=[]),b[t].push(e.nota)});let S=Object.values(b).map(e=>e.reduce((e,t)=>e+t,0)/e.length),C=S.length>0?Math.round(S.reduce((e,t)=>e+t,0)/S.length*10)/10:0,w=y.filter(e=>e.nota>=4).length,T=y.length,E=T>0?Math.round(w/T*100):0,D={};c.forEach(e=>{D[e.clase_id]||(D[e.clase_id]={P:0,A:0,J:0,T:0,total:0}),e.estado&&(D[e.clase_id][e.estado]=(D[e.clase_id][e.estado]||0)+1,D[e.clase_id].total++)});let O=new Set([...o,...Object.keys(D)]),{data:k}=O.size>0?await M.from(`clases`).select(`id, nombre, instrumento, nivel`).in(`id`,[...O]):{data:[]},A=new Map((k||[]).map(e=>[e.id,e])),ee=c.filter(e=>e.estado===`P`&&e.contenido_dsl?.trim()),te=l?.filter(e=>e.observations?.trim())||[],ne=`—`;if(r.fecha_nacimiento){let e=new Date(r.fecha_nacimiento),t=new Date;ne=t.getFullYear()-e.getFullYear(),(t.getMonth()<e.getMonth()||t.getMonth()===e.getMonth()&&t.getDate()<e.getDate())&&ne--}let re=r.created_at?new Date(r.created_at).toLocaleDateString(`es-ES`,{month:`long`,year:`numeric`}):`Reciente`,ie=(r.instrumento_principal||``).toLowerCase(),j=`var(--pm-primary)`;(ie.includes(`violin`)||ie.includes(`cuerda`))&&(j=`#FF3B30`),(ie.includes(`piano`)||ie.includes(`teclado`))&&(j=`#FF9500`),ie.includes(`guitarra`)&&(j=`#5856D6`),(ie.includes(`canto`)||ie.includes(`voz`))&&(j=`#AF52DE`),e.innerHTML=`
            ...
            <div class="pm-zen-details-grid">
              <div class="pm-zen-detail">
                ...
                <div style="flex:1;min-width:0;">
                  ...
                  <strong>${x(r.tlf_alumno||r.representante_tlf)||`—`}</strong>
                </div>
