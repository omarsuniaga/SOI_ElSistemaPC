const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushService-DFPonvfY.js","assets/rolldown-runtime-DlOssbPu.js","assets/supabase-KnARm58N.js","assets/maestroAuth-CgmSmLyS.js","assets/permisoService-CO79I3bS.js","assets/permisosSupabase-OUju-023.js","assets/sistemaView-DKwU-O74.js","assets/router-CIpEKvFn.js","assets/vendor-BUMNmNsE.js","assets/vendor-COf7rB16.css","assets/CHANGELOG-B6r9MGGR.js","assets/groqService-mbMO9U99.js","assets/errorReporter-CDvSLm79.js","assets/AppToast-3qbHkRVc.js","assets/ausenciasPanel-DIvICqyN.js","assets/ausenciaModal-ByYaADu0.js","assets/focusTrap-_L6o1rch.js","assets/portalUtils-C92TBVO0.js","assets/AppModal-CBzMtyFx.js"])))=>i.map(i=>d[i]);
import{i as e}from"./supabase-KnARm58N.js";import{i as t,n,o as r}from"./maestroAuth-CgmSmLyS.js";import{a as i,c as a,d as o,f as s,i as c,l,n as u,p as d,r as f}from"./pushService-DFPonvfY.js";import{t as p}from"./focusTrap-_L6o1rch.js";import{t as m}from"./preload-helper-eAV8hweq.js";import{t as h}from"./AppModal-CBzMtyFx.js";import{n as g}from"./phoneUtils-BHeSQPiO.js";import{t as _}from"./sanitize-CA_-Iy3d.js";import{i as v}from"./disponibilidadApi-C8TpT-WN.js";import{n as y}from"./CHANGELOG-B6r9MGGR.js";import{c as b,i as x}from"./portalUtils-C92TBVO0.js";import{t as S}from"./ausenciaModal-ByYaADu0.js";var C={async open(){let e=await u(),t=await c();h.open({title:`Notificaciones`,size:`md`,body:this._renderBody(e,t),saveText:`Hecho`,onShow:e=>this._initLogic(e),onSave:async e=>(await this._handleSave(e),!0)})},_renderBody(e,t){return`
    ...
    </div>`;let r=document.getElementById(`col-izquierda`),i=document.getElementById(`col-derecha`);O(r,n),k(r,n),B(r,n),A(i),j(i,n),M(i),N(i,n),i.insertAdjacentHTML(`beforeend`,`<div id="pm-collaboration-container"></div>`),L(i),R(i),J(n),U(n),Y(),m(async()=>{let{getPermisos:e,solicitarPermiso:t}=await import(`./permisoService-CO79I3bS.js`).then(e=>e.n);return{getPermisos:e,solicitarPermiso:t}},__vite__mapDeps([4,1,5,2])).then(async({getPermisos:e,solicitarPermiso:t})=>{try{let r=await e(n.id),i=document.getElementById(`pm-collaboration-container`);i&&z(i,r,n.id,t)}catch(e){console.warn(`[PerfilView] Error cargando permisos de colaboración:`,e.message)}})}function O(e,t){let n=b(t.nombre_completo);e.insertAdjacentHTML(`beforeend`,`
    ...
    </section>`),P(t)}async function P(e){await I(e.id),document.getElementById(`btn-nueva-necesidad`)?.addEventListener(`click`,()=>{F(e)})}function F(t){h.open({title:`Nueva Solicitud`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
    ...
    </section>`)}function z(e,t,n,r){let i=t?.solicitud_actual,a=i?.solicita_alumnos||!1,o=i?.solicita_clases||!1,s=i?.estado||null;e.innerHTML=`
    <section class="card-apple pm-settings-section" aria-labelledby="collab-title">
      ...
      <div class="pm-collab-cards">
        ${[{key:`alumnos:create`,title:`Registrar Alumnos`,desc:`Dar de alta estudiantes para preparar su inscripción y seguimiento académico.`,icon:`bi-person-plus`,iconClass:`pm-icon-blue`,active:t.puede_registrar_alumnos,pending:a&&s===`pendiente`,pending_alumnos:!0},{key:`clases:enroll`,title:`Crear y Gestionar Clases`,desc:`Crear clases, inscribir alumnos y mantener la secuencia operativa del grupo.`,icon:`bi-journal-bookmark`,iconClass:`pm-icon-teal`,active:t.puede_inscribir_clases,pending:o&&s===`pendiente`,pending_clases:!0}].map(e=>{let t=``,n=``;return e.active?(t=`<span class="pm-collab-badge active"><i class="bi bi-patch-check-fill"></i> Concedido</span>`,n=e.key===`alumnos:create`?`
  ...
  `,e.querySelectorAll(`.pm-collab-request-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let i=t.dataset.key;t.disabled=!0;let a=t.innerHTML;t.innerHTML=`<span class="pm-settings-spinner"></span> Enviando...`;try{await r(n,i),window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Solicitud enviada correctamente. Esperando aprobación admin.`,type:`success`}}));let{getPermisos:t}=await m(async()=>{let{getPermisos:e}=await import(`./permisoService-CO79I3bS.js`).then(e=>e.n);return{getPermisos:e}},__vite__mapDeps([4,1,5,2]));z(e,await t(n),n,r)}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al enviar solicitud: `+e.message,type:`danger`}})),t.disabled=!1,t.innerHTML=a}})}),e.querySelectorAll(`.pm-collab-action-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.route;t===`registrar-alumno`?window.router&&window.router.navigate(`registrar-alumno`):t===`gestionar-clases`&&window.router&&window.router.navigate(`gestionar-clases`)})})}function B(e,t){let n=t.disponibilidad||{},r=!t.especialidad||!t.disponibilidad||Object.keys(t.disponibilidad).length===0;e.insertAdjacentHTML(`beforeend`,`
    <section class="card-apple pm-settings-section ${r?`pm-section-warning`:``}" aria-labelledby="disp-title">
      ...
      <div id="pm-avail-days" class="pm-avail-days" role="list">
        ${E.map(e=>V(e.key,n[e.key]||[],e.label)).join(``)}
      </div>
    </section>`)}function V(e,t,n){let r=t.length>0;return`
...
`);throw Error(e)}let{error:c}=await e.from(`maestros`).update({nombre_completo:r,tlf:i,especialidad:a}).eq(`id`,t.id);if(c)throw c;let l={...t,nombre_completo:r,nombre:r,telefono:i,tlf:i,especialidad:a,disponibilidad:o};localStorage.setItem(n,JSON.stringify(l)),T.dirty=!1,window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Perfil actualizado`,type:`success`}})),window.pwaInstaller&&window.pwaInstaller.evaluateInsights()}catch(e){window.dispatchEvent(new CustomEvent(`showToast`,{detail:{message:`Error al guardar: `+e.message,type:`danger`}}))}finally{T.saving=!1,s.disabled=!1,s.innerHTML=c}}function G(){let e={};return E.forEach(({key:t})=>{let n=[];document.querySelectorAll(`[data-dia="${t}"].pm-avail-franja`).forEach(e=>{let t=e.querySelector(`[data-field="inicio"]`)?.value,r=e.querySelector(`[data-field="fin"]`)?.value;t&&r&&n.push({inicio:t,fin:r})}),e[t]=n}),e}function K(){h.open({title:`¿Cerrar Sesión?`,size:`sm`,body:`
      ...
      </div>`,saveText:`Salir`,cancelText:`Cancelar`,onSave:async()=>(await r(),window.location.reload(),!0)})}function q(e){let t=e===`system`?window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`:e;document.documentElement.setAttribute(`data-bs-theme`,t),document.documentElement.setAttribute(`data-portal-theme`,t),document.documentElement.classList.toggle(`pm-dark`,t===`dark`),document.querySelectorAll(`.pm-theme-opt`).forEach(t=>{t.setAttribute(`aria-checked`,t.dataset.theme===e?`true`:`false`),t.classList.toggle(`active`,t.dataset.theme===e)}),localStorage.setItem(`portal-maestros-theme`,e),T.theme=e}function J(e){let t=!e.especialidad||!e.disponibilidad||Object.keys(e.disponibilidad||{}).length===0,n=document.getElementById(`pm-banner-perfil-incompleto`);n&&(t?(n.style.display=`block`,n.innerHTML=`
      ...
      </div>`):n.style.display=`none`)}function Y(){document.querySelectorAll(`.card-apple`).forEach((e,t)=>{e.style.opacity=`0`,e.style.transform=`translateY(12px)`,setTimeout(()=>{e.style.transition=`opacity 0.4s ease, transform 0.4s ease`,e.style.opacity=`1`,e.style.transform=`translateY(0)`},50*t)})}var X=`
  .pm-profile-alert {
    grid-column: 1 / -1;
    padding: 0 0 0.5rem;
  }
...
`;if(!document.getElementById(`pm-avail-styles`)){let e=document.createElement(`style`);e.id=`pm-avail-styles`,e.textContent=X,document.head.appendChild(e)}export{D as renderPerfilView};