import"./modulepreload-polyfill-Ke7zwH0v.js";import{i as e}from"./supabase-KnARm58N.js";import"./vendor-BUMNmNsE.js";/* empty css                        */import{t}from"./horarioBuilderView-TcvhxPqC.js";async function n(t){let{data:n}=await e.from(`profiles`).select(`rol`).eq(`id`,t).maybeSingle();return[`admin`,`superadmin`,`coordinacion_academica`,`direccion`].includes(n?.rol)}function r(t,a=null){t.style.background=``,t.innerHTML=`
