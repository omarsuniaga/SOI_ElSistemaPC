const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ausenciaForm-BDf-hvX8.js","assets/supabase-BryBf0UA.js","assets/ausenciaHistorial-wV6MFpoc.js","assets/jspdf.es.min-B4LpO49P.js","assets/rolldown-runtime-tcWNtVWY.js","assets/preload-helper-CQ36nxok.js","assets/typeof-C7CwdyHk.js","assets/jspdf.plugin.autotable-BYntMLuC.js","assets/configView-rcmNnMjH.js","assets/pushService-BMnXDTUe.js","assets/maestroAuth-C_VNWKdh.js","assets/importView-CiLpJE3y.js","assets/reportService-Dvm4weUC.js","assets/groqService-CNWH1ut_.js","assets/AppToast-L43yfvBt.js"])))=>i.map(i=>d[i]);
import{n as e}from"./rolldown-runtime-tcWNtVWY.js";import{$ as t,B as n,C as r,Ct as i,D as a,E as o,F as s,Ft as c,G as l,H as u,J as d,K as f,L as p,O as m,P as h,Q as g,R as ee,S as te,St as ne,T as _,U as re,V as ie,W as ae,X as oe,Y as se,Z as ce,_ as le,_t as ue,a as de,at as fe,b as pe,bt as me,c as he,ct as ge,d as _e,dt as ve,et as ye,f as be,ft as xe,g as Se,gt as Ce,h as we,ht as Te,i as Ee,k as De,l as Oe,lt as ke,m as Ae,mt as je,n as Me,nt as Ne,o as Pe,ot as Fe,p as Ie,r as Le,rt as Re,s as ze,st as Be,t as Ve,tt as He,u as Ue,ut as We,v as Ge,vt as Ke,w as qe,wt as Je,x as Ye,xt as v,y as Xe,yt as Ze}from"./adminNotificacionesView-DHOeTYUK.js";import{i as y,n as Qe,r as $e,t as et}from"./supabase-BryBf0UA.js";import{n as tt,r as nt}from"./vendor-CAKU_njC.js";import{i as rt}from"./permisosSupabase-DX8LFO6R.js";import{t as b}from"./AppToast-L43yfvBt.js";import{t as it}from"./preload-helper-CQ36nxok.js";import{t as x}from"./AppModal-BohrepL3.js";import{n as at}from"./groqService-CNWH1ut_.js";import{t as S}from"./router-D1rLi8eq.js";import{t as ot}from"./jspdf.es.min-B4LpO49P.js";import{t as st}from"./jspdf.plugin.autotable-BYntMLuC.js";import{t as ct}from"./clases-C94TYo1J.js";import{t as lt}from"./sesiones-Dk3BCHe7.js";import{t as ut}from"./cumplimientoMaestrosWidget-2Z4601XL.js";import{r as dt,t as ft}from"./analyticsFillingBehaviorWidget-CVe6FiVd.js";var pt=`auth-session`;function mt(e,t=!0){let n={access_token:e.access_token,refresh_token:e.refresh_token,user:e.user,expires_at:e.expires_at,persistent:t};(t?localStorage:sessionStorage).setItem(pt,JSON.stringify(n)),t?sessionStorage.removeItem(pt):localStorage.removeItem(pt)}function ht(){let e=localStorage.getItem(pt),t=sessionStorage.getItem(pt),n=e||t;if(!n)return null;try{return JSON.parse(n)}catch{return null}}function gt(){localStorage.removeItem(pt),sessionStorage.removeItem(pt)}function _t(){let e=ht();return!e||!e.expires_at?!1:Date.now()/1e3<e.expires_at-10}var vt=[];async function yt(e,t,n=!1){let{data:r,error:i}=await et(e,t);return i?(console.error(`🔑 login error:`,i),{user:null,session:null,error:i}):(r.session&&mt(r.session,n),{user:r.user,session:r.session,error:null})}async function bt(e,t,n={}){let{data:r,error:i}=await $e(e,t,n);return i?{user:null,session:null,error:i}:{user:r.user,session:r.session,error:null}}async function xt(){let{error:e}=await Qe();return gt(),vt.forEach(e=>e(null)),{error:e}}function St(){return _t()}function Ct(){return ht()?.user||null}var C={user:null,session:null,loading:!0,error:null,listeners:[]};function w(){C.listeners.forEach(e=>e(C))}function wt(e){return C.listeners.push(e),()=>{C.listeners=C.listeners.filter(t=>t!==e)}}async function Tt(e,t,n=!1){if(C.loading=!0,C.error=null,w(),e===`demo@soi.com`&&t===`demo123`){let e={id:`demo-user-id`,email:`demo@soi.com`,user_metadata:{full_name:`Usuario Demo`},role:`admin`},t={user:e,access_token:`demo-token`};return localStorage.setItem(`demo_mode`,`true`),v.isDemoMode=!0,mt(t,n),C.user=e,C.session=t,C.loading=!1,w(),{success:!0,user:e,session:t}}try{let r=await yt(e,t,n),i=r?.error&&(r.error.message||r.error),a=r?.user&&!i;return C.user=a?r.user:null,C.session=a?r.session:null,C.loading=!1,w(),i?{success:!1,error:typeof i==`string`?i:i.message||`Error desconocido`}:{success:a,user:C.user,session:C.session}}catch(e){return C.loading=!1,C.error=e.message,w(),{success:!1,error:e.message}}}async function Et(e,t,n){C.loading=!0,C.error=null,w();try{let r=await bt(e,t,n);C.user=r.user,C.session=r.session,C.loading=!1,w();let i=!r.error&&!!r.user,a=i&&!r.session;return{...r,success:i,needsConfirmation:a,message:a?`Registro exitoso. Tu cuenta está pendiente de aprobación por un administrador.`:void 0}}catch(e){return C.loading=!1,C.error=e.message,w(),{success:!1,error:e.message}}}function Dt(){xt(),localStorage.removeItem(`demo_mode`),v.isDemoMode=!1,C.user=null,C.session=null,C.error=null,w()}function Ot(){return Ct()}function kt(){return C.user?!0:St()}async function At(){let{data:{session:e},error:t}=await y.auth.getSession();return t||!e?(gt(),C.user=null,C.session=null,C.loading=!1,w(),{authenticated:!1}):(mt(e,ht()?.persistent??!0),C.session=e,C.user=e.user,C.loading=!1,w(),{authenticated:!0,user:C.user})}At();var T={subscribe:wt,login:Tt,register:Et,logout:Dt,getUser:Ot,isAuthenticated:kt,notifyListeners:w,refreshAuth:At,getState:()=>({...C})},jt={config:{fontSizeBase:`0.8rem`,fontSizeSmall:`0.7rem`,paddingX:`0.5rem`,paddingY:`0.35rem`,gap:`0.35rem`},styles:`
    /* Compact Tables */
    .table-compact {
      font-size: 0.8rem;
...
`+E(e.representante_tlf),hn(e.interes_musical),E(e.instrumento_interes),e.requiere_iniciacion_musical?`Sí`:`No`,e.acepta_pago_600?`Sí`:`No`]),headStyles:{fillColor:un,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:42},2:{cellWidth:10,halign:`center`},3:{cellWidth:14},4:{cellWidth:20},5:{cellWidth:42},6:{cellWidth:16},7:{cellWidth:22},8:{cellWidth:15,halign:`center`},9:{cellWidth:14,halign:`center`}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();_n(r,e.pageNumber,t)}}),e.length>0&&(r.addPage(),gn(r,`PERFIL SOCIOCULTURAL — ${i.toUpperCase()}`,`Información motivacional y social de los alumnos inscritos`),st(r,{startY:36,margin:{left:10,right:10},theme:`striped`,head:[[`#`,`Nombre`,`Colegio`,`Grado`,`Padres en vida`,`Monopar.`,`Subsidio`,`¿Por qué se unió?`,`Músico favorito`]],body:e.map((e,t)=>[t+1,E(e.nombre_completo),E(e.centro_estudios),E(e.grado_nivel),e.padres_en_vida===`ambos`?`Ambos`:e.padres_en_vida===`solo_madre`?`Solo madre`:e.padres_en_vida===`solo_padre`?`Solo padre`:e.padres_en_vida===`ninguno`?`Ninguno`:`—`,e.familia_monoparental?`Sí`:`No`,e.beneficiario_subsidio_estado?`Sí`:`No`,E(e.por_que_unirse).slice(0,80)+(E(e.por_que_unirse).length>80?`…`:``),E(e.musico_favorito)]),headStyles:{fillColor:un,textColor:255,fontStyle:`bold`,fontSize:7.5},bodyStyles:{fontSize:7,cellPadding:1.5},alternateRowStyles:{fillColor:[240,245,255]},columnStyles:{0:{cellWidth:7,halign:`center`},1:{cellWidth:38},2:{cellWidth:38},3:{cellWidth:16},4:{cellWidth:20},5:{cellWidth:14,halign:`center`},6:{cellWidth:14,halign:`center`},7:{cellWidth:55},8:{cellWidth:28}},didDrawPage:e=>{let t=r.internal.getNumberOfPages();_n(r,e.pageNumber,t)}}));let d=r.internal.getNumberOfPages();for(let e=1;e<=d;e++)r.setPage(e),_n(r,e,d);return r}function yn(e,t,n){vn(e,t,n).save(`reporte-inscripciones-${[``,`enero`,`febrero`,`marzo`,`abril`,`mayo`,`junio`,`julio`,`agosto`,`septiembre`,`octubre`,`noviembre`,`diciembre`][n]}-${t}.pdf`)}function bn(e){return je.map(t=>`<option value="${t.value}" ${t.value===e?`selected`:``}>${t.label}</option>`).join(``)}function xn(e){let t=e||{};return`<form class="row g-3">
    ...
    <div class="card shadow-sm mt-3">
      ...
      </div>`);try{i=await me(t,n),r&&(r.innerHTML=jn(i)+Mn(i),Nn(r));let a=e.querySelector(`#btn-descargar-pdf`);a&&(a.disabled=i.length===0,a.textContent=i.length>0?`Descargar PDF (${i.length} alumnos)`:`Sin inscritos`)}catch(e){console.error(e),r&&(r.innerHTML=`
      ...
      <div class="preload-search card shadow-sm mb-4">
        ...
        <div class="table-responsive mt-2" style="max-height:250px;overflow-y:auto">
          <table class="table table-sm table-striped mb-0 small">
            ...
            <tbody>${e.map(e=>`
        <tr>
          <td class="text-truncate" title="${_(e.alumno_nombre)}">${_(e.alumno_nombre)}</td>
          <td class="text-truncate" title="${_(e.postulante_nombre)}">${_(e.postulante_nombre)}</td>
        ...
        </div>`:``}function _(e){if(!e)return`—`;let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}h.addEventListener(`click`,()=>te(!1)),g.addEventListener(`click`,()=>te(!0)),d.addEventListener(`click`,async()=>{d.disabled=!0,d.innerHTML=`<span class="spinner-border spinner-border-sm me-1"></span>Sincronizando...`;try{let e=await pi();f.innerHTML=`
  ...
  `).join(``)}function Aa(e,t){let n=t[e.key],r=`modal-field-${e.key}`;if(e.type===`checkbox`){let t=n===!0||n===`true`||n===1||n===`1`?`checked`:``;return`
      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" id="${r}" name="${_(e.key)}" ${t}>
        <label class="form-check-label" for="${r}">${_(e.label)}</label>
      </div>
    `}if(e.type===`textarea`)return`
      <div class="mb-3">
        <label class="form-label fw-semibold" for="${r}">${_(e.label)}</label>
        <textarea class="form-control" id="${r}" name="${_(e.key)}" rows="3">${n==null?``:_(String(n))}</textarea>
      </div>
    `;if(e.type===`select`){let t=(e.options||[]).map(e=>`<option value="${_(e.v)}" ${n===e.v?`selected`:``}>${_(e.l)}</option>`).join(``);return`
      <div class="mb-3">
        <label class="form-label fw-semibold" for="${r}">${_(e.label)}</label>
        <select class="form-select" id="${r}" name="${_(e.key)}">${t}</select>
      </div>
    `}if(e.type===`date`){let t=n?String(n).slice(0,10):``;return`
      <div class="mb-3">
        <label class="form-label fw-semibold" for="${r}">${_(e.label)}</label>
        <input type="date" class="form-control" id="${r}" name="${_(e.key)}" value="${_(t)}">
      </div>
    `}return`
    <div class="mb-3">
      <label class="form-label fw-semibold" for="${r}">${_(e.label)}</label>
      <input type="text" class="form-control" id="${r}" name="${_(e.key)}" value="${n==null?``:_(String(n))}">
    </div>
  `}function ja(e){if(!e)return`?`;let t=e.trim().split(/\s+/);return t.length===1?t[0][0].toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}async function Ma(e,t={}){let n=t.alumnoId||t.id;if(!n){e.innerHTML=`<div class="alert alert-danger m-4">ID de alumno no especificado.</div>`;return}e.innerHTML=`
    <div class="d-flex justify-content-center align-items-center" style="min-height:300px">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Cargando...</span>
      </div>
    </div>
  `;let{data:r,error:i}=await y.from(`alumnos`).select(`*`).eq(`id`,n).single();if(i||!r){e.innerHTML=`<div class="alert alert-danger m-4">Error al cargar el alumno: ${_(i?.message||`No encontrado`)}</div>`;return}let{data:a}=await y.from(`alumnos_clases`).select(`clase_id, clases(id, nombre, dia, hora_inicio)`).eq(`alumno_id`,n).eq(`activo`,!0),s=(a||[]).map(e=>e.clases).filter(Boolean),c=!1,l=!1;function u(){let t=ja(r.nombre_completo),n=qe(r.fecha_nacimiento),i=r.activo?`<span class="badge bg-success">Activo</span>`:`<span class="badge bg-secondary">Inactivo</span>`,a=[`personal`,`madre`,`padre`,`representante`,`salud`,`musical`],c=[...a,`clases`,`progreso`,`asistencias`].map((e,t)=>`
      <li class="nav-item" role="presentation">
        <button
    ...
    `).join(``);function l(e){let t=Ea[e];return`
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h6 class="fw-bold text-uppercase text-muted small mb-0">${_(Da[e])}</h6>
          <button class="btn btn-sm btn-outline-primary" data-edit-section="${_(e)}">
              ...
              <div class="d-flex gap-3 align-items-center">
                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    ${n===null?``:`<span class="text-muted small">${_(String(n))} años</span>`}
    ...
    `}async function f(){if(l)return;l=!0;let e=document.getElementById(`asistencias-content`);if(!e)return;let{data:t,error:r}=await y.from(`asistencias`).select(`*`).eq(`alumno_id`,n).order(`fecha`,{ascending:!1}).limit(30);if(r){e.innerHTML=`<div class="alert alert-warning">Error al cargar asistencias: ${_(r.message)}</div>`;return}if(!t||t.length===0){e.innerHTML=`<p class="text-muted fst-italic">Sin registros de asistencia.</p>`;return}let i=0,a=0,s=0;for(let e of t){let t=(e.estado||e.asistio||``).toString().toLowerCase();t===`true`||t===`presente`||t===`1`?i++:t===`justificado`||t===`justified`?s++:a++}let c=t.length,u=c>0?Math.round(i/c*100):0;function d(e){let t=(e.estado||e.asistio||``).toString().toLowerCase();return t===`true`||t===`presente`||t===`1`?`<span class="badge bg-success">Presente</span>`:t===`justificado`||t===`justified`?`<span class="badge bg-warning text-dark">Justificado</span>`:`<span class="badge bg-danger">Ausente</span>`}e.innerHTML=`
      ...
      <div class="row g-2 mb-3">
        ...
        <div class="col-6 col-md-3">
          <div class="card text-center border-0 bg-light">
            <div class="card-body py-2">
              <div class="fs-4 fw-bold text-success">${_(String(i))}</div>
        ...
        <div class="col-6 col-md-3">
          <div class="card text-center border-0 bg-light">
            <div class="card-body py-2">
              <div class="fs-4 fw-bold text-danger">${_(String(a))}</div>
        ...
        <div class="col-6 col-md-3">
          <div class="card text-center border-0 bg-light">
            <div class="card-body py-2">
              <div class="fs-4 fw-bold text-warning">${_(String(s))}</div>
    ...
    <div class="card border-warning shadow-sm mb-4">
      <div class="card-body text-center py-3">
        ...
        <div class="alert alert-info d-flex align-items-center gap-2 mb-4">
          ...
          <span class="small">No se encontraron postulantes con el nombre <strong>${_(e.nombre_completo)}</strong>.</span>
        ...
        <td class="small fw-semibold">${_(t.replace(/_/g,` `))}</td>
        <td class="small">${_(String(i))}</td>
        <td class="small text-muted">${o?_(String(n)):`<em>vacío</em>`}</td>
      ...
      <div class="card border-warning shadow-sm mb-4">
        <div class="card-header d-flex align-items-center gap-2 bg-warning bg-opacity-10">
          ...
          <div class="flex-grow-1">
            <div class="fw-bold small">Postulante encontrado: ${_(r.nombre_completo||``)}</div>
            <div class="text-muted" style="font-size:0.72rem">Estado: ${_(r.estado||`—`)} · ID: ${_(r.id||``)}</div>
          </div>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
          ...
          <div class="alert alert-danger small mt-2">Error al guardar: ${_(e.message)}</div>`)}})}catch(e){n.innerHTML=`
      <div class="alert alert-danger d-flex align-items-center gap-2 mb-4">
        <i class="bi bi-exclamation-triangle"></i>
        <span class="small">Error al buscar postulante: ${_(e.message)}</span>
        <button class="btn btn-sm btn-outline-secondary ms-auto" id="btn-close-panel"><i class="bi bi-x"></i></button>
...
`);alert(`Citas para el día ${t} de ${Fo[z.month-1]}:\n\n${r}\n\nSelecciona el perfil para ver detalles.`),n.length===1&&S.navigate(`postulado`,{id:n[0].id})})})}function Go(){S.register(`alumnos`,r),S.register(`alumnos-reporte-mes`,Pn),S.register(`alumnos-inscribir`,xa),S.register(`alumnos-pdf-demo`,Pa),S.register(`alumno`,Ma),S.register(`postulados`,to),S.register(`postulado`,Eo),S.register(`postulados-calendario`,Lo)}function Ko(e){return e?{...e,nombre:e.nombre??e.name??``,codigo:e.codigo_salon??``,ubicacion:e.ubicacion??e.location??``,condicion:e.condicion_fisica??`buena`,is_active:e.is_active??e.isActive??e.activo??!0,capacidad:parseInt(e.capacidad)||20,piso:e.piso!==void 0&&e.piso!==null?parseInt(e.piso):null,equipamiento:Array.isArray(e.equipamiento)?e.equipamiento.join(`, `):e.equipamiento||``,descripcion:e.descripcion||``}:null}async function qo(){let{data:e,error:t}=await y.from(`salones`).select(`*`).order(`nombre`,{ascending:!0});if(t)throw console.error(`Error cargando salones:`,t.message),Error(`No se pudieron cargar los salones`);return e.map(Ko)}async function Jo(e){let t=(e.nombre||``).trim(),n=(e.codigo_salon||``).trim();if(!t)throw Error(`El nombre es obligatorio`);let{data:r,error:i}=await y.from(`salones`).select(`id, nombre, codigo_salon`).or(`nombre.eq."${t}", codigo_salon.eq."${n}"`).maybeSingle();if(i&&console.error(`Error validando duplicados:`,i),r){if(r.nombre.toLowerCase()===t.toLowerCase())throw Error(`Ya existe un salón con ese nombre`);if(n&&r.codigo_salon?.toLowerCase()===n.toLowerCase())throw Error(`Ya existe un salón con ese código`)}let a={nombre:t,codigo_salon:n||void 0,capacidad:parseInt(e.capacidad)||20,ubicacion:(e.ubicacion||``).trim(),piso:e.piso===void 0?null:parseInt(e.piso),condicion_fisica:e.condicion_fisica||`buena`,equipamiento:typeof e.equipamiento==`string`?e.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(e.equipamiento)?e.equipamiento:[],descripcion:(e.descripcion||``).trim(),is_active:e.is_active===void 0?!0:e.is_active,responsable_id:e.responsable_id||null},{data:o,error:s}=await y.from(`salones`).insert([a]).select();if(s)throw s.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error creando salon:`,s.message),Error(`No se pudo crear el salon`));return o[0]}async function Yo(e,t){let n=(t.nombre||``).trim(),r=(t.codigo_salon||``).trim();if(n||r){let{data:t}=await y.from(`salones`).select(`id, nombre, codigo_salon`).neq(`id`,e);if(t){if(n&&t.find(e=>e.nombre.toLowerCase()===n.toLowerCase()))throw Error(`Ya existe otro salón con ese nombre`);if(r&&t.find(e=>e.codigo_salon?.toLowerCase()===r.toLowerCase()))throw Error(`Ya existe otro salón con ese código`)}}let i={...t};n&&(i.nombre=n),r&&(i.codigo_salon=r),i.capacidad&&=parseInt(i.capacidad),i.piso!==void 0&&(i.piso=parseInt(i.piso)),i.equipamiento!==void 0&&(i.equipamiento=typeof i.equipamiento==`string`?i.equipamiento.split(`,`).map(e=>e.trim()).filter(Boolean):Array.isArray(i.equipamiento)?i.equipamiento:[]),i.updated_at=new Date().toISOString();let{data:a,error:o}=await y.from(`salones`).update(i).eq(`id`,e).select();if(o)throw o.code===`23505`?Error(`El nombre o código del salón ya está registrado`):(console.error(`Error actualizando salon:`,o.message),Error(`No se pudo actualizar el salon`));return a[0]}async function Xo(e){let{error:t}=await y.from(`salones`).update({is_active:!1,updated_at:new Date().toISOString()}).eq(`id`,e);if(t)throw console.error(`Error eliminando salon:`,t.message),Error(`No se pudo inactivar el salon`)}var B=new class{constructor(){this.salones=[],this.cargando=!1,this.error=null,this.listeners=[]}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notify(){this.listeners.forEach(e=>e(this))}async fetchSalones(){this.cargando=!0,this.error=null,this.notify();try{this.salones=await qo()}catch(e){this.error=e.message,console.error(e)}finally{this.cargando=!1,this.notify()}}getFiltered(e=``,t=``,n=``){return this.salones.filter(r=>{let i=e.toLowerCase(),a=r.nombre.toLowerCase().includes(i)||r.codigo&&r.codigo.toLowerCase().includes(i)||r.ubicacion.toLowerCase().includes(i),o=t===``||String(r.piso)===String(t),s=n===``||r.condicion===n;return a&&o&&s})}},Zo={editandoId:null};function V(e){return e?String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`):``}function Qo(e){if(!e)return`?`;let t=String(e).trim().split(/\s+/);return t.length===1?t[0].substring(0,2).toUpperCase():(t[0].charAt(0)+t[t.length-1].charAt(0)).toUpperCase()}function $o(e){e.innerHTML=`
  ...
  `}function ds(){return H.timeline.length===0?`<div class="text-center py-5 text-muted"><i class="bi bi-calendar-x fs-1 d-block mb-2"></i>No hay clases registradas.</div>`:H.timeline.map((e,t)=>{let n=ps(e.fecha),r=`accordion-fecha-${t}`,i=e.clases.map((e,n)=>{let r=`accordion-clase-${t}-${n}`,i=e.hora_inicio?`${e.hora_inicio.slice(0,5)} - ${e.hora_fin?.slice(0,5)||`??:??`}`:`Sin horario`;return`
    ...
    `}).join(``)}function fs(e){let t=e.asistencias||[],n=t.filter(e=>e.estado===`presente`),r=t.filter(e=>e.estado===`ausente`),i=t.filter(e=>e.estado===`justificado`),a=(e,t,n)=>t.length===0?``:`
      <div class="mb-3">
  ...
  `}function ps(e){return new Date(e+`T12:00:00`).toLocaleDateString(`es-ES`,{weekday:`long`,day:`numeric`,month:`long`})}function ms(e){e.querySelector(`#select-periodo`)?.addEventListener(`change`,async e=>{H.filtroPeriodo=e.target.value,await hs()}),e.querySelector(`#accordion-dias`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="view-detail"]`);t&&gs(t.dataset.id)}),e.querySelector(`#btn-nueva-sesion`)?.addEventListener(`click`,()=>_s())}async function hs(){let e=H.container;b.info(`Cargando asistencias...`),await ss();let t=e.querySelector(`.asistencias-header-premium p.text-muted`);t&&(t.textContent=`${H.resumenGlobal?.totalRegistros||0} registros en total`);let n=e.querySelector(`.stats-panel`);n&&(n.innerHTML=`
    ...
    `);let r=e.querySelector(`#accordion-dias`);r&&(r.innerHTML=ds()),ms(e),b.success(`Asistencias cargadas`)}async function gs(e){b.info(`Cargando detalle...`);try{let t=await u(e);x.open({title:`Sesión: ${t.sesion.claseNombre}`,size:`lg`,hideSave:!0,cancelText:`Cerrar`,body:`
        <div class="row g-4">
          <div class="col-md-8">
...
Para las próximas semanas, incorporá al menos una pieza nueva por mes y dedicá 5-10 minutos a ejercicios de lectura rítmica.`,isMock:!0};try{return{success:!0,feedback:await Hs([{role:`user`,content:i}],{maxTokens:600,temperature:.8}),isMock:!1}}catch(e){return console.error(`analizarEnfoque error:`,e),{success:!1,feedback:``,error:e.message}}}var Ks=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),qs=`
...
.cob-ai-badge { font-size:.7rem; color: var(--bs-warning-text-emphasis); }
</style>`;async function Js({plan:e,claseId:t,instrumento:n,nivel:r,maestroId:a,onConfirm:o,onSkip:s}){let c=document.createElement(`div`);c.innerHTML=`${qs}
    <div class="modal fade" id="cob-modal" tabindex="-1" data-bs-backdrop="static">
      ...
      ${Object.entries(t).map(([e,{nombre:t,rows:n}])=>`
        ...
        </div>`).join(``)}`,e.querySelectorAll(`.cob-check`).forEach(t=>{t.addEventListener(`change`,()=>{let n=+t.dataset.idx;d[n].checked=t.checked;let r=e.querySelector(`.cob-nivel-sel[data-idx="${n}"]`);r&&(r.disabled=!t.checked)})}),e.querySelectorAll(`.cob-nivel-sel`).forEach(e=>{e.addEventListener(`change`,()=>{d[+e.dataset.idx].nivel=e.value})})}}var Ys=e=>String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);async function Xs(e){e.innerHTML=`
    <div class="page-container">
...
.cm-obj-input { flex:1; }
    ...
    </div>`,document.body.appendChild(t);let n=t.querySelector(`#cc-modal`),r=new bootstrap.Modal(n);t.querySelector(`#cc-btn-save`).addEventListener(`click`,async()=>{let n=t.querySelector(`#cc-instrumento`).value.trim(),i=t.querySelector(`#cc-nivel`).value.trim();if(!n||!i){b.error(`Instrumento y nivel son obligatorios`);return}try{await fe({instrumento:n,nivel:i,descripcion:t.querySelector(`#cc-desc`).value.trim()}),b.success(`Currículo creado`),r.hide(),e?.()}catch(e){b.error(e.message)}}),n.addEventListener(`hidden.bs.modal`,()=>t.remove()),r.show()}async function ec(e,t){let{data:n,error:r}=await y.from(`curriculos`).select(`id, instrumento, nivel, descripcion, curriculo_pilares(id, nombre, orden, curriculo_objetivos(id, descripcion, orden))`).eq(`id`,e).single();if(r){b.error(r.message);return}let i=document.createElement(`div`);i.innerHTML=`
    <div class="modal fade" id="ce-modal" tabindex="-1">
      ...
      </div>`,e.querySelectorAll(`.pilar-nombre`).forEach(e=>{e.addEventListener(`blur`,async()=>{await Re(e.closest(`[data-pilar-id]`).dataset.pilarId,{nombre:e.value.trim()})})}),e.querySelectorAll(`.pilar-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`).dataset.pilarId;confirm(`¿Eliminar este pilar y todos sus objetivos?`)&&(await ke(t),n.curriculo_pilares=n.curriculo_pilares.filter(e=>e.id!==t),s())})}),e.querySelectorAll(`.obj-desc`).forEach(e=>{e.addEventListener(`blur`,async()=>{await Ne(e.closest(`[data-obj-id]`).dataset.objId,{descripcion:e.value.trim()})})}),e.querySelectorAll(`.obj-del`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-obj-id]`),r=t.dataset.objId;await ge(r);let i=t.closest(`[data-pilar-id]`).dataset.pilarId,a=n.curriculo_pilares.find(e=>e.id===i);a&&(a.curriculo_objetivos=a.curriculo_objetivos.filter(e=>e.id!==r)),s()})}),e.querySelectorAll(`.new-obj-btn`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.closest(`[data-pilar-id]`),r=t.dataset.pilarId,i=t.querySelector(`.new-obj-input`),a=i.value.trim();if(!a)return;let o=n.curriculo_pilares.find(e=>e.id===r),c=(o?.curriculo_objetivos||[]).length,l=await Fe(r,a,c);o&&(o.curriculo_objetivos=[...o.curriculo_objetivos||[],l]),i.value=``,s()})}),document.getElementById(`ce-add-pilar`)?.addEventListener(`click`,async()=>{let e=prompt(`Nombre del nuevo pilar:`);if(!e?.trim())return;let t=n.curriculo_pilares.length,r=await Be(n.id,e.trim(),t);n.curriculo_pilares.push({...r,curriculo_objetivos:[]}),s()})}a.addEventListener(`hidden.bs.modal`,()=>{i.remove(),t?.()}),o.show(),s()}var tc=`
...
.cambio-move { color: #ffc107; }
    ...
    </div>`,document.body.appendChild(r);let i=document.getElementById(`ruta-variante-dialog`),a=new bootstrap.Modal(i);async function o(){let n=document.getElementById(`variante-body`);try{let r=await Xe(e);n.innerHTML=`
...
</style>`;async function oc(e){if(e)try{let t=await pe();if(t.length===0){e.innerHTML=`${ac}<div class="alert alert-info">No hay variantes pendientes de aprobación.</div>`;return}let n=`${ac}
      <div class="mb-3">
        <h5><span class="badge bg-warning">${t.length} pendientes</span></h5>
      </div>`;for(let e of t){let t=e.ruta_base_id?await Xe(e.ruta_base_id):null;n+=`
...
{Actividad} Construcción de acordes en el instrumento`}],U={planes:[],cargando:!1,viewMode:`maestro`,activeTab:`planes`,asistenteRendered:!1,rutasRendered:!1,seleccionados:new Set,container:null},W=Ls();async function dc(e,{viewMode:t=`maestro`}={}){if(e){if(U.container=e,U.viewMode=t,U.seleccionados=new Set,U.asistenteRendered=!1,U.rutasRendered=!1,t===`plantillas`){vc(e);return}try{U.cargando=!0,fc(e),await W.fetchPlanificacionesConDetalles(),U.planes=[...W.planificaciones],U.cargando=!1,mc(e),bc(e)}catch(t){console.error(`[planificacionView]`,t),pc(e,t.message)}}}function fc(e){e.innerHTML=`
    ...
    </div>`}function mc(e){let t=U.viewMode===`admin`,n=t?`Todas las Planificaciones`:`Mis Planes de Clase`,r=t?`bi-shield-check`:`bi-journal-check`,i=t?`${W.planificaciones.length} planes pendientes de revisión`:`${W.planificaciones.length} planes registrados`,a=t?hc():``;e.innerHTML=`
    <div class="page-container">
      <!-- Header -->
      ...
      <div class="planificacion-filter-toolbar mb-4">
        ...
        <div class="premium-select-container">
          ...
          <select class="form-select premium-filter-select" id="select-estado">
            ...
            ${Je.getEstados().map(e=>`<option value="${e.value}">${e.label}</option>`).join(``)}
          </select>
        </div>
      </div>
  ...
  `}function gc(e){if(!e||e.length===0)return``;let t=U.viewMode===`admin`;return e.map(e=>{let n=Je.getEstadoConfig(e.estado),r=e.estado===`revisado`?`border-accent-success`:e.estado===`ejecutado`?`border-accent-warning`:`border-accent-secondary`;return`
  ...
  `,e.querySelectorAll(`button[data-template-id]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=uc.find(t=>t.id===e.dataset.templateId);t&&yc(t)})})}function yc(e){x.open({title:`Usar plantilla: ${e.nombre}`,saveText:`Crear Plan`,size:`lg`,body:`
    ...
    `,onOpen:async e=>{let{data:t}=await y.from(`clases`).select(`id, nombre`).order(`nombre`),r=e.querySelector(`#plan-clase_id`);r.innerHTML=`<option value="">Seleccionar clase...</option>`+(t||[]).map(e=>`<option value="${e.id}" ${e.id===n.clase_id?`selected`:``}>${h(e.nombre)}</option>`).join(``);let i=e.querySelector(`#plan-dsl-container`),a=ne({initialContent:n.notas_dsl||``,onChange:(t,n)=>{let r=e.querySelector(`#plan-dsl-summary`);r&&n.items&&n.items.length>0&&(r.innerHTML=`<strong>Elementos:</strong> ${n.items.length} indicadores/actividades parseadas`)},onAlumnoClick:async()=>{let e=(await ue()).slice(0,3).map(e=>`#${e.nombre_completo}`).join(`, `);a.component&&a.component.insertText(e+` `)}});i.appendChild(a),e._dslEditor=a},onSave:async t=>{let n=t._dslEditor,r={tema:t.querySelector(`#plan-tema`).value.trim(),clase_id:t.querySelector(`#plan-clase_id`).value,objetivos:t.querySelector(`#plan-objetivos`).value.trim(),contenido:t.querySelector(`#plan-contenido`)?.value.trim()||``,notas_dsl:n?n.getContent():``,fecha_inicio:t.querySelector(`#plan-fecha`).value||null,instrumento:t.querySelector(`#plan-instrumento`).value.trim()||null,evaluacion_metodo:t.querySelector(`#plan-eval`).value.trim()||null},i=new Je(r).validate();if(i.length>0)return b.error(i[0]),!1;try{return e?(await se(e,r),b.success(`Plan actualizado correctamente`)):(await oe(r),b.success(`Plan creado correctamente`)),dc(U.container,{viewMode:U.viewMode}),!0}catch(e){return b.error(e.message),!1}}})}function wc(e){let t=W.getById(e);if(!t)return;let n=Je.getEstadoConfig(t.estado);x.open({title:`Plan: ${t.clase_nombre||`Sin clase`}`,hideSave:!0,size:`lg`,body:`
  ...
  `}function pl(e){return e.map(e=>{let t=d.getTipos().find(t=>t.value===e.tipo),n=d.getPrioridades().find(t=>t.value===e.prioridad),r=d.getEstados().find(t=>t.value===e.estado),i=e.prioridad===`alta`?`border-accent-danger`:e.prioridad===`media`?`border-accent-warning`:`border-accent-secondary`;return`
...
`)}))return;Q.undoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.redoStack=[];let i=Q.assignments.findIndex(t=>t.clase_id===e.clase_id);if(i===-1)return;let a={...Q.assignments[i]},o=Ud(a.hora_inicio,a.hora_fin);a.dia=t,a.hora_inicio=n,a.hora_fin=Wd(n,o),Q.assignments[i]=a;let s=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=s.conflicts,Q.assignments=s.assignments,Ld(),Rd(),Gd(),Kd()}finally{i&&(i.disabled=!1),Gd()}}}))}function qd(){$.addEventListener(`change`,e=>{e.target.id===`hb-periodo-select`&&(Q.activePeriodo=e.target.value,Ld())}),$.addEventListener(`click`,async e=>{let t=e.target.closest(`.vt-pill[data-view]`);if(t){let e=t.dataset.view;yd.includes(e)&&e!==Q.activeView&&(Q.activeView=e,zd(),Ld());return}if(e.target.closest(`#hb-drag-toggle`)){Q.draggable=!Q.draggable;let e=$.querySelector(`#hb-drag-toggle`);e&&(e.innerHTML=Q.draggable?`<i class="bi bi-unlock-fill"></i> Bloqueando`:`<i class="bi bi-lock-fill"></i> Editar`),Ld(),Kd();return}if(e.target.closest(`#hb-undo-btn`)){if(Q.undoStack.length===0)return;Q.redoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.assignments=Q.undoStack.pop();let e=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=e.conflicts,Q.assignments=e.assignments,Ld(),Rd(),Gd(),Kd();return}if(e.target.closest(`#hb-redo-btn`)){if(Q.redoStack.length===0)return;Q.undoStack.push(JSON.parse(JSON.stringify(Q.assignments))),Q.assignments=Q.redoStack.pop();let e=od(Q.assignments,{returnAnnotated:!0});Q.conflicts=e.conflicts,Q.assignments=e.assignments,Ld(),Rd(),Gd(),Kd();return}if(e.target.closest(`#hb-generate-btn`)){Jd();return}if(e.target.closest(`#hb-save-btn`)){Yd();return}if(e.target.closest(`#hb-publish-btn`)){if(Q.publishWizardOpen=!Q.publishWizardOpen,Q.publishWizardOpen&&Q.runId)try{Q.feedback=await kd(Q.runId)}catch{Q.feedback=[]}Bd();return}})}async function Jd(){let e=$.querySelector(`#hb-generate-btn`);e&&(e.disabled=!0),Vd(!0);try{let e=await Ku(),{conflicts:t,assignments:n}=od(nd({clasesConMaestro:(e.clases||[]).map(e=>({id:e.id,nombre:e.nombre,maestro_principal_id:e.maestro_principal_id,total_alumnos:e.total_alumnos||0,duracion:60})),maestros:e.maestros||[],salones:e.salones||[],config:{gapMinimo:15,duracionBloque:60}}).assignments,{returnAnnotated:!0,gapMinutes:15});Q.assignments=n,Q.conflicts=t,Ld(),Rd(),Kd();let r=$.querySelector(`#hb-save-btn`);r&&(r.disabled=Q.assignments.length===0),Hd(t.length>0?`Horario generado con ${t.length} conflicto(s)`:`Horario optimizado sin conflictos`,t.length>0?`warning`:`success`)}catch(e){console.error(`[horarioBuilderView] handleGenerate error:`,e),Hd(`Error al generar: `+e.message,`danger`)}finally{Vd(!1),e&&(e.disabled=!1)}}async function Yd(){let e=$.querySelector(`#hb-save-btn`);e&&(e.disabled=!0,e.innerHTML=`<span class="spinner-border spinner-border-sm"></span> Guardando…`);try{let e=await qu({assignments:Q.assignments,periodo_id:Q.activePeriodo,estado:`borrador`});if(e?.id){Q.runId=e.id,Q.estado=`borrador`;let t=$.querySelector(`#hb-publish-btn`);t&&(t.disabled=!1),Hd(`Horario guardado como borrador`,`success`)}else Hd(`Guardado incompleto: no se obtuvo ID del registro`,`warning`);Q.error=null}catch(e){console.error(`[horarioBuilderView] handleSave error:`,e),Q.error=e.message,Hd(`Error al guardar: `+e.message,`danger`)}finally{e&&(e.disabled=!1,e.innerHTML=`<i class="bi bi-floppy-fill"></i> Guardar`)}}function Xd(){S.register(`horario-builder`,Fd)}function Zd(){S.register(`admin-notificaciones`,e=>{try{Ve(e)}catch(t){console.error(`[admin-notificaciones] Error al renderizar la vista:`,t),e.innerHTML=`
  ...
  `;let u=document.createElement(`nav`);u.className=`app-bottom-nav`,u.innerHTML=nf.map(e=>`
